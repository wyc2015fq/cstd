...
1、简单地说，页面渲染就是浏览器将html代码根据CSS定义的规则显示在浏览器窗口中的这个过程。
...
　　HTML规范的最新版本是HTML4(http://www.w3.org/TR/html401/)，[HTML5](http://lib.csdn.net/base/html5)还在制定中（译注：两年前），最新的CSS规范版本是2（http://www.w3.org/TR/CSS2），[CSS3](http://lib.csdn.net/base/css3)也还正在制定中（译注：同样两年前）。
...
　　[html5](http://lib.csdn.net/base/html5)并没有规定浏览器必须具有的UI元素，但列出了一些常用元素，包括地址栏、状态栏及工具栏。还有一些浏览器有自己专有的功能，比如Firefox的下载管理。更多相关内容将在后面讨论用户界面时介绍。
...
　　5. UI后端 － 用来绘制类似组合选择框及对话框等基本组件，具有不特定于某个平台的通用接口，底层使用[操作系统](http://lib.csdn.net/base/operatingsystem)的用户接口。

　　6. [js](http://lib.csdn.net/base/javascript)解释器 － 用来解释执行JS代码。

　　7. 数据存储 － 属于持久层，浏览器需要在硬盘中保存类似cookie的各种数据，[Html5](http://lib.csdn.net/base/html5)定义了web database技术，这是一种轻量级完整的客户端存储技术

![img](https://pic002.cnblogs.com/images/2011/265173/2011110316262567.png)
...
　　Webkit是一款开源渲染引擎，它本来是为[Linux](http://lib.csdn.net/base/linux)平台研发的，后来由Apple移植到Mac及Windows上，相关内容请参考[http://webkit.org](http://webkit.org/)。
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316264892.png)

图3：webkit主流程

![img](https://pic002.cnblogs.com/images/2011/265173/2011110316270146.jpg)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316271310.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316272491.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316274796.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316280265.png)
...
　　Html5规范中描述了这个解析[算法](http://lib.csdn.net/base/datastructure)，算法包括两个阶段——符号化及构建树。

　　符号化是词法分析的过程，将输入解析为符号，html的符号包括开始标签、结束标签、属性名及属性值。

　　符号识别器识别出符号后，将其传递给树构建器，并读取下一个字符，以识别下一个符号，这样直到处理完所有输入。

![img](https://pic002.cnblogs.com/images/2011/265173/2011110316282058.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316283115.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316284511.gif)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316563380.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316565168.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316570450.png)

　　上下文树如下（节点名：指向的规则节点）

![img](https://pic002.cnblogs.com/images/2011/265173/2011110316572022.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316575534.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316582721.jpg)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316585169.png)

　　Inline box：并没有自己的块状区域，但包含在一个块状区域内

![img](https://pic002.cnblogs.com/images/2011/265173/2011110316590681.png)

　　block一个挨着一个垂直格式化，inline则在水平方向上格式化。

![img](https://pic002.cnblogs.com/images/2011/265173/2011110316591786.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316593174.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316594780.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110316595942.png)

#### 　　Absolute和Fixed

　　这种情况下的布局完全不顾普通的文档流，元素不属于文档流的一部分，大小取决于容器。Fixed时，容器为viewport（可视区域）。

![img](https://pic002.cnblogs.com/images/2011/265173/2011110317001254.png)
...
![img](https://pic002.cnblogs.com/images/2011/265173/2011110317002510.png)
