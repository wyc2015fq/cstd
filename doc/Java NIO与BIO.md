...
请注意处理状态由程序执行多久决定。换句话说，一旦`reader.readLine()`方法返回，你就知道文本行肯定就已读完， `readline()`阻塞直到整行读完，这就是原因。你也知道此行包含名称；同样，第二个`readline()`调用返回的时候，你知道这行包含年龄等。 正如你可以看到，该处理程序仅在有新数据读入时运行，并知道每步的数据是什么。一旦正在运行的线程已处理过读入的某些数据，该线程不会再回退数据（大多如此）。下图也说明了这条原则：
 



![img](https://upload-images.jianshu.io/upload_images/722827-bc0fc9a1c6f2f464.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/342)
...
![img](https://upload-images.jianshu.io/upload_images/722827-62e277a029257bc7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/421)
...
![img](https://upload-images.jianshu.io/upload_images/722827-5975140ab6a28e6c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/293)
...
![img](https://upload-images.jianshu.io/upload_images/722827-dc6fb6aa286ebe03.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/500)
