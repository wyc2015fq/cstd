...
现在我们只剩下一个问题了，就是什么是unmarked点，我们知道内轮廓点开始点P的下方一定是一个黑色像素，是不是黑色像素就是unmarked点呢，显然不是，如下图像的[Q点](https://www.baidu.com/s?wd=Q%E7%82%B9&tn=24004469_oem_dg&rsv_dl=gh_pl_sl_csd)，它的下面也是黑色像素，然而它却不是内轮廓上的点。
