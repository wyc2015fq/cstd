...
[![img](http://static.oschina.net/uploads/img/201412/08141454_ACE9.jpg)](http://static.oschina.net/uploads/img/201412/08141454_ACE9.jpg)
...
![img](http://static.oschina.net/uploads/img/201412/08141455_yH58.png)

 

YUYV为YUV422采样的存储格式中的一种，相邻的两个Y共用其相邻的两个Cb、Cr，分析，对于像素点Y'00、Y'01 而言，其Cb、Cr的值均为 Cb00、Cr00，其他的像素点的YUV取值依次类推。 **（2） UYVY 格式 （属于YUV422）**

[![img](http://static.oschina.net/uploads/img/201412/08141455_BHdN.png)](http://static.oschina.net/uploads/img/201412/08141455_BHdN.png)
...
YUV422P也属于YUV422的一种，它是一种Plane模式，即平面模式，并不是将YUV数据交错存储，而是先存放所有的Y分量，然后存储所有的U（Cb）分量，最后存储所有的V（Cr）分量，如上图所示。其每一个像素点的YUV值提取方法也是遵循YUV422格式的最基本提取方法，即两个Y共用一个UV。比如，对于像素点Y'00、Y'01 而言，其Cb、Cr的值均为 Cb00、Cr00。
  ...
  [![img](http://static.oschina.net/uploads/space/2014/1208/141625_Nmib_1024767.png)](http://static.oschina.net/uploads/space/2014/1208/141625_Nmib_1024767.png)

**（4）YV12，YU12格式（属于YUV420）**

YU12和YV12属于YUV420格式，也是一种Plane模式，将Y、U、V分量分别打包，依次存储。其每一个像素点的YUV数据提取遵循YUV420格式的提取方式，即4个Y分量共用一组UV。注意，上图中，Y'00、Y'01、Y'10、Y'11共用Cr00、Cb00，其他依次类推。

![img](http://static.oschina.net/uploads/space/2014/1208/141726_CZLj_1024767.png)
...
​       [![img](http://static.oschina.net/uploads/img/201412/08141455_sPDM.png)](http://static.oschina.net/uploads/img/201412/08141455_sPDM.png)      

​                        YUV420p数据格式如下图

​           [![img](http://static.oschina.net/uploads/img/201412/08141455_7BIM.png)](http://static.oschina.net/uploads/img/201412/08141455_7BIM.png)
