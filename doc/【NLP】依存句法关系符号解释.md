...
今天开始读一篇论文：leveraging linguistic structure for open domain information extraction

于是……重新复习了很多句法分析的内容，转载一个关键词的解释(?https://blog.csdn.net/lihaitao000/article/details/51812618
