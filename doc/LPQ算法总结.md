...
2013年08月17日 03:32:22 [colourfulcloud](https://me.csdn.net/colourfulcloud) 阅读数：4812
...
在利用LPQ进行图像匹配的时候，若效果不明显，可以尝试使用分块图像，就是先把图像划分成子图像，再对每个子图像计算LPQ直方图，把这些子图像的LPQ直方图拼接起来作为图像的LPQ特征值再进行匹配，效果会明显改善。