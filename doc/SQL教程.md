...
https://www.liaoxuefeng.com/wiki/001508284671805d39d23243d884b8b99f440bfae87b0f4000/001509167363938072fc3ae9c454397bbd791fd88b7d92d000
...
SELECT AVG(score) average FROM students GROUP BY class_id
```
...
SELECT AVG(score) average, class_id, gender FROM students GROUP BY class_id, gender;
```

| average | class_id | gender |
| :------ | :------- | :----- |
| 89      | 1        | M      |
| 84      | 1        | F      |
| 81      | 2        | F      |
...
LEFT OUTER JOIN则返回左表都存在的行。如果我们给students表增加一列，并添加class_id=5，由于classes表并不存在id=5的列，所以，LEFT OUTER JOIN的结果会增加一列，对应的`class_name`是`NULL`：
...
![inner-join](https://cdn.liaoxuefeng.com/cdn/files/attachments/001541249316013907464fc679b425d9fd004cb391c7e93000/l)

LEFT OUTER JOIN是选出左表存在的记录：

![left-outer-join](https://cdn.liaoxuefeng.com/cdn/files/attachments/001541249995221903a689145e14a9e9a434c78158f3d64000/l)

RIGHT OUTER JOIN是选出右表存在的记录：

![right-outer-join](https://cdn.liaoxuefeng.com/cdn/files/attachments/001541250005973eb9312fd5da847d18ee6c6fd56ce63de000/l)

FULL OUTER JOIN则是选出左右表都存在的记录：

![full-outer-join](https://cdn.liaoxuefeng.com/cdn/files/attachments/0015412500166713848ed04a125473c823e7e9c76f4f85a000/l)
...
![insert-brain](https://cdn.liaoxuefeng.com/cdn/files/attachments/001542790812108f347845f00e441808d82dd882021398f000/l)
...
![update-sql](https://cdn.liaoxuefeng.com/cdn/files/attachments/001527403290307dfc320af3cff465e99f03427a4dcc10c000/l)
...
![sql-delete](https://cdn.liaoxuefeng.com/cdn/files/attachments/001543149100349bc00576eeb7046539db7eab5d639c88c000/l)
