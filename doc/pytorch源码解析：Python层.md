# pytorch源码解析：Python层
置顶 2018年07月31日 10:55:16 [诸葛冰箱102](https://me.csdn.net/f1121814098) 阅读数：1228
...
### pytorch的主要概念
pytorch的主要概念官网有很人性化的教程[Deep Learning with PyTorch: A 60 Minute Blitz](http://pytorch.org/tutorials/beginner/deep_learning_60min_blitz.html)， 这里简单概括这些概念：
### Tensor
...
![img](https://upload-images.jianshu.io/upload_images/2159902-b1eed88292fea1a1.png?imageMogr2/auto-orient/)
- data 为其封装的tensor值
- grad 为其求导后的值
...
![img](https://upload-images.jianshu.io/upload_images/2159902-3c50b522ede0fcb6.png?imageMogr2/auto-orient/)
### 前向传播、反向传播
前向传播
