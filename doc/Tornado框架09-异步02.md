# Tornado框架09-异步02
 																				...
 																				2017年10月21日 17:33:12 					[Python小学生](https://me.csdn.net/qq_31518167) 						阅读数：306 						 																															

 									

​                   					 							 					                   					 					版权声明：本文为博主原创文章，未经博主允许不得转载。					https://blog.csdn.net/qq_31518167/article/details/78305117				
...
```
http://int.dpool.sina.com.cn/iplookup/iplookup.php?format=json&ip=[ip地址字串]1
```
    ...
    def on_response(self, response):
        if response.error:
            ...
            if 1 == data["ret"]:
                ...
                self.write("查询IP信息错误")
        self.finish() # 发送响应信息，结束请求处理1234567891011121314151617
```
    ...
    def get(self):
        ...
        if response.error:
            ...
            if 1 == data["ret"]:
                ...
                self.write("查询IP信息错误")12345678910111213
```
...
class IndexHandler(tornado.web.RequestHandler):
    ...
    def get_ip_info(self, ip):
        ...
        raise tornado.gen.Return(rep)  # 此处需要注意123456789101112131415161718
```
