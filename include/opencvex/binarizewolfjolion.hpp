...
#ifndef __BINARIZEWOLFJOLION_HPP__
#define __BINARIZEWOLFJOLION_HPP__
...
void NiblackSauvolaWolfJolion(const Mat& im, Mat& output, NiblackVersion version,
 ...
 **********************************************************/
#if 0
int test_binarizewolfjolion(int argc, char **argv)
{
	char version;
	int c;
	int winx=0, winy=0;
...
#endif // __BINARIZEWOLFJOLION_HPP__
