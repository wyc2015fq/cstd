...
namespace FastColoredTextBoxNS
{
    ...
    /// </summary>
    //[Browsable(false)]
    class AutocompleteMenu : ToolStripDropDown, IDisposable
    {
        ...
        /// </summary>
        Size MaxTooltipSize { get { return listView.MaxToolTipSize; } set { listView.MaxToolTipSize = value; } }
        /// <summary>
        /// Tooltip will perm show and duration will be ignored
        /// </summary>
        bool AlwaysShowTooltip { get { return listView.AlwaysShowTooltip; } set { listView.AlwaysShowTooltip = value; } }

        /// <summary>
        /// Back color of selected item
        /// </summary>
        //[DefaultValue(typeof(Color), "Orange")]
        Color getSelectedColor() { return listView.SelectedColor; }
        void setSelectedColor(const Color& value) { listView.SelectedColor = value; }
    ...
    class AutocompleteListView : UserControl, IDisposable
    {
    ...
    class SelectingEventArgs : EventArgs
    {
