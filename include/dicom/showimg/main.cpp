/****************************************************************************
** $Id: qt/examples/showimg/main.cpp   2.3.7   edited 2001-06-12 $
**
...
int main( int argc, char **argv )
{
	...
	QPEApplication::setColorSpec( QPEApplication::NormalColor );
	argc--;
	argv++;
    } 
    else {
	QPEApplication::setColorSpec( QPEApplication::CustomColor );
    }

    QPEApplication::setFont( QFont("Helvetica", 12) );
