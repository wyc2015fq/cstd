...
namespace AForge
{
    ...
    public struct DoublePoint
    {
        ...
        /// 
        static DoublePoint operator +( DoublePoint point1, DoublePoint point2 )
        {
        ...
        /// coordinates of specified points.</returns>
        /// 
        static DoublePoint Add( DoublePoint point1, DoublePoint point2 )
        {
            return new DoublePoint( point1.X + point2.X, point1.Y + point2.Y );
        }
        ...
        /// coordinates of specified points.</returns>
        ///
        static DoublePoint Subtract( DoublePoint point1, DoublePoint point2 )
        {
            return new DoublePoint( point1.X - point2.X, point1.Y - point2.Y );
        }
        ...
        /// 
        static DoublePoint operator +( DoublePoint point, double valueToAdd )
        {
        ...
        /// the specified point increased by specified value.</returns>
        /// 
        static DoublePoint Add( DoublePoint point, double valueToAdd )
        {
            return new DoublePoint( point.X + valueToAdd, point.Y + valueToAdd );
        }
        ...
        /// 
        static DoublePoint operator -( DoublePoint point, double valueToSubtract )
        {
        ...
        /// the specified point decreased by specified value.</returns>
        /// 
        static DoublePoint Subtract( DoublePoint point, double valueToSubtract )
        {
            return new DoublePoint( point.X - valueToSubtract, point.Y - valueToSubtract );
        }
        ...
        ///
        static DoublePoint operator *( DoublePoint point, double factor )
        {
        ...
        /// the specified point multiplied by specified value.</returns>
        ///
        static DoublePoint Multiply( DoublePoint point, double factor )
        {
            return new DoublePoint( point.X * factor, point.Y * factor );
        }
        ...
        /// the specified point divided by specified value.</returns>
        /// 
        static DoublePoint Divide( DoublePoint point, double factor )
        {
            return new DoublePoint( point.X / factor, point.Y / factor );
        }
        ...
        ///
        static bool operator ==( DoublePoint point1, DoublePoint point2 )
        {
        ...
        /// <summary>
        /// Explicit conversion to <see cref="IPOINT"/>.
        /// </summary>
        /// 
        ...
        /// 
        static explicit operator IPOINT( DoublePoint point )
        {
            return new IPOINT( (int) point.X, (int) point.Y );
        }
        ...
        /// 
        static explicit operator Point( DoublePoint point )
        {
