...
namespace AForge
{
    ...
    public struct Point
    {
        ...
        /// 
        static Point operator +( Point point, float valueToAdd )
        {
        ...
        /// the specified point increased by specified value.</returns>
        /// 
        static Point Add( Point point, float valueToAdd )
        {
            return new Point( point.X + valueToAdd, point.Y + valueToAdd );
        }
        ...
        /// 
        static Point operator -( Point point, float valueToSubtract )
        {
        ...
        /// the specified point decreased by specified value.</returns>
        /// 
        static Point Subtract( Point point, float valueToSubtract )
        {
            return new Point( point.X - valueToSubtract, point.Y - valueToSubtract );
        }
        ...
        ///
        static Point operator *( Point point, float factor )
        {
        ...
        /// the specified point multiplied by specified value.</returns>
        ///
        static Point Multiply( Point point, float factor )
        {
            return new Point( point.X * factor, point.Y * factor );
        }
        ...
        /// the specified point divided by specified value.</returns>
        /// 
        static Point Divide( Point point, float factor )
        {
            return new Point( point.X / factor, point.Y / factor );
        }
        ...
        /// 
        static explicit operator IPOINT( Point point )
        {
        ...
        /// 
        static implicit operator DoublePoint( Point point )
        {
