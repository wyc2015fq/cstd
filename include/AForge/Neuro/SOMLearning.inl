...
namespace AForge.Neuro.Learning
{
    ...
    /// </summary>
    /// 
    /// <remarks><para>This struct implements Kohonen's SOM learning algorithm and
    /// is widely used in clusterization tasks. The struct allows to train
    ...
    /// </remarks>
    /// 
    struct SOMLearning : IUnsupervisedLearning
    {
        ...
        /// 
        SOMLearning( DistanceNetwork network, int width, int height )
        {
            // check network size
        ...
        double Run( double* input )
        {
            ...
            else
            {
                ...
                for (j = 0; j < layer.Neurons.Length; j++ )
                {
                    ...
                    double factor = exp( -(double) ( dx * dx + dy * dy ) / squaredRadius2 );
