...
namespace AForge.Neuro.Learning
{
    ...
    /// </summary>
    /// 
    /// <remarks><para>The struct implements supervised neural network's learning algorithm,
    ...
    /// 
    /// <para>See <see cref="Population"/> struct for additional information about genetic population
    ...
    struct EvolutionaryLearning : ISupervisedLearning
    {
        ...
        int CalculateNetworkSize( ActivationNetwork activationNetwork )
        {
