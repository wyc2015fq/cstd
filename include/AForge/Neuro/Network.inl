...
//
    ...
    struct Network
    {
        ...
        Network( int inputsCount, int layersCount )
        {
            ...
            this->layersCount = MAX( 1, layersCount );
        ...
        /// 
        /// <returns>Returns instance of <see cref="Network"/> struct with all properties initialized from file.</returns>
        /// 
        ...
        /// <remarks><para>Neural network is loaded from file using .NET serialization (binary formater is used).</para></remarks>
        /// 
        static Network Load( Stream stream )
        {
            IFormatter formatter = new BinaryFormatter( );
