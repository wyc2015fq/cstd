...
//
    ...
    /// </summary>
    /// 
    /// <remarks><para>The struct implements back propagation learning algorithm,
    ...
    /// 
    struct BackPropagationLearning : ISupervisedLearning
    {
        // network to teach
        ...
        double Momentum
        {
            ...
            set
            {
                momentum = MAX( 0.0, MIN( 1.0, value ) );
            }
        }
        ...
        /// 
        BackPropagationLearning( ActivationNetwork network )
        {
        ...
        void CalculateUpdates( double* input )
        {
            ...
            for (i = 0; i < layer.Neurons.Length; i++ )
            {
                ...
                for (j = 0; j < neuronWeightUpdates.Length; j++ )
                {
