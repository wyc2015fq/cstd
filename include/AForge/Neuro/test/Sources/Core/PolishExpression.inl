...
namespace AForge
{
	...
	/// </summary>
	/// 
	/// <remarks>The struct evaluates expressions writen in postfix polish notation.
	...
	/// </example>
	/// 
	public struct PolishExpression
	{
		/// <summary>
		/// Constructor (the struct should not be instantiated at this moment)
		/// </summary>
