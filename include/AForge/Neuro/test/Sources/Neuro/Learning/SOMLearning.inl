...
namespace AForge.Neuro.Learning
{
	...
	/// </summary>
	/// 
	/// <remarks>This struct implements Kohonen's SOM learning algorithm and
	/// is widelí used in clusterization tasks. The struct allows to train
	/// <see cref="DistanceNetwork">Distance Networks</see>.</remarks>
	/// 
	public struct SOMLearning : IUnsupervisedLearning
	{
