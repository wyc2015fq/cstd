...
namespace AForge.Video.VFW
{
    ...
    internal static class Win32
    {
        ...
        /// 
        [DllImport( "avifil32.dll" )]
        static extern int AVIFileRelease(
            IntPtr aviHandler );
        ...
        /// 
        [DllImport( "avifil32.dll" )]
        static extern int AVIStreamRelease(
        ...
        /// 
        [DllImport( "avifil32.dll" )]
        static extern int AVIStreamSetFormat(
            IntPtr streamHandler,
            int position,
        ...
        /// 
        [DllImport( "avifil32.dll" )]
        static extern int AVIStreamStart(
            IntPtr streamHandler );
        ...
        /// 
        [DllImport( "avifil32.dll" )]
        static extern int AVIStreamLength(
            IntPtr streamHandler );
        ...
        /// 
        [DllImport( "avifil32.dll" )]
        static extern int AVIStreamWrite(
            IntPtr streamHandler,
            int start,
            int samples,
            IntPtr buffer,
        ...
        /// 
        [DllImport( "avifil32.dll" )]
        static extern int AVISaveOptions(
            IntPtr window,
            int flags,
            int streams,
        ...
        /// 
        [DllImport( "avifil32.dll" )]
        static extern int AVIMakeCompressedStream(
        ...
        /// 
        static string decode_mmioFOURCC( int code )
        {
            char[] chs = new char[4];
        ...
        /// <returns>Returns TRUE if the user pressed OK, FALSE for CANCEL, or an error otherwise.</returns>
        /// 
        static int AVISaveOptions( IntPtr stream, ref AVICOMPRESSOPTIONS options )
        {
