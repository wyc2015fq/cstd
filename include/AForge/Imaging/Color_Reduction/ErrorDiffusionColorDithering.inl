...
namespace AForge.Imaging.ColorReduction
{
    ...
    public abstract class ErrorDiffusionColorDithering
    {
        ...
        /// 
        protected abstract  void Diffuse( int rError, int gError, int bError, byte* ptr );
        ...
        {
            if ( ( sourceImage->t != PixelFormat_24bppRgb ) &&
                 ( sourceImage->t != PixelFormat_32bppRgb ) &&
                 ( sourceImage->t != PixelFormat_32bppArgb ) &&
                 ( sourceImage->t != PixelFormat_32bppPArgb ) )
            {
            ...
            stride = sourceImage->s;
            pixelSize = Bitmap.GetPixelFormatSize( sourceImage->t ) / 8;
            ...
            for (i = 0, n = colorTable.Length; i < n; i++ )
            {
