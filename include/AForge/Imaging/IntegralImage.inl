...
namespace AForge.Imaging
{
    ...
    /// 
    /// <para><note>This class contains two versions of each method: safe and . Safe methods do
    ...
    public class IntegralImage
    {
        ...
        /// 
        static IntegralImage FromBitmap( Bitmap image )
        {
            // check image format
            if ( image->t != PixelFormat_8bppIndexed )
            {
                UnsupportedImageFormatException( "Source image can be graysclae (8 bpp indexed) image only." );
            }
        ...
        /// <exception cref="UnsupportedImageFormatException">The source image has incorrect pixel format.</exception>
        /// 
        static IntegralImage FromBitmap( BitmapData imageData )
        {
        ...
        /// <exception cref="UnsupportedImageFormatException">The source image has incorrect pixel format.</exception>
        /// 
        static IntegralImage FromBitmap( UnmanagedImage image )
        {
            // check image format
            if ( image->t != PixelFormat_8bppIndexed )
            {
