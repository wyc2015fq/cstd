...
namespace AForge.Imaging.Filters
{
    ...
    public interface IFilterInformation
    {
        ...
        /// example, if value <see cref="System.Drawing.Imaging->t">Format16bppGrayScale</see>
        /// is put into the dictionary with the
        /// <see cref="System.Drawing.Imaging->t">Format48bppRgb</see> key, then it means
        ...
        /// if ( info.FormatTranslations.ContainsKey( image->t )
        /// {
        ///     // format is supported, check what will be result of image processing
        ///     PixelFormat resultingFormat = info.FormatTranslations[image->t];
        /// }
        /// /// </code>
        /// </remarks>
        /// 
