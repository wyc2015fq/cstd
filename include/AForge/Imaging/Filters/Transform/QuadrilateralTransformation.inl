...
namespace AForge.Imaging.Filters
{
    ...
    public class QuadrilateralTransformation : BaseTransformationFilter
    {
        ...
        private List<IPOINT> sourceQuadrilateral;
        ...
        /// </remarks>
        /// 
        public List<IPOINT> SourceQuadrilateral
        {
        ...
        /// 
        public QuadrilateralTransformation( List<IPOINT> sourceQuadrilateral, int newWidth, int newHeight )
            : this( )
        {
        ...
        ///
        public QuadrilateralTransformation( List<IPOINT> sourceQuadrilateral )
            : this( )
        {
        ...
        private void CalculateDestinationSize( )
        {
            ...
            newWidth  = (int) MAX( sourceQuadrilateral[0].DistanceTo( sourceQuadrilateral[1] ),
                                        sourceQuadrilateral[2].DistanceTo( sourceQuadrilateral[3] ) );
            newHeight = (int) MAX( sourceQuadrilateral[1].DistanceTo( sourceQuadrilateral[2] ),
        ...
        protected override  void ProcessFilter( UnmanagedImage sourceData, UnmanagedImage destinationData )
        {
            ...
            List<IPOINT> dstRect = new List<IPOINT>( );
            dstRect.Add( new IPOINT( 0, 0 ) );
            dstRect.Add( new IPOINT( dstWidth - 1, 0 ) );
            dstRect.Add( new IPOINT( dstWidth - 1, dstHeight - 1 ) );
            dstRect.Add( new IPOINT( 0, dstHeight - 1 ) );

            // calculate tranformation matrix
            double[,] matrix = QuadTransformationCalcs.MapQuadToQuad( dstRect, sourceQuadrilateral );

            // do the job
            byte* ptr = (byte*) destinationData->tt.data;
