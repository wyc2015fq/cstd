...
namespace AForge.Imaging.Filters
{
    ...
    public class QuadrilateralTransformationNearestNeighbor : BaseTransformationFilter
    {
        ...
        /// </remarks>
        /// 
        public List<IPOINT> SourceCorners
        {
        ...
        /// 
        public QuadrilateralTransformationNearestNeighbor( List<IPOINT> sourceCorners, int newWidth, int newHeight )
		{
        ...
        ///
        public QuadrilateralTransformationNearestNeighbor( List<IPOINT> sourceCorners ) 
        {
        ...
        protected override System.Drawing.Size CalculateNewImageSize( UnmanagedImage sourceData )
        {
            ...
            foreach ( IPOINT point in baseFilter.SourceQuadrilateral )
            {
                if ( ( point.X < 0 ) ||
                     ( point.Y < 0 ) ||
