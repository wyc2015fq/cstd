...
namespace AForge.Imaging.Filters
{
    ...
    public class SimpleQuadrilateralTransformation : BaseTransformationFilter
    {
        ...
        /// 
        public SimpleQuadrilateralTransformation( List<IPOINT> sourceQuadrilateral, int newWidth, int newHeight )
            : this( )
        {
        ...
        ///
        public SimpleQuadrilateralTransformation( List<IPOINT> sourceQuadrilateral )
            : this( )
        {
