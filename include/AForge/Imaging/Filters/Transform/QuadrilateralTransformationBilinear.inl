...
namespace AForge.Imaging.Filters
{
    ...
    public class QuadrilateralTransformationBilinear : BaseTransformationFilter
    {
        ...
        /// 
        public QuadrilateralTransformationBilinear( List<IPOINT> sourceCorners, int newWidth, int newHeight )
		{
        ...
        ///
        public QuadrilateralTransformationBilinear( List<IPOINT> sourceCorners )
        {
