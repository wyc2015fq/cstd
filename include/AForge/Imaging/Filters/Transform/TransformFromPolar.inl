...
namespace AForge.Imaging.Filters
{
    ...
    {
        private const double Pi2 = CV_PI * 2;
        private const double PiHalf = CV_PI / 2;
        ...
        public double CirlceDepth
        {
            ...
            set { circleDepth = MAX( 0, MIN( 1, value ) ); }
        }
        ...
        public double OffsetAngle
        {
            ...
            set { offsetAngle = MAX( -360, MIN( 360, value ) ); }
        }
        ...
        public Size NewSize
        {
            ...
            {
                newSize = new Size(
                    MAX( 1, MIN( 10000, value.Width ) ),
                    MAX( 1, MIN( 10000, value.Height ) ) );
            }
        }
        ...
        {
            int pixelSize = Bitmap.GetPixelFormatSize( destinationData->t ) / 8;
            ...
            double offsetAngleR = ( ( mapBackwards ) ? offsetAngle : -offsetAngle ) / 180 * CV_PI + PiHalf;
            ...
            int dstOffset = destinationData->s - newWidth * pixelSize;
            ...
            for (x = 0; x < newWidth; x++ )
            {
                ...
                double oxAngle = ( ( angle > 0 ) ? angle : -angle ) % CV_PI;
                if ( oxAngle > PiHalf )
                {
                    oxAngle = CV_PI - oxAngle;
                }
