...
namespace AForge.Imaging.Filters
{
    ...
    public class CanvasFill : BaseInPlaceFilter
    {
        ...
        {
            get { return Color_rgb( fillRed, fillGreen, fillBlue ); }
            set
            {
                fillRed = value.R;
                fillGreen = value.G;
        ...
        protected override  void ProcessFilter( UnmanagedImage image )
        {
            ...
            int startX = MAX( 0, region.X );
            int startY = MAX( 0, region.Y );
            ...
            int stopX = MIN( width, region.Right );
            int stopY = MIN( height, region.Bottom );
