...
namespace AForge.Imaging.Filters
{
    ...
    public class WaterWave : BaseFilter
    {
        ...
        public int HorizontalWavesCount
        {
            ...
            set { xWavesCount = MAX( 1, MIN( 10000, value ) ); }
        }
        ...
        public int VerticalWavesCount
        {
            ...
            set { yWavesCount = MAX( 1, MIN( 10000, value ) ); }
        }
        ...
        public int HorizontalWavesAmplitude
        {
            ...
            set { xWavesAmplitude = MAX( 0, MIN( 10000, value ) ); }
        }
        ...
        public int VerticalWavesAmplitude
        {
            ...
            set { yWavesAmplitude = MAX( 0, MIN( 10000, value ) ); }
        }
        ...
        protected override  void ProcessFilter( UnmanagedImage source, UnmanagedImage destination )
        {
            ...
            double xFactor = 2 * CV_PI * xWavesCount / width;
            double yFactor = 2 * CV_PI * yWavesCount / height;
