...
namespace AForge.Imaging.Filters
{
    ...
    public class ApplyMask : BaseInPlacePartialFilter
    {
        ...
        private ApplyMask( )
        {
            ...
            formatTranslations[PixelFormat_64bppPArgb]     = PixelFormat_64bppPArgb;
        }
            ...
            if ( ( pixelSize <= 4 ) && ( pixelSize != 2 ) )
            {
                ...
                switch ( pixelSize )
                {
                    case 1:
                        ...
                        {
                            for (x = startX; x < stopX; x++, imagePtr++, mask++ )
                            {
                                if ( *mask == 0 )
                                {
                                    *imagePtr = 0;
                    ...
                    case 3:
                        ...
                        for (y = startY; y < stopY; y++ )
                        {
                            for (x = startX; x < stopX; x++, imagePtr += 3, mask++ )
                            {
                                if ( *mask == 0 )
                                {
                                    imagePtr[RGB_R] = 0;
                    ...
                    case 4:
                        ...
                        for (y = startY; y < stopY; y++ )
                        {
                            for (x = startX; x < stopX; x++, imagePtr += 4, mask++ )
                            {
                                if ( *mask == 0 )
                                {
                                    imagePtr[RGB_R] = 0;
