...
namespace AForge.Imaging.Filters
{
    ...
    public class Pixellate : BaseInPlacePartialFilter
    {
        ...
        public int PixelWidth
        {
            ...
            set { pixelWidth = MAX( 2, MIN( 32, value ) ); }
        }
        ...
        public int PixelHeight
        {
            ...
            set { pixelHeight = MAX( 2, MIN( 32, value ) ); }
        }
        ...
        {
            set { pixelWidth = pixelHeight = MAX( 2, MIN( 32, value ) ); }
        }
        ...
        protected override  void ProcessFilter( UnmanagedImage image, Rectangle rect )
        {
            ...
            src += ( startY * image->s + rect.Left * pixelSize );
            ...
            if ( image->t == PixelFormat_8bppIndexed )
            {
                ...
                for (y1 = startY, y2 = startY; y1 < stopY; )
                {
                    // collect pixels
            ...
            else
            {
                ...
                for (y1 = startY, y2 = startY; y1 < stopY; )
                {
                    ...
                    for (i = 0; ( i < pixelHeight ) && ( y2 < stopY ); i++, y2++ )
                    {
                        ...
                        {
                            k = ( x / pixelWidth ) * 3;
                            dst[RGB_R] = (byte) tmp[k];
                            dst[RGB_G] = (byte) tmp[k + 1];
                            dst[RGB_B] = (byte) tmp[k + 2];
                        }
                        dst += offset;
                    }
                }
