    ...
    public class IterativeThreshold : Threshold
    {
        ...
        public int CalculateThreshold( UnmanagedImage image, Rectangle rect )
        {
            if ( ( image->t != PixelFormat_8bppIndexed ) &&
                ...
                UnsupportedImageFormatException( "Source pixel format is not supported by the routine." );
            ...
            
            {
                ...
                else
                {
                    ...
                    // collect histogram first
                    byte* basePtr = (byte*) image->tt.data + startX * 2;
                    int stride = image->s;
            ...
            while ( fabs( oldThreshold - calculatedThreshold ) > minError );
