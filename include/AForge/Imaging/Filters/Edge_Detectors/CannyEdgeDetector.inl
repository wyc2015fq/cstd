...
namespace AForge.Imaging.Filters
{
    ...
    public class CannyEdgeDetector : BaseUsingCopyPartialFilter
    {
        ...
        protected override  void ProcessFilter( UnmanagedImage source, UnmanagedImage destination, Rectangle rect )
        {
            ...
            int gx, gy;
            //
            double orientation, toAngle = 180.0 / CV_PI;
            ...
            // do the job
            byte* src = (byte*) blurredImage->tt.data;
            // allign pointer
            ...
            for (y = startY; y < stopY; y++ )
            {
                ...
                for (x = startX; x < stopX; x++, src++, p++ )
                {
                    ...
                    // get gradient value
                    gradients[x, y] = (float) sqrt( gx * gx + gy * gy );
