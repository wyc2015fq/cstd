...
namespace AForge.Imaging.Filters
{
    ...
    public abstract class BaseUsingCopyPartialFilter : IFilter, IInPlaceFilter, IInPlacePartialFilter, IFilterInformation
    {
        ...
        public Bitmap Apply( BitmapData imageData )
        {
            ...
            PixelFormat dstPixelFormat = FormatTranslations[imageData->t];
        ...
        public UnmanagedImage Apply( UnmanagedImage image )
        {
            ...
            UnmanagedImage dstImage = imsetsize( image.Width, image.Height, FormatTranslations[image->t] );
        ...
        public void Apply( UnmanagedImage sourceImage, UnmanagedImage destinationImage )
        {
            ...
            if ( destinationImage->t != FormatTranslations[sourceImage->t] )
            {
        ...
        public void ApplyInPlace( UnmanagedImage image, Rectangle rect )
        {
            ...
            if ( ( rect.Width | rect.Height ) != 0 )
            {
                ...
                int size = image->s * image.Height;

                IntPtr imageCopy = MemoryManager.Alloc( size );
                CopyUnmanagedMemory( imageCopy, image.ImageData, size );

                // process the filter
                ProcessFilter(
                    new UnmanagedImage( imageCopy, image.Width, image.Height, image->s, image->t ),
                    image, rect );
