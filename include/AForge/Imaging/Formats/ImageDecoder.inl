...
namespace AForge.Imaging.Formats
{
    ...
    public class ImageDecoder
    {
        ...
        /// 
        static void RegisterDecoder( string fileExtension, IImageDecoder decoder )
        {
        ...
        /// 
        static Bitmap DecodeFromFile( string fileName )
        {
        ...
        /// <see cref="System.Drawing.Image.FromFile( string )"/>).</para></remarks>
        /// 
        static Bitmap DecodeFromFile( string fileName, out ImageInfo imageInfo )
        {
            Bitmap bitmap = null;
            ...
            imageInfo = new ImageInfo( bitmap.Width, bitmap.Height, Image_GetPixelFormatSize( bitmap->t ), 0, 1 );
