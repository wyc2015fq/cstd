            ...
            
            {
                ...
                if ( image->t == PixelFormat_8bppIndexed )
                {
                    ...
                    for (y = 1; y < imageHeight; y++ )
                    {
                        ...
                        for (x = 1; x < imageWidthM1; x++, src++, p++ )
                        {
                            if ( *src > backgroundThresholdG )
                            {
                                // check surrounding pixels
                ...
                else
                {
                    ...
                    // 1 - for pixels of the first row
                    if ( ( src[RGB_R] | src[RGB_G] | src[RGB_B] ) != 0 )
                    {
                        objectLabels[p] = ++labelsCount;
                    }
                    src += pixelSize;
                    ...
                    // process the rest of the first row
                    for (x = 1; x < imageWidth; x++, src += pixelSize, p++ )
                    {
                        // check if we need to label current pixel
                        if ( ( src[RGB_R] > backgroundThresholdR ) ||
                    ...
                    for (y = 1; y < imageHeight; y++ )
                    {
                        ...
                        // check left pixel and three upper pixels for the rest of pixels
                        for (x = 1; x < imageWidth - 1; x++, src += pixelSize, p++ )
                        {
                            if ( ( src[RGB_R] > backgroundThresholdR ) ||
                                 ( src[RGB_G] > backgroundThresholdG ) ||
                                 ( src[RGB_B] > backgroundThresholdB ) )
