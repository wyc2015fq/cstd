...
namespace AForge.Imaging
{
    ...
    public interface IBlockMatching
    {
        ...
        /// 
        List<BlockMatch> ProcessImage( Bitmap sourceImage, List<IPOINT> coordinates, Bitmap searchImage );
        ...
        /// <returns>Returns list of found block matches.</returns>
        /// 
        List<BlockMatch> ProcessImage( BitmapData sourceImageData, List<IPOINT> coordinates, BitmapData searchImageData );
        ...
        /// <returns>Returns list of found block matches.</returns>
        /// 
        List<BlockMatch> ProcessImage( UnmanagedImage sourceImage, List<IPOINT> coordinates, UnmanagedImage searchImage );
    }
}
