...
namespace AForge.Imaging
{
    ...
    /// <para><note><see cref="System.Drawing.Imaging->t">PixelFormat_24bppRgb</see>
    ...
    public class RGB
    {
        ...
        {
            get { return Color_rgb( Alpha, Red, Green, Blue ); }
            set
            {
                Red   = value.R;
                Green = value.G;
    ...
    public class HSL
    {
        ...
        /// 
        static void FromRGB( RGB rgb, HSL hsl )
        {
        ...
        /// 
        static void ToRGB( HSL hsl, RGB rgb )
        {
            if ( hsl.Saturation == 0 )
            {
                // gray values
    ...
    public class YCbCr
    {
        ...
        {
            this.Y  = MAX(  0.0f, MIN( 1.0f, y ) );
            this.Cb = MAX( -0.5f, MIN( 0.5f, cb ) );
            this.Cr = MAX( -0.5f, MIN( 0.5f, cr ) );
        }
        ...
        /// 
        static void FromRGB( RGB rgb, YCbCr ycbcr )
        {
        ...
        /// 
        static void ToRGB( YCbCr ycbcr, RGB rgb )
        {
