    ...
    static class MemoryManager
    {
        ...
        static int MaximumCacheSize
        {
            ...
            set
            {
                lock ( memoryBlocks )
                {
                    maximumCacheSize = MAX( 0, MIN( 10, value ) );
                }
            }
        }
        ...
        /// 
        static void Free( IntPtr pointer )
        {
            lock ( memoryBlocks )
            {
        ...
        static int FreeUnusedMemory( )
        {
            lock ( memoryBlocks )
            {
                ...
                for (i = currentCacheSize - 1; i >= 0; i-- )
                {
