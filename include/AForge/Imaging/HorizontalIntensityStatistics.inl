    ...
    public class HorizontalIntensityStatistics
    {
        ...
        public HorizontalIntensityStatistics( Bitmap image )
        {
            ...
            if (
                ...
                ( image->t != PixelFormat_16bppGrayScale ) &&
                ( image->t != PixelFormat_24bppRgb ) &&
                ( image->t != PixelFormat_32bppRgb ) &&
                ( image->t != PixelFormat_32bppArgb ) &&
                ( image->t != PixelFormat_48bppRgb ) &&
                ( image->t != PixelFormat_64bppArgb )
                )
            {
        ...
        private void ProcessImage( UnmanagedImage image )
        {
            ...
            
            {
                ...
                else if ( pixelFormat == PixelFormat_16bppGrayScale )
                {
                    ...
                    ( pixelFormat == PixelFormat_32bppArgb ) )
                {
                    ...
                    byte* p = (byte*) image->tt.data;
                    int pixelSize = ( pixelFormat == PixelFormat_24bppRgb ) ? 3 : 4;
                    ...
                    ( pixelFormat == PixelFormat_48bppRgb ) ||
                    ( pixelFormat == PixelFormat_64bppArgb ) )
                {
                    // 48/64 bpp color image
                    byte* basePtr = (byte*) image->tt.data;
                    int stride = image->s;
                    int pixelSize = ( pixelFormat == PixelFormat_48bppRgb ) ? 3 : 4;
