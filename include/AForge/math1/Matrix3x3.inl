...
namespace AForge.Math
{
    ...
    public struct Matrix3x3
    {
        ...
        /// float yaw   = 10.0f / 180 * CV_PI;
        /// float pitch = 30.0f / 180 * CV_PI;
        /// float roll  = 45.0f / 180 * CV_PI;
        /// 
        ...
        /// 
        static Matrix3x3 CreateFromRows( Vector3 row0, Vector3 row1, Vector3 row2 )
        {
            Matrix3x3 m = new Matrix3x3( );
        ...
        /// 
        static Matrix3x3 CreateFromColumns( Vector3 column0, Vector3 column1, Vector3 column2 )
        {
            Matrix3x3 m = new Matrix3x3( );
        ...
        /// 
        static Matrix3x3 CreateDiagonal( Vector3 vector )
        {
            Matrix3x3 m = new Matrix3x3( );
        ...
        /// 
        static Matrix3x3 operator *( Matrix3x3 matrix1, Matrix3x3 matrix2 )
        {
            Matrix3x3 m = new Matrix3x3( );
        ...
        ///
        static Vector3 operator *( Matrix3x3 matrix, Vector3 vector )
        {
            return new Vector3(
        ...
        /// by the specified vector.</returns>
        ///
        static Vector3 Multiply( Matrix3x3 matrix, Vector3 vector )
        {
        ...
        /// 
        static Matrix3x3 operator *( Matrix3x3 matrix, float factor )
        {
            Matrix3x3 m = new Matrix3x3( );
        ...
        /// specified matrix multiples by the specified factor.</returns>
        /// 
        static Matrix3x3 Multiply( Matrix3x3 matrix, float factor )
        {
        ...
        /// 
        static Matrix3x3 operator +( Matrix3x3 matrix, float value )
        {
            Matrix3x3 m = new Matrix3x3( );
        ...
        /// specified matrix increased by the specified value.</returns>
        /// 
        static Matrix3x3 Add( Matrix3x3 matrix, float value )
        {
            return matrix + value;
        }
        ...
        /// 
        static bool operator ==( Matrix3x3 matrix1, Matrix3x3 matrix2 )
        {
            return (
