...
namespace AForge.Math
{
    ...
    public struct Vector3
    {
        ...
        ///
        static Vector3 operator +( Vector3 vector1, Vector3 vector2 )
        {
        ...
        /// 
        static Vector3 operator +( Vector3 vector, float value )
        {
        ...
        /// <returns>Returns new vector with all coordinates increased by the specified value.</returns>
        /// 
        static Vector3 Add( Vector3 vector, float value )
        {
            return vector + value;
        }
        ...
        /// <returns>Returns new vector with all coordinates decreased by the specified value.</returns>
        /// 
        static Vector3 Subtract( Vector3 vector, float value )
        {
            return vector - value;
        }
        ...
        /// coordinates of the two specified vectors.</returns>
        ///
        static Vector3 Multiply( Vector3 vector1, Vector3 vector2 )
        {
            return vector1 * vector2;
        }
        ...
        ///
        static Vector3 operator *( Vector3 vector, float factor )
        {
        ...
        /// <returns>Returns new vector with all coordinates multiplied by the specified factor.</returns>
        ///
        static Vector3 Multiply( Vector3 vector, float factor )
        {
        ...
        /// corresponding coordinates of the second vector.</returns>
        ///
        static Vector3 Divide( Vector3 vector1, Vector3 vector2 )
        {
            return vector1 / vector2;
        }
        ...
        /// <returns>Returns new vector with all coordinates divided by the specified factor.</returns>
        ///
        static Vector3 Divide( Vector3 vector, float factor )
        {
            return vector / factor;
        }
        ...
        /// 
        static bool operator ==( Vector3 vector1, Vector3 vector2 )
        {
        ...
        public Vector3 Abs( )
        {
            return new Vector3( fabs( X ), fabs( Y ), fabs( Z ) );
        }
