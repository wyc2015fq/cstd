...
namespace AForge.Math
{
    ...
    public struct Complex : ICloneable, ISerializable
    {
        ...
        /// </summary>
        static readonly Complex Zero = new Complex( 0, 0 );

        /// <summary>
        ///  A double-precision complex number that represents one.
        /// </summary>
        static readonly Complex One = new Complex( 1, 0 );
        ...
        /// 
        static Complex Add( Complex a, double s )
        {
        ...
        /// 
        static void Add( Complex a, Complex b, ref Complex result )
        {
            result.Re = a.Re + b.Re;
            result.Im = a.Im + b.Im;
        }
        ...
        /// <param name="result">A <see cref="Complex"/> instance to hold the result.</param>
        /// 
        static void Add( Complex a, double s, ref Complex result )
        {
            result.Re = a.Re + s;
            result.Im = a.Im;
        }
        ...
        /// 
        static Complex Subtract( Complex a, double s )
        {
            return new Complex( a.Re - s, a.Im );
        }
        ...
        /// 
        static Complex Subtract( double s, Complex a )
        {
        ...
        /// <param name="result">A <see cref="Complex"/> instance to hold the result.</param>
        /// 
        static void Subtract( Complex a, Complex b, ref Complex result )
        {
            result.Re = a.Re - b.Re;
            result.Im = a.Im - b.Im;
        }
        ...
        /// <param name="result">A <see cref="Complex"/> instance to hold the result.</param>
        /// 
        static void Subtract( Complex a, double s, ref Complex result )
        {
            result.Re = a.Re - s;
            result.Im = a.Im;
        }
        ...
        /// <param name="result">A <see cref="Complex"/> instance to hold the result.</param>
        /// 
        static void Subtract( double s, Complex a, ref Complex result )
        {
            result.Re = s - a.Re;
            result.Im = a.Im;
        }
        ...
        /// <returns>Returns new <see cref="Complex"/> instance containing the result of multiplication.</returns>
        /// 
        static Complex Multiply( Complex a, double s )
        {
        ...
        /// <param name="result">A <see cref="Complex"/> instance to hold the result.</param>
        /// 
        static void Multiply( Complex a, Complex b, ref Complex result )
        {
            // (x + yi)(u + vi) = (xu – yv) + (xv + yu)i. 
            double aRe = a.Re, aIm = a.Im;
            double bRe = b.Re, bIm = b.Im;
        ...
        /// <param name="result">A <see cref="Complex"/> instance to hold the result.</param>
        /// 
        static void Multiply( Complex a, double s, ref Complex result )
        {
            result.Re = a.Re * s;
            result.Im = a.Im * s;
        }
        ...
        /// <exception cref="DivideByZeroException">Can not divide by zero.</exception>
        /// 
        static Complex Divide( Complex a, double s )
        {
            if ( s == 0 )
            {
                throw new DivideByZeroException( "Can not divide by zero." );
        ...
        /// <exception cref="DivideByZeroException">Can not divide by zero.</exception>
        /// 
        static Complex Divide( double s, Complex a )
        {
            if ( ( a.Re == 0 ) || ( a.Im == 0 ) )
            {
                throw new DivideByZeroException( "Can not divide by zero." );
        ...
        /// <exception cref="DivideByZeroException">Can not divide by zero.</exception>
        /// 
        static void Divide( Complex a, Complex b, ref Complex result )
        {
            double aRe = a.Re, aIm = a.Im;
            double bRe = b.Re, bIm = b.Im;
            double modulusSquared = bRe * bRe + bIm * bIm;
        ...
        /// <exception cref="DivideByZeroException">Can not divide by zero.</exception>
        /// 
        static void Divide( Complex a, double s, ref Complex result )
        {
            if ( s == 0 )
            {
                throw new DivideByZeroException( "Can not divide by zero." );
        ...
        /// <exception cref="DivideByZeroException">Can not divide by zero.</exception>
        /// 
        static void Divide( double s, Complex a, ref Complex result )
        {
            if ( ( a.Re == 0 ) || ( a.Im == 0 ) )
            {
                throw new DivideByZeroException( "Can not divide by zero." );
        ...
        /// 
        static bool ApproxEqual( Complex a, Complex b )
        {
        ...
        /// <remarks><para>The default tolerance value, which is used for the test, equals to 8.8817841970012523233891E-16.</para></remarks>
        /// 
        static bool ApproxEqual( Complex a, Complex b, double tolerance )
        {
            return
                (
                ( fabs( a.Re - b.Re ) <= tolerance ) &&
                ( fabs( a.Im - b.Im ) <= tolerance )
                );
        }
        ...
        static Complex Sqrt( Complex a )
        {
            ...
            {
                result.Re = ( a.Re > 0 ) ? sqrt( a.Re ) : sqrt( -a.Re );
                result.Im = 0.0;
            }
            else
            {
                ...
                result.Re = sqrt( 0.5 * ( modulus + a.Re ) );
                result.Im = sqrt( 0.5 * ( modulus - a.Re ) );
                if ( a.Im < 0.0 )
                    result.Im = -result.Im;
            }
        ...
        static Complex Exp( Complex a )
        {
            Complex result = Complex.Zero;
            double r = exp( a.Re );
            result.Re = r * cos( a.Im );
            result.Im = r * sin( a.Im );
        ...
        static Complex Tan( Complex a )
        {
            ...
            else
            {
                double real2 = 2 * a.Re;
                double imag2 = 2 * a.Im;
                double denom = cos( real2 ) + cosh( real2 );

                result.Re = sin( real2 ) / denom;
                result.Im = sinh( imag2 ) / denom;
            }
        ...
        /// 
        static bool operator ==( Complex u, Complex v )
        {
        ...
        /// <returns>Returns new <see cref="Complex"/> instance containing the sum.</returns>
        /// 
        static Complex operator +( Complex a, double s )
        {
        ...
        /// <returns>Returns new <see cref="Complex"/> instance containing the sum.</returns>
        /// 
        static Complex operator +( double s, Complex a )
        {
            return Complex.Add( a, s );
        }
        ...
        /// 
        static explicit operator Complex( float value )
        {
        ...
        /// real part initialized to the specified value.</returns>
        /// 
        static explicit operator Complex( double value )
        {
