...
namespace AForge.Math
{
    ...
    public struct Vector4
    {
        ...
        public float Norm
        {
            get { return (float) sqrt( X * X + Y * Y + Z * Z + W * W ); }
        }
        ...
        ///
        static Vector4 operator +( Vector4 vector1, Vector4 vector2 )
        {
        ...
        /// 
        static Vector4 operator +( Vector4 vector, float value )
        {
        ...
        /// <returns>Returns new vector with all coordinates increased by the specified value.</returns>
        /// 
        static Vector4 Add( Vector4 vector, float value )
        {
            return vector + value;
        }
        ...
        /// coordinates of the two specified vectors.</returns>
        ///
        static Vector4 Subtract( Vector4 vector1, Vector4 vector2 )
        {
            return vector1 - vector2;
        }
        ...
        /// <returns>Returns new vector with all coordinates decreased by the specified value.</returns>
        /// 
        static Vector4 Subtract( Vector4 vector, float value )
        {
            return vector - value;
        }
        ...
        /// coordinates of the two specified vectors.</returns>
        ///
        static Vector4 Multiply( Vector4 vector1, Vector4 vector2 )
        {
            return vector1 * vector2;
        }
        ...
        ///
        static Vector4 operator *( Vector4 vector, float factor )
        {
        ...
        /// <returns>Returns new vector with all coordinates multiplied by the specified factor.</returns>
        ///
        static Vector4 Multiply( Vector4 vector, float factor )
        {
        ...
        /// <returns>Returns new vector with all coordinates divided by the specified factor.</returns>
        ///
        static Vector4 Divide( Vector4 vector, float factor )
        {
            return vector / factor;
        }
        ...
        /// 
        static bool operator ==( Vector4 vector1, Vector4 vector2 )
        {
        ...
        public Vector4 Abs( )
        {
            return new Vector4( fabs( X ), fabs( Y ), fabs( Z ), fabs( W ) );
        }
