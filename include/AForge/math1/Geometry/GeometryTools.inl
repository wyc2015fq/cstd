...
namespace AForge.Math.Geometry
{
    ...
    static class GeometryTools
    {
        ...
        /// 
        static float GetAngleBetweenVectors( Point startPoint, Point vector1end, Point vector2end )
        {
            ...
            return (float) ( Math.Acos( ( x1 * x2 + y1 * y2 ) / ( sqrt( x1 * x1 + y1 * y1 ) * sqrt( x2 * x2 + y2 * y2 ) ) ) * 180.0 / CV_PI );
        }
        ...
        /// 
        static float GetAngleBetweenLines( Point a1, Point a2, Point b1, Point b2 )
        {
