...
namespace AForge.Math.Geometry
{
    ...
    public class LineStraighteningOptimizer : IShapeOptimizer
    {
        ...
        public float MaxDistanceToRemove
        {
            ...
            set { maxDistanceToRemove = MAX( 0, value ); }
        }
        ...
        /// 
        public List<IPOINT> OptimizeShape( List<IPOINT> shape )
        {
            // optimized shape
            List<IPOINT> optimizedShape = new List<IPOINT>( );
            // list of recently removed points
            List<IPOINT> recentlyRemovedPoints = new List<IPOINT>( );
