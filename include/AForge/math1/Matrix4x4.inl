...
namespace AForge.Math
{
    ...
    public struct Matrix4x4
    {
        ...
        /// 
        static Matrix4x4 CreateFromRotation( Matrix3x3 rotationMatrix )
        {
            Matrix4x4 m = Matrix4x4.Identity;
        ...
        /// 
        static Matrix4x4 CreateLookAt( Vector3 cameraPosition, Vector3 cameraTarget )
        {
            Matrix4x4 m = new Matrix4x4( );
        ...
        /// 
        static Matrix4x4 CreateFromRows( Vector4 row0, Vector4 row1, Vector4 row2, Vector4 row3 )
        {
            Matrix4x4 m = new Matrix4x4( );
        ...
        /// 
        static Matrix4x4 CreateFromColumns( Vector4 column0, Vector4 column1, Vector4 column2, Vector4 column3 )
        {
            Matrix4x4 m = new Matrix4x4( );
        ...
        /// 
        static Matrix4x4 CreateDiagonal( Vector4 vector )
        {
            Matrix4x4 m = new Matrix4x4( );
        ...
        /// 
        static Matrix4x4 operator *( Matrix4x4 matrix1, Matrix4x4 matrix2 )
        {
            Matrix4x4 m = new Matrix4x4( );
        ...
        ///
        static Vector4 operator *( Matrix4x4 matrix, Vector4 vector )
        {
            return new Vector4(
        ...
        /// 
        static bool operator ==( Matrix4x4 matrix1, Matrix4x4 matrix2 )
        {
            return (
