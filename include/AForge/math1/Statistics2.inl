...
namespace AForge.Math
{
    ...
    static class Statistics
    {
        ...
        /// </remarks>
        /// 
        static double StdDev( int[] values )
        {
        ...
        /// </remarks>
        /// 
        static double StdDev( int[] values, double mean )
        {
            double  stddev = 0;
            double  diff;
            int     hits;
            ...
            return ( total == 0 ) ? 0 : sqrt( stddev / total );
        }
        ...
        /// </remarks>
        /// 
        static IntRange GetRange( int[] values, double percent )
        {
            int total = 0, n = values.Length;
