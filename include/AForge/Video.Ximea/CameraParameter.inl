...
namespace AForge.Video.Ximea
{
    ...
    static class CameraParameter
    {
        ...
        /// </summary>
        /// 
        static class ColorCorrectionMatrix
        {
            /// <summary>
