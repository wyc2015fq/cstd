...
namespace AForge.Video.DirectShow.Internals
{
    ...
    internal static class Tools
    {
        ...
        /// 
        static IPin GetPin( IBaseFilter filter, PinDirection dir, int num )
        {
            IPin[] pin = new IPin[1];
        ...
        /// <returns>Returns filter's pin.</returns>
        /// 
        static IPin GetInPin( IBaseFilter filter, int num )
        {
        ...
        /// <returns>Returns filter's pin.</returns>
        /// 
        static IPin GetOutPin( IBaseFilter filter, int num )
        {
