...
namespace AForge.Controls
{
    ...
    public class HuePicker : System.Windows.Forms.Control
    {
        ...
        protected override void OnPaint( PaintEventArgs pe )
        {
            ...
            // get pie rectangle
            rcPie = new Rectangle( 4, 4, MIN( rc.Right, rc.Bottom ) - 8, MIN( rc.Right, rc.Bottom ) - 8 );
            ...
            else
            {
                ...
                for (i = 0; i < 360; i++ )
                {
                    ...
                    {
                        brush = new SolidBrush( Color_rgb( 128, 128, 128 ) );
                    }
        ...
        private void HSLPicker_MouseMove( object sender, System.Windows.Forms.MouseEventArgs e )
        {
            ...
            if ( trackMode != 0 )
            {
                ...
                if ( trackMode == 1 )
                {
                    ...
                    min = (int) ( Math.Atan2( -dy, dx ) * 180 / CV_PI );
                    if ( min < 0 )
                    {
                        min = 360 + min;
                    }
                ...
                else
                {
                    ...
                    max = (int) ( Math.Atan2( -dy, dx ) * 180 / CV_PI );
                    if ( max < 0 )
                    {
                        max = 360 + max;
                    }
