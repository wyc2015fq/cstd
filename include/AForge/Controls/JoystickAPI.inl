...
namespace AForge.Controls
{
    internal static class JoystickAPI
    {
        ...
        [DllImport( "winmm.dll" )]
        static extern ResultCode joyGetDevCapsW( int uJoyID,
            [In, Out, MarshalAs( UnmanagedType.LPStruct )] JOYCAPS pjc, int cbjc );

        [DllImport( "winmm.dll" )]
        static extern ResultCode joyGetPos( int uJoyID, JOYINFO pji );

        [DllImport( "winmm.dll" )]
        static extern ResultCode joyGetPosEx( int uJoyID, JOYINFOEX pji );

        [DllImport( "winmm.dll" )]
        static extern ResultCode joyReleaseCapture( int uJoyID );

        [DllImport( "winmm.dll" )]
        static extern ResultCode joySetCapture( IntPtr hwnd, int uJoyID, int uPeriod, bool fChanged );
