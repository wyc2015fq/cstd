...
namespace AForge.Vision.Motion
{
    ...
    public class GridMotionAreaProcessing : IMotionProcessing
    {
        ...
        {
            this.gridWidth  = MIN( 64, MAX( 2, gridWidth ) );
            this.gridHeight = MIN( 64, MAX( 2, gridHeight ) );
