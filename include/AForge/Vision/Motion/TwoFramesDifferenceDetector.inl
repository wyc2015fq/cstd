        ...
        public  void ProcessFrame( UnmanagedImage videoFrame )
        {
            lock ( sync )
            {
                ...
                if ( previousFrame == null )
                {
                    ...
                    previousFrame = imsetsize( width, height, PixelFormat_8bppIndexed );
                ...
                byte* prevFrame = (byte*) previousFrame->tt.data;
                byte* currFrame = (byte*) motionFrame->tt.data;
                // difference value
                int diff;
                ...
                for (i = 0; i < frameSize; i++, prevFrame++, currFrame++ )
                {
                    // difference
