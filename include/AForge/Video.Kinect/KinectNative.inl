...
namespace AForge.Video.Kinect
{
    ...
    internal static class KinectNative
    {
        ...
        static extern int freenect_init( ref IntPtr context, IntPtr freenectUSBContext );
        ...
        static int freenect_process_events( IntPtr context )
        {
            lock ( sync )
            {
        ...
        static int freenect_process_events_timeout0( IntPtr context )
        {
            lock ( sync )
            {
        ...
        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern void freenect_set_log_level( IntPtr context, LogLevelOptions level );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern void freenect_set_log_callback( IntPtr context, FreenectLogCallback callback );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern int freenect_shutdown( IntPtr context );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern int freenect_num_devices( IntPtr context );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern int freenect_open_device( IntPtr context, ref IntPtr device, int index );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern int freenect_close_device( IntPtr device );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        [return: MarshalAs( UnmanagedType.Struct )]
        static extern BitmapInfoHeader freenect_find_video_mode( CameraResolution resolution, VideoCameraFormat videoFormat );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern int freenect_set_video_mode( IntPtr device, [In, MarshalAs( UnmanagedType.Struct )] BitmapInfoHeader infoHeader );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern int freenect_set_video_buffer( IntPtr device, IntPtr buffer );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern void freenect_set_video_callback( IntPtr device, FreenectVideoDataCallback callback );
        ...
        static int freenect_start_video( IntPtr device )
        {
            lock ( sync )
            {
        ...
        static int freenect_stop_video( IntPtr device )
        {
            lock ( sync )
            {
        ...
        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        [return: MarshalAs( UnmanagedType.Struct )]
        static extern BitmapInfoHeader freenect_find_depth_mode( CameraResolution resolution, DepthCameraFormat depthFormat );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern int freenect_set_depth_mode( IntPtr device, BitmapInfoHeader infoHeader );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern int freenect_set_depth_buffer( IntPtr device, IntPtr buffer );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern void freenect_set_depth_callback( IntPtr device, FreenectDepthDataCallback callback );
        ...
        static int freenect_start_depth( IntPtr device )
        {
            lock ( sync )
            {
        ...
        static int freenect_stop_depth( IntPtr device )
        {
            lock ( sync )
            {
        ...
        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern int freenect_set_led( IntPtr device, LedColorOption option );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern int freenect_update_tilt_state( IntPtr device );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern IntPtr freenect_get_tilt_state( IntPtr device );

        [DllImport( "freenect", CallingConvention = CallingConvention.Cdecl )]
        static extern int freenect_set_tilt_degs( IntPtr device, double angle );
        ...
        static event ErrorHandler OnError;
    }
}
