        ...
        private void HandleDataReceived( IntPtr device, IntPtr depthData, UInt32 timestamp )
        {
            ...
            try
            {
                image = new Bitmap( width, height, ( !provideOriginalDepthImage ) ?
                    PixelFormat_24bppRgb : PixelFormat_16bppGrayScale );
                ...
                
                {
                    ...
                    if ( !provideOriginalDepthImage )
                    {
                        ...
                        byte* dst = (byte*) data->tt.data;
                        int offset = data->s - width * 3;
                        byte red, green, blue;
                    ...
                    else
                    {
                        ...
                        ushort* dst = (ushort*) data->tt.data;
                        int offset = ( data->s >> 1 ) - width;
