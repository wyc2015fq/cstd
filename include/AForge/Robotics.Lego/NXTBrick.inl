...
namespace AForge.Robotics.Lego
{
    ...
    public partial class NXTBrick
    {
        ...
        public class MotorState
        {
            ...
            {
                get { return power; }
                set { power = MIN( MAX( -100, value ), 100 ); }
            }
            private int power;
            ...
            public int TurnRatio
            {
                ...
                set { turnRatio = MIN( MAX( -100, value ), 100 ); }
            }
        ...
        public bool SetBrickName( string deviceName )
        {
            ...
            System.Text.ASCIIEncoding.ASCII.GetBytes( deviceName, 0, MIN( deviceName.Length, 14 ), command, 2 );
        ...
        public bool LsRead( Sensor sensor, byte[] readValues, out int bytesRead )
        {
            ...
            {
                bytesRead = reply[3];
                Array.Copy( reply, 4, readValues, 0, MIN( readValues.Length, bytesRead ) );
                return true;
            }
