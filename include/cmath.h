...
// ���Է�
// ���õȲ����ʽ:
//  �����Ļ�, ��1��ʼһֱ�㵽���е�ǰ��͵�һ�δ���x��ʱ��,���������������source code(C):
...
// Newton ��
// ���������ת��Ϊ���?��������⣬��?����x��
// ��������������������Newton ������������ڵ�������һ�㲻ͬ��������ĸ�������������ͨ��֤�������ǿ��Է��֣�Newton������ʽ����������������ģ������У�?
// ��������ô֤���ģ����Բο�hacker��s delight��
// ���⣬��ֵ��ѡ��Ҳ�Ǻ���Ҫ��һ������������ѡ����ڵ��ڵ���С��?���ݴ�����
...
// �����ȷ�Ϸ�?
// �����ȷ�Ϸ���Ϊһ��?2λ������������Ӧ����һ��16λ�����������?6λ��������ʵ����ȷ��ÿλ�ı�����0����1.���ǰ��������Ϊ������ӵĲ��֣�һ��������ȷ�ϵ�ֵ����һ������δȷ�ϵ�ֵ���Ӹ�λ����λ��ÿ�ε���ȷ��һλ����ʼʱ����ȷ�ϲ���Ϊ0��������ĳ�ʼ��ʽΪ��?
//  �㷨������Ϊ��James Ulery ����:Computing Integer Square Roots
...
static int16u g_sqrt_table[1024];
