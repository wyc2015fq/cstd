...
%a = load('E:\luobo\参考论文\AdaBoost\boost - 副本\AdaBoost训练\adaboost_tree\萝卜\adaboost_tree训练\cla_1_boostrp15000.mat');
%Model = a.Model;
%Thrs = a.Thrs;
