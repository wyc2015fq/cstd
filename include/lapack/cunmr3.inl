...
/* Subroutine */ static int cunmr3_(char *side, char *trans, integer *m, integer *n, 
        integer *k, integer *l, scomplex *a, integer *lda, scomplex *tau, 
        scomplex *c__, integer *ldc, scomplex *work, integer *info, ftnlen 
        side_len, ftnlen trans_len)
{
    ...
    static scomplex taui;
     ...
     /* Subroutine */ int clarz_(char *, integer *, integer *, integer *
            , scomplex *, integer *, scomplex *, scomplex *, integer *, scomplex *
