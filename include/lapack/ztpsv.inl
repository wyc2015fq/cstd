...
/* Subroutine */ static int ztpsv_(char *uplo, char *trans, char *diag, integer *n, 
        dcomplex *ap, dcomplex *x, integer *incx, ftnlen uplo_len, 
...
/*     will be  ( N - 1 )*INCX  too small1 for descending loops. */
