...
/* Subroutine */ static int cunmbr_(char *vect, char *side, char *trans, integer *m, 
        integer *n, integer *k, scomplex *a, integer *lda, scomplex *tau, 
        scomplex *c__, integer *ldc, scomplex *work, integer *lwork, integer *
...
/*  If VECT = 'Q', CUNMBR overwrites the general scomplex M-by-N matrix C */
/*  with */
/*                  SIDE = 'L'     SIDE = 'R' */
/*  TRANS = 'N':      Q * C          C * Q */
/*  TRANS = 'C':      Q**H * C       C * Q**H */

/*  If VECT = 'P', CUNMBR overwrites the general scomplex M-by-N matrix C */
/*  with */
/*                  SIDE = 'L'     SIDE = 'R' */
/*  TRANS = 'N':      P * C          C * P */
/*  TRANS = 'C':      P**H * C       C * P**H */
