...
/* Subroutine */ static int clahqr_(logical *wantt, logical *wantz, integer *n, 
        integer *ilo, integer *ihi, scomplex *h__, integer *ldh, scomplex *w, 
        integer *iloz, integer *ihiz, scomplex *z__, integer *ldz, integer *
        info)
{
...
static integer c__1 = 1;
    ...
    void c_sqrt(scomplex *, scomplex *), r_cnjg(scomplex *, scomplex *);
    double c_abs(scomplex *);

    /* Local variables */
    static integer i__, j, k, l, m;
    static real s;
    static scomplex t, u, v[2], x, y;
    ...
    static scomplex temp;
     /* Subroutine */ int cscal_(integer *, scomplex *, scomplex *, 
            integer *), ccopy_(integer *, scomplex *, integer *, scomplex *, 
            integer *);
    static real rtemp, rwork[1];
     /* Subroutine */ int clarfg_(integer *, scomplex *, scomplex *, 
            integer *, scomplex *);
...
/*     If norm(H) <= (real)sqrt(OVFL), overflow should not occur. */
    ...
    smlnum = (real)slamch_("Safe minimum", (ftnlen)12) / ulp;
...
/*        Look for a single small1 subdiagonal element. */
        ...
        for (k = i__; k >= i__2; --k) {
            ...
            tst1 = (r__1 = h__[i__3].r, SABS(r__1)) + (r__2 = (real)r_imag(&h__[k - 
                    1 + (k - 1) * h_dim1]), SABS(r__2)) + ((r__3 = h__[i__4]
...
/*           Exceptional shift. */
            ...
            s = (r__1 = h__[i__2].r, SABS(r__1)) * .75f;
            i__2 = i__ + i__ * h_dim1;
...
/*        Look for two consecutive small1 subdiagonal elements. */
...
/*           negligible. */
            ...
            i__3 = m + 1 + m * h_dim1;
            h21 = h__[i__3].r;
            s = (r__1 = h11s.r, SABS(r__1)) + (r__2 = (real)r_imag(&h11s), SABS(
                    r__2)) + SABS(h21);
            ...
            i__3 = m + (m - 1) * h_dim1;
            h10 = h__[i__3].r;
            tst1 = ((r__1 = h11s.r, SABS(r__1)) + (r__2 = (real)r_imag(&h11s), SABS(
                    r__2))) * ((r__3 = h11.r, SABS(r__3)) + (r__4 = (real)r_imag(&
                    h11), SABS(r__4)) + ((r__5 = h22.r, SABS(r__5)) + (r__6 = 
                    (real)r_imag(&h22), SABS(r__6))));
            if ((r__1 = h10 * h21, SABS(r__1)) <= ulp * tst1) {
                goto L50;
            }
/* L40: */
        }
        ...
        i__2 = l + 1 + l * h_dim1;
        h21 = h__[i__2].r;
        s = (r__1 = h11s.r, SABS(r__1)) + (r__2 = (real)r_imag(&h11s), SABS(r__2)) 
                + SABS(h21);
        q__1.r = h11s.r / s, q__1.i = h11s.i / s;
        h11s.r = q__1.r, h11s.i = q__1.i;
        h21 /= s;
...
/*              consecutive small1 subdiagonals were found, then extra */
/*              scaling must be performed to ensure that H(M,M-1) remains */
/*              real. */

                q__1.r = 1.f - t1.r, q__1.i = 0.f - t1.i;
                temp.r = q__1.r, temp.i = q__1.i;
                r__1 = (real)c_abs(&temp);
