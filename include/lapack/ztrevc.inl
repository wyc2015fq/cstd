...
/* Subroutine */ static int ztrevc_(char *side, char *howmny, logical *select, 
        integer *n, dcomplex *t, integer *ldt, dcomplex *vl, 
        integer *ldvl, dcomplex *vr, integer *ldvr, integer *mm, integer 
        *m, dcomplex *work, doublereal *rwork, integer *info, ftnlen 
...
static integer c__1 = 1;
    ...
    static logical somev;
     ...
     /* Subroutine */ int xerbla_(char *, integer *, ftnlen), zdscal_(
            integer *, doublereal *, dcomplex *, integer *);
     integer izamax_(integer *, dcomplex *, integer *);
    static logical rightv;
     doublereal dzasum_(integer *, dcomplex *, integer *);
    static doublereal smlnum;
     /* Subroutine */ int zlatrs_(char *, char *, char *, char *, 
