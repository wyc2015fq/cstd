...
/* Subroutine */ static int zher2k_(char *uplo, char *trans, integer *n, integer *k, 
        dcomplex *alpha, dcomplex *a, integer *lda, dcomplex *
        b, integer *ldb, doublereal *beta, dcomplex *c__, integer *ldc, 
