...
/* Subroutine */ static int clarfb_(char *side, char *trans, char *direct, char *
        storev, integer *m, integer *n, integer *k, scomplex *v, integer *ldv, 
        scomplex *t, integer *ldt, scomplex *c__, integer *ldc, scomplex *work, 
...
/*  CLARFB applies a scomplex block reflector H or its transpose H' to a */
