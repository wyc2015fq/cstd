...
/* Subroutine */ static int zhegv_(integer *itype, char *jobz, char *uplo, integer *
        n, dcomplex *a, integer *lda, dcomplex *b, integer *ldb, 
        doublereal *w, dcomplex *work, integer *lwork, doublereal *rwork,
         integer *info, ftnlen jobz_len, ftnlen uplo_len)
{
    ...
    static logical upper, wantz;
     ...
     /* Subroutine */ int zhegst_(integer *, char *, integer *, 
            dcomplex *, integer *, dcomplex *, integer *, integer *,
             ftnlen);
    static integer lwkopt;
    static logical lquery;
     /* Subroutine */ int zpotrf_(char *, integer *, dcomplex *, 
