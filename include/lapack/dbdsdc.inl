...
/* Subroutine */ static int dbdsdc_(char *uplo, char *compq, integer *n, doublereal *
        ...
        iwork, integer *info, ftnlen uplo_len, ftnlen compq_len)
{
    ...
    static integer poles, iuplo, nsize, start;
     /* Subroutine */ int dlasd0_(integer *, integer *, doublereal *, 
            doublereal *, doublereal *, integer *, doublereal *, integer *, 
            integer *, integer *, doublereal *, integer *);
     doublereal dlamch_(char *, ftnlen);
     /* Subroutine */ int dlasda_(integer *, integer *, integer *, 
            integer *, doublereal *, doublereal *, doublereal *, integer *, 
...
/*        A subproblem with E(I) small1 for I < NM1. */

                nsize = i__ - start + 1;
            } else if ((d__1 = e[i__], ABS(d__1)) >= eps) {

/*        A subproblem with E(NM1) not too small1 but I = NM1. */

                nsize = *n - start + 1;
            } else {

/*        A subproblem with E(NM1) small1. This implies an */
