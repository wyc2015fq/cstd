...
/* Subroutine */ static int cunmlq_(char *side, char *trans, integer *m, integer *n, 
        integer *k, scomplex *a, integer *lda, scomplex *tau, scomplex *c__, 
        integer *ldc, scomplex *work, integer *lwork, integer *info, ftnlen 
        side_len, ftnlen trans_len)
{
    ...
    static integer nbmin, iinfo;
     /* Subroutine */ int cunml2_(char *, char *, integer *, integer *, 
            integer *, scomplex *, integer *, scomplex *, scomplex *, integer *, 
            scomplex *, integer *, ftnlen, ftnlen), clarfb_(char *, char *, 
...
/*  CUNMLQ overwrites the general scomplex M-by-N matrix C with */
