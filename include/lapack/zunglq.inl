/* ../../../dependencies/lapack/src/zunglq.f -- translated by f2c (version 20061008).
...
/* Subroutine */ static int zunglq_(integer *m, integer *n, integer *k, 
        dcomplex *a, integer *lda, dcomplex *tau, dcomplex *
        work, integer *lwork, integer *info)
{
    ...
    static integer i__, j, l, ib, nb, ki, kk, nx, iws, nbmin, iinfo;
     /* Subroutine */ int zungl2_(integer *, integer *, integer *, 
...
/*  ZUNGLQ generates an M-by-N scomplex matrix Q with orthonormal rows, */
