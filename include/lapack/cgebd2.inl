...
/* Subroutine */ static int cgebd2_(integer *m, integer *n, scomplex *a, integer *lda,
        ...
        integer *info)
{
    ...
    static scomplex alpha;
     /* Subroutine */ int clarf_(char *, integer *, integer *, scomplex *
            ...
            clarfg_(integer *, scomplex *, scomplex *, integer *, scomplex *), 
            clacgv_(integer *, scomplex *, integer *), xerbla_(char *, integer 
            *, ftnlen);
