...
/* Subroutine */ static int ztrsen_(char *job, char *compq, logical *select, integer 
        *n, dcomplex *t, integer *ldt, dcomplex *q, integer *ldq, 
        dcomplex *w, integer *m, doublereal *s, doublereal *sep, 
        dcomplex *work, integer *lwork, integer *info, ftnlen job_len, 
        ftnlen compq_len)
{
    ...
    static logical wantbh;
     /* Subroutine */ int zlacon_(integer *, dcomplex *, 
            dcomplex *, doublereal *, integer *), zlacpy_(char *, 
            integer *, integer *, dcomplex *, integer *, dcomplex *,
             integer *, ftnlen);
    static logical wantsp;
     /* Subroutine */ int ztrexc_(char *, integer *, dcomplex *, 
            integer *, dcomplex *, integer *, integer *, integer *, 
            integer *, ftnlen);
    static logical lquery;
     /* Subroutine */ int ztrsyl_(char *, char *, integer *, integer *, 
            integer *, dcomplex *, integer *, dcomplex *, integer *,
             dcomplex *, integer *, doublereal *, integer *, ftnlen, 
            ftnlen);
...
/*  When SEP is small1, small1 changes in T can cause large changes in */
