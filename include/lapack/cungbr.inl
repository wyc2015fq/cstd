...
/* Subroutine */ static int cungbr_(char *vect, integer *m, integer *n, integer *k, 
        scomplex *a, integer *lda, scomplex *tau, scomplex *work, integer *lwork,
         integer *info, ftnlen vect_len)
{
    ...
    static logical wantq;
     ...
     /* Subroutine */ int cunglq_(integer *, integer *, integer *, 
