...
/* Subroutine */ static int sggev_(char *jobvl, char *jobvr, integer *n, real *a, 
        ...
        integer *lwork, integer *info, ftnlen jobvl_len, ftnlen jobvr_len)
{
    ...
    static integer ileft, icols, irows;
     /* Subroutine */ int slabad_(real *, real *), sggbak_(char *, char 
    ...
    static logical ilascl, ilbscl;
     ...
     /* Subroutine */ int xerbla_(char *, integer *, ftnlen), sgghrd_(
    ...
    static integer ijobvl, iright;
     /* Subroutine */ int sgeqrf_(integer *, integer *, real *, integer 
    ...
    static real anrmto, bnrmto;
     /* Subroutine */ int shgeqz_(char *, char *, char *, integer *, 
            integer *, integer *, real *, integer *, real *, integer *, real *
            , real *, real *, real *, integer *, real *, integer *, real *, 
            integer *, integer *, ftnlen, ftnlen, ftnlen);
    static integer minwrk, maxwrk;
    static real smlnum;
     /* Subroutine */ int sorgqr_(integer *, integer *, integer *, real 
            *, integer *, real *, real *, integer *, integer *);
    static logical lquery;
     /* Subroutine */ int sormqr_(char *, char *, integer *, integer *, 
...
/*          (j+1)-st eigenvalues are a scomplex conjugate pair, with */
/*          ALPHAI(j+1) negative. */
...
/*          (j+1)-th eigenvalues form a scomplex conjugate pair, then */
...
/*     Scale A if MAX element outside range [SMLNUM,BIGNUM] */
    ...
    anrm = (real)slange_("M", n, n, &a[a_offset], lda, &work[1], (ftnlen)1);
    ilascl = FALSE_;
...
/*     Scale B if MAX element outside range [SMLNUM,BIGNUM] */
    ...
    bnrm = (real)slange_("M", n, n, &b[b_offset], ldb, &work[1], (ftnlen)1);
    ilbscl = FALSE_;
