...
/* Subroutine */ static int cungql_(integer *m, integer *n, integer *k, scomplex *a, 
...
static integer c__2 = 2;
    ...
    static integer i__, j, l, ib, nb, kk, nx, iws, nbmin, iinfo;
     /* Subroutine */ int cung2l_(integer *, integer *, integer *, 
...
/*  CUNGQL generates an M-by-N scomplex matrix Q with orthonormal columns, */
