...
/* Subroutine */ static int slasq2_(integer *n, real *z__, integer *info)
{
    ...
    static integer iinfo;
     /* Subroutine */ int slasq3_(integer *, integer *, real *, integer 
...
/*        EMIN. Find Gershgorin-type bound if Q's much greater than E's. */
        ...
        emax = 0.f;
        if (n0 > i0) {
            emin = (r__1 = z__[(n0 << 2) - 5], SABS(r__1));
        } else {
            emin = 0.f;
        }
        qmin = z__[(n0 << 2) - 3];
...
/*           When EMIN is very small1 check for splits. */
