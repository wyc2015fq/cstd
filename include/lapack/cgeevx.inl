...
/* Subroutine */ static int cgeevx_(char *balanc, char *jobvl, char *jobvr, char *
        sense, integer *n, scomplex *a, integer *lda, scomplex *w, scomplex *vl, 
        integer *ldvl, scomplex *vr, integer *ldvr, integer *ilo, integer *ihi,
         real *scale, real *abnrm, real *rconde, real *rcondv, scomplex *work, 
...
static integer c__4 = 4;
    ...
    static integer icond;
     ...
     doublereal scnrm2_(integer *, scomplex *, integer *);
     /* Subroutine */ int cgebak_(char *, char *, integer *, integer *, 
            integer *, real *, integer *, scomplex *, integer *, integer *, 
            ftnlen, ftnlen), cgebal_(char *, integer *, scomplex *, integer *, 
            integer *, integer *, real *, integer *, ftnlen), slabad_(real *, 
            real *);
    static logical scalea;
     doublereal clange_(char *, integer *, integer *, scomplex *, 
            integer *, real *, ftnlen);
    static real cscale;
     /* Subroutine */ int cgehrd_(integer *, integer *, integer *, 
            scomplex *, integer *, scomplex *, scomplex *, integer *, integer *),
             clascl_(char *, integer *, integer *, real *, real *, integer *, 
            integer *, scomplex *, integer *, integer *, ftnlen);
     doublereal slamch_(char *, ftnlen);
     /* Subroutine */ int csscal_(integer *, real *, scomplex *, integer 
            *), clacpy_(char *, integer *, integer *, scomplex *, integer *, 
            scomplex *, integer *, ftnlen), xerbla_(char *, integer *, ftnlen);
     integer ilaenv_(integer *, char *, char *, integer *, integer *, 
            integer *, integer *, ftnlen, ftnlen);
    static logical select[1];
    static real bignum;
     /* Subroutine */ int slascl_(char *, integer *, integer *, real *, 
            real *, integer *, integer *, real *, integer *, integer *, 
            ftnlen);
     integer isamax_(integer *, real *, integer *);
     /* Subroutine */ int chseqr_(char *, char *, integer *, integer *, 
            integer *, scomplex *, integer *, scomplex *, scomplex *, integer *, 
            scomplex *, integer *, integer *, ftnlen, ftnlen), ctrevc_(char *, 
            char *, logical *, integer *, scomplex *, integer *, scomplex *, 
            integer *, scomplex *, integer *, integer *, integer *, scomplex *, 
            real *, integer *, ftnlen, ftnlen), cunghr_(integer *, integer *, 
            integer *, scomplex *, integer *, scomplex *, scomplex *, integer *, 
            integer *), ctrsna_(char *, char *, logical *, integer *, scomplex 
            *, integer *, scomplex *, integer *, scomplex *, integer *, real *, 
            real *, integer *, integer *, scomplex *, integer *, real *, 
...
/*  CGEEVX computes for an N-by-N scomplex nonsymmetric matrix A, the */
...
/*     Get machine constants */
    ...
    smlnum = (real)slamch_("S", (ftnlen)1);
    bignum = 1.f / smlnum;
    slabad_(&smlnum, &bignum);
    smlnum = (real)sqrt(smlnum) / eps;
    bignum = 1.f / smlnum;

/*     Scale A if MAX element outside range [SMLNUM,BIGNUM] */

    icond = 0;
    anrm = (real)clange_("M", n, n, &a[a_offset], lda, dum, (ftnlen)1);
    scalea = FALSE_;
...
/*     Balance the matrix and compute ABNRM */
    ...
    cgebal_(balanc, n, &a[a_offset], lda, ilo, ihi, &scale[1], &ierr, (ftnlen)
            1);
    *abnrm = (real)clange_("1", n, n, &a[a_offset], lda, dum, (ftnlen)1);
    if (scalea) {
        dum[0] = *abnrm;
...
/*        Normalize left eigenvectors and make largest component real */
        ...
        for (i__ = 1; i__ <= i__1; ++i__) {
            scl = (real)(1.f / scnrm2_(n, &vl[i__ * vl_dim1 + 1], &c__1));
...
/*        Normalize right eigenvectors and make largest component real */
        ...
        i__1 = *n;
        for (i__ = 1; i__ <= i__1; ++i__) {
            scl = (real)(1.f / scnrm2_(n, &vr[i__ * vr_dim1 + 1], &c__1));
...
/* Computing 2nd power */
                r__1 = vr[i__3].r;
/* Computing 2nd power */
                r__2 = (real)r_imag(&vr[k + i__ * vr_dim1]);
                rwork[k] = r__1 * r__1 + r__2 * r__2;
/* L30: */
            }
            k = isamax_(n, &rwork[1], &c__1);
