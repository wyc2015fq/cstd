...
/* Subroutine */ static int clabrd_(integer *m, integer *n, integer *nb, scomplex *a, 
        integer *lda, real *d__, real *e, scomplex *tauq, scomplex *taup, 
        scomplex *x, integer *ldx, scomplex *y, integer *ldy)
{
    ...
    static scomplex alpha;
     /* Subroutine */ int cscal_(integer *, scomplex *, scomplex *, 
            ...
            integer *, ftnlen), clarfg_(integer *, scomplex *, scomplex *, 
            integer *, scomplex *), clacgv_(integer *, scomplex *, integer *);
