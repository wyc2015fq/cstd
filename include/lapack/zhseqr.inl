...
/* Subroutine */ static int zhseqr_(char *job, char *compz, integer *n, integer *ilo,
         integer *ihi, dcomplex *h__, integer *ldh, dcomplex *w, 
        dcomplex *z__, integer *ldz, dcomplex *work, integer *lwork,
...
static logical c_false = FALSE_;
    ...
    static dcomplex s[225]        /* was [15][15] */, v[16];
    static integer i1, i2, ii, nh, nr, ns, nv;
    static dcomplex vv[16];
    static integer itn;
    static dcomplex tau;
    static integer its;
    ...
    static doublereal rtemp;
     /* Subroutine */ int zgemv_(char *, integer *, integer *, 
...
/*  ZHSEQR computes the eigenvalues of a scomplex upper Hessenberg */
