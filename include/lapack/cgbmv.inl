...
/* Subroutine */ static int cgbmv_(char *trans, integer *m, integer *n, integer *kl, 
        integer *ku, scomplex *alpha, scomplex *a, integer *lda, scomplex *x, 
        integer *incx, scomplex *beta, scomplex *y, integer *incy, ftnlen 
        trans_len)
{
