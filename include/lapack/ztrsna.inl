...
/* Subroutine */ static int ztrsna_(char *job, char *howmny, logical *select, 
        integer *n, dcomplex *t, integer *ldt, dcomplex *vl, 
        integer *ldvl, dcomplex *vr, integer *ldvr, doublereal *s, 
        doublereal *sep, integer *mm, integer *m, dcomplex *work, 
...
static integer c__1 = 1;
    ...
    static logical wantsp;
     /* Subroutine */ int zlatrs_(char *, char *, char *, char *, 
            ...
            ftnlen), ztrexc_(char *, integer *, dcomplex *, integer *, 
            dcomplex *, integer *, integer *, integer *, integer *, 
            ftnlen);
