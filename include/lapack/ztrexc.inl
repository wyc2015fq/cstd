...
/* Subroutine */ static int ztrexc_(char *compq, integer *n, dcomplex *t, 
        integer *ldt, dcomplex *q, integer *ldq, integer *ifst, integer *
...
static integer c__1 = 1;
    ...
    static dcomplex t11, t22, sn, temp;
    ...
    static logical wantq;
     /* Subroutine */ int xerbla_(char *, integer *, ftnlen), zlartg_(
