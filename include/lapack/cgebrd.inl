...
/* Subroutine */ static int cgebrd_(integer *m, integer *n, scomplex *a, integer *lda,
         real *d__, real *e, scomplex *tauq, scomplex *taup, scomplex *work, 
        integer *lwork, integer *info)
{
    ...
    static integer nbmin, iinfo, minmn;
     /* Subroutine */ int cgebd2_(integer *, integer *, scomplex *, 
            integer *, real *, real *, scomplex *, scomplex *, scomplex *, 
            integer *), clabrd_(integer *, integer *, integer *, scomplex *, 
            integer *, real *, real *, scomplex *, scomplex *, scomplex *, 
            integer *, scomplex *, integer *), xerbla_(char *, integer *, 
            ftnlen);
...
/*  CGEBRD reduces a general scomplex M-by-N matrix A to upper or lower */
