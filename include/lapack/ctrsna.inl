...
/* Subroutine */ static int ctrsna_(char *job, char *howmny, logical *select, 
        integer *n, scomplex *t, integer *ldt, scomplex *vl, integer *ldvl, 
        scomplex *vr, integer *ldvr, real *s, real *sep, integer *mm, integer *
        m, scomplex *work, integer *ldwork, real *rwork, integer *info, ftnlen 
...
static integer c__1 = 1;
    ...
    static real xnorm;
     ...
     /* Subroutine */ int clacpy_(char *, integer *, integer *, scomplex 
            *, integer *, scomplex *, integer *, ftnlen), xerbla_(char *, 
            integer *, ftnlen);
    static real bignum;
    static logical wantbh;
     /* Subroutine */ int clatrs_(char *, char *, char *, char *, 
            ...
            real *, scomplex *, integer *), ctrexc_(char *, integer *, scomplex 
            *, integer *, scomplex *, integer *, integer *, integer *, integer 
            *, ftnlen);
...
/*           eigenvalue. */
            ...
            rnrm = (real)scnrm2_(n, &vr[ks * vr_dim1 + 1], &c__1);
            lnrm = (real)scnrm2_(n, &vl[ks * vl_dim1 + 1], &c__1);
            s[ks] = (real)c_abs(&prod) / (rnrm * lnrm);
...
/*                 overflow. */
                    ...
                    i__2 = ix + work_dim1;
                    xnorm = (real)((r__1 = (real)work[i__2].r, SABS(r__1)) + (r__2 = 
                            (real)r_imag(&work[ix + work_dim1]), SABS(r__2)));
