...
/* Subroutine */ static int zungql_(integer *m, integer *n, integer *k, 
...
static integer c__2 = 2;
    ...
    static integer i__, j, l, ib, nb, kk, nx, iws, nbmin, iinfo;
     /* Subroutine */ int zung2l_(integer *, integer *, integer *, 
...
/*  ZUNGQL generates an M-by-N scomplex matrix Q with orthonormal columns, */
