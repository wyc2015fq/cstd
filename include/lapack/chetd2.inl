...
/* Subroutine */ static int chetd2_(char *uplo, integer *n, scomplex *a, integer *lda,
         real *d__, real *e, scomplex *tau, integer *info, ftnlen uplo_len)
{
...
static integer c__1 = 1;
    ...
    static scomplex alpha;
     ...
     /* Subroutine */ int chemv_(char *, integer *, scomplex *, scomplex *
            , integer *, scomplex *, integer *, scomplex *, scomplex *, integer *
            , ftnlen), caxpy_(integer *, scomplex *, scomplex *, integer *, 
            scomplex *, integer *);
    static logical upper;
     /* Subroutine */ int clarfg_(integer *, scomplex *, scomplex *, 
            integer *, scomplex *), xerbla_(char *, integer *, ftnlen);
...
/*  CHETD2 reduces a scomplex Hermitian matrix A to real symmetric */
