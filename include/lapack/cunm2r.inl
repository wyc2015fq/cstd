...
/* Subroutine */ static int cunm2r_(char *side, char *trans, integer *m, integer *n, 
        integer *k, scomplex *a, integer *lda, scomplex *tau, scomplex *c__, 
        integer *ldc, scomplex *work, integer *info, ftnlen side_len, ftnlen 
        trans_len)
{
...
/*  CUNM2R overwrites the general scomplex m-by-n matrix C with */
