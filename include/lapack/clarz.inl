...
/* Subroutine */ static int clarz_(char *side, integer *m, integer *n, integer *l, 
        scomplex *v, integer *incv, scomplex *tau, scomplex *c__, integer *ldc, 
        scomplex *work, ftnlen side_len)
{
...
static integer c__1 = 1;
    ...
    /* Local variables */
     /* Subroutine */ int cgerc_(integer *, integer *, scomplex *, 
            scomplex *, integer *, scomplex *, integer *, scomplex *, integer *),
             cgemv_(char *, integer *, integer *, scomplex *, scomplex *, 
            integer *, scomplex *, integer *, scomplex *, scomplex *, integer *, 
            ftnlen);
     logical lsame_(char *, char *, ftnlen, ftnlen);
     /* Subroutine */ int cgeru_(integer *, integer *, scomplex *, 
            scomplex *, integer *, scomplex *, integer *, scomplex *, integer *),
             ccopy_(integer *, scomplex *, integer *, scomplex *, integer *), 
            caxpy_(integer *, scomplex *, scomplex *, integer *, scomplex *, 
            integer *), clacgv_(integer *, scomplex *, integer *);
