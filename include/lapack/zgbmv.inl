...
/* Subroutine */ static int zgbmv_(char *trans, integer *m, integer *n, integer *kl, 
        integer *ku, dcomplex *alpha, dcomplex *a, integer *lda, 
        dcomplex *x, integer *incx, dcomplex *beta, dcomplex *
