...
/* Subroutine */ static int zgelqf_(integer *m, integer *n, dcomplex *a, 
        integer *lda, dcomplex *tau, dcomplex *work, integer *lwork,
         integer *info)
{
    ...
    static integer i__, k, ib, nb, nx, iws, nbmin, iinfo;
     /* Subroutine */ int zgelq2_(integer *, integer *, dcomplex *,
             integer *, dcomplex *, dcomplex *, integer *), xerbla_(
            char *, integer *, ftnlen);
...
/*  ZGELQF computes an LQ factorization of a scomplex M-by-N matrix A: */
/*  A = L * Q. */
