...
/* Subroutine */ static int cggbak_(char *job, char *side, integer *n, integer *ilo, 
        integer *ihi, real *lscale, real *rscale, integer *m, scomplex *v, 
...
/*  CGGBAK forms the right or left eigenvectors of a scomplex generalized */
