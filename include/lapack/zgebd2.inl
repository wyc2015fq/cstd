...
/* Subroutine */ static int zgebd2_(integer *m, integer *n, dcomplex *a, 
        integer *lda, doublereal *d__, doublereal *e, dcomplex *tauq, 
        dcomplex *taup, dcomplex *work, integer *info)
{
    ...
    static dcomplex alpha;
     /* Subroutine */ int zlarf_(char *, integer *, integer *, 
            dcomplex *, integer *, dcomplex *, dcomplex *, 
            integer *, dcomplex *, ftnlen), xerbla_(char *, integer *, 
            ftnlen), zlarfg_(integer *, dcomplex *, dcomplex *, 
...
/*  ZGEBD2 reduces a scomplex general m by n matrix A to upper or lower */
