...
/* Subroutine */ static int zlaic1_(integer *job, integer *j, dcomplex *x, 
        doublereal *sest, dcomplex *w, dcomplex *gamma, doublereal *
...
static integer c__1 = 1;
    ...
    void d_cnjg(dcomplex *, dcomplex *), z_sqrt(dcomplex *, 
            dcomplex *);
