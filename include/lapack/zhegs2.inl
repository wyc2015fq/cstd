/* ../../../dependencies/lapack/src/zhegs2.f -- translated by f2c (version 20061008).
...
/* Subroutine */ static int zhegs2_(integer *itype, char *uplo, integer *n, 
        ...
        integer *info, ftnlen uplo_len)
{
    ...
    static doublereal akk, bkk;
     /* Subroutine */ int zher2_(char *, integer *, dcomplex *, 
            dcomplex *, integer *, dcomplex *, integer *, 
            dcomplex *, integer *, ftnlen);
     logical lsame_(char *, char *, ftnlen, ftnlen);
    static logical upper;
     /* Subroutine */ int zaxpy_(integer *, dcomplex *, 
            dcomplex *, integer *, dcomplex *, integer *), ztrmv_(
            char *, char *, char *, integer *, dcomplex *, integer *, 
            dcomplex *, integer *, ftnlen, ftnlen, ftnlen), ztrsv_(char *
            , char *, char *, integer *, dcomplex *, integer *, 
            dcomplex *, integer *, ftnlen, ftnlen, ftnlen), xerbla_(char 
            *, integer *, ftnlen), zdscal_(integer *, doublereal *, 
            dcomplex *, integer *), zlacgv_(integer *, dcomplex *, 
            integer *);
