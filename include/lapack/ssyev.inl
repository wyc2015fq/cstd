...
/* Subroutine */ static int ssyev_(char *jobz, char *uplo, integer *n, real *a, 
...
static real c_b17 = 1.f;
    ...
    static integer indtau, indwrk;
     /* Subroutine */ int ssterf_(integer *, real *, real *, integer *);
     doublereal slansy_(char *, char *, integer *, real *, integer *, 
            real *, ftnlen, ftnlen);
    static integer llwork;
    static real smlnum;
    static integer lwkopt;
    static logical lquery;
     /* Subroutine */ int sorgtr_(char *, integer *, real *, integer *, 
...
/*     Scale matrix to allowable range, if necessary. */
    ...
    anrm = (real)slansy_("M", uplo, n, &a[a_offset], lda, &work[1], (ftnlen)1, (
            ftnlen)1);
    iscale = 0;
