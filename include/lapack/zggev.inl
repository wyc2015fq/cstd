...
/* Subroutine */ static int zggev_(char *jobvl, char *jobvr, integer *n, 
        dcomplex *a, integer *lda, dcomplex *b, integer *ldb, 
        dcomplex *alpha, dcomplex *beta, dcomplex *vl, integer 
        *ldvl, dcomplex *vr, integer *ldvr, dcomplex *work, integer 
        ...
        jobvr_len)
{
    ...
    static integer ileft, icols, irwrk, irows;
     ...
     /* Subroutine */ int zggbak_(char *, char *, integer *, integer *, 
            integer *, doublereal *, doublereal *, integer *, dcomplex *,
    ...
    static integer ijobvl, iright;
     /* Subroutine */ int zgghrd_(char *, char *, integer *, integer *, 
    ...
    static integer ijobvr;
     /* Subroutine */ int zgeqrf_(integer *, integer *, dcomplex *,
             integer *, dcomplex *, dcomplex *, integer *, integer *
            );
    static doublereal anrmto;
    static integer lwkmin;
    static doublereal bnrmto;
     /* Subroutine */ int zlacpy_(char *, integer *, integer *, 
            dcomplex *, integer *, dcomplex *, integer *, ftnlen), 
            zlaset_(char *, integer *, integer *, dcomplex *, 
            dcomplex *, dcomplex *, integer *, ftnlen), ztgevc_(
            char *, char *, logical *, integer *, dcomplex *, integer *, 
            ...
            dcomplex *, integer *, integer *, integer *, dcomplex *,
             ...
             char *, integer *, integer *, integer *, dcomplex *, 
...
/*  ZGGEV computes for a pair of N-by-N scomplex nonsymmetric matrices */
