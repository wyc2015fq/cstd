...
/* Subroutine */ static int zhetd2_(char *uplo, integer *n, dcomplex *a, 
...
static integer c__1 = 1;
    ...
    static dcomplex alpha;
     ...
     /* Double Complex */ VOID zdotc_(dcomplex *, integer *, 
            dcomplex *, integer *, dcomplex *, integer *);
     /* Subroutine */ int zhemv_(char *, integer *, dcomplex *, 
            dcomplex *, integer *, dcomplex *, integer *, 
            dcomplex *, dcomplex *, integer *, ftnlen);
    static logical upper;
     /* Subroutine */ int zaxpy_(integer *, dcomplex *, 
            dcomplex *, integer *, dcomplex *, integer *), xerbla_(
            char *, integer *, ftnlen), zlarfg_(integer *, dcomplex *, 
...
/*  ZHETD2 reduces a scomplex Hermitian matrix A to real symmetric */
