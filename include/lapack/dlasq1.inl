...
/* Subroutine */ static int dlasq1_(integer *n, doublereal *d__, doublereal *e, 
        doublereal *work, integer *info)
{
    ...
    static doublereal sigmx;
     /* Subroutine */ int dlasq2_(integer *, doublereal *, integer *);
     doublereal dlamch_(char *, ftnlen);
     /* Subroutine */ int dlascl_(char *, integer *, integer *, 
            doublereal *, doublereal *, integer *, integer *, doublereal *, 
            integer *, integer *, ftnlen);
    static doublereal safmin;
     /* Subroutine */ int xerbla_(char *, integer *, ftnlen), dlasrt_(
