...
/* Subroutine */ static int slaqp2_(integer *m, integer *n, integer *offset, real *a,
...
static integer c__1 = 1;
    ...
    static integer offpi;
     /* Subroutine */ int slarf_(char *, integer *, integer *, real *, 
...
/*        Update partial column norms. */
        ...
        for (j = i__ + 1; j <= i__2; ++j) {
            if (vn1[j] != 0.f) {
/* Computing 2nd power */
                r__2 = (r__1 = a[offpi + j * a_dim1], SABS(r__1)) / vn1[j];
                temp = 1.f - r__2 * r__2;
                temp = dmax(temp,0.f);
/* Computing 2nd power */
                r__1 = vn1[j] / vn2[j];
                ...
                if (temp2 == 1.f) {
                    if (offpi < *m) {
                        i__3 = *m - offpi;
                        vn1[j] = (real)snrm2_(&i__3, &a[offpi + 1 + j * a_dim1], &
                                c__1);
                        vn2[j] = vn1[j];
                    } else {
                        vn1[j] = 0.f;
