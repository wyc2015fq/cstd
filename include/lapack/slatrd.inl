...
/* Subroutine */ static int slatrd_(char *uplo, integer *n, integer *nb, real *a, 
...
/*              Compute W(1:i-1,i) */
                ...
                i__2 = i__ - 1;
                alpha = (real)(tau[i__ - 1] * -.5f * sdot_(&i__2, &w[iw * w_dim1 + 1]
...
/*              Compute W(i+1:n,i) */
                ...
                i__2 = *n - i__;
                alpha = (real)(tau[i__] * -.5f * sdot_(&i__2, &w[i__ + 1 + i__ * 
