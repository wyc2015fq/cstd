...
/* Subroutine */ static int zlarft_(char *direct, char *storev, integer *n, integer *
        k, dcomplex *v, integer *ldv, dcomplex *tau, dcomplex *
...
static integer c__1 = 1;
    ...
    static dcomplex vii;
     ...
     /* Subroutine */ int zgemv_(char *, integer *, integer *, 
            ...
            ztrmv_(char *, char *, char *, integer *, dcomplex *, 
            integer *, dcomplex *, integer *, ftnlen, ftnlen, ftnlen), 
