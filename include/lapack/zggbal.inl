...
/* Subroutine */ static int zggbal_(char *job, integer *n, dcomplex *a, integer 
        *lda, dcomplex *b, integer *ldb, integer *ilo, integer *ihi, 
...
/*  ZGGBAL balances a pair of general scomplex matrices (A,B).  This */
