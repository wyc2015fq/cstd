...
/* Subroutine */ static int dgesvx_(char *fact, char *trans, integer *n, integer *
        ...
        equed_len)
{
    ...
    static logical equil;
     ...
     /* Subroutine */ int dlaqge_(integer *, integer *, doublereal *, 
    ...
    static logical nofact;
     /* Subroutine */ int dgeequ_(integer *, integer *, doublereal *, 
            integer *, doublereal *, doublereal *, doublereal *, doublereal *,
    ...
    static doublereal bignum;
     doublereal dlantr_(char *, char *, char *, integer *, integer *, 
            doublereal *, integer *, doublereal *, ftnlen, ftnlen, ftnlen);
    static integer infequ;
    static logical colequ;
     /* Subroutine */ int dgetrs_(char *, integer *, integer *, 
