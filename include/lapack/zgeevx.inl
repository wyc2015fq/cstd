...
/* Subroutine */ static int zgeevx_(char *balanc, char *jobvl, char *jobvr, char *
        sense, integer *n, dcomplex *a, integer *lda, dcomplex *w, 
        dcomplex *vl, integer *ldvl, dcomplex *vr, integer *ldvr, 
        integer *ilo, integer *ihi, doublereal *scale, doublereal *abnrm, 
        doublereal *rconde, doublereal *rcondv, dcomplex *work, integer *
...
static integer c__4 = 4;
    ...
    static integer ierr, itau, iwrk, nout, icond;
     ...
     /* Subroutine */ int zscal_(integer *, dcomplex *, 
            dcomplex *, integer *), dlabad_(doublereal *, doublereal *);
     doublereal dznrm2_(integer *, dcomplex *, integer *);
    ...
    static doublereal cscale;
     /* Subroutine */ int dlascl_(char *, integer *, integer *, 
            ...
            integer *, integer *, doublereal *, integer *, dcomplex *, 
            integer *, integer *, ftnlen, ftnlen), zgebal_(char *, integer *, 
            dcomplex *, integer *, integer *, integer *, doublereal *, 
            integer *, ftnlen);
    ...
    static doublereal bignum;
     ...
     /* Subroutine */ int zgehrd_(integer *, integer *, integer *, 
            dcomplex *, integer *, dcomplex *, dcomplex *, 
            integer *, integer *), zlascl_(char *, integer *, integer *, 
            doublereal *, doublereal *, integer *, integer *, dcomplex *,
    ...
    static doublereal smlnum;
     /* Subroutine */ int zhseqr_(char *, char *, integer *, integer *, 
            integer *, dcomplex *, integer *, dcomplex *, 
            dcomplex *, integer *, dcomplex *, integer *, integer *,
             ftnlen, ftnlen);
    static logical lquery, wantvr;
     /* Subroutine */ int ztrevc_(char *, char *, logical *, integer *, 
            dcomplex *, integer *, dcomplex *, integer *, 
            dcomplex *, integer *, integer *, integer *, dcomplex *,
             doublereal *, integer *, ftnlen, ftnlen), ztrsna_(char *, char *,
             logical *, integer *, dcomplex *, integer *, dcomplex *
            , integer *, dcomplex *, integer *, doublereal *, doublereal 
            *, integer *, integer *, dcomplex *, integer *, doublereal *,
...
/*  ZGEEVX computes for an N-by-N scomplex nonsymmetric matrix A, the */
