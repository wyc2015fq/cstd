...
static doublereal slansy_(char *norm, char *uplo, integer *n, real *a, integer *lda, 
...
/* Computing MAX */
                    r__2 = value, r__3 = (r__1 = a[i__ + j * a_dim1], SABS(
                            r__1));
...
/*        Find normI(A) ( = norm1(A), since A is symmetric). */
        ...
        if (lsame_(uplo, "U", (ftnlen)1, (ftnlen)1)) {
            ...
            for (j = 1; j <= i__1; ++j) {
                ...
                i__2 = j - 1;
                for (i__ = 1; i__ <= i__2; ++i__) {
                    absa = (r__1 = a[i__ + j * a_dim1], SABS(r__1));
                    sum += absa;
                    work[i__] += absa;
/* L50: */
                }
                work[j] = sum + (r__1 = a[j + j * a_dim1], SABS(r__1));
/* L60: */
            }
            i__1 = *n;
...
/* L80: */
            ...
            i__1 = *n;
            for (j = 1; j <= i__1; ++j) {
                sum = work[j] + (r__1 = a[j + j * a_dim1], SABS(r__1));
                i__2 = *n;
