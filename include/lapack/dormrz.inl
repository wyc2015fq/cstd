...
/* Subroutine */ static int dormrz_(char *side, char *trans, integer *m, integer *n, 
...
static integer c__65 = 65;
    ...
    static integer nbmin, iinfo;
     /* Subroutine */ int dormr3_(char *, char *, integer *, integer *, 
            integer *, integer *, doublereal *, integer *, doublereal *, 
            doublereal *, integer *, doublereal *, integer *, ftnlen, ftnlen),
             xerbla_(char *, integer *, ftnlen);
     integer ilaenv_(integer *, char *, char *, integer *, integer *, 
            integer *, integer *, ftnlen, ftnlen);
     /* Subroutine */ int dlarzb_(char *, char *, char *, char *, 
