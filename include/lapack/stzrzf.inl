...
/* Subroutine */ static int stzrzf_(integer *m, integer *n, real *a, integer *lda, 
...
static integer c__2 = 2;
    ...
    static integer i__, m1, ib, nb, ki, kk, mu, nx, iws, nbmin;
     ...
     /* Subroutine */ int slarzb_(char *, char *, char *, char *, 
            integer *, integer *, integer *, integer *, real *, integer *, 
            real *, integer *, real *, integer *, real *, integer *, ftnlen, 
            ftnlen, ftnlen, ftnlen);
    static integer ldwork;
     /* Subroutine */ int slarzt_(char *, char *, integer *, integer *, 
            real *, integer *, real *, real *, integer *, ftnlen, ftnlen);
    static integer lwkopt;
    static logical lquery;
     /* Subroutine */ int slatrz_(integer *, integer *, integer *, real 
            *, integer *, real *, real *);
