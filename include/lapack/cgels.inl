...
/* Subroutine */ static int cgels_(char *trans, integer *m, integer *n, integer *
        nrhs, scomplex *a, integer *lda, scomplex *b, integer *ldb, scomplex *
        work, integer *lwork, integer *info, ftnlen trans_len)
{
    ...
    static real rwork[1];
     ...
     /* Subroutine */ int cgeqrf_(integer *, integer *, scomplex *, 
            integer *, scomplex *, scomplex *, integer *, integer *), claset_(
            char *, integer *, integer *, scomplex *, scomplex *, scomplex *, 
            integer *, ftnlen), xerbla_(char *, integer *, ftnlen);
     integer ilaenv_(integer *, char *, char *, integer *, integer *, 
            integer *, integer *, ftnlen, ftnlen);
    static integer scllen;
    static real bignum;
     /* Subroutine */ int cunmlq_(char *, char *, integer *, integer *, 
            integer *, scomplex *, integer *, scomplex *, scomplex *, integer *, 
            scomplex *, integer *, integer *, ftnlen, ftnlen), cunmqr_(char *, 
            char *, integer *, integer *, integer *, scomplex *, integer *, 
            scomplex *, scomplex *, integer *, scomplex *, integer *, integer *, 
            ftnlen, ftnlen);
    static real smlnum;
