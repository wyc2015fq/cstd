...
/* Subroutine */ static int sbdsqr_(char *uplo, integer *n, integer *ncvt, integer *
        ...
        ftnlen uplo_len)
{
    ...
    static real sminl;
     /* Subroutine */ int slasr_(char *, char *, char *, integer *, 
            integer *, real *, real *, real *, integer *, ftnlen, ftnlen, 
            ftnlen);
    static real sigmx;
    static logical lower;
     /* Subroutine */ int sswap_(integer *, real *, integer *, real *, 
