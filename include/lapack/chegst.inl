...
/* Subroutine */ static int chegst_(integer *itype, char *uplo, integer *n, scomplex *
        ...
        uplo_len)
{
    ...
    static integer k, kb, nb;
     /* Subroutine */ int chemm_(char *, char *, integer *, integer *, 
            scomplex *, scomplex *, integer *, scomplex *, integer *, scomplex *, 
            scomplex *, integer *, ftnlen, ftnlen);
     logical lsame_(char *, char *, ftnlen, ftnlen);
     /* Subroutine */ int ctrmm_(char *, char *, char *, char *, 
            integer *, integer *, scomplex *, scomplex *, integer *, scomplex *, 
            integer *, ftnlen, ftnlen, ftnlen, ftnlen), ctrsm_(char *, char *,
             char *, char *, integer *, integer *, scomplex *, scomplex *, 
            integer *, scomplex *, integer *, ftnlen, ftnlen, ftnlen, ftnlen);
    static logical upper;
     /* Subroutine */ int chegs2_(integer *, char *, integer *, scomplex 
            *, integer *, scomplex *, integer *, integer *, ftnlen), cher2k_(
            char *, char *, integer *, integer *, scomplex *, scomplex *, 
            integer *, scomplex *, integer *, real *, scomplex *, integer *, 
