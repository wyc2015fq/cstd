...
/* Subroutine */ static int chbmv_(char *uplo, integer *n, integer *k, scomplex *
        alpha, scomplex *a, integer *lda, scomplex *x, integer *incx, scomplex *
        beta, scomplex *y, integer *incy, ftnlen uplo_len)
{
