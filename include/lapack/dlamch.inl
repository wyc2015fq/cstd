        ...
        doublereal *rmax)
{
    ...
    static doublereal third, lrmin, lrmax, sixth;
     /* Subroutine */ int dlamc1_(integer *, integer *, logical *, 
            logical *);
     doublereal dlamc3_(doublereal *, doublereal *);
    static logical lieee1;
     /* Subroutine */ int dlamc4_(integer *, doublereal *, integer *), 
...
/*        is detected when we cannot recover the previous A. */
        ...
        for (i__ = 1; i__ <= 3; ++i__) {
            d__1 = small1 * rbase;
            small1 = dlamc3_(&d__1, &zero);
/* L20: */
        }
        a = dlamc3_(&one, &small1);
...
static doublereal dlamch_(char *cmach, ftnlen cmach_len)
{
  ...
  static integer c__1 = 1;
    ...
    static doublereal small1, sfmin;
     /* Subroutine */ int dlamc2_(integer *, integer *, logical *, 
