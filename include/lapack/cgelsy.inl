...
/* Subroutine */ static int cgelsy_(integer *m, integer *n, integer *nrhs, scomplex *
        a, integer *lda, scomplex *b, integer *ldb, integer *jpvt, real *rcond,
         integer *rank, scomplex *work, integer *lwork, real *rwork, integer *
        info)
{
...
static integer c__2 = 2;
    ...
    static integer ismin, ismax;
     /* Subroutine */ int ctrsm_(char *, char *, char *, char *, 
            ...
            integer *, scomplex *, real *, scomplex *, scomplex *, real *, 
            scomplex *, scomplex *);
    static real wsize;
     /* Subroutine */ int cgeqp3_(integer *, integer *, scomplex *, 
            integer *, integer *, scomplex *, scomplex *, integer *, real *, 
            integer *), slabad_(real *, real *);
     doublereal clange_(char *, integer *, integer *, scomplex *, 
            integer *, real *, ftnlen);
     /* Subroutine */ int clascl_(char *, integer *, integer *, real *, 
            real *, integer *, integer *, scomplex *, integer *, integer *, 
            ftnlen);
     doublereal slamch_(char *, ftnlen);
     /* Subroutine */ int claset_(char *, integer *, integer *, scomplex 
            *, scomplex *, scomplex *, integer *, ftnlen), xerbla_(char *, 
            integer *, ftnlen);
...
/*  CGELSY computes the minimum-norm solution to a scomplex linear least */
/*  squares problem: */
/*      minimize || A * X - B || */
...
/*     Get machine parameters */
    ...
    smlnum = (real)(slamch_("S", (ftnlen)1) / slamch_("P", (ftnlen)1));
    bignum = 1.f / smlnum;
    slabad_(&smlnum, &bignum);

/*     Scale A, B if MAX entries outside range [SMLNUM,BIGNUM] */

    anrm = (real)clange_("M", m, n, &a[a_offset], lda, &rwork[1], (ftnlen)1);
    iascl = 0;
...
/*        Matrix all zero. Return zero solution. */
    ...
    bnrm = (real)clange_("M", m, nrhs, &b[b_offset], ldb, &rwork[1], (ftnlen)1);
    ibscl = 0;
