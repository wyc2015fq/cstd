...
/* Subroutine */ static int dgelsy_(integer *m, integer *n, integer *nrhs, 
...
static doublereal c_b54 = 1.;
    ...
    static doublereal sminpr, smaxpr, smlnum;
     /* Subroutine */ int dormrz_(char *, char *, integer *, integer *, 
            integer *, integer *, doublereal *, integer *, doublereal *, 
            doublereal *, integer *, doublereal *, integer *, integer *, 
            ftnlen, ftnlen);
    static integer lwkopt;
    static logical lquery;
     /* Subroutine */ int dtzrzf_(integer *, integer *, doublereal *, 
