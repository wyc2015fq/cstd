...
/* Subroutine */ static int sgelsy_(integer *m, integer *n, integer *nrhs, real *a, 
        integer *lda, real *b, integer *ldb, integer *jpvt, real *rcond, 
        integer *rank, real *work, integer *lwork, real *rwork, integer *info)
{
...
/*     Scale A, B if MAX entries outside range [SMLNUM,BIGNUM] */
    ...
    anrm = (real)slange_("M", m, n, &a[a_offset], lda, &work[1], (ftnlen)1);
    iascl = 0;
...
/*        Matrix all zero. Return zero solution. */
    ...
    bnrm = (real)slange_("M", m, nrhs, &b[b_offset], ldb, &work[1], (ftnlen)1);
    ibscl = 0;
...
/*     Determine RANK using incremental condition estimation */
    ...
    work[ismin] = 1.f;
    work[ismax] = 1.f;
    smax = (r__1 = a[a_dim1 + 1], SABS(r__1));
    smin = smax;
    if ((r__1 = a[a_dim1 + 1], SABS(r__1)) == 0.f) {
        *rank = 0;
        i__1 = MAX(*m,*n);
        slaset_("F", &i__1, nrhs, &c_b31, &c_b31, &b[b_offset], ldb, (ftnlen)
                1);
