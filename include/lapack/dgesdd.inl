...
/* Subroutine */ static int dgesdd_(char *jobz, integer *m, integer *n, doublereal *
        ...
        integer *iwork, integer *info, ftnlen jobz_len)
{
    ...
    static integer idum[1], ierr, itau;
     /* Subroutine */ int dgemm_(char *, char *, integer *, integer *, 
    ...
    static logical wntqn, wntqo, wntqs;
     /* Subroutine */ int dbdsdc_(char *, char *, integer *, doublereal 
    ...
    static integer bdspac;
     /* Subroutine */ int dgelqf_(integer *, integer *, doublereal *, 
    ...
    static doublereal bignum;
     /* Subroutine */ int dormbr_(char *, char *, char *, integer *, 
            integer *, integer *, doublereal *, integer *, doublereal *, 
            doublereal *, integer *, doublereal *, integer *, integer *, 
