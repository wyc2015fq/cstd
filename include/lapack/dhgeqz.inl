...
/* Subroutine */ static int dhgeqz_(char *job, char *compq, char *compz, integer *n, 
        ...
        ftnlen compq_len, ftnlen compz_len)
{
    ...
    static doublereal tempi, tempr;
     doublereal dlapy2_(doublereal *, doublereal *), dlapy3_(doublereal 
            *, doublereal *, doublereal *);
     /* Subroutine */ int dlasv2_(doublereal *, doublereal *, 
            doublereal *, doublereal *, doublereal *, doublereal *, 
            doublereal *, doublereal *, doublereal *);
    static logical ilazr2;
    static doublereal ascale, bscale;
     doublereal dlamch_(char *, ftnlen);
     /* Subroutine */ int dlarfg_(integer *, doublereal *, doublereal *,
             integer *, doublereal *);
     doublereal dlanhs_(char *, integer *, doublereal *, integer *, 
            doublereal *, ftnlen);
     /* Subroutine */ int dlaset_(char *, integer *, integer *, 
