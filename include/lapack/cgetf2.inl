...
/* Subroutine */ static int cgetf2_(integer *m, integer *n, scomplex *a, integer *lda,
...
static integer c__1 = 1;
    ...
    static integer j, jp;
     /* Subroutine */ int cscal_(integer *, scomplex *, scomplex *, 
            integer *), cgeru_(integer *, integer *, scomplex *, scomplex *, 
            integer *, scomplex *, integer *, scomplex *, integer *), cswap_(
