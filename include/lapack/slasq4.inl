...
/* Subroutine */ static int slasq4_(integer *i0, integer *n0, real *z__, integer *pp,
...
/*        No eigenvalues deflated. */
        ...
        if (*dmin__ == *dn || *dmin__ == *dn1) {
            ...
            b1 = (real)sqrt(z__[nn - 3]) * sqrt(z__[nn - 5]);
            b2 = (real)sqrt(z__[nn - 7]) * sqrt(z__[nn - 9]);
