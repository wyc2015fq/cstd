...
/* Subroutine */ static int clartg_(scomplex *f, scomplex *g, real *cs, scomplex *sn, 
        scomplex *r__)
{
    /* Initialized data */
    ...
    /* Builtin functions */
    double log(doublereal), pow_ri(real *, integer *), r_imag(scomplex *), 
            sqrt(doublereal);
    ...
    static scomplex ff;
    static real di, dr;
    static scomplex fs, gs;
    static real f2s, g2s, eps, scale;
    static integer count;
    static real safmn2, safmx2;
     doublereal slapy2_(real *, real *), slamch_(char *, ftnlen);
    static real safmin;
...
/* Computing MAX */
/* Computing MAX */
    r__7 = (r__1 = f->r, SABS(r__1)), r__8 = (r__2 = (real)r_imag(f), SABS(r__2));
/* Computing MAX */
    r__9 = (r__3 = g->r, SABS(r__3)), r__10 = (r__4 = (real)r_imag(g), SABS(r__4));
...
/*        This is a rare case: F is very small1. */

        if (f->r == 0.f && f->i == 0.f) {
            *cs = 0.f;
            r__2 = g->r;
            r__3 = (real)r_imag(g);
            r__1 = (real)slapy2_(&r__2, &r__3);
            r__->r = r__1, r__->i = 0.f;
/*           Do scomplex/real division explicitly with two real divisions */
            r__1 = gs.r;
            r__2 = (real)r_imag(&gs);
            d__ = (real)slapy2_(&r__1, &r__2);
            r__1 = gs.r / d__;
            r__2 = (real)(-r_imag(&gs) / d__);
...
/*        and so CS .lt. sqrt(SAFMIN)/SAFMN2 = (real)sqrt(EPS) */
/*        Therefore, CS = F2S/G2S / sqrt( 1 + (F2S/G2S)**2 ) = F2S/G2S */
        *cs = f2s / g2s;
/*        Make sure ABS(FF) = 1 */
/*        Do scomplex/real division explicitly with 2 real divisions */
/* Computing MAX */
        r__3 = (r__1 = f->r, SABS(r__1)), r__4 = (r__2 = (real)r_imag(f), SABS(r__2)
                );
        if (dmax(r__3,r__4) > 1.f) {
            ...
            d__ = (real)slapy2_(&r__1, &r__2);
            r__1 = f->r / d__;
            r__2 = (real)r_imag(f) / d__;
            q__1.r = r__1, q__1.i = r__2;
            ff.r = q__1.r, ff.i = q__1.i;
        } else {
            dr = safmx2 * f->r;
            di = (real)(safmx2 * r_imag(f));
            d__ = (real)slapy2_(&dr, &di);
            r__1 = dr / d__;
            r__2 = di / d__;
            q__1.r = r__1, q__1.i = r__2;
            ff.r = q__1.r, ff.i = q__1.i;
...
/*        F2S cannot overflow, and it is accurate */
        ...
        f2s = (real)sqrt(g2 / f2 + 1.f);
/*        Do the F2S(real)*FS(scomplex) multiply with two real multiplies */
        r__1 = f2s * fs.r;
        r__2 = (real)(f2s * r_imag(&fs));
        q__1.r = r__1, q__1.i = r__2;
        r__->r = q__1.r, r__->i = q__1.i;
        *cs = 1.f / f2s;
        d__ = f2 + g2;
