...
/* Subroutine */ static int sgeevx_(char *balanc, char *jobvl, char *jobvr, char *
...
static integer c__4 = 4;
    ...
    static real cscale;
     /* Subroutine */ int sgebak_(char *, char *, integer *, integer *, 
     ...
     /* Subroutine */ int sgehrd_(integer *, integer *, integer *, real 
    ...
    static integer minwrk, maxwrk;
     /* Subroutine */ int strsna_(char *, char *, logical *, integer *, 
...
/*     Scale A if MAX element outside range [SMLNUM,BIGNUM] */
    ...
    icond = 0;
    anrm = (real)slange_("M", n, n, &a[a_offset], lda, dum, (ftnlen)1);
    scalea = FALSE_;
...
/*     Balance the matrix and compute ABNRM */
    ...
    sgebal_(balanc, n, &a[a_offset], lda, ilo, ihi, &scale[1], &ierr, (ftnlen)
            1);
    *abnrm = (real)slange_("1", n, n, &a[a_offset], lda, dum, (ftnlen)1);
    if (scalea) {
        dum[0] = *abnrm;
...
/*        Normalize left eigenvectors and make largest component real */
        ...
        for (i__ = 1; i__ <= i__1; ++i__) {
            if (wi[i__] == 0.f) {
                scl = (real)(1.f / snrm2_(n, &vl[i__ * vl_dim1 + 1], &c__1));
                sscal_(n, &scl, &vl[i__ * vl_dim1 + 1], &c__1);
            } else if (wi[i__] > 0.f) {
                r__1 = (real)snrm2_(n, &vl[i__ * vl_dim1 + 1], &c__1);
                r__2 = (real)snrm2_(n, &vl[(i__ + 1) * vl_dim1 + 1], &c__1);
                scl = (real)(1.f / slapy2_(&r__1, &r__2));
                sscal_(n, &scl, &vl[i__ * vl_dim1 + 1], &c__1);
...
/*        Normalize right eigenvectors and make largest component real */
        ...
        for (i__ = 1; i__ <= i__1; ++i__) {
            if (wi[i__] == 0.f) {
                scl = (real)(1.f / snrm2_(n, &vr[i__ * vr_dim1 + 1], &c__1));
                sscal_(n, &scl, &vr[i__ * vr_dim1 + 1], &c__1);
            } else if (wi[i__] > 0.f) {
                r__1 = (real)snrm2_(n, &vr[i__ * vr_dim1 + 1], &c__1);
                r__2 = (real)snrm2_(n, &vr[(i__ + 1) * vr_dim1 + 1], &c__1);
                scl = (real)(1.f / slapy2_(&r__1, &r__2));
                sscal_(n, &scl, &vr[i__ * vr_dim1 + 1], &c__1);
