/* ../../../dependencies/lapack/src/zgetrf.f -- translated by f2c (version 20061008).
...
/* Subroutine */ static int zgetrf_(integer *m, integer *n, dcomplex *a, 
...
static integer c_n1 = -1;
    ...
    static integer i__, j, jb, nb, iinfo;
     /* Subroutine */ int zgemm_(char *, char *, integer *, integer *, 
            ...
            zgetf2_(integer *, integer *, dcomplex *, integer *, integer 
            *, integer *), xerbla_(char *, integer *, ftnlen);
     integer ilaenv_(integer *, char *, char *, integer *, integer *, 
            integer *, integer *, ftnlen, ftnlen);
     /* Subroutine */ int zlaswp_(integer *, dcomplex *, integer *,
