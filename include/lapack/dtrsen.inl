...
/* Subroutine */ static int dtrsen_(char *job, char *compq, logical *select, integer 
        ...
        liwork, integer *info, ftnlen job_len, ftnlen compq_len)
{
    ...
    static logical wantbh;
     /* Subroutine */ int dtrexc_(char *, integer *, doublereal *, 
            integer *, doublereal *, integer *, integer *, integer *, 
            doublereal *, integer *, ftnlen);
    static integer liwmin;
    static logical wantsp, lquery;
     /* Subroutine */ int dtrsyl_(char *, char *, integer *, integer *, 
            integer *, doublereal *, integer *, doublereal *, integer *, 
...
/*          .TRUE.; a scomplex conjugate pair of eigenvalues must be */
