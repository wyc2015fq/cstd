...
/* Subroutine */ static int cgeev_(char *jobvl, char *jobvr, integer *n, scomplex *a, 
        integer *lda, scomplex *w, scomplex *vl, integer *ldvl, scomplex *vr, 
        integer *ldvr, scomplex *work, integer *lwork, real *rwork, integer *
...
/*  CGEEV computes for an N-by-N scomplex nonsymmetric matrix A, the */
...
/* L10: */
            ...
            r__1 = (real)sqrt(rwork[irwork + k - 1]);
