...
/* Subroutine */ static int dgeqp3_(integer *m, integer *n, doublereal *a, integer *
...
static integer c__2 = 2;
    ...
    static integer minws;
     /* Subroutine */ int dlaqp2_(integer *, integer *, integer *, 
     ...
     /* Subroutine */ int dlaqps_(integer *, integer *, integer *, 
