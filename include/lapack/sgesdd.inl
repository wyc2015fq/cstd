...
/* Subroutine */ static int sgesdd_(char *jobz, integer *m, integer *n, real *a, 
        ...
        jobz_len)
{
    ...
    static integer chunk;
     /* Subroutine */ int sgemm_(char *, char *, integer *, integer *, 
    ...
    static integer bdspac;
     /* Subroutine */ int sbdsdc_(char *, char *, integer *, real *, 
    ...
    static real bignum;
     /* Subroutine */ int sgelqf_(integer *, integer *, real *, integer 
    ...
    static integer ldwrkl;
     /* Subroutine */ int sormbr_(char *, char *, char *, integer *, 
            integer *, integer *, real *, integer *, real *, real *, integer *
            , real *, integer *, integer *, ftnlen, ftnlen, ftnlen);
    static integer ldwrkr, minwrk, ldwrku, maxwrk;
     /* Subroutine */ int sorglq_(integer *, integer *, integer *, real 
...
/*     Scale A if MAX element outside range [SMLNUM,BIGNUM] */
    ...
    anrm = (real)slange_("M", m, n, &a[a_offset], lda, dum, (ftnlen)1);
    iscl = 0;
