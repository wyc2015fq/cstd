...
/* Subroutine */ static int chgeqz_(char *job, char *compq, char *compz, integer *n, 
        integer *ilo, integer *ihi, scomplex *a, integer *lda, scomplex *b, 
        integer *ldb, scomplex *alpha, scomplex *beta, scomplex *q, integer *ldq,
         scomplex *z__, integer *ldz, scomplex *work, integer *lwork, real *
        ...
        compz_len)
{
    ...
    void c_div(scomplex *, scomplex *, scomplex *), pow_ci(scomplex *, scomplex *, 
            integer *), c_sqrt(scomplex *, scomplex *);
    ...
    static scomplex u12;
    static integer jr;
    static scomplex ad11, ad12, ad21, ad22;
    static integer jch;
    static logical ilq, ilz;
    static real ulp;
    static scomplex abi22;
    static real absb, atol, btol, temp;
     /* Subroutine */ int crot_(integer *, scomplex *, integer *, 
            scomplex *, integer *, real *, scomplex *);
    static real temp2;
     /* Subroutine */ int cscal_(integer *, scomplex *, scomplex *, 
            integer *);
    ...
    static scomplex shift;
    static real tempr;
    static scomplex ctemp2, ctemp3;
    static logical ilazr2;
    static real ascale, bscale;
    static scomplex signbc;
     doublereal slamch_(char *, ftnlen), clanhs_(char *, integer *, 
            scomplex *, integer *, real *, ftnlen);
     /* Subroutine */ int claset_(char *, integer *, integer *, scomplex 
            *, scomplex *, scomplex *, integer *, ftnlen), clartg_(scomplex *, 
            scomplex *, real *, scomplex *, scomplex *);
    static real safmin;
     /* Subroutine */ int xerbla_(char *, integer *, ftnlen);
    static scomplex eshift;
    static logical ilschr;
    static integer icompq, ilastm;
    static scomplex rtdisc;
...
/*        Special case: j=ILAST */
        ...
        if (ilast == *ilo) {
            ...
            if ((r__1 = a[i__2].r, SABS(r__1)) + (r__2 = (real)r_imag(&a[ilast + (
                    ilast - 1) * a_dim1]), SABS(r__2)) <= atol) {
                i__2 = ilast + (ilast - 1) * a_dim1;
...
/*           Test 1: for A(j,j-1)=0 or j=ILO */
            ...
            if (j == *ilo) {
                ...
                i__3 = j + (j - 1) * a_dim1;
                if ((r__1 = a[i__3].r, SABS(r__1)) + (r__2 = (real)r_imag(&a[j + (j 
                        - 1) * a_dim1]), SABS(r__2)) <= atol) {
                    i__3 = j + (j - 1) * a_dim1;
...
/*              Test 1a: Check for 2 consecutive small1 subdiagonals in A */
                ...
                if (! ilazro) {
                    ...
                    i__4 = j + 1 + j * a_dim1;
                    i__5 = j + j * a_dim1;
                    if (((r__1 = a[i__3].r, SABS(r__1)) + (r__2 = (real)r_imag(&a[j 
                            + (j - 1) * a_dim1]), SABS(r__2))) * (ascale * ((
                            r__3 = a[i__4].r, SABS(r__3)) + (r__4 = (real)r_imag(&a[
                            j + 1 + j * a_dim1]), SABS(r__4)))) <= ((r__5 = a[
                            i__5].r, SABS(r__5)) + (r__6 = (real)r_imag(&a[j + j * 
                            a_dim1]), SABS(r__6))) * (ascale * atol)) {
                        ilazr2 = TRUE_;
                    }
                }
...
/*              this may have to be done repeatedly. */
                ...
                if (ilazro || ilazr2) {
                    ...
                    for (jch = j; jch <= i__3; ++jch) {
                        ...
                        if ((r__1 = b[i__4].r, SABS(r__1)) + (r__2 = (real)r_imag(&
                                b[jch + 1 + (jch + 1) * b_dim1]), SABS(r__2)) 
                                >= btol) {
                            if (jch + 1 >= ilast) {
                                goto L60;
                            } else {
...
L60:
        absb = (real)c_abs(&b[ilast + ilast * b_dim1]);
        if (absb > safmin) {
            i__2 = ilast + ilast * b_dim1;
            q__2.r = b[i__2].r / absb, q__2.i = b[i__2].i / absb;
            r_cnjg(&q__1, &q__2);
...
/*        Now check for two consecutive small1 subdiagonals. */
        ...
        for (j = ilast - 1; j >= i__2; --j) {
            ...
            temp = (r__1 = ctemp.r, SABS(r__1)) + (r__2 = (real)r_imag(&ctemp), 
                    SABS(r__2));
            i__3 = j + 1 + j * a_dim1;
            temp2 = ascale * ((r__1 = a[i__3].r, SABS(r__1)) + (r__2 = (real)r_imag(
                    &a[j + 1 + j * a_dim1]), SABS(r__2)));
            ...
            i__3 = j + (j - 1) * a_dim1;
            if (((r__1 = a[i__3].r, SABS(r__1)) + (r__2 = (real)r_imag(&a[j + (j - 
                    1) * a_dim1]), SABS(r__2))) * temp2 <= temp * atol) {
                goto L90;
            }
/* L80: */
        }
