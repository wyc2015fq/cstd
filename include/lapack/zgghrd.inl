...
/* Subroutine */ static int zgghrd_(char *compq, char *compz, integer *n, integer *
        ilo, integer *ihi, dcomplex *a, integer *lda, dcomplex *b, 
        integer *ldb, dcomplex *q, integer *ldq, dcomplex *z__, 
        integer *ldz, integer *info, ftnlen compq_len, ftnlen compz_len)
{
    ...
    static integer icompq, icompz;
     /* Subroutine */ int zlaset_(char *, integer *, integer *, 
            ...
            ftnlen), zlartg_(dcomplex *, dcomplex *, doublereal *, 
            dcomplex *, dcomplex *);
