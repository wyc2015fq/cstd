...
/* Subroutine */ static int cungqr_(integer *m, integer *n, integer *k, scomplex *a, 
...
static integer c__2 = 2;
    ...
    static integer i__, j, l, ib, nb, ki, kk, nx, iws, nbmin, iinfo;
     /* Subroutine */ int cung2r_(integer *, integer *, integer *, 
...
/*  CUNGQR generates an M-by-N scomplex matrix Q with orthonormal columns, */
