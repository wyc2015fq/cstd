...
/* Subroutine */ static int clahrd_(integer *n, integer *k, integer *nb, scomplex *a, 
        integer *lda, scomplex *tau, scomplex *t, integer *ldt, scomplex *y, 
        integer *ldy)
{
...
static integer c__1 = 1;
    ...
    static scomplex ei;
     /* Subroutine */ int cscal_(integer *, scomplex *, scomplex *, 
            integer *), cgemv_(char *, integer *, integer *, scomplex *, 
            ...
            integer *, scomplex *, integer *), ctrmv_(char *, char *, char *, 
            integer *, scomplex *, integer *, scomplex *, integer *, ftnlen, 
            ftnlen, ftnlen), clarfg_(integer *, scomplex *, scomplex *, integer 
            *, scomplex *), clacgv_(integer *, scomplex *, integer *);
...
/*  CLAHRD reduces the first NB columns of a scomplex general n-by-(n-k+1) */
