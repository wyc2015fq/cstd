...
/* Subroutine */ static int ctrmm_(char *side, char *uplo, char *transa, char *diag, 
        integer *m, integer *n, scomplex *alpha, scomplex *a, integer *lda, 
        scomplex *b, integer *ldb, ftnlen side_len, ftnlen uplo_len, ftnlen 
