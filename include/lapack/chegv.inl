...
/* Subroutine */ static int chegv_(integer *itype, char *jobz, char *uplo, integer *
        n, scomplex *a, integer *lda, scomplex *b, integer *ldb, real *w, 
        scomplex *work, integer *lwork, real *rwork, integer *info, ftnlen 
        jobz_len, ftnlen uplo_len)
{
    ...
    static integer nb, neig;
     /* Subroutine */ int cheev_(char *, char *, integer *, scomplex *, 
            integer *, real *, scomplex *, integer *, real *, integer *, 
            ftnlen, ftnlen);
    ...
    static logical upper, wantz;
     /* Subroutine */ int chegst_(integer *, char *, integer *, scomplex 
            *, integer *, scomplex *, integer *, integer *, ftnlen);
     integer ilaenv_(integer *, char *, char *, integer *, integer *, 
            integer *, integer *, ftnlen, ftnlen);
     /* Subroutine */ int xerbla_(char *, integer *, ftnlen), cpotrf_(
            char *, integer *, scomplex *, integer *, integer *, ftnlen);
