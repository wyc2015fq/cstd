...
/* Subroutine */ static int dtrevc_(char *side, char *howmny, logical *select, 
...
static logical c_true = TRUE_;
    ...
    static logical leftv, bothv;
     /* Subroutine */ int daxpy_(integer *, doublereal *, doublereal *, 
            integer *, doublereal *, integer *);
    static doublereal vcrit;
    static logical somev;
    static doublereal xnorm;
     /* Subroutine */ int dlaln2_(logical *, integer *, integer *, 
