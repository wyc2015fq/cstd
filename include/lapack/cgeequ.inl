...
/* Subroutine */ static int cgeequ_(integer *m, integer *n, scomplex *a, integer *lda,
...
/* Computing MAX */
            i__3 = i__ + j * a_dim1;
            r__3 = r__[i__], r__4 = (r__1 = a[i__3].r, SABS(r__1)) + (r__2 = 
                    (real)r_imag(&a[i__ + j * a_dim1]), SABS(r__2));
...
/* Computing MAX */
            i__3 = i__ + j * a_dim1;
            r__3 = c__[j], r__4 = ((r__1 = a[i__3].r, SABS(r__1)) + (r__2 = 
                    (real)r_imag(&a[i__ + j * a_dim1]), SABS(r__2))) * r__[i__];
