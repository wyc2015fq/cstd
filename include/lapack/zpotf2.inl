...
/* Subroutine */ static int zpotf2_(char *uplo, integer *n, dcomplex *a, 
        integer *lda, integer *info, ftnlen uplo_len)
{
    ...
    static logical upper;
     /* Subroutine */ int xerbla_(char *, integer *, ftnlen), zdscal_(
            integer *, doublereal *, dcomplex *, integer *), zlacgv_(
...
/*  ZPOTF2 computes the Cholesky factorization of a scomplex Hermitian */
