...
/* Subroutine */ static int ctrexc_(char *compq, integer *n, scomplex *t, integer *
        ldt, scomplex *q, integer *ldq, integer *ifst, integer *ilst, integer *
...
static integer c__1 = 1;
    ...
    static real cs;
    static scomplex t11, t22, sn, temp;
     /* Subroutine */ int crot_(integer *, scomplex *, integer *, 
            scomplex *, integer *, real *, scomplex *);
     logical lsame_(char *, char *, ftnlen, ftnlen);
    static logical wantq;
     /* Subroutine */ int clartg_(scomplex *, scomplex *, real *, scomplex 
            *, scomplex *), xerbla_(char *, integer *, ftnlen);
