...
/* Subroutine */ static int ctrevc_(char *side, char *howmny, logical *select, 
        integer *n, scomplex *t, integer *ldt, scomplex *vl, integer *ldvl, 
        scomplex *vr, integer *ldvr, integer *mm, integer *m, scomplex *work, 
    ...
    static logical leftv, bothv, somev;
     ...
     /* Subroutine */ int csscal_(integer *, real *, scomplex *, integer 
            *), xerbla_(char *, integer *, ftnlen), clatrs_(char *, char *, 
            char *, char *, integer *, scomplex *, integer *, scomplex *, real *
...
/*  a scomplex upper triangular matrix T. */
...
/*     part of T to control overflow in triangular solver. */
    ...
    for (j = 2; j <= i__1; ++j) {
        i__2 = j - 1;
        rwork[j] = (real)scasum_(&i__2, &t[j * t_dim1 + 1], &c__1);
/* L30: */
    }
...
/* Computing MAX */
            i__1 = ki + ki * t_dim1;
            r__3 = ulp * ((r__1 = t[i__1].r, SABS(r__1)) + (r__2 = (real)r_imag(&t[
                    ki + ki * t_dim1]), SABS(r__2)));
...
/*              (T(1:KI-1,1:KI-1) - T(KI,KI))*X = SCALE*WORK. */
            ...
            for (k = 1; k <= i__1; ++k) {
                ...
                i__2 = k + k * t_dim1;
                if ((r__1 = t[i__2].r, SABS(r__1)) + (r__2 = (real)r_imag(&t[k + k *
                         t_dim1]), SABS(r__2)) < smin) {
                    i__3 = k + k * t_dim1;
...
/*           Copy the vector x or Q*x to VR and normalize. */
            ...
            if (! over) {
                ...
                i__1 = ii + is * vr_dim1;
                remax = (real)(1.f / ((r__1 = vr[i__1].r, SABS(r__1)) + (r__2 = 
                        (real)r_imag(&vr[ii + is * vr_dim1]), SABS(r__2))));
...
/* L60: */
                ...
                i__1 = ii + ki * vr_dim1;
                remax = (real)(1.f / ((r__1 = vr[i__1].r, SABS(r__1)) + (r__2 = 
                        (real)r_imag(&vr[ii + ki * vr_dim1]), SABS(r__2))));
...
/* Computing MAX */
            i__2 = ki + ki * t_dim1;
            r__3 = ulp * ((r__1 = t[i__2].r, SABS(r__1)) + (r__2 = (real)r_imag(&t[
                    ki + ki * t_dim1]), SABS(r__2)));
            smin = dmax(r__3,smlnum);
...
/*              (T(KI+1:N,KI+1:N) - T(KI,KI))'*X = SCALE*WORK. */
            ...
            for (k = ki + 1; k <= i__2; ++k) {
                ...
                i__3 = k + k * t_dim1;
                if ((r__1 = t[i__3].r, SABS(r__1)) + (r__2 = (real)r_imag(&t[k + k *
                         t_dim1]), SABS(r__2)) < smin) {
                    i__4 = k + k * t_dim1;
...
/*           Copy the vector x or Q*x to VL and normalize. */
            ...
            if (! over) {
                ...
                i__2 = ii + is * vl_dim1;
                remax = 1.f / ((r__1 = vl[i__2].r, SABS(r__1)) + (r__2 = 
                        (real)r_imag(&vl[ii + is * vl_dim1]), SABS(r__2)));
                i__2 = *n - ki + 1;
...
/* L110: */
                ...
                i__2 = ii + ki * vl_dim1;
                remax = 1.f / ((r__1 = vl[i__2].r, SABS(r__1)) + (r__2 = 
                        (real)r_imag(&vl[ii + ki * vl_dim1]), SABS(r__2)));
