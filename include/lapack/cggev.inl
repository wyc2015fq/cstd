...
/* Subroutine */ static int cggev_(char *jobvl, char *jobvr, integer *n, scomplex *a, 
        integer *lda, scomplex *b, integer *ldb, scomplex *alpha, scomplex *beta,
         scomplex *vl, integer *ldvl, scomplex *vr, integer *ldvr, scomplex *
        ...
        ftnlen jobvr_len)
{
    ...
    static integer ileft, icols, irwrk, irows;
     /* Subroutine */ int cggbak_(char *, char *, integer *, integer *, 
            integer *, real *, real *, integer *, scomplex *, integer *, 
            integer *, ftnlen, ftnlen), cggbal_(char *, integer *, scomplex *, 
            integer *, scomplex *, integer *, integer *, integer *, real *, 
            real *, real *, integer *, ftnlen), slabad_(real *, real *);
     doublereal clange_(char *, integer *, integer *, scomplex *, 
            integer *, real *, ftnlen);
     /* Subroutine */ int cgghrd_(char *, char *, integer *, integer *, 
            integer *, scomplex *, integer *, scomplex *, integer *, scomplex *, 
            integer *, scomplex *, integer *, integer *, ftnlen, ftnlen), 
            clascl_(char *, integer *, integer *, real *, real *, integer *, 
            integer *, scomplex *, integer *, integer *, ftnlen);
    static logical ilascl, ilbscl;
     /* Subroutine */ int cgeqrf_(integer *, integer *, scomplex *, 
            integer *, scomplex *, scomplex *, integer *, integer *);
     doublereal slamch_(char *, ftnlen);
     /* Subroutine */ int clacpy_(char *, integer *, integer *, scomplex 
            *, integer *, scomplex *, integer *, ftnlen), claset_(char *, 
            integer *, integer *, scomplex *, scomplex *, scomplex *, integer *, 
            ftnlen), ctgevc_(char *, char *, logical *, integer *, scomplex *, 
            integer *, scomplex *, integer *, scomplex *, integer *, scomplex *, 
            integer *, integer *, integer *, scomplex *, real *, integer *, 
            ftnlen, ftnlen), xerbla_(char *, integer *, ftnlen);
    static logical ldumma[1];
    static char chtemp[1];
    static real bignum;
     /* Subroutine */ int chgeqz_(char *, char *, char *, integer *, 
            integer *, integer *, scomplex *, integer *, scomplex *, integer *, 
            scomplex *, scomplex *, scomplex *, integer *, scomplex *, integer *, 
            scomplex *, integer *, real *, integer *, ftnlen, ftnlen, ftnlen);
     integer ilaenv_(integer *, char *, char *, integer *, integer *, 
            integer *, integer *, ftnlen, ftnlen);
    static integer ijobvl, iright, ijobvr;
     /* Subroutine */ int cungqr_(integer *, integer *, integer *, 
            scomplex *, integer *, scomplex *, scomplex *, integer *, integer *);
    static real anrmto;
    static integer lwkmin;
    static real bnrmto;
     /* Subroutine */ int cunmqr_(char *, char *, integer *, integer *, 
            integer *, scomplex *, integer *, scomplex *, scomplex *, integer *, 
            scomplex *, integer *, integer *, ftnlen, ftnlen);
    static real smlnum;
...
/*  CGGEV computes for a pair of N-by-N scomplex nonsymmetric matrices */
...
/*     Get machine constants */
    ...
    eps = (real)slamch_("E", (ftnlen)1) * slamch_("B", (ftnlen)1);
...
/* Computing MAX */
                    i__3 = jr + jc * vl_dim1;
                    r__3 = temp, r__4 = (r__1 = vl[i__3].r, SABS(r__1)) + (
                            r__2 = (real)r_imag(&vl[jr + jc * vl_dim1]), SABS(r__2))
                            ;
                    temp = dmax(r__3,r__4);
/* L10: */
                }
...
/* Computing MAX */
                    i__3 = jr + jc * vr_dim1;
                    r__3 = temp, r__4 = (r__1 = vr[i__3].r, SABS(r__1)) + (
                            r__2 = (real)r_imag(&vr[jr + jc * vr_dim1]), SABS(r__2))
                            ;
                    temp = dmax(r__3,r__4);
/* L40: */
                }
