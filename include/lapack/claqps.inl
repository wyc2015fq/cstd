...
/* Subroutine */ static int claqps_(integer *m, integer *n, integer *offset, integer 
        *nb, integer *kb, scomplex *a, integer *lda, integer *jpvt, scomplex *
        tau, real *vn1, real *vn2, scomplex *auxv, scomplex *f, integer *ldf)
{
...
static integer c__1 = 1;
    ...
    static real temp, temp2;
     /* Subroutine */ int cgemm_(char *, char *, integer *, integer *, 
            ...
            scomplex *, scomplex *, integer *, ftnlen, ftnlen), cgemv_(char *, 
            integer *, integer *, scomplex *, scomplex *, integer *, scomplex *, 
            integer *, scomplex *, scomplex *, integer *, ftnlen), cswap_(
            integer *, scomplex *, integer *, scomplex *, integer *);
...
/*        Update partial column norms. */
        ...
        if (rk < lastrk) {
            ...
            for (j = k + 1; j <= i__1; ++j) {
                if (vn1[j] != 0.f) {
                    temp = (real)c_abs(&a[rk + j * a_dim1]) / vn1[j];
/* Computing MAX */
...
L60:
    if (lsticc > 0) {
        ...
        i__1 = *m - rk;
        vn1[lsticc] = (real)scnrm2_(&i__1, &a[rk + 1 + lsticc * a_dim1], &c__1);
