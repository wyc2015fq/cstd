...
/* Subroutine */ static int cungtr_(char *uplo, integer *n, scomplex *a, integer *lda,
         scomplex *tau, scomplex *work, integer *lwork, integer *info, ftnlen 
        uplo_len)
{
...
static integer c_n1 = -1;
    ...
    static logical upper;
     ...
     /* Subroutine */ int cungql_(integer *, integer *, integer *, 
            scomplex *, integer *, scomplex *, scomplex *, integer *, integer *),
             cungqr_(integer *, integer *, integer *, scomplex *, integer *, 
