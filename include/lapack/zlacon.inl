...
/* Subroutine */ static int zlacon_(integer *n, dcomplex *v, dcomplex *x, 
...
static integer c__1 = 1;
    ...
    static integer jlast;
     /* Subroutine */ int zcopy_(integer *, dcomplex *, integer *, 
            dcomplex *, integer *);
     integer izmax1_(integer *, dcomplex *, integer *);
     doublereal dzsum1_(integer *, dcomplex *, integer *), dlamch_(
            char *, ftnlen);
...
/*  ZLACON estimates the 1-norm of a square, scomplex matrix A. */
