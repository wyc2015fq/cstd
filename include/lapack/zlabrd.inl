...
/* Subroutine */ static int zlabrd_(integer *m, integer *n, integer *nb, 
        dcomplex *a, integer *lda, doublereal *d__, doublereal *e, 
        dcomplex *tauq, dcomplex *taup, dcomplex *x, integer *
        ldx, dcomplex *y, integer *ldy)
{
    ...
    static dcomplex alpha;
     /* Subroutine */ int zscal_(integer *, dcomplex *, 
            ...
            zlarfg_(integer *, dcomplex *, dcomplex *, integer *, 
            dcomplex *), zlacgv_(integer *, dcomplex *, integer *);
...
/*  ZLABRD reduces the first NB rows and columns of a scomplex general */
