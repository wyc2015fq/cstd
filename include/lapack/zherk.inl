...
/* Subroutine */ static int zherk_(char *uplo, char *trans, integer *n, integer *k, 
        doublereal *alpha, dcomplex *a, integer *lda, doublereal *beta, 
        dcomplex *c__, integer *ldc, ftnlen uplo_len, ftnlen trans_len)
{
