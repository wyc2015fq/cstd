...
/* Subroutine */ static int cgesvd_(char *jobu, char *jobvt, integer *m, integer *n, 
        scomplex *a, integer *lda, real *s, scomplex *u, integer *ldu, scomplex *
        vt, integer *ldvt, scomplex *work, integer *lwork, real *rwork, 
        integer *info, ftnlen jobu_len, ftnlen jobvt_len)
{
    ...
    static logical wntua, wntva, wntun, wntuo, wntvn, wntvo, wntus, wntvs;
     /* Subroutine */ int cgebrd_(integer *, integer *, scomplex *, 
            integer *, real *, real *, scomplex *, scomplex *, scomplex *, 
            integer *, integer *);
     doublereal clange_(char *, integer *, integer *, scomplex *, 
            integer *, real *, ftnlen);
     /* Subroutine */ int cgelqf_(integer *, integer *, scomplex *, 
            integer *, scomplex *, scomplex *, integer *, integer *), clascl_(
            char *, integer *, integer *, real *, real *, integer *, integer *
            , scomplex *, integer *, integer *, ftnlen), cgeqrf_(integer *, 
     ...
     /* Subroutine */ int clacpy_(char *, integer *, integer *, scomplex 
            ...
            *, real *, real *, scomplex *, integer *, scomplex *, integer *, 
            scomplex *, integer *, real *, integer *, ftnlen), xerbla_(char *, 
    ...
    static real bignum;
     ...
     /* Subroutine */ int cunmbr_(char *, char *, char *, integer *, 
            integer *, integer *, scomplex *, integer *, scomplex *, scomplex *, 
            integer *, scomplex *, integer *, integer *, ftnlen, ftnlen, 
            ftnlen), cunglq_(integer *, integer *, integer *, scomplex *, 
            integer *, scomplex *, scomplex *, integer *, integer *), cungqr_(
...
/*     Get machine constants */
    ...
    smlnum = (real)sqrt(slamch_("S", (ftnlen)1)) / eps;
    bignum = 1.f / smlnum;
