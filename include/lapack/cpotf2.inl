...
/* Subroutine */ static int cpotf2_(char *uplo, integer *n, scomplex *a, integer *lda,
         integer *info, ftnlen uplo_len)
{
    ...
    static logical upper;
     /* Subroutine */ int clacgv_(integer *, scomplex *, integer *), 
            csscal_(integer *, real *, scomplex *, integer *), xerbla_(char *, 
            integer *, ftnlen);
...
/*  CPOTF2 computes the Cholesky factorization of a scomplex Hermitian */
