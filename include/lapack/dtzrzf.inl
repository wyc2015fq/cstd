...
/* Subroutine */ static int dtzrzf_(integer *m, integer *n, doublereal *a, integer *
...
static integer c__2 = 2;
    ...
    static integer i__, m1, ib, nb, ki, kk, mu, nx, iws, nbmin;
     /* Subroutine */ int xerbla_(char *, integer *, ftnlen), dlarzb_(
     ...
     /* Subroutine */ int dlarzt_(char *, char *, integer *, integer *, 
