...
/* Subroutine */ static int clarzb_(char *side, char *trans, char *direct, char *
        storev, integer *m, integer *n, integer *k, integer *l, scomplex *v, 
        integer *ldv, scomplex *t, integer *ldt, scomplex *c__, integer *ldc, 
        scomplex *work, integer *ldwork, ftnlen side_len, ftnlen trans_len, 
...
static integer c__1 = 1;
    ...
    static integer i__, j, info;
     ...
     /* Subroutine */ int ccopy_(integer *, scomplex *, integer *, 
            scomplex *, integer *), ctrmm_(char *, char *, char *, char *, 
...
/*  CLARZB applies a scomplex block reflector H or its transpose H**H */
