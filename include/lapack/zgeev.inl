...
/* Subroutine */ static int zgeev_(char *jobvl, char *jobvr, integer *n, 
        dcomplex *a, integer *lda, dcomplex *w, dcomplex *vl, 
        ...
        ftnlen jobvr_len)
{
    ...
    static doublereal cscale;
     /* Subroutine */ int zgebak_(char *, char *, integer *, integer *, 
            integer *, doublereal *, integer *, dcomplex *, integer *, 
    ...
    static logical lquery, wantvr;
     /* Subroutine */ int zunghr_(integer *, integer *, integer *, 
            dcomplex *, integer *, dcomplex *, dcomplex *, 
            integer *, integer *);
