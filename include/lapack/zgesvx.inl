...
/* Subroutine */ static int zgesvx_(char *fact, char *trans, integer *n, integer *
        nrhs, dcomplex *a, integer *lda, dcomplex *af, integer *
        ldaf, integer *ipiv, char *equed, doublereal *r__, doublereal *c__, 
        dcomplex *b, integer *ldb, dcomplex *x, integer *ldx, 
        doublereal *rcond, doublereal *ferr, doublereal *berr, dcomplex *
        ...
        trans_len, ftnlen equed_len)
{
    ...
    static doublereal bignum;
     /* Subroutine */ int zlaqge_(integer *, integer *, dcomplex *,
             integer *, doublereal *, doublereal *, doublereal *, doublereal *
            , doublereal *, char *, ftnlen), zgecon_(char *, integer *, 
            dcomplex *, integer *, doublereal *, doublereal *, 
            dcomplex *, doublereal *, integer *, ftnlen);
    static integer infequ;
    static logical colequ;
    static doublereal rowcnd;
     /* Subroutine */ int zgeequ_(integer *, integer *, dcomplex *,
             integer *, doublereal *, doublereal *, doublereal *, doublereal *
            , doublereal *, integer *);
    static logical notran;
     /* Subroutine */ int zgerfs_(char *, integer *, integer *, 
            dcomplex *, integer *, dcomplex *, integer *, integer *,
             dcomplex *, integer *, dcomplex *, integer *, 
            doublereal *, doublereal *, dcomplex *, doublereal *, 
            integer *, ftnlen), zgetrf_(integer *, integer *, dcomplex *,
             integer *, integer *, integer *), zlacpy_(char *, integer *, 
            integer *, dcomplex *, integer *, dcomplex *, integer *,
             ftnlen);
     doublereal zlantr_(char *, char *, char *, integer *, integer *, 
            dcomplex *, integer *, doublereal *, ftnlen, ftnlen, ftnlen);
    static doublereal smlnum;
     /* Subroutine */ int zgetrs_(char *, integer *, integer *, 
