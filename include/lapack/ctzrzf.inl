...
/* Subroutine */ static int ctzrzf_(integer *m, integer *n, scomplex *a, integer *lda,
...
static integer c__2 = 2;
    ...
    static integer i__, m1, ib, nb, ki, kk, mu, nx, iws, nbmin;
     /* Subroutine */ int clarzb_(char *, char *, char *, char *, 
            integer *, integer *, integer *, integer *, scomplex *, integer *, 
     ...
     /* Subroutine */ int clarzt_(char *, char *, integer *, integer *, 
            scomplex *, integer *, scomplex *, scomplex *, integer *, ftnlen, 
            ftnlen), clatrz_(integer *, integer *, integer *, scomplex *, 
            integer *, scomplex *, scomplex *);
