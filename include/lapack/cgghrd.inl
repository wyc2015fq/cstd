...
/* Subroutine */ static int cgghrd_(char *compq, char *compz, integer *n, integer *
        ilo, integer *ihi, scomplex *a, integer *lda, scomplex *b, integer *ldb,
         scomplex *q, integer *ldq, scomplex *z__, integer *ldz, integer *info, 
    ...
    static scomplex ctemp;
     /* Subroutine */ int claset_(char *, integer *, integer *, scomplex 
            *, scomplex *, scomplex *, integer *, ftnlen), clartg_(scomplex *, 
            scomplex *, real *, scomplex *, scomplex *), xerbla_(char *, integer 
            *, ftnlen);
...
/*  CGGHRD reduces a pair of scomplex matrices (A,B) to generalized upper */
