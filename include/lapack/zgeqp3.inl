...
/* Subroutine */ static int zgeqp3_(integer *m, integer *n, dcomplex *a, 
        integer *lda, integer *jpvt, dcomplex *tau, dcomplex *work, 
...
static integer c__2 = 2;
    ...
    static integer j, jb, na, nb, sm, sn, nx, fjb, iws, nfxd, nbmin, minmn, 
            minws;
     /* Subroutine */ int zswap_(integer *, dcomplex *, integer *, 
            dcomplex *, integer *), zlaqp2_(integer *, integer *, 
            integer *, dcomplex *, integer *, integer *, dcomplex *,
             doublereal *, doublereal *, dcomplex *);
    ...
    static integer topbmn, sminmn;
     /* Subroutine */ int zlaqps_(integer *, integer *, integer *, 
            integer *, integer *, dcomplex *, integer *, integer *, 
            dcomplex *, doublereal *, doublereal *, dcomplex *, 
            dcomplex *, integer *);
