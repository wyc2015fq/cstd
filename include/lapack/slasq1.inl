...
/* Subroutine */ static int slasq1_(integer *n, real *d__, real *e, real *work, 
        integer *info)
{
    ...
    static real safmin;
     /* Subroutine */ int xerbla_(char *, integer *, ftnlen), slascl_(
...
/*     Estimate the largest singular value. */
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
        d__[i__] = (r__1 = d__[i__], SABS(r__1));
/* Computing MAX */
        r__2 = sigmx, r__3 = (r__1 = e[i__], SABS(r__1));
        sigmx = dmax(r__2,r__3);
/* L10: */
    }
    d__[*n] = (r__1 = d__[*n], SABS(r__1));
