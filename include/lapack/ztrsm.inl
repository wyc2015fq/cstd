...
/* Subroutine */ static int ztrsm_(char *side, char *uplo, char *transa, char *diag, 
        integer *m, integer *n, dcomplex *alpha, dcomplex *a, 
        integer *lda, dcomplex *b, integer *ldb, ftnlen side_len, ftnlen 
...
static dcomplex c_b1 = {1.,0.};
    ...
    /* Builtin functions */
    void z_div(dcomplex *, dcomplex *, dcomplex *), d_cnjg(
            dcomplex *, dcomplex *);
