...
/* Subroutine */ static int sggbal_(char *job, integer *n, real *a, integer *lda, 
...
L350:
    ...
    for (i__ = *ilo; i__ <= i__1; ++i__) {
        ...
        rab = (r__1 = a[i__ + (irab + *ilo - 1) * a_dim1], SABS(r__1));
        i__2 = *n - *ilo + 1;
        irab = isamax_(&i__2, &b[i__ + *ilo * b_dim1], lda);
/* Computing MAX */
        r__2 = rab, r__3 = (r__1 = b[i__ + (irab + *ilo - 1) * b_dim1], SABS(
                r__1));
        rab = dmax(r__2,r__3);
        r__1 = rab + sfmin;
...
/* Computing MIN */
        ...
        cab = (r__1 = a[icab + i__ * a_dim1], SABS(r__1));
        icab = isamax_(ihi, &b[i__ * b_dim1 + 1], &c__1);
/* Computing MAX */
        r__2 = cab, r__3 = (r__1 = b[icab + i__ * b_dim1], SABS(r__1));
        cab = dmax(r__2,r__3);
        r__1 = cab + sfmin;
