...
/* Subroutine */ static int sgesvx_(char *fact, char *trans, integer *n, integer *
        ...
        ftnlen equed_len)
{
    ...
    static logical nofact;
     /* Subroutine */ int slaqge_(integer *, integer *, real *, integer 
    ...
    static logical colequ;
     /* Subroutine */ int sgeequ_(integer *, integer *, real *, integer 
    ...
    static logical notran;
     doublereal slantr_(char *, char *, char *, integer *, integer *, 
            real *, integer *, real *, ftnlen, ftnlen, ftnlen);
     /* Subroutine */ int sgetrs_(char *, integer *, integer *, real *, 
...
/*              leading rank-deficient INFO columns of A. */
                ...
                rpvgrw = (real)slantr_("M", "U", "N", info, info, &af[af_offset], 
                        ldaf, &work[1], (ftnlen)1, (ftnlen)1, (ftnlen)1);
                if (rpvgrw == 0.f) {
                    rpvgrw = 1.f;
                } else {
                    rpvgrw = (real)slange_("M", n, info, &a[a_offset], lda, &work[1]
                            , (ftnlen)1) / rpvgrw;
                }
                work[1] = rpvgrw;
                *rcond = 0.f;
...
/*     reciprocal pivot growth factor RPVGRW. */
    ...
    anorm = (real)slange_(norm, n, n, &a[a_offset], lda, &work[1], (ftnlen)1);
    rpvgrw = (real)slantr_("M", "U", "N", n, n, &af[af_offset], ldaf, &work[1], (
            ftnlen)1, (ftnlen)1, (ftnlen)1);
    if (rpvgrw == 0.f) {
        rpvgrw = 1.f;
    } else {
        rpvgrw = (real)slange_("M", n, n, &a[a_offset], lda, &work[1], (ftnlen)1) / 
                rpvgrw;
    }
