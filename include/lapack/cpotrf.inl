...
/* Subroutine */ static int cpotrf_(char *uplo, integer *n, scomplex *a, integer *lda,
         integer *info, ftnlen uplo_len)
{
    ...
    static integer j, jb, nb;
     /* Subroutine */ int cgemm_(char *, char *, integer *, integer *, 
            ...
            scomplex *, scomplex *, integer *, ftnlen, ftnlen), cherk_(char *, 
            char *, integer *, integer *, real *, scomplex *, integer *, real *
    ...
    static logical upper;
     /* Subroutine */ int cpotf2_(char *, integer *, scomplex *, integer 
...
/*  CPOTRF computes the Cholesky factorization of a scomplex Hermitian */
