...
/* Subroutine */ static int cbdsqr_(char *uplo, integer *n, integer *ncvt, integer *
        nru, integer *ncc, real *d__, real *e, scomplex *vt, integer *ldvt, 
        scomplex *u, integer *ldu, scomplex *c__, integer *ldc, real *rwork, 
        integer *info, ftnlen uplo_len)
{
    ...
    static real unfl, sinl, cosr, smin, smax, sinr;
     /* Subroutine */ int slas2_(real *, real *, real *, real *, real *)
            ;
     logical lsame_(char *, char *, ftnlen, ftnlen);
    static real oldcs;
     /* Subroutine */ int clasr_(char *, char *, char *, integer *, 
            integer *, real *, real *, scomplex *, integer *, ftnlen, ftnlen, 
            ftnlen);
    static integer oldll;
    static real shift, sigmn, oldsn;
     /* Subroutine */ int cswap_(integer *, scomplex *, integer *, 
            scomplex *, integer *);
    static integer maxit;
    static real sminl, sigmx;
    static logical lower;
     /* Subroutine */ int csrot_(integer *, scomplex *, integer *, 
            scomplex *, integer *, real *, real *), slasq1_(integer *, real *, 
...
/*  or Q' * C, for given scomplex input matrices U, VT, and C. */
...
/*     Get machine constants */
    ...
    eps = (real)slamch_("Epsilon", (ftnlen)7);
    unfl = (real)slamch_("Safe minimum", (ftnlen)12);
...
/*     Compute approximate maximum, minimum singular values */
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
/* Computing MAX */
        r__2 = smax, r__3 = (r__1 = d__[i__], SABS(r__1));
        smax = dmax(r__2,r__3);
/* L20: */
    }
    i__1 = *n - 1;
    for (i__ = 1; i__ <= i__1; ++i__) {
/* Computing MAX */
        r__2 = smax, r__3 = (r__1 = e[i__], SABS(r__1));
        smax = dmax(r__2,r__3);
/* L30: */
    }
    sminl = 0.f;
...
/*        Relative accuracy desired */
        ...
        for (i__ = 2; i__ <= i__1; ++i__) {
            mu = (r__2 = d__[i__], SABS(r__2)) * (mu / (mu + (r__1 = e[i__ - 
                    1], SABS(r__1))));
...
/* Computing MAX */
        r__1 = SABS(tol) * smax, r__2 = *n * 6 * *n * unfl;
        thresh = dmax(r__1,r__2);
    }
...
/*     Find diagonal block of matrix to work on */
    ...
    if (tol < 0.f && (r__1 = d__[m], SABS(r__1)) <= thresh) {
        d__[m] = 0.f;
    }
    smax = (r__1 = d__[m], SABS(r__1));
    smin = smax;
    i__1 = m - 1;
    for (lll = 1; lll <= i__1; ++lll) {
        ll = m - lll;
        abss = (r__1 = d__[ll], SABS(r__1));
        abse = (r__1 = e[ll], SABS(r__1));
...
/*     (from larger end diagonal element towards smaller) */
    ...
    if (ll > oldm || m < oldll) {
        if ((r__1 = d__[ll], SABS(r__1)) >= (r__2 = d__[m], SABS(r__2))) {

/*           Chase bulge from top (big end) to bottom (small1 end) */

            idir = 1;
        } else {

/*           Chase bulge from bottom (big end) to top (small1 end) */
...
/*        First apply standard test to bottom of matrix */
        ...
        if ((r__2 = e[m - 1], SABS(r__2)) <= SABS(tol) * (r__1 = d__[m], SABS(
                r__1)) || tol < 0.f && (r__3 = e[m - 1], SABS(r__3)) <= 
                thresh) {
            e[m - 1] = 0.f;
            goto L60;
        }
...
/*           apply convergence criterion forward */
            ...
            mu = (r__1 = d__[ll], SABS(r__1));
            sminl = mu;
            i__1 = m - 1;
            for (lll = ll; lll <= i__1; ++lll) {
                if ((r__1 = e[lll], SABS(r__1)) <= tol * mu) {
                    e[lll] = 0.f;
                    goto L60;
                }
                sminlo = sminl;
                mu = (r__2 = d__[lll + 1], SABS(r__2)) * (mu / (mu + (r__1 = 
                        e[lll], SABS(r__1))));
                sminl = dmin(sminl,mu);
/* L100: */
            }
...
/*        First apply standard test to top of matrix */
        ...
        if ((r__2 = e[ll], SABS(r__2)) <= SABS(tol) * (r__1 = d__[ll], SABS(
                r__1)) || tol < 0.f && (r__3 = e[ll], SABS(r__3)) <= thresh) {
            e[ll] = 0.f;
            goto L60;
        }
...
/*           apply convergence criterion backward */
            ...
            for (lll = m - 1; lll >= i__1; --lll) {
                ...
                sminlo = sminl;
                mu = (r__2 = d__[lll], SABS(r__2)) * (mu / (mu + (r__1 = e[
                        lll], SABS(r__1))));
                sminl = dmin(sminl,mu);
/* L110: */
            }
...
/*        Compute the shift from 2-by-2 block at end of matrix */
        ...
        if (idir == 1) {
            sll = (r__1 = d__[ll], SABS(r__1));
            slas2_(&d__[m - 1], &e[m - 1], &d__[m], &shift, &r__);
        } else {
            sll = (r__1 = d__[m], SABS(r__1));
...
/*           Test convergence */
            ...
            if ((r__1 = e[m - 1], SABS(r__1)) <= thresh) {
                e[m - 1] = 0.f;
            }
...
/*           Save cosines and sines for later singular vector updates */
            ...
            f = ((r__1 = d__[ll], SABS(r__1)) - shift) * (r_sign(&c_b49, &d__[
                    ll]) + shift / d__[ll]);
            g = e[ll];
            i__1 = m - 1;
            for (i__ = ll; i__ <= i__1; ++i__) {
...
/*           Save cosines and sines for later singular vector updates */
            ...
            f = ((r__1 = d__[m], SABS(r__1)) - shift) * (r_sign(&c_b49, &d__[
                    m]) + shift / d__[m]);
            g = e[m - 1];
            i__1 = ll + 1;
            for (i__ = m; i__ >= i__1; --i__) {
