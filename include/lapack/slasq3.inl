...
/* Subroutine */ static int slasq3_(integer *i0, integer *n0, real *z__, integer *pp,
        ...
        integer *iter, integer *ndiv, logical *ieee)
{
    ...
    static real tol2, temp;
     /* Subroutine */ int slasq4_(integer *, integer *, real *, integer 
...
/*           Success. */
            ...
            goto L100;
                 ...
                 tol * (*sigma + dn1) && SABS(dn) < tol * *sigma) {
