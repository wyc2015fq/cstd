...
/* Subroutine */ static int cunmrz_(char *side, char *trans, integer *m, integer *n, 
        integer *k, integer *l, scomplex *a, integer *lda, scomplex *tau, 
...
/*  CUNMRZ overwrites the general scomplex M-by-N matrix C with */
