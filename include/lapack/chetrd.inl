...
/* Subroutine */ static int chetrd_(char *uplo, integer *n, scomplex *a, integer *lda,
         real *d__, real *e, scomplex *tau, scomplex *work, integer *lwork, 
...
static real c_b23 = 1.f;
    ...
    static logical upper;
     /* Subroutine */ int chetd2_(char *, integer *, scomplex *, integer 
            *, real *, real *, scomplex *, integer *, ftnlen), cher2k_(char *, 
            char *, integer *, integer *, scomplex *, scomplex *, integer *, 
            scomplex *, integer *, real *, scomplex *, integer *, ftnlen, 
            ftnlen), clatrd_(char *, integer *, integer *, scomplex *, integer 
            *, real *, scomplex *, scomplex *, integer *, ftnlen), xerbla_(char 
            *, integer *, ftnlen);
...
/*  CHETRD reduces a scomplex Hermitian matrix A to real symmetric */
