...
/* Subroutine */ static int dhseqr_(char *job, char *compz, integer *n, integer *ilo,
...
static integer c__1 = 1;
    ...
    static doublereal unfl, temp, ovfl;
     ...
     /* Subroutine */ int dgemv_(char *, integer *, integer *, 
            doublereal *, doublereal *, integer *, doublereal *, integer *, 
            doublereal *, doublereal *, integer *, ftnlen);
    static integer itemp;
     /* Subroutine */ int dcopy_(integer *, doublereal *, integer *, 
            doublereal *, integer *);
    static logical initz, wantt, wantz;
     ...
     doublereal dlanhs_(char *, integer *, doublereal *, integer *, 
            doublereal *, ftnlen);
     /* Subroutine */ int dlahqr_(logical *, logical *, integer *, 
     ...
     /* Subroutine */ int xerbla_(char *, integer *, ftnlen), dlarfx_(
