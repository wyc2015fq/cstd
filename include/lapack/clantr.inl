...
static doublereal clantr_(char *norm, char *uplo, char *diag, integer *m, integer *n,
         scomplex *a, integer *lda, real *work, ftnlen norm_len, ftnlen 
...
/* Computing MIN */
                    ...
                    i__2 = MIN(i__3,i__4);
                    for (i__ = 1; i__ <= i__2; ++i__) {
                        work[i__] += (real)c_abs(&a[i__ + j * a_dim1]);
/* L160: */
                    }
/* L170: */
                }
