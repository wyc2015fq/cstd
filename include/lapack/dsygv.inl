...
/* Subroutine */ static int dsygv_(integer *itype, char *jobz, char *uplo, integer *
        ...
        ftnlen jobz_len, ftnlen uplo_len)
{
    ...
    static integer nb, neig;
     ...
     /* Subroutine */ int dtrmm_(char *, char *, char *, char *, 
    ...
    static logical upper;
     /* Subroutine */ int dsyev_(char *, char *, integer *, doublereal *
    ...
    static logical wantz;
     ...
     /* Subroutine */ int dpotrf_(char *, integer *, doublereal *, 
