...
/* Subroutine */ static int dsteqr_(char *compz, integer *n, doublereal *d__, 
...
static integer c__2 = 2;
    ...
    static integer lend, jtot;
     ...
     /* Subroutine */ int dlasr_(char *, char *, char *, integer *, 
            integer *, doublereal *, doublereal *, doublereal *, integer *, 
            ftnlen, ftnlen, ftnlen);
    static doublereal anorm;
     /* Subroutine */ int dswap_(integer *, doublereal *, integer *, 
