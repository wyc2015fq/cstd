...
/* Subroutine */ static int sgeqp3_(integer *m, integer *n, real *a, integer *lda, 
...
static integer c__2 = 2;
    ...
    static integer topbmn, sminmn;
     /* Subroutine */ int slaqps_(integer *, integer *, integer *, 
...
/*        store the exact column norms. */
        ...
        for (j = nfxd + 1; j <= i__1; ++j) {
            work[j] = (real)snrm2_(&sm, &a[nfxd + 1 + j * a_dim1], &c__1);
            work[*n + j] = work[j];
/* L20: */
        }
