...
/* Subroutine */ static int zpotrf_(char *uplo, integer *n, dcomplex *a, 
        integer *lda, integer *info, ftnlen uplo_len)
{
    ...
    static integer j, jb, nb;
     ...
     /* Subroutine */ int zgemm_(char *, char *, integer *, integer *, 
            ...
            integer *, doublereal *, dcomplex *, integer *, doublereal *,
             dcomplex *, integer *, ftnlen, ftnlen);
    static logical upper;
     /* Subroutine */ int ztrsm_(char *, char *, char *, char *, 
            ...
            zpotf2_(char *, integer *, dcomplex *, integer *, integer *, 
...
/*  ZPOTRF computes the Cholesky factorization of a scomplex Hermitian */
