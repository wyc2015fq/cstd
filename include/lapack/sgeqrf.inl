...
/* Subroutine */ static int sgeqrf_(integer *m, integer *n, real *a, integer *lda, 
...
static integer c__2 = 2;
    ...
    static integer i__, k, ib, nb, nx, iws, nbmin, iinfo;
     /* Subroutine */ int sgeqr2_(integer *, integer *, real *, integer 
     ...
     /* Subroutine */ int slarft_(char *, char *, integer *, integer *, 
