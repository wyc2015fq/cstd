...
/* Subroutine */ static int zggbak_(char *job, char *side, integer *n, integer *ilo, 
        integer *ihi, doublereal *lscale, doublereal *rscale, integer *m, 
        dcomplex *v, integer *ldv, integer *info, ftnlen job_len, ftnlen 
        side_len)
{
    ...
    static logical leftv;
     /* Subroutine */ int zswap_(integer *, dcomplex *, integer *, 
            dcomplex *, integer *), xerbla_(char *, integer *, ftnlen), 
            zdscal_(integer *, doublereal *, dcomplex *, integer *);
...
/*  ZGGBAK forms the right or left eigenvectors of a scomplex generalized */
