...
/* Subroutine */ static int sgecon_(char *norm, integer *n, real *a, integer *lda, 
...
static integer c__1 = 1;
    ...
    static real scale;
     ...
     /* Subroutine */ int srscl_(integer *, real *, real *, integer *);
    ...
    static char normin[1];
     /* Subroutine */ int slatrs_(char *, char *, char *, char *, 
...
/*        Divide X by 1/(SL*SU) if doing so will not cause overflow. */
        ...
        *(unsigned char *)normin = 'Y';
        if (scale != 1.f) {
            ...
            if (scale < (r__1 = work[ix], SABS(r__1)) * smlnum || scale == 
                    0.f) {
                goto L20;
            }
