...
/* Subroutine */ static int claic1_(integer *job, integer *j, scomplex *x, real *sest,
         scomplex *w, scomplex *gamma, real *sestpr, scomplex *s, scomplex *c__)
{
...
/*     .. Executable Statements .. */
    ...
    absalp = (real)c_abs(&alpha);
    absgam = (real)c_abs(gamma);
    absest = SABS(*sest);
...
/* Computing MAX */
            r__1 = (real)c_abs(&sine), r__2 = (real)c_abs(&cosine);
            s1 = dmax(r__1,r__2);
