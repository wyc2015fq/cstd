...
/* Subroutine */ static int clatrd_(char *uplo, integer *n, integer *nb, scomplex *a, 
        integer *lda, real *e, scomplex *tau, scomplex *w, integer *ldw, ftnlen 
        uplo_len)
{
...
static integer c__1 = 1;
    ...
    static scomplex alpha;
     ...
     /* Subroutine */ int cgemv_(char *, integer *, integer *, scomplex *
            ...
            , integer *, ftnlen), chemv_(char *, integer *, scomplex *, 
            scomplex *, integer *, scomplex *, integer *, scomplex *, scomplex *, 
            integer *, ftnlen);
     logical lsame_(char *, char *, ftnlen, ftnlen);
     /* Subroutine */ int caxpy_(integer *, scomplex *, scomplex *, 
            integer *, scomplex *, integer *), clarfg_(integer *, scomplex *, 
            scomplex *, integer *, scomplex *), clacgv_(integer *, scomplex *, 
            integer *);
...
/*  CLATRD reduces NB rows and columns of a scomplex Hermitian matrix A to */
