...
/* Subroutine */ static int zgetri_(integer *n, dcomplex *a, integer *lda, 
        integer *ipiv, dcomplex *work, integer *lwork, integer *info)
        {
    ...
    static logical lquery;
     /* Subroutine */ int ztrtri_(char *, char *, integer *, 
            dcomplex *, integer *, integer *, ftnlen, ftnlen);
