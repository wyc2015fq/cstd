...
/* Subroutine */ static int zbdsqr_(char *uplo, integer *n, integer *ncvt, integer *
        nru, integer *ncc, doublereal *d__, doublereal *e, dcomplex *vt, 
        integer *ldvt, dcomplex *u, integer *ldu, dcomplex *c__, 
        integer *ldc, doublereal *rwork, integer *info, ftnlen uplo_len)
{
    ...
    static doublereal unfl, sinl, cosr, smin, smax, sinr;
     /* Subroutine */ int dlas2_(doublereal *, doublereal *, doublereal 
            *, doublereal *, doublereal *);
    ...
    static logical lower;
     /* Subroutine */ int zlasr_(char *, char *, char *, integer *, 
            integer *, doublereal *, doublereal *, dcomplex *, integer *,
             ftnlen, ftnlen, ftnlen), zdrot_(integer *, dcomplex *, 
            integer *, dcomplex *, integer *, doublereal *, doublereal *)
            , zswap_(integer *, dcomplex *, integer *, dcomplex *, 
