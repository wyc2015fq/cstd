...
/* Subroutine */ static int zlahrd_(integer *n, integer *k, integer *nb, 
        dcomplex *a, integer *lda, dcomplex *tau, dcomplex *t, 
        integer *ldt, dcomplex *y, integer *ldy)
{
...
static integer c__1 = 1;
    ...
    static dcomplex ei;
     /* Subroutine */ int zscal_(integer *, dcomplex *, 
            ...
            integer *, dcomplex *, integer *), ztrmv_(char *, char *, 
            char *, integer *, dcomplex *, integer *, dcomplex *, 
