...
/* Subroutine */ static int zlahqr_(logical *wantt, logical *wantz, integer *n, 
        integer *ilo, integer *ihi, dcomplex *h__, integer *ldh, 
        dcomplex *w, integer *iloz, integer *ihiz, dcomplex *z__, 
...
static integer c__1 = 1;
    ...
    void z_sqrt(dcomplex *, dcomplex *), d_cnjg(dcomplex *, 
            dcomplex *);
    ...
    static doublereal rtemp, rwork[1];
     ...
     /* Subroutine */ int zlarfg_(integer *, dcomplex *, 
