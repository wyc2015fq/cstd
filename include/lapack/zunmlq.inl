...
/* Subroutine */ static int zunmlq_(char *side, char *trans, integer *m, integer *n, 
        integer *k, dcomplex *a, integer *lda, dcomplex *tau, 
        dcomplex *c__, integer *ldc, dcomplex *work, integer *lwork,
         integer *info, ftnlen side_len, ftnlen trans_len)
{
    ...
    static integer nbmin, iinfo;
     ...
     /* Subroutine */ int zlarfb_(char *, char *, char *, char *, 
            integer *, integer *, integer *, dcomplex *, integer *, 
            dcomplex *, integer *, dcomplex *, integer *, 
            dcomplex *, integer *, ftnlen, ftnlen, ftnlen, ftnlen);
    static logical notran;
    static integer ldwork;
     /* Subroutine */ int zlarft_(char *, char *, integer *, integer *, 
...
/*  ZUNMLQ overwrites the general scomplex M-by-N matrix C with */
