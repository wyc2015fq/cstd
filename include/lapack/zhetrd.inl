...
/* Subroutine */ static int zhetrd_(char *uplo, integer *n, dcomplex *a, 
        integer *lda, doublereal *d__, doublereal *e, dcomplex *tau, 
        dcomplex *work, integer *lwork, integer *info, ftnlen uplo_len)
{
...
/*  ZHETRD reduces a scomplex Hermitian matrix A to real symmetric */
