...
/* Subroutine */ static int ctgevc_(char *side, char *howmny, logical *select, 
        integer *n, scomplex *a, integer *lda, scomplex *b, integer *ldb, 
        scomplex *vl, integer *ldvl, scomplex *vr, integer *ldvr, integer *mm, 
        integer *m, scomplex *work, real *rwork, integer *info, ftnlen 
        side_len, ftnlen howmny_len)
{
    ...
    static integer isrc;
    static real temp;
    static scomplex suma, sumb;
    static real xmax, scale;
    static logical ilall;
    static integer iside;
    static real sbeta;
     logical lsame_(char *, char *, ftnlen, ftnlen);
     /* Subroutine */ int cgemv_(char *, integer *, integer *, scomplex *
            , scomplex *, integer *, scomplex *, integer *, scomplex *, scomplex *
            , integer *, ftnlen);
    static real small1;
...
/*  eigenvectors of a pair of scomplex upper triangular matrices (A,B). */
...
/*     solver. */
    ...
    i__1 = a_dim1 + 1;
    anorm = (r__1 = a[i__1].r, SABS(r__1)) + (r__2 = (real)r_imag(&a[a_dim1 + 1]), 
            SABS(r__2));
    i__1 = b_dim1 + 1;
    bnorm = (r__1 = b[i__1].r, SABS(r__1)) + (r__2 = (real)r_imag(&b[b_dim1 + 1]), 
            SABS(r__2));
    rwork[1] = 0.f;
    rwork[*n + 1] = 0.f;
    i__1 = *n;
    for (j = 2; j <= i__1; ++j) {
        ...
        for (i__ = 1; i__ <= i__2; ++i__) {
            i__3 = i__ + j * a_dim1;
            rwork[j] += (r__1 = a[i__3].r, SABS(r__1)) + (r__2 = (real)r_imag(&a[
                    i__ + j * a_dim1]), SABS(r__2));
            i__3 = i__ + j * b_dim1;
            rwork[*n + j] += (r__1 = b[i__3].r, SABS(r__1)) + (r__2 = (real)r_imag(&
                    b[i__ + j * b_dim1]), SABS(r__2));
/* L30: */
        }
/* Computing MAX */
        i__2 = j + j * a_dim1;
        r__3 = anorm, r__4 = rwork[j] + ((r__1 = a[i__2].r, SABS(r__1)) + (
                r__2 = (real)r_imag(&a[j + j * a_dim1]), SABS(r__2)));
        anorm = dmax(r__3,r__4);
/* Computing MAX */
        i__2 = j + j * b_dim1;
        r__3 = bnorm, r__4 = rwork[*n + j] + ((r__1 = b[i__2].r, SABS(r__1)) 
                + (r__2 = (real)r_imag(&b[j + j * b_dim1]), SABS(r__2)));
...
/*        Main loop over eigenvalues */
        ...
        for (je = 1; je <= i__1; ++je) {
            ...
            if (ilcomp) {
                ...
                i__2 = je + je * a_dim1;
                i__3 = je + je * b_dim1;
                if ((r__2 = a[i__2].r, SABS(r__2)) + (r__3 = (real)r_imag(&a[je + 
                        je * a_dim1]), SABS(r__3)) <= safmin && (r__1 = b[
                        i__3].r, SABS(r__1)) <= safmin) {
...
/* Computing MAX */
                i__2 = je + je * a_dim1;
                i__3 = je + je * b_dim1;
                r__4 = ((r__2 = a[i__2].r, SABS(r__2)) + (r__3 = (real)r_imag(&a[je 
                        + je * a_dim1]), SABS(r__3))) * ascale, r__5 = (r__1 =
                         b[i__3].r, SABS(r__1)) * bscale, r__4 = MAX(r__4,
                        r__5);
...
/*              Scale to avoid underflow */
                ...
                lsa = SABS(sbeta) >= safmin && SABS(acoeff) < small1;
                lsb = (r__1 = salpha.r, SABS(r__1)) + (r__2 = (real)r_imag(&salpha),
                         SABS(r__2)) >= safmin && (r__3 = bcoeff.r, SABS(r__3)
                        ) + (r__4 = (real)r_imag(&bcoeff), SABS(r__4)) < small1;
                ...
                if (lsb) {
/* Computing MAX */
                    r__3 = scale, r__4 = small1 / ((r__1 = salpha.r, SABS(r__1)
                            ) + (r__2 = (real)r_imag(&salpha), SABS(r__2))) * dmin(
                            bnorm,big);
...
/* Computing MIN */
/* Computing MAX */
                    r__5 = 1.f, r__6 = SABS(acoeff), r__5 = MAX(r__5,r__6), 
                            r__6 = (r__1 = bcoeff.r, SABS(r__1)) + (r__2 = 
                            r_imag(&bcoeff), SABS(r__2));
                ...
                acoefa = SABS(acoeff);
                bcoefa = (r__1 = bcoeff.r, SABS(r__1)) + (r__2 = (real)r_imag(&
                        bcoeff), SABS(r__2));
                xmax = 1.f;
                i__2 = *n;
                for (jr = 1; jr <= i__2; ++jr) {
...
/*                 with scaling and perturbation of the denominator */
                    ...
                    if ((r__1 = d__.r, SABS(r__1)) + (r__2 = (real)r_imag(&d__), 
                            SABS(r__2)) <= dmin__) {
                    ...
                    if ((r__1 = d__.r, SABS(r__1)) + (r__2 = (real)r_imag(&d__), 
                            SABS(r__2)) < 1.f) {
                        if ((r__1 = sum.r, SABS(r__1)) + (r__2 = (real)r_imag(&sum),
                                 SABS(r__2)) >= bignum * ((r__3 = d__.r, SABS(
                                r__3)) + (r__4 = (real)r_imag(&d__), SABS(r__4)))) {
                            temp = 1.f / ((r__1 = sum.r, SABS(r__1)) + (r__2 =
                                     r_imag(&sum), SABS(r__2)));
                            i__3 = j - 1;
                            for (jr = je; jr <= i__3; ++jr) {
                                i__4 = jr;
                                i__5 = jr;
...
/* Computing MAX */
                    i__3 = j;
                    r__3 = xmax, r__4 = (r__1 = work[i__3].r, SABS(r__1)) + (
                            r__2 = (real)r_imag(&work[j]), SABS(r__2));
                    xmax = dmax(r__3,r__4);
/* L100: */
                }
...
/* Computing MAX */
                    i__3 = (isrc - 1) * *n + jr;
                    r__3 = xmax, r__4 = (r__1 = work[i__3].r, SABS(r__1)) + (
                            r__2 = (real)r_imag(&work[(isrc - 1) * *n + jr]), SABS(
                            r__2));
                    xmax = dmax(r__3,r__4);
/* L110: */
                }
...
/*        Main loop over eigenvalues */
        ...
        for (je = *n; je >= 1; --je) {
            ...
            if (ilcomp) {
                ...
                i__1 = je + je * a_dim1;
                i__2 = je + je * b_dim1;
                if ((r__2 = a[i__1].r, SABS(r__2)) + (r__3 = (real)r_imag(&a[je + 
                        je * a_dim1]), SABS(r__3)) <= safmin && (r__1 = b[
                        i__2].r, SABS(r__1)) <= safmin) {
...
/* Computing MAX */
                i__1 = je + je * a_dim1;
                i__2 = je + je * b_dim1;
                r__4 = ((r__2 = a[i__1].r, SABS(r__2)) + (r__3 = (real)r_imag(&a[je 
                        + je * a_dim1]), SABS(r__3))) * ascale, r__5 = (r__1 =
                         b[i__2].r, SABS(r__1)) * bscale, r__4 = MAX(r__4,
                        r__5);
                temp = 1.f / dmax(r__4,safmin);
                i__1 = je + je * a_dim1;
...
/*                 with scaling and perturbation of the denominator */
                    ...
                    if ((r__1 = d__.r, SABS(r__1)) + (r__2 = (real)r_imag(&d__), 
                            SABS(r__2)) < 1.f) {
                        i__1 = j;
                        if ((r__1 = work[i__1].r, SABS(r__1)) + (r__2 = 
                                r_imag(&work[j]), SABS(r__2)) >= bignum * ((
                                r__3 = d__.r, SABS(r__3)) + (r__4 = (real)r_imag(&
                                d__), SABS(r__4)))) {
                            i__1 = j;
                            temp = 1.f / ((r__1 = work[i__1].r, SABS(r__1)) + 
                                    (r__2 = (real)r_imag(&work[j]), SABS(r__2)));
                            i__1 = je;
                            for (jr = 1; jr <= i__1; ++jr) {
                                i__2 = jr;
...
/* Computing MAX */
                    i__2 = (isrc - 1) * *n + jr;
                    r__3 = xmax, r__4 = (r__1 = work[i__2].r, SABS(r__1)) + (
                            r__2 = (real)r_imag(&work[(isrc - 1) * *n + jr]), SABS(
                            r__2));
                    xmax = dmax(r__3,r__4);
/* L220: */
