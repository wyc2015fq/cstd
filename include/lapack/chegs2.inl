...
/* Subroutine */ static int chegs2_(integer *itype, char *uplo, integer *n, scomplex *
        a, integer *lda, scomplex *b, integer *ldb, integer *info, ftnlen 
        uplo_len)
{
    ...
    static scomplex ct;
    static real akk, bkk;
     /* Subroutine */ int cher2_(char *, integer *, scomplex *, scomplex *
    ...
    static logical upper;
     /* Subroutine */ int ctrmv_(char *, char *, char *, integer *, 
            scomplex *, integer *, scomplex *, integer *, ftnlen, ftnlen, 
            ftnlen), ctrsv_(char *, char *, char *, integer *, scomplex *, 
            integer *, scomplex *, integer *, ftnlen, ftnlen, ftnlen), clacgv_(
            integer *, scomplex *, integer *), csscal_(integer *, real *, 
            scomplex *, integer *), xerbla_(char *, integer *, ftnlen);
...
/*  CHEGS2 reduces a scomplex Hermitian-definite generalized */
