...
/* Subroutine */ static int dsyev_(char *jobz, char *uplo, integer *n, doublereal *a,
...
static doublereal c_b17 = 1.;
    ...
    static integer indtau;
     /* Subroutine */ int dsterf_(integer *, doublereal *, doublereal *,
             integer *);
     doublereal dlansy_(char *, char *, integer *, doublereal *, 
            integer *, doublereal *, ftnlen, ftnlen);
    static integer indwrk;
     /* Subroutine */ int dorgtr_(char *, integer *, doublereal *, 
