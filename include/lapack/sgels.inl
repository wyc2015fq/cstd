...
/* Subroutine */ static int sgels_(char *trans, integer *m, integer *n, integer *
    ...
    static real bignum;
     /* Subroutine */ int sgelqf_(integer *, integer *, real *, integer 
            ...
            *, integer *, integer *, real *, real *, real *, integer *, 
            ftnlen);
    static real smlnum;
     /* Subroutine */ int sormlq_(char *, char *, integer *, integer *, 
...
/*     Scale A, B if MAX element outside range [SMLNUM,BIGNUM] */
    ...
    anrm = (real)slange_("M", m, n, &a[a_offset], lda, rwork, (ftnlen)1);
    iascl = 0;
...
/*        Matrix all zero. Return zero solution. */
    ...
    bnrm = (real)slange_("M", &brow, nrhs, &b[b_offset], ldb, rwork, (ftnlen)1);
    ibscl = 0;
