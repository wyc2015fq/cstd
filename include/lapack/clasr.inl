...
/* Subroutine */ static int clasr_(char *side, char *pivot, char *direct, integer *m,
         integer *n, real *c__, real *s, scomplex *a, integer *lda, ftnlen 
...
/*  where A is an m by n scomplex matrix and P is an orthogonal matrix, */
