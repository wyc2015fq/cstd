...
/* Subroutine */ static int slaexc_(logical *wantq, integer *n, real *t, integer *
...
static integer c__3 = 3;
    ...
    static real scale, dnorm, xnorm;
     /* Subroutine */ int slanv2_(real *, real *, real *, real *, real *
     ...
     /* Subroutine */ int slarfg_(integer *, real *, real *, integer *, 
            ...
            , real *);
    static real thresh;
     /* Subroutine */ int slarfx_(char *, integer *, integer *, real *, 
...
/*        and compute its norm. */
        ...
        slacpy_("Full", &nd, &nd, &t[*j1 + *j1 * t_dim1], ldt, d__, &c__4, (
                ftnlen)4);
        dnorm = (real)slange_("Max", &nd, &nd, d__, &c__4, &work[1], (ftnlen)3);
...
/* Computing MAX */
        r__2 = SABS(d__[2]), r__3 = SABS(d__[6]), r__2 = MAX(r__2,r__3), r__3 
                = (r__1 = d__[10] - t11, SABS(r__1));
...
/* Computing MAX */
        r__2 = SABS(d__[1]), r__3 = SABS(d__[2]), r__2 = MAX(r__2,r__3), r__3 
                = (r__1 = d__[0] - t33, SABS(r__1));
        if (dmax(r__2,r__3) > thresh) {
            goto L50;
        }
...
/* Computing MAX */
        r__1 = SABS(d__[2]), r__2 = SABS(d__[6]), r__1 = MAX(r__1,r__2), r__2 
                = SABS(d__[3]), r__1 = MAX(r__1,r__2), r__2 = SABS(d__[7]);
