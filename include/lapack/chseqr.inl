...
/* Subroutine */ static int chseqr_(char *job, char *compz, integer *n, integer *ilo,
         integer *ihi, scomplex *h__, integer *ldh, scomplex *w, scomplex *z__, 
        integer *ldz, scomplex *work, integer *lwork, integer *info, ftnlen 
...
static logical c_false = FALSE_;
    ...
    static scomplex s[225]        /* was [15][15] */, v[16];
    static integer i1, i2, ii, nh, nr, ns, nv;
    static scomplex vv[16];
    static integer itn;
    static scomplex tau;
    static integer its;
    ...
    static real ovfl;
     ...
     /* Subroutine */ int cgemv_(char *, integer *, integer *, scomplex *
            ...
            , integer *, ftnlen), ccopy_(integer *, scomplex *, integer *, 
            scomplex *, integer *);
    static integer itemp;
    static real rtemp;
    static logical initz, wantt, wantz;
    static real rwork[1];
     doublereal slapy2_(real *, real *);
     /* Subroutine */ int slabad_(real *, real *), clarfg_(integer *, 
            scomplex *, scomplex *, integer *, scomplex *);
     ...
     /* Subroutine */ int csscal_(integer *, real *, scomplex *, integer 
            *), clahqr_(logical *, logical *, integer *, integer *, integer *,
             scomplex *, integer *, scomplex *, integer *, integer *, scomplex *,
             integer *, integer *), clacpy_(char *, integer *, integer *, 
            scomplex *, integer *, scomplex *, integer *, ftnlen), claset_(char 
            *, integer *, integer *, scomplex *, scomplex *, scomplex *, integer 
            *, ftnlen), xerbla_(char *, integer *, ftnlen);
     integer ilaenv_(integer *, char *, char *, integer *, integer *, 
            integer *, integer *, ftnlen, ftnlen);
     /* Subroutine */ int clarfx_(char *, integer *, integer *, scomplex 
            *, scomplex *, scomplex *, integer *, scomplex *, ftnlen);
    static real smlnum;
...
/*  CHSEQR computes the eigenvalues of a scomplex upper Hessenberg */
...
/*     Ensure that the subdiagonal elements are real. */
    ...
    for (i__ = *ilo + 1; i__ <= i__1; ++i__) {
        ...
        if (r_imag(&temp) != 0.f) {
            r__1 = temp.r;
            r__2 = (real)r_imag(&temp);
            rtemp = (real)slapy2_(&r__1, &r__2);
            i__2 = i__ + (i__ - 1) * h_dim1;
...
/*     If norm(H) <= (real)sqrt(OVFL), overflow should not occur. */
...
/*        Look for a single small1 subdiagonal element. */

        i__2 = l + 1;
        for (k = i__; k >= i__2; --k) {
            i__3 = k - 1 + (k - 1) * h_dim1;
            i__5 = k + k * h_dim1;
            tst1 = (r__1 = h__[i__3].r, SABS(r__1)) + (r__2 = (real)r_imag(&h__[k - 
                    1 + (k - 1) * h_dim1]), SABS(r__2)) + ((r__3 = h__[i__5]
                    .r, SABS(r__3)) + (r__4 = (real)r_imag(&h__[k + k * h_dim1]), 
                    SABS(r__4)));
            if (tst1 == 0.f) {
                i__3 = i__ - l + 1;
                tst1 = (real)clanhs_("1", &i__3, &h__[l + l * h_dim1], ldh, rwork, (
                        ftnlen)1);
            }
            i__3 = k + (k - 1) * h_dim1;
/* Computing MAX */
            r__2 = ulp * tst1;
            if ((r__1 = h__[i__3].r, SABS(r__1)) <= dmax(r__2,smlnum)) {
                goto L80;
            }
/* L70: */
        }
...
/*           Exceptional shifts. */
            ...
            for (ii = i__ - ns + 1; ii <= i__2; ++ii) {
                ...
                i__5 = ii + (ii - 1) * h_dim1;
                i__6 = ii + ii * h_dim1;
                r__3 = ((r__1 = h__[i__5].r, SABS(r__1)) + (r__2 = h__[i__6]
                        .r, SABS(r__2))) * 1.5f;
...
/*           reset it to the unit vector. */
            ...
            i__3 = itemp - 1;
            rtemp = (r__1 = v[i__3].r, SABS(r__1)) + (r__2 = (real)r_imag(&v[itemp 
                    - 1]), SABS(r__2));
            if (rtemp == 0.f) {
                v[0].r = 1.f, v[0].i = 0.f;
                i__3 = nv;
