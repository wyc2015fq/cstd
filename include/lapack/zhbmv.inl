...
/* Subroutine */ static int zhbmv_(char *uplo, integer *n, integer *k, dcomplex 
        *alpha, dcomplex *a, integer *lda, dcomplex *x, integer *
        incx, dcomplex *beta, dcomplex *y, integer *incy, ftnlen 
        uplo_len)
{
