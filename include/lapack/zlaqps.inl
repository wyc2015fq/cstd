...
/* Subroutine */ static int zlaqps_(integer *m, integer *n, integer *offset, integer 
        *nb, integer *kb, dcomplex *a, integer *lda, integer *jpvt, 
        dcomplex *tau, doublereal *vn1, doublereal *vn2, dcomplex *
        auxv, dcomplex *f, integer *ldf)
{
