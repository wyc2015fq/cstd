...
/* Subroutine */ static int cheev_(char *jobz, char *uplo, integer *n, scomplex *a, 
        integer *lda, real *w, scomplex *work, integer *lwork, real *rwork, 
...
static real c_b18 = 1.f;
    ...
    static logical lower, wantz;
     doublereal clanhe_(char *, char *, integer *, scomplex *, integer *,
             real *, ftnlen, ftnlen);
    static integer iscale;
     ...
     /* Subroutine */ int chetrd_(char *, integer *, scomplex *, integer 
            *, real *, real *, scomplex *, scomplex *, integer *, integer *, 
            ftnlen);
    static real safmin;
    ...
    static integer indtau, indwrk;
     /* Subroutine */ int csteqr_(char *, integer *, real *, real *, 
            scomplex *, integer *, real *, integer *, ftnlen), cungtr_(char *, 
...
/*     Get machine constants. */
    ...
    eps = (real)slamch_("Precision", (ftnlen)9);
    smlnum = safmin / eps;
    bignum = 1.f / smlnum;
    rmin = (real)sqrt(smlnum);
    rmax = (real)sqrt(bignum);

/*     Scale matrix to allowable range, if necessary. */

    anrm = (real)clanhe_("M", uplo, n, &a[a_offset], lda, &rwork[1], (ftnlen)1, (
            ftnlen)1);
    iscale = 0;
