...
/* Subroutine */ static int cgeqp3_(integer *m, integer *n, scomplex *a, integer *lda,
         integer *jpvt, scomplex *tau, scomplex *work, integer *lwork, real *
        rwork, integer *info)
{
...
static integer c__2 = 2;
    ...
    static integer minmn, minws;
     /* Subroutine */ int claqp2_(integer *, integer *, integer *, 
            scomplex *, integer *, integer *, scomplex *, real *, real *, 
            scomplex *);
     doublereal scnrm2_(integer *, scomplex *, integer *);
     /* Subroutine */ int cgeqrf_(integer *, integer *, scomplex *, 
            integer *, scomplex *, scomplex *, integer *, integer *), xerbla_(
            char *, integer *, ftnlen);
     integer ilaenv_(integer *, char *, char *, integer *, integer *, 
            integer *, integer *, ftnlen, ftnlen);
     /* Subroutine */ int claqps_(integer *, integer *, integer *, 
            integer *, integer *, scomplex *, integer *, integer *, scomplex *, 
            real *, real *, scomplex *, scomplex *, integer *);
...
/*  where tau is a real/scomplex scalar, and v is a real/scomplex vector */
...
/*        store the exact column norms. */
        ...
        for (j = nfxd + 1; j <= i__1; ++j) {
            rwork[j] = (real)scnrm2_(&sm, &a[nfxd + 1 + j * a_dim1], &c__1);
            rwork[*n + j] = rwork[j];
/* L20: */
        }
