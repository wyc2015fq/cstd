...
/* Subroutine */ static int clarfg_(integer *n, scomplex *alpha, scomplex *x, integer *
        incx, scomplex *tau)
{
...
static scomplex c_b5 = {1.f,0.f};
    ...
    static real alphi, alphr, xnorm;
     doublereal scnrm2_(integer *, scomplex *, integer *), slapy3_(real *
            , real *, real *);
...
/*     .. Executable Statements .. */
    ...
    i__1 = *n - 1;
    xnorm = (real)scnrm2_(&i__1, &x[1], incx);
    alphr = alpha->r;
    alphi = (real)r_imag(alpha);
...
/*        general case */
        ...
        r__1 = (real)slapy3_(&alphr, &alphi, &xnorm);
        beta = (real)-r_sign(&r__1, &alphr);
        safmin = (real)(slamch_("S", (ftnlen)1) / slamch_("E", (ftnlen)1));
        rsafmn = 1.f / safmin;
