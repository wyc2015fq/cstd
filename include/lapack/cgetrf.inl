...
/* Subroutine */ static int cgetrf_(integer *m, integer *n, scomplex *a, integer *lda,
...
static integer c_n1 = -1;
    ...
    static integer iinfo;
     /* Subroutine */ int ctrsm_(char *, char *, char *, char *, 
            ...
            integer *, scomplex *, integer *, integer *, integer *), xerbla_(
            char *, integer *, ftnlen);
     integer ilaenv_(integer *, char *, char *, integer *, integer *, 
            integer *, integer *, ftnlen, ftnlen);
     /* Subroutine */ int claswp_(integer *, scomplex *, integer *, 
