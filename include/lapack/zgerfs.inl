...
/* Subroutine */ static int zgerfs_(char *trans, integer *n, integer *nrhs, 
        dcomplex *a, integer *lda, dcomplex *af, integer *ldaf, 
        integer *ipiv, dcomplex *b, integer *ldb, dcomplex *x, 
        integer *ldx, doublereal *ferr, doublereal *berr, dcomplex *work,
...
static integer c__1 = 1;
    ...
    static integer count;
     /* Subroutine */ int zgemv_(char *, integer *, integer *, 
            ...
            zcopy_(integer *, dcomplex *, integer *, dcomplex *, 
            integer *), zaxpy_(integer *, dcomplex *, dcomplex *, 
            integer *, dcomplex *, integer *);
     doublereal dlamch_(char *, ftnlen);
    static doublereal safmin;
     /* Subroutine */ int xerbla_(char *, integer *, ftnlen), zlacon_(
            integer *, dcomplex *, dcomplex *, doublereal *, 
            integer *);
