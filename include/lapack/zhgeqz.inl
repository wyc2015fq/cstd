...
/* Subroutine */ static int zhgeqz_(char *job, char *compq, char *compz, integer *n, 
        integer *ilo, integer *ihi, dcomplex *a, integer *lda, 
        dcomplex *b, integer *ldb, dcomplex *alpha, dcomplex *
        beta, dcomplex *q, integer *ldq, dcomplex *z__, integer *
        ldz, dcomplex *work, integer *lwork, doublereal *rwork, integer *
        info, ftnlen job_len, ftnlen compq_len, ftnlen compz_len)
{
    ...
    void z_div(dcomplex *, dcomplex *, dcomplex *), pow_zi(
            dcomplex *, dcomplex *, integer *), z_sqrt(
            dcomplex *, dcomplex *);
