...
/* Subroutine */ static int clarft_(char *direct, char *storev, integer *n, integer *
        k, scomplex *v, integer *ldv, scomplex *tau, scomplex *t, integer *ldt, 
...
static integer c__1 = 1;
    ...
    static scomplex vii;
     ...
     /* Subroutine */ int ctrmv_(char *, char *, char *, integer *, 
            ...
            ftnlen), clacgv_(integer *, scomplex *, integer *);
...
/*  CLARFT forms the triangular factor T of a scomplex block reflector H */
