...
/* Subroutine */ static int zgelsy_(integer *m, integer *n, integer *nrhs, 
        dcomplex *a, integer *lda, dcomplex *b, integer *ldb, 
        integer *jpvt, doublereal *rcond, integer *rank, dcomplex *work, 
...
static integer c__2 = 2;
    ...
    static doublereal wsize;
     /* Subroutine */ int zcopy_(integer *, dcomplex *, integer *, 
            dcomplex *, integer *), ztrsm_(char *, char *, char *, char *
            , integer *, integer *, dcomplex *, dcomplex *, integer 
            *, dcomplex *, integer *, ftnlen, ftnlen, ftnlen, ftnlen), 
            zlaic1_(integer *, integer *, dcomplex *, doublereal *, 
            dcomplex *, dcomplex *, doublereal *, dcomplex *, 
            dcomplex *), dlabad_(doublereal *, doublereal *), zgeqp3_(
            integer *, integer *, dcomplex *, integer *, integer *, 
            dcomplex *, dcomplex *, integer *, doublereal *, 
            integer *);
    ...
    static doublereal bignum;
     /* Subroutine */ int zlascl_(char *, integer *, integer *, 
    ...
    static logical lquery;
     /* Subroutine */ int zunmqr_(char *, char *, integer *, integer *, 
            ...
            integer *, integer *, dcomplex *, integer *, dcomplex *,
             dcomplex *, integer *, dcomplex *, integer *, integer *
            , ftnlen, ftnlen), ztzrzf_(integer *, integer *, dcomplex *, 
