...
/* Subroutine */ static int zlarzb_(char *side, char *trans, char *direct, char *
        storev, integer *m, integer *n, integer *k, integer *l, dcomplex 
        *v, integer *ldv, dcomplex *t, integer *ldt, dcomplex *c__, 
        integer *ldc, dcomplex *work, integer *ldwork, ftnlen side_len, 
...
static integer c__1 = 1;
    ...
    static integer i__, j, info;
     ...
     /* Subroutine */ int zgemm_(char *, char *, integer *, integer *, 
            ...
            zlacgv_(integer *, dcomplex *, integer *);
