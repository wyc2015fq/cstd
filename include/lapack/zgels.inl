...
/* Subroutine */ static int zgels_(char *trans, integer *m, integer *n, integer *
        nrhs, dcomplex *a, integer *lda, dcomplex *b, integer *ldb, 
        dcomplex *work, integer *lwork, integer *info, ftnlen trans_len)
{
    ...
    static doublereal rwork[1];
     /* Subroutine */ int ztrsm_(char *, char *, char *, char *, 
     ...
     /* Subroutine */ int zgelqf_(integer *, integer *, dcomplex *,
            ...
            *, integer *, integer *, dcomplex *, integer *, integer *, 
            ftnlen), zgeqrf_(integer *, integer *, dcomplex *, integer *,
             dcomplex *, dcomplex *, integer *, integer *), zlaset_(
            char *, integer *, integer *, dcomplex *, dcomplex *, 
            dcomplex *, integer *, ftnlen);
    static doublereal smlnum;
    static logical lquery;
     /* Subroutine */ int zunmlq_(char *, char *, integer *, integer *, 
