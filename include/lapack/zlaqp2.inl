...
/* Subroutine */ static int zlaqp2_(integer *m, integer *n, integer *offset, 
        dcomplex *a, integer *lda, integer *jpvt, dcomplex *tau, 
        doublereal *vn1, doublereal *vn2, dcomplex *work)
{
...
static integer c__1 = 1;
    ...
    static integer offpi, itemp;
     /* Subroutine */ int zlarf_(char *, integer *, integer *, 
            ...
            integer *, dcomplex *, ftnlen), zswap_(integer *, 
