...
/* Subroutine */ static int zunml2_(char *side, char *trans, integer *m, integer *n, 
        integer *k, dcomplex *a, integer *lda, dcomplex *tau, 
        dcomplex *c__, integer *ldc, dcomplex *work, integer *info, 
        ftnlen side_len, ftnlen trans_len)
{
    ...
    static dcomplex taui;
     ...
     /* Subroutine */ int zlarf_(char *, integer *, integer *, 
            ...
            ftnlen), zlacgv_(integer *, dcomplex *, integer *);
...
/*  ZUNML2 overwrites the general scomplex m-by-n matrix C with */
