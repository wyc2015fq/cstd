...
/* Subroutine */ static int cgetri_(integer *n, scomplex *a, integer *lda, integer *
        ipiv, scomplex *work, integer *lwork, integer *info)
        {
...
static integer c__2 = 2;
    ...
    static integer i__, j, jb, nb, jj, jp, nn, iws;
     /* Subroutine */ int cgemm_(char *, char *, integer *, integer *, 
            ...
            integer *, scomplex *, scomplex *, integer *, ftnlen);
    static integer nbmin;
     /* Subroutine */ int cswap_(integer *, scomplex *, integer *, 
            scomplex *, integer *), ctrsm_(char *, char *, char *, char *, 
            integer *, integer *, scomplex *, scomplex *, integer *, scomplex *, 
    ...
    static integer ldwork;
     /* Subroutine */ int ctrtri_(char *, char *, integer *, scomplex *, 
            integer *, integer *, ftnlen, ftnlen);
