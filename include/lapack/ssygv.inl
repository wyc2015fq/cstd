...
/* Subroutine */ static int ssygv_(integer *itype, char *jobz, char *uplo, integer *
        ...
        integer *lwork, integer *info, ftnlen jobz_len, ftnlen uplo_len)
{
    ...
    static logical upper;
     /* Subroutine */ int strmm_(char *, char *, char *, char *, 
    ...
    static logical wantz;
     ...
     /* Subroutine */ int spotrf_(char *, integer *, real *, integer *, 
            integer *, ftnlen);
    static integer lwkopt;
    static logical lquery;
     /* Subroutine */ int ssygst_(integer *, char *, integer *, real *, 
