/* ../../../dependencies/lapack/src/cung2l.f -- translated by f2c (version 20061008).
...
/* Subroutine */ static int cung2l_(integer *m, integer *n, integer *k, scomplex *a, 
        integer *lda, scomplex *tau, scomplex *work, integer *info)
{
...
static integer c__1 = 1;
    ...
    static integer i__, j, l, ii;
     /* Subroutine */ int cscal_(integer *, scomplex *, scomplex *, 
            integer *), clarf_(char *, integer *, integer *, scomplex *, 
