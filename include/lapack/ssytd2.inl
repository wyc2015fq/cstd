...
/* Subroutine */ static int ssytd2_(char *uplo, integer *n, real *a, integer *lda, 
...
static real c_b14 = -1.f;
    ...
    static real taui;
     ...
     /* Subroutine */ int ssyr2_(char *, integer *, real *, real *, 
...
/*              Compute  w := x - 1/2 * tau * (x'*v) * v */
                ...
                alpha = (real)(taui * -.5f * sdot_(&i__, &tau[1], &c__1, &a[(i__ + 1)
                         * a_dim1 + 1], &c__1));
...
/*              Compute  w := x - 1/2 * tau * (x'*v) * v */
                ...
                i__2 = *n - i__;
                alpha = (real)(taui * -.5f * sdot_(&i__2, &tau[i__], &c__1, &a[i__ + 
                        1 + i__ * a_dim1], &c__1));
                i__2 = *n - i__;
