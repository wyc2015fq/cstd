...
/* Subroutine */ static int claqge_(integer *m, integer *n, scomplex *a, integer *lda,
...
/*     Initialize LARGE and SMALL. */
    ...
    small1 = (real)(slamch_("Safe minimum", (ftnlen)12) / slamch_("Precision", (ftnlen)9));
    large = 1.f / small1;

    if (*rowcnd >= .1f && *amax >= small1 && *amax <= large) {
