...
/* Subroutine */ static int zlarz_(char *side, integer *m, integer *n, integer *l, 
        dcomplex *v, integer *incv, dcomplex *tau, dcomplex *
        c__, integer *ldc, dcomplex *work, ftnlen side_len)
{
...
static integer c__1 = 1;
    ...
    /* Local variables */
     ...
     /* Subroutine */ int zgerc_(integer *, integer *, dcomplex *, 
            ...
            zgeru_(integer *, integer *, dcomplex *, dcomplex *, 
            ...
            integer *, dcomplex *, integer *), zlacgv_(integer *, 
            dcomplex *, integer *);
