...
/* Subroutine */ static int zlatrd_(char *uplo, integer *n, integer *nb, 
        dcomplex *a, integer *lda, doublereal *e, dcomplex *tau, 
        dcomplex *w, integer *ldw, ftnlen uplo_len)
{
...
static integer c__1 = 1;
    ...
    static dcomplex alpha;
     ...
     /* Subroutine */ int zgemv_(char *, integer *, integer *, 
            ...
            zhemv_(char *, integer *, dcomplex *, dcomplex *, 
            integer *, dcomplex *, integer *, dcomplex *, 
            dcomplex *, integer *, ftnlen), zaxpy_(integer *, 
            dcomplex *, dcomplex *, integer *, dcomplex *, 
            integer *), zlarfg_(integer *, dcomplex *, dcomplex *, 
            integer *, dcomplex *), zlacgv_(integer *, dcomplex *, 
            integer *);
...
/*  ZLATRD reduces NB rows and columns of a scomplex Hermitian matrix A to */
