...
/* Subroutine */ static int zlatrs_(char *uplo, char *trans, char *diag, char *
        normin, integer *n, dcomplex *a, integer *lda, dcomplex *x, 
...
static doublereal c_b36 = .5;
    ...
    static dcomplex uscal;
    static integer jlast;
    static dcomplex csumj;
     /* Double Complex */ VOID zdotc_(dcomplex *, integer *, 
            dcomplex *, integer *, dcomplex *, integer *);
    static logical upper;
     /* Double Complex */ VOID zdotu_(dcomplex *, integer *, 
            dcomplex *, integer *, dcomplex *, integer *);
     /* Subroutine */ int zaxpy_(integer *, dcomplex *, 
            dcomplex *, integer *, dcomplex *, integer *), ztrsv_(
            char *, char *, char *, integer *, dcomplex *, integer *, 
            dcomplex *, integer *, ftnlen, ftnlen, ftnlen), dlabad_(
