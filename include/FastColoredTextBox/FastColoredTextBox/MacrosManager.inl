...
{
    /// <summary>
    /// This struct records, stores and executes the macros.
    /// </summary>
    struct MacrosManager
    {
        readonly List<object> macro = new List<object>();
        ...
        /// </summary>
        bool AllowMacroRecordingByUser { get;set; }
        ...
        /// FCTB
        /// </summary>
        FastColoredTextBox UnderlayingControl { get; set; }
        ...
        /// </summary>
        void AddCharToMacros(char c, Keys modifiers)
        {
        ...
        /// </summary>
        void AddKeyToMacros(Keys keyData)
        {
            macro.Add(keyData);
        }
        ...
        /// </summary>
        bool MacroIsEmpty { get { return macro.Count == 0; }}
