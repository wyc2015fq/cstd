...
// #define Styles32
    ...
    /// </summary>
    struct FastColoredTextBox : UserControl, ISupportInitialize
    {
        ...
        int TextHeight;
        bool AllowInsertRemoveLines = true;
        Brush backBrush;
        ...
        Dictionary<int, int> foldingPairs = new Dictionary<int, int>();
        bool handledChar;
        ...
        int maxLineLength;
        bool mouseIsDrag;
        bool mouseIsDragDrop;
        bool multiline;
        bool needRecalc;
        bool needRecalcWordWrap;
        Point needRecalcWordWrapInterval;
        ...
        int reservedCountOfLineNumberChars = 1;
        int zoom = 100;
        Size localAutoScrollMinSize;
        ...
        ServiceColors ServiceColors { get; set; }
        ...
        [Browsable(false)]
        Dictionary<int, int> FoldedBlocks { get; set; }
        ...
        BracketsHighlightStrategy BracketsHighlightStrategy { get; set; }
        ...
        bool WordWrapAutoIndent { get; set; }
        ...
        /// </summary>
        [Browsable(false)]
        MacrosManager MacrosManager { get { return macrosManager; } }
        ...
        FindEndOfFoldingBlockStrategy FindEndOfFoldingBlockStrategy { get; set; }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        HotkeysMapping HotkeysMapping{ get; set;}
        ...
        /// </summary>
        [Browsable(false)]
        TextStyle FoldedBlockStyle { get; set; }

        /// <summary>
        /// Style for brackets highlighting
        /// </summary>
        [Browsable(false)]
        MarkerStyle BracketsStyle { get; set; }

        /// <summary>
        /// Style for alternative brackets highlighting
        /// </summary>
        [Browsable(false)]
        MarkerStyle BracketsStyle2 { get; set; }
        ...
        HighlightingRangeType HighlightingRangeType { get; set; }
        ...
        bool AllowSeveralTextStyleDrawing { get; set; }
        ...
        bool AutoIndentExistingLines { get; set; }
        ...
        int DelayedTextChangedInterval
        {
        ...
        bool selectionHighlightingForLineBreaksEnabled;
        /// <summary>
        ...
        [Browsable(false)]
        FindForm findForm { get; set; }

        [Browsable(false)]
        ReplaceForm replaceForm { get; set; }
        ...
        /// </summary>
        /// <remarks>For more flexibility you can use ExportToHTML struct also</remarks>
        [Browsable(false)]
        string Html
        {
            get
        ...
        /// </summary>
        /// <remarks>For more flexibility you can use ExportToRTF struct also</remarks>
        [Browsable(false)]
        string Rtf
        {
            get
        ...
        int ReservedCountOfLineNumberChars
        {
        ...
        event EventHandler<ToolTipNeededEventArgs> ToolTipNeeded;
        ...
        virtual Hint AddHint(Range range, Control innerControl, bool scrollToHint, bool inline,
                                    bool dock)
        {
        ...
        /// <param name="range">Linked range</param>
        /// <param name="innerControl">Inner control</param>
        Hint AddHint(Range range, Control innerControl)
        {
        ...
        /// <param name="inline">Inlining. If True then hint will moves apart text</param>
        /// <param name="dock">Docking. If True then hint will fill whole line</param>
        virtual Hint AddHint(Range range, string text, bool scrollToHint, bool inline, bool dock)
        {
        ...
        /// <param name="range">Linked range</param>
        /// <param name="text">Text of simple hint</param>
        Hint AddHint(Range range, string text)
        {
        ...
        virtual void OnHintClick(Hint hint)
        {
            if (HintClick != null)
        ...
        /// </summary>
        virtual void OnVisibleRangeChanged()
        {
            needRecalcFoldingLines = true;
        ...
        virtual void OnCharSizeChanged()
        {
        ...
        event EventHandler<HintClickEventArgs> HintClick;
        ...
        new event EventHandler<TextChangedEventArgs> TextChanged;
        ...
        event EventHandler<TextChangingEventArgs> Pasting;
        ...
        event EventHandler SelectionChangedDelayed;
        ...
        event EventHandler VisibleRangeChangedDelayed;
        ...
        event EventHandler<VisualMarkerEventArgs> VisualMarkerClick;
        ...
        event EventHandler<PaintLineEventArgs> PaintLine;
        ...
        event EventHandler<CustomActionEventArgs> CustomAction;
        ...
        event EventHandler ScrollbarsUpdated;
        ...
        event EventHandler<WordWrapNeededEventArgs> WordWrapNeeded;


        /// <summary>
        /// Returns list of styles of given place
        /// </summary>
        List<Style> GetStylesOfChar(Place place)
        {
        ...
        virtual TextSource CreateTextSource()
        {
        ...
        void ts_RecalcWordWrap(object sender, TextSource.TextChangedEventArgs e)
        {
        ...
        /// Call this method if the recalc of the position of lines is needed.
        /// </summary>
        void NeedRecalc(bool forced, bool wordWrapRecalc)
        {
            needRecalc = true;
        ...
        void AddVisualMarker(VisualMarker marker)
        {
        ...
        virtual void OnTextChangedDelayed(Range changedRange)
        {
            if (TextChangedDelayed != null)
                TextChangedDelayed(this, new TextChangedEventArgs(changedRange));
        }

        virtual void OnSelectionChangedDelayed()
        {
        ...
        virtual void OnVisibleRangeChangedDelayed()
        {
        ...
        /// Shows find dialog
        /// </summary>
        void ShowFindDialog(string findText)
        {
            if (findForm == null)
        ...
        /// Shows replace dialog
        /// </summary>
        virtual void ShowReplaceDialog(string findText)
        {
            if (ReadOnly)
                return;
            if (replaceForm == null)
        ...
        virtual void OnCreateClipboardData(DataObject data)
        {
        ...
        static MemoryStream PrepareHtmlForClipboard(string html)
        {
        ...
        virtual void InsertText(string text, bool jumpToCaret)
        {
            if (text == null)
                return;
            if (text == "\r")
        ...
        /// </summary>
        /// <param name="text"></param>
        virtual Range InsertText(string text, Style style)
        {
        ...
        /// Insert text into current selection position (with predefined style)
        /// </summary>
        virtual Range InsertText(string text, Style style, bool jumpToCaret)
        {
            if (text == null)
                return null;
        ...
        /// Append string to end of the Text
        /// </summary>
        virtual void AppendText(string text, Style style)
        {
            if (text == null)
                return;
        ...
        StyleIndex GetStyleIndexMask(Style[] styles)
        {
        ...
        static SizeF GetCharSize(Font font, char c)
        {
        ...
        void OnScroll(ScrollEventArgs se, bool alignByLines)
        {
        ...
        /// </summary>
        static void CalcCutOffs(List<int> cutOffPositions, int maxCharsPerLine, int maxCharsPerSecondaryLine, bool allowIME, bool charWrap, Line line)
        {
        ...
        static bool IsCJKLetter(char c)
        {
        ...
        virtual void OnScrollbarsUpdated()
        {           
        ...
        /// </summary>
        void DoRangeVisible(Range range)
        {
        ...
        /// Scroll control for display given range
        /// </summary>
        void DoRangeVisible(Range range, bool tryToCentre)
        {
            range = range.Clone();
            range.Normalize();
        ...
        /// </summary>
        virtual bool ProcessKey(Keys keyData)
        {
        ...
        void DoAction(FCTBAction action)
        {
            switch (action)
            {
        ...
        virtual void OnCustomAction(CustomActionEventArgs e)
        {
        ...
        bool GotoNextBookmark(int iLine)
        {
        ...
        /// </summary>
        /// <param name="iLine">Current bookmark line index</param>
        bool GotoPrevBookmark(int iLine)
        {
            Bookmark nearestBookmark = null;
        ...
        /// Bookmarks line
        /// </summary>
        virtual void BookmarkLine(int iLine)
        {
        ...
        /// </summary>
        virtual void UnbookmarkLine(int iLine)
        {
        ...
        /// Insert/remove comment prefix into selected lines
        /// </summary>
        virtual void CommentSelected(string commentPrefix)
        {
        ...
        void OnKeyPressing(KeyPressEventArgs args)
        {
            if (KeyPressing != null)
        ...
        override bool ProcessKeyMessage(ref Message m)
        {
            if (m.Msg == WM_CHAR)
        ...
        /// </summary>
        virtual bool ProcessKey(char c, Keys modifiers)
        {
            if (handledChar)
                return true;
        ...
        string AutoIndentCharsPatterns { get; set; }

        /// <summary>
        /// Do AutoIndentChars
        /// </summary>
        void DoAutoIndentChars(int iLine)
        {
        ...
        void DoAutoIndentChars(int iLine, Regex regex)
        {
        ...
        bool DoAutocompleteBrackets(char c)
        {
        ...
        bool InsertBrackets(char left, char right)
        {
            if (Selection.ColumnSelectionMode)
            {
        ...
        virtual void DoAutoIndentIfNeed()
        {
            if (Selection.ColumnSelectionMode)
                return;
            if (AutoIndent)
        ...
        /// </summary>
        virtual void DoAutoIndent(int iLine)
        {
            if (Selection.ColumnSelectionMode)
                return;
            Place oldStart = Selection.Start;
        ...
        /// </summary>
        virtual int CalcAutoIndent(int iLine)
        {
        ...
        int GetMaxStartSpacesCount(int fromLine, int toLine)
        {
            if (fromLine > toLine)
                return 0;
        ...
        void DrawText(Graphics* gr, Place start, Size size)
        {
            if (needRecalc)
                Recalc();
        ...
        void DrawMarkers(PaintEventArgs e, Pen servicePen)
        {
        ...
        Rectangle prevCaretRect;

        void DrawRecordingHint(Graphics* graphics)
        {
            const int w = 75;
            const int h = 13;
        ...
        void DrawTextAreaBorder(Graphics* graphics)
        {
        ...
        void PaintHintBrackets(Graphics* gr)
        {
        ...
        virtual void DrawFoldingLines(PaintEventArgs e, int startLine, int endLine)
        {
            e.Graphics.SmoothingMode = SmoothingMode.None;
        ...
        void DrawLineChars(Graphics* gr, int firstChar, int lastChar, int iLine, int iWordWrapLine, int startX,
                                   int y)
        {
            Line line = lines[iLine];
            LineInfo lineInfo = LineInfos[iLine];
        ...
        void OnMouseClickText(MouseEventArgs e)
        {
            //click on text
            Place oldEnd = Selection.End;
            Selection.BeginUpdate();
        ...
        virtual void CheckAndChangeSelectionType()
        {
        ...
        void DoScrollVertical(int countLines, int direction)
        {
            if (VerticalScroll.Visible || !ShowScrollBars)
            {
        ...
        /// </returns>
        static int GetControlPanelWheelScrollLinesValue()
        {
            try
            {
        ...
        Place PointToPlace(Point point)
        {
            #if debug
            var sw = Stopwatch.StartNew();
            #endif
        ...
        int PointToPosition(Point point)
        {
        ...
        /// Fires TextChanged event
        /// </summary>
        virtual void OnTextChanged(Range r)
        {
            OnTextChanged(new TextChangedEventArgs(r));
        }
        ...
        /// Fires TextChanged event
        /// </summary>
        virtual void OnTextChanged(TextChangedEventArgs args)
        {
            //
        ...
        /// </summary>
        void ClearFoldingState(Range range)
        {
        ...
        virtual void OnFoldingHighlightChanged()
        {
        ...
        int PlaceToPosition(Place point)
        {
        ...
        Point PlaceToPoint(Place place)
        {
        ...
        Range GetRange(int fromPos, int toPos)
        {
            var sel = new Range(this);
        ...
        /// <returns>Range</returns>
        Range GetRange(Place fromPlace, Place toPlace)
        {
        ...
        IEnumerable<Range> GetRanges(string regexPattern)
        {
        ...
        /// <param name="regexPattern">Regex pattern</param>
        /// <returns>Enumeration of ranges</returns>
        IEnumerable<Range> GetRanges(string regexPattern, RegexOptions options)
        {
            var range = new Range(this);
            range.SelectAll();
            //
        ...
        virtual void ExpandFoldedBlock(int iLine)
        {
            if (iLine < 0 || iLine >= lines.Count)
                throw new ArgumentOutOfRangeException("Line index out of range");
        ...
        /// </summary>
        virtual void ExpandBlock(int fromLine, int toLine)
        {
        ...
        /// </summary>
        virtual void CollapseAllFoldingBlocks()
        {
            for (int i = 0; i < LinesCount; i++)
        ...
        virtual void ExpandAllFoldingBlocks()
        {
            for (int i = 0; i < LinesCount; i++)
                SetVisibleState(i, VisibleState.Visible);
        ...
        virtual void CollapseFoldingBlock(int iLine)
        {
            if (iLine < 0 || iLine >= lines.Count)
                throw new ArgumentOutOfRangeException("Line index out of range");
        ...
        virtual int FindEndOfFoldingBlock(int iStartLine, int maxLines)
        {
            //find end of block
            int i;
        ...
        /// </summary>
        string GetLineFoldingStartMarker(int iLine)
        {
        ...
        /// </summary>
        string GetLineFoldingEndMarker(int iLine)
        {
        ...
        virtual void RecalcFoldingLines()
        {
            if (!needRecalcFoldingLines)
                return;
        ...
        /// Collapse text block
        /// </summary>
        virtual void CollapseBlock(int fromLine, int toLine)
        {
            int from = Math.Min(fromLine, toLine);
            int to = Math.Max(fromLine, toLine);
            if (from == to)
        ...
        /// </summary>
        virtual void DecreaseIndentOfSingleLine()
        {
        ...
        /// </summary>
        virtual void InsertLinePrefix(string prefix)
        {
            Range old = Selection.Clone();
        ...
        /// </summary>
        virtual void RemoveLinePrefix(string prefix)
        {
            Range old = Selection.Clone();
            int from = Math.Min(Selection.Start.iLine, Selection.End.iLine);
            int to = Math.Max(Selection.Start.iLine, Selection.End.iLine);
        ...
        virtual void OnVisualMarkerClick(MouseEventArgs args, StyleVisualMarker marker)
        {
        ...
        virtual void OnMarkerClick(MouseEventArgs args, VisualMarker marker)
        {
        ...
        virtual void OnMarkerDoubleClick(VisualMarker marker)
        {
            if (marker is FoldedAreaMarker)
            {
        ...
        void HighlightBrackets1(char LeftBracket, char RightBracket, ref Range leftBracketPosition, ref Range rightBracketPosition)
        {
            if (!Selection.IsEmpty)
                return;
            if (LinesCount == 0)
        ...
        /// </summary>
        Range GetBracketsRange(Place placeInsideBrackets, char leftBracket, char rightBracket)
        {
        ...
        void HighlightBrackets2(char LeftBracket, char RightBracket, ref Range leftBracketPosition, ref Range rightBracketPosition)
        {
            if (!Selection.IsEmpty)
                return;
            if (LinesCount == 0)
        ...
        /// </summary>
        bool SelectNext(string regexPattern, bool backward = false, RegexOptions options = RegexOptions.None)
        {
            var sel = Selection.Clone();
            sel.Normalize();
        ...
        virtual void OnSyntaxHighlight(TextChangedEventArgs args)
        {
            #if debug
        ...
        /// </summary>
        virtual void Print(Range range, PrintDialogSettings settings)
        {
        ...
        virtual string PrepareHtmlText(string s)
        {
        ...
        /// Prints all text
        /// </summary>
        void Print(PrintDialogSettings settings)
        {
...
window.status = ""#print"";
        ...
        static void SetPageSetupSettings(PrintDialogSettings settings)
        {
        ...
        virtual void OnPaintLine(PaintLineEventArgs e)
        {
            if (PaintLine != null)
                PaintLine(this, e);
        }
        ...
        /// Open text file
        /// </summary>
        void OpenFile(string fileName, Encoding enc)
        {
        ...
        void OpenBindingFile(string fileName, Encoding enc)
        {
        ...
        /// <param name="fileName"></param>
        /// <param name="enc"></param>
        void SaveToFile(string fileName, Encoding enc)
        {
        ...
        /// </summary>
        void SetVisibleState(int iLine, VisibleState state)
        {
            LineInfo li = LineInfos[iLine];
        ...
        /// </summary>
        VisibleState GetVisibleState(int iLine)
        {
        ...
        /// </summary>
        List<int> FindLines(string searchPattern, RegexOptions options)
        {
        ...
        /// Removes given lines
        /// </summary>
        void RemoveLines(List<int> iLines)
        {
        ...
        override void OnDragEnter(DragEventArgs e)
        {
        ...
        override void OnDragDrop(DragEventArgs e)
        {
        ...
        void DoDragDrop_old(Place place, string text)
        {
        ...
        virtual void DoDragDrop(Place place, string text)
        {
            Range insertRange = new Range(this, place, place);
        ...
        override void OnDragOver(DragEventArgs e)
        {
            if (e.Data.GetDataPresent(DataFormats.Text))
            {
                Point p = PointToClient(new Point(e.X, e.Y));
        ...
        bool middleClickScrollingActivated;
        Point middleClickScrollingOriginPoint;
        Point middleClickScrollingOriginScroll;
        readonly Timer middleClickScrollingTimer = new Timer();
        ScrollDirection middleClickScollDirection = ScrollDirection.None;

        /// <summary>
        /// Activates the scrolling mode (middle click button).
        /// </summary>
        /// <param name="e">MouseEventArgs</param>
        void ActivateMiddleClickScrollingMode(MouseEventArgs e)
        {
            if (!middleClickScrollingActivated)
            {
        ...
        /// </summary>
        void DeactivateMiddleClickScrollingMode()
        {
            if (middleClickScrollingActivated)
            {
        ...
        /// Restore scrolls
        /// </summary>
        void RestoreScrollsAfterMiddleClickScrollingMode()
        {
        ...
        void DrawMiddleClickScrolling(Graphics* gr)
        {
        ...
        void DrawTriangle(Graphics* g, Brush brush)
        {
            const int size = 5;
        ...
        struct LineYComparer : IComparer<LineInfo>
        {
            readonly int Y;
            ...
            int Compare(LineInfo x, LineInfo y)
            {
                if (x.startY == -10)
    ...
    struct PaintLineEventArgs : PaintEventArgs
    {
        PaintLineEventArgs(int iLine, Rectangle rect, Graphics* gr, Rectangle clipRect) : base(gr, clipRect)
        {
            LineIndex = iLine;
            LineRect = rect;
        }
        ...
        Rectangle LineRect { get; set; }
    }

    struct LineInsertedEventArgs : EventArgs
    {
        LineInsertedEventArgs(int index, int count)
        {
            Index = index;
            Count = count;
        }
    ...
    struct LineRemovedEventArgs : EventArgs
    {
        LineRemovedEventArgs(int index, int count, List<int> removedLineIds)
        {
            Index = index;
            Count = count;
        ...
        /// </summary>
        List<int> RemovedLineUniqueIds { get; set; }
    }
    ...
    struct TextChangedEventArgs : EventArgs
    {
        ...
        /// Constructor
        /// </summary>
        TextChangedEventArgs(Range changedRange)
        {
        ...
        /// </summary>
        Range ChangedRange { get; set; }
    }

    struct TextChangingEventArgs : EventArgs
    {
        string InsertingText { get; set; }
    ...
    struct WordWrapNeededEventArgs : EventArgs
    {
        List<int> CutOffPositions { get; set;}
        bool ImeAllowed { get; set;}
        Line Line { get; set; }

        WordWrapNeededEventArgs(List<int> cutOffPositions, bool imeAllowed, Line line)
        {
    ...
    struct PrintDialogSettings
    {
        ...
        bool ShowPageSetupDialog { get; set; }
        bool ShowPrintDialog { get; set; }
        bool ShowPrintPreviewDialog { get; set; }
    ...
    struct AutoIndentEventArgs : EventArgs
    {
        AutoIndentEventArgs(int iLine, string lineText, string prevLineText, int tabLength, int currentIndentation)
        {
            this->iLine = iLine;
            LineText = lineText;
        ...
        int iLine { get; internal set; }
        int TabLength { get; internal set; }
        string LineText { get; internal set; }
        string PrevLineText { get; internal set; }
    ...
    /// Strategy of search of end of folding block
    /// </summary>
    enum FindEndOfFoldingBlockStrategy
    {
        Strategy1,
        Strategy2
    }
    ...
    /// </summary>
    struct ToolTipNeededEventArgs : EventArgs
    {
        ToolTipNeededEventArgs(Place place, string hoveredWord)
        {
    ...
    /// </summary>
    struct HintClickEventArgs : EventArgs
    {
        HintClickEventArgs(Hint hint)
        {
            Hint = hint;
        }
    ...
    /// </summary>
    struct CustomActionEventArgs : EventArgs
    {
        FCTBAction Action { get; set; }

        CustomActionEventArgs(FCTBAction action)
        {
            Action = action;
        }
    }
    ...
    {
        Color CollapseMarkerForeColor { get; set; }
        Color CollapseMarkerBackColor { get; set; }
        Color CollapseMarkerBorderColor { get; set; }
        Color ExpandMarkerForeColor { get; set; }
        Color ExpandMarkerBackColor { get; set; }
        Color ExpandMarkerBorderColor { get; set; }
