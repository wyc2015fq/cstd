...
{
    static struct EncodingDetector
    {
        ...
        static Encoding DetectTextFileEncoding(string InputFilename)
        {
        ...
        static Encoding DetectTextFileEncoding(FileStream InputFileStream, long HeuristicSampleSize)
        {
            bool uselessBool = false;
            return DetectTextFileEncoding(InputFileStream, _defaultHeuristicSampleSize, out uselessBool);
        }

        static Encoding DetectTextFileEncoding(FileStream InputFileStream, long HeuristicSampleSize, out bool HasBOM)
        {
        ...
        static Encoding DetectBOMBytes(byte[] BOMBytes)
        {
        ...
        static Encoding DetectUnicodeInByteSampleByHeuristics(byte[] SampleBytes)
        {
        ...
        static bool IsCommonUSASCIIByte(byte testByte)
        {
            if (testByte == 0x0A //lf
                || testByte == 0x0D //cr
                || testByte == 0x09 //tab
        ...
        static int DetectSuspiciousUTF8SequenceLength(byte[] SampleBytes, long currentPos)
        {
            int lengthFound = 0;
