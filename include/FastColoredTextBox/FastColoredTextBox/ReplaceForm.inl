...
{
    partial struct ReplaceForm : Form
    {
        FastColoredTextBox tb;
        bool firstSearch = true;
        Place startPlace;

        ReplaceForm(FastColoredTextBox tb)
        {
            InitializeComponent();
            this->tb = tb;
        }
        ...
        void btFindNext_Click(object sender, EventArgs e)
        {
            try
            {
                if (!Find(tbFind.Text))
        ...
        void tbFind_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
        ...
        override bool ProcessCmdKey(ref Message msg, Keys keyData) // David
        {
        ...
        void ReplaceForm_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        void btReplaceAll_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        void cbMatchCase_CheckedChanged(object sender, EventArgs e)
        {
            ResetSerach();
        }
    }
