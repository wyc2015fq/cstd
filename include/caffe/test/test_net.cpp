...
namespace caffe
{
  ...
  protected:
    ...
    virtual void CopyNetBlobs(const bool copy_diff,
                              vector<boost::shared_ptr<Blob<Dtype> > >* blobs_copy) {
      CHECK(net_);
      const vector<boost::shared_ptr<Blob<Dtype> > > & net_blobs = net_->blobs();
      blobs_copy->clear();
    ...
    virtual void CopyNetParams(const bool copy_diff,
                               vector<boost::shared_ptr<Blob<Dtype> > >* params_copy) {
      CHECK(net_);
      const vector<boost::shared_ptr<Blob<Dtype> > > & net_params = net_->params();
      params_copy->clear();
  ...
  TYPED_TEST(NetTest, TestLossWeight)
  {
    ...
    vector<boost::shared_ptr<Blob<Dtype> > > blob_grads;
    this->CopyNetBlobs(kCopyDiff, &blob_grads);
    vector<boost::shared_ptr<Blob<Dtype> > > param_grads;
    ...
    for (int i = 0; i < kNumLossWeights; ++i) {
      ...
      const vector<boost::shared_ptr<Blob<Dtype> > > & weighted_blobs =
        this->net_->blobs();
      ...
      const vector<boost::shared_ptr<Blob<Dtype> > > & weighted_params =
        this->net_->params();
  ...
  TYPED_TEST(NetTest, TestComboLossWeight)
  {
    ...
    vector<boost::shared_ptr<Blob<Dtype> > > blob_grads_loss_2;
    this->CopyNetBlobs(kCopyDiff, &blob_grads_loss_2);
    vector<boost::shared_ptr<Blob<Dtype> > > param_grads_loss_2;
    ...
    const vector<boost::shared_ptr<Blob<Dtype> > > & blob_grads_loss_3 =
      this->net_->blobs();
    ...
    const vector<boost::shared_ptr<Blob<Dtype> > > & blob_grads_midnet_loss_3 =
      this->net_->blobs();
  ...
  TYPED_TEST(NetTest, TestParamPropagateDown)
  {
    ...
    this->net_->Forward();
    this->net_->Backward();
    const vector<boost::shared_ptr<Blob<Dtype> > > & params = this->net_->params();
    ...
    this->net_->Forward();
    this->net_->Backward();
    const vector<boost::shared_ptr<Blob<Dtype> > > & params2 = this->net_->params();
    ...
    this->net_->Forward();
    this->net_->Backward();
    const vector<boost::shared_ptr<Blob<Dtype> > > & params3 = this->net_->params();
    ...
    this->net_->Forward();
    this->net_->Backward();
    const vector<boost::shared_ptr<Blob<Dtype> > > & params4 = this->net_->params();
  ...
  TYPED_TEST(NetTest, TestReshape)
  {
    ...
    boost::shared_ptr<Blob<Dtype> > input_blob = this->net_->blob_by_name("data");
