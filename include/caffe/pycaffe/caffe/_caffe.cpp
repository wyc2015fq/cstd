...
1>          ]
1>  C:\local\boost_1_65_0\boost / type_traits / alignment_of.hpp(41) : note: 由于下列成员:
1>  C:\local\boost_1_65_0\boost / type_traits / alignment_of.hpp(41) : note: “void caffe::Solver<Dtype>::ApplyUpdate(void)” : 是抽象的
1>          with
#endif
