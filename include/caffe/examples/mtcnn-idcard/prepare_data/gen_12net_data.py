...
for annotation in annotations:
    ...
    for i in range(na):
        ...
        bbox = bound_box_ex(pts_ex(pts2), ex_r)
        ...
        for box in boxes:
            ...
            n_idx = save_rand_image(neg_save_dir,img,box,boxes,0,0,0.3,n_idx,max_num,outsize,f2,None,0,all_list)
            p_idx = save_rand_image(pos_save_dir,img,box,boxes,0,0.65,1,p_idx,max_num,outsize,f1,pts2,1,all_list)
            d_idx = save_rand_image(part_save_dir,img,box,boxes,0,0.4,0.65,d_idx,max_num,outsize,f3,pts2,-1,all_list)
...
pickle_save(os.path.join(save_dir, "all.imdb"), all_list)
#all_list2 = pickle_load(os.path.join(save_dir, "all.imdb"))
