...
#define MCVIP_CHANNELS_MAX    (16)    ///< Max channels that can be captured over one video input port
...
#define MCVIP_CAPTURE_THR_PRI_MED   (75)  ///< Capture Thread Priority: Medium
#define MCVIP_CAPTURE_THR_PRI_HIGH  (99) ///< Capture Thread Priority: High (recommended)
...
#define MCVIP_VIDEO_DECODER_MODE_4CH_HALF_D1               1   ///< Video decoder mode: 4CH Half-D1
#define MCVIP_VIDEO_DECODER_MODE_4CH_CIF                   2   ///< Video decoder mode: 4CH CIF
#define MCVIP_VIDEO_DECODER_MODE_8CH_CIF                   3   ///< Video decoder mode: 8CH CIF
#define MCVIP_VIDEO_DECODER_MODE_4CH_HALF_D1_PLUS_D1       4   ///< Video decoder mode: 4CH Half-D1 + D1
#define MCVIP_VIDEO_DECODER_MODE_4CH_CIF_PLUS_D1           5   ///< Video decoder mode: 4CH CIF     + D1
#define MCVIP_VIDEO_DECODER_MODE_8CH_CIF_PLUS_D1           6   ///< Video decoder mode: 8CH CIF     + D1
#define MCVIP_VIDEO_DECODER_MODE_2CH_D1_CROP               7   ///< Video decoder mode: 2CH D1 CROPPED
#define MCVIP_VIDEO_DECODER_MODE_4CH_HALF_D1_CROP          8   ///< Video decoder mode: 4CH Half-D1 CROPPED
#define MCVIP_VIDEO_DECODER_MODE_4CH_CIF_CROP              9   ///< Video decoder mode: 4CH CIF CROPPED
#define MCVIP_VIDEO_DECODER_MODE_8CH_CIF_CROP             10   ///< Video decoder mode: 8CH CIF CROPPED
#define MCVIP_VIDEO_DECODER_MODE_4CH_HALF_D1_PLUS_D1_CROP 11   ///< Video decoder mode: 4CH Half-D1 + D1 CROPPED
#define MCVIP_VIDEO_DECODER_MODE_4CH_CIF_PLUS_D1_CROP     12   ///< Video decoder mode: 4CH CIF     + D1 CROPPED
#define MCVIP_VIDEO_DECODER_MODE_8CH_CIF_PLUS_D1_CROP     13   ///< Video decoder mode: 8CH CIF     + D1 CROPPED
#define MCVIP_VIDEO_DECODER_MODE_MAX                      14   ///< Video decoder mode: Max
