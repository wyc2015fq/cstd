...
extern int nline = 1;
// int nline=1 已经在别的文件中定义过了，在这里只是引用
/*
* Malloc the AC Memory
*/
static void* AC_MALLOC(int n) //void表示未确定类型的指针
{
...
/*
* Simple QUEUE Structure 简单的队列结构
*/
...
/*
*Init the Queue 初始化队列
*/
static void queue_init(QUEUE* s)
{
  s->head = s->tail = 0; // 指向最开始的0位置
  s->count = 0;
}
/*
