...
*/
CV_INLINE u32 strtoul10(const char* in, const char** out=0)
{
	if (!in)
	{
		if (out)
...
/** \param[in] in: The string of digits to convert. Only a leading - or +
    ...
    returned.
*/
CV_INLINE s32 strtol10(const char* in, const char** out=0)
{
	if (!in)
	{
		if (out)
...
/** \param[in] in: The string of digits to convert. No leading chars are
    ...
    too many digits to encode in an u32 then INT_MAX will be returned.
*/
CV_INLINE u32 strtoul16(const char* in, const char** out=0)
{
	if (!in)
	{
		if (out)
...
/** \param[in] in The string of digits to convert. No leading chars are
    ...
    too many digits to encode in an u32 then INT_MAX will be returned.
*/
CV_INLINE u32 strtoul8(const char* in, const char** out=0)
{
	if (!in)
	{
		if (out)
...
/** \param[in] in The string of digits to convert. If string starts with 0x the
    ...
    too many digits to encode in an u32 then INT_MAX will be returned.
*/
CV_INLINE u32 strtoul_prefix(const char* in, const char** out=0)
{
	if (!in)
	{
		if (out)
...
/** Only digits 0 to 9 are parsed.  Parsing stops at any other character,
    ...
    sequence.
*/
CV_INLINE f32 strtof10(const char* in, const char** out = 0)
{
	if (!in)
	{
		if (out)
...
*/
CV_INLINE float fast_atof(const char* floatAsString, const char** out=0)
{
	float ret;
	if (out)
