 ...
 */
ArrayVector LoadLibFunction(int nargout, const ArrayVector& arg, interpreter_t* eval);
/**
 * import a C function
 */
ArrayVector ImportFunction(int nargout, const ArrayVector& arg, interpreter_t* eval);
/**
 *  Add the loadlib and import functions to the given context.
 */
void LoadModuleFunctions(context_t* context);
