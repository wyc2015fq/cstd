...
//F*/
#if 0
CvStatus icvForward1DHMM(int num_states, int num_obs, CvMatr64d A, CvMatr64d B, double* scales)
{
...
//    Notes:
//F*/
CvStatus icvCreate1DHMM(CvEHMM** this_hmm, int state_number, int* num_mix, int obs_size)
{
  int i;
