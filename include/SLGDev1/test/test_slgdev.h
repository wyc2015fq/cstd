...
int VideoProCB1(const VideoPro* pro)
{
    //printf("w=%d h=%d\n", pro->biWidth, pro->biHeight);
    return 0;
}
...
#include "../sock/openssl.h"
#ifdef USE_SSL
#include "test_openssl_net.h"
#endif // USE_SSL
...
int test_slgdev()
{
    if (0)
    {
        ...
        str_ip = "dasd-dj-cc.dd24gf-vslgdev_privateSDSFEFDdsdFSDF.cdddf.ewrwerwes.werwerwe.1233.22.cc.cc.test_1.test-1.com";
    ...
    if (0)
    {
        ...
        DEV_APPUPDATE c = {0};
        char* path = "C:/rootca/111/yi_cert.pfx";
        char* buf = NULL;
        if (1)
        {
            pass = "secret";
            path = "C:/rootca/111/jim_cert.pfx";
        }
        if (1)
        {
            pass = "123456";
            path = "C:/rootca/111/keypair(1).pfx";
        }
