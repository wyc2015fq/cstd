...
// #define WAKE_MOTION_SNS         0x40000000

// Other Setting with bit
#define ENABLE_IPV4             0x00000001
#define ENABLE_IPV6             0x00000002
#define IPV4_DHCP_ENABLED       0x00000004    //开启IPv4的DHCP服务
#define IPV6_DHCP_ENABLED       0x00000008    //开启IPv6的DHCP服务
#define ENABLE_CARD_FULL_CMP    0x00000010    //Full card comparision, include facility code.
...
#define WG_48  8
    ...
    typedef struct
    {
        ...
        char m_VerifyMode;
        //BIT(0)  : 0不输出扩展韦根信号,1输出. bu yong
        //BIT(1)  : 0输出韦根26,1输出韦根34.  bu yong
        //BIT(2)  : 0按照BIT(4)输出 , 1输出m_OutputCtx中指定内容
        //BIT(4)  : 0直接输出卡号,1输出编号
        //BIT(4-7): WG输出协议, 0-disable , 1-wg26 , 2-wg34 , 3-wg35 , 4-wg36 , 5-wg37 , 6-wg44 , 7-wg45 , 8-wg48
        char m_OutputWG;
        //韦根协议输出内容
        int m_OutputCtx;
    } DEVSET;
