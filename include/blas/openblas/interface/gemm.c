...
#undef ERROR_NAME
#undef GEMM_MULTITHREAD_THRESHOLD
...
static void NAME(char *TRANSA, char *TRANSB,
...
static void CNAME(enum CBLAS_ORDER order, enum CBLAS_TRANSPOSE TransA, enum CBLAS_TRANSPOSE TransB,
	   blasint m, blasint n, blasint k,
#ifndef COMPLEX
	   FLOAT alpha,
#else
