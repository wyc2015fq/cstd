...
#undef GEMM_RT
#undef GEMM_TC
#undef GEMM_THREAD_CC
#undef GEMM_THREAD_CN
#undef GEMM_THREAD_CR
#undef GEMM_THREAD_CT
#undef GEMM_THREAD_NC
#undef GEMM_THREAD_NN
#undef GEMM_THREAD_NR
#undef GEMM_THREAD_NT
#undef GEMM_THREAD_RC
#undef GEMM_THREAD_RN
#undef GEMM_THREAD_RR
#undef GEMM_THREAD_RT
#undef GEMM_THREAD_TC
#undef GEMM_THREAD_TN
#undef GEMM_THREAD_TR
#undef GEMM_THREAD_TT
#undef GEMM_TN
#undef GEMM_TR
#undef GEMM_TT
#undef GEMM3M_CC
...
#undef GEMM3M_CR
#undef GEMM3M_CT
#undef GEMM3M_INCOPYB
#undef GEMM3M_INCOPYI
#undef GEMM3M_INCOPYR
#undef GEMM3M_ITCOPYB
#undef GEMM3M_ITCOPYI
#undef GEMM3M_ITCOPYR
#undef GEMM3M_KERNEL
#undef GEMM3M_NC
#undef GEMM3M_NN
#undef GEMM3M_NR
#undef GEMM3M_NT
#undef GEMM3M_ONCOPYB
#undef GEMM3M_ONCOPYI
#undef GEMM3M_ONCOPYR
#undef GEMM3M_OTCOPYB
#undef GEMM3M_OTCOPYI
#undef GEMM3M_OTCOPYR
#undef GEMM3M_RC
#undef GEMM3M_RN
#undef GEMM3M_RR
#undef GEMM3M_RT
#undef GEMM3M_TC
#undef GEMM3M_THREAD_CC
#undef GEMM3M_THREAD_CN
#undef GEMM3M_THREAD_CR
#undef GEMM3M_THREAD_CT
#undef GEMM3M_THREAD_NC
#undef GEMM3M_THREAD_NN
#undef GEMM3M_THREAD_NR
#undef GEMM3M_THREAD_NT
#undef GEMM3M_THREAD_RC
#undef GEMM3M_THREAD_RN
#undef GEMM3M_THREAD_RR
#undef GEMM3M_THREAD_RT
#undef GEMM3M_THREAD_TC
#undef GEMM3M_THREAD_TN
#undef GEMM3M_THREAD_TR
#undef GEMM3M_THREAD_TT
#undef GEMM3M_TN
#undef GEMM3M_TR
#undef GEMM3M_TT
#undef GEMV_C
...
#undef GETF2
#undef GETRF
#undef GETRF_PARALLEL
#undef GETRF_SINGLE
#undef GETRS_C_PARALLEL
#undef GETRS_C_SINGLE
#undef GETRS_N
#undef GETRS_N_PARALLEL
#undef GETRS_N_SINGLE
#undef GETRS_R_PARALLEL
#undef GETRS_R_SINGLE
#undef GETRS_T
#undef GETRS_T_PARALLEL
#undef GETRS_T_SINGLE
#undef HEMM_ILTCOPY
#undef HEMM_IUTCOPY
#undef HEMM_LL
#undef HEMM_LU
...
#undef HEMM_RL
#undef HEMM_RU
#undef HEMM_THREAD_LL
#undef HEMM_THREAD_LU
#undef HEMM_THREAD_RL
#undef HEMM_THREAD_RU
#undef HEMM3M_ILCOPYB
#undef HEMM3M_ILCOPYI
#undef HEMM3M_ILCOPYR
#undef HEMM3M_IUCOPYB
#undef HEMM3M_IUCOPYI
#undef HEMM3M_IUCOPYR
#undef HEMM3M_LL
#undef HEMM3M_LU
#undef HEMM3M_OLCOPYB
#undef HEMM3M_OLCOPYI
#undef HEMM3M_OLCOPYR
#undef HEMM3M_OUCOPYB
#undef HEMM3M_OUCOPYI
#undef HEMM3M_OUCOPYR
#undef HEMM3M_RL
#undef HEMM3M_RU
#undef HEMM3M_THREAD_LL
#undef HEMM3M_THREAD_LU
#undef HEMM3M_THREAD_RL
#undef HEMM3M_THREAD_RU
#undef HEMV_L
#undef HEMV_M
#undef HEMV_THREAD_L
#undef HEMV_THREAD_M
...
#undef HERK_LC
#undef HERK_LN
#undef HERK_THREAD_LC
#undef HERK_THREAD_LN
#undef HERK_THREAD_LR
#undef HERK_THREAD_LT
#undef HERK_THREAD_UC
#undef HERK_THREAD_UN
#undef HERK_THREAD_UR
#undef HERK_THREAD_UT
#undef HERK_UC
#undef HERK_UN
#undef IAMAX_K
#undef IAMIN_K
#undef IMATCOPY_K_CN
#undef IMATCOPY_K_CNC
#undef IMATCOPY_K_CT
#undef IMATCOPY_K_CTC
#undef IMATCOPY_K_RN
#undef IMATCOPY_K_RNC
#undef IMATCOPY_K_RT
#undef IMATCOPY_K_RTC
#undef IMAX_K
#undef IMIN_K
#undef LARF_L
#undef LARF_R
...
#undef LAUU2_L
#undef LAUU2_U
#undef LAUUM_L_PARALLEL
#undef LAUUM_L_SINGLE
#undef LAUUM_U_PARALLEL
#undef LAUUM_U_SINGLE
#undef MAX_K
#undef MIN_K
#undef NEG_TCOPY
#undef NRM2_K
#undef OMATCOPY_K_CN
#undef OMATCOPY_K_CNC
#undef OMATCOPY_K_CT
#undef OMATCOPY_K_CTC
#undef OMATCOPY_K_RN
#undef OMATCOPY_K_RNC
#undef OMATCOPY_K_RT
#undef OMATCOPY_K_RTC
#undef POTF2_L
#undef POTF2_U
#undef POTRF_L_PARALLEL
#undef POTRF_L_SINGLE
#undef POTRF_U_PARALLEL
#undef POTRF_U_SINGLE
#undef QGETF2
#undef QLARF_L
#undef QLARF_R
#undef QLASWP_MINUS
...
#undef SYMM_RL
#undef SYMM_RU
#undef SYMM_THREAD_LL
#undef SYMM_THREAD_LU
#undef SYMM_THREAD_RL
#undef SYMM_THREAD_RU
#undef SYMM3M_ILCOPYB
#undef SYMM3M_ILCOPYI
#undef SYMM3M_ILCOPYR
#undef SYMM3M_IUCOPYB
#undef SYMM3M_IUCOPYI
#undef SYMM3M_IUCOPYR
#undef SYMM3M_LL
#undef SYMM3M_LU
#undef SYMM3M_OLCOPYB
#undef SYMM3M_OLCOPYI
#undef SYMM3M_OLCOPYR
#undef SYMM3M_OUCOPYB
#undef SYMM3M_OUCOPYI
#undef SYMM3M_OUCOPYR
#undef SYMM3M_RL
#undef SYMM3M_RU
#undef SYMM3M_THREAD_LL
#undef SYMM3M_THREAD_LU
#undef SYMM3M_THREAD_RL
#undef SYMM3M_THREAD_RU
#undef SYMV_L
#undef SYMV_THREAD_L
#undef SYMV_THREAD_U
#undef SYMV_U
#undef SYR2K_KERNEL_L
#undef SYR2K_KERNEL_U
#undef SYR2K_LC
#undef SYR2K_LN
#undef SYR2K_LR
#undef SYR2K_LT
...
#undef SYRK_LR
#undef SYRK_LT
#undef SYRK_THREAD_LC
#undef SYRK_THREAD_LN
#undef SYRK_THREAD_LR
#undef SYRK_THREAD_LT
#undef SYRK_THREAD_UC
#undef SYRK_THREAD_UN
#undef SYRK_THREAD_UR
#undef SYRK_THREAD_UT
#undef SYRK_UC
#undef SYRK_UN
#undef SYRK_UR
#undef SYRK_UT
...
#undef TRMM_IUNCOPY
#undef TRMM_IUTCOPY
#undef TRMM_KERNEL_LC
#undef TRMM_KERNEL_LN
#undef TRMM_KERNEL_LR
#undef TRMM_KERNEL_LT
#undef TRMM_KERNEL_RC
#undef TRMM_KERNEL_RN
#undef TRMM_KERNEL_RR
#undef TRMM_KERNEL_RT
#undef TRMM_LCLN
#undef TRMM_LCLU
#undef TRMM_LCUN
#undef TRMM_LCUU
...
#undef TRMV_NUN
#undef TRMV_NUU
#undef TRMV_THREAD_NLN
#undef TRMV_THREAD_NLU
#undef TRMV_THREAD_NUN
#undef TRMV_THREAD_NUU
#undef TRMV_THREAD_TLN
#undef TRMV_THREAD_TLU
#undef TRMV_THREAD_TUN
#undef TRMV_THREAD_TUU
#undef TRMV_TLN
#undef TRMV_TLU
#undef TRMV_TUN
#undef TRMV_TUU
...
#undef TRSM_IUNCOPY
#undef TRSM_IUTCOPY
#undef TRSM_KERNEL_LC
#undef TRSM_KERNEL_LN
#undef TRSM_KERNEL_LR
#undef TRSM_KERNEL_LT
#undef TRSM_KERNEL_RC
#undef TRSM_KERNEL_RN
#undef TRSM_KERNEL_RR
#undef TRSM_KERNEL_RT
#undef TRSM_LCLN
#undef TRSM_LCLU
#undef TRSM_LCUN
#undef TRSM_LCUU
...
#undef TRTI2_UN
#undef TRTI2_UU
#undef TRTRI_LN_PARALLEL
#undef TRTRI_LN_SINGLE
#undef TRTRI_LU_PARALLEL
#undef TRTRI_LU_SINGLE
#undef TRTRI_UN_PARALLEL
#undef TRTRI_UN_SINGLE
#undef TRTRI_UU_PARALLEL
#undef TRTRI_UU_SINGLE
#undef XGETF2
#undef XLARF_L
#undef XLARF_R
#undef XLASWP_MINUS
...
#undef ZTRMV_RUN
#undef ZTRMV_RUU
#undef ZTRMV_THREAD_CLN
#undef ZTRMV_THREAD_CLU
#undef ZTRMV_THREAD_CUN
#undef ZTRMV_THREAD_CUU
#undef ZTRMV_THREAD_NLN
#undef ZTRMV_THREAD_NLU
#undef ZTRMV_THREAD_NUN
#undef ZTRMV_THREAD_NUU
#undef ZTRMV_THREAD_RLN
#undef ZTRMV_THREAD_RLU
#undef ZTRMV_THREAD_RUN
#undef ZTRMV_THREAD_RUU
#undef ZTRMV_THREAD_TLN
#undef ZTRMV_THREAD_TLU
#undef ZTRMV_THREAD_TUN
#undef ZTRMV_THREAD_TUU
#undef ZTRMV_TLN
#undef ZTRMV_TLU
#undef ZTRMV_TUN
#undef ZTRMV_TUU
