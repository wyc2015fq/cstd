...
#include "kernel/CMakeFiles/sgemm_beta.c"//int sgemm_beta(BLASLONG, BLASLONG, BLASLONG, float, float  *, BLASLONG, float   *, BLASLONG, float  *, BLASLONG);
#include "kernel/CMakeFiles/dgemm_beta.c"//int dgemm_beta(BLASLONG, BLASLONG, BLASLONG, double,double *, BLASLONG, double  *, BLASLONG, double *, BLASLONG);
...
#include "kernel/CMakeFiles/sgemm_oncopy.c"//int sgemm_oncopy(BLASLONG m, BLASLONG n, float *a, BLASLONG lda, float *b);
#include "kernel/CMakeFiles/sgemm_otcopy.c"//int sgemm_otcopy(BLASLONG m, BLASLONG n, float *a, BLASLONG lda, float *b);
...
#include "kernel/CMakeFiles/dgemm_oncopy.c"//int dgemm_oncopy(BLASLONG m, BLASLONG n, double *a, BLASLONG lda, double *b);
#include "kernel/CMakeFiles/dgemm_otcopy.c"//int dgemm_otcopy(BLASLONG m, BLASLONG n, double *a, BLASLONG lda, double *b);
...
#include "kernel/CMakeFiles/sgemm_kernel.c"//int sgemm_kernel(BLASLONG, BLASLONG, BLASLONG, float,  float  *, float  *, float  *, BLASLONG);
#include "kernel/CMakeFiles/dgemm_kernel.c"//int dgemm_kernel(BLASLONG, BLASLONG, BLASLONG, double, double *, double *, double *, BLASLONG);
...
#include "driver/level3/CMakeFiles/sgemm_nn.c"//int sgemm_nn(blas_arg_t *, BLASLONG *, BLASLONG *, float *, float *, BLASLONG);
#include "driver/level3/CMakeFiles/sgemm_nt.c"//int sgemm_nt(blas_arg_t *, BLASLONG *, BLASLONG *, float *, float *, BLASLONG);
#include "driver/level3/CMakeFiles/sgemm_tn.c"//int sgemm_tn(blas_arg_t *, BLASLONG *, BLASLONG *, float *, float *, BLASLONG);
#include "driver/level3/CMakeFiles/sgemm_tt.c"//int sgemm_tt(blas_arg_t *, BLASLONG *, BLASLONG *, float *, float *, BLASLONG);

#include "driver/level3/CMakeFiles/dgemm_nn.c"//int dgemm_nn(blas_arg_t *, BLASLONG *, BLASLONG *, double *, double *, BLASLONG);
#include "driver/level3/CMakeFiles/dgemm_nt.c"//int dgemm_nt(blas_arg_t *, BLASLONG *, BLASLONG *, double *, double *, BLASLONG);
#include "driver/level3/CMakeFiles/dgemm_tn.c"//int dgemm_tn(blas_arg_t *, BLASLONG *, BLASLONG *, double *, double *, BLASLONG);
#include "driver/level3/CMakeFiles/dgemm_tt.c"//int dgemm_tt(blas_arg_t *, BLASLONG *, BLASLONG *, double *, double *, BLASLONG);
