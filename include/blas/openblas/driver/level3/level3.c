#undef A
#undef B
#undef BETA_OPERATION
#undef C
#undef FUSED_KERNEL_OPERATION
#undef ICOPY_OPERATION
#undef K
#undef KERNEL_FUNC
#undef KERNEL_OPERATION
#undef LDA
#undef LDB
#undef LDC
#undef M
#undef N
#undef OCOPY_OPERATION
#undef START_RPCC
#undef STOP_RPCC
...
static int CNAME(blas_arg_t *args, BLASLONG *range_m, BLASLONG *range_n,
