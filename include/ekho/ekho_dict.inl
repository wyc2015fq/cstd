...
void Dict::addSpecialSymbols(void) {
  ...
  mPunctuationNameMap[59] = "·ÖºÅ";
  addDictItem(65307, mFullPause); // Chinese ";"
  mPunctuationNameMap[65307] = "·ÖºÅ";
  addDictItem(12290, mFullPause); // Chinese "."
  mPunctuationNameMap[12290] = "¾äºÅ";
  addDictItem(63, mFullPause); // ?
  mPunctuationNameMap[63] = "ÎÊºÅ";
  ...
  mPunctuationNameMap[46] = "µã";

  // half pauses
  addDictItem(44, mHalfPause); // ","
  mPunctuationNameMap[44] = "¶ººÅ";
  addDictItem(65292, mHalfPause); // Chinese ","
  mPunctuationNameMap[65292] = "¶ººÅ";
  addDictItem(58, mHalfPause); // ":"
  mPunctuationNameMap[58] = "Ã°ºÅ";
  addDictItem(65306, mHalfPause); // Chinese ":"
  mPunctuationNameMap[65306] = "Ã°ºÅ";
  addDictItem(8230, mHalfPause); // Chinese "..."
  mPunctuationNameMap[8230] = "Ê¡ÂÔºÅ";

  // quater pauses
  addDictItem(45, mQuaterPause); // "-"
  mPunctuationNameMap[45] = "¼õºÅ";
  addDictItem(8212, mQuaterPause); // Chinese "-"
  mPunctuationNameMap[8212] = "¼õºÅ";
//  addDictItem(32, mQuaterPause); // " "
//  addDictItem(12288, mQuaterPause); // Chinese " "
  addDictItem(39, mQuaterPause); // "'"
  mPunctuationNameMap[39] = "µ¥ÒýºÅ";
  addDictItem(8216, mQuaterPause); // Chinese "'"
  mPunctuationNameMap[8216] = "µ¥ÒýºÅ";
  addDictItem(34, mQuaterPause); // '"'
  mPunctuationNameMap[34] = "Ë«ÒýºÅ";
  addDictItem(8220, mQuaterPause); // Chinese '"'
  mPunctuationNameMap[8220] = "Ë«ÒýºÅ";
  addDictItem(40, mQuaterPause); // "("
  mPunctuationNameMap[40] = "×óÀ¨ºÅ";
  addDictItem(65288, mQuaterPause); // Chinese "("
  mPunctuationNameMap[65288] = "×óÀ¨ºÅ";
  addDictItem(41, mQuaterPause); // ")"
  mPunctuationNameMap[41] = "ÓÒÀ¨ºÅ";
  addDictItem(65289, mQuaterPause); // Chinese ")"
  mPunctuationNameMap[65289] = "ÓÒÀ¨ºÅ";
  addDictItem(12298, mQuaterPause); // Chinese "<<"
  mPunctuationNameMap[12298] = "×óÊéÃûºÅ";
  addDictItem(12299, mQuaterPause); // Chinese ">>"
  mPunctuationNameMap[12299] = "ÓÒÊéÃûºÅ";
  addDictItem(91, mQuaterPause); // Chinese "["
  mPunctuationNameMap[91] = "×óÖÐÀ¨ºÅ";
  addDictItem(12300, mQuaterPause); // Chinese "["
  mPunctuationNameMap[12300] = "×óÖÐÀ¨ºÅ";
  addDictItem(93, mQuaterPause); // Chinese "]"
  mPunctuationNameMap[93] = "ÓÒÖÐÀ¨ºÅ";
  addDictItem(12301, mQuaterPause); // Chinese "]"
  mPunctuationNameMap[12301] = "ÓÒÖÐÀ¨ºÅ";
  addDictItem(12302, mQuaterPause); // Chinese "[["
  mPunctuationNameMap[12302] = "×óÊéÃûºÅ";
  addDictItem(12303, mQuaterPause); // Chinese "]]"
  mPunctuationNameMap[12303] = "ÓÒÊéÃûºÅ";

  // for Tibetan
  mPunctuationNameMap[3853] = "??"; // "shad";
  mPunctuationNameMap[3851] = "?????"; // "tseg";

  // + - * / ? ... £û£ý¡°¡±{}#$%^&*()_+| backslash <>~` 
  mPunctuationNameMap[43] = "¼ÓºÅ";
  mPunctuationNameMap[42] = "³ËºÅ";
  mPunctuationNameMap[47] = "³ýºÅ";
  mPunctuationNameMap[61] = "µÈºÅ";
  mPunctuationNameMap[33] = "Ì¾ºÅ";
  mPunctuationNameMap[65371] = "×ó´óÀ¨ºÅ";
  mPunctuationNameMap[65373] = "ÓÒ´óÀ¨ºÅ";
  mPunctuationNameMap[8221] = "ÓÒË«ÒýºÅ";
  mPunctuationNameMap[123] = "×ó´óÀ¨ºÅ";
  mPunctuationNameMap[125] = "ÓÒ´óÀ¨ºÅ";
  mPunctuationNameMap[35] = "¾®ºÅ";
  mPunctuationNameMap[36] = "ÃÀÔª·ûºÅ";
  mPunctuationNameMap[37] = "°Ù·ÖºÅ";
  mPunctuationNameMap[94] = "³Ë·½·ûºÅ";
  mPunctuationNameMap[38] = "·ûºÅÓë";
  mPunctuationNameMap[95] = "ÏÂ»®Ïß";
  mPunctuationNameMap[124] = "·ûºÅ»ò";
  mPunctuationNameMap[92] = "·´Ð±¸Ü";
  mPunctuationNameMap[60] = "Ð¡ÓÚºÅ";
  mPunctuationNameMap[62] = "´óÓÚºÅ";
  mPunctuationNameMap[126] = "²¨ÀËºÅ";
  mPunctuationNameMap[96] = "×óµ¥ÒýºÅ";
}
