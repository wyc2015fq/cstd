...
int CALLAGREEMENT _color_to_rgb(const char* name, int len, unsigned long* rgb)
{
  char buf[256];
...
int CALLAGREEMENT _search_pix(LPXPMCOLOR pcol, int ncol, const char* pix, int cpp)
{
  int i;
