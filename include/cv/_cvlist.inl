...
#define CC_FORCE_INLINE CC_INLINE

#if !defined(_LIST_INLINE)
#define _LIST_INLINE CC_FORCE_INLINE
#endif /*_LIST_INLINE*/
...
#define INSERT_NEW(element_type, l, element)\
    ...
    {\
        ...
        {\
            *(void**)l->m_buffer = cAlloc(l->m_buf_size*sizeof(element_type) + sizeof(void*));\
...
{\
    _CVLIST* pl = (_CVLIST*)cAlloc(sizeof(_CVLIST));\
    pl->m_buf_size = size > 0 ? size : default_size;\
    pl->m_first_buffer = cAlloc(pl->m_buf_size*sizeof(ELEMENT_##type) + sizeof(void*));\
