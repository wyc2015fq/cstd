...
#undef CC_8TO32F
#undef CC_SQR_8U
#define CC_8TO32F(x)  icv8x32fTab[(x)+128]
#define CC_SQR_8U(x)  icv8x16uSqrTab[(x)+255]

#undef icvIplToCvDepth
#define icvIplToCvDepth(depth) \
    icvDepthToType[(((depth) & 255) >> 2) + ((depth) < 0)]

#undef CC_FAST_CAST_8U
#define CC_FAST_CAST_8U(t)   (assert(-256 <= (t) && (t) <= 512), icvSaturate8u[(t)+256])
...
{
    -1, -1, CC_8U, CC_8S, CC_16U, CC_16S, -1, -1,
    CC_32F, CC_32S, -1, -1, -1, -1, -1, -1, CC_64F, -1
};
