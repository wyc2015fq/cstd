...
namespace perf
{
    img_t readImage(const string& fileName, int flags)
    {
    ...
    struct KeypointIdxCompare
    {
        ...
        explicit KeypointIdxCompare(std::vector<KeyPoint>* _keypoints) : keypoints(_keypoints) {}

        bool operator ()(size_t i1, size_t i2) const
        {
            KeyPoint kp1 = (*keypoints)[i1];
            KeyPoint kp2 = (*keypoints)[i2];
    ...
    void sortKeyPoints(std::vector<KeyPoint>& keypoints, InputOutputArray _descriptors)
    {
        ...
        if (_descriptors.needed())
        {
            ...
            new_descriptors cvSetMat(descriptors.size(), descriptors CC_MAT_TYPE());
        }
