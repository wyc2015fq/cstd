...
CC_ENUM(ThreshType, THRESH_BINARY, THRESH_BINARY_INV, THRESH_TRUNC, THRESH_TOZERO, THRESH_TOZERO_INV)

typedef std::tr1::tuple<CvSize, MatType, ThreshType> Size_MatType_ThreshType_t;
...
PERF_TEST_P(Size_MatType_ThreshType, threshold,
            testing::Combine(
                ...
                testing::Values(CC_8UC1, CC_16SC1, CC_32FC1, CC_64FC1),
                ThreshType::all()
                )
            )
{
...
typedef perf::TestBaseWithParam<CvSize> Size_Only;
...
CC_ENUM(AdaptThreshType, THRESH_BINARY, THRESH_BINARY_INV)
CC_ENUM(AdaptThreshMethod, ADAPTIVE_THRESH_MEAN_C, ADAPTIVE_THRESH_GAUSSIAN_C)

typedef std::tr1::tuple<CvSize, AdaptThreshType, AdaptThreshMethod, int> Size_AdaptThreshType_AdaptThreshMethod_BlockSize_t;
