                             ...
                             float *velocityY, int velStep)
{
    ...
    II = (icvDerProduct *) cAlloc(BufferSize * sizeof(icvDerProduct));
    WII = (icvDerProduct *) cAlloc(BufferSize * sizeof(icvDerProduct));
...
//F*/
CC_IMPL void
cvCalcOpticalFlowLK(const void* srcarrA, const void* srcarrB, CSize winSize,
                     void* velarrx, void* velarry)
{
    CC_FUNCNAME("cvCalcOpticalFlowLK");
    ...
    IPPI_CALL(icvCalcOpticalFlowLK_8u32fR((uchar*)srcA->tt.data, (uchar*)srcB->tt.data,
