...
class CC_EXPORTS CvMAT : public CvMat
{
protected:
...
public:
    ...
    /* creation */
    explicit CvMAT(int rows, int cols, int type, void* data, int step = CC_AUTOSTEP);
    explicit CvMAT(int rows, int type, void* data, int step = CC_AUTOSTEP);
    ...
    double norm(int norm_type = CC_L2) const;
    double norm(CvMat& mat, int norm_type = CC_L2) const;
    CvScalar sum() const;
...
/* const_A(i,j) */
struct  CC_EXPORTS _CvMATConstElem_
{
...
struct  CC_EXPORTS _CvMATElemCn_
{
...
/* A(i,j) */
struct  CC_EXPORTS _CvMATElem_ : public _CvMATConstElem_
{
...
struct  CC_EXPORTS _CvMAT_BASE_OP_
{
    _CvMAT_BASE_OP_() {};
...
/* (A^t)*alpha */
struct  CC_EXPORTS _CvMAT_T_ : public _CvMAT_BASE_OP_
{
    explicit _CvMAT_T_(const CvMAT* a);
    explicit _CvMAT_T_(const CvMAT* a, double alpha);
    
    double det() const;
    double norm(int normType = CC_L2) const;
...
/* inv(A) */
struct  CC_EXPORTS _CvMAT_INV_ : public _CvMAT_BASE_OP_
{
...
/* (A^ta)*(B^tb)*alpha */
struct  CC_EXPORTS _CvMAT_MUL_ : public _CvMAT_BASE_OP_
{
...
struct  CC_EXPORTS _CvMAT_MUL_ADD_ : public _CvMAT_BASE_OP_
{
...
/* A + B*beta */
struct  CC_EXPORTS _CvMAT_ADD_ : public _CvMAT_BASE_OP_
{
...
struct  CC_EXPORTS _CvMAT_ADD_EX_ : public _CvMAT_BASE_OP_
{
...
/* A*alpha */
struct  CC_EXPORTS _CvMAT_SCALE_ : public _CvMAT_BASE_OP_
{
...
/* A*alpha + beta */
struct  CC_EXPORTS _CvMAT_SCALE_SHIFT_ : public _CvMAT_BASE_OP_
{
...
/* (A & B), (A | B) or (A ^ B) */
struct  CC_EXPORTS _CvMAT_LOGIC_ : public _CvMAT_BASE_OP_
{
...
struct  CC_EXPORTS _CvMAT_UN_LOGIC_ : public _CvMAT_BASE_OP_
{
...
/* ~A */
struct  CC_EXPORTS _CvMAT_NOT_ : public _CvMAT_BASE_OP_
{
...
struct  CC_EXPORTS _CvMAT_CVT_ : public _CvMAT_BASE_OP_
{
...
/* conversion of data type */
struct  CC_EXPORTS _CvMAT_COPY_
{
...
struct  CC_EXPORTS _CvMAT_DOT_OP_ : public _CvMAT_BASE_OP_
{
...
/* A.inv()*B or A.pinv()*B */
struct  CC_EXPORTS _CvMAT_SOLVE_ : public _CvMAT_BASE_OP_
{
...
/* A <=> B */
struct  CC_EXPORTS _CvMAT_CMP_ : public _CvMAT_BASE_OP_
{
...
inline _CvMATElemCn_::_CvMATElemCn_(uchar* p, int t, int coi) :
    ptr(p), type(CC_MAT_TYPE(t))
{
    if(coi)
    {
        assert((unsigned)coi < (unsigned)CC_MAT_CN(t));
        ptr += coi * CC_ELEM_SIZE(type);
    }
}
...
{
    if(type == elem.type)
        memcpy(ptr, elem.ptr, CC_ELEM_SIZE(type));
    else
    {
        assert(CC_MAT_CN(elem.type) == 1);
...
inline _CvMATElem_& _CvMATElem_::operator = (const _CvMATConstElem_& elem)
{
    ...
    {
        assert(CC_MAT_CN(type ^ elem.type) == 0);
...
{
    int step = cols*CC_ELEM_SIZE(type), total_size = step*rows;
    this->rows = rows;
    this->cols = cols;
    this->step = rows == 1 ? 0 : step;
    this->tid = CC_MAT_MAGIC_VAL | (type & CC_MAT_TYPE_MASK) | CC_MAT_CONT_FLAG;
    refcount = (int*)cvAlloc((size_t)total_size + 8);
    tt.data = (uchar*)(((size_t)(refcount + 1) + 7) & -8);
    *refcount = 1;
}
...
{   return _CvMATElem_(CC_MAT_ELEM_PTR(*this, row, 0), type);   }


inline _CvMATConstElem_ CvMAT::operator ()(int row) const
{   return _CvMATConstElem_(CC_MAT_ELEM_PTR(*this, row, 0), type); }


inline _CvMATElem_ CvMAT::operator ()(int row, int col)
{   return _CvMATElem_(CC_MAT_ELEM_PTR(*this, row, col), type); }


inline _CvMATConstElem_ CvMAT::operator ()(int row, int col) const
{   return _CvMATConstElem_(CC_MAT_ELEM_PTR(*this, row, col), type); }


inline _CvMATElemCn_ CvMAT::operator()(int row, int col, int coi)
{   return _CvMATElemCn_(CC_MAT_ELEM_PTR(*this, row, col), type, coi);  }


inline _CvMATElemCn_ CvMAT::operator()(CvPoint pt, int coi)
{   return _CvMATElemCn_(CC_MAT_ELEM_PTR(*this, pt.y, pt.x), type, coi);  }


inline double CvMAT::operator()(int row, int col, int coi) const
{   return get(CC_MAT_ELEM_PTR(*this, row, col), type, coi);    }


inline _CvMATElem_ CvMAT::operator ()(CvPoint pt)
{   return _CvMATElem_(CC_MAT_ELEM_PTR(*this, pt.y, pt.x), type); }


inline _CvMATConstElem_ CvMAT::operator ()(CvPoint pt) const
{   return _CvMATConstElem_(CC_MAT_ELEM_PTR(*this, pt.y, pt.x), type); }


inline double CvMAT::operator()(CvPoint pt, int coi) const
{   return get(CC_MAT_ELEM_PTR(*this, pt.y, pt.x), type, coi);    }


inline void* CvMAT::ptr(int row)
{   return CC_MAT_ELEM_PTR(*this, row, 0);    }


inline const void* CvMAT::ptr(int row) const
{   return (const void*)CC_MAT_ELEM_PTR(*this, row, 0);   }


inline void* CvMAT::ptr(int row, int col)
{   return CC_MAT_ELEM_PTR(*this, row, col);  }


inline const void* CvMAT::ptr(int row, int col) const
{   return (const void*)CC_MAT_ELEM_PTR(*this, row, col); }


inline void* CvMAT::ptr(CvPoint pt)
{   return CC_MAT_ELEM_PTR(*this, pt.y, pt.x);    }


inline const void* CvMAT::ptr(CvPoint pt) const
{   return (const void*)CC_MAT_ELEM_PTR(*this, pt.y, pt.x); }
...
{   return _CvMAT_CMP_(&a, &b, CC_CMP_GT); }

inline _CvMAT_CMP_ operator >= (const CvMAT& a, const CvMAT& b)
{   return _CvMAT_CMP_(&a, &b, CC_CMP_GE); }

inline _CvMAT_CMP_ operator < (const CvMAT& a, const CvMAT& b)
{   return _CvMAT_CMP_(&a, &b, CC_CMP_LT); }

inline _CvMAT_CMP_ operator <= (const CvMAT& a, const CvMAT& b)
{   return _CvMAT_CMP_(&a, &b, CC_CMP_LE); }

inline _CvMAT_CMP_ operator == (const CvMAT& a, const CvMAT& b)
{   return _CvMAT_CMP_(&a, &b, CC_CMP_EQ); }

inline _CvMAT_CMP_ operator != (const CvMAT& a, const CvMAT& b)
{   return _CvMAT_CMP_(&a, &b, CC_CMP_NE); }


inline _CvMAT_CMP_ operator > (const CvMAT& a, double alpha)
{   return _CvMAT_CMP_(&a, alpha, CC_CMP_GT); }

inline _CvMAT_CMP_ operator > (double alpha, const CvMAT& a)
{   return _CvMAT_CMP_(&a, alpha, CC_CMP_LT); }

inline _CvMAT_CMP_ operator >= (const CvMAT& a, double alpha)
{   return _CvMAT_CMP_(&a, alpha, CC_CMP_GE); }

inline _CvMAT_CMP_ operator >= (double alpha, const CvMAT& a)
{   return _CvMAT_CMP_(&a, alpha, CC_CMP_LE); }
...
inline _CvMAT_CMP_ operator == (const CvMAT& a, double alpha)
{   return _CvMAT_CMP_(&a, alpha, CC_CMP_EQ); }

inline _CvMAT_CMP_ operator == (double alpha, const CvMAT& a)
{   return _CvMAT_CMP_(&a, alpha, CC_CMP_EQ); }

inline _CvMAT_CMP_ operator != (const CvMAT& a, double alpha)
{   return _CvMAT_CMP_(&a, alpha, CC_CMP_NE); }
