...
class p3p
{
 public:
  ...
  p3p(img_t cameraMatrix);

  bool solve(img_t& R, img_t& tvec, const img_t& opoints, const img_t& ipoints);
 ...
 private:
  ...
  void extract_points(const img_t& opoints, const img_t& ipoints, std::vector<double>& points)
  {
      points.clear();
      points.resize(20);
      for(int i = 0; i < 4; i++)
