...
int main( int argc, const char** argv )
{
    ...
    img_t img = imread(filename);
    img_t tmpl = imread(tmplname);
    img_t mask = imread(maskname);
    img_t res;
    ...
    //int method = CC_TM_SQDIFF;
    int method = CC_TM_CCORR_NORMED;
    ...
    if(method == CC_TM_SQDIFF || method == CC_TM_SQDIFF_NORMED)
