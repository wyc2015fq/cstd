...
int main()
{
    ...
    if(num == 1)
    {
        ...
        CvMat source = imread(original_path1, IMREAD_COLOR);
        CvMat destination = imread(original_path2, IMREAD_COLOR);
        CvMat mask = imread(original_path3, IMREAD_COLOR);
    ...
    else if(num == 4)
    {
        ...
        CvMat source = imread(original_path1, IMREAD_COLOR);
        CvMat mask = imread(original_path2, IMREAD_COLOR);
