...
CvMat img0, img1, img2, res, res1, final, final1, blend;
...
void source(int event, int x, int y, int, void*)
{
    ...
    if (event == EVENT_RBUTTONUP)
    {
        ...
        final = CvMat::zeros(img0.size(),CC_8UC3);
        res1 = CvMat::zeros(img0.size(),CC_8UC1);
...
void destination(int event, int x, int y, int, void*)
{
    ...
    if (event == EVENT_RBUTTONUP)
    {
        ...
        final1 = CvMat::zeros(img2.size(),CC_8UC3);
        res = CvMat::zeros(img2.size(),CC_8UC1);
