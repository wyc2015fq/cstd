...
int main(void)
{
    CvMat img1 = imread("../data/graf1.png", IMREAD_GRAYSCALE);
    CvMat img2 = imread("../data/graf3.png", IMREAD_GRAYSCALE);
    ...
    Ptr<ORB> orb_detector = ORB::create(10000);
    ...
    for (unsigned i = 0; i < matched1.size(); i++) {
        CvMat col = CvMat::ones(3, 1, CC_64F);
