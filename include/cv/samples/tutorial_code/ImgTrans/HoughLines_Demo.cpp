...
CvMat src, edges;
CvMat src_gray;
CvMat standard_hough, probabilistic_hough;
...
void Standard_Hough( int, void* )
{
  ...
  HoughLines( edges, s_lines, 1, CC_PI/180, min_threshold + s_trackbar, 0, 0 );
...
void Probabilistic_Hough( int, void* )
{
  ...
  HoughLinesP( edges, p_lines, 1, CC_PI/180, min_threshold + p_trackbar, 30, 10 );
