...
public:
  ...
  std::vector<CPoint2f> get_points2d() const { return list_points2d_; }
  std::vector<CPoint3f> get_points3d() const { return list_points3d_; }
  ...
  void registerPoint(const CPoint2f &point2d, const CPoint3f &point3d);
  void reset();
...
std::vector<CPoint2f> list_points2d_;
/** The list of 3D points to register the model */
std::vector<CPoint3f> list_points3d_;
};
