...
{
    CommandLineParser parser(argc, argv, "{help h||}{@image|../data/fruits.jpg|}");
    if (parser.has("help"))
    {
        help();
        return 0;
    ...
    img = img0.clone();
    inpaintMask = img_t::zeros(img.size(), CC_8U);
