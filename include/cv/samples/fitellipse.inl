...
void processImage(int /*h*/, void*)
{
    ...
    img_t bimage = image >= sliderPos;

    findContours(bimage, contours, CC_RETR_LIST, CC_CHAIN_APPROX_NONE);

    img_t cimage = img_t::zeros(bimage.size(), CC_8UC3);
    ...
    for(size_t i = 0; i < contours.size(); i++)
    {
        ...
        img_t pointsf;
        img_t(contours[i]).convertTo(pointsf, CC_32F);
