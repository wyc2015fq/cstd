...
const int kMinColumnWidth1 = 200;
...
const double kAlignedFraction1 = 0.03125;
...
bool TabFind::TestBoxForTabs(BLOBNBOX* bbox, int min_gutter_width,
  ...
  int alignment_tolerance = static_cast<int>(resolution_ * kAlignedFraction1);
