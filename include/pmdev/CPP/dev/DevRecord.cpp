...
DevRecord::DevRecord(const char* cszIP, NCMD* pCMD, BOOL bServer, void* pvClientData)
{
  ProcessNCMD(cszIP, pCMD, bServer, pvClientData);
}

DevRecord::DevRecord(const char* cszIP, const DEV_DL_RECORD_RANGE& cRange, int nFlag, int nSeq, char* pbBuf, unsigned int& nLen)
{
  assert(pbBuf);
  NCMD* pCMD     = (NCMD*)pbBuf;
  pCMD->m_MCmd   = CMD_M_VERIFY;
...
void DevRecord::ProcessNCMD(const char* cszIP, NCMD* pCMD, BOOL bServer, void* pvClientData)
{
  assert(pCMD);
  DEV_RECORD Tmp;
  ...
  OnDevCmd(cszIP, NULL, DEV_RECORD_OPER, DEV_OPER_DOWNLOAD, &Tmp, pCMD->m_Param1, GET_ERR(pCMD->m_CFlag), pvClientData);
}

DevAlarm::DevAlarm(const char* cszIP, NCMD* pCMD, BOOL bServer, void* pvClientData)
{
  ProcessNCMD(cszIP, pCMD, bServer, pvClientData);
}

DevAlarm::DevAlarm(const char* cszIP, const DEV_DL_RECORD_RANGE& cRange, int nFlag, int nSeq, char* pbBuf, unsigned int& nLen)
{
  assert(pbBuf);
  NCMD* pCMD     = (NCMD*)pbBuf;
  pCMD->m_MCmd   = CMD_M_ALARM;
  pCMD->m_SCmd   = CMD_S_GET;
  pCMD->m_Param1 = nSeq;
  pCMD->m_Param2 = DotIpToLong(cszIP);
  pCMD->m_CFlag  = 0;
...
void DevAlarm::ProcessNCMD(const char* cszIP, NCMD* pCMD, BOOL bServer, void* pvClientData)
{
  assert(pCMD);
  DEV_RECORD Tmp ;
  ...
  OnDevCmd(cszIP, NULL, DEV_ALARM_OPER, DEV_OPER_DOWNLOAD, &Tmp, pCMD->m_Param1, GET_ERR(pCMD->m_CFlag), pvClientData);
}

DevRecordEx::DevRecordEx(const char* cszIP, NCMD* pCMD, BOOL bServer, void* pvClientData)
{
  ProcessNCMD(cszIP, pCMD, bServer, pvClientData);
}

DevRecordEx::DevRecordEx(const char* cszIP, const DEV_DL_RECORD_RANGE& cRange, int nSeq, char* pbBuf, unsigned int& nLen)
{
  assert(pbBuf);
  NCMD* pCMD     = (NCMD*)pbBuf;
  pCMD->m_MCmd   = CMD_M_RECORD_EX;
  pCMD->m_SCmd   = CMD_S_GET;
  pCMD->m_Param1 = nSeq;
  pCMD->m_Param2 = DotIpToLong(cszIP);
  pCMD->m_CFlag  = F_DL_PIC;
...
void DevRecordEx::ProcessNCMD(const char* cszIP, NCMD* pCMD, BOOL bServer, void* pvClientData)
{
  assert(pCMD);
  ...
  if (SUC_EXECUT == GET_ERR(pCMD->m_CFlag)) {
    ...
    case CMD_M_ALARM: {
      ...
      OnDevCmd(cszIP, NULL, DEV_RECORD_EX_OPER, DEV_OPER_DOWNLOAD, &records, pCMD->m_Param1, GET_ERR(pCMD->m_CFlag), pvClientData);
    }
    break;
    ...
    case CMD_M_OPTLOG: {
      ...
      OnDevCmd(cszIP, NULL, DEV_LOG_EX_OPER, DEV_OPER_DOWNLOAD, &records, pCMD->m_Param1, GET_ERR(pCMD->m_CFlag), pvClientData);
    }
    break;
    ...
    case CMD_M_CIMAGE: {
      ...
      OnDevCmd(cszIP, NULL, DEV_CIMAGE_EX_OPER, DEV_OPER_DOWNLOAD, &records, pCMD->m_Param1, GET_ERR(pCMD->m_CFlag), pvClientData);
    }
    break;
    ...
    case CMD_M_VERIFY:
    case CMD_M_ALARM:
      OnDevCmd(cszIP, NULL, DEV_RECORD_EX_OPER, DEV_OPER_DOWNLOAD, NULL, pCMD->m_Param1, GET_ERR(pCMD->m_CFlag), pvClientData);
      break;

    case CMD_M_OPTLOG:
      OnDevCmd(cszIP, NULL, DEV_LOG_EX_OPER, DEV_OPER_DOWNLOAD, NULL, pCMD->m_Param1, GET_ERR(pCMD->m_CFlag), pvClientData);
      break;

    case CMD_M_CIMAGE:
      OnDevCmd(cszIP, NULL, DEV_CIMAGE_EX_OPER, DEV_OPER_DOWNLOAD, NULL, pCMD->m_Param1, GET_ERR(pCMD->m_CFlag), pvClientData);
      break;
