 ...
 */
/* Functions for input */
static int ReadNativeData(FieldSpec* field, stream_t* file);
static int NativeRead(void* data, int type, long length, stream_t* file);
static int ReadNativeArray(Array* array, stream_t* file);
static FieldSpec* ReadNativeFieldSpec(stream_t* file);
static int ReadNativeString(char** string, stream_t* file);
/* Functions for output */
static int WriteNativeData(FieldSpec* field, stream_t* file);
static int NativeWrite(void* data, int type, long length, stream_t* file);
static int WriteNativeArray(Array* array, stream_t* file);
static int WriteNativeFieldSpec(FieldSpec* field, stream_t* file);
static int WriteNativeString(char* string, stream_t* file);
/*
 ...
 */
static FieldSpec*
ReadNativeFieldSpec(stream_t* file)
{
 ...
 */
static int
ReadNativeString(char** string, stream_t* file)
{
  long length;
  char* str;
