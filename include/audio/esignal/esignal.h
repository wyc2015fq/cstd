...
#define ASCII   4
  ...
  int     ReadPreamble(char** version, char** arch, long* pre_size,
      long* hdr_size, long* rec_size, stream_t* file);
  int     ReadFieldList(FieldList* list, int arch, stream_t* file);
  ...
  int     ReadNativeFieldList(FieldList* list, stream_t* file);
  int     WriteNativeFieldList(FieldList list, stream_t* file);
  long      NativeRecordSize(FieldList list);
  int     ReadNativeRecord(FieldSpec** fields, stream_t* file);
  int     WriteNativeRecord(FieldSpec** fields, stream_t* file);
  ...
  int     ReadEdrFieldList(FieldList* list, stream_t* file, int longlong);
  int     WriteEdrFieldList(FieldList list, stream_t* file, int longlong);
  ...
  int     ReadAsciiFieldList(FieldList* list, stream_t* file);
  int     WriteAsciiFieldList(FieldList list,
      stream_t* file, Annot* annotate);
  int     ReadAsciiRecord(FieldSpec** fields, stream_t* file);
