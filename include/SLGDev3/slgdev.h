...
#define ARMED_ENABLE_AWAYS          0x00400000 //触发报警时，报警持续 //Trigger alarm, alarm lasting
#define OPENSSL_ENABLE              0x00800000 //ssl加密//ssl encryption
#define WAKE_INPUT_ENABLED          0x20000000 //开启仅辅助输入能激活验证//Activate verification only by auxiliary input
...
// #define DEV_TYPE_FACE1 0x0 //Facial Terminal 1
// #define DEV_TYPE_FACE2 0x1 //Facial Terminal 2
// #define DEV_TYPE_CARD1 0x2 //Card Scanner 1
// #define DEV_TYPE_CARD2 0x3 //Card Scanner 2
// #define DEV_TYPE_IN 0x4 //Auxiliary Input
// #define DEV_TYPE_OUT 0x5 //Auxiliary Output
// #define DEV_TYPE_INWL 0x6 //Wireless Input
// #define DEV_TYPE_DOOR 0xF //Door
...
#define DEV_WEB_LOADUSER  0x0001 //加载用户//Loading users
#define DEV_WEB_WRITEUSER 0x0002 //写用户//write user
#define DEV_WEB_WRITEREC  0x0004 //写记录//write record
#define DEV_WEB_SYNCTIME  0x0008 //同步时间//synchronization time
...
//Comment:
////////////////////////////////////////////////////////////////////////////////////////
BOOL SLGDEV_CALL SLG_ULUpdate(const char* cszDevAddr, const DEV_APPUPDATE& cAppData, int nSeq = -1);
////////////////////////////////////////////////////////////////////////////////////////
//功能: 启动视频
//参数: cszDevAddr 设备地址
//hwnd 视频显示窗口句柄
...
//令为S_GET和S_SET。设置成功时返回SUC_EXECUT.
