...
namespace nana
{
	...
	public:
		...
		virtual size tooltip_size() const = 0;
		virtual void tooltip_text(const char*)	= 0;
		virtual void tooltip_move(const point& screen_pos, bool ignore_pos)	= 0;
		virtual void duration(size_t) = 0;
	};
	...
	public:
		...
		tooltip() = default;
		tooltip(window w, const ::string &tip){set(w,tip);}


		static void set(window, const char*);
		static void show(window, point pos, const char*, size_t duration);
		static void close();
	private:
