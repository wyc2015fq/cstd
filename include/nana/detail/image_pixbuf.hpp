...
namespace nana
{
	namespace paint{	namespace detail{
		...
		public:
			...
			void paste(const rectangle& src_r, graph_reference graph, const point& p_dst) const
			{
				pixbuf_.paste(src_r, graph.handle(), p_dst);
			}

			void stretch(const rectangle& src_r, graph_reference dst, const rectangle& r) const
			{
