...
namespace nana
{
	//class color_proxy
		...
		color_proxy& color_proxy::operator=(const color& clr)
		{
			color_ = make_shared<color>(clr);
			return *this;
		}
	...
	namespace detail
	{
		//class color_schemes
			...
			{
				map<scheme_factory_interface::factory_identifier*, unique_ptr<scheme>> scheme_template;
			};
			...
			{
				return factory.create(scheme_template(move(factory)));
			}
