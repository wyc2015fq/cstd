...
namespace nana
{
	...
	private:
		static void _m_check_restrict_area(point & pos, const size & size, const rectangle& restr_area)
		{
	...
	private:
		...
		point origin_;
		vector<drag_target_t> targets_;
		vector<trigger_t> triggers_;
	};
	...
	//class dragger
		...
		{
			impl_->drag_target(wd, rectangle(), arrange::horizontal_vertical);
		}

		void dragger::target(window wd, const rectangle& restrict_area, arrange arg)
		{
