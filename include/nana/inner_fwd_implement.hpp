...
namespace nana{
	namespace detail
	{
		class shortkey_container
		{
			...
			//Noncopyable
			shortkey_container(const shortkey_container&) {}
			shortkey_container& operator=(const shortkey_container&) {}

			shortkey_container& operator=(shortkey_container&) {}
		public:
			shortkey_container();
			...
			vector<unsigned long> keys(window wd) const;
		...
		{
			//Noncopyable
			root_register(const root_register&) {}
			root_register& operator=(const root_register&) {}

			//Nonmovable
			root_register(root_register&) {}
			root_register& operator=(root_register&) {}
		public:
			root_register();
			~root_register();
