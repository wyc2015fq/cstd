...
namespace nana
{
	namespace paint
	{
		...
		public:
			...
			size extent_size(int x, int y, const wchar_t*, size_t len, unsigned restricted_pixels) const;

			void render(const point&, const wchar_t*, size_t len);
			void render(const point&, const wchar_t*, size_t len, unsigned restricted_pixels, bool omitted);
			void render(const point&, const wchar_t*, size_t len, unsigned restricted_pixels);
		private:
		...
		public:
			 ...
			 */
			void draw(const char* text, point pos, unsigned width);
			void draw(const wchar* text, point pos, unsigned width);
		private:
			graph_reference graph_;
			align text_align_;
