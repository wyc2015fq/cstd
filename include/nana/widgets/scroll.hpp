	...
	namespace drawerbase
	{
		namespace scroll
		{
			...
			private:
				...
				void _m_button_frame(graph_reference, rectangle, int state);
				void _m_draw_scroll(graph_reference, int state);
				void _m_draw_button(graph_reference, rectangle, buttons what, int state);
			private:
			...
			private:
				...
				{
					graph_ = &graph;
					widget_ = static_cast< scroll<Vertical>*>(&widget);
					widget.caption("nana scroll");

					timer_.stop();
					timer_.elapse(bind(&trigger::_m_tick, this));
				}
				...
				void resized(graph_reference graph, const arg_resized&)
				{
					drawer_.draw(graph, metrics_.what);
					API::dev::lazy_refresh();
				}

				void mouse_enter(graph_reference graph, const arg_mouse& arg)
				{
				...
				void dbl_click(graph_reference graph, const arg_mouse& arg)
				{
