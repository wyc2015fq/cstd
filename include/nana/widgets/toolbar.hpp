...
namespace nana
{
	...
	{
	public:
		using size_type = size_t;      ///< A type to count the number of elements.
		...
		void append(const char* text, const image& img);   ///< Adds a control button.
		void append(const char* text);   ///< Adds a control button.
