...
namespace skeletons
{
	class content_view
	{
		...
		content_view(const content_view&) {}
		content_view& operator=(const content_view&) {}

		content_view(content_view&) {}
		content_view& operator=(content_view&) {}
	public:
		...
		struct events_type
		{
			::function<void(const point&)> hover_outside;
			::function<void()> scrolled;
		};
		...
		void set_wheel_speed(function<unsigned()> fn);
