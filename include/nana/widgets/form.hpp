...
namespace nana
{
	...
	namespace drawerbase
	{
		namespace form
		{
			...
			class form_base
				: public widget_object<category::root_tag, drawerbase::form::trigger, events_root_extension>
			{
			public:
	...
	public:
		...
		form(const form&, const size& = { 300, 200 }, const appearance& = {});	//Copy constructor
		form(window, const size& = { 300, 200 }, const appearance& = {});
