...
namespace nana
{
	namespace drawerbase{
		namespace float_listbox
		{
			...
			struct module_def
			{
				vector<shared_ptr<item_interface>> items;

				size_t max_items{ 10 };				// the number of items display.
				mutable size_t index{ npos };	// the result of the selection.
			...
			public:
				...
				virtual void render(widget_reference, graph_reference, const rectangle&, const item_interface*, state_t) = 0;
