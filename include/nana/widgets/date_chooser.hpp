...
namespace nana
{
	...
	public:
		...
		date_chooser(window, const rectangle& r = rectangle(), bool visible = true);

		bool chose() const;
		date read() const;
		void weekstr(unsigned index, ::string);///<Set the week strings which will be displayed for day, index is in range of [0, 6]
	};
}//end namespace nana
