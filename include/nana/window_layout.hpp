...
namespace detail
{
	...
	public:
		...
		static void paste_children_to_graphics(core_window_t*, graphics& graph);
		...
		static bool read_overlaps(core_window_t*, const rectangle& vis_rect, vector<wd_rectangle>& blocks);
	...
	private:
		 ...
		 */
		static void _m_paste_children(core_window_t* window, bool has_refreshed, bool request_refresh_children, const rectangle& parent_rect, graphics& graph, const point& graph_rpos);
	...
	private:
		struct data_section
		{
			vector<core_window_t*> 	effects_bground_windows;
		};
