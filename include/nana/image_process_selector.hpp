	...
	namespace paint
	{
		...
		{           /// Configure the image processing algorithms.
			...
			public:
				...
				void add_stretch(const char* name)
				{
				...
				void alpha_blend(const char* name);
				            /// Inserts a new user defined image process for alpha blend.
                template<typename ImageProcessor>
				void add_alpha_blend(const char* name)
				{
					image_process_provider& p = image_process_provider::instance();
				...
				template<typename ImageProcessor>
				void add_blend(const char* name)
				{
					image_process_provider& p = image_process_provider::instance();
