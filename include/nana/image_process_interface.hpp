	...
	{                       /// Image Processing Algorithm Interfaces
		...
		{           /// The interface of stretch algorithm.
			...
			public:
				...
				virtual void process(const pixel_buffer & s_pixbuf, 
			...
			public:
				...
				virtual void process(const pixel_buffer& s_pixbuf, const rectangle& s_r, pixel_buffer& d_pixbuf, const point& d_pos) const = 0;
			};
			...
			public:
				...
				virtual void process( const pixel_buffer& src_pixbuf, 
                                      const rectangle& src_area, 
                                      pixel_buffer& dest_pixbuf, 
			...
			public:
				...
				virtual void process(pixel_buffer & pixbuf, 
			...
			public:
				...
				virtual void process(pixel_buffer&, const rectangle& r, size_t radius) const = 0;
			};
		}
	}//end namespace paint
}//end namespace nana
