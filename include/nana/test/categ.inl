	...
	#include <nana/gui/widgets/categorize.hpp>
		...
		class renderer
		{
		 public:
			...
			virtual ~renderer() = 0;
			virtual void background(graph_reference, window, const rectangle&, 
									const   ui_element&)     = 0;
			virtual void root_arrow(graph_reference, const rectangle&, state_t) = 0;
			virtual void item(graph_reference, const rectangle&, size_t index,
			const char* name, unsigned text_height,
	...
	void selected(arg_categorize<int>  categ)
	{
		msgbox mb(categ.widget, "categorize");
	...
	int main()
	{
		...
		form fm;
		categorize<int> categ(fm, rectangle(10, 10, 200, 24));
