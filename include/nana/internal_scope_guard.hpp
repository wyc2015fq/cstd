...
namespace nana
{
	...
	{
		internal_scope_guard(const internal_scope_guard&) {}
		internal_scope_guard(internal_scope_guard&) {}

		internal_scope_guard& operator=(const internal_scope_guard&) {}
		internal_scope_guard& operator=(internal_scope_guard&) {}
	public:
	...
	{
		internal_revert_guard(const internal_revert_guard&) {}
		internal_revert_guard(internal_revert_guard&) {}

		internal_revert_guard& operator=(const internal_revert_guard&) {}
		internal_revert_guard& operator=(internal_revert_guard&) {}
	public:
