...
/*!
*/
void CTRGTextureLightMap2_M4_scanline_bilinear(IBurningShader* s)
{
  ...
  for (i = 0; i <= dx; i++) {
    ...
    if (line->z[0] < z[i])
...
#endif
      {
        ...
        g3 = tofix(line->c[0][0][2], inversew);
        b3 = tofix(line->c[0][0][3], inversew);
#endif
#else
...
#ifdef IPOL_C0
        r3 = tofix(line->c[0][0][1], FIX_POINT_F32_MUL);
        g3 = tofix(line->c[0][0][2], FIX_POINT_F32_MUL);
        b3 = tofix(line->c[0][0][3], FIX_POINT_F32_MUL);
#endif
#endif
...
void CTRGTextureLightMap2_M4_drawTriangle(IBurningShader* s, const s4DVertex* a, const s4DVertex* b, const s4DVertex* c)
{
  sScanLineData* line = s->line;
  sScanConvertData* scan = s->scan;
  f32 ca, ba, cb;
...
#endif
      // render a scanline
      CTRGTextureLightMap2_M4_scanline_bilinear(s);
