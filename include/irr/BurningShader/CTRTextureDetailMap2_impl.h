...
/*!
*/
void CTRTextureDetailMap2_scanline_bilinear(IBurningShader* s)
{
...
void CTRTextureDetailMap2_drawTriangle(IBurningShader* s, const s4DVertex* a, const s4DVertex* b, const s4DVertex* c)
{
  sScanLineData* line = s->line;
  sScanConvertData* scan = s->scan;
  f32 ca, ba, cb;
...
#endif
      // render a scanline
      CTRTextureDetailMap2_scanline_bilinear(s);
