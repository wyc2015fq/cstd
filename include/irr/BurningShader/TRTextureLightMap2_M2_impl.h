...
/*!
*/
REALINLINE void CTRTextureLightMap2_M2_scanline_bilinear2(IBurningShader* s)
{
...
#endif
      dst[i] = fix_to_color_rgb(clampfix_maxcolor(imulFix_tex2(r0, r1)), clampfix_maxcolor(imulFix_tex2(g0, g1)), clampfix_maxcolor(imulFix_tex2(b0, b1)));
    }
#ifdef IPOL_W
    line->w[0] += line->w[1];
#else
...
void CTRTextureLightMap2_M2_drawTriangle(IBurningShader* s, const s4DVertex* a, const s4DVertex* b, const s4DVertex* c)
{
  sScanLineData* line = s->line;
  f32 ca, ba, cb;
  f32 temp[4];
...
#endif
      // render a scanline
      CTRTextureLightMap2_M2_scanline_bilinear2(s);
