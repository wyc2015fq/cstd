...
void convert16bitToA8R8G8B8andResize(const s16* in, s32* out, s32 newWidth, s32 newHeight, s32 currentWidth, s32 currentHeight)
{
  ...
  sourceXStep = (f32)currentWidth / (f32)newWidth;
  sourceYStep = (f32)currentHeight / (f32)newHeight;
...
void convert_viaFormat(const void* sP, ECOLOR_FORMAT sF, s32 sN, void* dP, ECOLOR_FORMAT dF)
{
  switch (sF) {
  case ECF_A1R5G5B5:
    switch (dF) {
