...
const char* colladaSectionName =   "COLLADA";
const char* librarySectionName =   "library";
const char* libraryNodesSectionName = "library_nodes";
const char* libraryGeometriesSectionName = "library_geometries";
const char* libraryMaterialsSectionName = "library_materials";
const char* libraryImagesSectionName = "library_images";
const char* libraryVisualScenesSectionName = "library_visual_scenes";
const char* libraryCamerasSectionName = "library_cameras";
const char* libraryLightsSectionName = "library_lights";
const char* libraryEffectsSectionName = "library_effects";
const char* assetSectionName =     "asset";
const char* sceneSectionName =     "scene";
const char* visualSceneSectionName = "visual_scene";
const char* lightPrefabName =      "light";
const char* cameraPrefabName =     "camera";
const char* materialSectionName =  "material";
const char* geometrySectionName =  "geometry";
const char* imageSectionName =     "image";
const char* textureSectionName =   "texture";
const char* effectSectionName =    "effect";
const char* pointSectionName =     "point";
const char* directionalSectionName = "directional";
const char* spotSectionName =      "spot";
const char* ambientSectionName =   "ambient";
const char* meshSectionName =      "mesh";
const char* sourceSectionName =    "source";
const char* arraySectionName =     "array";
const char* floatArraySectionName = "float_array";
const char* intArraySectionName =  "int_array";
const char* techniqueCommonSectionName = "technique_common";
const char* accessorSectionName =  "accessor";
const char* verticesSectionName =  "vertices";
const char* inputTagName =         "input";
const char* polylistSectionName =  "polylist";
const char* trianglesSectionName = "triangles";
const char* polygonsSectionName =  "polygons";
const char* primitivesName =       "p";
const char* vcountName =           "vcount";
const char* upAxisNodeName =       "up_axis";
const char* nodeSectionName =      "node";
const char* lookatNodeName =       "lookat";
const char* matrixNodeName =       "matrix";
const char* perspectiveNodeName =  "perspective";
const char* rotateNodeName =       "rotate";
const char* scaleNodeName =        "scale";
const char* translateNodeName =    "translate";
const char* skewNodeName =         "skew";
const char* bboxNodeName =         "boundingbox";
const char* minNodeName =          "min";
const char* maxNodeName =          "max";
const char* instanceName =         "instance";
const char* instanceGeometryName = "instance_geometry";
const char* instanceSceneName =    "instance_visual_scene";
const char* instanceEffectName =   "instance_effect";
const char* instanceMaterialName = "instance_material";
const char* instanceLightName =    "instance_light";
const char* instanceNodeName =     "instance_node";
const char* bindMaterialName =     "bind_material";
const char* extraNodeName =        "extra";
const char* techniqueNodeName =    "technique";
const char* colorNodeName =        "color";
const char* floatNodeName =        "float";
const char* float2NodeName =       "float2";
const char* float3NodeName =       "float3";
const char* newParamName =         "newparam";
const char* paramTagName =         "param";
const char* initFromName =         "init_from";
const char* dataName =             "data";
const char* wrapsName =            "wrap_s";
const char* wraptName =            "wrap_t";
const char* minfilterName =        "minfilter";
const char* magfilterName =        "magfilter";
const char* mipfilterName =        "mipfilter";
const char* textureNodeName =      "texture";
const char* doubleSidedNodeName =  "double_sided";
const char* constantAttenuationNodeName = "constant_attenuation";
const char* linearAttenuationNodeName = "linear_attenuation";
const char* quadraticAttenuationNodeName = "quadratic_attenuation";
const char* falloffAngleNodeName = "falloff_angle";
const char* falloffExponentNodeName = "falloff_exponent";
const char* profileCOMMONSectionName = "profile_COMMON";
const char* profileCOMMONAttributeName = "COMMON";
const char* const inputSemanticNames[] = {"POSITION", "VERTEX", "NORMA", "TEXCOORD",
    "UV", "TANGENT", "IMAGE", "TEXTURE", 0
                                         };
// We have to read ambient lights like other light types here, so we need a type for it
const E_LIGHT_TYPE ELT_AMBIENT = E_LIGHT_TYPE(ELT_COUNT + 1);
}
...
public:
  CLightPrefab(const char* id) : CPrefab(id) {
    ...
    os::Printer::log("COLLADA: loaded light prefab", Id, ELL_DEBUG);
#endif
  }
  SLight LightData; // publically accessible
  //! creates an instance of this prefab
  ISceneNode* addInstance(ISceneNode* parent,
      ISceneManager* mgr) {
#ifdef COLLADA_READER_DEBUG
    os::Printer::log("COLLADA: Constructing light instance", Id, ELL_DEBUG);
#endif
    if (LightData.Type == ELT_AMBIENT) {
      mgr->setAmbientLight(LightData.DiffuseColor);
      return 0;
    }
    ILightSceneNode* l = mgr->addLightSceneNode(parent);
    if (l) {
...
public:
  ...
  ISceneNode* addInstance(ISceneNode* parent,
      ISceneManager* mgr) {
#ifdef COLLADA_READER_DEBUG
    os::Printer::log("COLLADA: Constructing mesh instance", Id, ELL_DEBUG);
#endif
    ISceneNode* m = mgr->addMeshSceneNode(Mesh, parent);
    if (m) {
      m->setName(getId());
      //        m->setMaterialFlag(EMF_BACK_FACE_CULLING, false);
      //        m->setDebugDataVisible(EDS_FULL);
    }
    return m;
  }
};
...
public:
  CCameraPrefab(const char* id)
    : CPrefab(id), YFov(PI / 2.5f), ZNear(1.0f), ZFar(3000.0f) {
#ifdef COLLADA_READER_DEBUG
    os::Printer::log("COLLADA: loaded camera prefab", Id, ELL_DEBUG);
#endif
  }
  ...
  ISceneNode* addInstance(ISceneNode* parent,
      ISceneManager* mgr) {
#ifdef COLLADA_READER_DEBUG
    os::Printer::log("COLLADA: Constructing camera instance", Id, ELL_DEBUG);
#endif
    ICameraSceneNode* c = mgr->addCameraSceneNode(parent);
    if (c) {
      c->setFOV(YFov);
...
public:
...
#ifdef COLLADA_READER_DEBUG
    os::Printer::log("COLLADA: loaded scene prefab", Id, ELL_DEBUG);
#endif
  }
  //! creates an instance of this prefab
  ISceneNode* addInstance(ISceneNode* parent,
      ISceneManager* mgr) {
#ifdef COLLADA_READER_DEBUG
    os::Printer::log("COLLADA: Constructing scene instance", Id, ELL_DEBUG);
#endif
    if (Children_size == 0) {
      return 0;
    }
    IDummyTransformationSceneNode* s = mgr->addDummyTransformationSceneNode(parent);
    if (s) {
      s->setName(getId());
      ...
      int i;
      for (i = 0; i < 16; ++i) {
        t += char * ((double)Transformation[i]);
        t += " ";
      }
#ifdef COLLADA_READER_DEBUG
      os::Printer::log("COLLADA: Transformation", t, ELL_DEBUG);
#endif
  ...
  IColladaPrefab* > Children;
  matrix4 Transformation;
};
//! Constructor
CColladaFileLoader::CColladaFileLoader(ISceneManager* smgr,
    IFileSystem* fs)
...
bool CColladaFileLoader::isALoadableFileExtension(const char* filename) const
{
  return hasFileExtension(filename, "xml", "dae");
}
//! creates/loads an animated mesh from the file.
//! \return Pointer to the created mesh. Returns 0 if loading failed.
//! If you no longer need the mesh, you should call IAnimatedMesh::drop().
//! See IReferenceCounted::drop() for more information.
IAnimatedMesh* CColladaFileLoader::createMesh(IReadFile* file)
{
  IXMLReaderUTF8* reader = FileSystem->createXMLReaderUTF8(file);
  if (!reader) {
    return 0;
  }
  ...
  IAnimatedMesh* returnMesh = DummyMesh;
  if (Version < 10400) {
  ...
  if (LoadedMeshCount > 1 && FirstLoadedMesh) {
    os::Printer::log("Added COLLADA mesh", FirstLoadedMeshName);
    SceneManager->getMeshCache()->addMesh(FirstLoadedMeshName, FirstLoadedMesh);
  }
...
void CColladaFileLoader::skipSection(IXMLReaderUTF8* reader, bool reportSkipping)
{
#ifndef COLLADA_READER_DEBUG
  if (reportSkipping) // always report in COLLADA_READER_DEBUG mode
#endif
    os::Printer::log("COLLADA skipping section", char * (reader->getNodeName()), ELL_DEBUG);
...
#ifdef COLLADA_READER_DEBUG
      if (reportSkipping) {
        os::Printer::log("Skipping COLLADA unknown element", char * (reader->getNodeName()), ELL_DEBUG);
      }
#endif
      ++tagCounter;
    }
...
void CColladaFileLoader::readColladaSection(IXMLReaderUTF8* reader)
{
  if (reader->isEmptyElement()) {
    return;
  }
  // todo: patch level needs to be handled
  const f32 version = fast_atof(char * (reader->getAttributeValue("version")));
  Version = floor32(version) * 10000 + round32(fract(version) * 1000.0f);
  ...
  while (reader->read())
    if (reader->getNodeType() == EXN_ELEMENT) {
      ...
      else if (librarySectionName == reader->getNodeName()) {
        readLibrarySection(reader);
      }
      else if (libraryNodesSectionName == reader->getNodeName()) {
        readLibrarySection(reader);
      }
      else if (libraryGeometriesSectionName == reader->getNodeName()) {
        readLibrarySection(reader);
      }
      else if (libraryMaterialsSectionName == reader->getNodeName()) {
        readLibrarySection(reader);
      }
      else if (libraryEffectsSectionName == reader->getNodeName()) {
        readLibrarySection(reader);
      }
      else if (libraryImagesSectionName == reader->getNodeName()) {
        readLibrarySection(reader);
      }
      else if (libraryCamerasSectionName == reader->getNodeName()) {
        readLibrarySection(reader);
      }
      else if (libraryLightsSectionName == reader->getNodeName()) {
        readLibrarySection(reader);
      }
      else if (libraryVisualScenesSectionName == reader->getNodeName()) {
        readVisualScene(reader);
      }
      else if (assetSectionName == reader->getNodeName()) {
        readAssetSection(reader);
      }
      else if (sceneSectionName == reader->getNodeName()) {
...
void CColladaFileLoader::readLibrarySection(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
  ...
  while (reader->read()) {
    if (reader->getNodeType() == EXN_ELEMENT) {
      ...
      if (cameraPrefabName == reader->getNodeName()) {
        ...
        else if (imageSectionName == reader->getNodeName()) {
          readImage(reader);
        }
        else if (lightPrefabName == reader->getNodeName()) {
          readLightPrefab(reader);
        }
        else if (materialSectionName == reader->getNodeName()) {
          readMaterial(reader);
        }
        else if (nodeSectionName == reader->getNodeName()) {
          CScenePrefab p("");
          readNodeSection(reader, SceneManager->getRootSceneNode(), &p);
        }
        else if (effectSectionName == reader->getNodeName()) {
          readEffect(reader);
        }
        else
          // program section tbd
...
void CColladaFileLoader::readVisualScene(IXMLReaderUTF8* reader)
{
  CScenePrefab* p = 0;
  while (reader->read()) {
    if (reader->getNodeType() == EXN_ELEMENT) {
      ...
      else if (p && nodeSectionName == reader->getNodeName()) { // as a child of visual_scene
        readNodeSection(reader, SceneManager->getRootSceneNode(), p);
      }
      else if (assetSectionName == reader->getNodeName()) {
        readAssetSection(reader);
      }
      else if (extraNodeName == reader->getNodeName()) {
      ...
      else if ((visualSceneSectionName == reader->getNodeName()) && p) {
        Prefabs.push_back(p);
        p = 0;
      }
    }
...
void CColladaFileLoader::readSceneSection(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
  ...
  // read the scene
  matrix4 transform; // transformation of this node
  aabbox3df bbox;
  ...
  while (reader->read()) {
    if (reader->getNodeType() == EXN_ELEMENT) {
      ...
      else if (matrixNodeName == reader->getNodeName()) {
        transform *= readMatrixNode(reader);
      }
      else if (perspectiveNodeName == reader->getNodeName()) {
        transform *= readPerspectiveNode(reader);
      }
      else if (rotateNodeName == reader->getNodeName()) {
        transform *= readRotateNode(reader);
      }
      else if (scaleNodeName == reader->getNodeName()) {
        transform *= readScaleNode(reader);
      }
      else if (skewNodeName == reader->getNodeName()) {
        transform *= readSkewNode(reader);
      }
      else if (translateNodeName == reader->getNodeName()) {
        transform *= readTranslateNode(reader);
      }
      else if (bboxNodeName == reader->getNodeName()) {
      ...
      else if ((instanceSceneName == reader->getNodeName())) {
...
void CColladaFileLoader::readAssetSection(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
  ...
  while (reader->read()) {
    if (reader->getNodeType() == EXN_ELEMENT) {
      if (upAxisNodeName == reader->getNodeName()) {
        reader->read();
        FlipAxis = (char * ("Z_UP") == reader->getNodeData());
      }
    }
    else if ((reader->getNodeType() == EXN_ELEMENT_END) &&
...
void CColladaFileLoader::readNodeSection(IXMLReaderUTF8* reader, ISceneNode* parent, CScenePrefab* p)
{
  if (reader->isEmptyElement()) {
    return;
#ifdef COLLADA_READER_DEBUG
  ...
  while (reader->read()) {
    if (reader->getNodeType() == EXN_ELEMENT) {
      ...
      else if (lookatNodeName == reader->getNodeName()) {
        transform *= readLookAtNode(reader);
      }
      else if (matrixNodeName == reader->getNodeName()) {
        transform *= readMatrixNode(reader);
...
matrix4 CColladaFileLoader::readLookAtNode(IXMLReaderUTF8* reader)
{
  matrix4 mat;
  if (reader->isEmptyElement()) {
    return mat;
  ...
  mat.buildCameraLookAtMatrixLH(
      vector3df(floats[0], floats[1], floats[2]),
      vector3df(floats[3], floats[4], floats[5]),
      vector3df(floats[6], floats[7], floats[8]));
  return mat;
}
//! reads a <skew> element and its content and creates a matrix from it
matrix4 CColladaFileLoader::readSkewNode(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
  ...
  quaternion q;
  q.fromAngleAxis(floats[0]*DEGTORAD, vector3df(floats[1], floats[2], floats[3]));
  mat = q.getMatrix();
...
void CColladaFileLoader::readBboxNode(IXMLReaderUTF8* reader,
    aabbox3df& bbox)
{
#ifdef COLLADA_READER_DEBUG
  os::Printer::log("COLLADA reading boundingbox node", ELL_DEBUG);
#endif
  bbox.reset(aabbox3df());
  if (reader->isEmptyElement()) {
    return;
  }
  f32 floats[3];
  while (reader->read()) {
    if (reader->getNodeType() == EXN_ELEMENT) {
      ...
      else if (maxNodeName == reader->getNodeName()) {
        readFloatsInsideElement(reader, floats, 3);
...
matrix4 CColladaFileLoader::readMatrixNode(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
  ...
  readFloatsInsideElement(reader, mat, 16);
  // put translation into the correct place
  if (FlipAxis) {
    matrix4 mat2(mat, matrix4::EM4CONST_TRANSPOSED);
    mat2[1] = mat[8];
    mat2[2] = mat[4];
    mat2[4] = mat[2];
    mat2[5] = mat[10];
    ...
    return matrix4(mat, matrix4::EM4CONST_TRANSPOSED);
  }
}
//! reads a <perspective> element and its content and creates a matrix from it
matrix4 CColladaFileLoader::readPerspectiveNode(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
...
matrix4 CColladaFileLoader::readRotateNode(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
  ...
  if (!iszero(floats[3])) {
    quaternion q;
    if (FlipAxis) {
      q.fromAngleAxis(floats[3]*DEGTORAD, vector3df(floats[0], floats[2], floats[1]));
    }
    else {
      q.fromAngleAxis(floats[3]*DEGTORAD, vector3df(floats[0], floats[1], floats[2]));
    }
    return q.getMatrix();
  }
  else {
...
matrix4 CColladaFileLoader::readScaleNode(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
  ...
  readFloatsInsideElement(reader, floats, 3);
  if (FlipAxis) {
    mat.setScale(vector3df(floats[0], floats[2], floats[1]));
  }
  else {
    mat.setScale(vector3df(floats[0], floats[1], floats[2]));
  }
  return mat;
}
//! reads a <translate> element and its content and creates a matrix from it
matrix4 CColladaFileLoader::readTranslateNode(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
  ...
  readFloatsInsideElement(reader, floats, 3);
  if (FlipAxis) {
    mat.setTranslation(vector3df(floats[0], floats[2], floats[1]));
  }
  else {
    mat.setTranslation(vector3df(floats[0], floats[1], floats[2]));
  }
  return mat;
}
//! reads any kind of <instance*> node
void CColladaFileLoader::readInstanceNode(IXMLReaderUTF8* reader,
    ISceneNode* parent, ISceneNode** outNode,
    CScenePrefab* p, const char* type)
{
  // find prefab of the specified id
  char* url = reader->getAttributeValue("url");
  uriToId(url);
#ifdef COLLADA_READER_DEBUG
...
void CColladaFileLoader::instantiateNode(ISceneNode* parent,
    ISceneNode** outNode, CScenePrefab* p, const char* url,
    const char* type)
{
#ifdef COLLADA_READER_DEBUG
...
void CColladaFileLoader::readCameraPrefab(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
...
void CColladaFileLoader::readImage(IXMLReaderUTF8* reader)
{
...
#ifdef COLLADA_READER_DEBUG
  os::Printer::log("COLLADA reading image", char * (image.Id), ELL_DEBUG);
#endif
  ...
  if (Version >= 10400) { // start with 1.4
    while (reader->read()) {
      if (reader->getNodeType() == EXN_ELEMENT) {
        ...
        else if (initFromName == reader->getNodeName()) {
          reader->read();
          image.Source = reader->getNodeData();
          image.Source.trim();
          image.SourceIsFilename = true;
        }
        else if (dataName == reader->getNodeName()) {
          reader->read();
          image.Source = reader->getNodeData();
          image.Source.trim();
...
void CColladaFileLoader::readTexture(IXMLReaderUTF8* reader)
{
...
#ifdef COLLADA_READER_DEBUG
  os::Printer::log("COLLADA reading material", char * (material.Id), ELL_DEBUG);
#endif
  if (Version >= 10400) {
    while (reader->read()) {
      if (reader->getNodeType() == EXN_ELEMENT &&
    ...
    if (!reader->isEmptyElement()) {
      ...
      if (p && p->Type == ECPT_FLOAT3) {
        material.Mat.AmbientColor = SColorf(p->Floats[0], p->Floats[1], p->Floats[2]).toSColor();
      }
      p = getColladaParameter(ECPN_DIFFUSE);
      if (p && p->Type == ECPT_FLOAT3) {
        material.Mat.DiffuseColor = SColorf(p->Floats[0], p->Floats[1], p->Floats[2]).toSColor();
      }
...
void CColladaFileLoader::readEffect(IXMLReaderUTF8* reader, SColladaEffect* effect)
{
  static const char* constantNode("constant");
  static const char* lambertNode("lambert");
  static const char* phongNode("phong");
  static const char* blinnNode("blinn");
  static const char* emissionNode("emission");
  static const char* ambientNode("ambient");
  static const char* diffuseNode("diffuse");
  static const char* specularNode("specular");
  static const char* shininessNode("shininess");
  static const char* reflectiveNode("reflective");
  static const char* reflectivityNode("reflectivity");
  static const char* transparentNode("transparent");
  static const char* transparencyNode("transparency");
  static const char* indexOfRefractionNode("index_of_refraction");
  if (!effect) {
    Effects.push_back(SColladaEffect());
    effect = &Effects.getLast();
    effect->Parameters = new CAttributes();
    effect->Id = readId(reader);
    effect->Transparency = 1.f;
    effect->Mat.Lighting = true;
    effect->Mat.NormalizeNormals = true;
#ifdef COLLADA_READER_DEBUG
    os::Printer::log("COLLADA reading effect", char * (effect->Id), ELL_DEBUG);
#endif
  }
  while (reader->read()) {
    if (reader->getNodeType() == EXN_ELEMENT) {
      ...
      if (!reader->isEmptyElement() && ((profileCOMMONSectionName == reader->getNodeName()) ||
      ...
      else if (newParamName == reader->getNodeName()) {
...
#endif
          effect->Mat.setFlag(EMF_GOURAUD_SHADING,
              phongNode == reader->getNodeName() ||
              blinnNode == reader->getNodeName());
          while (reader->read()) {
            if (reader->getNodeType() == EXN_ELEMENT) {
              const char* node = reader->getNodeName();
              if (emissionNode == node || ambientNode == node ||
                ...
                while (reader->read()) {
                  if (reader->getNodeType() == EXN_ELEMENT &&
                    ...
                    const SColorf colorf = readColorNode(reader);
                    const SColor color = colorf.toSColor();
              ...
              else if (shininessNode == node || reflectivityNode == node ||
        ...
        else if (!reader->isEmptyElement() && (extraNodeName == reader->getNodeName())) {
          readEffect(reader, effect);
        }
        else if (doubleSidedNodeName == reader->getNodeName()) {
...
#endif
            effect->Mat.setFlag(EMF_BACK_FACE_CULLING, false);
          }
        }
        else {
          skipSection(reader, true);  // ignore all other sections
      ...
      else if (profileCOMMONSectionName == reader->getNodeName()) {
        break;
      }
      else if (techniqueNodeName == reader->getNodeName()) {
        break;
      }
      else if (extraNodeName == reader->getNodeName()) {
        break;
  ...
  if (effect->Mat.AmbientColor == SColor(0) &&
      effect->Mat.DiffuseColor != SColor(0)) {
    effect->Mat.AmbientColor = effect->Mat.DiffuseColor;
  }
  if (effect->Mat.DiffuseColor == SColor(0) &&
      effect->Mat.AmbientColor != SColor(0)) {
    effect->Mat.DiffuseColor = effect->Mat.AmbientColor;
  }
  if ((effect->Transparency != 0.0f) && (effect->Transparency != 1.0f)) {
    effect->Mat.MaterialType = EMT_TRANSPARENT_VERTEX_ALPHA;
    effect->Mat.ZWriteEnable = false;
  }
  E_TEXTURE_CLAMP twu = ETC_REPEAT;
  s32 idx = effect->Parameters->findAttribute(wrapsName);
  if (idx >= 0) {
    twu = (E_TEXTURE_CLAMP)(effect->Parameters->getAttributeAsInt(idx));
  }
  E_TEXTURE_CLAMP twv = ETC_REPEAT;
  idx = effect->Parameters->findAttribute(wraptName);
  if (idx >= 0) {
    twv = (E_TEXTURE_CLAMP)(effect->Parameters->getAttributeAsInt(idx));
  }
  int i;
  ...
  effect->Mat.setFlag(EMF_BILINEAR_FILTER, effect->Parameters->getAttributeAsBool("bilinear"));
  effect->Mat.setFlag(EMF_TRILINEAR_FILTER, effect->Parameters->getAttributeAsBool("trilinear"));
  effect->Mat.setFlag(EMF_ANISOTROPIC_FILTER, effect->Parameters->getAttributeAsBool("anisotropic"));
}
const SColladaMaterial* CColladaFileLoader::findMaterial(const char* materialName)
{
#ifdef COLLADA_READER_DEBUG
  ...
  if (Materials[mat].InstanceEffectId_size != 0) {
    ...
    if (effect != -1) {
      ...
      if (Effects[effect].Textures_size) {
...
void CColladaFileLoader::readBindMaterialSection(IXMLReaderUTF8* reader, const char* id)
{
#ifdef COLLADA_READER_DEBUG
  ...
  while (reader->read()) {
    if (reader->getNodeType() == EXN_ELEMENT) {
      if (instanceMaterialName == reader->getNodeName()) {
        ...
        char* meshbufferReference = reader->getAttributeValue("symbol");
        if (meshbufferReference_size == 0) {
          continue;
        }
        char* target = reader->getAttributeValue("target");
        uriToId(target);
        if (target_size == 0) {
          continue;
        }
...
#ifdef COLLADA_READER_DEBUG
        os::Printer::log((char * ("Material binding: ") + meshbufferReference + " " + target), ELL_DEBUG);
#endif
        if (MaterialsToBind.find(meshbufferReference)) {
          IMeshBuffer* > & toBind
            = MeshesToBind[MaterialsToBind[meshbufferReference]];
#ifdef COLLADA_READER_DEBUG
          os::Printer::log("Material binding now ", material->Id, ELL_DEBUG);
          os::Printer::log("#meshbuffers", char * ((int)toBind_size), ELL_DEBUG);
#endif
          SMesh tmpmesh;
          int i;
          for (i = 0; i < toBind_size; ++i) {
            toBind[i]->getMaterial() = material->Mat;
            tmpmesh.addMeshBuffer(toBind[i]);
            if ((material->Transparency != 0.0f) && (material->Transparency != 1.0f)) {
              toBind[i]->getMaterial().MaterialType = EMT_TRANSPARENT_VERTEX_ALPHA;
          ...
          if ((material->Transparency != 0.0f) && (material->Transparency != 1.0f)) {
#ifdef COLLADA_READER_DEBUG
            os::Printer::log("COLLADA found transparency material", char * (material->Transparency), ELL_DEBUG);
#endif
            SceneManager->getMeshManipulator()->setVertexColorAlpha(&tmpmesh, floor32(material->Transparency * 255.0f));
          }
        }
      }
    }
...
void CColladaFileLoader::readGeometry(IXMLReaderUTF8* reader)
{
  char* id = readId(reader);
#ifdef COLLADA_READER_DEBUG
  ...
  if (!reader->isEmptyElement())
    while (reader->read()) {
      if (reader->getNodeType() == EXN_ELEMENT) {
        ...
        else if (sourceSectionName == nodeName) {
          // create a new source
          sources.push_back(SSource());
          sources.getLast().Id = readId(reader);
#ifdef COLLADA_READER_DEBUG
          os::Printer::log("Reading source", sources.getLast().Id, ELL_DEBUG);
#endif
        }
...
#ifdef COLLADA_READER_DEBUG
            os::Printer::log("Read array", sources.getLast().Array.Name, ELL_DEBUG);
#endif
          }
#ifdef COLLADA_READER_DEBUG
          else
            os::Printer::log("Warning, array outside source found",
                readId(reader), ELL_DEBUG);
#endif
        }
...
#endif
                amesh->setMaterialFlag(EMF_BACK_FACE_CULLING, false);
              }
            }
            else
        ...
        if (okToReadArray && !sources.empty()) {
          f32 > & a = sources.getLast().Array.Data;
  ...
  // create file name
  char* filename = CurrentlyLoadingMesh;
  filename += '#';
  filename += id;
  // add to scene manager
  if (LoadedMeshCount) {
    SceneManager->getMeshCache()->addMesh(filename, amesh);
    os::Printer::log("Added COLLADA mesh", filename, ELL_DEBUG);
  }
  else {
...
void CColladaFileLoader::readPolygonSection(IXMLReaderUTF8* reader,
    ...
    const char* geometryId)
{
...
#endif
  char* materialName = reader->getAttributeValue("material");
  char* polygonType = reader->getNodeName();
  ...
  if (!reader->isEmptyElement())
    while (reader->read()) {
      ...
      if (reader->getNodeType() == EXN_ELEMENT) {
        ...
        if (inputTagName == nodeName) {
          ...
          if (inp.Semantic == ECIS_VERTEX) {
            ...
            for (i = 1; i < Inputs_size; ++i) {
              ...
              maxOffset = max_(maxOffset, localInputs.getLast().Offset);
              ++inputSemanticCount;
            }
          }
          uriToId(inp.Source);
          maxOffset = max_(maxOffset, inp.Offset);
          ++inputSemanticCount;
        }
        else if (primitivesName == nodeName) {
          parsePolygonOK = true;
          polygons.push_back(SPolygon());
        }
        else if (vcountName == nodeName) {
          parseVcountOK = true;
        } // end  is polygon node
      } // end is element node
      else if (reader->getNodeType() == EXN_ELEMENT_END) {
        ...
        if (parseVcountOK) {
        ...
        else if (parsePolygonOK && polygons_size) {
          char* data = reader->getNodeData();
          data.trim();
          const c8* p = &data[0];
          ...
          if (vCounts.empty()) {
            ...
            int i;
            for (i = 0; i < vCounts_size; i++) {
              const int polyVCount = vCounts[i];
              int > polyCorners;
              for (int j = 0; j < polyVCount * inputSemanticCount; j++) {
                if (!*p) {
                  break;
                }
                findNextNoneWhiteSpace(&p);
              ...
              while (polyCorners_size >= 3 * inputSemanticCount) {
                // add one triangle's worth of indices
                for (int k = 0; k < inputSemanticCount * 3; ++k) {
  ...
  int i;
  for (i = 0; i < localInputs_size; ++i) {
    SColladaInput& inp = localInputs[i];
    u32 s;
    for (s = 0; s < sources_size; ++s) {
      if (sources[s].Id == inp.Source) {
        // slot found
        inp.Data = sources[s].Array.Data;
    ...
    if (s == sources_size) {
      ...
      tmp += " sourceArray:";
      tmp += inp.Source;
      os::Printer::log(tmp, ELL_DEBUG);
#endif
    }
  }
  if ((inputSemanticCount == 0) || !polygons_size) {
  ...
  if (textureCoordSetCount < 2) {
    ...
    SMeshBuffer* mbuffer = new SMeshBuffer();
    buffer = mbuffer;
    map<S3DVertex, int> vertMap;
    int i;
    for (i = 0; i < polygons_size; ++i) {
      u16* indices;
      const u32 vertexCount = polygons[i].Indices_size / maxOffset;
      mbuffer->Vertices.reallocate(mbuffer->Vertices_size + vertexCount);
      // for all index/semantic groups
      for (int v = 0; v < polygons[i].Indices_size; v += maxOffset) {
        S3DVertex vtx;
        vtx.Color.set(255, 255, 255, 255);
        // for all input semantics
        for (int k = 0; k < localInputs_size; ++k) {
        ...
        map<S3DVertex, int>::Node* n = vertMap.find(vtx);
        if (n) {
      ...
      if (polygonsSectionName == polygonType &&
        ...
        if (FlipAxis) {
          for (int ind = indices_size - 3; ind > 0 ; --ind) {
          ...
          for (int ind = 0; ind + 2 < indices_size; ++ind) {
            mbuffer->Indices.push_back(indices[0]);
            mbuffer->Indices.push_back(indices[ind + 1]);
            mbuffer->Indices.push_back(indices[ind + 2]);
          }
        ...
        // it's just triangles
        for (int ind = 0; ind < indices_size; ind += 3) {
          if (FlipAxis) {
            mbuffer->Indices.push_back(indices[ind + 2]);
            mbuffer->Indices.push_back(indices[ind + 1]);
    ...
    SMeshBufferLightMap* mbuffer = new SMeshBufferLightMap();
    buffer = mbuffer;
    int i;
    for (i = 0; i < polygons_size; ++i) {
      const u32 vertexCount = polygons[i].Indices_size / maxOffset;
      ...
      // add vertex indices
      const u32 oldVertexCount = mbuffer->Vertices_size - vertexCount;
  ...
  if (m) {
    ...
    if (m->Transparency != 1.0f) {
      SceneManager->getMeshManipulator()->setVertexColorAlpha(&tmpmesh, floor32(m->Transparency * 255.0f));
    }
  }
  // add future bind reference for the material
  char* meshbufferReference = geometryId + "/" + materialName;
  if (!MaterialsToBind.find(meshbufferReference)) {
    MaterialsToBind[meshbufferReference] = MeshesToBind_size;
    MeshesToBind.push_back(IMeshBuffer* > ());
  }
...
#ifdef COLLADA_READER_DEBUG
  os::Printer::log("COLLADA added meshbuffer", char * ((int)buffer->getVertexCount()) + " vertices, " + char * ((int)buffer->getIndexCount()) + " indices.", ELL_DEBUG);
#endif
  buffer->drop();
}
//! reads a <light> element and stores it as prefab
void CColladaFileLoader::readLightPrefab(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
      ...
      while (reader->read()) {
        if (reader->getNodeType() == EXN_ELEMENT) {
          if (pointSectionName == reader->getNodeName()) {
            prefab->LightData.Type = ELT_POINT;
          }
          else if (directionalSectionName == reader->getNodeName()) {
            prefab->LightData.Type = ELT_DIRECTIONAL;
          }
          else if (spotSectionName == reader->getNodeName()) {
            prefab->LightData.Type = ELT_SPOT;
          }
          else if (ambientSectionName == reader->getNodeName()) {
            prefab->LightData.Type = ELT_AMBIENT;
          }
          else if (colorNodeName == reader->getNodeName()) {
          ...
          else if (falloffAngleNodeName == reader->getNodeName()) {
            readFloatsInsideElement(reader, &prefab->LightData.OuterCone, 1);
            prefab->LightData.OuterCone *= DEGTORAD;
          }
          else if (falloffExponentNodeName == reader->getNodeName()) {
...
{
  int i;
  for (i = 0; i < ColladaParameters_size; ++i)
...
void CColladaFileLoader::readColladaInput(IXMLReaderUTF8* reader, SColladaInput > & inputs)
{
  // parse param
  SColladaInput p;
  // get type
  char* semanticName = reader->getAttributeValue("semantic");
  int i;
...
void CColladaFileLoader::readColladaInputs(IXMLReaderUTF8* reader, const char* parentName)
{
  Inputs.clear();
  while (reader->read()) {
    if (reader->getNodeType() == EXN_ELEMENT &&
...
void CColladaFileLoader::readColladaParameters(IXMLReaderUTF8* reader,
    const char* parentName)
{
  ...
  while (reader->read()) {
    ...
    if (reader->getNodeType() == EXN_ELEMENT &&
      ...
      // get type
      u32 i;
      char* typeName = reader->getAttributeValue("type");
      ...
      // get name
      char* nameName = reader->getAttributeValue("name");
      for (i = 0; typeNames[i]; ++i)
...
CV_INLINE f32 CColladaFileLoader::readFloat(const c8** p)
{
  f32 ftmp;
...
CV_INLINE s32 CColladaFileLoader::readInt(const c8** p)
{
...
void CColladaFileLoader::readFloatsInsideElement(IXMLReaderUTF8* reader, f32* floats, u32 count)
{
  if (reader->isEmptyElement()) {
    return;
  }
...
void CColladaFileLoader::readIntsInsideElement(IXMLReaderUTF8* reader, s32* ints, u32 count)
{
  if (reader->isEmptyElement()) {
    return;
  }
...
SColorf CColladaFileLoader::readColorNode(IXMLReaderUTF8* reader)
{
  if (reader->getNodeType() == EXN_ELEMENT &&
      colorNodeName == reader->getNodeName()) {
    f32 color[4];
    readFloatsInsideElement(reader, color, 4);
    return SColorf(color[0], color[1], color[2], color[3]);
  }
  return SColorf();
}
f32 CColladaFileLoader::readFloatNode(IXMLReaderUTF8* reader)
{
#ifdef COLLADA_READER_DEBUG
...
void CColladaFileLoader::uriToId(char* str)
{
...
char* CColladaFileLoader::readId(IXMLReaderUTF8* reader)
{
  char* id = reader->getAttributeValue("id");
  if (id_size == 0) {
...
ITexture* CColladaFileLoader::getTextureFromImage(char* uri, SColladaEffect* effect)
{
#ifdef COLLADA_READER_DEBUG
  ...
  for (;;) {
    ...
    for (i = 0; i < Images_size; ++i) {
      if (uri == Images[i].Id) {
        if (Images[i].Source_size && Images[i].SourceIsFilename) {
          ...
          u32* ptrdest = data;
          const c8* ptrsrc = Images[i].Source;
          for (int j = 0; j < size; ++j) {
            sscanf(ptrsrc, "%x", ptrdest);
            ++ptrdest;
            ptrsrc += 4;
          }
          IImage* img = driver->createImageFromData(ECF_A8R8G8B8, Images[i].Dimension, data, true, true);
          ITexture* tex = driver->addTexture((CurrentlyLoadingMesh + "#" + Images[i].Id), img);
          img->drop();
          return tex;
        }
        break;
    ...
    if (effect && effect->Parameters->getAttributeType(uri) == EAT_STRING) {
      uri = effect->Parameters->getAttributeAsString(uri);
#ifdef COLLADA_READER_DEBUG
      os::Printer::log("COLLADA now searching texture", uri, ELL_DEBUG);
#endif
    }
    else {
      break;
...
void CColladaFileLoader::readParameter(IXMLReaderUTF8* reader, IAttributes* parameters)
{
#ifdef COLLADA_READER_DEBUG
  ...
  const char* name = reader->getAttributeValue("sid");
  if (!reader->isEmptyElement()) {
    while (reader->read()) {
      if (reader->getNodeType() == EXN_ELEMENT) {
        if (floatNodeName == reader->getNodeName()) {
          const f32 f = readFloatNode(reader);
          parameters->addFloat(name, f);
        }
        else if (float2NodeName == reader->getNodeName()) {
          f32 f[2];
          readFloatsInsideElement(reader, f, 2);
          //            Parameters.addVector2d(name, vector2df(f[0],f[1]));
        }
        else if (float3NodeName == reader->getNodeName()) {
          f32 f[3];
          readFloatsInsideElement(reader, f, 3);
          parameters->addVector3d(name, vector3df(f[0], f[1], f[2]));
        }
        else if ((initFromName == reader->getNodeName()) ||
            (sourceSectionName == reader->getNodeName())) {
          reader->read();
          parameters->addString(name, reader->getNodeData());
        }
        else if (wrapsName == reader->getNodeName()) {
          reader->read();
          const char* val = reader->getNodeData();
          if (val == "WRAP") {
            parameters->addInt(wrapsName, (int)ETC_REPEAT);
          }
          else if (val == "MIRROR") {
            parameters->addInt(wrapsName, (int)ETC_MIRROR);
          }
          else if (val == "CLAMP") {
            parameters->addInt(wrapsName, (int)ETC_CLAMP_TO_EDGE);
          }
          else if (val == "BORDER") {
            parameters->addInt(wrapsName, (int)ETC_CLAMP_TO_BORDER);
          }
          else if (val == "NONE") {
            parameters->addInt(wrapsName, (int)ETC_CLAMP_TO_BORDER);
          }
          ...
          const char* val = reader->getNodeData();
          if (val == "WRAP") {
            parameters->addInt(wraptName, (int)ETC_REPEAT);
          }
          else if (val == "MIRROR") {
            parameters->addInt(wraptName, (int)ETC_MIRROR);
          }
          else if (val == "CLAMP") {
            parameters->addInt(wraptName, (int)ETC_CLAMP_TO_EDGE);
          }
          else if (val == "BORDER") {
            parameters->addInt(wraptName, (int)ETC_CLAMP_TO_BORDER);
          }
          else if (val == "NONE") {
            parameters->addInt(wraptName, (int)ETC_CLAMP_TO_BORDER);
          }
          ...
          else if (val == "LINEAR_MIPMAP_NEAREST") {
            parameters->addBool("bilinear", true);
          }
        }
        else if (magfilterName == reader->getNodeName()) {
          reader->read();
          const char* val = reader->getNodeData();
          if (val != "LINEAR") {
        ...
        else if (mipfilterName == reader->getNodeName()) {
