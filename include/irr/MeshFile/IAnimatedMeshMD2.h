...
public:
  ...
  void getFrameLoop(EMD2_ANIMATION_TYPE l, s32& outBegin,
      s32& outEnd, s32& outFPS) = 0;
  ...
  bool getFrameLoop(const c8* name,
      s32& outBegin, s32& outEnd, s32& outFPS) = 0;
  //! Get amount of md2 animations in this file.
  s32 getAnimationCount() = 0;
  //! Get name of md2 animation.
  /** \param nr: Zero based index of animation. */
  const c8* getAnimationName(s32 nr) = 0;
};
#endif
