...
void CParticleRingEmitter::serializeAttributes(IAttributes* out, SAttributeReadWriteOptions* options) const
{
...
void CParticleRingEmitter::deserializeAttributes(IAttributes* in, SAttributeReadWriteOptions* options)
{
