...
\code
  ...
  p->setParticleSize(dimension2df(20.0f, 10.0f));
  IParticleEmitter* em = p->createBoxEmitter(
    F3AABBOX(-5,0,-5,5,1,5),
    float3(0.0f,0.03f,0.0f),
...
public:
  ...
  void setParticleSize(
      const dimension2df& size = dimension2df(5.0f, 5.0f)) = 0;
  ...
  Default is true. */
  void setParticlesAreGlobal(bool global = true) = 0;
  //! Remove all currently visible particles
  void clearParticles() = 0;
  ...
  void doParticleSystem(u32 time) = 0;
  //! Gets the particle emitter, which creates the particles.
  /** \return The particle emitter. Can be 0 if none is set. */
  IParticleEmitter* getEmitter() = 0;
  ...
  new particles. */
  void setEmitter(IParticleEmitter* emitter) = 0;
  ...
  void addAffector(IParticleAffector* affector) = 0;
  //! Get a list of all particle affectors.
  /** \return The list of particle affectors attached to this node. */
  const list<IParticleAffector*>& getAffectors() = 0;
  //! Removes all particle affectors in the particle system.
  void removeAllAffectors() = 0;
  ...
  IParticleAffector* createScaleParticleAffector(const dimension2df& scaleTo = dimension2df(1.0f, 1.0f)) = 0;
  ...
  IParticleRotationAffector* createRotationAffector(
      ...
      const float3 pivotPoint = float3(0.0f, 0.0f, 0.0f)) = 0;
};
#endif
