...
public:
  ...
  s32 write(const void* buffer, u32 sizeToWrite) = 0;
  ...
  bool seek(long finalPos, bool relativeMovement = false) = 0;
...
IWriteFile* createWriteFile(const char* fileName, bool append);
#endif
