...
public:
  ...
  s32 findFile(const char* filename, bool isFolder = false) = 0;
  //! Returns the base path of the file list
  const char* getPath() = 0;
  ...
  u32 addItem(const char* fullPath, u32 offset, u32 size, bool isDirectory, u32 id = 0) = 0;
