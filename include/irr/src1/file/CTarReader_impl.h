...
bool CArchiveLoaderTAR::isALoadableFileFormat(const char* filename) const
{
...
IFileArchive* CArchiveLoaderTAR::createArchive(const char* filename, bool ignoreCase, bool ignorePaths) const
{
...
IReadFile* CTarReader::createAndOpenFile(const char* filename)
{
