...
//#include "irrString.h"
CMemoryFile::CMemoryFile(void* memory, long len, const char* fileName, bool d)
...
const char* CMemoryFile::getFileName() const
{
  return Filename;
}
IReadFile* createMemoryReadFile(void* memory, long size, const char* fileName, bool deleteMemoryWhenDropped)
{
