...
public:
  ...
  ~COpenGLCgMaterialRenderer();
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial, bool resetAllRenderstates, IMaterialRendererServices* services);
  bool OnRender(IMaterialRendererServices* services, E_VERTEX_TYPE vtxtype);
