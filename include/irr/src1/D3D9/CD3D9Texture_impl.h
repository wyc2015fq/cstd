...
CD3D9Texture::CD3D9Texture(CD3D9Driver* driver, const dimension2du& size,
...
const dimension2du& CD3D9Texture::getOriginalSize() const
{
  return ImageSize;
}
//! Returns (=size) of the texture.
const dimension2du& CD3D9Texture::getSize() const
{
  return TextureSize;
}
