...
public:
  ...
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  IGUIEnvironment* getGUIEnvironment() = 0;
  ...
  /** Example Usage:
    ...
    if (n)
    {
      n->setScale(float3(46.0f, 45.0f, 46.0f));
  ...
  IMeshSceneNode* addSphereSceneNode(f32 radius = 5.0f, s32 polyCount = 16,
      ...
      const float3 scale = float3(1.0f, 1.0f, 1.0f)) = 0;
  ...
  IBillboardSceneNode* addBillboardSceneNode(ISceneNode* parent = 0,
      ...
      SColor colorTop = 0xFFFFFFFF, SColor colorBottom = 0xFFFFFFFF) = 0;
  ...
  \return Pointer to the created scene node.
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  ISceneNode* addEmptySceneNode(ISceneNode* parent = 0, s32 id = -1) = 0;
  ...
  IAnimatedMesh* addHillPlaneMesh(const char* name,
      ...
      const dimension2df& countHills = dimension2df(0.0f, 0.0f),
      const dimension2df& textureRepeatCount = dimension2df(1.0f, 1.0f)) = 0;
  ...
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  IAnimatedMesh* addTerrainMesh(const char* meshname,
      IImage* texture, IImage* heightmap,
      const dimension2df& stretchSize = dimension2df(10.0f, 10.0f),
      f32 maxHeight = 200.0f,
      const dimension2du& defaultVertexBlockSize = dimension2du(64, 64)) = 0;
  ...
  IAnimatedMesh* addArrowMesh(const char* name,
      SColor vtxColorCylinder = 0xFFFFFFFF,
      SColor vtxColorCone = 0xFFFFFFFF,
  ...
  */
  IAnimatedMesh* addVolumeLightMesh(const char* name,
      ...
      const SColor TailColor = SColor(0, 0, 0, 0)) = 0;
  ...
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  ISceneNode* getSceneNodeFromId(s32 id, ISceneNode* start = 0) = 0;
  ...
  and null if no scene node could be found.
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  ISceneNode* getSceneNodeFromName(const c8* name, ISceneNode* start = 0) = 0;
  ...
  and null if no scene node could be found.
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  ISceneNode* getSceneNodeFromType(ESCENE_NODE_TYPE type, ISceneNode* start = 0) = 0;
  ...
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  ICameraSceneNode* getActiveCamera() = 0;
  //! Sets the currently active camera.
  /** The previous active camera will be deactivated.
  \param camera: The new camera which should be active. */
  void setActiveCamera(ICameraSceneNode* camera) = 0;
  //! Sets the color of stencil buffers shadows drawn by the scene manager.
  void setShadowColor(SColor color = SColor(150, 0, 0, 0)) = 0;
  //! Get the current color of shadows.
  SColor getShadowColor() = 0;
  ...
  u32 registerNodeForRendering(ISceneNode* node,
  ...
  ISceneNodeAnimator* createRotationAnimator(const float3 rotationSpeed) = 0;
  ...
  ISceneNodeAnimator* createFlyStraightAnimator(const float3 startPoint,
      const float3 endPoint, u32 timeForWay, bool loop = false, bool pingpong = false) = 0;
  ...
  If you no longer need the animator, you should call ISceneNodeAnimator::drop().
  See IReferenceCounted::drop() for more information. */
  ISceneNodeAnimator* createDeleteAnimator(u32 timeMs) = 0;
  ...
  it:
  \code
  const F3AABBOX& box = yourSceneNode->getBoundingBox();
  ...
  float3(0,-10.0f,0) would give an approximately realistic gravity.
  You can disable gravity by setting it to float3(0,0,0).
  ...
  ISceneNodeAnimatorCollisionResponse* createCollisionResponseAnimator(
      ...
      const float3 gravityPerSecond = float3(0, -10.0f, 0),
  ...
  See IReferenceCounted::drop() for more information. */
  ITriangleSelector* createTriangleSelector(IMesh* mesh, ISceneNode* node) = 0;
  ...
  */
  ITriangleSelector* createTriangleSelector(IAnimatedMeshSceneNode* node) = 0;
  ...
  If you no longer need the selector, you should call ITriangleSelector::drop().
  See IReferenceCounted::drop() for more information. */
  ITriangleSelector* createTriangleSelectorFromBoundingBox(ISceneNode* node) = 0;
  ...
  If you no longer need the selector, you should call ITriangleSelector::drop().
  See IReferenceCounted::drop() for more information. */
  IMetaTriangleSelector* createMetaTriangleSelector() = 0;
  ...
  u32 getMeshLoaderCount() = 0;
  //! Retrieve the given mesh loader
  /** \param index The index of the loader to retrieve. This parameter is an 0-based
  array index.
  \return A pointer to the specified loader, 0 if the index is incorrect. */
  IMeshLoader* getMeshLoader(u32 index) = 0;
  ...
  \param externalLoader: Implementation of a new mesh loader. */
  void addExternalSceneLoader(ISceneLoader* externalLoader) = 0;
  //! Returns the number of scene loaders supported by Irrlicht at this time
  u32 getSceneLoaderCount() = 0;
  //! Retrieve the given scene loader
  /** \param index The index of the loader to retrieve. This parameter is an 0-based
  array index.
  \return A pointer to the specified loader, 0 if the index is incorrect. */
  ISceneLoader* getSceneLoader(u32 index) = 0;
  //! Get pointer to the scene collision manager.
  /** \return Pointer to the collision manager
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  ISceneCollisionManager* getSceneCollisionManager() = 0;
  //! Get pointer to the mesh manipulator.
  /** \return Pointer to the mesh manipulator
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  IMeshManipulator* getMeshManipulator() = 0;
  ...
  E_SCENE_NODE_RENDER_PASS getSceneNodeRenderPass() = 0;
  ...
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  ISceneNodeFactory* getDefaultSceneNodeFactory() = 0;
  //! Adds a scene node factory to the scene manager.
  /** Use this to extend the scene manager with new scene node types which it should be
  able to create automaticly, for example when loading data from xml files. */
  void registerSceneNodeFactory(ISceneNodeFactory* factoryToAdd) = 0;
  //! Get amount of registered scene node factories.
  u32 getRegisteredSceneNodeFactoryCount() = 0;
  //! Get a scene node factory by index
  /** \return Pointer to the requested scene node factory, or 0 if it does not exist.
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  ISceneNodeFactory* getSceneNodeFactory(u32 index) = 0;
  ...
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  ISceneNodeAnimatorFactory* getDefaultSceneNodeAnimatorFactory() = 0;
  //! Adds a scene node animator factory to the scene manager.
  /** Use this to extend the scene manager with new scene node animator types which it should be
  able to create automaticly, for example when loading data from xml files. */
  void registerSceneNodeAnimatorFactory(ISceneNodeAnimatorFactory* factoryToAdd) = 0;
  //! Get amount of registered scene node animator factories.
  u32 getRegisteredSceneNodeAnimatorFactoryCount() = 0;
  ...
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  ISceneNodeAnimatorFactory* getSceneNodeAnimatorFactory(u32 index) = 0;
  //! Get typename from a scene node type or null if not found
  const c8* getSceneNodeTypeName(ESCENE_NODE_TYPE type) = 0;
  //! Returns a typename from a scene node animator type or null if not found
  const c8* getAnimatorTypeName(ESCENE_NODE_ANIMATOR_TYPE type) = 0;
  //! Adds a scene node to the scene by name
  /** \return Pointer to the scene node added by a factory
  This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
  ISceneNode* addSceneNode(const char* sceneNodeTypeName, ISceneNode* parent = 0) = 0;
  ...
  ISceneNodeAnimator* createSceneNodeAnimator(const char* typeName, ISceneNode* target = 0) = 0;
  ...
  ISceneManager::drop().
  See IReferenceCounted::drop() for more information. */
  ISceneManager* createNewSceneManager(bool cloneContent = false) = 0;
  ...
  bool saveScene(const char* filename, ISceneUserDataSerializer* userDataSerializer = 0, ISceneNode* node = 0) = 0;
  //! Saves the current scene into a file.
  /** Scene nodes with the option isDebugObject set to true are
  not being saved. The scene is usually written to an .irr file,
  an xml based format. .irr files can Be edited with the Irrlicht
  ...
  is also the default).
  \return True if successful. */
  bool saveScene(IWriteFile* file, ISceneUserDataSerializer* userDataSerializer = 0, ISceneNode* node = 0) = 0;
  //! Saves the current scene into a file.
  /** Scene nodes with the option isDebugObject set to true are
  not being saved. The scene is usually written to an .irr file,
  an xml based format. .irr files can Be edited with the Irrlicht
  ...
  is also the default).
  \return True if successful. */
  bool saveScene(IXMLWriter* writer, const char* currentPath, ISceneUserDataSerializer* userDataSerializer = 0, ISceneNode* node = 0) = 0;
  ...
  \return True if successful. */
  bool loadScene(const char* filename, ISceneUserDataSerializer* userDataSerializer = 0, ISceneNode* rootNode = 0) = 0;
  //! Loads a scene. Note that the current scene is not cleared before.
  /** The scene is usually loaded from an .irr file, an xml based
  format, but other scene formats can be added to the engine via
  ISceneManager::addExternalSceneLoader. .irr files can Be edited
  ...
  (which is also the default).
  \return True if successful. */
  bool loadScene(IReadFile* file, ISceneUserDataSerializer* userDataSerializer = 0, ISceneNode* rootNode = 0) = 0;
  //! Get a mesh writer implementation if available
  /** Note: You need to drop() the pointer after use again, see IReferenceCounted::drop()
  for details. */
  IMeshWriter* createMeshWriter(EMESH_WRITER_TYPE type) = 0;
  //! Get a skinned mesh, which is not available as header-only code
  /** Note: You need to drop() the pointer after use again, see IReferenceCounted::drop()
  for details. */
  ISkinnedMesh* createSkinnedMesh() = 0;
  //! Sets ambient color of the scene
  void setAmbientLight(const SColorf& ambientColor) = 0;
  //! Get ambient color of the scene
  const SColorf& getAmbientLight() = 0;
  ...
  void setLightManager(ILightManager* lightManager) = 0;
  ...
  const IGeometryCreator* getGeometryCreator(void) = 0;
  ...
  false. */
  bool isCulled(const ISceneNode* node) = 0;
};
#endif
