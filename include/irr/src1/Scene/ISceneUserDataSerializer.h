...
public:
  ...
  void OnCreateNode(ISceneNode* node) = 0;
  ...
  void OnReadUserData(ISceneNode* forSceneNode, IAttributes* userData) = 0;
  ...
  IAttributes* createUserData(ISceneNode* forSceneNode) = 0;
};
#endif
