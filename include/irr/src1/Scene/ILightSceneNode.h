...
public:
  ...
  void setLightData(const SLight& light) = 0;
  //! Gets the light data associated with this ILightSceneNode
  /** \return The light data. */
  const SLight& getLightData() = 0;
  //! Gets the light data associated with this ILightSceneNode
  /** \return The light data. */
  SLight& getLightData() = 0;
  ...
  void setLightType(E_LIGHT_TYPE type) = 0;
  //! Gets the light type.
  /** \return The current light type. */
  E_LIGHT_TYPE getLightType() = 0;
  ...
  void enableCastShadow(bool shadow = true) = 0;
  //! Check whether this light casts shadows.
  /** \return True if light would cast shadows, else false. */
  bool getCastShadow() = 0;
};
#endif
