...
void CCubeSceneNode::setSize()
{
  ...
  Mesh = SceneManager->getGeometryCreator()->createCubeMesh(float3(Size));
}
//! renders the node.
...
const F3AABBOX& CCubeSceneNode::getBoundingBox() const
{
...
SMaterial& CCubeSceneNode::getMaterial(u32 i)
{
