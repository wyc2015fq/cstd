...
bool CImageLoaderDDS::isALoadableFileExtension(const char* filename) const
{
  return hasFileExtension(filename, "dds");
}
//! returns true if the file maybe is able to be loaded by this class
bool CImageLoaderDDS::isALoadableFileFormat(IReadFile* file) const
{
  if (!file) {
    return false;
  }
...
IImage* CImageLoaderDDS::loadImage(IReadFile* file) const
{
