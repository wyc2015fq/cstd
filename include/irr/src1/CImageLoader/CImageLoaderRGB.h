...
private:
  bool readHeader(IReadFile* file, rgbStruct& rgb) const;
  void readRGBrow(u8* buf, int y, int z, IReadFile* file, rgbStruct& rgb) const;
  void processFile(IReadFile* file, rgbStruct& rgb) const;
  bool checkFormat(IReadFile* file, rgbStruct& rgb) const;
  bool readOffsetTables(IReadFile* file, rgbStruct& rgb) const;
