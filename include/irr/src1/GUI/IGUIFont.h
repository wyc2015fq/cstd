...
public:
  ...
  it would be drawn. */
  dimension2du getDimension(const char* text) = 0;
  ...
  s32 getCharacterFromPos(const char* text, s32 pixel_x) = 0;
  //! Returns the type of this font
  EGUI_FONT_TYPE getType() const {
    return EGFT_CUSTOM;
  }
  //! Sets global kerning width for the font.
  void setKerningWidth(s32 kerning) = 0;
  //! Sets global kerning height for the font.
  void setKerningHeight(s32 kerning) = 0;
  ...
  */
  void setInvisibleCharacters(const char* s) = 0;
};
#endif
