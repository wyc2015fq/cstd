...
public:
  //! constructor
  IGUIInOutFader(IGUIEnvironment* environment, IGUIElement* parent, s32 id, IRECT rectangle)
  ...
  void setColor(SColor source, SColor dest) = 0;
