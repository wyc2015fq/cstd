...
//#include "os.h"
//! constructor
CGUICheckBox::CGUICheckBox(bool checked, IGUIEnvironment* environment, IGUIElement* parent, s32 id, IRECT rectangle)
...
void CGUICheckBox::draw()
{
  ...
  if (skin) {
    ...
    IRECT checkRect(AbsoluteRect.UpperLeftCorner.X,
