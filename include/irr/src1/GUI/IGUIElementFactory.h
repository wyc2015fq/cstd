...
public:
  ...
  IGUIElement* addGUIElement(EGUI_ELEMENT_TYPE type, IGUIElement* parent = 0) = 0;
  ...
  \return Pointer to the new element or null if not successful. */
  IGUIElement* addGUIElement(const c8* typeName, IGUIElement* parent = 0) = 0;
  //! Get amount of GUI element types this factory is able to create
  s32 getCreatableGUIElementTypeCount() = 0;
  ...
  EGUI_ELEMENT_TYPE getCreateableGUIElementType(s32 idx) = 0;
  ...
  getCreatableGUIElementTypeCount() */
  const c8* getCreateableGUIElementTypeName(s32 idx) = 0;
  ...
  const c8* getCreateableGUIElementTypeName(EGUI_ELEMENT_TYPE type) = 0;
};
