...
class IGUISkin : public IAttributeExchangingObject
{
public:
  //! returns default color
  SColor getColor(EGUI_DEFAULT_COLOR color) = 0;
  //! sets a default color
  void setColor(EGUI_DEFAULT_COLOR which, SColor newColor) = 0;
  //! returns size for the given size type
  s32 getSize(EGUI_DEFAULT_SIZE size) = 0;
  //! Returns a default text.
  /** For example for Message box button captions:
  "OK", "Cancel", "Yes", "No" and so on. */
  const char* getDefaultText(EGUI_DEFAULT_TEXT text) = 0;
  //! Sets a default text.
  /** For example for Message box button captions:
  "OK", "Cancel", "Yes", "No" and so on. */
  void setDefaultText(EGUI_DEFAULT_TEXT which, const char* newText) = 0;
  //! sets a default size
  void setSize(EGUI_DEFAULT_SIZE which, s32 size) = 0;
  //! returns the default font
  IGUIFont* getFont(EGUI_DEFAULT_FONT which = EGDF_DEFAULT) = 0;
  //! sets a default font
  void setFont(IGUIFont* font, EGUI_DEFAULT_FONT which = EGDF_DEFAULT) = 0;
  ...
  u32 getIcon(EGUI_DEFAULT_ICON icon) = 0;
  //! Sets a default icon
  /** Sets the sprite index used for drawing icons like arrows,
  close buttons and ticks in checkboxes
  \param icon: Enum specifying which icon to change
  \param index: The sprite index used to draw this icon */
  void setIcon(EGUI_DEFAULT_ICON icon, u32 index) = 0;
  ...
  void draw3DTabButton(IGUIElement* element, bool active,
      const IRECT& rect, const IRECT* clip = 0, EGUI_ALIGNMENT alignment = EGUIA_UPPERLEFT) = 0;
  ...
  void draw3DTabBody(IGUIElement* element, bool border, bool background,
      const IRECT& rect, const IRECT* clip = 0, s32 tabHeight = -1, EGUI_ALIGNMENT alignment = EGUIA_UPPERLEFT) = 0;
  ...
  void drawIcon(IGUIElement* element, EGUI_DEFAULT_ICON icon,
      const position2di position, u32 starttime = 0, u32 currenttime = 0,
      bool loop = false, const IRECT* clip = 0) = 0;
  ...
  void draw2DRectangle(IGUIElement* element, const SColor& color,
      const IRECT& pos, const IRECT* clip = 0) = 0;
