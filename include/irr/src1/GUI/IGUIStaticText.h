...
public:
  //! constructor
  IGUIStaticText(IGUIEnvironment* environment, IGUIElement* parent, s32 id, IRECT rectangle)
  ...
  SColor getOverrideColor(void) = 0;
  ...
  void setBackgroundColor(SColor color) = 0;
  ...
  bool isDrawBackgroundEnabled() = 0;
  //! Sets whether to draw the border
  void setDrawBorder(bool draw) = 0;
  //! Checks if border drawing is enabled
  /** \return true if border drawing is enabled, false otherwise */
  bool isDrawBorderEnabled() = 0;
  ...
  s32 getTextWidth(void) = 0;
  //! Set whether the text in this label should be clipped if it goes outside bounds
  void setTextRestrainedInside(bool restrainedInside) = 0;
  //! Checks if the text in this label should be clipped if it goes outside bounds
  bool isTextRestrainedInside() = 0;
  ...
  */
  void setRightToLeft(bool rtl) = 0;
