...
public:
  //! constructor
  IGUIContextMenu(IGUIEnvironment* environment, IGUIElement* parent, s32 id, IRECT rectangle)
    : IGUIElement(EGUIET_CONTEXT_MENU, environment, parent, id, rectangle) {}
  //! set behavior when menus are closed
  void setCloseHandling(ECONTEXT_MENU_CLOSE onClose) = 0;
  //! get current behavior when the menu will be closed
  ECONTEXT_MENU_CLOSE getCloseHandling() = 0;
  ...
  u32 addItem(const char* text, s32 commandId = -1, bool enabled = true,
  ...
  \param autoChecking: Specifies if the item should be checked by clicking
  \return Returns the index of the new item */
  u32 insertItem(u32 idx, const char* text, s32 commandId = -1, bool enabled = true,
      bool hasSubMenu = false, bool checked = false, bool autoChecking = false) = 0;
  ...
  s32 findItemWithCommandId(s32 commandId, u32 idxStartSearch = 0) = 0;
  //! Adds a separator item to the menu
  void addSeparator() = 0;
  //! Get text of the menu item.
  /** \param idx: Zero based index of the menu item */
  const char* getItemText(u32 idx) = 0;
  //! Sets text of the menu item.
  /** \param idx: Zero based index of the menu item
  \param text: New text of the item. */
  void setItemText(u32 idx, const char* text) = 0;
  //! Check if a menu item is enabled
  /** \param idx: Zero based index of the menu item */
  bool isItemEnabled(u32 idx) = 0;
  //! Sets if the menu item should be enabled.
  /** \param idx: Zero based index of the menu item
  \param enabled: True if it is enabled, otherwise false. */
  void setItemEnabled(u32 idx, bool enabled) = 0;
  //! Sets if the menu item should be checked.
  /** \param idx: Zero based index of the menu item
  \param enabled: True if it is enabled, otherwise false. */
  void setItemChecked(u32 idx, bool enabled) = 0;
  //! Check if a menu item is checked
  /** \param idx: Zero based index of the menu item */
  bool isItemChecked(u32 idx) = 0;
  //! Removes a menu item
  /** \param idx: Zero based index of the menu item */
  void removeItem(u32 idx) = 0;
  //! Removes all menu items
  void removeAllItems() = 0;
  //! Get the selected item in the menu
  /** \return Index of the selected item, -1 if none selected. */
  s32 getSelectedItem() = 0;
  //! Get the command id of a menu item
  /** \param idx: Zero based index of the menu item */
  s32 getItemCommandId(u32 idx) = 0;
  //! Sets the command id of a menu item
  /** \param idx: Zero based index of the menu item
  \param id: Command id of menu item, a simple id you may
  set to whatever you want. */
  void setItemCommandId(u32 idx, s32 id) = 0;
  //! Get a pointer to the submenu of an item.
  /** 0 is returned if there is no submenu
  \param idx: Zero based index of the menu item
  \return Returns a pointer to the submenu of an item. */
  IGUIContextMenu* getSubMenu(u32 idx) = 0;
  //! should the element change the checked status on clicking
  void setItemAutoChecking(u32 idx, bool autoChecking) = 0;
  //! does the element change the checked status on clicking
  bool getItemAutoChecking(u32 idx) = 0;
  //! When an eventparent is set it receives events instead of the usual parent element
  void setEventParent(IGUIElement* parent) = 0;
};
#endif
