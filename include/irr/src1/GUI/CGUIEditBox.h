...
public:
  //! constructor
  CGUIEditBox(const char* text, bool border, IGUIEnvironment* environment,
  ...
  bool isOverrideColorEnabled(void) const;
  ...
  void setPasswordBox(bool passwordBox, char passwordChar = '*');
...
protected:
  ...
  char* > BrokenText;
  s32 > BrokenTextPositions;
  IRECT CurrentTextRect, FrameRect; // temporary values
};
