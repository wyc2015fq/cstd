  ...
  : ITexture(name), Texture(0), IsRenderTarget(renderTarget)
{
  ...
  if (image) {
    ...
    dimension2du optSize = OrigSize.getOptimalSize();
...
const dimension2du& CSoftwareTexture::getOriginalSize() const
{
  return OrigSize;
}
//! Returns (=size) of the texture.
const dimension2du& CSoftwareTexture::getSize() const
{
