...
/** \mainpage irrXML 1.2 API documentation
 ...
 \section intro Introduction
  ...
  \code
  //#include <irrXML.h>
   // irrXML is located in the namespace io
...
public:
  ...
  unsigned int getAttributeCount() = 0;
  //! Returns name of an attribute.
  /** \param idx: Zero based index, should be something between 0 and getAttributeCount()-1.
  \return Name of the attribute, 0 if an attribute with this index does not exist. */
  const char_type* getAttributeName(int idx) = 0;
  //! Returns the value of an attribute.
  /** \param idx: Zero based index, should be something between 0 and getAttributeCount()-1.
  \return Value of the attribute, 0 if an attribute with this index does not exist. */
  const char_type* getAttributeValue(int idx) = 0;
  //! Returns the value of an attribute.
  /** \param name: Name of the attribute.
  \return Value of the attribute, 0 if an attribute with this name does not exist. */
  const char_type* getAttributeValue(const char_type* name) = 0;
  ...
  const char_type* getAttributeValueSafe(const char_type* name) = 0;
  ...
  ETEXT_FORMAT getSourceFormat() = 0;
  ...
  ETEXT_FORMAT getParserFormat() = 0;
};
template <typename T>
struct xmlChar {
  T c;
...
/** Not using char for this because
char has 16 bit on windows and 32 bit on other operating systems. */
