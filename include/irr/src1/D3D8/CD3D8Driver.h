...
public:
  //! constructor
  CD3D8Driver(const SIrrlichtCreationParameters& params, IFileSystem* io);
  //! destructor
  ~CD3D8Driver();
...
private:
  ...
  matrix4 Matrices[ETS_COUNT]; // matrices of the 3d mode we need to restore when we switch back from the 2d mode.
