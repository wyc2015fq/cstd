...
CV_INLINE void setTextureColorStage(IDirect3DDevice8* dev, DWORD i,
...
CV_INLINE void setTextureColorStage(IDirect3DDevice8* dev, DWORD i, DWORD arg1)
{
  dev->SetTextureStageState(i, D3DTSS_COLOROP, D3DTOP_SELECTARG1);
  dev->SetTextureStageState(i, D3DTSS_COLORARG1, arg1);
}
CV_INLINE void setTextureAlphaStage(IDirect3DDevice8* dev, DWORD i,
    DWORD arg1, DWORD op, DWORD arg2)
{
...
CV_INLINE void setTextureAlphaStage(IDirect3DDevice8* dev, DWORD i, DWORD arg1)
{
...
public:
  //! Constructor
  CD3D8MaterialRenderer(IDirect3DDevice8* d3ddev, IVideoDriver* driver)
...
{
public:
  CD3D8MaterialRenderer_SOLID(IDirect3DDevice8* p, IVideoDriver* d)
...
{
public:
  CD3D8MaterialRenderer_ONETEXTURE_BLEND(IDirect3DDevice8* p, IVideoDriver* d)
    : CD3D8MaterialRenderer(p, d) {}
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
      bool resetAllRenderstates, IMaterialRendererServices* services) {
    services->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
...
{
public:
  CD3D8MaterialRenderer_SOLID_2_LAYER(IDirect3DDevice8* p, IVideoDriver* d)
    : CD3D8MaterialRenderer(p, d) {}
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
      bool resetAllRenderstates, IMaterialRendererServices* services) {
    services->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
...
{
public:
  CD3D8MaterialRenderer_TRANSPARENT_ADD_COLOR(IDirect3DDevice8* p, IVideoDriver* d)
    : CD3D8MaterialRenderer(p, d) {}
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
      bool resetAllRenderstates, IMaterialRendererServices* services) {
    services->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
...
{
public:
  CD3D8MaterialRenderer_TRANSPARENT_VERTEX_ALPHA(IDirect3DDevice8* p, IVideoDriver* d)
    : CD3D8MaterialRenderer(p, d) {}
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
      bool resetAllRenderstates, IMaterialRendererServices* services) {
    services->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
...
{
public:
  CD3D8MaterialRenderer_TRANSPARENT_ALPHA_CHANNEL(IDirect3DDevice8* p, IVideoDriver* d)
    : CD3D8MaterialRenderer(p, d) {}
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
      bool resetAllRenderstates, IMaterialRendererServices* services) {
    services->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
...
{
public:
  CD3D8MaterialRenderer_TRANSPARENT_ALPHA_CHANNEL_REF(IDirect3DDevice8* p, IVideoDriver* d)
    : CD3D8MaterialRenderer(p, d) {}
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
      bool resetAllRenderstates, IMaterialRendererServices* services) {
    services->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
...
{
public:
  CD3D8MaterialRenderer_LIGHTMAP(IDirect3DDevice8* p, IVideoDriver* d)
    : CD3D8MaterialRenderer(p, d) {}
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
      bool resetAllRenderstates, IMaterialRendererServices* services) {
    services->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
...
{
public:
  CD3D8MaterialRenderer_DETAIL_MAP(IDirect3DDevice8* p, IVideoDriver* d)
    : CD3D8MaterialRenderer(p, d) {}
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
      bool resetAllRenderstates, IMaterialRendererServices* services) {
    services->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
...
{
public:
  CD3D8MaterialRenderer_SPHERE_MAP(IDirect3DDevice8* p, IVideoDriver* d)
    : CD3D8MaterialRenderer(p, d) {}
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
      bool resetAllRenderstates, IMaterialRendererServices* services) {
    services->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
...
{
public:
  CD3D8MaterialRenderer_REFLECTION_2_LAYER(IDirect3DDevice8* p, IVideoDriver* d)
    : CD3D8MaterialRenderer(p, d) {}
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
      bool resetAllRenderstates, IMaterialRendererServices* services) {
    services->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
...
{
public:
  CD3D8MaterialRenderer_TRANSPARENT_REFLECTION_2_LAYER(IDirect3DDevice8* p, IVideoDriver* d)
    : CD3D8MaterialRenderer(p, d) {}
  void OnSetMaterial(const SMaterial& material, const SMaterial& lastMaterial,
      bool resetAllRenderstates, IMaterialRendererServices* services) {
    services->setBasicRenderStates(material, lastMaterial, resetAllRenderstates);
