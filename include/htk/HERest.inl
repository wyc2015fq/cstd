...
//  -C .\config\config1 -I .\labels\phones0.mlf -t 250.0 150.0 1000.0 -S train.scp -H .\hmms\hmm0\macros -H .\hmms\hmm0\hmmdefs -M .\hmms\hmm1 .\lists\monophones0 
...
void DoForwardBackward(FBInfo *fbInfo, UttInfo *utt, char * datafn, char * datafn2)
{
   ...
   LoadLabs1(utt, lff, datafn_lab, labDir, labExt);
   /* Load the data */
   LoadData1(fbInfo->al_hset, utt, dff, datafn, datafn2);
