...
static ConfParam *cParm21[MAXGLOBS];       /* config parameters */
static int numParm21 = 0;
...
void InitVQ(void)
{
   ...
   numParm21 = GetConfig("HVQ", TRUE, cParm21, MAXGLOBS);
   if (numParm21>0){
      if (GetConfInt(cParm21,numParm21,"TRACE",&i)) trace21 = i;
   }
