...
static int trace18 = 0;
#define T_MEL  0002     /* Mel filterbank */

/* -------------------- Config and Memory ----------------------- */

static MemHeap sigpHeap;
static ConfParam *cParm18[MAXGLOBS];       /* config parameters */
static int numParm18 = 0;
...
void InitSigP(void)
{
   ...
   numParm18 = GetConfig("HSIGP", TRUE, cParm18, MAXGLOBS);
   if (numParm18>0){
      if (GetConfInt(cParm18,numParm18,"TRACE",&i)) trace18 = i;
   }
