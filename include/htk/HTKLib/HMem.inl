...
static ConfParam *cParm12[MAXGLOBS];       /* config parameters */
static int numParm12 = 0;
...
void InitMem(void)
{
   ...
   numParm12 = GetConfig("HMEM", TRUE, cParm12, MAXGLOBS);
   if (numParm12>0){
      if (GetConfInt(cParm12,numParm12,"TRACE",&i)) trace12 = i;
      if (GetConfBool(cParm12,numParm12,"PROTECTSTAKS",&b)) protectStaks = b;
   }
}
