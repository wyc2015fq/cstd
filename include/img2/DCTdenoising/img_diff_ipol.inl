...
int main(int argc, char** argv)
{
  ...
  if (nc != nc2 || nx != nx2 || ny != ny2) {
    printf("error :: input images of different size or number of \
channels \n");
    return EXIT_FAILURE;
  }
  // variables
  ...
  if (io_png_write_f32(argv[4], difference, (size_t) d_w, (size_t) d_h,
      (size_t) d_c) != 0) {
