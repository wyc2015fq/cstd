...
int TreeListRegister( HINSTANCE hInstance ) {
  ...
  sClass.cbClsExtra = 0;
  sClass.cbWndExtra = sizeof( UITreeList* );
...
static LRESULT SendNotify( UITreeList *pData, NMHDR *pNotify ) {
...
//    Ergibt den Rückgabewert der WM_NOTIFY Nachrich
static void CallbackEntry( UITreeList *pData, BaseItem *pEntry, unsigned uItem, unsigned uFlags, int &iImage, unsigned &uTextSize, LPCTSTR &pText ) {
  NMTVDISPINFO sInfo;
...
//    uFlags        : Welche Daten sollen abgefragt werden
//    Ergibt den Rückgabewert der WM_NOTIFY Nachrich
static void CallbackExtra( UITreeList *pData, BaseItem *pEntry, ExtraItem *pExtra, unsigned uItem, unsigned uSub, unsigned uFlags, int &iImage, unsigned &uTextSize, LPCTSTR &pText ) {
  NMTVDISPINFO sInfo;
...
static LRESULT CALLBACK ToolProc( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam ) {
  ...
  pData = ( UITreeList* ) GetWindowLongPtr( hWnd, GWLP_USERDATA );
...
static void ChangeColSize( UITreeList *pData, int iDelta ) {
  unsigned uPos;
  HDITEM sItem;
  RECT sRect;
  int iWeight;
...
static HIMAGELIST CreateDragImage( UITreeList *pData, unsigned uItem, unsigned uSub ) {
  ExtraItem * pExtra;
  BaseItem *pEntry;
  HIMAGELIST hList;
  BITMAPINFO sInfo;
...
static int UpdateRect( UITreeList *pData, unsigned uItem, unsigned uSub ) {
  BaseItem * pEntry;
  RECT sRect;
  unsigned uPos;
...
//    Ergibt 1 wenn der Eintrag sichtbar war
static int UpdateColRect( UITreeList *pData, unsigned uColumn ) {
  RECT sRect;
...
//    uItem        : Ist die Nummer des Eintrages
//    Ergibt 1 wenn der Eintrag sichtbar war
static int UpdateRow( UITreeList *pData, unsigned uItem ) {
  BaseItem * pEntry;
  RECT sRect;
  unsigned uPos;
...
//    pData        : Zeiger auf die Fensterdaten
//    Ergibt 1 wenn der Eintrag sichtbar war
static void UpdateView( UITreeList *pData ) {
  RECT sRect;
...
//    pData        : Zeiger auf die Fensterdaten
//    Ergibt 1 wenn der sich Einstellungen verändert haben
static void UpdateScrollY( UITreeList *pData ) {
  SCROLLINFO sInfo;
...
static void UpdateToolTip( UITreeList *pData, unsigned uItem, unsigned uFlags ) {
...
static void UpdateItems( UITreeList *pData, unsigned uItem ) {
  unsigned uPos;
  unsigned uOld;
  unsigned uNum;
  unsigned uTemp;
...
static int UpdateColumns( UITreeList *pData ) {
  HWND hHeader;
  unsigned uPos;
  int iSize;
  int iNum;
...
//             0 = Ausgeführt
//             1 = Abbruch
static int TreeListToggleItem( UITreeList *pData, unsigned uItem, unsigned uAddFlags ) {
  NMTREEVIEW sNotify;
  BaseItem **pList;
  BaseItem *pEntry;
  BaseItem *pTemp;
...
//    Ergibt 1 wenn der Eintrag sichtbar war
static int TreeListGetItemRect( UITreeList *pData, unsigned uItem, unsigned uFlags, RECT *pRect ) {
  ExtraItem * pExtra;
  BaseItem *pEntry;
  unsigned uPos;
  unsigned uSub;
...
static int TreeListEnsureVisible( UITreeList *pData, unsigned uItem, unsigned uSub ) {
  BaseItem * pEntry;
  BaseItem *pTemp;
  unsigned uTemp;
  unsigned uPos;
...
static int TreeListIsVisible( UITreeList *pData, unsigned uItem, unsigned uSub ) {
  BaseItem * pEntry;
  unsigned uPos;
  int iNum;
  int iAnf;
...
static int TreeListXorSelectItem( UITreeList *pData, unsigned uItem, int iMode ) {
  NMTREEVIEW sNotify;
  BaseItem *pEntry;
  unsigned uOld;
  unsigned uRet;
...
//    Wählt den Focus ab
//    pData        : Zeiger auf die Fensterdaten
static void TreeListRemoveFocus( UITreeList *pData ) {
  ExtraItem * pExtra;
  BaseItem *pEntry;
  unsigned uItem;
  unsigned uSub;
...
static int TreeListSetFocus( UITreeList *pData, unsigned uItem, unsigned uSub ) {
  ExtraItem * pExtra;
  BaseItem *pEntry;
  BaseItem *pTemp;
  unsigned uTemp;
...
static int TreeListSelectItem( UITreeList *pData, unsigned uItem, unsigned uSubItem, int iMode ) {
  NMTREEVIEW sNotify;
  ExtraItem *pExtra;
  BaseItem *pEntry;
  BaseItem *pTemp;
...
static int TreeListSelectChilds( UITreeList *pData, unsigned uItem, int iMode ) {
  BaseItem * pEntry;
  unsigned uLevel;
  unsigned uXor;
...
static unsigned TreeListInsertItem( UITreeList *pData, TV_INSERTSTRUCT *pInsert ) {
  char * pTemp;
  BYTE bFlag;
  LPCTSTR pText;
  LPCTSTR pTextTemp;
...
static int TreeListSetItem( UITreeList *pData, const TV_ITEM *pItem ) {
  BYTE bCall;
  BYTE bFlags;
  ExtraItem **pList;
  ExtraItem *pExtra;
...
//    Ergibt 1 wenn ok oder 0 bei einem Fehler
static unsigned TreeListGetItem( UITreeList *pData, TV_ITEM *pItem ) {
  ExtraItem **pList;
  ExtraItem *pExtra;
  BaseItem *pEntry;
  unsigned uBits;
...
static int TreeListDeleteColumn( UITreeList *pData, unsigned uCol ) {
  ExtraItem **pList;
  ExtraItem *pExtra;
  RECT sRect;
  unsigned uPos;
...
static int TreeListInsertColumn( UITreeList *pData, unsigned uCol, TV_COLUMN *pColumn ) {
  ExtraItem **pList;
  HDITEM sItem;
  RECT sRect;
  BYTE bMark;
...
static int TreeListScanColumn( UITreeList *pData, unsigned uSub ) {
  BaseItem **pList;
  BaseItem *pEntry;
  ExtraItem *pExtra;
  ExtraItem **pItems;
...
static unsigned TreeListHitTest( UITreeList *pData, TV_HITTESTINFO *pInfo ) {
  int iXpos;
  int iYpos;
  int iZpos;
  int iWidth;
...
static unsigned TreeListSetInsertMark( UITreeList *pData, unsigned uItem, int iMode ) {
...
static LRESULT TreeListGetItemColor( UITreeList *pData, unsigned uItem, unsigned uSub, int iMode ) {
  COLORREF uColor;
  ExtraItem *pExtra;
  BaseItem *pEntry;
...
//    Ergibt die alte Farbe oder TV_NOCOLOR wenn keine Farbe eingestellt war
static COLORREF TreeListSetItemColor( UITreeList *pData, unsigned uItem, unsigned uSub, COLORREF uColor, int iMode ) {
  TV_ITEM sSet;
  COLORREF uOld;
  ExtraItem *pExtra;
  BaseItem *pEntry;
...
static int TreeListSetTrackItem( UITreeList *pData, unsigned uItem, unsigned uSub ) {
  ExtraItem * pExtra;
  BaseItem *pEntry;
  int iRet = 1;
...
//    Ergibt 1 wenn der Eintrag unterstrichen wurde
static unsigned TreeListGetNextItem( UITreeList *pData, unsigned uItem, unsigned uFlags ) {
  BaseItem * pEntry;
  unsigned uStop;
  unsigned uPos;
...
static unsigned TreeListFindItem( UITreeList *pData, unsigned uItem, TVFIND *pFind ) {
  int iImage;
  BaseItem *pEntry;
  ExtraItem *pExtra;
  LPCTSTR pCmpText;
...
static unsigned TreeListNextSelUntil( UITreeList *pData, unsigned uItem, unsigned uStop ) {
  BaseItem * pEntry;
...
//    uStop    : Bestimmt bei welchem Eintrag abgebrochen werden soll werden soll
//    Ergibt die Nummer des Eintrages oder 0 wenn keiner gefunden wurde
static unsigned TreeListNextUnselUntil( UITreeList *pData, unsigned uItem, unsigned uStop ) {
  BaseItem * pEntry;
...
static void TreeListMouseClick( UITreeList *pData, UINT uMsg, WPARAM wParam, LPARAM lParam ) {
  ExtraItem * pExtra;
  BaseItem *pEntry;
  BaseItem *pTemp;
  ...
  if ( uItem )                                                 // Wurde auf einen Eintrag getrückt
  {
    ...
    else if ( sInfo.flags & uMaskItem )                         // Eintrag auswählen
    {
      ...
      if ( pData->uStyleEx & TVS_EX_MULTISELECT )             // Mehrfachauswahl erlaubt
      {
        ...
        if ( wParam & MK_CONTROL )                         // Einzelen Eintrag umschalten
        {
          ...
          if ( pEntry && ( pEntry->uState & TVIS_SELECTED ) ) {
            ...
            if ( TreeListXorSelectItem( pData, uItem, TVC_BYMOUSE ) ) {                                // Auch unsichtbare Kinder abwählen
              pTemp = pData->pTreeItems[ pEntry->uFirstChild ];
              if ( pTemp && !pTemp->uShowPos )
                for ( uTemp = uItem;; ) {
      ...
      if ( uMsg == WM_LBUTTONDBLCLK ) {                                            // Auto-Edit mit Doppelklick
...
static void TreeListChar( UITreeList *pData, UINT nChar, LPARAM lParam ) {
  LPTSTR pName;
  ExtraItem *pExtra;
  BaseItem *pEntry;
  unsigned uDelta;
...
static void TreeListKeyDown( UITreeList *pData, WPARAM wParam, LPARAM lParam ) {
  BaseItem * pTemp;
  BaseItem *pEntry;
...
static int TreeListSortItemsEx( UITreeList *pData, TV_SORTEX *pSortData, int iMode ) {
  TV_SORTEX sSort;
  unsigned uNum;
  unsigned uItem;
  unsigned uLast;
...
//    iMode        : 1=Rekursiv sortieren
//    Ergibt 1 wenn ok sonst 0
static int TreeListSortItemsCb( UITreeList *pData, TV_SORTCB *pSortData, int iMode ) {
  TV_SORTCB sSort;
  unsigned uNum;
  unsigned uItem;
  unsigned uLast;
...
//    iMode        : 1=Rekursiv sortieren
//    Ergibt 1 wenn ok sonst 0
static int TreeListSortItems( UITreeList *pData, unsigned uParent, int iMode ) {
  unsigned uNum;
  unsigned uItem;
  unsigned uLast;
  unsigned uFirst;
...
static int TreeListEndLabelEdit( UITreeList *pData, int iMode ) {
  TCHAR cText[ 2052 ];
...
//    Ergibt das Handle des Edit-Controlls oder NULL bei einem Fehler
static HWND TreeListEditLabel( UITreeList *pData, unsigned uItem, unsigned uSub ) {
  HDC hDc;
  HWND hWnd;
  LRESULT lRet;
  char cTemp;
  ...
  {
  case 1:
    pData->hEdit = CreateWindow( _T( "COMBOBOX" ), NULL, WS_BORDER | WS_CHILD | CBS_AUTOHSCROLL | CBS_DROPDOWN, 0, 0, 0, 0, pData->hWnd, ( HMENU ) 3, NULL, NULL );
    pData->uEditMode = 1;
    SendMessage( pData->hEdit, CB_LIMITTEXT, 2048, 0 );
    break;
    
  case 2:
    pData->hEdit = CreateWindow( _T( "COMBOBOX" ), NULL, WS_BORDER | WS_CHILD | CBS_AUTOHSCROLL | CBS_DROPDOWNLIST, 0, 0, 0, 0, pData->hWnd, ( HMENU ) 3, NULL, NULL );
    pData->uEditMode = 2;
    SendMessage( pData->hEdit, CB_LIMITTEXT, 2048, 0 );
    break;
...
//                0 wenn der Eintrag nicht gewählt wurde
static int TreeListStartNotifyEdit( UITreeList *pData, unsigned uItem, unsigned uSub, WPARAM wParam, LPARAM lParam ) {
  TCHAR cText[ 1024 ];
...
//    Ergibt 1 das Editieren gestartet wurde, ansonsten 0
//                0 wenn der Eintrag nicht gewählt wurde
static int TreeListStartAutoEdit( UITreeList *pData, unsigned uColumn, WPARAM wParam, LPARAM lParam ) {
  TCHAR cBuffer[ 256 ];
  NMTREEVIEW sNotify;
  ExtraItem *pExtra;
  BaseItem *pEntry;
...
static LRESULT CALLBACK TreeListProc( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam ) {
  ...
  case WM_NCDESTROY:                                         // Das Fenster zerstören
    ...
    memset( pData, 0, sizeof( UITreeList ) );
    delete pData;
  ...
  case TVM_SETCOLUMN:                                             // Einen Spalten-Header einstellen
    ...
    if ( pData->hHeader && U( wParam ) < pData->uColumnCount ) {
      ...
      if ( pCol->mask & TVCF_WIDTH ) {
        sItem.mask |= HDI_WIDTH;
        sItem.cxy = pCol->cx;
        pData->aColumn[ U( wParam ) ].sSize = ( short ) sItem.cxy;
      }
