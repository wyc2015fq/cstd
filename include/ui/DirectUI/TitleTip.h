#pragma once
class CTitleTip : public CWindowWnd {
public:
  DECLARE_WND_CLASS( _T( "TitleTip" ) )
...
public:
  BOOL Create( HWND hWndParent, BOOL bShowThemed ) {
    ...
    m_rgbTextColour = ( bShowThemed ) ? GetSysColor( COLOR_WINDOWTEXT ) : GetSysColor( COLOR_INFOTEXT );
