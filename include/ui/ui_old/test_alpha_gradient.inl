...
struct the_application : public agg::platform_support {
...
int test_alpha_gradient()
{
  ...
  XCreateWindow(disp, mainwin, "AGG Example. Alpha channel gradient", 100, 100, 800, 600, id_lay1);
