...
void CBCGPToolbarComboBoxButton::AdjustRect ()
{
	...
	m_pWndCombo->SetWindowPos (NULL,
		m_rect.left + iHorzMargin_tbcbb, m_rect.top,
	...
	if (m_bFlat)
	{
		...
		m_rect.left = m_rectCombo.left - iHorzMargin_tbcbb;
		m_rect.right = m_rectCombo.right + iHorzMargin_tbcbb;
		...
		if (m_pWndEdit != NULL)
		{
			...
			m_pWndEdit->SetWindowPos (NULL,
				m_rect.left + iHorzMargin_tbcbb + iBorderOffset, m_rect.top + iBorderOffset,
