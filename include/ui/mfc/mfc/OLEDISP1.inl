...
//extern "C" DWORD AFXAPI _AfxDispatchCall(AFX_PMSG pfn, void* pArgs, UINT nSizeArgs);
    ...
    VARIANT* pvarResult, DISPPARAMS* pDispParams, UINT* puArgErr)
{
  ...
  if (sc == S_OK) {
    TRY {
      ...
      typedef DWORD (AFXAPI * fnDispatch_t)(AFX_PMSG, void*, UINT);
      fnDispatch_t pfnDispatch = (fnDispatch_t)& _AfxDispatchCall;
