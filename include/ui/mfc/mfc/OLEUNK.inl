...
#define OleGetInterfacePtr(pTarget, pEntry) \
  ((LPUNKNOWN)((BYTE*)pTarget + pEntry->nOffset))
#define OleGetAggregatePtr(pTarget, pEntry) \
  (*(LPUNKNOWN*)((BYTE*)pTarget + pEntry->nOffset))
/////////////////////////////////////////////////////////////////////////////
  ...
  if (bUnknown) {
    do {
      ...
      while (pEntry->piid != NULL) {
        ...
        LPUNKNOWN lpUnk = OleGetInterfacePtr(this, pEntry);
...
LPUNKNOWN CCmdTarget::QueryAggregates(const void* iid)
{
  ...
  do {
    ...
    while (pEntry->nOffset != (size_t) - 1) {
      LPUNKNOWN lpQuery = OleGetAggregatePtr(this, pEntry);
