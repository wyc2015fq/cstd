...
{
  ASSERT_VALID(this);
  return (COleDocument*)m_pDocument;
}
...
{
  ASSERT_VALID(this);
  ASSERT(GetSelectionType() != createNewItem);
  return m_szFileName;
}
...
{
  ASSERT_VALID(this);
  NotifyClient(OLE_CHANGED, nDrawAspect);
}
...
{
  ASSERT_VALID(this);
  return GetDocument()->m_pEmbeddedItem != this;
}
