...
extern WNDPROC get_class_winproc( struct tagCLASS *class1 ) DECLSPEC_HIDDEN;
extern struct dce *get_class_dce( struct tagCLASS *class1 ) DECLSPEC_HIDDEN;
extern struct dce *set_class_dce( struct tagCLASS *class1, struct dce *dce ) DECLSPEC_HIDDEN;
