...
static const int iAnimTimerId1 = 2;
static const int iCheckActivityTimerId = 3;
static clock_t nLastAnimTime1 = 0;
...
void CBCGPPopupWindow::OnTimer(UINT_PTR nIDEvent)
{
  ...
  case iAnimTimerId1:
    if (!m_bAnimationIsDone) {
      ...
      int nDuration = nCurrAnimTime - nLastAnimTime1;
...
void CBCGPPopupWindow::StartAnimation(BOOL bShow/* = TRUE*/)
{
  ...
  SetTimer(iAnimTimerId1, m_AnimationSpeed, NULL);
  nLastAnimTime1 = clock();
}
//*******************************************************************************
