...
public:
  ...
  void EnableTabSwap(BOOL bEnable) {
    m_bEnableTabSwap = bEnable;
  }
  BOOL IsTabSwapEnabled() const {
    return m_bEnableTabSwap;
  }

  void SetDontActivateView(BOOL bSet)  {
    m_bDontActivateView = bSet;
  }
  BOOL IsActivateView()          {
    return m_bDontActivateView;
  }
  ...
  void AddIcon(HICON hIcon, int iIcon) {
    m_mapAddedIcons.SetAt(hIcon, iIcon);
  }

  BOOL EnableCustomToolTips(BOOL bEnable = TRUE);

  virtual BOOL IsActiveInMDITabGroup() const {
    return FALSE;
  }
  virtual BOOL IsMDIFocused() const {
    return FALSE;
  }
...
public:
  ...
  virtual BOOL IsRestoreTabAttributes() const {
    return TRUE;
  }
  ...
  BOOL IsSingleTabStatic() const {
    return m_bSingleTabIsStatic;
  }
  ...
  BOOL IsPropertySheetTab() const {
    return m_bIsPropertySheetTab;
  }
