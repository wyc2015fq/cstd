...
const int nImageHeight1 = 15;
const int nImageWidth1 = 16;
    ...
    BOOL /*bHighlight*/)
{
  ...
  if (m_Images.GetCount() == 0) {
    ...
    m_Images.SetImageSize(CSize(nImageWidth1, nImageHeight1));
    if (globalData.Is32BitIcons()) {
  ...
  rc.left += nImageWidth1 + nImageMargin;
    ...
    CSize sizeDefault)
{
  ...
  size.cx += nImageWidth1 + nImageMargin;
  return size;
}
