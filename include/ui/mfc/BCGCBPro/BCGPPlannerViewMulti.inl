...
//#define new DEBUG_NEW
#endif
static const int s_HeaderAllDayPadding1 = 2;
//////////////////////////////////////////////////////////////////////
...
void CBCGPPlannerViewMulti::AdjustLayout(CDC* /*pDC*/, const CRect& rectClient)
{
  ...
  const int nRowHeightPadding = m_nRowHeight + s_HeaderAllDayPadding1;
...
void CBCGPPlannerViewMulti::AdjustAppointments()
{
  ...
  const int yOffset = GetViewHourOffset() * m_nRowHeight;
  const int yHeaderOffset = m_nHeaderScrollOffset * (m_nRowHeight + s_HeaderAllDayPadding1);
