...
public:
  ...
  // Attributes
public:
  CBCGPBarContainerManager& GetContainerManager() {
    return m_barContainerManager;
  }
...
public:
  ...
  virtual int GetControlBarCount() const {
    return m_barContainerManager.GetBarCount();
  }
  ...
  void SetLastFocusedBar(HWND hwnd) {
    m_hWndLastFocused = hwnd;
  }
