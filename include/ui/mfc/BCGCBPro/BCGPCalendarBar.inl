...
#define visualManagerInstance   CBCGPCalendarVisualManager::GetInstance ()
#endif
...
void CBCGPCalendar::OnNcPaint()
{
  if (GetStyle() & WS_BORDER) {
    visualManagerInstance->OnDrawControlBorder(this);
  }
}
...
{
  m_Colors.Reset();
  visualManagerInstance->GetCalendarColors(this, m_Colors);
...
#else
  visualManagerInstance->OnDrawCalendarImage(pDC, m_rectBtnPrev, 8);
  visualManagerInstance->OnDrawCalendarImage(pDC, m_rectBtnNext, 9);
#endif
...
LRESULT CBCGPCalendar::OnPrint(WPARAM wp, LPARAM lp)
{
  ...
  if ((dwFlags & PRF_NONCLIENT) == PRF_NONCLIENT && (GetStyle() & WS_BORDER)) {
    ...
    visualManagerInstance->OnDrawControlBorder(pDC, rect, this, FALSE);
  }
  return Default();
}
//****************************************************************************************
