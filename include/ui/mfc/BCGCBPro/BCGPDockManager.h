...
public:
  ...
  DWORD GetEnabledAutoHideAlignment() const {
    return m_dwEnabledSlideBars;
  }
  BOOL IsActivateAutoHideBarOnMouseClick() const {
    return m_bActivateAutoHideBarOnMouseClick;
  }
  ...
  CRect GetClientAreaBounds() const {
    return m_rectClientAreaBounds;
  }
  CRect GetOuterEdgeBounds() const {
    return m_rectOuterEdgeBounds;
  }
  CFrameWnd* GetDockSite() const {
    return m_pParentWnd;
  }
