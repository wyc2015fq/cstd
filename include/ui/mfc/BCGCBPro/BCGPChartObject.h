...
public:
  ...
  CBCGPRect GetCoordinates() const {
    return m_rectCoordinates;
  }
  ...
  CBCGPSize GetObjectSize() const {
    return m_szObjectSize;
  }
  ...
  CBCGPRect GetBoundingRect() const {
    return m_rectScreenBounds;
  }
  CBCGPRect GetShapeRect() const {
    return m_rectScreen;
  }
...
public:
  ...
  void SetDrawConnector(BOOL bDraw = TRUE) {
    m_bDrawConnector = bDraw;
  }
  virtual BOOL IsDrawConnector() const {
    return m_bDrawConnector;
  }
