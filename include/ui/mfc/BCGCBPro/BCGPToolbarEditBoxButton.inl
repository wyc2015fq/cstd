...
static const int iDefaultSize3 = 150;
static const int iHorzMargin3 = 3;
static const int iVertMargin3 = 1;
  ...
  CBCGPToolbarButton(uiId, iImage)
{
  ...
  m_iWidth = (iWidth == 0) ? iDefaultSize3 : iWidth;
  Initialize();
}
//**************************************************************************************
...
void CBCGPToolbarEditBoxButton::OnMove()
{
  ...
  m_pWndEdit->SetWindowPos(NULL,
      m_rect.left + iHorzMargin3,
      m_rect.top + yOffset,
      m_rect.Width() - 2 * iHorzMargin3,
      cy,
...
void CBCGPToolbarEditBoxButton::OnChangeParentWnd(CWnd* pWndParent)
{
  ...
  CRect rect = m_rect;
  rect.DeflateRect(iHorzMargin3, iVertMargin3);
