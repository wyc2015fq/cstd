...
public:
  ...
  const CBCGPDockingControlBar* GetLeftBar() const {
    return m_pBarLeftTop;
  }
  const CBCGPDockingControlBar* GetRightBar() const {
    return m_pBarRightBottom;
  }
  const CBCGPSlider* GetSlider() const {
    return m_pSlider;
  }
  const CBCGPBarContainer* GetLeftContainer() const {
    return m_pLeftContainer;
  }
  const CBCGPBarContainer* GetRightContainer() const {
    return m_pRightContainer;
  }

  DWORD GetRecentSliderStyle() const {
    return m_dwRecentSliderStyle;
  }
  CRect GetRecentSliderRect() const {
    return m_rectRecentSlider;
  }

  CBCGPBarContainer* GetParentContainer() const {
  ...
  void SetSlider(CBCGPSlider* pSlider) {
    m_pSlider = pSlider;
  }
  ...
  void SetParentContainer(CBCGPBarContainer* p) {
  ...
  void SetRecentPercent(int nRecentPercent) {
    m_nRecentPercent = nRecentPercent;
  };
  int GetRecentPercent() {
    return m_nRecentPercent;
  }
