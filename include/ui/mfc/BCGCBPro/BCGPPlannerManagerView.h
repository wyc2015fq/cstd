...
protected:
  ...
  virtual BOOL OnBeginChangeOperation(CBCGPPlannerManagerCtrl::BCGP_PLANNER_CHANGE_OPERATION /*operation*/) {
    return TRUE;
  }
  ...
  virtual BOOL OnIconUpDownClick(BOOL /*bIconUp*/) {
    return FALSE;
  }
  // click on day caption
  // wParam, lParam - not used
  // Return value - return FALSE if default handler is needed
  virtual BOOL OnDayCaptionClick() {
    return FALSE;
  }
  // click on week caption
  // wParam, lParam - not used
  // Return value - return FALSE if default handler is needed
  virtual BOOL OnWeekCaptionClick() {
    return FALSE;
  }
