...
static COLORREF CalculateHourLineColor2(COLORREF clrBase, BOOL /*bWorkingHours*/, BOOL bHour)
{
...
void CBCGPVisualManagerVS2012::GetGanttColors(const CBCGPGanttChart* pChart, BCGP_GANTT_CHART_COLORS& colors, COLORREF clrBack) const
{
  ...
  colors.clrGridLine0 = IsDarkTheme() ? m_clrSeparator : CalculateHourLineColor2(colors.clrRowDayOff, TRUE, TRUE);
  colors.clrGridLine1 = IsDarkTheme() ? m_clrSeparator : CalculateHourLineColor2(colors.clrRowDayOff, TRUE, !bIsDefault);
