...
public:
  ...
  CBCGPChartShape3D* GetShape() const {
    return m_pShape;
  }
...
public:
  ...
  const CBCGPPointsArray& GetVertexes() const {
    return m_arOriginalVertexes;
  }
  const CBCGPPointsArray& GetFinalVertexes() const {
    return m_arFinalVertexes;
  }
  const CBCGPPointsArray& GetRotatedVertexes() const {
    return m_arRotatedVertexes;
  }
  const CBCGPChartSide3DArray& GetSides() const {
    return m_sides;
  }
  ...
  const CBCGPPtArrayArray& GetPreparedSidePoints() const {
    return m_arPreparedSidePoints;
  }
...
public:
  ...
  virtual const CBCGPChartEdge3DList& GetEdges() const {
    return CBCGPChartShape3DRect::m_lst3DRectEdges;
  }
  virtual const CBCGPMatrix& GetVertexIndexes() const {
    return CBCGPChartShape3DRect::m_m3DRectVertexIndexes;
  }
...
public:
  ...
  virtual const CBCGPChartEdge3DList& GetEdges() const {
    return CBCGPChartShape3DCube::m_lst3DCubeEdges;
  }
  virtual const CBCGPMatrix& GetVertexIndexes() const {
    return CBCGPChartShape3DCube::m_m3DCubeVertexIndexes;
  }

  virtual void OnDraw(CBCGPEngine3D* pGM);
  virtual void CopyFrom(const CBCGPChartShape3D& src);

  void SetFillLeftAsTop(BOOL bSet) {
    m_bFillLeftAsTop = bSet;
  }
  BOOL IsFillLeftAsTop() const {
    return m_bFillLeftAsTop;
  }

  void SetFillLeftAsBottom(BOOL bSet) {
    m_bFillLeftAsBottom = bSet;
  }
  BOOL IsFillLeftAsBottom() const {
    return m_bFillLeftAsBottom;
  }
...
public:
  ...
  int GetWallPosition() const {
    return m_nWallPosition;
  }
