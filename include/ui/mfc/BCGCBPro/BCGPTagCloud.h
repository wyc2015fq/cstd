...
public:
  ...
  const CBCGPColor& GetHighlightedColor() const {
    return m_colorHighlightedText;
  }
  void SetHighlightedColor(const CBCGPColor& color) {
    m_colorHighlightedText = color;
  }
...
public:
  ...
  const CBCGPColor& GetHighlightedTextColor() const {
    return m_clrHighlightedText;
  }
...
public:
  ...
  const CList<CBCGPTagCloudElement*, CBCGPTagCloudElement*>& GetTagList() const {
    return m_lstTags;
  }
