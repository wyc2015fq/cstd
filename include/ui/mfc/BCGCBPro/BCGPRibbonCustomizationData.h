...
public:
  ...
  const CArray<CBCGPRibbonCustomCategory*, CBCGPRibbonCustomCategory*>& GetCustomTabs() const {
    return m_arCustomTabs;
  }
  const CMap<DWORD, DWORD, CBCGPRibbonCustomPanel*, CBCGPRibbonCustomPanel*>& GetCustomPanels() const {
    return m_mapCustomPanels;
  }
