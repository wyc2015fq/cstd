...
public:
  ...
  const BCGPChartFormatSeries* GetFormat() const {
    return m_pFormatElement;
  }
  ...
  virtual CBCGPChartShape3D*  GetShape3D() const {
    return m_pShape3D;
  }

  virtual const CString& GetCategoryName() const {
    return m_strCategoryName;
  }
  virtual void SetCategoryName(const CString& strName) {
    m_strCategoryName = strName;
  }
  ...
  virtual BOOL IsUseWordWrapForDatalabels() const {
    return m_bUseWordWrapForDataLabels;
  }

  int GetLegendID() const {
    return m_nLegendID;
  }
...
public:
  ...
  BCGPChartType GetChartType() const {
    return m_chartType;
  }
  BCGPChartCategory GetChartCategory() const {
    return m_chartCategory;
  }

  void SetChartCtrl(CBCGPChartVisualObject* pChartCtrl);
  CBCGPChartVisualObject* GetChartCtrl() const {
    return m_pChart;
  }

  void SetChartImpl(CBCGPBaseChartImpl* pImpl);
  CBCGPBaseChartImpl* GetChartImpl();
  const CBCGPBaseChartImpl* GetChartImpl() const {
    return m_pChartImpl;
  }
  ...
  CBCGPChartSeries::TreatNulls GetTreatNulls() const {
    return m_treatNulls;
  }
  ...
  virtual BOOL IsAutoColorDataPoints() const {
    return m_bAutoColorDataPoints && !m_bHistoryMode;
  }
  ...
  virtual BOOL IsColorEachLineEnabled() const {
    return FALSE;
  }
  ...
  virtual BOOL IsZComponentSet() const {
    return m_bZComponentSet;
  }

  virtual CBCGPSize GetMaxDataLabelSize() const {
    return m_szMaxDataLabelSize;
  }
  virtual void ResetMaxDataLabelSize() {
    m_szMaxDataLabelSize.SetSizeEmpty();
  }
  ...
  BOOL IsRangeSeries() const {
    return (m_chartType == BCGP_CT_RANGE);
  }
  ...
  BOOL IsBackgroundOrder() const {
    return m_bIsBackgroundOrder;
  }
  void SetBackroundOrder(BOOL bIsBackOrder) {
    m_bIsBackgroundOrder = bIsBackOrder;
  }
  ...
  virtual double GetFixedMajorXUnit() const {
    return 1.;
  }
  virtual void UpdateAxes();
  int GetHistoryDepth() {
    return m_nHistoryDepth;
  }

  void SetOffsetFromNullZone(int nOffset) {
    m_nOffsetFromNullZone = nOffset;
  }
  int GetOffsetFromNullZone() const {
    return m_nOffsetFromNullZone;
  }
  ...
  BOOL IsUpdateAxesOnNewDataEnabled() const {
    return m_bUpdateAxesOnNewData;
  }

  virtual void SetIndexMode(BOOL bSet);
  virtual BOOL IsIndexMode() const {
    return m_bIndexMode;
  }
  ...
  virtual BCGPChartDataLabelOptions::LabelContent GetDefaultLegendContent() const {
    return BCGPChartDataLabelOptions::LC_X_VALUE;
  }

  virtual BOOL IsIgnoreNegativeValues() const {
    return FALSE;
  }
  virtual void SetIgnoreNegativeValues(BOOL bIgnore) {
    m_bIgnoreNegativeValues = bIgnore;
  }

  virtual BOOL CanIncludeDataPointToLegend(int nDataPointIndex);

  double GetMinDataPointDistance() const {
    return m_dblMinDataPointDistance;
  }

  virtual CBCGPPoint ScreenPointFromChartData(const CBCGPChartData& data, int nDataPointIndex);

  void SetFullStackedMinMax();
  BOOL IsFullStackedMinMaxSet() const {
    return m_bFullStackedMinMaxSet;
  }
  ...
  virtual BOOL IsOptimizedLongDataMode() const {
    return m_arLongDataY.GetSize() > 0;
  }
  virtual double GetLongDataEmptyValue() const {
    return m_dblEmptyValue;
  }
  void SetLongDataEmptyValue(double dblVal) {
    m_dblEmptyValue = dblVal;
  }
  virtual int GetLongDataOffset() const {
    return m_nLongDataOffset;
  }
  void SetLongDataOffset(int nOffset = 0) {
    m_nLongDataOffset = nOffset;
  }
  ...
  const CBCGPDoubleArray& GetLongDataY() const {
    return m_arLongDataY;
  }
  const CBCGPDoubleArray& GetLongDataX() const {
    return m_arLongDataX;
  }
  const CBCGPDoubleArray& GetLongDataY1() const {
    return m_arLongDataY1;
  }

  virtual BOOL IsFillClosedShape() const {
    return FALSE;
  }
...
protected:
  ...
  virtual BOOL CanUseRangeForMinMax() const {
    return TRUE;
  }
...
public:
  ...
  virtual BOOL IsColorEachLineEnabled() const {
    return m_bColorEachLine;
  }

  virtual BOOL IsConnectFirstLastPoints() const {
    return m_bConnectFirstLastPoints;
  }
  virtual BOOL IsFillClosedShape() const {
    return m_bFillClosedShape;
  }
...
public:
  ...
  BOOL IsCustomSize() const {
    return m_bCustomSize;
  }
  int GetCustomSizePercent() const {
    return m_nCustomSizePercent;
  }
  ...
  BOOL IsCustomOffset() const {
    return m_bCustomOffset;
  }
  int GetCustomOffsetPercent() const {
    return m_nCustomOffsetPercent;
  }
  ...
  int GetSeriesCountOnAxis() const {
    return m_nSeriesCountOnAxis;
  }
  ...
  virtual BCGPChartDataLabelOptions::LabelContent GetDefaultLegendContent() const {
    return BCGPChartDataLabelOptions::LC_CATEGORY_NAME;
  }
...
public:
  ...
  const CBCGPChartValue& GetOrigin() const {
    return m_valOrigin;
  }
...
public:
  ...
  const CBCGPBrush& GetFrameColor() const {
    return m_brFrame;
  }
  ...
  double GetSurfaceOpacity() const {
    return m_dblSurfaceOpacity;
  }

  void EnableFrameTransparency(BOOL bEnable = TRUE);
  BOOL IsFrameTransparencyEnabled() const {
    return m_bEnableFrameTransparency;
  }
  ...
  BOOL IsDrawFlat() const {
    return m_bDrawFlat;
  }
  double GetFlatLevel() const {
    return m_dblFlatLevel;
  }
  ...
  int GetLevelCount() const {
    return (int)m_arFillBrushes.GetSize() - 1;
  }

  virtual void LevelIndexToString(int nLevelIndex, CString& strValues);
  BOOL IsLevelRangeInLegendLabelEnabled() const {
    return m_bLevelRangleInLabel;
  }
  ...
  const CBCGPChartSurfaceTriangleArray& GetSurfaceTriangles() const {
    return m_arSurfaceTriangles;
  }

  int GetLegendElementCount() const;

  void SetContinuousLegendKey(BOOL bSet = TRUE);
  BOOL IsContinuousLegendKey() const {
    return m_bContinuousLegendKey;
  }
...
public:
  ...
  virtual const CBCGPPointsArray& GetScreenPoints() const {
    return m_arScreenPoints;
  }

  BOOL IsFilterSimilarXValues() const {
    return m_bFilterSimilarXValues;
  }
  void SetFilterSimilarXValues(BOOL bSet = TRUE) {
    m_bFilterSimilarXValues = bSet;
  }
...
public:
  ...
  virtual BOOL IsIgnoreNegativeValues() const {
    return m_bIgnoreNegativeValues;
  }
...
public:
  ...
  virtual double GetPieExplosion() const {
    return m_dblPieExplosion;
  }
  ...
  void SetPieRotation(int nAngle = 0) {
    m_nPieRotation = nAngle;
  }
  int  GetPieRotation() const {
    return m_nPieRotation;
  }
  ...
  double GetPieAngle() const {
    return m_dblPieAngle;
  }

  void EnableFitDiagramArea(BOOL bFit = TRUE) {
    m_bFitDiagramArea = bFit;
  }
  BOOL IsFitDiagramAreaEnabled() const {
    return m_bFitDiagramArea;
  }
...
public:
  ...
  int GetDepthPercent() const {
    return m_nDepthPercent;
  }

  void SetRotation(double dblAngle);
  double GetRotation() const {
    return m_dblRotation;
  }

  void SetCircularBase(BOOL bIsCircularBase = FALSE);
  BOOL IsCircularBase() const {
    return m_bIsCircularBase;
  }
...
public:
  ...
  BOOL IsNeckHeightChartValue() const {
    return m_bNeckHeightIsValue;
  }
  double GetNeckHeight() const {
    return m_dblNeckHeight;
  }

  void SetNeckWidth(int nWidth);
  int GetNeckWidth() const {
    return m_nNeckWidth;
  }

  CBCGPSize GetNeckSizeInPixels() const {
    return m_szNeckSize;
  }
...
public:
  BOOL IsMainStockSeries() const {
    return m_bIsMainStockSeries;
  }
  virtual void RecalcMinMaxValues() {
    return;
  }
...
public:
  ...
  CBCGPBaseChartStockSeries::StockSeriesType GetStockSeriesType() const {
    return m_type;
  }
  ...
  int GetChildSeriesCount() const {
    return (int)m_arChildSeries.GetSize();
  }
  virtual void OnCalcScreenPoints(CBCGPGraphicsManager* pGM, const CBCGPRect& rectDiagramArea);
  ...
  BCGPCHART_STOCK_CALLBACK GetCustomStockValueCallback() const {
    return m_pfnCustomValueCallback;
  }
...
public:
  ...
  void SetDisplayComponentPercentInTooltip(BOOL bSet = TRUE) {
    m_bShowPercentsInTooltip = bSet;
  }
  BOOL IsDisplayComponentPercentInTooltip() const {
    return m_bShowPercentsInTooltip;
  }
