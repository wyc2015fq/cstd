...
public:
  ...
  CPoint  GetHotSpot() const {
    return m_dragFrameImpl.m_ptHot;
  }
  CPoint  GetClientHotSpot() const {
    return m_ptClientHotSpot;
  }
  void  SetClientHotSpot(const CPoint& ptNew) {
    m_ptClientHotSpot = ptNew;
  }
  ...
  CBCGPDockBarRow* GetDockBarRow() const {
    return m_pDockBarRow;
  }
  void       SetDockBarRow(CBCGPDockBarRow* pRow) {
    m_pDockBarRow = pRow;
  }
...
protected:
  ...
  virtual BOOL OnAfterShowControlBarMenu(int nMenuResult)  {
    return TRUE;
  }
