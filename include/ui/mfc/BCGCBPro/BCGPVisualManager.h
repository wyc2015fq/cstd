...
public:
  ...
  virtual BOOL IsFlatTheme() const {
    return TRUE;
  }
  ...
  virtual BOOL IsStatusBarCoversFrame() {
    return FALSE;
  }
  ...
  virtual BOOL AreCustomToolbarCtrlColors() {
    return FALSE;
  }
  ...
  virtual double GetGrayScaleLumRatio() {
    return m_dblGrayScaleLumRatio;
  }
  ...
  virtual int GetMessageBarMargin()       {
    return 4;
  }
  virtual BOOL IsDrawMessageBoxButtonsBanner()  {
    return TRUE;
  }

  // Outlook bar:
  virtual int GetOutlookBarSplitterHeight() {
    return 8;
  }
  ...
  virtual BOOL IsDockingTabUpperCase()    {
    return FALSE;
  }
  virtual BOOL IsFocusedTabSeparateLook()   {
    return FALSE;
  }
  virtual BOOL IsTopLevelMenuItemUpperCase()  {
    return FALSE;
  }
  ...
  virtual BOOL IsExpandingBoxTransparent() {
    return m_bIsTransparentExpandingBox;
  }
  ...
  virtual int GetAutohideButtonExtraSpace() {
    return 0;
  }
  ...
  virtual BOOL DoesRibbonExtendCaptionToTabsArea()  {
    return FALSE;
  }

  virtual BOOL IsRibbonTabsAreaDark()         {
    return FALSE;
  }
  ...
  virtual int GetRibbonButtonsGroupHorzMargin()   {
    return 0;
  }
  virtual BOOL IsDrawRibbonGroupSeparator()     {
    return FALSE;
  }
  virtual void OnDrawRibbonGroupSeparator(CDC* /*pDC*/, CRect /*rectSeparator*/) {}

  virtual int GetRibbonBackstageTopLineHeight()   {
    return 1;
  }
  virtual void OnDrawRibbonBackstageTopLine(CDC* pDC, CRect rectLine);

  virtual BOOL IsRibbonBackstageHideTabs()      {
    return FALSE;
  }
  virtual COLORREF GetRibbonBackstageTextColor();
  virtual BOOL IsRibbonBackstageWhiteBackground()   {
    return TRUE;
  }
  ...
  COLORREF GetMainButtonColor() const {
    return m_clrMainButton;
  }
  ...
  virtual BOOL IsDrawFocusRectOnPushButton(CBCGPButton* /*pButton*/)  {
    return TRUE;
  }
