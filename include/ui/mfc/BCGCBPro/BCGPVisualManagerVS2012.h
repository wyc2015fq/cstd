...
public:
  ...
  static COLORREF GetFrameColor() {
    return m_clrFrame;
  }
  static COLORREF GetFrameTextColor(BOOL bActive) {
    return bActive ? m_clrFrameTextActive : m_clrFrameTextInactive;
  }
