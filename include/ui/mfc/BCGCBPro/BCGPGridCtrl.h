...
public:
  ...
  virtual BOOL OnCreate(int /* nRow */, int /* nColumn */) {
    return TRUE;
  }
...
public:
  ...
  virtual CBCGPGridFilter* CreateFilter() {
    return new CBCGPGridFilter;
  }
...
public:
  ...
  PrintParams& GetPrintParams()  {
    return m_PrintParams;
  }
  CDC* GetPrintDC()  {
    return m_pPrintDC;
  };
...
public:
  ...
  void SetItemRTC(int nColumn, CRuntimeClass* pRuntimeClass);
  void SetDefaultItemRTC(CRuntimeClass* pRTC) {
    m_pDefaultItemRTC = pRTC;
  }
  CRuntimeClass* GetItemRTC(int nColumn) const;
  CRuntimeClass* GetDefaultItemRTC() const {
    return m_pDefaultItemRTC;
  }
  ...
  virtual int GetHierarchyOffset() const {
    return GetColumnsInfo().GetGroupColumnCount() * GetHierarchyLevelOffset();
  }
