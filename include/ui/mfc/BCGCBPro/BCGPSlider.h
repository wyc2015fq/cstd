...
public:
  BOOL    IsHorizontal() const {
    return m_dwSliderStyle & SS_HORZ;
  }
  int     GetWidth() const  {
    return m_nWidth;
  }
...
public:
  ...
  void SetContainerManager(CBCGPBarContainerManager* p) {
...
protected:
  void SetDefaultMode(BOOL bMode) {
    m_bDefaultSlider = bMode;
  }
