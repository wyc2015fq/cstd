...
static COLORREF CalculateHourLineColor1(COLORREF clrBase, BOOL bWorkingHours, BOOL bHour)
{
  double H, S, V;
...
static COLORREF CalculateWorkingColor1(COLORREF /*clrBase*/)
{
...
{
  if (bLight) {
    return CalculateHourLineColor1(clrBase, TRUE, FALSE);
  }
  return CalculateHourLineColor1(clrBase, FALSE, TRUE);
}
...
void CBCGPVisualManager2007::GetGanttColors(const CBCGPGanttChart* pChart, BCGP_GANTT_CHART_COLORS& colors, COLORREF clrBack) const
{
  ...
  colors.clrRowBackground = CalculateWorkingColor1(clrBack);
  ...
  if (bIsDefault) {
    ...
    colors.clrGridLine1 = CalculateHourLineColor1(clrBack, TRUE, TRUE);
  }
    ...
    BOOL bWorkingHours, BOOL bHour)
{
  ...
  ASSERT_VALID(pView);
  return CalculateHourLineColor1(GetPlannerViewBackgroundColor(pView), bWorkingHours, bHour);
}
//*******************************************************************************
COLORREF CBCGPVisualManager2007::GetPlannerViewWorkingColor(CBCGPPlannerView* pView)
{
  ...
  ASSERT_VALID(pView);
  return CalculateWorkingColor1(GetPlannerViewBackgroundColor(pView));
}
//*******************************************************************************
