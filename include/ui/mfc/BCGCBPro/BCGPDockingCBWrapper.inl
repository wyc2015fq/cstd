...
#endif
static const CString DockingCBWrapper_strControlBarProfile = _T("BCGControlBars");
...
{
  CString strProfileName = ::BCGPGetRegPath(DockingCBWrapper_strControlBarProfile, lpszProfileName);
  if (nIndex == -1) {
    nIndex = GetDlgCtrlID();
  }
  CString strSection;
