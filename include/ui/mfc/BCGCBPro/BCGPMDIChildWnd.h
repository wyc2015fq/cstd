...
public:
  // ---- MDITabGroup+
  CBCGPTabWnd*    GetRelatedTabGroup() {
    return m_pRelatedTabGroup;
  }
  void        SetRelatedTabGroup(CBCGPTabWnd* p)  {
    m_pRelatedTabGroup = p;
  }
  // ---- MDITabGroup-
...
protected:
  ...
  CBCGPMDITabProxyWnd* GetTabProxyWnd() {
    return &m_tabProxyWnd;
  }
