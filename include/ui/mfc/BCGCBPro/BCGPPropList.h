...
public:
  ...
  const CString& GetStateToolTip() const {
    return m_strStateToolTip;
  }
  TCHAR GetStateIndicator() const {
    return m_cStateIndicator;
  }
  COLORREF GetStateColor() const {
    return m_clrState;
  }
  BOOL IsDrawStateColorBorder() const {
    return m_bDrawStateBorder;
  }
