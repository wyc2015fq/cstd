...
const UINT DropDownList_idStart = (UINT) - 200;
/////////////////////////////////////////////////////////////////////////////
// CBCGPDropDownList
...
void CBCGPDropDownList::AddString(LPCTSTR lpszItem)
{
  ...
  const UINT uiID = DropDownList_idStart - GetCount();
    ...
    BOOL bHighlight)
{
  ...
  if (m_pRibbonCombo != NULL) {
    ...
    int nIndex = (int) DropDownList_idStart - pItem->m_nID;
...
#ifndef BCGP_EXCLUDE_RIBBON
  int nIndex = (int) DropDownList_idStart - uiCommandID;
  if (m_pRibbonCombo != NULL) {
    ASSERT_VALID(m_pRibbonCombo);
