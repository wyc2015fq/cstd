...
#undef REG_PARAMS_FMT
#undef REG_ENTRY_NAME
#undef REG_ENTRY_BUTTONS
#undef REG_ENTRY_ORIG_ITEMS
#undef REG_ENTRY_TOOLTIPS
#undef REG_ENTRY_KEYS
#undef REG_ENTRY_LARGE_ICONS
#undef REG_ENTRY_ANIMATION
#undef REG_ENTRY_RU_MENUS
#undef REG_ENTRY_MENU_SHADOWS
#undef REG_ENTRY_SHOW_ALL_MENUS_DELAY
#undef REG_ENTRY_CMD_USAGE_COUNT
#undef REG_ENTRY_LOOK2000
#undef REG_ENTRY_RESET_ITEMS
...
static const CString strToolbarProfile1 = _T("BCGToolBars");
#ifdef AFX_INIT_SEG
...
{
  CString strProfileName = ::BCGPGetRegPath(strToolbarProfile1, lpszProfileName);
  BOOL bResult = FALSE;
  if (nIndex == -1) {
    nIndex = GetDlgCtrlID();
  }
