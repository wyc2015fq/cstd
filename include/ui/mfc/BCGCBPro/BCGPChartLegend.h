...
public:
  ...
  void SetPosition(const CBCGPPoint& pt) {
    m_rectBounds.SetRect(pt, m_szScrollButtonSize);
  }
...
public:
  ...
  LegendCellType  GetCellType() const {
    return m_cellType;
  }
  ...
  virtual const CBCGPSize& GetSize() const {
    return m_szCellSize;
  }

  virtual void UpdateCellParams();

  CBCGPChartLegendEntry* GetParentLegendEntry() const {
    return m_pParentEntry;
  }
  CBCGPChartLegendVisualObject* GetParentLegend() const;
  CBCGPChartVisualObject* GetRelatedChrt() const {
    return m_pChart;
  }
  CBCGPChartSeries* GetRelatedSeries() const {
    return m_pSeries;
  }
  int GetRelatedDataPointIndex() const {
    return m_nDataPointIndex;
  }

  void SetCustomData(CObject* pObject = NULL) {
    m_pCustomData = pObject;
  }
  CObject* GetCustomData() const {
    return m_pCustomData;
  }
  CBCGPRect GetHitRect() const {
    return m_rectHit;
  }

  const BCGPChartCellParams& GetCellParams() const {
    return m_cellParams;
  }
  ...
  const CString& GetCellText() const {
    return m_strLabel;
  }
...
public:
  ...
  int GetCellCount() const {
    return (int)m_lstLegendCells.GetCount();
  }
...
public:
  ...
  const CBCGPRect& GetLegendBounds() const {
    return m_rectLegendBounds;
  }
  const CBCGPSize& GetTitleSize() const {
    return m_szTitleSize;
  }
  ...
  int  GetLegendEntryCount() const {
    return (int)m_lstLegendEntries.GetCount();
  }
  ...
  CRuntimeClass* GetLegendCellRTC() const {
    return m_pLegendCellRTC;
  }
  ...
  int GetRelatedChartCount() const {
    return (int)m_lstRelatedCharts.GetCount();
  }
  ...
  int GetColumnCount() const {
    return (int)m_arColumnWidths.GetSize();
  }
  ...
  LegendAlignment GetVerticalAlignment() const {
    return m_vertAlignment;
  }
  LegendAlignment GetHorizontalAlignment() const {
  ...
  BOOL IsLegendTitleVisible() const {
    return m_legendStyle.m_bShowTitle;
  }
  const CString& GetLegendTitle() const {
    return m_strLegendTitle;
  }
  void SetAdjustLegendSizeByTitleSize(BOOL bSet = TRUE, BOOL bRedraw = TRUE);
  BOOL IsAdjustLegendSizeByTitleSize() const {
    return m_legendStyle.m_bAdjustLegendSizeByTitleSize;
  }
  //--- End Title

  void ShowChartNameInLegend(BOOL bShow = TRUE, BOOL bRedraw = TRUE);
  BOOL IsChartNameInLegendVisible() const {
    return m_legendStyle.m_bShowChartName;
  }
  ...
  void SetScrollStep(double dblStep) {
    m_dblScrollStep = dblStep;
  }
  double GetScrollStep() const {
