...
public:
  ...
  // Functions:
public:
  CBCGPOutlineBaseNode* GetValue()       {
    return this;
  }
  CObList*        GetNodes()       {
    return &m_lstNodes;
  }
  CBCGPOutlineNode*   GetParentNode() const  {
...
public:
  ...
  // Undo/Redo
  // ---------
  void EnableUndoCharMode(BOOL bEnable = TRUE) {
    m_bUndoCharMode = bEnable;
  }
  ...
  // Graphical symbols support
  // -------------------------
  CImageList* GetSymImgList() const {
    return m_pSymbolsImgList;
  }
  ...
  // Hyperlink Support
  //------------------
  void EnableHyperlinkSupport(BOOL bEnabled = TRUE) {
    m_bEnableHyperlinkSupport = bEnabled;
  }
  BOOL IsHyperlinksSupportEnabled() const {
    return m_bEnableHyperlinkSupport;
  }
...
public:
  ...
  //---------------------
  virtual BOOL FillIntelliSenseList(CObList& lstIntelliSenseData, LPCTSTR lpszIntelliSense) const  {
    return FALSE;
  }
  ...
  //---------------
  virtual BOOL OnBeforeTextInserted(CString& strInsertedText, int nOffset) {
    return TRUE;
  }
  virtual BOOL OnBeforeTextDeleted(int nOffset, const CString& strDeletedText) {
    return TRUE;
  }
  ...
  // Undo/Redo
  //----------
  virtual void SetOverrideMode(BOOL bSet = FALSE) {
    m_bOvrMode = bSet;
  }
  virtual BOOL GetOverrideMode() const {
    return m_bOvrMode;
  }
  //----------
  // Undo/Redo
  ...
  virtual BOOL OnBeforeUndoRedo(BCGP_EDIT_UNDO_ACTION* /*pUndoAction*/) {
    return TRUE;
  }
  virtual void OnAfterUndoRedo(BCGP_EDIT_UNDO_ACTION* /*pUndoAction*/) {}

  virtual BOOL OnBeforeAddUndoAction(BCGP_EDIT_UNDO_ACTION* pUndoAction) {
    return TRUE;
  }
  ...
  virtual void SetLastUndoReason(DWORD dwUndoReason) {
    m_dwLastUndoReason = dwUndoReason;
  }
  virtual DWORD GetLastUndoReason() const {
    return m_dwLastUndoReason;
  }
  ...
  virtual BOOL OnBeforeInvokeIntelliSense(const CString& strBuffer, int& nCurrOffset, CString& strIntelliSense) const {
    return TRUE;
  }
  ...
  virtual BOOL OnUpdateMarkerLine(int nNewLine) {
    return TRUE;
  }
  virtual BOOL OnRemoveMarker(CBCGPEditMarker* pMarker, POSITION posMarker) {
    return TRUE;
  }
  ...
  virtual BOOL OnGetHyperlinkString(int nStartOffset, CString& strURL) {
    return TRUE;
  }
  virtual BOOL OnGetHyperlinkToolTip(int nStartOffset, CString& strToolTip) {
    return TRUE;
  }
