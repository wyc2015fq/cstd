...
static const CString g_strEOL1 = _T("\r\n");
...
/////////////////////////////////////////////////////////////////////////////
// Find/Replace dialog
static UINT WM_FINDREPLACE1 = ::RegisterWindowMessage(FINDMSGSTRING);
...
BEGIN_MESSAGE_MAP(CBCGPGridCtrl, CWnd)
  ...
  ON_REGISTERED_MESSAGE(WM_FINDREPLACE1, OnFindReplace)
