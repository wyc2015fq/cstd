...
public:
  ...
  BCGP_PREDOCK_STATE GetPreDockState() {
    return m_preDockStateCurr;
  }
  ...
  virtual int GetControlBarCount() const {
    return (CWnd::FromHandlePermanent(m_hEmbeddedBar) != NULL) ? 1 : 0;
  }
  ...
  CRect GetRecentFloatingRect() const {
    return m_rectRecentFloatingRect;
  }
