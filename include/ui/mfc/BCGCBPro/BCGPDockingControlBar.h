...
public:
  ...
  void SetLastPercentInContainer(int n) {
    m_nLastPercent = n;
  }
  int  GetLastPercentInContainer() const {
    return m_nLastPercent;
  }
  void GetRecentSiblingBarInfo(CList<UINT, UINT&>& lstBarIDs);

  CRect GetAHRestoredRect() const {
    return m_rectRestored;
  }
  ...
  CBCGPAutoHideToolBar* GetAutoHideToolBar() const {
    return m_pAutoHideBar;
  }
  CBCGPAutoHideButton* GetAutoHideButton() {
    return m_pAutoHideButton;
  }
