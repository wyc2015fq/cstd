...
// Overrides
	...
	virtual BOOL Create(LPCTSTR lpszCaption, CWnd* pParentWnd, const IRECT& rect, UINT nID, DWORD dwStyle, DWORD dwBCGStyle = CBRS_BCGP_RESIZE, CCreateContext* pContext = NULL);
	//}}AFX_VIRTUAL
