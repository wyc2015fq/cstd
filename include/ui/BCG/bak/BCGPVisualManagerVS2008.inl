...
#define WINXPBLUE_MENUITEM_BORDER	_RGB(152, 181, 226)
								...
								BOOL bNCArea)
{
	...
	if (!pMenuBar->m_bDisableSideBarInXPMode)
	{
		...
		pDC->MoveTo (rectImages.r, rectImages.t);
		pDC->LineTo (rectImages.r, rectImages.b);
											...
											CRect rect, COLORREF& clrText)
{
	...
	pDC->RoundRect (rect.l, rect.t, rect.r, rect.b, nRoundSize + 2, nRoundSize + 2);
										 ...
										 const CBCGPBaseTabWnd* pTabWnd)
{
	...
	if (pMainFrame->GetSafeHwnd() != NULL)
	{
		...
		rect.t = rectMain.t;
		rect.l = rectMain.l;
		rect.r = rect.l + globalData.m_rectVirtual.Width() + 10;
	}
...
void CBCGPVisualManagerVS2008::OnDrawAutoHideButtonBorder (CDC* pDC, CRect rect, CRect rectBorderSize, CBCGPAutoHideButton* pButton)
{
	...
	case CBRS_ALIGN_BOTTOM:
		(*m_pfDrawThemeBackground) (m_hThemeTab, pDC, TABP_TABITEM, nState, &rect, 0);
