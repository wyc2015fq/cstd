...
// Overrides
	...
	CList<UINT>* GetAssociatedSiblingBarIDs (CBCGPDockingControlBar* pBar);
...
protected:
	...
	CList<UINT> m_lstSavedSiblingBarIDsLeft;
	CList<UINT> m_lstSavedSiblingBarIDsRight;
...
protected:
	...
	CBCGPDockingControlBar* LoadTabbedBar (CArchive& ar, CList<UINT>& lstBarIDs);
...
{
	CList<CBCGPBarContainer*> m_lstDisposedContainers;
public:
