...
public:
	...
	CList<HWND>		m_lstRecentListOfBars; // need to remember a list of siblings bar
...
public:
	...
	void SaveListOfRecentBars (CList<HWND>& lstOrg, BOOL bForSlider);
	CList<HWND>& GetRecentListOfBars (BOOL bForSlider);
