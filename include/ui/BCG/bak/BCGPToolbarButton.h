...
public:
	...
	//-----------------------------------------------------------------
	static void SetProtectedCommands (const CList<UINT>& lstCmds);
	static const CList<UINT>& GetProtectedCommands()	{	return m_lstProtectedCommands;	}
...
// Overrides:
	...
	{
		return !IsBCGPStandardCommand (m_nID) && (m_lstProtectedCommands.Find (m_nID) == NULL);
	}
...
protected:
	...
	static CList<UINT>	m_lstProtectedCommands;
