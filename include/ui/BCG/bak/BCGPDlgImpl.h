...
protected:
	...
	BOOL ProcessMouseClick (IPOINT pt);
	BOOL ProcessMouseMove (IPOINT pt);
	...
	void EnableVisualManagerStyle (BOOL bEnable, BOOL bNCArea = FALSE, const CList<UINT>* plstNonSubclassedItems = NULL);
	...
	CArray<CWnd*>	m_arSubclassedCtrls;
