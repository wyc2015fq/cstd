...
void CBCGPColorButton::OnDraw (CDC* pDC, const CRect& rect, UINT uiState)
{
	...
	rectColor.r -= sizeArrow.w + nImageHorzMargin;

	CRect rectArrow = rect;
	rectArrow.l = rectColor.r;
	...
	if (color == (COLORREF) -1)	// Automatic
	{
		...
		if (!m_strAutoColorText.IsEmpty())
		{
			...
			CRect rectText = rect;
			rectText.l = rectColor.r;
			rectText.r = rectArrow.l;
...
void CBCGPColorButton::OnShowColorPopup() 
{
	...
	if (!m_pPopup->Create (this, rectWindow.l, rectWindow.b, NULL,
