...
// Overrides
	...
	public:
	virtual BOOL Create(DWORD dwStyle, const IRECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext = NULL);
	virtual BOOL CreateEx(DWORD dwStyleEx, DWORD dwStyle, const IRECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext);
	//}}AFX_VIRTUAL
