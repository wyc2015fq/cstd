...
void CBCGPRibbonKeyTip::OnPaint(CDC* pDC) 
{
...
BOOL CBCGPRibbonKeyTip::Show (BOOL bRepos)
{
	...
	{
		SetWindowPos (NULL, rect.l, rect.t, -1, -1, SWP_NOZORDER | SWP_NOACTIVATE | SWP_NOSIZE);
	}
