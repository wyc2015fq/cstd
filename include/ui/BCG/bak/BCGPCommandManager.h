...
protected:
	CMap<UINT, int>	m_CommandIndex;
	CMap<UINT, int>	m_CommandIndexUser;
	CMap<UINT, int>	m_DefaultImages;

	// List of menu items where image appearance is disabled:
	CList<UINT>			m_lstCommandsWithoutImages;

	// List of menu items with user images:
	CMap<UINT,int>		m_mapMenuUserImages;
};
