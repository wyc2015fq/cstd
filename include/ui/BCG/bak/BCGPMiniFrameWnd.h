...
// Overrides
	...
	public:
	virtual BOOL Create(LPCTSTR lpszWindowName, DWORD dwStyle, const IRECT& rect, CWnd* pParentWnd, CCreateContext* pContext = NULL);
	virtual BOOL CreateEx(DWORD dwStyleEx, LPCTSTR lpszWindowName, DWORD dwStyle, const IRECT& rect, CWnd* pParentWnd, CCreateContext* pContext = NULL);
...
protected:
	...
	afx_msg void OnMoving(UINT fwSide, IRECT* pRect);
	afx_msg void OnNcCalcSize(BOOL bCalcValidRects, NCCALCSIZE_PARAMS FAR* lpncsp);
	afx_msg void OnNcPaint();
	afx_msg BOOL OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message);
	afx_msg void OnSizing(UINT fwSide, IRECT* pRect);
...
protected:
	...
	static CMap<UINT,HWND>	m_mapFloatingBars;
	static CList<HWND>			CBCGPMiniFrameWnd::m_lstFrames;
