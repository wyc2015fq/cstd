...
public:
	...
	typedef CArray<CBitmapCacheItem*> XCache;
	typedef CArray<CSize> XSizes;
...
public:
	...
	{
		return !m_brDlgBackground.IsValid() ?
...
protected:
	...
	virtual void DrawNcCaption (CDC* pDC, CRect rectCaption, 
						   ...
						   CBitmap* hIcon, BOOL bPrefix, BOOL bActive, BOOL bTextCenter,
