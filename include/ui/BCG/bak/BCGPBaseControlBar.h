...
// Overrides
	...
	public:
	virtual BOOL CreateEx(DWORD dwStyleEx, LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const IRECT& rect, CWnd* pParentWnd, UINT nID, DWORD dwBCGStyle = 0, CCreateContext* pContext = NULL);
...
public:
	...
	{
		CSize size;
		size.w = (bStretch && bHorz ? 32767 : 0);
		size.h = (bStretch && !bHorz ? 32767 : 0);
		return size;
	}
