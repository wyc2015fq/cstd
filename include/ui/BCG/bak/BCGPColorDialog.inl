...
BOOL CBCGPColorDialog::OnInitDialog()
{
	...
	{
		m_pPropSheet->EnableVisualManagerStyle();
	...
	m_pPropSheet->SetWindowPos(NULL, rectListWnd.l, rectListWnd.t, rectListWnd.Width(),
				rectListWnd.Height(), SWP_NOZORDER | SWP_NOACTIVATE);

	SetPageOne (GetRV (m_CurrentColor), 
				GetGV (m_CurrentColor),
				GetBV (m_CurrentColor));

	SetPageTwo (GetRV (m_CurrentColor),
				GetGV (m_CurrentColor),
				GetBV (m_CurrentColor));
...
void CBCGPColorDialog::OnLButtonDown(UINT nFlags, CPoint point) 
{
	...
	SetPageOne (GetRV (m_NewColor), 
				GetGV (m_NewColor),
				GetBV (m_NewColor));

	SetPageTwo (GetRV (m_NewColor),
				GetGV (m_NewColor),
				GetBV (m_NewColor));
