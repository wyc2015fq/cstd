...
public:
	...
	BOOL AddButton (CBitmap* hBmp, LPCTSTR lpszLabel, UINT iIdCommand, int iInsertAt = -1);
	BOOL AddButton (CBitmap* hIcon, LPCTSTR lpszLabel, UINT iIdCommand, int iInsertAt = -1, BOOL bAlphaBlend = FALSE);
...
protected:
	...
	int	 AddBitmapImage (CBitmap* hBitmap);
