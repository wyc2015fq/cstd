...
//****
BOOL CBCGPGanttControl::Create (DWORD dwStyle, const IRECT& rect, CWnd* pParentWnd, UINT nID)
{
...
void CBCGPGanttControl::DoVerticalResize (CWnd* pSender)
{
	...
	if (m_nState == eStateProcessingChartNotification) // Chart -> Grid
	{
		...
		m_pGrid->SetVerticalSizes (rectChart.t - rectClient.t, m_pChart->GetDefaultItemHeight());
	}
...
//****
void CBCGPGanttControl::OnPaint(CDC* pDC)
{
	CPaintDC dc (this);
}
//****
