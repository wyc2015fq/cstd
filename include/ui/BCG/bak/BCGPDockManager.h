...
protected:
	...
	CList<BCGP_AUTOHIDEBAR_SAVE_INFO> 
	...
	CList<HWND>				m_lstBarsHiddenOnDeactivate;

	// maintains a list of control bars hidden during in-place activation
	CList<HWND>				m_lstBarsHiddenForOLE;

	// maintains a list of control bars hidden during in-place activation
	CList<HWND>				m_lstHiddenMDITabbedBars;
	...
	CMap<UINT,CBCGPControlBar*>	m_mapControlBarsInMenu;
...
protected:
	...
	void AlignContainer (CRect& rectCurrBounds, int& posNextBar, DWORD dwAlignment, 
						 BOOL bHorizontal);
