...
// Construction
protected:
	CBCGPRibbonPanel(LPCTSTR lpszName = NULL, CBitmap* hIcon = NULL, BOOL bAutoDestroyIcon = TRUE);
	CBCGPRibbonPanel(CBCGPRibbonPaletteButton* pPaletteButton);

	virtual void CopyFrom (CBCGPRibbonPanel& src);

	void CommonInit (LPCTSTR lpszName = NULL, CBitmap* hIcon = NULL, BOOL bAutoDestroyIcon = TRUE);
