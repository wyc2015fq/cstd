...
protected:
	...
	CMap<CBitmap*,CBitmap*,int,int>	m_mapIcons;	// Icons already loaded into the image list
...
public:
	...
	void CalcWindowRectForMDITabbedGroups	(IRECT* lpClientRect, UINT nAdjustType);
