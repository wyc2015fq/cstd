...
// Overrides
	...
	public:
	virtual BOOL Create(DWORD dwStyle, const IRECT& rect, CWnd* pParentWnd, DWORD dwBCGStyle, CCreateContext* pContext = NULL);
	virtual BOOL CreateEx(DWORD dwStyleEx, DWORD dwStyle, const IRECT& rect, CWnd* pParentWnd, DWORD dwBCGStyle, CCreateContext* pContext = NULL);
	protected:
	virtual void CalcWindowRect(IRECT* lpClientRect, UINT nAdjustType = adjustBorder);
	//}}AFX_VIRTUAL
