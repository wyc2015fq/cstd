...
public: 
	...
	void GetItemRect(int nIndex, IRECT* lpRect) const;
	...
	void SetPaneIcon (int nIndex, CBitmap* hIcon, BOOL bUpdate = TRUE, BOOL bAlphaBlend = FALSE);
	void SetPaneIcon (int nIndex, CBitmap* hBmp, 
