...
CBCGPPrintPreviewView::CBCGPPrintPreviewView()
{
	...
	m_nSimpleType = 0;
	m_nCurrentPage = 1;
	m_recentToolbarSize.w = m_recentToolbarSize.h = -1;
}
//****
CBCGPPrintPreviewView::~CBCGPPrintPreviewView()
{
...
void CBCGPPrintPreviewView::SetToolbarSize()
{
	...
	szSize.w = rectParent.Width();

	CRect rectToolBar;
	m_wndToolBar.GetWindowRect (rectToolBar);
	pParent->ScreenToClient (rectToolBar);

	m_pToolBar->SetWindowPos (NULL, rectToolBar.l, rectToolBar.t, szSize.w, szSize.h, 
				SWP_NOACTIVATE|SWP_SHOWWINDOW|SWP_NOZORDER);

	m_wndToolBar.SetWindowPos (NULL, 0, 0, szSize.w, szSize.h, 
				SWP_NOACTIVATE|SWP_SHOWWINDOW|SWP_NOZORDER);

	//----------------------------------------------------
	// Adjust parent toolbar (actually - dialog bar) size:
	//----------------------------------------------------
	m_pToolBar->m_sizeDefault.h = szSize.h;
