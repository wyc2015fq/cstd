			...
			BOOL bDrawBorder, BOOL bGrayDisabledButtons)
{
	...
	if (m_bDrawDownArrow)
	{
		if (bHorz)
		{
			rectParent.r -= sizeImage.w + SEPARATOR_SIZE;
			rectArrow.l = rectParent.r - 1;
			rectArrow.OffsetRect (-sizeExtra.w / 2, -sizeExtra.h / 2);
		}
		else
		{
			rectParent.b -= sizeImage.h + SEPARATOR_SIZE;
			rectArrow.t = rectParent.b - 1;
		}
	}
