...
public:
	...
	BOOL Create(LPCTSTR lpszCaption, CWnd* pParentWnd, const IRECT& rect, 
									UINT nImagesSmall,
									UINT nImagesLarge,
...
// Operations
public:
	CBCGPRibbonPanel* AddPanel (LPCTSTR lpszPanelName, CBitmap* hIcon = 0, int nRows = 3, CRuntimeClass* pRTI = NULL, BOOL bAutoDestroyIcon = TRUE);
