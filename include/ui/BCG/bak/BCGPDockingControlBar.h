...
public:
	...
	public:
	virtual BOOL Create(LPCTSTR lpszCaption, CWnd* pParentWnd, const IRECT& rect, BOOL bHasGripper, UINT nID, DWORD dwStyle, DWORD dwTabbedStyle = CBRS_BCGP_REGULAR_TABS, DWORD dwBCGStyle = dwDefaultBCGDockingBarStyle, CCreateContext* pContext = NULL);
	virtual BOOL CreateEx(DWORD dwStyleEx, LPCTSTR lpszCaption, CWnd* pParentWnd, const IRECT& rect, BOOL bHasGripper, UINT nID, DWORD dwStyle, DWORD dwTabbedStyle = CBRS_BCGP_REGULAR_TABS, DWORD dwBCGStyle = dwDefaultBCGDockingBarStyle, CCreateContext* pContext = NULL);
...
public:	
	...
	virtual BOOL CanAcceptBar (const CBCGPBaseControlBar* pBar) const
	{
		...
		return (pBar->m_bCanAcceptBar && (IsDocked() || IsFloatingMulti())) ;
	}
	...
	void GetRecentSiblingBarInfo (CList<UINT>& lstBarIDs);
...
protected:
	...
	CList<CBCGPCaptionButton*>	m_arrButtons;
