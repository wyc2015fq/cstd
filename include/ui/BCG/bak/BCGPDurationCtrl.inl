...
void CBCGPDurationCtrl::AdjustControl (CRect rectClient, BOOL bRedraw/* = TRUE)*/)
{
	...
	for (int i = 0; i < PARTS_NUM; i ++)
	{
		...
		m_rectParts [i] = CRect (x, rectClient.t,
								x + size.w, rectClient.t + m_iControlHeight);
	...
	m_iControlWidth = m_rectParts [nRightPart].r + 2;
	...
	if (m_spinButton)
	{
		...
		m_wndSpin.SetWindowPos (NULL, 
				rectClient.l + m_iControlWidth - iSpinWidth - 2, 
				rectClient.t,
