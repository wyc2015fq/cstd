...
// Overrides
	...
	public:
	virtual BOOL Create(LPCTSTR lpszClassName, DWORD dwStyle, const IRECT& rect, CWnd* pParentWnd, UINT nID, DWORD dwBCGStyle = dwDefaultCBStyle, CCreateContext* pContext = NULL);
	virtual BOOL CreateEx(DWORD dwStyleEx, LPCTSTR lpszClassName, DWORD dwStyle, const IRECT& rect, CWnd* pParentWnd, UINT nID, DWORD dwBCGStyle = dwDefaultCBStyle, CCreateContext* pContext = NULL);
	//}}AFX_VIRTUAL
...
public:
	...
	void SetRecentTabWindowInfo (DWORD dwFrameAlignment, 
								 const CList<UINT>& lstSiblingBars);
