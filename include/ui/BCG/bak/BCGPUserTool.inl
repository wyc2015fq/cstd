...
void CBCGPUserTool::DrawToolIcon (CDC* pDC, const CRect& rectImage)
{
	...
	::DrawIconEx (pDC,
		rectImage.l + x, rectImage.t + y, m_hIcon,
...
//****
CBitmap* CBCGPUserTool::SetToolIcon()
{
...
//****
CBitmap* CBCGPUserTool::LoadDefaultIcon()
{
	if (globalData.m_hiconTool == NULL)
	{
		CBCGPLocalResource locaRes;

		globalData.m_hiconTool = (CBitmap*) ::LoadImage (
			AfxGetResourceHandle(),
			MAKEINTRESOURCE (IDI_BCGRES_TOOL),
			IMAGE_ICON,
			globalData.m_sizeSmallIcon.w,
