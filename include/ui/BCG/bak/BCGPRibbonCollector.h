...
public:
	enum XFlags
	{
		e_CollectUpdatedToolInfo = 0x01,
		e_CollectRibbonBarIcons  = 0x02,
		e_CollectStatusBarIcons  = 0x04,
		e_CollectGroupImages     = 0x08
	};
...
protected:
	...
	virtual void CollectBaseElement (const CBCGPBaseRibbonElement& element, CBCGPRibbonInfo::XElement& info);
