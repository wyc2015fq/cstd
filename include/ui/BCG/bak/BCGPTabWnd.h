...
public:
	// Create methods:
	BOOL Create (Style style, const IRECT& rect, CWnd* pParentWnd, UINT nID,
	...
	static CBitmap* GetDocumentIcon (UINT nCmdID);
...
protected:
	...
	static CMap<UINT,UINT,CBitmap*,CBitmap*>	m_mapDocIcons;
