								 ...
								 BOOL bIsHighlighted)
{
	...
	if ((hdItem.fmt & (HDF_BITMAP | HDF_BITMAP_ON_RIGHT)) && hdItem.hbm != NULL)
	{
		...
		{
			rectBitmap.r--;
			rect.r = rectBitmap.l = rectBitmap.r - bmp.bmWidth;
		}
		else
		{
			rectBitmap.l++;
			rect.l = rectBitmap.r = rectBitmap.l + bmp.bmWidth;
		}
		
		rectBitmap.t += max (0, (rectBitmap.Height() - bmp.bmHeight) / 2);
		rectBitmap.b = rectBitmap.t + bmp.bmHeight;
...
//****
void CBCGPHeaderCtrl::OnPaint(CDC* pDC) 
{
