...
public:
  ...
  inline CPoint  TopLeft()      {
    return CPoint(top, left);
  }
  inline CPoint  BottomRight()    {
    return CPoint(bottom, right);
  }

  inline CPoint  CenterPoint()  {
  ...
  inline void  OffsetRect(POINT point)      {
    ::OffsetRect(this, point.x, point.y);
  }
  inline void  OffsetRect(SIZE size)        {
    ::OffsetRect(this, size.cx, size.cy);
  }
  inline BOOL  IntersectRect(LPCRECT lpRect1, LPCRECT lpRect2)  {
    return ::IntersectRect(this, lpRect1, lpRect2);
  }
  inline BOOL  UnionRect(LPCRECT lpRect1, LPCRECT lpRect2)    {
  ...
  inline CRect  operator+(POINT pt)   {
    CRect rect(*this);
  ...
  inline CRect  operator+(SIZE size)  {
    CRect rect(*this);
...
public:
  ...
  HBRUSH GetSafeHandle() {
    return GetBrush(); //compatibilidad con MFC
  }
