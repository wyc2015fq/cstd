...
class the_application : public agg::platform_support
{
    ...
    agg::slider_ctrl<_rgba8> m_offset;
    agg::cbox_ctrl<_rgba8>   m_white_on_black;
...
public:
        ...
        m_white_on_black(10, 10+60, "White on black")
    {
        ...
        m_white_on_black.text_color(_rgba8(127, 127, 127));
        m_white_on_black.inactive_color(_rgba8(127, 127, 127));
    }
    ...
    virtual void on_draw()
    {
        ...
        rb.clear(m_white_on_black.status() ? _rgba(0,0,0) : _rgba(1,1,1));
        ...
        p.width(1.0);
        ras.add_path(p);
        ren.color(m_white_on_black.status() ? _rgba(1,1,1) : _rgba(0,0,0));
        agg::render_scanlines(ras, sl, ren);
