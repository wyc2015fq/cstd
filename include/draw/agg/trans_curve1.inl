...
public:
    ...
    agg::slider_ctrl<_rgba8> m_num_points;
    agg::cbox_ctrl<_rgba8>   m_close;
    agg::cbox_ctrl<_rgba8>   m_preserve_x_scale;
    agg::cbox_ctrl<_rgba8>   m_fixed_len;
    agg::cbox_ctrl<_rgba8>   m_animate;
    double                       m_dx[6];
    double                       m_dy[6];
    bool                         m_prev_animate;
    ...
    virtual void on_draw()
    {
        ...
        r.color(_rgba8(170, 50, 20, 100));
        ras.add_path(stroke);
        agg::render_scanlines(ras, sl, r);

        //--------------------------
        // Render the "poly" tool and controls
        r.color(_rgba(0, 0.3, 0.5, 0.3));
        ras.add_path(m_poly);
        agg::render_scanlines(ras, sl, r);
