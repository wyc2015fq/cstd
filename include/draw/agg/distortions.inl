...
{
    agg::slider_ctrl<_rgba8> m_angle;
    agg::slider_ctrl<_rgba8> m_scale;
    agg::slider_ctrl<_rgba8> m_amplitude;
    agg::slider_ctrl<_rgba8> m_period;
    agg::rbox_ctrl<_rgba8>   m_distortion;

    double m_center_x;
    double m_center_y;
    double m_phase;

    typedef agg::pod_auto_array<_rgba8, 256> color_array_type;
...
public:
        ...
        m_phase(0.0)
    {
        ...
        for(i = 0; i < 256; i++)
        {
            m_gradient_colors[i] = _rgba8(p[0], p[1], p[2], p[3]);
            p += 4;
        }
    }
    ...
    virtual void on_draw()
    {
        ...
        typedef agg::span_allocator<_rgba8> span_alloc_type;
        ...
        img_source_type img_src(img_pixf, _rgba(1,1,1));
...
*/
        ...
        typedef agg::span_image_filter_rgb_bilinear_clip<pixfmt,
                                                         interpolator_type> span_gen_type;
        span_gen_type sg(img_pixf, _rgba(1,1,1), interpolator);
        //------------------------------------------
...
*/
        ...
        ras.add_path(tr);
        agg::render_scanlines_aa_solid(ras, sl, rb, _rgba8(0,0,0));

        typedef agg::span_gradient<_rgba8, 
                                   interpolator_type,
                                   agg::gradient_circle,
