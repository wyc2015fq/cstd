...
class the_application : public agg::platform_support
{
    ...
    agg::slider_ctrl<_rgba> m_image_angle;
    agg::slider_ctrl<_rgba> m_image_scale;

    agg::cbox_ctrl<_rgba> m_rotate_polygon;
    agg::cbox_ctrl<_rgba> m_rotate_image;

    agg::rbox_ctrl<_rgba> m_example;
...
// --------------(Example 6)
        ...
        agg::span_allocator<_rgba8> sa;

        // "hardcoded" bilinear filter
        //------------------------------------------
        typedef agg::span_image_filter_rgba_bilinear_clip<pixfmt, 
                                                          interpolator_type> span_gen_type;
        span_gen_type sg(pixf_img, _rgba(1,1,1), interpolator);
        //------------------------------------------
