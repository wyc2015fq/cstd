...
public:
    ...
    virtual void on_draw()
    {
        ...
        img_source_type img_src(img_pixf, _rgba_pre(0, 0.4, 0, 0.5));
...
*/
        ...
        typedef agg::span_image_filter_rgb_bilinear_clip<pixfmt,
                                                         interpolator_type> span_gen_type;
        span_gen_type sg(img_pixf, _rgba_pre(0, 0.4, 0, 0.5), interpolator);
        //------------------------------------------
...
//{
//    // Fully transparent
//    rb.copy_hline(0, i, app.rbuf_img(0).width(), _rgba(0, 0, 0, 0));  
//    if(i + 1 < app.rbuf_img(0).height())
//    {
//        // Fully opaque white
//        rb.copy_hline(0, i + 1, app.rbuf_img(0).width(), _rgba(1, 1, 1, 1));  
//    }
//}
