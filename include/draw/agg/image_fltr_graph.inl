...
{
    agg::slider_ctrl<_rgba>  m_radius;
    agg::cbox_ctrl<_rgba>  m_bilinear;
    agg::cbox_ctrl<_rgba>  m_bicubic;
    agg::cbox_ctrl<_rgba>  m_spline16;
    agg::cbox_ctrl<_rgba>  m_spline36;
    agg::cbox_ctrl<_rgba>  m_hanning;
    agg::cbox_ctrl<_rgba>  m_hamming;
    agg::cbox_ctrl<_rgba>  m_hermite;
    agg::cbox_ctrl<_rgba>  m_kaiser;
    agg::cbox_ctrl<_rgba>  m_quadric;
    agg::cbox_ctrl<_rgba>  m_catrom;
    agg::cbox_ctrl<_rgba>  m_gaussian;
    agg::cbox_ctrl<_rgba>  m_bessel;
    agg::cbox_ctrl<_rgba>  m_mitchell;
    agg::cbox_ctrl<_rgba>  m_sinc;
    agg::cbox_ctrl<_rgba>  m_lanczos;
    agg::cbox_ctrl<_rgba>  m_blackman;
    agg::cbox_ctrl<_rgba>* m_filters[32];
...
public:
    ...
    virtual void on_draw()
    {
        ...
        for(i = 0; i <= 16; i++)
        {
            ...
            ras.add_path(tr);
            rs.color(_rgba8(0, 0, 0, i == 8 ? 255 : 100));
