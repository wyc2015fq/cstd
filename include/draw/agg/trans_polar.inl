...
{
    agg::slider_ctrl<_rgba8> m_slider1;
    agg::slider_ctrl<_rgba8> m_slider_spiral;
    agg::slider_ctrl<_rgba8> m_slider_base_y;
...
public:
    ...
    virtual void on_draw()
    {
        ...
        typedef agg::conv_segmentator<agg::slider_ctrl<_rgba8> > conv_segmentator_type;
        ...
        agg::transformed_control<_rgba8, 
                                 agg::slider_ctrl<_rgba8>, 
