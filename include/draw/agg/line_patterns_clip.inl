...
{
    _rgba8 m_ctrl_color;
    agg::polygon_ctrl<_rgba8> m_line1;
...
public:
    ...
    virtual void on_draw()
    {
        ...
        ren_base.clear(_rgba(0.5, 0.75, 0.85));
        ...
        ren_line.color(_rgba8(0,0,127));            //mandatory!
        ...
        //------------------------
        ren_base.blend_bar(0, 0, (int)width(), (int)height(), _rgba(1,1,1), 200);
        ...
        //------------------------
        ren_base.copy_bar(0, 0, (int)width(), (int)height(), _rgba(1,1,1));
