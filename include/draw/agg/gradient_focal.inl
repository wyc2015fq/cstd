...
class the_application : public agg::platform_support
{
    ...
    typedef agg::gradient_lut<agg::color_interpolator<_rgba8>, 1024> color_func_type;
...
public:
    ...
    void build_gradient_lut()
    {
        ...
        m_gradient_lut.add_color(0.0, _rgba8_gamma_dir(_rgba8(0, 255, 0),   m_gamma_lut));
        m_gradient_lut.add_color(0.2, _rgba8_gamma_dir(_rgba8(120, 0, 0),   m_gamma_lut));
        m_gradient_lut.add_color(0.7, _rgba8_gamma_dir(_rgba8(120, 120, 0), m_gamma_lut));
        m_gradient_lut.add_color(1.0, _rgba8_gamma_dir(_rgba8(0, 0, 255),   m_gamma_lut));

        //m_gradient_lut.add_color(0.0, _rgba8::from_wavelength(380, m_gamma.value()));
        //m_gradient_lut.add_color(0.1, _rgba8::from_wavelength(420, m_gamma.value()));
        //m_gradient_lut.add_color(0.2, _rgba8::from_wavelength(460, m_gamma.value()));
        //m_gradient_lut.add_color(0.3, _rgba8::from_wavelength(500, m_gamma.value()));
        //m_gradient_lut.add_color(0.4, _rgba8::from_wavelength(540, m_gamma.value()));
        //m_gradient_lut.add_color(0.5, _rgba8::from_wavelength(580, m_gamma.value()));
        //m_gradient_lut.add_color(0.6, _rgba8::from_wavelength(620, m_gamma.value()));
        //m_gradient_lut.add_color(0.7, _rgba8::from_wavelength(660, m_gamma.value()));
        //m_gradient_lut.add_color(0.8, _rgba8::from_wavelength(700, m_gamma.value()));
        //m_gradient_lut.add_color(0.9, _rgba8::from_wavelength(740, m_gamma.value()));
        //m_gradient_lut.add_color(1.0, _rgba8::from_wavelength(780, m_gamma.value()));
    ...
    virtual void on_draw()
    {
        ...
        agg::render_scanlines_aa_solid(m_rasterizer, m_scanline, rb, _rgba(1,1,1));
        ...
        agg::render_scanlines_aa_solid(m_rasterizer, m_scanline, rb, _rgba(0,0,0));
