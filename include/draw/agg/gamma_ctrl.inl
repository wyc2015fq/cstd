...
agg::gamma_ctrl<_rgba8> g_ctrl(10.0, 10.0, 300.0, 200.0, !flip_y);
...
public:
    ...
    virtual void on_draw()
    {
        ...
        color = _rgba(0.0, 0.5, 0.0);
        ras.add_path(text1, 0);
        agg::render_scanlines_aa_solid(ras, sl, rb, color);


        color = _rgba(0.5, 0.0, 0.0);
