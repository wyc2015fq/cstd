...
public:
    ...
    _rgba8 pixel(int x, int y) const
    {
        _rgba8 c = m_pf.pixel(x, y);
...
{
    _rgba8 m_ctrl_color;
    agg::bezier_ctrl<_rgba8> m_curve1;
    agg::bezier_ctrl<_rgba8> m_curve2;
    agg::bezier_ctrl<_rgba8> m_curve3;
    agg::bezier_ctrl<_rgba8> m_curve4;
    agg::bezier_ctrl<_rgba8> m_curve5;
    agg::bezier_ctrl<_rgba8> m_curve6;
    agg::bezier_ctrl<_rgba8> m_curve7;
    agg::bezier_ctrl<_rgba8> m_curve8;
    agg::bezier_ctrl<_rgba8> m_curve9;
    agg::slider_ctrl<_rgba8> m_scale_x;
    agg::slider_ctrl<_rgba8> m_start_x;
...
public:
    ...
    the_application(agg::pix_format_e format, bool flip_y) :
        ...
        m_ctrl_color(_rgba(0, 0.3, 0.5, 0.3)),
    ...
    virtual void on_draw()
    {
        ...
        ren_base.clear(_rgba(1.0, 1.0, 0.95));
