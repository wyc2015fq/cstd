...
class the_application : public agg::platform_support
{
    ...
    agg::slider_ctrl<_rgba> m_dilation;
    agg::slider_ctrl<_rgba> m_gamma;
    agg::slider_ctrl<_rgba> m_alpha;
...
public:
    ...
    void render_gouraud(Scanline& sl, Ras& ras)
    {
        ...
        // Single triangle
        //span_gen.colors(_rgba(1,   0,   0,  alpha),
        //                _rgba(0,   1,   0,  alpha),
        //                _rgba(0,   0,   1,  alpha));
        ...
        span_gen.colors(_rgba(1,   0,   0,    alpha),
                        _rgba(0,   1,   0,    alpha),
                        _rgba(brc, brc, brc,  alpha));
        span_gen.triangle(m_x[0], m_y[0], m_x[1], m_y[1], xc, yc, d);
        ras.add_path(span_gen);
        agg::render_scanlines_aa(ras, sl, ren_base, span_alloc, span_gen);


        span_gen.colors(_rgba(0,   1,   0,    alpha),
                        _rgba(0,   0,   1,    alpha),
                        _rgba(brc, brc, brc,  alpha));
        ...
        span_gen.colors(_rgba(0,   0,   1,   alpha),
                        _rgba(1,   0,   0,   alpha),
                        _rgba(brc, brc, brc, alpha));
