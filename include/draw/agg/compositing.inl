            ...
            double shadow_alpha)
{
    ...
    agg::render_scanlines_aa_solid(ras, sl, rbase, 
                                   _rgba(0.6, 0.6, 0.6, 0.7*shadow_alpha));
...
class the_application : public agg::platform_support
{
    ...
    agg::rbox_ctrl<_rgba8> m_comp_op;
...
public:
    ...
    void render_scene(rbuf_type& rbuf, prim_pixfmt_type& pixf)
    {
        ...
        circle(rb, 
               _rgba8(0xFD, 0xF0, 0x6F, unsigned(m_alpha_dst.value() * 255)), 
               _rgba8(0xFE, 0x9F, 0x34, unsigned(m_alpha_dst.value() * 255)),
        ...
        else
        {
            ...
            src_shape(renderer, 
                      _rgba8(0x7F, 0xC1, 0xFF, unsigned(m_alpha_src.value() * 255)), 
                      _rgba8(0x05, 0x00, 0x5F, unsigned(m_alpha_src.value() * 255)),
                      300+50, 100+24*3, 107+50, 100+79*3);
/*
            src_shape(renderer, 
                      _rgba8(0xFF, 0xFF, 0xFF, unsigned(m_alpha_src.value() * 255)), 
                      _rgba8(0xFF, 0xFF, 0xFF, unsigned(m_alpha_src.value() * 255)),
                      300+50, 100+24*3, 107+50, 100+79*3);
*/
        }
    ...
    virtual void on_draw()
    {
        ...
        for(y = 0; y < rb.height(); y += 8)
        {
            ...
            {
                rb.copy_bar(x, y, x+7, y+7, _rgba8(0xdf, 0xdf, 0xdf));
            }
        }
        ...
        rb2.clear(_rgba8(0,0,0,0));
        //rb2.clear(_rgba8(255,255,255,255));
