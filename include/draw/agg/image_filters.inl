...
class the_application : public agg::platform_support
{
    ...
    agg::slider_ctrl<_rgba> m_step;
    agg::rbox_ctrl<_rgba>   m_filters;
    agg::cbox_ctrl<_rgba>   m_normalize;
    agg::cbox_ctrl<_rgba>   m_run;
    agg::cbox_ctrl<_rgba>   m_single_step;
    agg::cbox_ctrl<_rgba>   m_refresh;
...
public:
        ...
        m_time2(0)
    {
        ...
        m_filters.background_color(_rgba(0.0, 0.0, 0.0, 0.1));
    ...
    virtual void on_draw()
    {
        ...
        ras.add_path(pt);
        agg::render_scanlines_aa_solid(ras, sl, rb, _rgba(0,0,0));
    ...
    void transform_image(double angle)
    {
        ...
        source_type source(pixf_img, _rgba_pre(0,0,0,0));
        ...
        case 1:
            {
                ...
                span_gen_type sg(pixf_img, _rgba_pre(0,0,0,0), interpolator);
                ras.add_path(tr);
                agg::render_scanlines_aa(ras, sl, rb_pre, sa, sg);
            }
            break;
