...
public:
    ...
    agg::rbox_ctrl<_rgba8>   m_trans_type;
    agg::cbox_ctrl<_rgba8>   m_reset;
    agg::slider_ctrl<_rgba8> m_mul1;
    agg::slider_ctrl<_rgba8> m_mul2;
    ...
    virtual void on_draw()
    {
        ...
        r.color(_rgba8(240, 255, 200, 100));
        ras1.add_path(ps1);
        agg::render_scanlines(ras1, sl, r);

        r.color(_rgba8(255, 240, 240, 100));
        ras2.add_path(ps2);
