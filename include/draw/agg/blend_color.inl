...
public:
        ...
        m_shape(m_path)
    {
        ...
        for(i = 0; i < 256; i++)
        {
            m_color_lut[i] = _rgba8(p[0], p[1], p[2], (i > 63) ? 255 : i * 4);//p[3]);
    ...
    virtual void on_draw()
    {
        ...
        if(bbox.clip(agg::rect_d(0, 0, width(), height())))
        {
            ...
            {
                // Blur it
                agg::stack_blur_gray8(pixf2, agg::uround(m_radius.value()), agg::uround(m_radius.value()));
            }
