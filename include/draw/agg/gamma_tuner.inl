...
class the_application : public agg::platform_support
{
    ...
    agg::slider_ctrl<_rgba8> m_r;
    agg::slider_ctrl<_rgba8> m_g;
    agg::slider_ctrl<_rgba8> m_b;
    agg::rbox_ctrl  <_rgba8> m_pattern;
...
public:
    ...
    virtual void on_draw()
    {
        ...
        color_type color(_rgba(m_r.value(), m_g.value(), m_b.value()));
        ...
        // Clear the area
        //---------------------
        renb.copy_bar(50, 80, 50+square_size-1, 80+square_size-1, _rgba(0,0,0));
        ...
        for(i = 0; i < square_size; i += 2)
        {
            ...
            color_type c = color.gradient(_rgba(0,0,0), k);
