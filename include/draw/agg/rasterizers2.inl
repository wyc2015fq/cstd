...
{
    agg::slider_ctrl<_rgba8> m_step;
    agg::slider_ctrl<_rgba8> m_width;
    agg::cbox_ctrl<_rgba8>   m_test;
    agg::cbox_ctrl<_rgba8>   m_rotate;
    agg::cbox_ctrl<_rgba8>   m_accurate_joins;
    agg::cbox_ctrl<_rgba8>   m_scale_pattern;
    double m_start_angle;
...
public:
    ...
    void draw_aliased_pix_accuracy(rasterizer_outline& ras, renderer_prim& prim)
    {
        ...
        prim.line_color(_rgba(0.4, 0.3, 0.1));
        ras.add_path(trans);
    }
...
ren.color(_rgba8(0,0,0));          //mandatory!
