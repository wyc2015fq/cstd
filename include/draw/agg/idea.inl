...
class the_application : public agg::platform_support
{
    ...
    agg::cbox_ctrl<_rgba8> m_even_odd;
    agg::cbox_ctrl<_rgba8> m_draft;
    agg::cbox_ctrl<_rgba8> m_roundoff;
    agg::slider_ctrl<_rgba8> m_angle_delta;
    bool m_redraw_flag;
...
public:
    ...
    virtual void on_draw()
    {
        ...
        if(m_redraw_flag)
        {
            ...
            rbase.clear(_rgba8(255,255,255));
