...
public:
    ...
    typedef agg::glyph_raster_bin<_rgba8> glyph_gen;
    ...
    virtual void on_draw()
    {
        ...
        typedef agg::span_gradient<_rgba8, 
                                   ...
                                   agg::gradient_linear_color<_rgba8> > span_gen_type;
        ...
        grad_func.periods(5);
        agg::gradient_linear_color<_rgba8> color_func;
        color_func.colors(_rgba(1.0,0,0), _rgba(0,0.5,0));
