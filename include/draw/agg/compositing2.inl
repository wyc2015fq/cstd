...
public:
    ...
    virtual void on_draw()
    {
        ...
        generate_color_ramp(m_ramp1, 
                            _rgba(0, 0, 0, m_alpha_dst.value()),
                            _rgba(0, 0, 1, m_alpha_dst.value()),
                            _rgba(0, 1, 0, m_alpha_dst.value()),
                            _rgba(1, 0, 0, 0));

        generate_color_ramp(m_ramp2, 
                            _rgba(0, 0, 0, m_alpha_src.value()),
                            _rgba(0, 0, 1, m_alpha_src.value()),
                            _rgba(0, 1, 0, m_alpha_src.value()),
                            _rgba(1, 0, 0, 0));
