...
{
    agg::rbox_ctrl<_rgba>   m_type;
    agg::slider_ctrl<_rgba> m_width;
    agg::cbox_ctrl<_rgba>   m_benchmark;
    agg::cbox_ctrl<_rgba>   m_draw_nodes;
    agg::cbox_ctrl<_rgba>   m_draw_edges;
    agg::cbox_ctrl<_rgba>   m_draft;
    agg::cbox_ctrl<_rgba>   m_translucent;
    graph                       m_graph;
...
public:
                          ...
                          Source& src)
    {
        ...
        switch(m_draw)
        {
            ...
            case 3:
            {
                ...
                {
                    ren_fine.color(_rgba8(r, g, b, a));
                    agg::render_scanlines(ras, m_sl, ren_fine);
                }
                else
                {
                    ren_draft.color(_rgba8(r, g, b, a));
    ...
    void draw_lines_draft()
    {
        ...
        for(i = 0; i < m_graph.get_num_edges(); i++)
        {
            ...
            int a = 255;
            if(m_translucent.status()) a = 80;
            prim.line_color(_rgba8(r, g, b, a));
            ras.add_path(s);
        }
    }
