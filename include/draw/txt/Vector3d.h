www.pudn.com _ Quaternion.rar _ Vector3d.h_ change_2004-08-11_size_4885b
...
public : 
  ...
  // Binary operators 
  //友元函数的定义可以放在程序中的任意位置，表示对类的私有成员的访问 
  ...
  int Equals(const CVector3d& v, double tolerence) const;//类外部定义的常成员函数，需要在定义和声明两个地方都标识const 
