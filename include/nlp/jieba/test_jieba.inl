...
#else
const char* const DICT_PATH = "../dict/jieba.dict.txt";
const char* const HMM_PATH = "../dict/hmm_model.txt";
const char* const USER_DICT_PATH = "../dict/user.dict.txt";
const char* const IDF_PATH = "../dict/idf.txt";
const char* const STOP_WORD_PATH = "../dict/stop_words.txt";
#endif

#include "cstd.h"

int test_jieba(int argc, char** argv) {
	sys_chdir("E:/code/c/AI/自然语言处理/分词/jieba/cppjieba-master/test");
