...
def add_shader_neg(img):
    img3 = img.copy()
    if 1:
        img3 = rotate(img3, randint(-20, 20))
        img3 = rand_crop(img3, 0.3, 0.6)
...
rootpath = "E:/OCR_Line/adaboost_front/"
...
if 0:
    ...
    for i in range(100):
        ...
        cv.imwrite(rootpath+"pos/%05d.bmp" % i, img5)
    #plt.show()
...
if 0:
    ...
    for j in range(len(li)):
        ...
        for i in range(50):
            ...
            cv.imwrite(rootpath+"pos/%02d_%05d.bmp" % (j, i), img5)
    #plt.show()
...
if 1:
    ...
    for j in range(len(li)):
        ...
        for i in range(200):
            ...
            img5 = (img4*255).astype(np.uint8);
            img5 = cv.equalizeHist(img5)
            cv.imwrite(rootpath+"neg1/%02d_%05d.bmp" % (j, i), img5)
    #plt.show()
...
if 0:
    ...
    for i in range(len(flist)):
        ...
        if img.shape(0)>10:
            ...
            cv.imwrite(rootpath+"neg/%05d.bmp" % i, img4)
