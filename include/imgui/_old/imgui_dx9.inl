...
void ImGui_ImplDX9_RenderDrawLists1(ImDrawData* draw_data)
{
...
bool ImGui_ImplDX9_Init(void* hwnd, IDirect3DDevice9* device)
{
  ...
  io->RenderDrawListsFn = ImGui_ImplDX9_RenderDrawLists; // Alternatively you can set this to NULL and call ImGui_GetDrawData() after ImGui_Render() to get the same ImDrawData pointer.
...
void ImGui_ImplDX9_InvalidateDeviceObjects()
{
  ...
  if (LPDIRECT3DTEXTURE9 tex = (LPDIRECT3DTEXTURE9)ImGui_GetIO()->Fonts->TexID) {
    tex->Release();
...
WNDCLASSEX g_wc = {0};
int imgui_dx9_init(const char* lpWindowName, int x, int y, int nWidth, int nHeight)
{
  // Create application window
  WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, LoadCursor(NULL, IDC_ARROW), NULL, NULL, _T("ImGui Example"), NULL };
  RegisterClassEx(&wc);
  HWND hwnd = CreateWindowA(_T("ImGui Example"), lpWindowName, WS_OVERLAPPEDWINDOW, x, y, nWidth, nHeight, NULL, NULL, wc.hInstance, NULL);
  // Initialize Direct3D
