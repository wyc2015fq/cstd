...
class DummyDataLayerTest : public CPUDeviceTest {
 protected:
  DummyDataLayerTest()
      : blob_top_a_(new Blob()),
        blob_top_b_(new Blob()),
        blob_top_c_(new Blob()) {}
  ...
  Blob* const blob_top_a_;
  Blob* const blob_top_b_;
  Blob* const blob_top_c_;
