...
static void conv3x3s1_neon(const img_t* bottom_blob, img_t* top_blob, const float* _kernel, const float* _bias)
{
    int w = bottom_blob->w;
    int h = bottom_blob->h;
    int inch = pBox_channels(bottom_blob);
        ...
        for (int q=0; q<inch; q++)
        {
            ...
            for (; i < outh; i++)
            {
                ...
                for (; nn>1; nn-=2)
                {
                    float32x4_t _sum1 = vld1q_f32(outptr);
                    float32x4_t _sum2 = vdupq_n_f32(0.f);
                    float32x4_t _sum3 = vld1q_f32(outptr+4);
                    float32x4_t _sum4 = vdupq_n_f32(0.f);

                    float32x4_t _r00 = vld1q_f32(r0);
                    float32x4_t _r04 = vld1q_f32(r0 + 4);
                    float32x4_t _r08 = vld1q_f32(r0 + 8);
                    float32x4_t _r01 = vextq_f32(_r00, _r04, 1);
                    float32x4_t _r02 = vextq_f32(_r00, _r04, 2);
                    float32x4_t _r03 = vextq_f32(_r00, _r04, 3);
                    float32x4_t _r05 = vextq_f32(_r04, _r08, 1);

                    float32x4_t _r10 = vld1q_f32(r1);
                    float32x4_t _r14 = vld1q_f32(r1 + 4);
                    float32x4_t _r18 = vld1q_f32(r1 + 8);
                    float32x4_t _r11 = vextq_f32(_r10, _r14, 1);
                    float32x4_t _r12 = vextq_f32(_r10, _r14, 2);
                    float32x4_t _r13 = vextq_f32(_r10, _r14, 3);
                    float32x4_t _r15 = vextq_f32(_r14, _r18, 1);

                    float32x4_t _r20 = vld1q_f32(r2);
                    float32x4_t _r24 = vld1q_f32(r2 + 4);
                    float32x4_t _r28 = vld1q_f32(r2 + 8);
                    float32x4_t _r21 = vextq_f32(_r20, _r24, 1);
                    float32x4_t _r22 = vextq_f32(_r20, _r24, 2);
                    float32x4_t _r23 = vextq_f32(_r20, _r24, 3);
                    float32x4_t _r25 = vextq_f32(_r24, _r28, 1);

                    _sum1 = vfmaq_laneq_f32(_sum1, _r00, _k0123, 0);
                    _sum2 = vfmaq_laneq_f32(_sum2, _r01, _k0123, 1);
                    _sum3 = vfmaq_laneq_f32(_sum3, _r03, _k0123, 0);
                    _sum4 = vfmaq_laneq_f32(_sum4, _r04, _k0123, 1);

                    _sum1 = vfmaq_laneq_f32(_sum1, _r02, _k0123, 2);
                    _sum2 = vfmaq_laneq_f32(_sum2, _r10, _k3456, 0);
                    _sum3 = vfmaq_laneq_f32(_sum3, _r05, _k0123, 2);
                    _sum4 = vfmaq_laneq_f32(_sum4, _r13, _k3456, 0);

                    _sum1 = vfmaq_laneq_f32(_sum1, _r11, _k3456, 1);
                    _sum2 = vfmaq_laneq_f32(_sum2, _r12, _k3456, 2);
                    _sum3 = vfmaq_laneq_f32(_sum3, _r14, _k3456, 1);
                    _sum4 = vfmaq_laneq_f32(_sum4, _r15, _k3456, 2);

                    _sum1 = vfmaq_laneq_f32(_sum1, _r20, _k6789, 0);
                    _sum2 = vfmaq_laneq_f32(_sum2, _r21, _k6789, 1);
                    _sum3 = vfmaq_laneq_f32(_sum3, _r23, _k6789, 0);
                    _sum4 = vfmaq_laneq_f32(_sum4, _r24, _k6789, 1);

                    _sum1 = vfmaq_laneq_f32(_sum1, _r22, _k6789, 2);
                    _sum3 = vfmaq_laneq_f32(_sum3, _r25, _k6789, 2);

                    _sum1 = vaddq_f32(_sum1, _sum2);
                    _sum3 = vaddq_f32(_sum3, _sum4);

                    vst1q_f32(outptr, _sum1);
                    vst1q_f32(outptr+4, _sum3);
...
static void conv3x3s1_winograd64_transform_kernel_neon(const float* kernel, img_t* kernel_tm, int inch, int outch)
{
    pBoxsetsize(kernel_tm, inch, 8*8, outch);
    ...
    for (int p = 0; p<outch; p++)
    {
        for (int q = 0; q<inch; q++)
        {
            ...
            float* kernel_tm0 = pBox_row(kernel_tm, p, q);
...
static void conv3x3s1_winograd64_neon(const img_t* bottom_blob, img_t* top_blob, const float* kernel, const float* _bias)
{
    IM_BEGIN(im, 4);
    img_t* kernel_tm = im++;
    int i, j, p, q, m;
    ...
    w = outw + 2;
    h = outh + 2;
    bottom_blob_bordered = copy_make_border(bottom_blob, im++, 0, h - bottom_blob->h, 0, w - bottom_blob->w, 0, 0.f);

    const float* bias = _bias;

    // BEGIN transform input
    img_t* bottom_blob_tm = im++;
    {
        int w_tm = outw / 6 * 8;
        int h_tm = outh / 6 * 8;
        pBoxsetsize(bottom_blob_tm, w_tm/8 * h_tm/8, 8*8, inch);
...
//         };
        ...
        for (q = 0; q<inch; q++)
        {
            const img_t img0 = pBox_channel(bottom_blob_bordered, q);
            img_t img0_tm = pBox_channel(bottom_blob_tm, q);
            ...
            for (i=0; i<h_tm/8; i++)
            {
                for (j=0; j<w_tm/8; j++)
                {
                    const float* r0 = pBox_row0(&img0, i * 6) + j * 6;
                    float* r0_tm = pBox_row0(&img0_tm, i * w_tm/8 + j);
    ...
    // BEGIN dot
    img_t* top_blob_tm = im++;
    {
        int w_tm = outw / 6 * 8;
        int h_tm = outh / 6 * 8;
        pBoxsetsize(top_blob_tm, w_tm/8 * h_tm/8, 8*8, outch);

        #pragma omp parallel for
        for (int p = 0; p<outch; p++)
        {
            img_t out0_tm = pBox_channel(top_blob_tm, p);
            const img_t kernel0_tm = pBox_channel(kernel_tm, p);

            pBox_fill(&out0_tm, 0.f);

            int q = 0;
            for (; q+3<inch; q+=4)
            {
                const float* r0 = pBox_channel_p(bottom_blob_tm, q);
                const float* r1 = pBox_channel_p(bottom_blob_tm, q+1);
                const float* r2 = pBox_channel_p(bottom_blob_tm, q+2);
                const float* r3 = pBox_channel_p(bottom_blob_tm, q+3);

                const float* k0 = pBox_row0(&kernel0_tm, q);
                const float* k1 = pBox_row0(&kernel0_tm, q+1);
                const float* k2 = pBox_row0(&kernel0_tm, q+2);
                const float* k3 = pBox_row0(&kernel0_tm, q+3);

                float* output0_tm = pBox_datap(&out0_tm);
    ...
    img_t* top_blob_bordered = bottom_blob_tm;
    pBoxsetsize(top_blob_bordered, outh, outw, outch);
    {
//         const float otm[6][8] = {
...
//         };
        ...
        for (int p = 0; p<outch; p++)
        {
            const img_t out0_tm = pBox_channel(top_blob_tm, p);
            img_t out0 = pBox_channel(top_blob_bordered, p);
            ...
            for (int i=0; i<outh/6; i++)
            {
                ...
                {
                    const float* output0_tm = pBox_row0(&out0_tm, i * w_tm/8 + j);
                    float* output0 = pBox_row0(&out0, i * 6) + j * 6;
...
static void conv3x3s2_neon(const img_t* bottom_blob, img_t* top_blob, const float* _kernel, const float* _bias)
{
    int w = bottom_blob->w;
    int h = bottom_blob->h;
    int inch = pBox_channels(bottom_blob);
