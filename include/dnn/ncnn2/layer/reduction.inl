...
static int reduction_op(const img_t* a, img_t* b, float v0, int dim, float coeff)
{
  Op op;
  Op2 op2;
...
int Reduction::forward(const img_t* bottom_blob, img_t* top_blob) const
{
