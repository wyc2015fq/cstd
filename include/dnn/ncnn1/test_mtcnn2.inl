...
struct mtcnn {
    struct Net Pnet[1], Rnet[1], Onet[1];
    img_t img[1];
...
void mtcnn_init(struct mtcnn* s) {
    net_load_param_from_file(s->Pnet, "det1.param", "det1.bin");
    net_load_param_from_file(s->Rnet, "det2.param", "det2.bin");
    net_load_param_from_file(s->Onet, "det3.param", "det3.bin");
}
