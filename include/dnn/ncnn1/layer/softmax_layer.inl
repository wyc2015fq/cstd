...
static int SoftmaxLayer(enum LayerOp op, const struct Layer* layer, struct Net* net) {
  ...
  int channels = pBox_channels(bottom_blob->data);
  int inner_num_ = pBox_pixnum(bottom_blob->data);
  int i, j, k;
