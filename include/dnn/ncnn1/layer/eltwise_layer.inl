...
void EltwiseLayer::Forward_cpu(
  ...
  case EltwiseParameter_EltwiseOp_PROD:
    caffe_mul(count, pBox_datap(bottom_blob->data), pBox_datap(top_blob->data), top_data);
  ...
  case EltwiseParameter_EltwiseOp_MAX:
    ...
    // bottom 0 & 1
    bottom_data_a = pBox_datap(bottom_blob->data);
    bottom_data_b = pBox_datap(top_blob->data);
