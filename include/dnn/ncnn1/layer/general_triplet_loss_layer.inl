...
#include "general_triplet_loss_layer.hpp"
...
void GeneralTripletLossLayer::Forward_cpu(const vector<Blob*>& bottom,
    const vector<Blob*>& top) {
...
void GeneralTripletLossLayer::Backward_cpu(const vector<Blob*>& top,
