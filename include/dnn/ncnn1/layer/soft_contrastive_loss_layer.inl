...
#include "soft_contrastive_loss_layer.hpp"
...
void SoftContrastiveLossLayer::Forward_cpu(const vector<Blob*>& bottom,
    const vector<Blob*>& top) {
...
void SoftContrastiveLossLayer::Backward_cpu(const vector<Blob*>& top,
