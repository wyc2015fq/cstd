...
void PredictBoxLayer::Forward_cpu(
    const vector<Blob*>& bottom, const vector<Blob*>& top) {
  const Dtype* score_data = Blob_datap(bottom_blob->data);
        ...
        if (((!nms_ && score_data[bottom[0]->offset(n, 1, y, x)] > positive_thresh_) ||
          ...
          if (bounding_box_regression_) {
            if (bounding_box_exp_) {
              bb_data[top[0]->offset(n, 0, y, x)] += Blob_datap(top_blob->data)[bottom[1]->offset(n, 0, y, x)] * real_receptive_field;
              bb_data[top[0]->offset(n, 1, y, x)] += Blob_datap(top_blob->data)[bottom[1]->offset(n, 1, y, x)] * real_receptive_field;
              bb_data[top[0]->offset(n, 2, y, x)] *= exp(Blob_datap(top_blob->data)[bottom[1]->offset(n, 2, y, x)]);
              bb_data[top[0]->offset(n, 3, y, x)] *= exp(Blob_datap(top_blob->data)[bottom[1]->offset(n, 3, y, x)]);
            }
            else {
              bb_data[top[0]->offset(n, 0, y, x)] += Blob_datap(top_blob->data)[bottom[1]->offset(n, 1, y, x)] * real_receptive_field;
              bb_data[top[0]->offset(n, 1, y, x)] += Blob_datap(top_blob->data)[bottom[1]->offset(n, 0, y, x)] * real_receptive_field;
              bb_data[top[0]->offset(n, 2, y, x)] +=
                (Blob_datap(top_blob->data)[bottom[1]->offset(n, 3, y, x)] - Blob_datap(top_blob->data)[bottom[1]->offset(n, 1, y, x)]) * real_receptive_field;
              bb_data[top[0]->offset(n, 3, y, x)] +=
                (Blob_datap(top_blob->data)[bottom[1]->offset(n, 2, y, x)] - Blob_datap(top_blob->data)[bottom[1]->offset(n, 0, y, x)]) * real_receptive_field;
            }
          }
          count++;
        }
