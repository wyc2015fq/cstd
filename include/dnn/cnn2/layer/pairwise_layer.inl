...
void PairwiseLayer::Forward_cpu(
    const vector<Blob*>& bottom, const vector<Blob*>& top) {
  int* mask = NULL;
  const Dtype* bottom_data_a = Blob_datap(bottom_blob->data);
  const Dtype* bottom_data_b = Blob_datap(top_blob->data);
...
void PairwiseLayer::Backward_cpu(const vector<Blob*>& top,
