...
void EltwiseLayer::Forward_cpu(
  ...
  case EltwiseParameter_EltwiseOp_PROD:
    caffe_mul(count, Blob_datap(bottom_blob->data), Blob_datap(top_blob->data), top_data);
  ...
  case EltwiseParameter_EltwiseOp_MAX:
    ...
    // bottom 0 & 1
    bottom_data_a = Blob_datap(bottom_blob->data);
    bottom_data_b = Blob_datap(top_blob->data);
...
void EltwiseLayer::Backward_cpu(const vector<Blob*>& top,
