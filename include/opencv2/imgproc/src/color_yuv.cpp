...
{
    OclHelper< Set<1>, Set<1>, Set<CV_8U>, SizePolicy_FROM_YUV> h(_src, _dst, 1);
...
{
    OclHelper< Set<1>, Set<3, 4>, Set<CV_8U>, SizePolicy_FROM_YUV > h(_src, _dst, dcn);
...
{
    OclHelper< Set<3, 4>, Set<1>, Set<CV_8U>, SizePolicy_TO_YUV > h(_src, _dst, 1);
...
{
    CvtHelper< Set<3, 4>, Set<1>, Set<CV_8U>, SizePolicy_TO_YUV > h(_src, _dst, 1);
...
{
    CvtHelper< Set<1>, Set<1>, Set<CV_8U>, SizePolicy_FROM_YUV > h(_src, _dst, 1);
...
{
    if(dcn <= 0) dcn = 3;
    CvtHelper< Set<1>, Set<3, 4>, Set<CV_8U>, SizePolicy_FROM_YUV> h(_src, _dst, dcn);
