...
void test_android()
{
  ...
  setbkcolor(0x7c5731);
	...
	setlinestyle(CAP_FLAT, 10);	// 设置线条样式为宽度 10 的实线，端点是平的
	setfillcolor(0x24c097);							// 设置填充颜色为绿色

	// 画身体
	fillroundrect(-75, -111, 75, 39, 36);
  ...
  line( 38, -177,  28, -162);
	...
	setlinestyle(CAP_FLAT, 10);	// 恢复线条样式为宽度 10 的实线，端点是平的
  
	// 画胳膊
  fillroundrect(-117, -99, -75, 7, 42);		// 右胳膊
	fillroundrect( 117, -99,  75, 7, 42);		// 左胳膊
  
	// 画腿
	fillpie(-50, 49, -8, 91, PI, PI * 2);			// 右腿
	line(-50, 40, -50, 70);
	line(-8, 40, -8, 70);
	solidroundrect(-45, 0, -13, 86, 32);
