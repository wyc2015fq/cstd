...
void test_doraemon()
{
	...
	setlinecolor(BLACK);
	fillroundrect(-135, -206, 135, 54, 248);

	setfillcolor(WHITE);								// 脸
	fillellipse(-115, -144, 115, 46);

	fillroundrect(-63, -169, 0, -95, 56);			// 右眼
	fillroundrect(0, -169,  63, -95, 56);			// 左眼
	...
	fillcircle( 140, 99, 27);
	fillroundrect(-2, 178, -112, 205, 24);	// 脚
	fillroundrect( 2, 178,  112, 205, 24);
	...
	fillroundrect(-100, 23, 100, 42, 12);
