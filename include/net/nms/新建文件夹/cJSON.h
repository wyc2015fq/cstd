...
extern cJSON* cJSON_OpenFile(char* file);
extern int    cJSON_SaveFile(char* file, cJSON* json);

#define cJSON_ASSERT(c,r) if (!(c)){r}
...
cJSON* cJSON_OpenFile(char* file)
{
  FILE* f;
  int len;
  char* data;
...
int cJSON_SaveFile(char* file, cJSON* json)
{
  FILE* f;
  char filetemp[200];
  char* data;
