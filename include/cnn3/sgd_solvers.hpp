...
namespace caffe
{
  ...
  {
  public:
    explicit SGDSolver(CJSON* param)
  ...
  {
  public:
    explicit NesterovSolver(CJSON* param)
  ...
  {
  public:
    explicit AdaGradSolver(CJSON* param)
  ...
  {
  public:
    explicit RMSPropSolver(CJSON* param)
      : SGDSolver<Dtype>(param) { constructor_sanity_check(); }
  ...
  {
  public:
    explicit AdaDeltaSolver(CJSON* param)
  ...
  {
  public:
    explicit AdamSolver(CJSON* param)
