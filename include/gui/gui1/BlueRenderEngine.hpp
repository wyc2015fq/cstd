...
CRenderClip::~CRenderClip(Surface* hDC)
{
...
#include "PaintManager.hpp"

struct BlueRenderEngine {
  ...
  void DoFillRect(HDC hDC, CPaintManagerUI* pManager, RECT rcItem, UITYPE_COLOR Color) {
