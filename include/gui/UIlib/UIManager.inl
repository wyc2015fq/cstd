...
HICON CPaintManagerUI::GetThemeIcon(int iIndex, int cxySize) const
{
   if( m_himgIcons16 == NULL ) {
      m_himgIcons16 = ImageList_LoadImage(m_hInstance, (IDB_ICONS16), 16, 0, RGB(255,0,255), IMAGE_BITMAP, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
      m_himgIcons24 = ImageList_LoadImage(m_hInstance, (IDB_ICONS16), 16, 0, RGB(255,0,255), IMAGE_BITMAP, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
      m_himgIcons32 = ImageList_LoadImage(m_hInstance, (IDB_ICONS16), 16, 0, RGB(255,0,255), IMAGE_BITMAP, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
      m_himgIcons50 = ImageList_LoadImage(m_hInstance, (IDB_ICONS50), 50, 0, RGB(255,0,255), IMAGE_BITMAP, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
   }
