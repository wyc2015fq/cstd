...
LRESULT CALLBACK test_head_WndProc(HWND, UINT, WPARAM, LPARAM) ;
LRESULT CALLBACK test_head_ListProc(HWND, UINT, WPARAM, LPARAM) ;
WNDPROC OldList ;
int test_head()
{
  ...
  wndclass.lpfnWndProc = test_head_WndProc ;
...
LRESULT CALLBACK test_head_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
LRESULT CALLBACK test_head_ListProc(HWND hwnd, UINT message,
