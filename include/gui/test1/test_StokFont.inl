/*-----------------------------------------
 ...
 -----------------------------------------*/
#include <windows.h>
LRESULT CALLBACK test_StokFont_WndProc(HWND, UINT, WPARAM, LPARAM) ;
int test_StokFont()
{
  ...
  wndclass.lpfnWndProc = test_StokFont_WndProc ;
...
LRESULT CALLBACK test_StokFont_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
  static struct {
    int idStockFont ;
    TCHAR* szStockFont ;
