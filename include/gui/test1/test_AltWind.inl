/*-----------------------------------------------
 ...
 -----------------------------------------------*/
#include <windows.h>
LRESULT CALLBACK test_AltWind_WndProc(HWND, UINT, WPARAM, LPARAM) ;
int test_AltWind()
{
  ...
  wndclass.lpfnWndProc = test_AltWind_WndProc ;
...
LRESULT CALLBACK test_AltWind_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
