...
LRESULT CALLBACK test_OwnDraw_WndProc(HWND, UINT, WPARAM, LPARAM) ;
HINSTANCE hInst ;
int test_OwnDraw()
{
  ...
  wndclass.lpfnWndProc = test_OwnDraw_WndProc ;
...
LRESULT CALLBACK test_OwnDraw_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
