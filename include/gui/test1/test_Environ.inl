...
#define ID_LIST 1
#define ID_TEXT 2
LRESULT CALLBACK test_Environ_WndProc(HWND, UINT, WPARAM, LPARAM) ;
int test_Environ()
{
  ...
  wndclass.lpfnWndProc = test_Environ_WndProc ;
...
LRESULT CALLBACK test_Environ_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
  ...
  case WM_COMMAND :
    if (LOWORD(wParam) == ID_LIST && HIWORD(wParam) == LBN_SELCHANGE) {
      ...
      pVarValue = (char*)calloc(iLength, sizeof(TCHAR)) ;
