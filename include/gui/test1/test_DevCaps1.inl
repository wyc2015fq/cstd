...
LRESULT CALLBACK test_DevCaps1_WndProc(HWND, UINT, WPARAM, LPARAM) ;
int test_DevCaps1()
{
  ...
  wndclass.lpfnWndProc = test_DevCaps1_WndProc ;
...
LRESULT CALLBACK test_DevCaps1_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
