			...
			void image_stretch(const paint::pixel_buffer& s_pixbuf, const rectangle& r_src, paint::pixel_buffer & pixbuf, const rectangle& r_dst) const
			{
			...
			: public image_process::stretch_interface
		{
			...
			void process(const paint::pixel_buffer & s_pixbuf, const rectangle& r_src, paint::pixel_buffer & pixbuf, const rectangle& r_dst) const
			{
		...
		{
			//process
			virtual void process(const paint::pixel_buffer& s_pixbuf, const rectangle& s_r, paint::pixel_buffer& d_pixbuf, const point& d_pos) const
			{
		...
		{
			//process
			virtual void process(const paint::pixel_buffer& s_pixbuf, const rectangle& s_r, paint::pixel_buffer& d_pixbuf, const point& d_pos, double fade_rate) const
			{
		...
		{
			virtual void process(paint::pixel_buffer & pixbuf, const point& pos_beg, const point& pos_end, const ::color& clr, double fade_rate) const
			{
		...
		{
			void process(pixel_buffer& pixbuf, const rectangle& area, std::size_t u_radius) const
			{
