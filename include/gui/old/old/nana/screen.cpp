...
namespace nana
{
...
#else
		real_display(std::size_t number, const ::rectangle& r)
	...
	public:
		...
		const ::rectangle& area() const override
		{
			return area_;
		}

		const ::rectangle& workarea() const override
		{
			return workarea_;
		}
	private:
	...
	::size screen::desktop_size()
	{
		...
		return{w, h};
#else
		return ::detail::native_interface::primary_monitor_size();
#endif
	}
