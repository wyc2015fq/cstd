...
namespace nana
{
	namespace detail
	{
		...
		//struct basic_window
			...
			void basic_window::bind_native_window(native_window_type wd, unsigned width, unsigned height, unsigned extra_width, unsigned extra_height, paint::graphics& graphics)
			{
			...
			void basic_window::_m_initialize(basic_window* agrparent)
			{
				...
				flags.tab = detail::tab_type::none;
