...
namespace nana
{
	...
	public:
		...
		bool draw(graph_reference, const color& bgcolor, const color& fgcolor, const rectangle& r, element_state) override;
	private:
	...
	public:
		//Implement element_interface
		bool draw(graph_reference, const ::color& bgcolor, const ::color& fgcolor, const ::rectangle&, element_state) override;
	private:
	...
	namespace element
	{
		...
		public:
			...
			bground& image(const paint::image&, bool vertical, const rectangle& valid_area);		///< Set a picture for the background
			bground& image(const paint::graphics&, bool vertical, const rectangle& valid_area);	///< Set a picture for the background
