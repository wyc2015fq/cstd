	...
	namespace drawerbase
	{
		namespace spinbox
		{
			...
			public:
				...
				{
					widget_.events().text_changed.emit(::arg_spinbox{ widget_ }, widget_.handle());
				}
			private:
				::spinbox & widget_;
			};
			...
			public:
				...
				void attach(::widget& wdg, ::paint::graphics& graph)
				{
					auto wd = wdg.handle();
					graph_ = &graph;
					...
					evt_agent_.reset(new event_agent(static_cast<spinbox&>(wdg)));
