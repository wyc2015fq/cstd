...
namespace nana
{
	...
	//@brief:The definition of class widget
		...
		void widget::typeface(const paint::font& font)
		{
			_m_typeface(font);
		}

		paint::font widget::typeface() const
		{
			return _m_typeface();
		}
		...
		std::unique_ptr<::detail::widget_notifier_interface> widget::_m_wdg_notifier()
		{
			return std::unique_ptr<::detail::widget_notifier_interface>(new inner_widget_notifier(*this));
		}
		...
		paint::font widget::_m_typeface() const
		{
