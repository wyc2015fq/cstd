...
namespace nana
{
	namespace drawerbase
	{
		namespace categorize
		{
			...
			{
				std::function<void(any&)> selected;
			};
			...
			private:
				...
				void item(graph_reference graph, const rectangle& r, std::size_t index, const std::string& name_utf8, unsigned txtheight, bool has_child, mouse_action state)
				{
			...
			public:
				...
				void insert(const std::string& name, const any& value)
				{
					item_tag m;
					m.pixels = 0;
					m.value = value;
				...
				bool childset(const std::string& name, const any& value)
				{
					if(cur_)
					{
			...
			//class trigger
				...
				void trigger::insert(const std::string& str, any value)
				{
					throw_not_utf8(str);
				...
				bool trigger::childset(const std::string& str, any value)
				{
				...
				any& trigger::value() const
				{
					...
					throw std::runtime_error("categorize::value, current category is empty");
				}
