...
namespace nana
{
	...
	1. native_window_type is a type of system handle of windows.
	2. all the children windows of a frame is topmost to Nana.GUI windows.
	3. a simple example. Displaying a Windows Edit Control.

			frame frame(parent, 0, 0 200, 100);
     ...
     */
	class frame: public widget_object<category::frame_tag, int, general_events>
	{
