...
namespace nana{	namespace paint
{
	namespace detail
	{
		...
		public:
			...
			virtual void paste(const rectangle& src_r, graph_reference graph, const point& p_dst) const override;
			virtual void stretch(const rectangle&, graph_reference graph, const rectangle& r) const override;
