...
namespace detail
{
	class element_store
	{
		typedef ::element::element_interface element_interface;
		typedef pat::cloneable< ::element::element_interface> cloneable_element;

		struct data
		{
			cloneable_element object;
			::element::element_interface * fast_ptr;
