...
namespace nana
{
	...
	namespace detail
	{
		...
		void bedrock::_m_emit_core(event_code evt_code, core_window_t* wd, bool draw_only, const ::event_arg& event_arg)
		{
			...
			case event_code::mouse_up:
			{
				...
				void(::detail::drawer::*drawer_event_fn)(const arg_mouse&);
			...
			case event_code::shortkey:
			{
				...
				void(::detail::drawer::*drawer_event_fn)(const arg_keyboard&);
