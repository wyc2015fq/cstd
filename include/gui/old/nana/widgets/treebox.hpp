	...
	namespace drawerbase
	{
		namespace treebox
		{
			...
			struct node_attribute
			{
				...
				bool selected;
				bool mouse_pointed;
				paint::image icon_normal;
				paint::image icon_hover;
				paint::image icon_expanded;
				::std::string text;
			};
			...
			public:
				...
				virtual void set_color(const color& bgcolor, const color& fgcolor) = 0;
