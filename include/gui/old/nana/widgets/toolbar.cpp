...
namespace nana
{
	...
	namespace drawerbase
	{
		namespace toolbar
		{
			struct item_type
			{
				...
				item_type(const std::string& text, const paint::image& img, kind type)
			...
			public:
				...
				void insert(size_type pos, std::string text, const paint::image& img, item_type::kind type)
				{
				...
				void push_back(const std::string& text, const paint::image& img)
				{
				...
				{
					insert(cont_.size(), text, paint::image(), item_type::kind::button);
				}
			...
			public:
				...
				item_renderer(paint::graphics& graph, bool textout, unsigned scale, const ::color& bgcolor)
	...
	//class toolbar
		...
		void toolbar::append(const std::string& text, const paint::image& img)
		{
