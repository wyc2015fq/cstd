	...
	namespace drawerbase
	{
		...
		namespace treebox
		{
			...
			private:
				void _m_draw()
				{
					...
					{
						paint::graphics item_graph({ item_r_.width, item_r_.height });
			...
			public:
				...
				paint::image* image(const node_type* node)
				{
				...
				: public renderer_interface
			{
				...
				void set_color(const color & bgcolor, const color& fgcolor) override
				{
					bgcolor_ = bgcolor;
					fgcolor_ = fgcolor;
				}
		...
		namespace treebox
		{
			//class trigger
				...
				any & trigger::value(node_type* node) const
				{
