	...
	namespace drawerbase
	{
		namespace categorize
		{
			...
			public:
				...
				virtual void item(graph_reference, const rectangle&, std::size_t index, const ::std::string& name, unsigned textheight, bool has_child, mouse_action) = 0;
			...
			public:
				...
				void insert(const ::std::string&, any);
				bool childset(const ::std::string&, any);
