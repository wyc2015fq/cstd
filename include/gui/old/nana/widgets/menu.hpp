	...
	namespace drawerbase
	{
		namespace menu
		{
			...
			public:
				...
				virtual void item_image(graph_reference, const point&, unsigned image_px, const paint::image&) = 0;
				virtual void item_text(graph_reference, const point&, const std::string&, unsigned text_pixels, const attr&) = 0;
