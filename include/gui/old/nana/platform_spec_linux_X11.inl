...
#include "msg_packet.inl"
	...
	struct drawable_impl_type
	{
		...
		void fgcolor(const ::color&); //deprecated
	...
	public:
		...
		bool caret_update(native_window_type, paint::graphics& root_graph, bool is_erase_caret_from_root_graph);
		...
		const paint::graphics& keep_window_icon(native_window_type, const paint::image&);
	private:
	...
	private:
		...
		std::map<native_window_type, paint::graphics> iconbase_;
