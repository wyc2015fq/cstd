...
namespace nana
{
	...
	public:
			...
			: public abstract_content
		{
			struct implement;
		public:
			path(::std::string label, const ::filebox&);
			~path();
		...
		void image(::paint::image, bool is_left, const rectangle& valid_area = {});
		void image_v(::paint::image, bool is_top, const rectangle& valid_area = {});
