...
LRESULT CALLBACK test_Clover_WndProc(HWND, UINT, WPARAM, LPARAM) ;
int test_Clover()
{
  ...
  wndclass.lpfnWndProc = test_Clover_WndProc ;
...
LRESULT CALLBACK test_Clover_WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
