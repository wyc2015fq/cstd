...
#include <windows.h>
#define DIVISIONS 5
LRESULT CALLBACK test_Checker4_WndProc(HWND, UINT, WPARAM, LPARAM) ;
...
int test_Checker4()
{
  ...
  wndclass.lpfnWndProc = test_Checker4_WndProc ;
...
LRESULT CALLBACK test_Checker4_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
