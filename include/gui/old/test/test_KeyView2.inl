/*--------------------------------------------------------
 ...
 --------------------------------------------------------*/
#include <windows.h>
LRESULT CALLBACK test_KeyView2_WndProc(HWND, UINT, WPARAM, LPARAM) ;
int test_KeyView2()
{
  ...
  wndclass.lpfnWndProc = test_KeyView2_WndProc ;
...
LRESULT CALLBACK test_KeyView2_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
