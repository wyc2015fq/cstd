{
  ...
  sx = zb->w;
  pp = (PIXEL*)((char*) zb->pbuf + zb->step * p1->y + p1->x * zb->cn);
#ifdef INTERP_Z
...
#define RGBPIXEL RGB_TO_PIXEL24(pp, r>>16, g>>16, b>>16)
#else
#define RGBPIXEL RGB_TO_PIXEL(pp, r >> 8,g >> 8,b >> 8)
#endif
#else /* INTERP_RGB */
#define zRGB(x)
#if TGL_FEATURE_RENDER_BITS == 24
#define RGBPIXEL RGB_TO_PIXEL24(pp, r, g, b)
#else
