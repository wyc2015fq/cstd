/*----------------------------------------
 ...
 ----------------------------------------*/
#include <windows.h>
LRESULT CALLBACK test_Colors1_WndProc(HWND, UINT, WPARAM, LPARAM) ;
...
int test_Colors1()
{
  ...
  wndclass.lpfnWndProc = test_Colors1_WndProc ;
...
LRESULT CALLBACK test_Colors1_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
