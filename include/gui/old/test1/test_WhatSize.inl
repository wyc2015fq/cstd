/*-----------------------------------------
 ...
 -----------------------------------------*/
#include <windows.h>
LRESULT CALLBACK test_WhatSize_WndProc(HWND, UINT, WPARAM, LPARAM) ;
int test_WhatSize()
{
  ...
  wndclass.lpfnWndProc = test_WhatSize_WndProc ;
...
LRESULT CALLBACK test_WhatSize_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
