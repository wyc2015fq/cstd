...
LRESULT CALLBACK test_WhatClr_WndProc(HWND, UINT, WPARAM, LPARAM) ;
int test_WhatClr()
{
  ...
  wndclass.lpfnWndProc = test_WhatClr_WndProc ;
...
LRESULT CALLBACK test_WhatClr_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
