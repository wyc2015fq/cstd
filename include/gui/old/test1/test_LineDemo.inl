/*--------------------------------------------------
 ...
 --------------------------------------------------*/
#include <windows.h>
LRESULT CALLBACK test_LineDemo_WndProc(HWND, UINT, WPARAM, LPARAM) ;
int test_LineDemo()
{
  ...
  wndclass.lpfnWndProc = test_LineDemo_WndProc ;
...
LRESULT CALLBACK test_LineDemo_WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
