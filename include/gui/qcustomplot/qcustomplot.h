...
class QCPPaintBufferPixmap : public QCPAbstractPaintBuffer
{
public:
...
class QCPPaintBufferGlPbuffer : public QCPAbstractPaintBuffer
{
public:
...
class QCPPaintBufferGlFbo : public QCPAbstractPaintBuffer
{
public:
...
class QCPAbstractPlottable : public QCPLayerable
{
...
class QCPAbstractItem : public QCPLayerable
{
...
{
  // No   macro due to template class
...
class QCPSelectionDecoratorBracket : public QCPSelectionDecorator
{
  Q_GADGET
public:
...
class QCPAbstractLegendItem : public QCPLayoutElement
{
...
class QCPCurve : public QCPAbstractPlottable1D<QCPCurveData>
{
...
class QCPBars : public QCPAbstractPlottable1D<QCPBarsData>
{
...
class QCPStatisticalBox : public QCPAbstractPlottable1D<QCPStatisticalBoxData>
{
...
class QCPFinancial : public QCPAbstractPlottable1D<QCPFinancialData>
{
