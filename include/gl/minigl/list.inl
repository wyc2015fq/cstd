...
static void APIENTRY delete_list(GLContext* c, int list)
{
...
void APIENTRY gl_print_op(FILE* f, GLParam* p)
{
  int op;
  char* s;
...
void APIENTRY gl_compile_op(GLContext* c, GLParam* p)
{
  int op, op_size;
...
void APIENTRY glNewList(unsigned int list, int mode)
{
  GLList* l;
  GLContext* c = gl_get_context();
