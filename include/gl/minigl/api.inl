...
/* glVertex */
void MYGLAPI glVertex4f(GLfloat x, GLfloat y, GLfloat z, GLfloat w)
{
  GLParam p[5];
...
void MYGLAPI glVertex2f(GLfloat x, GLfloat y)
//void glVertex2f(GLfloat x,GLfloat y)
{
  glVertex4f(x, y, 0, 1);
}

void MYGLAPI glVertex3f(GLfloat x, GLfloat y, GLfloat z)
{
  glVertex4f(x, y, z, 1);
}
