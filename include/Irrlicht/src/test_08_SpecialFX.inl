...
int main()
{
  ...
  */
  ...
  node->setMaterialTexture(0, driver->getTexture("../../media/stones.bmp"));
  node->setMaterialTexture(1, driver->getTexture("../../media/water.bmp"));
  ...
  */
  ...
  while (device->run())
    if (device->isWindowActive()) {
      ...
      if (lastFPS != fps) {
        core::stringw str = "Irrlicht Engine - SpecialFX example [";
        str += driver->getName();
        str += "] FPS:";
        str += fps;
