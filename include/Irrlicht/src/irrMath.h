...
template<class T>
inline const T& min_3(const T& a, const T& b, const T& c)
{
...
template<class T>
inline const T& max_3(const T& a, const T& b, const T& c)
{
...
#else
inline const unsigned int clamp(const unsigned int value, const unsigned int low, const unsigned int high)
{
  return min_(max_(value, low), high);
}
inline const int clamp(const int value, const int low, const int high)
{
  return min_(max_(value, low), high);
}
inline const float clamp(const float value, const float low, const float high)
{
  return min_(max_(value, low), high);
}
