...
void CGUITreeView::recalculateItemHeight()
{
  ...
  if (ScrollBarV) {
    ScrollBarV->setMax(core::max_((int)0, (int)(TotalItemHeight - AbsoluteRect.getHeight())));
  }
  if (ScrollBarH) {
    ScrollBarH->setMax(core::max_((int)0, (int)(TotalItemWidth - AbsoluteRect.getWidth())));
  }
}
