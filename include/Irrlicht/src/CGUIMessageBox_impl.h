...
void CGUIMessageBox::setButton(IGUIButton*& button, bool isAvailable, const core::rect<s32>& btnRect, const char* text, IGUIElement*& focusMe)
{
...
void CGUIMessageBox::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options = 0)
{
  ...
  MessageText = in->getAttributeAsString("MessageText").c_str();
