...
public:
  ...
  SColor operator+(const SColor& other) const {
    return SColor(core::min_(getAlpha() + other.getAlpha(), (u32)255u),
        core::min_(getRed() + other.getRed(), (u32)255u),
        core::min_(getGreen() + other.getGreen(), (u32)255u),
        core::min_(getBlue() + other.getBlue(), (u32)255u));
  }
  ...
  SColor getInterpolated_quadratic(const SColor& c1, const SColor& c2, f32 d) const {
    ...
    const f32 mul2 = d * d;
    return SColor(
        core::clamp((s32)core::floor32(getAlpha() * mul0 + c1.getAlpha() * mul1 + c2.getAlpha() * mul2), (s32)0, (s32)255),
        core::clamp((s32)core::floor32(getRed()   * mul0 + c1.getRed()   * mul1 + c2.getRed()   * mul2), (s32)0, (s32)255),
        core::clamp((s32)core::floor32(getGreen() * mul0 + c1.getGreen() * mul1 + c2.getGreen() * mul2), (s32)0, (s32)255),
        core::clamp((s32)core::floor32(getBlue()  * mul0 + c1.getBlue()  * mul1 + c2.getBlue()  * mul2), (s32)0, (s32)255));
  }
...
{
  const f32 maxVal = core::max_3(color.getRed(), color.getGreen(), color.getBlue());
  const f32 minVal = (f32)core::min_3(color.getRed(), color.getGreen(), color.getBlue());
