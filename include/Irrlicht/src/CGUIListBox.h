...
public:
  ...
  virtual const char* getListItem(u32 id) const;
  //! adds an list item, returns id of item
  virtual u32 addItem(const char* text);
  //! clears the list
  virtual void clear();
  ...
  //! sets the selected item. Set this to -1 if no item should be selected
  virtual void setSelected(const char* item);
  ...
  virtual u32 addItem(const char* text, s32 icon);
  ...
  virtual void setItem(u32 index, const char* text, s32 icon);
  //! Insert the item at the given index
  //! Return the index on success or -1 on failure.
  virtual s32 insertItem(u32 index, const char* text, s32 icon);
