...
public:
  ...
  //! Adds a menu item.
  virtual u32 addItem(const char* text, s32 commandid,
      bool enabled, bool hasSubMenu, bool checked, bool autoChecking);
  //! Insert a menu item at specified position.
  virtual u32 insertItem(u32 idx, const char* text, s32 commandId, bool enabled,
  ...
  virtual const char* getItemText(u32 idx) const;
  //! Sets text of the menu item.
  virtual void setItemText(u32 idx, const char* text);
