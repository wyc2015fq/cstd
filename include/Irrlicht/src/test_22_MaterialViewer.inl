...
public:
  // Constructor
  CColorControl(gui::IGUIEnvironment* guiEnv, const core::position2d<s32>& pos, const char* text, IGUIElement* parent, s32 id = -1)
    ...
    EditAlpha = addEditForNumbers(guiEnv, core::position2d<s32>(0, 15), "a", -1, groupElement);
    EditRed = addEditForNumbers(guiEnv, core::position2d<s32>(0, 30), "r", -1, groupElement);
    EditGreen = addEditForNumbers(guiEnv, core::position2d<s32>(0, 45), "g", -1, groupElement);
    EditBlue = addEditForNumbers(guiEnv, core::position2d<s32>(0, 60), "b", -1, groupElement);
    ColorStatic = guiEnv->addStaticText("", core::rect<s32>(60, 15, 80, 75), true, false, groupElement, -1, true);
    guiEnv->addButton(core::rect<s32>(60, 35, 80, 50), groupElement, ButtonSetId, "set");
...
protected:
  ...
  gui::IGUIEditBox* addEditForNumbers(gui::IGUIEnvironment* guiEnv, const core::position2d<s32>& pos, const char* text, s32 id, gui::IGUIElement* parent) {
    using namespace gui;
    ...
    gui::IGUIEditBox* edit = guiEnv->addEditBox("0", rect, true, parent, id);
    return edit;
  }
...
public:
  // Constructor
  CAllColorsControl(gui::IGUIEnvironment* guiEnv, const core::position2d<s32>& pos, const char* description, bool hasEmissive, IGUIElement* parent, s32 id = -1)
...
protected:
  void createColorControls(gui::IGUIEnvironment* guiEnv, const core::position2d<s32>& pos, bool hasEmissive) {
    ...
    ControlDiffuseColor = new CColorControl(guiEnv, pos + core::position2d<s32>(0, 75), "diffuse", this);
    ControlSpecularColor = new CColorControl(guiEnv, pos + core::position2d<s32>(0, 150), "specular", this);
    if (hasEmissive) {
      ControlEmissiveColor = new CColorControl(guiEnv, pos + core::position2d<s32>(0, 225), "emissive", this);
    }
  }
private:
...
struct SMeshNodeControl {
  ...
  void init(scene::IMeshSceneNode* node, IrrlichtDevice* device, const core::position2d<s32>& pos, const char* description) {
...
struct SLightNodeControl {
  ...
  void init(scene::ILightSceneNode* node, gui::IGUIEnvironment* guiEnv, const core::position2d<s32>& pos, const char* description) {
...
protected:
  ...
  bool init(int argc, char* argv[]) {
    ...
    NodeLeft.init(nodeL, Device, core::position2d<s32>(10, 20), "left node");
    scene::IMeshSceneNode* nodeR = smgr->addCubeSceneNode(30.0f, 0, -1,
        core::vector3df(35, 0, 100),
        core::vector3df(0, 0, 0),
        core::vector3df(1.0f, 1.0f, 1.0f));
    NodeRight.init(nodeR, Device, core::position2d<s32>(530, 20), "right node");
    // add one light
    scene::ILightSceneNode* nodeLight = smgr->addLightSceneNode(0, core::vector3df(0, 0, 0),
        video::SColorf(1.0f, 1.0f, 1.0f),
        100.0f);
    LightControl.init(nodeLight, guiEnv, core::position2d<s32>(270, 20), "light");
    ...
    GlobalAmbient = new CColorControl(guiEnv, core::position2d<s32>(270, 300), "global ambient", guiEnv->getRootGUIElement());
