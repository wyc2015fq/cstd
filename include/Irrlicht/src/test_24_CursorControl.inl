...
void PrintMouseEventName(const SEvent& event, stringw& result)
{
  ...
  case EMIE_LMOUSE_PRESSED_DOWN:
    result += stringw("EMIE_LMOUSE_PRESSED_DOWN");
    break;
  case EMIE_RMOUSE_PRESSED_DOWN:
    result += stringw("EMIE_RMOUSE_PRESSED_DOWN");
    break;
  case EMIE_MMOUSE_PRESSED_DOWN:
    result += stringw("EMIE_MMOUSE_PRESSED_DOWN");
    break;
  case EMIE_LMOUSE_LEFT_UP:
    result += stringw("EMIE_LMOUSE_LEFT_UP");
    break;
  case EMIE_RMOUSE_LEFT_UP:
    result += stringw("EMIE_RMOUSE_LEFT_UP");
    break;
  case EMIE_MMOUSE_LEFT_UP:
    result += stringw("EMIE_MMOUSE_LEFT_UP");
    break;
  case EMIE_MOUSE_MOVED:
    result += stringw("EMIE_MOUSE_MOVED");
    break;
  case EMIE_MOUSE_WHEEL:
    result += stringw("EMIE_MOUSE_WHEE");
    break;
  case EMIE_LMOUSE_DOUBLE_CLICK:
    result += stringw("EMIE_LMOUSE_DOUBLE_CLICK");
    break;
  case EMIE_RMOUSE_DOUBLE_CLICK:
    result += stringw("EMIE_RMOUSE_DOUBLE_CLICK");
    break;
  case EMIE_MMOUSE_DOUBLE_CLICK:
    result += stringw("EMIE_MMOUSE_DOUBLE_CLICK");
    break;
  case EMIE_LMOUSE_TRIPLE_CLICK:
    result += stringw("EMIE_LMOUSE_TRIPLE_CLICK");
    break;
  case EMIE_RMOUSE_TRIPLE_CLICK:
    result += stringw("EMIE_RMOUSE_TRIPLE_CLICK");
    break;
  case EMIE_MMOUSE_TRIPLE_CLICK:
    result += stringw("EMIE_MMOUSE_TRIPLE_CLICK");
    break;
  default:
    break;
  }
...
void PrintMouseState(const SEvent& event, stringw& result)
{
  ...
  result += stringw("\n");
  result += stringw("Wheel: ");
  result += stringw(event.MouseInput.Wheel);
  result += stringw("\n");
  result += stringw("Shift: ");
  if (event.MouseInput.Shift) {
    result += stringw("true\n");
  }
  else {
    result += stringw("false\n");
  }
  result += stringw("Control: ");
  ...
  result += stringw("ButtonStates: ");
  result += stringw(event.MouseInput.ButtonStates);
  result += stringw("\n");
  result += stringw("isLeftPressed: ");
  ...
  result += stringw("isMiddlePressed: ");
...
int main()
{
  ...
  context.ButtonSetVisible = env->addButton(rect<s32>(410, 20, 560, 40), 0, -1, "set visible (delayed)");
  context.ButtonSetInvisible = env->addButton(rect<s32>(410, 50, 560, 70), 0, -1, "set invisible (delayed)");
  context.ButtonSimulateBadFps = env->addButton(rect<s32>(410, 80, 560, 100), 0, -1, "simulate bad FPS");
  context.ButtonSimulateBadFps->setIsPushButton(true);
  context.ButtonChangeIcon = env->addButton(rect<s32>(410, 140, 560, 160), 0, -1, "replace cursor icon\n(cursor+sprite must be selected)");
