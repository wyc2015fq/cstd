...
int main()
{
  ...
  */
  env->addStaticText("Transparent Control:", rect<s32>(150, 20, 350, 40), true);
  ...
  env->addStaticText("Logging ListBox:", rect<s32>(50, 110, 250, 130), true);
  IGUIListBox* listbox = env->addListBox(rect<s32>(50, 140, 250, 210));
  env->addEditBox("Editable Text", rect<s32>(350, 80, 550, 100));
