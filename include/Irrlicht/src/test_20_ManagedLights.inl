...
int main(int argumentCount, char* argumentValues[])
{
  ...
  guienv->addStaticText("1 - No light management", core::rect<s32>(10, 10, 200, 30));
  guienv->addStaticText("2 - Closest 3 lights", core::rect<s32>(10, 30, 200, 50));
  guienv->addStaticText("3 - Lights in zone", core::rect<s32>(10, 50, 200, 70));
  /*
