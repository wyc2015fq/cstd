...
public:
  ...
  virtual IGUIButton* addButton(const core::rect<s32>& rectangle, IGUIElement* parent = 0, s32 id = -1, const char* text = 0, const char* tooltiptext = 0);
  ...
  //! Adds a message box.
  virtual IGUIWindow* addMessageBox(const char* caption, const char* text = 0,
  ...
  //! adds a checkbox
  virtual IGUICheckBox* addCheckBox(bool checked, const core::rect<s32>& rectangle, IGUIElement* parent = 0, s32 id = -1, const char* text = 0);
  //! adds a list box
  ...
  virtual IGUIMeshViewer* addMeshViewer(const core::rect<s32>& rectangle, IGUIElement* parent = 0, s32 id = -1, const char* text = 0);
  //! Adds a file open dialog.
  virtual IGUIFileOpenDialog* addFileOpenDialog(const char* title = 0,
      bool modal = true, IGUIElement* parent = 0, s32 id = -1,
      bool restoreCWD = false, io::path::char_type* startDir = 0);
  //! Adds a color select dialog.
  virtual IGUIColorSelectDialog* addColorSelectDialog(const char* title = 0, bool modal = true, IGUIElement* parent = 0, s32 id = -1);
  //! adds a static text. The returned pointer must not be dropped.
  virtual IGUIStaticText* addStaticText(const char* text, const core::rect<s32>& rectangle,
      bool border = false, bool wordWrap = true, IGUIElement* parent = 0, s32 id = -1, bool drawBackground = false);
  //! Adds an edit box. The returned pointer must not be dropped.
  virtual IGUIEditBox* addEditBox(const char* text, const core::rect<s32>& rectangle,
      bool border = false, IGUIElement* parent = 0, s32 id = -1);
  //! Adds a spin box to the environment
  virtual IGUISpinBox* addSpinBox(const char* text, const core::rect<s32>& rectangle,
      bool border = false, IGUIElement* parent = 0, s32 id = -1);
