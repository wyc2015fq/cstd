...
void loadModel(const c8* fn)
{
  ...
  if (!m) {
    ...
    if (StartUpModelFile != filename)
      Device->getGUIEnvironment()->addMessageBox(
          Caption.c_str(), "The model could not be loaded. " \
  ...
  Model->setMaterialFlag(video::EMF_LIGHTING, isUseLight);
  Model->setMaterialFlag(video::EMF_NORMALIZE_NORMALS, isUseLight);
...
void createToolBox()
{
  ...
  env->addStaticText("X:", core::rect<s32>(22, 48, 40, 66), false, false, t1);
  env->addEditBox("1.0", core::rect<s32>(40, 46, 130, 66), true, t1, GUI_ID_X_SCALE);
  env->addStaticText("Y:", core::rect<s32>(22, 82, 40, 96), false, false, t1);
  env->addEditBox("1.0", core::rect<s32>(40, 76, 130, 96), true, t1, GUI_ID_Y_SCALE);
  env->addStaticText("Z:", core::rect<s32>(22, 108, 40, 126), false, false, t1);
  env->addEditBox("1.0", core::rect<s32>(40, 106, 130, 126), true, t1, GUI_ID_Z_SCALE);
  env->addButton(core::rect<s32>(10, 134, 85, 165), t1, GUI_ID_BUTTON_SET_SCALE, "Set");
  // quick scale buttons
  env->addButton(core::rect<s32>(65, 20, 95, 40), t1, GUI_ID_BUTTON_SCALE_MUL10, "* 10");
  env->addButton(core::rect<s32>(100, 20, 130, 40), t1, GUI_ID_BUTTON_SCALE_DIV10, "* 0.1");
  updateScaleInfo(Model);
  ...
  env->addStaticText(":", core::rect<s32>(10, 240, 150, 265), true, false, t1);
  env->addStaticText("Framerate:",
      core::rect<s32>(12, 240, 75, 265), false, false, t1);
  // current frame info
  env->addStaticText("", core::rect<s32>(75, 240, 200, 265), false, false, t1,
      GUI_ID_ANIMATION_INFO);
