...
public:
  ...
  virtual const char* getAttributeTypeString(const c8* attributeName);
  //! Returns the type string of the attribute by index.
  //! \param index: Index value, must be between 0 and getAttributeCount()-1.
  virtual const char* getAttributeTypeString(s32 index);
  ...
  virtual bool write(io::IXMLWriter* writer, bool writeXMLHeader = false, const char* nonDefaultElementName = 0);
  /*
    Integer Attribute
  */
