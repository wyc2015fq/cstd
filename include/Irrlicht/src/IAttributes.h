...
public:
  ...
  virtual const char* getAttributeTypeString(const c8* attributeName) = 0;
  //! Returns the type string of the attribute by index.
  //! \param index: Index value, must be between 0 and getAttributeCount()-1.
  virtual const char* getAttributeTypeString(s32 index) = 0;
  ...
  virtual bool read(io::IXMLReader* reader, bool readCurrentElementOnly = false, const char* elementName = 0) = 0;
  ...
  //! \param elementName: The surrounding element name. If it is null, the default one, "attributes" will be taken.
  virtual bool write(io::IXMLWriter* writer, bool writeXMLHeader = false, const char* elementName = 0) = 0;
  /*
    Integer Attribute
  */
