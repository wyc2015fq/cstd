...
//! and int swprintf(char *wcs, size_t maxlen, const char *format, ...);
...
#endif
// define the char type if not already built in.
#ifdef _MSC_VER
...
/**
  ...
  the standard compiler to treat char as a built-in type, and
