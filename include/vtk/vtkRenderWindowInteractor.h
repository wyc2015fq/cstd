...
public:
   ...
   */
  virtual void Enable() { this->Enabled = 1; }
  virtual void Disable() { this->Enabled = 0; }
  ...
  void UnRegister(vtkRenderWindow* window) {}
  void Register(vtkRenderWindow* window) {}
  //@}
...
public:
  ...
  //void GrabFocus(vtkCommand *mouseEvents, vtkCommand *keypressEvents=NULL)    {this->Superclass::InternalGrabFocus(mouseEvents,keypressEvents);}
