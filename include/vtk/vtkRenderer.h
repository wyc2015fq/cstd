...
public:
   ...
   */
  void AddActor(vtkActor *p);
  void AddVolume(vtkVolume *p);
  void RemoveActor(vtkActor *p);
  void RemoveVolume(vtkVolume *p);
  //@}
  ...
  */
   ...
   */
  vtkCullerCollection *GetCullers() {return this->Cullers;}
...
public:
  ...
  void SetSelector(vtkHardwareSelector* selector)
    { this->Selector = selector; Modified(this); }
