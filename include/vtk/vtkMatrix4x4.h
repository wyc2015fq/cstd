...
public:
  ...
  void DeepCopy(const vtkMatrix4x4 *source)
    {vtkMatrix4x4::DeepCopy(*this->Element, source); Modified(this); }
  ...
  void DeepCopy(const double elements[16])
    { this->DeepCopy(*this->Element, elements); Modified(this); }

  /**
   * Set all of the elements to zero.
   */
  void Zero()
    { vtkMatrix4x4::Zero(*this->Element); Modified(this); }
   ...
   */
  void Identity()
    { vtkMatrix4x4::Identity(*this->Element); Modified(this);}
  ...
  static void Invert(const vtkMatrix4x4 *in, vtkMatrix4x4 *out)
    {vtkMatrix4x4::Invert(*in->Element, *out->Element); Modified(out); }
  void Invert()
  ...
  static void Transpose(const vtkMatrix4x4 *in, vtkMatrix4x4 *out)
    {vtkMatrix4x4::Transpose(*in->Element, *out->Element); Modified(out); }
  void Transpose()
