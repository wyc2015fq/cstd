...
{ \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): setting " #name " to " << _arg); \
  if (this->name != _arg) \
  { \
    this->name = _arg; \
    Modified(this); \
...
virtual type Get##name () { \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): returning " << #name " of " << this->name ); \
  return this->name; \
}
...
{ \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): setting " << #name " to " << (_arg?_arg:"(null)") ); \
...
virtual char* Get##name () { \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): returning " << #name " of " << (this->name?this->name:"(null)")); \
  return this->name; \
}
...
#define vtkSetObjectBodyMacro(name,type,args)                   \
  {                                                             \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this         \
...
{ \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): setting " << #name " to (" << _arg1 << "," << _arg2 << ")"); \
...
virtual type *Get##name () \
{ \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): returning " << #name " pointer " << this->name); \
  return this->name; \
} \
...
{ \
    _arg1 = this->name[0]; \
    _arg2 = this->name[1]; \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): returning " << #name " = (" << _arg1 << "," << _arg2 << ")"); \
} \
...
{ \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): setting " << #name " to (" << _arg1 << "," << _arg2 << "," << _arg3 << ")"); \
...
{ \
    ...
    _arg2 = this->name[1]; \
    _arg3 = this->name[2]; \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): returning " << #name " = (" << _arg1 << "," << _arg2 << "," << _arg3 << ")"); \
} \
...
{ \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): setting " << #name " to (" << _arg1 << "," << _arg2 << "," << _arg3 << "," << _arg4 << ")"); \
...
{ \
    ...
    _arg3 = this->name[2]; \
    _arg4 = this->name[3]; \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): returning " << #name " = (" << _arg1 << "," << _arg2 << "," << _arg3 << "," << _arg4 << ")"); \
} \
...
{ \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): setting " << #name " to (" << _arg1 << "," << _arg2 << "," << _arg3 << "," << _arg4 << "," << _arg5 << "," << _arg6 << ")"); \
...
{ \
    ...
    _arg5 = this->name[4]; \
    _arg6 = this->name[5]; \
  vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): returning " << #name " = (" << _arg1 << "," << _arg2 << "," << _arg3 << "," << _arg4 << "," << _arg5 <<"," << _arg6 << ")"); \
} \
...
{ if (0) { \
  std::cout << "Generic Warning: In " __FILE__ ", line " << __LINE__ << "\n" x \
      << "\n\n"; }}
...
#define GETCLASSNAME(x)  ("")

#define vtkWorldCoordinateMacro(name) \
virtual vtkCoordinate *Get##name##Coordinate () \
{ \
    vtkDebugMacro(<< GETCLASSNAME(this) << " (" << this << "): returning " #name "Coordinate address " << this->name##Coordinate ); \
