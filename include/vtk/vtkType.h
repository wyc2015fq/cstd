...
#define VTK_LONG_LONG_MIN           VTK_TYPE_CAST(int64, ~(~0UL >> 1))
#define VTK_LONG_LONG_MAX           VTK_TYPE_CAST(int64, ~0ul >> 1)
#define VTK_UNSIGNED_LONG_LONG_MIN  VTK_TYPE_CAST(uint64, 0ul)
#define VTK_UNSIGNED_LONG_LONG_MAX  VTK_TYPE_CAST(uint64, ~0ul)
...
typedef vtkMTimeType vtkTimeStamp;
