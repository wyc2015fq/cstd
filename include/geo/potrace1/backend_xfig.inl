...
/* $Id: backend_xfig.c,v 1.10 2005/02/22 21:31:23 selinger Exp $ */
...
CC_INLINE dpoint_t trans(dpoint_t p, trans_t t) {
  dpoint_t res;
...
int page_xfig(FILE *fout, potrace_path_t *plist, imginfo_t *imginfo) {
  ...
  fprintf(fout, "#created by "POTRACE" "VERSION", written by Peter Selinger 2001-2005\n");
