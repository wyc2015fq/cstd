...
static CC_INLINE void progress_update(double d, progress_t *prog) {
  double d_scaled;
...
static CC_INLINE void progress_subrange_start(double a, double b, const progress_t *prog, progress_t *sub) {
  double min, max;
...
static CC_INLINE void progress_subrange_end(progress_t *prog, progress_t *sub) {
  if (prog != NULL && prog->callback != NULL) {
