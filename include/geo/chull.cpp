www.pudn.com _ chull_3dConvexHull.rar _ chull.cpp_ change_2007-10-13_size_16109b
...
{   
  ...
  *nf = get_n_faces ();   
  ...
  /* memory allocation */   
  float *cv_vertices = (float*)pmalloc(3*(*nv)*sizeof(float));   
  int   *cv_faces    = (int*)pmalloc(3*(*nf)*sizeof(int));   
