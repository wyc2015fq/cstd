...
int test_cube(sys_event_t* event)
{
  ...
  if (!inited) {
    inited = 1;
    ArcBall_init(ArcBall, 640.0f, 480.0f); // NEW: ArcBall Instance
  ...
  if (1) {
    ...
    glTranslatef(0, 0, -6.0f); // Move Right 1.5 Units And Into The Screen 7.0
