static void tutorial20(sys_event_t* event)
{
  static int inited = 0;
  ...
  static GLuint m_eyeWorldPosLocation;
  static GLuint m_matSpecularIntensityLocation;
  static GLuint m_matSpecularPowerLocation;
...
FragColor = texture2D(gSampler, TexCoord0.xy) * (AmbientColor + DiffuseColor + SpecularColor);\
    ...
    glEnable(GL_CULL_FACE);
        const vec3 Normal = vec3(0.0, 1.0f, 0.0f);
        Vertex Vertices[6] = {
                                Vertex(vec3(0.0f, 0.0f, 0.0f),             vec2(0.0f, 0.0f), Normal),
                                Vertex(vec3(0.0f, 0.0f, FieldDepth),       vec2(0.0f, 1.0f), Normal),
                                Vertex(vec3(FieldWidth, 0.0f, 0.0f),       vec2(1.0f, 0.0f), Normal),

                                Vertex(vec3(FieldWidth, 0.0f, 0.0f),       vec2(1.0f, 0.0f), Normal),
                                Vertex(vec3(0.0f, 0.0f, FieldDepth),       vec2(0.0f, 1.0f), Normal),
                                Vertex(vec3(FieldWidth, 0.0f, FieldDepth), vec2(1.0f, 1.0f), Normal)
        };
    ...
    Light.AmbientIntensity = 0.00f;
    Light.DiffuseIntensity = 0.01f;
    Light.Direction = vec3(1.0f, -1.0, 0.0);
  }
  static vec3 campos(5.0f, 1.0f, -3.0f);
  ...
  glUniform3f(m_eyeWorldPosLocation, campos.x, campos.y, campos.z);
  glUniform1f(m_matSpecularIntensityLocation, 1.0f);
  glUniform1f(m_matSpecularPowerLocation, 32.f);
