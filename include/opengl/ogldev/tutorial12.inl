static void tutorial12(sys_event_t* event)
{
  static int inited = 0;
 ...
 FragColor = Color;\
  ...
  float44 m_WPtransformation;
  GetWPTrans(m_WPtransformation, 0.0f, 0.0f, 5.0f, 0.0f, Scale, 0.0f, 1, 1, 1, &gPersProjInfo);
  glUniformMatrix4fv(gWorldLocation, 1, GL_TRUE, m_WPtransformation[0]);
  float Vertices[] = {
    -1.0f, -1.0f, 0.5773f,
    0.0f, -1.0f, -1.15475f,
    1.0f, -1.0f, 0.5773f,
