...
namespace caffe
{
  ...
  protected:
    FilterLayerTest()
      : blob_bottom_data_(new Blob(4, 3, 6, 4)),
        blob_bottom_labels_(new Blob(4, 1, 1, 1)),
        blob_bottom_selector_(new Blob(4, 1, 1, 1)),
    ...
    Blob* const blob_bottom_labels_;
    Blob* const blob_bottom_selector_;
    // blobs for the top of FilterLayer
    Blob* const blob_top_data_;
    Blob* const blob_top_labels_;
