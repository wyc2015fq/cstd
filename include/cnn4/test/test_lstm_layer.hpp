...
namespace caffe
{
  ...
  protected:
    ...
    Blob blob_bottom_;
    Blob blob_bottom_cont_;
    Blob blob_bottom_static_;
    Blob blob_top_;
    vector<Blob*> blob_bottom_vec_;
    vector<Blob*> blob_top_vec_;

    Blob unit_blob_bottom_cont_;
    Blob unit_blob_bottom_c_prev_;
    Blob unit_blob_bottom_x_;
    Blob unit_blob_top_c_;
    Blob unit_blob_top_h_;
  ...
  TYPED_TEST(LSTMLayerTest, TestForward)
  {
    ...
    Blob bottom_copy(this->blob_bottom_.shape());
    bottom_copy.CopyFrom(this->blob_bottom_);
    Blob top_copy(this->blob_top_.shape());
