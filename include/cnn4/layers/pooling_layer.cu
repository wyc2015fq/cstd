...
template <typename Dtype>
void PoolingLayer<Dtype>::Forward(GPUContext* context, const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void PoolingLayer<Dtype>::Backward(GPUContext* context, const vector<Blob<Dtype>*>& top,
