...
template <typename Dtype>
void SigmoidLayer<Dtype>::Forward(GPUContext* context, const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void SigmoidLayer<Dtype>::Backward(GPUContext* context, const vector<Blob<Dtype>*>& top,
