...
namespace
{
  ...
  template <typename Dtype>
  void InnerProductLayer<Dtype>::Forward(CPUContext* context, const vector<Blob<Dtype>*> & bottom,
      const vector<Blob<Dtype>*> & top)
  {
  ...
  template <typename Dtype>
  void InnerProductLayer<Dtype>::Backward(CPUContext* context, const vector<Blob<Dtype>*> & top,
