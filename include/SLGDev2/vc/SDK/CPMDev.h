...
//       例如: 
//           CPM_CNDev("192.168.1.150""); // ipv4
//           CPM_CNDev("2001::51d6:120a:e9f4:d0ce"); // ipv6
//           CPM_CNDev("mr-bubblehead-2.example.com"); // hostname
...
typedef enum {
  ...
  //3 : need encrypt and it is client-side 并进行根证书验证，请把根证书放 "C:\\rootca"(SSL_ROOTCA_PATH) 目录下
  SRV_QUERY_ENCRYPT, // 与中转服务器是否进行加密传输
  DEV_VERIFYCERT_FAILUE, // 证书验证失败
} DEV_CONNECT_STATUS;
typedef enum {
...
typedef enum {
  ...
  DEV_START_VERIFY = 0x0c, // 开始验证
  DEV_STOP_VERIFY = 0x0d, // 停止验证
...
////////////////////////////////////////////////////////////////////////////////////////
//功能 设置参数
//参数 type 参数类型 如 CPM_DEBUG (value=[0 1])
// value 参数的值
//说明
////////////////////////////////////////////////////////////////////////////////////////
#define CPM_DEBUG -1 // 打印调试信息
long CPMDEV_CALL CPM_SetLong(long type, long value);
EXTERN_C_END
#endif
