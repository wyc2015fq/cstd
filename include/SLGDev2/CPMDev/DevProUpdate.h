...
{
public:
  DevProUpdate(const CSock* s, NCMD* pCMD, BOOL bServer, void* pvClientData);
  DevProUpdate(const CSock* s, const DEV_APPUPDATE& cData, int nSeq, char* pbBuf, unsigned int& nLen);  //更新设备
private:
