...
{
public:
  DevAuth(const CSock* s, NCMD* pCMD, BOOL bServer, void* pvClientData);
  DevAuth(const CSock* s, const DEV_AUTH& cAuth, BOOL bSet, int nSeq, char* pbBuf, unsigned int& uLen);
private:
