...
class BatchLoader(object):
    def __init__(self,cls_list,roi_list,pts_list,net_side,cls_root,roi_root,pts_root):
        ...
        self.roi_list = []
        self.pts_list = []
        save_dir = 'E:/data/ew_id/mtcnn/'
        save_dir = root+"12"
        print("Start Reading Classify Data into Memory...")
        
        all_list = all_list2 = pickle_load(os.path.join(save_dir, "all.imdb"))
        self.cls_list,self.roi_list,self.pts_list = get_all_list(all_list)
