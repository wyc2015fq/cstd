...
set INCLUDE=%INCLUDE%;D:\code\lib\boost_1_65_0
...
set LIB=%CodeDir%\lib\x64;%LIB%;%NvidiaDir%\lib\x64;
set LIB=%LIB%;D:\code\lib\boost_1_65_0\lib64-msvc-14.0
set LIB=%LIB%;D:\code\git\boost_1_65_0\stage\lib;C:\local\boost_1_65_0\lib64-msvc-14.0

::set LIB=%LIB%;

set cc=%cc% /GS /GL /W3 /Gy /Gd /Oi /MD /Zc:wchar_t /bigobj /Zi /Gm- /O2 /sdl /Zc:inline /fp:precise /EHsc
