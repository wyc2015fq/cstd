# Skywind Inside » GDB 从裸奔到穿戴整齐
## GDB 从裸奔到穿戴整齐
February 28th, 2018[skywind](http://www.skywind.me/blog/archives/author/skywind)[Leave a comment](#respond)[Go to comments](#comments)
...
- 切换文件：c-x c-f （先按 ctrl*x 再按 ctrl*f），输入文件名时可以用 tab 补全
