# Skywind Inside » VimScript 五分钟入门（翻译）
## VimScript 五分钟入门（翻译）
May 26th, 2018[skywind](http://www.skywind.me/blog/archives/author/skywind)[Leave a comment](#respond)[Go to comments](#comments)
