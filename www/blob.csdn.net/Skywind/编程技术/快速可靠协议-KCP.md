# Skywind Inside » 快速可靠协议-KCP
## 快速可靠协议-KCP
December 22nd, 2012[skywind](http://www.skywind.me/blog/archives/author/skywind)[Leave a comment](#respond)[Go to comments](#comments)
...
URL：[https://github.com/skywind3000/kcp](https://github.com/skywind3000/kcp)
### **技术特性**
...
- **工作模式**int ikcp_nodelay(ikcpcb *kcp, int nodelay, int interval, int resend, int nc);- **nodelay **：是否启用 nodelay模式，0不启用；1启用。 
