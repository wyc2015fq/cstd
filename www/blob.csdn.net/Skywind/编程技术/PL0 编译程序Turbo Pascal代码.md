# Skywind Inside » PL0 编译程序Turbo Pascal代码
## PL0 编译程序Turbo Pascal代码
April 10th, 2001[skywind](http://www.skywind.me/blog/archives/author/skywind)[Leave a comment](#respond)[Go to comments](#comments)
麻雀虽小，五脏具全，对编译原理的代码以TPASCAL格式重新整理和排版，还原最原版的代码
编译版和例子下载：
[http://www.skywind.me/maker/pl0-pas.rar](http://www.skywind.me/maker/pl0-pas.rar)
```delphi
(********************* PL0 编译程序Turbo Pascal代码 *********************)
