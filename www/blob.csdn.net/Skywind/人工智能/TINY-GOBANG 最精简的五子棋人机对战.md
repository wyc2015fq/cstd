# Skywind Inside » TINY-GOBANG 最精简的五子棋人机对战
## TINY-GOBANG 最精简的五子棋人机对战
November 8th, 2012[skywind](http://www.skywind.me/blog/archives/author/skywind)[Leave a comment](#respond)[Go to comments](#comments)
国庆没事，想看看最少多少行可以写一个人机对战起来游戏，于是有了这个Python版五子棋人机对战，仅仅几百行。
[http://www.skywind.me/mw/images/7/7f/Gobang.7z](http://www.skywind.me/mw/images/7/7f/Gobang.7z)
[https://github.com/skywind3000/gobang](https://github.com/skywind3000/gobang)
下面是代码（点击More展开）
```py
#! /usr/bin/env python
# -*- coding: utf-8 -*-
