# Stata: 拉索回归和岭回归 (Ridge, Lasso) 简介 - 简书
...
Stata 连享会： [知乎](https://zhuanlan.zhihu.com/arlion) | [简书](https://www.jianshu.com/u/69a30474ef33) | [码云](https://gitee.com/arlionn)
...
![\begin{align} \min_{\beta} (y-z\beta)^{T}(y-z\beta) \\ s.t. \sum_{j=1}^p \beta_j^2 \leq t \end{align}](https://math.jianshu.com/math?formula=%5Cbegin%7Balign%7D%20%5Cmin_%7B%5Cbeta%7D%20(y-z%5Cbeta)%5E%7BT%7D(y-z%5Cbeta)%20%5C%5C%20s.t.%20%5Csum_%7Bj%3D1%7D%5Ep%20%5Cbeta_j%5E2%20%5Cleq%20t%20%5Cend%7Balign%7D)

其中，t 代表惩罚的力度，t 越大，对系数的大小惩罚越重，约束越紧。取系数的平方和形式可以避免正负系数相抵消的情况。在矩阵形式中，Z 按照传统是标准化之后的（均值为 0，方差为 1），y 也需要中心化。不难证明，这个优化问题的解是：

![{\beta}^{ridge}=(z^{T}z+\lambda I_{p})^{-1}z^{T}y](https://math.jianshu.com/math?formula=%7B%5Cbeta%7D%5E%7Bridge%7D%3D(z%5E%7BT%7Dz%2B%5Clambda%20I_%7Bp%7D)%5E%7B-1%7Dz%5E%7BT%7Dy)
...
![\begin{align} \min_{\beta} (y-z\beta)^{T}(y-z\beta) \\ s.t. \sum_{j=1}^p |\beta_j| \leq t \end{align}](https://math.jianshu.com/math?formula=%5Cbegin%7Balign%7D%20%5Cmin_%7B%5Cbeta%7D%20(y-z%5Cbeta)%5E%7BT%7D(y-z%5Cbeta)%20%5C%5C%20s.t.%20%5Csum_%7Bj%3D1%7D%5Ep%20%7C%5Cbeta_j%7C%20%5Cleq%20t%20%5Cend%7Balign%7D)

等价地，我们可以用以下损失函数来表示：

![PRSS(\beta)=(y-z\beta)^{T}(y-z\beta)+{\lambda} \| {\beta} \|_{1}](https://math.jianshu.com/math?formula=PRSS(%5Cbeta)%3D(y-z%5Cbeta)%5E%7BT%7D(y-z%5Cbeta)%2B%7B%5Clambda%7D%20%5C%7C%20%7B%5Cbeta%7D%20%5C%7C_%7B1%7D)
...
![](https://upload-images.jianshu.io/upload_images/7692714-c1b627b7603ab0c4.png)
...
![](https://upload-images.jianshu.io/upload_images/7692714-062fd4a2488c6325.png)
...
![](https://upload-images.jianshu.io/upload_images/7692714-5f6daa4360cf17da.png)
...
![](https://upload-images.jianshu.io/upload_images/7692714-8e0964ad40b7444f.png)
...
![](https://upload-images.jianshu.io/upload_images/7692714-60b3b0c5d5477d57.png)
...
![](https://upload-images.jianshu.io/upload_images/7692714-7877ebc8b861bdbf.jpg)
