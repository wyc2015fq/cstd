# 5 款 Linux 街机游戏 - 文章 - 伯乐在线
原文出处： [Joshua Allen Holm](https://opensource.com/article/18/1/arcade-games-linux)   译文出处：[Linux中国/Rachel](https://linux.cn/article-10433-1.html)
![](http://jbcdn2.b0.upaiyun.com/2019/01/3d62608ee84e9b8601819c7609b43f24.jpg)
...
### 太空危机AstroMenace
![](http://jbcdn2.b0.upaiyun.com/2019/01/154283c31dd140af55de0ab3b5221452.png)
...
### 坦克战役Battle Tanks
![](http://jbcdn2.b0.upaiyun.com/2019/01/3189ffe1805158124389e1827a033bbf.png)
...
### 火星M.A.R.S.
![](http://jbcdn2.b0.upaiyun.com/2019/01/b5379a874172f5e60ea456032901876c.png)
[火星](http://mars-game.sourceforge.net/?page_id=10) 是一个自上而下的太空射击游戏，游戏机制类似传统街机游戏 “爆破彗星Asteroids”。玩家在操控一个太空船的同时向敌方射击并躲避敌军的弹幕射击。游戏有标准的死斗和团体死斗模式，除此之外也有更新鲜的比赛形式 —— 例如在一个模式下，玩家需要控制一个球使其进入敌方母星。该游戏支持本地多人游戏，但遗憾的是不支持多人联机。该游戏的开发更新似乎已经停止，所以该游戏之后增加联机模式的几率很小，但就算没有联机支持，这个游戏仍然值得一试。
安装火星，你只需要在终端下运行以下指令：
- Fedora 用户： `dnf install marsshooter`
- Debian/Ubuntu 用户： `apt install marsshooter`
### 不存在之球Neverball
![](http://jbcdn2.b0.upaiyun.com/2019/01/8826dd45c14930d73b05e45a75bd9a49.png)
[不存在之球](https://neverball.org/index.php) 的游戏灵感来源自世嘉的 “超级猴子球Super Monkey Ball” ，玩家需要将一个球在 3D 球场上运动起来，但是玩家控制的不是球，而是球场。游戏任务是在规定的时限内，收集足够多的金币从而打开该关卡的出口并且将小球落进该洞中。游戏可以调整难度，从休闲到难以超乎想象，可以适应不同的玩家需求。该游戏支持键盘/鼠标以及控制杆操作。
安装不存在之球，你只需要在终端下运行以下指令:
- Fedora 用户：`dnf install neverball`
- Debian/Ubuntu 用户：`apt install neverball`
### 超级 TuxSuperTux
![](http://jbcdn2.b0.upaiyun.com/2019/01/bd1a5242f1cb1de3e27ef4ba2163c3e0.png)
