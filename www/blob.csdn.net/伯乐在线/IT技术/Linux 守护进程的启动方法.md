# Linux 守护进程的启动方法 - 文章 - 伯乐在线
原文出处： [阮一峰（@ruanyf）](http://www.ruanyifeng.com/blog/2016/02/linux-daemon.html)
“守护进程”（daemon）就是一直在后台运行的进程（daemon）。
本文介绍如何将一个 Web 应用，启动为守护进程。
![](http://jbcdn2.b0.upaiyun.com/2016/03/3ae0403d62bfcdf65f8dec74174e323b.png)
## 一、问题的由来
...
下一篇文章，我就来介绍[Systemd](http://blog.jobbole.com/?p=98667)。
