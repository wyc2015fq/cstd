# Linux TCP/IP 网络工具对比：net-tools 和 iproute2 - 文章 - 伯乐在线
原文出处： [Dan Nanni](http://xmodulo.com/2014/09/linux-tcpip-networking-net-tools-iproute2.html)   译文出处：[Linux.Cn-KayGuoWhu](https://linux.cn/article-4326-1.html)
...
![](http://jbcdn2.b0.upaiyun.com/2016/01/f49ddc5d7246ccfa57cd0f4a6c35d533.png)
### 显示所有已连接的网络接口
...
$ ip link show
```
![](http://jbcdn2.b0.upaiyun.com/2016/01/fc8dc2f37cef282fff8cca265db4a3f1.jpg)
### 激活或停用网络接口
...
![](http://jbcdn2.b0.upaiyun.com/2016/01/3f786e8f75a103af16461936b3959b3f.jpg)
### 为网络接口分配IPv6地址
...
```
![](http://jbcdn2.b0.upaiyun.com/2016/01/55ec83a724f84b0c2b422cd0db91bb67.jpg)
### 移除网络设备的IPv6地址
...
$ ip route show
```
![](http://jbcdn2.b0.upaiyun.com/2016/01/ead0dc89a01c12e48f9254b3f600411e.jpg)
### 添加和修改默认路由
...
$ ss -l
```
![](http://jbcdn2.b0.upaiyun.com/2016/01/d94da69846f8a84f25f25016839cc6d9.jpg)
### 查看ARP表
使用这些命令显示内核的ARP表。
使用**net-tools**:
...
$ ip neigh
```
![](http://jbcdn2.b0.upaiyun.com/2016/01/775915ac54612cfc2ace7ab1b61c733e.jpg)
### 添加或删除静态ARP项
