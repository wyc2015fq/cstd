# Nginx 配置简述 - 文章 - 伯乐在线
原文出处： [小胡子哥（@Barret李靖）](http://www.barretlee.com/blog/2016/11/19/nginx-configuration-start/)
...
![Nginx](http://jbcdn2.b0.upaiyun.com/2016/11/635ef04d374650792ae0732be0b1b293.jpg)
### 简介
...
```
启动后，访问 [htttp://127.0.0.1:8888](8888) ，如果 `/home/barret/test/` 下有 `index.html` 文件就会展示 `index.html` 的内容，否则返回 `404`。
### Nginx 配置一个 Web 服务器
...
location <a href="http://www.jobbole.com/members/baojiang9145">@other</a> {
