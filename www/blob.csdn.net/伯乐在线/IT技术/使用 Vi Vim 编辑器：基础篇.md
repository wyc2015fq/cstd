# 使用 Vi/Vim 编辑器：基础篇 - 文章 - 伯乐在线
原文出处： [LinuxTechLab](http://linuxtechlab.com/working-vi-editor-basics/)   译文出处：[Linux中国/Fan Li](https://linux.cn/article-9323-1.html)
...
- `d$` 删除从光标所在行开始的所有行
- `d^` 删除从文件开始直到光标所在行的所有行 4 `dw` 删除从光标所在位置直到下一个词开始的所有内容
### 复制与黏贴
