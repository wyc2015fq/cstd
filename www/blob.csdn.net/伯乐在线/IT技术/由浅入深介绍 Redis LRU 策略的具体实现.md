# 由浅入深介绍 Redis LRU 策略的具体实现 - 文章 - 伯乐在线
原文出处： [zxszcaijin](http://blog.chinaunix.net/uid-20708886-id-5753422.html)
...
分析
这里我们采用双向链表来实现元素(k-v键值对)的存储，同时采用hash表来存储相关的key与item的对应关系。这样，我们既能在O(1)的时间对key进行操作，同时又能利用Double LinkedList的添加和删除节点的便利性。(get/set都能在O(1)内完成)。![20708886_14766036335zay](http://jbcdn2.b0.upaiyun.com/2016/10/6faaf566c0e9a62cca9d82ecb7f5eb2e.png)
具体实现(Python语言)
...
![20708886_14766044814007](http://jbcdn2.b0.upaiyun.com/2016/10/005b068f3e42702891978ae42098be66.jpg)
