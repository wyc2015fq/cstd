# 在 Linux 下截屏并编辑的最佳工具 - 文章 - 伯乐在线
原文出处： [Ankush Das](https://itsfoss.com/take-screenshot-linux/)   译文出处：[Linux中国/Hank Chow](https://linux.cn/article-10070-1.html)
> 
有几种获取屏幕截图并对其进行添加文字、箭头等编辑的方法，这里提及的的屏幕截图工具在 Ubuntu 和其它主流 Linux 发行版中都能够使用。
![在 Ubuntu Linux 中如何获取屏幕截图](http://jbcdn2.b0.upaiyun.com/2018/10/c6528446cd46bec21d44fdbab9664596.png)
...
![flameshot](http://jbcdn2.b0.upaiyun.com/2018/10/6df2fe79d764566dc213e3fd267a89f5.png)
功能概述：
- 注释 (高亮、标示、添加文本、框选)
- 图片模糊
- 图片裁剪
...
![](http://jbcdn2.b0.upaiyun.com/2018/10/faa7c46e876893f16c6028813d49c0bf.png)
*将键盘快捷键映射到 Flameshot*
### 方法 3：在 Linux 中使用 Shutter 获取屏幕截图并编辑
![](http://jbcdn2.b0.upaiyun.com/2018/10/e773fc115f2cf2b74c81e9d58d5b4a2d.jpg)
功能概述：
- 注释 (高亮、标示、添加文本、框选)
- 图片模糊
- 图片裁剪
...
![](http://jbcdn2.b0.upaiyun.com/2018/10/15aae087bc09bae009cda6211ab989cf.jpg)
功能概述：
