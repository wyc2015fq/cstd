# HTTPS 工作原理和 TCP 握手机制 - 文章 - 伯乐在线
原文出处： [coodoing](http://www.cnblogs.com/ttltry-air/archive/2012/08/20/2647898.html)
# 1、HTTPS的工作原理
...
（3）客户必须再次回应服务段一个ACK报文，这是报文段3。 ![](http://ww1.sinaimg.cn/large/7cc829d3gw1f7xujurrmwj20g30c6756.jpg)
**为什么需要“三次握手”**
...
![](http://ww4.sinaimg.cn/large/7cc829d3gw1f7xujw7rz9j20ds0andgn.jpg)
**为什么需要“四次挥手”**
那可能有人会有疑问，在tcp连接握手时为何ACK是和SYN一起发送，这里ACK却没有和FIN一起发送呢。原因是因为tcp是全双工模式，接收到FIN时意味将没有数据再发来，但是还是可以继续发送数据。
**握手，挥手过程中各状态介绍（详见wiki：[TCP](http://en.wikipedia.org/wiki/Transmission_Control_Protocol)）**
> 
**3次握手过程状态：**
...
CLOSED: 表示连接中断。
TCP的具体状态图可参考：
![](http://ww4.sinaimg.cn/large/7cc829d3gw1f7xumlfg9oj20k60g841l.jpg)
扩展资料：
- 1、[HTTPS那些事（一）HTTPS原理](http://www.guokr.com/post/114121/)
- 2、[HTTP协议详解](http://www.cnblogs.com/TankXiao/archive/2012/02/13/2342672.html)
- 3、[Wiki：TCP](http://en.wikipedia.org/wiki/Transmission_Control_Protocol)
- 4、[HTTP协议及其POST与GET操作差异](http://www.cnblogs.com/skynet/archive/2010/05/18/1738301.html)
