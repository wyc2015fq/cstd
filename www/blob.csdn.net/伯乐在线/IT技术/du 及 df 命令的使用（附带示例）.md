# du 及 df 命令的使用（附带示例） - 文章 - 伯乐在线
原文出处： [shusain](http://linuxtechlab.com/du-df-commands-examples/)   译文出处：[Linux中国/geekpi](https://linux.cn/article-9457-1.html)
...
$ du /home
```
![du command](http://jbcdn2.b0.upaiyun.com/2018/03/a7080196ba5d69aefcecf7bbf44c9556.jpg)
...
$ du -h /home
```
![du command](http://jbcdn2.b0.upaiyun.com/2018/03/1b9dd42d7efa627e663eeb719c31051b.jpg)
#### 3、 目录的总磁盘大小
...
$ du -s /home
```
![du command](http://jbcdn2.b0.upaiyun.com/2018/03/3d49dd172fc018cabd4747f4db263811.jpg)
它是 `/home` 目录的总大小
### df 命令
...
$ df
```
![df command](http://jbcdn2.b0.upaiyun.com/2018/03/ab5724c46d3e98a63c869827c65cd227.jpg)
#### 2、 人类可读格式的信息
...
$ df -h
```
![df command](http://jbcdn2.b0.upaiyun.com/2018/03/5e54bd24a629aad15d72114b57687e18.jpg)
上面的命令以人类可读格式显示信息。
#### 3、 显示特定分区的信息
...
$ df -hT /etc
```
![df command](http://jbcdn2.b0.upaiyun.com/2018/03/5b29e87fdba47b650c6958d569d553c2.jpg)
