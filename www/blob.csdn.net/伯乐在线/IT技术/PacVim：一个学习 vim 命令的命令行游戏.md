# PacVim：一个学习 vim 命令的命令行游戏 - 文章 - 伯乐在线
原文出处： [Sk](https://www.ostechnix.com/pacvim-a-cli-game-to-learn-vim-commands/)   译文出处：[Linux中国/geekpi](https://linux.cn/article-9738-1.html?pr)
![](http://jbcdn2.b0.upaiyun.com/2018/06/57beea594a88813722998ea81bc96125.png)
...
![](http://jbcdn2.b0.upaiyun.com/2018/06/89a95a6695047749834d9662e67957f2.png)
要开始游戏，只需按下回车。
![](http://jbcdn2.b0.upaiyun.com/2018/06/aeb1e44f7421aad3ecab3a2937083929.png)
现在开始游戏。阅读下一节了解如何玩。
要退出，请按下 `ESC` 或 `q`。
以下命令以困难模式启动游戏第 `5` 关。
