# 20 个 OpenSSH 最佳安全实践 - 文章 - 伯乐在线
原文出处： [Vivek Gite](https://www.cyberciti.biz/tips/linux-unix-bsd-openssh-server-best-practices.html)   译文出处：[Linux中国/shipsw](https://linux.cn/article-9394-1.html)
...
```
![OpenSSH 服务安全最佳实践](http://jbcdn2.b0.upaiyun.com/2018/03/8a0f95a8ae7fc345dc09338c5fa70583.png)
...
$ ssh -Q key
```
![OpenSSH安全教程查询密码和算法选择](http://jbcdn2.b0.upaiyun.com/2018/03/01f18d7dbf3c663c1e4e51d9efddd873.jpg)
...
```
### 其他建议
- [使用 2FA 加强 SSH 的安全性](https://www.cyberciti.biz/open-source/howto-protect-linux-ssh-login-with-google-authenticator/) – 可以使用 [OATH Toolkit](http://www.nongnu.org/oath-toolkit/) 或 [DuoSecurity](https://duo.com) 启用多重身份验证。
- [基于密匙链的身份验证](https://www.cyberciti.biz/faq/ssh-passwordless-login-with-keychain-for-scripts/) – 密匙链是一个 bash 脚本，可以使得基于密匙的验证非常的灵活方便。相对于无密码密匙，它提供更好的安全性。
### 更多信息
