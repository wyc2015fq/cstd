# 穷人的持续集成与持续交付（下） - 文章 - 伯乐在线
原文出处： [邱俊涛（@正反反长）](http://icodeit.org/2016/01/a-poor-mans-cd-part2/)
# 客户端程序的的持续交付
[上篇文章](http://blog.jobbole.com/97109/)介绍了如何使用一些免费的服务来实现服务器端API的持续集成、持续交付环境的搭建。有了服务端，自然需要有消费者，在本文中我们将使用另外一个工具来实现纯前端的站点的部署。
其中包括：
- 持续集成（单元测试，集成测试等）
- 持续部署/持续交付
- 静态站点托管
...
我们的应用最后看起来是这样子的。
![bookmarks app](http://ww1.sinaimg.cn/large/0064cTs2jw1ezvdnm9zm8j30m80e0q4d.jpg)
## 技术选型
...
gulp
```
![Snap CI unit](http://ww1.sinaimg.cn/large/0064cTs2jw1ezvdnqs0nvj30m80c1wep.jpg)
...
```
![Snap CI logs](http://ww3.sinaimg.cn/large/0064cTs2jw1ezvdnokc0aj30m80g2n3i.jpg)
### 部署
...
![AWS S3](http://ww3.sinaimg.cn/large/0064cTs2jw1ezvdnkbfszj30m806udhb.jpg)
...
![snap ci pipeline](http://ww3.sinaimg.cn/large/0064cTs2jw1ezvdnqcwnsj30m80g2q6e.jpg)
