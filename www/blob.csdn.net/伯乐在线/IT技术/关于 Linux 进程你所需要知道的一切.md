# 关于 Linux 进程你所需要知道的一切 - 文章 - 伯乐在线
原文出处： [Aaron Kili](http://www.tecmint.com/linux-process-management/)   译文出处：[ictlyh](https://linux.cn/article-8451-1.html)
...
![Linux 进程状态](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093035wd0ly8pppjc0fo8o.png)
*Linux 进程状态*
### 在 Linux 中创建进程
...
# pidof httpd
```
![查找 Linux 进程 ID](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093035lfx9l4zhhf6xelyx.png)
*查找 Linux 进程 ID*
...
$ echo $PPID
```
![查找 Linux 父进程 ID](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093035qz92snskbzi2d3ed.png)
*查找 Linux 父进程 ID*
### 在 Linux 中启动进程
...
# cloudcmd
```
![启动 Linux 交互进程](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093036n3fss8efrh7edfdr.png)
*启动 Linux 交互进程*
#### Linux 后台任务
...
# jobs
```
![在后台启动 Linux 进程](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093036yzo2fnei5ici9oii.png)
*在后台启动 Linux 进程*
...
# fg %1
```
![Linux 后台进程任务](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093036lhy8xqnf5yzffyyy.png)
*Linux 后台进程任务*
...
# ps -e | head
```
![列出 Linux 活跃进程](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093037fg0vsxpivovwxk0u.png)
*列出 Linux 活跃进程*
#### 2. top – 系统监控工具
...
# top
```
![列出 Linux 正在运行的程序](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093037zssr5b6tqnqnx6c2.png)
*列出 Linux 正在运行的程序*
...
# glances
```
![Glances - Linux 进程监控](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093038zt91ht6xg9o2fgmo.png)
*Glances – Linux 进程监控*
...
- [监控 Linux 性能的 20 个命令行工具](http://www.tecmint.com/command-line-tools-to-monitor-linux-performance/)
- [13 个有用的 Linux 监控工具](http://www.tecmint.com/linux-performance-monitoring-tools/)
### 如何在 Linux 中控制进程
...
$ pgrep -u tecmint glances
```
![控制 Linux 进程](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093038u3hxhdtwzj8iz38j.png)
*控制 Linux 进程*
想要深入了解如何使用这些命令，在 Linux 中杀死/终止活跃进程，可以点击下面的链接：
- [终止 Linux 进程的 Kill、Pkill 和 Killall 命令指南](http://www.tecmint.com/how-to-kill-a-process-in-linux/)
- [如何在 Linux 中查找并杀死进程](http://www.tecmint.com/find-and-kill-running-processes-pid-in-linux/)
注意当你系统僵死freeze时你可以使用它们杀死 [Linux 中的不响应程序](http://www.tecmint.com/kill-processes-unresponsive-programs-in-ubuntu/)。
#### 给进程发送信号
...
$ kill -l
```
![列出所有 Linux 信号](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093038dn9ll1v2xs4cln7c.png)
*列出所有 Linux 信号*
...
$ top
```
![列出 Linux 正在运行的进程](https://dn-linuxcn.qbox.me/data/attachment/album/201704/27/093037zssr5b6tqnqnx6c2.png)
*列出 Linux 正在运行的进程*
...
- [Linux 进程管理：启动、停止以及中间过程](http://www.tecmint.com/rhcsa-exam-boot-process-and-process-management/)
- [使用 ‘top’ 命令 Batch 模式查找内存使用最高的 15 个进程](http://www.tecmint.com/find-processes-by-memory-usage-top-batch-mode/)
- [在 Linux 中查找内存和 CPU 使用率最高的进程](http://www.tecmint.com/find-linux-processes-memory-ram-cpu-usage/)
- [在 Linux 中如何使用进程 ID 查找进程名称](http://www.tecmint.com/find-process-name-pid-number-linux/)
