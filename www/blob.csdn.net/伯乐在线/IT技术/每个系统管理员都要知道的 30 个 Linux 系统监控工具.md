# 每个系统管理员都要知道的 30 个 Linux 系统监控工具 - 文章 - 伯乐在线
原文出处： [Vivek Gite](https://www.cyberciti.biz/tips/top-linux-monitoring-tools.html)   译文出处：[jessie-pang](https://linux.cn/article-9373-1.html)
...
![](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003617yrapgeguzhzegrjm.jpg)
*图 01：Linux top 命令*
#### top 的常用快捷键
常用快捷键列表：
|快捷键|用法|
...
### 3. w – 找出登录的用户以及他们在做什么
[w 命令](https://www.cyberciti.biz/faq/unix-linux-w-command-examples-syntax-usage-2/) 显示了当前登录在该系统上的用户及其进程。
...
- 基于二层地址的网络流量统计
![Fig.02: General interface statistics: IP traffic statistics by network interface ](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003617vegee3q22m51fng5.png)
*图 02：常规接口统计：基于网络接口的 IP 流量统计*
![Fig.03 Network traffic statistics by TCP connection](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003617afed2848vd2dfufw.png)
...
```
输出示例：
![iotop monitoring linux disk read write IO](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003617v0k9dgp548dgwd0t.jpg)
...
```
输出示例：
![htop process viewer for Linux](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003618lfboctxr5s1zoash.jpg)
...
$ atop
```
![atop Command Line Tools to Monitor Linux Performance](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003618uffd9f955nz8mc9n.jpg)
...
- [lastcomm 命令](https://www.cyberciti.biz/faq/linux-unix-lastcomm-command-examples-usage-syntax/)：显示已执行过的命令
...
$ sudo nethogs
```
![nethogs linux monitoring tools open source](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003618dnv8ux8nukoo5nvv.jpg)
...
$ sudo iftop
```
![iftop in action](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003618eekdbv23qho62fdk.gif)
...
$ vnstat
```
![vnstat linux network traffic monitor](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003619j0qz1eb3gqv43pq3.jpg)
相关链接：
...
$ nmon
```
![nmon command](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003619wvfjn0m0fjsmgxwl.jpg)
...
$ glances
```
![Glances](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003619rlt3p5pp3ge5jg45.jpg)
...
![Fig.05 KDE System Guard](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003619r9blsmq55lgw1uss.png)
...
- 文件系统
- 列出所有挂载的文件系统及其基本信息
![Fig.06 The Gnome System Monitor application](https://dn-linuxcn.qbox.me/data/attachment/album/201802/23/003620wb8m90lmmp8e4wex.png)
*图 06：Gnome 系统监控程序*
### 福利：其他工具
更多工具：
...
- [ntop](https://www.cyberciti.biz/faq/debian-ubuntu-install-ntop-network-traffic-monitoring-software/) 基于网页的工具 – `ntop` 是查看网络使用情况的最佳工具，与 `top` 命令之于进程的方式类似，即网络流量监控工具。您可以查看网络状态和 UDP、TCP、DNS、HTTP 等协议的流量分发。
