# Git 的 4 个阶段的撤销更改 - 文章 - 伯乐在线
原文出处： [张京](https://www.fengerzh.com/git-reset/)
![](http://wx1.sinaimg.cn/mw690/63918611gy1fltan48ktfj21hm12y7f5.jpg)
...
# 基本概念
## 3个步骤
![](http://wx2.sinaimg.cn/mw690/63918611gy1fltan4vu1cj20m80463yo.jpg)
...
```
- `git add .`把所有文件放入`暂存区`；
- `git commit`把所有文件从`暂存区`提交进`本地仓库`；
...
![](http://wx2.sinaimg.cn/mw690/63918611gy1fltan5a4xuj20fi07z3zc.jpg)
...
![](http://wx2.sinaimg.cn/mw690/63918611gy1fltan5m82pj20ag01rt8l.jpg)
...
![](http://wx1.sinaimg.cn/mw690/63918611gy1fltan637jhj20en076aas.jpg)
...
```
来进行撤销操作。
![](http://wx4.sinaimg.cn/mw690/63918611gy1fltan6hur7j20c9075jrr.jpg)
...
git push -f
```
![](http://wx2.sinaimg.cn/mw690/63918611gy1fltan6vs0lj20di04d0td.jpg)
# 总结
