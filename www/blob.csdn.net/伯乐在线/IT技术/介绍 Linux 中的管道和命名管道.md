# 介绍 Linux 中的管道和命名管道 - 文章 - 伯乐在线
原文出处： [Archit Modi](https://opensource.com/article/18/8/introduction-pipes-linux)   译文出处：[Linux中国/geekpi](https://linux.cn/article-9992-1.html)
> 
要在命令间移动数据？使用管道可使此过程便捷。
![](http://jbcdn2.b0.upaiyun.com/2018/09/a836f3cdf91cb1dcf551a3cd4f561da6.jpg)
...
![](http://jbcdn2.b0.upaiyun.com/2018/09/49dba0a934014ce2131193852491b64b.png)
...
![](http://jbcdn2.b0.upaiyun.com/2018/09/e3d27db16394809cf34d6b6a978c73f4.png)
如上所示，`ls -al` 命令的输出被重定向到 `contents.txt` 并插入到文件中。类似地，`tail` 命令的输入通过 < `符号从 `contents.txt` 读取。`
![](http://jbcdn2.b0.upaiyun.com/2018/09/55c8812ac4c408cd865f535200ce69c1.png)
![](http://jbcdn2.b0.upaiyun.com/2018/09/1cecee49e0d70b57db6356204b09b1ae.png)
