# Linux 命令行工具使用小贴士及技巧（3） - 文章 - 伯乐在线
原文出处： [Ansh](https://www.howtoforge.com/tutorial/linux-command-line-tips-tricks-part-3-cdpath/)   译文出处：[HaitaoBio](https://linux.cn/article-8387-1.html)
在这个系列的[第一部分](http://blog.jobbole.com/110739/)，我们详细地讨论了 `cd -` 命令，在[第二部分](http://blog.jobbole.com/110774/)，我们深入探究了 `pushd` 和 `popd` 两个命令，以及它们使用的场景。
