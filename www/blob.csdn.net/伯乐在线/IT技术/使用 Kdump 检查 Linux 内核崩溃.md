# 使用 Kdump 检查 Linux 内核崩溃 - 文章 - 伯乐在线
原文出处： [opensource](https://opensource.com/article/17/6/kdump-usage-and-internals)   译文出处：[Linux中国/firmianay](https://linux.cn/article-8737-1.html)
> 
...
[https://v.qq.com/x/page/k0531jsbps7.html](https://v.qq.com/x/page/k0531jsbps7.html)
### kdump: 端到端流
下图展示了流程图。必须在引导“第一内核”期间为捕获内核保留 crashkernel 的内存。您可以在内核命令行中传递 `crashkernel=Y@X`，其中 `@X` 是可选的。`crashkernel=256M` 适用于大多数 x86_64 系统；然而，为崩溃内核选择适当的内存取决于许多因素，如内核大小和 initramfs，以及 initramfs 中包含的模块和应用程序运行时的内存需求。有关传递崩溃内核参数的更多方法，请参阅 [kernel-parameters 文档](https://github.com/torvalds/linux/blob/master/Documentation/admin-guide/kernel-parameters.txt)。
![pratyush_f1.png](http://jbcdn2.b0.upaiyun.com/2017/08/673c86f0c1d5d2c8ade8526b1370a25f.png)
...
![pratyush_f2.png](http://jbcdn2.b0.upaiyun.com/2017/08/85d3f4c654785d18b750564db21ded7b.png)
