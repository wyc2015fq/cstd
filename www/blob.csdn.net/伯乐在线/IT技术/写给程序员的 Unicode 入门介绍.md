...
英文出处：[Nathan Reed](http://reedbeta.com/blog/programmers-intro-to-unicode/)。欢迎加入[翻译组](https://github.com/jobbole/translation-project)。
![](http://wx3.sinaimg.cn/large/63918611gy1ffv4y7078mj20a200qmx6.jpg)
程序员世界对这个名字发自内心的恐惧和敬畏。我们都知道在我们的软件中应该 “支持 Unicode”（无论是什么意思——对所有的字符串使用 wchar_t，是吗？）。但 Unicode 很深奥，它有千页的 [Unicode 标准](http://www.unicode.org/versions/latest/)，还有几十页的补充附录、报告和[注解](http://www.unicode.org/notes/)，简直太吓人了。即使 Unicode 诞生 30 多年后，程序员们还觉得它很神秘。
...
然而，Unicode 的目标是准确地表示全世界的书写系统（writing systems）。Unicode 协会的目标是“让全世界的人们不论什么语言都可以使用电脑”，所以你可想见，书面语言的多样性是巨大的！迄今为止，Unicode 支持135 种不同的书写系统，包含约 1100 种语言，但目前还有超过 [100 种书写系统没有支持](http://linguistics.berkeley.edu/sei/)，包括现代的和已成为历史的，Unicode 协会还在努力将其加进来。
...
![](http://wx4.sinaimg.cn/large/63918611gy1ffv3s279ehj20x615e3ye.jpg)
- 白色表示未用空间；
- 蓝色表示已用空间；
- 绿色表示自用区域；
...
![](http://wx1.sinaimg.cn/large/63918611gy1ffv530saw0j20zk0k04b3.jpg)
### 书写系统
让我们放大前三个面板，因为这是最重要的部分：
![](http://wx1.sinaimg.cn/large/63918611gy1ffv3s5u04zj21dw0h0jre.jpg)
...
![](http://wx2.sinaimg.cn/large/63918611gy1ffv3s9a237j21dw0h040p.jpg)
...
![](http://wx4.sinaimg.cn/large/63918611gy1ffv3scnzygj20jl04b0ts.jpg)
