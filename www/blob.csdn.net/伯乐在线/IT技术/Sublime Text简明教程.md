# Sublime Text简明教程 - 文章 - 伯乐在线
原文出处： [saymagic（@say_magic）](http://blog.saymagic.cn/2015/01/01/sublime_text_concise_course.html)
## 安装Sublime Text
...
![http://cdn.saymagic.cn/150101214652.41.59.png](http://ww2.sinaimg.cn/large/0064cTs2jw1ezoo9oog8nj30y30hg3zf.jpg)
...
Sublime默认有个特别蛋疼的是每次打开一个文件都会新建一个窗口，特别让人抓狂，我们接下来就通过配置文件将其修改掉。首先，选中左上角的Sublime Text -> Preference -> “Preferences.sublime-settings”，即可打开配置文件。按command+F 搜索 “open_files_in_new_window”，然后把true修改为false即可。
...
## 配合终端的使用
当我们想要用Sublime Text 打开一个文件的时候，我们首先需要找到文件，然后右键选择用Sublime Text打开，但对于习惯终端操作的人来说不是很方便，没关系，Sublime Text提供了终端打开文件的功能。Sublime Text的终端命令为`subl`,但需要注意的是`subl`命令默认不在环境变量里，所以我们需要将其添加到环境变量，`subl`的位置为`/Applications/Sublime Text.app/Contents/SharedSupport/bin `,我们需要讲这个路径添加到.bash_profile文件里。添加的方法我以前的文章也提过，这里不再重复，不会的话可以google。
...
![http://cdn.saymagic.cn/150101222824.28.03.png](http://ww4.sinaimg.cn/large/0064cTs2jw1ezoo9pg207j30ia0hbtak.jpg)
...
![http://cdn.saymagic.cn/150101231942.19.27.png](http://ww1.sinaimg.cn/large/0064cTs2jw1ezoo9ranuhj313h0emmyy.jpg)
## PackageControl
...
![http://cdn.saymagic.cn/150101212632.25.26.png](http://ww1.sinaimg.cn/large/0064cTs2jw1ezoo9mg278j30xw0hl43m.jpg)
...
![http://cdn.saymagic.cn/150101224810.46.45.png](http://ww4.sinaimg.cn/large/0064cTs2jw1ezoo9pyozxj30wf0aydht.jpg)
advancedNewFile是怎样提高新建文件速度呢？我们可以使用快捷键`command+alt+n`，Sublime Text底部会弹出输入框:
![http://cdn.saymagic.cn/150101225117.50.59.png](http://ww4.sinaimg.cn/large/0064cTs2jw1ezoo9qk3zej314005j74n.jpg)
...
![http://cdn.saymagic.cn/150101213519.05.52.png](http://ww4.sinaimg.cn/large/0064cTs2jw1ezoo9mwzotj30gc07zdhe.jpg)
PackageControl中有一款名字叫做SideBarEnhancements的插件可以增强sidebar的功能。打开命令模式－>进入pci界面->输入SideBarEnhancements回车安装：
![http://cdn.saymagic.cn/150101213847.gif](http://ww4.sinaimg.cn/large/0064cTs2jw1ezoo9noi53g30sm0gthdt.gif)
安装完成之后，效果如下：
![http://cdn.saymagic.cn/150101214015.gif](http://ww2.sinaimg.cn/large/0064cTs2jw1ezoo9o51aig30sm0g4n8b.gif)
