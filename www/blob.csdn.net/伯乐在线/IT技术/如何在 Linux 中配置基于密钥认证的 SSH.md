# 如何在 Linux 中配置基于密钥认证的 SSH - 文章 - 伯乐在线
原文出处： [SK](https://www.ostechnix.com/configure-ssh-key-based-authentication-linux/)   译文出处：[Linux中国/LuMing](https://linux.cn/article-10086-1.html)
### 什么是基于 SSH 密钥的认证？
