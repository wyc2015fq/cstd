# 在 Linux 下 9 个有用的 touch 命令示例 - 文章 - 伯乐在线
原文出处： [Pradeep Kumar](https://www.linuxtechi.com/9-useful-touch-command-examples-linux/)   译文出处：[Linux中国/MjSeven](https://linux.cn/article-9597-1.html)
...
```
`touch` 命令中使用的选项：
![touch-command-options](http://jbcdn2.b0.upaiyun.com/2018/05/6935db9d7347a8379097b2fa18a81a09.jpg)
...
![stat-command-output-linux](http://jbcdn2.b0.upaiyun.com/2018/05/1487299597cc1f3a1792992976c94fc6.jpg)
