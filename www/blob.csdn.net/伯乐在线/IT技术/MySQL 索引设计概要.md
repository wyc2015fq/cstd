# MySQL 索引设计概要 - 文章 - 伯乐在线
原文出处： [Draveness](http://draveness.me/sql-index-intro.html)
在关系型数据库中设计索引其实并不是复杂的事情，很多开发者都觉得设计索引能够提升数据库的性能，相关的知识一定非常复杂。
![Index-and-Performance](http://jbcdn2.b0.upaiyun.com/2017/09/e53f2b2cf119db0c59de9f83caa31f5e.jpg)
...
![Disk-IO](http://jbcdn2.b0.upaiyun.com/2017/09/3eef1adc99076fce083d3b1beea313fd.jpg)
除此之外，我们还需要知道数据库对数据的读取并不是以行为单位进行的，无论是读取一行还是多行，都会将该行或者多行所在的页全部加载进来，然后再读取对应的数据记录；也就是说，读取所耗费的时间与行数无关，只与页数有关。
![Page-DatabaseBufferPool](http://jbcdn2.b0.upaiyun.com/2017/09/61d440834e7684466865619054c05717.jpg)
...
![Disk-Random-IO](http://jbcdn2.b0.upaiyun.com/2017/09/0f07e5811a5dc125cc01482284cd2f3f.jpg)
...
![Disk-IO-Total-Time](http://jbcdn2.b0.upaiyun.com/2017/09/bdeb5251f80438e8d19027231912074a.jpg)
...
![Read-from-Memory](http://jbcdn2.b0.upaiyun.com/2017/09/249d4599ab96b6adc85b9c01c3682e7e.jpg)
...
![Sequential-Reads-from-Disk](http://jbcdn2.b0.upaiyun.com/2017/09/2312998ad76d8fb341969812487f1de4.jpg)
如果一个页面的大小为 4KB，那么 1s 的时间就可以读取 10000 个页，读取一个页面所花费的平均时间就是 0.1ms，相比随机读取的 10ms 已经降低了两个数量级，甚至比内存中读取数据还要快。
![Random-to-Sequentia](http://jbcdn2.b0.upaiyun.com/2017/09/9ebb7991b42865054e063cefb1a4347b.jpg)
数据页面的顺序读取有两个非常重要的优势：
...
![Thin-Index-and-Fat-Index](http://jbcdn2.b0.upaiyun.com/2017/09/305453471fa87c6a090eb4f92003e759.jpg)
> 
...
![Thin-Index-and-Clustered-Index](http://jbcdn2.b0.upaiyun.com/2017/09/d30e5ece6b40f3019e207a701d2c50ad.jpg)
...
![Filter-Facto](http://jbcdn2.b0.upaiyun.com/2017/09/f4149e33e1dccc5702864a629b300bf5.jpg)
...
![Combined-Filter-Facto](http://jbcdn2.b0.upaiyun.com/2017/09/f0e821466f63037631b10ca9bce799cb.jpg)
> 
...
![Same-Columns-Filter-Facto](http://jbcdn2.b0.upaiyun.com/2017/09/3a84a867b9d385867fa3e462cda4f376.jpg)
...
![Match-Columns-Filter-Columns](http://jbcdn2.b0.upaiyun.com/2017/09/98f9cda753228126ca4d454edfe18386.jpg)
...
![Three-Star-Index](http://jbcdn2.b0.upaiyun.com/2017/09/51b6a983ef0d571b7821f1c88738cf2f.jpg)
...
![Behind-Three-Star-Index](http://jbcdn2.b0.upaiyun.com/2017/09/8acc115991e8b8f008f9b0a768092dbd.jpg)
...
![Different-Stars-Index](http://jbcdn2.b0.upaiyun.com/2017/09/0623c023856da52e860cca75c59198a4.jpg)
