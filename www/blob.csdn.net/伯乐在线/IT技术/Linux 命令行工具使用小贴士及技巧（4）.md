# Linux 命令行工具使用小贴士及技巧（4） - 文章 - 伯乐在线
原文出处： [Ansh](https://www.howtoforge.com/tutorial/command-line-aliases-in-linux/)   译文出处：[ictlyh](https://linux.cn/article-8393-1.html)
到目前为止，在该系列指南中，我们已经讨论了 [cd –](http://blog.jobbole.com/110739/) 和 [pushd/popd 命令](http://blog.jobbole.com/110774/)的基本使用方法和相关细节，以及 [CDPATH 环境变量](http://blog.jobbole.com/110845/)。在这第四期、也是最后一期文章中，我们会讨论别名的概念以及你可以如何使用它们使你的命令行导航更加轻松和平稳。
