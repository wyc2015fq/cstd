# Pet：一个简单的命令行片段管理器 - 文章 - 伯乐在线
原文出处： [SK](https://www.ostechnix.com/pet-simple-command-line-snippet-manager/)   译文出处：[Linux中国/MjSeven](https://linux.cn/article-9600-1.html)
![](http://jbcdn2.b0.upaiyun.com/2018/05/310d11635ef5716e4028f2035c080286.png)
...
```
![](http://jbcdn2.b0.upaiyun.com/2018/05/1fa3f36d4576527b79f7052bfeac8ac1.png)
...
![](http://jbcdn2.b0.upaiyun.com/2018/05/7158fec67536c6b012992d5502083043.png)
#### 片段列表
要查看保存的片段，运行：
...
$ pet list
```
![](http://jbcdn2.b0.upaiyun.com/2018/05/22016dbcb67a4acd00cf651f0e35b9ec.png)
#### 编辑片段
如果你想编辑代码片段的描述或命令，运行：
...
![](http://jbcdn2.b0.upaiyun.com/2018/05/cf214a0ef38d5b40bc4432a0aade3021.png)
...
```
输入搜索字词或关键字以缩小搜索结果范围。
![](http://jbcdn2.b0.upaiyun.com/2018/05/8d353e209372d40f943c717f666c5b28.png)
#### 同步片段
首先，你需要获取访问令牌。转到此链接 [https://github.com/settings/tokens/new](https://github.com/settings/tokens/new) 并创建访问令牌（只需要 “gist” 范围）。
使用以下命令来配置 Pet：
