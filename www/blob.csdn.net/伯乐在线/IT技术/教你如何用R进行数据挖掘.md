# 教你如何用R进行数据挖掘 - 文章 - 伯乐在线
原文出处： [数据人-薛丽丹](http://shujuren.org/article/95.html)
## 教你用R进行数据挖掘
### 引言
...
 它是,数据分析公司高度寻求技能之一。
2、如何安装R / Rstudio?
你可以[https://www.r-project.org/官网下载并安装R，需要注意的是R的更新速度很快，下载新版本的体验会更好一些。](https://www.r-project.org/%E5%AE%98%E7%BD%91%E4%B8%8B%E8%BD%BD%E5%B9%B6%E5%AE%89%E8%A3%85R%EF%BC%8C%E9%9C%80%E8%A6%81%E6%B3%A8%E6%84%8F%E7%9A%84%E6%98%AFR%E7%9A%84%E6%9B%B4%E6%96%B0%E9%80%9F%E5%BA%A6%E5%BE%88%E5%BF%AB%EF%BC%8C%E4%B8%8B%E8%BD%BD%E6%96%B0%E7%89%88%E6%9C%AC%E7%9A%84%E4%BD%93%E9%AA%8C%E4%BC%9A%E6%9B%B4%E5%A5%BD%E4%B8%80%E4%BA%9B%E3%80%82)
另外,我建议你从RStudio开始，因为RStudio的界面编程体验更好一些。你可以通过[https://www.rstudio.com/products/rstudio/download/](https://www.rstudio.com/products/rstudio/download/) 在“支持的平台上安装”部分中, 根据您的操作系统选择您需要的安装程序。点击桌面图标RStudio,就开始你的编程体验，如下图所示：
![1](http://jbcdn2.b0.upaiyun.com/2016/06/28c8edde3d61a0411511d3b1866f063624.png)
让我们快速的了解:一下R界面
...
![2](http://jbcdn2.b0.upaiyun.com/2016/06/665f644e43731ff9db3d341da5c827e117.png)
1、数据集中基础概念
...
```
![3](http://jbcdn2.b0.upaiyun.com/2016/06/38026ed22fc1a91d92b5d2ef93540f2017.png)
...
```
![4](http://jbcdn2.b0.upaiyun.com/2016/06/011ecee7d295c066ae68d4396215c3d014.png)
...
```
![5](http://jbcdn2.b0.upaiyun.com/2016/06/4e44f1ac85cd60e3caa56bfd4afb675e8.png)
...
> summary(train)
```
![6](http://jbcdn2.b0.upaiyun.com/2016/06/3d2f8900f2e49c02b481c2f717aa902012.png)
...
> str(combi)
```
在本节中,我将介绍**回归、决策树和随机森林等算法**。这些算法的详细解释已经超出了本文的范围，如果你想详细的了解，推荐大家看机器学习的相关书籍。现在我们要将两个数据集分开，以便我们来进行预测建模。如下：
...
```
##### 1、多元线性回归
使用多元回归建模时，一般用于响应变量（因变量）是连续型和可供预测变量有很多时。如果它因变量被分类,我们一般会使用逻辑回归。在我们做回归前，我们先来了解一些回归的基本假设：
 在响应变量和自变量之间存在某种线性关系；
...
```
![7](http://jbcdn2.b0.upaiyun.com/2016/06/cd7fd1517e323f26c6f1b0b6b96e3b3d9.png)
...
> summary(linear_model)
```
![8](http://jbcdn2.b0.upaiyun.com/2016/06/815e6212def15fe76ed27cec7a393d596.png)
...
> plot(linear_model)
```
![9](http://jbcdn2.b0.upaiyun.com/2016/06/4c0d13d3ad6cc317017872e51d01b2385.png)
...
> summary(linear_model)
```
![10](http://jbcdn2.b0.upaiyun.com/2016/06/8d8e353b98d5191d5ceea1aa3eb05d435.png)
...
> plot(linear_model)
```
![11](http://jbcdn2.b0.upaiyun.com/2016/06/7bfc85c0d74ff05806e0b5a0fa0c1df114.png)
...
> print(tree_model)
```
![571f331fd8d9a](http://jbcdn2.b0.upaiyun.com/2016/06/1184bf3ddf634be99f8e2ab0e885edde1.png)
...
> 
prp(main_tree) #输出决策树
![12](http://jbcdn2.b0.upaiyun.com/2016/06/c8b2f17833a4c73bb20f88876219ddcd10.png)
...
> print(rf_model)
```
![2222](http://jbcdn2.b0.upaiyun.com/2016/06/d1d16c28c7674cfc5e269dbe1209f5521.png)
...
![13](http://jbcdn2.b0.upaiyun.com/2016/06/7e51746feafa7f2621f71943da8f603c8.png)
