# Git 与 Repo 入门 - 文章 - 伯乐在线
本文作者： [伯乐在线](http://blog.jobbole.com) - [AngelDevil](http://www.jobbole.com/members/angeldevil) 。未经作者许可，禁止转载！
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/72bc6f8213d6f1289dbec2b97903ee2d.jpg)
## 二、本地版本控制
手工管理比较麻烦且混乱，所以出现了本地版本控制系统，记录文件每次的更新，可以对每个版本做一个快照，或是记录补丁文件。比如RCS。
![](http://jbcdn2.b0.upaiyun.com/2016/05/62f94c78bbd3c7e8106fd25f1b44bbdd.png)
## 三、集中版本控制
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/5bd85f9f2f506677947823f97ac30185.png)
...
当然，这增加了本地存储空间的占用。
![](http://jbcdn2.b0.upaiyun.com/2016/05/61881ba4674adb1b43dbf65ed19d3fd2.png)
# GIT
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/f9b0b3fec754328993e99fbbed3dda37.png)
当我们往工作目录添加一个文件的时候，这个文件默认是未跟踪状态的，我们肯定不希望编译生成的一大堆临时文件默认被跟踪还要我们每次手动将这些文件清除出去。用以下命令可以跟踪文件：
> 
git add <file>
上图中右边3个状态都是已跟踪状态，其中的灰色箭头只表示untrackedtracked的转换而不是untrackedunmodified的转换，新添加的文件肯定算是被修改过的。那么，staged状态又是什么呢？这就要搞清楚GIT的三个工作区域：本地数据（仓库）目录，工作目录，暂存区，如下图所示：
![](http://jbcdn2.b0.upaiyun.com/2016/05/2c35c3f986c3aefb6d0e266223a781fd.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/265675ed0ee759ef9c7a24bf3052927f.png)
...
git diff
比如下图：
![](http://jbcdn2.b0.upaiyun.com/2016/05/8b95a8314b87c5f9fe5cd1c6a7258efa.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/159353248a2326fc7bed41e5628566e9.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/0cf6832c9e281dd109afcf7a4e197b7b.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/7acf68851c3d228f60d81b23206137d6.png)
### 移动文件
和移除文件一样，移动文件不可以通过GUI直接重命令或用”mv”命令，而是要用”git mv”，不然同移除文件一样你会得到如下结果：
![](http://jbcdn2.b0.upaiyun.com/2016/05/1c1a5ac647caf73dbf9b42948ce259dd.png)
如果要重命名文件可以使用
> 
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/a8918f638124712c5f6de13427df8171.png)
### 移除所有未跟踪文件
> 
...
### 查看提交历史
查看提交历史使用如下图的命令
![](http://jbcdn2.b0.upaiyun.com/2016/05/12d4c82ac34d49a29a7334d24ae2ec87.png)
如图所示，显示了作者，作者邮箱，提交说明与提交时间，”git log”可以使用放多参数，比如：
![](http://jbcdn2.b0.upaiyun.com/2016/05/e20a55e2730a3e014dd0b1eac030e3c3.png)
仅显示最新的1个log，用”-n”表示。
![](http://jbcdn2.b0.upaiyun.com/2016/05/c29388d8dc7ee6cb3407aeb99638cf5e.png)
...
假设我们的提交历史是这样的：
![](http://jbcdn2.b0.upaiyun.com/2016/05/cf9a8f719be24ad953f1a084fc2bba09.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/e9e20296233215241016e2f528eee7b3.png)
注释部分详细说明了每个选项的作用，如果我们想交互这两个提交，只需把开头的这两行交换下位置就OK了，交换位置后保存，然后看下提交历史：
![](http://jbcdn2.b0.upaiyun.com/2016/05/9bd90405ab104b31345ec45971705ea2.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/aae19301aa54f545678990e590302f1a.png)
如果进行多次提交，仓库的历史会像这样：
![](http://jbcdn2.b0.upaiyun.com/2016/05/549d893ab04e0ba16e67b5d714ebca88.png)
### 分支引用
所谓的GIT分支，其实就是一个指向某一个Commit对象的指针，像下面这样，有两个分支，master与testing：
![](http://jbcdn2.b0.upaiyun.com/2016/05/d553d9d93a77d7f2e57364ad625cd80b.png)
而我们怎么知道当前在哪一个分支呢？其实就是很简单地使用了一个名叫HEAD的指针，如上图所示。HEAD指针的值可以为一个SHA-1值或是一个引用，看以下例子：
![](http://jbcdn2.b0.upaiyun.com/2016/05/ec99c6682e174d8e59987ce1d29b8061.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/39133ba831f75975758f69d0d9563148.png)（merge）
![](http://jbcdn2.b0.upaiyun.com/2016/05/94b01c865739f4b13eb45f75441b50c6.png)（rebase）
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/3daa774479b0ee0c2fd46ce98d9139d6.png)
## 八、其他
...
这个命令可以撤销整个工程的本地修改。
说明：文中关于Git的知识大多来自Pro-GIt，这本书感觉不错，想学习的可以找来看：[Pro-Git](http://git-scm.com/book/zh)
> 
**打赏支持我写出更多好文章，谢谢！**
[打赏作者](#rewardbox)
#### 打赏支持我写出更多好文章，谢谢！
任选一种支付方式
![](http://jbcdn2.b0.upaiyun.com/2016/09/c5e42799d113d429836b0938c12503ae.jpg)![](http://jbcdn2.b0.upaiyun.com/2016/09/5d90f02b3f87e95bd9133b56e56331ee.jpg)
