# Nginx 日志分析及性能排查 - 文章 - 伯乐在线
原文出处： [oschina](https://my.oschina.net/362228416/blog/844713)
...
```
![每分钟的访问量](http://jbcdn2.b0.upaiyun.com/2017/02/21a8199b39971b96c166adafa977a412.png)
...
```
![可视化页面](http://jbcdn2.b0.upaiyun.com/2017/02/7811d2ea21165b8430d893b57143a8be.png)
...
```
但是这种实时的方式，还需要ssh远程登录，不太方便，还可以使用lua来进行实时统计，然后写一个界面把数据展示出来，通过[lua-nginx-module](https://github.com/openresty/lua-nginx-module)，nginx/tengine 都可以用，如果直接安装openresty的话，就方便了，内嵌了lua，不需要重新编译nginx了，openresty的入门可以看我写的一些[文章](https://github.com/362228416/openresty-web-dev)
以上～～～
