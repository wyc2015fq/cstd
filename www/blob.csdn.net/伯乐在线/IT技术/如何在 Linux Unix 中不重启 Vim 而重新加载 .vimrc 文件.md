# 如何在 Linux/Unix 中不重启 Vim 而重新加载 .vimrc 文件 - 文章 - 伯乐在线
原文出处： [Vivek Gite](https://www.cyberciti.biz/faq/how-to-reload-vimrc-file-without-restarting-vim-on-linux-unix/)   译文出处：[Linux中国/geekpi](https://linux.cn/article-9392-1.html)
...
syntax on
```
- 使用 `:wq` 保存文件，并从 `~/.vimrc` 窗口退出
- 输入下面任一命令重载 `~/.vimrc`：`:so $MYVIMRC` 或者 `:source ~/.vimrc`。
![How to reload .vimrc file without restarting vim](http://jbcdn2.b0.upaiyun.com/2018/02/60581ae8d4e6aedf13e41be2a2c5c1dd.jpg)
...
via: [https://www.cyberciti.biz/faq/how-to-reload-vimrc-file-without-restarting-vim-on-linux-unix/](https://www.cyberciti.biz/faq/how-to-reload-vimrc-file-without-restarting-vim-on-linux-unix/)
