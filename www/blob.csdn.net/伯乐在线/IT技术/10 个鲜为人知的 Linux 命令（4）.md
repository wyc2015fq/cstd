# 10 个鲜为人知的 Linux 命令（4） - 文章 - 伯乐在线
原文出处： [Tecmint](https://linux.cn/article-2404-1.html)   译文出处：[Linux中国/geekpi](https://linux.cn/article-2404-1.html)
继续我们的”鲜为人知”系列，本系列的第四篇会让你了解一些**有趣**又**动态**的命令。这里我们进入实际的教程，没有很多理论。
![](http://jbcdn2.b0.upaiyun.com/2017/11/439cfc12a2cdbbb44fb31f0011e23a71.png)
- [11 个鲜为人知的 Linux 命令（1）](http://blog.jobbole.com/112817/)
- [10 个鲜为人知的 Linux 命令（2）](http://blog.jobbole.com/112820/)
- [10 个鲜为人知的 Linux 命令（3）](http://blog.jobbole.com/112836/)
...
```
![在终端下显示日期](http://jbcdn2.b0.upaiyun.com/2017/11/a9559c6b705bc2550c947d3af3f62670.jpg)
### 36. convert 命令
在写教程的时候，我经常需要生成输出，很多时候是图片格式的输出。上面的命令集合并不适合我。假设我需要tree命令的图片格式的输出(对 **/etc/x11** 目录 )。


```
root@tecmint:/etc/X11# tree | convert label:<a href="http://www.jobbole.com/members/lourenfu">@-</a> /home/avi/tree.png
```
...
root@tecmint [~]# dstat
```
![dstat 命令](http://jbcdn2.b0.upaiyun.com/2017/11/9b7546b8eceaafe962a495954b1b792e.jpeg)
### 40. bind -p 命令
