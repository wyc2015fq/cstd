# 一次完整的 HTTP 请求过程 - 文章 - 伯乐在线
本文作者： [伯乐在线](http://blog.jobbole.com) - [刘志军](http://www.jobbole.com/members/liuzhijun) 。未经作者许可，禁止转载！
...
[<message-body>]
```
![request-format](http://jbcdn2.b0.upaiyun.com/2016/10/c0cdafd8bdb8d0c87b3c35498aa0417f.png)
...
[<message-body>]
```
![response-format](http://jbcdn2.b0.upaiyun.com/2016/10/fb7d113c2dd70ef44cd93efffb172b51.png)
...
![%e8%a1%a81](http://jbcdn2.b0.upaiyun.com/2016/10/391868c33e744ea238c8cb4f3a6c1107.jpg)
### Socket 对象方法
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        conn.close()
```
浏览器访问地址：[http://localhost:8000](http://localhost:8000)
![http](http://jbcdn2.b0.upaiyun.com/2016/10/77b95cf4ea96167b7e2b32dae3b21f74.jpg)
参考：
- [Response](https://www.w3.org/Protocols/rfc2616/rfc2616-sec6.html)
- [Request](https://www.w3.org/Protocols/rfc2616/rfc2616-sec5.html#sec5)
- [Scoket](https://docs.python.org/2/library/socket.html#socket.socket)
> 
**打赏支持我写出更多好文章，谢谢！**
[打赏作者](#rewardbox)
#### 打赏支持我写出更多好文章，谢谢！
![](http://jbcdn2.b0.upaiyun.com/2017/07/70024e36fc00b008e9db72238c9d345c.jpg)
