# 从0到1搭建移动App功能自动化测试平台 (4)：自动化测试代码⎡工程化⎦ - 文章 - 伯乐在线
原文出处： [debugtalk](http://debugtalk.com/post/build-app-automated-test-platform-from-0-to-1-refactor-testcase-scripts/)
在本系列的[上一篇文章](http://blog.jobbole.com/101781/)中，我通过系统登录这一典型功能点，演示了编写自动化测试脚本的整个流程，并对测试脚本进行了初步优化。
...
![](http://debugtalk.com/images/testcase_login_and_logout.png)
