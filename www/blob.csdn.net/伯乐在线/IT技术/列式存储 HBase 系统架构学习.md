...
# 七、hbase 集群的搭建及使用
- [分布式实时日志系统（四） 环境搭建之centos 6.4下hbase 1.0.1 分布式集群搭建](http://ixirong.com/2015/05/25/how-to-install-hbase-cluster/) 文中介绍了集群的搭建过程，提供了一键安装的脚本。
