...
![RGB color cube](http://jbcdn2.b0.upaiyun.com/2018/09/a1a9eb3d2a3819ce5e549378e91707f4.png)
...
# 参考
- [Color Quantization](http://tpgit.github.io/UnOfficialLeptDocs/leptonica/color-quantization.html)
- [Color quantization using modified median cut](http://leptonica.com/papers/mediancut.pdf)
- [Median-Cut Color Quantization](http://collaboration.cmc.ec.gc.ca/science/rpn/biblio/ddj/Website/articles/DDJ/1994/9409/9409e/9409e.htm)
- [Wicked Code](http://www.microsoft.com/msj/archive/S3F1.aspx)
- [Clustering – scikit-learn](http://scikit-learn.org/stable/modules/clustering.html#k-means)
- [Color Quantization using K-Means](http://scikit-learn.org/stable/auto_examples/cluster/plot_color_quantization.html)
- [Extract Color Themes from Images](https://github.com/rainyear/ImageColorTheme)
