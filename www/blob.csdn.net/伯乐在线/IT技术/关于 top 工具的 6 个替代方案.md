# 关于 top 工具的 6 个替代方案 - 文章 - 伯乐在线
原文出处： [SK](https://www.ostechnix.com/some-alternatives-to-top-command-line-utility-you-might-want-to-know/)   译文出处：[Linux中国/Hank Chow](https://linux.cn/article-10323-1.html)
...
$ htop
```
![](http://jbcdn2.b0.upaiyun.com/2018/12/b815aac59b4db9f3f43949869f123a85.png)
...
```
显示界面如下：
![](http://jbcdn2.b0.upaiyun.com/2018/12/291e28ac038fd3d6aad11b0dadd3e0f9.png)
...
```
显示界面如下：
![](http://jbcdn2.b0.upaiyun.com/2018/12/fc16fc03e2eb72d248635a13ed19ff67.png)
...
```
就像下面这样：
![](http://jbcdn2.b0.upaiyun.com/2018/12/d29e2d1359367c23284804b5a179ff78.png)
`ptop` 的快捷键包括以下这些：
- `Ctrl+k`：杀死一个进程。
- `Ctrl+n`：按照内存使用量对进程排序。
