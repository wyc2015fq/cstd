# 手把手指导您使用 Git - 文章 - 伯乐在线
原文出处： [Kedar Vijay Kulkarni](https://opensource.com/article/18/1/step-step-guide-git)   译文出处：[Linux中国/ChenYi](https://linux.cn/article-9319-1.html)
...
![](http://jbcdn2.b0.upaiyun.com/2018/06/2ea0e8b205ec27442832ce5b1e0c4b8e.png)
选择一个用户名（比如说，octocat123），输入您的邮箱地址和密码，然后点击 **Sign up for GitHub**。进入之后，您将看到下方插图的界面：
![](http://jbcdn2.b0.upaiyun.com/2018/06/40cb004cd0b2c76974a758187dd42609.png)
### 步骤 2：创建一个新的仓库
一个仓库（ repository），类似于能储存物品的场所或是容器；在这里，我们创建仓库存储代码。在 `+` 符号（在插图的右上角，我已经选中它了） 的下拉菜单中选择 **New Repository**。
![](http://jbcdn2.b0.upaiyun.com/2018/06/03428a7fdaed912f2fe0b4cd3d7e6b21.png)
给您的仓库命名（比如说，Demo）然后点击 **Create Repository**。无需考虑本页面的其他选项。
恭喜！您已经在 GitHub.com 中建立了您的第一个仓库。
### 步骤 3: 创建文件
当仓库创建完毕后，界面将和下方一致：
![](http://jbcdn2.b0.upaiyun.com/2018/06/495f98aaf52d221a19f36c00fab9f348.png)
不必惊慌，它比看上去简单。跟紧步骤。忽略其他内容，注意截图上的 “…or create a new repository on the command line,”。
在您的计算机中打开终端。
![](http://jbcdn2.b0.upaiyun.com/2018/06/2d4acbf3a6a04a52708163d0e0076ab6.png)
...
![](http://jbcdn2.b0.upaiyun.com/2018/06/dc452e9264aa58b7502df5c06069e24c.png)
...
![](http://jbcdn2.b0.upaiyun.com/2018/06/8ca11bf5cd5069c6edbc8b5081048f10.png)
此刻我们已经连接到远程仓库，可以推送我们的代码 到 GitHub.com（例如上传 `README.md` 文件）。
执行完毕后，您的终端会显示如下信息：
![](http://jbcdn2.b0.upaiyun.com/2018/06/ad6f842634493d3eb98b683488023800.png)
然后，如果您访问 `https://github.com/<your_username>/Demo`，您会看到截图内显示的情况：
![](http://jbcdn2.b0.upaiyun.com/2018/06/b09c603947a63405fe70e869b60c3b34.png)
