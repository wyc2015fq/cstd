# React 许可证的五宗罪 - 文章 - 伯乐在线
原文出处： [Simon Phipps](https://opensource.com/article/17/9/5-reasons-facebooks-react-license-was-mistake)   译文出处：[Linux中国/薛亮](https://linux.cn/article-8876-1.html)
> 
...
- 不公平的比赛场
Facebook 使用的专利授权条款为其提供了特殊权利和保护，而项目中的其他人并不享有。这使得开源开发人员感到紧张，原因与[贡献者协议](https://webmink.com/2010/09/01/copyright-aggregation/)（contributor agreements）一样。开源项目的软件自由的全部价值在于它创造了一个[安全的空间](https://meshedinsights.com/2017/05/03/is-the-gpl-really-declining/#safe)，在其中每个人都是平等的，它保护每个人免受他人动机的影响。刻意为自己设置额外权利是反社会的行为，可悲的是，开源社区有很多不平等权利最终被滥用的例子。
- 隐含的授权无效
...
作者简介：Simon Phipps 是“公开软件”（Public Software）开源项目的发起人，以志愿者身份担任 OSI 和文档基金会（The Document Foundation）的理事。
