# 基于 LVS 的 AAA 负载均衡架构实践 - 文章 - 伯乐在线
原文出处： [RiboseYim](https://my.oschina.net/zijingshanke/blog/741470)
## 一、背景
...
![lb-aaa-now](http://jbcdn2.b0.upaiyun.com/2016/10/ed8cd76add28f649274eeade198e9d4b.png)
**容量计算**
...
![lb-aaa-haproxy](http://jbcdn2.b0.upaiyun.com/2016/10/56827cee019e9181afe6f52e66646375.png)
官方文档对于source调度算法的描述：
> 
source
...
即使用上“HAProxy+TProxy”的组合拳，还是存在另外一个问题： **设备对于认证结果报文，似乎需要请求报文的目标地址（代理服务器）与结果报文的发送端（Real AAA Server）一致。**![lb-aaa-flow](http://jbcdn2.b0.upaiyun.com/2016/10/3fe520808a27e55401d7141aff4359f4.png)
...
![lb-aaa-lvs-single](http://jbcdn2.b0.upaiyun.com/2016/10/43818bbac24dab4b215c4e0e625e5887.png)
另外，为了防止LVS控制机的单点故障问题，还选用了Keepalived，负责LVS控制机和备用机的自动故障切换。
![lb-aaa-lvs-cluster](http://jbcdn2.b0.upaiyun.com/2016/10/00250cc09e81291d9af6dace0f20fcd4.png)
...
## 五、小结
#### **1. 各种负载均衡实现在网络中的位置**
![lb-normal-model](http://jbcdn2.b0.upaiyun.com/2016/10/aaf62ea1044e2741d52e1c08363959e4.png)
...
#### **3.花边故事**
HAProxy的官网目前是被封锁的，国内没梯子访问不了，Why ? 在他们家的操作手册后面有LVS、Nginx的推荐链接。以前并没有注意。
