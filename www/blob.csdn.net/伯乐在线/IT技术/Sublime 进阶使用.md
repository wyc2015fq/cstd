# Sublime 进阶使用 - 文章 - 伯乐在线
原文出处： [saymagic（@say_magic）](http://blog.saymagic.cn/2015/06/20/write-blog-by-sublime.html)
> 
相信很多人和我一样喜欢书写MarkDown格式的文本。以前我一直在使用MacDown来编写，但当发现了Sublime后,我找到了更有意思的写作方式，我将结合多个Sublime插件，让我们写的文章既可以存储在Git上，又可以保存在印象笔记供自己随时查看。此文以[Sublime简明教程](http://blog.jobbole.com/96990/)一文为基础，如果对Sublime不是很了解可以先去查看此文。
## 插件安装
在本文中，我们需要安装如下一些插件，插件的安装方法可以参考上一篇文章的最后部分:[Sublime简明教程](http://blog.jobbole.com/96990/)。所需插件如下:
...
![](http://ww3.sinaimg.cn/large/0064cTs2jw1ezoom3ktc5j313x0hjtbk.jpg)
- 点击`Revoke your developer token`重新授权应用（若之前没有授权此步可能没有）:
![](http://ww3.sinaimg.cn/large/0064cTs2jw1ezoom3xuz3j313r0cignq.jpg)
- 点击`Create a developer token`,然后会获得 Developer Token 和 NoteStore URL：
![](http://ww1.sinaimg.cn/large/0064cTs2jw1ezoom4ctdqj313z0j8adz.jpg)
- 记住上面的两个值。
...
![](http://ww2.sinaimg.cn/large/0064cTs2jw1ezoom4ngwkj30gn069ab1.jpg)
可以点击`Evernote:list recent notes`,如果看到罗列出最新的笔记，则说明授权成功，我们就可以开始后面的工作
![](http://ww2.sinaimg.cn/mw690/0064cTs2jw1ezoom5c9juj30gq06swh1.jpg)
## 引入模板
...
![](http://ww1.sinaimg.cn/mw690/0064cTs2jw1ezoom9fi0pj30ij07qdha.jpg)
此时，我只需按下`ctrl+alt+m`,即可按照模板新建一个md文件:
![](http://ww1.sinaimg.cn/large/0064cTs2jw1ezoomapbuaj30q00b0jsh.jpg)
现在，我们可以`ctrl+s`进行保存为md文件，`MarkDownEditing`插件就会将此md文件进行高亮显示。
![](http://ww3.sinaimg.cn/large/0064cTs2jw1ezoom5z76lj30vm0kmdin.jpg)
## 效果预览
...
![](http://ww1.sinaimg.cn/mw690/0064cTs2jw1ezoom6wzo9j30hr0byjtf.jpg)
接着，选择你希望显示的模式，比如github,然后浏览器就会打开然后显示此md文件。
![](http://ww2.sinaimg.cn/large/0064cTs2jw1ezooma3a5pj313j0jc7aw.jpg)
...
![](http://ww1.sinaimg.cn/large/0064cTs2jw1ezoosedyoaj30gm0bb0um.jpg)
点击后会显示让我们选择存放在哪个笔记本，我们选择后就会自动存放到我们的印象笔记中，但此时你会发现一个问题，文件不高亮显示了，别急，此时文件按照`Evernote`格式显示，我们改回`MarkDown`文件即可,更改的地方在编辑器右下角:
![](http://ww4.sinaimg.cn/large/0064cTs2jw1ezoom86h78j30h50f440j.jpg)
我们再去我们的印象笔记看一下，你会发现存储在印象笔记中的格式已经是排版过的效果，很赞！
![](http://ww4.sinaimg.cn/large/0064cTs2jw1ezoom8uzdpj30s10n9jz4.jpg)
## 保存到Git仓库
