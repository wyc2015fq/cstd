# 一步步实现 Redis 搜索引擎 - 文章 - 伯乐在线
原文出处： [jasonGeng88](https://github.com/jasonGeng88/blog/blob/master/201706/redis-search.md)
## 场景
...
![](https://github.com/jasonGeng88/blog/raw/master/201706/assets/redis_search_01.png)
从上图中可以看出，搜索总共分为6大类，每大类中又分了各个子类。这中间，各大类条件之间是取的交集，各子类中有单选、多选、以及自定义的情况，最终输出符合条件的结果集。
好了，既然需求很明确了，我们就开始来实现。
## [](https://github.com/jasonGeng88/blog/blob/master/201706/redis-search.md?hmsr=toutiao.io&utm_medium=toutiao.io&utm_source=toutiao.io#实现1)实现1
...
## [](https://github.com/jasonGeng88/blog/blob/master/201706/redis-search.md?hmsr=toutiao.io&utm_medium=toutiao.io&utm_source=toutiao.io#实现2)实现2
...
## [](https://github.com/jasonGeng88/blog/blob/master/201706/redis-search.md?hmsr=toutiao.io&utm_medium=toutiao.io&utm_source=toutiao.io#实现3)实现3
...
具体方案，如图所示：
![](https://github.com/jasonGeng88/blog/raw/master/201706/assets/redis_search_02.png)
...
![](https://github.com/jasonGeng88/blog/raw/master/201706/assets/redis_search_03.png)
...
## [](https://github.com/jasonGeng88/blog/blob/master/201706/redis-search.md?hmsr=toutiao.io&utm_medium=toutiao.io&utm_source=toutiao.io#扩展)扩展
### [](https://github.com/jasonGeng88/blog/blob/master/201706/redis-search.md?hmsr=toutiao.io&utm_medium=toutiao.io&utm_source=toutiao.io#分页)分页
这里你或许发现了一个严重的功能缺陷，列表查询怎么能没有分页。是的，我们马上来看 Redis 是如何实现分页的。
分页主要涉及排序，这里简单起见，就以创建时间为例。
如图所示：
![](https://github.com/jasonGeng88/blog/raw/master/201706/assets/redis_search_04.png)
...
- 当前页内容：`ZRANGE`命令
- 若以倒序排列：`ZREVRANGE`命令
### [](https://github.com/jasonGeng88/blog/blob/master/201706/redis-search.md?hmsr=toutiao.io&utm_medium=toutiao.io&utm_source=toutiao.io#数据更新)数据更新
...
### [](https://github.com/jasonGeng88/blog/blob/master/201706/redis-search.md?hmsr=toutiao.io&utm_medium=toutiao.io&utm_source=toutiao.io#性能优化)性能优化
...
## [](https://github.com/jasonGeng88/blog/blob/master/201706/redis-search.md?hmsr=toutiao.io&utm_medium=toutiao.io&utm_source=toutiao.io#总结)总结
