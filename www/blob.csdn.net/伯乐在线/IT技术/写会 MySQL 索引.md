# 写会 MySQL 索引 - 文章 - 伯乐在线
原文出处： [andyqian](https://my.oschina.net/u/1462914/blog/1563127)
#### 前言
...
#### 最后
上面简单说了，索引是什么、有什么用，以及建立索引时的一些技巧，还着重说了索引的重要性。那么索引这么重要，在平时编码时如何规避问题呢？以下是我个人的建议:
- 在建表时就应该考虑添加索引，如: 外键字段等等。
