# 图解 HTTP 协议 - 文章 - 伯乐在线
原文出处： [BYSocket （@BYSocket）](http://www.bysocket.com/?p=282)
# 一、技术基石及概述
问：什么是HTTP?
...
![1](http://jbcdn2.b0.upaiyun.com/2016/11/b557ca7c801cfa27d2743eb9cb89dfb0.png)
...
![11](http://jbcdn2.b0.upaiyun.com/2016/11/331e061736edef967e804db9d796a421.png)
# 二、深入理解技术基石和工作流程
既然HTTP是基于传输层的TCP协议，而TCP协议是**面向连接**的**端到端**的协议。因此，使用HTTP协议传输前，首先建立TCP连接，就是因此在谈的TCP链接过程的“三次握手”。如图
![1_thumb2](http://jbcdn2.b0.upaiyun.com/2016/11/55931284a671fe8a4122ff8419e1fb5e.png)
...
![13](http://jbcdn2.b0.upaiyun.com/2016/11/580cb803800d76ec3d8ffdae2ccadfa3.png)
# 三、详解工作过程的HTTP报文
...
![image1](http://jbcdn2.b0.upaiyun.com/2016/11/d6550b0e1a4af283049b46a819c4489b.png)
对于其中请求报文详解:
> 
1、请求行
方法字段 + URL + Http协议版本
...
报文主体
如图，就是这篇博客响应的内容:
![image3_thumb](http://jbcdn2.b0.upaiyun.com/2016/11/07ee4c8d12fdfab3389b324410837a0b.png)
对其中响应报文详解：
> 
1、状态行
...
![3ad_i2e8dmdh35ghv1dl](http://jbcdn2.b0.upaiyun.com/2016/11/d446628828d75c724531dd78fd93099b.png)
刷新一下：
![image11](http://jbcdn2.b0.upaiyun.com/2016/11/c171c13a45b865b292fde11549281586.png)
这上面的304就证明了
> 
...
![image2](http://jbcdn2.b0.upaiyun.com/2016/11/a62c9e69927cec236295cdd1a909650b.png)
至于如何使用它们，坐等系列文章吧。
# 五、总结
