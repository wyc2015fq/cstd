# 每个 Linux 新手都应该知道的 10 个命令 - 文章 - 伯乐在线
原文出处： [Sam Bocetta](https://opensource.com/article/18/4/10-commands-new-linux-users)   译文出处：[Linux中国/MjSeven](https://linux.cn/article-9601-1.html)
> 
