# Git 分支操作介绍 - 文章 - 伯乐在线
原文出处： [Kedar Vijay Kulkarni](https://opensource.com/article/18/5/git-branching)   译文出处：[Linux中国/Andy Song](https://linux.cn/article-9724-1.html)
![](http://jbcdn2.b0.upaiyun.com/2018/06/b84f8d56e47a8496314a55a39b08ad10.jpg)
在本系列的前两篇文章中，我们[开始使用 Git](http://blog.jobbole.com/114101/)，学会如何[克隆项目，修改、增加和删除内容](http://blog.jobbole.com/114104/)。在这第三篇文章中，我将介绍 Git 分支，为何以及如何使用分支。
![树枝](http://jbcdn2.b0.upaiyun.com/2018/06/33aa33f3f7c1b6dab4b586b93923469a.jpg)
...
### 创建分支
让我们回顾[本系列上一篇文章](http://blog.jobbole.com/114104/)，看一下在我们的 Demo 目录中分支是怎样的。如果你没有完成上述操作，请按照文章中的指示从 GitHub 克隆代码并进入 Demo 目录。运行如下命令：
...
![终端输出](http://jbcdn2.b0.upaiyun.com/2018/06/50e63bfafb866781b469c1a77a4f93a7.png)
...
![终端输出](http://jbcdn2.b0.upaiyun.com/2018/06/bf0f4c89a9667eb09fb29956b9cc9d56.png)
...
![Gitk 输出](http://jbcdn2.b0.upaiyun.com/2018/06/4d766fc6104150cd915e1348c4ca080c.png)
...
![终端输出](http://jbcdn2.b0.upaiyun.com/2018/06/9940ad61d955b4a2cfbeb264b8844f73.png)
...
![终端输出](http://jbcdn2.b0.upaiyun.com/2018/06/4f3bcd2a38a341027ce084f1ed51bfa4.png)
当你访问 GitHub 时，在分支选择的下拉列表中可以发现两个可供选择的分支。
![GitHub](http://jbcdn2.b0.upaiyun.com/2018/06/29592bacfeab5a8a161ca2f1b837c350.png)
点击 `myBranch` 切换到 `myBranch` 分支，你可以看到在此分支上新增的文件。
![GitHub](http://jbcdn2.b0.upaiyun.com/2018/06/eb928ec5ffe78a74df84b376c33b30a8.png)
...
- **删除本地分支** 你不能删除正在操作的分支，故切换到 `master` 分支 （或其它你希望保留的分支），命令及终端输出如下：![](http://jbcdn2.b0.upaiyun.com/2018/06/e1b4762c1603c531f92cc662147e319d.png)`git branch` 可以列出可用的分支，使用 `checkout` 切换到 `master` 分支，然后使用 `git branch -D myBranch` 删除该分支。再次运行 `git branch` 检查是否只剩下两个分支（而不是三个）。
...
git push origin :myBranch
```
![Terminal output](http://jbcdn2.b0.upaiyun.com/2018/06/1b91a34117a4ea69a12a6c9f714f9def.png)
