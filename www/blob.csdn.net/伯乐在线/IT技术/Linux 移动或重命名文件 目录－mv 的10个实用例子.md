# Linux 移动或重命名文件/目录－mv 的10个实用例子 - 文章 - 伯乐在线
原文出处： [Pungki Arianto](https://linoxide.com/linux-command/mv-command-linux/)   译文出处：[Linux中国/Linchenguang](https://linux.cn/article-2688-1.html)
熟悉了 [复制命令](http://linux.cn/article-2687-1.html)，下一个相关的命令就是 mv 命令。当你想要将文件从一个位置移动到另一个地方并且不想复制它，那么**mv 命令**是完成这个任务的首选。
### 初识 mv 命令
![](http://jbcdn2.b0.upaiyun.com/2017/12/0ffd848e786b38cbd9e7fe73b8a984f9.png)
...
```
![mv command](http://jbcdn2.b0.upaiyun.com/2017/12/4337b72366dcd1d179e54f6733353c31.png)
如我们所见，当我们移动 file_1.txt 文件时，先前目录的 file*_*1.txt 就**被删除了**。
#### 2.移动多个文件
...
```
![Move multiple files](http://jbcdn2.b0.upaiyun.com/2017/12/b2638990e4d535ef720494594f82aeff.png)
...
```
![Move using pattern](http://jbcdn2.b0.upaiyun.com/2017/12/001cbc57d22fd5836324e4c34ff49a98.png)
#### 3.移动目录
不同于复制命令，用 mv 命令移动目录相当直接。移动目录你可以使用不带选项的 mv 命令。看下面的截图就一目了然了。
![Moving directory](http://jbcdn2.b0.upaiyun.com/2017/12/6097ea1227a2aacc6f5da69ab6ba228a.png)
#### 4.重命名文件或目录
...
```
![Renaming file](http://jbcdn2.b0.upaiyun.com/2017/12/d10e2e03d32e0a5970da8ce2cdbc0254.png)
#### 5. 重命名目录
...
```
![Renaming directory](http://jbcdn2.b0.upaiyun.com/2017/12/cf60abcbc8e5d4ad81ea8666b78564a3.png)
#### 6. 打印移动信息
...
```
![mv with verbose mode](http://jbcdn2.b0.upaiyun.com/2017/12/4f9bef19e69f100e7d4f1ec973114f82.png)
该方法同样适用于目录。
![mv directory with verbose mode](http://jbcdn2.b0.upaiyun.com/2017/12/8eda462dd144998963b5adea39260da7.png)
#### 7. 使用交互模式
...
```
![mv with interactive mode](http://jbcdn2.b0.upaiyun.com/2017/12/0e39f8eaefe16af197716905386551be.png)
这个提示会让我们知道目标位置处file_1.txt的存在。如果我们按**y**键，那么那个文件将会被删除，否则不会。
#### 8. 使用更新选项
-i 选项会提示我们关于覆盖文件的提示，而 -u 则只在源文件比目标文件新时才执行更新。让我们看一看下面的例子：
![Update only newer](http://jbcdn2.b0.upaiyun.com/2017/12/2eb8dce13a7f749f4c2b392c0622324a.png)
...
```
![No overwrite](http://jbcdn2.b0.upaiyun.com/2017/12/a5751c3a71e972ec2e8a1abad55667ce.png)
#### 10. 复制时创建备份
...
```
![Backup option](http://jbcdn2.b0.upaiyun.com/2017/12/c5e357026dd7c98407042492ab8592e2.png)
如截图中所见，在 /home/pungki/office 目录下出现了名为**file_1.txt~** 和 **file_2.txt~** 的文件。那个**波浪符号（～）**意味着这些文件是备份文件。从它们的属性中我们可以看到，这些文件比file_1.txt和file_2.txt要旧。
#### 11. 无条件覆盖已经存在的文件
