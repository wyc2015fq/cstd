# Spark性能优化指南：高级篇 - 文章 - 伯乐在线
原文出处： [美团点评技术博客 - 李雪蕤](http://tech.meituan.com/spark-tuning-pro.html)
# 前言
继[基础篇](http://blog.jobbole.com/102631/)讲解了每个Spark开发人员都必须熟知的开发调优与资源调优之后，本文作为《Spark性能优化指南》的高级篇，将深入分析数据倾斜调优与shuffle调优，以解决更加棘手的性能问题。
# 数据倾斜调优
## 调优概述
...
![skwed-mech.png](http://jbcdn2.b0.upaiyun.com/2016/06/76ee9cce0e6698df601f69dd5391ad50.jpg)
## 如何定位导致数据倾斜的代码
...
![shuffle-skwed-web-ui-demo.png](http://jbcdn2.b0.upaiyun.com/2016/06/4a0b720ebf30ea46808d54d3334ce274.jpg)
...
![shuffle-skwed-add-partition.png](http://jbcdn2.b0.upaiyun.com/2016/06/3a377663688e9de1daea38f335971698.jpg)
...
![shuffle-skwed-map-join.png](http://jbcdn2.b0.upaiyun.com/2016/06/94cda7ef709c7147002e1a03f6320303.jpg)
...
![shuffle-skwed-sample-expand.png](http://jbcdn2.b0.upaiyun.com/2016/06/015164661e02094980e51090e44ef4ae.jpg)
...
![hash-shuffle-common.png](http://jbcdn2.b0.upaiyun.com/2016/06/93001590f39951c638b6cf18279230c9.jpg)
...
![hash-shuffle-consolidate.png](http://jbcdn2.b0.upaiyun.com/2016/06/ea1f3a6ecef35644870d097c7f4d5bfd.jpg)
...
![sort-shuffle-common.png](http://jbcdn2.b0.upaiyun.com/2016/06/822a67cba467a6f4c6bb31f577d02804.jpg)
### bypass运行机制
...
![sort-shuffle-bypass.png](http://jbcdn2.b0.upaiyun.com/2016/06/14758238499d8fd73f53a2b21db602bc.jpg)
## shuffle相关参数调优
...
# 写在最后的话
本文分别讲解了开发过程中的优化原则、运行前的资源参数设置调优、运行中的数据倾斜的解决方案、为了精益求精的shuffle调优。希望大家能够在 阅读本文之后，记住这些性能调优的原则以及方案，在Spark作业开发、测试以及运行的过程中多尝试，只有这样，我们才能开发出更优的Spark作业，不断提升其性能。
