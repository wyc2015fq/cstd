# 一位女军官的 Linux 探索之路 - 文章 - 伯乐在线
原文出处： [Ken Starks](http://fossforce.com/2016/05/anatomy-linux-user/)   译文出处：[vim-kakali](https://linux.cn/article-7667-1.html)
...
![](http://jbcdn2.b0.upaiyun.com/2016/08/6cbeae1be588d218987dda136f52918d.jpg)
...
大概第一周左右，她通过电话和邮件问了我一些常规问题，而最主要的问题还是她想知道如何保存她 OpenOffice 文件才可以让她的同事也可以打开这些文件。教一个人使用 Linux 或者 Open/LibreOffice 的时候最重要的就是教她保存文件。大多数用户在弹出的对话框中直接点了保存，结果就用默认的开放文档格式（Open Document Format）（ODF）保存了，这让他们吃了不少苦头。
