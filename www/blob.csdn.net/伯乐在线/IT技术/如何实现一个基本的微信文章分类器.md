...
本项目的地址：[https://github.com/fullstacky…](https://github.com/fullstackyang/article-classifier)
# 一、文本分类器的概述
...
# 二、准备训练语料
这里需要的语料就是微信公众号的文章，我们可以抓取搜狗微信搜索网站（[http://weixin.sogou.com/](http://weixin.sogou.com/)）首页上已经分类好的文章，直接采用其分类结果，这样也省去了标注的工作。至于如何开发爬虫去抓取文章，这里就不再讨论了。
...
上面几个概率值，都可以比较方便地从训练语料上统计得到。若还有不明白的小伙伴，推荐阅读这篇博客：[文本分类入门（十一）特征选择方法之信息增益](http://www.blogjava.net/zhenandaci/archive/2009/03/24/261701.html)
## 3.2 卡方检验
...
- Ansj中文分词器，[https://github.com/NLPchina/a…](https://github.com/NLPchina/ansj_seg)
- HanLP中文分词器，[https://github.com/hankcs/HanLP](https://github.com/hankcs/HanLP)
