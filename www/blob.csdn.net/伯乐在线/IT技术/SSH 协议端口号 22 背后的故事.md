# SSH 协议端口号 22 背后的故事 - 文章 - 伯乐在线
原文出处： [Tatu Ylonen](https://www.ssh.com/ssh/port)   译文出处：[Linux中国/kenxx](https://linux.cn/article-8476-1.html)
...
![](http://wx1.sinaimg.cn/large/63918611gy1fff79liaiuj20ku0bqq3b.jpg)
...
端口号可以在配置文件 [/etc/ssh/sshd_config](https://www.ssh.com/ssh/sshd_config/) 中将 `Port 22` 更改。也可以使用 `-p ` 选项运行 [sshd](https://www.ssh.com/ssh/sshd/)。SSH 客户端和 [sftp](https://www.ssh.com/ssh/sftp/) 程序也可以使用 `-p ` 选项。
### 配置 SSH 协议穿越防火墙
