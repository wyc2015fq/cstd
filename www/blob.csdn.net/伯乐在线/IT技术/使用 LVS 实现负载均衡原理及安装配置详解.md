# 使用 LVS 实现负载均衡原理及安装配置详解 - 文章 - 伯乐在线
原文出处： [肖邦Linux](http://www.cnblogs.com/liwei0526vip/p/6370103.html)
...
## 二、LVS的基本工作原理
![11781035-20170207085512619-1627288925](http://jbcdn2.b0.upaiyun.com/2017/02/d7ccf86f24b48a1aedbb559f1f4866b2.png)
...
![12781035-20170208130339541-1597888386](http://jbcdn2.b0.upaiyun.com/2017/02/cfdcc72a5d25c7c782be8675483ddbe3.png)
...
![13781035-20170208131643026-1985709106](http://jbcdn2.b0.upaiyun.com/2017/02/0a8f9ce20c8934f9e3bbcdd15d4bff7d.png)
**(a)** 当用户请求到达Director Server，此时请求的数据报文会先到内核空间的PREROUTING链。 此时报文的源IP为CIP，目标IP为VIP
**(b)** PREROUTING检查发现数据包的目标IP是本机，将数据包送至INPUT链
...
![14781035-20170208132504057-1671947616](http://jbcdn2.b0.upaiyun.com/2017/02/3133868705ba82c6d92ebda872589cf1.png)
**(a)** 当用户请求到达Director Server，此时请求的数据报文会先到内核空间的PREROUTING链。 此时报文的源IP为CIP，目标IP为VIP 。
**(b)** PREROUTING检查发现数据包的目标IP是本机，将数据包送至INPUT链
