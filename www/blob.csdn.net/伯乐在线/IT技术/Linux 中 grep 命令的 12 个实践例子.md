# Linux 中 grep 命令的 12 个实践例子 - 文章 - 伯乐在线
原文出处： [tecmint](https://www.tecmint.com/12-practical-examples-of-linux-grep-command/)   译文出处：[Linux中国/Linux-pdz](https://linux.cn/article-2250-1.html)
你是否遇到过需要在文件中查找一个特定的字符串或者样式，但是不知道从哪儿开始？那么,就请**grep**来帮你吧。
![](http://jbcdn2.b0.upaiyun.com/2017/10/5d48fbc415ad93a43ccc4e6f9f2fd95e.png)
