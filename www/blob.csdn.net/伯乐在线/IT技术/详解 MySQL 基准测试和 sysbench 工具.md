# 详解 MySQL 基准测试和 sysbench 工具 - 文章 - 伯乐在线
原文出处： [编程迷思](http://www.cnblogs.com/kismetv/p/7615738.html)
## 前言
...
![](http://jbcdn2.b0.upaiyun.com/2017/10/82a41dd113faf12511a4a9eeb23eb804.png)
### （2）执行测试
将测试结果导出到文件中，便于后续分析。
...
## 5、测试结果
测试结束后，查看输出文件，如下所示：
![](http://jbcdn2.b0.upaiyun.com/2017/10/bc2d91443c26b403618e0378598e0f0d.png)
其中，对于我们比较重要的信息包括：
queries：查询总数及qps
