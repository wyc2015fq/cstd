# Redis基础、高级特性与性能调优 - 文章 - 伯乐在线
原文出处： [kelgon](https://www.jianshu.com/p/2f14bc570563)
...
- Redis面临的并发写压力会有多大？在不使用pipelining时，Redis的写性能可以超过10万次/秒（更多的benchmark可以参考 [https://redis.io/topics/benchmarks](https://link.jianshu.com?t=https://redis.io/topics/benchmarks) ）
