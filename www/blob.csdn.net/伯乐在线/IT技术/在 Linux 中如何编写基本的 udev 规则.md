# 在 Linux 中如何编写基本的 udev 规则 - 文章 - 伯乐在线
原文出处： [LinuxConfig](https://linuxconfig.org/tutorial-on-how-to-write-basic-udev-rules-in-linux)   译文出处：[Linux中国/qhwdw](https://linux.cn/article-9365-1.html)
### 读者对象
