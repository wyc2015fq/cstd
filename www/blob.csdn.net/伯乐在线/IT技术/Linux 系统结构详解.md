# Linux 系统结构详解 - 文章 - 伯乐在线
原文出处： [huangguisu](http://blog.csdn.net/hguisu/article/details/6122513)
Linux系统一般有4个主要部分：
**内核、shell、文件系统和应用程序**。内核、shell和文件系统一起形成了基本的操作系统结构，它们使得用户可以运行程序、管理文件并使用系统。部分层次结构如图1-1所示。
**![](http://jbcdn2.b0.upaiyun.com/2016/07/dd015b912c8db762aac2cb0c9d29610c.png)**
# 1. linux内核
...
![](http://jbcdn2.b0.upaiyun.com/2016/07/4cea25315824ef1099175cb240a8f4d1.jpg)
图1
...
**进程调度**控制进程对CPU的访问。当需要选择下一个进程运行时，由调度程序选择最值得运行的进程。可运行进程实际上是仅等待CPU资源的进程，如果某个进程在等待其它资源，则该进程是不可运行进程。Linux使用了比较简单的基于优先级的进程调度算法选择新的进程。
...
![](http://jbcdn2.b0.upaiyun.com/2016/07/dc0a2941d47ca52ad10ac2942aff640e.jpeg)
...
![](http://jbcdn2.b0.upaiyun.com/2016/07/78afbce4c325287df1bb3ce5a8f03019.jpg)
图2
...
![](http://jbcdn2.b0.upaiyun.com/2016/07/8f98df093fad08be4d6ae7866db474da.jpg)
ext2文件系统示意图
...
![](http://jbcdn2.b0.upaiyun.com/2016/07/f8ea820387665154dcaa808c008d07fa.jpg)
...
![](http://jbcdn2.b0.upaiyun.com/2016/07/dea856cacd8769b7491d895bc5e9e3f1.jpg)
图、FAT文件系统数据存取示意图
...
![](http://jbcdn2.b0.upaiyun.com/2016/07/bcc1aaee2d5ad30ad794c522fbc923e2.png)
...
具体关系可以看下图：
![](http://jbcdn2.b0.upaiyun.com/2016/07/48520005f0e65a969b98717aaaacbcdd.jpg)
图5：软链接和硬链接
从图上可以看出硬链接和软链接的区别：
> 
