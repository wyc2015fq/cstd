...
6. git：现在的最爱……
比较一下cvs,svn,和git：
![开源版本控制工具比较](http://jbcdn2.b0.upaiyun.com/2016/10/cd2116ae2f6f663827744ae79c3c04ac.png)
# Git 简要
...
![这里写图片描述](http://jbcdn2.b0.upaiyun.com/2016/10/f9a8217d6b0eb4d523298fcfefe7e86b.png)
主要目录结构描述见下表：
|子目录名|简要描述|
|----|----|
| | |
...
| | |
| | |
branchesGit 项目分支信息，新版 Git 已经不再使用该目录configGit 项目配置信息descriptionGit 项目描述信息HEAD指向 Git 项目当前分支的头指针hooks默认的”hooks”脚本，被特定事件发生前后触发。info里面含一个 exclude 文件，指 Git 项目要忽略的文件。objectsGit 的数据对象，包括：commits, trees, blobs, tags。refs指向所有 Git 项目分支的指针
...
![这里写图片描述](http://jbcdn2.b0.upaiyun.com/2016/10/7bc8f6e28b47f52ff053b07896f405de.png)
...
![暂存区的样子](http://jbcdn2.b0.upaiyun.com/2016/10/41dd63ef03554bba5d9eebea73503ab4.png)
...
![分支简要](http://jbcdn2.b0.upaiyun.com/2016/10/ffd69c1076c063dfb6ef048884b4c1f6.png)
分支指向了一次提交，也是 Git 中的分支为什么这么轻量的原因。
因为分支就是指向了一个 Commit 的指针，当提交新的 Commit，这个分支的指向只需要跟着更新就可以了，而创建分支仅仅是创建一个指针。
# Git 必备技能
## 常见命令速查
![常见命令速查表](http://jbcdn2.b0.upaiyun.com/2016/10/0435d1c7fdf7de0851f6c87bf12209a0.png)
...
Merge 之后仍可以做出新的提交。
![merge](http://jbcdn2.b0.upaiyun.com/2016/10/4a3e10e7208546ca8d9c1d9e34fd44fa.png)
### rebase
Rebase 会把从 Merge Base 以来的所有提交，以补丁的形式一个一个重新达到目标分支上。这使得目标分支合并该分支的时候会直接 Fast Forward，即不会产生任何冲突。
![rebase](http://jbcdn2.b0.upaiyun.com/2016/10/4fc871d03fbab902c3f8f04da1e5acbd.png)
...
![git 典型实践](http://jbcdn2.b0.upaiyun.com/2016/10/2e370596c8095239140bc0e01c318835.png)
## 主要分支
把origin/master作为主要分支，源码的HEAD总是表示production-ready(可随时部署)状态。
![master和develop](http://jbcdn2.b0.upaiyun.com/2016/10/40b02fc5d50d311d07f458bfb5333607.png)
...
![feature和develop](http://jbcdn2.b0.upaiyun.com/2016/10/db0a43d594b876ec3e6025a3981c5b80.png)
...
```
![merge without FF](http://jbcdn2.b0.upaiyun.com/2016/10/99890ae5520ffbab91b173bafff34466.png)
### Release branches
继承分支: develop
