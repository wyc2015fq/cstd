# 献给命令行重度用户的一组实用 BASH 脚本 - 文章 - 伯乐在线
原文出处： [SK](https://www.ostechnix.com/collection-useful-bash-scripts-heavy-commandline-users/)   译文出处：[Linux中国/MjSeven](https://linux.cn/article-9939-1.html)
...
```
参考以下屏幕截图：
![sk@sk_001](http://jbcdn2.b0.upaiyun.com/2018/08/1e19e82a0dc17db6a2d4b661b2864324.png)
#### 2、 Stocks – 显示股票价格详细信息
...
```
示例输出：
![](http://jbcdn2.b0.upaiyun.com/2018/08/d410559e9bf3a551ea31d6c952d300c2.png)
...
```
示例输出：
![](http://jbcdn2.b0.upaiyun.com/2018/08/93aac59df9c833a9c066b5f5b22a80af.png)
#### 4、 Crypt – 加解密文件
...
![](http://jbcdn2.b0.upaiyun.com/2018/08/69c016c8d2925ebc204de486d913a907.png)
要查看艺术家的近期视频，你可以使用：
...
```
示例输出：
![](http://jbcdn2.b0.upaiyun.com/2018/08/8bc142cd7dab438ca883c144e137680f.png)
很酷，不是吗？
#### 13、 Cryptocurrency
它将显示十大加密货币实时汇率。
输入以下命令，然后单击回车来运行：
...
$ cryptocurrency
```
![](http://jbcdn2.b0.upaiyun.com/2018/08/daaad978cd5afc3692bdcf1d5716d174.png)
#### 14、 Lyrics
这个脚本从命令行快速获取一首歌曲的歌词。
...
```
![](http://jbcdn2.b0.upaiyun.com/2018/08/125e0389f4eb08d2e53e4aae4e747263.png)
#### 15、 Meme
...
![](http://jbcdn2.b0.upaiyun.com/2018/08/ef9ba98934c2915c14d4fe83e8e4ba50.png)
#### 17、 Siteciphers
...
```
![](http://jbcdn2.b0.upaiyun.com/2018/08/5468bd4494accc9bd8934d16ec0d1bd9.png)
#### 18、 Todo
它允许你直接从终端创建日常任务。
让我们来创建一些任务。
