# 在 Linux 命令行中使用 tcpdump 抓包 - 文章 - 伯乐在线
原文出处： [Ricardo Gerardi](https://opensource.com/article/18/10/introduction-tcpdump)   译文出处：[Linux中国/jrg](https://linux.cn/article-10191-1.html)
> 
...
```
# Found
The document has moved [here](https://opensource.com/).
