# Apache Spark 内存管理详解 - 文章 - 伯乐在线
原文出处： [IBM developerWorks](https://www.ibm.com/developerworks/cn/analytics/library/ba-cn-apache-spark-memory-management/index.html)
...
##### 图 1 . 堆内和堆外内存示意图
![](http://wx1.sinaimg.cn/mw690/63918611gy1fe7btgzmz8j20le0fidhc.jpg)
### 1.1 堆内内存
...
##### 图 2 . 静态内存管理图示——堆内
![](http://wx2.sinaimg.cn/mw690/63918611gy1fe7bthl4e5j21gw0uctl0.jpg)
...
##### 图 3 . 静态内存管理图示——堆外
![](http://wx1.sinaimg.cn/mw690/63918611gy1fe7btigrknj21660k0go5.jpg)
静态内存管理机制实现起来较为简单，但如果用户不熟悉 Spark 的存储机制，或没有根据具体的数据规模和计算任务或做相应的配置，很容易造成”一半海水，一半火焰”的局面，即存储内存和执行内存中的一方剩余大量的空间，而另一方却早早被占满，不得不淘汰或移出旧的内容以存储新的内容。由于新的内存管理机制的出现，这种方式目前已经很少有开发者使用，出于兼容旧版本的应用程序的目的，Spark 仍然保留了它的实现。
### 2.2 统一内存管理
Spark 1.6 之后引入的统一内存管理机制，与静态内存管理的区别在于存储内存和执行内存共享同一块空间，可以动态占用对方的空闲区域，如图 4 和图 5 所示
##### 图 4 . 统一内存管理图示——堆内
![](http://wx3.sinaimg.cn/mw690/63918611gy1fe7btii2gzj21ie0ugn7h.jpg)
##### 图 5 . 统一内存管理图示——堆外
![](http://wx2.sinaimg.cn/mw690/63918611gy1fe7btiy9f8j20r40d2myr.jpg)
...
##### 图 6 . 动态占用机制图示
![](http://wx2.sinaimg.cn/mw690/63918611gy1fe7btjegg2j21io0m8af9.jpg)
...
##### 图 7 . Storage 模块示意图
![](http://wx1.sinaimg.cn/mw690/63918611gy1fe7btk043lj20to0fcjtl.jpg)
...
![](http://wx2.sinaimg.cn/mw690/63918611gy1fe7btkmjq9j219s0tcae5.jpg)
...
- [Spark OFF_HEAP](http://www.jianshu.com/p/c6f6d4071560)
