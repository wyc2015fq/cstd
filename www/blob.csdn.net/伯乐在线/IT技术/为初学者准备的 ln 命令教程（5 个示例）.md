# 为初学者准备的 ln 命令教程（5 个示例） - 文章 - 伯乐在线
原文出处： [Himanshu Arora](https://www.howtoforge.com/linux-ln-command/)   译文出处：[Linux中国/ChenYi](https://linux.cn/article-9501-1.html)
...
```
![如何使用 ln 命令创建硬链接](http://jbcdn2.b0.upaiyun.com/2018/04/01298effe75946f995e7917f557462d5.png)
...
```
![如何使用 ln 命令创建软/符号链接](http://jbcdn2.b0.upaiyun.com/2018/04/50c704a6f945d0c923e4e0537f8c8074.png)
...
![ln 命令示例](http://jbcdn2.b0.upaiyun.com/2018/04/e0fd2f36a9b21dba7e12ac1cb09ade9d.png)
然而，如果一定要这么做，您可以使用 `-f` 命令行选项覆盖此行为。
![如何使用 ln 命令创建软/符号链接](http://jbcdn2.b0.upaiyun.com/2018/04/50acf4e490700767594928b22cfe2699.png)
...
![如何使用 ln 命令创建现有文件的同名备份](http://jbcdn2.b0.upaiyun.com/2018/04/4c82e6ffb43f28c1e41aa82208cb755a.png)
