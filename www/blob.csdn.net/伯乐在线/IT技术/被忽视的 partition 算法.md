...
![Partition 一次扫描进行划分](http://xuelangzf-github.qiniudn.com/20160901_lost_partition_1.png)Partition 一次扫描进行划分
# Partition 实现
...
![Partition 简单实现](http://xuelangzf-github.qiniudn.com/20160901_lost_partition_2.png)Partition 简单实现
...
![Partition 高效实现](http://xuelangzf-github.qiniudn.com/20160901_lost_partition_3.png)Partition 高效实现
...
![三分划分](http://xuelangzf-github.qiniudn.com/20160901_lost_partition_4.png)三分划分
可以结合下面代码来理解具体的逻辑：
...
**更多阅读**
[被忽视的 partition 算法](http://selfboot.cn/2016/09/01/lost_partition/)
