# 在 Git 中怎样克隆、修改、添加和删除文件？ - 文章 - 伯乐在线
原文出处： [Kedar Vijay Kulkarni](https://opensource.com/article/18/2/how-clone-modify-add-delete-git-files)   译文出处：[Linux中国/MjSeven](https://linux.cn/article-9517-1.html)
![](http://jbcdn2.b0.upaiyun.com/2018/06/a9f8e32251fe9ed8030a42ac78ef2343.jpg)
在 [本系列的第一篇文章](http://blog.jobbole.com/114101/) 开始使用 Git 时，我们创建了一个简单的 Git 仓库，并用我们的计算机连接到它，向其中添加一个文件。在本文中，我们将学习一些关于 Git 的其他内容，即如何克隆（下载）、修改、添加和删除 Git 仓库中的文件。
### 让我们来克隆一下
...
让我们克隆在上一篇文章中创建的名为 Demo 的仓库。（如果你还没有创建 Demo 仓库，请跳回到[那篇文章](http://blog.jobbole.com/114101/)并在继续之前执行那些步骤）要克隆文件，只需打开浏览器并导航到 `https://github.com/<your_username>/Demo` (其中 <your_username> `` 是你仓库的名称。例如，我的仓库是 `https://github.com/kedark3/Demo`)。一旦你导航到该 URL，点击“克隆或下载Clone or download”按钮，你的浏览器看起来应该是这样的：
![](http://jbcdn2.b0.upaiyun.com/2018/06/c73c351075b2d57e2d8d9b59bc36ac5b.png)
...
```
终端看起来应该是这样的：
![](http://jbcdn2.b0.upaiyun.com/2018/06/bbaf1d51a27e653b3ff50bc5b5fd4034.png)
### 修改文件
...
![](http://jbcdn2.b0.upaiyun.com/2018/06/72ebaab494134e1fef97873629f8df5a.png)
...
这里是终端输出：
![](http://jbcdn2.b0.upaiyun.com/2018/06/2787ca9ba76aedea3d424335e3cd5938.png)
我们来分析一下：
...
![](http://jbcdn2.b0.upaiyun.com/2018/06/9a0c05bdb3439247c9634ec4bf1f3b05.png)
### 上传文件到你的仓库
...
![](http://jbcdn2.b0.upaiyun.com/2018/06/78dda20702c27aabe4b05aa9195fe867.png)
...
![](http://jbcdn2.b0.upaiyun.com/2018/06/7b5fcf2b0b8426eb0f6947e13740d8b4.png)
...
```
终端输出如下：
![](http://jbcdn2.b0.upaiyun.com/2018/06/416a3cda5609a4d6af59d9b3ac7ed5a9.png)
`git status` 告诉你有 `file.txt` 被修改，对于 Git 来说它是一个 `new file`，Git 在此之前并不知道。现在我们已经为 Git 添加了 `file.txt`，我们可以提交更改并将其推送到 `origin/master`。
![](http://jbcdn2.b0.upaiyun.com/2018/06/b9726595fac48135765596f41e98112c.png)
Git 现在已经将这个新文件上传到 GitHub；如果刷新 GitHub 页面，则应该在 GitHub 上的仓库中看到新文件 `file.txt`。
![](http://jbcdn2.b0.upaiyun.com/2018/06/deb4e163d789a2e959251df26e0ef9cc.png)
...
```
现在你的终端看起来像这样：
![](http://jbcdn2.b0.upaiyun.com/2018/06/a702fafff9bde602d93411167d94710b.png)
你的 GitHub 看起来像这样：
![](http://jbcdn2.b0.upaiyun.com/2018/06/4d86c6b7db708b054256542492880b21.png)
