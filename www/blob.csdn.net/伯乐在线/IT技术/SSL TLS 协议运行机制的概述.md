# SSL/TLS 协议运行机制的概述 - 文章 - 伯乐在线
原文出处： [阮一峰（ @ruanyf ）](http://www.ruanyifeng.com/blog/2014/02/ssl_tls.html)
互联网的通信安全，建立在SSL/TLS协议之上。
本文简要介绍SSL/TLS协议的运行机制。文章的重点是设计思想和运行过程，不涉及具体的实现细节。如果想了解这方面的内容，请参阅[RFC文档](http://tools.ietf.org/html/rfc5246)。
![](http://jbcdn2.b0.upaiyun.com/2016/09/be87125057d2eba95318914303391f76.jpg)
**一、作用**
...
**四、握手阶段的详细过程**
![](http://jbcdn2.b0.upaiyun.com/2016/09/6c37780313051e51974a7e8e26c37e7e.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/09/8ac24c47a63c7eb487e019394dbb2e5d.gif)
**五、参考链接**
