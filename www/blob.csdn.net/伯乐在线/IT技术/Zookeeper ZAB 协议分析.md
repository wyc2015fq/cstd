...
![phase 1](http://7xjtfr.com1.z0.glb.clouddn.com/phase1.png)
...
![phase 2](http://7xjtfr.com1.z0.glb.clouddn.com/phase2.png)
#### Phase 3: Broadcast（广播阶段）
到了这个阶段，Zookeeper 集群才能正式对外提供事务服务，并且 leader 可以进行消息广播。同时如果有新的节点加入，还需要对新节点进行同步。
![phase 3](http://7xjtfr.com1.z0.glb.clouddn.com/phase3.png)
...
#### 选举过程
![FLE](http://7xjtfr.com1.z0.glb.clouddn.com/FLE.png)
### Recovery Phase （恢复阶段）
...
![Recovery Phase](http://7xjtfr.com1.z0.glb.clouddn.com/recovery.png)
## 总结
