# 每天一个 Linux 命令（44）： top 命令 - 文章 - 伯乐在线
原文出处： [peida](http://www.cnblogs.com/peida/archive/2012/12/24/2831353.html)
...
![top1](http://jbcdn2.b0.upaiyun.com/2017/01/e95c9dd12759228fef3d269315975953.jpg)
观察上图，服务器有16个逻辑CPU，实际上是4个物理CPU。再按数字键1，就会返回到top基本视图界面。
2.高亮显示当前运行进程
敲击键盘“b”（打开/关闭加亮效果），top的视图变化如下：
![top2](http://jbcdn2.b0.upaiyun.com/2017/01/b861e8c23e401e4c8d8db36016923cfa.png)
...
![top3](http://jbcdn2.b0.upaiyun.com/2017/01/1cc907747880452b88afcc9280acb0cd.png)
敲击键盘“x”（打开/关闭排序列的加亮效果），top的视图变化如下：
![top4](http://jbcdn2.b0.upaiyun.com/2017/01/ebcc3d9db19e3940e3b8a6e72d90fe26.png)
可以看到，top默认的排序列是“%CPU”。
4. 通过”shift + >”或”shift + <”可以向右或左改变排序列
下图是按一次”shift + >”的效果图,视图现在已经按照%MEM来排序。
![top5](http://jbcdn2.b0.upaiyun.com/2017/01/53acffcc323258aeac59390c573ca8dd.png)
实例2：显示 完整命令
命令：
...
```
输出：
![top6](http://jbcdn2.b0.upaiyun.com/2017/01/d5d286b09b5fc03ea9c19492e7232777.png)
说明：
实例3：以批处理模式显示程序信息
命令：
...
```
输出：
![top7](http://jbcdn2.b0.upaiyun.com/2017/01/240902a1a33ff9f76a9654f491f49c5c.png)
说明：
** 5.top交互命令**
