# 开发者的实用 Vim 插件（3） - 文章 - 伯乐在线
原文出处： [howtoforge](https://www.howtoforge.com/tutorial/vim-editor-plugins-for-software-developers-3/)   译文出处：[Linux中国 - Taylor1024](https://linux.cn/article-8367-1.html)
到目前为止，在本系列 vim 插件文章中，我们介绍了使用 Pathogen 插件管理包安装基本的 vim 插件，也提及了另外三个插件：[Tagbar、delimitMate](http://blog.jobbole.com/107412/) 和 [Syntastic](http://blog.jobbole.com/107411/)。现在，在最后一部分，我们将介绍另一个十分有用的插件 a.vim。
...
![Vim.a vertical split screen](http://jbcdn2.b0.upaiyun.com/2017/04/79bb902f94257b54657413bf30f48c90.png)
![vim.a horizontal split screen](http://jbcdn2.b0.upaiyun.com/2017/04/4b568d2acfdf155c7326f30f1026d1f2.png)
使用 `:A` 命令在已经打开的文件中切换。
这个插件还可以让你在同一个 Vim 窗口中不同选项卡中打开多个相应的文件，你键入这个命令 `:AT`。
![tabs in Vim with a.vim.](http://jbcdn2.b0.upaiyun.com/2017/04/945fe1483843e44c6ad4c4161a82396f.png)
