# 5 个好用的开发者 Vim 插件 - 文章 - 伯乐在线
原文出处： [Ricardo Gerardi](https://opensource.com/article/19/1/vim-plugins-developers)   译文出处：[Linux中国/pityonline](https://linux.cn/article-10563-1.html)
> 
通过这 5 个插件扩展 Vim 功能来提升你的编码效率。
![](http://jbcdn2.b0.upaiyun.com/2019/02/bd52853a7b3ec8810c11e90c1b77f44b.jpg)
...
### 2、NERD Commenter
[NERD Commenter](https://github.com/scrooloose/nerdcommenter) 插件给 Vim 增加了代码注释的功能，类似在 IDEintegrated development environment 中注释功能。有了这个插件，你可以一键注释单行或多行代码。
