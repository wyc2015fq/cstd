# 阿里根据截图查到泄露者，这样的技术是如何做到的？ - 文章 - 伯乐在线
原文出处： [知乎](https://www.zhihu.com/question/50735753)
...
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l87t8baj20go08bdho.jpg)
### 伯小乐整理了 2 位知乎网友的回答分享。（均已获授权）
### 一、[liu fuqiang 的分享](https://www.zhihu.com/question/50735753/answer/122593277)，3800+ 顶
...
![](http://ww3.sinaimg.cn/mw690/6941baebgw1f81l86zuzhj204v014t8i.jpg)
...
![](http://ww3.sinaimg.cn/mw690/6941baebgw1f81l87a3kcj20go04wt8v.jpg)
上图为叠加数字盲水印的基本流程。编码的目的有二，一是对水印加密，二控制水印能量的分布。以下是叠加数字盲水印的实验。这是原图像，尺寸300*240 （不要问我为什么不用Lena，那是我前女友），
![](http://ww3.sinaimg.cn/mw690/6941baebgw1f81l86emh0j208c06omxb.jpg)
之后进行傅里叶变换，下图变换后的频域图像，
![](http://ww3.sinaimg.cn/mw690/6941baebgw1f81l85v5eej208c06otaa.jpg)
这是我想加的水印，尺寸200*100，
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l85aspcj205k02sa9z.jpg)
这是我编码后的水印，编码方式采用随机序列编码，通过编码，水印分布到随机分布到各个频率，并且对水印进行了加密，
![](http://ww2.sinaimg.cn/mw690/6941baebgw1f81l85byaej208c06ota5.jpg)
将上图与原图的频谱叠加，可见图像的频谱已经发生了巨大的变化，
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81lftlz9lj208c06ojsy.jpg)
之后，将叠加水印的频谱进行傅里叶逆变换，得到叠加数字水印后的图像，
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l845ed7j208c06odft.jpg)
肉眼几乎看不出叠加水印后的图像与原图的差异，这样，数字盲水印已经叠加到图像中去。实际上，我们是把水印以噪声的形式添加到原图像中。下图是在空域上的加水印图与原图的残差（调整了对比度，不然残差调小看不见），
![](http://ww2.sinaimg.cn/mw690/6941baebgw1f81l83tzv9j208c06o0ta.jpg)
...
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l82xkzkj20fl0bot9j.jpg)
水印提取是水印叠加的逆过程，
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l834eubj20go04kmxa.jpg)
经提取后，我们得到如下水印，**问：为什么水印要对称呢？**嘿嘿，大家想想看。
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l82lg6yj208c06o3ym.jpg)
### 三、攻击性实验
本部分进行攻击性实验，来验证通过频域手段叠加数字盲水印的鲁棒性。
1.进行涂抹攻击，这是攻击后的图片：
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l82dt6sj208c06oaa5.jpg)
再进行水印提取：
![](http://ww3.sinaimg.cn/mw690/6941baebgw1f81l820s3rj208c06oabr.jpg)
2.进行剪切攻击，就是网上经常用的截图截取一部分的情况：
![](http://ww2.sinaimg.cn/mw690/6941baebgw1f81lh3755sj206o06oglj.jpg)
进行循环补全：
![](http://ww2.sinaimg.cn/mw690/6941baebgw1f81lgfk9q2j208c06o3yh.jpg)
提取水印：
![](http://ww2.sinaimg.cn/mw690/6941baebgw1f81l805d1gj208c06o75t.jpg)
3.伸缩攻击（这个实验明码做的，水印能量较高，隐匿性不强）：
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l818ue8j206o06oglj.jpg)
提取水印（水印加的不好，混频挺严重的）：
![](http://ww3.sinaimg.cn/mw690/6941baebgw1f81l7zmzwwj208c06o0ua.jpg)
4.旋转攻击（明码）：
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l7zjuzej208c06o74l.jpg)
提取水印：
![](http://ww2.sinaimg.cn/mw690/6941baebgw1f81l7z3xtgj208c06odh6.jpg)
5.JPEG压缩后（这个实验我好像是拿明码做的，能量主要加在了高频）：
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l7yffkhj208c06odfu.jpg)
提取结果：
![](http://ww2.sinaimg.cn/mw690/6941baebgw1f81l7y95y1j208c06o75o.jpg)
6.PS 4像素马赛克/均值滤波等，攻击后图像(这是我女朋友吗？丑死了)：
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l7xq39zj208c06o0sz.jpg)
提取水印后图像：
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l7x7kvgj208c06oabc.jpg)
7.截屏，
截屏后我手动抠出要测试的图像区域，并且抽样或者插值到原图尺寸：
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l7wrd0lj208c06owev.jpg)
测试结果：
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l7w4ce9j208c06omyi.jpg)
8. 亮度调节（明码）：
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l7vfj03j208c06owed.jpg)
水印提取：
![](http://ww3.sinaimg.cn/mw690/6941baebgw1f81l7vnhjlj208c06owg3.jpg)
9.色相调节（明码）：
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l7ulwogj208c06o3yi.jpg)
水印提取：
![](http://ww3.sinaimg.cn/mw690/6941baebgw1f81l7u9eogj208c06ojsk.jpg)
10.饱和度调节（明码）：
![](http://ww3.sinaimg.cn/mw690/6941baebgw1f81l7ubin2j208c06o0sq.jpg)
水印：
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l7tbzj4j208c06o75q.jpg)
11.对比度（明码）：
![](http://ww2.sinaimg.cn/mw690/6941baebgw1f81l7sto9wj208c06omx5.jpg)
水印：
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l7sgz0bj208c06o402.jpg)
12.评论区用waifu2x去噪后图片：
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l7sso1uj208c06oq2x.jpg)
解水印：
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l7ryharj208c06omy8.jpg)
13.美图秀秀，我对我女票一键美颜，美白，磨皮，加腮红，加唇彩（有一种很羞耻的感觉，捂脸）：
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l7rl9gwj208c06oglo.jpg)
提取水印：
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l7r67mbj208c06omy8.jpg)
14.对于背景纯色的图其实也是无所谓的
![](http://ww3.sinaimg.cn/mw690/6941baebgw1f81l7qdxpdj208w06owep.jpg)
能量系数为10时加水印图片：觉得太显噪就把能量系数调低，不过水印的隐秘性和鲁棒性是互斥的
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l7q17zhj208w06ojrj.jpg)
最终提取出的水印：
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l7pyq66j208w06o0su.jpg)
15.我用将RGB>600的像素设置成为(0，255，0)来模拟PS魔术手，
![](http://ww1.sinaimg.cn/mw690/6941baebgw1f81l7pmfkrj208w06o74k.jpg)
提取水印为：
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l7pbknyj208w06o0um.jpg)
16.屏摄，好吧，这个实验我做哭了
屏摄图：
![](http://ww3.sinaimg.cn/mw690/6941baebgw1f81l7ocjxdj208c06omxk.jpg)
实验结果：
![](http://ww4.sinaimg.cn/mw690/6941baebgw1f81l7nkeu6j208c06odhh.jpg)
我把水印能量系数调整到2000都没有用。
...
本文方法**针对屏摄**不行，我多次实验没有成功，哪位大神可以做一下或者讨论讨论。还有二值化不行，这是我想当然的，觉得肯定不行所以没做实验。其他的我试了试，用给出的方法调整一下能量系数都可以。我想大家最关心的是什么最安全，不会被追踪。
不涉及图像的都安全，比如拿笔记下来。涉及图像的**屏摄最安全**，截屏十分不安全。
=====**彩蛋**====
![](http://ww2.sinaimg.cn/mw690/6941baebgw1f81l7nf25tj208k06f3yv.jpg)
我在上图明码写入了信息。为了抵抗jpg压缩，我水印能量较高，并且因为没有编码，能量分布不均。图中规律性纹路，就是你懂的。嘿嘿，你懂的，解开看看吧。
[@杨一丁](//www.zhihu.com/people/58bf4ee9c1518503b1766f3b3366d6be) 在答案中给出了上图隐写的内容，（雾）。
**五、附录**
...
figure, imshow(FAO); title('watermarked image');
```
### 二、[shotgun 的回答分享](https://www.zhihu.com/question/50735753/answer/122777762)，254 顶
