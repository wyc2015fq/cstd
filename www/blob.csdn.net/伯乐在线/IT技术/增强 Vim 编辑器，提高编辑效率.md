# 增强 Vim 编辑器，提高编辑效率 - 文章 - 伯乐在线
原文出处： [Girish Managoli](https://opensource.com/article/18/9/vi-editor-productivity-powerhouse)   译文出处：[Linux中国/idea2act](https://linux.cn/article-10039-1.html)
...
set number
```
![](http://jbcdn2.b0.upaiyun.com/2018/09/a36b261b6f71c696462598de3acdf5d4.png)
要在文本行超过一定长度时自动换行：
...
set showmatch
```
![](http://jbcdn2.b0.upaiyun.com/2018/09/eb3fb3097f9b2d154e8a5eb44c82c84d.jpg)
### 3. 搜索
高亮搜索内容的所有匹配位置：
...
set hlsearch
```
![](http://jbcdn2.b0.upaiyun.com/2018/09/aae2ba05559f98a8dac71202c1de82f6.png)
搜索过程中动态显示匹配内容：
...
set incsearch
```
![](http://jbcdn2.b0.upaiyun.com/2018/09/327cf7882ec8d967ca6b5930f031d829.png)
搜索时忽略大小写：
...
![](http://jbcdn2.b0.upaiyun.com/2018/09/95f6d1a5dd90f97b56eb8030c7636612.jpg)
...
set laststatus=2
```
![](http://jbcdn2.b0.upaiyun.com/2018/09/5ba560439be8027fd02d4f4d1633a1ca.png)
### 5. 拼写
...
![](http://jbcdn2.b0.upaiyun.com/2018/09/1e95aa06e28b8bad52276ecf7f3121c5.png)
使用命令行获取帮助：
...
:help autoindent
```
![](http://jbcdn2.b0.upaiyun.com/2018/09/2185972aa793a200947ea4be508b99b1.jpg)
