# 把 SQL Server 迁移到 Linux？不如换成 MySQL - 文章 - 伯乐在线
原文出处： [Tony Branson](https://www.howtoforge.com/tutorial/moving-with-sql-server-to-linux-move-from-sql-server-to-mysql-as-well/)   译文出处：[Linux中国](https://linux.cn/article-8073-1.html)
