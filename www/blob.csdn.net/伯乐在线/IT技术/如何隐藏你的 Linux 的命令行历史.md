# 如何隐藏你的 Linux 的命令行历史 - 文章 - 伯乐在线
原文出处： [Himanshu Arora](https://www.maketecheasier.com/linux-command-line-history-incognito/)   译文出处：[chunyang-wen](https://linux.cn/article-7575-1.html)
...
```
下面的截图是这种方式的一个例子。
![](http://jbcdn2.b0.upaiyun.com/2016/07/4a15d336a1fa2014dc277255d3649c8f.png)
...
```
下面是这个例子的截图。
![](http://jbcdn2.b0.upaiyun.com/2016/07/4f683a1410e5a3b63acbe1cac9b54394.png)
第二个 ‘echo’命令被成功的删除了。
