# Linux 包管理基础：apt、yum、dnf 和 pkg - 文章 - 伯乐在线
原文出处： [Brennen Bearnes](https://www.digitalocean.com/community/tutorials/package-management-basics-apt-yum-dnf-pkg)   译文出处：[Linux中国/Snapcrafter](https://linux.cn/article-8782-1.html)
### 介绍
