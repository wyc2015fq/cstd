# 一个开源项目维护者的笔记：为什么我关闭 PR - 文章 - 伯乐在线
原文出处： [jeffgeerling](https://www.jeffgeerling.com/blog/2016/why-i-close-prs-oss-project-maintainer-notes)   译文出处：[oschina/局长](https://www.oschina.net/news/81789/why-i-close-prs-oss-project-maintainer-notes)
...
#### **一切都应该通过自动化测试**
几乎每个我维护的项目都至少全面覆盖了通过 Travis CI，Jenkins 或其他 CI 系统的 ‘happy path’。[If You Breaka My Tests I Breaka You Face](https://www.amazon.com/SmartSign-Lyle-K2-0113-AL-12x18-Breaka-Aluminum/dp/B01KIYWD70/ref=as_li_ss_tl?ie=UTF8&qid=1482861696&sr=8-1-fkmr0&keywords=if+you+taka+my+space+i+breaka+your+face&linkCode=ll1&tag=mmjjg-20&linkId=71ba06c689653589697ff5c93c95491f)。但也会有少数例外的情况，如果所有测试都不通过，我不会合并 PR。我也不会合并具有大量新的、未测试功能的 PR。我不要求覆盖 100% 的单元测试，但所有的 happy path 应该经过测试。
#### **可维护性 > 完整性**
