# Linux 的 EXT4 文件系统的历史、特性以及最佳实践 - 文章 - 伯乐在线
原文出处： [David Both](https://opensource.com/article/17/5/introduction-ext4-filesystem)   译文出处：[Linux中国/chenxinlong](https://linux.cn/article-8685-1.html)
...
![图 1： EXT 文件系统中的柱面组的结构](https://dn-linuxcn.qbox.me/data/attachment/album/201707/11/154011lxv9mpu50c5v0xa5.png)
...
![图 2 ：inode 存储有关每个文件的信息，并使 EXT 文件系统能够查找属于它的所有数据。](https://dn-linuxcn.qbox.me/data/attachment/album/201707/11/154012v1jru7qjxs47fc71.png)
