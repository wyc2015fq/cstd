# 在 Linux 中自动配置 IPv6 地址 - 文章 - 伯乐在线
原文出处： [Carla Schroder](https://www.linux.com/learn/intro-to-linux/2017/12/ipv6-auto-configuration-linux)   译文出处：[Linux中国/qhwdw](https://linux.cn/article-9434-1.html)
在 [KVM 中测试 IPv6 网络：第 1 部分](https://www.linux.com/learn/intro-to-linux/2017/11/testing-ipv6-networking-kvm-part-1) 一文中，我们学习了关于唯一本地地址unique local addresses（ULA）的相关内容。在本文中，我们将学习如何为 ULA 自动配置 IP 地址。
### 何时使用唯一本地地址
