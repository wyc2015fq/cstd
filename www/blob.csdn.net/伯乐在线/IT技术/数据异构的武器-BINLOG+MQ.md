# 数据异构的武器-BINLOG+MQ - 文章 - 伯乐在线
原文出处： [新栋BOOK](https://my.oschina.net/wangxindong/blog/1531596)
### 1、定义
...
![异构维度.png](http://jbcdn2.b0.upaiyun.com/2017/09/fa46be3f45850ad48951742bb9ec51df.png)
异构维度
**总结起来大概有以下几种场景**
- 数据库镜像
- 数据库实时备份
...
- 价格、库存变化等重要业务消息
### 3、数据异构方向
![异构的几种方向.png](http://jbcdn2.b0.upaiyun.com/2017/09/939f4abdb92c7c0ce9a8ba0918d85180.png)
几种异构方式
...
![canal异构方式.png](http://jbcdn2.b0.upaiyun.com/2017/09/a8369973e6880af9e85c3c0477430595.png)
canal异构方式
##### 5.1.2、使用说明
...
![mysql主备复制实现原理.jpg](http://jbcdn2.b0.upaiyun.com/2017/09/daadf7db68a30d1e844ebee84d7f854c.jpg)
mysql主备复制实现原理
...
再来看下canal的原理，如下图：
![canal工作原理.jpg](http://jbcdn2.b0.upaiyun.com/2017/09/a82380169db0d36662aaefb8c910003a.jpg)
...
**有关canal更具体的使用和详细原理请参照：[https://github.com/alibaba/canal](https://github.com/alibaba/canal)**
##### 5.1.4、注意点
- 1、确认MySQL开启binlog，使用**show variables like ‘log_bin’;** 查看ON为已开启
- 2、确认目标库可以产生binlog，**show master status** 注意Binlog_Do_DB，Binlog_Ignore_DB参数
- 3、确认binlog格式为ROW，使用**show variables like ‘binlog_format’;** 非ROW模式登录MySQL执行 **set global binlog_format=ROW; flush logs;** 或者通过更改MySQL配置文件并重启MySQL生效。
...
#### 5.2、mq方式
![MQ异构方式.png](http://jbcdn2.b0.upaiyun.com/2017/09/fd773d9eb65abb904785d4dbd31196d3.png)
MQ异构方式
...
**转载请注明出处，并附上链接 https://my.oschina.net/wangxindong/blog/1531596**
参考资料：[https://github.com/alibaba/canal](https://github.com/alibaba/canal)
