# 三款简单而优秀的 Linux 网络监视工具 - 文章 - 伯乐在线
原文出处： [Carla Schroder](https://www.linux.com/learn/intro-to-linux/2017/10/3-simple-excellent-linux-network-monitors)   译文出处：[Linux中国/nodekey](https://linux.cn/article-9284-1.html)
> 
...
- `p` 暂停显示更新。
- `q` 退出程序。
![text display](http://jbcdn2.b0.upaiyun.com/2018/01/e648c6c2bf6d2eb4da04ede2c411d4b0.png)
*图 1:组织性和可读性良好的文本显示。*
...
```
![vnstati](http://jbcdn2.b0.upaiyun.com/2018/01/8fc64a29fff93e65cff2e523c0861ec7.png)
