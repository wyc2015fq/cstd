# Linux 内核学习经验总结 - 文章 - 伯乐在线
原文出处： [冰凌块儿](http://blog.chinaunix.net/uid-24669930-id-4039377.html)
### **开篇**
...
尽信书不如无书。
[http://lwn.net/Articles/419855/](http://lwn.net/Articles/419855/) 此处是一篇关于LKD3的书评，指出了其中的错误，当你读完的时候，不妨去找找，看一下自己在其中所描述的地方有什么特别的印象。
[http://lwn.net/Articles/161190/](http://lwn.net/Articles/161190/)此处是一篇对ULK3的介绍，我认为其中很关键的几句话就可以给本书定位：
