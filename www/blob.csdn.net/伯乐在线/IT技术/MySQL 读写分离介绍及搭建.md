# MySQL 读写分离介绍及搭建 - 文章 - 伯乐在线
原文出处： [bestvivi](https://segmentfault.com/a/1190000003716617)
![MySQL读写分离01](http://jbcdn2.b0.upaiyun.com/2016/04/0179acef207be44c777afd46519971bf.png)
...
![MySQL读写分离02](http://jbcdn2.b0.upaiyun.com/2016/04/e403fd94060ea1f83fd9aee2acad3d23.png)
## MySQL读写分离配置
MySQL环境准备
master 192.168.1.5
slave 192.168.1.6
...
mysql> grant all on *.* to libai@'192.168.1.%' identified by 'lib;
```
