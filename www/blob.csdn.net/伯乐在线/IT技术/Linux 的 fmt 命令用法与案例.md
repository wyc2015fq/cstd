# Linux 的 fmt 命令用法与案例 - 文章 - 伯乐在线
原文出处： [Himanshu Arora](https://www.howtoforge.com/linux-fmt-command/ )   译文出处：[lujun9972](https://linux.cn/article-9240-1.html)
...
```
下面截屏是命令的执行结果：
![format contents of file in single line](http://jbcdn2.b0.upaiyun.com/2018/01/435b2ea3a3a986139f36c1d3ba19f5db.png)
...
```
下面这个例子把行宽削减到了 20：
![change maximum line width](http://jbcdn2.b0.upaiyun.com/2018/01/d104ae214b626206e10c813ff6da7dd2.png)
### Q3、如何让 fmt 突出显示第一行？
...
fmt -t [file-name]
```
![make fmt highlight the first line](http://jbcdn2.b0.upaiyun.com/2018/01/20eefe77b7ac2caa4e2d1868d5ee9548.png)
### Q4、如何使用 fmt 拆分长行？
...
```
下面是一个例子：
![make fmt split long lines](http://jbcdn2.b0.upaiyun.com/2018/01/b5087c0f6ec116a53f90d84902fe07cd.png)
