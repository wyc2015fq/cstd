# Linux 主目录中的隐藏文件是干什么用的？ - 文章 - 伯乐在线
原文出处： [Alexander Fox](https://www.maketecheasier.com/hidden-files-linux-home-directory/)   译文出处：[Linux中国/MjSeven](https://linux.cn/article-9409-1.html)
在 Linux 系统中，你可能会在主目录中存储了大量文件和文件夹。但在这些文件之外，你知道你的主目录还附带了很多隐藏的文件和文件夹吗？如果你在主目录中运行 `ls -a`，你会发现一堆带有点前缀的隐藏文件和目录。这些隐藏的文件到底做了什么？
### 在主目录中隐藏的文件是干什么用的?
![hidden-files-liunux-2](http://jbcdn2.b0.upaiyun.com/2018/03/c96c574ca76e6b552476e508f1247902.png)
...
### 主目录中某些隐藏文件的特定用途是什么？
![hidden-files-linux-3](http://jbcdn2.b0.upaiyun.com/2018/03/e5c7ad21014cb9f242377c5c8c36e38f.png)
