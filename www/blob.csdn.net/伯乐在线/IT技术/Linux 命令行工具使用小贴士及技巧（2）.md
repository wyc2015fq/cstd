# Linux 命令行工具使用小贴士及技巧（2） - 文章 - 伯乐在线
原文出处： [Ansh](https://www.howtoforge.com/tutorial/linux-command-line-tips-tricks-part-2/)   译文出处：[Linux中国 - geekpi](https://linux.cn/article-8371-1.html)
的[在本系列第一部分](http://blog.jobbole.com/110739/)中，我们通过讨论 `cd -` 命令的用法，重点介绍了 Linux 中的命令行导航。还讨论了一些其他相关要点/概念。现在进一步讨论，在本文中，我们将讨论如何使用 `pushd` 和 `popd` 命令在 Linux 命令行上获得更快的导航体验。
