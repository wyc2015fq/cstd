# 大数据系统数据采集产品的架构分析 - 文章 - 伯乐在线
原文出处： [taogang](http://my.oschina.net/taogang/blog/524385)
任何完整的大数据平台，一般包括以下的几个过程：
- 数据采集
- 数据存储
- 数据处理
- 数据展现（可视化，报表和监控）
![](http://ww3.sinaimg.cn/mw690/63918611jw1f4udt29riij20z90k8gq2.jpg)
...
![](http://ww3.sinaimg.cn/mw690/63918611jw1f4udt4b9x4j20ne034jrv.jpg)
Flume设计成一个分布式的管道架构，可以看作在数据源和目的地之间有一个Agent的网络，支持数据路由。
![](http://ww2.sinaimg.cn/mw690/63918611jw1f4udt6fklnj20mo06xwf4.jpg)
...
![](http://ww3.sinaimg.cn/mw690/63918611jw1f4udt8o52aj21j80g2tcq.jpg)
Flume在source和sink端都使用了transaction机制保证在数据传输中没有数据丢失。
![](http://ww4.sinaimg.cn/mw690/63918611jw1f4udtb8drwj21d60fe41m.jpg)
Source上的数据可以复制到不同的通道上。每一个Channel也可以连接不同数量的Sink。这样连接不同配置的Agent就可以组成一个复杂的数据收集网络。通过对agent的配置，可以组成一个路由复杂的数据传输网络。
![](http://ww4.sinaimg.cn/mw690/63918611jw1f4udusv326j20qm0i0gmv.jpg)
配置如上图所示的agent结构，Flume支持设置sink的Failover和Load Balance，这样就可以保证即使有一个agent失效的情况下，整个系统仍能正常收集数据。
![](http://ww2.sinaimg.cn/mw690/63918611jw1f4uduuwcw7j218i0fgjv0.jpg)
...
![](http://ww1.sinaimg.cn/mw690/63918611jw1f4uduwz4rbj20py0fg765.jpg)
Fluentd的部署和Flume非常相似：
![](http://ww3.sinaimg.cn/mw690/63918611jw1f4uduz5szjj20n80ci772.jpg)
![](http://ww2.sinaimg.cn/mw690/63918611jw1f4udv0zlfej20m20da41a.jpg)
Fluentd的架构设计和Flume如出一辙：
![](http://ww3.sinaimg.cn/mw690/63918611jw1f4udvbp8moj20mq0bkjt3.jpg)
...
Fluentd的配置非常方便，如下图：
![](http://ww4.sinaimg.cn/mw690/63918611jw1f4udvdxex3j20x20f8jxo.jpg)
Fluentd的技术栈如下图：
![](http://ww4.sinaimg.cn/mw690/63918611jw1f4udvfudhdj20v20ne420.jpg)
FLuentd和其插件都是由Ruby开发，[MessgaePack](https://github.com/msgpack)提供了JSON的序列化和异步的并行通信RPC机制。
![](http://ww1.sinaimg.cn/mw690/63918611jw1f4udvilpbfj20nw090abe.jpg)
...
![](http://ww4.sinaimg.cn/mw690/63918611jw1f4udvlsd81j20y40faq4s.jpg)
...
Chukwa的部署架构如下。
![](http://ww3.sinaimg.cn/mw690/63918611jw1f4udvvp444j20os0ec0vq.jpg)
...
![](http://ww3.sinaimg.cn/mw690/63918611jw1f4udvzm0wwj20p60eigo7.jpg)
### Splunk Forwarder
...
![](http://ww2.sinaimg.cn/mw690/63918611jw1f4udw1nkszj20vw0we42t.jpg)
