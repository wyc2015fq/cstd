# Linux 26 周年，来一场怀旧之旅 - 文章 - 伯乐在线
原文出处： [Jim Hall](https://opensource.com/article/17/8/linux-anniversary)   译文出处：[Linux中国/softpaopao](https://linux.cn/article-8836-1.html)
> 
...
![Installing SLS 1.05 from the login prompt](http://jbcdn2.b0.upaiyun.com/2017/09/5c45499b688747f0526bf130c0154587.png)
在 SLS 1.05 中引入的一个漂亮的功能是支持彩色的文本模式安装器。当我选择彩色模式时，安装器切换到一个带有黑色文字的亮蓝色背景，不再是我们祖祖辈辈们使用的原始的普通黑白文本。
![Color-enabled text-mode installer in SLS 1.05](http://jbcdn2.b0.upaiyun.com/2017/09/a6012be8a0eee0df8f3e26191734cd8a.png)
...
![Creating a partition for Linux, putting an ext2 filesystem on it, and installing Linux](http://jbcdn2.b0.upaiyun.com/2017/09/ec187c4e241e9271150072dbe7d4cdfe.png)
![First boot](http://jbcdn2.b0.upaiyun.com/2017/09/387f178eb53fc2ac018d8054a21e7071.png)
### 系统级别
...
![Checking out the filesystem and available disk space](http://jbcdn2.b0.upaiyun.com/2017/09/f4a217e99547a2749af4bb5c658d56df.png)
熟悉的 `/proc` 元文件系统在 Linux 1.0 就存在了，尽管对比我们今天在现代系统上看到的，它并不能提供许多信息。在 Linux 1.0， `/proc` 包含一些接口来探测类似 `meminfo` 和 `stat` 之类的基本系统状态。
![The familiar /proc meta filesystem](http://jbcdn2.b0.upaiyun.com/2017/09/8419659167d2ca26f0182224283a317d.png)
...
![The /etc directory](http://jbcdn2.b0.upaiyun.com/2017/09/237938a3c980e846b2d65d67899e6ddb.png)
### 你能做些什么
...
![The Softlanding menu shell (MESH)](http://jbcdn2.b0.upaiyun.com/2017/09/b7f623257b1323375b9a13f652b57a2d.png)
除了 MESH 之外，在 SLS 1.05 中还少量包含了一些全屏应用程序。你可以找到熟悉的用户工具，包括 Elm 邮件阅读器、GNU Emacs 可编程编辑器，以及古老的 Vim 编辑器。
![Elm mail reader](http://jbcdn2.b0.upaiyun.com/2017/09/91dd27186da1961d4ca3e93928ff0956.png)
![GNU Emacs programmable editor](http://jbcdn2.b0.upaiyun.com/2017/09/f752eaf2abf8ea574b328c61f914cc33.png)
SLS 1.05 甚至包含了一个可以让你在终端玩的俄罗斯方块版本。
![Tetris for terminals](http://jbcdn2.b0.upaiyun.com/2017/09/7f441201064939f5d49061a65a0fcdf0.png)
...
![Minicom modem-dialer application](http://jbcdn2.b0.upaiyun.com/2017/09/13b052925335f4bf15a61e2a2f73352b.png)
...
![A simple nroff text document](http://jbcdn2.b0.upaiyun.com/2017/09/ec200b92a91cd1e94945295a30d3eb8c.png)
![nroff text document output](http://jbcdn2.b0.upaiyun.com/2017/09/f217fcd68ed4087077ecc9c0214f0fe4.png)
### 运行 X windows
...
![The syssetup program](http://jbcdn2.b0.upaiyun.com/2017/09/bcaea8d4616c94e53487a762f0b7eaf0.png)
但这是来自于 1994 年的 X windows，它仍然并没有桌面的概念。我可以从 FVWM （一个虚拟窗口管理器）或 TWM （选项卡式的窗口管理器）中选择。TWM 直观地设置提供一个功能简单的图形环境。
![TWM](http://jbcdn2.b0.upaiyun.com/2017/09/97c8eadaf2ce93c38995b0a92e839fc5.png)
### 关机
...
![Shutting down](http://jbcdn2.b0.upaiyun.com/2017/09/b6254ead7170bd2dbacf864457006fdc.png)
