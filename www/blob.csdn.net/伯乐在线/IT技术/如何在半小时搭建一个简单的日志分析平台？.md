# 如何在半小时搭建一个简单的日志分析平台？ - 文章 - 伯乐在线
原文出处： [翟志军](https://my.oschina.net/zjzhai/blog/751246)
...
#### 简单日志分析架构图
![](http://ww2.sinaimg.cn/mw690/63918611gw1f8958e3z4oj213q0qkjx6.jpg)
...
```
更多关于Vagrantfile：[https://www.vagrantup.com/docs/vagrantfile/](https://www.vagrantup.com/docs/vagrantfile/)
...
192.168.4.10
```
具体请看文档：[http://docs.ansible.com/ansible/intro_inventory.html](http://docs.ansible.com/ansible/intro_inventory.html)
- `-u vagrant -k` 表示使用vagrant账号ssh登录目标机器
**部署的这个过程，要看你的网速和elastic源的提供速度，可能会很漫长。** 参考时长为半小时。建议执行部署后，做些别的事情，比如午休。
#### 测试部署是否成功
- 打开Elasticsearch [http://192.168.4.10:9200/_plugin/head/](http://192.168.4.10:9200/_plugin/head/) 可看到界面：![](http://ww2.sinaimg.cn/mw690/63918611gw1f8958ekaguj21oa0pw43l.jpg)
- 打开Kibana [http://192.168.4.10:5601](http://192.168.4.10:5601/) 可看到界面：![](http://ww4.sinaimg.cn/mw690/63918611gw1f8958ez67tj21og12ugr6.jpg)
- - 打开各种浏览器，输入url：[http://192.168.4.10/1.gif?account=oschina&e=pv&p=p233444&url=www.oschina.net&title=学习&sh=1200&sw=800&cd=400&lang=en](http://192.168.4.10/1.gif?account=oschina&e=pv&p=p233444&url=www.oschina.net&title=%E5%AD%A6%E4%B9%A0&sh=1200&sw=800&cd=400&lang=en)，然后可在Elasticsearch中和kibana中看到相应的数据
