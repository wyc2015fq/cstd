...
![2-qa](http://insights.thoughtworkers.org/wp-content/uploads/2016/11/2-QA-1024x722.png)
#### 1. 理解和澄清业务需求
...
![3-bottle](http://insights.thoughtworkers.org/wp-content/uploads/2016/11/3-bottle.jpg)
> 
##### 注意：
...
可以参考[测试四象限](http://lisacrispin.com/2011/11/08/using-the-agile-testing-quadrants/)和[测试金字塔](http://martinfowler.com/bliki/TestPyramid.html)等模型来制定测试策略，并根据产品发布周期制定具体的测试计划、设计测试内容。
> 
##### 注意
设计测试，不仅是指设计测试用例。
...
> 
##### 注意
缺陷分析是非常重要的一个环节，但却很容易被忽略。关于缺陷管理的更多详细内容请参考我的另一篇文章[《软件缺陷的有效管理》](http://www.jianshu.com/p/cf5c0fce6ccc)。
...
![SONY DSC](http://insights.thoughtworkers.org/wp-content/uploads/2016/11/4-Somnium.jpg)
...
![5-i-cant](http://insights.thoughtworkers.org/wp-content/uploads/2016/11/5-i-cant.jpg)
#### 各项软技能
