# 通过这 9 本开源好书学习 C 语言 - 文章 - 伯乐在线
本文由 [伯乐在线](http://blog.jobbole.com) - [艾凌风](http://www.jobbole.com/members/hanxiaomax) 翻译。未经许可，禁止转载！
英文出处：[Steve Emms](https://www.ossblog.org/learn-c-programming-with-9-excellent-open-source-books/)。欢迎加入[翻译组](https://github.com/jobbole/translation-project)。
...
## [《 C 语言》（ *The C Book*）](http://publications.gbdirect.co.uk/c_book/)
![](http://wx4.sinaimg.cn/large/63918611gy1fcpp4ada1kj205b07ndg4.jpg)
...
## [风格的要素—— C 语言版（*C Elements of Style*）](http://www.oualline.com/books.free/style/index.html)
![](http://wx4.sinaimg.cn/mw690/63918611gy1fcpp43madyj205b06qgll.jpg)
...
本书通过知识共享协议发布。
## [《编写你自己的Lisp语言》（*Build Your Own Lisp*）](http://buildyourownlisp.com/)
![](http://wx2.sinaimg.cn/mw690/63918611gy1fcpp43al2ej205b07wjrg.jpg)
...
![](http://wx1.sinaimg.cn/mw690/63918611gy1fcpp45dh2ij205b07ddfm.jpg)
...
![](http://wx1.sinaimg.cn/mw690/63918611gy1fcpp44ut72j20d70hpdfo.jpg)
...
## [《 C 语言基础》（*Essential C*）](http://cslibrary.stanford.edu/101/EssentialC.pdf)
![](http://wx2.sinaimg.cn/mw690/63918611gy1fcpp446mgnj205b075glz.jpg)
...
## [《Beej的 C 语言教程》（*Beej’s Guide to C Programming*）](http://beej.us/guide/bgc/)
![](http://wx3.sinaimg.cn/mw690/63918611gy1fcpp42isi9j205b077q2q.jpg)
...
![](http://wx4.sinaimg.cn/large/63918611gy1fcpp4a2s6jj205b0750so.jpg)
...
本书基于Creative Commons Attribution-Noncommercial- No Derivative Works 3.0 协议发布
## [《GCC简介》（*An Introduction to GCC*）](http://www.network-theory.co.uk/docs/gccintro/)
![](http://wx3.sinaimg.cn/mw690/63918611gy1fcpp48yo4qj205b07x407.jpg)
作者 Brian Gough ，144页
...
- 编译带有debug信息的程序——提供了一个`-g`选项用以在中间文件和可执行文件中存储额外的调试信息。这些调试信息使得我们可以追踪错误，将机器指令中的问题定位到源代码中。
...
- 编译器相关工具——介绍了GCC编译过程中会用到的一些有用的工具。包括用来创建库的 GNU 归档工具 **ar**，GNU 性能和覆盖率测试程序**gprof** 和 *gcov*
...
- [《C编程导论》（ *Introduction to C Programming* ）](http://www.tti.unipa.it/~ricrizzo/KS/Data/RMiles/contents.html)– 作者 Rob Miles
- [《新标准 C 语言》（*The New Standard C: An Economic and Cultural Commentary）*](http://www.coding-guidelines.com/cbook/cbook1_2.pdf) – 作者 Derek M. Jones
- [《使用标准 C 语言进行面向对象编程》（*Object-Oriented Programming with ANSI-C* ）](http://www.cs.rit.edu/~ats/books/ooc.pdf)– 作者 Axel-Tobias Schreiner
- [《编写零缺陷的 C 语言代码》（*Writing Bug-Free C Code）*](http://www.duckware.com/bugfreec/index.html)– 作者 Jerry Jongenius
最后，如果你想买一本权威参考书，请认准《[C程序设计语言](https://www.amazon.cn/gp/product/B0011425T8/ref=as_li_qf_sp_asin_il_tl?ie=UTF8&camp=536&creative=3200&creativeASIN=B0011425T8&linkCode=as2&tag=vastwork-23)》（*The C Programming Language*）。这本书非常简练，不适合新手，但是被奉为经典。
> 
**打赏支持我翻译更多好文章，谢谢！**
[打赏译者](#rewardbox)
#### 打赏支持我翻译更多好文章，谢谢！
