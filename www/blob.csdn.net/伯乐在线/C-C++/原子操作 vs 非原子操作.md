# 原子操作 vs 非原子操作 - 文章 - 伯乐在线
本文由 [伯乐在线](http://blog.jobbole.com) - [欣仔](http://www.jobbole.com/members/randomli) 翻译。未经许可，禁止转载！
英文出处：[Jeff Preshing](http://preshing.com/20130618/atomic-vs-non-atomic-operations/)。欢迎加入[翻译组](https://github.com/jobbole/translation-project)。
...
- 如果一个线程在两个机器指令的间隙先调用存储变量，将会在内存中留下像0x0000000000000002这样的值——这是一个**写撕裂**。在这个时候，如果另一个线程读取共享变量，它将会接收到一个完全伪造的、没有人想要存储的值。
