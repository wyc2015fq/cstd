# STL 的 erase() 陷阱-迭代器失效总结 - 文章 - 伯乐在线
原文出处： [jackjoe，2015-10-30](http://www.cnblogs.com/blueoverflow/p/4923523.html#top)
下面材料整理自Internet&著作。
...
```
##### 2.2 注意
**注****意：vector、deque 不能像上面的“正确使用方法2”的办法来遍历删除。原因请参考Effective STL条款9。摘录到下面：**
