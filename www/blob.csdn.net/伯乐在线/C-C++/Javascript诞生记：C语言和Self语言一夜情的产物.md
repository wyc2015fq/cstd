# Javascript诞生记：C语言和Self语言一夜情的产物 - 文章 - 伯乐在线
原文出处： [阮一峰](http://www.ruanyifeng.com/blog/2011/06/birth_of_javascript.html)
1.
二周前，我谈了一点Javascript的历史。
今天把这部分补全，从历史的角度，说明Javascript到底是如何设计出来的。
只有了解这段历史，才能明白Javascript为什么是现在的样子。我[依据的资料](http://brendaneich.com/2008/04/popularity/)，主要是Brendan Eich的自述。
2.
上一篇文章写道：
