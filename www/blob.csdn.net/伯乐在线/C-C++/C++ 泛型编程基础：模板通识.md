# C++ 泛型编程基础：模板通识 - 文章 - 伯乐在线
原文出处： [Fireplusplus](http://blog.csdn.net/qq_33724710/article/details/51711128)
> 
...
- 不进行参数类型检测,安全性不高
- 编译预处理阶段完成替换，调试不便
所以在C++中又引入了**泛型编程**的概念。泛型编程是编写与类型无关的代码。这是代码复用的一种手段。模板则是泛型编程的基础。
模板分为了函数模板和类模板：
![](http://jbcdn2.b0.upaiyun.com/2016/11/2074de11ed8bab98e090f585414c8a50.png)
### 函数模板
...
```
![](http://jbcdn2.b0.upaiyun.com/2016/11/4ad5ac6fe27b6556d73e021eece55190.png)
...
#### 实例化
编译器用模板产生指定的类或者函数的特定类型版本,产生模板特定类型的过程称为函数模板**实例化**。(用类类型来创建一个对象也叫做实例化哦！)
#### 模板的编译
模板被编译了两次:
...
```
编译器生成了如下这样的函数：
![](http://jbcdn2.b0.upaiyun.com/2016/11/9377b5d5c9d0eff1d4f6770f409b4f7d.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/11/5321166579fb3d6f7181509ded5e679a.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/11/eabba28ef19082e81b4df778d9252d65.png)
模板形参的名字在同一模板形参列表中只能使用一次。
![](http://jbcdn2.b0.upaiyun.com/2016/11/2ba4d2bd8e9fa13c44f413e2be68c48d.png)
所有模板形参前面必须加上class或者typename关键字修饰。
![](http://jbcdn2.b0.upaiyun.com/2016/11/5517ce5007cc5738cad06d3f7db0e620.png)
...
```
再次强调，实参类型必须与特化版本函数的形参类型**完全匹配**，哪怕实参前边修饰的没有const，而模板形参中有，也不会构成特化。特化版本是对应于此模板而写的，特化版本的参数类型必须完全与模板形参相同，如上述例子中，都为const &。
### 类模板
#### 格式
