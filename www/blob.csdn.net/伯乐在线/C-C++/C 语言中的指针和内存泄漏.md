...
原文出处： [IBM DeveloperWorks](http://www.ibm.com/developerworks/cn/aix/library/au-toughgame/)
## 引言
...
```
##### 图 1. 垃圾数据
![](http://ww3.sinaimg.cn/mw690/005RM8OMgw1emyi1dd0uwg305l00k0mk.gif)
...
##### 图 2. 原始 q 内容
![](http://ww1.sinaimg.cn/mw690/005RM8OMgw1emyi1e1mcng301m00j0a4.gif)
##### 图 3. 覆盖后的 q 内容
![](http://ww2.sinaimg.cn/mw690/005RM8OMgw1emyi1eaa72g301m00j0b3.gif)
...
这向如下面的图 4 所示的内存位置赋值。
##### 图 4. 内存位置
![](http://ww2.sinaimg.cn/mw690/005RM8OMgw1emyi1fp1xmg3079048mwy.gif)
...
##### 图 5. 内存泄漏
![](http://ww4.sinaimg.cn/mw690/005RM8OMgw1emyi1etroxg307h03tjr6.gif)
- 在对指针赋值前，请确保内存位置不会变为孤立的。
- 首先释放父块假设有一个指针 `memoryArea`，它指向一个 10 字节的内存位置。该内存位置的第三个字节又指向某个动态分配的 10 字节的内存位置，如图 6所示。
##### 图 6. 动态分配的内存
![](http://ww3.sinaimg.cn/mw690/005RM8OMgw1emyi1fznamg308p01ymwx.gif)
