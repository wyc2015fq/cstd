# C/C++内存泄漏及检测 - 文章 - 伯乐在线
原文出处： [吴秦](http://www.cnblogs.com/skynet/archive/2011/02/20/1959162.html)
...
![20110220175032977](http://jbcdn2.b0.upaiyun.com/2015/11/c314cd1828a7ae7aa0dd62cfdea6fa55.png)
如果没有使用 #define _CRTDBG_MAP_ALLOC 语句，内存泄漏转储将如下所示：
![201102201750332863](http://jbcdn2.b0.upaiyun.com/2015/11/cbab3c92ca6add11a043a9f5b751104a.png)
...
```
调试时，程序输出如下结果：
![201102201750331958](http://jbcdn2.b0.upaiyun.com/2015/11/7a9f716c3681c099b71a08571f74614f.png)
...
Linux下面也有原理相同的方法——mtrace，[http://en.wikipedia.org/wiki/Mtrace](http://en.wikipedia.org/wiki/Mtrace)。方法类似，我这就不具体描述，参加给出的链接。这节我主要介绍一个非常强大的工具valgrind。
如下图所示：
![201102201750364202](http://jbcdn2.b0.upaiyun.com/2015/11/e078bd14c03cc40aae55bcfc93f69f1e.png)
如上图所示知道：
