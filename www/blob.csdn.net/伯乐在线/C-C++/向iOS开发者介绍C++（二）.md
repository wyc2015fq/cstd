# 向iOS开发者介绍C++（二） - 文章 - 伯乐在线
原文出处： [Matt Galloway](http://www.raywenderlich.com/62990/introduction-c-ios-developers-part-2)   译文出处：[cocoachina](http://www.cocoachina.com/applenews/devnews/2014/0417/8182.html)
欢迎回到向iOS开发者介绍C++系列的第二部分（[向iOS开发者介绍C++（一）](http://blog.jobbole.com/66887/)） ！在第一部分，我们了解了类和内存管理。在第二部分部分我们将深入了解类以及其他有意思的特征。你将会了解到什么是“模板”以及标准模板库。
**多态性**
简单地说，多态性是一个重载子类中函数的概念。在Objective-C中，你可能已经做过很多次，例如，子类化UIViewController和重载viewDidLoad。
![parfwefrot_lion-480x305](http://jbcdn2.b0.upaiyun.com/2014/05/7508ee1d44ce5a2784d2051062586f0e.jpg)
...
现在开始了解虚拟函数是如何发挥作用的吧！
![picrgregregerg3](http://jbcdn2.b0.upaiyun.com/2014/05/46e5e3e18ec1bc64e837ae6f995d072a.png)
**虚函数的内部功能**
...
![pregregergrgwrgic4](http://jbcdn2.b0.upaiyun.com/2014/05/ddd35eaa843900a1e83751c0e608da15.png)
...
```
很强大，对吧？
![prgergrwegergic5](http://jbcdn2.b0.upaiyun.com/2014/05/e60be5ef685b10d6b1fb93793e6223af.png)
