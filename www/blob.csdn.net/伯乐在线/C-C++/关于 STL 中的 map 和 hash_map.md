# 关于 STL 中的 map 和 hash_map - 文章 - 伯乐在线
原文出处： [梦醒潇湘love](http://blog.chinaunix.net/uid-26548237-id-3800125.html)
...
```
这样，就可以使用equal_to>作为比较函数了。另一种方法就是使用函数对象。自定义一个比较函数体：
