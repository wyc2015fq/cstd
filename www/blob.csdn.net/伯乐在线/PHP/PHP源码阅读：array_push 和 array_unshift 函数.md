# PHP源码阅读：array_push 和 array_unshift 函数 - 文章 - 伯乐在线
...
内部实现的流程图如下：
![array_push流程图](http://jbcdn2.b0.upaiyun.com/2016/06/6eecb0ae188b4410451a52fc61b3c165.png)
### 源码解读
...
![zend_insert](http://jbcdn2.b0.upaiyun.com/2016/06/afc030e341b7a868803968c9f66e5ef7.png)
## array_unshift
...
实现的效果图如下：
![php_splice](http://jbcdn2.b0.upaiyun.com/2016/06/ba88eb18252c31b3c8c22e89316a9216.png)
## 小结
要理解array_push函数的执行过程主要理解栈的思想即可，而array_unshift则是新建一个数组，然后将两数组合并为结果数组。 这次阅读源码过程中，同时也研究了PHP中的哈希表数据结构及一些API，也给自己补充了一些哈希表的知识。学习到了PHP底层是使用双向链表做哈希冲突的处理，获益匪浅。日后再做关于PHP数据结构的分享。
