# PHP 实战之设计模式：PHP 中的设计模式 - 文章 - 伯乐在线
原文出处： [王下邀月熊](https://segmentfault.com/a/1190000003817321)
本文为翻译文章
> 
原文地址：[Design Patterns in PHP](http://www.devbattles.com/en/sand/post-1306-Design+Patterns+in+PHP#.Vg9o9Ohl9Bk.twitter)
如果打算学习PHP的童鞋可以参考下笔者的[编程语言学习知识体系要点列表](https://segmentfault.com/a/1190000004612590)
