# 漫画赏析：Linux 内核到底长啥样 - 文章 - 伯乐在线
原文出处： [Daniel Stori](http://turnoff.us/geek/inside-the-linux-kernel/)   译文出处：[bestony](https://linux.cn/article-8290-1.html)
...
在开始，我们先来看看这幅漫画的全貌！
![Inside the Linux Kernel](http://jbcdn2.b0.upaiyun.com/2017/03/d0e5d9795c14684deb0ab99fc2291c17.gif)
这幅漫画是以一个房子的侧方刨面图来绘画的。使用这样的一个房子来代表 Linux 内核。
### 地基
作为一个房子，最重要的莫过于其地基，在这个图片里，我们也从最下面的地基开始看起：
![Filesystem](http://jbcdn2.b0.upaiyun.com/2017/03/0f8e76ebc255a6f4ad127e5214d9c692.png)
...
### 一层（地面层）
![floor](http://jbcdn2.b0.upaiyun.com/2017/03/b40a2b4ffbc503f67f5aa7dd370b5a64.png)
看完了地基，接下来我们来看地基上面的一层，都有哪些东西。
![Process Table](http://jbcdn2.b0.upaiyun.com/2017/03/c5e84e0cc463c5815716781336a61393.png)
...
![watchdog](http://jbcdn2.b0.upaiyun.com/2017/03/2fb96784326b53eceae292e64acea838.jpg)
瞧瞧，垫子（进程表）旁边也有一只小狗，它会监控小企鹅的状态（监控进程），当小企鹅们不听话时，它就会汪汪地叫喊起来。
![httpd process](http://jbcdn2.b0.upaiyun.com/2017/03/7a77236f76c5a09a6d9e479b7bf97bcc.png)
...
![apache logo](http://jbcdn2.b0.upaiyun.com/2017/03/6155e478fda5ab579bfea8ccb23dfb8b.jpg)
向右看，我们可以看到这里仍有一扇门，门上写着 21，但是，看起来这扇门似乎年久失修，上面的门牌号都歪了，门口也没人守着。看起来这个 21 端口的 FTP 协议有点老旧了，目前用的人也比以前少了，以至于这里都没人接待了。
![Port 21](http://jbcdn2.b0.upaiyun.com/2017/03/6860e7a085cef441b5f7c801cd8fabcf.png)
...
![ssh daemon](http://jbcdn2.b0.upaiyun.com/2017/03/3afe1d17cfe3a119f3fa61b0cbe36aa1.png)
它的身上写着 52，说明它是第 52 个小企鹅。
![to fs](http://jbcdn2.b0.upaiyun.com/2017/03/aaf4fed57a3556f88043c3cb4a315535.jpg)
在图片的左上角，有一个向下台阶。这个台阶是底层（地基）的文件系统中的，进程们可以通过这个台阶，到文件系统中去读取文件，进行操作。
![CronTab](http://jbcdn2.b0.upaiyun.com/2017/03/e031020df8bfec148e69bedb5c0f8dbd.png)
在这一层中，有一个身上写着 217 的小企鹅，他正满头大汗地看着自己的手表。这只小企鹅就是定时任务（Crontab），他会时刻关注时间，查看是否要去做某个工作。
![pipeline](http://jbcdn2.b0.upaiyun.com/2017/03/74408ea7758fc0a8355a17a8dcce4276.jpg)
在图片的中部，有两个小企鹅扛着管道（PipeLine）在行走，一只小企鹅可以把自己手上的东西通过这个管道，传递给后面的小企鹅。不过怎么看起来前面这种（男？）企鹅累得满头大汗，而后面那只（女？）企鹅似乎游刃有余——喂喂，前面那个，裤子快掉了~
![Wine](http://jbcdn2.b0.upaiyun.com/2017/03/935b7491e3b70a7f0f4061557121fabe.jpg)
...
![tty](http://jbcdn2.b0.upaiyun.com/2017/03/67de2af92033683c60ae9a84046d50e3.png)
tty（终端）是对外沟通的渠道之一，但是，不是每一个进程都需要 tty，某些进程可以直接通过其他途径（比如端口）来和外部进行通信，对外提供服务的，所以，这一层不是完整的一层，只是个跃层。
好了，我们有落下什么吗？
![](http://jbcdn2.b0.upaiyun.com/2017/03/770237592879671f913a999d78b6be21.jpg)
这小丑是谁啊？
啊哈，我也不知道，或许是病毒？你说呢？
