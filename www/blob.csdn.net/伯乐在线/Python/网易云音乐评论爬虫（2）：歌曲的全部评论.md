# 网易云音乐评论爬虫（2）：歌曲的全部评论 - Python - 伯乐在线
原文出处： [志颖](https://www.zhouzying.cn/58.html)
...
# 一，首先分析数据的请求方式
网易云音乐歌曲页面的URL形式为https://music.163.com/#/song?id=歌曲id号,这里我用Delacey的[Dream it possible](https://music.163.com/#/song?id=38592976) 为例进行讲解,它的URL为https://music.163.com/#/song?id=38592976.接下来开始分析数据的请求方式.
由于网易云音乐的评论是通过Ajax传输，我们打开浏览器的开发者工具(检查元素)，选中控制面板中的Network,再点击XHR(捕获ajax数据)，然后点击左上角的重新加载，会看到下面图片中的数据请求列表
![](http://jbcdn2.b0.upaiyun.com/2018/10/7f8c36aa8854bd7c85b1329ce188af88.png)
点击R_SO_4_38592976?csrf_token=cdee144903c5a32e6752f50180329fc9这一行,再点击Preview
![](http://jbcdn2.b0.upaiyun.com/2018/10/78a18a9f20dd3b2c370fb5c3e8ed6423.png)
发现我们所需要的数据就在这json格式的数据中,其中comments中是第一页的全部评论,一共20条,hotcomments是精彩评论一共有15条,每首歌曲只有第一页评论才有精彩评论.接着看一下它的请求头,点击Headers
![](http://jbcdn2.b0.upaiyun.com/2018/10/bb4b5c0c518e1209ef3e9a47df592c6c.png)
我们发现的它是个post请求,向下滑你会发现这个post请求还带有数据
![](http://jbcdn2.b0.upaiyun.com/2018/10/a8fbd643bcd4abbc7602fb6a132591c8.png)
这些数据都是经过加密处理的,因此我们需要分析它的加密过程来生成相应的参数,然后把加密后的参数加到post请求中才能获取到我们需要的评论数据.
# 二,分析加密过程
通过断点调试发现params和encSecKey是由js脚本中的window.asrsea()函数生成的.
![](http://jbcdn2.b0.upaiyun.com/2018/10/06473cf7991d3f526d664116eb8cec79.png)
我们发现window.asrsea()函数有4个参数,在浏览器的js控制台分别对这四个参数进行调试:
![](http://jbcdn2.b0.upaiyun.com/2018/10/7edf5566977d91e6c6a63bada6cc7a23.png)
...
![](http://jbcdn2.b0.upaiyun.com/2018/10/b9b6947d6e1fc2120543353592271031.png)
然后按下电脑的Esc键打开js控制台,输入i1x,查看第一个变量:
![](http://jbcdn2.b0.upaiyun.com/2018/10/3f88f1de0fcd7600a6f68425ef879559.png)
这是第一页的i1x的值,接下来看第二页的(需要点击第2页,然后输入i1x的值):
![](http://jbcdn2.b0.upaiyun.com/2018/10/5d15f3198a5b8f9fa9230d64b3f4365f.png)
再看第3页:
![](http://jbcdn2.b0.upaiyun.com/2018/10/cc76e8b145c07312b7b1579c2bc2b9e3.png)
再看第4页:
![](http://jbcdn2.b0.upaiyun.com/2018/10/5c6f79724aa573c7a60a299992a19958.png)
...
```
至此,获取网易云音乐全部评论的Python爬虫实现原理分析全部完成!若想获取全部代码请上我的Github:[获取网易云音乐歌曲全部评论代码](https://github.com/zyingzhou/wangyiyun_music/blob/master/get_comments.py)
