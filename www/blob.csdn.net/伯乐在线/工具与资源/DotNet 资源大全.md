# DotNet 资源大全 - 文章 - 伯乐在线
本文由 [伯乐在线](http://blog.jobbole.com) - [Erucy](http://www.jobbole.com/members/Erucy) 翻译，[唐尤华](http://www.jobbole.com/members/tangyouhua) 校稿。未经许可，禁止转载！
英文出处：[Vitali Fokin](https://github.com/quozd/awesome-dotnet)。欢迎加入[翻译组](https://github.com/jobbole/translation-project)。
...
[https://github.com/jobbole/awesome-dotnet-cn](https://github.com/jobbole/awesome-dotnet-cn)
（注：下面用 [$] 标注的表示收费工具，但部分收费工具针对开源软件的开发/部署/托管是免费的）
- [目录](#awesome-dotnet)- [API](#api)
