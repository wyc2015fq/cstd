# Getty：Java NIO 框架设计与实现 - 文章 - 伯乐在线
本文作者： [伯乐在线](http://blog.jobbole.com) - [肖汉松](http://www.jobbole.com/members/Yonah) 。未经作者许可，禁止转载！
欢迎加入伯乐在线 [专栏作者](http://blog.jobbole.com/99322)。
## 前言
[Getty](https://github.com/x-hansong/Getty) 是我为了学习 Java NIO 所写的一个 NIO 框架，实现过程中参考了 Netty 的设计，同时使用 Groovy 来实现。虽然只是玩具，但是麻雀虽小，五脏俱全，在实现过程中，不仅熟悉了 NIO 的使用，还借鉴了很多 Netty 的设计思想，提升了自己的编码和设计能力。
...
![reactor](http://7xjtfr.com1.z0.glb.clouddn.com/getty-1.png)
...
![event](http://7xjtfr.com1.z0.glb.clouddn.com/getty-2.png)
...
```
### 事件处理流程
![编程模型](http://7xjtfr.com1.z0.glb.clouddn.com/getty-3.png)
...
```
## 总结
[Getty](https://github.com/x-hansong/Getty)是我造的第二个小轮子，第一个是[RedisHttpSession](https://github.com/x-hansong/RedisHttpSession)。都说不要重复造轮子。这话我是认同的，但是掌握一门技术最好的方法就是实践，在没有合适项目可以使用新技术的时候，造一个简单的轮子是不错的实践手段。
[Getty](https://github.com/x-hansong/Getty) 的缺点或者说还可以优化的点：
- 线程的使用直接用了`Thread`类，看起来有点low。等以后水平提升了再来抽象一下。
