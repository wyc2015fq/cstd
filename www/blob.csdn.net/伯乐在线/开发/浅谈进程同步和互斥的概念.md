...
![1](http://jbcdn2.b0.upaiyun.com/2015/12/306190c1ced194f0c938e23484cb9adb.png)
图1.进程之间的同步
...
代码1.C#模拟进程之间的同步
运行结果如图2所示。
![2](http://jbcdn2.b0.upaiyun.com/2015/12/0a0e42575e8030c0506138325a650e55.png)
图2.运行结果
**进程互斥**
进程互斥是进程之间的间接制约关系。当一个进程进入临界区使用临界资源时，另一个进程必须等待。只有当使用临界资源的进程退出临界区后，这个进程才会解除阻塞状态。
比如进程B需要访问打印机，但此时进程A占有了打印机，进程B会被阻塞，直到进程A释放了打印机资源,进程B才可以继续执行。概念如图3所示。
![3](http://jbcdn2.b0.upaiyun.com/2015/12/0481bd28e4e757a409bc9f28a494f071.png)
图3.进程之间的互斥
...
代码2.C#模拟进程之间的互斥
运行结果如图4所示。
![4](http://jbcdn2.b0.upaiyun.com/2015/12/ef630285d4d546d225a93eeefa6d9478.png)
图4.C#模拟进程互斥
### 实现临界区互斥的基本方法
**硬件实现方法**
...
运行结果如图5所示。
![5](http://jbcdn2.b0.upaiyun.com/2015/12/643e7695544ff8428b55ef1b9a4f88d1.png)
图5.生产者消费者C#模拟结果
**读者–写者问题**
问题描述:
...
代码4.C#模拟读者和写者问题
运行结果如图6所示。
图6.读者写者的运行结果 **哲学家进餐问题** 问题描述: 有五个哲学家，他们的生活方式是交替地进行思考和进餐。哲学家们公用一张圆桌，周围放有五把椅子，每人坐一把。在圆桌上有五个碗和五根筷子，当一个哲学家思考时，他不与其他人交谈，饥饿时便试图取用其左、右最靠近他的筷子，但他可能一根都拿不到。只有在他拿到两根筷子时，方能进餐，进餐完后，放下筷子又继续思考。 ![8](http://jbcdn2.b0.upaiyun.com/2015/12/5a26cadcc11783352b591ca1d41a81a6.png)
图7.哲学家进餐问题
...
代码5.C#模拟哲学家用餐问题
运行结果如图7所示。
![7](http://jbcdn2.b0.upaiyun.com/2015/12/46e4cd61194dfe6816b77de3d17d7c31.png)
图8.哲学家问题运行结果
### 总结
