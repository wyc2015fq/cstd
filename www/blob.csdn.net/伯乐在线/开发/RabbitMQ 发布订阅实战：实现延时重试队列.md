# RabbitMQ 发布订阅实战：实现延时重试队列 - 文章 - 伯乐在线
...
具体流程见下图
![xxx](https://segmentfault.com/img/remote/1460000014847793?w=809&h=926)
- 生产者发布消息到主Exchange
...
![-w539](https://segmentfault.com/img/remote/1460000014847794)
### 消息发布
...
![](https://segmentfault.com/img/remote/1460000014847795?w=1626&h=284)
查看队列的详细信息，我们可以看到 **queueName@retry** 队列与其它两个队列的不同
![-w486](https://segmentfault.com/img/remote/1460000014847796)
#### Bind Exchange & Queue
...
![-w361](https://segmentfault.com/img/remote/1460000014847797)
![-w405](https://segmentfault.com/img/remote/1460000014847798)
![-w399](https://segmentfault.com/img/remote/1460000014847799)
#### 消息消费实现
