...
synchronized不了解的，可以看看这篇干货《[深入浅出 synchronized](http://blog.jobbole.com/104725/)》
### 定义
...
public class ReentrantLock implements Lock, java.io.Serializable {
    ...
    abstract static class Sync extends AbstractQueuedSynchronizer {
        /**
         * Performs {<a href='http://www.jobbole.com/members/wx412606617'>@link</a> Lock#lock}. The main reason for subclassing
...
在深入理解ReentrantLock的实现原理之前，我们先了解一下java同步器。[深入浅出java同步器](http://www.jianshu.com/p/d8eeb31bee5c)
### 非公平锁实现
...
同步器那块的逻辑在《[深入浅出 Java 同步器](http://blog.jobbole.com/104853/)》一文中已经讲解的很清楚。
### 公平锁实现
