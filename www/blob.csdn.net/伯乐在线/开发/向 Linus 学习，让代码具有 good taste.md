# 向 Linus 学习，让代码具有 good taste - 文章 - 伯乐在线
原文出处： [Brian Barto](https://medium.com/@bartobri/applying-the-linus-tarvolds-good-taste-coding-requirement-99749f37684a)   译文出处：[Linux中国](https://linux.cn/article-8498-1.html)
...
![](http://wx4.sinaimg.cn/large/63918611gy1ffjtjwjg02j20m80ci0tz.jpg)
他展示的是一个代码片段。但这段代码并没有 “good taste”。这是一个具有 “poor taste” 的代码片段，把它作为例子，以提供一些初步的比较。
![Poor Taste Code Example](http://jbcdn2.b0.upaiyun.com/2017/05/e22500d419de9fe5192d222fef980a51.png)
...
![Good Taste Code Example](http://jbcdn2.b0.upaiyun.com/2017/05/e7c9836afc370ab34c38a7f9fe10d051.png)
原先的 10 行代码现在减少为 4 行。
...
- 复杂性 — 在双层循环里面使用 4 个条件语句似乎过于复杂。
- 高效性 — 假设 `GRID_SIZE` 的值为 64，那么这个循环需要执行 4096 次，但需要进行赋值的只有位于边缘的 256 个点。
