# DotNet Core 多平台开发体验 - 文章 - 伯乐在线
原文出处： [蛀牙](http://www.cnblogs.com/caipeiyu/p/5537021.html)
## 前言
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/0d9ffbe57b9b3b358f401f80c34c28a5.png)
...
dotnet -v
```
![](http://jbcdn2.b0.upaiyun.com/2016/06/a571c23d2ad3f3e0d0dcccd2aa09812b.png)
#### 命令行下的项目建立与运行
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/1d76e9cfba1b9c08d39e32c56267b1f3.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/55004f20cde0a5ac6f652733764503f7.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/86afba6a5b29b53f60dd46d7482d74f6.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/99c176134df76d67c1420b81db2c73f4.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/b82a9251d293bc3729e3296ff8c3904d.png)
初始化完后，我们可以看到我们有15个文件要提交，但是我们并不需要把这么多个文件都给提交了，我们只要提交Program.cs project.json 这两个文件，然后在其他地方下载后来生成其他文件就可以了。
![](http://jbcdn2.b0.upaiyun.com/2016/06/1dd8258bfe79c0cbb974ed0de6774042.png)
于是，我们就添加了一个.gitignore文件，文件内容添加要排除的东西，然后我们就剩下三个文件提交了
![](http://jbcdn2.b0.upaiyun.com/2016/06/ca0554c004cb5ef96e45dc2ec8d2dd49.png)
最后，输入提交的信息然后点击那个勾符号，就提交到本地的库里面了。
![](http://jbcdn2.b0.upaiyun.com/2016/06/80c2beaf98e1bb9d922bdb0c493492c8.png)
完成了上面的步骤后，我们还需要把库同步到[github](https://github.com)上面去。首先，我们去注册一个账户，然后新建一个repository，建立过程自己摸索，就不写的那么详细。建完后如下图
![](http://jbcdn2.b0.upaiyun.com/2016/06/c5d1e60f9a872fe51f50e28697218221.png)
然后到我们的目录下输入下面的两条命令
> 
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/9714f570b29fce370040d57391ffaf0f.png)
![](http://jbcdn2.b0.upaiyun.com/2016/06/7761bd6e439e223aebfcd9f000e78185.png)
下载完后双击我们的git项目，然后在弹出的窗口里面选择project.json，就会生成左边的那样项目工程了。
![](http://jbcdn2.b0.upaiyun.com/2016/06/4b3ad42311f12e53a881ca4d1dbca3d9.png)
然后我们编译成功并运行起来。
![](http://jbcdn2.b0.upaiyun.com/2016/06/88e0a92d85586c9ae0e83f47b47c7d0c.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/ce50a637b3264e5a5f6d471a1486877f.png)
第二添加一个类Startup
...
```
然后点击运行按钮，程序成功的运行起来
![](http://jbcdn2.b0.upaiyun.com/2016/06/0583240bfb16ff547177f198efc5d65d.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/1e9b88732c2293f2c09b3392598abb2d.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/319086b29154816846d227dbf6d220d0.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/64e6b746ffef04de4f7c2074cf36993c.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/06/86c0ad991db15756c686fbb124338dbb.png)
