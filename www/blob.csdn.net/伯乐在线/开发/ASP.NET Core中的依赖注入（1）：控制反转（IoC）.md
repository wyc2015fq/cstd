# ASP.NET Core中的依赖注入（1）：控制反转（IoC） - 文章 - 伯乐在线
原文出处： [蒋金楠](http://www.cnblogs.com/artech/p/asp-net-core-di-ioc.html)
...
![3-1](http://jbcdn2.b0.upaiyun.com/2016/04/82189887a9bd3b61b7cbb5e984f3e988.png)
...
![3-2](http://jbcdn2.b0.upaiyun.com/2016/04/ad306fac9057a8217f1d47a64efbb0a3.png)
现在我们将MvcLib从类库改造成一个框架，并姑且将其称为MvcFrame。如左图所示，MvcFrame的核心是一个被称为MvcEngine的执行引擎，它驱动一个编排好的工作流对HTTP请求进行一致性处理。如果我们利用MvcFrame构建一个具体的MVC应用，除了根据我们的业务需求定义相应的Controller和View之外，我们只需要初始化这个引擎并直接启动它即可。如果你曾经开发过ASP.NET MVC应用，你会发现ASP.NET MVC就是这么一个框架。![3-3](http://jbcdn2.b0.upaiyun.com/2016/04/41762eab4744e7e1388f6ef9801d2e5d.png)
...
## 二、对流程的定制
![3-4](http://jbcdn2.b0.upaiyun.com/2016/04/99ceed71e11c5d0ee5b264b9dbd8b84d.png)
...
![3-5](http://jbcdn2.b0.upaiyun.com/2016/04/290518b1f83840f4831768de4298d188.png)
...
![3-6](http://jbcdn2.b0.upaiyun.com/2016/04/a5ca86fdc23d1324d0ba10cf3ad5f90f.png)
...
## 抽象工厂（Abstract Factory）
![3-7](http://jbcdn2.b0.upaiyun.com/2016/04/3b8cc7481fd69bd0d259761144c1daf7.png)
