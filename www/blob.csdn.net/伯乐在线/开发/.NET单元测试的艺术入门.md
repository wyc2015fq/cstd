# .NET单元测试的艺术入门 - 文章 - 伯乐在线
原文出处： [周旭龙](http://www.cnblogs.com/edisonchou/p/5437205.html)
...
## 1.2 与集成测试的区别
![](http://jbcdn2.b0.upaiyun.com/2016/05/e65e4966fc18e6d8221e8796c2581ee7.jpg)
> 
...
# 二、测试驱动开发基础
## 2.1 传统的单元测试流程
![](http://jbcdn2.b0.upaiyun.com/2016/05/70e414c9f5f8c4e1c322a3447e56ecf1.png)
## 2.2 测试驱动开发的概要流程
![](http://jbcdn2.b0.upaiyun.com/2016/05/ff8f734813ade1ff4193fcc92eb5b57f.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/9776b2507a747e648012c182ec41e298.jpg)
Step2.在NuGet中找到NUnit Test Adapter并安装
![](http://jbcdn2.b0.upaiyun.com/2016/05/9cb32cd8b2d0ee2bb4ebd0a1f63b178d.jpg)
## 3.2 LogAn 项目介绍
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/b2eff7b0170466c0ccca3f7fc2c3028f.png)
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/556f4b12efd8eaeda41a45e0b9c04cd9.jpg)
从上图可以看出，我们得测试方法并没有通过，我们期望（Expected）的结果是False，而实际（Actual）的结果却是True。
## 3.5 继续添加测试方法
（1）通常在进行单元测试时我们会考虑到代码覆盖率，点击”测试”->”分析代码覆盖率”->”所有测试”，你可以看到以下结果：**80%**
![](http://jbcdn2.b0.upaiyun.com/2016/05/ab06cb533022ed28e769ede625fb9823.jpg)
...
```
这时测试结果如下图所示：
![](http://jbcdn2.b0.upaiyun.com/2016/05/234d8b82a6d5d4dd63312c7d62ddd265.jpg)
这时再来看看代码覆盖率：**100%**
![](http://jbcdn2.b0.upaiyun.com/2016/05/d6433b79d1edbd6d3e371f753b19c77a.jpg)
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/1b29c01dbf7df48f94e161cbf6bcaae7.jpg)
# 四、更多的NUnit
## 4.1 参数化重构单元测试
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/b359f350e360d9a52172e849d533df18.jpg)
## 4.2 SetUp和TearDown
...
```
## 4.3 检验预期的异常
很多时候，我们的方法中会抛出一些异常，这时如果我们的测试也应该做一些修改。在NUnit中，提供了一个API : Assert.Catch(delegate)
...
[Test]
    public void IsValidFileName_EmptyName_Throws()
    {
        LogAnalyzer analyzer = new LogAnalyzer();
        // 使用Assert.Catch
        var ex = Assert.Catch(() => analyzer.IsValidLogFileName(string.Empty));
        // 使用Assert.Catch返回的Exception对象
        StringAssert.Contains("filename has to be provided", ex.Message);
    }
```
![](http://jbcdn2.b0.upaiyun.com/2016/05/5c06f047d44f4b09310ea72bc384dbfd.jpg)
## 4.4 忽略测试
...
```
可以看到，这个测试确实被忽略了：
![](http://jbcdn2.b0.upaiyun.com/2016/05/3a421dac00963d2479cfe613ece7ba96.jpg)
## 4.5 设置测试的类别
...
```
![](http://jbcdn2.b0.upaiyun.com/2016/05/e796cb2e7eec85f2850f64d8c3ab727b.jpg)
# 五、小结
...
![](http://jbcdn2.b0.upaiyun.com/2016/05/039597f0e53c131681d9ebb5826b0694.jpg)
# 参考资料
![The Art of Unit Testing](http://jbcdn2.b0.upaiyun.com/2016/05/55ff18d03eadb771530de9bf5a1e0042.jpg)
