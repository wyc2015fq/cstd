...
## 参考资料
- [Concurrent tasks on node.js](http://stackoverflow.com/questions/10773564/which-would-be-better-for-concurrent-tasks-on-node-js-fibers-web-workers-or-t?noredirect=1&lq=1)
- [利用 Nginx 为 Nodejs 添加负载均衡](http://blog.chinaunix.net/xmlrpc.php?r=blog/article&uid=90618&id=4836653)
