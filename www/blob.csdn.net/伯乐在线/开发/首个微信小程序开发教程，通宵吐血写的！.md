...
![](http://ww2.sinaimg.cn/large/7cc829d3gw1f83ylykh6pj210f0dw0tp.jpg)
...
![](http://jbcdn2.b0.upaiyun.com/2016/09/af5ee39f0eb091ccfe01328b813683da.png)
...
```
本例中使用了[`<view/>`](https://mp.weixin.qq.com/debug/wxadoc/dev/component/view.html?t=1474644083132)、[`<image/>`](https://mp.weixin.qq.com/debug/wxadoc/dev/component/image.html?t=1474644083132)、[`<text/>`](https://mp.weixin.qq.com/debug/wxadoc/dev/component/text.html?t=1474644083132)来搭建页面结构，绑定数据和交互处理函数。
...
```
运行结果如下：
![](http://ww2.sinaimg.cn/large/7cc829d3gw1f83ym0roz3j21hc0ukaed.jpg)
### 4. 手机预览
![](http://ww3.sinaimg.cn/large/7cc829d3gw1f83ylzul9sj21hc0ukjul.jpg)
...
![](http://jbcdn2.b0.upaiyun.com/2016/09/f5eeea33f0125a5d57c42b73e1a6f828.png)
2. 点击「新建 web+」项目，随后出现如下画面：
![](http://jbcdn2.b0.upaiyun.com/2016/09/18daea468c8b4323318e033b89aeffd7.jpeg)
3. 该页面内的各项内容需要注意——
- AppID：依照官方解释来填。
...
![](http://jbcdn2.b0.upaiyun.com/2016/09/ff741f48d05d43b45c67446000c46cab.jpeg)
5. 如上图所示，此刻，微信开发者工具已经为你自动构建了一个初始的 demo 项目，该项目内包含了一个微信应用项目所需具备的基本内容和框架结构。点击项目名称（图中即「cards」）进入该项目，就能看到整个项目的基本架构了：
![](http://jbcdn2.b0.upaiyun.com/2016/09/97d369cc72659e4c1aef94b3fdbf32c7.jpeg)
### 第二章：项目构架
...
### 生命周期：
在index.js里面：
![](http://jbcdn2.b0.upaiyun.com/2016/09/56b729512be29685340e5bb6e71d73b3.jpeg)
开发者工具上 Console 可以看到：
![](http://jbcdn2.b0.upaiyun.com/2016/09/76b22837bfcc7c5cd71e45f4394782a2.jpeg)
...
![](http://jbcdn2.b0.upaiyun.com/2016/09/90d157997d7b86994c42f4f7378444cf.jpeg)
2. 接下来，你需要根据自己的项目内容调整项目结构。在范例项目中，「card_course」目录下面主要包含了「tabBar」页面以及该应用的一些配置文件。
3. 示例项目的「tabBar」是五个菜单按钮：
![](http://jbcdn2.b0.upaiyun.com/2016/09/dd068321976fb69fb9118580e55be942.png)
4. 找到「app.json」文件，用来配置这个五个菜单。在代码行中找到「”tabBar”」：
![](http://jbcdn2.b0.upaiyun.com/2016/09/e9576400b6f17d911942b90ed789ff39.jpeg)
你可以根据实际项目需求更改，其中：
...
![](http://jbcdn2.b0.upaiyun.com/2016/09/95aee32110554b8c77b81c5e66d93f44.jpeg)
![](http://jbcdn2.b0.upaiyun.com/2016/09/fafe3844478b131ed538fe321d85bcc0.jpeg)
...
![](http://jbcdn2.b0.upaiyun.com/2016/09/fdc5ab602d70e2b7f1ad5a77fc1ea70b.jpeg)
7. 以上是示例项目首页的「wxml」编码。从图中就可以看出，实现一个页面代码量非常少。
8. 「Wxss」文件是引入的样式文件，你也可以直接在里面写样式，示例中采用的是引入方式：
![](http://jbcdn2.b0.upaiyun.com/2016/09/14fd66de880778de8e447ba42046a3d4.jpeg)
![](http://jbcdn2.b0.upaiyun.com/2016/09/700ca0f199c9e1d77eb5ae280f9dc272.jpeg)
...
![](http://jbcdn2.b0.upaiyun.com/2016/09/90ae1066491f41fb185740092ef1128c.png)
![](http://jbcdn2.b0.upaiyun.com/2016/09/b7a4528dbfbefd3263213e38a40b279c.jpeg)
11. 「Js」文件需要在「app.json」文件的「”page”」里预先配置好。为了项目结构清晰化，我在示例项目中的「index」首页同级目录新建其它四个页面文件，具体如下：
![](http://jbcdn2.b0.upaiyun.com/2016/09/1452532ac7374e77e27ee8bb00b0972b.jpeg)
