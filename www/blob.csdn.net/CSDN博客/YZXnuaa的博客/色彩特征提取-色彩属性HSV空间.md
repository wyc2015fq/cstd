# 色彩特征提取-色彩属性HSV空间 - YZXnuaa的博客 - CSDN博客
2018年03月21日 09:58:42[YZXnuaa](https://me.csdn.net/YZXnuaa)阅读数：356
...
        HSV(Hue, Saturation, Value)是根据颜色的直观特性由A. R. Smith在1978年创建的一种颜色空间, 也称六角锥体模型(Hexcone Model)。色彩的基本属性离开RGB色彩空间，重新定义了色彩的HSV空间，依然表示 单个色彩的唯一性，但有可能仍然没有包含提夫尼蓝。参考：[色彩的HSV表示](https://baike.baidu.com/item/HSV/547122?fr=aladdin)模型，Hue, Saturation, Value。HSV空间和RGB空间是双射映射。
