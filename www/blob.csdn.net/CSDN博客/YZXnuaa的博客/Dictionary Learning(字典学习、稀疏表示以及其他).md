# Dictionary Learning(字典学习、稀疏表示以及其他) - YZXnuaa的博客 - CSDN博客
...
![](https://images2015.cnblogs.com/blog/808068/201610/808068-20161012222354781-1278472836.png)
整张头像的照片是个图片，通过对图片的分割可以将图片分割为一个一个的小块，也就是一个个Pitch。如果对pitch仍然不了解，只好请你看这个：[http://blog.csdn.net/zouxy09/article/details/8775488](http://blog.csdn.net/zouxy09/article/details/8775488)
