# java中重载与重写的区别 - 博客堂 - CSDN博客





2017年02月15日 10:07:12[最小森林](https://me.csdn.net/u012052268)阅读数：196标签：[java](https://so.csdn.net/so/search/s.do?q=java&t=blog)
...
# [java中重载与重写的区别](http://www.cnblogs.com/bluestorm/archive/2012/03/01/2376236.html)
...
    （2） [Java](http://java.chinaitlab.com/)的方法重载，就是在类中可以创建多个方法，它们具有相同的名字，但具有不同的参数和不同的定义。
