# 【Tensorflow】Tensorflow一些常用基本概念与函数（2） - zj360202的专栏 - CSDN博客





2017年12月07日 15:58:53[zj360202](https://me.csdn.net/zj360202)阅读数：366
...
1、获取这种格式的文件方式为，首先将一般的数据格式填入Example protocol buffer中，再将 protocol buffer序列化为一个字符串，然后使用tf.python_io.TFRecordWriter类的相关方法将字符串写入一个TFRecords文件中，[参见MNIST例子](https://www.tensorflow.org/code/tensorflow/examples/how_tos/reading_data/convert_to_records.py)，将MNIST
 数据转换为该类型数据。 
