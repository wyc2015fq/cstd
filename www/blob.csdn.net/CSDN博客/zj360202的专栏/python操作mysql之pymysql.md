# python操作mysql之pymysql - zj360202的专栏 - CSDN博客





2017年12月25日 17:29:23[zj360202](https://me.csdn.net/zj360202)阅读数：610
...
1. python监听mysql数据变化：对于希望通过Python监听数据库某条记录是否修改的时候，需要重新连接数据库，为了提供数据库的效率，一般会在数据库端建立连接池，


在Python中不断的pymysql.connect,然后close，这个不会消耗多少的性能，但是如果不重新连接的话，在你第一次查询的结果后面再次查询



的时候，无论此数据是否修改，查出来都是没有反应的，切忌切忌
