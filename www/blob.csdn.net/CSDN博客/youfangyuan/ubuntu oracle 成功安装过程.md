# ubuntu oracle 成功安装过程 - youfangyuan - CSDN博客
2013年01月20日 19:43:56[youfangyuan](https://me.csdn.net/youfangyuan)阅读数：390
一，下载一个oracle的基本包
...
八，创建版本声明,新建/etc/redhat-release
...
十，解压10201_database_linux32.zip，并且重新启动用oracle用户登录
unzip 10201_database_linux32.zip  
sudo reboot  
cd database  
./runInstaller  
这样就可以进入图形界面安装了。但是会遇到一些问题。
十一，遇到的问题，解决，以及要注意的地方
1，乱码问题
export LC_ALL=C  
英文界面安装
2，选择字符集
...
5，添加oracle的一些管理密码
oracle 设置密码
6，安装到倒数第二步，会弹出个对话框，要求你执行二个shell脚本，不要急着点next
