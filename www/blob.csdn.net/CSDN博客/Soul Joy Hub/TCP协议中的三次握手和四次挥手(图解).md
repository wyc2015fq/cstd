# TCP协议中的三次握手和四次挥手(图解) - Soul Joy Hub - CSDN博客

2017年03月22日 14:45:38[卓寿杰_SoulJoy](https://me.csdn.net/u011239443)阅读数：534标签：[tcp](https://so.csdn.net/so/search/s.do?q=tcp&t=blog)
...
而Server端所经历的过程如下：转载请注明:[blog.csdn.net/whuslei](blog.csdn.net/whuslei)
