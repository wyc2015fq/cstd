# 基于深度学习的CT图像肺结节自动检测技术四—数据增强—定义神经网络并训练 - wsp_1138886114的博客 - CSDN博客





2018年09月22日 17:44:10[SongpingWang](https://me.csdn.net/wsp_1138886114)阅读数：1431
...
### 文章目录
- [数据增强](#_32)
- [测试前图像准备—图像数据类型转换—通道归一化（灰度图）](#_188)
- [定义神经网络并训练](#_232)
