# 基于深度学习（端到端）的OCR文字识别 - wsp_1138886114的博客 - CSDN博客





2018年11月09日 17:34:26[SongpingWang](https://me.csdn.net/wsp_1138886114)阅读数：2135
...
（1）将文件./ctpn/text.yml中的“USE_GPU_NMS”设置为“False” （2）在文件中设置“__C.USE_GPU_NMS” ./lib/fast_rcnn/config.py为“False”;

（3）在文件./lib/fast_rcnn/nms_wrapper.py中注释掉“from lib.utils.gpu_nms import gpu_nms”;

（4）重建 [setup.py](http://setup.py)：
```python
...
Github地址：[https://github.com/eragonruan/text-detection-ctpn](https://github.com/eragonruan/text-detection-ctpn)
...
关于 OCR 端到端识别:CRNN网络请查看 [https://blog.csdn.net/wsp_1138886114/article/details/82555728](https://blog.csdn.net/wsp_1138886114/article/details/82555728)

[你可以运行demo.py](http://xn--demo-955fmzs1wbm3izeo.py) 写入测试图片的路径来测试识别效果，
...
特别鸣谢
[http://www.sohu.com/a/256995954_787107](http://www.sohu.com/a/256995954_787107)
