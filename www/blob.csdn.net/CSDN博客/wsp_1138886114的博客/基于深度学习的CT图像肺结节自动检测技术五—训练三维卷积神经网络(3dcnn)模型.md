# 基于深度学习的CT图像肺结节自动检测技术五—训练三维卷积神经网络(3dcnn)模型 - wsp_1138886114的博客 - CSDN博客





2018年09月21日 22:38:27[SongpingWang](https://me.csdn.net/wsp_1138886114)阅读数：1490
...
### 文章目录
- [实现3dcnn的网络结构，并加载预训练好的权重](#3dcnn_22)
