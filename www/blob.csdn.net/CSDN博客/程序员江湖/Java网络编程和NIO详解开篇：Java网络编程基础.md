# Java网络编程和NIO详解开篇：Java网络编程基础 - 程序员江湖 - CSDN博客





2017年07月13日 11:33:18[黄小斜](https://me.csdn.net/a724888)阅读数：4013
...
![](https://img-blog.csdn.net/20180526111500319?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2E3MjQ4ODg=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)![](http://t.williamgates.net/image-D030_53E07B61.jpg)ClientServerOpen ConnectionSend RequestReceive ResponseClose Connection
...
一个真正的服务端程序可能会在一个loop中调用receive()方法，传送所有接收到的DatagramPacket到工作的线程池中，就像TCP服务器处理请求连接一样（查看[Java Multithreaded Servers](http://tutorials.jenkov.com/java-multithreaded-servers/index.html)获取更多详情）
...
|`1`|`URL url = ``new``URL(``"[http://jenkov.com](http://jenkov.com/)"``);`|
|----|----|
...
|`01`|`String urlString = ``"[http://butterfly.jenkov.com/](http://butterfly.jenkov.com/)"`|
|----|----|
...
*InetAddress* 类还拥有大量你可以调用的其它方法。例如：你可以通过调用*getAddress()*方法来获取 IP 地址的 byte 数组。如果要了解更多的方法，最简单的方式就是读 JavaDoc 文档中关于 *InetAddress* 类的部分。
...
![](https://img-blog.csdn.net/20180526140237371?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2E3MjQ4ODg=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
