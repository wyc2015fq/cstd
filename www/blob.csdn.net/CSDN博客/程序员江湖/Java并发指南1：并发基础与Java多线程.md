# Java并发指南1：并发基础与Java多线程 - 程序员江湖 - CSDN博客





2017年03月08日 09:46:01[黄小斜](https://me.csdn.net/a724888)阅读数：5822
...
- 
# [实现Runnable接口和继承Thread类区别](https://www.cnblogs.com/xubiao/p/5418141.html)
...
```
*/** * 一直运行的线程，中断状态为 true * * @author Jeff Lee @ bysocket.com * @since 2018年02月23日19:03:02 */*
...
```
*/** * 抛出 InterruptedException 的线程，中断状态被重置为默认状态 false * * @author Jeff Lee @ bysocket.com * @since 2018年02月23日19:03:02 */*
...
```
*/** * 安全终止线程 * * @author Jeff Lee @ bysocket.com * @since 2018年02月23日19:03:02 */*
...
本文*转载自*[并发编程网 – ifeve.com](http://ifeve.com/)
