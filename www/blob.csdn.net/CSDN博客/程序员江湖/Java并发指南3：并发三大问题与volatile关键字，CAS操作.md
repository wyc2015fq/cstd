# Java并发指南3：并发三大问题与volatile关键字，CAS操作 - 程序员江湖 - CSDN博客





2017年03月08日 14:06:54[黄小斜](https://me.csdn.net/a724888)阅读数：6490
...
|`001`|`       ``private``AtomicInteger atomicI = ``new``AtomicInteger(``0``);`|
|----|----|
|`002`||
|----|----|
|`003`|`       ``private``int``i = ``0``;`|
