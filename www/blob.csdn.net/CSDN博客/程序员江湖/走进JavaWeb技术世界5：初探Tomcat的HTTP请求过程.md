# 走进JavaWeb技术世界5：初探Tomcat的HTTP请求过程 - 程序员江湖 - CSDN博客





2017年06月13日 21:57:53[黄小斜](https://me.csdn.net/a724888)阅读数：5789
...
|123456789101112|`<``Server``>                                                //顶层类元素，可以包括多个Service   ``    ``<``Service``>                                           //顶层类元素，可包含一个Engine，多个Connecter``        ``<``Connector``>                                     //连接器类元素，代表通信接口``                ``<``Engine``>                                //容器类元素，为特定的Service组件处理客户请求，要包含多个Host``                        ``<``Host``>                          //容器类元素，为特定的虚拟主机组件处理客户请求，可包含多个Context``                                ``<``Context``>               //容器类元素，为特定的Web应用处理所有的客户请求``                                ``</``Context``>``                        ``</``Host``>``                ``</``Engine``>``        ``</``Connector``>``    ``</``Service``>``</``Server``>`|
|----|----|
