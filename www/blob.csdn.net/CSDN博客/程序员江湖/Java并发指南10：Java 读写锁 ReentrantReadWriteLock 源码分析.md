# Java并发指南10：Java 读写锁 ReentrantReadWriteLock 源码分析 - 程序员江湖 - CSDN博客





2017年03月08日 19:08:34[黄小斜](https://me.csdn.net/a724888)阅读数：3412
...
- [源码分析](https://www.javadoop.com/post/reentrant-read-write-lock#%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90)- [读锁获取](https://www.javadoop.com/post/reentrant-read-write-lock#%E8%AF%BB%E9%94%81%E8%8E%B7%E5%8F%96)
...
- **firstReader** 和 **firstReaderHoldCount** 有什么用？其实也没什么用，但是它也能提示性能。将"第一个"获取读锁的线程记录在 firstReader 属性中，这里的**第一个**不是全局的概念，等这个 firstReader 当前代表的线程释放掉读锁以后，会有后来的线程占用这个属性的。**firstReader 和 firstReaderHoldCount 使得在读锁不产生竞争的情况下，记录读锁重入次数非常方便快速**
