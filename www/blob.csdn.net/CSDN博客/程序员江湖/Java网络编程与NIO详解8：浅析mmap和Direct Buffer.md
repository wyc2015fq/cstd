# Java网络编程与NIO详解8：浅析mmap和Direct Buffer - 程序员江湖 - CSDN博客





2017年07月07日 19:58:53[黄小斜](https://me.csdn.net/a724888)阅读数：1068
...
关于java引用类型的实现和原理可以阅读之前的文章[Reference 、ReferenceQueue 详解](http://www.importnew.com/26250.html) 和 [Java 引用类型简述](http://www.importnew.com/26171.html)。

## 关于linux的内核态和用户态

![](http://incdn1.b0.upaiyun.com/2017/08/a1c59d418325d59599c29ff2b587c55f.png)
- 内核态：控制计算机的硬件资源，并提供上层应用程序运行的环境。比如socket I/0操作或者文件的读写操作等
- 用户态：上层应用程序的活动空间，应用程序的执行必须依托于内核提供的资源。
- 系统调用：为了使上层应用能够访问到这些资源，内核为上层应用提供访问的接口。

![](http://incdn1.b0.upaiyun.com/2017/08/e145b5436286bbc2512b97be3860d427.png)
...
![](http://incdn1.b0.upaiyun.com/2017/08/31d11490d20f02e9ed1f7eea2a318638.png)
...
![](http://incdn1.b0.upaiyun.com/2017/08/caa35598742279c28d06369760f38323.png)
...
![](http://incdn1.b0.upaiyun.com/2017/08/8ef99c738161a15328c8407f0fac3bab.png)
...
```java
read(FileDescriptor var0, ByteBuffer var1,
```
...
```java
readIntoNativeBuffer(var0, var1, var2, var4);
```
...
```java
var6 = readIntoNativeBuffer(var0, var5, var2, var4);
```
...
![](http://incdn1.b0.upaiyun.com/2017/08/8d921b6112fb828be56f64c245b2cc9a.png)
...
```java
Java_java_lang_Runtime_maxMemory(JNIEnv *env, jobject
```
...
```java
JVM_ENTRY_NO_ENV(jlong, JVM_MaxMemory(
```
...
![](http://incdn1.b0.upaiyun.com/2017/08/71fb39c74b5e95097d5ce669a911fcb2.png)![](http://incdn1.b0.upaiyun.com/2017/08/55becba84de6902babbb03b6bfe17e18.png)
...
![](http://incdn1.b0.upaiyun.com/2017/08/f20e391888a9d009aa252b032728e3ad.png)
