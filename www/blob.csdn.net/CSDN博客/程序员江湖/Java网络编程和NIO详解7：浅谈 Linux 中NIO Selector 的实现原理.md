# Java网络编程和NIO详解7：浅谈 Linux 中NIO Selector 的实现原理 - 程序员江湖 - CSDN博客





2017年07月07日 19:54:20[黄小斜](https://me.csdn.net/a724888)阅读数：537标签：[NIO																[Selector																[LInux IO																[IO多路复用																[epoll](https://so.csdn.net/so/search/s.do?q=epoll&t=blog)
个人分类：[Java网络编程与NIO](https://blog.csdn.net/a724888/article/category/7633143)

所属专栏：[Java网络编程与NIO](https://blog.csdn.net/column/details/21963.html)](https://so.csdn.net/so/search/s.do?q=IO多路复用&t=blog)
...
② 如果发现channel所发生I/O事件不是当前SelectionKey所感兴趣，则不会将SelectionKeyImpl放入selectedKeys集合中，也不会使numKeysUpdated++](https://so.csdn.net/so/search/s.do?q=LInux IO&t=blog)](https://so.csdn.net/so/search/s.do?q=Selector&t=blog)](https://so.csdn.net/so/search/s.do?q=NIO&t=blog)
