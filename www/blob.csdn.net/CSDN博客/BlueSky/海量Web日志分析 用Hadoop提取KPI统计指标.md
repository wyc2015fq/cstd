# 海量Web日志分析 用Hadoop提取KPI统计指标 - BlueSky - CSDN博客
2016年03月04日 23:44:13[ASIA_kobe](https://me.csdn.net/ASIA_kobe)阅读数：727
个人分类：[Hadoop](https://blog.csdn.net/ASIA_kobe/article/category/6119583)
转自：http://blog.fens.me/hadoop-mapreduce-log-kpi/
[Hadoop家族系列文章](http://blog.fens.me/series-hadoop-family/)，主要介绍Hadoop家族产品，常用的项目包括Hadoop, Hive, Pig, HBase, Sqoop, Mahout, Zookeeper, Avro, Ambari, Chukwa，新增加的项目包括，YARN,
 Hcatalog, Oozie, Cassandra, Hama, Whirr, Flume, Bigtop, Crunch, Hue等。
...
**转载请注明出处：**
[http://blog.fens.me/hadoop-mapreduce-log-kpi/](http://blog.fens.me/hadoop-mapreduce-log-kpi/)
![hadoop-kpi-logo](http://blog.fens.me/wp-content/uploads/2013/10/hadoop-kpi-logo.png)
**前言**
...
百度统计，对我[个人网站](http://www.fens.me/)做的统计！[http://www.fens.me](http://www.fens.me/)
**基本统计指标：**
![hadoop-kpi-baidu](http://blog.fens.me/wp-content/uploads/2013/10/hadoop-kpi-baidu.png)
**用户的访问设备统计指标：**
![hadoop-kpi-baidu2](http://blog.fens.me/wp-content/uploads/2013/10/hadoop-kpi-baidu2.png)
从商业的角度，个人网站的特征与电商网站不太一样，没有转化率，同时跳出率也比较高。从技术的角度，同样都关注KPI指标设计。
## 3.算法模型：Hadoop并行算法
![hadoop-kpi-log](http://blog.fens.me/wp-content/uploads/2013/10/hadoop-kpi-log.png)
**并行算法的设计：**
注：找到第一节有定义的8个变量
**PV(PageView): 页面访问量统计**
...
## 4.架构设计：日志KPI系统架构
![hadoop-kpi-architect](http://blog.fens.me/wp-content/uploads/2013/10/hadoop-kpi-architect.png)
...
![hadoop-kpi-process](http://blog.fens.me/wp-content/uploads/2013/10/hadoop-kpi-process.png)
...
######################################################
看文字不过瘾，作者视频讲解，请访问网站：[http://onbook.me/video](http://onbook.me/video)
######################################################
