# 君生我未生！Stata - 论文中基本统计量和回归表格输出到word - stata连享会 - CSDN博客





2018年05月31日 14:48:16[arlionn](https://me.csdn.net/arlionn)阅读数：10308
...
Stata连享会     [最新专题课程](https://gitee.com/arlionn/stata_training/blob/master/README.md)  || [精彩推文](https://github.com/arlionn/stata/blob/master/README.md)
> 
君生我未生，我生君已老；
...
- [2. 简要说明](#2__38)
- [3. 下载及安装](#3__47)
- [4. 输出四张常用基本表格实操](#4__63)
- [4.1 输出基本统计量： `sum2docx` 命令](#41__sum2docx__65)
- [4.1.1 语法结构](#411__67)
- [4.1.2 范例](#412__74)
- [4.2 输出相关系数矩阵：`corr2docx` 命令](#42_corr2docx__91)
- [4.2.1 语法结构](#421__93)
- [4.2.2 范例](#422__99)
- [4.3 组间均值差异检验：`t2docx` 命令](#43_t2docx__118)
- [4.3.1 语法结构](#431__120)
- [4.3.2 范例](#432__126)
- [4.4 回归结果：`reg2docx` 命令](#44_reg2docx__142)
- [4.4.1 说明](#441__146)
- [4.4.2 范例](#442__149)
- [5. 将上述四张表输出至一个 Word 文档中](#5__Word__174)
- [5.1 基本思路](#51__177)
- [5.2 写作建议](#52__182)
- [5.3 Stata 范例](#53_Stata__191)
- [本文相关资料下载链接](#_263)
- [关于我们](#_270)
- [联系我们](#_277)
- [往期精彩推文](#_284)
...
![图 2 :下载外部命令](http://upload-images.jianshu.io/upload_images/7692714-b11dfbbfa2fd8c12.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![图4：相关系数矩阵](http://upload-images.jianshu.io/upload_images/7692714-d0c463091ea0be01.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![图5：组间均值 t 检验](http://upload-images.jianshu.io/upload_images/7692714-d2141e3e463771f4.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![图 7 ：论文结构设计](http://upload-images.jianshu.io/upload_images/7692714-39394931c157c204.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![image](http://upload-images.jianshu.io/upload_images/7692714-c962d755b2c312f9.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![图 8 ：汇总展示  ](http://upload-images.jianshu.io/upload_images/7692714-ebc751f35d27bc87.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

> 
### 本文相关资料下载链接


为了方便各位复制文中的代码和命令，我们将本文涉及的 Stata 命令汇总到了一个 **Do-file** 中，各位可以到 [『Stata连享会•码云』](https://gitee.com/arlionn)  → [『快速输出论文表格』](https://gitee.com/arlionn/reg2docx) 项目中下载。
...
![](https://upload-images.jianshu.io/upload_images/7692714-8b1fb0b5068487af.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
![欢迎加入Stata连享会 (公众号: StataChina)](http://upload-images.jianshu.io/upload_images/7692714-7a9f35b57cfb18be.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
