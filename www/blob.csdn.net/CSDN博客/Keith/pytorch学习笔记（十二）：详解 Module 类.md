# pytorch学习笔记（十二）：详解 Module 类 - Keith - CSDN博客





2017年10月19日 10:35:02[ke1th](https://me.csdn.net/u012436149)阅读数：13021
...
需要注意的是：`module.eval()` 仅仅设置 `module` 的 `training` 属性，如果我们想获得最快的推断速度， 还需要 设置 输入 `Variable`的`volatile` 属性为 `True`。  
