# pytorch学习笔记（八）：PytTorch可视化工具 visdom - Keith - CSDN博客





2017年04月06日 14:52:08[ke1th](https://me.csdn.net/u012436149)阅读数：30909
...
![visdom_big](https://lh3.googleusercontent.com/-bqH9UXCw-BE/WL2UsdrrbAI/AAAAAAAAnYc/emrxwCmnrW4_CLTyyUttB0SYRJ-i4CCiQCLcB/s0/Screen+Shot+2017-03-06+at+10.51.02+AM.png%22visdom_big%22)
...
- [可视化接口](#%E5%8F%AF%E8%A7%86%E5%8C%96%E6%8E%A5%E5%8F%A3)
...
![](https://lh3.googleusercontent.com/-h3HuvbU2V0SfgqgXGiK3LPghE5vqvS0pzpObS0YgG_LABMFk62JCa3KVu_2NV_4LJKaAa5-tg=s0)

向您和您的合作者发送可视化 图像，图片和文本。

![](https://thumbs.gfycat.com/SlipperySecondhandGemsbuck-size_restricted.gif)

通过编程组织您的可视化空间，或者通过`UI`为实时数据创建`dashboards`，检查实验的结果，或者`debug`实验代码。

![](https://lh3.googleusercontent.com/-IHexvZ-FMtk/WLTXBgQlijI/AAAAAAAAm_s/514LM8R1XFgyNKPVMf4tNwYluZsHsC63wCLcB/s0/Screen+Shot+2017-02-27+at+3.15.27+PM.png)
...
![](https://lh3.googleusercontent.com/-kLnogsg9RCs/WLx34PEsGWI/AAAAAAAAnSs/7t_62pbfmfoEBnkcbKTXIqz0WM8pQJHVQCLcB/s0/Screen+Shot+2017-03-05+at+3.34.43+PM.png)
...
![](https://lh3.googleusercontent.com/-1wRSpNIoFeo/WLXacodRTMI/AAAAAAAAnEo/sTr5jSnQviA0uLqFIvwPGledmxcpupdkgCLcB/s0/Screen+Shot+2017-02-28+at+2.54.13+PM.png)
...
![](https://lh3.googleusercontent.com/-ZKeFJfMe5S4/WLXebiNgFwI/AAAAAAAAnFI/AH2cGsf40hEWbH6UeclYQcZPS0YZbcayQCLcB/s0/env_fork_2.gif)
- 
**Save:** 你可以手动的保存`env`通过点击`save`按钮。它会首先序列化`env`的状态，然后以`json`文件的形式保存到硬盘上，包括窗口的位置。 同样，您也可以通过编程来实现`env`的保存。

当面对一些十分复杂的可视化，例如参数设置非常重要，这中保存`env`状态的方法是十分有用的。例：数据丰富的演示，模型的训练 `dashboard`， 或者 系统实验。这种设计依旧可以使这些可视化十分容易分享和复用。- 
