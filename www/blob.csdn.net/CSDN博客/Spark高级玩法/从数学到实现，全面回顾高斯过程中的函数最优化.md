# 从数学到实现，全面回顾高斯过程中的函数最优化 - Spark高级玩法 - CSDN博客
2018年03月10日 00:00:00[Spark高级玩法](https://me.csdn.net/rlnLo2pNEfx9c)阅读数：820
选自efavdb
**作者：**** Jonathan Landy**
**机器之心编译**
**参与：白悦、蒋思源**
...
![640?wx_fmt=gif&wxfrom=5&wx_lazy=1](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_gif/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6FQ4IA5OAn5QEuYnr3HxBXInpDE1SYH0cWG3y6ovL2dnfAwic6m2vicjA/640?wx_fmt=gif&wxfrom=5&wx_lazy=1)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6PHo02SELoKJSXRnkaUl2AaN00T3zSkpfcrJ3SZqmGZk877BehMB9qA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q63O6YoaabzN60VgojGFXoDib9DJB3ibatatTtdYfJqq3B7ib95xohlHNSg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6djzRrVdd8cpazXko3tLE1UTC4TGqxqiaOjguAlniaJYGDv9hETaIyB4w/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6Tzerdqt9Sh2c0IoIZngjbagXbDG1vGOQy99qsdkdOQRzlVJ4Et76sQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6viaozTc0rAPnU1pGTAVfAfjBBYUGpLRhTYObwffNakoRibrtuFvSDTMA/640?wx_fmt=png)
y 是测量值的向量，长度为 n,
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q655VRibeUnm5ojURW24kfGLqmafDEzAfvePUnzgBib3VqQfsQq4Dp2Zuw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6X0a73xn2v3LHu9ibp3yfJGEiaxXXp6LrzZ562Sg7u2IlKUpvZS2NDX7Q/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6DgQ2KyLZaXJGcI5c6mMhICniaRXTyURB8HRsIF2x5iaKQKCse05pUC2A/640?wx_fmt=png)
**后验采样**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6Xe1iasPyLampGRUZbxp829PY8lfs16jQBxSTLZgM5m8AibwPo3LK5sNA/640?wx_fmt=png)
**选择协方差超参数**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6bnquwHWg0NY6dr4icsG2ZyTbicW7GWiajVcKjuZQ70DFVHib83QOiblafCg/640?wx_fmt=png)
我们可以像附录中评估后验分布那样直接进行积分。但更快的方法是注意到 f 积分后，y 值服从如下的正态分布
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6xvThAaver9N5ia8KTjDzDEDFlpIOuAGWKlzxTMq8fJrsULAKR1A6UPQ/640?wx_fmt=png)
其中σ^2 * I_00 在式（6）中定义，由此得出，
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6malxA6PqQk0mUVZXyRuJnibeC2kd7wQkf6EqYkwUPzY4qAxXTDdqWjg/640?wx_fmt=png)
...
**高斯置信下界（GLCB）**
GLCB 在每点的评分方式为
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6YOicuZNQFxdaPeYVGlxT6jxiczdMMBZZAsIkPV9e6A0qYU9M0V2pib4xw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6jPczJjC5n4urI7hicwliamOwJhhLVgaicsNznCoZnuceQ0sB7FxZyrYlg/640?wx_fmt=png)
**高斯预期改进（EI）**
上式常见的变形叫做预期改进，定义为
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6KwoXRdZc7nrzhH41aeMO1N19XJggMK8siaaAx6ZyDGRyjGicQEKBiaoxg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6BrayHTbOPo7lKjfHGxT4gGZMicgTiaVq7ZytnAhhwuy2MnayXOUwdIEQ/640?wx_fmt=png)
**讨论**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q61EuBOnNAUfwHeCVqvaFdMauPMHOibRp0NHVSeYJuNroVKo5rzTjlGqw/640?wx_fmt=png)
这里，(1/σ^2) * I 在式（6）中被定义，但在样本集外的所有行中都为零。为了得到式（5），我们必须统一为正文中逆矩阵的分块结构。
首先，我们可以得出
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q61z9lTV6Cn3Dib9m2GG2lEohh8TPvrxVMo8jWG8kErZIr9rynAUBvn7Q/640?wx_fmt=png)
这里我们使用了分块表示法。为了计算上述的逆矩阵，我们将利用分块矩阵求逆公式，
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6N85QMibjOficy4GyFbD6hrQuotEEOib3g9rIibzvicNgSYTgr7gQRKrgoCw/640?wx_fmt=png)
矩阵（A2）中块 C = 0、D = 1，这大大简化了上述过程。代入后得到
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6o9S7qUdrBpPcWJlNZTQhGF5KZRBy1UTJVY7LSgsibKAY4eAluGzxo7Q/640?wx_fmt=png)
利用这个结果和（A1），我们可以得到测试集的平均值
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6KfehD00TqrPYPobIuzvEZdxy5gNBALHyUqZygteJYtia1zIjNkqezyw/640?wx_fmt=png)
其中第二行的分子分母同时乘了 (1/σ^2) * I_00 的逆。类似地，测试集的协方差由（A3）的右下块给出。得到，
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6RAgdxUx19GjNnHFX4ykLYsjibZeSmBvr7Q99Fchib3LtIgR7UvXRvGRw/640?wx_fmt=png)
由（A4）和（A5）得出式（5）。
**方法 2**
在第二种方法中，我们考虑一组测试点 f_1 和一组观测样本 f_0 的联合分布，我们再次假设密度函数的均值为零。那么两者的联合概率密度是
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6tyqryspSOlEhn2WjicQTTs5jEJsPbctrSticffoYwOQmWKe6OibMQJ3Gg/640?wx_fmt=png)
现在，我们利用结果
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6icHibDibclMVzoOjgPaiczShFLLI7tbXhyOcshkia97Wib0Ij6rVqVCe38MA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6iap4ROXce3PmbD2uhN5xnNIYgicqB0Qf35qt4JHXq0DMoicj0ibHf1Te5A/640?wx_fmt=png)
**预定义的核函数**
- 
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6lNebbBakGaGaxEeQvCZlcKPFTpux3pHWPibnL6bPuj9EtV5rhUicIEGA/640?wx_fmt=png)
这个公式是 logistic 回归的一个正常非线性泛化。此外，f 的先验概率再次得到等式（3）。使用此式和（A8），我们可以得到 f 的后验概率
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gWibhWklL7plpXzAacM1kx5Q6miceCniaFBNGb3Q52j4KCPeZCB2tlgl67JMypCdKsNibXanXFLF0sZKqA/640?wx_fmt=png)
利用这个公式，可以很容易地从近似后验中获得置信区间和样本，类似于回归。![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9c4jab8nF8K4VVPCf7vYpUb3LVyVibRztpAJEINu984RZzXn0oGoPuQPFsKOGB9ad8e747b2icIRibg/640?wx_fmt=png)
