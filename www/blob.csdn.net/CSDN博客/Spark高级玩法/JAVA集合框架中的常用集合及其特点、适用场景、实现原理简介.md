# JAVA集合框架中的常用集合及其特点、适用场景、实现原理简介 - Spark高级玩法 - CSDN博客
2018年04月29日 00:00:00[Spark高级玩法](https://me.csdn.net/rlnLo2pNEfx9c)阅读数：163
...
# List类集合
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqibdkCccssNGhCxn0bjib63cX7MaoW44ewbMNwM3CYFI5esZWDToXSq4Q/640?wx_fmt=png)
图片.png
...
插入：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqRdxkEWyNGtDr0EtqqjTSewwm5hrxFsMlwEbeqpLF6TyTicW59XoQgHg/640?wx_fmt=png)
图片.png
删除：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqtQf3F8icQhIWpkZQmo4P8D6Y35rSVDxPATXm2qghFW7RpGMx6SR28Uw/640?wx_fmt=png)
图片.png
## LinkedList
LinkedList基于链表来实现集合的功能，其实现了静态类Node，集合中的每个对象都由一个Node保存，每个Node都拥有到自己的前一个和后一个Node的引用
LinkedList追加元素的过程示例：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqPqH1GykQtl4EuOtpDACg8pZMCV5rEibe1JWvCJicn1mhhdyLqpcFAJ8w/640?wx_fmt=png)
图片.png
...
# Map类集合
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqTqBcpsOUWS2br3ModqkFCDf2K8yzVdDZ0tg5rjiaCZdvVCvVIgTVcYQ/640?wx_fmt=png)
图片.png
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqz4yOwWLEWtPibvsHSafd7HHCUNVyPxk2DGmPsbHZ5bsQCY08HkMfo1w/640?wx_fmt=png)
图片.png
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqtPeC6wZEXPCMCGflnEQrJibmbERicR61DiaSBiaiaib3B8ibPN6STiab8R1ibjA/640?wx_fmt=png)
图片.png
HashMap的Entry类：
```java
```java
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqT43aOH5sEFhmpPFlSHmMPY6If2AnFP7SDMQTu6V7bbiaRx2RmxEpwxA/640?wx_fmt=png)
图片.png
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqBM2o7ia1yFkrBSQx3n9bET7yYbC3Q5NmypPlwRqZd1lnatUovTBAAvg/640?wx_fmt=png)
图片.png
## TreeMap
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqlTuALXWAJicwXCwaRkfNkib5p2EQcf4tavpCciaVAF6lIVlqOmBzNcLJw/640?wx_fmt=png)
图片.png
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqEUibHnGvmSz6DWbRFtEbUyEjuCZ1AbC0bzj8dbkIibWcH2sVhicJZDtCg/640?wx_fmt=png)
图片.png
# Queue/Deque类集合
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEqxSGJHA5WFXObBeFicJDxozVGrq6Nl5ibyPtBXaoIYOr4mIuPicOaSNPicQ/640?wx_fmt=png)
图片.png
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTr8gbRtpeWjPWDzQ4ic96FiaEq9iaK2vaic3cyKTJ6ISVTbAqKwdvaic8zz8Tm2NrWVHPia4LFKhNBXbpryg/640?wx_fmt=png)
**推荐阅读：**
1，[面试的角度诠释Java工程师（二）](http://mp.weixin.qq.com/s?__biz=MzA3MDY0NTMxOQ==&mid=2247484696&idx=1&sn=587f1e653fabc068c0308ff1eddd1e7c&chksm=9f38e630a84f6f2672d9040460e603958727fbec331ed037e6ef68d48d45849809bbba760b03&scene=21#wechat_redirect)
...
3，[Kafka源码系列之Broker的IO服务及业务处理](http://mp.weixin.qq.com/s?__biz=MzA3MDY0NTMxOQ==&mid=2247483680&idx=1&sn=ab5bb4613e0b05e4dd3d089c4aa4d668&chksm=9f38e208a84f6b1e7b27519d73d1fcb27671248f618f5a1ba608f87d33d1f0682ec0ed0bfa4f&scene=21#wechat_redirect)
4，[（译）理解 LSTM 网络 （Understanding LSTM Networks by colah）](http://mp.weixin.qq.com/s?__biz=MzA3MDY0NTMxOQ==&mid=2247484734&idx=1&sn=1dbf5f6ba3fc2fbe03227cf0ed4e8ace&chksm=9f38e616a84f6f00715fcfd5e810142469244fd75af0f00fcd44156320378b591e7c3870bde2&scene=21#wechat_redirect)
