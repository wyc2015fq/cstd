# 知乎数据埋点方案 - Spark高级玩法 - CSDN博客
2018年11月02日 00:00:00[Spark高级玩法](https://me.csdn.net/rlnLo2pNEfx9c)阅读数：833
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricF6XkEvM0XR5NGPe0BCRV3uZMibJENiayUT3eG5n2aQoiaucAicFgC831sPNCtmUrQJ2QROOQAz5sSzQ/640)
## 客户端埋点为什么难？
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricF6XkEvM0XR5NGPe0BCRV3MjDMk9wLZ2dRtltFgJk07ibnhjICO9toAPymBa5r0icQkaFkxnC1jiaxQ/640)
## 埋点的流程
...
目前知乎的埋点流程如下图所示。
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/XCETLoXzTricF6XkEvM0XR5NGPe0BCRV3B2rlEF0w0Eyvo2OlB2MTG7tmZOFgbnKfXuW7XzIJGEV86fTZq2xmHQ/640)
...
- 
数据仓库接口人负责业务数据的生产，和数据仓库团队对接，对埋点的定义需要有深入的理解综合考虑各角色的意愿后，我们设计了「业务数据负责人」这个角色，来整体来负责业务的数据生产工作，主要负责业务数据仓库需求和埋点设计。
### 工具
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricF6XkEvM0XR5NGPe0BCRV3RGG3YRbe736xw7AI6Wx6xB8tCrJg97tXldlQUCJcLNGiaNWxiays7tgA/640)
What
在事件发生位置上的内容信息，这里采集的内容由业务决定。 例如点击的卡片是一个回答还是一个 Live，当前内容的状态这类需求。
对于业务定制化的「What」，最初我们为个性化的需求，设计了通用的 ContentInfo，以及特定领域的数据结构。
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricF6XkEvM0XR5NGPe0BCRV3ak8LPSNdTEMljCtJBnasZeCBdnbTd4rcjU2g6zXHykmAZ6vOqzYyTA/640)
...
当数据结构较复杂，客户端工作量增大
- 
打错和打漏的情况，需要发版，周期长面对上述打点，对于不是必须由客户端获取的数据改成由业务后端生成 Protocol Buffers 结构，序列化成 string 随 api 带回客户端，客户端只需将 string 放置到通用的位置即可。数据平台组统一的实时 ETL 程序会反序列化该结构，过程如下图所示。
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/XCETLoXzTricF6XkEvM0XR5NGPe0BCRV3U7L86pmpDIqdcsjaM82CHC6TTJubHyPf0A2QWkj1SUf3SW3ibYVcBFA/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/XCETLoXzTricF6XkEvM0XR5NGPe0BCRV31LoxX9JvHr3mUE2zFMrRlLvLr6jS1yQjnadfsggjibwrGY8xku996icw/640)
创建埋点
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricF6XkEvM0XR5NGPe0BCRV3xsxJMfUUzKoBibfBcD22E5XbcJF7kNIdK04EMHvQc5HlXwNnRCmrFgg/640)
### 埋点测试平台
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/XCETLoXzTricF6XkEvM0XR5NGPe0BCRV3nNxqatK9egQ8x9S5fs1pV5m3WqnVJEM19MyXw8iaKX1eTeibd3m5diczA/640)
## 其他：关于 Hybrid 类型埋点
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricF6XkEvM0XR5NGPe0BCRV30P8L1UcU56jaRibQibTKGZMXj0NfedLNFl4NBXicBz89WLTvxLC1Mq9Kw/640)
Hybrid 框架主要处理以下的问题：
- 
