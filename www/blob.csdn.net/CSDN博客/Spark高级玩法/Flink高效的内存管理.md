# Flink高效的内存管理 - Spark高级玩法 - CSDN博客
2018年10月17日 00:01:09[Spark高级玩法](https://me.csdn.net/rlnLo2pNEfx9c)阅读数：238
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFUMu34x6hWaep4gddRRDvwfvAVnKdV1YaoPU1qia3LRsvbpe3vpj3HxE4zYbX8iawRGsiagiaVRP6Fhqg/640)
- 
...
- 
**减少GC压力。**显而易见，因为所有常驻型数据都以二进制的形式存在 Flink 的`MemoryManager`中，这些`MemorySegment`一直呆在老年代而不会被GC回收。其他的数据对象基本上是由用户代码生成的短生命周期对象，这部分对象可以被 Minor GC 快速回收。只要用户不去创建大量类似缓存的常驻型对象，那么老年代的大小是不会变的，Major GC也就永远不会发生。从而有效地降低了垃圾回收的压力。另外，这里的内存块还可以是堆外内存，这可以使得 JVM 内存更小，从而加速垃圾回收。
- 
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFUMu34x6hWaep4gddRRDvwfS8PhFsZnicDvYLjsZ3yJbX1LaOdLBT3FCB4NBlyoJethtBibOMU2wqnw/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFUMu34x6hWaep4gddRRDvwfUG9gMQibPNCagRgzfklV3s9HYEvPSKGFSJFaMUIZNw8Nic6693lADNag/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFUMu34x6hWaep4gddRRDvwfIJmuWiaxLL80mDIhGBAAkQbteDicTRXdomx7GfbumvXSteyQA6icKflFA/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFUMu34x6hWaep4gddRRDvwf2RsND2x2x7xdicicAicB3TW4BWKcOH3IwH6YzTB8CPF75zSecMrxyhasQ/640)
## 总结
