# Java动态代理原理及解析 - Spark高级玩法 - CSDN博客
2018年03月20日 00:00:00[Spark高级玩法](https://me.csdn.net/rlnLo2pNEfx9c)阅读数：115
## **代理：设计模式**
代理模式是一种常用的设计模式，其目的就是为其他对象提供一个代理以控制对某个真实对象的访问。代理类负责为委托类预处理消息，过滤消息并转发消息，以及进行消息被委托类执行后的后续处理。
![640?wxfrom=5&wx_lazy=1](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/QCu849YTaIPUvmaJWYOF6qbr20BzWsuFMMtRQVaIx9lgFJOicho7ibTk2Ml9Z2eFuF2C0vYVUvtribx0oA0icPwz4Q/640?wxfrom=5&wx_lazy=1)
...
> 
动态代理的注意点： 
1，包：代理接口是public，则代理类被定义在顶层包(package为空)，否则(default)，代理类被定义在该接口所在包，![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/QCu849YTaIPUvmaJWYOF6qbr20BzWsuFcUKzFiaicz5Oicdib9dg0dp1TONbH0MM1dibYgYefteIYeQl0EdKovMnMBQ/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/QCu849YTaIPUvmaJWYOF6qbr20BzWsuFU7lhpNEp8ibQnEC4lbt69waFSGQoF0wfS4WHP8V6EkuWsOtlmd8w22w/640)
4，类继承关系
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/QCu849YTaIPUvmaJWYOF6qbr20BzWsuFS61Ep2QMaAIT2kX2I3o3j16icyAmoSyS4qge0GGxCOlLTQ2Jx9qAdCw/640)
...
代码在反编译中 
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/QCu849YTaIPUvmaJWYOF6qbr20BzWsuFSbD7Fjtgox7uKlak4ibEB5xGK5dR9tjCKeunlZaaCoEodG8R65xLeew/640)
### **一个动态代理的demo**
```
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/QCu849YTaIPUvmaJWYOF6qbr20BzWsuFSB151LVoW5xiaypaLa73Lc4d44R1jg9L7zuWIXYialSbNjicGry5CCtgA/640)
...
- 
**原文：http://blog.csdn.net/Scplove/article/details/52451899**
