# 深入了解Redis内存模型 - Spark高级玩法 - CSDN博客
2018年06月05日 23:32:55[Spark高级玩法](https://me.csdn.net/rlnLo2pNEfx9c)阅读数：410
# 一、Redis内存统计
...
```
```
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlGG1KY7EBTGGa9D6RxLPhpzXCASQic7wn7dicj6xsgCxkSj4yVTJSLSaA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlib9dYxVmhviclGkeAguyZ6fBcJJeMibhUwnAjdQb0DMmT3TGibN4dF591g/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlWibsAFLdaNyVhlsFzicJS0qWltyjh43KRp1frqicgicXPLtQSPa5PG2vCQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITl7nFZ6yXOlG6BWp1ERkk5rhicdpWdxoeY0ddtQFyvBHqrB0eGG1mD0rg/640?wx_fmt=png)
### （2）encoding
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlecPEg27TNH66R1sjD18icY7h0Bf0tRfrzsflicXeYhJ8icFgcezzvlXPQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlAeibpMkMxO55qpjzPzia26gzB5ibFlzk4RpWasibx4LVWrQajSOB9CudQg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlKwoF7iasFAibQXaLf7IWyVmYc7PfUBic5AvHicCmxxXicddZl9ubcZYMia0g/640?wx_fmt=png)
### （5）ptr
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlgrumMputGfGHnIKibOcwibiafO7E9ej1VDTsum5tS45fzb55hyyotl2Qg/640?wx_fmt=png)
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlQaFic0dMibRLtaeicH6pJQBn3v1rcAGQerqDzib4SSibibERD6FfEibSWTq4g/640?wx_fmt=png)
图片来源：《Redis设计与实现》
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlklewu5LQicefuCuPYmiclNFtlw5wvUY9Xm89CEUpcsXM2d7q3dQgzAJg/640?wx_fmt=png)
图片来源：《Redis设计与实现》
...
raw：大于39个字节的字符串
示例如下图所示：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlHjLqyAicNGCxQBueTl9y9IDBGkViaA4K7wIlZjOEkhBWVMpib19aGZpiag/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITl1PF60u5E40e3FN2EHjibDibrVF7hqO4I4m2PqbvNXg9febjV1UymyicoQ/640?wx_fmt=png)
## 2、列表
### （1）概况
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlD0L2qmDD5iadfibicZxnhIfsEeax74GrsS6mrdvMMpFlwDQoCNzput8SQ/640?wx_fmt=png)
图片来源：《Redis设计与实现》
...
下图展示了列表编码转换的特点：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlTkzgHAPctuKqARXkuiaefaHTnzEeoicxziaiaZgibzFiaKbHxk8m6MhR3ajw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlAQ3j5QJparNQYFOcFuZqVIdufKqQBRsgoliaaChQvXr5Q0m2iaBOguDg/640?wx_fmt=png)
图片改编自：《Redis设计与实现》
下面从底层向上依次介绍各个部分：
**dictEntry**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlTsLuDQBtKsrh5ZUs45hiaERE0YLH3fgH6mZEJzbJgvasoFSmS9l3gDQ/640?wx_fmt=png)
## 4、集合
### （1）概况
...
下图展示了集合编码转换的特点：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlcqsSX1NNKK8I8zoTB7Wibeibpxib4eNT2yMz2eGrhCOvJgVAM57CIMg4w/640?wx_fmt=png)
## 5、有序集合
### （1）概况
...
下图展示了有序集合编码转换的特点：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/XCETLoXzTricqtPjzFGR7hhCIOsz7BITlxbjoJ695Dj7SZ3uZOH52msRlmVVOTZdmVbnA8S4QeVSBOW3C0ic0Dmg/640?wx_fmt=png)
# 五、应用举例
...
```
```cpp
String memoryAllLine = jedis.info(
```
```cpp
"memory"
```
