# 数据仓库②-数据仓库与数据集市建模 - Spark高级玩法 - CSDN博客
2018年03月02日 00:00:00[Spark高级玩法](https://me.csdn.net/rlnLo2pNEfx9c)阅读数：523
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlObeZDdQbmWgY8jPjPmxfqmzfkXR1W02tAOiccLA1eIEoIOc8L2B53jjQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOIW8DG5udvTdib9dCKbu9Q6SOxhvWuUrVYE0gWOM8JznQSgiaxA62NVRA/640?wx_fmt=png)
星形模式中的维表相对雪花模式来说要大，而且不满足规范化设计。雪花模型相当于将星形模式的大维表拆分成小维表，满足了规范化设计。然而这种模式在实际应用中很少见，因为这样做会导致开发难度增大，而数据冗余问题在数据仓库里并不严重。
3. 星座模式
星座模式(Fact Constellations Schema)也是星型模式的扩展。基于这种思想就有了星座模式：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOf0JhAJJDVmZOaVuWmrKtxKQZxUqGZegeMV4rUSyHazhGuUPBicSfibicA/640?wx_fmt=png)
前面介绍的两种维度建模方法都是多维表对应单事实表，但在很多时候维度空间内的事实表不止一个，而一个维表也可能被多个事实表用到。在业务发展后期，绝大部分维度建模都采用的是星座模式。
4. 三种模式对比
归纳一下，星形模式/雪花模式/星座模式的关系如下图所示：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOCWzdyibBtdByR1ESJLb1t1yH91WWQ1GYEhWvibjMPYEXoheyM3ralkNw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOb8tH6Df9AibJvibq1GQK1YDdbfNHj2KPGQEhJxfv2TTuyNtxvHBMHBRg/640?wx_fmt=png)
随后可利用建模工具将ER图直接映射到关系图：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOgPGDySBLxmgaRI8Bln7SsFOwKdQxiaUaHnOnvrDicGjiaEHdWiabyVXxQg/640?wx_fmt=png)
...
明确这四个问题后，便能轻松完成维度建模：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOUzHAePLrquGic2qY36ibShf2B9yjMGst7jIZxB52QiccG9d4oy8f4S3Bw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOnIBSMy1yBAXUd6prJx7e8Ooew4uGeoTgGVxrLy49gyCdoB0yqk2ib7Q/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOFBXRKrVReNgBvpz3mibGt9hoQTe56uje2hicHnEicVNpmj903BQQ7rDUA/640?wx_fmt=png)
2. 细节/聚集事实表
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOmAsxJicygqBnBjibmR74A9LrWESbUy7SsWUvZibqeovq4zg1Y2MKvOaHg/640?wx_fmt=png)
缓慢变化维度问题
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOhYGOyjbpiaX1Q6XEsmgwOw0WfE5AhgQChzpb1Qiae4KgjU0pzZKrZRew/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOcXNq2bULTtC3r387RASudKHvKq95LAbTqfnWE6CsiaoWdmbOefk4eWw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlO4BlAJjex0RjYaB4OkOic16F2WPYZ0ABEL2BM86vCzicQqbAxgYE0OFPg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlOsAAG3rWnXLGCLee9AnRIiaQ2BPoVDRRAlaKs9wF1DnqNpJ7bRmYFribg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFVmJwYc9DKA6CQGavOzmNlONMXD8Tne1icp5FfZSgibVXcU0PqZGkFNIrcxdpuTHjD6ngPPDk6c9BHQ/640?wx_fmt=png)
...
本文来自http://www.cnblogs.com/muchen/p/5310732.html，作者穆晨，本文已获得授权，谢谢作者大作，未获授权请勿转载。
**浪尖微店，就在浪尖公众号菜单栏：资料教程。**
**推荐阅读：**
1，[超越Spark，大数据集群计算的生产实践](http://mp.weixin.qq.com/s?__biz=MzA3MDY0NTMxOQ==&mid=2247484395&idx=1&sn=82ae3b4fd460d4666d46aa2348f540c6&chksm=9f38e0c3a84f69d5b0d871133d9f94c3612c7a98e9dc93ac74d0f2ccce12a13f18207cbd9ce0&scene=21#wechat_redirect)
2，[hive的分区和分桶](http://mp.weixin.qq.com/s?__biz=MzA3MDY0NTMxOQ==&mid=2247484404&idx=1&sn=88c0418a866572c1dd85ced93d1168f0&chksm=9f38e0dca84f69ca45cd77722839004db02019297c8608835114e382d1b85c6bb6c1fe920934&scene=21#wechat_redirect)
