# HBase 深入浅出 - Spark高级玩法 - CSDN博客
2018年10月04日 00:05:14[Spark高级玩法](https://me.csdn.net/rlnLo2pNEfx9c)阅读数：89
## **HBase 在大数据生态圈中的位置**
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGJSKnicjLnxWJicDVicGDLj5WdlwsnqySEy835UMJ2Hblf3Ydv64uT0etw/640)
理解了上面的表格之后，我们在看看数据是如何在 HBase 以及 RDBMS 中排布的。首先，数据在 RDBMS 的排布大致如表 2。
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGTVDR5GXxO7WxkvBHVaNcXChiaqiceCsRvsBaxibJ2MdJ56H6MP8rbNhQg/640)
那么数据在 HBase 中的排布会是什么样子呢？如表 3 所示（这只是逻辑上的排布）。
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGM59UhofHG4Mn7TUicWl8oxNlPzSfNrC9wBpGFOIPmhwjDhkXP8d7bBA/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGR4s9e3FsIMcY3uId0yibAb9wIwuibo6Enz5e6Ek2onJGfELGvvJ3tiaKA/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGcLAtzpIibxhbLUPGibrD2ye4hV7zticrdya4GHEIDfqv5waPl5r68dpvg/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGC8X4OLQf1HtvkbLfjh0ialgTWiaicrpWL2yA1Kjd8fPgTdFbKeqYxZicWg/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGvIsC4yzvSwx5M2eqWTOK02xjJ7Bpf24cNiawfLuRgibHMNOp444RZ5oQ/640)
...
图 4. HFile 的结构
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGG48k3BkVHrtTLx9guaby4PDQ7CFfV7L9LG0SI7JXnKbsxFktXwN3ONA/640)
...
#### 图 5. HBase 的数据映射关系
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGvnchUg349CnZRjfW0QAPg2EX2cFo4Tp3w12nJh8GQR3pbic1JeSjEwA/640)
## **HBase 的使用建议**
...
#### 图 6. Phoenix 的下载页面
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGBggMjvic2aiaWeYONdvT2ae5XJrmpph7Zlpv7ss7un3ctmvytKoRlc5g/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGyNgWFdwlPyA0apEUash3ekicsnjUIrGzHjBCARly50wauyg0Fj1103Q/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGic7IGkfO5bTTMKZLHicMEicNnIuvWNsMeTicjOuWzP53DxziczEeE0btTJg/640)
然后我们在 Sqlline.py 的终端中执行"!table"命令，我们发现并没有 table1 这张表。接下来我们执行如下的命令：
createview"table1" (pk VARCHAR PRIMARY KEY, "cf1"."name"VARCHAR, "cf1"."age"VARCHAR);
然后再使用!table 命令，这时候结果如下：
#### 图 8. Phoenix 执行表查询结果
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGRT23RibzbFHjcK8L278s8PZe5YXQQROCtrQh6vwwszGIFH8FUggGFFw/640)
我们可以看到结果中多了一个 table1 的视图，这样 Phoenix 就将 table1 表的内容关联到了 Phoenix 的视图当中。我们可以使用 select 等语句访问其中的内容，如下：
#### 图 9. Phoenix 执行查询结果
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGtScJnHaF1jVvRHLgSWbWE3womjgqRx3qMSc6BcnR1YjhombKV05MxA/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGGiauV2PrMla6IRXONjWQBJbMacP5GXC6u9AYzhauUibTd8bJibxS5m4CMQ/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/adI0ApTVBFV5PmE5B4qWuS8ZsxcVGUGG3OjqnRZKOcOmz2qvk4miavDPedVagrYRRqH9c2sic3mhLia9qibIpvCbNw/640)
