# 【深度学习】③--神经网络细节与训练注意点 - Spark高级玩法 - CSDN博客
2018年02月01日 00:00:00[Spark高级玩法](https://me.csdn.net/rlnLo2pNEfx9c)阅读数：539
## 要么关注我好了~
## **1. 权重的初始化**
### 1.1 fine-tuning
...
![640?wx_fmt=png&wxfrom=5&wx_lazy=1](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9H9icregtwkRYXsuRLTrKefVxGRyeNj897IiaWuastEvUQ0AEoNbeyUEAw/640?wx_fmt=png&wxfrom=5&wx_lazy=1)
### 1.2 随机数很小数初始化权重
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HqaEsKUt6Dr3FVqXPf1DeLGOQF8EkEB8icdkr2VMvzeUDNu1w13WicA2Q/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9H7ibs6lIqicqNiaicRvHLmC8ySGJEibejcELelE3SmnEiad0FMqOlHLcp7PeQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HI99HXTzfCl5rxgUVzVdmQzZfpqNJsASjQaOMQv9QQ3HQUdMdhruHZw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HNDmEXngZOp91kvXAWzflBJlhVkqfG6wcRRe8nbB6AsLuheQxK31csw/640?wx_fmt=png)
柱状分布图与我们之前看的有所不同，再来回顾一样ReLU激励函数的函数图，它是一个由y=x,和 y = 0 两条射线组成的，当x < 0 时，y = 0. 所以柱状图的分布值也是 >= 0 。 
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HrJEGnibS7yHGhTw62P41QQqn22QRZKJ5sMqufvv8Qul6MKVfZricBosw/640?wx_fmt=png)
...
根据新的方法，输出了以下结果：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HdhCus5cjicWUZkSMEeAPsgibnk2YzLSXiaPpa8Fdn74vJ1I1NgXHahiaSA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HTeiawt3FJo2AIt51QqwTTLPN5ojuMm3Xv0TKOSuTQKaPkibtNPwuIrSQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9Hmshp2DT6rFnU7F17XKkibPjvpYSuF7DiaEAjHgpfZLgHZvq080pbvqicg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HZWjAh5p8daSaMfrpTAVOHR3sctLuzLuBRB0ZTPxSsAmtONFVessJFQ/640?wx_fmt=png)
## **3. 训练检查与监控**
### 3.1 在小数据集上“过拟合”
在真正训练模型前我们需要做这样一步： 
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HDYAGfnuBua1LnhliaSXKKH7yaGhuXemDXLOdDdRsniaM4DibJxDRLiatCw/640?wx_fmt=png)
### 3.2 加入小强度的正则化
在确保了神经网络在小数据集上的过拟合，接下来就加入正则化，但强度不要太大，去观察输出的损失loss是否在下降.如果逐渐下降则该神经网络通过检验。
下面那是python代码和输出结果。 
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HGPDxIfv99dJUq8KWCQBVIQWmRo26514aiahzdSA0vRVLuQ3ibFIAiaHlQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HCQ37icwV71aU9ibubR4EuLE5oZgVbgw0DFic9GfHM2ryDtbibEyy2qhbFg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HicSGa70tWt1KRKbIGvkTjib0yAKW0KKOHO9o4Z2G3gHpEPSiaquZlzujQ/640?wx_fmt=png)
## **4. 最优化与参数更新**
### 4.1 SGD 与学习率
只要学习率很小，就能保证loss一直减小，但是收敛会非常慢 
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9Hzs1xUK4xsRDlJE11VicpqbzYaxxxQhiaa8Dj73bYamh3ebOyqoKic9Log/640?wx_fmt=png)
动量更新Momentum update
这是受物理学启发的优化方法，加快了收敛速度。这个方法加入了一步分加速度： 
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HyD7GyOhuBeOZ4v71UegPgwvd8WPNQaNsevGsR51dU6BiagAKmAIGlfA/640?wx_fmt=png)
v可以初始化为0，mu可以设置为0.9左右值。
Nesterov Momentum
另一种优化的方法是基于凸优化理论，它的收敛更好。 
当我们下山中每向下走一步，走完之后的位置其实已经变化了，所以应该用心的位置去做求导，如下公式 
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9H5MdiaoibXLaqmxxUsfQBciajwuHlbhmRH1PMIDibKLmt346O0UpZZoQ2cw/640?wx_fmt=png)
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9H1bzGqxDQDjEJNDLLApib1Br2X8k937r9xI9LokgkZfZXQtyN3B5LTcg/640?wx_fmt=png)
学习率衰减
...
2.指数衰减 
随着t的上升，a会逐渐下降 
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HPsMiaDoSnMo2kyjRs4gP9JZ2Ctv8xR9QVE84zTSIiaCYC9ZWPKOlV2FQ/640?wx_fmt=png)
3.1/t衰减 
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HMeDNKd2iaEEUMxo7aJS8oYMFhMCmbySn6haC0EycWljDiaDZ71mfhUvQ/640?wx_fmt=png)
## **5. 深层网络与ResNet**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HibGMhdkYTha6WjNAmbULgh8t7qO9ElBRSpywpfwYplmYVpuhAtTnibRA/640?wx_fmt=png)
左图画出了不同层次的ResNet的损失图，实线是验证集，虚线是训练集，可以看出层次越深的话损失就越低了。 
但是一个有趣的事情是，当层次继续上升，到了1202层的时候，它的损失反而比110层的要大了。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9Haf2lZbKcic7kv2BetpibRicLiaEDjB3Cy9x5w8Psum0FdWTh5jkXEytdqg/640?wx_fmt=png)
下面是ResNet的python代码，可能有点看不清，想要的童鞋可以直接问我要。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HmXQHvncVLJwMjOr4iatsvVibsY0F9j5gaEugCwS4XZiccvwqDgLqib5Zug/640?wx_fmt=png)
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9Hy4ibNmTwnWczKkNL0x1jH0eXtZN02v5SJR31j3PMSIbf4KYtiaicpDngA/640?wx_fmt=png)
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/oryJxDmHwIIjZZnh7uiaw2Oda8a9SVO9HaKd9pUNogAib7SDyEnsObz5bOicO628q6NdU9fBENWoCP0WUqyXf4SVA/640?wx_fmt=png)
