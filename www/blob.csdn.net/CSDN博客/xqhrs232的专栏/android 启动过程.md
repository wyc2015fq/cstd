# android 启动过程 - xqhrs232的专栏 - CSDN博客
2011年03月28日 10:34:00[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：669标签：[android																[command																[service																[action																[list																[signal](https://so.csdn.net/so/search/s.do?q=signal&t=blog)](https://so.csdn.net/so/search/s.do?q=list&t=blog)](https://so.csdn.net/so/search/s.do?q=action&t=blog)](https://so.csdn.net/so/search/s.do?q=service&t=blog)](https://so.csdn.net/so/search/s.do?q=command&t=blog)](https://so.csdn.net/so/search/s.do?q=android&t=blog)
个人分类：[Android/Java](https://blog.csdn.net/xqhrs232/article/category/906925)
原文地址::[http://blog.csdn.net/yahoozhuo/archive/2010/04/01/5442000.aspx](http://blog.csdn.net/yahoozhuo/archive/2010/04/01/5442000.aspx)
...
二. Linux 内核启动挂载android根文件系统过程分析
顺便罗列一下内核启动流程：
...
- 重啟需要重啟的服务
- 輪詢注冊的事件
- 如果signal_recv_fd 的revents 為POLLIN，則得到一個信號，獲取并處理
...
类型为：stream
本文来自CSDN博客，转载请标明出处：[http://blog.csdn.net/yahoozhuo/archive/2010/04/01/5442000.aspx](http://blog.csdn.net/yahoozhuo/archive/2010/04/01/5442000.aspx)
