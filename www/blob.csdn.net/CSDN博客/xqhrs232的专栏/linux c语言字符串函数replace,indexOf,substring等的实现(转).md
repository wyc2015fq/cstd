# linux c语言字符串函数replace,indexOf,substring等的实现(转) - xqhrs232的专栏 - CSDN博客
2017年03月22日 17:24:51[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：547
原文地址::[http://www.cnblogs.com/qq78292959/archive/2012/05/04/2483049.html](http://www.cnblogs.com/qq78292959/archive/2012/05/04/2483049.html)
...
- externvoid replaceFirst(char *str1,char *str2,char *str3);  
- externvoid replace(char *str1,char *str2,char *str3);  
- externvoid substring(char *dest,char *src,int start,int end);  
- externchar charAt(char *src,int index);  
- externint indexOf(char *str1,char *str2);  
- externint lastIndexOf(char *str1,char *str2);  
- externvoid ltrim(char *str);  
- externvoid rtrim(char *str);  
- externvoid trim(char *str);  
再写个测试文件test.c:
- #include <string.h>
- #include <stdio.h>
- #include "mystr.h"
