# GSM/GPRS的CMS errors & CME errors - xqhrs232的专栏 - CSDN博客
2013年02月04日 17:36:03[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：1188
个人分类：[3G/RIL/TAPI/网络技术](https://blog.csdn.net/xqhrs232/article/category/906928)
原文地址::[http://bbs.sendsms.com.cn/f9/cms-errors-cme-errors-176/](http://bbs.sendsms.com.cn/f9/cms-errors-cme-errors-176/)
小知识：
What is +CMS, and +CME Errors? 
+CMS Errors are returned from the SMSC. +CME Errors are generated by the GSM device firmware. 
CMS是 短信中心SMSC的返回错误；CME是设备返回的错误。
