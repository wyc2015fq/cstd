# ifconfig 源码 - xqhrs232的专栏 - CSDN博客
2018年01月08日 10:57:12[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：196
个人分类：[Linux/Ubuntu/Fedora](https://blog.csdn.net/xqhrs232/article/category/906931)
原文地址::[http://blog.csdn.net/timebomb/article/details/9216679](http://blog.csdn.net/timebomb/article/details/9216679)
相关文章
1、[ifconfig源码分析之与内核交互数据](ifconfig源码分析之与内核交互数据)----[http://blog.csdn.net/rosetta/article/details/7563615](http://blog.csdn.net/rosetta/article/details/7563615)
贴一下ifconfig的源码（它属于net-tool软件包），以备平时查看网络信息的配置。
[cpp][view
 plain](http://blog.csdn.net/timebomb/article/details/9216679#)[copy](http://blog.csdn.net/timebomb/article/details/9216679#)
- /*
...
- staticint get_nmbc_parent(char *parent, unsigned long *nm,   
-                unsigned long *bc);  
- staticint set_ifstate(char *parent, unsigned long ip,  
-                unsigned long nm, unsigned long bc,  
- int flag);  
- 
- staticint if_print(char *ifname)  
- {  
- int res;  
- 
- if (ife_short)  
...
- staticint set_flag(char *ifname, short flag)  
- {  
- struct ifreq ifr;  
- 
...
- staticint clr_flag(char *ifname, short flag)  
- {  
- struct ifreq ifr;  
- int fd;  
- 
...
- staticint test_flag(char *ifname, short flags)  
- {  
- struct ifreq ifr;  
- int fd;  
- 
...
- }  
- 
- staticvoid version(void)  
- {  
-     fprintf(stderr, "%s\n%s\n", Release, Version);  
-     exit(E_USAGE);  
- }  
- 
- staticint set_netmask(int skfd, struct ifreq *ifr, struct sockaddr *sa)  
- {  
- int err = 0;  
- 
...
- int fd;  
- #if HAVE_AFINET6
- externstruct aftype inet6_aftype;  
...
- #endif
- #if HAVE_AFINET
- externstruct aftype inet_aftype;  
- #endif
- 
- #if I18N
-     setlocale (LC_ALL, "");  
...
-         opt_a = 1;  
- 
- elseif (!strcmp(*argv, "-s"))  
-         ife_short = 1;  
- 
- elseif (!strcmp(*argv, "-v"))  
-         opt_v = 1;  
- 
- elseif (!strcmp(*argv, "-V") || !strcmp(*argv, "-version") ||  
-         !strcmp(*argv, "--version"))  
-         version();  
- 
- elseif (!strcmp(*argv, "-?") || !strcmp(*argv, "-h") ||  
...
- 
- staticint set_ip_using(constchar *name, int c, unsigned long ip)  
- {  
- struct ifreq ifr;  
- struct sockaddr_in sin;  
- 
...
- }  
- 
- staticint do_ifcmd(struct interface *x, struct ifcmd *ptr)  
- {  
- char *z, *e;  
- struct sockaddr_in *sin;  
- int i;  
...
- 
- 
- staticint get_nmbc_parent(char *parent,  
-                unsigned long *nm, unsigned long *bc)  
- {  
- struct interface *i;  
- struct sockaddr_in *sin;  
