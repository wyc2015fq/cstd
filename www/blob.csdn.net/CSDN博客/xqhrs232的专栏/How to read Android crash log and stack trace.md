# How to read Android crash log and stack trace - xqhrs232的专栏 - CSDN博客
2012年05月29日 10:33:56[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：743标签：[crash																[android																[thread																[signal																[structure																[build](https://so.csdn.net/so/search/s.do?q=build&t=blog)](https://so.csdn.net/so/search/s.do?q=structure&t=blog)](https://so.csdn.net/so/search/s.do?q=signal&t=blog)](https://so.csdn.net/so/search/s.do?q=thread&t=blog)](https://so.csdn.net/so/search/s.do?q=android&t=blog)](https://so.csdn.net/so/search/s.do?q=crash&t=blog)
个人分类：[Android/Java](https://blog.csdn.net/xqhrs232/article/category/906925)
原文地址::[http://bootloader.wikidot.com/linux:android:crashlog](http://bootloader.wikidot.com/linux:android:crashlog)
An Android crash in C/C++ code often generates some crash log which looks like the following. They can be seen either with "adb logcat" or found in one of the tombstones under /data/tombstones. This article briefly explains the structure of the log, how
 to read it, and how to translate the addresses into symbols with the [stack](http://bootloader.wikidot.com/local--files/linux:android:crashlog/stack) tool.
...
[stack](http://bootloader.wikidot.com/local--files/linux:android:crashlog/stack) here.
```
...
```
## References
Debugging Native Code: [http://source.android.com/porting/debugging_native.html](http://source.android.com/porting/debugging_native.html)
