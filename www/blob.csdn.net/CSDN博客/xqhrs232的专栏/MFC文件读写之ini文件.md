# MFC文件读写之ini文件 - xqhrs232的专栏 - CSDN博客
2017年07月06日 11:48:53[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：276
原文地址::[http://b217dgy.blog.51cto.com/5704306/1251422/](http://b217dgy.blog.51cto.com/5704306/1251422/)
相关文章
1、[VS
 INI文件读写（仅供参考哦！）](http://blog.csdn.net/mycomputerxiaomei/article/details/7747548)----[http://blog.csdn.net/mycomputerxiaomei/article/details/7747548](http://blog.csdn.net/mycomputerxiaomei/article/details/7747548)
什么是ini文件？
...
[cpp][view
 plain](http://blog.csdn.net/rayborn1105/article/details/8192142#)[copy](http://blog.csdn.net/rayborn1105/article/details/8192142#)[print](http://blog.csdn.net/rayborn1105/article/details/8192142#)[?](http://blog.csdn.net/rayborn1105/article/details/8192142#)
- 
...
- 
- 
DWORD GetProfileSectionNames(CStringArray&
 strArray); // 返回section数量  
- 
- 
int GetProfileInt(LPCTSTR lpszSectionName, LPCTSTR lpszKeyName);
    
- 
DWORD GetProfileString(LPCTSTR lpszSectionName, LPCTSTR lpszKeyName,
 CString& szKeyValue);    
- 
- 
...
UINT m_unMaxSection; //
 最多支持的section数(256)  
- 
UINT m_unSectionNameMaxSize; //
 section名称长度，这里设为32(Null-terminated)  
- 
- 
void Init();
    
...
- 
- 
DWORD CIniFile::GetProfileSectionNames(CStringArray
 &strArray)    
- 
{    
- 
int nAllSectionNamesMaxSize
 = m_unMaxSection*m_unSectionNameMaxSize+1;    
- 
char *pszSectionNames
 = newchar[nAllSectionNamesMaxSize];
    
- 
DWORD dwCopied
 = 0;    
...
- 
   } while (pSection
 && pSection<pszSectionNames+nAllSectionNamesMaxSize);    
- 
- 
delete[] pszSectionNames;
    
...
- 
- 
DWORD CIniFile::GetProfileString(LPCTSTR lpszSectionName, LPCTSTR lpszKeyName,
 CString& szKeyValue)    
- 
{    
- 
...
- 
int nKeyValue
 = ::GetPrivateProfileInt(lpszSectionName, lpszKeyName, 0, m_szFileName);    
- 
- 
return nKeyValue;
    
...
{    
- 
return ::WritePrivateProfileString(lpszSectionName,
 lpszKeyName, lpszKeyValue, m_szFileName);    
- 
}    
- 
- 
...
- 
return ::WritePrivateProfileString(lpszSectionName,
 lpszKeyName, szKeyValue, m_szFileName);    
- 
}    
- 
- 
...
{    
- 
return ::WritePrivateProfileSection(lpszSectionName,
 NULL, m_szFileName);    
- 
}    
- 
