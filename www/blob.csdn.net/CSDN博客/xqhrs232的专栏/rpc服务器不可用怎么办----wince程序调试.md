# rpc服务器不可用怎么办----wince程序调试 - xqhrs232的专栏 - CSDN博客
2015年04月29日 15:05:01[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：2018
...
相关文章
1、使用Visual Studio2008 调试Windows Mobile程序，提示RPC服务器不可用----[http://bbs.csdn.net/topics/390737273](http://bbs.csdn.net/topics/390737273)
...
//===============================================================================================================================
备注::
1》把VS2005关闭重新打开就可以解决这个RPC服务器不能用的问题！！！
