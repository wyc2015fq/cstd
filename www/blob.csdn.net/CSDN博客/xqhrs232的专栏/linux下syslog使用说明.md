# linux下syslog使用说明 - xqhrs232的专栏 - CSDN博客
2016年03月23日 17:42:57[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：350
原文地址：[http://blog.chinaunix.net/uid-25120309-id-3359929.html](http://blog.chinaunix.net/uid-25120309-id-3359929.html)
相关文章
1、[linux syslog详解](http://www.cnblogs.com/skyofbitbit/p/3674664.html)----[http://www.cnblogs.com/skyofbitbit/p/3674664.html](http://www.cnblogs.com/skyofbitbit/p/3674664.html)
2、[关于syslog](http://blog.csdn.net/smstong/article/details/8919803)----[http://blog.csdn.net/smstong/article/details/8919803](http://blog.csdn.net/smstong/article/details/8919803)
syslog 系统日志应用
 1) 概述
...
 4) klogd 守护进程
      klogd 守护进程获得并记录 Linux 内核信息。通常，syslogd 会记录 klogd 传来的所有信息，然而，如果调用带有 -f filename 变量的 klogd 时，klogd 就在 filename 中记录所有信息，而不是传给syslogd。当指定另外一个文件进行日志记录时，klogd 就向该文件中写入所有级别或优先权。Klogd 中没有和 /etc/syslog.conf 类似的配置文件。使用 klogd 而避免使用 syslogd 的好处在于可以查找大量错误。如果有人入侵了内核，使用
 klogd 可以修改错误。
 5) 配置一个中央日志服务器 
...
[c-sharp][view
 plain](http://blog.csdn.net/ast_224/article/details/3930398#)[copy](http://blog.csdn.net/ast_224/article/details/3930398#)[print](http://blog.csdn.net/ast_224/article/details/3930398#)[?](http://blog.csdn.net/ast_224/article/details/3930398#)
- //syslog.c 
- #include  
...
[](http://blog.chinaunix.net/uid-25120309-id-3359929.html#)[](http://blog.chinaunix.net/uid-25120309-id-3359929.html#)[](http://blog.chinaunix.net/uid-25120309-id-3359929.html#)[](http://blog.chinaunix.net/uid-25120309-id-3359929.html#)[](http://blog.chinaunix.net/uid-25120309-id-3359929.html#)
