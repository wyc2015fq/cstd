# 详解coredump - xqhrs232的专栏 - CSDN博客
2016年10月19日 00:35:14[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：161
个人分类：[Linux/Ubuntu/Fedora](https://blog.csdn.net/xqhrs232/article/category/906931)
原文地址::[http://blog.csdn.net/tenfyguo/article/details/8159176/](http://blog.csdn.net/tenfyguo/article/details/8159176/)
**一，什么是coredump**
...
![](https://img-my.csdn.net/uploads/201211/07/1352287597_1389.jpg)
...
![](https://img-my.csdn.net/uploads/201211/07/1352287700_6534.jpg)
     可以看到ELF文件头的Type字段的类型是：CORE (Core file)
     可以通过简单的file命令进行快速判断：     ![](https://img-my.csdn.net/uploads/201211/07/1352287746_8191.jpg)
**四，产生coredum的一些条件总结**
1，  产生coredump的条件，首先需要确认**当前会话**的ulimit –c，若为0，则不会产生对应的coredump，需要进行修改和设置。
ulimit  -c unlimited  (可以产生coredump且不受大小限制)
若想甚至对应的字符大小，则可以指定：
ulimit –c [size]
![](https://img-my.csdn.net/uploads/201211/07/1352287797_3458.jpg)
...
      更多ulimit的命令使用，可以参考：[http://baike.baidu.com/view/4832100.htm](http://baike.baidu.com/view/4832100.htm)
...
![](https://img-my.csdn.net/uploads/201211/07/1352287869_3119.jpg)
Ø  按如下方式进行编译和执行，注意这里需要-g选项编译。
![](https://img-my.csdn.net/uploads/201211/07/1352287908_9077.jpg)
可以看到，当输入12的时候，系统提示段错误并且core dumped
Ø  我们进入对应的core文件生成目录，优先确认是否core文件格式并启用gdb进行调试。
![](https://img-my.csdn.net/uploads/201211/07/1352287964_7192.jpg)
...
![](https://img-my.csdn.net/uploads/201211/07/1352288068_8926.jpg)
