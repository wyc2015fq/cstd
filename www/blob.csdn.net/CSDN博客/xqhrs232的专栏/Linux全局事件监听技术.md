# Linux全局事件监听技术 - xqhrs232的专栏 - CSDN博客
2017年07月24日 15:38:29[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：291
个人分类：[X11/Qt/Qt quick/Qxml界面技术](https://blog.csdn.net/xqhrs232/article/category/6455019)
原文地址::[http://www.51testing.com/html/22/n-3716622.html](http://www.51testing.com/html/22/n-3716622.html)
应用场景
...
X11相关的技术有两种方案：
　　· 通过 XGrabPointer 和 XGrabKeyboard 抓取系统的焦点后监听全局事件
　　· 通过 XRecord Extension 非侵入式的监听全局事件
...
　技术原理
　　X11是Linux下最古老和通用的技术，不论用户的输入事件还是最后画到屏幕的绘制动作其实都是
 XServer 来实现的。
...
![](http://www.51testing.com/attachments/2017/03/14982672_201703231051071eDev.png)
我对开发者的学习一项新技术的建议是：
