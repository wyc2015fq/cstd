# (转)BMP文件格式详解（BMP file format）[图文解说] - xqhrs232的专栏 - CSDN博客
2012年09月25日 20:01:32[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：1132标签：[file																[windows																[嵌入式																[存储																[header																[struct](https://so.csdn.net/so/search/s.do?q=struct&t=blog)](https://so.csdn.net/so/search/s.do?q=header&t=blog)](https://so.csdn.net/so/search/s.do?q=存储&t=blog)](https://so.csdn.net/so/search/s.do?q=嵌入式&t=blog)](https://so.csdn.net/so/search/s.do?q=windows&t=blog)](https://so.csdn.net/so/search/s.do?q=file&t=blog)
个人分类：[DirectUI界面技术																[C/C++/VC++/VS](https://blog.csdn.net/xqhrs232/article/category/906934)](https://blog.csdn.net/xqhrs232/article/category/1243806)
原文地址::[http://hi.baidu.com/hsyl2012/item/f605e02169b9410976272c1a](http://hi.baidu.com/hsyl2012/item/f605e02169b9410976272c1a)
相关网帖
1.BMP格式图像文件详析----[http://www.thethirdmedia.com/pc/200407/20040722117029.shtm](http://www.thethirdmedia.com/pc/200407/20040722117029.shtm)
...
![](http://hiphotos.baidu.com/hsyl/pic/item/c9177f3e1ec8870670cf6c98.jpg)
...
我们使用的图像显示如下：
![](http://hiphotos.baidu.com/hsyl/pic/item/6709c93d0b0e75fc9f3d6298.jpg)
...
![](http://hiphotos.baidu.com/hsyl/pic/item/70cf3bc7e2fcb6e7d1006098.jpg)
这种存储方式称为小端方式(little endian) , 与之相反的是大端方式（big endian）。对两者的使用情况有兴趣的可以深究一下，其中还是有学问的。
2. 以下所有分析均以字节为序号单位进行。
   下面我们对从文件中拉出来的数据进行剖析：
![](http://hiphotos.baidu.com/hsyl/pic/item/9f3df8dcaec1f49acd116698.jpg)
**一、bmp文件头**
...
其中：
![](http://hiphotos.baidu.com/hsyl/pic/item/d100baa14cd03cb047106498.jpg)
对照文件数据我们看到：
![](http://hiphotos.baidu.com/hsyl/pic/item/cd11728bc4d1f729c8fc7a98.jpg)
...
![](http://hiphotos.baidu.com/hsyl/pic/item/4710b9124d3d8df5c3fd7898.jpg)
对照数据文件：
![](http://hiphotos.baidu.com/hsyl/pic/item/c8fcc3ce443cb23892457e98.jpg)
...
![](http://hiphotos.baidu.com/hsyl/pic/item/9245d6885ffec9afa4c27298.jpg)
...
![](http://hiphotos.baidu.com/hsyl/pic/item/d43f879429033325d21b7098.jpg)
索引：(蓝，绿，红，Alpha)
0号：(fe，fa，fd，00)
1号：(fd，f3，fc，00)
2号：(f4，f3，fc，00)
...
![](http://hiphotos.baidu.com/hsyl/pic/item/a4c27d1e5dda40cf1bd57698.jpg)
...
填充后的每行的字节数为：
![](http://hiphotos.baidu.com/hsyl/pic/item/d21b0ef48a14e355ddc47498.jpg) ，其中BPP（Bits Per Pixel）为每像素的比特数。
在程序中，我们可以表示为：
...
2.      gwwgle的专栏 BMP格式详解 [http://blog.csdn.net/gwwgle/archive/2009/11/06/4775396.aspx](http://blog.csdn.net/gwwgle/archive/2009/11/06/4775396.aspx)
3.      匿名 BMP格式图像文件详析[http://www.thethirdmedia.com/pc/200407/20040722117029.shtm](http://www.thethirdmedia.com/pc/200407/20040722117029.shtm)
4.      Singler的专栏位图文件（BMP）格式分析以及程序实现[http://blog.csdn.net/yyfzy/archive/2006/06/10/785945.aspx](http://blog.csdn.net/yyfzy/archive/2006/06/10/785945.aspx)
//===========================================================================
备注::
至此，我们通过分析一个具体的位图文件例子详细地剖析了位图文件的组成。需要注意的是：我们讲的主要是PC机上的位图文件的构成，对于嵌入式平台，可能在调色板数据段与PC机的不同。如在嵌入式平台上常见的16位r5g6b5位图实际上采用的掩模的方式而不是索引的方式来表示图像。此时，在调色板数据段共有四个部分，每个部分为四个字节，实际表示的是彩色版规范。即：
第一个部分是红色分量的掩模
