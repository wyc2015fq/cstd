# linux下实现两个线程之间的通信 - xqhrs232的专栏 - CSDN博客
2016年04月22日 18:35:36[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：2008
原文地址::[http://blog.csdn.net/scnujack/article/details/6438252](http://blog.csdn.net/scnujack/article/details/6438252)

流程图：
![](http://hi.csdn.net/attachment/201105/22/0_1306066657HSZ3.gif)
用gcc编译通过（gcc -pthread filename.c)。。。
**[c-sharp]**[view
 plain](http://blog.csdn.net/scnujack/article/details/6438252#)[copy](http://blog.csdn.net/scnujack/article/details/6438252#)
- #include<stdio.h>
- #include<memory.h>
- #include<pthread.h>
- int buf[1000000];  
