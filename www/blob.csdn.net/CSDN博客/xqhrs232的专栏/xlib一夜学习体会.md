# xlib一夜学习体会 - xqhrs232的专栏 - CSDN博客
2017年11月06日 23:58:59[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：209
个人分类：[X11/Qt/Qt quick/Qxml界面技术](https://blog.csdn.net/xqhrs232/article/category/6455019)
原文地址::[http://blog.csdn.net/hxh129/article/details/7839118](http://blog.csdn.net/hxh129/article/details/7839118)
相关文章
1、**xlib查找window并且置顶代码****----[http://laokaddk.blog.51cto.com/368606/970060/](http://laokaddk.blog.51cto.com/368606/970060/)**
**2、**[Proper
 algorithm for XQueryTree to get in z order](https://stackoverflow.com/questions/31888887/proper-algorithm-for-xquerytree-to-get-in-z-order)----[https://stackoverflow.com/questions/31888887/proper-algorithm-for-xquerytree-to-get-in-z-order](https://stackoverflow.com/questions/31888887/proper-algorithm-for-xquerytree-to-get-in-z-order)
3、XWindow的程序性能及改善 
 ----[http://blog.163.com/hbu_lijian/blog/static/1261291532012429104043353/](http://blog.163.com/hbu_lijian/blog/static/1261291532012429104043353/)
4、XGrabButton man page on HP-UX----[http://www.polarhome.com/service/man/?qf=XGrabButton&tf=2&of=HP-UX&sf=](http://www.polarhome.com/service/man/?qf=XGrabButton&tf=2&of=HP-UX&sf=)
5、[x扩展协议实例](http://blog.chinaunix.net/uid-741742-id-359289.html) ----[http://blog.chinaunix.net/uid-741742-id-359289.html](http://blog.chinaunix.net/uid-741742-id-359289.html)
...
[cpp][view
 plain](http://blog.csdn.net/luckyaslan/article/details/7835006#)[copy](http://blog.csdn.net/luckyaslan/article/details/7835006#)
...
- }  
[cpp][view
 plain](http://blog.csdn.net/hxh129/article/details/7839118#)[copy](http://blog.csdn.net/hxh129/article/details/7839118#)
- void findwindow(Ghandles *g, Window rootWindow)  
- {  
-     Window parent;  
-     Window *children;  
...
- }  
还可以实现窗口
 切换.... xlib唯一和GTK+ 不同的地方, 就是可以控制底层的一些东西, 其它概念拆不多.
[cpp][view
 plain](http://blog.csdn.net/luckyaslan/article/details/7835006#)[copy](http://blog.csdn.net/luckyaslan/article/details/7835006#)
- /*
- * Xlib 学习
...
//======================================================================================================================
备注::
1>xquerytree/XQueryData/XQueryPointer/XGrabButton
