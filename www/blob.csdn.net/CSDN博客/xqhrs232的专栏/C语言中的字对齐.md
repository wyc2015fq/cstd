# C语言中的字对齐 - xqhrs232的专栏 - CSDN博客
2010年06月29日 10:21:00[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：699标签：[c																[语言																[数据结构																[struct																[编译器																[平台](https://so.csdn.net/so/search/s.do?q=平台&t=blog)](https://so.csdn.net/so/search/s.do?q=编译器&t=blog)](https://so.csdn.net/so/search/s.do?q=struct&t=blog)](https://so.csdn.net/so/search/s.do?q=数据结构&t=blog)](https://so.csdn.net/so/search/s.do?q=语言&t=blog)](https://so.csdn.net/so/search/s.do?q=c&t=blog)
个人分类：[C/C++/VC++/VS](https://blog.csdn.net/xqhrs232/article/category/906934)
声明：本文是本人在学习过程中看到的文章，感觉讲解的非常透彻，出处已经不知道了，如有侵权请联系本人！
一、什么是对齐，以及为什么要对齐：
...
本文来自CSDN博客，转载请标明出处：[http://blog.csdn.net/kmcti/archive/2007/11/12/1880893.aspx](http://blog.csdn.net/kmcti/archive/2007/11/12/1880893.aspx)
