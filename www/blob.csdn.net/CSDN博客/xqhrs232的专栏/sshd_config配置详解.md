# sshd_config配置详解 - xqhrs232的专栏 - CSDN博客
2017年06月19日 14:32:17[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：251
个人分类：[Linux/Ubuntu/Fedora](https://blog.csdn.net/xqhrs232/article/category/906931)
原文地址::[http://www.2cto.com/os/201401/272738.html](http://www.2cto.com/os/201401/272738.html)
相关文章
1、[sshd_config配置 详解](http://www.cnblogs.com/findumars/p/5410924.html)----[http://www.cnblogs.com/findumars/p/5410924.html](http://www.cnblogs.com/findumars/p/5410924.html)
# sshd_config配置详解
```java
**名称     sshd***_***config** - OpenSSH SSH 服务器守护进程配置文件
**大纲     /etc/ssh/sshd***_***config描述**
     ...
     **Ciphers**
             指定SSH-2允许使用的[加密](http://www.2cto.com/article/jiami/)算法。多个算法之间使用逗号分隔。可以使用的算法如下：
     ...
     **DenyGroups**
             ...
             **DenyUsers**, **AllowUsers**, **DenyGroups**, **AllowGroups     ForceCommand**
             ...
             这可以应用于 shell 、命令、子[系统](http://www.2cto.com/os/)的完成，通常用于 **Match** 块中。
     ...
     **KeyRegenerationInterval**
             ...
             这个机制可以尽量减小密钥丢失或者[黑客](http://www.2cto.com/)攻击造成的损失。
     ...
     **PermitUserEnvironment**
             ...
             默认值是"no"。如果设为"yes"可能会导致用户有机会使用某些机制(比如 LD_PRELOAD)绕过访问控制，造成安全[漏洞](http://www.2cto.com/)。
     **PidFile**
