# 使用 ssh -R 建立反向/远程TCP端口转发代理 - xqhrs232的专栏 - CSDN博客
2017年04月25日 13:44:23[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：474
个人分类：[Linux/Ubuntu/Fedora](https://blog.csdn.net/xqhrs232/article/category/906931)
原文地址::[http://m.blog.csdn.net/article/details?id=46673089](http://m.blog.csdn.net/article/details?id=46673089)
相关文章
1、shootback：反向TCP隧道----[https://m.sohu.com/n/482449785/?qq-pf-to=pcqq.c2c](https://m.sohu.com/n/482449785/?qq-pf-to=pcqq.c2c)
http://blog.163.com/digoal@126/blog/static/163877040201451464251856/
是一个非常棒的工具, 不但能建立动态转发, 例如chrome的Switchy插件用到的就是这个技术.
[http://blog.163.com/digoal@126/blog/static/163877040201141821810103/](http://blog.163.com/digoal@126/blog/static/163877040201141821810103/)
还能建立TCP的转发隧道, 例如我以前写过的关于使用ssh 隧道加密和加速WAN传输的几个例子.
[http://blog.163.com/digoal@126/blog/static/163877040201342383123592/](http://blog.163.com/digoal@126/blog/static/163877040201342383123592/)
[http://blog.163.com/digoal@126/blog/static/16387704020115294425540/](http://blog.163.com/digoal@126/blog/static/16387704020115294425540/)
...
![使用 ssh -R 建立反向/远程TCP端口转发代理 - 德哥@Digoal - PostgreSQL](http://img0.ph.126.net/Yw2zbG6yARzg4y6oyaRIdg==/6608849934236162607.png)
反向代理应用场景.
...
![使用 ssh -R 建立反向/远程TCP端口转发代理 - 德哥@Digoal - PostgreSQL](http://img1.ph.126.net/FMrrTWw5IoL8gmGbLXIASw==/6608944492236153394.png)
...
![使用 ssh -R 建立反向/远程TCP端口转发代理 - 德哥@Digoal - PostgreSQL](http://img1.ph.126.net/0kVBZ44jNvEg5PmN-wZkSg==/6608181431167460269.png)
下面来举个例子 : 
场景 : 
...
![使用 ssh -R 建立反向/远程TCP端口转发代理 - 德哥@Digoal - PostgreSQL](http://img2.ph.126.net/Pj59DiHylahWR04f-06CnA==/6608598146073403055.png)
简单步骤.
1. 拨号, 略
...
man vncserver
[参考]
1. [http://blog.163.com/digoal@126/blog/static/163877040201141821810103/](http://blog.163.com/digoal@126/blog/static/163877040201141821810103/)
2. [http://blog.163.com/digoal@126/blog/static/16387704020115294425540/](http://blog.163.com/digoal@126/blog/static/16387704020115294425540/)
3. [http://blog.163.com/digoal@126/blog/static/163877040201342383123592/](http://blog.163.com/digoal@126/blog/static/163877040201342383123592/)
4. man ssh
...
when logging inas root on the remote machine.IPv6 addresses can be specified by enclosing the address
in square braces orusing an alternative syntax:[bind_address/]host/port/hostport.
Bydefault, the listening socket on the server will be bound to the loopback interface only.This may be
