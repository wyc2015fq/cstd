# DIB类的封装 - xqhrs232的专栏 - CSDN博客
2012年10月26日 23:30:13[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：978
原文地址::[http://blog.csdn.net/gao19900617/article/details/8098343](http://blog.csdn.net/gao19900617/article/details/8098343)
**主要成员函数**
**1.构造函数**
...
**头文件**
**[cpp]**[view
 plain](http://blog.csdn.net/gao19900617/article/details/8098343#)[copy](http://blog.csdn.net/gao19900617/article/details/8098343#)
- #pragma once
- 
...
-  DibInfo = (BITMAPINFO*) newchar [ cbHeaderSize ];  
...
-  DibBits = (void*) newchar[GetBodySize()];  
- //把文件指针移动到DIB图像数组
