# linux 头文件以及库的路径 - xqhrs232的专栏 - CSDN博客
2017年03月31日 16:44:30[xqhrs232](https://me.csdn.net/xqhrs232)阅读数：314
原文地址::[http://blog.csdn.net/longxj04/article/details/9118891](http://blog.csdn.net/longxj04/article/details/9118891)

原文：[http://erex.sinaapp.com/?p=126](http://erex.sinaapp.com/?p=126)
原来在编译的时候可以指定执行时去哪里找需要的lib文件，长知识了
本文详细介绍了[Linux](http://lib.csdn.net/base/linux) 下gcc头文件指定方法，以及搜索路径顺序的问题。另外，还总结了，gcc动态链接的方法以及路径指定，同样也讨论了搜索路径的顺序问题。本文包含了很多的例子，具有很强的操作性，希望读者自己去走一遍。
一.#include <>与#include “”
