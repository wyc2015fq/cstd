# RabbitMQ在分布式系统的应用 - 纸上得来终觉浅，绝知此事要躬行 - CSDN博客





2016年05月20日 18:30:15[boonya](https://me.csdn.net/boonya)阅读数：3802
...
转载自：[http://geek.csdn.net/news/detail/74184](http://geek.csdn.net/news/detail/74184)
...
命令：`rabbitmqctl set_policy ha-all “^ha\.” ‘{“ha-mode”:”all”}’`：设置所有以’ha’开头的queue在所有节点上拥有备份。[详细语法点这里](http://www.rabbitmq.com/ha.html)；也可以在界面上配置。

![图片描述](https://img-blog.csdn.net/20160516071133333)
...
![图片描述](https://img-blog.csdn.net/20160516071302117)
...
![图片描述](https://img-blog.csdn.net/20160516071728646)
**更多性能参数见：**[RabbitMQ Performance Measurements](http://www.rabbitmq.com/blog/2012/04/25/rabbitmq-performance-measurements-part-2/)
...
![图片描述](https://img-blog.csdn.net/20160516072110882)
...
![图片描述](https://img-blog.csdn.net/20160516072226270)
...
![图片描述](https://img-blog.csdn.net/20160516072323273)
...
![图片描述](https://img-blog.csdn.net/20160516072410600)
...
![图片描述](https://img-blog.csdn.net/20160516072457055)
...
![图片描述](https://img-blog.csdn.net/20160516072543977)

其实就是一对一模式的一种用法：

首先，客户端发送一条消息到服务端声明的队列，消息属性中包含`reply_to`和`correlation_id`
...
![图片描述](https://img-blog.csdn.net/20160516073554945)
...
启动后，执行`rabbitmq-plugins enable rabbitmq_management`→访问[http://localhost:15672](http://localhost:15672)→查看节点状态，队列信息等等，甚至可以动态配置消息队列的主备策略，如下图：

![图片描述](https://img-blog.csdn.net/20160516073935092)
...
![图片描述](https://img-blog.csdn.net/20160516074503286)
