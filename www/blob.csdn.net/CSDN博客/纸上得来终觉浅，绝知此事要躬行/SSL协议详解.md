# SSL协议详解 - 纸上得来终觉浅，绝知此事要躬行 - CSDN博客





2015年01月04日 13:38:04[boonya](https://me.csdn.net/boonya)阅读数：1027标签：[java																[ssl																[encryption																[socket](https://so.csdn.net/so/search/s.do?q=socket&t=blog)
...
原文地址：[http://www.cnblogs.com/zhuqil/archive/2012/10/06/ssl_detail.html](http://www.cnblogs.com/zhuqil/archive/2012/10/06/ssl_detail.html)**[](http://www.cnblogs.com/zhuqil/archive/2012/10/06/ssl_detail.html)**
...
      SSL中，使用握手协议协商加密和MAC算法以及保密密钥 ，使用握手协议对交换的数据进行加密和签名，使用警报协议定义数据传输过程中，出现问题如何去解决，整个过程比较复杂。




          作者：朱祁林出处：http://zhuqil.cnblogs.com 本文版权归作者和博客园共有，欢迎转载，但未经作者同意必须保留此段声明，且在文章页面明显位置给出原文连接，否则保留追究法律责任的权利。](https://so.csdn.net/so/search/s.do?q=encryption&t=blog)](https://so.csdn.net/so/search/s.do?q=ssl&t=blog)](https://so.csdn.net/so/search/s.do?q=java&t=blog)
