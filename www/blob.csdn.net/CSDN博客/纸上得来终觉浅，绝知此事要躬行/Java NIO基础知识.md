# Java NIO基础知识 - 纸上得来终觉浅，绝知此事要躬行 - CSDN博客





2013年02月26日 22:38:05[boonya](https://me.csdn.net/boonya)阅读数：852
...
public class CopyFile {	
	...
	while (true) {			
		...
		buffer.clear();		
        	       // 从输入通道中将数据读到缓冲区			
                 int r = fcin.read(buffer);			// read方法返回读取的字节数，可能为零，如果该通道已到达流的末尾，则返回-1	      if (r == -1) {				break;			}	
