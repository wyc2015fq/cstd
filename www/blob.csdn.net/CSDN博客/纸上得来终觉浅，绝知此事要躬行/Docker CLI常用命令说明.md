# Docker CLI常用命令说明 - 纸上得来终觉浅，绝知此事要躬行 - CSDN博客





2018年10月08日 10:37:53[boonya](https://me.csdn.net/boonya)阅读数：231
...
文章地址：[https://docs.docker.com/engine/reference/commandline/docker/](https://docs.docker.com/engine/reference/commandline/docker/)
...
[docker commit](https://docs.docker.com/engine/reference/commandline/commit/) 从容器的更改中创建新图像
...
[docker image](https://docs.docker.com/engine/reference/commandline/image/) 管理图像
...
[docker tag](https://docs.docker.com/engine/reference/commandline/tag/) 创建引用SOURCE_IMAGE的标记TARGET_IMAGE
[docker top](https://docs.docker.com/engine/reference/commandline/top/) 显示容器的运行进程
[docker trust](https://docs.docker.com/engine/reference/commandline/trust/) 管理Docker镜像上的信任
...
[docker wait](https://docs.docker.com/engine/reference/commandline/wait/) 阻止直到一个或多个容器停止，然后打印退出代码
