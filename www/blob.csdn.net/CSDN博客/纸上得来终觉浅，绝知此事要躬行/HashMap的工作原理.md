# HashMap的工作原理 - 纸上得来终觉浅，绝知此事要躬行 - CSDN博客





2015年04月09日 20:12:02[boonya](https://me.csdn.net/boonya)阅读数：565标签：[Java																[hashmap																[hashcode																[hashtable](https://so.csdn.net/so/search/s.do?q=hashtable&t=blog)
...
### [](https://github.com/stephanietang/ImportNew/blob/master/Java/How%20HashMap%20works%20in%20Java.md#%E5%85%88%E6%9D%A5%E4%B8%AA%E7%AE%80%E5%8D%95%E7%9A%84%E9%97%AE%E9%A2%98)先来些简单的问题
...
但一些面试者可能可以给出答案，“HashMap是基于hashing的原理，我们使用put(key, value)存储对象到HashMap中，使用get(key)从HashMap中获取对象。当我们给put()方法传递键和值时，我们先对键调用hashCode()方法，返回的hashCode用于找到bucket位置来储存Entry对象。”这里关键点在于指出，HashMap是在bucket中储存键对象和值对象，作为Map.Entry。这一点有助于理解获取对象的逻辑。如果你没有意识到这一点，或者错误的认为仅仅只在bucket中存储值的话，你将不会回答如何从HashMap中获取对象的逻辑。这个答案相当的正确，也显示出面试者确实知道hashing以及HashMap的工作原理。但是这仅仅是故事的开始，当面试官加入一些Java程序员每天要碰到的实际场景的时候，错误的答案频现。下个问题可能是关于HashMap中的碰撞探测(collision
 detection)以及碰撞的解决方法：
...
### [](https://github.com/stephanietang/ImportNew/blob/master/Java/How%20HashMap%20works%20in%20Java.md#%E6%80%BB%E7%BB%93)总结

#### [](https://github.com/stephanietang/ImportNew/blob/master/Java/How%20HashMap%20works%20in%20Java.md#hashmap%E7%9A%84%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86-1)HashMap的工作原理
...
原文链接： [Javarevisited](http://javarevisited.blogspot.hk/2011/02/how-hashmap-works-in-java.html) 翻译： [ImportNew.com](http://www.importnew.com/)- [唐小娟](http://www.importnew.com/author/tangxiaojuan)
译文链接： [http://www.importnew.com/7099.html](http://www.importnew.com/7099.html)](https://so.csdn.net/so/search/s.do?q=hashcode&t=blog)](https://so.csdn.net/so/search/s.do?q=hashmap&t=blog)](https://so.csdn.net/so/search/s.do?q=Java&t=blog)
