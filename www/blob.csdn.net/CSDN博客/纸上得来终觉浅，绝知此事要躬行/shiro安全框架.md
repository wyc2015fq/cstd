# shiro安全框架 - 纸上得来终觉浅，绝知此事要躬行 - CSDN博客





2012年11月28日 10:28:03[boonya](https://me.csdn.net/boonya)阅读数：15853
...
图
 1. 整体架构
![图 1. 整体架构](http://www.ibm.com/developerworks/cn/opensource/os-cn-shiro/image001.jpg)
...
图
 2. 安全模型
![图 2. 安全模型](http://www.ibm.com/developerworks/cn/opensource/os-cn-shiro/image002.jpg)
...
图
 3. 关键类
![图 3. 关键类](http://www.ibm.com/developerworks/cn/opensource/os-cn-shiro/image003.jpg)
...
![图 4. CredentialsMatcher 的作用](http://www.ibm.com/developerworks/cn/opensource/os-cn-shiro/image004.jpg)
...
![图 5. PermissionResolver 和 Permission 的关系](http://www.ibm.com/developerworks/cn/opensource/os-cn-shiro/image005.jpg)
...
图
 6. JdbcRealm 的继承链
![图 6. JdbcRealm 的继承链](http://www.ibm.com/developerworks/cn/opensource/os-cn-shiro/image006.jpg)
...
图
 7. Filter 的作用
![图 7. Filter 的作用](http://www.ibm.com/developerworks/cn/opensource/os-cn-shiro/image007.jpg)
...
图
 8. 配置关系
![图 8. 配置关系](http://www.ibm.com/developerworks/cn/opensource/os-cn-shiro/image008.jpg)
...
- 
直接到 J-security 的网站上 [下
 载](http://sourceforge.net/projects/jsecurity/files/jsecurity/0.9.0/)，本文用到的就是这个；
- 
...
图
 9 程序执行的流程
![图 9 程序执行的流程](http://www.ibm.com/developerworks/cn/opensource/os-cn-shiro/image009.jpg)
...
清单
 3. 在 web.xml 加入 SecurityFilter 的内容：
...
使用步骤如下：
- 
安装 Shiro Plugin，在你的 grails 项目中运行：`grails install-plugin shiro`， 会创建 grails-app/realms 目录，并提供如下新的
 Grails 命令：
...
- 
下面进行 Shiro 快速入门。在 grails 项目的目录下执行：`grails quick-start`，这个命令会创 建如下内容：
- 
...
如下是经常使用到的 Tag：
- [principal](http://c/Documents%20and%20Settings/ada/.grails/1.1.2/plugins/grails-shiro-1.0.1/docs/gapi/grails-app/taglib/ShiroTagLib.html#principal)，
 输出当前用户的标识
- 
hasRole，判断当前用户是否属于给定的角色，参数：name
- 
hasPermission, 判断当前用户是否具有指定的权限，参数：type，action 或者 permission
- [isLoggedIn](http://c/Documents%20and%20Settings/ada/.grails/1.1.2/plugins/grails-shiro-1.0.1/docs/gapi/grails-app/taglib/ShiroTagLib.html#isLoggedIn)，
 判断当前用户是否已经登录
- 
...
[下载本文中的示例代码](http://www.ibm.com/developerworks/apps/download/index.jsp?contentid=478167&filename=shirossc.rar&method=http&locale=zh_CN)
