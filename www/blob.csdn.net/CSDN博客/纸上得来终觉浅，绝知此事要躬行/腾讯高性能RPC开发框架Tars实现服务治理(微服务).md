# 腾讯高性能RPC开发框架Tars实现服务治理(微服务) - 纸上得来终觉浅，绝知此事要躬行 - CSDN博客





2017年05月21日 18:11:56[boonya](https://me.csdn.net/boonya)阅读数：8421
...
Github：[https://github.com/Tencent/Tars](https://github.com/Tencent/Tars)
...
![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars.png)
...
![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_tuopu.png)
...
![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_jiaohu.png)
...
![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_web_system.png)
...
![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_server_client.png)
...
![tarsproto](https://github.com/Tencent/Tars/raw/master/docs/images/tars_tarsproto.png)
...
![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_junheng.png)

## 4.4. 容错保护

容错保护通过两种方式实现：名字服务排除和Client主动屏蔽。

![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_rongcuo.png)
...
![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_overload.png)

## 4.6. 消息染色

框架提供了对某服务某接口的特定请求进行染色的能力，染色的消息可以透传到后面需要访问的所有服务上，对染色的请求，服务自动把日志上报到特定的染色日志服务器上，使用者只需在染色服务器上即可分析请求访问的路径，方便跟踪定位问题。如下：

![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_dye.png)

## 4.7. IDC分组

为了加快服务间的访问速度，建设跨地区、跨机房调用带来的网络资源消耗，减少网络故障带来的影响，框架提供了跨地区、跨机房，就近接入的功能。

![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_idc.png)
...
![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_set.png)
...
![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_stat.png)

2.提供了用户自定义属性数据上报的功能，方便用户查看服务的某些纬度或者指标，比如内存使用情况、队列大小、cache命中率等；

![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_property.png)

3.提供了服务状态变更和异常信息上报的功能，方便用户查看服务的何时发布过、重启过、宕过以及遇到的异常致命错误等；

![tars](https://github.com/Tencent/Tars/raw/master/docs/images/tars_notify.png)
