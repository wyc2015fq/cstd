...
# 史上最全设计模式导学目录（完整版） - wangzhiguo9261的博客 - CSDN博客


2018年02月07日 16:34:45[码里偷闲王果果](https://me.csdn.net/wangzhiguo9261)阅读数：81个人分类：[设计模式](https://blog.csdn.net/wangzhiguo9261/article/category/7413323)
...
祝大家**圣诞节快乐**！![微笑](http://static.blog.csdn.net/xheditor/xheditor_emot/default/smile.gif)**花絮：本文的工作量大大超过之前的估计，****几乎****整个平安夜都花在它身上了，**![大笑](http://static.blog.csdn.net/xheditor/xheditor_emot/default/laugh.gif)
**基础知识**
**设计模式概述**
...
多人联机射击游戏
[多人联机射击游戏中的设计模式应用（一）](http://blog.csdn.net/lovelion/article/details/8262987)：抽象工厂模式，建造者模式，工厂方法模式，迭代器模式，命令模式[多人联机射击游戏中的设计模式应用（二）](http://blog.csdn.net/lovelion/article/details/8263025)：观察者模式，单例模式，状态模式，适配器模式

数据库同步系统
[设计模式综合实例分析之数据库同步系统（一）](http://blog.csdn.net/lovelion/article/details/8671196)：数据库同步系统概述，建造者模式，简单工厂模式[设计模式综合实例分析之数据库同步系统（二）](http://blog.csdn.net/lovelion/article/details/8671578)：享元模式，单例模式，观察者模式，模板方法模式
[设计模式综合实例分析之数据库同步系统（三）](http://blog.csdn.net/lovelion/article/details/8671653)：策略模式，组合模式，命令模式，职责链模式

**友情提示：****请尊重作者劳动成果，如需转载本博客文章请注明出处！谢谢合作！**![微笑](http://static.blog.csdn.net/xheditor/xheditor_emot/default/smile.gif)
