# [答案V0.1版]精选微软等数据结构+算法面试100题 [前20题] - 结构之法 算法之道 - CSDN博客





2010年11月05日 22:01:00[v_JULY_v](https://me.csdn.net/v_JULY_v)阅读数：11195
...
[[整理]精选微软等数据结构+算法面试100题](http://topic.csdn.net/u/20101023/20/5652ccd7-d510-4c10-9671-307a56006e6d.html)
...
4: 51//push 5,min=p->[3]=1     ^
3: 11//push 1,min=p->[3]=1     |  //此刻push进A的元素1小于B中栈顶元素2
2: 42//push 4,min=p->[0]=2     |
1: 62//push 6,min=p->[0]=2     |
0: 22//push 2,min=p->[0]=2     |
...
然后，pop栈A中元素，51462
     A       B->更新 
4:  511//pop 5,min=p->[3]=1      |
3:  112//pop 1,min=p->[0]=2      |
2:  422//pop 4,min=p->[0]=2      |
1:  622//pop 6,min=p->[0]=2      |
0:  22    NULL //pop 2,min=NULL          v
...
[http://zhedahht.blog.163.com/blog/#m=0](http://zhedahht.blog.163.com/blog/#m=0)
...
intNumberTB::getFrequecy(intnum)  //此处的num即指上排的数 i
{  
intcount=0;  
...
structBTreeNode//a node in the binary tree
{
int         m_nValue;//value of node
...
[http://blog.sina.com.cn/s/blog_5e3ab00c0100lya2.html](http://blog.sina.com.cn/s/blog_5e3ab00c0100lya2.html)
