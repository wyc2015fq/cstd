# 编程艺术第十六~第二十章：全排列/跳台阶/奇偶调序，及一致性Hash算法 - 结构之法 算法之道 - CSDN博客





2011年10月17日 00:00:25[v_JULY_v](https://me.csdn.net/v_JULY_v)阅读数：62591标签：[算法																[编程																[cache																[object																[permutation																[服务器](https://so.csdn.net/so/search/s.do?q=服务器&t=blog)
个人分类：[11.TAOPP（编程艺术）																[12.TAOPP string																[19.TAOPP algorithms																[13.TAOPP array](https://blog.csdn.net/v_JULY_v/article/category/823516)
所属专栏：[程序员编程艺术](https://blog.csdn.net/column/details/taopp.html)](https://blog.csdn.net/v_JULY_v/article/category/823518)
...
    同时，本文会在解答去年微软面试100题的部分题目时，尽量结合今年最近各大IT公司最新的面试题来讲解，两相对比，彼此对照，相信你会更加赞同我上面的话。且本文也不奢望读者能从中学到什么高深技术之类的东西，只求读者看此文看着**舒服**便可**，**通顺流畅以致一口气读完而无任何压力。ok，有任何问题，欢迎不吝指正。谢谢。
...
    分析：此题最初整理于去年的微软面试100题中第53题，第二次整理于[微软、Google等公司非常好的面试题及解答[第61-70题]](http://blog.csdn.net/v_JULY_v/archive/2011/04/10/6313257.aspx) 第67题。无独有偶，这个问题今年又出现于今年的2011.10.09百度笔试题中。ok，接下来，咱们先好好分析这个问题。
...
    分析：在[](http://blog.csdn.net/v_july_v/article/details/6803368)[九月腾讯，创新工场，淘宝等公司最新面试十三题](http://blog.csdn.net/v_july_v/article/details/6803368)中第23题又出现了这个问题，题目描述如下：23、人人笔试1：一个人上台阶可以一次上1个，2个，或者3个，问这个人上n层的台阶，总共有几种走法？咱们先撇开这个人人笔试的问题（其实差别就在于人人笔试题中多了一次可以跳三级的情况而已），先来看这个第27题。
...
- 同时，有朋友指出对于这个台阶问题只需求幂就可以了（求复数幂C++库里有），不用任何循环且复杂度为O（1），如下图所示，是否真如此?：![](http://hi.csdn.net/attachment/201110/16/0_1318784720p4Ag.gif)
...
分析：
- 你当然可以从头扫描这个数组，每碰到一个偶数时，拿出这个数字，并把位于这个数字后面的所有数字往前挪动一位。挪完之后在数组的末尾有一个空位，这时把该偶数放入这个空位。由于碰到一个偶数，需要移动O(n)个数字，只是这种方法总的时间复杂度是O(n２)，不符合要求，pass。
...
[view plain](http://blog.csdn.net/v_JULY_v/article/details/6347454#)
...
- 以上部分代码思路有参考自此博客：[http://zhedahht.blog.163.com/blog/](http://zhedahht.blog.163.com/blog/)。特此注明下。     
- 上文第五部分来源：[http://blog.csdn.net/sparkliang/article/details/5279393](http://blog.csdn.net/sparkliang/article/details/5279393)；

- 行文仓促，若有任何问题或漏洞，欢迎不吝指正或赐教。谢谢。转载，请注明出处。完。](https://blog.csdn.net/v_JULY_v/article/category/823515)](https://blog.csdn.net/v_JULY_v/article/category/784066)](https://so.csdn.net/so/search/s.do?q=permutation&t=blog)](https://so.csdn.net/so/search/s.do?q=object&t=blog)](https://so.csdn.net/so/search/s.do?q=cache&t=blog)](https://so.csdn.net/so/search/s.do?q=编程&t=blog)](https://so.csdn.net/so/search/s.do?q=算法&t=blog)
