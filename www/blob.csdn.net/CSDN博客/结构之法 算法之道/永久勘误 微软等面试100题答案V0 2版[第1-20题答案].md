# 永久勘误:微软等面试100题答案V0.2版[第1-20题答案] - 结构之法 算法之道 - CSDN博客





2011年01月10日 11:05:00[v_JULY_v](https://me.csdn.net/v_JULY_v)阅读数：88910
...
**2.设计包含min函数的栈。**定义栈的数据结构，要求添加一个min函数，能够得到栈的最小元素。
...
**第4题，**当访问到某一结点时，把该结点添加到路径上，并累加当前结点的值。
...
**5.查找最小的k个元素**题目：输入n个整数，输出其中最小的k个。
...
---------------------
第5题，更多，请看：
[**程序员面试题狂想曲：第三章、寻找最小的k个数、updated 10次**](http://blog.csdn.net/v_JULY_v/archive/2011/04/28/6370650.aspx)。
...
**第10题，单词翻转。**//单词翻转，引用自117 楼 wocaoqwer 的回复。
...
**第16题**题目：输入一颗二元树，从上往下按层打印树的每个结点，同一层中按照从左往右的顺序打印。
例如输入
...
**第18题：**题目：n个数字（0,1,…,n-1）形成一个圆圈，从数字0开始，
...
- [**答案修正与优化[第1-10题]**](http://blog.csdn.net/v_JULY_v/archive/2011/03/25/6278484.aspx)
- [**答案修正与优化[第11-20题]**](http://blog.csdn.net/v_JULY_v/archive/2011/04/04/6301244.aspx)
