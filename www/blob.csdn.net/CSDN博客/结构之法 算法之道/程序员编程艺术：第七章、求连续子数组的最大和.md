# 程序员编程艺术：第七章、求连续子数组的最大和 - 结构之法 算法之道 - CSDN博客





2011年05月25日 09:30:00[v_JULY_v](https://me.csdn.net/v_JULY_v)阅读数：72248
...
前奏
- 希望更多的人能和我一样，把本狂想曲系列中的任何一道面试题当做一道简单的编程题或一个实质性的问题来看待，在阅读本狂想曲系列的过程中，希望你能尽量暂时放下所有有关面试的一切包袱，潜心攻克每一道“编程题”，在解决编程题的过程中，好好享受编程带来的无限乐趣，与思考带来的无限激情。--By [**@July_____**](http://weibo.com/julyweibo)。
- 原狂想曲系列已更名为：[**程序员编程艺术系列**](http://blog.csdn.net/v_JULY_v/category/784066.aspx)。原狂想曲创作组更名为编程艺术室。编程艺术室致力于以下三点工作：1、针对一个问题，不断寻找更高效的算法，并予以编程实现。2、解决实际中会碰到的应用问题，如[**第十章、如何给10^7个数据量的磁盘文件排序**](http://blog.csdn.net/v_JULY_v/archive/2011/05/28/6451990.aspx)。3、经典算法的研究与实现。总体突出一点：编程，如何高效的编程解决实际问题。欢迎有志者加入。
