...
2017年03月12日 01:46:41[Eastmount](https://me.csdn.net/Eastmount)阅读数：3162
...
        比如执行下列SQL语句：
`insert task (depid) VALUES('1067105002');`        输出结果如下所示：
...
[MySQL INSERT插入条件判断：如果不存在则插入](https://my.oschina.net/jsan/blog/270161/)
        同时，强烈推荐大家阅读"老紫竹"老师的数据库博客，参考：
...
(By:Eastmount 2017-03-12 晚上1点[http://blog.csdn.net//eastmount/](http://blog.csdn.net//eastmount/) )
