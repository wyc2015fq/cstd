# 打印机控制命令行 - sandro_zhang的专栏 - CSDN博客
2011年11月30日 10:52:27[sandro_zhang](https://me.csdn.net/sandro_zhang)阅读数：4340
在CMD中输入rundll32 printui.dll,PrintUIEntry 即可得到如下用法和示例：
```
