# 【算法题】训练部队 - xiaxzhou的博客 - CSDN博客





2017年05月28日 11:13:49[xiaxzhou](https://me.csdn.net/xiaxzhou)阅读数：303
...
int main()
{
    ...
    long long add(0);
    long long a_1(0), b_1(0);
    long long a_2(0), b_2(0);
    long long zhan, qian;
    ...
    cout << max(a_1+b_1+add,a_2+b_2+add-(b_2-a_2));
