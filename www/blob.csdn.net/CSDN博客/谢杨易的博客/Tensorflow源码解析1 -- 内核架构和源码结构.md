...
# Tensorflow源码解析1 -- 内核架构和源码结构 - 谢杨易的博客 - CSDN博客

置顶2018年11月15日 14:20:51[谢杨易](https://me.csdn.net/u013510838)阅读数：3100
...
![](https://img.alicdn.com/tfs/TB1cTE.pxjaK1RjSZFAXXbdLFXa-1080-693.png)
...
![](https://img.alicdn.com/tfs/TB19glXpG6qK1RjSZFmXXX0PFXa-339-302.png)
整个框架以C API为界，分为前端和后端两大部分。
前端：提供编程模型，多语言的接口支持，比如Python Java C++等。通过C API建立前后端的连接，后面详细讲解。
后端：提供运行环境，完成计算图的执行。进一步分为4层运行时：分为分布式运行时和本地运行时，负责计算图的接收，构造，编排等。
...
![](https://img.alicdn.com/tfs/TB1NMs.pCrqK1RjSZK9XXXyypXa-300-103.png)
3 前端多语言实现 - swig包装器
...
![](https://img.alicdn.com/tfs/TB1KiVFpH2pK1RjSZFsXXaNlXXa-1340-1440.png)
4 tensorflow 源码结构
TensorFlow源码基本也是按照框架分层来组织文件的。如下
![](https://img.alicdn.com/tfs/TB1gbpnpQPoK1RjSZKbXXX1IXXa-1442-996.png)
其中core为tf的核心，它的源码结构如下
![](https://img.alicdn.com/tfs/TB1mM4spFzqK1RjSZFoXXbfcXXa-1150-730.png)
5 总结
