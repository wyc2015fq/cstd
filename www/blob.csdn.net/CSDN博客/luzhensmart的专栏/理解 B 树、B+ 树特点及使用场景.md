...
# 理解 B 树、B+ 树特点及使用场景 - luzhensmart的专栏 - CSDN博客


2019年03月17日 15:08:05[芦震](https://me.csdn.net/luzhensmart)阅读数：12
...
子树，P[M]指向关键字大于K[M-1]的子树，其它P[i]指向关键字属于(K[[i-1](https://www.baidu.com/s?wd=i-1&tn=24004469_oem_dg&rsv_dl=gh_pl_sl_csd)], K[i])的子树；
如：（**M=3**）
![](https://p-blog.csdn.net/images/p_blog_csdn_net/manesking/4.JPG)
看着概念可能有点难理解，来看看图对比下平衡二叉树和 B 树。
## 对比平衡二叉树和 B 树
首先是节点，**平衡二叉树**的节点如下图所示，每个节点有一个数据和最多两个子树：
![](https://img-blog.csdn.net/20180529000150258?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTEyNDA4Nzc=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
B 树中的每个节点由两部分组成：
关键字（可以理解为数据）
指向孩子节点的指针
B 树的节点如下图所示，每个节点可以有不只一个数据，同时拥有**数据数加一**个子树，同时每个节点左子树的数据比当前节点都小、右子树的数据都比当前节点的数据大：
![](https://img-blog.csdn.net/20180529000218771?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTEyNDA4Nzc=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
所有的叶子结点都位于同一层
用一张图对比平衡二叉树和 B 树：
![](https://img-blog.csdn.net/20180529000253349?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTEyNDA4Nzc=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
![](https://img-blog.csdn.net/20180529000417324?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTEyNDA4Nzc=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
建议放大图查看。
...
![](https://img-blog.csdn.net/20180529000447408?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTEyNDA4Nzc=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)拆为-->![](https://img-blog.csdn.net/20180529000514223?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTEyNDA4Nzc=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
![](https://img-blog.csdn.net/20180529000552857?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTEyNDA4Nzc=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
![](https://img-blog.csdn.net/20180529000628693?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTEyNDA4Nzc=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
再添加元素也是类似的逻辑：
...
![](https://img-blog.csdn.net/20180529000735623?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTEyNDA4Nzc=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
