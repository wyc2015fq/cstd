# Java static关键字以及Java静态变量和静态方法 - 右上角同学的专栏 - CSDN博客
2016年07月05日 17:10:33[右上角徐](https://me.csdn.net/u011032983)阅读数：1464
文章转自：https://zm8.sm-tc.cn/?src=http%3A%2F%2Fwww.weixueyuan.net%2Fview%2F6003.html&uid=fa02d55aa569691b10f4503c69ca9748&hid=9ef94188d4ef3c6260f29e9774217126&pos=3&cid=9&time=1467708772610&from=click&restype=1&pagetype=0000004000000402&bu=structure_web_info&query=java+static+void+main%E5%87%BD%E6%95%B0%E9%87%8C%E9%87%8C%E8%83%BD%E6%93%8D%E4%BD%9C%E5%A4%96%E9%83%A8%E9%9D%9Estatic%E9%9D%99%E6%80%81%E5%8F%98%E5%90%97&mode=&uc_param_str=dnntnwvepffrgibijbprsvdsei
...
上面的代码中，i 是静态变量，通过 obj1 改变 i 的值，会影响到 obj2；j 是实例变量，通过 obj1 改变 j 的值，不会影响到 obj2。这是因为 obj1.i 和 obj2.i 指向同一个内存空间，而 obj1.j
 和 obj2.j 指向不同的内存空间，请看下图：
![](http://cdn8.sm-img5.com/?src=l4uLj8XQ0IiIiNGImpaHipqGip6R0ZGai9CKj5OQnpuM0J6Tk5aSmNDOys%2FOz8zQx9LOys%2FOz8zPxsrJz83LzMbRj5GY&restype=3&from=derive&pi=&v=1)
图1  静态变量内存分配
...
一般我们导入类都这样写：import packageName.className;  // 导入某个特定的类或import packageName.*;  // 导入包中的所有类
而静态导入可以这样写：import static packageName.className.methonName;  // 导入某个特定的静态方法或import static packageName.className.*;  // 导入类中的所有静态成员
...
请看下面的代码：import static java.lang.System.*;
