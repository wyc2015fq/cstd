# NAT技术基本原理与应用 - aiaiai010101的博客 - CSDN博客

2018年11月26日 15:59:41[aiaiai010101](https://me.csdn.net/aiaiai010101)阅读数：54
...
转载自：http://www.cnblogs.com/derrick/p/4052401.html?utm_source=tuicool&utm_medium=referral#undefined
...
![clip_image002](https://images0.cnblogs.com/blog/337581/201410/261726025908105.jpg)
...
![clip_image003](https://images0.cnblogs.com/blog/337581/201410/261726034803434.jpg)
...
![clip_image005](https://images0.cnblogs.com/blog/337581/201410/261726043554533.jpg)

### 1.2.1静态NAT

通过手动设置，使 Internet 客户进行的通信能够映射到某个特定的私有[网络](http://www.chinaitpower.com/Net/index.html)地址和端口。如果想让连接在 Internet 上的计算机能够使用某个私有[网络](http://www.chinaitpower.com/Net/index.html)上的[服务器](http://www.chinaitpower.com/System/Server/index.html)（如网站[服务器](http://www.chinaitpower.com/System/Server/index.html)）以及应用[程序](http://www.chinaitpower.com/Dev/index.html)（如游戏），那么静态映射是必需的。静态映射不会从 NAT 转换表中删除。

　　如果在 NAT 转换表中存在某个映射，那么 NAT 只是单向地从 Internet 向私有[网络](http://www.chinaitpower.com/Net/index.html)传送数据。这样，NAT 就为连接到私有[网络](http://www.chinaitpower.com/Net/index.html)部分的计算机提供了某种程度的保护。但是，如果考虑到 Internet 的安全性，NAT 就要配合全功能的防火墙一起使用。
...
![clip_image009](https://images0.cnblogs.com/blog/337581/201410/261726055901589.jpg)
...
![clip_image011](https://images0.cnblogs.com/blog/337581/201410/261726066836388.jpg) 当IP包经过NAT网关时，NAT Gateway会将IP包的源IP转换为NAT Gateway的公共IP并转发到公共网，此时IP包（Dst=202.20.65.4，Src=202.20.65.5）中已经不含任何私有网IP的信息。由于IP包的源IP已经被转换成NAT Gateway的公共IP，Web Server发出的响应IP包（Dst= 202.20.65.5,Src=202.20.65.4）将被发送到NAT Gateway。

这时，NAT Gateway会将IP包的目的IP转换成私有网中主机的IP，然后将IP包（Des=192.168.1.2，Src=202.20.65.4）转发到私有网。对于通信双方而言，这种地址的转换过程是完全透明的。转换示意图如下。
![clip_image013](https://images0.cnblogs.com/blog/337581/201410/261726094655171.jpg)
...
![clip_image015](https://images0.cnblogs.com/blog/337581/201410/261726109339156.jpg)
...
![clip_image017](https://images0.cnblogs.com/blog/337581/201410/261726128085084.jpg) 此时，NAT Gateway会在Connection Track中加入端口信息加以区分。如果两客户机访问同一服务器的源端口不同，那么在Track Table里加入端口信息即可区分，如果源端口正好相同，那么在实行SNAT和DNAT的同时对源端口也要做相应的转换，如下图所示。

![clip_image019](https://images0.cnblogs.com/blog/337581/201410/261726149658224.jpg)
...
![clip_image020](https://images0.cnblogs.com/blog/337581/201410/261726156378852.jpg)
