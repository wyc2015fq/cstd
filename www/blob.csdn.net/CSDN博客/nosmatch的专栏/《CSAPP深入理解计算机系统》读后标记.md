# 《CSAPP深入理解计算机系统》读后标记 - nosmatch的专栏 - CSDN博客
2012年05月10日 09:18:05[nosmatch](https://me.csdn.net/HDUTigerkin)阅读数：535标签：[存储																[优化																[编程																[cache																[汇编																[hierarchy](https://so.csdn.net/so/search/s.do?q=hierarchy&t=blog)](https://so.csdn.net/so/search/s.do?q=汇编&t=blog)](https://so.csdn.net/so/search/s.do?q=cache&t=blog)](https://so.csdn.net/so/search/s.do?q=编程&t=blog)](https://so.csdn.net/so/search/s.do?q=优化&t=blog)](https://so.csdn.net/so/search/s.do?q=存储&t=blog)
陆陆续续花了一个月的时间，终于看完了[CSAPP](http://book.douban.com/subject/1896753/)(Computer System：A programmer‘s perspective 注：第二版已出：[英文版](http://www.china-pub.com/197441)[中文版](http://www.china-pub.com/197167))，头一次看那么厚(900页)的原版书，看完还是有一点点成就感的。
...
**Chapter 1A Tour of Computer System**
一个对计算机系统总体的介绍，简单明了。
...
**chapter 3Machine-Level Representation of Program**
汇编语言的复习。
...
**chapter 8Exceptional Control Flow**
...
**chapter 9Measuring Program Execution Time**
