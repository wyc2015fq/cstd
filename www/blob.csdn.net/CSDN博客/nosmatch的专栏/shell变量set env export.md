# shell变量set env export - nosmatch的专栏 - CSDN博客
2011年08月11日 18:38:01[nosmatch](https://me.csdn.net/HDUTigerkin)阅读数：1022
...
五：常见的shell变量
PATH 这个变量包含了一系列由冒号分隔开的目录，系统就从这些目录里寻找可执行文件。如果你输入的可执行文件（例如ls、rc-update或者emerge）
 不在这些目录中，系统就无法执行它（除非你输入这个命令的完整路径，如/bin/ls）。  
