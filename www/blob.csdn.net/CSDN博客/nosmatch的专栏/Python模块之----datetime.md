# Python模块之----datetime - nosmatch的专栏 - CSDN博客
2011年08月17日 14:35:06[nosmatch](https://me.csdn.net/HDUTigerkin)阅读数：673标签：[python																[date																[calendar																[2010																[immutable																[import](https://so.csdn.net/so/search/s.do?q=import&t=blog)](https://so.csdn.net/so/search/s.do?q=immutable&t=blog)](https://so.csdn.net/so/search/s.do?q=2010&t=blog)](https://so.csdn.net/so/search/s.do?q=calendar&t=blog)](https://so.csdn.net/so/search/s.do?q=date&t=blog)](https://so.csdn.net/so/search/s.do?q=python&t=blog)
...
----
# tm: 23:46:10
# hour: 23, minute: 46, second: 10, microsecond:
 0 
# tm1: 20:46:10
# isoformat(): 23:46:10
```
...
# utcnow(): 2010-04-07 01:48:16.234000
 # 中国位于+8时间，与本地时间相差8 
...
%%: %% => %
    使用例子：
[](link.php?url=http://blog.csdn.net%2FJGood%2Farchive%2F2010%2F04%2F07%2F5457284.aspx)
```
dt 
= datetime.now()
