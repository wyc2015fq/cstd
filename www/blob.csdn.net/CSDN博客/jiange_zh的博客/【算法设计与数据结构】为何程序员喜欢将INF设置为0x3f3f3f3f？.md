...
# 【算法设计与数据结构】为何程序员喜欢将INF设置为0x3f3f3f3f？ - jiange_zh的博客 - CSDN博客


2015年12月06日 20:53:46[jiange_zh](https://me.csdn.net/jiange_zh)阅读数：13820
...
`if (d[u]+w[u][v]<d[v]) d[v]=d[u]+w[u][v];`如果u,v之间没有边，那么w[u][v]=INF，如果我们的INF取0x7fffffff，那么d[u]+w[u][v]会溢出而变成负数，我们的松弛操作便出错了！
