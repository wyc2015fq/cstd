# Qt 下快速读写Excel指南 - fanyun的博客 - CSDN博客
2018年03月25日 22:16:17[老樊Lu码](https://me.csdn.net/fanyun_01)阅读数：368
...
大家以后读取excel时（win下），不用考虑别的方法，用`QAxObject`就行，速度杠杠的，慢是你操作有误！下面就说说如何能提高其读取效率。
# 读取excel慢的原因
...
对于如下如的excel：
![这里写图片描述](https://img-blog.csdn.net/20160804175451390)
读取后的`QList<QList<QVariant> >`结构如下所示：
![这里写图片描述](https://img-blog.csdn.net/20160804174250619)
继续展开
![这里写图片描述](https://img-blog.csdn.net/20160804174259744)
下面看看此excel的读取速度有多高 
...
# 源代码
![这里写图片描述](https://img-blog.csdn.net/20160804175212076)
[–> 见 github](https://github.com/czyt1988/czyBlog/tree/master/tech/fastReadExcel)
版权声明：本文为博主原创文章，未经博主允许不得转载。 https://blog.csdn.net/czyt1988/article/details/52121360
