# GitHub上Top20个 Python 语言机器学习项目 - fanyun的博客 - CSDN博客
2018年12月31日 17:56:01[老樊Lu码](https://me.csdn.net/fanyun_01)阅读数：48
个人分类：[IT																[Python](https://blog.csdn.net/fanyun_01/article/category/7407442)](https://blog.csdn.net/fanyun_01/article/category/6065088)
## 1. Scikit-learn
www.github.com/scikit-learn/scikit-learn
Scikit-learn 是基于Scipy为机器学习建造的的一个[Python](http://codecloud.net/?s=Python)模块，他的特色就是多样化的分类，回归和聚类的算法包括支持向量机，逻辑回归，朴素贝叶斯分类器，随机森林，Gradient Boosting，聚类算法和DBSCAN。而且也设计出了Python numerical和scientific libraries Numpy and Scipy
## 2.Pylearn2
...
Pybrain是基于[Python语言](http://codecloud.net/?s=Python)强化学习，人工智能，神经网络库的简称。 它的目标是提供灵活、容易使用并且强大的机器学习算法和进行各种各样的预定义的环境中测试来比较你的算法。
## 6.Pattern
...
Bob是一个免费的信号处理和机器学习的工具。它的工具箱是用[Python](http://codecloud.net/?s=Python)和C++语言共同编写的，它的设计目的是变得更加高效并且减少开发时间，它是由处理图像工具,音频和视频处理、机器学习和模式识别的大量软件包构成的。
## 9.Skdata
...
Ramp是一个在[Python语言](http://codecloud.net/?s=Python)下制定机器学习中加快原型设计的解决方案的库程序。他是一个轻型的pandas-based机器学习中可插入的框架，它现存的Python语言下的机器学习和统计工具（比如scikit-learn,rpy2等）Ramp提供了一个简单的声明性语法探索功能从而能够快速有效地实施算法和转换。
## 17.Feature Forge
...
本文转载自:[http://codecloud.net/top2o-python-on-github-4546.html](http://codecloud.net/top2o-python-on-github-4546.html)
