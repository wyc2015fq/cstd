# http协议详解 - fanyun的博客 - CSDN博客
2017年03月31日 12:38:11[老樊Lu码](https://me.csdn.net/fanyun_01)阅读数：564标签：[C++](https://so.csdn.net/so/search/s.do?q=C++&t=blog)
个人分类：[C++](https://blog.csdn.net/fanyun_01/article/category/6102444)
所属专栏：[C/C++/C#开发实战365](https://blog.csdn.net/column/details/c-plus-plus-01.html)

 概述：
       HTTP协议（HyperTextTransfer Protocol，超文本传输协议）是用于从WWW服务器传输超文本到本地浏览器的传送协议。
**1.1 HTTP协议简介：**
...
HTTP协议通常承载于TCP协议之上，有时也承载于TLS或SSL协议层之上，这个时候，就成了我们常说的HTTPS，默认HTTP的端口号为80，HTTPS的端口号为443。如下图1-1所示：
![](https://img-blog.csdn.net/20160928181906540?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
                          图1-1  HTTP在TCP/IP协议栈中的位置
**1.3 HTTP的请求响应模型：**
HTTP协议永远都是客户端发起请求，服务器回送响应。见下图1-2所示：
![](https://img-blog.csdn.net/20160928182013198?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
                                       图 1-2 HTTP请求模型
...
![](https://img-blog.csdn.net/20160928182138763?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
图1 设置Capture选项
       一般读者只需要选择最上边的下拉框，选择合适的Device，而后点击“Capture Filter”，此处选择的是“HTTP TCP port（80）”，选择后点击上图的“Start”开始抓包。
![](https://img-blog.csdn.net/20160928182336875?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
图2 选择Capture Filter
例如在浏览器中打开[http://image.baidu.com/](http://image.baidu.com/)，抓包如图3所示：
![](https://img-blog.csdn.net/20160928182527675?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
图3  抓包
...
![](https://img-blog.csdn.net/20160928182610176?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
图4 http请求消息
      回应的消息如图5所示：
![](https://img-blog.csdn.net/20160928182714043?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
图5 http状态响应信息
**1.6.1 host头域**
...
在图4中，Referer行的内容为：
![](https://img-blog.csdn.net/20160928182813491?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
**1.6.3 User-Agent头域**
User-Agent头域的内容包含发出请求的用户信息。
在图4中，User-Agent行的内容为：
[](http://files.jb51.net/upload/201108/20110826201313846.jpg)
