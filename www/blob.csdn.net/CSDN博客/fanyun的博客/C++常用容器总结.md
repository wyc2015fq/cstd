# C++常用容器总结 - fanyun的博客 - CSDN博客
2017年02月26日 21:13:19[老樊Lu码](https://me.csdn.net/fanyun_01)阅读数：638标签：[C++](https://so.csdn.net/so/search/s.do?q=C++&t=blog)
...
(1) vector
内部[数据结构](http://lib.csdn.net/base/datastructure)：数组。
随机访问每个元素，所需要的时间为常量。
