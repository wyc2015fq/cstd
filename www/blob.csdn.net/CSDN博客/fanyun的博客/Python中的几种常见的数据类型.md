# Python中的几种常见的数据类型 - fanyun的博客 - CSDN博客
2017年04月04日 19:29:24[老樊Lu码](https://me.csdn.net/fanyun_01)阅读数：405
所属专栏：[巧用脚本](https://blog.csdn.net/column/details/15130.html)
1.整数
[python](http://www.1jtx.com/python/)可以处理任意大小的整数，当然包括负整数，在[python](http://www.1jtx.com/python/)程序中，整数的表示方法和数学上的写法一模一样，例如：1，100，-8080，0，等等。
