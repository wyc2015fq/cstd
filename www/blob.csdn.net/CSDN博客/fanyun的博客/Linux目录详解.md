# Linux目录详解 - fanyun的博客 - CSDN博客
2016年04月08日 11:21:50[老樊Lu码](https://me.csdn.net/fanyun_01)阅读数：855
所属专栏：[Linux系统开发维护实战](https://blog.csdn.net/column/details/linux-01.html)
Linux目录和Windows目录有着很大的不同，Linux目录类似一个树，最顶层是其根目录，如下图：
![](https://img-blog.csdn.net/20160412142652325?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
![](https://img-blog.csdn.net/20160412142730622?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
**/bin **二进制可执行命令
**/dev**设备特殊文件
**/etc **系统管理和配置文件
**/etc/rc.d**启动的配置文件和脚本
