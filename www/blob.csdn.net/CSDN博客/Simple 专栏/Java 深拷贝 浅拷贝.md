# Java 深拷贝/浅拷贝 - Simple 专栏 - CSDN博客
2012年01月15日 17:28:18[Simple_Zz](https://me.csdn.net/love284969214)阅读数：916标签：[java																[java基础																[java面试](https://so.csdn.net/so/search/s.do?q=java面试&t=blog)](https://so.csdn.net/so/search/s.do?q=java基础&t=blog)](https://so.csdn.net/so/search/s.do?q=java&t=blog)
...
![](http://hi.csdn.net/attachment/201202/27/0_13303512963l30.gif)
对于Asian对象有：
- Chinese a1 = new Asian("yellow",new Person("李四","mam",23)); 
- Chinese a2 = new Asian(a1);
- New Asian(a1)执行Asian类的拷贝构造方法，由于对象赋值是引用赋值。
- 使得a1和a2引用同一个对象如下图：
![](http://hi.csdn.net/attachment/201202/27/0_133035141375ZL.gif)
当a1执行某条可以改变该值的语句时，那么a1将会通过这个语句也可以改变a2对象的成员变量
如果执行以下语句：a2.name = new Person(a1.name)
这时将会创建一个新的Person对象如下图：
![](http://hi.csdn.net/attachment/201202/27/0_1330351465s7F7.gif)
