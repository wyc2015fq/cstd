...
# 大数据开发初学者学习路线 - Magician的博客 - CSDN博客


2017年12月27日 14:24:33[春雨里de太阳](https://me.csdn.net/qq_16633405)阅读数：5339所属专栏：[自学大数据之路](https://blog.csdn.net/column/details/18514.html)


[目录](#目录)[前言](#前言)
[导读：](#导读)
[第一章：初识Hadoop](#第一章初识hadoop)
[第二章：更高效的WordCount](#第二章更高效的wordcount)
[第三章：把别处的数据搞到Hadoop上](#第三章把别处的数据搞到hadoop上)
[第四章：把Hadoop上的数据搞到别处去](#第四章把hadoop上的数据搞到别处去)
[第五章：快一点吧，我的SQL](#第五章快一点吧我的sql)
[第六章：一夫多妻制](#第六章一夫多妻制)
[第七章：越来越多的分析任务](#第七章越来越多的分析任务)
[第八章：我的数据要实时](#第八章我的数据要实时)
[第十章：牛逼高大上的机器学习](#第十章牛逼高大上的机器学习)


# 目录
最近看到一篇很不错的文章，献给正在学习大数据的你我他。如果能答出文章中大部分问题，那么恭喜你已经从“小白”进化到“小菜鸟”的阶段。
转自：[http://www.ppvke.com/Blog/archives/50967](http://www.ppvke.com/Blog/archives/50967)
## 前言
...
此时，你的”大数据平台”是这样的：
![这里写图片描述](https://img-blog.csdn.net/20171227141238761?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvcXFfMTY2MzM0MDU=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
![这里写图片描述](https://img-blog.csdn.net/20171227141335351?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvcXFfMTY2MzM0MDU=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
## 第四章：把Hadoop上的数据搞到别处去
...
同3.5.
如果你认真完成了上面的学习和实践，此时，你的”大数据平台”应该是这样的：
![这里写图片描述](https://img-blog.csdn.net/20171227141424178?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvcXFfMTY2MzM0MDU=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
[http://lxw1234.com/archives/category/spark](http://lxw1234.com/archives/category/spark)
如果你认真完成了上面的学习和实践，此时，你的”大数据平台”应该是这样的：
![这里写图片描述](https://img-blog.csdn.net/20171227141510969?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvcXFfMTY2MzM0MDU=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
## 第六章：一夫多妻制
...
如果你认真完成了上面的学习和实践，此时，你的”大数据平台”应该是这样的：
![这里写图片描述](https://img-blog.csdn.net/20171227141628596?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvcXFfMTY2MzM0MDU=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
Zeus：
[https://github.com/alibaba/zeus](https://github.com/alibaba/zeus)
等等……
另外，我这边是之前单独开发的任务调度与监控系统，具体请参考《大数据平台任务调度与监控系统》.
如果你认真完成了上面的学习和实践，此时，你的”大数据平台”应该是这样的：![这里写图片描述](https://img-blog.csdn.net/20171227141710695?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvcXFfMTY2MzM0MDU=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
## 第八章：我的数据要实时
...
如果你认真完成了上面的学习和实践，此时，你的”大数据平台”应该是这样的：
![这里写图片描述](https://img-blog.csdn.net/20171227141744998?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvcXFfMTY2MzM0MDU=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
如果你已经掌握了如何很好的对外（业务）提供数据，那么你的“大数据平台”应该是这样的：![这里写图片描述](https://img-blog.csdn.net/20171227141829153?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvcXFfMTY2MzM0MDU=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
## 第十章：牛逼高大上的机器学习
...
![这里写图片描述](https://img-blog.csdn.net/20171227141907176?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvcXFfMTY2MzM0MDU=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
End.
