...
示例二：
```
xcopy C:\tomcat\webapps\cas.server.web H:\u\cas\ /d:5-1-2017 /c /y /s
pause
```
=============================================================
