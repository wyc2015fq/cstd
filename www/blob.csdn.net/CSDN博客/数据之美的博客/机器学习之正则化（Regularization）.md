# 机器学习之正则化（Regularization） - 数据之美的博客 - CSDN博客
2017年06月29日 23:38:05[看穿数据之美](https://me.csdn.net/oppo62258801)阅读数：278
...
![image](http://images.cnitblog.com/blog/663864/201411/081950152375432.png)
之前，我们看到了线性回归情况下的过拟合。类似的情况也适用于逻辑回归。
### 3
那么，如果发生了过拟合问题，我们应该如何处理？
过多的变量（特征），同时只有非常少的训练数据，会导致出现过度拟合的问题。因此为了解决过度拟合，有以下两个办法。
![image](http://images.cnitblog.com/blog/663864/201411/081950339879703.png)
> 
方法一：尽量减少选取变量的数量
...
## 2. Cost Function
![image](http://images.cnitblog.com/blog/663864/201411/081950460499853.png)
### 1
...
![image](http://images.cnitblog.com/blog/663864/201411/081950538152248.png)
这里我的意思就是，上图的式子是我们的优化目标，也就是说我们需要尽量减少代价函数的均方误差。
对于这个函数我们对它添加一些项，加上 1000 乘以 θ3 的平方，再加上 1000 乘以 θ4 的平方，
![image](http://images.cnitblog.com/blog/663864/201411/081951047539138.png)
1000 只是我随便写的某个较大的数字而已。现在，如果我们要最小化这个函数，那么为了最小化这个新的代价函数，我们要让 θ3 和 θ4 尽可能小。因为，如果你在原有代价函数的基础上加上 1000 乘以 θ3 这一项 ，那么这个新的代价函数将变得很大，所以，当我们最小化这个新的代价函数时，
 我们将使 θ3 的值接近于 0，同样 θ4 的值也接近于 0，就像我们忽略了这两个值一样。如果我们做到这一点（ θ3 和 θ4 接近 0 ），那么我们将得到一个近似的二次函数。
![image](http://images.cnitblog.com/blog/663864/201411/081951300032292.png)
因此，我们最终恰当地拟合了数据，我们所使用的正是二次函数加上一些非常小，贡献很小项（因为这些项的 θ3、 θ4 非常接近于0）。显然，这是一个更好的假设。
### 2
![image](http://images.cnitblog.com/blog/663864/201411/081951588935799.png)
...
![image](http://images.cnitblog.com/blog/663864/201411/081952152064015.png)
...
![image](http://images.cnitblog.com/blog/663864/201411/081952330495431.png)
下面的这项就是一个正则化项
![image](http://images.cnitblog.com/blog/663864/201411/081952345967158.png)
并且 λ 在这里我们称做正则化参数。
> 
...
### 3
![image](http://images.cnitblog.com/blog/663864/201411/081953140499371.png)
在正则化线性回归中，如果正则化参数值 λ 被设定为非常大，那么将会发生什么呢？
我们将会非常大地惩罚参数θ1 θ2 θ3 θ4 … 也就是说，我们最终惩罚θ1 θ2 θ3 θ4 … 
 在一个非常大的程度，那么我们会使所有这些参数接近于零。
![image](http://images.cnitblog.com/blog/663864/201411/081953465963762.png)
...
![image](http://images.cnitblog.com/blog/663864/201411/081953557536697.png)
对于线性回归(的求解)，我们之前运用了两种学习算法，一种基于梯度下降，一种基于正规方程。
### 1
梯度下降，如下：
![image](http://images.cnitblog.com/blog/663864/201411/081954274561745.png)
### 2
正规方程，如下：
![image](http://images.cnitblog.com/blog/663864/201411/081954443152563.png)
### 3
![image](http://images.cnitblog.com/blog/663864/201411/081954592215008.png)
...
![image](http://images.cnitblog.com/blog/663864/201411/081955014244135.png)
...
![image](http://images.cnitblog.com/blog/663864/201411/081955311908741.png)
同样使用梯度下降：
![image](http://images.cnitblog.com/blog/663864/201411/081955489245956.png)
如果在高级优化算法中，使用正则化技术的话，那么对于这类算法我们需要自己定义costFunction。
> 
For those methods what we needed to do was to define the function that's called the cost function.[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)
![image](http://images.cnitblog.com/blog/663864/201411/081957037373100.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)[](http://images.cnitblog.com/blog/663864/201411/081956161909993.png)
