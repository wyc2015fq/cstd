# 深度学习 基于R-CNN的物体检测 - 数据之美的博客 - CSDN博客
2017年06月17日 10:30:22[看穿数据之美](https://me.csdn.net/oppo62258801)阅读数：404
**基于R-CNN的物体检测**
**原文地址：**[http://blog.csdn.net/hjimce/article/details/50187029](http://blog.csdn.net/hjimce/article/details/50187029)
**作者：**hjimce
**一、相关理论**
本篇博文主要讲解2014年CVPR上的经典paper：《Rich feature hierarchies for Accurate Object Detection and
 Segmentation》，这篇文章的[算法](http://lib.csdn.net/base/datastructure)思想又被称之为：R-CNN（Regions with Convolutional Neural Network Features），是物体检测领域曾经获得state-of-art精度的经典文献。
   这篇paper的思想，改变了物体检测的总思路，现在好多文献关于[深度学习](http://lib.csdn.net/base/deeplearning)的物体检测的算法，基本上都是继承了这个思想，比如：《Spatial
 Pyramid Pooling in Deep Convolutional Networks for Visual Recognition》，所以学习经典算法，有助于我们以后搞物体检测的其它paper。
