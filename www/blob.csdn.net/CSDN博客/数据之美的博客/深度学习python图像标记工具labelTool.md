# 深度学习python图像标记工具labelTool - 数据之美的博客 - CSDN博客
2017年04月10日 16:49:58[看穿数据之美](https://me.csdn.net/oppo62258801)阅读数：2528
[深度学习](http://lib.csdn.net/base/deeplearning)训练需要标记图像位置和类别，之前用的时候是叫做BBox-Label-Tool-master，遇到大图像就显示不完整了，没有自适应缩放，
 这是改进后的[Python](http://lib.csdn.net/base/python)脚本。
目录结构：图片目录名images, 标签目录名labels，图像目录下各类别目录名要以001,002,003,...的格式命名。
![](https://img-blog.csdn.net/20160913094215813?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
![](https://img-blog.csdn.net/20160913094418580?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
这是运行labelTool ( python main.py)时的截屏，图像框记录的是比例值，
快捷键a,d前后切换图像，esc取消当前框
![](https://img-blog.csdn.net/20160913093513287?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
python脚本main.py:
**[python]**[view
 plain](http://blog.csdn.net/wuzuyu365/article/details/52523061#)[copy](http://blog.csdn.net/wuzuyu365/article/details/52523061#)
![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1878425/fork)
- # -*- coding:utf-8 -*-
- #-------------------------------------------------------------------------------
...
- ifnot os.path.exists(self.outDir):  
...
- self.saveImage()  
- ifself.cur < self.total:  
- self.cur += 1
- self.loadImage()  
- 
- def gotoImage(self):  
-         idx = int(self.idxEntry.get())  
- if1 <= idx and idx <= self.total:  
- self.saveImage()  
- self.cur = idx  
- self.loadImage()  
- 
