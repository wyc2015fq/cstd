# hbase hbck - 数据之美的博客 - CSDN博客
2018年11月19日 14:18:22[看穿数据之美](https://me.csdn.net/oppo62258801)阅读数：88
```
hbase hbck是hbase自带的一项肥肠实用的工具，很多hbase中出现的问题都可以尝试用hbase hbck修复。
