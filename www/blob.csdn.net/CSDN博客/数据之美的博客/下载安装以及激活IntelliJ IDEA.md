# 下载安装以及激活IntelliJ IDEA - 数据之美的博客 - CSDN博客
2018年06月03日 14:22:24[看穿数据之美](https://me.csdn.net/oppo62258801)阅读数：147
1.下载java安装包jdk，http://www.oracle.com/technetwork/java/javase/downloads/index.html，安装过程一直点击下一步即可完成安装
2.下载IntelliJ IDEA，https://www.jetbrains.com/idea/download/#section=mac，选择相应的操作系统即可下载，安装过程一直点击下一步即可完成安装
3.自动启动IntelliJ IDEA时会弹出激活的界面，此时有三种激活方式，我选择active code方式激活。
激活方式按照如下的步骤：
a.找到文件 /etc/hosts ，打开，在最后一行输入  0.0.0.0 account.jetbrains.com
b.在active code下面的输入框里面输入下面的激活码，点击 active，即可激活成功
...
另外一种激活方式可去 [http://idea.lanyus.com/](http://idea.lanyus.com/) 生成激活码
maven下载及安装流程
下载：
...
2.配置文件
```
MAVEN_HOME=/usr/xxx/maven-3.3.9    //解压maven的路径
  PATH=$MAVEN_HOME/bin:$PATH 
  export MAVEN_HOME
  export PATH
```
2.source .**.bash_profile  配置文件生效**
下载安装以及激活过程完成！
