# Ubuntu16.04的Python virtualenv问题 - 数据之美的博客 - CSDN博客
2017年12月18日 00:01:19[看穿数据之美](https://me.csdn.net/oppo62258801)阅读数：122
...
## 问题解决办法
- 
首先检查python环境，Ubuntu16.04默认使用的Python2.7.11
- 
然后仔细查了一下Ubuntu16.04安装包，发现Ubuntu16.04带了两个版本的的virtualenv：
...
- 
重新安装python-virtualenv包，如果检查已经安装了virtualenv 和 python3-virtualenv，那么先卸载这两个包，然后安装。
`sudo apt-get install python-virtualenv`- 1
- 
创建virtual env 
...
`python -m virtualenv myenv`- 1
> 
转载请以链接形式标明本文链接 
本文链接：[http://blog.csdn.net/kongxx/article/details/51858153](http://blog.csdn.net/kongxx/article/details/51858153)
