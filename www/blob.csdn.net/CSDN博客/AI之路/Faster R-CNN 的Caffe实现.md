# Faster R-CNN 的Caffe实现 - AI之路 - CSDN博客





2017年05月24日 19:49:21[AI之路](https://me.csdn.net/u014380165)阅读数：16216
...
**解决：**很明显是找不到text_format，所以在/py-faster-rcnn/tools/下面找到对应的train_****.py。比如你是用faster rcnn的交替训练，那么打开train_faster_rcnn_alt_opt.py，在开头添加一句：`import google.protobuf.text_format`。然后再运行`./experiments/scripts/faster_rcnn_alt_opt.sh 0 ZF pascal_voc` 就可以成功运行了，如下图：
