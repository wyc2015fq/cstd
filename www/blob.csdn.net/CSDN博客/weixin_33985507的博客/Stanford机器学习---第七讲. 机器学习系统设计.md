# Stanford机器学习---第七讲. 机器学习系统设计 - weixin_33985507的博客 - CSDN博客
2015年06月24日 21:18:00[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：3
本栏目（Machine learning）包括单参数的线性回归、多参数的线性回归、Octave Tutorial、Logistic Regression、Regularization、神经网络、机器学习系统设计、SVM（Support Vector Machines 支持向量机）、聚类、降维、异常检测、大规模机器学习等章节。所有内容均来自Standford公开课machine learning中Andrew老师的讲解。（[https://class.coursera.org/ml/class/index](https://class.coursera.org/ml/class/index)）
...
![](https://img-my.csdn.net/uploads/201208/06/1344221595_7877.png)
...
![](https://img-my.csdn.net/uploads/201208/06/1344221628_8812.png)
...
![](https://img-my.csdn.net/uploads/201208/06/1344222395_5558.png)
===============================
**（二）、**Error分析
...
- 利用画[learning curves](http://blog.csdn.net/abcjennifer/article/details/7797502)的方法去探究，数据集更多 或者 加入更多features 是否有利于系统工作；
...
如下图所示：
![](https://img-my.csdn.net/uploads/201208/06/1344224597_7318.png)
...
![](https://img-my.csdn.net/uploads/201208/06/1344225165_9614.png)
===============================
**（三）、**对Skewed Classes建立Error Metrics
...
![](https://img-my.csdn.net/uploads/201208/06/1344228190_4576.png)
也可参考我原来[关于ROC曲线的文章](http://blog.csdn.net/abcjennifer/article/details/7359370)。
...
![](https://img-my.csdn.net/uploads/201208/06/1344229771_1587.png)
由于TP=0, 所以precision=recall=0！证明了该算法的un-avaliable！
所以，无论一个类是否是Skewed Classes，只要满足precision 和 recall都很高才可以保证该算法的实用性。
练习题，做下看：
![](https://img-my.csdn.net/uploads/201208/06/1344229877_6028.png)
...
![](https://img-my.csdn.net/uploads/201208/06/1344233395_7783.png)
这里存在一个threshold=0.5。
根据
![](https://img-my.csdn.net/uploads/201208/06/1344233820_1001.png)
不同的threshold有如下两类情况：
...
![](https://img-my.csdn.net/uploads/201208/06/1344233930_8612.png)
...
![](https://img-my.csdn.net/uploads/201208/06/1344234229_8698.png)
...
![](https://img-my.csdn.net/uploads/201208/06/1344234475_3823.png)
当p=0 或 r=0时，有f=0;
当p=1&&r=1时，有f=1，最大；
...
练习，做下吧~（这道略弱）：
![](https://img-my.csdn.net/uploads/201208/06/1344234722_3677.png)
===============================
**（五）、机器学习数据选定**
对于机器学习，我们可以选择很多不同的algorithems进行prediction，如：
![](https://img-my.csdn.net/uploads/201208/06/1344235765_4070.png)
...
记得上一讲中我们已经介绍过了[bias和variance的定义和区别](http://blog.csdn.net/abcjennifer/article/details/7797502)，这里我们来看，他们的产生环境：
...
如下图所示：
![](https://img-my.csdn.net/uploads/201208/06/1344236254_8495.png)
综上所述，对数据及进行rational分析的结果是两条：
首先，x中有足够多的feature，以得到low bias;
其次，有足够大的training set，以得到low variance；
练习题：
![](https://img-my.csdn.net/uploads/201208/06/1344236622_2972.png)
