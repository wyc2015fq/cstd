# python 参数传递总结 - weixin_33985507的博客 - CSDN博客
2018年12月25日 16:38:00[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：4
## 参数的传递
...
...     print "p3==>",p3
... 
>>> foo("python",1,["hiekay","github","io"])    #一一对应地赋值
p1==> python
p2==> 1
p3==> ['hiekay', 'github', 'io']
>>> foo("python")
...
...     print args
... 
>>> foo("hiekay.github.io") #以tuple形式接收到，哪怕是一个
('hiekay.github.io',)
