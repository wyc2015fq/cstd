# 解决Ubuntu下Sublime Text 3无法输入中文 - weixin_33985507的博客 - CSDN博客
2016年11月12日 17:24:00[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：3
## 前言
sublime很好用，但是ubuntu下不能输入中文，这是一个很大的问题。不知道为什么开发着一直也不解决，好在还是有高手在，总能找到方法。网上方法很多，但是也很乱，现在我将自己的经验总结一下。
首先，我参考了好几篇文章，都是蛮不错的，先列出来：
- [sublime-text-imfix](https://github.com/lyfeyaj/sublime-text-imfix):首先推荐这个方法，最简单，但是在我的系统上有些问题。**可用这个的强烈推荐用这个**
- [完美解决 Linux 下 Sublime Text 中文输入](https://www.sinosky.org/linux-sublime-text-fcitx.html)：讲的比较明白，也可用参考。
- [Ubuntu下Sublime Text 3解决无法输入中文的方法](http://jingyan.baidu.com/article/f3ad7d0ff8731609c3345b3b.html): 讲解的最清楚了，建议看看。
## 我的方法
1.下载我们需要的文件，打开终端，输入：
```bash
