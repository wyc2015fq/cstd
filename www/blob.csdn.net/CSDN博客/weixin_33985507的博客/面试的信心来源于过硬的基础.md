# 面试的信心来源于过硬的基础 - weixin_33985507的博客 - CSDN博客
2018年03月06日 13:25:24[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：2
...
@ 宋体      SimSun
    ...
    body { font-family: Microsoft Yahei,SimSun,Helvetica; } 复制代码
```
```
## 9、可能用到的meta标签
```xml
