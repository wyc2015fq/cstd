# html/css基础篇——GET和POST的区别 - weixin_33985507的博客 - CSDN博客
2016年01月29日 15:34:00[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：7
　　本文前面部分转自[木-叶的博文](http://www.cnblogs.com/nankezhishi/archive/2012/06/09/getandpost.html)，后面有本人自己的一些总结和体会。
...
     “知之为知之，不知为不知，是知也。”
### 　　上面文章是转载的，最后说一点get和post的一点差异吧。
　　首先在使用上，还是严格遵守
GET - 从指定的服务器中获取数据
　　POST - 提交数据给指定的服务器处理
　　然后说说他们的一些差别：
GET　
- GET查询字符串（键值对）被附加在URL地址后面一起发送到服务器
- GET请求能够被缓存
- GET请求会保存在浏览器的浏览记录中
- 以GET请求的URL能够保存为浏览器书签
POST
- POST查询字符串被放在POST信息中的一个单独地方和HTTP请求一起发送到服务器.
- POST请求不能被缓存下来
- POST请求不会保存在浏览器浏览记录中
...
![](https://images2015.cnblogs.com/blog/831429/201601/831429-20160129161753458-2131354254.png)![](https://images2015.cnblogs.com/blog/831429/201601/831429-20160129162139427-766206574.png)
