# Vue-cli3项目处理包括（i18n/font-spider/xss/wangeditor） - weixin_33985507的博客 - CSDN博客
2018年10月28日 23:05:10[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：1
...
- 
vue首屏渲染方案
- [https://juejin.im/post/5a9ca4...](https://juejin.im/post/5a9ca40b6fb9a028b77a4aac)
...
- 处理时删除有bug,解决方案已经提在[https://github.com/wangfupeng...](https://github.com/wangfupeng1988/wangEditor/issues/1749)
- 
xss处理
- xss.js处理xss,生成白名单过滤所有非白名单标签，会转化成文本输出入如<会转化为<等；也可定制标签中属性，非对应属性会清空，主要处理对应富文本
- 无论请求亦或回显渲染都需过滤
- 
