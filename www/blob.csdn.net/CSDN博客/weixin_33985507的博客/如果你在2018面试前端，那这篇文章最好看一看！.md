# 如果你在2018面试前端，那这篇文章最好看一看！ - weixin_33985507的博客 - CSDN博客
2018年09月10日 01:22:54[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：1
[github版本戳,求star,follow](https://github.com/qianbin01/frontend_train)
### 前端目录
- [HTML相关](#html)
- [CSS相关](#css)
...
新标签：
![h5新元素](https://image-static.segmentfault.com/106/953/1069532331-5b95e5c3c4fed_articlex)
##### 2 meta viewport相关
```
...
##### animation
![](https://image-static.segmentfault.com/889/309/889309352-5b95e5c393e2d_articlex)
##### 长宽比方案
- 使用padding方式结合calc实现
...
性能优化图
![性能优化](https://image-static.segmentfault.com/481/185/481185627-5b95e5c3bb7a0_articlex)
##### 20 for 中setTimeOut
要为循环题创建不同的循环副本
##### 21 sort函数
V8 引擎 sort 函数只给出了两种排序 InsertionSort 和 QuickSort，数量小于10的数组使用 插入，比10大的数组则使用 快排。
##### 22 navigator
![Navigator](https://image-static.segmentfault.com/127/731/1277310912-5b95e5c3af7ba_articlex)
##### 23 jquery绑定方式
- click后者覆盖
- bind后者覆盖
- on(jquery>=1.7)
...
如下图
![区别图](https://image-static.segmentfault.com/158/041/158041892-59526c132881b_articlex)
...
##### GET POST区别
![get_post](https://image-static.segmentfault.com/113/514/1135149981-5b95e5c3939fe_articlex)
##### 请求行，请求头，请求体详解
![如图](https://image-static.segmentfault.com/279/942/279942626-5ac0fb6ecd53b_articlex)
1,2,3请求行，4请求体，5请求体
##### 跨域、JSONP 、CORS、postMessage
跨域概念解释：当前发起请求的域与该请求指向的资源所在的域不一样。这里的域指的是这样的一个概念：我们认为若协议 + 域名 + 端口号均相同，那么就是同域。
如下表
![图](https://image-static.segmentfault.com/359/094/359094746-5b95e5c3647b4_articlex)
jsoup实现
```java
原生
<script>
...
##### 生命周期顺序
![生命周期](https://image-static.segmentfault.com/209/609/2096098274-59a598af6eed2_articlex)
##### 组件通信
...
##### 各种排序实现
相关数据
![表格](https://image-static.segmentfault.com/111/042/1110429154-5b95e5c371df7_articlex)
```java
...
- DNS解析
先本地缓存找，在一层层找
将常见的地址解析成唯一对应的ip地址基本顺序为：本地域名服务器->根域名服务器->com顶级域名服务器依次类推下去,找到后记录并缓存下来如www.google.com为
...
![](https://image-static.segmentfault.com/582/949/582949384-5b95e5c3692d8_articlex)
