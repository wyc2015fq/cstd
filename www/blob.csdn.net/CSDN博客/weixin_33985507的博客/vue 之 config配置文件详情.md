# vue 之 config配置文件详情 - weixin_33985507的博客 - CSDN博客
2018年11月13日 10:59:00[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：76
        本文章来自转载，主要讲解了vue-cli下的config配置相关文件。（涉及到较复杂的解释将通过标识的方式(如（1）)将解释写到单独的注释模块，）
```
...
```
> 
本文转自[qz奔跑的马](https://www.cnblogs.com/ye-hcj/)# [vue-cli脚手架config目录下index.js配置文件详解](https://www.cnblogs.com/ye-hcj/p/7077796.html)
不要被任何人打乱你的脚步，因为没有人和你一样清楚和在乎自己的梦想。
