# HTTPS的七个误解(转载) - weixin_33985507的博客 - CSDN博客
2011年02月14日 11:06:00[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：2
# HTTPS的七个误解
开发网页的时候，往往需要观察HTTP通信。
我使用的工具主要有两个，在Firefox中是Firebug，在IE中是Fiddler。但是，一直听别人说，付费软件HttpWatch是这方面最好的工具。
![clip_image001](http://articles.csdn.net/uploads/allimg/110214/093ZTU1-0.gif)
前几天，HttpWatch的官方网志刊登了一篇好文章，澄清了一些HTTPS协议容易产生误解的地方。学习之后，我增长了不少网页加密通信的知识。
我觉得这篇文章很实用，值得留作参考，就翻译了出来。
==============================================
**HTTPS****的七个误解**
译者：阮一峰
![clip_image002](http://articles.csdn.net/uploads/allimg/110214/093ZS429-1.jpg)
**误解七：HTTPS无法缓存**
...
![clip_image003](http://articles.csdn.net/uploads/allimg/110214/093ZR315-2.gif)
**误解六：SSL证书很贵**
...
![clip_image004](http://articles.csdn.net/uploads/allimg/110214/093ZQ631-3.gif)
...
![clip_image005](http://articles.csdn.net/uploads/allimg/110214/093ZWC9-4.gif)
...
![clip_image006](http://articles.csdn.net/uploads/allimg/110214/093ZU303-5.gif)
第一次打开网页的时候，HTTPS协议会比HTTP协议慢一点，这是因为读取和验证SSL证书的时间。下面是一张HTTP网页打开时间的瀑布图。
![clip_image007](http://articles.csdn.net/uploads/allimg/110214/093ZW044-6.gif)
同一张网页使用HTTPS协议之后，打开时间变长了。
![clip_image008](http://articles.csdn.net/uploads/allimg/110214/093ZR431-7.gif)
建立连接的部分，大约慢了10%。但是，一旦有效的HTTPS连接建立起来，再刷新网页，两种协议几乎没有区别。先是HTTP协议的刷新表现：
![clip_image009](http://articles.csdn.net/uploads/allimg/110214/093ZR142-8.gif)
然后是HTTPS协议：
![clip_image010](http://articles.csdn.net/uploads/allimg/110214/093ZUZ4-9.gif)
...
![clip_image011](http://articles.csdn.net/uploads/allimg/110214/093ZQ0S-10.gif)
...
![clip_image012](http://articles.csdn.net/uploads/allimg/110214/093ZW1D-11.gif)
也就是说，这些cookie是在HTTPS环境下建立的，但是却在HTTP环境下传输。如果有人劫持到这些cookie，那他就能以你的身份在Twitter上发言了。
原文链接：[Top 7 Myths about HTTPS Myth #7 – HTTPS Never Caches](http://blog.httpwatch.com/2011/01/28/top-7-myths-about-https/)
译文链接：[HTTPS的七个误解](http://www.ruanyifeng.com/blog/2011/02/seven_myths_about_https.html)
