# live555 源码分析：MediaSever - weixin_33985507的博客 - CSDN博客
2017年08月31日 15:04:00[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：12
...
- 创建 `TaskScheduler` 用于执行任务调度。关于 `TaskScheduler` 的更详细信息可以参考 [live555 源码分析：基础设施](https://www.jianshu.com/p/199048a9c959)。
- 创建 `UsageEnvironment` 用于日志输出等 I/O 操作。关于 `UsageEnvironment` 的更详细信息可以参考 [live555 源码分析：基础设施](https://www.jianshu.com/p/199048a9c959)。
- 创建 `RTSPServer` 用于接受连接、处理请求等。这里会首先尝试使用 554 端口，如果失败，就尝试使用 8554 端口，如果两个端口都没法用，就失败退出程序。
- 为 `RTSPServer` 设置 HTTP 隧道端口。这里会依次尝试使用 80、8000 和 8080 端口。
- 执行事件循环。
...
![1315506-791dcd5f2574c420.png](https://upload-images.jianshu.io/upload_images/1315506-791dcd5f2574c420.png)
...
- 通过 `accept()` 获得新建立的连接的 socket。
- 设置新 socket 的选项，使它称为非阻塞 socket，并增大该 socket 的发送缓冲区。可以看一下在 live555 中设置 socket 选项的这些函数，它们在 groupsock 模块中定义：
```
...
```
- 通过 `createNewClientConnection()`，创建一个新的客户端连接 `ClientConnection`。`createNewClientConnection()` 是一个纯虚函数，它的实现将在类继承层次中实现了该函数的类中层次最低的那个类里，对于
...
![1315506-25767662578513fe.png](https://upload-images.jianshu.io/upload_images/1315506-25767662578513fe.png)
...
# live555 源码分析系列文章
[live555 源码分析：简介](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/08/28/live555_src_analysis_introduction/)
[live555 源码分析：基础设施](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/08/30/live555_src_analysis_infrasture/)
[live555 源码分析：MediaSever](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/08/31/live555_src_analysis_mediaserver/)
[Wireshark 抓包分析 RTSP/RTP/RTCP 基本工作过程](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/09/01/live555_src_analysis_rtsp_rtp_rtcp_wireshark/)
[live555 源码分析：RTSPServer](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/09/03/live555_src_analysis_rtspserver/)
[live555 源码分析： DESCRIBE 的处理](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/09/04/live555_src_analysis_describe/)
[live555 源码分析： SETUP 的处理](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/09/05/live555_src_analysis_setup/)
[live555 源码分析： PLAY 的处理](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/09/05/live555_src_analysis_play/)
[live555 源码分析：RTSPServer 组件结构](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/09/06/live555_src_analysis_rtspserver_arch/)
[live555 源码分析：ServerMediaSession](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/09/07/live555_src_analysis_servermediasession/)
[live555 源码分析：子会话 SDP 行生成](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/09/07/live555_src_analysis_subsession_sdp/)
[live555 源码分析：子会话 SETUP](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/09/08/live555_src_analysis_subsession_setup/)
[live555 源码分析：播放启动](https://link.jianshu.com?t=https://www.wolfcstech.com/2017/09/08/live555_src_analysis_start_streaming/)
