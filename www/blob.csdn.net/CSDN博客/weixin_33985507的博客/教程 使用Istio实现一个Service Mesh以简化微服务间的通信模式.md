# 教程|使用Istio实现一个Service Mesh以简化微服务间的通信模式 - weixin_33985507的博客 - CSDN博客
2018年09月05日 04:08:27[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：2
> 
本文为译文，英文原文地址：[kublr.com/blog/implem…](https://link.juejin.im?target=https%3A%2F%2Fkublr.com%2Fblog%2Fimplementing-a-service-mesh-with-istio-to-simplify-microservices-communication%2F)
本文转载自：[www.servicemesher.com/blog/hands-…](https://link.juejin.im?target=http%3A%2F%2Fwww.servicemesher.com%2Fblog%2Fhands-on-canary-deployments-with-istio-and-kubernetes%2F)
更多 Service Mesh 文章请访问：[www.servicemesher.com](https://link.juejin.im?target=http%3A%2F%2Fwww.servicemesher.com)
本文为该教程的第1部分。
...
您可以在[官方文档](https://link.juejin.im?target=https%3A%2F%2Fistio.io%2Fzh%2Fdocs%2Fconcepts%2Fwhat-is-istio%2F)中阅读更多内容，但是出于本教程的目的，以下是Istio组件及其功能的摘要：
**控制平面**
...
对于本教程，我们假设您正在运行Kubernetes集群（提示：您可以在几分钟内[遵循这些说明](https://link.juejin.im?target=https%3A%2F%2Fkublr.com%2Fblog%2Fhow-to-install-a-single-master-kubernetes-k8s-cluster%2F)或启动新集群，或者使用“[Kublr-in-a-box](https://link.juejin.im?target=https%3A%2F%2Fkublr.com%2Fdemo%2F)”通过几个简单的步骤设置本地群集)。对于本教程，有1个主节点和2个工作节点的小型集群应该足够了。
##### 教程第1阶段：安装Istio控制平面
...
复制代码
```
另一种安装方式是[使用Kublr安装你的kubernetes集群环境](https://link.juejin.im?target=https%3A%2F%2Fkublr.com%2Fdemo%2F)——一个简单的方法是通过云提供商([阿里云](https://link.juejin.im?target=https%3A%2F%2Fcn.aliyun.com%2Fproduct%2Fkubernetes%3Fspm%3D5176.8142029.cloudEssentials.10.54216d3elxa6Yg)、[腾讯云](https://link.juejin.im?target=https%3A%2F%2Fcloud.tencent.com%2Fproduct%2Ftke)、[aws](https://link.juejin.im?target=https%3A%2F%2Fus-west-2.console.aws.amazon.com%2Feks%2Fhome%3Fregion%3Dus-west-2%23%2Fhome)、[azure](https://link.juejin.im?target=https%3A%2F%2Fazure.microsoft.com%2Fzh-cn%2Fservices%2Fkubernetes-service%2F)、[gcp](https://link.juejin.im?target=https%3A%2F%2Fcloud.google.com%2Fkubernetes-engine%2F)或者[quick start](https://link.juejin.im?target=https%3A%2F%2Fdocs.kublr.com%2Fquickstart%2F)）上拉起一个kubernetes集群。 [kublr](https://link.juejin.im?target=https%3A%2F%2Fdocs.kublr.com%2Fquickstart%2F)。
...
现在我们添加针对此pod的Envoy代理配置到这个文件中。使用“[istioctl kube-inject](https://link.juejin.im?target=https%3A%2F%2Fistio.io%2Fdocs%2Freference%2Fcommands%2Fistioctl.html%23istioctl%2520kube-inject)”命令，它将生成一个可供kubectl部署使用包含Envoy代理额外组件的新yaml文件，运行命令：
```bash
...
在我们的下一篇文章中，[与Istio一起实践的金丝雀部署](https://link.juejin.im?target=https%3A%2F%2Fkublr.com%2Fblog%2Fhands-on-canary-deployments-with-istio-and-kubernetes%2F)，我们将自定义http头路由请求到正确的服务版本。通过这样做，我们将完全控制流量，并将分析Zipkin仪表板中的分布式追踪结果。
Istio的部署十分依赖Kubernetes，为了大家更好的理解 Kubernetes 原理，我推荐学习**[深入剖析Kubernetes by 张磊，极客时间出品](https://link.juejin.im?target=https%3A%2F%2Fjimmysong.io%2Fposts%2Fkubernetes-tutorial-recommendation%2F)**。
## ServiceMesher社区信息
微信群：[联系我入群](https://link.juejin.im?target=http%3A%2F%2Fwww.servicemesher.com%2Fcontact%2F)
社区官网：[www.servicemesher.com](https://link.juejin.im/?target=https%3A%2F%2Flink.juejin.im%3Ftarget%3Dhttps%253A%252F%252Flink.juejin.im%253Ftarget%253Dhttps%25253A%25252F%25252Flink.juejin.im%25253Ftarget%25253Dhttps%2525253A%2525252F%2525252Flink.juejin.im%2525253Ftarget%2525253Dhttps%252525253A%252525252F%252525252Flink.juejin.im%252525253Ftarget%252525253Dhttps%25252525253A%25252525252F%25252525252Flink.juejin.im%25252525253Ftarget%25252525253Dhttps%2525252525253A%2525252525252F%2525252525252Flink.juejin.im%2525252525253Ftarget%2525252525253Dhttps%252525252525253A%252525252525252F%252525252525252Flink.juejin.im%252525252525253Ftarget%252525252525253Dhttps%25252525252525253A%25252525252525252F%25252525252525252Flink.juejin.im%25252525252525253Ftarget%25252525252525253Dhttp%2525252525252525253A%2525252525252525252F%2525252525252525252Fwww.servicemesher.com%2525252525252525252F)
Slack：[servicemesher.slack.com](https://link.juejin.im/?target=https%3A%2F%2Flink.juejin.im%3Ftarget%3Dhttps%253A%252F%252Flink.juejin.im%253Ftarget%253Dhttps%25253A%25252F%25252Flink.juejin.im%25253Ftarget%25253Dhttps%2525253A%2525252F%2525252Flink.juejin.im%2525253Ftarget%2525253Dhttps%252525253A%252525252F%252525252Flink.juejin.im%252525253Ftarget%252525253Dhttps%25252525253A%25252525252F%25252525252Flink.juejin.im%25252525253Ftarget%25252525253Dhttps%2525252525253A%2525252525252F%2525252525252Flink.juejin.im%2525252525253Ftarget%2525252525253Dhttps%252525252525253A%252525252525252F%252525252525252Flink.juejin.im%252525252525253Ftarget%252525252525253Dhttps%25252525252525253A%25252525252525252F%25252525252525252Flink.juejin.im%25252525252525253Ftarget%25252525252525253Dhttps%2525252525252525253A%2525252525252525252F%2525252525252525252Fservicemesher.slack.com) 需要邀请才能加入
Twitter: [twitter.com/servicemesh…](https://link.juejin.im?target=https%3A%2F%2Ftwitter.com%2Fservicemesher)
GitHub：[github.com/servicemesh…](https://link.juejin.im?target=https%3A%2F%2Fgithub.com%2Fservicemesher)
