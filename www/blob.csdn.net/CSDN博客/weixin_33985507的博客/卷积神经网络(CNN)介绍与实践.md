# 卷积神经网络(CNN)介绍与实践 - weixin_33985507的博客 - CSDN博客
2018年07月19日 16:29:00[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：7
## 1 CNN的前生今世
### 1.1 大脑
作为人类，我们不断地通过眼睛来观察和分析周围的世界，我们不需要刻意的“努力”思考，就可以对所看到的一切做出预测，并对它们采取行动。当我们看到某些东西时，我们会根据我们过去学到的东西来标记每个对象。为了说明这些情况，请看下面这张图片：
![1531909-8c047d8884aa6455.png](https://upload-images.jianshu.io/upload_images/1531909-8c047d8884aa6455.png)
...
![1531909-985ecf9d00bee373.png](https://upload-images.jianshu.io/upload_images/1531909-985ecf9d00bee373.png)
...
![1531909-31d1b48636edec48.png](https://upload-images.jianshu.io/upload_images/1531909-31d1b48636edec48.png)
...
![1531909-7eda90096de63400.png](https://upload-images.jianshu.io/upload_images/1531909-7eda90096de63400.png)
...
![1531909-a743c7747d48b0f2.png](https://upload-images.jianshu.io/upload_images/1531909-a743c7747d48b0f2.png)
LeNet-5网络 示意图1
![1531909-2f884eb5cbf1a7a2.png](https://upload-images.jianshu.io/upload_images/1531909-2f884eb5cbf1a7a2.png)
LeNet-5网络 示意图2
## 2 卷积神经网络
...
CNN的概念图如下：
![1531909-563b7aaa812d960d.png](https://upload-images.jianshu.io/upload_images/1531909-563b7aaa812d960d.png)
CNN概念图1
![1531909-8d69ee9ee863756b.png](https://upload-images.jianshu.io/upload_images/1531909-8d69ee9ee863756b.png)
CNN概念图2
![1531909-e0cedbb4d09b3d1c.png](https://upload-images.jianshu.io/upload_images/1531909-e0cedbb4d09b3d1c.png)
CNN概念图3
...
![1531909-279c4912744eca3f.png](https://upload-images.jianshu.io/upload_images/1531909-279c4912744eca3f.png)
卷积运算 1
每次移动一步，我们可以一次做完整张表的计算，如下：
![1531909-8ed1594933d1bcbc.png](https://upload-images.jianshu.io/upload_images/1531909-8ed1594933d1bcbc.png)
卷积运算 2
下面的动图更好地解释了计算过程：
![1531909-9bdd5096b12aa5fd.gif](https://upload-images.jianshu.io/upload_images/1531909-9bdd5096b12aa5fd.gif)
...
![1531909-df086e2364853b15.png](https://upload-images.jianshu.io/upload_images/1531909-df086e2364853b15.png)
16种不同的Feature Detector
利用Feature Detector萃取出物体的边界
![1531909-30902a3ec368c64f.png](https://upload-images.jianshu.io/upload_images/1531909-30902a3ec368c64f.png)
利用Feature Detector萃取出物体的边界
使用Relu函数去掉负值，更能淬炼出物体的形状
![1531909-c97f50737816652a.png](https://upload-images.jianshu.io/upload_images/1531909-c97f50737816652a.png)
Relu函数去掉负值
![1531909-27526811f5eb4d99.png](https://upload-images.jianshu.io/upload_images/1531909-27526811f5eb4d99.png)
淬炼出物体的形状1
![1531909-439b4790b64ae66e.png](https://upload-images.jianshu.io/upload_images/1531909-439b4790b64ae66e.png)
淬炼出物体的形状2
...
![1531909-4063759e53c2bc5c.png](https://upload-images.jianshu.io/upload_images/1531909-4063759e53c2bc5c.png)
其他函数
这里还有一个概念就是**步长**，**Stride**是每次卷积滤波器移动的步长。步幅大小通常为1，意味着滤镜逐个像素地滑动。通过增加步幅大小，您的滤波器在输入上滑动的间隔更大，因此单元之间的重叠更少。
下面的动画显示步幅大小为1。
![1531909-659bf8ba260aa833.gif](https://upload-images.jianshu.io/upload_images/1531909-659bf8ba260aa833.gif)
步幅为1
...
![1531909-36da4908829470ff.gif](https://upload-images.jianshu.io/upload_images/1531909-36da4908829470ff.gif)
...
![1531909-f3daf861d882404f.png](https://upload-images.jianshu.io/upload_images/1531909-f3daf861d882404f.png)
池化层 示意图 1
![1531909-2d6fb7eed9d3c857.png](https://upload-images.jianshu.io/upload_images/1531909-2d6fb7eed9d3c857.png)
池化层 示意图 2
### 2.3 Fully Connected Layer 全连接层
基本上全连接层的部分就是将之前的结果平坦化之后接到最基本的神经网络了
![1531909-20b592fd47809153.png](https://upload-images.jianshu.io/upload_images/1531909-20b592fd47809153.png)

![1531909-4ecdc2dfefb56f54.png](https://upload-images.jianshu.io/upload_images/1531909-4ecdc2dfefb56f54.png)

![1531909-4bc198275647d005.png](https://upload-images.jianshu.io/upload_images/1531909-4bc198275647d005.png)
## 3 利用CNN识别MNIST手写字体
...
![1531909-af303ba39812f0cf.png](https://upload-images.jianshu.io/upload_images/1531909-af303ba39812f0cf.png)
