# JavaScript 函数式编程初窥 - weixin_33985507的博客 - CSDN博客
2017年11月25日 14:53:00[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：16
## 编程范式
...
### 不同的编程范式有不同的代码表现
![259493-4711f098366c6830.png](https://upload-images.jianshu.io/upload_images/259493-4711f098366c6830.png)
image.png
...
![259493-1e47cfb0ba627930.png](https://upload-images.jianshu.io/upload_images/259493-1e47cfb0ba627930.png)
image.png
...
### 使用不可变数据的弊端
不可变数据有更多内存开销。
![259493-21f8c722c4942358.png](https://upload-images.jianshu.io/upload_images/259493-21f8c722c4942358.png)
image.png
修改数据的情况下，直接替换了变量的值，内存开销不变。
![259493-f374a23e76fb0da3.png](https://upload-images.jianshu.io/upload_images/259493-f374a23e76fb0da3.png)
image.png
使用不可变数据后，我们复制了一个对象，内存开销翻倍。
![259493-b4b8e56fa9a41f0c.png](https://upload-images.jianshu.io/upload_images/259493-b4b8e56fa9a41f0c.png)
image.png
...
### 参考资料
- [Anjana Vakil: Learning Functional Programming with JavaScript - JSUnconf 2016](https://link.jianshu.com?t=https://www.youtube.com/watch?v=e-5obm1G_FY)
- [Anjana Vakil: Immutable data structures for functional JS - JSConf EU 2017](https://link.jianshu.com?t=https://www.youtube.com/watch?v=Wo0qiGPSV-s)
- [JavaScript 轻量级函数式编程](https://link.jianshu.com?t=https://github.com/ikcamp/Functional-Light-JS)
- [Douglas Crockford: Monads and Gonads (YUIConf Evening Keynote)](https://link.jianshu.com?t=https://www.youtube.com/watch?v=dkZFtimgAcM)
- [A Brief Intro to Functional Programming](https://link.jianshu.com?t=https://io-meter.com/2017/05/29/A-Brief-Intro-to-Functional-Programming/)
- [JavaScript 中的函数式编程](https://link.jianshu.com?t=https://vivaxyblog.github.io/2017/05/19/functional-programming-in-javascript.html)
