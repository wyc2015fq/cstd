# linux每日命令(37)：top命令 - weixin_33985507的博客 - CSDN博客
2018年12月07日 10:11:00[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：5
...
```
说明：
观察上图，服务器有2个逻辑CPU，实际上是1个物理CPU。再按数字键1，就会返回到top基本视图界面。
## 2.高亮显示当前运行进程
在top基本视图中，敲击键盘“b”（打开/关闭加亮效果）
