# 常见的web安全漏洞 - weixin_33985507的博客 - CSDN博客
2017年06月21日 16:28:00[weixin_33985507](https://me.csdn.net/weixin_33985507)阅读数：17
### 1、XSS攻击
> 
它允许恶意web用户将代码植入到提供给其它用户使用的页面中。其实在web前端方面，可以简单的理解为一种javascript代码注入,如果你的用户名称里面含有script标签的话，就可以执行其中的代码了。
![3229842-434c86a6a45f8094.png](https://upload-images.jianshu.io/upload_images/3229842-434c86a6a45f8094.png)
还可以使用ajax，将其他用户在当前域名下的cookie获取并发送到自己的服务器上。这样就可以获取他人信息了。再在各个QQ群中，散播自己的空间，引诱别人来访问。就可以拿到用户在这个域名下的cookie或者其他隐私了。
![3229842-f98f52fd4f9f6d20.png](https://upload-images.jianshu.io/upload_images/3229842-f98f52fd4f9f6d20.png)
如何防范？
最简单的办法防治办法，还是将前端输出数据都进行转义最为稳妥。
![3229842-48fa1dfd434168c5.png](https://upload-images.jianshu.io/upload_images/3229842-48fa1dfd434168c5.png)
...
## 二、防止攻击的措施总结
- 对用户输入的数据进行全面安全检查或过滤，尤其注意检查是否包含SQL 或XSS特殊字符。
- 
