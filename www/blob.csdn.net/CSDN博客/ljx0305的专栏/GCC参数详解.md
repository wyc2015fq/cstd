# GCC参数详解 - ljx0305的专栏 - CSDN博客
2008年07月17日 22:41:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：413标签：[gcc																[汇编																[编译器																[语言																[file																[文本编辑](https://so.csdn.net/so/search/s.do?q=文本编辑&t=blog)](https://so.csdn.net/so/search/s.do?q=file&t=blog)](https://so.csdn.net/so/search/s.do?q=语言&t=blog)](https://so.csdn.net/so/search/s.do?q=编译器&t=blog)](https://so.csdn.net/so/search/s.do?q=汇编&t=blog)](https://so.csdn.net/so/search/s.do?q=gcc&t=blog)
个人分类：[Linux程序及使用																[C](https://blog.csdn.net/ljx0305/article/category/394717)](https://blog.csdn.net/ljx0305/article/category/394700)
                 GCC参数详解
　　[版本]
　　-0.13
　　[声明]
...
　　-2002-08-16
　　ver 0.16 增加了gcc编译的4个阶段的命[本文来自：http://doc.linuxpk.com/3721.html](http://doc.linuxpk.com/3721.html)
[发表您的高见！](http://bbs.linuxpk.com/)
