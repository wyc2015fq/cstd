# Posix多线程编程学习笔记（二）—线程属性（1） - ljx0305的专栏 - CSDN博客
2008年08月01日 10:52:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：531
**一．线程属性<?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" />**
...
|参数：|Attr线程属性变量Detachstate线程的分离状态属性|
|返回值：|若成功返回0，若失败返回-1。|
...
|参数：|attr线程属性变量inheritsched线程的继承性|
|返回值：|若成功返回0，若失败返回-1。|
...
**引用:http://blog.chinaunix.net/u/22935/showart_341886.html**
