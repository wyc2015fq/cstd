# static_cast、dynamic_cast、reinterpret_cast、和const_cast - ljx0305的专栏 - CSDN博客
2008年06月01日 21:54:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：501标签：[class																[object																[c																[存储](https://so.csdn.net/so/search/s.do?q=存储&t=blog)](https://so.csdn.net/so/search/s.do?q=c&t=blog)](https://so.csdn.net/so/search/s.do?q=object&t=blog)](https://so.csdn.net/so/search/s.do?q=class&t=blog)
个人分类：[C++](https://blog.csdn.net/ljx0305/article/category/380566)
[static_cast、dynamic_cast、reinterpret_cast、和const_cast](http://blog.csdn.net/fisher_jiang/archive/2008/04/30/2349633.aspx)
...
转自：[http://blog.csdn.net/fisher_jiang/archive/2008/04/30/2349633.aspx](http://blog.csdn.net/fisher_jiang/archive/2008/04/30/2349633.aspx)
