# C++中的显式构造函数 - ljx0305的专栏 - CSDN博客
2008年11月09日 21:47:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：492标签：[c++																[编译器																[null																[存储																[c](https://so.csdn.net/so/search/s.do?q=c&t=blog)](https://so.csdn.net/so/search/s.do?q=存储&t=blog)](https://so.csdn.net/so/search/s.do?q=null&t=blog)](https://so.csdn.net/so/search/s.do?q=编译器&t=blog)](https://so.csdn.net/so/search/s.do?q=c++&t=blog)
...
ClxString lxTest =13; 
ClxString lxTest ='A';
引用：[http://blog.csdn.net/starlee/archive/2006/10/12/1331268.aspx](http://blog.csdn.net/starlee/archive/2006/10/12/1331268.aspx)
