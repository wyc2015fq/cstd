# RHEL AS5 通过yum update自动升级 - ljx0305的专栏 - CSDN博客
2011年12月24日 15:22:44[ljx0305](https://me.csdn.net/ljx0305)阅读数：564标签：[centos																[mozilla																[list																[linux																[工具																[search](https://so.csdn.net/so/search/s.do?q=search&t=blog)](https://so.csdn.net/so/search/s.do?q=工具&t=blog)](https://so.csdn.net/so/search/s.do?q=linux&t=blog)](https://so.csdn.net/so/search/s.do?q=list&t=blog)](https://so.csdn.net/so/search/s.do?q=mozilla&t=blog)](https://so.csdn.net/so/search/s.do?q=centos&t=blog)
...
第一种方法:
通过 
[http://mirror-status.centos.org](http://mirror-status.centos.org)
网站查找离自己最近的镜像站点，替换下面文件中的相应地址：
...
cd /etc/pki/rpm-gpg
wget 
[http://mirror.be10.com/centos/RPM-GPG-KEY-CentOS-5](http://mirror.be10.com/centos/RPM-GPG-KEY-CentOS-5)
...
引用:http://linux.chinaunix.net/techdoc/system/2008/07/18/1018380.shtml
第二种方法:
...
首先介绍一下本人的环境：RHEL5.3
华中科技大学的源： [http://centos.ustc.edu.cn/CentOS-Base.repo.5](http://centos.ustc.edu.cn/CentOS-Base.repo.5)
...
我就直接rpm了，不下载了
#rpm -ivh [http://centos.ustc.edu.cn/centos/5.3/os/i386/CentO/yum-3.2.19-18.el5.centos.noarch.rpm](http://centos.ustc.edu.cn/centos/5.3/os/i386/CentO/yum-3.2.19-18.el5.centos.noarch.rpm) –nodeps
#rpm -ivh [http://centos.ustc.edu.cn/centos/5.3/os/i386/CentOS/yum-metadata-parser-1.1.2-2.el5.i386.rpm](http://centos.ustc.edu.cn/centos/5.3/os/i386/CentOS/yum-metadata-parser-1.1.2-2.el5.i386.rpm) –nodeps
当YUM工具安装完成后，下面就可以来设置YUM的源了，目前国内最快的源，中国科技大学的算一个，至于是否选择其他的，又是一个见仁见智的问题了…
下载源配置文件：
#wget [http://centos.ustc.edu.cn/CentOS-Base.repo.5](http://centos.ustc.edu.cn/CentOS-Base.repo.5)
