# extern "C"的用法解析 - ljx0305的专栏 - CSDN博客
2008年03月11日 21:01:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：517标签：[c																[c++																[语言																[编译器																[module																[float](https://so.csdn.net/so/search/s.do?q=float&t=blog)](https://so.csdn.net/so/search/s.do?q=module&t=blog)](https://so.csdn.net/so/search/s.do?q=编译器&t=blog)](https://so.csdn.net/so/search/s.do?q=语言&t=blog)](https://so.csdn.net/so/search/s.do?q=c++&t=blog)](https://so.csdn.net/so/search/s.do?q=c&t=blog)
extern "C"的用法解析
http://blog.sina.com.cn/u/494a1ebc010004g5
C++中extern “C”含义深层探索
**1.****引言**
...
 引用:http://www.cnblogs.com/xulei/archive/2006/11/12/558139.html            
