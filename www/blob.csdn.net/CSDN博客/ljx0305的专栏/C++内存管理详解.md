# C++内存管理详解 - ljx0305的专栏 - CSDN博客
2011年04月20日 21:02:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：588标签：[c++																[null																[delete																[编译器																[initialization																[float](https://so.csdn.net/so/search/s.do?q=float&t=blog)](https://so.csdn.net/so/search/s.do?q=initialization&t=blog)](https://so.csdn.net/so/search/s.do?q=编译器&t=blog)](https://so.csdn.net/so/search/s.do?q=delete&t=blog)](https://so.csdn.net/so/search/s.do?q=null&t=blog)](https://so.csdn.net/so/search/s.do?q=c++&t=blog)
...
　　　　　示例3.3（b） 数组退化为指针
**4、指针参数是如何传递内存的？**　　如果函数的参数是一个指针，不要指望用该指针去申请动态内存。示例7-4-1中，Test函数的语句GetMemory(str, 200)并没有使str获得期望的内存，str依旧是NULL，为什么？
...
**6、有了malloc/free为什么还要new/delete？**　　malloc与free是C++/C语言的标准库函数，new/delete是C++的运算符。它们都可用于申请动态内存和释放内存。
...
　　示例7试图耗尽操作系统的内存
**8、malloc/free 的使用要点**　　函数malloc的原型如下：
...
引用：[http://www.cnblogs.com/dazhong/articles/721704.html](http://www.cnblogs.com/dazhong/articles/721704.html)
