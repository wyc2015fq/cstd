# C++中extern “C”含义深层探索 - ljx0305的专栏 - CSDN博客
2007年08月21日 17:19:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：497标签：[c++																[c																[语言																[编译器																[module																[float](https://so.csdn.net/so/search/s.do?q=float&t=blog)](https://so.csdn.net/so/search/s.do?q=module&t=blog)](https://so.csdn.net/so/search/s.do?q=编译器&t=blog)](https://so.csdn.net/so/search/s.do?q=语言&t=blog)](https://so.csdn.net/so/search/s.do?q=c&t=blog)](https://so.csdn.net/so/search/s.do?q=c++&t=blog)
...
#endif 
的作用又是什么呢？我们将在下文一一道来。
**3.深层揭密extern "C"**　　extern "C" 包含双重含义，从字面上即可得到：首先，被它修饰的目标是“extern”的；其次，被它修饰的目标是“C”的。让我们来详细解读这两重含义。
...
**4.extern "C"的惯用法**　　（1）在C++中引用C语言中的函数和变量，在包含C语言头文件（假设为cExample.h）时，需进行下列处理：
extern "C"
{
#include "cExample.h"
}
