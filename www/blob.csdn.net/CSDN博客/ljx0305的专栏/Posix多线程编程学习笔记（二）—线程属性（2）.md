# Posix多线程编程学习笔记（二）—线程属性（2） - ljx0305的专栏 - CSDN博客
2008年08月01日 10:55:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：832
**四、线程的调度策略<?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" />**
...
|参数：|attr线程属性变量param sched_param结构|
|返回值：|若成功返回0，若失败返回-1。|
...
引用:http://blog.chinaunix.net/u/22935/showart_341888.html
