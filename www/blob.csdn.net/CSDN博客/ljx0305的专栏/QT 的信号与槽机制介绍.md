# QT 的信号与槽机制介绍 - ljx0305的专栏 - CSDN博客
2011年11月24日 15:57:50[ljx0305](https://me.csdn.net/ljx0305)阅读数：492标签：[qt																[signal																[object																[class																[工具																[scroll](https://so.csdn.net/so/search/s.do?q=scroll&t=blog)](https://so.csdn.net/so/search/s.do?q=工具&t=blog)](https://so.csdn.net/so/search/s.do?q=class&t=blog)](https://so.csdn.net/so/search/s.do?q=object&t=blog)](https://so.csdn.net/so/search/s.do?q=signal&t=blog)](https://so.csdn.net/so/search/s.do?q=qt&t=blog)
个人分类：[Qt](https://blog.csdn.net/ljx0305/article/category/937304)
**QT 的信号与槽机制介绍**
QT 是一个跨平台的 C++ GUI 应用构架，它提供了丰富的窗口部件集，具有面向对象、易于扩展、真正的组件编程等特点，更为引人注目的是目前 Linux 上最为流行的 KDE 桌面环境就是建立在 QT 库的基础之上。QT 支持下列平台：MS/WINDOWS-95、98、NT 和 2000；UNIX/X11-Linux、Sun Solaris、HP-UX、Digital Unix、IBM AIX、SGI IRIX；EMBEDDED- 支持 framebuffer 的 Linux 平台。伴随着 KDE 的快速发展和普及，QT
 很可能成为 Linux 窗口平台上进行软件开发时的 GUI 首选。
概述
...
[回页首](http://www.ibm.com/developerworks/cn/linux/guitoolkit/qt/signal-slot/#ibm-pcon)
信号
...
- [KDevelop]()
关于作者
唐新华 软件工程师。Email: [xhsmart@263.net](mailto:xhsmart@263.net?cc=xhsmart@263.net)
引用:[http://www.ibm.com/developerworks/cn/linux/guitoolkit/qt/signal-slot/](http://www.ibm.com/developerworks/cn/linux/guitoolkit/qt/signal-slot/)
