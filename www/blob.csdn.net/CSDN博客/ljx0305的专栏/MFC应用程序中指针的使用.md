# MFC应用程序中指针的使用  - ljx0305的专栏 - CSDN博客
2010年03月04日 16:01:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：434标签：[mfc																[文档																[null																[class																[框架																[工具](https://so.csdn.net/so/search/s.do?q=工具&t=blog)](https://so.csdn.net/so/search/s.do?q=框架&t=blog)](https://so.csdn.net/so/search/s.do?q=class&t=blog)](https://so.csdn.net/so/search/s.do?q=null&t=blog)](https://so.csdn.net/so/search/s.do?q=文档&t=blog)](https://so.csdn.net/so/search/s.do?q=mfc&t=blog)
个人分类：[C++																[MFC](https://blog.csdn.net/ljx0305/article/category/403913)](https://blog.csdn.net/ljx0305/article/category/380566)
======================================================
     MFC应用程序中指针的使用
======================================================
      1)       在View中获得Doc指针     
