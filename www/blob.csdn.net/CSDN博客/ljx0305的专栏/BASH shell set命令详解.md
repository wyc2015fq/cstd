# BASH shell set命令详解 - ljx0305的专栏 - CSDN博客
2009年03月10日 14:29:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：1370标签：[shell																[bash																[emacs																[扩展																[任务																[脚本](https://so.csdn.net/so/search/s.do?q=脚本&t=blog)](https://so.csdn.net/so/search/s.do?q=任务&t=blog)](https://so.csdn.net/so/search/s.do?q=扩展&t=blog)](https://so.csdn.net/so/search/s.do?q=emacs&t=blog)](https://so.csdn.net/so/search/s.do?q=bash&t=blog)](https://so.csdn.net/so/search/s.do?q=shell&t=blog)
