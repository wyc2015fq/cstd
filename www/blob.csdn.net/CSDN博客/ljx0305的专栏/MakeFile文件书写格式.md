# MakeFile文件书写格式 - ljx0305的专栏 - CSDN博客
2008年02月09日 17:29:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：4297
可访问blog [http://xhbdahai.cublog.cn/](http://xhbdahai.cublog.cn/)
**跟我一起写 Makefile**
**概述******——****
...
**9****、****Yacc C****程序时的隐含规则。**“<n>.c”的依赖文件被自动推导为“n.y”（Yacc生成的文件），其生成命令是：“$(YACC) $(YFALGS)”。（“Yacc”是一个语法分析器，关于其细节请查看相关资料）
**10****、****Lex C****程序时的隐含规则。**
...
[摘要(无)](mk:@MSITStore:D:/上课/上一个班级的Linux/Linux初级/资料/跟我一起写%20Makefile.chm::/跟我一起写Makefile.htm#123456789)[备注(无)](mk:@MSITStore:D:/上课/上一个班级的Linux/Linux初级/资料/跟我一起写%20Makefile.chm::/跟我一起写Makefile.htm#123456789)[附件(无)](mk:@MSITStore:D:/上课/上一个班级的Linux/Linux初级/资料/跟我一起写%20Makefile.chm::/跟我一起写Makefile.htm#123456789)
