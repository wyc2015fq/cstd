# DLL编写教程 - ljx0305的专栏 - CSDN博客
2008年05月31日 21:54:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：604标签：[dll																[object																[api																[编译器																[语言																[null](https://so.csdn.net/so/search/s.do?q=null&t=blog)](https://so.csdn.net/so/search/s.do?q=语言&t=blog)](https://so.csdn.net/so/search/s.do?q=编译器&t=blog)](https://so.csdn.net/so/search/s.do?q=api&t=blog)](https://so.csdn.net/so/search/s.do?q=object&t=blog)](https://so.csdn.net/so/search/s.do?q=dll&t=blog)
DLL编写教程
...
引用:http://www.blogjava.net/wxb_nudt/archive/2008/05/28/144371.html#203645
