# Linux环境下的Socket编程 - ljx0305的专栏 - CSDN博客
2008年07月30日 15:51:00[ljx0305](https://me.csdn.net/ljx0305)阅读数：540标签：[socket																[linux																[struct																[服务器																[数据结构																[internet](https://so.csdn.net/so/search/s.do?q=internet&t=blog)](https://so.csdn.net/so/search/s.do?q=数据结构&t=blog)](https://so.csdn.net/so/search/s.do?q=服务器&t=blog)](https://so.csdn.net/so/search/s.do?q=struct&t=blog)](https://so.csdn.net/so/search/s.do?q=linux&t=blog)](https://so.csdn.net/so/search/s.do?q=socket&t=blog)
...
引用：[http://www.chinalinuxpub.com/read.php?wid=180](http://www.chinalinuxpub.com/read.php?wid=180)
