...
# 1.11 JavaScript2：变量、数组、字符串 - 尹成的技术博客 - CSDN博客

2018年11月09日 16:49:15[尹成](https://me.csdn.net/yincheng01)阅读数：90
...
## 字符串反转
varstr ='asdfj12jlsdkf098';
varstr2 = str.split('').reverse().join('');
alert(str2);
学院Go语言视频主页
