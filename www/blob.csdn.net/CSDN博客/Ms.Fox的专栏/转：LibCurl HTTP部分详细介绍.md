# 转：LibCurl HTTP部分详细介绍 - Ms.Fox的专栏 - CSDN博客
2017年06月18日 23:35:31[lulu-lu](https://me.csdn.net/smbluesky)阅读数：379
一、LibCurl基本编程框架
二、一些基本的函数
...
5 断点续传实例
一、LibCurl基本编程框架
[libcurl](http://curl.haxx.se/)是一个跨平台的网络协议库，支持http, https, ftp, gopher, telnet, dict, file, 和ldap 协议。libcurl同样支持HTTPS证书授权，HTTP POST, HTTP PUT, FTP 上传, HTTP基本表单上传，代理，cookies,和用户认证。想要知道更多关于libcurl的介绍，可以到官网 [http://curl.haxx.se/](http://curl.haxx.se/)上去了解，在这里不再详述。
win32版的libcurl下载地址:[http://curl.freeby.pctools.cl/download/libcurl-7.18.0-win32-msvc.zip](http://curl.freeby.pctools.cl/download/libcurl-7.18.0-win32-msvc.zip)
...
./ progress  [http://software.sky-union.cn/index.asp](http://software.sky-union.cn/index.asp)
5 断点续传实例
```
[](http://blog.csdn.net/fengshuiyue/article/details/39530093/)
...
./ resume  
转载地址：http://blog.csdn.net/fengshuiyue/article/details/39530093/
