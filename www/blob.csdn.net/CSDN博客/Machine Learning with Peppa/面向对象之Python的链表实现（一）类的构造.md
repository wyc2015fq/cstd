# 面向对象之Python的链表实现（一）类的构造 - Machine Learning with Peppa - CSDN博客





2018年01月22日 22:58:51[刺客五六柒](https://me.csdn.net/qq_39521554)阅读数：249
...
实现链表，本质上和语言是无关的。但是灵活度却和实现它的语言密切相关。最近在学习Python数据结构，看到了一个很有意思的链表实现（基本类似于C），里面使用类对象定义了一个单向链表。

之后会在做双链表与循环链表的一些练习，大家可以参考一下。代码如下：
...
```python
[output]1: 9 8 7 6 5 4 3 2 1 0

[output]2: 11 12 13 14 15 16 17 18 19
```
