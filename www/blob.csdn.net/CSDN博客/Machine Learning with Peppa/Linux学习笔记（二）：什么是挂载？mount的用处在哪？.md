# Linux学习笔记（二）：什么是挂载？mount的用处在哪？ - Machine Learning with Peppa - CSDN博客





2018年03月09日 19:10:08[刺客五六柒](https://me.csdn.net/qq_39521554)阅读数：13591
...
6.所以Linux下，mount挂载的作用，就是**将一个设备（通常是存储设备）挂接到一个已存在的目录上。**访问这个目录就是访问该存储设备。
