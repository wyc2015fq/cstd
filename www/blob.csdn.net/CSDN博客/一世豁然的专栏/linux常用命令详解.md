...
本博客转载于：[http://blog.chinaunix.net/uid-26180298-id-3152746.html](http://blog.chinaunix.net/uid-26180298-id-3152746.html)
...
inger、mail等。Linux网络操作命令的一个特点是，命令参数选项和功能很多，一个命令往往还可以实现其它命令的功能。
ifconfig
1.作用
