# linux特殊符号大全 - 一世豁然的专栏 - CSDN博客





2015年03月29日 18:46:11[一世豁然](https://me.csdn.net/Explorer_day)阅读数：434标签：[嵌入式操作系统](https://so.csdn.net/so/search/s.do?q=嵌入式操作系统&t=blog)
...
本博客转载于：[http://www.cnblogs.com/balaamwe/archive/2012/03/15/2397998.html](http://www.cnblogs.com/balaamwe/archive/2012/03/15/2397998.html)
...
   ${parameter:-word}   ${parameter:=word}   ${parameter:?word}   ${parameter:+word}   ${parameter:offset}   ${parameter:offset:length}   ${!prefix*}   ${#parameter}   ${parameter#word}   ${parameter##word}   ${parameter%word}   ${parameter%%word}   ${parameter/pattern/string} 
