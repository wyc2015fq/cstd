...
本博客转载于:[http://blog.csdn.net/u011794238/article/details/51422956](http://blog.csdn.net/u011794238/article/details/51422956)
...
[Java](http://lib.csdn.net/base/javase)的核心类都放在Java包以及其子包下，Java扩展的许多类都放在Javax包以及其子包下。


这些实用类也就是前面所说的API，[Oracle](http://lib.csdn.net/base/oracle)按这些类的功能分别放在不同的包下。
...
3），java[.NET](http://lib.csdn.net/base/dotnet)：网络编程接口和类，以后要写和网络相关的应用就要用这个包。
...
6），java.sql：jdbc相关接口和类 ，以后操作java连接[数据库](http://lib.csdn.net/base/mysql)就要使用到这个包。
