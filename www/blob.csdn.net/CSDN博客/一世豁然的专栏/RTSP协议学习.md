...
本博客转载于：[http://blog.csdn.net/machh/article/details/51721639](http://blog.csdn.net/machh/article/details/51721639)
...
Microsoft Media Services(MMS) was Microsoft's proprietary networkstreaming protocol used to transfer [unicast](http://en.wikipedia.org/wiki/Unicast) data
 in [WindowsMedia Services](http://en.wikipedia.org/wiki/Windows_Media_Services) (previously
 called NetShow Services). MMS canbe transported via [UDP](http://en.wikipedia.org/wiki/User_Datagram_Protocol)or [TCP](http://en.wikipedia.org/wiki/Transmission_Control_Protocol).The
 MMS default [port](http://en.wikipedia.org/wiki/TCP_and_UDP_port)is [UDP/TCP1755](http://en.wikipedia.org/wiki/List_of_TCP_and_UDP_port_numbers).

Microsoft deprecated MMS in favor of [RTSP](http://en.wikipedia.org/wiki/RTSP) in
 2003 with the release of the Windows MediaServices 9 Series, but continued to support the MMS for some time in theinterest of [backwards
 compatibility](http://en.wikipedia.org/wiki/Backwards_compatibility). Support for the protocol was finallydropped in [WindowsMedia
 Services](http://en.wikipedia.org/wiki/Windows_Media_Services) 2008[[1]](http://en.wikipedia.org/wiki/Microsoft_Media_Services#cite_note-0%23cite_note-0).


Note however that Microsoft stillrecommends[[2]](http://en.wikipedia.org/wiki/Microsoft_Media_Services#cite_note-1%23cite_note-1) using"mms://"
 as a "protocol rollover[[3]](http://en.wikipedia.org/wiki/Microsoft_Media_Services#cite_note-2%23cite_note-2)[URL](http://en.wikipedia.org/wiki/Uniform_Resource_Locator)".As
 part of protocol rollover a [WindowsMedia
 Player 11](http://en.wikipedia.org/wiki/Windows_Media_Player_11) client opening an "mms://" URL willattempt to connect first with RTSP over UDP and if that fails it will attemptRTSP over TCP. Earlier [WindowsMedia
 Player](http://en.wikipedia.org/wiki/Windows_Media_Player) clients as well as version 11 after having failed RTSPwill attempt MMS over UDP, then MMS over TCP. If MMS failed a modified versionof a [HTTP](http://en.wikipedia.org/wiki/HyperText_Transfer_Protocol)over
 TCP connection will be attempted, this modified version is also referredto as MMSH[[4]](http://en.wikipedia.org/wiki/Microsoft_Media_Services#cite_note-3%23cite_note-3).
