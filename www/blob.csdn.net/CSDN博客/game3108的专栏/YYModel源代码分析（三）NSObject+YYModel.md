# YYModel源代码分析（三）NSObject+YYModel - game3108的专栏 - CSDN博客
2016年09月02日 20:56:02[game3108](https://me.csdn.net/game3108)阅读数：1026
## 前言
本文的中文注释代码demo更新在我的[github](https://github.com/game3108/BlogDemo/tree/master/YYModelDemo)上。
上篇 [YYModel源代码分析（二）YYClassInfo](http://www.jianshu.com/p/012dbce17a50) 主要分析了YYClassInfo文件。本篇会主要集中在NSObject+YYModel文件上。文章内容会包含一些与JSONModel的比较，想了解JSONModel，可以参考[JSONModel源代码解析](http://www.jianshu.com/p/64ce3927eb62)。
## 主体分层
...
## 参考资料
[简书地址](http://www.jianshu.com/p/7cf8b43f5d88)
