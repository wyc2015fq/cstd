# iOS图形处理和性能 - game3108的专栏 - CSDN博客
2016年03月30日 21:06:02[game3108](https://me.csdn.net/game3108)阅读数：401
个人分类：[iOS																[转载](https://blog.csdn.net/game3108/article/category/2926393)](https://blog.csdn.net/game3108/article/category/2844789)
链接：http://blog.inico.me/2013/05/17/designing-for-ios-graphics-performance/#.VvvLNeZyZG0
原文：https://robots.thoughtbot.com/post/36591648724/designing-for-ios-graphics-performance
...
接入设备
- 
在XCode的Developer Applications里打开Instruments（Command+Shift+i）   ![](http://pic.yupoo.com/demon42111915/CRYj9u3F/medish.jpg)
- 
选择iOS>Graphics>Core Animation template ![](http://pic.yupoo.com/demon42111915/CRYj8kna/medish.jpg)
- 
打开详情面板，选择适当的窗口模式 
...
选择你的target设备
- 
检查Color Offscreen-Rendered Yellow的debug选项
- 
在你设备上所有的离屏绘制都会呈现出黄色的色调
...
UIBezierPath *roundedRectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(, , width, height) cornerRadius: borderRadius];
...
CGContextDrawLinearGradient(context, background, CGPointMake(, ), CGPointMake(, height-), );
...
```
为了确保我们新建的BHybird类能正常使用，在Interface Builder里我们赋值一个button，把实现类改成CBHybird后，把button的content内容改为*CGContext-generated image（*便于区分）。是驴是马，咱们cmd+R跑起来试试~
