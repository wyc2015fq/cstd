# UIKit性能调优实战讲解 - game3108的专栏 - CSDN博客
2016年03月30日 15:07:32[game3108](https://me.csdn.net/game3108)阅读数：470
项目中，一开始没考虑到性能方面的问题，学会用core animation后发现，问题实在太多，某些tableview滚动后的fps只有30多，进行了几版优化，现在已经上到了55，纪录一下看过的一篇不错的概念文章。
链接：http://www.jianshu.com/p/619cf14640f3
...
- `shouldRasterize`和离屏渲染的关系是什么，何时应该使用？
...
![](http://upload-images.jianshu.io/upload_images/1171077-ae80c7d848fc7b74.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
打开Core Animation调试
注意这个调试必须使用真机，点击左上角的红色圆圈就会开始录制。新手可能不太熟悉，这里简单介绍一下调试界面：
![](http://upload-images.jianshu.io/upload_images/1171077-2d3291d97e7ffe99.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
调试界面
我们需要了解两个两个区域：
...
![](http://upload-images.jianshu.io/upload_images/1171077-6fb5ba7033c1f825.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/1171077-7d6dcd41fe0d6a72.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/1171077-0386edf0d24b7099.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
显示流程
Commit Transaction和Decode在同一帧内进行，如果这两个操作的耗时超过16.67s，Draw Calls就会延迟到下一帧，从而导致fps值的降低。下面是Commit Transaction的详细流程：
![](http://upload-images.jianshu.io/upload_images/1171077-5f115f552ca219ad.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
解码与转换
...
![](http://upload-images.jianshu.io/upload_images/1171077-c6226861bea907a9.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
图片缩放
...
![](http://upload-images.jianshu.io/upload_images/1171077-e22bfaff8314b6d6.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
正常渲染通道
首先，OpenGL提交一个命令到Command Buffer，随后GPU开始渲染，渲染结果放到Render Buffer中，这是正常的渲染流程。但是有一些复杂的效果无法直接渲染出结果，它需要分步渲染最后再组合起来，比如添加一个蒙版(mask)：
![](http://upload-images.jianshu.io/upload_images/1171077-551823de77e0e04e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
离屏渲染
...
![](http://upload-images.jianshu.io/upload_images/1171077-84a9318793df9d5a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
离屏渲染
...
![](http://upload-images.jianshu.io/upload_images/1171077-2092b1b15b094025.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
重绘区域
# 总结
...
# 参考资料：
- [绘制像素到屏幕上](http://objccn.io/issue-3-1/)，原文：[Getting Pixels onto the Screen](https://www.objc.io/issues/3-views/)
- [Advanced Graphics and Animations for iOS Apps](https://developer.apple.com/videos/play/wwdc2014-419/)：这是2014年WWDC Session 419，强烈建议看一遍。
...
还有一些高质量的问答：
- [What triggers “Color Copied Images” and “Color Hits Green and Misses Red” in Instruments?](http://stackoverflow.com/questions/6302029/what-triggers-color-copied-images-and-color-hits-green-and-misses-red-in-ins)
- [UILabel is marked as red when`Color Blended Layers` is selected](http://stackoverflow.com/questions/34895641/uilabel-is-marked-as-red-when-color-blended-layers-is-selected)
...
文／bestswifter（简书作者）
原文链接：http://www.jianshu.com/p/619cf14640f3
