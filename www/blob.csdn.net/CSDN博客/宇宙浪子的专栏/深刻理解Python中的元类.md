# 深刻理解Python中的元类 - 宇宙浪子的专栏 - CSDN博客
2015年07月21日 10:34:20[_宇宙浪子_](https://me.csdn.net/bluehawksky)阅读数：297标签：[python																[元类](https://so.csdn.net/so/search/s.do?q=元类&t=blog)](https://so.csdn.net/so/search/s.do?q=python&t=blog)
...
![\](http://up.2cto.com/2012/0612/20120612012142525.jpg)
**类也是对象**
在理解元类之前，你需要先掌握Python中的类。Python中类的概念借鉴于Smalltalk，这显得有些奇特。在大多数[编程语言](http://blog.jobbole.com/tag/%E7%BC%96%E7%A8%8B%E8%AF%AD%E8%A8%80/)中，类就是一组用来描述如何生成一个对象的代码段。在Python中这一点仍然成立：
```
```python
>>>
```
...
```
```python
.__new__(upperattr_metaclass, future_class_name, future_class_parents,
 uppercase_attr)
```
```
...
英文原文：[Stack Overflow](http://stackoverflow.com/questions/100003/what-is-a-metaclass-in-python)    编译：[伯乐](http://www.jobbole.com/)在线— 陈舸
