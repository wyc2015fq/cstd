# python实现的json数据以HTTP GET,POST,PUT,DELETE方式页面请求 - 宇宙浪子的专栏 - CSDN博客
2015年01月06日 15:40:08[_宇宙浪子_](https://me.csdn.net/bluehawksky)阅读数：424标签：[python																[json																[urllib2](https://so.csdn.net/so/search/s.do?q=urllib2&t=blog)](https://so.csdn.net/so/search/s.do?q=json&t=blog)](https://so.csdn.net/so/search/s.do?q=python&t=blog)
个人分类：[Python](https://blog.csdn.net/bluehawksky/article/category/2542577)
# [python实现的json数据以HTTP GET,POST,PUT,DELETE方式页面请求](http://blog.csdn.net/fireroll/article/details/38396583)
# 一、JSON简介
