# Python特殊语法：filter、map、reduce、lambda [转] - 宇宙浪子的专栏 - CSDN博客
2014年12月07日 18:20:51[_宇宙浪子_](https://me.csdn.net/bluehawksky)阅读数：248标签：[python																[filter																[reduce																[lambda																[map](https://so.csdn.net/so/search/s.do?q=map&t=blog)](https://so.csdn.net/so/search/s.do?q=lambda&t=blog)](https://so.csdn.net/so/search/s.do?q=reduce&t=blog)](https://so.csdn.net/so/search/s.do?q=filter&t=blog)](https://so.csdn.net/so/search/s.do?q=python&t=blog)
个人分类：[Python](https://blog.csdn.net/bluehawksky/article/category/2542577)
## [Python特殊语法：filter、map、reduce、lambda [转]](http://www.cnblogs.com/longdouhzt/archive/2012/05/19/2508844.html)
...
>>> (lambda x: x * 2)(3) 
6
我们也可以**把filter map reduce 和lambda结合起来**用，函数就可以简单的写成一行。
例如
