# Python模块学习 ---- time 日期时间处理 - 宇宙浪子的专栏 - CSDN博客
2014年09月05日 15:56:56[_宇宙浪子_](https://me.csdn.net/bluehawksky)阅读数：376标签：[Python](https://so.csdn.net/so/search/s.do?q=Python&t=blog)
...
**[python]**[view
 plain](http://blog.csdn.net/jgood/article/details/4292912#)[copy](http://blog.csdn.net/jgood/article/details/4292912#)
- import time  
- 
- print time.clock() #1
- time.sleep(2)  
...
　　以上介绍的方法是time模块中最常用的几个方法，在Python手册中还介绍了其他的方法和属性，如：time.timezone, time.tzname ...感兴趣的朋友可以参考Python手册 [time](http://docs.python.org/library/time.html) 模块
