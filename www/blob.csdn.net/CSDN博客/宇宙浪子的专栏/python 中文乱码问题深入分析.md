# python 中文乱码问题深入分析 - 宇宙浪子的专栏 - CSDN博客
2014年09月05日 15:49:09[_宇宙浪子_](https://me.csdn.net/bluehawksky)阅读数：359标签：[Python](https://so.csdn.net/so/search/s.do?q=Python&t=blog)
...
2． UTF-8，E59388； 
3． GBK，B9FE。 
**一、python中的str和unicode **一直以来，python中的中文编码就是一个极为头大的问题，经常抛出编码转换的异常，python中的str和unicode到底是一个什么东西呢？ 
...
例如：
![python 字符串和unicode](http://files.jb51.net/upload/201103/20110313135227531.jpg)
...
![decode和encode演示](http://files.jb51.net/upload/201103/20110313135230491.jpg)
将GBK'哈哈'转换成unicode，然后再转换成UTF8
#### 三、Setdefaultencoding
![setdefaultencoding](http://files.jb51.net/upload/201103/20110313135230405.jpg)
如上图的演示代码所示：
