# Python正则表达式指南 - 宇宙浪子的专栏 - CSDN博客
2015年12月15日 15:49:08[_宇宙浪子_](https://me.csdn.net/bluehawksky)阅读数：303标签：[python																[正则表达式](https://so.csdn.net/so/search/s.do?q=正则表达式&t=blog)](https://so.csdn.net/so/search/s.do?q=python&t=blog)
个人分类：[Python](https://blog.csdn.net/bluehawksky/article/category/2542577)
转自：[http://www.cnblogs.com/huxi/archive/2010/07/04/1771073.html](http://www.cnblogs.com/huxi/archive/2010/07/04/1771073.html)
## 1. 正则表达式基础
### 1.1. 简单介绍
...
r
```
`"m.expand(r'\2 \1\3'):"``, m.expand(r``'\2 \1\3'``)`
`### output ###`
