# 浅析python的metaclass - 宇宙浪子的专栏 - CSDN博客
2015年12月21日 13:44:43[_宇宙浪子_](https://me.csdn.net/bluehawksky)阅读数：324标签：[python																[metaclass](https://so.csdn.net/so/search/s.do?q=metaclass&t=blog)](https://so.csdn.net/so/search/s.do?q=python&t=blog)
个人分类：[Python](https://blog.csdn.net/bluehawksky/article/category/2542577)
转自：[http://jianpx.iteye.com/blog/908121](http://jianpx.iteye.com/blog/908121)
...
1. 你可以自由的、动态的修改/增加/删除 类的或者实例中的方法或者属性
Python代码  ![收藏代码](http://jianpx.iteye.com/images/icon_star.png)
- #!/usr/bin/python
- #coding :utf-8
- 
- 
...
[http://mikeconley.ca/blog/2010/05/04/python-metaclasses-in-review-board/](http://mikeconley.ca/blog/2010/05/04/python-metaclasses-in-review-board/)
6. 自动委托(auto delegate)
以下是网上的例子：
...
more...
2. 参考资料:
* Metaclass Programming In Python [[http://gnosis.cx/publish/programming/metaclass_1.html](http://gnosis.cx/publish/programming/metaclass_1.html)]
* Python中用MetaClass实现委托、不可变集合 [[http://marlonyao.iteye.com/blog/762156](http://marlonyao.iteye.com/blog/762156)]
* Metaclass [[http://en.wikipedia.org/wiki/Metaclasses#Python_example](http://en.wikipedia.org/wiki/Metaclasses#Python_example)]
