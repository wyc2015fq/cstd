# C++ 多线程编程之在类中使用多线程(thread)的方法 - DumpDoctorWang的博客 - CSDN博客





2018年03月28日 16:24:13[原我归来是少年](https://me.csdn.net/DumpDoctorWang)阅读数：724
...
参见[C++使用thread类多线程编程](https://blog.csdn.net/dcrmg/article/details/53912941)。
...
这种方法是把lambda函数(参考[链接](https://blog.csdn.net/u010984552/article/details/53634513))作为线程参数，使用lambda函数捕获类的成员函数及属性，然后就可以在类内使用多线程。
