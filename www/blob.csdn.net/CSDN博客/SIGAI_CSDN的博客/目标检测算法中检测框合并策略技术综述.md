...
# 目标检测算法中检测框合并策略技术综述 - SIGAI_CSDN的博客 - CSDN博客
...
2018年10月30日 11:02:11[SIGAI_csdn](https://me.csdn.net/SIGAI_CSDN)阅读数：3042
...
![](https://img-blog.csdnimg.cn/20181030105538928.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
图 1 目标检测领域重要论文
...
![](https://img-blog.csdnimg.cn/20181030105545448.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
图 2 NMS消除冗余候选框
...
![](https://img-blog.csdnimg.cn/20181030105554221.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
图 3猫和狗两类目标检测
![](https://img-blog.csdnimg.cn/20181030105559820.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
图 4 NMS算法过程
...
![](https://img-blog.csdnimg.cn/20181030110015785.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
论文置信度重置函数有两种形式改进，一种是线性加权的：
![](https://img-blog.csdnimg.cn/20181030110024890.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
一种是高斯加权的：
![](https://img-blog.csdnimg.cn/20181030110034303.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
2.2 代码实现
论文作者提供 R-FCN 和Faster-RCNN集成soft-NMS的代码实现[https://github.com/bharatsingh430/soft-nms](https://link.zhihu.com/?target=https%3A//github.com/bharatsingh430/soft-nms)。
...
3.2 网络结构与算法实现
![](https://img-blog.csdnimg.cn/20181030105706300.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
图 9 R-CNN和Softer-NMS异同
如所示Softer-NMS网络结构，与R-CNN不同的是引入absolute value layer（图中AbsVal）,实现标注方差的预测。
论文假设Bounding box为高斯分布：
![](https://img-blog.csdnimg.cn/20181030110054252.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
ground truth符合delta分布：
![](https://img-blog.csdnimg.cn/20181030110102570.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
KL散度可以表示为：
![](https://img-blog.csdnimg.cn/20181030110111556.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
推倒过程详见原论文，重点看看作者推倒的KL loss：
![](https://img-blog.csdnimg.cn/20181030110123952.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
是不是和L1正则化很像？是不是预测的Bounding box与ground truth的曼哈顿距离的一维表示？
![](https://img-blog.csdnimg.cn/20181030105736244.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
图 10 Softer-NMS实现过程
...
![](https://img-blog.csdnimg.cn/20181030110139331.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
考虑特殊情况，可以认为是预测坐标点之间求平均值。
3.3 代码分析
softerNMS的开源代码在[https://github.com/yihui-he/softerNMS](https://link.zhihu.com/?target=https%3A//github.com/yihui-he/softerNMS)。
在softer-NMS/detectron/core/test.py有Softer-NMS(配置cfg.STD_NMS), Soft-NMS(配置cfg.TEST.SOFT_NMS.ENABLED)以及NMS的实现。
![](https://img-blog.csdnimg.cn/2018103010575672.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
在softer-NMS/detectron/utils/py_cpu_nms.py文件有Softer-NMS的具体实现，加权求平均在47-48行代码实现：
![](https://img-blog.csdnimg.cn/20181030105802620.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
3.4 性能分析
![](https://img-blog.csdnimg.cn/2018103010580822.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
图 11对比交叉实验
![](https://img-blog.csdnimg.cn/20181030105812662.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
图 12 softer-NMS效果对比
...
4.2 模型框架
![](https://img-blog.csdnimg.cn/20181030105821300.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
图 13 IoU模型架构
...
![](https://img-blog.csdnimg.cn/20181030105826877.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
图 14 分类置信度、定位置信度和IOU with ground truth相关性
![](https://img-blog.csdnimg.cn/20181030105833622.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20181030105848667.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
图 16 Pool方式对比
4.5 bbox refinement
![](https://img-blog.csdnimg.cn/20181030105855587.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20181030105906441.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20181030105915590.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1NJR0FJX0NTRE4=,size_16,color_FFFFFF,t_70)
...
参考文献
[1][https://github.com/hoya012/deep_learning_object_detection](https://link.zhihu.com/?target=https%3A//github.com/hoya012/deep_learning_object_detection)
