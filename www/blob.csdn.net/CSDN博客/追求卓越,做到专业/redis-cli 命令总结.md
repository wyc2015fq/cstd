...
# redis-cli 命令总结 - 追求卓越,做到专业 - CSDN博客


2016年11月24日 10:48:06[Waldenz](https://me.csdn.net/enter89)阅读数：285标签：[Redis																](https://so.csdn.net/so/search/s.do?q=Redis&t=blog)[命令																](https://so.csdn.net/so/search/s.do?q=命令&t=blog)[
...
官网命令列表：[http://redis.io/commands](http://redis.io/commands)（英文）
### 1、连接操作相关的命令
