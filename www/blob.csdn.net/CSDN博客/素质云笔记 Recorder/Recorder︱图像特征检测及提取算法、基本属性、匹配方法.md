...
2017年03月17日 17:32:32[悟乙己](https://me.csdn.net/sinat_26917383)阅读数：13250
...
④许多形状特征所反映的目标形状信息与人的直观感觉不完全一致，或者说，特征空间的相似性与人视觉系统感受到的相似性有差别。- （1）边界特征法
...
在线性投影分析中，以**主分量分析（PCA，或称K-L变换）和Fisher线性鉴别分析（LDA）**最具代表性，围绕这两种方法所形成的特征抽取算法，已成为模式识别领域中最为经典和广泛使用的方法。 
...
![这里写图片描述](https://img-blog.csdn.net/20170317172803317?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvc2luYXRfMjY5MTczODM=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
Canny边缘检测之所以优秀是因为它在一阶微分算子的基础上，增加了非最大值抑制和双阈值两项改进。利用非极大值抑制不仅可以有效地抑制多响应边缘，而且还可以提高边缘的定位精度；利用双阈值可以有效减少边缘的漏检率。- ORB特征
...
效果： 
![这里写图片描述](https://raw.githubusercontent.com/abhijeet3922/Image-compression-with-Kmeans-clustering/master/tiger.png)
![这里写图片描述](https://raw.githubusercontent.com/abhijeet3922/Image-compression-with-Kmeans-clustering/master/compressed_tiger.png)

.
## 延伸二：车辆追踪算法大PK：SVM+HOG vs. YOLO

云栖社区：[车辆追踪算法大PK：SVM+HOG vs. YOLO](https://yq.aliyun.com/articles/71662)
