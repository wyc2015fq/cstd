...
2016年06月09日 11:15:08[悟乙己](https://me.csdn.net/sinat_26917383)阅读数：33911
...
    笔者在尝试wordcloud2的时候，本来是从来没有遇到过报错问题，但是公司电脑里面是低版本的R（3.1），随后就出现了这样的报错， 是格式问题，需要把中文格式转化为UTF8才能塞入wordcloud2当中。
      于是笔者也在低版本下尝试了很多种可能性譬如：
