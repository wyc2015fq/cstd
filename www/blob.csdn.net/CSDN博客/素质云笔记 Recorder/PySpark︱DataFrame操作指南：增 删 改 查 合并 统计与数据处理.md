# PySpark︱DataFrame操作指南：增/删/改/查/合并/统计与数据处理 - 素质云笔记/Recorder... - CSDN博客





2018年05月29日 18:38:51[悟乙己](https://me.csdn.net/sinat_26917383)阅读数：16038
...
### 文章目录
- [1、-------- 查 --------](#1___13)
- [---  1.1 行元素查询操作 ---](#__11___15)
- [**像SQL那样打印列表前20元素**](#SQL20_16)
- [**以树的形式打印概要**](#_24)
- [**获取头几行到本地：**](#_30)
- [**查询总行数：**](#_37)
- [取别名](#_43)
- [**查询某列为null的行：**](#null_48)
- [**输出list类型，list中每个元素是Row类：**](#listlistRow_56)
- [查询概况](#_65)
- [去重set操作](#set_84)
- [随机抽样](#_93)
- [--- 1.2 列元素操作 ---](#_12___109)
- [**获取Row元素的所有列名：**](#Row_110)
- [**选择一列或多列：select**](#select_117)
- [**重载的select方法：**](#select_128)
- [**还可以用where按条件选择**](#where_136)
- [--- 1.3 排序 ---](#_13___142)
- [--- 1.4 抽样 ---](#_14___162)
- [--- 1.5 按条件筛选when / between ---](#_15_when__between__177)
- [2、-------- 增、改 --------](#2___214)
- [--- 2.1 新建数据 ---](#_21___216)
- [--- 2.2 新增数据列 withColumn---](#_22__withColumn_233)
- [一种方式通过functions](#functions_260)
- [**另一种方式通过另一个已有变量：**](#_308)
- [**修改原有df[“xx”]列的所有值：**](#dfxx_314)
- [**修改列的类型（类型投射）：**](#_320)
- [修改列名](#_326)
- [--- 2.3 过滤数据---](#_23__332)
- [3、-------- 合并 join / union --------](#3__join__union__355)
- [3.1 横向拼接rbind](#31_rbind_356)
- [--- 3.2 Join根据条件 ---](#_32_Join__364)
- [单字段Join](#Join_365)
- [多字段join](#join_375)
- [混合字段](#_381)
- [--- 3.2 求并集、交集 ---](#_32___390)
- [--- 3.3 分割：行转列 ---](#_33___470)
- [4 -------- 统计 --------](#4____485)
- [--- 4.1 频数统计与筛选 ----](#_41___487)
- [--- 4.2 分组统计---](#_42__495)
- [交叉分析](#_496)
- [**groupBy方法整合：**](#groupBy_514)
- [--- 4.3  apply 函数 ---](#_43__apply___567)
- [---- 4.4 【Map和Reduce应用】返回类型seqRDDs ----](#_44_MapReduceseqRDDs__580)
- [-------- 5、删除 --------](#_5__642)
- [-------- 6、去重 --------](#_6__683)
- [6.1 distinct：返回一个不包含重复记录的DataFrame](#61_distinctDataFrame_685)
- [6.2 dropDuplicates：根据指定字段去重](#62_dropDuplicates_693)
- [-------- 7、 格式转换 --------](#_7___725)
- [pandas-spark.dataframe互转](#pandassparkdataframe_727)
- [转化为RDD](#RDD_744)
- [-------- 8、SQL操作 --------](#_8SQL__756)
- [-------- 9、读写csv --------](#_9csv__772)
- [延伸一：去除两个表重复的内容](#_807)
...
以及查询类型，之前是type，现在是`df.printSchema()`
...
但是！！ 如何新增一个特别List??(参考：[王强的知乎回复](https://www.zhihu.com/question/56472176?from=profile_question_card))
...
![此处输入图片的描述](https://img-blog.csdn.net/20161012233045662)
...
可以参考：[Spark Python API函数学习：pyspark API(1)](https://www.iteblog.com/archives/1395.html)
...
[【总结】PySpark的DataFrame处理方法：增删改差](https://blog.csdn.net/weimingyu945/article/details/77981884)
