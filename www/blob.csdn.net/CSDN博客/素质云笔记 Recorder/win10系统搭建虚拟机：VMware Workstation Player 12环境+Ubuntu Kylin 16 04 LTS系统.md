...
2016年11月19日 15:52:20[悟乙己](https://me.csdn.net/sinat_26917383)阅读数：4872
...
**应用一：报错vmware提示：此虚拟机似乎正在使用中，取得该虚拟机的所有权失败错误怎么办？**
...
# 应用一：报错vmware提示：此虚拟机似乎正在使用中，取得该虚拟机的所有权失败错误
...
**     于是一不做二不休，直接删除了D:\Virtual Machines\CentOS-6.3\下的*.lck文件夹，然后再虚拟机中重新打开D:\Virtual Machines\CentOS-6.3\CentOS-6.3.vmx。呵，正常了。**
