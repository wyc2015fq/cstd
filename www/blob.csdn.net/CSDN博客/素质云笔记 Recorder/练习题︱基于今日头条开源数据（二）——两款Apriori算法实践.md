...
2018年06月07日 16:23:26[悟乙己](https://me.csdn.net/sinat_26917383)阅读数：644
...
> code + data可见：
> [mattzheng/AprioriDemo](https://github.com/mattzheng/AprioriDemo)
...
> 0.6
> items
> , rules = runApriori(inFile, minSupport, minConfidence)
> \# ------------ print函数 ------------
> printResults(
> items
> , rules)
> \# ------------ dataframe------------
> items_data,rules_data = transferDataFrame(
> items
> , rules)
...
> [ ](https://img-blog.csdn.net/20180607160239228?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzI2OTE3Mzgz/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)

> rules_data 的置信度表格，指向为
> word_x->word_y
...
> [ ](https://img-blog.csdn.net/20180607160632869?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzI2OTE3Mzgz/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
> print
> (
> '--------items number is: %s , rules number is : %s--------'
> %(len(items),len(rules)))
\#
> ------------ print函数 ------------
...
> [ ](https://img-blog.csdn.net/20180607160827757?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzI2OTE3Mzgz/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
