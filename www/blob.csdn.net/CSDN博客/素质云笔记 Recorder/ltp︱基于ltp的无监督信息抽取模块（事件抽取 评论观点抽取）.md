...
# ltp︱基于ltp的无监督信息抽取模块（事件抽取-评论观点抽取） - 素质云笔记-Recorder... - CSDN博客

2018年09月19日 10:57:44[悟乙己](https://me.csdn.net/sinat_26917383)阅读数：1516
...
> [1.2 code粗解读](#12_code_44)

> [1.3 结果展示](#13__63)

> [2 三元组事件抽取 + 因果事件抽取](#2____77)
...
> [
](https://img-blog.csdn.net/20180919102440812?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzI2OTE3Mzgz/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
> word列，就是这句话主要分词结果
...
> 通常表示动作的施事，A1通常表示动作的影响等，A2-5 根据谓语动词不同会有不同的语义含义。其余的15个语义角色为附加语义角色，如LOC， 表示地点，TMP，表示时间等（一些符号可见笔者另一篇博客：
> [python︱六款中文分词模块尝试:jieba、THULAC、SnowNLP、pynlpir、CoreNLP、pyLTP](https://blog.csdn.net/sinat_26917383/article/details/77067515)
> ）。
...
> 项目地址：
> [https://github.com/liuhuanyong/EventTriplesExtraction](https://github.com/liuhuanyong/EventTriplesExtraction)
...
> [
](https://img-blog.csdn.net/20180918175330481?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NpbmF0XzI2OTE3Mzgz/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
