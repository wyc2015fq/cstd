...
# ChineseWiki︱百万中文维基百科词条下载与整理 - 素质云笔记-Recorder... - CSDN博客

2018年03月07日 09:35:49[悟乙己](https://me.csdn.net/sinat_26917383)阅读数：3343
...
本篇code见：[mattzheng/ChineseWiki](https://github.com/mattzheng/ChineseWiki/blob/master/README.md)
...
2、词条的编号信息，官方提供
[zhwiki-20180301-pages-articles-multistream-index.txt.bz2 23.6](https://dumps.wikimedia.org/zhwiki/20180301/zhwiki-20180301-pages-articles-multistream-index.txt.bz2)
MB
1、繁简转化库——opencc的安装与使用
其中繁体转简体中文的库，opencc的安装，网上的说明程序真尼玛多，没一个搞的定的，吐槽一下！！！
直接来看[github](https://github.com/yichen0831/opencc-python)原文，安装方式：
pip install opencc-python-reimplemented或者把github下载下来用python setup.py install安装，哪有网上教程那么麻烦！
使用也不太一样：
...
to_convert = '开放中文转换'
converted = openCC.convert(to_convert)支持的转换模式有：
...
'tw2sp': Traditional Chinese (Taiwan standard) to Simplified Chinese (with phrases)此处补充，如何判断一个句子中是否有繁体字
...
* 形而上学/宇宙论
* 知识论然后笔者的做法是利用给每一行进行打标wiki_clean.py，因为每一行通过符号是可以直接从属关系。记号遵从以下表格：
内容级别内容标记|
|---|---|---|
1级标题【政治学】1|
2级标题== 历史 ==2|
...
概念从属关系，驾驶汽车与汽车，肯定想知道驾驶汽车
目前做到的效果是：
search_txt = '民用无人机到自主驾驶汽车'
search(search_txt)结果输出：
