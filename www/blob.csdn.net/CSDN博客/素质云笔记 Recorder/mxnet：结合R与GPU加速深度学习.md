...
2016年10月05日 10:57:41[悟乙己](https://me.csdn.net/sinat_26917383)阅读数：3450
...
```
- 如果你是Linux用户或者想尝试GPU版本，请参考[这个链接里](http://mxnet.readthedocs.org/en/latest/build.html#r-package-installation)的详细编译教程在本地进行编译。
...
在神经网络中，回归与分类的差别主要在于输出层的损失函数。这里我们使用了平方误差来训练模型。希望能更进一步了解Symbol的读者可以继续阅读这两份分别以[代码](http://mxnet.readthedocs.org/en/latest/R-package/ndarrayAndSymbolTutorial.html)和[配图](http://mxnet.readthedocs.org/en/latest/python/symbol_in_pictures.html)为主的文档。
