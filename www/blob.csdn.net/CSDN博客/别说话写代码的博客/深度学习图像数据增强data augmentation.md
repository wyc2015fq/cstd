# 深度学习图像数据增强data augmentation - 别说话写代码的博客 - CSDN博客





2018年05月04日 15:36:52[别说话写代码](https://me.csdn.net/qq_21997625)阅读数：1841标签：[深度学习																[数据增强																[data augmentation](https://so.csdn.net/so/search/s.do?q=data augmentation&t=blog)
...
更多数据增强方法：https://github.com/aleju/imgaug](https://so.csdn.net/so/search/s.do?q=数据增强&t=blog)](https://so.csdn.net/so/search/s.do?q=深度学习&t=blog)
