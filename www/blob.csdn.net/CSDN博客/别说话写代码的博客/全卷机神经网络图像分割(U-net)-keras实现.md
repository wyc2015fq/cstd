# 全卷机神经网络图像分割(U-net)-keras实现 - 别说话写代码的博客 - CSDN博客





2018年09月10日 19:11:23[别说话写代码](https://me.csdn.net/qq_21997625)阅读数：388
...
转自：[https://blog.csdn.net/u012931582/article/details/70215756](https://blog.csdn.net/u012931582/article/details/70215756)

最近在研究全卷积神经网络在图像分割方面的应用，因为自己是做医学图像处理方面的工作，所以就把一个基于FCN（全卷积神经网络）的神经网络用 [keras](https://keras.io/) 实现了，并且用了一个医学图像的数据集进行了图像分割。

# 全卷积神经网络

大名鼎鼎的FCN就不多做介绍了，这里有一篇很好的博文 [http://www.cnblogs.com/gujianhan/p/6030639.html](http://www.cnblogs.com/gujianhan/p/6030639.html)。 
