...
mail [user1@email.addr](mailto:user1@email.addr)ess 
mail [user1@email.addr](mailto:user1@email.addr)ess user2 
...
person : 预备对谈的使用者帐号，如果该使用者在其他机器上，则可输入 [person@machine.name](mailto:person@machine.name)
...
talk [Rollaend@linuxfab.cx](mailto:Rollaend@linuxfab.cx) pts/2 

接下来就是等Rollaend回应，若Rollaend接受，则Rollaend输入 `talk [jzlee@jzlee.home](mailto:jzlee@jzlee.home)`即可开始对谈，结束请按 ctrl+c 
