# 加密算法之BLOWFISH算法 - 深之JohnChen的专栏 - CSDN博客

2012年02月11日 16:24:08[byxdaz](https://me.csdn.net/byxdaz)阅读数：15533
...
　　6)用key_pbox[16]和key_pbox[17]做首次输入（相当于上面的全0的输入），用类似的方法，替换key_sbox信息加密。信息加密就是用[函数](http://baike.baidu.com/view/15061.htm)把待加密信息x分成32位的两部分:xL,xRBF_En对输入信息进行变换，BF_En函数详细过程如下： 
...
![](http://oldblog.eccn.com/UploadFiles/2007-9/911730680.jpg)
...
　　由于该CrackMe主要是测试你的密码学知识，所以没有在其他方面设关卡。为了减小文件体积，缩短大家下载的时间，用upx加了壳，直接用Trw2000的"PNewSec+Makepe"很方便地就能脱掉[壳](http://baike.baidu.com/view/102444.htm)。 
...
　　如果你对这个[CrackMe](http://baike.baidu.com/view/1090281.htm)很有兴趣，还想研究一下他的ComputerID是如何产生的，也可以继续跟踪，分析，在这里，我给处我分析的结果： 
...
　　注册机源码里头有一些语句没有派上用场，用“;”屏蔽了，如果你有兴趣，可以把前面的;号去掉然后把.data段里头的PW_1换成你机器的ComputerID,再按照程序中的说明自己修改一下源程序，用Masm32V6重新编译，直接按Generate，也能得到正确的[序列号](http://baike.baidu.com/view/53324.htm)。
...
代码下载：[http://download.csdn.net/detail/byxdaz/4057820](http://download.csdn.net/detail/byxdaz/4057820)
