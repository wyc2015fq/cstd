# 曲线拟合(转载) - 深之JohnChen的专栏 - CSDN博客

2006年02月08日 15:07:00[byxdaz](https://me.csdn.net/byxdaz)阅读数：3321标签：[null																[math.h																[c																[存储](https://so.csdn.net/so/search/s.do?q=存储&t=blog)](https://so.csdn.net/so/search/s.do?q=c&t=blog)](https://so.csdn.net/so/search/s.do?q=math.h&t=blog)](https://so.csdn.net/so/search/s.do?q=null&t=blog)
