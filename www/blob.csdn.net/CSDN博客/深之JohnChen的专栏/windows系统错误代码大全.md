# windows系统错误代码大全 - 深之JohnChen的专栏 - CSDN博客

2008年12月18日 15:56:00[byxdaz](https://me.csdn.net/byxdaz)阅读数：2009
...
0026 无法访问指定的磁盘或软盘。
0027 驱动器找不到所请求的扇区。
0028 [打印机](http://detail.zol.com.cn/print_index/subcate11_list_1.html)缺纸。
0029 系统无法写入指定的设备。
0030 系统无法读取指定的设备。
0031 与系统连接的设备不能正常运转。
...
0056 已经达到网络命令的极限。
0057 网络适配器出现错误。
0058 指定的[服务器](http://detail.zol.com.cn/server_index/subcate31_list_1.html)无法执行所请求的操作。
0059 网络出现意外错误。
0060 远程适配器不兼容。
0061 打印机队列已满。
...
0997 正在处理重叠的 I/O 操作。
0998 对[内存](http://detail.zol.com.cn/memory_index/subcate3_list_1.html)位置的无效访问。
0999 执行页内操作出错。
1001 递归太深；堆栈溢出。
1002 窗口无法用来发送消息。
1003 无法完成此项功能。
...
1456 找不到菜单项。
1457 [键盘](http://detail.zol.com.cn/keyboard_index/subcate33_list_1.html)布局句柄无效。
1458 不允许使用挂钩类型。
1459 该操作需要交互式窗口工作站。
1460 由于超时时间已过，该操作返回。
1461 无效监视器句柄。
