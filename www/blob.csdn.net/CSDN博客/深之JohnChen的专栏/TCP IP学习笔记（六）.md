# TCP/IP学习笔记（六） - 深之JohnChen的专栏 - CSDN博客

2006年04月13日 09:53:00[byxdaz](https://me.csdn.net/byxdaz)阅读数：1403标签：[tcp																[服务器																[网络																[路由器																[算法																[任务](https://so.csdn.net/so/search/s.do?q=任务&t=blog)](https://so.csdn.net/so/search/s.do?q=算法&t=blog)](https://so.csdn.net/so/search/s.do?q=路由器&t=blog)](https://so.csdn.net/so/search/s.do?q=网络&t=blog)](https://so.csdn.net/so/search/s.do?q=服务器&t=blog)](https://so.csdn.net/so/search/s.do?q=tcp&t=blog)
