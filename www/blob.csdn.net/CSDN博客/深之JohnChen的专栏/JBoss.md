# JBoss - 深之JohnChen的专栏 - CSDN博客

2009年04月15日 09:29:00[byxdaz](https://me.csdn.net/byxdaz)阅读数：892标签：[jboss																[应用服务器																[ejb																[hibernate																[aop																[jmx](https://so.csdn.net/so/search/s.do?q=jmx&t=blog)](https://so.csdn.net/so/search/s.do?q=aop&t=blog)](https://so.csdn.net/so/search/s.do?q=hibernate&t=blog)](https://so.csdn.net/so/search/s.do?q=ejb&t=blog)](https://so.csdn.net/so/search/s.do?q=应用服务器&t=blog)](https://so.csdn.net/so/search/s.do?q=jboss&t=blog)
个人分类：[JAVA](https://blog.csdn.net/byxdaz/article/category/628883)


**JBoss**

JBoss是全世界开发者共同努力的成果，一个基于[J2EE](http://writeblog.csdn.net/view/1507.htm)的[开放源代码](http://writeblog.csdn.net/view/1708.htm)的应用服务器。 因为JBoss代码遵循LGPL许可，你可以在任何商业应用中免费使用它，而不用支付费用。
　　2006年,Jboss公司(http://jboss.org)被[Redhat](http://writeblog.csdn.net/view/82246.htm)公司(http://redhat.com)收购。
　　JBoss是一个管理[EJB](http://writeblog.csdn.net/view/3542.htm)的容器和服务器，支持EJB 1.1、EJB 2.0和EJB3.0的规范。但JBoss核心服务不包括支持[servlet](http://writeblog.csdn.net/view/25169.htm)/[JSP](http://writeblog.csdn.net/view/3387.htm)的WEB容器，一般与[Tomcat](http://writeblog.csdn.net/view/10166.htm)或[Jetty](http://writeblog.csdn.net/view/1425008.htm)绑定使用。
　　JBoss具有如下优点：
...
　　5、JBoss与Web服务器在同一个[Java虚拟机](http://writeblog.csdn.net/view/374952.htm)中运行，Servlet调用EJB不经过网络，从而大大提高运行效率，提升安全性能。
