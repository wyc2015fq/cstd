# Linux iostat监测IO状态 - 三少GG - CSDN博客
2014年07月24日 09:37:48[三少GG](https://me.csdn.net/scut1135)阅读数：503
...
rsec/s：每秒读取的扇区数；wsec/：每秒写入的扇区数。r/s：The number of read requests that were issued to the
 device per second；w/s：The number of write requests that were issued to the device per second；
...
参考文献：
- Linux man iostat
- [How Linux iostat computes its results](http://www.xaprb.com/blog/2010/01/09/how-linux-iostat-computes-its-results/)
- [Linux iostat](http://www.mjmwired.net/kernel/Documentation/iostats.txt)
*******************
