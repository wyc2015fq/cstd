# dll封装3 - 三少GG - CSDN博客
2013年03月05日 01:40:55[三少GG](https://me.csdn.net/scut1135)阅读数：791
...
[How to create and use DLL in C++](http://programmingexamples.wikidot.com/blog:1)
Posted on 
Friday: 06 May, 2011
...
- To create the DLL export library: Project > MyDLL properties… > Configuration Properties > C/C++ >Preprocessor > Append, or insert, "DLLDIR_EX" (without the quotation marks) to the Preprocessor Definition text box > OK. This will prevent compiler assumptions
 and warnings. [[1]()]
- Build > Build Solution
- Your DLL should be ready. You should have files MyDLL.dll and MyDLL.lib in directory
project-directory\Debug.
**HelloDLL.h**
#pragmaonce//more about this in reference 1#ifdefDLLDIR_EX   #defineDLLDIR__declspec(dllexport)// export DLL information#else   #defineDLLDIR__declspec(dllimport)// import DLL information#endifclassDLLDIRHelloDLL{public:
    HelloDLL(void);
    ~HelloDLL(void);
 
      voidhello();
     staticvoidhelloStatic();
 
};
**HelloDLL.cpp**
#include "StdAfx.h"#include "HelloDLL.h"#include <iostream>usingnamespacestd; 
 
HelloDLL::HelloDLL(void){}HelloDLL::~HelloDLL(void){}voidHelloDLL::hello(){cout << "Hello World of DLL" << endl;
}voidHelloDLL::helloStatic(){cout << "Hello World of DLL static" << endl;
}
**Step 3**: Use the DLL in a new project.
- Create a new project: Visual Studio > File > New Project > Win32 Console Application. Name it
Use of MyDLL and press OK.
- Press Next.
...
- Move file MyDLL.dll in the same directory as the source code of your project
Use of MyDLL.
- Add header file: Project > Properties > Configuration Properties > C/C++ > Additional Include Directories > Add the directory where the file
HelloDLL.h is located.
**Step 5**: Test your DLL.
I used the following code:
#include "stdafx.h"#include "HelloDLL.h"int_tmain(intargc, _TCHAR* argv[]){HelloDLLhelloDLL;
     helloDLL.hello();
...
Bibliography
1. [Regular DLL Tutor For Beginners](http://www.codeproject.com/KB/DLL/RegDLL.aspx)
2. [C++ Tutorial: Create a DLL in VC++ 2010/2008](http://thedarkjoker94.cer33.com/?p=637)
