# C/C++编译器-cl.exe的命令选项 || 找不到mspdb80.dll文件 - 三少GG - CSDN博客
2013年03月05日 01:42:51[三少GG](https://me.csdn.net/scut1135)阅读数：2877
**和在IDE中编译相比，命令行模式编译速度更快，并可以避免被IDE产生的一些附加信息所干扰。本**文将介绍微软C/C++编译器命令行模式设定和用法。
1、设置环境变量：
