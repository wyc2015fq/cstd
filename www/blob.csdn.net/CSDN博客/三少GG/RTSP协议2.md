# RTSP协议2 - 三少GG - CSDN博客
2012年04月09日 14:53:08[三少GG](https://me.csdn.net/scut1135)阅读数：1616标签：[session																[exception																[import																[java																[string																[server](https://so.csdn.net/so/search/s.do?q=server&t=blog)](https://so.csdn.net/so/search/s.do?q=string&t=blog)](https://so.csdn.net/so/search/s.do?q=java&t=blog)](https://so.csdn.net/so/search/s.do?q=import&t=blog)](https://so.csdn.net/so/search/s.do?q=exception&t=blog)](https://so.csdn.net/so/search/s.do?q=session&t=blog)
### [RTSP客户端的JAVA实现](http://weiyuhu.iteye.com/blog/568515)
一.参考资料      
