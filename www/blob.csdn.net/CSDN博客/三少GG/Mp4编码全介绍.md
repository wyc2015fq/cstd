# Mp4编码全介绍 - 三少GG - CSDN博客
2011年04月07日 17:31:00[三少GG](https://me.csdn.net/scut1135)阅读数：1438标签：[asp																[流媒体服务器																[avi																[apple																[工具																[扩展](https://so.csdn.net/so/search/s.do?q=扩展&t=blog)](https://so.csdn.net/so/search/s.do?q=工具&t=blog)](https://so.csdn.net/so/search/s.do?q=apple&t=blog)](https://so.csdn.net/so/search/s.do?q=avi&t=blog)](https://so.csdn.net/so/search/s.do?q=流媒体服务器&t=blog)](https://so.csdn.net/so/search/s.do?q=asp&t=blog)
个人分类：[PKU Research](https://blog.csdn.net/scut1135/article/category/801457)
**[http://my.oschina.net/alphajay/blog/4276](http://my.oschina.net/alphajay/blog/4276)**
...
**10) 我如何才能在MP4文件中使用可变形重设尺寸(anamorphic resize)？**MPEG-4标准崇尚“多才能”，能够满足大众的各种需求。它提供了三种可能性：
...
-- 一个*分离*滤镜(*splitter/parser* filter)：它能够在回放时将容器中包含的数据流（音频流、视频流、字幕流）分离开。
-- 一个*解码*滤镜(*decode* filter)：它（例如：ffdshow, 3ivx, CoreAAC）能够将编码的数据流解码。
...
在网络上有不少此类的信息：
MP4的说明文件可在**[这里](http://standards.iso.org/ittf/PubliclyAvailableStandards/c041828_ISO_IEC_14496-12_2005(E).zip)**找到。MPEG-4系统标准的草案可在**[这里](http://le-hacker.org/hacks/mpeg-drafts/is144961cd.pdf)**找到。
