# boost bind使用资料 - 三少GG - CSDN博客
2012年12月18日 01:26:10[三少GG](https://me.csdn.net/scut1135)阅读数：664

### [boost bind使用指南](http://blog.csdn.net/adcxf/article/details/3970116)
分类： [c/c++/vc](http://blog.csdn.net/adcxf/article/category/324685)2009-03-08 21:48
4767人阅读[评论](http://blog.csdn.net/adcxf/article/details/3970116#comments)(6)收藏[举报](http://blog.csdn.net/adcxf/article/details/3970116#report)
bind - boost
头文件: boost/bind.hpp
bind 是一组重载的函数模板.
...
bind(_1, 5));//想实现 _1(5);  这样的调用. 但这样不行!
