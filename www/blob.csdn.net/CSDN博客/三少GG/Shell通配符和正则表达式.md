# Shell通配符和正则表达式 - 三少GG - CSDN博客
2013年08月05日 14:43:39[三少GG](https://me.csdn.net/scut1135)阅读数：2832
...
![](https://img-my.csdn.net/uploads/201206/10/1339331278_4493.png)
打开Shell的方式有两种：
...
![](https://img-my.csdn.net/uploads/201206/10/1339332001_2213.png)![](https://img-my.csdn.net/uploads/201206/10/1339332011_6953.png)
![](https://img-my.csdn.net/uploads/201206/10/1339332023_6294.png)
       (2) PuTTY
       这是个比较常用的ssh连接工具。PuTTY的登陆界面如下所示：
![](https://img-my.csdn.net/uploads/201206/10/1339332564_5445.png)
在“主机名称(或IP地址)”栏中输入远程主机的IP地址，点击打开，在出现的界面中输入登陆用户及其密码，成功登陆之后就会出现命令提示符了：
![](https://img-my.csdn.net/uploads/201206/10/1339333377_5117.png)
...
“ . ”符号：表示匹配任意**一个**字符。字符“ . "就表示一个字符，这个字符可以是任意字符。例如字符串 ...73 就表示前面3个字符为任意字符(包括空格)，第4个和第5个字符分别是7和3。
