# CICC科普栏目｜神经网络浅讲：从神经元到深度学习 - 人工智能学家 - CSDN博客
2018年08月14日 23:42:16[人工智能学家](https://me.csdn.net/cf2SudS8x8F0v)阅读数：79
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/f84kJBXzrBXS7WMo15YNV4gA9tJ5LZmiavVKazlgEe1HymERfGHBQ9uakwxNZqCbBSSvl6WbDbmLlKPlQLq4h9A/640?wx_fmt=jpeg)
图1 人脑神经网络
来源： 计算机的潜意识
摘要：神经网络是一门重要的机器学习技术。它是目前最为火热的研究方向–深度学习的基础。
...
十.备注
## **一、前言**
让我们来看一个经典的神经网络。这是一个包含三个层次的神经网络。红色的是**输入层**，绿色的是**输出层**，紫色的是**中间层（也叫隐藏层）**。输入层有3个输入单元，隐藏层有4个单元，输出层有2个单元。后文中，我们统一使用这种颜色来表达神经网络的结构。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa3rPHE7FLibLsIRaE9W6ex34mBQ4vtx90QEfoiaPte73mpMBgWyMOicagA/640?)
图2 神经网络结构图
在开始介绍前，有一些知识可以先记在心里：
设计一个神经网络时，输入层与输出层的节点数往往是固定的，中间层则可以自由指定；
神经网络结构图中的拓扑与箭头代表着**预测**过程时数据的流向，跟**训练**时的数据流有一定的区别；
结构图里的关键不是圆圈（代表“神经元”），而是连接线（代表“神经元”之间的连接）。每个连接线对应一个不同的**权重（其值称为权值）**，这是需要训练得到的。
除了从左到右的形式表达的结构图，还有一种常见的表达形式是从下到上来表示一个神经网络。这时候，输入层在图的最下方。输出层则在图的最上方，如下图：
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa1tRvJCo24LA6d1UpB8n1euqIO1FPtlpvK6QFzYB8oMTiaTDOD5VqTaA/640?)
图3 从下到上的神经网络结构图
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaXItNwHZL6PdibLl8tjicN9bgmLlVpEINOaKbyYDRicheAZrQz8p4I0XBQ/640?)
图4 神经元
1943年，心理学家McCulloch和数学家Pitts参考了生物神经元的结构，发表了抽象的神经元模型MP。在下文中，我们会具体介绍神经元模型。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDavbo6oepePNRoLt3fTmdfxCMQTgicpqmTiaQb6hPjI765VH43JITKCQbg/640?)
图5 Warren McCulloch
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa78bC0WHgd7U2l6rfRXYEL1V7g0kib3pVKp5zZXTYInTbLcvGtgc07UA/640?)
Walter Pitts
**2.结构**
神经元模型是一个包含输入，输出与计算功能的模型。输入可以类比为神经元的树突，而输出可以类比为神经元的轴突，计算则可以类比为细胞核。
下图是一个典型的神经元模型：包含有3个输入，1个输出，以及2个计算功能。
注意中间的箭头线。这些线称为“连接”。每个上有一个“权值”。
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/f84kJBXzrBXS7WMo15YNV4gA9tJ5LZmiaeK8rfNQa5SWrFmfV8RUoblOg29Yh20KmbReJlV2PKtRptafUtEyh4A/640?wx_fmt=jpeg)
图6 神经元模型
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa9zYiaiaLOhC1JAuJx7G5r4ibOEzbjeDWHcSH5ib4h9QNoicMWFPrqiaPzLcA/640?)
图7 连接（connection）
如果我们将神经元图中的所有变量用符号表示，并且写出输出的计算公式的话，就是下图。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa3RCr0CwM6myVDsljn8SE53soQ4PPEZmR7e6ic0dYzGtolxCbyXHo0zA/640?)
图8 神经元计算
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa3H2c0EyXr9fcsruJTZgibreiaYLic8GoAG6M9TsxzNhnmnntDp2ibtFCVQ/640?)
图9 神经元扩展
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaLnFFBIQ1jG32hjhGnWrVroeStcmib1EG2j7cqRZ6ORR0ibEulFpaCCQA/640?)
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaENDFgEZdV5Q6D2dcnmAgHhNrsUicic2KDicwYu0PqFEpHJeeYXYo6PlPw/640?)
图11 Rosenblat与感知器
**2.结构**
下面来说明感知器模型。
在原来MP模型的“输入”位置添加神经元节点，标志其为“输入单元”。其余不变，于是我们就有了下图：从本图开始，我们将权值w1, w2, w3写到“连接线”的中间。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaymJ6s6ploEaYcicyjU1p4yia14gaXkvN5CtaibOptFdNjEN8HKMicp1VDQ/640?)
图12 单层神经网络
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDanTkhibicIM3HmicEmfLWRWY5foYgmKeXtsMyKajTsScLxcRJ7QlukK1Rw/640?)
图13 单层神经网络(Z1)
可以看到，z1的计算跟原先的z并没有区别。
我们已知一个神经元的输出可以向多个神经元传递，因此z2的计算公式如下图。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDapBbIQwzAKzLaF1dic9a9ADl7A3GY3bz8kX6Rr5yE6hhNS0nGkJiaLwKQ/640?)
图14 单层神经网络(Z2)
可以看到，z2的计算中除了三个新的权值：w4，w5，w6以外，其他与z1是一样的。
整个网络的输出如下图。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa47LXZCQHPr3TMnZWqrQ73mDt4vacYtjCfjr1Ps80D2myTeiaftc2xWg/640?)
图15 单层神经网络(Z1和Z2)
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaVD83Fp5WJG7HdswB9gYZmic3Vb5elRC3gibpzwfCQhwZHC9g95et3AjQ/640?)
图16 单层神经网络(扩展)
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaicuSnciazlUYIXb5bo7DAV9zfS7tNYXMmibYlFoJc1ibta0nOYNibGNcQyw/640?)
图17 单层神经网络（决策分界）
**4.影响　**
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa6NRic3LOOubq0gqEtMhagBIuQibSsQhItJVoibJ53pN58dgjDkYAjuHlg/640?)
图18 Marvin Minsky
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaN63mqsFTbliclyHAvKgFNEVBDoYxuBAdgCibwHibIicqraicy0bibx0lwA0Q/640?)
图19 David Rumelhart
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa5UwNaEg6B96ZaiauqwiadcXyzdIHIsSN2uqRyvoKYb2ibNw8niab5vEeoA/640?)
Geoffery Hinton
**2.结构**
两层神经网络除了包含一个输入层，一个输出层以外，还增加了一个中间层。此时，中间层和输出层都是计算层。我们扩展上节的单层神经网络，在右边新加一个层次（只含有一个节点）。
现在，我们的权值矩阵增加到了两个，我们用上标来区分不同层次之间的变量。
例如ax(y)代表第y层的第x个节点。z1，z2变成了a1(2)，a2(2)。下图给出了a1(2)，a2(2)的计算公式。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa27lQX2eTo45DfKiavmyYaMoDjvFVYfqCSMbQdReiasM69gL8V8cP8jiaA/640?)
图20 两层神经网络（中间层计算）
 计算最终输出z的方式是利用了中间层的a1(2)，a2(2)和第二个权值矩阵计算得到的，如下图。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaKhwZqricxkhLzO1ZO5b5kpoUohlfibbJ6HpPczTviaOUUzuBg2eQHm7HQ/640?)
图21 两层神经网络（输出层计算）
 假设我们的预测目标是一个向量，那么与前面类似，只需要在“输出层”再增加节点即可。
我们使用向量和矩阵来表示层次中的变量。a(1)，a(2)，z是网络中传输的向量数据。W(1)和W(2)是网络的矩阵参数。如下图。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaRxPYgQu8zb7oAxf2PEDDNXgHMrcTjzPy3lSOQnhTPNaeoGTSbpFcNQ/640?)
图22 两层神经网络（向量形式）
使用矩阵运算来表达整个计算公式的话如下：
 g(W(1) * a(1)) = a(2);
g(W(2) * a(2)) = z;
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa7gwx48iafOQlPkBeOoZkPzBV6jfDZN2cCMeA35DicZxJjl96SSu4crMw/640?)
图23 两层神经网络（考虑偏置节点）
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaUsLSuN3bZL11rlk6cuh4mRSKVJZyY3Q5ohyjRoSMZbgd4VGICDSR0A/640?)
图24 两层神经网络（决策分界）
可以看到，这个两层神经网络的决策分界是非常平滑的曲线，而且分类的很好。
有趣的是，前面已经学到过，单层网络只能做线性分类任务。而两层神经网络中的后一层也是线性分类层，应该只能做线性分类任务。为什么两个线性分类任务结合就可以做非线性分类任务？
我们可以把输出层的决策分界单独拿出来看一下。就是下图。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaicVfr5vlnxf9gsocNklCRINicEyBWewCGY24Ziay95rXT8FykbvibWfyhQ/640?)
图25 两层神经网络（空间变换）
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaULI9j1sT6z9fRva4koJsEJcN819SfEnpN7MkXZA4tCEjDWymrRmsXA/640?)
图26 EasyPR字符识别网络
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDarD7cGYIgiay2CaicHLRx3F4pNerZXsiaiaJNjb3Zzjm0dhgMHN1ibRE0wZQ/640?)
图27 反向传播算法
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaRJg8jTia4eeOcbBNick0HNGKls47fibotEQPdQNib5AOHxjQhYp2gFy3Uw/640?)
图28 Vladimir Vapnik
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaSkEVDIqQcTSkwLiatOTFs2fw9WX6ZChfmUolAlckVeyOnVDvIRW8SkQ/640?)
图29 Geoffery Hinton
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa6Z7TlhWe8xeUYxVgmhDQxics3zjSMVjjicE3P22YDOEbnosZfpaZVYZg/640?)
图30 多层神经网络
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa94ymaPlKQYmeKNh5SANjM8BNjZUKjr4TSoibTDdVkicgy813VVLNSEJw/640?)
图31 多层神经网络（较少参数）
假设我们将中间层的节点数做一下调整。第一个中间层改为3个单元，第二个中间层改为4个单元。
经过调整以后，整个网络的参数变成了33个。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDawkVRIUasMLq7Kl41aM0W5pwiaxWMvOpYmVcOklPaiaFibuH2V7NxfqFUw/640?)
图32 多层神经网络（较多参数）
虽然层数保持不变，但是第二个神经网络的参数数量却是第一个神经网络的接近两倍之多，从而带来了更好的表示（represention）能力。表示能力是多层神经网络的一个重要性质，下面会做介绍。
在参数一致的情况下，我们也可以获得一个“更深”的网络。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaySTZ8BoATuLGSHpjYuVUfJzE5gSNOibE8xwqUdpqKpDGFceBfnns90w/640?)
图33 多层神经网络（更深的层次）
...
关于逐层特征学习的例子，可以参考下图。
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaiauLdEwJGTdGib4HmnO5SPXbJKa4eoA2DZ62RVX62RpCxRgcNCNXNlTA/640?)
图34 多层神经网络（特征学习）
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/rxOU5rqRdovgBO17vRXu0o7wW21IDfDa8nmiaiaVgZ40XArTcPXzDD2x7p0jkwg50wKCXseDyDr9UTsoHnMD4QbA/640?)
图35 Yann LeCun
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaNNFtsn3suDf0icgSFqywyhg4SKzfKqhthAvgUaYliciaqLJMV1C4ibZEJw/640?)
Yoshua Bengio
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaW9xAOMzaDuVibuxEXTibubnKUX8DEymZoAYYLpfNxEyiczlExNibRaKq4w/640?)
图36 三起三落的神经网络
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDafYzMkOK9fAQUFNHALIwGddyKK1J0OEkGic1gIlkR7FbAdhuEh3rmzJA/640?)
 图37 表示能力不断增强
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaCowNjia5Rj3t82uZIcAQch2VYXHiaEpJxbU5DQDIyWXbicjvrkunuTrKA/640?)
图38 发展的外在原因
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDayjcq7NKT1clZgFG9jlKUqOdbILkXfYB8Y92SxQN12qJVdJR3gqIeicg/640?)
图39 量子计算
**2.人工智能**
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaccu1HJrLVpr3LhfdnunOlZWJHVqTDta3Gp63hLicD1fzJL7C3WzZSew/640?)
图40 人工智能
## **八、总结**
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaDnZK9yKlBrQFcTY1LJx63G9x7qvmiapGjZ9ibPP0sFjJGds9A3Ot9rnA/640?)
图41 神经网络的类别
...
![640?](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/rxOU5rqRdovgBO17vRXu0o7wW21IDfDaSUBNpeUWfUg7bUtjqZnc1Vsf6icm4qMZuFJic7iauS5riafl9HtMp3BIdg/640?)
图42 Ng与神经网络
