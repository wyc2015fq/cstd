# 让计算机拥有一双眼睛，人工智能科学家已经努力了半个世纪 - 人工智能学家 - CSDN博客
2017年09月26日 00:00:00[人工智能学家](https://me.csdn.net/cf2SudS8x8F0v)阅读数：163

![640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/f84kJBXzrBXDzbjqsQCQUiaPD85zS5tB11jPNBtHCuEBITIZP82r2owIwC05ibibGMiaGHuNK4ee5mAibdJib59gtAsQ/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1)
*来源：科技行者*
...
![0?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/f84kJBXzrBXDzbjqsQCQUiaPD85zS5tB1ULovHPNI7TWCzcwxDSrWD9yyg9JetIV3nQNEjVvSYwmp1LaknWKbNQ/0?wx_fmt=jpeg)
...
**但是，如果图片是这样的呢？**
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/pNoroqw9XtuQeWQrBjcRd87QkI94EcQicg4gCawwwzEmfIbhOicUsycxZtHCSsMGIrmX4IstvgF03dca53CIxbCg/640?wx_fmt=jpeg)
...
*![0?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/f84kJBXzrBXDzbjqsQCQUiaPD85zS5tB1y9cGT18RCFlFQicpYEIrpAjdLeueD3tulwXxBvJROM4OgDBN7NTfp4Q/0?wx_fmt=jpeg)*
*图：典型的卷积神经网络架构*
...
**第一步：把图片分解成部分重合的小图块**
![0?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/f84kJBXzrBXDzbjqsQCQUiaPD85zS5tB1syFHXuUVAdEojicKhNicuISkeNcBwoXv7yWR8HoYPF4gvJLapbG15ia3g/0?wx_fmt=jpeg)
*于是图片被分解成了 77 块同样大小的小图块。*
**第二步：把每个小图块输入到小型神经网络中**
*![0?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/f84kJBXzrBXDzbjqsQCQUiaPD85zS5tB1w0QvNu1ohBwXfibOsOZG334fadv0ibhyaWVyBxrPblONh0czWV4lvsQQ/0?wx_fmt=jpeg)*
...
![0?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/f84kJBXzrBXDzbjqsQCQUiaPD85zS5tB1kubfyWCnq5XLxnouUTyOLuD95U5OyIKMibnZJJDMn6uxxvMiaAjPKtrA/0?wx_fmt=jpeg)
**第四步：缩减像素采样**
第三步的结果是一个数组，这个数组对应着原始图片中最异常的部分。但是这个数组依然很大:
![0?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/f84kJBXzrBXDzbjqsQCQUiaPD85zS5tB1rEkmW3BXmm5keNHkiau3BczaIHkZ15PEGvPiaNfajl5fmw8HbAIuf0Ew/0?wx_fmt=jpeg)
为了减小这个数组的大小，我们利用一种叫做最大池化（max pooling）的函数来降采样（downsample）。但这依然不够！
让我们先来看每个 2×2 的方阵数组，并且留下最大的数：
![0?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/f84kJBXzrBXDzbjqsQCQUiaPD85zS5tB1eIMolqydRicCxSRHiaFu4gMYPevxia49MNmVMpjtSrBqPw6CHdS8iaiblqg/0?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/pNoroqw9XtuQeWQrBjcRd87QkI94EcQicCvZw9uiaNayRpEibRg81mI5RRe1yt4D5TXwTHSAuRwGjSAA3ombibyjAQ/640?wx_fmt=jpeg)
...
![0?wx_fmt=gif](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_gif/pNoroqw9XtuQeWQrBjcRd87QkI94EcQicJsNpicK0aSwCOmZfmZVvrFCQnbuepcy8eZkk4esWm6Fvh7dOw7iaFwyg/0?wx_fmt=gif)
*这里有一张谷歌图像搜索的时间表。*
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/pNoroqw9XtuQeWQrBjcRd87QkI94EcQic7DvoUg2VZsKVNoBoypGrrKVicbHXsvYmvDgLW42Mr6yicbmJ6CkN733Q/640?wx_fmt=jpeg)
**IBM沃森视觉识别**
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/pNoroqw9XtuQeWQrBjcRd87QkI94EcQicWibbgGWia7XMcR6ic79gJkQ8U4QVLXnab491uoW1zibZFJCibHEIJce7HFA/640?wx_fmt=jpeg)
