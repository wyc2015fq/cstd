# 卷积神经网络为什么能称霸计算机视觉领域？ - 人工智能学家 - CSDN博客
2018年04月27日 00:00:00[人工智能学家](https://me.csdn.net/cf2SudS8x8F0v)阅读数：2279
![640?wx_fmt=png&wxfrom=5&wx_lazy=1](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/f84kJBXzrBWickMhiao4pFUhgTvjv48rdRtXIMJo3Hl0glPcmK427qFHqW7Jeum6DiayB9ZkuqVmXFh3lEPDicQJXQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1)
来源：图灵人工智能
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4bEGWCicAxyZ1a5p8B6BCWxBmKVqT0lS3ZtOJ65sBngqO39Dp9Jicicjsg/640?wx_fmt=jpeg)
视觉皮层结构
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4eYTZpfzF6JpHhHrTLuPEOuZUs1cfk63u4VdjSn0nTnNyC3bomYxEibQ/640?wx_fmt=jpeg)
假设输入图像的矩阵为以（x,y）为中心的3x3子图像为：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4RLGFgqbN0N1aCVmjbIqxZj5WrKXFLcPElnCn2wIAlFvibXicN7bQTWNg/640?wx_fmt=jpeg)
在该点处的卷积结果按照如下方式计算：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4BewSSLBQTfXE07HIsVrh9myJfEfibMvLzlsVLCCp3eM8BmM3cwzoZRg/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb44qnYUlmAqicicV7MofxyeMSicuJmLGHc8cyiapEqyq5zEH8jzViaenYuiaLA/640?wx_fmt=jpeg)
Sobel算子卷积结果
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4Cy3GCLhBx3FLLwmGibM7bQ4voDE1gpNbfGPFbAwyz3x9UTrsnHibFQRw/640?wx_fmt=jpeg)
卷积核为：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb48cUOyJcAntpzzx3oxxZDfbkPuSVbSibC8nRSIoqCxxKYNCDMIra1aJg/640?wx_fmt=jpeg)
首先用图像第一个位置处的子图像，即左上角的子图像和卷积核对应元素相乘，然后相加，在这里子图像为：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4BOagQ55c0H2MBZDTRR3n6TA1ich6IyzibicEkRRp9TkOvE3UFzEDw0sQw/640?wx_fmt=jpeg)
卷积结果为：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4ZZIzAmRp0rzbiagxUlLdjoujAOo9QibtNF60EJIfUs9eX6KsicNrXDzUw/640?wx_fmt=jpeg)
接下来在待卷积图像上向右滑动一列，将第二个位置处的子图像：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4qAicyd1veufCAdRncoPcdj3MlAuO1Yx2AnEXic0VvXntA5VnjDwJoAUQ/640?wx_fmt=jpeg)
与卷积核卷积，结果为154。接下来，再向右滑动一位，将第三个位置处的子图像与卷积核进行卷积，结果为166。处理完第一行之后，向下滑动一行，然后重复上面的过程。以此类推，最后得到卷积结果图像为：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4vCXF294CbROqD0x5iarYObBXNlBv70XRZYTfz2mrvOuqDxRwSgvndUQ/640?wx_fmt=jpeg)
...
下图是一个简单的例子：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/75DkJnThACngFp2P5DZhVDuOhIeJyIb4BBzyxnibticlicUVAzzMI9X5ELGGwGYHwqVH3BUUOxDddlqDDtQebDSlw/640?wx_fmt=png)
多通道卷积
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4TeFenvAMXWPyxp2HbOWCcY0Mic1T38qbKx3XX7qYfZYX4T85J5iaZlbA/640?wx_fmt=jpeg)
在这里进行无重叠的2x2max池化，结果图像为：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb46TLPW4k6tMverTlavHWhA2wG01sp6Sd6AeXa6P7cjU9WLtsbRfkuyQ/640?wx_fmt=jpeg)
结果图像中第一个元素11是原图左上角2x2子图像：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4e89j6M8Xn7ic1dYwVF7QuHBshtBkDRBk6bwiajZReIPscUCiavk6IogSg/640?wx_fmt=jpeg)
元素的最大值11。第二个元素9为第二个2x2子图像：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb48wZia2JO61SfwzUlcqiatt8CTK1dYa9WlNroInpZI7ucFIFMtavNymEQ/640?wx_fmt=jpeg)
元素的最大值9，其他的以此类推。如果是采用的均值下采样，结果为：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb47Qr0B0E8UGSoMVNABl8J9wym5deqibzYmS8ZtdMXbAEqicxjAfBWY2Vg/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4DUonDiaWo2pVloDjzNiaBLXGI7SpNbL6LmbSw95iaYkpClK2EpaWUZsMw/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4IwibfO8KM1u2gW8My4EfVHK17OLbl43nkvicWFOPCL6QoRzSGqPj1x8g/640?wx_fmt=jpeg)
卡车图像
用AlexNet网络处理之后，第一个卷积层的输出结果（我们把各个卷积核的结果依次排开了）是这样的：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb43iaiaVFZTpMPK0pnPVefhh6C7p4mkpcia3Av3HjodsbVibSlWjIrribHk9w/640?wx_fmt=jpeg)
卷层1的结果
可以看到这里抽取了一些边缘信息。第二个卷积层的输出结果是这样的：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4jiaT49wHEibdptvyWlzAZ7GwtibEjQztbrGpcesbjnYk83sniaJCvDH5dQ/640?wx_fmt=jpeg)
卷层2的结果
它抽取了更大区域的特征。后面几个卷积层的结果是这样的：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4nY86rdpgb0SfFz4icTt41icyTwSOqKhxorL5NG5Rz1vZUHDT0hdEibfSQ/640?wx_fmt=jpeg)
卷层3—5的结果
卷积层3-5的结果在上图中依次排开。然后我们看全连接层，下图自上向下是3个全连接层的输出结果：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4ib9LD28vkaNK6rLHqMYdqgAoh7zRGvnorXujI5UDtcryrF5tiaJqHGjA/640?wx_fmt=jpeg)
全连接层的结果
我们再来看卷积核的可视化结果。第一个卷积层的卷积核图像如下图所示：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4k4hdHia16QCnJnEl3nNfBBDxKibGrArSXD1xaULHkerkicdYYK3ky8cUg/640?wx_fmt=jpeg)
     卷积层1的卷积核
     可以看到，这些卷积核确实是在提取边缘，方向等信息。再看第2个卷积层的卷积核：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyIb4Xe4arB3otaTpmgrWa6pQ6I3n1VL0PwqxaQC2gCHdyOdwvGLViaI38Ww/640?wx_fmt=jpeg)
卷积层2的卷积核
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/75DkJnThACngFp2P5DZhVDuOhIeJyI