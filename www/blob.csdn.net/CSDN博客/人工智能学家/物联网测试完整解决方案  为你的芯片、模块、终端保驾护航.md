# 物联网测试完整解决方案 | 为你的芯片、模块、终端保驾护航 - 人工智能学家 - CSDN博客
2018年03月13日 00:00:00[人工智能学家](https://me.csdn.net/cf2SudS8x8F0v)阅读数：1711
![640?wx_fmt=png&wxfrom=5&wx_lazy=1](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK778yiaHZykqAbFXyLibdGAiaQVQ2dZaG4yWZmnRlRyghwocY0XSiaXTaqHAFxhMKSschmgq1nKiajGDAl7g/640?wx_fmt=png&wxfrom=5&wx_lazy=1)
来源：物联网智库
2017年被视为物联网商用元年。
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK778yiaHZykqAbFXyLibdGAiaQVQiaFV21PDb8YLibrtInfwGk1gqNJKPO7BdRKNrXVHgOe30FQ9bX5PQOeQ/640?wx_fmt=png)
**2、功耗和电池寿命测试**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK778yiaHZykqAbFXyLibdGAiaQVQd4GUicjyPzq6iahkvgCFWUsbVaEPJs7y1NGJGXojCVk5HJqo7yBHIjZA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK778yiaHZykqAbFXyLibdGAiaQVQm9OQ7TvUmrXXsxps71xnnXQN7k9Dp4KBJonu4wQogv4zq8SAfGVLFQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK778yiaHZykqAbFXyLibdGAiaQVQt6diczKS9QWDcThv3QjsIT4lhmChMicUX72k8Vb1JEBFEribsUrM2XV0A/640?wx_fmt=png)
**>>> 真实工况下的电池容量和电池自放电测量**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK778yiaHZykqAbFXyLibdGAiaQVQacWVr6XJdYH4FfxVpfSbKZYJegDN6EpFTmUqyBstDCicmjlSu2hWWrw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK778yiaHZykqAbFXyLibdGAiaQVQUw6YS1nHMTKgwHJ9OBgnBRAzQxVjT0iadlpYxArlCDo7roibia23Z7drg/640?wx_fmt=png)
**3、NB-IoT射频测试**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK77ibcKwKRJJLich499XujXyssRrYp7OTI0QGbDh3P2xNL9Yueo6LWctKBeKHN7dKHumxB9SdEtdeoLGw/640?wx_fmt=png)
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK77ibcKwKRJJLich499XujXyssRPfleaSfjB6uR9XJTcyyD4f7CXu7Bu0vqKTY2oZCTOLZxLvE5SiaSWcg/640?wx_fmt=png)
**>>> 发接收机指标评估测试**
- 
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK77ibcKwKRJJLich499XujXyssRmPTSqILibkMylvAbRv5zNWiaKIJUR7BnDticPAeMRgBmms0ezXiclcTKxw/640?wx_fmt=png)
**4、NB-IoT一致性测试**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK77ibcKwKRJJLich499XujXyssRG9DMjHUZkBQWvxV8fVv2iaMqyjYY3C1UjE0Nf7vgcKkmBP6EghrXjmg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK77ibcKwKRJJLich499XujXyssRWHduWAL3lm7U85u5JiaMS3ia1crdxFyB2lXcic31VfEia9SoHGk0NrbcJQ/640?wx_fmt=png)
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK77ibcKwKRJJLich499XujXyssRKVE4micu56QWCOVssC3fUU6qLic89YGSDwLOqHP15GvnfANkaYLCvnYw/640?wx_fmt=png)
**>>> 干扰和故障排查**
如果在预测试的时候发现了EMI故障，我们可以按照使用相应的测试工具进行排查，这包括了使用频谱仪和近场探头扫描特定的频段，确认噪声源的时域和频域表现，根据测量结果测算出EMI噪声的传播路径，最终整改EMI噪声源及其传播途径，并验证改进后的效果。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/Z0qPK2ZK77ibcKwKRJJLich499XujXyssRUicJfqOStJLicv2cSpGs16KdicEFQFH7b2rZchG3DR69NcxEtzMsE1rDw/640?wx_fmt=png)
