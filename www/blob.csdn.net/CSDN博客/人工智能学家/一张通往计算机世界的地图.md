# 一张通往计算机世界的地图 - 人工智能学家 - CSDN博客
2017年10月12日 00:00:00[人工智能学家](https://me.csdn.net/cf2SudS8x8F0v)阅读数：133
![640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51tyGC1pkdMuL5JYtPopPWYWKHWl6rMoD05MhcicB5SkoN4eicqrJPyBZUg/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1)
...
**计算机理论**
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51tibOPkkB9vXoaZJJK5lT67RiavDN8jFgzJACkEo5Xx2h3cJLRTOUenZjQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51t3ibibriaXn7ibrd8ywC3rIGKPSIgHEUYqcdTdwGMQ6OoFvXTFibTdoMTO5g/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51tyKhOxXYKIUbiaIZWibgA6SuxaGrPpf2icXmIS0ATuFQXLsAgFTjnVk02w/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51tibeouk1jQic3F4Gzz8o9zMyDg0bOr8iaA3CfJ7EibibkjS3v7jAO9XfHnNg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51twvTY1xaEUd7tiaImQFxqibOhssXHAfibFFdK7GgCv7XOdHrkLYZmq0WVA/640?wx_fmt=png)
* 信息理论和密码学。 | 图片来源：Dominic Walliman *
以上就是计算机理论分支中非常重要的部分。当然除此之外，还有很多其他组成部分，包括逻辑学，图形学，计算几何学，自动机理论，量子计算，并行处理，数据结构等。这里不再一一列举。
**计算机工程**
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51teC9DU9ssIsntzcDicf3ksCE0HTHd56CP0eolKDSf5MRRJqibjtOibZicdQ/640?wx_fmt=png)
...
*![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51trMmG5MsUT0DI5fPCPkaGdWvTn1w6OV5n3VYFehR7ULDibt9bBVqlrjA/640?wx_fmt=png)*
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51tnBdsLrZNiaxwklg7DEExOGfUzyQZ0M9HiaqK4epAicO6Ud57bWXHXCaeg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51tFp9xBrIPXfhyngdGKxjGcFxibfqh1tfvPiaFpkZrqdNkKh3ulJibiakLiaQ/640?wx_fmt=png)
...
**计算机应用**
*![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51tv783TpdiaM0UtTcfIgPfJiagAMqVfG0hy1NejHYsA53mG3sKgS57WOYg/640?wx_fmt=png)*
...
*![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/tqOuxs8dsHNnqjPWg4YNhoJTP0PEN51teiaozGCYYPiaWibyWNSTZMOqZeUqPbg0ic3HE7OAST91DJcXIr5tMfEfaA/640?wx_fmt=png)*
...
除了上述的领域，计算机应用这一分支也利用计算机来研究科学问题，例如物理学和神经学。这个领域通常使用超级计算机来解决大规模的模拟（Simulation）问题。与此同时计算机应用还包括人机交互（Human Computer Interaction）的研究，旨在设计让用户更加轻松使用的计算机系统。同时，虚拟现实（Virtual Reality，例如戴在头上的VR眼镜），增强现实（Augmented
 Reality，例如之前很流行的一款pokemon go 的游戏）以及混合现实（Mixed Reality, 例如用手机扫描实体书的时候能看到网上的书评）的研究将虚拟和现实世界渐渐联系在一起。机器人（Robotics）的研究也将机器在形态和运动方式上和人更加相似。
...
[](http://mp.weixin.qq.com/s?__biz=MzA4NDU1MDY5OA==&mid=2653187020&idx=1&sn=d6f354204156e8bb77316e5e7d226ad1&chksm=8435be89b342379f6b9070299889e74fd1629697f21d862dcac6ee20d4f14eb90f3f14780e57&scene=21#wechat_redirect)
