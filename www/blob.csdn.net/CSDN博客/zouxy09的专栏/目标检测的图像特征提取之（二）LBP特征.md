...
# 目标检测的图像特征提取之（二）LBP特征 - zouxy09的专栏 - CSDN博客


2012年08月31日 15:33:21[zouxy09](https://me.csdn.net/zouxy09)阅读数：145677
...
图2.5给出了求取旋转不变的LBP的过程示意图，图中算子下方的数字表示该算子对应的LBP值，图中所示的8种LBP模式，经过旋转不变的处理，最终得到的具有旋转不变性的LBP值为15。也就是说，图中的8种LBP模式对应的旋转不变的LBP模式都是00001111。
...
Reference：
黄非非，基于LBP的人脸识别研究，重庆大学硕士学位论文，2009.5
