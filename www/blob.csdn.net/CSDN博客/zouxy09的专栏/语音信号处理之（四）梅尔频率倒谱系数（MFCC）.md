...
# 语音信号处理之（四）梅尔频率倒谱系数（MFCC） - zouxy09的专栏 - CSDN博客


2013年06月23日 21:05:57[zouxy09](https://me.csdn.net/zouxy09)阅读数：127522个人分类：[语音识别与TTS																](https://blog.csdn.net/zouxy09/article/category/1218766)[机器学习																](https://blog.csdn.net/zouxy09/article/category/1333962)[
...
![](https://img-blog.csdn.net/20130623205905281?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvem91eHkwOQ==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
...
那怎么把他们分离开呢？也就是，怎么在给定log X[k]的基础上，求得log H[k]和log E[k]以满足log X[k] = log H[k] + log E[k]呢？
...
把它俩叠加起来就是原来的频谱信号了。
![](https://img-blog.csdn.net/20130623210235781?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvem91eHkwOQ==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
...
**三、****Mel****频率分析（****Mel-Frequency Analysis****）**
...
**四、****Mel****频率倒谱系数（****Mel-Frequency Cepstral Coefficients****）**
