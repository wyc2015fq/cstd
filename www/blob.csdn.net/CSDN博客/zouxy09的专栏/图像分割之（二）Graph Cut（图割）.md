...
# 图像分割之（二）Graph Cut（图割） - zouxy09的专栏 - CSDN博客


2013年01月23日 00:32:20[zouxy09](https://me.csdn.net/zouxy09)阅读数：156403
...
《Interactive Graph Cuts for Optimal Boundary & Region Segmentation of Objects in N-D Images》（Boykov，iccv01）这篇paper讲怎么用graphcut来做image
 segmentation。
在Boykov和Kolmogorov俩人的主页上就有大量的code。包括maxflow/min-cut、stereo algorithms等算法：
