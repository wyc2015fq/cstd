...
# 几分钟内学习 Clojure - 阳光岛主 - CSDN博客

2013年11月18日 22:28:57[阳光岛主](https://me.csdn.net/sunboy_2050)阅读数：5936所属专栏：[Clojure 学习总结](https://blog.csdn.net/column/details/learn-clojure.html)



**[Clojure](http://clojure.org/)**是JVM上的一个LISP语言变种，它比Common Lisp更强调纯函数式编程，但提供了一些STM工具以处理它所引入的状态问题。
Clojure源码托管在：[github](https://github.com/clojure/clojure)
在线练习编译环境：[himera](http://himera.herokuapp.com/index.html)

[learnclojure.clj](http://learnxinyminutes.com/docs/clojure/)示例：
...
[ClojureScript REPL](http://himera.herokuapp.com/index.html)
