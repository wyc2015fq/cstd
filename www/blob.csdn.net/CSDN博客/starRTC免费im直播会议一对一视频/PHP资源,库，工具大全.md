# PHP资源,库，工具大全 - starRTC免费im直播会议一对一视频 - CSDN博客
2017年08月01日 09:26:46[starRTC免费IM直播会议一对一视频](https://me.csdn.net/elesos)阅读数：447

内容包括：库、框架、模板、安全、代码分析、日志、第三方库、配置工具、Web 工具、书籍、电子书、经典博文等等。
大家可以搜索其它语言，如awesome-java的[https://github.com/akullpp/awesome-java](https://github.com/akullpp/awesome-java)
## 依赖管理
### [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=2)]依赖和包管理库
Composer/Packagist：一个包和依赖管理器
Composer Installers：一个多框架Composer库安装器
Pickle：一个PHP扩展安装器
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=3)]其他的依赖管理
其他的相关依赖管理:
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=4)]框架
Web开发框架:
...
Phalcon -通过C扩展实现的框架
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=5)]其他框架
其他Web开发框架:
Symfony CMF - 创建自定义CMS的内容管理框架
Knp RAD Bundle -Symfony 2的快速应用程序（RAD）包
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=6)]框架组件
来自web开发框架的独立组件:
Symfony2 Components -Symfony2组件
Zend Framework 2 Components -ZF2组件
Aura Components -PHP5.4组件包
Hoa Project -另一个PHP组件包
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=7)]微型框架
微型框架和路由:
...
Pux -另一个快速路由库
编者补充：现在有了lumen
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=8)]其他微型框架
其他相关的微型框架和路由:
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=9)]模板
模板化和词法分析的库和工具:
Twig -一个全面的模板语言
...
Plates -一个原生PHP模板库
Lex -一个轻量级模板解析器
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=10)]静态站点生成器
预处理工具来生成web页面的内容:
Sculpin -转换Markdown和Twig为静态HTML的工具
Phrozn - 另一个转换Textile，Markdown和Twig为HTML的工具
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=11)]HTTP
用于HTTP和网站爬取的库:
Guzzle-一个全面的HTTP客户端
Buzz -另一个HTTP客户端
Requests -一个简单的HTTP库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=12)]URL
解析URL的库:
Purl -一个URL处理库
PHP Domain Parser -一个本地前缀解析库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=13)]Email
发送和解析邮件的库:
SwiftMailer - 一个邮件解决方案
PHPMailer- 另一个邮件解决方案
Fetch -一个IMAP库
Email Reply Parser -一个邮件回复解析库
Stampie -邮件服务库，A library for email services such as SendGrid, PostMark, MailGun 和 Mandrill.
CssToInlineStyles -一个在邮件模板内联CSS的库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=14)]文件
文件处理和MIME类型检测库:
Gaufrette -一个文件系统抽象层
...
CSV - 一个CSV数据处理库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=15)]Streams 流
处理流的库
Streamer - 一个面向对象的流包装库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=16)]Dependency Injection依赖注入
实现依赖注入设计模式的库:
Pimple - 一个小的依赖注入容器
Auryn - 另一个依赖注入容器
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=17)]Imagery 图像
处理图像的库
Imagine -一个图像处理库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=18)]Testing 测试
测试代码和生成测试数据的库
PHPUnit-一个单元测试框架
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=19)]Continuous Integration 持续集成
持续集成的库和应用:
Travis CI- 一个持续集成平台
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=20)]Documentation 文档
生成项目文档的库
Sami -一个API文档生成器
APIGen -另一个API文档生成器
PHP Documentor 2 -一个API文档生成器
phpDox - 一个PHP项目的文档生成器（不限于API文档）
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=21)]Security 安全
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=22)]Passwords 密码
处理和存储密码的库和工具:
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=23)]Code Analysis 代码分析
分析，解析和处理代码库的库的工具
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=24)]Debugging调试
调试代码的库和工具
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=25)]Build Tools 构建工具
项目构建和自动化工具
Go -一个简单的PHP构建工具
Bob - 一个简单的项目自动化工具
Phake -一个PHP克隆库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=26)]Task Runners 任务运行器
自动运行任务的库
Task -一个灵感来源于Grunt和Gulp的纯PHP任务运行器
Robo -一个面向对象配置的PHP任务运行器
Bldr -一个构建在Symfony组件上的PHP任务运行器
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=27)]Navigation导航
构建导航结构的工具
KnpMenu - 一个菜单库
Cartographer -一个站点地图生成库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=28)]Asset Management 资源管理
管理，压缩和最小化web站点资源的工具
Assetic - 一个资源管理的管道库
Pipe -另一个资源管理的管道库
Munee -一个资源优化库
...
Puli - 一个检测资源绝对路径的库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=29)]Geolocation 地理位置
为地理编码地址和使用纬度经度的库。
GeoCoder -一个地理编码库
GeoTools -一个地理工具相关的库
PHPGeo -一个简单的地理库
GeoJSON -一个地理JSON的实现
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=30)]Date and Time 日期和时间
处理日期和时间的库
Carbon- 一个简单的日期时间API扩展
ExpressiveDate -另一个日期时间API扩展
CalendR - 一个日历管理库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=31)]Event 事件
时间驱动或非阻塞事件循环实现的库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=32)]Logging 日志
生成和处理日志文件的库
Monolog- 一个全面的日志工具
KLogger -一个易用的PSR-3兼容的日志类
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=33)]E-commerce 电子商务
...
Swap -一个汇率库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=34)]PDF
处理PDF文件的库和软件
Snappy -一个PDF和图像生成器库
WKHTMLToPDF -一个将HTML转换为PDF的工具
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=35)]Database 数据库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=36)]Migrations 迁移
帮助管理数据库模式和迁移的库
PHPMig -另一个迁移管理库
Phinx - 另一个数据库迁移管理库
Migrations-一个迁移管理库
Doctrine Migrations -一个Doctrine迁移库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=37)]NoSQL
处理NoSQL后端的库
MongoQB -一个MongoDB查询构建库
Monga -一个MongoDB抽象库
Predis - 一个功能完整的Redis库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=38)]Queue 队列
处理事件和任务队列的库
Pheanstalk -一个Beanstalkd 客户端库
PHP AMQP -一个纯PHP AMQP库
Thumper - 一个RabbitMQ模式库
Bernard -一个多后端抽象库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=39)]Search 搜索
在数据上索引和执行查询的库和软件
ElasticSearch PHP -ElasticSearch的官方客户端库
Elastica -ElasticSearch的客户端库
Solarium -Solr的客户端库
SphinxQL query builder -Sphinx搜索引擎的的查询库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=40)]Command Line 命令行
构建命令行工具的库
Boris - 一个微型PHP REPL
PsySH - 另一个微型PHP REPL
Pecan -一个事件驱动和非阻塞内核
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=41)]Authentication 身份验证
实现身份验证的库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=42)]Markup 标记
处理标记的库
Decoda -一个轻量级标记解析库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=43)]Strings 字符串
解析和处理字符串的库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=44)]Numbers 数字
处理数字的库
Numbers PHP -处理数字的库
Math -处理大数字的库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=45)]Filtering and Validation 过滤和验证
过滤和验证数据的库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=46)]REST和API
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=47)]Caching 缓存
缓存数据的库
Alternative PHP Cache (APC) - 打开PHP伪代码缓存
Cache-一个缓存库（Doctrine部分）
Stash -另一个缓存库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=48)]数据结构和存储
实现数据结构和存储技术的库
Ardent -一个数据结构库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=49)]Notifications 通知
处理通知软件的库
Nod -一个通知库（Growl等）
Notificato - 一个处理推送通知的库
Notification Pusher -一个设备推送通知的独立库
Notificator -一个轻量级的通知库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=50)]Deployment 部署
项目部署库
Pomander -一个PHP应用部署工具
Rocketeer -PHP世界里的一个快速简单的部署器
Envoy -一个用PHP运行SSH任务的工具
Plum - 一个部署库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=51)]国际化和本地化
国际化（I18n）和本地化（L10n）:Aura.Intl
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=52)]第三方API
访问第三方API的库
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=53)]Extensions 扩展
帮组构建PHP扩展的库
Zephir -用于开发PHP扩展，且介于PHP和C++之间的编译语言
PHP CPP -一个开发PHP扩展的C++库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=54)]Miscellaneous 杂项
不在上面分类中的有用库和工具
Spork -一个处理forking的库
...
print_o - 一个对象图的可视化器
Alias -一个类别名库
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=55)]software 软件
创建一个开发环境的软件
### [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=56)]PHP安装
在你的电脑上帮助安装和管理PHP的工具
HomeBrew -一个OSX包管理器
...
### [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=57)]Development Environment 开发环境
创建沙盒开发环境的软件和工具
Vagrant -一个便携的开发环境工具
Ansible - 一个非常简单的编制框架
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=58)]Virtual Machines 虚拟机
相关的PHP虚拟机
HipHop PHP -Facebook出品的PHP虚拟机，运行时和JIT
HippyVM -另一个PHP虚拟机
Hack - 一个PHP进行无缝操作的 HHVM编程语言
### [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=59)]IDE 集成开发环境
支持PHP的集成开发环境
Netbeans -一个支持PHP和HTML5的IDE
Eclipse for PHP Developers -一个基于Eclipse平台的PHP IDE
PhpStorm-一个商业PHP IDE
### [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=60)]Web Applications --Web应用
基于Web的应用和工具
3V4L一个在线的PHP shell
DBV -一个数据库版本控制应用
PHP Queue -一个管理后端队列的应用
Composer **as** a Service - 作为一个**zip**文件下载Composer包的工具
MailCatcher - 一个抓取和查看邮件的web工具
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=61)]Resources 资源
各种提高你的PHP开发技能和知识的资源，比如书籍，网站，文章
### [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=62)]PHP网站
PHP相关的有用网站
...
### [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=63)]Other Websites 其他网站
web开发相关的有用网站
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=64)]PHP 书籍
PHP相关的非常好的书籍
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=65)]其他书籍
与一般计算和web开发相关的书
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=66)]PHP视频
PHP相关的非常不错的视频
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=67)]PHP阅读
PHP相关的阅读资料
...
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=68)]PHP Internals Reading PHP内核阅读
阅读PHP内核或性能相关的资料
PHP RFCs - PHP RFCs主页（请求注解）
PHP Internals Book - 一本由三名核心开发编写的关于PHP内核的在线书
Print vs Echo, Which One is Faster? -一篇关于打印和**echo**性能的文章
...
开发人员的PHP源代码： 1234 -关于PHP源代码的系列
垃圾收集： 123 关于PHP垃圾收集原理的系列
## [[编辑](http://192.168.1.100/elesos_com/index.php?title=PHP%E8%B5%84%E6%BA%90%E5%A4%A7%E5%85%A8&action=edit&section=69)]艺搜参考
[https://github.com/ziadoz/awesome-php](https://github.com/ziadoz/awesome-php)
[http://blog.jobbole.com/82908/](http://blog.jobbole.com/82908/)
