# 双目测距（三）--立体匹配 - 工作笔记 - CSDN博客





2016年07月26日 09:57:34[Eason.wxd](https://me.csdn.net/App_12062011)阅读数：10026
...
![](http://hi.csdn.net/attachment/201010/26/0_128808555546yB.gif)
...
**![](http://hi.csdn.net/attachment/201010/26/0_12880855628YUv.gif)**
...
**![](http://hi.csdn.net/attachment/201010/26/0_1288085569qzrj.gif)**
...
**![](http://hi.csdn.net/attachment/201010/26/0_128808557997cC.gif)**
...
**![](http://hi.csdn.net/attachment/201010/26/0_1288085586CO9f.gif)**
...
**![](http://hi.csdn.net/attachment/201010/26/0_1288085592Y3Ny.gif)**
...
**![](http://hi.csdn.net/attachment/201010/26/0_1288085599HDQa.gif)**
...
**![](http://hi.csdn.net/attachment/201010/26/0_1288085608FwLf.gif)**
...
(1) 新增了 SGBM 立体匹配算法（源自Heiko Hirschmuller的《[Stereo Processing by Semi-global Matching and Mutual Information](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.88.8897&rep=rep1&type=pdf)》），可以获得比 BM 算法物体轮廓更清晰的视差图（但低纹理区域容易出现横/斜纹路，在
...
在**OpenCV2.1中，BM算法可以用 CV_16S 或者 CV_32F 的方式输出视差数据**，使用32位float格式可以得到真实的视差值，而CV_16S 格式得到的视差矩阵则需要 除以16 才能得到正确的视差。另外，OpenCV2.1另外两种立体匹配算法
...
**CV_STEREO_BM_XSOBEL（水平方向Sobel算子，默认类型）**, 该参数为 int 型； 
...
**stereo_match.cpp 给出了 P1 和 P2 比较合适的数值**。 
