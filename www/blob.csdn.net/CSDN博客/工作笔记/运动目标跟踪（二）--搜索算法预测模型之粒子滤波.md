# 运动目标跟踪（二）--搜索算法预测模型之粒子滤波 - 工作笔记 - CSDN博客





2016年06月25日 16:33:44[Eason.wxd](https://me.csdn.net/App_12062011)阅读数：6951
...
[http://blog.csdn.net/jinshengtao/article/details/30970733](http://blog.csdn.net/jinshengtao/article/details/30970733)

推荐大家看论文《An adaptive color-based particle ﬁlter》
...
![](https://img-blog.csdn.net/20140615100454281)

![](https://img-blog.csdn.net/20140615100502421)

![](https://img-blog.csdn.net/20140615100513125)

![](https://img-blog.csdn.net/20140615100519281)

![](https://img-blog.csdn.net/20140615100525265)

![](https://img-blog.csdn.net/20140615100535453)

![](https://img-blog.csdn.net/20140615100542375)

![](https://img-blog.csdn.net/20140615100552578)
...
**[cpp]**[view plain](http://blog.csdn.net/jinshengtao/article/details/30970733#)[copy](http://blog.csdn.net/jinshengtao/article/details/30970733#)[print](http://blog.csdn.net/jinshengtao/article/details/30970733#)[?](http://blog.csdn.net/jinshengtao/article/details/30970733#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)![派生到我的代码片](https://code.csdn.net/assets/ico_fork.svg)- // TwoLevel.cpp : 定义控制台应用程序的入口点。
- //
- 
- /************************************************************************/
...
- 
- 
- typedefstruct __SpaceState {  /* 状态空间变量 */
- int xt;               /* x坐标位置 */
- int yt;               /* x坐标位置 */
- float v_xt;           /* x方向运动速度 */
- float v_yt;           /* y方向运动速度 */
...
-     weights = newfloat [NParticle];     /* 申请粒子权重数组的空间 */
- if ( weights == NULL ) return( -3 );      
-     nbin = R_BIN * G_BIN * B_BIN; /* 确定直方图条数 */
-     ModelHist = newfloat [nbin]; /* 申请直方图内存 */
...
- int i, j;  
- 
-     cumulateWeight = newfloat [N+1]; /* 申请累计权重数组内存，大小为N+1 */
...
![](https://img-blog.csdn.net/20140615100934390)

![](https://img-blog.csdn.net/20140615100938984)

![](https://img-blog.csdn.net/20140615100952218)
