# 双目测距（五）--匹配算法对比 - 工作笔记 - CSDN博客





2016年07月26日 13:21:41[Eason.wxd](https://me.csdn.net/App_12062011)阅读数：22031
...
[view plaincopy to clipboardprint?](http://blog.csdn.net/wqvbjhc/article/details/6260844#)
...
![clip_image001](http://images2015.cnblogs.com/blog/451660/201601/451660-20160114151746491-1568691201.png)

这图是解释BM（bidirectional matching)算法的很好的例子。进行双向匹配，首先通过匹配代价在右图中计算得出匹配点。然后相同的原理及计算在左图中的匹配点。比较找到的左匹配点和源匹配点是否一致，如果你是，则匹配成功。

![image](http://images2015.cnblogs.com/blog/451660/201601/451660-20160114151753835-1022576108.png)
...
![clip_image002](http://images2015.cnblogs.com/blog/451660/201601/451660-20160114151756757-834432493.png)
...
![clip_image003](http://images2015.cnblogs.com/blog/451660/201601/451660-20160114151806850-411337389.png)
...
![](http://hi.csdn.net/attachment/201010/26/0_1288085621pPNo.gif)
...
![](http://hi.csdn.net/attachment/201010/26/0_1288085627U1Fq.gif)
...
**有关立体匹配的介绍和常见匹配算法的比较，推荐大家看看[Stefano Mattoccia](http://www.vision.deis.unibo.it/smatt/stereo.htm) 的讲义 [Stereo Vision: algorithms and applications](http://www.vision.deis.unibo.it/smatt/Seminars/StereoVision.pdf)，190页的ppt，讲解得非常形象详尽。**
...
(1) 新增了 SGBM 立体匹配算法（源自Heiko Hirschmuller的《[Stereo Processing by Semi-global Matching and Mutual Information](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.88.8897&rep=rep1&type=pdf)》），可以获得比 BM 算法物体轮廓更清晰的视差图（但低纹理区域容易出现横/斜纹路，在 GCstate->fullDP 选项使能时可消减这种异常纹路，但对应区域视差变为0，且运行速度会有所下降），速度比 BM 稍慢， 352*288的帧处理速度大约是 5 帧/秒；
...
“[@scyscyao](http://blog.csdn.net/scyscyao/archive/2010/05/06/5562024.aspx)：在OpenCV2.0中，BM函数得出的结果是以16位符号数的形式的存储的，出于精度需要，所有的视差在输出时都扩大了16倍(2^4)。其具体代码表示如下：
...
在**OpenCV2.1中，BM算法可以用 CV_16S 或者 CV_32F 的方式输出视差数据**，使用32位float格式可以得到真实的视差值，而CV_16S 格式得到的视差矩阵则需要 除以16 才能得到正确的视差。另外，OpenCV2.1另外两种立体匹配算法 **SGBM 和 GC 只支持 CV_16S 格式的 disparity 矩阵**。
...
![](http://hi.csdn.net/attachment/201010/26/0_1288085635u1Qh.gif)
...
![](http://hi.csdn.net/attachment/201010/26/0_1288085642ULuG.gif)
...
![](http://images0.cnblogs.com/blog2015/466153/201508/201952551915334.png)
...
![](http://images0.cnblogs.com/blog2015/466153/201508/202009090357514.jpg)

则每个像素的disparity只和其左边的像素相关，有如下公式：

![](http://images0.cnblogs.com/blog2015/466153/201508/211012485664034.png)
...
![](http://images0.cnblogs.com/blog2015/466153/201508/202010419413499.png)

![](http://images0.cnblogs.com/blog2015/466153/201508/202010470033144.png)
...
![](http://images0.cnblogs.com/blog2015/466153/201508/202011265661432.png)

SGBM算法遍历每个像素，针对每个像素的操作和disparity的范围有关，故时间复杂度为：

![](http://images0.cnblogs.com/blog2015/466153/201508/202011568005667.png)
