# 图像检索（二）--综述（2016年之前） - 工作笔记 - CSDN博客





2019年03月07日 00:21:46[Eason.wxd](https://me.csdn.net/App_12062011)阅读数：2196
...
转自：[https://blog.csdn.net/l7H9JA4/article/details/80569458](https://blog.csdn.net/l7H9JA4/article/details/80569458)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawBCMaGjZ1AEAULgTPe4VgzU1PyWQhS8jeAWlgRLFx6PEvYnGARnW5prcaNQPktyjm1HQGC4obtFOg/640?wx_fmt=png)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/iaTa8ut6HiawBCMaGjZ1AEAULgTPe4VgzUWcAxmaVWhv4ohpecv7yNGQ2GPDcutQdr49UJ6g5gicjAB56oEDXcDpQ/640?wx_fmt=jpeg)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawBCMaGjZ1AEAULgTPe4VgzUpTqs1SUdD0icZP8duXB7hZicKuxNpVp8SfdkyMRU2MMqAib5NuIKQTEJQ/640?wx_fmt=png)

图2：基于SIFT特征与CNN特征的图像检索流程

**局部特征提取。**假设我们有一个含![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawBCMaGjZ1AEAULgTPe4VgzURZSldaHLRQwV0RRdLFKNbhzibGYCVibewVTOxyibJlwdl9HxheiaUytIuA/640?wx_fmt=png)张图片的画廊![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJlfMNRI3ef56OqtXG0hzkCegZskoCIXp7kVBiazDwr0L2mUCH6AyKKGA/640?wx_fmt=png)。指定一个特征检测器，我们从稀疏的感兴趣点或密集的图像块中提取局部描述符。我们用![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJWa5nImxlfq5Ctiao6ItMlPsvo9E9bLIFwyhMySq2N3N8hQHb9SY8O9w/640?wx_fmt=png)来表示局部描述符，用![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJus85lfKowIlvKcY4Alibvv2x51kOkaKkqIW9jeuGEmXux2vc7rgtSIA/640?wx_fmt=png)表示图像中被检测的区域。

**编码本的训练。**基于SIFT的方法你先训练编码本。编码本中的每一个视觉词汇位于子空间的中心，这称为“沃罗诺伊单元”。更大的码本对应于更精细的划分，从而产生更多区分性的视觉词，反之亦然。假设已有一些局部描述符![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ8K97iaxmiclMJP5DQpA4cestxnd29w1pWpQwD6tt2JrB0dyu6cK9ibcQA/640?wx_fmt=png)从无标签的训练集中计算出。例如k-means这样的基准方法就是将![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJWLsCXdtEtg8C8yIhL5OcibnaQ16Il9IoPhXdj3tMUHoSH9h74g3HALw/640?wx_fmt=png)个点聚类成![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJzCVFXcAMV6GESFC2pP4kmlq6c9lZutBFZ69kibZnxd3wH3qfMCpJrsw/640?wx_fmt=png)簇，得到的![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJzCVFXcAMV6GESFC2pP4kmlq6c9lZutBFZ69kibZnxd3wH3qfMCpJrsw/640?wx_fmt=png)个视觉词汇即编码本的大小![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJzCVFXcAMV6GESFC2pP4kmlq6c9lZutBFZ69kibZnxd3wH3qfMCpJrsw/640?wx_fmt=png)。

**特征编码。**一个局部描述符![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJL7ZTaf2jAqts9WRCmuZtXbBF1icOXQYvnUEu9n4Cic6Jee8Dg4qQj16w/640?wx_fmt=png)通过特征编码过程![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJud2pNWt1ZbnpggTk3GCZ8eic9EHNKk92R0ibsYicX5cDa3WK4ibMF1j0hA/640?wx_fmt=png)被映射到嵌入特征![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJe7oeic0PfNrkX3fTYqLTiblaxiaJ9uoSrYg6xr4XGqflXBle89R0IWkZQ/640?wx_fmt=png)。在使用k-means方法时，可以根据![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJTebtzPPSqPDEtLsx1NMsXoAS6PQLlflnq9LZNoic0pb7R2yBGpdPE1g/640?wx_fmt=png)到视觉词汇的距离进行编码。对于大规模的编码本，硬量化和软量化方法都是很好的选择。前者量化得到只有一个非零条目的嵌入特征![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJibyVImxaH3wjXswD4rghHcxeWib53jscc4gfXFwKy5pPJZqSEXaOQjPQ/640?wx_fmt=png)，后者则是将![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJTebtzPPSqPDEtLsx1NMsXoAS6PQLlflnq9LZNoic0pb7R2yBGpdPE1g/640?wx_fmt=png)量化表示为少量的视觉词汇。在汇总所有的局部嵌入特征后就得到了一个全局签名。对于中等规模的编码本来说，可以通过额外的二值签名拉埃保护原始信息。当使用小规模编码本时，大多使用VLAD，FV之类的编码方法（译者注：VLAD可以理解为是BOF和FV的折中，BOF是把特征点做kmeans聚类，然后用离特征点最近的一个聚类中心去代替该特征点，损失较多信息；FV是对特征点用GMM建模，GMM实际上也是一种聚类，只不过它是考虑了特征点到每个聚类中心的距离，也就是用所有聚类中心的线性组合去表示该特征点，在GMM建模的过程中也有损失信息；VLAD像BOF那样，只考虑离特征点最近的聚类中心，同时保存了每个特征点到离它最近的聚类中心的距离；像FV那样，VLAD考虑了特征点的每一维的值，对图像局部信息有更细致的刻画）。
...
**局部描述符。**局部描述符使用一系列检测区域对局部图像内容进行编码。SIFT描述符一直以来都是大家默认使用的描述符。这种128维的向量在匹配准确率上从众多描述符中脱颖而出。更进一步地，PCA-SIFT描述符将特征向量的维度从128维减少到36维，通过增加特征建立计算量和降低区分度来加快匹配速度。另一种改进方法是RootSIFT，它首先将SIFT描述符进行![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJuxhr2fJRf6mfD1zwYu2OiaD3xIHFC4nKcT2mgicKBkhds2HKJgXKWHpw/640?wx_fmt=png)归一化，随后对每个元素开方。RootSIFT现在是基于SIFT的检索方法惯用方法。除了SIFT之外，SURF描述符也被广泛应用。SURF描述符结合了海森-拉普拉斯检测器和局部梯度直方图。积分图技巧可以用于加速特征的计算（译者注：积分图技巧会对原图像首先生成一张积分图，这种通过空间换取时间的策略，在计算图像的诸如海尔特征时可以大幅提高计算速度）。SURF可以取得和SIFT近乎一样的准确率，同时SURF计算速度更快。文献《A comparison of sift, pca-sift and surf》对SIFT，PCA-SIFT和SURFF进行了比较。为了进一步加快匹配速度，二值描述符用汉明距离替代了欧氏距离。
...
聚类时的算法复杂度很大程度上依赖于编码本的大小。用VLAD或FV生成打的编码本通常很小，一般是64,128,256。在VLAD中使用平面k-means聚类算法生成编码本。在FV中使用GMM算法，例如![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ1btzaDBV6QAp3JoSCRzicAzoyDqF7z9rpgBgIcR0hbLszNPB6NWedAw/640?wx_fmt=png)，式中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJvuK3k0ra0fHZSXYNHicuw3vxcf8h9GnmT8HqenqBR8vY3EW1wup8nzg/640?wx_fmt=png)表示高斯混合曲线的数目，通过极大似然估计算法训练得到![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJvuK3k0ra0fHZSXYNHicuw3vxcf8h9GnmT8HqenqBR8vY3EW1wup8nzg/640?wx_fmt=png)。GMM用![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJvuK3k0ra0fHZSXYNHicuw3vxcf8h9GnmT8HqenqBR8vY3EW1wup8nzg/640?wx_fmt=png)个混合高斯分布曲线描述特征空间，这同时也可以表示为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJq5dj6k1T0LN3O6WaAO8ms4ZKRNFowussm4n6HUfFSExmicD79F5BW9g/640?wx_fmt=png)，其中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJquia3BAibFvoS0RpibeLcmlNUaiaBafgCbyzicOB6wymO19ROJPpvedUAzw/640?wx_fmt=png)，![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJPFgPBv2xLnS6uk1c2SnDSoZ2mkXJ2SrB7vLvpGLtmQTcr3mBWIBDIQ/640?wx_fmt=png)和![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJkY039g2zQ5BibcSgZOdxzymoSm6PCG7LHmWwoibpvWR4DxiabNfawj0QA/640?wx_fmt=png)别表示混合权重，均值向量和高斯曲线![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJPFgPBv2xLnS6uk1c2SnDSoZ2mkXJ2SrB7vLvpGLtmQTcr3mBWIBDIQ/640?wx_fmt=png)的协方差矩阵。

3.3.1 编码方法

因为小规模编码本尺寸小的缘故，相对复杂的和存储信息的方法可以在这上面使用。我们在这个小节中主要调研了FV，VLAD方法及其发展。使用预先训练的GMM模型，FV描述局部特征和GMM中心之间的平均一阶和二阶差异。它的维度是![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJIlCmmX2AlDpemOx1LWd9Vk9wr4ibx629miaNibfUMibia2iaMfnicicX9icibC8A/640?wx_fmt=png)，其中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJMPz3W2GtSrCDYgdobBOpmW2vxELm9DesLW5XzQyvyBAptKOIZfmqlw/640?wx_fmt=png)是局部描述符的维度，![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJvuK3k0ra0fHZSXYNHicuw3vxcf8h9GnmT8HqenqBR8vY3EW1wup8nzg/640?wx_fmt=png)是GMM编码本的长度。FV通常进行指数归一化（power normalization）以抑制突发性问题。在这一步，FV的每一部分在的非线性变换由参数![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJRiaayjwj9HIRsAJJbibPvgaHxnibsLIsteUJ0bPqwATed0wkZ9Sp67aJg/640?wx_fmt=png)表征。接下来使用![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJT5f3OsQRR9XqZE4RkiaBd3s5J8kz10GZ9cgR3If1Bw5kvsghopctiaRA/640?wx_fmt=png)归一化，这样FV就从各方面得到提升。例如，Koniusz等人用每个描述符的空间坐标和相关的可调权重来对其进行扩充。在《Revisiting the fisher vector for fine-grained classification》这篇文献中，更大的编码本（将近4096）表现出比小编码本更好的分类准确率，当然计算花费同时也增大了。为了修正局部区域独立同分布这一假设，Cinbis等人提出了非独立同分布模型，这个工作抑制了突发事件的影响，同时也改进了指数归一化的效果。

VLAD编码方案由Jégou提出，可以认为VLAD是FV的简化版本。VLAD量化将局部特征量化为最近邻视觉词汇，同时记录下两者的距离。由于编码本规模小，因此最近邻检索方案可行。在残差向量被总和池化聚合后进行归一化。VLAD的维度是![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJACK1zm15FYwvXnFPZcibq1RPWpFgRSnf609dk3p96CM56S3Z5FzI9aA/640?wx_fmt=png)。同样，研究人员对VLAD在多方面进行了改进。Jégou和Chum提出使用PCA和白化（在表5中表示为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ6u9RGlNtE1briaWslOrHFjuNpNw62kicKYyTtRkm2tWydp8H8hmc6xAQ/640?wx_fmt=png)）去消除视觉词语共现现象，并且训练多个编码本以减少量化带来的损失。Arandjelovi![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJmCKL2DYLZDACKPbg3vAhA9lHS7wcCoqJ5poicYZMNU9iac4MtvibiaY7Cg/640?wx_fmt=png)等从三个方面拓展了VLAD：1）归一化每个粗糙聚类中的残差和，称为内部归一化，2）通过词汇自适应来解决数据集迁移问题，3）用多VLAD模型(multi-VLAD)来解决小目标发掘问题。Delhumeau等提出应该将残差向量归一化，而不是求残差和；他们还提倡在每个Voronoi格内进行PCA降维，而不是像《Aggregating local image descriptors into compact codes》中所提出的降维方案。《Improving large-scale image retrieval through robust aggregation of local descriptors》中提出应该使用软任务和经验性地为每个等级学习最佳权重来改进硬量化方案。
...
BoW，VLAD和FV的复杂度基本一致。我们忽视线下训练时间和SIFT特征提取时间。在视觉词汇分配这一步中，VLAD（FV）模型中每一个特征（高斯曲线）需要计算和每一个视觉词汇的距离（soft assignment coefficient），因此这一步的计算复杂度为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJwV8UND3897Wibalhfx8ibjB590vGP3jD55X3ggFf4Nw5fhHAbrYgVSPw/640?wx_fmt=png)。并且其他步骤的计算复杂度都要小于![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJwV8UND3897Wibalhfx8ibjB590vGP3jD55X3ggFf4Nw5fhHAbrYgVSPw/640?wx_fmt=png)。考虑到是以求和池化方式进行的嵌入，因此编码过程总的计算复杂度为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJlE22aLiba0SXvZZCQPstTuT80MmDeEHRFlA14l5xbD3icicVYkJ7dx7qw/640?wx_fmt=png)，其中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJAbUnMFwWo0MEFBmVc8Hp63dyLCsZrOmJzkQZpq0MntOdnIegabqs4w/640?wx_fmt=png)表示图像中提取的特征的数目。三角嵌入式VLAD的一个变异体，它和VLAD的计算复杂度相似，都是![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJlE22aLiba0SXvZZCQPstTuT80MmDeEHRFlA14l5xbD3icicVYkJ7dx7qw/640?wx_fmt=png)。multi-VLAD的计算复杂度也是![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJlE22aLiba0SXvZZCQPstTuT80MmDeEHRFlA14l5xbD3icicVYkJ7dx7qw/640?wx_fmt=png)，但是它匹配过程的复杂度过大。分层的VLAD的计算复杂度是![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJcue2mY6xkK2b5WIZGloFS8s7gq0rZ8dBge1NBCDo5vARQYvYibgH1VA/640?wx_fmt=png)，其中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJuSypvphI93ziblzZ9g0t98Al4cT8LrhkdlragCfCA8PXCDyXMEJLnaw/640?wx_fmt=png)表示第二个编码本的大小。在特征聚类这一步，GMP和民主聚合方案都有很高的计算复杂度。GMP的复杂度是![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJmhY4QcEhOefpLWxHQoUHicZQ2g2aia5wsNv61NBwxhibmMumjdJqZvYQg/640?wx_fmt=png)，式中是![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJoENKK8dibNaicNv3WpYibhubpsfdicgsXV5hfHoaH3TbUM7DUoarjN00qQ/640?wx_fmt=png)特征嵌入的维度， 民主聚类方法的计算复杂度主要来源于Sinkhorn算法。
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJicib7TsfM34zwtjxLibAur9woTjic0RGiamrhPeSJONsW0laosqRocguicaQ/640?wx_fmt=jpeg)
...
在将数据分配到大量集群中,近似方法是至关重要的。在检索社区中，两个有代表性的工作是：分层k-means(HKM)和近似k-means(AKM)，如图1和图3所示。HKM方法在2006年提出，HKM分层次地应用标准k-means方法进行特征训练。HKM首先将特征空间中的点划分为几个簇，接着递归地将每个簇划分为更多的群集。在每次递归时，每个点都要被归类为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJxrKMMaDAVqicVlbga68CTZWC3aKopnU3I3RO8Hp3O8K8HwPDNBgrMkA/640?wx_fmt=png)个簇中的某一个，聚类树的深度为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ5oCNyrk8gpjwRDl7bpk7tgrsDreiaYvKTK6anejEiaWibDmrFicz4Vicq4g/640?wx_fmt=png)，其中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ43sbpcKI8Z1sW5zjPg9o11RhIwWySFcmibr2yibrh922f599B006MKLA/640?wx_fmt=png)是期望得到的聚类簇数目。HKM的计算复杂度是![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJhEqwcGoSv7qNptcv8fDkMLgvuqWiblLTdMWVjTKa0TemFibvb83C9iaibQ/640?wx_fmt=png)，其中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJAeoibbbJyCzsYfRJ8Qwx6bBLdsSxnFdncQWKgPgGEbXzT3CHXYQ8UPg/640?wx_fmt=png)是训练样本数。当![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ43sbpcKI8Z1sW5zjPg9o11RhIwWySFcmibr2yibrh922f599B006MKLA/640?wx_fmt=png)很大的时候，HKM的计算复杂度远小于扁平k-means（flat k-means）![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJiaMCRFicNZxBWpmmnLLm8Re2lYOsMqAqEJMjKDWJ1ErvNJkbmQT9zLwQ/640?wx_fmt=png)的计算复杂度（译者注：显然大规模编码本的![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJMIqpjrGHNXKEP6DGoQweHaxjyibIPtmOL47CqAxuGJ1vYb6CQyUjjWQ/640?wx_fmt=png)要远小于![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ43sbpcKI8Z1sW5zjPg9o11RhIwWySFcmibr2yibrh922f599B006MKLA/640?wx_fmt=png)）。另一个里程碑式的大规模编码本生成算法是AKM。该方法利用随机K-D树对K聚类中心进行索引，使得在分配步骤中能够高效地使用ANN搜索。

在AMK算法中，分配步骤的花费可以表示为，其中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ0iaXGzbeTN2xuav838EGvsnoByNYrPxcwQAS0r6lmOPUlwHwAmHz6DQ/640?wx_fmt=png)是K-D树中要访问的最近簇的候选数。因此AKM的计算复杂度与HKM相当，并且当K较大时，明显小于扁平k-means算法。实验表明AKM的量化误差要低于HKM，因此它要要优于HKM算法。在大多数基于AKM的方法中，最似最近邻检索算法选用FLANN。
...
对ANN方法来说，最早的解决方案是沿着分层树结构量化局部特征。不同级别的量化树节点被赋予不同的权重。然而，由于高度不平衡的树结构，该方法优于基于k-d树的量化方法：一个视觉词被分配给每个局部特征，使用从码书构建的k-d树来进行快速ANN搜索。对这种硬量化方案的一种改进是Philbin等人提出的软量化方案，这种方案将一个特征量化为几个最近的视觉词汇。由式![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJesT1hyLL5JUodWwjvvZCLevBCvY90q7krW1HVnnAujVB94GquibibYgA/640?wx_fmt=png)指出，每个指定的视觉单词的权重与它到特征的距离呈负相关，其中d是描述符和聚类中心之间的距离。虽然软量化是基于欧几里得距离，但Mikulik等人提出通过无监督的匹配特征集为每个视觉单词找到相关的视觉单词。基于概率模型，这些备选词往往包含匹配特征的描述符。为了减少软量化的存储成本和查询视觉词汇的数量，Cai等提出当局部特征离最近的视觉词汇距离很远时，该特征可以被丢弃而且不会带来性能的下降。为了进一步加速量化，标量量化提出局部特征在没有明确训练的编码本的情况下被量化。浮点向量是二值化的，并且所得的二进制向量的第一维直接转换为十进制数作为视觉词汇。在高量化误差和低召回率的情况下，标量量化使用位翻转（bit-flop）来为局部特征生成数百个视觉词汇。

3.4.3 特征加权

**TF-IDF.** 视觉词汇在编码本![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJppLJ3c0IfAzsj2HQ2fd8oGGz76Wg8QbqMibSMkG6icpTNTOstkZs2SicQ/640?wx_fmt=png)中往往被分配给指定的权重。称为频率与逆文档频率（TF-IDF），这种策略被集成在BoW编码中。TF定义如下：

![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJxXIOcuiafwv81SumIkQYu59z9Qqebpr199n0TIshQH2LmxWLuVe4SUg/640?wx_fmt=png)

式中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJfDegLBRICUFuVWXyyheUVJtwujuYVls191JV0LVMOn4O153KJg44Qw/640?wx_fmt=png)是视觉词汇![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJoia3YoYgK980oz5bN0ib0lPVy1VZjSkfWHVK5BibXkia8uAu1JDbYEm7Bw/640?wx_fmt=png)在图像![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJiaEZC7ZfpDfOZKQFcQc6JU7EYHjAEOw1u2icdEKAOxtpDPtDovxmxLlw/640?wx_fmt=png)中出现的次数。另一方面，IDF通过全局统计来表明给定视觉词汇（对文档）的贡献。视觉词汇经典的IDF计算公式如下：

![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJs3vDcal5rGWdbWDF5TbKF9Xd1QjAKZlvWs9giczh08iasmng7gmzibqcw/640?wx_fmt=png)

式中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJS0icRiaJIr4g3LS0qvUuHls5cBJKVHBl02BEbA72Akic43Viaf0oJgHAMA/640?wx_fmt=png)是图形数目，![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJqfLDIhElhY5PMRc9cIl3qVVNWXES72QsmOR9e9MGuClJ9avuCyI9Cw/640?wx_fmt=png)表示视觉词汇![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJkfWeiaZUODjYu5YwEVj17IMoErTPgbcWVhCxVFYdswk36icX3WRcWzaw/640?wx_fmt=png)出现的图像编号。视觉词汇![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJkfWeiaZUODjYu5YwEVj17IMoErTPgbcWVhCxVFYdswk36icX3WRcWzaw/640?wx_fmt=png)出现在图像![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJiaEZC7ZfpDfOZKQFcQc6JU7EYHjAEOw1u2icdEKAOxtpDPtDovxmxLlw/640?wx_fmt=png)中的TF-IDF值为：

![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJmwDVPHjAvODOFfiamU2ecobPCicXQibY68qJ5DgAIcLHQiasA6MRgQWsBQ/640?wx_fmt=png)

**改进方案。**与视觉单词加权相关的一个主要问题是突变性。它指的是图像中出现重复结构的现象。这个问题往往在图像相似度中占主要位置。Jégou等人提出了几个TF的变种来解决突变问题。一个有效的策略是在TF上进行平方运算。Revaud等人提出了检测在不相关图像中频繁出现的关键点组来降低评分函数的计算值，而不是用相同的单词索引来分组特征。尽管上述两种方法都提出在量化后检测突变组，Shi等人提出在描述符阶段检测它们。检测到的突变描述符经过平均池化并且送往BoW结构中。在改进IDF方面，Zheng等人提出了![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJdQLIXTJk22HTF0AOa84CbVAY6MQQaG6xtDyxLeo3Zqwq2KY31GUmpg/640?wx_fmt=png)IDF方法来处理突变情况，同时Murata等人设计了后来被并入到BM25公式的指数IDF。在大多数方案都以抑制突变性为目的时，Torii等人将这个问题视为体系结构的一个显着特征，并在突发性检测后设计新的相似性度量方法。
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJHGuZUruLM8vPhxHPq3rpKibibumTAGH9ow3sPkVFqJW5Zd1oq6e14Siag/640?wx_fmt=png)
...
HE算法由Jégou等人在论文《Hamming embedding and weak geometric consistency for large scale image search》中提出，它提升了中等规模编码本下视觉词汇的区分能力，也是首次将一个SIFT描述符![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ1GZiaIicssNp2oKEAcV7DGnUZibVdcic6vfoXlYvlpe2t8CyEar1U7MPGg/640?wx_fmt=png)从![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJG4A9bjDJWqx8XIlbVfNUdP2L6yWxIR1KTYs9Uxl9xfbW2GoFcA5bLQ/640?wx_fmt=png)维空间映射到![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJetfFsxWYgx6AkIcbL8d9Syxe1DsMYXO3wwj7wMZKdDsQ6LBQJOTplw/640?wx_fmt=png)维空间：

![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJiadE1AFBpubIx9X2MUmRFeibkIavyaoF2KxcGWVcGDNOibgYWq3nQichrg/640?wx_fmt=png)

式中，![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJvHmDBG5hGVgSOE2aTXsXyI11FJL7fibNAib2Fzv0X20bGc34xIOwoAgg/640?wx_fmt=png)是一二个投影矩阵，![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJXl8wQ81y7VMBNhAlOUvtVhY68UPl9XfOWUAcK4oZ6v6SEyiaslD9jcw/640?wx_fmt=png)是一个低维向量。通过创建一个高斯随机矩阵同时对它使用![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJibbZydSniaKdWtTUBoVOTeBvib3iaMxWibgu9np9XXE4MEKpABR26GYfTmQ/640?wx_fmt=png)分解，矩阵![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJcS9usYOY3ibvp04XCp0m2wTc18kO1uLH5D6dcKe1EuETkicger9g9j0g/640?wx_fmt=png)作为最后正交阵的前![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJetfFsxWYgx6AkIcbL8d9Syxe1DsMYXO3wwj7wMZKdDsQ6LBQJOTplw/640?wx_fmt=png)行，对于二值化![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJXl8wQ81y7VMBNhAlOUvtVhY68UPl9XfOWUAcK4oZ6v6SEyiaslD9jcw/640?wx_fmt=png)，Jegou等人提出在每个Voronoi单元![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJK8YQVQ8AgebPTGUIl0krzoww9hqFvUzj2mfMICZhjMZlQdxd5tkHmg/640?wx_fmt=png)中使用描述符下降法来计算低维向量的中值向量![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJn2qXKZd1wJiaCHb86CMRPhWveV7AXAsgNfAyvicEiaPpz34Bg7YicWmGnw/640?wx_fmt=png)。给定描述符![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJccSlKajcXsbNxOnm5eBVpFd1pt9Fu4p3hvgtw3KQ7b27NNZt2YOk0w/640?wx_fmt=png)和它的投影向量![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJXl8wQ81y7VMBNhAlOUvtVhY68UPl9XfOWUAcK4oZ6v6SEyiaslD9jcw/640?wx_fmt=png)，HE计算它的视觉词汇![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJAnhGBHvQHcEbKYLTjJZaspF8zq61NypQrdVPXiaiafkFV3dQyWYyQWKA/640?wx_fmt=png)，HE二值向量计算公式如下：

![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJLNErCHia7ueSzCn1FvohRe4e5WiaHJ57vpzugvaAgnib3IAS6BfiaBfZCw/640?wx_fmt=png)

其中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJhf709E3nEsuPOzxBxTkS2yZNJbmFIToK1G3FriavAYZMAZqHYXKyz5A/640?wx_fmt=png)是第![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJetfFsxWYgx6AkIcbL8d9Syxe1DsMYXO3wwj7wMZKdDsQ6LBQJOTplw/640?wx_fmt=png)维的HE向量计算结果。二值特征![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ0sY1rvKwe1ZsNFJyU1U2E6lkNuqFLnAQPovCiad5zXgWpVOQyK00Ficg/640?wx_fmt=png)作为特征匹配的第二重校验。当满足以下两个标准时，一对局部特征可以认为是匹配的：1) 它们是同一个视觉词汇；2) 它们的HE哈希值距离很小。HE的扩展方法通过指数函数估计特征![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJoniblsytial6vtgnlXtz47p2yHQQy8QAMu5PZRTWMcicekGsvVCc7V56w/640?wx_fmt=png)和![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJUSKQh6icPLXLCXsI6DhAJXuSr9P407rfj6ZSflGXPGj7gUGp2eydgaA/640?wx_fmt=jpeg)与Hamming距离的匹配强度：

![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ6UTic6eVibuhTdgKz4aU5gKHN42yWZHPricANtdPtiab4fwlRfZZMkLxHA/640?wx_fmt=png)

其中，![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJxdUXib7LwgCIA83DbeeQKAbbSR9UFhiaeGPDSlb3rrBeYn6TP04y3diaA/640?wx_fmt=png)和分别代表特征![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJoniblsytial6vtgnlXtz47p2yHQQy8QAMu5PZRTWMcicekGsvVCc7V56w/640?wx_fmt=png)和![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJUSKQh6icPLXLCXsI6DhAJXuSr9P407rfj6ZSflGXPGj7gUGp2eydgaA/640?wx_fmt=jpeg)的二值向量，![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ2qAiaIqXDc0bgaw5gIIE0aS5QUZWickme2DLXrwQNTSXR41JugxayeyQ/640?wx_fmt=png)计算两个二值向量的汉明距离，![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJKYibUPkY8NxrOmhfjbvzUX8YKeYxcO6YPeR4fKPIS0FgzsMiaFoRDUrw/640?wx_fmt=png)是权重参数。如图6所示，HE及其加权版本在2008和2010年准确率大大提高。
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJVIQdjzzSPQHB1LqeZicpCBTriaic8tfMCCibqA3EBkk9rroTlkiaibvyNm8Q/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJuibYmdXXVicwWbPmjBmqqLHU4icbnEKATyHvjib2FDz1aHxTnjbOB1Zv3g/640?wx_fmt=png)
...
局部描述符与这些中间局部检测器紧密耦合，换而言之，它们是输入图像对这些卷积运算的响应。另一方面，在卷积运算后等到的激活图层可以看做是特征的集成，在这篇综述中将其称为“列特征”。例如，在AlexNet中第一层有![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJCrQbIcwdaKkib0M1WGNkice7G97ibG9DBo9DDZE3m1icLODqEY9vQHBiaqA/640?wx_fmt=png)个检测器（卷积滤波器）。这些滤波器产生了![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJCrQbIcwdaKkib0M1WGNkice7G97ibG9DBo9DDZE3m1icLODqEY9vQHBiaqA/640?wx_fmt=png)张大小为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJRGOw6ne66qNMG2L8gwzKOribJnESQ7tGvqyS2ibkfibyicb5PQuhfjicKww/640?wx_fmt=png)的热力图（在最大池化后）。热力图中的每个像素点具有大小为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJK2lWbhibnuMDdjR9v3ycqVZ2GEVAbUEQ5XhNrdzOkf1MEQhibIu76Zpg/640?wx_fmt=png)的感受野，同时记录了图像对滤波器的响应。因此列特征的大小是![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJmQlSEIhOg87PkHOD6fguRZMM49xxx3ibbum55vNLXf9Gkah50XQBbhg/640?wx_fmt=png)，它可以看作是对原始图像中某个图像块的描述。该描述符的每个维度表示相应检测器的激活程度，并且在某种程度上类似于SIFT描述符。列特征最早出现在《Visual instance retrieval with deep convolutional networks》中，Razavian等人首先在分好块的特征图上进行最大池化，然后将它们连接在所有过滤器上，最终生成列特征。在《Hypercolumns for object segmentation and fine-grained localization》中，来自多层的列特征被连接形成“超列”（hypercolumn）特征。
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJyj6G251cyXCu8KH515wDEuibZOcjywb2yEibSQbmic97gtgRIkicCibZ5kw/640?wx_fmt=png)
...
近年来用于微调网络方法数据集统计在表3中。数据集主要集中于建筑物和普通物体中。微调网络方向一个里程碑式的工作是《Neural codes for image retrieva》。这篇文章通过一个半自动化的方法收集**地标数据集**：在Yandex搜索引擎中自动地爬取流行的地标，然后手动估计排名靠前的相关图像的比例。该数据集包含672类不同的地标建筑，微调网络在相关的地标数据集，如Oxford5k和假日数据集上表现优异，但是在Ukbench数据集（包含有普通物体）上性能降低了。Babenko等人也在含有300个多角度拍摄的日常物品图像的**多视图RGB-D数据集**上对CNN模型进行了精细调整，以提高在Ukbench数据集上的性能。地标数据集后来被Gordo等人使用，他们使用基于SIFT匹配的自动清洗方法后再微调网络。在《Cnn image retrieval learns from bow: Unsupervised fine-tuning with hard examples》中，Radenovi等人利用检索和运动结构的方法来构建三维地标模型，以便将描述相同建筑的图像进行分组。使用这个标记的数据集，线性判别投影方法（在表5中表示为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJEwvOoUFccauNqxUMsc3BlIfcsZR085pmopic2jnTwRmPvO2MzHDQKNA/640?wx_fmt=png)）优于先前的白化方法。另一个名为** Tokyo Time Machine**的数据集使用谷歌街景时间机器工具来收集图像，谷歌提供的这个工具可以提供同一地点不同时间的图像。上述的大部分数据集主要关注了地标图像，而Bell等人则建立了一个由家具组成的产品数据集，通过开发众包流程来绘制现场的目标和相应产品之间的连接。对所得到的查询集进行微调也是可行的，但是这种方法可能不适合于新的查询类型。
...
验证网络可以使用孪生网络（siamese network）结合成对损失函数（pairwise loss）或三元损失函数（triplet loss），这种方法已经被更广泛地用于微调网络任务中。在《Learning visual similarity for product design with convolutional neural networks》中采用了基于AlexNet的孪生网络和对比损失函数。在《Cnn image retrieval learns from bow: Unsupervised fine-tuning with hard examples》中Radenovi´c等人提出用MAC成代替全连接层。更进一步地，可以通过建立的3维建筑模型挖掘训练对。基于共同观测的3D点云（匹配的SIFT特征）的数目来选择正例图像对，而CNN描述符中距离较小的那些图像对被认为是负例样本。这些图像输入到孪生网络中，并且用![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJWT1mP1mQ2bnsSfSD9zazjYMQ84ByPJQ8dIogGc2kibIuxqAecibetulA/640?wx_fmt=png)正则后的MAC层输出计算对比损失函数。与《Cnn image retrieval learns from bow: Unsupervised fine-tuning with hard examples》同时进行的一项工作是《Deep image retrieval: Learning global representations for image search》，Gordo等人在Landmark数据库上对三元损失网络和区域提取网络进行微调。《Deep image retrieval: Learning global representations for image search》这项工作的的优越性在于物体其定位能力，它很好地在特征学习和提取步骤中排除了图像背景。在这两项工作中，微调模型在landmark，OxFoD5K、PARIS6K和Holidays数据集上表现出了最先进的精度，以及在UKBayes数据集上表现出良好的泛化能力（将表5）。在《Netvlad: Cnn architecture for weakly supervised place recognition》中，在最后一个卷积层中插入一个类似VLAD编码层，通过反向传播进行训练。与此同时，设计了一个新的三元损失函数来利用弱监督的Google Street View Time Machine数据。
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJibJhBqCqOic5icwMNrdGmJROGF5nPqtgsZibt5xqjZj8HsvianZ3ndsolMw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJMhGd5ccI8s9rQS48aPPVTM16CXdnjoLRe1f5f0zuDmW4MyKCL2sJ3A/640?wx_fmt=png)

表5：一些有代表性的图像检索方法在六个数据集上的表现

### 5.2 评价指标

**精准度-召回率。**召回指的是返回的正确匹配数占数据库中总数或正确匹配数的比率，而精准度是指返回结果中真实匹配的那部分图像。给定一个集合含有![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJmHvyOqZ7jomNIsSG7hhNE0lLW4l2MfUKKXSmd6HXjH3ic2WUicpLkuRA/640?wx_fmt=png)张返回的图像，假设其中有![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJEOTia7MH0iauicoh4yP24o6RXrKbhyPAFibVtuXHVHnm7z15SG98O3MSJA/640?wx_fmt=png)张正确匹配的图像，而整个数据集中有![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJezobH6H0A8F96uGtp3U46bWFNMswEAznxDyOiaeuqtibxtxoUfn32mNQ/640?wx_fmt=png)张正确匹配的图像，那么召回率![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJDMjc6mVVaxxSGsPUBUJylAtNcjIUzDgfoz8HmqFibcKFZnc2sTHicKWQ/640?wx_fmt=png)和精准度![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJHbUokTeuHNzQ5icY3JkmmbVmtvx5FDN5vVsH7ia5PfhtOicZcHrIm0haw/640?wx_fmt=png)分别计算为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJAUjb0cYFLyTBykECZWlrj6b1tAzBYuNXtr9DoVEvejVBiar9ibQG47Bw/640?wx_fmt=png)和![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJZCLOUicS8Tib2yEFiajwaqVQ6XiaFUeibsI4ajMKYeXXMWCZRBPSHn0sKtQ/640?wx_fmt=png)。在图像检索中，给定一张待查询图像和返回列表，可以根据![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJxr1I2HZjEc5bLZGsV6P3xO4vGmiao0YiceQcXHWJibI1rB7hExQYkjzLQ/640?wx_fmt=png)这些点绘制精准度-召回率曲线，其中是![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJS0icRiaJIr4g3LS0qvUuHls5cBJKVHBl02BEbA72Akic43Viaf0oJgHAMA/640?wx_fmt=png)数据库中的图像数目。
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJHXG0TMefO9b9GadA0hZsUVqx7ueJ4MSgT6nUKKIZCTkmtC3jMibk5Sg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJtXeEcBU87xebic1ibLKnoPA3EA9KqKiaStOiaPsTr9A5KIEsN6TLSAciauQ/640?wx_fmt=png)

图7：特征维度对图像检索系统准确率的影响



![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJrrSyiajETzvvbyu9flNN2fXXwKLbibRiadzbFFCzVWeLibAhgZ1Qh2yOsQ/640?wx_fmt=png)表6：不同类别方法间的效率和准确度的比较
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJglVnnZqeNAQw6OEbn5G45roia7qYfpjqoKviaUapcwSZmuIZwDSQGpWQ/640?wx_fmt=png)
...
**空间验证与查询拓展。** 空间验证通常和QE算法一起使用，可以使得检索结果排列表更加精准。RANSAC验证在《Object retrieval with large vocabularies and fast spatial matching》中提出，它的复杂度为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJDKia5Tm6wgz7JGd7zZZU7wDJxMbneAlTgaLUrgHianK17elQ8YUPp6MQ/640?wx_fmt=png)，其中![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJtDjghXnrDd1vIAV5oeplZjom94ibSJ7CxHqmEyZTtSfBZ2synWA0a5A/640?wx_fmt=png)是匹配的特征数目，可以看出算法的复杂度较高。ADV方法的复杂度相对较小，为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ17EPT2pykTqiaWCicn9Mxp36dCibQiayMzVEMMaBsbuYsYgKk6PEaX9Bag/640?wx_fmt=png)，因为它能够避免不相关的Hough选票。《Hough pyramid matching: Speeded-up geometry re-ranking for large scale image retrieval》和《A vote-and-verify strategy for fast spatial verification in image retrieval》提出的方法最有效，复杂度仅为![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/iaTa8ut6HiawCjPuDaIYZ0PUkx3ebkxmPJ8cANuvbATBlIxFFQEOhvqibia0KlibPfrS1cVl30SIzkAkVF7WEnVhqGg/640?wx_fmt=png)，同时后一项工作进一步地输出QE的变换和内值。
