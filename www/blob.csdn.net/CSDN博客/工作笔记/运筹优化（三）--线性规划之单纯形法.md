# 运筹优化（三）--线性规划之单纯形法 - 工作笔记 - CSDN博客





2019年01月10日 12:42:55[Eason.wxd](https://me.csdn.net/App_12062011)阅读数：5295
...
参考：[http://www.cnblogs.com/ECJTUACM-873284962/](http://www.cnblogs.com/ECJTUACM-873284962/)
...
![](https://img-blog.csdn.net/20131118202830406?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvd2F5bmU1MDg=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
在标准形中，有m个约束条件（不包括非负约束），n个决策变量，且（n>=m）。首先，选取m个基变量![](http://latex.codecogs.com/gif.latex?%5Cinline&space;x_j%27%28j&space;=&space;1,2,...,m%29) ，基变量对应约束系数矩阵的列向量线性无关。通过矩阵的线性变换，基变量可由非基变量表示：

![](http://latex.codecogs.com/gif.latex?%5Cinline&space;x_i%27&space;=&space;%7BC_i%7D&space;+&space;%5Csum%5Climits_%7Bj&space;=&space;m&space;+&space;1%7D%5En&space;%7B%7Bm_%7Bij%7D%7Dx_j%27%7D&space;%28i&space;=&space;1,2,...,m%29)

如果令非基变量等于0，可求得基变量的值 ：

![](http://latex.codecogs.com/gif.latex?%5Cinline&space;x_i%27&space;=&space;%7BC_i%7D)
...
![](https://img-blog.csdn.net/20131118203004718?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvd2F5bmU1MDg=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
![](http://latex.codecogs.com/gif.latex?%5Cinline&space;z&space;=&space;%7Bz_0%7D&space;+&space;%5Csum%5Climits_%7Bj&space;=&space;m&space;+&space;1%7D%5En&space;%7B%7B%5Csigma&space;_j%7Dx_j%27%7D)

注意：这种传统方法用非基变量表示基变量和目标函数值的表示法叫单纯形字典。

当达到最优解时，所有的![](http://latex.codecogs.com/gif.latex?%5Cinline&space;%7B%7B%5Csigma&space;_j%7D%7D)应小于等于0。当存在j，![](http://latex.codecogs.com/gif.latex?%5Cinline&space;%7B%7B%5Csigma&space;_j%7D%7D) >0时，当前解不是最优解，为什么？

当前的目标函数值为z0，其中所有的非基变量值均取0。由之前分析可知，![](http://latex.codecogs.com/gif.latex?%5Cinline&space;%7Bx_j%27%7D)=0代表可行域的某个边界，是![](http://latex.codecogs.com/gif.latex?%5Cinline&space;%7Bx_j%27%7D)的最小值。如果可行解逐步离开这个边界，![](http://latex.codecogs.com/gif.latex?%5Cinline&space;%7Bx_j%27%7D)会变大，因为![](http://latex.codecogs.com/gif.latex?%5Cinline&space;%7B%7B%5Csigma&space;_j%7D%7D) >0，显然目标函数的取值也会变大，所以当前解不是最优解。我们需要寻找新的基变量。

## 5.3如何选择新的基变量

如果存在多个![](http://latex.codecogs.com/gif.latex?%5Cinline&space;%7B%7B%5Csigma&space;_j%7D%7D) >0，选择最大的![](http://latex.codecogs.com/gif.latex?%5Cinline&space;%7B%7B%5Csigma&space;_j%7D%7D) >0对应的变量作为基变量，这表示目标函数随着![](http://latex.codecogs.com/gif.latex?%5Cinline&space;%7Bx_j%27%7D)的增加，增长的最快。

## 5.4如何选择被替换的基变量

假如我们选择非基变量![](http://latex.codecogs.com/gif.latex?%5Cinline&space;x_s%27)作为下一轮的基变量，那么被替换基变量![](http://latex.codecogs.com/gif.latex?%5Cinline&space;%7Bx_j%27%7D)在下一轮中作为非基变量，等于0。选择![](http://latex.codecogs.com/gif.latex?%5Cinline&space;%7Bx_j%27%7D)的原则：替换后应该尽量使![](http://latex.codecogs.com/gif.latex?%5Cinline&space;x_s%27)值最大（因为上面已分析过，目标函数会随着![](http://latex.codecogs.com/gif.latex?%5Cinline&space;x_s%27)的增大而增大）。
...
![](https://images2015.cnblogs.com/blog/1100338/201706/1100338-20170630092355133-322033945.png)
...
![](https://img-blog.csdn.net/20150117151524140?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQveXl5d3d3NjY2/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
