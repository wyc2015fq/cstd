# 决策树（四）--随机森林与GBDT - 工作笔记 - CSDN博客





2016年07月22日 17:51:29[Eason.wxd](https://me.csdn.net/App_12062011)阅读数：5580
...
[美国金融银行业的大数据算法：随机森林模型+综合模型](http://www.36dsj.com/archives/14262)
...
![随机森林](http://www.36dsj.com/wp-content/uploads/2015/01/113.png)

就是将空间划分成下面的样子：

![随机森林](http://www.36dsj.com/wp-content/uploads/2015/01/26.png)
...
随机森林的过程请参考Mahout的[random forest](http://mahout.apache.org/) 。这个页面上写的比较清楚了，其中可能不明白的就是Information Gain，可以看看之前推荐过的Moore的页面。

**Gradient Boost Decision Tree:**

GBDT是一个应用很广泛的算法，可以用来做分类、回归。在很多的数据上都有不错的效果。GBDT这个算法还有一些其他的名字，比如说MART(Multiple Additive Regression Tree)，GBRT(Gradient Boost Regression Tree)，Tree Net等，其实它们都是一个东西（参考自[wikipedia
 – Gradient Boosting](http://en.wikipedia.org/wiki/Gradient_boosting))，发明者是Friedman
...
![大数据](http://www.36dsj.com/wp-content/uploads/2015/01/312.png)

对于Logistic变换后的结果，损失函数为：

![公式](http://www.36dsj.com/wp-content/uploads/2015/01/45.png)



image其中，yk为输入的样本数据的估计值，当一个样本x属于类别k时，yk = 1，否则yk = 0。

![大数据](http://www.36dsj.com/wp-content/uploads/2015/01/55.png)
...
![随机森林](http://www.36dsj.com/wp-content/uploads/2015/01/65.png)
