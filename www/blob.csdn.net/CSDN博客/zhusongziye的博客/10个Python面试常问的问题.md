# 10个Python面试常问的问题 - zhusongziye的博客 - CSDN博客





2018年05月20日 16:27:44[zhusongziye](https://me.csdn.net/zhusongziye)阅读数：90标签：[10个Python面试常问的问题](https://so.csdn.net/so/search/s.do?q=10个Python面试常问的问题&t=blog)
...
list2 = [i*2for i in ls if i>2]
print list2

dic1 = {x: x**2for x in (2, 4, 6)}
print dic1

dic2 = {x: 'item' + str(x**2) for x in (2, 4, 6)}
print dic2

set1 = {x for x in'hello world'if x notin'low level'}
print set1
