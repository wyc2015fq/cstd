# selenium 自动化测试面试题及答案 - zhusongziye的博客 - CSDN博客





2018年01月19日 19:36:26[zhusongziye](https://me.csdn.net/zhusongziye)阅读数：3839
...
22、公司内一直在使用的测试系统（B/S架构）突然不能访问了，需要你进行排查并恢复，说出你的检查方法
...
4、访问报404错误（无法找到该页）。说明是网站内容都正常是程序出现问题，看看程序是否完整。


5、访问网站出现MySQL Server Error 这个是数据库链接错误，查看数据库连接文件和数据库是不是错误。
