# Web测试方法总结 - zhusongziye的博客 - CSDN博客





2017年11月20日 21:51:59[zhusongziye](https://me.csdn.net/zhusongziye)阅读数：140标签：[Web测试方法总结](https://so.csdn.net/so/search/s.do?q=Web测试方法总结&t=blog)
...
　　（1）合法性检查：(输入0日、1日、32日)、月输入[1、3、5、7、8、10、12]、日输入[31]、月输入
