# Python 系统资源信息获取工具，psutil你用过没？ - zhusongziye的博客 - CSDN博客





2018年12月08日 13:51:28[zhusongziye](https://me.csdn.net/zhusongziye)阅读数：51标签：[Python 系统资源信息获取工具，psutil你用过没？](https://so.csdn.net/so/search/s.do?q=Python 系统资源信息获取工具，psutil你用过没？&t=blog)
...
![](https://img-blog.csdnimg.cn/20181208134830993.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3podXNvbmd6aXll,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20181208134853313.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3podXNvbmd6aXll,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20181208134920437.png)

cpu_times 中的参数有哪些含义呢？文档中也给出了具体的释义

![](https://img-blog.csdnimg.cn/2018120813493079.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3podXNvbmd6aXll,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20181208134947900.png)
...
![](https://img-blog.csdnimg.cn/20181208135000672.png)

如果要实现排行，那么就需要很多的记录，意味着我们可以尝试通过 for 循环来实现（此处将时间间隔设为 1 即可）：

![](https://img-blog.csdnimg.cn/20181208135007246.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3podXNvbmd6aXll,size_16,color_FFFFFF,t_70)

当然，这仅仅只是将信息输出了 10 次，如果要进行排行，那么还需要其他的处理。

![](https://img-blog.csdnimg.cn/20181208135015920.png)
...
![](https://img-blog.csdnimg.cn/20181208135040663.png)
...
![](https://img-blog.csdnimg.cn/20181208135052310.png)
...
![](https://img-blog.csdnimg.cn/20181208135102992.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3podXNvbmd6aXll,size_16,color_FFFFFF,t_70)
