# 抖音表白程序Python版，明人不说暗话，我喜欢你 - zhusongziye的博客 - CSDN博客





2018年11月26日 19:29:08[zhusongziye](https://me.csdn.net/zhusongziye)阅读数：970
...
最近一直在被抖音视频的表白程序刷屏，之前小编也收到过一个VB编写一个表白程序

![](https://img-blog.csdnimg.cn/20181124161422935.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3podXNvbmd6aXll,size_16,color_FFFFFF,t_70)

网上也流传过很多类似的表白程序，但是基本上都是由VB或者易语言编写的。

难道我大Python不能写出这样的程序来么？

人生苦短，我用Python，难道是开玩笑的？！肯定是可以编写出来的！



**效果图：**

![](https://img-blog.csdnimg.cn/20181124161445904.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3podXNvbmd6aXll,size_16,color_FFFFFF,t_70)

如果你要点击关闭的话，是关不掉的哟

![](https://img-blog.csdnimg.cn/20181124161510978.png)

如果点击考虑考虑的话

![](https://img-blog.csdnimg.cn/20181124161534905.gif)

主要用到的是pyqt5

素材是一张800*800的表情包

![](https://img-blog.csdnimg.cn/20181124161549934.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3podXNvbmd6aXll,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20181124161624771.png)
...
源自：https://zhuanlan.zhihu.com/p/38284396
