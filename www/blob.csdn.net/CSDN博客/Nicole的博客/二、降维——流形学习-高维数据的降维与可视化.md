# 二、降维——流形学习-高维数据的降维与可视化 - Nicole的博客 - CSDN博客
2018年04月23日 18:12:29[Nicole_Liang](https://me.csdn.net/weixin_39541558)阅读数：1011
## 1.流形学习的概念
...
## 2.流形学习的分类
可以将流形学习方法分为线性的和非线性的两种，线性的流形学习方法如我们熟知的**主成份分析（PCA），非线性的流形学习方法如等距映射（Isomap）、拉普拉斯特征映射（Laplacian eigenmaps，LE）、局部线性嵌入(Locally-linear embedding，LLE)。**
...
转载文章，原文地址：[http://blog.csdn.net/u012162613/article/details/45920827](http://blog.csdn.net/u012162613/article/details/45920827)
