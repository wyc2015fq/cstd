...
# Spark性能优化指南——高级篇 - bitcarmanlee的博客 - CSDN博客


2017年11月13日 22:15:50[bitcarmanlee](https://me.csdn.net/bitcarmanlee)阅读数：305
...
![这里写图片描述](https://img-blog.csdn.net/20171113215900777?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvYml0Y2FybWFubGVl/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
## 如何定位导致数据倾斜的代码
...
![这里写图片描述](https://img-blog.csdn.net/20171113215951382?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvYml0Y2FybWFubGVl/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
```
```python
sampledWordCounts = sampledPairs.countByKey()
...
![这里写图片描述](https://img-blog.csdn.net/20171113220803775?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvYml0Y2FybWFubGVl/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
```python
...
```
```python
originalKey = Long.valueOf(tuple._1.split(
```
```python
"_"
```
...
```
```python
Tuple2<Long, Long>(originalKey, tuple._2);
            }
        });
```
```python
...
![这里写图片描述](https://img-blog.csdn.net/20171113221248917?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvYml0Y2FybWFubGVl/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
```python
// 首先从包含了少数几个导致数据倾斜key的rdd1中，采样10%的样本数据。
```
```python
JavaPairRDD<Long, String> sampledRDD = rdd1.sample(
```
```python
false
```
...
```
```python
PairFunction<Tuple2<Long,Long>, Long, Long>() {
```
```python
private
```
...
```
```python
Tuple2<Long, Long>(tuple._2, tuple._1);
            }
        });
```
```python
...
```
```python
Long skewedUserid = reversedSampledRDD.sortByKey(
```
```python
false
```
...
```
```python
Function<Tuple2<Long,String>, Boolean>() {
```
```python
private
```
...
```
```python
Function<Tuple2<Long,Row>, Boolean>() {
```
```python
private
```
...
```
```python
PairFlatMapFunction<Tuple2<Long,Row>, String, Row>() {
```
```python
private
```
...
```
```python
PairFunction<Tuple2<Long,String>, String, String>() {
```
```python
private
```
...
```
```python
PairFunction<Tuple2<String,Tuple2<String,Row>>, Long, Tuple2<String, Row>>() {
```
```python
private
```
...
```
```python
key = Long.valueOf(tuple._1.split(
```
```python
"_"
```
...
```
```python
Tuple2<Long, Tuple2<String, Row>>(key, tuple._2);
                        }
                    });
```
```python
...
原文链接：[https://tech.meituan.com/spark-tuning-pro.html](https://tech.meituan.com/spark-tuning-pro.html)
