...
# Python中os与sys两模块的区别 - 机器学习的小学生 - CSDN博客


2017年06月16日 19:53:28[机器学习的小学生](https://me.csdn.net/xuluhui123)阅读数：597个人分类：[Python																](https://blog.csdn.net/xuluhui123/article/category/6679259)
...
总结就是，os模块负责程序与操作系统的交互，提供了访问操作系统底层的接口;sys模块负责程序与[Python](http://lib.csdn.net/base/python)解释器的交互，提供了一系列的函数和变量，用于操控[python](http://lib.csdn.net/base/python)的运行时环境。
os 常用方法
