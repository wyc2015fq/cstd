# POJ - 2002 Squares 数正方形【二分】【哈希表】 - 紫芝的博客 - CSDN博客





2018年11月18日 22:44:04[紫芝](https://me.csdn.net/qq_40507857)阅读数：1082
个人分类：[二分的力量																[数据结构																[hash算法](https://blog.csdn.net/qq_40507857/article/category/7988820)
...
[POJ - 2002](https://cn.vjudge.net/problem/15030/origin)
...
bool BS(Point po,int l,int r){
    int left=l,right=r,mid;
    while(left<=right){
        int mid=(left+right)>>1;
        if(p[mid].x==po.x&&p[mid].y==po.y)
            return true;
        if(p[mid]<po)
            left=mid+1;
        else
...
void transXY(Point a,Point b,Point &c,int f){
...
![](http://hi.csdn.net/attachment/201107/30/0_131203495621ME.gif)
...
![](http://hi.csdn.net/attachment/201107/30/0_1312034975Ny0J.gif)
...
```](https://blog.csdn.net/qq_40507857/article/category/7837948)](https://blog.csdn.net/qq_40507857/article/category/7595714)
