...
# pandas.read_csv参数整理 - leofionn的博客 - CSDN博客


2018年04月17日 15:15:51[leofionn](https://me.csdn.net/qq_36142114)阅读数：213


# pandas.read_csv参数整理
读取CSV（逗号分割）文件到DataFrame
也支持文件的部分导入和选择迭代
更多帮助参见：[http://pandas.pydata.org/pandas-docs/stable/io.html](http://pandas.pydata.org/pandas-docs/stable/io.html)
参数：
...
|mode|: str
|[Python](http://lib.csdn.net/base/python)|write mode, default ‘w’
