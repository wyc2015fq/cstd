# 【最长回文子串】Hihocoder/Week1 学习笔记 - CD's Coding - CSDN博客





2014年07月06日 17:17:56[糖果天王](https://me.csdn.net/okcd00)阅读数：899
...
小Hi笑着说道：“这个很容易啦，你只需要写一个程序，先从标准输入读取一个整数N，代表我给你的字符串的个数，然后接下来的就是我要给你的那N个字符串啦。而你要告诉我你的答案的话，只要将你计算出的最长回文子串的长度按照我给你的顺序依次输出到标准输出就可以了！你看这就是一个例子。”
...
从HIHO/Week4才有十佳代码，所以并不能看看大大们的高超技巧以点拨提高，继续自己想，毕竟提示三+四一旦成功就是O（n）的算法了，可以理解但暂时还没有想通，没办法先暂存去打今天的Codeforces了……
...
大爷我给您跪下了……
你的承诺呢？你的担架呢？！！！……
[后记] 后来证实这个是在当时的hihoOJ上有人用这个魔性代码过了这些样例，小HO不信拿来跑了一遍，并不是小HO的官方认证代码。
