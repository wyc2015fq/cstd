# 线上报名 | 高性能深度学习推理引擎 TensorRT 实战编程讲解 - Paper weekly - CSDN博客





2018年04月25日 00:00:00[Paper_weekly](https://me.csdn.net/c9Yv2cf9I06K2A9E)阅读数：279
...
![640?wxfrom=5&wx_lazy=1](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglGYv3tTIXV29g04z0QKv4vzhialFmd7ibLSXNVDf1AkhGMu2s17GY1uzzZfzCnHZAZTjnjibDLPOnHQ/640?wxfrom=5&wx_lazy=1)




**NVIDIA TensorRT™ 是一种高性能深度学习推理优化器和运行时提供低延迟和高通量的深度学习推理的应用程序**。使用 TensorRT，您可以优化神经网络模型，精确地校准低精度，并最终将模型部署到超大规模的数据中心、嵌入式或汽车产品平台。




在对所有主要框架进行培训的模型的推理过程中，**基于 TensorRT 的 GPU 应用程序的执行速度比 CPU 快 100 倍**。




在上期直播中，NVIDIA 开发者社区经理何琨和大家分享了** TensorRT 的性能特点，原理结构和使用方法**等内容，让大家对最新的人工智能推理工具和最酷的人工智能技术有了初步认识。




4 月 25 日晚 8 点，PaperWeekly 将再度联合 NVIDIA 为广大开发者带来 **TensorRT 的实战编程讲解**。




![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhgmAL3k0AWJHRQG7suGsmfYhPE4ezRibdOZ0Ing9F5b8LS0de3wf3rNUAD5GNfJkvd1x2maad8weIWg/640?wx_fmt=png)
...
本次直播，**从配置环境，到实战应用，嘉宾会****全程以命令行界面为基础呈现给大家**。




此外，嘉宾还将展示**最新版本 TensorRT 4.0 的使用案例**，涵盖 C++ 实现的 MNIST-LeNet，以及集成了 TensorRT 的 TensorFlow 框架真实案例。




最后，嘉宾还将为大家展示**利用 INT8 Inference 的性能测试**。




** 背景要求 **：本次线上分享需要参与用户有计算机背景和一定开发经验。
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/VBcD02jFhglGYv3tTIXV29g04z0QKv4v64KKDKgLOaxKv1eMdeqoevR3mvS96s1jXM5mrKvGl84IApsSJY3KbQ/640)
