...
2018年09月18日 12:25:47[Paper_weekly](https://me.csdn.net/c9Yv2cf9I06K2A9E)阅读数：855
...
这里是MNIST的实验结果图示，包括类内样本图示和按类采样图示。最后还简单估算了一下，以每一类对应的数目最多的那个真实标签为类标签的话，最终的 test 准确率大约有 84.5%，对比这篇文章*Unsupervised Deep Embedding for Clustering Analysis*[1]的结果（最高也是 84% 左右），感觉应该很不错了。
