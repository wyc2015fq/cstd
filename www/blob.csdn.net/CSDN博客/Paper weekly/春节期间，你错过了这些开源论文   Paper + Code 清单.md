...
2018年03月01日 00:00:00[Paper_weekly](https://me.csdn.net/c9Yv2cf9I06K2A9E)阅读数：384
...
**@paperweekly 推荐**
\#GAN
训练不稳定至今仍是 GAN 的一个重大挑战。本文提出了一种新型权值归一化（weight normalization）技术SN-GANs，能让判定器训练更加稳定。
