# 变分自编码器VAE：原来是这么一回事 | 附开源代码 - Paper weekly - CSDN博客





2018年03月23日 00:00:00[Paper_weekly](https://me.csdn.net/c9Yv2cf9I06K2A9E)阅读数：3894
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T27KgfBm8PibibwunTDhQibZFwOIE4tJJTRU2528Gia9fMh9bKhicDQClKicHw/640)
...
就这样，WGAN 就诞生了，详细过程请参考[互怼的艺术：从零直达 WGAN-GP](http://mp.weixin.qq.com/s?__biz=MzIwMTc4ODE0Mw==&mid=2247484880&idx=1&sn=4b2e976cc715c9fe2d022ff6923879a8&chksm=96e9da50a19e5346307b54f5ce172e355ccaba890aa157ce50fda68eeaccba6ea05425f6ad76&scene=21#wechat_redirect)。而 VAE 则使用了一个精致迂回的技巧。
...
首先我们有一批数据样本 {*X*1,…,*X*n}，其整体用 *X* 来描述，我们本想根据 {*X*1,…,*X*n} 得到 *X* 的分布 *p*(*X*)，如果能得到的话，那我直接根据 *p*(*X*) 来采样，就可以得到所有可能的 *X* 了（包括 {*X*1,…,*X*n} 以外的），这是一个终极理想的生成模型了。
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2wVnAmgotVfBYnDGJ28ic8NicXrr4eZj6iaGFuhibbwhL3UQt62XgHcgqzg/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2sOWXic8RwekfcDHGpUew6q9TuXor5aPg8tTuTAWuF6dJdZwxhXTib5Ow/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2Q3ZYtEfABMZgmSZMTxibOfn1Azbk7zZFZr4s9poUJc9K7BwiaCfq59cg/640)
...
于是我们构建两个神经网络 *μk*=*f*1(*Xk*)，log*σ*^2=*f*2(*Xk*) 来算它们了。我们选择拟合 log*σ*^2 而不是直接拟合 *σ*^2，是因为 *σ*^2 总是非负的，需要加激活函数处理，而拟合 log*σ*^2 不需要加激活函数，因为它可正可负。
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T29EJFHh2VKoEdIMcdndnbb4QcNlfnMDW2zFg3Dk35zZ2zGTqCicedRCw/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2nsJHHByezunnYQIUtGrzMXbzdQ43IEh2xwO0fibRVsYmLxWqFc55PFw/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2VVA90uJibT9E6T9abatyzbmhhFRhwofTaJIIMib7xb2gHyLWZ9078Lsw/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2DRtThoialfDkkGfKWoStoetnuFe9bBBzAjZu17SuficN6icUU11pdqVjA/640)




因为它们分别代表了均值 *μk* 和方差的对数 log*σ*^2，达到 *N*(0,*I*) 就是希望二者尽量接近于 0 了。不过，这又会面临着这两个损失的比例要怎么选取的问题，选取得不好，生成的图像会比较模糊。
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2icCq8NGK745cXzm8Hqke7jhalS6cQ8Zgf7xwlBiao3vRNnRF0ekhva5Q/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2HXWcFDAy0ZibTXCibsVruAAbIEibgQgIptR6O5Yn5f0jbtvhjJXeEXy0w/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2umEOFyvAaPxFbwlWmpUQMamPL18iaoAxbEZPkibD5CHgPYGsfmSLUrpA/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2PMiceKmiaKs8DnGzvNv3FYyPqpUsMRKyWHBFiaDAVic5c6RZbf1qInAF9w/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T22XNcpFsjNv78cptmhHpF4zUzgsrSLNce7tCaw9bfgzNXpwvsvibc8Zg/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T27wYdeTpfxgEJNFVaLcUb12DgtBTqqlGOmMaZnJewKGmmpNFgEplhqg/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2lMFwpVgmzXZlrUvG7ib5U8j5wdeGaEzJUvDc1WgIRtzn9ibWNtJcDQaA/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2wQ62r2ZHTTEx6UVcSZIITDBDoMn0btFU9x0SZVdxBEJ7hjtzS8nRhA/640)




如果是离散概率分布就要写成求和，我们要证明：**已概率分布 *p*(*x*)（或固定*q*(*x*)）的情况下，对于任意的概率分布 ***q*(*x*)**（或 ***p*(*x*)**），都有 *KL****p*(*x*)**‖***q*(*x*)**)≥0，而且只有当***p*(*x*)**=***q*(*x*)**时才等于零**。
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2oFZTicY8NUJyI2RYQiaTF9I8BzrDbUrCciayVPUSL3N7zCmyibJ9ZT69ag/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2xXpjBdicnTkONUmHDT1SXC7Fx6hyw6ictJc9t4coKnF0YTR1iboib50YxA/640)
...
![640](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/VBcD02jFhglfkZGTLyG60rcuZfgLf2T2j8ib2FnI9vmQKUJs3AzDuDiapthKPkZKrPsm9wgY40Y93BpOnMFt70OA/640)
