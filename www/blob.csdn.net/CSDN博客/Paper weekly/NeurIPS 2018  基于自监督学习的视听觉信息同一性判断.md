...
2018年12月13日 12:36:38[Paper_weekly](https://me.csdn.net/c9Yv2cf9I06K2A9E)阅读数：107
...
达特茅斯学院和 Facebook 联合发表于 NeurIPS 2018 的这篇文章正是**通过对视觉和听觉信息做同一性判断，在整体上优化视觉特征和听觉特征提取网络，在独立模态下也提高了各自的任务准确率。**不同于我们之前说的 ***Look, Listen and Learn***[1]，这篇论文不仅仅在语义上判断视觉和听觉的一致性，还在时序上做了严格对齐判断。
