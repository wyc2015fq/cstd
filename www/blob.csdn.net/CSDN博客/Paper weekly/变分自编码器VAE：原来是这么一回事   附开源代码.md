...
2018年03月23日 00:00:00[Paper_weekly](https://me.csdn.net/c9Yv2cf9I06K2A9E)阅读数：3789
...
于是我们构建两个神经网络*μk*=*f*1(*Xk*)，log*σ*^2=*f*2(*Xk*) 来算它们了。我们选择拟合log*σ*^2而不是直接拟合*σ*^2，是因为*σ*^2总是非负的，需要加激活函数处理，而拟合log*σ*^2不需要加激活函数，因为它可正可负。
