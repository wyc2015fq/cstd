# Java 好看的label-textfield（-button）布局 - Koma Hub - CSDN博客
2017年09月08日 11:39:00[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：682
```java
...
```
效果截图：
![](https://img-blog.csdn.net/20170908113941224?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvUm9uZ19Ub2E=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
以上截图代码：
```java
import java.awt.*;
...
```
效果截图：
![](https://img-blog.csdn.net/20170908115058092?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvUm9uZ19Ub2E=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
