# SeismicUnix：wtlib.c[小波变换库] - Koma Hub - CSDN博客
2018年12月18日 22:20:45[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：63
个人分类：[SeismicUnix](https://blog.csdn.net/Rong_Toa/article/category/7156242)
拿SU学习编程，真是发现原来上学的时候没有看su源代码真是白瞎了cwp这么无私的研究机构了，
```cpp
