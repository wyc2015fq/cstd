# MNIST机器学习入门 - Koma Hub - CSDN博客
2019年03月25日 22:06:10[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：35
个人分类：[MNIST																[Tensorflow																[AI](https://blog.csdn.net/Rong_Toa/article/category/7667639)](https://blog.csdn.net/Rong_Toa/article/category/8794377)](https://blog.csdn.net/Rong_Toa/article/category/7666188)
作者的相关文章
[MNIST手写数字数据集格式，如何读取MNIST数据集？](https://blog.csdn.net/Rong_Toa/article/details/80324454)
[【人工智能】利用C语言实现KNN算法进行手写数字识别](https://blog.csdn.net/Rong_Toa/article/details/80309077)
[【BP神经网络】使用反向传播训练多层神经网络的原则+“常见问题”](https://blog.csdn.net/Rong_Toa/article/details/80346754)
**Table of Contents**
[MNIST数据集](#mnist%E6%95%B0%E6%8D%AE%E9%9B%86-)
[Softmax回归介绍](#softmax%E5%9B%9E%E5%BD%92%E4%BB%8B%E7%BB%8D-)
[实现回归模型](#%E5%AE%9E%E7%8E%B0%E5%9B%9E%E5%BD%92%E6%A8%A1%E5%9E%8B-)
[训练模型](#%E8%AE%AD%E7%BB%83%E6%A8%A1%E5%9E%8B-)
[评估我们的模型](#%E8%AF%84%E4%BC%B0%E6%88%91%E4%BB%AC%E7%9A%84%E6%A8%A1%E5%9E%8B-)
*这个教程的目标读者是对机器学习和TensorFlow都不太了解的新手。如果你已经了解MNIST和softmax回归(softmax regression)的相关知识，你可以阅读这个[快速上手教程](http://www.tensorfly.cn/tfdoc/tutorials/mnist_pros.html)。*
当我们开始学习编程的时候，第一件事往往是学习打印"Hello World"。就好比编程入门有Hello World，机器学习入门有MNIST。
MNIST是一个入门级的计算机视觉数据集，它包含各种手写数字图片：
![](https://img-blog.csdnimg.cn/20190325215810709.png)
...
![](https://img-blog.csdnimg.cn/20190325215841117.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JvbmdfVG9h,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20190325215904908.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JvbmdfVG9h,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20190325215929347.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JvbmdfVG9h,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20190325215955264.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JvbmdfVG9h,size_16,color_FFFFFF,t_70)
我们也需要加入一个额外的偏置量（bias），因为输入往往会带有一些无关的干扰量。因此对于给定的输入图片 **x** 它代表的是数字 **i** 的证据可以表示为
![](https://img-blog.csdnimg.cn/20190325220019691.png)
其中 Wi 代表权重，bi代表数字 **i** 类的偏置量，**j** 代表给定图片 **x** 的像素索引用于像素求和。然后用softmax函数可以把这些证据转换成概率 **y**：
![](https://img-blog.csdnimg.cn/20190325220110345.png)
这里的softmax可以看成是一个激励（activation）函数或者链接（link）函数，把我们定义的线性函数的输出转换成我们想要的格式，也就是关于10个数字类的概率分布。因此，给定一张图片，它对于每一个数字的吻合度可以被softmax函数转换成为一个概率值。softmax函数可以定义为：
![](https://img-blog.csdnimg.cn/20190325220136482.png)
展开等式右边的子式，可以得到：
![](https://img-blog.csdnimg.cn/20190325220156118.png)
...
![](https://img-blog.csdnimg.cn/20190325220216301.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JvbmdfVG9h,size_16,color_FFFFFF,t_70)
如果把它写成一个等式，我们可以得到：
![](https://img-blog.csdnimg.cn/20190325220237848.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JvbmdfVG9h,size_16,color_FFFFFF,t_70)
我们也可以用向量表示这个计算过程：用矩阵乘法和向量相加。这有助于提高计算效率。（也是一种更有效的思考方式）
![](https://img-blog.csdnimg.cn/20190325220305419.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JvbmdfVG9h,size_16,color_FFFFFF,t_70)
更进一步，可以写成更加紧凑的方式：
![](https://img-blog.csdnimg.cn/20190325220330542.png)
## 实现回归模型
...
```
首先，我们用`tf.matmul(​​X，W)`表示`x`乘以`W`，对应之前等式里面的Wx
...
![](https://img-blog.csdnimg.cn/20190325220420298.png)
...
```
然后我们可以用 ![](https://img-blog.csdnimg.cn/20190325220451568.png)
计算交叉熵:
```
...
比结果更重要的是，我们从这个模型中学习到的设计思想。不过，如果你仍然对这里的结果有点失望，可以查看[下一个教程](http://www.tensorfly.cn/tfdoc/tutorials/mnist_pros.html)，在那里你可以学习如何用FensorFlow构建更加复杂的模型以获得更好的性能！
> 
