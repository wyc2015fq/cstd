# GTK实现：扫雷源代码（saolei.c） - Koma Hub - CSDN博客
2017年10月12日 20:54:33[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：299
```cpp
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
编译与运行：
```
$ gcc saolei.c `pkg-config --cflags --libs gtk+-2.0`
$ ./a.out
```
效果：
![](https://img-blog.csdn.net/20180511190223628)
