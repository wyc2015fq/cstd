# GTK实现文本翻页（dailyNote.c） - Koma Hub - CSDN博客
2017年10月12日 20:38:18[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：197
个人分类：[GTK																[C/C++](https://blog.csdn.net/Rong_Toa/article/category/7156199)](https://blog.csdn.net/Rong_Toa/article/category/7156203)
```cpp
/* 每日提示 tips.c */
#include <gtk/gtk.h>
...
编译与运行：
```
-bash-4.1$ gcc -o a dailyNote.c `pkg-config --cflags --libs gtk+-2.0`
-bash-4.1$ ./a
```
