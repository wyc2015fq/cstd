# Java实现查看SEGY（.su格式）数据道头字信息的GUI图形用户界面 - Koma Hub - CSDN博客
2018年01月30日 12:59:19[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：359
首先我们先生成一个.su格式的文件：
`$ suplane >v.su`
程序中文件名改为v.su
```java
...
![](https://img-blog.csdn.net/20180130125638501?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvUm9uZ19Ub2E=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
![](https://img-blog.csdn.net/20180130125750016?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvUm9uZ19Ub2E=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
下面给出代码：
```java
