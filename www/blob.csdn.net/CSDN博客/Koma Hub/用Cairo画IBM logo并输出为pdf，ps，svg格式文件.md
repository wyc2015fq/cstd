# 用Cairo画IBM logo并输出为pdf，ps，svg格式文件 - Koma Hub - CSDN博客
2019年03月03日 15:40:48[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：84
...
**Table of Contents**
[ibm_cairo_logo.c](#ibm_cairo_logo.c)
[Makefile](#Makefile)
已经在这里给出了源代码：[https://blog.csdn.net/Rong_Toa/article/details/88079069](https://blog.csdn.net/Rong_Toa/article/details/88079069)
# ibm_cairo_logo.c
```cpp
#include <gtk/gtk.h>
#include <cairo.h>
...
```
all: 
	gcc ibm_cairo_logo.c  `pkg-config --libs --cflags gtk+-2.0`
clean:
	rm -f a.out
```
![](https://img-blog.csdnimg.cn/20190303154014744.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JvbmdfVG9h,size_16,color_FFFFFF,t_70)
