# 浅析 Bash 中的 {花括号} | Linux 中国 - Koma Hub - CSDN博客
2019年03月19日 21:36:44[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：10
...
在这周，我们先来看看花括号 `{}`。
构造序列
花括号在之前的《[点的含义](http://mp.weixin.qq.com/s?__biz=MjM5NjQ4MjYwMQ==&mid=2664613216&idx=1&sn=d21cc61de85fafd185abbafd325a2997&chksm=bdcefe268ab977304a0331ca46943f33d8e548531106ed5f40a0ab6530f7164018dbb10ff584&scene=21#wechat_redirect)[1]》这篇文章中已经出现过了，当时我们只对点号 `.` 的用法作了介绍。但在构建一个序列的过程中，同样不可以缺少花括号。
我们使用
> 
`echo {0..10}`
