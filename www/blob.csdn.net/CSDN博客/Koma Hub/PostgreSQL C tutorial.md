# PostgreSQL C tutorial - Koma Hub - CSDN博客
2019年03月14日 22:37:55[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：37
个人分类：[PostgreSQL](https://blog.csdn.net/Rong_Toa/article/category/7718480)
**Table of Contents**
[About PostgreSQL database](#About%20PostgreSQL%20database)
[Installation](#Installation)
[Starting and stopping PostgreSQL](#Starting%20and%20stopping%20PostgreSQL)
[Creating a user and a database](#Creating%20a%20user%20and%20a%20database)
[C99](#C99)
[The libpq library](#The%20libpq%20library)
[lib_version.c](#lib_version.c)
[Server version](#Server%20version)
[server_version.c](#server_version.c)
[Authentication with a password](#Authentication%20with%20a%20password)
[password_authentication.c](#password_authentication.c)
[Creating a database table](#Creating%20a%20database%20table)
[create_table.c](#create_table.c)
[Simple query](#Simple%20query)
[query_version.c](#query_version.c)
[Retrieving multiple rows of data](#Retrieving%20multiple%20rows%20of%20data)
[multiple_rows.c](#multiple_rows.c)
[Prepared statements](#Prepared%20statements)
[prepared_statement.c](#prepared_statement.c)
[Metadata](#Metadata)
[Column headers](#Column%20headers)
[column_headers.c](#column_headers.c)
[Listing tables](#Listing%20tables)
[list_tables.c](#list_tables.c)
...
This was PostgreSQL C API tutorial. You may be also interested in [PostgreSQL Python tutorial](http://zetcode.com/db/postgresqlpythontutorial/),[PostgreSQL PHP tutorial](http://zetcode.com/db/postgresqlphp/), [SQLite C tutorial](http://zetcode.com/db/sqlitec/), or [MySQL C tutorial](http://zetcode.com/db/mysqlc/) on ZetCode.
