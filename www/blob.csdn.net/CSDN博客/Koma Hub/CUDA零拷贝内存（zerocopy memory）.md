# CUDA零拷贝内存（zerocopy memory） - Koma Hub - CSDN博客
2017年11月29日 16:07:25[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：1940
...
size_t nBytes = 2048;
    ...
    cudaFreeHost(h_A);
```
给个完整程序，源码网址：[点击打开链接](http://www.wrox.com/WileyCDA/WroxTitle/Professional-CUDA-C-Programming.productCd-1118739329,descCd-DOWNLOAD.html)
```cpp
