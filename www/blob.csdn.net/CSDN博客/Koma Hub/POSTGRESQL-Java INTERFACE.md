# POSTGRESQL - Java INTERFACE - Koma Hub - CSDN博客
2018年06月06日 22:07:36[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：58
个人分类：[PostgreSQL																[Java](https://blog.csdn.net/Rong_Toa/article/category/7156200)](https://blog.csdn.net/Rong_Toa/article/category/7718480)
# Installation
...
- 
Download the latest version of postgresql-VERSIONVERSION.jdbc.jar from [postgresql-jdbc][https://jdbc.postgresql.org/download.html](https://jdbc.postgresql.org/download.html) repository.
- 
...
The following section assumes you have little knowledge about Java JDBC concepts. If you do not have, then it is suggested to spent half and hour with [JDBC Tutorial][https://www.tutorialspoint.com/jdbc/jdbc-create-database.htm](https://www.tutorialspoint.com/jdbc/jdbc-create-database.htm) to become comfortable with concepts explained below.
# [](https://github.com/RongToa/ML/blob/master/SQL/PostgreSQL/PostgreSQL-java-APIs.md#connecting-to-database)Connecting To Database
...
```
# [](https://github.com/RongToa/ML/blob/master/SQL/PostgreSQL/PostgreSQL-java-APIs.md#create-a-table)Create a Table
...
```
# [](https://github.com/RongToa/ML/blob/master/SQL/PostgreSQL/PostgreSQL-java-APIs.md#insert-operation)INSERT Operation
...
```
# [](https://github.com/RongToa/ML/blob/master/SQL/PostgreSQL/PostgreSQL-java-APIs.md#select-operation)SELECT Operation
...
```
# [](https://github.com/RongToa/ML/blob/master/SQL/PostgreSQL/PostgreSQL-java-APIs.md#update-operation)UPDATE Operation
...
Operation done successfully
```
# [](https://github.com/RongToa/ML/blob/master/SQL/PostgreSQL/PostgreSQL-java-APIs.md#delete-operation)DELETE Operation
