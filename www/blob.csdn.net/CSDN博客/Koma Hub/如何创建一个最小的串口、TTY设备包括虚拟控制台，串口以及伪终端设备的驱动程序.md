# 如何创建一个最小的串口、TTY设备包括虚拟控制台，串口以及伪终端设备的驱动程序 - Koma Hub - CSDN博客
2019年02月27日 21:25:33[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：47
来源：LINUX设备驱动程序第三版配套源码
**Table of Contents**
[tiny_serial.c](#tiny_serial.c)
[tiny_tty.c](#tiny_tty.c)
[makefile](#makefile)
# tiny_serial.c
```cpp
/*
