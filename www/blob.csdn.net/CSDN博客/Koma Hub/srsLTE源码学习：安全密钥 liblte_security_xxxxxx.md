# srsLTE源码学习：安全密钥 liblte_security_xxxxxx - Koma Hub - CSDN博客
2019年04月08日 21:31:16[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：21
...
**Table of Contents**
[liblte_security.h](#liblte_security.h%C2%A0%C2%A0%20%C2%A0)
[liblte_security.cc](#liblte_security.cc%C2%A0%C2%A0)
# liblte_security.h    
...
LIBLTE_ERROR_ENUM liblte_security_encryption_eea1(uint8  *key,
                                                  ...
                                                  uint8  *out);
/*********************************************************************
    Name: liblte_security_decryption_eea1 解密
...
/*********************************************************************
    Name: liblte_security_generate_k_asme
    Description: Generate the security key Kasme. 生成安全密钥 K兹 me。
    Document Reference: 33.401 v10.0.0 Annex A.2
*********************************************************************/
LIBLTE_ERROR_ENUM liblte_security_generate_k_asme(uint8  *ck,
                                                  uint8  *ik,
...
/*********************************************************************
    Name: liblte_security_generate_k_enb
    Description: Generate the security key Kenb. //生成安全密钥 Kenb。
    Document Reference: 33.401 v10.0.0 Annex A.2
*********************************************************************/
LIBLTE_ERROR_ENUM liblte_security_generate_k_enb(uint8  *k_asme,
                                                 uint32  nas_count,
