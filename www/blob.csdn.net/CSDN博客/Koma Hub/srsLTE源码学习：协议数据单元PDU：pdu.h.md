# srsLTE源码学习：协议数据单元PDU：pdu.h - Koma Hub - CSDN博客
2019年04月11日 21:50:09[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：14

# TX与RX
- [TXD](https://www.baidu.com/s?wd=TXD&tn=SE_PcZhidaonwhc_ngpagmjz&rsv_dl=gh_pc_zhidao) 发送数据 Transmit(tx) Data 的简写形式。
