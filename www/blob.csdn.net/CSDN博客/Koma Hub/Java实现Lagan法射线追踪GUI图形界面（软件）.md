# Java实现Lagan法射线追踪GUI图形界面（软件） - Koma Hub - CSDN博客
2017年09月16日 20:04:50[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：323
```java
import java.io.*;
...
class myLaganRayTracingAboutDialog extends JDialog {
        ...
        public myLaganRayTracingAboutDialog() {
                ...
                topPanel.add(hint);
                ImageIcon icon = new ImageIcon("picture/ButtonImg/raytracing32.png");
...
```
软件主界面：
![](https://img-blog.csdn.net/20170916200513601?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvUm9uZ19Ub2E=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
结果效果图：
![](https://img-blog.csdn.net/20170916200539010?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvUm9uZ19Ub2E=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)![](https://img-blog.csdn.net/20170916200545041?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvUm9uZ19Ub2E=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)![](https://img-blog.csdn.net/20170916200550304?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvUm9uZ19Ub2E=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
