# x86 Assembly Guide - Koma Hub - CSDN博客
2019年03月18日 21:19:15[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：48
...
[Resources](#Resources)
[Registers](#Registers)
[Memory and Addressing Modes内存和寻址模式](#Memory%20and%20Addressing%20Modes%E5%86%85%E5%AD%98%E5%92%8C%E5%AF%BB%E5%9D%80%E6%A8%A1%E5%BC%8F)
[Declaring Static Data Regions声明静态数据区](#Declaring%20Static%20Data%20Regions%E5%A3%B0%E6%98%8E%E9%9D%99%E6%80%81%E6%95%B0%E6%8D%AE%E5%8C%BA)
[Addressing Memory寻址模式](#Addressing%20Memory%E5%AF%BB%E5%9D%80%E6%A8%A1%E5%BC%8F)
[Size Directives长度规定](#Size%20Directives%E9%95%BF%E5%BA%A6%E8%A7%84%E5%AE%9A)
[Instructions](#Instructions)
[Data Movement Instructions](#Data%20Movement%20Instructions)
[push — Push stack (Opcodes: FF, 89, 8A, 8B, 8C, 8E, ...)](#push%C2%A0%E2%80%94%20Push%20stack%20(Opcodes%3A%20FF%2C%2089%2C%208A%2C%208B%2C%208C%2C%208E%2C%20...))
[pop — Pop stack](#pop%C2%A0%E2%80%94%20Pop%20stack)
[lea — Load effective address](#lea%C2%A0%E2%80%94%20Load%20effective%20address)
[Arithmetic and Logic Instructions](#Arithmetic%20and%20Logic%20Instructions)
[add — Integer Addition](#add%C2%A0%E2%80%94%20Integer%20Addition)
[sub — Integer Subtraction](#sub%C2%A0%E2%80%94%20Integer%20Subtraction)
[inc, dec — Increment, Decrement](#inc%2C%20dec%C2%A0%E2%80%94%20Increment%2C%20Decrement)
[imul — Integer Multiplication](#imul%C2%A0%E2%80%94%20Integer%20Multiplication)
[idiv — Integer Division](#idiv%C2%A0%E2%80%94%20Integer%20Division)
[and, or, xor — Bitwise logical and, or and exclusive or](#and%2C%20or%2C%20xor%C2%A0%E2%80%94%20Bitwise%20logical%20and%2C%20or%20and%20exclusive%20or)
[not — Bitwise Logical Not](#not%C2%A0%E2%80%94%20Bitwise%20Logical%20Not)
[neg — Negate](#neg%C2%A0%E2%80%94%20Negate)
[shl, shr — Shift Left, Shift Right](#shl%2C%20shr%C2%A0%E2%80%94%20Shift%20Left%2C%20Shift%20Right)
[Control Flow Instructions](#Control%20Flow%20Instructions)
[jmp — Jump](#jmp%C2%A0%E2%80%94%20Jump)
[jcondition — Conditional Jump](#jcondition%C2%A0%E2%80%94%20Conditional%20Jump)
[cmp — Compare](#cmp%C2%A0%E2%80%94%20Compare)
[call, ret — Subroutine call and return](#call%2C%C2%A0ret%C2%A0%E2%80%94%20Subroutine%20call%20and%20return)
[Calling Convention](#Calling%20Convention)
[Caller Rules](#Caller%20Rules)
[Example](#Example%C2%A0)
[Callee Rules](#Callee%20Rules)
[Example](#Example)
**Contents:**[Registers](http://www.cs.virginia.edu/~evans/cs216/guides/x86.html#registers) | [Memory and Addressing](http://www.cs.virginia.edu/~evans/cs216/guides/x86.html#memory) | [Instructions](http://www.cs.virginia.edu/~evans/cs216/guides/x86.html#instructions) | [Calling Convention](http://www.cs.virginia.edu/~evans/cs216/guides/x86.html#calling)
> 
...
![](https://img-blog.csdnimg.cn/20190318211048598.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JvbmdfVG9h,size_16,color_FFFFFF,t_70)
## Memory and Addressing Modes内存和寻址模式
### Declaring Static Data Regions声明静态数据区
> 
...
现代X86处理器具有2^32字节的寻址空间。在上面的例子中，我们用标签(label)表示内存区域，这些标签在实际汇编时，均被32位的实际地址代替。除了支持这种直接的内存区域描述，X86还提供了一种灵活的内存寻址方式，即利用最多两个32位的寄存器和一个32位的有符号常数相加计算一个内存地址，其中一个寄存器可以左移1、2或3位以表述更大的空间。下面例子是汇编程序中常见的方式
...
![](https://img-blog.csdnimg.cn/20190318211139684.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1JvbmdfVG9h,size_16,color_FFFFFF,t_70)
...
> 
原文地址：[http://www.cs.virginia.edu/~evans/cs216/guides/x86.html](http://www.cs.virginia.edu/~evans/cs216/guides/x86.html)
译文：[http://www.cnblogs.com/YukiJohnson/archive/2012/10/27/2741836.html](http://www.cnblogs.com/YukiJohnson/archive/2012/10/27/2741836.html)
转载：[https://blog.csdn.net/u012837895/article/details/79855887](https://blog.csdn.net/u012837895/article/details/79855887)
