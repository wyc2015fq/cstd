# GitHub#C/C++#：linux Terminal game：2048（曾经红极一时的2048） - Koma Hub - CSDN博客
2018年05月11日 18:51:38[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：136
```cpp
/* ============================================================================
 Name        : 2048.c
...
```
效果图：
![](https://img-blog.csdn.net/20180511185110144)
源代码：[https://github.com/mevdschee/2048.c](https://github.com/mevdschee/2048.c)
