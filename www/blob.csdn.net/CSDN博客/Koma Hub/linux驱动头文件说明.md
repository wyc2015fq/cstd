# linux驱动头文件说明 - Koma Hub - CSDN博客
2019年01月27日 18:59:01[Koma_Wong](https://me.csdn.net/Rong_Toa)阅读数：73
...
编译后的linux内核，驱动头文件路径为/usr/src/kernels/3.10.0-693.el7.x86_64/include/linux，根据不同的内核版本，写成通用的路径模式为：
```
...
### （2）[Linux内核](https://www.baidu.com/s?wd=Linux%E5%86%85%E6%A0%B8&tn=24004469_oem_dg&rsv_dl=gh_pl_sl_csd)专用头文件子目录include/linux
...
以其中一个文件为例：
```
$ more /usr/src/kernels/`uname -r`/include/linux/stat.h
...
#endif
```
原文地址找不到了，但是有两位仁兄也转载过：
[https://blog.csdn.net/wanghanjiett/article/details/6791593](https://blog.csdn.net/wanghanjiett/article/details/6791593)
[https://blog.csdn.net/shenwanjiang111/article/details/52396097?utm_source=blogxgwz7](https://blog.csdn.net/shenwanjiang111/article/details/52396097?utm_source=blogxgwz7)
