# CV：深入浅出的讲解傅里叶变换（真正的通俗易懂） - wishchinYang的专栏 - CSDN博客
2018年02月04日 15:02:36[wishchin](https://me.csdn.net/wishchin)阅读数：983
     这是一篇很NB的文章，图文并茂...............
     另外这个回答比较好：[能不能通俗地讲解傅里叶和小波分析的关系](https://www.zhihu.com/question/22864189)？ 第二个妹子头像的回答
**两句话：傅里叶变换：知道一段时间内，信号的各个频率分量有分别多少。小波变换：知道一段时间内，信号的各个频率分量有分别多少，以及他们都是什么时候出现的。**
`     原文出处： [韩昊](http://zhuanlan.zhihu.com/wille/19763358)   `
...
在你的理解中，一段音乐是什么呢？
![](http://ww3.sinaimg.cn/mw690/7cc829d3gw1eh5v4r7dlkj20go05mwff.jpg)
这是我们对音乐最普遍的理解，一个随着时间变化的震动。但我相信对于乐器小能手们来说，音乐更直观的理解是这样的：
![](http://ww2.sinaimg.cn/mw690/7cc829d3gw1eh5v4w5m0xj20go05nwff.jpg)
好的！下课，同学们再见。
是的，其实这一段写到这里已经可以结束了。上图是音乐在时域的样子，而下图则是音乐在频域的样子。所以频域这一概念对大家都从不陌生，只是从来没意识到而已。
现在我们可以回过头来重新看看一开始那句痴人说梦般的话：世界是永恒的。
将以上两图简化：
时域：
![](http://ww1.sinaimg.cn/mw690/7cc829d3gw1eh5v4xmosuj20go096t9l.jpg)
频域：
![](http://ww3.sinaimg.cn/mw690/7cc829d3gw1egu4n43a2gj203t05jq2r.jpg)
...
![](http://ww4.sinaimg.cn/mw690/7cc829d3gw1eh5v4yfzcsj20go0cujt7.jpg)
第一幅图是一个郁闷的正弦波 cos（x）
...
![](http://ww1.sinaimg.cn/mw690/7cc829d3gw1eh5v4zmdijj20go0qun0b.jpg)
...
时域的基本单元就是“1 秒”，如果我们将一个角频率为![\omega_{0}](http://images.cnitblog.com/news/66372/201405/271732411343005.png)的正弦波 cos（![\omega_{0}](http://images.cnitblog.com/news/66372/201405/271732412442504.png)t）看作基础，那么频域的基本单元就是![\omega_{0}](http://images.cnitblog.com/news/66372/201405/271732416978431.png)。
...
![](http://ww2.sinaimg.cn/large/7cc829d3gw1egu4n8nmvhg20fk05lmxo.gif)
正弦波就是一个圆周运动在一条直线上的投影。所以频域的基本单元也可以理解为一个始终在旋转的圆
![](http://ww4.sinaimg.cn/mw690/7cc829d3gw1egu4mtx2sjg2074074tha.gif)
想看动图的同学请戳这里：
...
![File:Fourier series sawtooth wave circles animation.gif](http://images.cnitblog.com/news/66372/201405/271734071031740.gif)
以及这里：
...
![](http://ww2.sinaimg.cn/mw690/7cc829d3gw1eh5v5098jzj20go0btq3q.jpg)
这是什么奇怪的东西？
这就是矩形波在频域的样子，是不是完全认不出来了？教科书一般就给到这里然后留给了读者无穷的遐想，以及无穷的吐槽，其实教科书只要补一张图就足够了：频域图像，也就是俗称的频谱，就是——
![](http://ww2.sinaimg.cn/mw690/7cc829d3gw1eh5v53i4kjj20go07iab8.jpg)
再清楚一点：
![](http://ww2.sinaimg.cn/mw690/7cc829d3gw1eh5v57q4vij20go0a0gn0.jpg)
可以发现，在频谱中，偶数项的振幅都是0，也就对应了图中的彩色直线。振幅为 0 的正弦波。
![File:Fourier series and transform.gif](http://images.cnitblog.com/news/66372/201405/271734446194512.gif)
动图请戳：
...
![](http://ww4.sinaimg.cn/mw690/7cc829d3gw1eh5v58ov24j20go0hutao.jpg)
鉴于正弦波是周期的，我们需要设定一个用来标记正弦波位置的东西。在图中就是那些小红点。小红点是距离频率轴最近的波峰，而这个波峰所处的位置离频率轴有多远呢？为了看的更清楚，我们将红色的点投影到下平面，投影点我们用粉色点来表示。当然，这些粉色的点只标注了波峰距离频率轴的距离，并不是相位。
![](http://ww4.sinaimg.cn/mw690/7cc829d3gw1eh5v5cn9yrj20go0fsgmu.jpg)
...
最后来一张大集合：
![](http://ww1.sinaimg.cn/mw690/7cc829d3gw1eh5v5dhli2j20go0dtwga.jpg)
...
算了，还是上一张图方便大家理解吧：
![](http://ww4.sinaimg.cn/large/7cc829d3gw1eh5q2g0nhuj20go08baan.jpg)
...
![](http://ww1.sinaimg.cn/mw690/7cc829d3gw1eh5q2gl2u3j20go07z756.jpg)
以上是离散谱，那么连续谱是什么样子呢？
尽情的发挥你的想象，想象这些离散的正弦波离得越来越近，逐渐变得连续……
直到变得像波涛起伏的大海：
![](http://ww1.sinaimg.cn/mw690/7cc829d3gw1eh5q2i13r8j20go08smyb.jpg)
...
![](http://ww4.sinaimg.cn/large/7cc829d3gw1eh5q2ioeygj20go03cwep.jpg)
...
![](http://ww2.sinaimg.cn/mw690/7cc829d3gw1eh5q2na8puj207p04uwef.jpg)
所以其实我们在很早就接触到了光的频谱，只是并没有了解频谱更重要的意义。
但不同的是，傅里叶变换出来的频谱不仅仅是可见光这样频率范围有限的叠加，而是频率从 0 到无穷所有频率的组合。
这里，我们可以用两种方法来理解正弦波：
第一种前面已经讲过了，就是螺旋线在实轴的投影。
另一种需要借助欧拉公式的另一种形式去理解：
![e^{it}=cos (t) +i.sin (t)](http://images.cnitblog.com/news/66372/201406/071037533339291.png)
![e^{-it}=cos (t)-i.sin (t)](http://images.cnitblog.com/news/66372/201406/071037541452176.png)
将以上两式相加再除2，得到：
![](http://ww2.sinaimg.cn/mw690/7cc829d3gw1eh5q2uzxlfj203k010t8h.jpg)
这个式子可以怎么理解呢？
...
想象一下再往下翻：
![](http://ww3.sinaimg.cn/mw690/7cc829d3gw1eh5q2psb9wj20m80h8wi6.jpg)
是不是很漂亮？
你猜猜，这个图形在时域是什么样子？
![](http://ww4.sinaimg.cn/mw690/7cc829d3gw1eh5q2sq0eqj20go0d33z1.jpg)
...
![](http://ww4.sinaimg.cn/mw690/7cc829d3gw1eh5q2t82oxj20go0r8acj.jpg)
