# Python框架、库和软件资源大全(整理篇) - wishchinYang的专栏 - CSDN博客
2014年08月13日 08:54:29[wishchin](https://me.csdn.net/wishchin)阅读数：1346
有少量修改，请访问原始链接。PythonWIn的exe安装包;[http://www.lfd.uci.edu/~gohlke/pythonlibs/](http://www.lfd.uci.edu/~gohlke/pythonlibs/)
原文链接：[codecloud.net/python-resource-2109.html](codecloud.net/python-resource-2109.html)
现代[编程语言](http://codecloud.net/?s=%E7%BC%96%E7%A8%8B%E8%AF%AD%E8%A8%80)的一个非常令人欣慰的事是有很多的社区在驱动语言的发展。
很多来自世界各地的程序员不求回报的写代码为别人造轮子、贡献代码、开发框架。开放源代码使得分散在世界各地的程序员们都能够贡献他们的代码与创新。
[Python](http://codecloud.net/?s=Python)就是这样一门受到全世界各地开源社区支持的语言。Python可以用来开发各种小工具软件、web应用、科学计算、数据分析等等，Python拥有大量的流行框架，比如[Django](http://codecloud.net/?s=Django)。使用Python框架时，可以根据自己的需求插入不同的模块，比如可以用Scrapy来实现网络爬虫，可以用SciPy来进行科学计算。
Python很多模块框架都拥有来自社区良好的支持与维护。
Python是一门非常受欢迎的编程语言，最近甚至成为了美国很多大学最受欢迎的编程语言。
## [下面的这个列表是由程序员的资料库从网络上收集的有个Python的资源](http://codecloud.net)
- [Python 2.7 官方中文文档](http://codecloud.net/books/pythontutorial27/html/index.html)
- [Python 3.3 官方中文文档](http://codecloud.net/books/pythontutorial3/html/index.html)
- [Awesome Python](https://github.com/vinta/awesome-python#awesome-python)- [Environment Management](https://github.com/vinta/awesome-python#environment-management)
...
- [Imagery](https://github.com/vinta/awesome-python#imagery)
...
- [HTTP](https://github.com/vinta/awesome-python#http)
...
- [Authentication and OAuth](https://github.com/vinta/awesome-python#authentication-and-oauth)
...
- [Asset Management](https://github.com/vinta/awesome-python#asset-management)
...
- [Anti-spam](https://github.com/vinta/awesome-python#anti-spam)
...
- [Processes and Threads](https://github.com/vinta/awesome-python#processes-and-threads)
- [Concurrency and Networking](https://github.com/vinta/awesome-python#concurrency-and-networking)
...
- [GUI](https://github.com/vinta/awesome-python#gui)
...
- [Code Analysis and Linter](https://github.com/vinta/awesome-python#code-analysis-and-linter)
- [Debugging Tools](https://github.com/vinta/awesome-python#debugging-tools)
- [Science and Data Analysis](https://github.com/vinta/awesome-python#science-and-data-analysis)
...
- [MapReduce](https://github.com/vinta/awesome-python#mapreduce)
...
- [High Performance](https://github.com/vinta/awesome-python#high-performance)
- [Network Virtualization and SDN](https://github.com/vinta/awesome-python#network-virtualization-and-sdn)
...
- [Editor Plugins](https://github.com/vinta/awesome-python#editor-plugins)
- [Resources](https://github.com/vinta/awesome-python#resources)- [Websites](https://github.com/vinta/awesome-python#websites)
- [Weekly](https://github.com/vinta/awesome-python#weekly)
- [Twitter](https://github.com/vinta/awesome-python#twitter)
- [Other Awesome Lists](https://github.com/vinta/awesome-python#other-awesome-lists)
...
## [](https://github.com/vinta/awesome-python#package-management)Package Management
...
- [pytz](https://launchpad.net/pytz) - World timezone definitions, modern and historical. Brings the [Olson
 tz database](http://en.wikipedia.org/wiki/Tz_database) into Python.
## [](https://github.com/vinta/awesome-python#text-processing)Text Processing
...
- [xlwt](https://github.com/python-excel/xlwt) / [xlrd](https://github.com/python-excel/xlrd) - Packages is for writing and reading data and
...
- [TextBlob](http://textblob.readthedocs.org/) - Providing a consistent API for diving into common natural language processing (NLP) tasks. Stands on the giant shoulders of NLTK and Pattern, and plays
 nicely with both.
...
## [](https://github.com/vinta/awesome-python#imagery)Imagery
*Libraries for manipulating images.*
- [pillow](http://pillow.readthedocs.org/) - Pillow is the **friendly** PIL fork. PIL is the [Python
...
- [django-elastic-transcoder](https://github.com/StreetVoice/django-elastic-transcoder) - Django + [Amazon
...
## [](https://github.com/vinta/awesome-python#http)HTTP
...
## [](https://github.com/vinta/awesome-python#web-frameworks)Web Frameworks
*Full stack web frameworks.*
- **[Django](https://www.djangoproject.com/) - The most popular web framework in Python.**- [awesome-django](https://github.com/rosarior/awesome-django)
...
## [](https://github.com/vinta/awesome-python#cms)CMS
...
## [](https://github.com/vinta/awesome-python#e-commerce)E-commerce
...
## [](https://github.com/vinta/awesome-python#authentication-and-oauth)Authentication and OAuth
...
## [](https://github.com/vinta/awesome-python#search)Search
...
## [](https://github.com/vinta/awesome-python#asset-management)Asset Management
...
- [f**anstatic**](http://www.fanstatic.org/)** - Packages, optimizes, and serves static file dependencies as Python packages.**
...
- [libsass-python](http://hongminhee.org/libsass-python/) - A Python binding of [libsass](https://github.com/hcatlin/libsass), the reference
...
## [](https://github.com/vinta/awesome-python#forms)Forms
...
## [](https://github.com/vinta/awesome-python#anti-spam)Anti-spam
...
## [](https://github.com/vinta/awesome-python#processes-and-threads)Processes and Threads
...
## [](https://github.com/vinta/awesome-python#concurrency-and-networking)Concurrency and Networking
...
## [](https://github.com/vinta/awesome-python#cryptography)Cryptography
...
## [](https://github.com/vinta/awesome-python#gui)GUI
...
- [PySide](http://qt-project.org/wiki/pyside) - Python bindings for the [Qt](http://qt-project.org/) cross-platform application and UI framework,
 supporting the Qt v4 framework.
...
- [curses](https://docs.python.org/2/library/curses.html#module-curses) - Built-in wrapper for [ncurses](http://www.gnu.org/software/ncurses/) used
 to create terminal GUI applications.
...
## [](https://github.com/vinta/awesome-python#code-analysis-and-linter)Code Analysis and Linter
...
## [](https://github.com/vinta/awesome-python#science-and-data-analysis)Science and Data Analysis
...
## [](https://github.com/vinta/awesome-python#mapreduce)MapReduce
...
- [streamparse](https://github.com/Parsely/streamparse) - Run Python code against real-time streams of data. Integrates with [Apache
...
## [](https://github.com/vinta/awesome-python#high-performance)High Performance
...
## [](https://github.com/vinta/awesome-python#network-virtualization-and-sdn)Network Virtualization and SDN
...
## [](https://github.com/vinta/awesome-python#editor-plugins)Editor Plugins
...
- [Jedi-vim](https://github.com/davidhalter/jedi-vim) - Vim bindings for the [Jedi](https://github.com/davidhalter/jedi) autocompletion library
 for Python.
- Emacs
...
## [](https://github.com/vinta/awesome-python#weekly)Weekly
...
# [](https://github.com/vinta/awesome-python#other-awesome-lists)Other Awesome Lists
List of lists.
- Python
...
本文由 [程序员的资料库](http://codecloud.net)
整理自网络，欢迎转载，但请保留出处！
