# VS常用快捷键 - wishchinYang的专栏 - CSDN博客
2017年04月06日 15:12:49[wishchin](https://me.csdn.net/wishchin)阅读数：235
**跳转到指定的某一行 **方法1：组合键“Ctrl+G”； 
原文：[http://blog.csdn.net/lushuner/article/details/23688629](http://blog.csdn.net/lushuner/article/details/23688629)
VS2013常用快捷键： 
...
14.生成解决方案 
使用组合键“Ctrl+Shift+B”。 
**15.跳转到指定的某一行 **1）方法1：组合键“Ctrl+G”； 
2）方法2：单击状态栏中的行号。 
**16.注释/取消注释 **1）注释：组合键“Ctrl+K+C”； 
2）取消注释：组合键“Ctrl+K+U”。 
**17.全屏显示/退出全屏显示 **
