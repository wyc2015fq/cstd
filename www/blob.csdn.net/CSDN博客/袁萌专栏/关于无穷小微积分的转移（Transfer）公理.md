# 关于无穷小微积分的转移（Transfer）公理 - 袁萌专栏 - CSDN博客
2013年03月03日 03:49:51[yuanmeng001](https://me.csdn.net/yuanmeng001)阅读数：740
...
在《基础微积分》电子版到第一章第1.5节第28页，为达此目的，J.Keisler引进两条模型论（ModelTheory）公理（Axioms）：一是延伸公理（Extension
 Axiom，简记为EA），二是转移公理（Transfer
 Axiom，简记为TA）。EA是说，任何实函数f都存在一个相应的超实函数*f与其对应，*f叫做函数f的“自然延伸”(NaturalExtension)；而TA是说，任何陈述句（Statement）在R中成立，那么，该陈述句在*R中也必定成立。为准确理解转移公理（TA），我们要问，什么是陈述句？这是问题的关键。
