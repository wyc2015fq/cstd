# Pushlet定点推送消息 - z69183787的专栏 - CSDN博客
2014年03月22日 14:09:49[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1378
...
web.xml代码如下：
Xml代码    [](http://tonl.iteye.com/blog/1398995)![收藏代码](http://tonl.iteye.com/images/icon_star.png)
...
Js代码    [](http://tonl.iteye.com/blog/1398995)![收藏代码](http://tonl.iteye.com/images/icon_star.png)
- **if** (anEvent == 'join' || anEvent == 'join-listen') {    url = url + '&userId=' + PL.userId;   
-         }  
 好了，ajax-pushlet-client.js的修改就完成了。
接下来是test.html:
Html代码    [](http://tonl.iteye.com/blog/1398995)![收藏代码](http://tonl.iteye.com/images/icon_star.png)
- **<****html****>**
- **<****head****>**
...
Java代码    [](http://tonl.iteye.com/blog/1398995)![收藏代码](http://tonl.iteye.com/images/icon_star.png)
