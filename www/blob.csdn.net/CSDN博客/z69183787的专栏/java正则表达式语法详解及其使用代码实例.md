# java正则表达式语法详解及其使用代码实例 - z69183787的专栏 - CSDN博客
2016年08月20日 22:48:59[OkidoGreen](https://me.csdn.net/z69183787)阅读数：711
个人分类：[正则表达式](https://blog.csdn.net/z69183787/article/category/2175421)

代码下载地址：[http://www.zuidaima.com/share/1835085544524800.htm](http://www.zuidaima.com/share/1835085544524800.htm)
原文：[java正则表达式语法详解及其使用代码实例](http://www.zuidaima.com/share/1835085544524800.htm)
Regular Expressions of Java Tutorial
译者序
　　正则表达式善于处理文本，对匹配、搜索和替换等操作都有意想不到的作用。正因如此，正则表达式现在是作为程序员七种基本技能之一[*](http://blog.csdn.net/yaerfeng/article/details/28855587#noteStart01)，因此学习和使用它在工作中都能达到很高的效率。
...
　　我在一次偶然中发现了位于 [java.sun.com](http://java.sun.com/) 站点上的 [Java
 Tutorial](http://java.sun.com/docs/books/tutorial/)，也在那里看到了关于 Java 的正则表达式教程，感觉它不同于其他的正则表达式教程，文中以大量的匹配实例来进行说明。为了能让 Java 学习者能更好地使用正则表达式，就将其完整地译出了。该教程中所介绍的正则表达式应用仅仅是最为简单的（并没有完全地涉及到 Pattern 类支持的所有正则表达式语法，也没有涉及到高级的应用），适合于从未接触过或者是尚未完全明白正则表达式基础的学习者。在学习完该教程后，应该对正则表达式有了初步的了解，并能熟练地运用 java.util.regex
 包中的关于正则表达式的类库，为今后学习更高级的正则表达式技术奠定良好的基础。
　　教程中所有的源代码都在 src 目录下，可以直接编译运行。由于当前版本的 [Java Tutorial](http://java.sun.com/docs/books/tutorial/) 是基于 JDK 6.0 的，因此其中的示例程序也用到了 JDK 6.0 中的新增类库，但正则表达式在
 JDK 1.4 就已经存在了，为了方便大家使用，改写了部分的源代码，源代码类名中后缀为“V4”的表示用于 JDK 1.4 或以上版本，“V5”的表示用于 JDK 5.0 或以上版本，没有这些后缀的类在各个版本中均可以正常使用。
　　由于译者的水平和技术能力有限，译稿虽经多次校对，难免有疏漏之处，敬请大家批评和指正。若有发现不妥之处，请发送邮件至[FrankieGao123@gmail.com](mailto: FrankieGao123@gmail.com)，我会在 [blog](http://blog.csdn.net/bao110908) 中进行勘误，谢谢！
　　　　火龙果顿首！
2008 年 2 月 27 日
[*](http://blog.csdn.net/yaerfeng/article/details/28855587#noteStart_01) 
 这是由《程序员》杂志社评出的，刊登在《程序员》2007 年 3 月刊上。这七种基本技能是：数组，字符串与哈希表、正则表达式、调试、两门语言、一个开发环境、SQL 语言和编写软件的思想。
目录
- [译者序](http://blog.csdn.net/yaerfeng/article/details/28855587#foreword)
- [序](http://blog.csdn.net/yaerfeng/article/details/28855587#preface)
- [0　引言](http://blog.csdn.net/yaerfeng/article/details/28855587#reg0)- [0.1　什么是正则表达式？](http://blog.csdn.net/yaerfeng/article/details/28855587#reg0_1)
- [0.2　java.util.regex 包是如何描述正则表达式的？](http://blog.csdn.net/yaerfeng/article/details/28855587#reg0_2)
- [1　测试用具](http://blog.csdn.net/yaerfeng/article/details/28855587#reg1)
- [2　字符串](http://blog.csdn.net/yaerfeng/article/details/28855587#reg2)- [2.1　元字符](http://blog.csdn.net/yaerfeng/article/details/28855587#reg2_1)
[](http://blog.csdn.net/yaerfeng/article/details/28855587#reg2_1)
- [3　字符类](http://blog.csdn.net/yaerfeng/article/details/28855587#reg3)- [3.1　简单类](http://blog.csdn.net/yaerfeng/article/details/28855587#reg3_1)- [3.1.1　否定](http://blog.csdn.net/yaerfeng/article/details/28855587#reg3_1_1)
- [3.1.2　范围](http://blog.csdn.net/yaerfeng/article/details/28855587#reg3_1_2)
- [3.1.3　并集](http://blog.csdn.net/yaerfeng/article/details/28855587#reg3_1_3)
- [3.1.4　交集](http://blog.csdn.net/yaerfeng/article/details/28855587#reg3_1_4)
- [3.1.5　差集](http://blog.csdn.net/yaerfeng/article/details/28855587#reg3_1_5)
- [4　预定义字符类](http://blog.csdn.net/yaerfeng/article/details/28855587#reg4)
- [5　量词](http://blog.csdn.net/yaerfeng/article/details/28855587#reg5)- [5.1　零长度匹配](http://blog.csdn.net/yaerfeng/article/details/28855587#reg5_1)
- [5.2　捕获组和字符类中的量词](http://blog.csdn.net/yaerfeng/article/details/28855587#reg5_2)
- [5.3　贪婪、勉强和侵占量词间的不同](http://blog.csdn.net/yaerfeng/article/details/28855587#reg5_3)
- [6　捕获组](http://blog.csdn.net/yaerfeng/article/details/28855587#reg6)- [6.1　编号方式](http://blog.csdn.net/yaerfeng/article/details/28855587#reg6_1)
- [6.2　反向引用](http://blog.csdn.net/yaerfeng/article/details/28855587#reg6_2)
- [7　边界匹配器](http://blog.csdn.net/yaerfeng/article/details/28855587#reg7)
- [8　Pattern 类的方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg8)- [8.1　使用标志构建模式](http://blog.csdn.net/yaerfeng/article/details/28855587#reg8_1)
- [8.2　内嵌标志表达式](http://blog.csdn.net/yaerfeng/article/details/28855587#reg8_2)
- [8.3　使用 matches(String, CharSequence) 方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg8_3)
- [8.4　使用 split(String) 方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg8_4)
- [8.5　其他有用的方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg8_5)
- [8.6　在 java.lang.String 中等价的 Pattern 方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg8_6)
- [9　Matcher 类的方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg9)- [9.1　使用 start 和 end 方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg9_1)
- [9.2　使用 matches 和 lookingAt 方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg9_2)
- [9.3　使用 replaceFirst(String) 和 replaceAll(String) 方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg9_3)
- [9.4　使用 appendReplacement(StringBuffer, String) 和 appendTail(StringBuffer) 方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg9_4)
- [9.5　在 java.lang.String 中等价的 Matcher 方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg9_5)
- [10　PatternSyntaxException 类的方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg10)
- [11　更多的资源](http://blog.csdn.net/yaerfeng/article/details/28855587#reg11)
- [12　问题和练习](http://blog.csdn.net/yaerfeng/article/details/28855587#reg12)
- [注释](http://blog.csdn.net/yaerfeng/article/details/28855587#note)
- [译后记](http://blog.csdn.net/yaerfeng/article/details/28855587#last)
序[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
0　引言[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
0.1　什么是正则表达式？[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
0.2　java.util.regex 包是如何描述正则表达式的？[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
1　测试用具[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
**[java]**[view
 plain](http://blog.csdn.net/yaerfeng/article/details/28855587#)[copy](http://blog.csdn.net/yaerfeng/article/details/28855587#)
[print](http://blog.csdn.net/yaerfeng/article/details/28855587#)[?](http://blog.csdn.net/yaerfeng/article/details/28855587#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/379179/fork)
...
**[java]**[view
 plain](http://blog.csdn.net/yaerfeng/article/details/28855587#)[copy](http://blog.csdn.net/yaerfeng/article/details/28855587#)
[print](http://blog.csdn.net/yaerfeng/article/details/28855587#)[?](http://blog.csdn.net/yaerfeng/article/details/28855587#)
...
【译者注】
　　由于当前版本的 [Java Tutorial](http://java.sun.com/docs/books/tutorial/) 是基于 JDK 6.0 编写的，上述的测试用具由于使用到 JDK 6.0 中新增的类库（java.io.Console），所以该用具只能在
 JDK 6.0 的环境中编译运行，由于 Console 访问操作系统平台上的控制台，因此这个测试用具只能在操作系统的字符控制台中运行，不能运行在 IDE 的控制台中。
...
-     }   
- }  
2　字符串[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
2.1　元字符[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
3　字符类[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
3.1　简单类（Simple Classes）[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
3.1.1　否定[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
3.1.2　范围[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
3.1.3　并集[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
- No match found.  
3.1.4　交集[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
- No match found.  
3.1.5　差集[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
4　预定义字符类[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
`\S` 匹配非空白字符
`\W` 匹配非单词字符
5　量词[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
- Enter input string to search:   
- No match found.  
5.1　零长度匹配[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
5.2　捕获组和字符类中的量词[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
5.3　贪婪、勉强和侵占量词间的不同[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
6　捕获组[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
6.1　编号方式[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
　　有一个特别的组——组 0，它表示整个表达式。这个组不包括在 groupCount 的报告范围内。以`(?`开始的组是纯粹的非捕获组（non-capturing group），它不捕获文本，也不作为组总数而计数。（可以看[8
 Pattern 类的方法](http://blog.csdn.net/yaerfeng/article/details/28855587#reg8) 一节中非捕获组的例子。）
...
6.2　反向引用[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
7　边界匹配器[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
8　Pattern 类的方法[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
　　到目前为止，仅使用测试用具来建立最基本的 Pattern 对象。在这一节中，我们将探讨一些诸如使用标志构建模式、使用内嵌标志表达式等高级的技术。同时也探讨了一些目前还没有讨论过的其他有用的方法。
8.1　使用标志构建模式[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
- 
8.2　内嵌标志表达式[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
8.3　使用 matches(String, CharSequence) 方法[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
8.4　使用 split(String) 方法[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
　　split 方法是一个重要的工具，用于收集依赖于被匹配的模式任一边的文本。如下面的 [SplitDemo.java](http://blog.csdn.net/yaerfeng/article/details/src/SplitDemo.java) 所示，split 方法能从“one:two:three:four:five”字符串中解析出“one
 two three four five”单词：
**[java]**[view
 plain](http://blog.csdn.net/yaerfeng/article/details/28855587#)[copy](http://blog.csdn.net/yaerfeng/article/details/28855587#)
[print](http://blog.csdn.net/yaerfeng/article/details/28855587#)[?](http://blog.csdn.net/yaerfeng/article/details/28855587#)
- import java.util.regex.Pattern;   
...
- four  
- five  
8.5　其他有用的方法[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
　　你可以从下面的方法中找到比较好用的方法：
...
8.6　在 java.lang.String 中等价的 Pattern 方法[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
9　Matcher 类的方法[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
9.1　使用 start 和 end 方法[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
9.2　使用 matches 和 lookingAt 方法[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
　　matches 和 lookingAt 方法都是尝试该模式匹配输入序列。然而不同的是，matches 要求匹配整个输入字符串，而 lookingAt 不是这样。这两个方法都是从输入字符串的开头开始的。下面是[MatchesLooking.java](http://blog.csdn.net/yaerfeng/article/details/src/MatchesLooking.java) 完整的代码：
**[java]**[view
 plain](http://blog.csdn.net/yaerfeng/article/details/28855587#)[copy](http://blog.csdn.net/yaerfeng/article/details/28855587#)
[print](http://blog.csdn.net/yaerfeng/article/details/28855587#)[?](http://blog.csdn.net/yaerfeng/article/details/28855587#)
- import java.util.regex.Pattern;   
...
　     appendTail(StringBuffer) 方法[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
　　Matcher 类也提供了 appendReplacement 和 appendTail 两个方法用于文本替换。下面的这个例子（[RegexDemo.java](http://blog.csdn.net/yaerfeng/article/details/src/RegexDemo.java)）使用了这两个方法完成与
 replaceAll 相同的功能。
**[java]**[view
 plain](http://blog.csdn.net/yaerfeng/article/details/28855587#)[copy](http://blog.csdn.net/yaerfeng/article/details/28855587#)
[print](http://blog.csdn.net/yaerfeng/article/details/28855587#)[?](http://blog.csdn.net/yaerfeng/article/details/28855587#)
...
[print](http://blog.csdn.net/yaerfeng/article/details/28855587#)[?](http://blog.csdn.net/yaerfeng/article/details/28855587#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/379179/fork)
- -foo-foo-foo-  
9.5　在 java.lang.String 中等价的 Matcher 方法[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
10　PatternSyntaxException 类的方法[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
11　更多的资源[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
...
12　问题和练习[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
〖问题〗
...
解答：`([A-Z][a-zA-Z]*)\s\1`
注释[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
[[1]](http://blog.csdn.net/yaerfeng/article/details/28855587#note_01)  本文全文译自[Java
 Tutorial](http://java.sun.com/docs/books/tutorial/) 的 [Regular Expressions](http://java.sun.com/docs/books/tutorial/essential/regex/index.html)，标题是译者自拟的。——译者注
[[2]](http://blog.csdn.net/yaerfeng/article/details/28855587#note_02)  Unix 工具，用于文件中的字符串查找，它是最早的正则表达式工具之一。——译者注
[[3]](http://blog.csdn.net/yaerfeng/article/details/28855587#note_03)  若要退出可以使用 Ctrl
 + C 来中断。——译者注
[[4]](http://blog.csdn.net/yaerfeng/article/details/28855587#note_04)  图中的“索引
 3”指示是译者所加，原文中并没有。——译者注
[[5]](http://blog.csdn.net/yaerfeng/article/details/28855587#note_05)  这种方式在
 JDK 6.0 以前版本使用需要注意，在字符类中使用这种结构是有 bug 的，不过在 JDK 6.0 中已经修正。——译者注
[[6]](http://blog.csdn.net/yaerfeng/article/details/28855587#note_06)  若`\E`前没有`\Q`时会产生 PatternSyntaxException 异常指示语法错误。——译者注
[[7]](http://blog.csdn.net/yaerfeng/article/details/28855587#note_07)  第一次匹配时仅匹配字符串的开始部分，与`\A`类似。（引自
 Jeffrey E.F.Friedl,[Mastering Regular Expressions](http://www.oreilly.com/catalog/regex3/index.html), 3rd ed., §3.5.3.3, O'Reilly, 2006.）——译者注
[[8]](http://blog.csdn.net/yaerfeng/article/details/28855587#note_08)  \u030A，即字符
 å 上半部分的小圆圈（ ? ）（该字符在 IE 浏览器上无法正确显示，在 Firefox 浏览器上可以正常地显示）。——译者注
[[9]](http://blog.csdn.net/yaerfeng/article/details/28855587#note_09)  JDK
 5.0 新增的方法，JDK 1.4 中不能使用。——译者注
[[10]](http://blog.csdn.net/yaerfeng/article/details/28855587#note_10)  JDK
 1.4 和 JDK 5.0 适用的版本在所附的源代码中。适用于 JDK 1.4 的文件名为 [RegexTestHarness2V4.java](http://blog.csdn.net/yaerfeng/article/details/src/RegexTestHarness2V4.java)，JDK
 1.5 的文件名为 [RegexTestHarness2V5.java](http://blog.csdn.net/yaerfeng/article/details/src/RegexTestHarness2V5.java)。——译者注
[[11]](http://blog.csdn.net/yaerfeng/article/details/28855587#note_11)  第三版是本书的最新版本。第三版的中译本[《精通正则表达式》](http://www.china-pub.com/35269)已由电子工业出版社于 2007 年 7 月出版。——译者注
译后记[返回目录](http://blog.csdn.net/yaerfeng/article/details/28855587#contents)
