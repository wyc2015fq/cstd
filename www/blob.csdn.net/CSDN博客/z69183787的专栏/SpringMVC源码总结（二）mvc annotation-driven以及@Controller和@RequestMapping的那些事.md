# SpringMVC源码总结（二）mvc:annotation-driven以及@Controller和@RequestMapping的那些事 - z69183787的专栏 - CSDN博客
2016年10月14日 16:24:49[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1235
...
Java代码  ![收藏代码](http://lgbolgger.iteye.com/images/icon_star.png)
- publicinterface BeanDefinitionParser {  
- 
- /**
...
Java代码  ![收藏代码](http://lgbolgger.iteye.com/images/icon_star.png)
- publicstaticvoid registerDefaultComponents(ParserContext parserContext, Object source) {  
...
-      */
- protectedvoid initHandlerMethods() {  
...
-      */
- @Override
- protectedboolean isHandler(Class<?> beanType) {  
...
-      */
- protectedvoid detectHandlerMethods(final Object handler) {  
-         Class<?> handlerType =  
...
- thrownew IllegalStateException("Ambiguous mapping found. Cannot map '" + newHandlerMethod.getBean() +  
...
Java代码  ![收藏代码](http://lgbolgger.iteye.com/images/icon_star.png)
- publicfinalboolean supports(Object handler) {  
