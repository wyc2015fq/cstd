# 单例模式有五种写法：懒汉、饿汉、双重检验锁、静态内部类、枚举。 - z69183787的专栏 - CSDN博客
2017年10月11日 18:37:18[OkidoGreen](https://me.csdn.net/z69183787)阅读数：450
[http://blog.csdn.net/nsw911439370/article/details/50456231](http://blog.csdn.net/nsw911439370/article/details/50456231)
转 https://biezhi.me/article/how-to-correctly-write-singleton-pattern.html
...
### 双重检验锁
双重检验锁模式（double checked locking pattern），是一种使用同步块加锁的方法。程序员称其为双重检查锁，因为会有两次检查 `instance == null`，一次是在同步块外，一次是在同步块内。为什么在同步块内还要再检验一次？因为可能会有多个线程一起进入同步块外的
