# java高分局之JVM命令参数大全（高级垃圾回收选项） - z69183787的专栏 - CSDN博客
2018年02月01日 14:36:04[OkidoGreen](https://me.csdn.net/z69183787)阅读数：170
个人分类：[Jvm-内存模型分析																[Jvm-Gc&垃圾回收](https://blog.csdn.net/z69183787/article/category/2917447)](https://blog.csdn.net/z69183787/article/category/2275953)
...
`-XX:MaxHeapFreeRatio=75`- 1
- -XX:MaxMetaspaceSize=size
设置最大的本地内存类员工间可用于垃圾回收。默认没有限制。下面的例子把这个值设置成256m
`-XX:MaxMetaspaceSize=256m`- 1
- -XX:MaxNewSize=size
新生代最大大小。
