# 缓存淘汰算法--LRU算法 - z69183787的专栏 - CSDN博客
2017年12月06日 11:21:37[OkidoGreen](https://me.csdn.net/z69183787)阅读数：369
[http://flychao88.iteye.com/blog/1977653](http://flychao88.iteye.com/blog/1977653)
[https://blog.csdn.net/qq_32198277/article/details/79773695](https://blog.csdn.net/qq_32198277/article/details/79773695)
1. LRU
1.1. 原理
LRU（Least recently used，最近最少使用）算法根据数据的历史访问记录来进行淘汰数据，其核心思想是“如果数据最近被访问过，那么将来被访问的几率也更高”。
1.2. 实现
最常见的实现是使用一个链表保存缓存数据，详细算法实现如下：
![](https://img-my.csdn.net/uploads/201205/24/1337859321_3597.png)
1. 新数据插入到链表头部；
...
![](https://img-my.csdn.net/uploads/201205/24/1337859332_7838.png)
...
![](https://img-my.csdn.net/uploads/201205/24/1337859339_6844.png)
1. 新访问的数据插入到FIFO队列；
...
![](https://img-my.csdn.net/uploads/201205/24/1337859354_3696.png)
如上图，算法详细描述如下：
1. 新插入的数据放入Q0；
2. 每个队列按照LRU管理数据；
