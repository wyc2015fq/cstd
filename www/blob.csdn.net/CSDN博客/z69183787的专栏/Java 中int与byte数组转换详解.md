# Java 中int与byte数组转换详解 - z69183787的专栏 - CSDN博客
2014年08月14日 21:37:56[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1247
1、与运算符的理解（&）：     
...
|----|----|
|2|一个int 占4个字节，即32比特；|
|3|java的二进制采用的是补码形式⑴一个数为正，则它的原码、反码、补码相同⑵一个数为负，刚符号位为1，其余各位是对原码取反，然后整个数加1因为补码存在，所以右移运算后要与0xff相与运算|
