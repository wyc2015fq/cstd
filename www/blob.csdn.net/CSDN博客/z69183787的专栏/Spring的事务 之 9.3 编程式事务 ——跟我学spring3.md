# Spring的事务 之 9.3 编程式事务 ——跟我学spring3 - z69183787的专栏 - CSDN博客
2013年12月05日 15:50:46[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1350
个人分类：[事务-原理																[Spring-事务处理](https://blog.csdn.net/z69183787/article/category/7068794)](https://blog.csdn.net/z69183787/article/category/2175493)
## 9.3  编程式事务
### 9.3.1  编程式事务概述
...
![](http://sishuok.com/forum/upload/2012/2/22/1bda26e78f134086080b99da70faaea0__1.JPG)
图9-2 Required传播行为
![](http://sishuok.com/forum/upload/2012/2/22/996b5b4ffcb121abcb2abf500278a209__2.JPG)
...
![](http://sishuok.com/forum/upload/2012/2/22/750681bff974a861109ac3229d7320b4__3.JPG)
图9-4 RequiresNew传播行为
![](http://sishuok.com/forum/upload/2012/2/22/ddc2a2a4f9906035a1066841e908a7b4__4.JPG)
...
![](http://sishuok.com/forum/upload/2012/2/22/8555f75a872f5a2c90c0c6adc2c8d2c9__5.JPG)
图9-6 Required+Supports传播行为
![](http://sishuok.com/forum/upload/2012/2/22/a60f1fa02429463abdf5cfac907ec922__6.JPG)
...
![](http://sishuok.com/forum/upload/2012/2/22/958faab629dd921516a0c0a2666b352f__7.JPG)
       图9-8 Required+NotSupported传播行为
![](http://sishuok.com/forum/upload/2012/2/22/18168e9817741dd32854acc79881ef82__8.JPG)
...
![](http://sishuok.com/forum/upload/2012/2/22/f19617f8d1a9a5c2a33729e5035d62d9__9.JPG)
       图9-10 Required+Mandatory传播行为
![](http://sishuok.com/forum/upload/2012/2/22/97fd398ec3ec38e4f2a5125973b86d72__10.JPG)
...
![](http://sishuok.com/forum/upload/2012/2/22/818b88d4e35bab51dbeb67747beca6b7__11.JPG)
       图9-12 Required+Never传播行为
![](http://sishuok.com/forum/upload/2012/2/22/12309ecc111f137fe856269419b21b61__12.JPG)
...
![](http://sishuok.com/forum/upload/2012/2/22/e2bc0cf904c0f6dadbeb59166a0547b3__13.JPG)
       图9-14 Required+Nested传播行为
![](http://sishuok.com/forum/upload/2012/2/22/5a986bdc02677857f77f3c6f990c0894__14.JPG)
...
![](http://sishuok.com/forum/upload/2012/2/22/6ad9b6873fce225450220979974ce776__15.JPG)
图9-16 正确的事务只读设置
![](http://sishuok.com/forum/upload/2012/2/22/b5c529def4bffe887debb24faa9f23db__16.JPG)
图9-17 错误的事务只读设置
...
- package cn.javass.spring.chapter9.service.impl;  
- //省略import
- publicclass ConfigAddressServiceImpl implements IAddressService {  
- private IAddressDao addressDao;  
- publicvoid setAddressDao(IAddressDao addressDao) {  
- this.addressDao = addressDao;  
-     }  
...
- package cn.javass.spring.chapter9.service.impl;  
- //省略import
- publicclass ConfigUserServiceImpl implements IUserService {  
- private IUserDao userDao;  
- private IAddressService addressService;  
- publicvoid setUserDao(IUserDao userDao) {  
- this.userDao = userDao;  
...
4、执行测试，测试正常通过，说明该方式能正常工作，当调用save方法时将匹配到“<prop key="save*">”定义，而countAll将匹配到“<prop
 key="save*">”定义，底层代理会应用相应定义中的事务属性来创建或关闭事务。
![](http://sishuok.com/forum/upload/2012/2/22/fdc83c6cf49cb29400db7dbe453b72bb__17.JPG)
图9-18 代理方式实现事务管理
...
![](http://sishuok.com/forum/upload/2012/2/22/705ba0740d8aa4497a51b2c2e5a365fc__18.JPG)
图9-19 代理方式下的自我调用
       配置方式也好麻烦啊，每个业务实现都需要配置一个事务代理，发展到这，Spring想出更好的解决方案，Spring2.0及之后版本提出使用新的“<tx:tags/>”方式配置事务，从而无需为每个业务实现配置一个代理。
原创内容，转载请注明出处【[http://sishuok.com/forum/blogPost/list/2506.html](http://sishuok.com/forum/blogPost/list/2506.html)】
