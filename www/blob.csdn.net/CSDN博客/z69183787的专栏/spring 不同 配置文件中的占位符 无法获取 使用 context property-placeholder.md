# spring 不同 配置文件中的占位符 无法获取 使用 context:property-placeholder - z69183787的专栏 - CSDN博客
2016年12月01日 16:39:40[OkidoGreen](https://me.csdn.net/z69183787)阅读数：2179
这个在[spring](http://lib.csdn.net/base/javaee)中配置文件中是非常常用的。
context:property-placeholder大大的方便了我们[数据库](http://lib.csdn.net/base/mysql)的配置。
