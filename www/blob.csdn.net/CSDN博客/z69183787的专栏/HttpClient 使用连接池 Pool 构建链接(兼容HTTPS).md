# HttpClient 使用连接池 Pool 构建链接(兼容HTTPS) - z69183787的专栏 - CSDN博客
置顶2018年06月08日 11:02:19[OkidoGreen](https://me.csdn.net/z69183787)阅读数：918
...
[https://stackoverflow.com/questions/21574478/what-is-the-difference-between-closeablehttpclient-and-httpclient-in-apache-http](https://stackoverflow.com/questions/21574478/what-is-the-difference-between-closeablehttpclient-and-httpclient-in-apache-http)
...
It is mentioned in old 3.x httpcomponents [doc](http://hc.apache.org/httpcomponents-client-ga/tutorial/html/fundamentals.html), which is long back and has a lot difference from 4.x HC. Besides the explanation is so brief that doesn't say what this underlying resource is.
