# 来自内部的XSS攻击的防范 - z69183787的专栏 - CSDN博客
2014年06月25日 16:34:00[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1339
引入：
前面我们分2篇文章分别探讨了来自外部的XSS攻击和来自内部的XSS攻击，现在我们来专门探讨如何防范来自内部的XSS攻击。
实践：
其实从 http://www.2cto.com/Article/201312/264736.[html](http://www.2cto.com/kf/qianduan/css/) 文章中可以看出，主要的攻击手段无外乎是发送了一段恶意脚本到受害者机器上去运行，所以我们的思路就是，如何让这段脚本失效。
