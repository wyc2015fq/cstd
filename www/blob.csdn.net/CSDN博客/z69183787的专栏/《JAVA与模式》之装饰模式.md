# 《JAVA与模式》之装饰模式 - z69183787的专栏 - CSDN博客
2015年07月18日 20:21:35[OkidoGreen](https://me.csdn.net/z69183787)阅读数：607
...
public class IOTest {
    public static void main(String[] args) throws IOException {
        ...
        try{
            dis = **new DataInputStream(                    new BufferedInputStream(                            new FileInputStream("test.txt")                    )            );            **//读取文件内容
