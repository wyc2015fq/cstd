# 并发新特性—Executor框架与线程池（含代码） - z69183787的专栏 - CSDN博客
2016年11月06日 17:26:23[OkidoGreen](https://me.csdn.net/z69183787)阅读数：445
个人分类：[多线程](https://blog.csdn.net/z69183787/article/category/2176989)
**转载请注明出处：[http://blog.csdn](http://blog.csdn.net/ns_code/article/details/17465497)[.NET](http://lib.csdn.net/base/dotnet)/ns_code/article/details/17465497**
# Executor框架简介
在[Java](http://lib.csdn.net/base/java)5之后，并发编程引入了一堆新的启动、调度和管理线程的API。Executor框架便是[Java](http://lib.csdn.net/base/javaee) 5中引入的，其内部使用了线程池机制，它在java.util.cocurrent
 包下，通过该框架来控制线程的启动、执行和关闭，可以简化并发编程的操作。因此，在Java 5之后，通过Executor来启动线程比使用Thread的start方法更好，除了更易管理，效率更好（用线程池实现，节约开销）外，还有关键的一点：有助于避免this逃逸问题——如果我们在构造器中启动一个线程，因为另一个任务可能会在构造器结束之前开始执行，此时可能会访问到初始化了一半的对象用Executor在构造器中。
...
**[java]**[view
 plain](http://blog.csdn.net/ns_code/article/details/17465497#)[copy](http://blog.csdn.net/ns_code/article/details/17465497#)
![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/123981/fork)
...
- }  
  某次执行后的结果如下：
![](https://img-blog.csdn.net/20131221161412609)
...
- }  
    某次执行结果如下：
![](https://img-blog.csdn.net/20131221170327718)
