# Hbase 设计与开发实战 - z69183787的专栏 - CSDN博客
2016年10月21日 17:28:41[OkidoGreen](https://me.csdn.net/z69183787)阅读数：469
## Hbase 概述
### 大数据及 NoSQL 的前世今生
...
读者如果对 HBase 架构的细节内容感兴趣，可以通过[Hbase](http://docs.oracle.com/javaee/6/tutorial/doc/bncdq.html)官网，了解 Hbase
 整体架构及底层物理存储机制。
[回页首](http://www.ibm.com/developerworks/cn/analytics/library/ba-1604-hbase-develop-practice/index.html#ibm-pcon)
## Hbase 检索时间复杂度
...
关于-ROOT- & .META. 表的细节这里不再累述，感兴趣的读者可以参阅[Hbase –ROOT-及.META.
 表](http://hbase.apache.org/0.94/book/arch.catalog.html)资料，理解 Hbase IO 及数据检索时序原理。
...
关于 Hbase API 操作的代码这里不再详述，感兴趣的读者可以查阅[Hbase SDK](https://hbase.apache.org/apidocs/index.html)，熟悉操作 HBase 表及
 put、scan、delete 代码。
