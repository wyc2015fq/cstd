# Java后台实时输出数据到页面 - z69183787的专栏 - CSDN博客
2015年11月18日 14:23:50[OkidoGreen](https://me.csdn.net/z69183787)阅读数：27273
...
网上查了一下，大致是说这样输出没给浏览器响应的机会，只有等方法结束后浏览器才能响应读取到数据。貌似tomcat7之后的可以支持，行不通啊。
后来发现，如果向页面输出js脚本的话，浏览器是可以实时读取到的，见下面代码：
- out.println("<script>");
