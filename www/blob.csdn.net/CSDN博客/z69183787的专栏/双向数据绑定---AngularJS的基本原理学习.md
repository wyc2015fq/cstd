# 双向数据绑定---AngularJS的基本原理学习 - z69183787的专栏 - CSDN博客
2016年09月07日 16:54:44[OkidoGreen](https://me.csdn.net/z69183787)阅读数：2306
...
在html中:
<bodyng-app="ngApp"><divng-controller="ngCtl"><labelng-model="myLabel"></label><inputtype="text"ng-model="myInput" /><buttonng-model="myButton"ng-click="btnClicked"></button></div></body>
在js中:
```php
// angular app
...
看下边这段html:
<divng-app="dataApp">
    单价： <inputtype="number"min=0ng-model="price"ng-init="price = 299"><br>
    数量： <inputtype="number"min=0ng-model="quantity"ng-init="quantity = 1"><br>
    总价： {{ quantity * price }}
</div>
