# java多线程之 wait(),notify(),notifyAll()[迁] - z69183787的专栏 - CSDN博客
2012年12月17日 11:11:45[OkidoGreen](https://me.csdn.net/z69183787)阅读数：680
...
publicclass Consume implements Runnable{ 
...
package ProductAndConsume; 
import java.util.List; 
publicclass Product implements Runnable { 
private List container = null; 
privateint count; 
...
publicvoid setContainer(List container) { 
