# dubbo学习过程、使用经验分享及实现原理简单介绍 - z69183787的专栏 - CSDN博客
2017年12月21日 15:02:12[OkidoGreen](https://me.csdn.net/z69183787)阅读数：296
# 一、前言
...
# 二、什么是dubbo
Dubbo是阿里巴巴提供的开源的SOA服务化治理的技术框架，据说只是剖出来的一部分开源的，但一些基本的需求已经可以满足的，而且扩展性也非常好（至今没领悟到扩展性怎么做到的），通过spring bean的方式管理配置及实例，较容易上手且对应用无侵入。更多介绍可戳[http://alibaba.github.io/dubbo-doc-static/Home-zh.htm](http://alibaba.github.io/dubbo-doc-static/Home-zh.htm)。
# 三、如何使用dubbo
## 1.服务化应用基本框架
![](http://alibaba.github.io/dubbo-doc-static/dubbo-architecture.jpg-version=1&modificationDate=1330892870000.jpg)
...
[java][view
 plain](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)[copy](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)
- publicinterface UserService  
- {  
- public RpcResponseDto isValidUser(RpcAccountRequestDto requestDto) throwsnew RpcBusinessException, RpcSystemException;  
- }  
...
[html][view
 plain](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)[copy](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)
- <dubbo:registryaddress="zookeeper://127.0.0.1:2181/"group="test"/>
配置服务协议，多网卡可通过IP指定绑定的IP地址，不指定或者指定非法IP的情况下会绑定在0.0.0.0，使用Dubbo协议的服务会在初始化时建立长连接
[html][view
 plain](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)[copy](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)
- <dubbo:protocolname="dubbo"port="20880"accesslog="d:/access.log"></dubbo:protocol>
通过xml配置文件配置服务暴露，首先要有个spring bean实例（无论是注解配置的还是配置文件配置的），在下面ref中指定bean实例ID，作为服务实现类
[html][view
 plain](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)[copy](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)
- <dubbo:serviceinterface="com.web.foo.service.FirstDubboService"ref="firstDubboServiceImpl"version="1.0"></dubbo:service>
通过注解方式配置服务暴露，Component是Spring bean注解，Service是dubbo的注解（不要和spring bean的service注解弄混），如前文所述，dubbo注解只会在spring bean中被识别
[java][view
 plain](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)[copy](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)
- @Component
- @Service(version="1.0")  
- publicclass FirstDubboServiceImpl implements FirstDubboService  
- {  
- 
- @Override
- publicvoid sayHello(TestDto test)  
-     {  
...
[html][view
 plain](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)[copy](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)
- <dubbo:referenceinterface="com.web.foo.service.FirstDubboService"
...
-     }  
- }  
Reference被识别的条件是spring bean实例对应的当前类中的field，如上是直接修饰spring
 bean当前类中的属性
...
[html][view
 plain](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)[copy](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)
- <dubbo:monitorprotocol="registry"/><!--通过注册中心获取monitor地址后建立连接-->
[html][view
 plain](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)[copy](http://blog.csdn.net/hzzhoushaoyu/article/details/43273099#)
- <dubbo:monitoraddress="dubbo://127.0.0.1:7070/com.alibaba.dubbo.monitor.MonitorService"/><!--绕过注册中心直连monitor，同consumer直连-->
## 7.服务路由
...
![](https://img-blog.csdn.net/20150131183523383?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvaHp6aG91c2hhb3l1/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
配置完成后可在消费者标签页查看路由结果
![](https://img-blog.csdn.net/20150131185215353?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvaHp6aG91c2hhb3l1/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
## 8.负载均衡
dubbo提供4种负载均衡方式:
...
- publicclass AccessLogFilter implements Filter {  
- }  
## 10.其他特性
[http://alibaba.github.io/dubbo-doc-static/User+Guide-zh.htm#UserGuide-zh-%](http://alibaba.github.io/dubbo-doc-static/User+Guide-zh.htm)[3Cdubbo%3Amonitor%2F%3E](http://alibaba.github.io/dubbo-doc-static/User+Guide-zh.htm)
...
![](http://alibaba.github.io/dubbo-doc-static/dubbo-framework.jpg-version=1&modificationDate=1341329396000.jpg)
...
![](https://img-blog.csdn.net/20150131225902637?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvaHp6aG91c2hhb3l1/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
...
![](https://img-blog.csdn.net/20150131230209557?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvaHp6aG91c2hhb3l1/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
- ReferenceBean
