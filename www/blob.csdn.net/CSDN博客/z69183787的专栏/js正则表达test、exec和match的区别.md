# js正则表达test、exec和match的区别 - z69183787的专栏 - CSDN博客
2014年01月05日 17:06:57[OkidoGreen](https://me.csdn.net/z69183787)阅读数：15386
...
*attributes：g,全局匹配，i不区分大小写，m执行多行匹配，用最多的为g和i*2、第二种定义:/pattern/attributes.
如：var reg = /abc/g;
