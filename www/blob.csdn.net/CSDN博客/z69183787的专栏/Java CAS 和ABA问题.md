# Java CAS 和ABA问题 - z69183787的专栏 - CSDN博客
2016年12月14日 18:16:14[OkidoGreen](https://me.csdn.net/z69183787)阅读数：918
...
[](http://blog.hesey.net/wp-content/uploads/2011/09/ABA-1.png)
现有一个用单向链表实现的堆栈，栈顶为A，这时线程T1已经知道A.next为B，然后希望用CAS将栈顶替换为B：
head.compareAndSet(A,B);
在T1执行上面这条指令之前，线程T2介入，将A、B出栈，再pushD、C、A，此时堆栈结构如下图，而对象B此时处于游离状态：
[](http://blog.hesey.net/wp-content/uploads/2011/09/ABA-2.png)
此时轮到线程T1执行CAS操作，检测发现栈顶仍为A，所以CAS成功，栈顶变为B，但实际上B.next为null，所以此时的情况变为：
[](http://blog.hesey.net/wp-content/uploads/2011/09/ABA-3.png)
...
[流行的原子](https://www.ibm.com/developerworks/cn/java/j-jtp11234/)
[深入浅出 Java Concurrency (5): 原子操作
 part 4](http://www.blogjava.net/xylz/archive/2010/07/04/325206.html)
