# Spring定时任务的几种实现 - z69183787的专栏 - CSDN博客
2014年03月13日 19:24:10[OkidoGreen](https://me.csdn.net/z69183787)阅读数：795
...
**第一步：定义作业类**
Java代码  ![收藏代码](http://gong1208.iteye.com/images/icon_star.png)
...
Xml代码  ![收藏代码](http://gong1208.iteye.com/images/icon_star.png)
- <beanname="job1"class="org.springframework.scheduling.quartz.JobDetailBean">
- <propertyname="jobClass"value="com.gy.Job1"/>
...
- <propertyname="jobDetail"ref="job1"/>
- <!—每天12:00运行一次 -->
- <propertyname="cronExpression"value="0 0 12 * * ?"/>
- </bean>
...
- <beanclass="com.gy.Job2"/>
- </property>
- <propertyname="targetMethod"value="doJob2"/>
...
Xml代码  ![收藏代码](http://gong1208.iteye.com/images/icon_star.png)
- <beanid="simpleTrigger"class="org.springframework.scheduling.quartz.SimpleTriggerBean">
- <propertyname="jobDetail"ref="job2"/>
- <propertyname="startDelay"value="0"/><!-- 调度工厂实例化后，经过0秒开始执行调度 -->
- <propertyname="repeatInterval"value="2000"/><!-- 每2秒调度一次 -->
- </bean>
 第二种CronTriggerBean，支持到指定时间运行一次，如每天12:00运行一次等。
...
- {  
- publicabstract String cron();  
- 
- publicabstractlong fixedDelay();  
- 
- publicabstractlong fixedRate();  
- }  
