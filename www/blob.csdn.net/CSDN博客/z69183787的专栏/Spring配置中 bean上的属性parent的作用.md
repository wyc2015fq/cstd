# Spring配置中 bean上的属性parent的作用 - z69183787的专栏 - CSDN博客
2012年11月25日 12:57:18[OkidoGreen](https://me.csdn.net/z69183787)阅读数：19366
省去多余的父类配置，比如 事务管理：
```
...
<bean
	...
	<bean
		id="docReceiveFlowService" parent="basicTxProxy">
