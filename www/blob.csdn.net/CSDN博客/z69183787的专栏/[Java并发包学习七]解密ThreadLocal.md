# [Java并发包学习七]解密ThreadLocal - z69183787的专栏 - CSDN博客
2016年05月24日 14:47:59[OkidoGreen](https://me.csdn.net/z69183787)阅读数：684
...
# [](http://qifuguang.me/2015/09/02/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E4%B8%83%5D%E8%A7%A3%E5%AF%86ThreadLocal/#ThreadLocal%E5%9F%BA%E6%9C%AC%E6%93%8D%E4%BD%9C)ThreadLocal基本操作
## [](http://qifuguang.me/2015/09/02/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E4%B8%83%5D%E8%A7%A3%E5%AF%86ThreadLocal/#%E6%9E%84%E9%80%A0%E5%87%BD%E6%95%B0)构造函数
...
```
内部啥也没做。
## [](http://qifuguang.me/2015/09/02/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E4%B8%83%5D%E8%A7%A3%E5%AF%86ThreadLocal/#initialValue%E5%87%BD%E6%95%B0)initialValue函数
...
```
## [](http://qifuguang.me/2015/09/02/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E4%B8%83%5D%E8%A7%A3%E5%AF%86ThreadLocal/#get%E5%87%BD%E6%95%B0)get函数
该函数用来获取与当前线程关联的ThreadLocal的值，函数签名如下：
```
public T get()
```
如果当前线程没有该ThreadLocal的值，则调用`initialValue`函数获取初始值返回。
## [](http://qifuguang.me/2015/09/02/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E4%B8%83%5D%E8%A7%A3%E5%AF%86ThreadLocal/#set%E5%87%BD%E6%95%B0)set函数
set函数用来设置当前线程的该ThreadLocal的值，函数签名如下：
```
public void set(T value)
```
设置当前线程的ThreadLocal的值为value。
## [](http://qifuguang.me/2015/09/02/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E4%B8%83%5D%E8%A7%A3%E5%AF%86ThreadLocal/#remove%E5%87%BD%E6%95%B0)remove函数
remove函数用来将当前线程的ThreadLocal绑定的值删除，函数签名如下：
```
public void remove()
```
在某些情况下需要手动调用该函数，防止内存泄露。
# [](http://qifuguang.me/2015/09/02/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E4%B8%83%5D%E8%A7%A3%E5%AF%86ThreadLocal/#%E4%BB%A3%E7%A0%81%E6%BC%94%E7%A4%BA)代码演示
...
# [](http://qifuguang.me/2015/09/02/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E4%B8%83%5D%E8%A7%A3%E5%AF%86ThreadLocal/#%E5%A6%82%E4%BD%95%E5%AE%9E%E7%8E%B0%E7%9A%84)如何实现的
...
- Map为空或者e为空，则通过`initialValue`函数获取初始值value，然后用ThreadLocal的引用和value作为firstKey和firstValue创建一个新的Map
...
# [](http://qifuguang.me/2015/09/02/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E4%B8%83%5D%E8%A7%A3%E5%AF%86ThreadLocal/#%E5%86%8D%E6%B7%B1%E5%85%A5%E4%B8%80%E7%82%B9)再深入一点
...
![](http://7xlune.com1.z0.glb.clouddn.com/images/%E8%A7%A3%E5%AF%86ThreadLocal/ThreadLocal.png)
...
但是光这样还是不够的，上面的设计思路依赖一个前提条件：**要调用ThreadLocalMap的`getEntry`函数或者`set`函数。**这当然是不可能任何情况都成立的，所以很多情况下需要使用者手动调用ThreadLocal的`remove`函数，手动删除不再需要的ThreadLocal，防止内存泄露。所以JDK建议将ThreadLocal变量定义成
```
private
 static
```
...
# [](http://qifuguang.me/2015/09/02/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E4%B8%83%5D%E8%A7%A3%E5%AF%86ThreadLocal/#%E5%A3%B0%E6%98%8E)声明
原创文章，转载请注明出处，本文链接：
...
如果你已经读到此处，说明本文对你还是有帮助的，那么请支持一下博主，关注一下我的微信公众号:『机智的程序猿』，你的支持是我最大的动力：
