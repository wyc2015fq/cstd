# 学习jms（一）——基本实例 - z69183787的专栏 - CSDN博客
2014年03月05日 09:54:05[OkidoGreen](https://me.csdn.net/z69183787)阅读数：844
...
例子是用main函数跑的，没有在java ee容器里跑，所以没有办法依赖JNDI拿到ConnectionFactory的实例，只能手工创建ActiveMQConnectionFactory，所以和ActiveMQ的实现耦合了，没有办法连到别的jms实现上。如果实际的代码，用JNDI或者spring来获取ConnectionFactory的实例的话，那就可以仅针对接口编程，连接到任意jms
 provider了 
