# 死锁及oracle死锁 - z69183787的专栏 - CSDN博客
2015年03月10日 10:39:43[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1841
...
select A.SQL_TEXT, B.USERNAME, C.OBJECT_ID, C.SESSION_ID, B.SERIAL#, C.ORACLE_USERNAME,C.OS_USER_NAME,C.Process,''''||C.Session_ID||','||B.SERIAL#||''' from v$sql A, v$session B, v$locked_object C where
 A.HASH_VALUE = B.SQL_HASH_VALUE and B.SID = C.Session_ID
ORACLE锁具体分為以下几类：
...
http://www.cnblogs.com/highriver/archive/2011/04/06/2006684.html
另外百度百科介绍的也比较详细
