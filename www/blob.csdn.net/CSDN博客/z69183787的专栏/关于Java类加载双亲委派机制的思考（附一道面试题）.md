# 关于Java类加载双亲委派机制的思考（附一道面试题） - z69183787的专栏 - CSDN博客
2016年06月13日 14:47:07[OkidoGreen](https://me.csdn.net/z69183787)阅读数：3599
预定义类加载器和双亲委派机制
JVM预定义的三种类型类加载器：
...
标准扩展（Extension）类加载器：是由 Sun 的 ExtClassLoader（sun.misc.Launcher$ExtClassLoader）实现的。它负责将< [Java](http://www.2cto.com/kf/ware/Java/)_Runtime_Home >/lib/ext或者由[系统](http://www.2cto.com/os/)变量
