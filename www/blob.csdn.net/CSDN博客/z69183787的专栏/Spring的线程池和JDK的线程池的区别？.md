# Spring的线程池和JDK的线程池的区别？ - z69183787的专栏 - CSDN博客
2017年03月13日 14:29:29[OkidoGreen](https://me.csdn.net/z69183787)阅读数：8174
[API
 文档](http://docs.spring.io/spring/docs/current/javadoc-api/org/springframework/scheduling/concurrent/ThreadPoolTaskExecutor.html)中很清楚，SpringFrameWork 的 ThreadPoolTaskExecutor 是辅助 JDK 的 ThreadPoolExecutor
 的工具类，它将属性通过 JavaBeans 的命名规则提供出来，方便进行配置。
