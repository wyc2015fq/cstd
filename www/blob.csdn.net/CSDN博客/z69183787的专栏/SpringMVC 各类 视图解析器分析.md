...
[view source](http://www.see-source.com/blog/300000029/154#viewSource)[print](http://www.see-source.com/blog/300000029/154#printSource)[?](http://www.see-source.com/blog/300000029/154#about)
`1.``<``bean`
...
`06.``<``bean``id``=``"internalResource"``class``=``"org.springframework.web.servlet.view.InternalResourceView"``>`
`07.``<``property``name``=``"url"``value``=``"/index.jsp"``/>`
`08.``</``bean``>`
`09.``</``beans``>`
...
**BeanNameViewResolver**：这个视图解析器跟XmlViewResolver有点类似，也是通过把返回的逻辑视图名称去匹配定义好的视图bean对象。不同点有二，一是BeanNameViewResolver要求视图bean对象都定义在Spring的application context中，而XmlViewResolver是在指定的配置文件中寻找视图bean对象，二是BeanNameViewResolver不会进行视图缓存。看一个例子，在SpringMVC的配置文件中定义了一个BeanNameViewResolver视图解析器和一个id为test的InternalResourceview
 bean对象。
[view source](http://www.see-source.com/blog/300000029/154#viewSource)[print](http://www.see-source.com/blog/300000029/154#printSource)[?](http://www.see-source.com/blog/300000029/154#about)
...
[view source](http://www.see-source.com/blog/300000029/154#viewSource)[print](http://www.see-source.com/blog/300000029/154#printSource)[?](http://www.see-source.com/blog/300000029/154#about)
`01.``@Controller`
`02.``@RequestMapping``(``"/mytest"``)`
`03.``public``class``MyController {`
`04.``@RequestMapping``(``"resourceBundle"``)`
`05.``public``String resourceBundle() {`
`06.``return``"resourceBundle"``;`
`07.``}`
`08.`
`09.``@RequestMapping``(``"testResourceBundle"``)`
...
`03.``public``class``MyController {`
`04.`
`05.``@RequestMapping``(``"freemarker"``)`
`06.``public``ModelAndView freemarker() {`
`07.``ModelAndView mav = ``new``ModelAndView();`
`08.``mav.addObject(``"hello"``, ``"andy"``);`
`09.``mav.setViewName(``"freemarker"``);`
`10.``return``mav;`
`11.``}`
`12.`
`13.``}`
...
`05.``<``body``>`
`06.``<``b``>Hello World</``b``>`
`07.``<``font``color``=``"red"``>Hello World!</``font``>`
`08.``${hello}`
`09.``</``body``>`
`10.``</``html``>`
...
![](http://dl.iteye.com/upload/attachment/0079/3337/20dcae99-5b9f-3b0c-8a74-57bf4cd8b692.png)
# 视图解析器链
...
[view source](http://www.see-source.com/blog/300000029/154#viewSource)[print](http://www.see-source.com/blog/300000029/154#printSource)[?](http://www.see-source.com/blog/300000029/154#about)
`01.``<``bean``class``=``"org.springframework.web.servlet.view.XmlViewResolver"``>`
`02.``<``property``name``=``"location"``value``=``"/WEB-INF/views.xml"``/>`
`03.``<``property``name``=``"order"``value``=``"1"``/>`
`04.``</``bean``>`
`05.`
`06.``<``bean`
`07.``class``=``"org.springframework.web.servlet.view.UrlBasedViewResolver"``>`
`08.``<``property``name``=``"prefix"``value``=``"/WEB-INF/"``/>`
...
`11.``</``bean``>`
转自：http://haohaoxuexi.iteye.com/blog/1770554
