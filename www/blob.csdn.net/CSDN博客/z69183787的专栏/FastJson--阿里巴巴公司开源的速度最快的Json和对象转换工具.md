# FastJson--阿里巴巴公司开源的速度最快的Json和对象转换工具 - z69183787的专栏 - CSDN博客
2017年01月09日 20:54:40[OkidoGreen](https://me.csdn.net/z69183787)阅读数：408
这是关于FastJson的一个使用Demo，在[Java](http://lib.csdn.net/base/javase)环境下验证的
**[java]**[view
 plain](http://blog.csdn.net/djun100/article/details/24237371#)[copy](http://blog.csdn.net/djun100/article/details/24237371#)
![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/303896/fork)
- class User{  
- privateint id;  
- private String name;  
- publicint getId() {  
...
-      */
- privatestaticvoid json2JsonObjectM1() {  
- //一个JsonObject文本数据
...
-      */
- privatestaticvoid complexMap2JsonM9() {  
...
-      */
- privatestaticvoid complex2JsonM8() {  
-         Group group = new Group();  
-         group.setId(1);  
-         group.setName("group");  
- 
...
-      */
- privatestaticvoid complexExampleM7() {  
...
-      * 将JavaBean转换为JSON对象
-      */
- privatestaticvoid bean2JSONObjectM6() {  
...
-      */
- privatestaticvoid json2JavaBeanM4() {  
...
-      */
- privatestaticvoid json2JSONArrayM3() {  
-         String s = "[{\"id\":\"0375\",\"city\":\"平顶山\"},{\"id\":\"0377\",\"city\":\"南阳\"}]";  
- //将JSON文本转换为JSONArray
...
转自：[http://www.oschina.net/code/snippet_228315_35122](http://www.oschina.net/code/snippet_228315_35122)
