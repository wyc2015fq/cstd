# dubbo在controller中reference注解为空的问题深度解析 - z69183787的专栏 - CSDN博客
2017年12月20日 11:56:45[OkidoGreen](https://me.csdn.net/z69183787)阅读数：3278
## dubbo注解的使用
使用非常简单，下面贴出关键部分
```xml
//provider的配置文件
...
- 25
- 26
![结合](https://img-blog.csdn.net/20161104214922715)
...
```
- 1
不得不提下spring的processer和aware两个SPI点，设计的非常巧妙，完全符合设计六大原则之一的[开闭原则](http://baike.baidu.com/link?url=56MOhcSR4wOH5TLxWYXhz0SJicNulWL-LHF-OYrmMQmaAHxBK8Vxotf7THBDUBUykE8chjEIz-mIX2CjP7yffUDn4Z_v9-5R8k6NfQozAmCSdFi1YlHV5nB3Bx7l2ogv)
```
