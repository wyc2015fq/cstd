# Netty系列之Netty高性能之道 - z69183787的专栏 - CSDN博客
2016年09月12日 10:43:00[OkidoGreen](https://me.csdn.net/z69183787)阅读数：604
...
相关厂商内容
### [如何为不同的任务集挑选合适的技术解决方案](http://www.infoq.com/infoq/url.action?i=12895&t=f)
### [AWS Summit报名倒计时，赶紧报名参加AWS盛宴](http://www.infoq.com/infoq/url.action?i=12896&t=f)
### [针对容器化服务的分布式存储实践](http://www.infoq.com/infoq/url.action?i=12897&t=f)
### [深入浅出LBS游戏设计与开发实践](http://www.infoq.com/infoq/url.action?i=12898&t=f)
### [又拍云-领先的直播云、点播云等多场景 CDN 服务！](http://www.infoq.com/infoq/url.action?i=12493&t=f)
相关赞助商
![](http://cdn3.infoqstatic.com/statics_s2_20160831-0533u1/resource/sponsorship/featuredcategory/6821/AWS.jpg)
更多AWS最新精彩内容和活动，[请关注AWS专区](http://www.infoq.com/infoq/url.action?i=12514&t=f)！
### 1.2. Netty基础入门
...
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529010.png)
图2-1 BIO通信模型图
...
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529011.png)
图2-2 RPC调用性能三要素
### 2.2. Netty高性能之道
#### 2.2.1. 异步非阻塞通信
...
JDK NIO通信模型如下所示：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529012.png)
图2-3 NIO的多路复用模型图
...
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529013.png)
图2-3 NIO服务端通信序列图
客户端通信序列图如下：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529014.png)
图2-4 NIO客户端通信序列图
...
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529015.png)
图2-5 异步消息读取“零拷贝”
每循环读取一次消息，就通过ByteBufAllocator的ioBuffer方法获取ByteBuf对象，下面继续看它的接口定义：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529016.png)
...
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529017.png)
图2-7 CompositeByteBuf类继承关系
通过继承关系我们可以看出CompositeByteBuf实际就是个ByteBuf的包装器，它将多个ByteBuf组合成一个集合，然后对外提供统一的ByteBuf接口，相关定义如下：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529018.png)
图2-8 CompositeByteBuf类定义
添加ByteBuf，不需要做内存拷贝，相关代码如下：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529019.png)
图2-9 新增ByteBuf的“零拷贝”
最后，我们看下文件传输的“零拷贝”：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529020.png)
图2-10 文件传输“零拷贝”
Netty文件传输DefaultFileRegion通过transferTo方法将文件发送到目标Channel中，下面重点看FileChannel的transferTo方法，它的API DOC说明如下：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529021.png)
图2-11 文件传输 “零拷贝”
...
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529022.png)
图2-12 内存池ByteBuf
Netty提供了多种内存管理策略，通过在启动辅助类中配置相关参数，可以实现差异化的定制。
下面通过性能测试，我们看下基于内存池循环利用的ByteBuf和普通ByteBuf的性能差异。
用例一，使用内存池分配器创建直接内存缓冲区：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529023.png)
图2-13 基于内存池的非堆内存缓冲区测试用例
用例二，使用非堆内存分配器创建的直接内存缓冲区：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529024.png)
图2-14 基于非内存池创建的非堆内存缓冲区测试用例
各执行300万次，性能对比结果如下所示：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529040.png)
图2-15 内存池和非内存池缓冲区写入性能对比
性能测试表明，采用内存池的ByteBuf相比于朝生夕灭的ByteBuf，性能高23倍左右（性能数据与使用场景强相关）。
下面我们一起简单分析下Netty内存池的内存分配：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529025.png)
图2-16 AbstractByteBufAllocator的缓冲区分配
继续看newDirectBuffer方法，我们发现它是一个抽象方法，由AbstractByteBufAllocator的子类负责具体实现，代码如下：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529026.png)
图2-17 newDirectBuffer的不同实现
代码跳转到PooledByteBufAllocator的newDirectBuffer方法，从Cache中获取内存区域PoolArena，调用它的allocate方法进行内存分配：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529027.png)
图2-18 PooledByteBufAllocator的内存分配
PoolArena的allocate方法如下：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529028.png)
图2-18 PoolArena的缓冲区分配
我们重点分析newByteBuf的实现，它同样是个抽象方法，由子类DirectArena和HeapArena来实现不同类型的缓冲区分配，由于测试用例使用的是堆外内存，
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529029.png)
图2-19 PoolArena的newByteBuf抽象方法
因此重点分析DirectArena的实现：如果没有开启使用sun的unsafe，则
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529030.png)
图2-20 DirectArena的newByteBuf方法实现
执行PooledDirectByteBuf的newInstance方法，代码如下：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529031.png)
...
4) 向通信对端发送消息请求或者应答消息。
Reactor单线程模型示意图如下所示：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0808020.png)
图2-22 Reactor单线程模型
...
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/08080211.png)
图2-23 Reactor多线程模型
Reactor多线程模型的特点：
...
它的线程模型如下图所示：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/08080221.png)
...
Netty的串行化设计工作原理图如下：
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529035.png)
图2-25 Netty串行化工作原理图
...
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529036.png)
...
![](http://cdn2.infoqstatic.com/statics_s2_20160831-0533u1/resource/articles/netty-high-performance/zh/resources/0529037.png)
