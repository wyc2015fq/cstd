# Kafka设计解析（八）- Exactly Once语义与事务机制原理 - z69183787的专栏 - CSDN博客
2018年05月16日 19:15:28[OkidoGreen](https://me.csdn.net/z69183787)阅读数：266
...
# [](http://www.jasongj.com/kafka/transaction/#%E5%86%99%E5%9C%A8%E5%89%8D%E9%9D%A2%E7%9A%84%E8%AF%9D)写在前面的话
本文所有Kafka原理性的描述除特殊说明外均基于Kafka 1.0.0版本。
# [](http://www.jasongj.com/kafka/transaction/#%E4%B8%BA%E4%BB%80%E4%B9%88%E8%A6%81%E6%8F%90%E4%BE%9B%E4%BA%8B%E5%8A%A1%E6%9C%BA%E5%88%B6)为什么要提供事务机制
Kafka事务机制的实现主要是为了支持
- `Exactly Once`即正好一次语义
- 操作的原子性
- 有状态操作的可恢复性
## [](http://www.jasongj.com/kafka/transaction/#Exactly-Once)`Exactly Once`
...
## [](http://www.jasongj.com/kafka/transaction/#%E6%93%8D%E4%BD%9C%E5%8E%9F%E5%AD%90%E6%80%A7)操作原子性
...
# [](http://www.jasongj.com/kafka/transaction/#%E5%AE%9E%E7%8E%B0%E4%BA%8B%E5%8A%A1%E6%9C%BA%E5%88%B6%E7%9A%84%E5%87%A0%E4%B8%AA%E9%98%B6%E6%AE%B5)实现事务机制的几个阶段
## [](http://www.jasongj.com/kafka/transaction/#%E5%B9%82%E7%AD%89%E6%80%A7%E5%8F%91%E9%80%81)幂等性发送
...
## [](http://www.jasongj.com/kafka/transaction/#%E4%BA%8B%E5%8A%A1%E6%80%A7%E4%BF%9D%E8%AF%81)事务性保证
...
# [](http://www.jasongj.com/kafka/transaction/#%E4%BA%8B%E5%8A%A1%E6%9C%BA%E5%88%B6%E5%8E%9F%E7%90%86)事务机制原理
## [](http://www.jasongj.com/kafka/transaction/#%E4%BA%8B%E5%8A%A1%E6%80%A7%E6%B6%88%E6%81%AF%E4%BC%A0%E9%80%92)事务性消息传递
...
## [](http://www.jasongj.com/kafka/transaction/#%E4%BA%8B%E5%8A%A1%E4%B8%ADOffset%E7%9A%84%E6%8F%90%E4%BA%A4)事务中Offset的提交
...
## [](http://www.jasongj.com/kafka/transaction/#%E7%94%A8%E4%BA%8E%E4%BA%8B%E5%8A%A1%E7%89%B9%E6%80%A7%E7%9A%84%E6%8E%A7%E5%88%B6%E5%9E%8B%E6%B6%88%E6%81%AF)用于事务特性的控制型消息
...
## [](http://www.jasongj.com/kafka/transaction/#%E4%BA%8B%E5%8A%A1%E5%A4%84%E7%90%86%E6%A0%B7%E4%BE%8B%E4%BB%A3%E7%A0%81)事务处理样例代码
```
...
```
## [](http://www.jasongj.com/kafka/transaction/#%E5%AE%8C%E6%95%B4%E4%BA%8B%E5%8A%A1%E8%BF%87%E7%A8%8B)完整事务过程
![Kafka Transaction](http://www.jasongj.com/img/kafka/KafkaColumn8/KafkaTransaction.png)
### [](http://www.jasongj.com/kafka/transaction/#%E6%89%BE%E5%88%B0Transaction-Coordinator)找到`Transaction Coordinator`
...
### [](http://www.jasongj.com/kafka/transaction/#%E8%8E%B7%E5%8F%96PID)获取PID
...
### [](http://www.jasongj.com/kafka/transaction/#%E5%BC%80%E5%90%AF%E4%BA%8B%E5%8A%A1)开启事务
...
### [](http://www.jasongj.com/kafka/transaction/#Consume-Transform-Produce)Consume-Transform-Produce
...
### [](http://www.jasongj.com/kafka/transaction/#Commit%E6%88%96Abort%E4%BA%8B%E5%8A%A1)Commit或Abort事务
...
- 将`PREPARE_COMMIT`或`PREPARE_ABORT`消息写入`Transaction Log`，如上图中步骤5.1所示
- 通过`WriteTxnMarker`请求以`Transaction Marker`的形式将`COMMIT`或`ABORT`信息写入用户数据日志以及`Offset Log`中，如上图中步骤5.2所示
- 最后将`COMPLETE_COMMIT`或`COMPLETE_ABORT`信息写入`Transaction Log`中，如上图中步骤5.3所示
...
## [](http://www.jasongj.com/kafka/transaction/#%E6%80%BB%E7%BB%93)总结
...
# [](http://www.jasongj.com/kafka/transaction/#%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86)异常处理
## [](http://www.jasongj.com/kafka/transaction/#Exception%E5%A4%84%E7%90%86)Exception处理
...
## [](http://www.jasongj.com/kafka/transaction/#%E5%A4%84%E7%90%86Transaction-Coordinator%E5%A4%B1%E8%B4%A5)处理`Transaction Coordinator`失败
### [](http://www.jasongj.com/kafka/transaction/#%E5%86%99PREPARE-COMMIT-PREPARE-ABORT%E5%89%8D%E5%A4%B1%E8%B4%A5)写`PREPARE_COMMIT/PREPARE_ABORT`前失败
...
### [](http://www.jasongj.com/kafka/transaction/#%E5%86%99%E5%AE%8CPREPARE-COMMIT-PREPARE-ABORT%E5%90%8E%E5%A4%B1%E8%B4%A5)写完`PREPARE_COMMIT/PREPARE_ABORT`后失败
...
### [](http://www.jasongj.com/kafka/transaction/#%E5%86%99%E5%AE%8CCOMPLETE-COMMIT-ABORT%E5%90%8E%E5%A4%B1%E8%B4%A5)写完`COMPLETE_COMMIT/ABORT`后失败
...
## [](http://www.jasongj.com/kafka/transaction/#%E4%BA%8B%E5%8A%A1%E8%BF%87%E6%9C%9F%E6%9C%BA%E5%88%B6)事务过期机制
### [](http://www.jasongj.com/kafka/transaction/#%E4%BA%8B%E5%8A%A1%E8%B6%85%E6%97%B6)事务超时
`transaction.timeout.ms`
### [](http://www.jasongj.com/kafka/transaction/#%E7%BB%88%E6%AD%A2%E8%BF%87%E6%9C%9F%E4%BA%8B%E5%8A%A1)终止过期事务
...
### [](http://www.jasongj.com/kafka/transaction/#%E7%BB%88%E6%AD%A2Transaction-ID)终止`Transaction ID`
...
# [](http://www.jasongj.com/kafka/transaction/#%E4%B8%8E%E5%85%B6%E5%AE%83%E7%B3%BB%E7%BB%9F%E4%BA%8B%E5%8A%A1%E6%9C%BA%E5%88%B6%E5%AF%B9%E6%AF%94)与其它系统事务机制对比
## [](http://www.jasongj.com/kafka/transaction/#PostgreSQL-MVCC)PostgreSQL MVCC
...
## [](http://www.jasongj.com/kafka/transaction/#%E4%B8%A4%E9%98%B6%E6%AE%B5%E6%8F%90%E4%BA%A4)两阶段提交
...
## [](http://www.jasongj.com/kafka/transaction/#Zookeeper)Zookeeper
