# 用Linux命令行生成随机密码的十种方法 - z69183787的专栏 - CSDN博客
2017年03月22日 10:52:34[OkidoGreen](https://me.csdn.net/z69183787)阅读数：498
...
7. 这种方法使用非常有用的dd命令：
- dd if=/dev/urandom bs=1count=32 2>/dev/null | base64 -w 0 | rev | cut -b 2- | rev 
