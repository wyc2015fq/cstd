# Java RandomAccessFile用法 - z69183787的专栏 - CSDN博客
2016年12月16日 15:24:42[OkidoGreen](https://me.csdn.net/z69183787)阅读数：304
## RandomAccessFile
...
**[java]**[view
 plain](http://blog.csdn.net/akon_vm/article/details/7429245#)[copy](http://blog.csdn.net/akon_vm/article/details/7429245#)
...
该程序创建了一个128Mb的文件，如果一次性读到内存可能导致内存溢出，但这里访问好像只是一瞬间的事，这是因为，真正调入内存的只是其中的一小部分，其余部分则被放在交换文件上。这样你就可以很方便地修改超大型的文件了(最大可以到2 GB)。注意，[Java](http://lib.csdn.net/base/javase)是调用[操作系统](http://lib.csdn.net/base/operatingsystem)的"文件映射机制"来提升性能的。
...
- import java.io.*;  
- 
- publicclass RandomAccessFileDemo {  
- publicstaticvoid main(String[] args) throws Exception {  
...
- 
- // 利用线程在文件的指定位置写入指定数据
- staticclass FileWriteThread extends Thread{  
- privateint skip;  
- privatebyte[] content;  
- 
