# oracle job 定时执行 存储过程 - z69183787的专栏 - CSDN博客
2014年12月16日 13:33:28[OkidoGreen](https://me.csdn.net/z69183787)阅读数：2869
**一：简单测试job的创建过程案例： **
...
SQL> variable job2010 number;
SQL> begin
SQL> dbms_job.submit(:job2010,'delete from i0216_inv_balance_curstock where trunc(sysdate-mtime) > 90
and  ib_qty = 0;commit;',sysdate,'TRUNC(LAST_DAY(SYSDATE ) + 25)');   
<==每月25号00：00执行
SQL> end;
SQL> /
**步骤二：查询生成的job id**
