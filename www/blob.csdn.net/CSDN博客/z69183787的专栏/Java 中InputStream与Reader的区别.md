# Java 中InputStream与Reader的区别 - z69183787的专栏 - CSDN博客
2012年11月13日 19:04:46[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1140
...
BufferedReader的最大特点就是缓冲区的设置。通常Reader 所作的每个读取请求都会导致对底层字符或字节流进行相应的读取请求，如果没有缓冲，则每次调用
