# Java 并发面试题解 - z69183787的专栏 - CSDN博客
2019年01月10日 14:00:59[OkidoGreen](https://me.csdn.net/z69183787)阅读数：214
### **01**
### **前言**
大家好，我是 Eric，一名有多年互联网经验的专业技术从业人员。我最初在一家国际顶尖投行工作时，接触过各个国家形形色色的开发人员。
我发现，不论是哪个国家，什么背景的 Java 开发者，都对自己写的并发程序相当自信，但也会在出问题时表现得很诧异甚至一筹莫展。
...
![](https://mmbiz.qpic.cn/mmbiz_png/TCHicQEF6XKDiaKDvC2q34egQ6icrTuZ8mo0WWbwZFAbEv9ZSsxcrwFe075j0lwbhiaro5mqn2W3icq4Qzv4GnMPALA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/TCHicQEF6XKDiaKDvC2q34egQ6icrTuZ8moQB7R6mP7zg8XS9Eq1L7ZeS8sSGBLG8NW5rRMuPA83O2ccPWxmjsWdA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/TCHicQEF6XKDiaKDvC2q34egQ6icrTuZ8moomzmCOkLETBwYwXuhMLI4LQnqfrRsB0MJ8icvF2ibxPtOQbVZd9UY8jw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/TCHicQEF6XKDiaKDvC2q34egQ6icrTuZ8moHEo5Imd1fgqqQnBsbmRp7eVHzph8S2GoVpmw3hoU37kibtGYbFBTdwg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
举例说明如下：
![](https://mmbiz.qpic.cn/mmbiz_png/TCHicQEF6XKDiaKDvC2q34egQ6icrTuZ8mo39CTylBjlVxz1tVgMRqQU9GibicVR9VIXP8hniadUKnS9iaE0S5lc90hQg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
Semaphore，Java 版本的信号量实现，用于控制同时访问的线程个数，来达到限制通用资源访问的目的，其原理是通过 acquire() 获取一个许可，如果没有就等待，而 release() 释放一个许可。
![](https://mmbiz.qpic.cn/mmbiz_png/TCHicQEF6XKDiaKDvC2q34egQ6icrTuZ8moDEwx266gACjWic2WwvJSvvpbcSiaweQDg1icGBSs6w7Ziaj7TT5WKfGSxg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/TCHicQEF6XKDiaKDvC2q34egQ6icrTuZ8mon3302ecH5IW7Z9Irpqr6K2GoDAjyydMwniaJGWKich5QaWARYMbhialpA/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/TCHicQEF6XKDiaKDvC2q34egQ6icrTuZ8moUsaH3zrBFv9osKiaShDJTUqz5BQaj3F5LdqUC4m0ufDzFTxcV0Zlxxg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
### **05**
### **Java 内存模型相关问题**
...
### **06**
### **结语**
本文旨在抛砖引玉，但鉴于笔者水平有限，且时间仓促，工作繁忙，虽然尽可能地将自己在学习和实践中的所学、所得总结了出来，并且翻阅了大量书籍、文档和博客，仍然不可避免会存在疏漏，敬请广大读者海涵。
参考资料：《深入理解 Java 虚拟机 JVM 高级特性与最佳实践》（周志明著）
> 
**作者简介：**
Eric Chen， 国内 c9 高校计算机系本硕毕业，曾工作于某国际顶尖投行，是其风险系统的主要开发者，属于业内排名第一的系统；现工作于某国际知名电商，是其广告推荐系统的技术主程，拥有丰富的实战经验。
