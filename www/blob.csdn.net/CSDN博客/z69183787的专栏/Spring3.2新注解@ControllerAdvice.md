# Spring3.2新注解@ControllerAdvice - z69183787的专栏 - CSDN博客
2015年10月03日 21:34:51[OkidoGreen](https://me.csdn.net/z69183787)阅读数：3123
...
Java代码  ![收藏代码](http://jinnianshilongnian.iteye.com/images/icon_star.png)
- @ControllerAdvice
- publicclass ControllerAdviceTest {  
- 
- @ModelAttribute
- public User newUser() {  
...
3、@ExceptionHandler，异常处理器，此注解的作用是当出现其定义的异常时进行处理的方法，其可以使用springmvc提供的数据绑定，比如注入HttpServletRequest等，还可以接受一个当前抛出的Throwable对象。可以参考javadoc或snowolf的[Spring
 注解学习手札（八）补遗——@ExceptionHandler](http://snowolf.iteye.com/blog/1636050)。
