# 序列化和反序列化 - z69183787的专栏 - CSDN博客
2016年11月02日 10:49:42[OkidoGreen](https://me.csdn.net/z69183787)阅读数：435
个人分类：[序列化-概述																[RPC-概念](https://blog.csdn.net/z69183787/article/category/6497910)](https://blog.csdn.net/z69183787/article/category/5639019)
#摘要
...
![序列化组件](http://tech.meituan.com/img/serialization-deserialization/SerializationComponents.jpg)
## 序列化组件与数据库访问组件的对比
...
### 解析性能
![解析性能](http://tech.meituan.com/img/serialization-deserialization/performance.png)
### 序列化之空间开销
![序列化大小](http://tech.meituan.com/img/serialization-deserialization/verbosity.png)
从上图可得出如下结论：
