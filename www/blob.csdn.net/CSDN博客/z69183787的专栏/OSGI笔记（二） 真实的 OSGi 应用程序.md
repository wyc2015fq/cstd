# OSGI笔记（二） 真实的 OSGi 应用程序 - z69183787的专栏 - CSDN博客
2014年11月25日 16:05:40[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1523
发布和使用服务
...
- 
另外新建一个类似于 hello world 的 bundle 叫：`osgi.test.helloworld2`，用于测试`osgi.test.helloworld`bundle 提供的服务的可用性；
- 
