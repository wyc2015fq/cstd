# Mysql中的MVCC - z69183787的专栏 - CSDN博客
2016年04月06日 21:20:22[OkidoGreen](https://me.csdn.net/z69183787)阅读数：409
个人分类：[Mysql-基础知识																[Mysql-Mvcc多版本并发控制](https://blog.csdn.net/z69183787/article/category/6831722)](https://blog.csdn.net/z69183787/article/category/3258085)
...
下面演示下事务对某行记录的更新过程：
#### 1. 初始数据行
![](http://hi.csdn.net/attachment/201109/2/0_1314941383D0D8.gif)
F1～F6是某行列的名字，1～6是其对应的数据。后面三个隐含字段分别对应该行的事务号和回滚指针，假如这条数据是刚INSERT的，可以认为ID为1，其他两个字段为空。
#### 2.事务1更改该行的各字段的值
![](http://hi.csdn.net/attachment/201109/2/0_1314942146opRN.gif)
当事务1更改该行的值时，会进行如下操作：
- 用排他锁锁定该行
- 记录redo log
...
#### 3.事务2修改该行的值
![](http://hi.csdn.net/attachment/201109/2/0_1314943023gBpa.gif)
...
### 6. 参考资料
- Mysql官网
- [http://blog.chinaunix.net/link.php?url=http://forge.mysql.com%2Fwiki%2FMySQL_Internals](http://blog.chinaunix.net/link.php?url=http://forge.mysql.com%2Fwiki%2FMySQL_Internals)
