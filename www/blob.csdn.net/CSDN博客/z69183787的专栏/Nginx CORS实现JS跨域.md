# Nginx CORS实现JS跨域 - z69183787的专栏 - CSDN博客
2018年01月02日 18:23:36[OkidoGreen](https://me.csdn.net/z69183787)阅读数：192
个人分类：[跨域-Cors																[Nginx](https://blog.csdn.net/z69183787/article/category/5774417)](https://blog.csdn.net/z69183787/article/category/6512051)
## 1. 什么是跨域
...
利用flash
> 
以上方案见[http://www.cnblogs.com/rainman/archive/2011/02/20/1959325.html#m5](http://www.cnblogs.com/rainman/archive/2011/02/20/1959325.html#m5)
- 
通过代理，js访问代理，代理转到不同的域[http://developer.yahoo.com/javascript/howto-proxy.html](http://developer.yahoo.com/javascript/howto-proxy.html)
- 
Jquery JSONP(本质上就是动态创建script)[http://www.cnblogs.com/chopper/archive/2012/03/24/2403945.html](http://www.cnblogs.com/chopper/archive/2012/03/24/2403945.html)
- 跨域资源共享（CORS） 这就是我们要介绍的跨域解决方案，也是未来的跨域问题的标准解决方案
## 3. CORS
CORS: 跨域资源共享(Cross-Origin Resource Sharing)[http://www.w3.org/TR/cors/](http://www.w3.org/TR/cors/)
当前几乎所有的浏览器（Internet Explorer 8+， Firefox 3.5+， Safari 4+和 Chrome 3+）都可通过名为跨域资源共享（Cross-Origin Resource Sharing）的协议支持ajax跨域调用。(see: [http://caniuse.com/#search=cors](http://caniuse.com/#search=cors))
...
```
## 4. 服务端Nginx配置
要实现CORS跨域，服务端需要这个一个流程:[http://www.html5rocks.com/static/images/cors_server_flowchart.png](http://www.html5rocks.com/static/images/cors_server_flowchart.png)
...
[http://enable-cors.org/server_nginx.html](http://enable-cors.org/server_nginx.html)这里是一个nginx启用COSR的参考配置。
流程如下：
- 
...
```
但是由于[Nginx 的 if 是邪恶的](http://openresty.org/download/agentzh-nginx-tutorials-zhcn.html#00-Foreword02)，所以配置就相当地让人不爽（是我的配置不够简洁吗？）。下面nginx-spdy-push里/pub接口启用CORS的配置：
```
*# push publish*
...
```
## 5. 客户端javascript代码
下面是[https://spdy.gw.com.cn/sse.html](https://spdy.gw.com.cn/sse.html)里的代码
```
var xhr = new XMLHttpRequest();
...
xhr.send($('ch1').value);
```
页面的域是`https://spdy.gw.com.cn`， XMLHttpRequest的域是`https://test.gw.com.cn:2443`，不同的域，并且Post方式。
用Chrome测试，可以发现有一次OPTIONS应答。如过没有OPTIONS应答，可能是之前已经应答过，被浏览器缓存了
```
...
XMLHttpRequest2 新技巧
> 
[http://www.html5rocks.com/zh/tutorials/file/xhr2/](http://www.html5rocks.com/zh/tutorials/file/xhr2/)
- 
...
> 
[http://mozilla.com.cn/post/34886/](http://mozilla.com.cn/post/34886/)
- 
理解DOMString、Document、FormData、Blob、File、ArrayBuffer数据类型
> 
[http://www.css119.com/archives/1595](http://www.css119.com/archives/1595)
- 
nginx启用COSR的参考配置
> 
[http://enable-cors.org/server_nginx.html](http://enable-cors.org/server_nginx.html)
- 
...
JavaScript跨域总结与解决办法
> 
[http://www.cnblogs.com/rainman/archive/2011/02/20/1959325.html#m5](http://www.cnblogs.com/rainman/archive/2011/02/20/1959325.html#m5)
- 
深入浅出JSONP--解决ajax跨域问题
> 
[http://www.cnblogs.com/chopper/archive/2012/03/24/2403945.html](http://www.cnblogs.com/chopper/archive/2012/03/24/2403945.html)
- 
