# Groovy入门教程 - z69183787的专栏 - CSDN博客
2015年01月05日 19:04:19[OkidoGreen](https://me.csdn.net/z69183787)阅读数：497
...
打开eclipse，通过Software Updates > Find and Install...菜单，使用“Search for new features to install” 下载并安装groovy插件。New一个远程站点，url可使用[http://dist.codehaus.org/groovy/distributions/update/](http://dist.codehaus.org/groovy/distributions/update/)，插件名：Groovy
 plug-in。根据需要你可以同时选择groovy和grails（后续会学习到）：
三、创建groovy项目
1、  新建一个groovy项目
