# Zookeeper入门之使用curator连接zookeeper并且进行节点的增删改查及ACL - z69183787的专栏 - CSDN博客
2017年01月26日 12:00:49[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1415
...
具体代码实现模板:
**[java]**[view
 plain](http://blog.csdn.net/sqh201030412/article/details/51438508#)[copy](http://blog.csdn.net/sqh201030412/article/details/51438508#)
![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1686883/fork)
...
-  * 6.节点的分布式锁操作
-  */
- publicclass ZookeeperCuratorUtils {  
- 
- /**
-      * 先测试玩玩  
-      * @描述：XXXXXXX
...
-      * @author: songqinghu
-      */
- privatestatic CuratorFramework clientOne(){  
- //zk 地址
...
-      * @author: songqinghu
-      */
- privatestatic CuratorFramework clientTwo(){  
- 
...
-      * @throws Exception 
-      */
- privatestaticvoid nodesList(CuratorFramework client,String parentPath) throws Exception{  
...
-      * @throws Exception 
-      */
- privatestaticvoid createNode(CuratorFramework client,String path) throws Exception{  
- 
...
-      * @throws Exception 
-      */
- privatestaticvoid getDataNode(CuratorFramework client,String path) throws Exception{  
-         Stat stat = client.checkExists().forPath(path);  
-         System.out.println(stat);  
...
-      * @throws Exception 
-      */
- privatestaticvoid setDataNode(CuratorFramework client,String path,String message) throws Exception{  
- 
-         Stat stat = client.checkExists().forPath(path);  
-         System.out.println(stat);  
...
-     }  
- 
- privatestaticvoid deleteDataNode(CuratorFramework client,String path) throws Exception{  
- 
-         Stat stat = client.checkExists().forPath(path);  
