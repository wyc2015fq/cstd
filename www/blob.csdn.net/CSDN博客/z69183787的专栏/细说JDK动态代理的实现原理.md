# 细说JDK动态代理的实现原理 - z69183787的专栏 - CSDN博客
2016年10月27日 06:37:16[OkidoGreen](https://me.csdn.net/z69183787)阅读数：728
个人分类：[代理-动态代理](https://blog.csdn.net/z69183787/article/category/2176771)
关于JDK的动态代理，最为人熟知要可能要数Spring AOP的实现，默认情况下，Spring AOP的实现对于接口来说就是使用的JDK的动态代理来实现的，而对于类的代理使用CGLIB来实现。那么，什么是JDK的动态代理呢？
