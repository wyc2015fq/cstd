# JAVA – 虚函数、抽象函数、抽象类、接口 - z69183787的专栏 - CSDN博客
2017年03月22日 17:05:01[OkidoGreen](https://me.csdn.net/z69183787)阅读数：707
**[Java](http://lib.csdn.net/base/javase) – 虚函数、抽象函数、抽象类、接口**
**1. Java虚函数**
虚函数的存在是为了多态。
