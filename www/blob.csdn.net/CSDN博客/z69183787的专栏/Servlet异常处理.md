# Servlet异常处理 - z69183787的专栏 - CSDN博客
2015年09月08日 10:58:51[OkidoGreen](https://me.csdn.net/z69183787)阅读数：5242
Servlets异常处理实例代码 - 当一个servlet抛出一个异常，Web容器中搜索inweb.xml使用与之匹配的抛出的异常类型的异常类型元素的配置。
