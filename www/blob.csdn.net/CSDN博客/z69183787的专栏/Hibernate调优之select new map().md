# Hibernate调优之select new map() - z69183787的专栏 - CSDN博客
2014年11月21日 22:21:15[OkidoGreen](https://me.csdn.net/z69183787)阅读数：3165
...
        而mapping中的map只有一个构造函数new Map(PersistentClass
 owne)。所以我最刚开始认为是将字段封装成一个PersistentClass类，然后在new一个Map。
...
        单表查询
**[html]**[view
 plain](http://blog.csdn.net/jianxin1009/article/details/9385481#)[copy](http://blog.csdn.net/jianxin1009/article/details/9385481#)
- //开始查询  
