# mysql中kill掉所有锁表的进程 - z69183787的专栏 - CSDN博客
2015年07月23日 11:51:16[OkidoGreen](https://me.csdn.net/z69183787)阅读数：898
很多时候由于异常或程序错误会导致个别进程占用大量系统资源，需要结束这些进程，通常可以使用以下命令Kill进程:
mysql中kill掉所有锁表的进程
2009-05-12 14:03
转载请保留如下作者信息
作者 : jesse
博客 : [http://hi.baidu.com/leechl](http://hi.baidu.com/leechl)
...
当然了, 也可以一行搞定
foridin`mysqladmin
 processlist | grep -i locked | awk '{print $1}'`
do
mysqladminkill${id}
done
