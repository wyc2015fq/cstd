# 探索 ConcurrentHashMap 高并发性的实现机制 - z69183787的专栏 - CSDN博客
2015年07月01日 22:56:42[OkidoGreen](https://me.csdn.net/z69183787)阅读数：860
...
[回页首](http://www.ibm.com/developerworks/cn/java/java-lo-concurrenthashmap/#ibm-pcon)
## Java 内存模型
...
```
和 get 操作一样，首先根据散列码找到具体的链表；然后遍历这个链表找到要删除的节点；最后把待删除节点之后的所有节点原样保留在新链表中，把待删除节点之前的每个节点克隆到新链表中。下面通过图例来说明
 remove 操作。
```
