# zookeeper入门之curator框架--几种锁的操作 - z69183787的专栏 - CSDN博客
2017年01月26日 12:04:02[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1689
**[java]**[view
 plain](http://blog.csdn.net/sqh201030412/article/details/51456143#)[copy](http://blog.csdn.net/sqh201030412/article/details/51456143#)
![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1689670/fork)
...
-      * 共享锁测试
-      */
- privatestaticvoid testSharedLock(){  
...
-      * @author: songqinghu
-      */
- privatestaticvoid testReadWriterLock(){  
- //创建多线程 循环进行锁的操作
-         CuratorFramework client = getClient();  
- 
...
-      * @author: songqinghu
-      */
- privatestaticvoid readWriterLock(InterProcessLock lock){  
...
- 
- 
- privatestaticvoid testSharedSemaphore(finalint x){  
-         CuratorFramework client = getClient();  
...
-      */
- privatestaticvoid sharedSemaphore(InterProcessSemaphoreV2 semaphoreV2){  
- //CuratorFramework client = getClient();
...
[](http://blog.csdn.net/sqh201030412/article/details/51456143#)[](http://blog.csdn.net/sqh201030412/article/details/51456143#)[](http://blog.csdn.net/sqh201030412/article/details/51456143#)[](http://blog.csdn.net/sqh201030412/article/details/51456143#)[](http://blog.csdn.net/sqh201030412/article/details/51456143#)[](http://blog.csdn.net/sqh201030412/article/details/51456143#)
