# jedisLock—redis分布式锁实现 - z69183787的专栏 - CSDN博客
2017年03月08日 11:01:14[OkidoGreen](https://me.csdn.net/z69183787)阅读数：417
...
转：http://www.cnblogs.com/0201zcr/p/5942748.html
一、使用分布式锁要满足的几个条件：
...
　　分布式锁可以基于很多种方式实现，比如zookeeper、redis...。不管哪种方式，他的**基本原理**是不变的：**用一个状态值表示锁，对锁的占用和释放通过状态值来标识。**
 　　这里主要讲如何用redis实现分布式锁。
...
![](http://images2015.cnblogs.com/blog/731178/201610/731178-20161009161105582-1603617276.png)
...
**注意：**
C0 获取锁
C0 操作完成，准备删除锁，此时刚好C0锁刚好处于超时临界值
C1 成功获取锁
C0 成功删除锁
C2 获取锁
此时，C1和C2同时获取锁怎么破？
答：delete时 将lock的expire做判断 相等才删除
