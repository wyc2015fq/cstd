# Spring Validation Example – Spring MVC Form Validator - z69183787的专栏 - CSDN博客
2017年03月16日 15:11:00[OkidoGreen](https://me.csdn.net/z69183787)阅读数：753
转自：[http://www.journaldev.com/2668/spring-validation-example-mvc-validator](http://www.journaldev.com/2668/spring-validation-example-mvc-validator)
...
[Spring MVC Framework](http://www.journaldev.com/2433/spring-mvc-tutorial) supports JSR-303 specs by default and all
 we need is to add JSR-303 and it’s implementation dependencies in Spring MVC application. Spring also provides `@Validator` annotation and `BindingResult` class
