# spring mvc 使用及json 日期转换解决方案 - z69183787的专栏 - CSDN博客
2014年10月22日 14:08:16[OkidoGreen](https://me.csdn.net/z69183787)阅读数：20841
第一步：创建CustomObjectMapper类
**[html]**[view
 plain](http://blog.csdn.net/hellostory/article/details/17916413#)[copy](http://blog.csdn.net/hellostory/article/details/17916413#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/144147/fork)
- /**  
...
**效果如下：**
**格式化前：**
![](https://img-blog.csdn.net/20140106135432437?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvaGVsbG9zdG9yeQ==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
**格式化后：**
**![](https://img-blog.csdn.net/20140106135452156?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvaGVsbG9zdG9yeQ==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)**
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
**1.request对象的获取方式1：**在controller方法上加入request参数，spring会自动注入，如：public String list(HttpServletRequest request,HttpServletResponse response)
...
- <propertyname="objectMapper"value="#{jsonUtil.mapper}"/>
