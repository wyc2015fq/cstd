# Hibernate 参数设置一览表 - z69183787的专栏 - CSDN博客
2014年04月12日 12:03:48[OkidoGreen](https://me.csdn.net/z69183787)阅读数：9267
...
<hibernate-configuration> 
  <session-factory> 
   ...
   <!-- <prop key="hibernate.default_schema">XXXX</prop> -->
  </session-factory> 
</hibernate-configuration>
```
spring applicationContext sessionFactory 中使用 ：
```
