# RedisTemplate访问Redis数据结构（二）——List - z69183787的专栏 - CSDN博客
2018年07月17日 11:57:01[OkidoGreen](https://me.csdn.net/z69183787)阅读数：518
[https://blog.csdn.net/weixin_37490221/article/details/78134748](https://blog.csdn.net/weixin_37490221/article/details/78134748)
Redis列表是简单的字符串列表，按照插入顺序排序。你可以添加一个元素导列表的头部（左边）或者尾部（右边），此处我们使用redisTemplate，配置如下（详情请见链接：[RedisTemplate访问Redis数据结构（前言）](http://blog.csdn.net/weixin_37490221/article/details/78134105)）
```
