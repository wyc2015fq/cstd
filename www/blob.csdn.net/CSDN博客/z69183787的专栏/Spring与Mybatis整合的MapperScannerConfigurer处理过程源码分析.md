# Spring与Mybatis整合的MapperScannerConfigurer处理过程源码分析 - z69183787的专栏 - CSDN博客
2015年10月06日 19:27:08[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1765
## 前言
...
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis1.png)
...
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis2.png)
然后我们看下ClassPathMapperScanner中的关键是如何扫描对应package下的接口的。
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis3.png)
...
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis4.png)
MapperFactoryBean重写了checkDaoConfig方法：
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis5.png)
然后通过spring工厂拿对应的bean的时候：
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis6.png)
这里的SqlSession是SqlSessionTemplate，SqlSessionTemplate的getMapper方法：
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis7.png)
Configuration的getMapper方法，会使用MapperRegistry的getMapper方法：
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis8.png)
MapperRegistry的getMapper方法：
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis9.png)
MapperProxyFactory构造MapperProxy：
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis10.png)
**没错！ MapperProxyFactory就是使用了jdk组带的Proxy完成动态代理。**
MapperProxy本来一开始已经提到。MapperProxy内部使用了MapperMethod类完成方法的调用：
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis11.png)
...
```
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis12.png)
![](http://images.cnblogs.com/cnblogs_com/fangjian0423/603237/o_mybatis13.png)
示例代码：[](https://github.com/fangjian0423/dynamic-proxy-mybatis-study)[https://github.com/fangjian0423/dynamic-proxy-mybatis-study](https://github.com/fangjian0423/dynamic-proxy-mybatis-study)
## 总结
...
## 参考资料
[](https://mybatis.github.io/spring/zh/mappers.html)[https://mybatis.github.io/spring/zh/mappers.html](https://mybatis.github.io/spring/zh/mappers.html)
