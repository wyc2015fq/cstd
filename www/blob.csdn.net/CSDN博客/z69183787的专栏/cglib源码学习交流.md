# cglib源码学习交流 - z69183787的专栏 - CSDN博客
2016年10月27日 06:49:50[OkidoGreen](https://me.csdn.net/z69183787)阅读数：455
...
# cglib基本信息
- 
cglib的官方网站：  [http://cglib.sourceforge.net/![](http://agapple.iteye.com/images/icons/linkext7.gif)](http://cglib.sourceforge.net/)
- 
cglib目前的最新版本应该是2.2，公司普遍使用的版本也是这个
- 
官网的samples :  [http://cglib.sourceforge.net/xref/samples/![](http://agapple.iteye.com/images/icons/linkext7.gif)](http://cglib.sourceforge.net/xref/samples/)
# cglib代码包结构
- core (核心代码)
- EmitUtils
- ReflectUtils
...
## 对应的类图：![](http://dl.iteye.com/upload/attachment/341052/092dcafb-db5d-34e7-b91e-8ba43972747a.png)
- 
...
Java代码   ![收藏代码](http://agapple.iteye.com/images/icon_star.png)
...
Converter使用例子代码   ![收藏代码](http://agapple.iteye.com/images/icon_star.png)
...
- 
- // 反编译后的代码：　
- publicvoid getPropertyValues(Object obj, Object aobj[])  
-     {  
...
- //反编译代码查看：
- //首先保存了所有的属性到一个set中
- privatestatic FixedKeySet keys = new FixedKeySet(new String[] {  
- "bigInteger", "intValue"
-     });  
...
-         s;  
-         s.hashCode();  
-         JVM INSTR lookupswitch 2: default72
- //                   -139068386: 40
- //                   556050114: 52;
- goto _L1 _L2 _L3  
- _L2:  
...
# proxy (spring aop相关)
总体类结构图：
![](http://dl.iteye.com/upload/attachment/341054/0e0d7e2a-7aa4-3455-8445-763b9858a80d.png)
...
- 
反编译的部分代码代码   ![收藏代码](http://agapple.iteye.com/images/icon_star.png)
- //反编译的部分代码  
...
- 
反编译部分代码代码   ![收藏代码](http://agapple.iteye.com/images/icon_star.png)
- //反编译部分代码  
- public final int cal(int i, int j)  
- {  
-     this;  
