# web.xml文件中 - z69183787的专栏 - CSDN博客
2013年10月28日 13:44:39[OkidoGreen](https://me.csdn.net/z69183787)阅读数：4109
      最近做Jeecms项目中发现使用IE9下载文件（doc，docx等）时，浏览器有时直接打开文件显示乱码有时可以下载但下载后是一文件夹是里面一堆以xml文件（微软的office存储文件信息主要以xml文件存储），后来跟踪代码发现后台默认是以text形式输出文件，然后打开web.xml文件发现
**[html]**[view
