# javascript深入理解js闭包 - z69183787的专栏 - CSDN博客
2014年04月09日 13:45:03[OkidoGreen](https://me.csdn.net/z69183787)阅读数：1319
个人分类：[Javascript-概述																[Javascript-闭包](https://blog.csdn.net/z69183787/article/category/2178405)](https://blog.csdn.net/z69183787/article/category/2175033)
...
- 当**执行**函数a的时候，a会进入相应的**执行环境(excution context)**。
...
**四、闭包的应用场景**保护函数内的变量安全。以最开始的例子为例，函数a中i只有函数b才能访问，而无法通过其他途径访问到，因此保护了i的安全性。
