# 体验异步的终极解决方案-ES7的Async/Await - z69183787的专栏 - CSDN博客
2017年03月03日 17:29:32[OkidoGreen](https://me.csdn.net/z69183787)阅读数：5606
原文[http://think2011.github.io/2015/11/09/ES7-Async-Await/](http://think2011.github.io/2015/11/09/ES7-Async-Await/?utm_source=tuicool&utm_medium=referral)
...
```
## 捕捉错误
既然 `.then(..)` 不用写了，那么 `.catch(..)` 也不用写，可以直接用标准的 
```
try
 catch
```
...
![](http://img2.tuicool.com/2Y3MFjE.gif)
直接贴出代码，就不说明了。
```java
import fs from 'fs';
