# 与的区别与作用 - z69183787的专栏 - CSDN博客
2013年10月28日 13:45:49[OkidoGreen](https://me.csdn.net/z69183787)阅读数：2553
看到一篇关于web.xm文件中标签的讲解，顺带还阐述了容器的工作流程，因此转载此，以供参考，原文地址：[与的区别与作用](http://www.cnblogs.com/hzj-/articles/1689836.html)
<context-param>的作用:
...
**[java]**[view
 plain](http://blog.csdn.net/sccemstanford/article/details/9039409#)[copy](http://blog.csdn.net/sccemstanford/article/details/9039409#)
- publicclass SysListener extends HttpServlet implements ServletContextListener {privatestaticfinal Log logger = LogFactory.getLog(SysListener.class);publicvoid contextDestroyed(ServletContextEvent sce) {   //用于在容器关闭时,操作
...
- import javax.servlet.http.HttpServlet;publicclass MainServlet extends HttpServlet ...{    public MainServlet() ...{  
- super();  
-      }  
