# [Java并发包学习八]深度剖析ConcurrentHashMap - z69183787的专栏 - CSDN博客
2016年05月24日 14:53:26[OkidoGreen](https://me.csdn.net/z69183787)阅读数：767
# 概述
...
# [](http://qifuguang.me/2015/09/10/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E5%85%AB%5D%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90ConcurrentHashMap/#ConcurrentHashMap%E7%9A%84%E7%9B%AE%E7%9A%84)ConcurrentHashMap的目的
...
# [](http://qifuguang.me/2015/09/10/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E5%85%AB%5D%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90ConcurrentHashMap/#%E5%AE%9E%E7%8E%B0%E5%8E%9F%E7%90%86)实现原理
ConcurrentHashMap使用分段锁技术，将数据分成一段一段的存储，然后给每一段数据配一把锁，当一个线程占用锁访问其中一个段数据的时候，其他段的数据也能被其他线程访问，能够实现真正的并发访问。如下图是ConcurrentHashMap的内部结构图：
![](http://7xlune.com1.z0.glb.clouddn.com/images/%E6%B7%B1%E5%85%A5%E5%89%96%E6%9E%90ConcurrentHashMap/ConcurrentHashMap.png)
...
## [](http://qifuguang.me/2015/09/10/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E5%85%AB%5D%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90ConcurrentHashMap/#%E5%88%9D%E5%A7%8B%E5%8C%96)初始化
...
static final int DEFAULT_INITIAL_CAPACITY
 = 16;
```
- loadFactor表示负载因子，就是当ConcurrentHashMap中的元素个数大于**loadFactor * 最大容量**时就需要rehash，扩容。默认值为
```
static
...
- concurrencyLevel也就是Segment的个数不能超过规定的最大Segment的个数，默认值为`static final int MAX_SEGMENTS = 1 << 16;`，如果超过这个值，设置为这个值。
- 然后使用循环找到大于等于concurrencyLevel的第一个2的n次方的数ssize，这个数就是Segment数组的大小，并记录一共向左按位移动的次数sshift，并令`segmentShift = 32 - sshift`，并且segmentMask的值等于ssize
 - 1，segmentMask的各个二进制位都为1，目的是之后可以通过key的hash值与这个值做**&运算**确定Segment的索引。
- 检查给的容量值是否大于允许的最大容量值，如果大于该值，设置为该值。最大容量值为`static final int MAXIMUM_CAPACITY = 1 << 30;`。
- 然后计算每个Segment平均应该放置多少个元素，这个值c是向上取整的值。比如初始容量为15，Segment个数为4，则每个Segment平均需要放置4个元素。
- 最后创建一个Segment实例，将其当做Segment数组的第一个元素。
## [](http://qifuguang.me/2015/09/10/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E5%85%AB%5D%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90ConcurrentHashMap/#put%E6%93%8D%E4%BD%9C)put操作
put操作的源码如下：
```
...
## [](http://qifuguang.me/2015/09/10/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E5%85%AB%5D%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90ConcurrentHashMap/#get%E6%93%8D%E4%BD%9C)get操作
get操作的源码如下：
```
...
## [](http://qifuguang.me/2015/09/10/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E5%85%AB%5D%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90ConcurrentHashMap/#size%E6%93%8D%E4%BD%9C)size操作
...
## [](http://qifuguang.me/2015/09/10/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E5%85%AB%5D%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90ConcurrentHashMap/#containsValue%E6%93%8D%E4%BD%9C)containsValue操作
...
```
# [](http://qifuguang.me/2015/09/10/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E5%85%AB%5D%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90ConcurrentHashMap/#%E5%85%B3%E4%BA%8Ehash)关于hash
...
源码中的注释是这样的：
> 
Applies a supplemental hash function to a given hashCode, which defends against poor quality hash functions. This is critical because ConcurrentHashMap uses power-of-two length hash tables, that otherwise encounter
...
# [](http://qifuguang.me/2015/09/10/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E5%85%AB%5D%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90ConcurrentHashMap/#%E6%B3%A8%E6%84%8F%E4%BA%8B%E9%A1%B9)注意事项
...
# [](http://qifuguang.me/2015/09/10/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E5%85%AB%5D%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90ConcurrentHashMap/#%E5%A3%B0%E6%98%8E)声明
原创文章，转载请注明出处，本文链接：[http://qifuguang.me/2015/09/10/[Java并发包学习八]深度剖析ConcurrentHashMap/](http://qifuguang.me/2015/09/10/%5BJava%E5%B9%B6%E5%8F%91%E5%8C%85%E5%AD%A6%E4%B9%A0%E5%85%AB%5D%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90ConcurrentHashMap/)
