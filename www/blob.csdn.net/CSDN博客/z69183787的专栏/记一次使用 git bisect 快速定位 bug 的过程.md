# 记一次使用 git bisect 快速定位 bug 的过程 - z69183787的专栏 - CSDN博客
2017年02月09日 15:17:40[OkidoGreen](https://me.csdn.net/z69183787)阅读数：2897
...
不知道为什么，git 的官方文档总是写的让人感觉晦涩难懂，包括 [bisect
 的文档](https://git-scm.com/docs/git-bisect) 。于是经过一番 Google，我摸索到了核心的使用流程：
