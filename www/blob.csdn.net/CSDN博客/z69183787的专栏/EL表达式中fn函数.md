# EL表达式中fn函数 - z69183787的专栏 - CSDN博客
2014年04月17日 16:10:35[OkidoGreen](https://me.csdn.net/z69183787)阅读数：651
个人分类：[El表达式](https://blog.csdn.net/z69183787/article/category/2200673)
...
### [EL表达式中fn函数的使用及截取字符串](http://blog.csdn.net/blog/551776)
**文章分类:[Java编程](http://www.javaeye.com/blogs/category/java)** 关键字:
 el表达式中fn函数的使用及截取字符串
...
- fn:toUpperCase 转为大写字符 ${fn.UpperCase(product.name)}    
- fn:trim 去除字符串前后的空格 ${fn.trim(name)}   
**[java]**[view plain](http://blog.csdn.net/qingwangyoucao/article/details/6218069)[copy](http://blog.csdn.net/qingwangyoucao/article/details/6218069)
- 使用前在Jsp页面的首部加上以下代码:  
- 
- <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>   
- 
