# C++下基本类型所占位数和取值范围 - z69183787的专栏 - CSDN博客
2012年10月30日 09:35:54[OkidoGreen](https://me.csdn.net/z69183787)阅读数：804
...
 所以,如果要处理的数据中存在字节值大于127的情况，使用unsigned
 char较为妥当。
...
 输入输出short/unsigned
 short时，不建议直接使用int的格式符%d/%u等，要加前缀h。
