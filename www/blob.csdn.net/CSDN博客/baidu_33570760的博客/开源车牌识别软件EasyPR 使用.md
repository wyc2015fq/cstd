# 开源车牌识别软件EasyPR 使用 - baidu_33570760的博客 - CSDN博客
2017年08月23日 12:49:20[carman_风](https://me.csdn.net/baidu_33570760)阅读数：722
# 使用
基础准备： 
[opencv学习](http://blog.csdn.net/zhmxy555/article/category/1923021/4)
[easyPR学习](http://www.cnblogs.com/subconscious/p/3979988.html)
### 获取源代码
可以访问项目主页获取代码：
...
|`C/C++`-`附加包含目录`|**[opencv的include目录]**;$(SolutionDir)include|
**编译**
**Note**: Opencv3.2版本的支持，编译前仅需要将config.h中将#define CV_VERSION_THREE_ZERO改为#define CV_VERSION_THREE_TWO即可
