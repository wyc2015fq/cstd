# 目标检测训练数据旋转python代码——数据增广（一） - Snoopy_Dream - CSDN博客





置顶2018年06月13日 22:27:51[Snoopy_Dream](https://me.csdn.net/e01528)阅读数：1279
...
**转载请在首行附上原文链接！有帮助的话记得点ge赞.**

针对目标检测任务，对训练数据做旋转进而达到数据增广的python2代码，网上没找到，自己写了一份.
