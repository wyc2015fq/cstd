# 【Python-ML】神经网络-多层感知器增加梯度检验 - 专注于数据挖掘算法研究和应用 - CSDN博客





2018年01月26日 16:39:34[fjssharpsword](https://me.csdn.net/fjssharpsword)阅读数：285
...
class MLPGradientCheck(object):
    def __init__(self,n_output,n_features,n_hidden=30,l1=0.0,l2=0.0,epochs=500,eta=0.001,alpha=0.0,decrease_const=0.0,shuffle=True,minibatches=1,random_state=None):
        ...
        self.minibatches=minibatches#每批次训练样本数
    ...
    def _gradient_checking(self,X,y_enc,w1,w2,epsilon,grad1,grad2):
        ...
        for i in range(w2.shape[0]):
            for j in range(w2.shape[1]):
                ...
                epsilon_ary2[i,j]=0
        num_grad =np.hstack((num_grad1.flatten(),num_grad2.flatten()))#数值梯度
...
if __name__ == "__main__":   
    ...
    print (nn_check.fit(X_train[:5],y_train[:5],print_progress=False))#梯度检验结果，计算成本大
...
![](https://img-blog.csdn.net/20180126163917587?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvZmpzc2hhcnBzd29yZA==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)

![](https://img-blog.csdn.net/20180127083019962?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvZmpzc2hhcnBzd29yZA==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)


执行太长时间了，12个小时就跑了2个循环。

![](https://img-blog.csdn.net/20180126163926058?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvZmpzc2hhcnBzd29yZA==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
