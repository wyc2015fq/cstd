# Java正则表达式基础案例和语法 - 专注于数据挖掘算法研究和应用 - CSDN博客





2016年06月24日 17:03:58[fjssharpsword](https://me.csdn.net/fjssharpsword)阅读数：2119
...
从编程百科中码了3个基本案例并附录常用正则表达式和语法，如下：
...
public static void main(String[] args) throws Exception { 
		// 要验证的字符串
	    String str = "www.service@xsoftlab.net";
	    // 邮箱验证规则
