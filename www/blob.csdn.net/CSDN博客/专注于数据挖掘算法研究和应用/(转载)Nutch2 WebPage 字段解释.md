# (转载)Nutch2 WebPage 字段解释 - 专注于数据挖掘算法研究和应用 - CSDN博客





2016年04月06日 10:54:05[fjssharpsword](https://me.csdn.net/fjssharpsword)阅读数：2357
...
**[html]**[view
 plain](http://blog.csdn.net/itufo/article/details/20535539#)[copy](http://blog.csdn.net/itufo/article/details/20535539#)
...
parse状态，在执行parseJob之前都是NULL。 [ParseStatusCodes.html](http://nutch.apache.org/apidocs-2.0/org/apache/nutch/parse/ParseStatusCodes.html)
...
网页签名，用于判断网页是否改变，默认的实现是:org.apache.nutch.crawl.MD5Signature ，采用content的MD5值，另一个方案是org.apache.nutch.crawl.TextProfileSignature，content抽取文本、分词、排序等一系列操作后计算MD5值 [TextProfileSignature](http://nutch.apache.org/apidocs-2.0/org/apache/nutch/crawl/TextProfileSignature.html)
