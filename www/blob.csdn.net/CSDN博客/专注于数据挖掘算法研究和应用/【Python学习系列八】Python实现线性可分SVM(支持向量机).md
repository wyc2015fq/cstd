# 【Python学习系列八】Python实现线性可分SVM(支持向量机) - 专注于数据挖掘算法研究和应用 - CSDN博客





2017年06月08日 15:37:00[fjssharpsword](https://me.csdn.net/fjssharpsword)阅读数：2464
...
def smoP(dataMatIn, classLabels, C, toler, maxIter, kTup=('lin', 0)):
    ...
    while (iterr < maxIter) and ((alphaPairsChanged > 0) or (entireSet)):
        ...
        if entireSet:
            ...
            for i in nonBoundIs:
                alphaPairsChanged += innerL(i, oS)#内积
...
def main():
    trainDataSet, trainLabel = loadDataSet('D:\set.txt')
...
('ws = \n', array([[ 0.65307162],
       [-0.17196128]]))
('b = \n', matrix([[-2.89901748]]))
finish all in 19.5581056613
```
![](https://img-blog.csdn.net/20170608153648467?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvZmpzc2hhcnBzd29yZA==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
