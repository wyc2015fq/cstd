# Python学习笔记：类 - 去向前方的博客 - CSDN博客





2018年07月27日 19:55:42[Big_quant](https://me.csdn.net/lvsehaiyang1993)阅读数：1065
...
- [目录：](#目录)
- [9. 类](#9-类)- [9.1. 术语相关](#91-术语相关)
- [9.2. Python 作用域和命名空间](#92-python-作用域和命名空间)- [9.2.1. 作用域和命名空间示例](#921-作用域和命名空间示例)

- [9.3. 初识类](#93-初识类)- [9.3.1. 类定义语法](#931-类定义语法)
- [9.3.2. 类对象](#932-类对象)
- [9.3.3. 实例对象](#933-实例对象)
- [9.3.4. 方法对象](#934-方法对象)
- [9.3.5. 类和实例变量](#935-类和实例变量)

- [9.4. 一些说明](#94-一些说明)
- [9.5. 继承](#95-继承)- [9.5.1. 多继承](#951-多继承)
...
每个值都是一个对象，因此每个值都有一个 类( class ) （也称为它的 类型( type ) ），它存储为 object.**class** 。
...
要注意的是代码传入 exec()， eval() 时不考虑所调用的类的类名，视其为当前类，这类似于 global 语句的效应，已经按字节编译的部分也有同样的限制。这也同样作用于 getattr()， setattr() 和 delattr()，像直接引用 **dict** 一样。
