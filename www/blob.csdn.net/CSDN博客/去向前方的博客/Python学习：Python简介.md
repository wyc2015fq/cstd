# Python学习：Python简介 - 去向前方的博客 - CSDN博客





2018年07月19日 12:00:54[Big_quant](https://me.csdn.net/lvsehaiyang1993)阅读数：278
...
- [目录：](#目录)
- [3.Python 简介](#3python-简介)
- [3.1. 将 Python 当做计算器](#31-将-python-当做计算器)- [3.1.1. 数字](#311-数字)
- [3.1.2. 字符串](#312-字符串)
- [3.1.3. 列表](#313-列表)

- [3.2. 编程的第一步](#32-编程的第一步)
- [Footnotes](#footnotes)
...
通过 Python，还可以使用 ** 运算符计算幂乘方  [1](#fn:1) :
...
等号( ‘=’ )用于给变量赋值。赋值之后，在下一个提示符之前不会有任何结果显示: [↩](#fnref:1)
