# Keras学习笔记：函数式模型 - 去向前方的博客 - CSDN博客





2018年08月05日 13:40:55[Big_quant](https://me.csdn.net/lvsehaiyang1993)阅读数：672
...
- [目录：](#目录)
- [函数式（Functional）模型](#函数式functional模型)
- [第一个模型：全连接网络](#第一个模型全连接网络)
- [多输入和多输出模型](#多输入和多输出模型)
- [让我们用函数式模型来实现这个框图](#让我们用函数式模型来实现这个框图)
- [共享层](#共享层)
- [更多的例子](#更多的例子)
...
Keras：序列式模型 [keras ：序列式模型](https://blog.csdn.net/lvsehaiyang1993/article/details/81214250)
# 函数式（Functional）模型
...
![这里写图片描述](https://img-blog.csdn.net/20180805133739968?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2x2c2VoYWl5YW5nMTk5Mw==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
