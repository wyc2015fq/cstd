# 入行AI，脚踏实地 - 去向前方的博客 - CSDN博客





2018年07月07日 10:52:51[Big_quant](https://me.csdn.net/lvsehaiyang1993)阅读数：825
...
有一个网站，所有有志于算法的同学必须要知道：[https://arxiv.org](https://arxiv.org) ——这里有多个学科（包括computer science）大量的最新论文。
...
有个很简单的验证方法：现在就去[https://arxiv.org](https://arxiv.org)找一篇论文（比如这篇：Dynamic Routing Between Capsules），从头到尾读一遍。
