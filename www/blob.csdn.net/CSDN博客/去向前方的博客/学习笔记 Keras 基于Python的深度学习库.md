# 学习笔记 Keras:基于Python的深度学习库 - 去向前方的博客 - CSDN博客





2018年07月16日 11:38:57[Big_quant](https://me.csdn.net/lvsehaiyang1993)阅读数：207
...
您对文档的任何贡献，包括文档的翻译、查缺补漏、概念解释、发现和修改问题、贡献示例程序等，均会被记录在[致谢](http://keras-cn.readthedocs.io/en/latest/acknowledgement)，十分感谢您对Keras中文文档的贡献！
