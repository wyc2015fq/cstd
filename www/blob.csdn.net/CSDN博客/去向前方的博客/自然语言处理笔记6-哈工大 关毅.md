# 自然语言处理笔记6-哈工大 关毅 - 去向前方的博客 - CSDN博客





2019年01月11日 21:50:34[Big_quant](https://me.csdn.net/lvsehaiyang1993)阅读数：78
...
- [前言](#_2)
- [Markov模型1](#Markov1_6)
- [Markov模型2](#Markov2_14)
- [Markov 模型3](#Markov_3_46)
- [Markov模型4](#Markov4_69)
- [Markov模型（5）](#Markov5_95)
...
设$$X=（X_1,X_2,...X_t）是随机变量序列，其中每个随机变量的取值在有限集S={s_1,S_2},称为状态空间，时间不变性假设$$

N阶Markov模型，只需修改状态空间的定义S’={X}。定义新的变量$$X_i belong to s&#x27;$$

使得$$X_t=(S_{i-1},S_i)$$并且约定：
$$P(X_i|X_{i-1})=P((S_{i-1},S_i)|(S_{i-2}，S_{i-3}))$$

Markov模型的形式化表示，一个马尔可夫模型是一个三元组$$（S，\pi,A）$$,其中S是状态的集合，$$\pi$$是初始状态的概率，A是状态间的转移概率。
...
P(o|x,u)=bx1oz=$$\sum P(O|X,U)*P(X|u)$$
