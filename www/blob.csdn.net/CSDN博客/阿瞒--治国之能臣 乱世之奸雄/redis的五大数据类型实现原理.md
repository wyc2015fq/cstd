# redis的五大数据类型实现原理 - 阿瞒--治国之能臣 乱世之奸雄 - CSDN博客
2019年04月02日 14:06:01[baofenny](https://me.csdn.net/jiaminbao)阅读数：33
...
|12345678910111213|`typedef``struct``redisObject{``     ``//类型``     ``unsigned type:4;``     ``//编码``     ``unsigned encoding:4;``     ``//指向底层数据结构的指针``     ``void``*ptr;``     ``//引用计数``     ``int``refcount;``     ``//记录最后一次被程序访问的时间``     ``unsigned lru:22;``}robj`|
①、type属性
...
　　可以通过如下命令来判断对象类型：
|1|`type key`|
![](https://images2018.cnblogs.com/blog/1120165/201805/1120165-20180529081257173-892937737.png)
...
![](https://images2018.cnblogs.com/blog/1120165/201805/1120165-20180529083450328-194567473.png)
...
![](https://images2018.cnblogs.com/blog/1120165/201805/1120165-20180530080738392-1514060894.png)
...
![](https://images2018.cnblogs.com/blog/1120165/201805/1120165-20180530075632624-696981013.png)
...
**linkedlist表示如下：**
![](https://images2018.cnblogs.com/blog/1120165/201805/1120165-20180530110135961-1817773967.png)
**②、编码转换**
...
|123|`hset profile name ``"Tom"``hset profile age 25``hset profile career ``"Programmer"`|
...
![](https://images2018.cnblogs.com/blog/1120165/201805/1120165-20180530211037364-539249809.png)
...
![](https://images2018.cnblogs.com/blog/1120165/201805/1120165-20180530214840893-1250718951.png)
...
![](https://images2018.cnblogs.com/blog/1120165/201805/1120165-20180530220855467-991054734.png)
...
![](https://images2018.cnblogs.com/blog/1120165/201805/1120165-20180530222324083-666739532.png)
