# Adaboost 算法的原理与推导 - 李鑫o_O - CSDN博客





2016年05月07日 16:55:09[hustlx](https://me.csdn.net/HUSTLX)阅读数：1012
...
    一直想写Adaboost来着，但迟迟未能动笔。其算法思想虽然简单：听取多人意见，最后综合决策，但一般书上对其算法的流程描述实在是过于晦涩。昨日11月1日下午，在我组织的[**机器学习班**](http://www.julyedu.com/course/getDetail/35) 第8次课上Z讲师讲决策树与Adaboost，其中，Adaboost讲得酣畅淋漓，讲完后，我知道，可以写本篇博客了。

    无心啰嗦，本文结合[机器学习](http://lib.csdn.net/base/2)班决策树与Adaboost 的[PPT](http://pan.baidu.com/s/1hqePkdY)，跟Z讲师讲Adaboost指数损失函数推导的[PPT](http://pan.baidu.com/s/1kTkkepD)（第85~第98页）、以及《统计学习方法》等参考资料写就，可以定义为一篇课程笔记、读书笔记或学习心得，有何问题或意见，欢迎于本文评论下随时不吝指出，thanks。
...
- **第一轮迭代**中，样本“**6 7 8”**被分错，对应的误差率为**e1**=P(G1(xi)≠yi) = 3*0.1 = 0.3，此第一个基本分类器在最终的分类器中所占的权重为**a1** = 0.4236。第一轮迭代过后，样本新的权值为**D2 **= (0.0715, 0.0715, 0.0715, 0.0715, 0.0715,  0.0715, 0.1666,
 0.1666, 0.1666, 0.0715)；

- **第二轮迭代**中，样本**“3 4 5”**被分错，对应的误差率为**e2**=P(G2(xi)≠yi) = 0.0715 * 3 = 0.2143，此第二个基本分类器在最终的分类器中所占的权重为**a2** = 0.6496。第二轮迭代过后，样本新的权值为**D3 **= (0.0455, 0.0455, 0.0455, 0.1667, 0.1667,  0.01667,
 0.1060, 0.1060, 0.1060, 0.0455)；

- **第三轮迭代**中，样本**“0 1 2 9”**被分错，对应的误差率为**e3**= P(G3(xi)≠yi) = 0.0455*4 = 0.1820，此第三个基本分类器在最终的分类器中所占的权重为**a3** = 0.7514。第三轮迭代过后，样本新的权值为**D4 **= (0.125, 0.125,
 0.125, 0.102, 0.102,  0.102, 0.065, 0.065, 0.065, 0.125)。
...
    你甚至可以说，这个最终分类器其实就是一个加法模型。只是这个加法模型由基本分类器![](https://img-blog.csdn.net/20141229232238298)及其系数![](https://img-blog.csdn.net/20150102205239730)组成，m = 1, 2,
 ..., M。前向分步算法逐一学习基函数的过程，与Adaboost算法逐一学习各个基本分类器的过程一致。
...
- 邹博讲Adaboost指数损失函数推导的PPT：[http://pan.baidu.com/s/1kTkkepD](http://pan.baidu.com/s/1kTkkepD)（第85页~第98页）；
- 《统计学习方法 李航著》第8章；
...
[](http://blog.csdn.net/v_july_v/article/details/40718799#)[](http://blog.csdn.net/v_july_v/article/details/40718799#)[](http://blog.csdn.net/v_july_v/article/details/40718799#)[](http://blog.csdn.net/v_july_v/article/details/40718799#)[](http://blog.csdn.net/v_july_v/article/details/40718799#)[](http://blog.csdn.net/v_july_v/article/details/40718799#)
