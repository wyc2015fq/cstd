# 视音频数据处理入门：FLV封装格式解析 - 雷霄骅(leixiaohua1020)的专栏 - CSDN博客





2016年01月31日 18:57:10[雷霄骅](https://me.csdn.net/leixiaohua1020)阅读数：69034标签：[FLV																[封装格式																[分离																[音频																[视频](https://so.csdn.net/so/search/s.do?q=视频&t=blog)
...
![](https://img-blog.csdn.net/20160118102143440)
...
![](https://img-blog.csdn.net/20160118103525777)

有关FLV的格式本文不再做记录。可以参考文章《[视音频编解码学习工程：FLV封装格式分析器](http://blog.csdn.net/leixiaohua1020/article/details/17934487)》。本文的程序实现了FLV中的FLV Header和Tag的解析，并可以分离出其中的音频流。
...
![](https://img-blog.csdn.net/20160118103452238)
...
**雷霄骅 (Lei Xiaohua)leixiaohua1020@126.comhttp://blog.csdn.net/leixiaohua1020**](https://so.csdn.net/so/search/s.do?q=音频&t=blog)](https://so.csdn.net/so/search/s.do?q=分离&t=blog)](https://so.csdn.net/so/search/s.do?q=封装格式&t=blog)](https://so.csdn.net/so/search/s.do?q=FLV&t=blog)
