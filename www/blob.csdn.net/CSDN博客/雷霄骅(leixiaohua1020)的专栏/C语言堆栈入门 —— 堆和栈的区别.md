# C语言堆栈入门 —— 堆和栈的区别 - 雷霄骅(leixiaohua1020)的专栏 - CSDN博客





2013年10月15日 00:01:00[雷霄骅](https://me.csdn.net/leixiaohua1020)阅读数：32
...
关于存储内容还可以参考[这道题](http://student.csdn.net/space.php?do=question&ac=detail&qid=588)。这道题还涉及到局部变量的存活期。
