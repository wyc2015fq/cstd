# ffmpeg 源代码简单分析 ： avcodec_register_all() - 雷霄骅(leixiaohua1020)的专栏 - CSDN博客





2013年10月13日 13:34:00[雷霄骅](https://me.csdn.net/leixiaohua1020)阅读数：39
...
本文分析一下ffmpeg注册编解码器等的函数avcodec_register_all()（注意不是av_register_all()，那是注册所有东西的）。该函数在所有基于ffmpeg的应用程序中几乎都是第一个被调用的。只有调用了该函数，才能使用编解码器等。
