# MYSQL常用命令 - 雷霄骅(leixiaohua1020)的专栏 - CSDN博客





2013年10月10日 00:13:00[雷霄骅](https://me.csdn.net/leixiaohua1020)阅读数：33
...
5.导入数据库表
 ...
 　　 mysql> grant usage
 　　 -> ON test.*
 　　 -> TO[testuser@localhost](mailto:testuser@localhost);
...
在windows中MySql以服务形式存在，在使用前应确保此服务已经启动，未启动可用net start mysql命令启动。而Linux中启动时可用“/etc/rc.d/init.d/mysqld start"命令，注意启动者应具有管理员权限。
 ...
 grant all on mydb.* to[NewUserName@HostName](mailto:NewUserName@HostName)identified by "password" ;
 grant usage on *.* to[NewUserName@HostName](mailto:NewUserName@HostName)identified by "password";
 grant select,insert,update on mydb.* to[NewUserName@HostName](mailto:NewUserName@HostName)identified by "password";
 grant update,delete on mydb.TestTable to[NewUserName@HostName](mailto:NewUserName@HostName)identified by "password";
