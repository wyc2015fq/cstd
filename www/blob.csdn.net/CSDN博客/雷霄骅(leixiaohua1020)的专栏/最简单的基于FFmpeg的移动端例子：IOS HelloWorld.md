# 最简单的基于FFmpeg的移动端例子：IOS HelloWorld - 雷霄骅(leixiaohua1020)的专栏 - CSDN博客





2015年07月27日 20:18:17[雷霄骅](https://me.csdn.net/leixiaohua1020)阅读数：32790
...
本文记录IOS平台下基于FFmpeg的HelloWorld程序。该示例C语言的源代码来自于《[最简单的基于FFMPEG的Helloworld程序](http://blog.csdn.net/leixiaohua1020/article/details/46889849)》。相关的概念就不再重复记录了。

![](https://img-blog.csdn.net/20150801182605734)
...
`$(PROJECT_DIR)/include`Search Paths->Library Search Paths添加下面内容
...
![](https://img-blog.csdn.net/20150726212805864)
...
![](https://img-blog.csdn.net/20150726212715269)

单击不同的按钮，可以得到类库不同方面的信息。单击“Protocol”按钮内容如下所示。

![](https://img-blog.csdn.net/20150726212728045)

单击“AVFormat”按钮内容如下所示。

![](https://img-blog.csdn.net/20150726212855691)
单击“AVCodec”按钮内容如下所示。

![](https://img-blog.csdn.net/20150726212930214)
