# 最简单的基于FFmpeg的移动端例子：Android 视频解码器 - 雷霄骅(leixiaohua1020)的专栏 - CSDN博客





2015年07月24日 19:02:29[雷霄骅](https://me.csdn.net/leixiaohua1020)阅读数：43443标签：[FFmpeg																[Android																[视频解码																[JNI](https://so.csdn.net/so/search/s.do?q=JNI&t=blog)
...
本文记录一个安卓平台下基于FFmpeg的视频解码器。该视频解码器C语言的源代码来自于《[最简单的基于FFMPEG+SDL的视频播放器](http://blog.csdn.net/leixiaohua1020/article/details/38868499)》。相关的概念就不再重复记录了。
...
![](https://img-blog.csdn.net/20150722220503109)
...
![](https://img-blog.csdn.net/20150722220820498)
...
![](https://img-blog.csdn.net/20150722220836257)
...
simplest_sdl_ios_helloworld: 移植SDL到IOS平台的最简单程序](https://so.csdn.net/so/search/s.do?q=视频解码&t=blog)](https://so.csdn.net/so/search/s.do?q=Android&t=blog)](https://so.csdn.net/so/search/s.do?q=FFmpeg&t=blog)
