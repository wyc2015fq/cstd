# ffmpeg函数介绍 - 雷霄骅(leixiaohua1020)的专栏 - CSDN博客





2013年09月24日 16:01:00[雷霄骅](https://me.csdn.net/leixiaohua1020)阅读数：52
...
unsigned long (*update_checksum)(unsigned long checksum, const uint8_t *buf,  unsignedint size);
...
// 返回>=0时正常,假设读取包为:AVPacket vPacket返回值为 int vLen; 每次解码正常时,对vPacket做
