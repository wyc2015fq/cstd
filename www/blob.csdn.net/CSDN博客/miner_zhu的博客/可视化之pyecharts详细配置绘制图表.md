# 可视化之pyecharts详细配置绘制图表 - miner_zhu的博客 - CSDN博客





2018年08月22日 18:38:38[miner_zhu](https://me.csdn.net/miner_zhu)阅读数：3831
...
# [图形初始化](http://pyecharts.org/#/zh-cn/charts_configure?id=%E5%9B%BE%E5%BD%A2%E5%88%9D%E5%A7%8B%E5%8C%96)
...
标签)。类型为 list，list[0] 为文本内容，list[1] 为字体风格样式（选填）。如 ["this is a p label", "color:red"]。**仅限于在单个图形或者 page 类时使用。**


# [通用配置项](http://pyecharts.org/#/zh-cn/charts_configure?id=%E9%80%9A%E7%94%A8%E9%85%8D%E7%BD%AE%E9%A1%B9)
...
- yaxis_formatter -> str
	...
	y 轴标签格式器，如 '天'，则 y 轴的标签为数据加'天'(3 天，4 天),默认为 "" yaxis_formatter -> function
- yaxis_name -> str
...
官方文档链接：[http://pyecharts.org/#/zh-cn/charts_configure](http://pyecharts.org/#/zh-cn/charts_configure)
