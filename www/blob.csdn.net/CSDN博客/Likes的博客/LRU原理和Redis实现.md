# LRU原理和Redis实现 - Likes的博客 - CSDN博客
2019年04月11日 14:24:31[Lailikes](https://me.csdn.net/songchuwang1868)阅读数：7标签：[LRU																[Redis](https://so.csdn.net/so/search/s.do?q=Redis&t=blog)](https://so.csdn.net/so/search/s.do?q=LRU&t=blog)
...
![](https://pic1.zhimg.com/80/v2-584ed398c35ba76250cfb2f01b20ec0c_hd.jpg)
...
save("key6", 4)
相应的 LRU 双向链表部分变化如下：
![](https://pic3.zhimg.com/80/v2-e9a42fee5cdbf9e4e4d23015112fad4e_hd.jpg)
s = save, g = get
总结一下核心操作的步骤:
