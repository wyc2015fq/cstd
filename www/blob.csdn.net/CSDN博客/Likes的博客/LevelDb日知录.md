# LevelDb日知录 - Likes的博客 - CSDN博客
2019年04月01日 19:59:07[Lailikes](https://me.csdn.net/songchuwang1868)阅读数：16标签：[levelDB																[日知录](https://so.csdn.net/so/search/s.do?q=日知录&t=blog)](https://so.csdn.net/so/search/s.do?q=levelDB&t=blog)
个人分类：[分布式](https://blog.csdn.net/songchuwang1868/article/category/8678493)
**目录**
[LevelDb日知录之一：LevelDb 简介](#LevelDb%E6%97%A5%E7%9F%A5%E5%BD%95%E4%B9%8B%E4%B8%80%EF%BC%9ALevelDb%20%E7%AE%80%E4%BB%8B)
[LevelDb日知录之二：整体架构](#LevelDb%E6%97%A5%E7%9F%A5%E5%BD%95%E4%B9%8B%E4%BA%8C%EF%BC%9A%E6%95%B4%E4%BD%93%E6%9E%B6%E6%9E%84)
[LevelDb日知录之三：log文件](#LevelDb%E6%97%A5%E7%9F%A5%E5%BD%95%E4%B9%8B%E4%B8%89%EF%BC%9Alog%E6%96%87%E4%BB%B6)
[LevelDb日知录之四：SSTable文件](#LevelDb%E6%97%A5%E7%9F%A5%E5%BD%95%E4%B9%8B%E5%9B%9B%EF%BC%9ASSTable%E6%96%87%E4%BB%B6)
[LevelDb日知录之五：MemTable详解](#LevelDb%E6%97%A5%E7%9F%A5%E5%BD%95%E4%B9%8B%E4%BA%94%EF%BC%9AMemTable%E8%AF%A6%E8%A7%A3)
[LevelDb日知录之六 写入与删除记录](#LevelDb%E6%97%A5%E7%9F%A5%E5%BD%95%E4%B9%8B%E5%85%AD%C2%A0%E5%86%99%E5%85%A5%E4%B8%8E%E5%88%A0%E9%99%A4%E8%AE%B0%E5%BD%95)
[LevelDb日知录之七：读取记录](#LevelDb%E6%97%A5%E7%9F%A5%E5%BD%95%E4%B9%8B%E4%B8%83%EF%BC%9A%E8%AF%BB%E5%8F%96%E8%AE%B0%E5%BD%95)
[LevelDb日知录之八：Compaction操作](#LevelDb%E6%97%A5%E7%9F%A5%E5%BD%95%E4%B9%8B%E5%85%AB%EF%BC%9ACompaction%E6%93%8D%E4%BD%9C)
[LevelDb日知录之九 levelDb中的Cache](#LevelDb%E6%97%A5%E7%9F%A5%E5%BD%95%E4%B9%8B%E4%B9%9D%C2%A0levelDb%E4%B8%AD%E7%9A%84Cache)
[LevelDb日知录之十 Version、VersionEdit、VersionSet](#LevelDb%E6%97%A5%E7%9F%A5%E5%BD%95%E4%B9%8B%E5%8D%81%C2%A0Version%E3%80%81VersionEdit%E3%80%81VersionSet)
## [http://www.cnblogs.com/haippy/archive/2011/12/04/2276064.html](http://www.cnblogs.com/haippy/archive/2011/12/04/2276064.html)
## **LevelDb日知录之一****：****LevelDb 简介**
...
![](https://pic002.cnblogs.com/images/2011/274814/2011121116344075.png)
图1.1：LevelDb结构
...
![](https://pic002.cnblogs.com/images/2011/274814/2011121116350840.png)
图2.1：Manifest存储示意图
...
![](https://pic002.cnblogs.com/images/2011/274814/2011121116352940.png)
图3.1 log文件布局
...
![](https://pic002.cnblogs.com/images/2011/274814/2011121116355194.png)
图4.1 .sst文件的分块结构
...
![](https://pic002.cnblogs.com/images/2011/274814/2011121116360588.png)
图4.2 逻辑布局
...
![](https://pic002.cnblogs.com/images/2011/274814/2011121116362376.png)
图4.3 数据索引
...
![](https://pic002.cnblogs.com/images/2011/274814/2011121116363982.png)
图4.5 数据Block内部结构
...
![](https://pic002.cnblogs.com/images/2011/274814/2011121116365490.png)
图4.6 记录格式
...
![](https://pic002.cnblogs.com/images/2011/274814/2011121116371458.png)
图6.1 LevelDb写入记录
...
![](https://pic002.cnblogs.com/images/2011/274814/2011121116373065.png)
图7-1  LevelDb读取记录流程
...
![](https://pic002.cnblogs.com/images/2011/274814/2011121116374532.png)
...
 　　也就是说，选定了level L的文件A,之后在level L+1中找到了所有需要合并的文件B,C,D…..（可能L层块的值域远远大于L+1，所以会和多个块进行合并）等等。剩下的问题就是具体是如何进行major 合并的？就是说给定了一系列文件，每个文件内部是key有序的，如何对这些文件进行合并，使得新生成的文件仍然Key有序，同时抛掉哪些不再有价值的KV 数据。
    图8.2说明了这一过程。
![](https://pic002.cnblogs.com/images/2011/274814/2011121116385923.png)
图8.2 SSTable Compaction
　　Major compaction的过程如下：对多个文件采用多路归并排序的方式，依次找出其中最小的Key记录（每次取多个块中的最小者放到L+1新块中），也就是对多个文件中的所有记录重新进行排序。之后采取一定的标准判断这个Key是否还需要保存，如果判断没有保存价值，那么直接抛掉，如果觉得还需要继续保存，那么就将其写入level L+1层中新生成的一个SSTable文件中（如果一块装不下，还可以增添新块）。就这样对KV数据一一处理，形成了一系列新的L+1层数据文件，之前的L层文件和L+1层参与compaction 的文件数据此时已经没有意义了，所以全部删除。这样就完成了L层和L+1层文件记录的合并过程。
...
　　书接前文，前面讲过对于levelDb来说，读取操作如果没有在内存的memtable中找到记录，要多次进行磁盘访问操作。假设最优情况，即第一次就在level 0中最新的文件中找到了这个key，那么也需要读取2次磁盘，一次是将SSTable的文件中的index部分读入内存（Table Catch就是缓存index），这样根据这个index可以确定key是在哪个block中存储；第二次是读入这个block的内容（Block Catch就是缓存block数据），然后在内存中查找key对应的value。
　　levelDb中引入了两个不同的Cache:Table Cache和Block Cache。其中Block Cache是配置可选的，即在配置文件中指定是否打开这个功能。
![](https://pic002.cnblogs.com/images/2011/274814/2011121116391556.png)
图9.1 table cache
...
![](http://www.samecity.com/blog/Upload/PicFiles/2011101928022579.JPG)![](https://img-blog.csdnimg.cn/20190401203434354.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NvbmdjaHV3YW5nMTg2OA==,size_16,color_FFFFFF,t_70)
图9.2 block cache
