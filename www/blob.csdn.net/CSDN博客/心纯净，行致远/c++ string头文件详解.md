# c++ string头文件详解 - 心纯净，行致远 - CSDN博客





2018年11月15日 12:44:02[吉大秦少游](https://me.csdn.net/zhanshen112)阅读数：1520
...
首先，为了在我们的程序中**使用string类型，我们必须包含头文件 <string>。**
...
转载自：[c++ string头文件](https://blog.csdn.net/superna666/article/details/52809007)
