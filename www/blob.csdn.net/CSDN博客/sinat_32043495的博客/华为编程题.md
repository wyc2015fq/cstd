# 华为编程题 - sinat_32043495的博客 - CSDN博客





2018年03月07日 12:04:31[LZXandTM](https://me.csdn.net/sinat_32043495)阅读数：164
...
##### 输出例子1:
fpgadrive.c 1325 1#include<iostream>  
#include<string>  
#include<vector>  
#include<map>  
#include<algorithm>  
...
void RecordErrorLog(ErrorLog log, vector<ErrorLog>& res)  
{  
    bool isrepeat = false;  
...
        {
            if(dataarray[i])
                cout << i **<< endl**; **//一定要有<<endl这个，要不然会出错**
        }
    }
    return 0;
