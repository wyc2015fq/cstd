# 从 JavaScript 作用域说开去 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2017年05月31日 14:10:06[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：423
![](http://upload-images.jianshu.io/upload_images/1194012-ccfe3b139618f12a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
### 本文来自简书，原文地址:[http://www.jianshu.com/p/9ecb728c5db9](http://www.jianshu.com/p/9ecb728c5db9)
### 目录
- 1.静态作用域与动态作用域
- 2.变量的作用域
...
- 嵌套嵌套或被嵌套嵌套。
[名字空间](https://zh.wikipedia.org/wiki/%E5%91%BD%E5%90%8D%E7%A9%BA%E9%97%B4)是一种作用域，使用作用域的封装性质去逻辑上组群起关相的众识别子于单一识别子之下。因此，作用域可以影响这些内容的[名字解析](https://zh.wikipedia.org/w/index.php?title=%E5%90%8D%E5%AD%97%E8%A7%A3%E6%9E%90&action=edit&redlink=1)。
程序员常会[缩进](https://zh.wikipedia.org/w/index.php?title=%E7%B8%AE%E6%8E%92&action=edit&redlink=1)他们的[源代码](https://zh.wikipedia.org/wiki/%E5%8E%9F%E5%A7%8B%E7%A2%BC)中的作用域，改善可读性。
...
### 五. JavaScript 执行上下文
![](http://upload-images.jianshu.io/upload_images/1194012-c9ba7e028a43b43d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/1194012-b699bf7e43b0f855.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/1194012-46f32a3ecd3182fb.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
> 
...
![](http://upload-images.jianshu.io/upload_images/1194012-527582393c365549.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Ignition + TurboFan 的组合，就是字节码解释器 + JIT 编译器的黄金组合。这一黄金组合在很多 JS 引擎中都有所使用，例如微软的 Chakra，它首先解释执行字节码，然后观察执行情况，如果发现热点代码，那么后台的 JIT 就把字节码编译成高效代码，之后便只执行高效代码而不再解释执行字节码。苹果公司的 SquirrelFish Extreme 也引入了 JIT。SpiderMonkey 更是如此，所有 JS 代码最初都是被解释器解释执行的，解释器同时收集执行信息，当它发现代码变热了之后，JaegerMonkey、IonMonkey
 等 JIT 便登场，来编译生成高效的机器码。
总结一下：
JavaScript 代码会先被引擎编译，转化成能被解释器识别的字节码。
![](http://upload-images.jianshu.io/upload_images/1194012-99fe5882ea8822e5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
源码会被词法分析，语法分析，生成 AST 抽象语法树。
![](http://upload-images.jianshu.io/upload_images/1194012-89512e9b8df998eb.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/1194012-31029d068de47015.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/1194012-eb7712e90e2dfc1e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/1194012-c40b1dc0b56bbbc5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
当程序运行到标志 1 的时候：
![](http://upload-images.jianshu.io/upload_images/1194012-2b3d60394ed6ce26.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
函数 myFunc 通过 [[ Scope]] 连接着它的作用域，全局作用域。
当程序运行到标志 2 的时候，JavaScript 会创建一个新的作用域用来管理参数和本地变量。
![](http://upload-images.jianshu.io/upload_images/1194012-fceef31b6cd576b6.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/1194012-a3b9ea08a3fbb779.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/1194012-7396de2fe22f1d80.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
由于还没有执行这个函数，所以 startValue 的值还是 undefined。接下来就要执行 createInc 函数了。
![](http://upload-images.jianshu.io/upload_images/1194012-8b311617a76f38e2.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
接着再开始执行 inc(3)。
![](http://upload-images.jianshu.io/upload_images/1194012-49a85286d568fb68.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
当执行 inc(3) 代码的时候，代码将进入 inc Execution Context，并为该执行上下文创建 VO/AO，scope chain 和设置 this；这时，inc AO将指向 createInc AO。
![](http://upload-images.jianshu.io/upload_images/1194012-8e28a6355882987e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
