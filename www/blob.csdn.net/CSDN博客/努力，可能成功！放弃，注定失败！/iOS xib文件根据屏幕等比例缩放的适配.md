# iOS xib文件根据屏幕等比例缩放的适配 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2018年11月07日 13:23:23[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：517
## 前言
...
![](https://upload-images.jianshu.io/upload_images/1280054-3ce76ef06636abee.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000/format/webp)
xib等比例.png
...
```
另外我写了个小小的demo: [https://github.com/LvBisheng/TestScaleWithScreen](https://github.com/LvBisheng/TestScaleWithScreen)。 我只是提供了一个思路，大家可以根据需要自行对分类进行更改。
## 总结
