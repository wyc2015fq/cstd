# GCD线程间通信及合成图片、获取验证码 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2017年03月12日 15:57:08[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：500
## 本文来自简书，原文地址:[http://www.jianshu.com/p/4ac227e763fa](http://www.jianshu.com/p/4ac227e763fa)
...
#### 自定义串行队列
```
dispatch_queue_t serialQueue = dispatch_queue_create("wanglei",
 NULL);
```
#### 自定义并行队列
```
dispatch_queue_t concurrentQueue = dispatch_queue_create("king",
...
```
![](http://upload-images.jianshu.io/upload_images/3873966-76f9eb56f6adc6c6.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
效果图
![](http://upload-images.jianshu.io/upload_images/3873966-ae572a11922a691e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
效果图
