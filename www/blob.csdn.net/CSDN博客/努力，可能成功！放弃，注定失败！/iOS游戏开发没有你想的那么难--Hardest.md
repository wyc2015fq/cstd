# iOS游戏开发没有你想的那么难--Hardest - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年08月18日 22:35:14[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：388
## 和大家聊聊天
...
![](http://upload-images.jianshu.io/upload_images/575247-2cda5b9a5fe6a1ad.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Hardest
## 主体架构
### 音效和背景音乐
...
![](http://upload-images.jianshu.io/upload_images/575247-b37b45a138d312b9.gif?imageMogr2/auto-orient/strip)
启动页动画
...
选择关卡效果如下图所示
![](http://upload-images.jianshu.io/upload_images/575247-99e0749806ac616e.gif?imageMogr2/auto-orient/strip)
选择关卡效果图
...
![](http://upload-images.jianshu.io/upload_images/575247-af96eecbcaeb520c.gif?imageMogr2/auto-orient/strip)
准备开始控制器效果图
### 关卡控制器
24关,每关都有很多重复的功能,这里我们按照不同关卡的属性抽取出几种公共的父类,每个关卡根据自己的需求选择继承相应的控制器,并且在`ViewDidLoad`函数中初始化每个关卡不同的属性,具体分类效果如下图所示
![](http://upload-images.jianshu.io/upload_images/575247-7af5c5adf4fe8a4c.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
逻辑图
...
![](http://upload-images.jianshu.io/upload_images/575247-243fc5a819bedc46.gif?imageMogr2/auto-orient/strip)
单个手指头点击效果
![](http://upload-images.jianshu.io/upload_images/575247-b458f4902040093a.gif?imageMogr2/auto-orient/strip)
左右按钮交替点击效果
![](http://upload-images.jianshu.io/upload_images/575247-296e04b1bf42fafe.gif?imageMogr2/auto-orient/strip)
多个手指同时点击效果样式
- 
...
WNXScoreboardTypeSecondAndMS
![](http://upload-images.jianshu.io/upload_images/575247-6cd24d25eca3e9c2.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
WNXScoreboardTypeCountPTS计分板样式
![](http://upload-images.jianshu.io/upload_images/575247-1e73cca4cdc727e3.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
WNXScoreboardTypeTimeMS计分板样式
![](http://upload-images.jianshu.io/upload_images/575247-b2b0664599b21ced.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/575247-db5a1c060e4503e4.gif?imageMogr2/auto-orient/strip)
得分不够,显示失败
#### 状态二: 游戏成功
- 
当前关卡无得分记录,并且得分大于F,保存玩家得分,正常显示得分结果,并且解锁下一关.
![](http://upload-images.jianshu.io/upload_images/575247-ae34ba2310a9c59a.gif?imageMogr2/auto-orient/strip)
成功状态1
- 
当前关卡有记录,但是本次游戏得分没有超越历史记录,正常显示得分结果,不保存本次游戏得分.
![](http://upload-images.jianshu.io/upload_images/575247-8ec71e1956e4fe14.gif?imageMogr2/auto-orient/strip)
成功状态2
- 
当前关卡有记录,并且本次游戏得分超越历史记录,显示超越历史得分动画,并且讲本次得分替换掉上一次得分.
![](http://upload-images.jianshu.io/upload_images/575247-13327edb21c44b9e.gif?imageMogr2/auto-orient/strip)
成功状态3
### 失败(WNXFailViewController)
部分关卡会有在游戏中失败的情况,如下图
![](http://upload-images.jianshu.io/upload_images/575247-8e3ceccdf80d3956.gif?imageMogr2/auto-orient/strip)
游戏失败
...
```
![](http://upload-images.jianshu.io/upload_images/575247-bdc9ae30c629d055.gif?imageMogr2/auto-orient/strip)
暂停控制器效果图
### 项目总结
...
文／维尼的小熊（简书作者）
原文链接：http://www.jianshu.com/p/5554abf34556
