# 一步步搭建视频直播系统，基于LFLiveKit＋ijkplayer＋rtmp（iOS端） - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2017年01月05日 10:22:53[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：5215
## 原文来自简书，原文地址：[http://www.jianshu.com/p/30595a5bff42](http://www.jianshu.com/p/30595a5bff42)
## 本文主要使用的三个技术：
- 推流：LFLiveKit
- 播放：ijkplayer
- 服务器:nginx+rtmp+ffmpeg
有了这三点技术就可以完成一个简约的直播系统。效果图如下（右边的是用模拟器设备运行播放的，中间的是用VLC播放器播放的，当前在用手机推流直播）。
![](http://upload-images.jianshu.io/upload_images/301102-f17034a855973086.gif?imageMogr2/auto-orient/strip)
效果图.gif
## 一、推流
...
![](http://upload-images.jianshu.io/upload_images/301102-1ad9999f78d7d3c6.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
screen1.png
...
1）改为竖屏直播，配置如下图
![](http://upload-images.jianshu.io/upload_images/301102-482e32a21a8a2e0f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
screen3.png
...
## 二、播放
ijkplayer：是基于FFmpeg的跨平台播放器框架，由B站开发。目前已被多个主流直播App集成使用。github地址：[https://github.com/Bilibili/ijkplayer](https://github.com/Bilibili/ijkplayer)
若不愿运行源demo（配置时间较久），可以直接跳到第四步集成IJKMediaFramework库。
#### 1.查看README.md，找到Build iOS，如下截图：
![](http://upload-images.jianshu.io/upload_images/301102-82620448cc082dc7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
screen4.png
#### 2.根据介绍进行终端命令行操作，截图如下：
![](http://upload-images.jianshu.io/upload_images/301102-3428b8c1120b1d76.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
screen5.png
继续执行如下命令（时间稍长）
```
cd ios
...
![](http://upload-images.jianshu.io/upload_images/301102-71fb86817a3055d0.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
screen6.png
...
抓取了映客、喵播、斗鱼等的直播接口用在了此demo上的地址是[github地址](https://github.com/SoftProgramLX/LXLiveAll)。
...
再次运行如果报错如下：
![](http://upload-images.jianshu.io/upload_images/301102-4e7d36f950f319a7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
screen7.png
