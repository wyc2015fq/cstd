# iOS开发 - 超详细集成 FFmpeg 步骤 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2019年02月21日 14:30:24[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：47
![](https://upload-images.jianshu.io/upload_images/790890-616616e451d2bc98.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/396/format/webp)
### 概述
...
2，FFmpeg 作者
![](https://upload-images.jianshu.io/upload_images/790890-44afe3933df66073.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/146/format/webp)
...
2. 相关地址
- FFmpeg 官网 : [http://ffmpeg.org/download.html](http://ffmpeg.org/download.html)
- FFmpeg 源码 : [https://github.com/FFmpeg/FFmpeg](https://github.com/FFmpeg/FFmpeg)
...
- 
![](https://upload-images.jianshu.io/upload_images/790890-ed0e694bed0c6558.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000/format/webp)
如果显示大概如上图，那么说明安装成功
4. 编译 iOS 下 FFmpeg
- 主要是用于iOS下进行使用FFmpeg
...
- 
![](https://upload-images.jianshu.io/upload_images/790890-a98e7124fc16fe3e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/712/format/webp)
配置裁剪（可选项）：
...
例如：
> 
![](https://upload-images.jianshu.io/upload_images/790890-ba5c8df31ecc75bd.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000/format/webp)
...
- 
![](https://upload-images.jianshu.io/upload_images/790890-1be2201663d8a4fb.gif?imageMogr2/auto-orient/strip%7CimageView2/2/w/758/format/webp)
运行完毕就会生成：
- 
ffmpeg-2.8、FFmpeg-iOS 、scratch、thin 等这些文件夹。
- 
lib：对应的 FFmpeg 静态库
![](https://upload-images.jianshu.io/upload_images/790890-ac2b145251fde76e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/627/format/webp)
- 
include：对应的 FFmpeg 头文件
![](https://upload-images.jianshu.io/upload_images/790890-ac5b53b42548c1f4.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/594/format/webp)
三、iOS 下 集成 FFmpeg
...
- 
![](https://upload-images.jianshu.io/upload_images/790890-b6e6308661971d6f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/824/format/webp)
2，导入库文件
...
```
- 
![](https://upload-images.jianshu.io/upload_images/790890-a54aad33bd46ce3a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/956/format/webp)
（3）然后导入 #import "avformat.h" 在代码中 写 av_register_all() 然后进行编译，如果没有报错，代表编译成功。
- 
![](https://upload-images.jianshu.io/upload_images/790890-9b0401c424d30e50.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/827/format/webp)
...
![](https://upload-images.jianshu.io/upload_images/790890-941d574d6475c5b6.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/410/format/webp)
- config.h 文件 (在scratch目录下四个文件都有 )：
![](https://upload-images.jianshu.io/upload_images/790890-efb70b72b833b5d8.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/615/format/webp)
示例 - 拖入对应文件到工程
- 
![](https://upload-images.jianshu.io/upload_images/790890-787c672da35dd47b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/902/format/webp)
注释掉无关代码：
...
（1）解决编译问题1：
- 
![](https://upload-images.jianshu.io/upload_images/790890-416c5b025967018c.gif?imageMogr2/auto-orient/strip%7CimageView2/2/w/480/format/webp)
（2）解决编译问题2：
- 
![](https://upload-images.jianshu.io/upload_images/790890-4ec86c0ac061a235.gif?imageMogr2/auto-orient/strip%7CimageView2/2/w/957/format/webp)
如果提示以下错误，还需注释以下代码
- 
![](https://upload-images.jianshu.io/upload_images/790890-3e0ab390584750af.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/695/format/webp)
```
{ "videotoolbox_pixfmt", HAS_ARG | OPT_STRING | OPT_EXPERT, { &videotoolbox_pixfmt}, "" },
{ "videotoolbox",   videotoolbox_init,   HWACCEL_VIDEOTOOLBOX,   AV_PIX_FMT_VIDEOTOOLBOX },
```
...
- 并在 ffmpeg.h 中声明。
- 
![](https://upload-images.jianshu.io/upload_images/790890-6dd8c1e53ef2aea5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/651/format/webp)
五、优化解决集成后问题
...
- 如下图：
- 
![](https://upload-images.jianshu.io/upload_images/790890-8302dc5f87d3e971.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/727/format/webp)
2. 命令执行结束崩溃问题
说明
...
- 
![](https://upload-images.jianshu.io/upload_images/790890-23bb175299357a53.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/594/format/webp)
- 
![](https://upload-images.jianshu.io/upload_images/790890-c16302f2e3dfc032.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/746/format/webp)
这种方法的缺点：
...
![](https://upload-images.jianshu.io/upload_images/790890-0d6c96a7ba8d38e1.gif?imageMogr2/auto-orient/strip%7CimageView2/2/w/959/format/webp)
...
![](https://upload-images.jianshu.io/upload_images/790890-e2e056a51bc64fc5.gif?imageMogr2/auto-orient/strip%7CimageView2/2/w/961/format/webp)
（1）第一种调用方式
简单容易理解，但是麻烦。
```
...
```
### 结尾
- 文中Demo:[https://github.com/bigsen/FFmpeg_iOS](https://github.com/bigsen/FFmpeg_iOS)
- 到目前我们已经可以在iOS平台调用FFmpeg了，更多FFmpeg命令可查看其它相关文章。
- 后续的话，我会放出一款工具，可以更方便的调用FFmpeg进行处理命令。
作者：Forest_Sen
链接：https://www.jianshu.com/p/ecfbebadbe55
來源：简书
