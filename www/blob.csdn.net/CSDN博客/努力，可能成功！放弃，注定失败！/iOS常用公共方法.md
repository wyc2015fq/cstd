# iOS常用公共方法 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年05月27日 16:55:50[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：947
###### 1. 获取磁盘总空间大小
```
//磁盘总空间
...
```
输出结果如下:
![](http://upload-images.jianshu.io/upload_images/1803339-a63d16ad6cccc312.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
输出结果
###### 7. 获取当前时间
```
//获取当前时间
...
```
输出结果如下:
![](http://upload-images.jianshu.io/upload_images/1803339-591e3b7e5982b1b8.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
输出结果
###### 9. 判断手机号码格式是否正确
```
//判断手机号码格式是否正确
...
```
*若还有其它常用的公共方法, 请与我联系, 我会在这里添加您提供的方法, 并注明提供者信息, 以便能够更好的分享给大家使用! 欢迎大家积极提供! 谢谢!*
文／jianshu_wl（简书作者）
