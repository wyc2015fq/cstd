# Runtime- 结合Demo, 让你轻松搞定 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2019年01月03日 10:31:26[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：21
![](https://upload-images.jianshu.io/upload_images/8283020-d0cb687298f0a1ea.jpeg?imageMogr2/auto-orient/strip%7CimageView2/2/w/768/format/webp)
Runtime.jpeg
> 
...
`强烈建议`结合着`Demo`代码边看代码边看文档 [Demo Github链接](https://github.com/YTiOSer/YTRuntimeDemo)。
### 一.Runtime简介
...
### 三.Runtime的使用
> 
上面讲的可能让大家感觉还是不好理解, 比较书面, 下面我结合着具体的`Demo`来详细上面说到的功能. `强烈建议`结合着`Demo`代码边看代码边看文档 [Demo Github链接](https://github.com/YTiOSer/YTRuntimeDemo).
1.`iOS`黑魔法 `Swizzle`
...
@end
```
以上介绍了几点`Runtime`的特性, 并结合我们开发中可能遇到的情况就行讲解, 这样大家可以更好的理解, 建议大家对照着我的 [Demo](https://github.com/YTiOSer/YTRuntimeDemo) 详细看下, 自己也试一试, 只有自己动手才能真正的理解.
有什么问题可以随时给我留言, 我看到后会第一时间回复, 如果看完文章感觉对您有所帮忙的话, 不妨关注喜欢下哦, 看 `demo` 时候麻烦也 `star`下!!!
作者：直男程序员
链接：https://www.jianshu.com/p/663197a0ab9e
來源：简书
