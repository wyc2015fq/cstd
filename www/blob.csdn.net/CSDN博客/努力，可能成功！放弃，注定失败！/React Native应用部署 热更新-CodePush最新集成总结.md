# React Native应用部署/热更新-CodePush最新集成总结 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2019年02月21日 14:36:10[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：38
# React Native应用部署/热更新-CodePush最新集成总结(新)
本文出自[《React Native学习笔记》](https://link.jianshu.com?t=https://github.com/crazycodeboy/RNStudyNotes/)系列文章。
了解更多，可以[关注我的GitHub](https://link.jianshu.com?t=https://github.com/crazycodeboy/)和加入：
[React Native学习交流群](https://link.jianshu.com?t=http://jq.qq.com/?_wv=1027&k=2IBHgLD)
...
- 整合了移动端APP的开发，不仅缩短了APP的开发时间，也提高了APP的开发效率。
- 为移动APP动态更新提供了基础。
...
CodePush开源了react-native版本，[react-native-code-push](https://link.jianshu.com?t=https://github.com/Microsoft/react-native-code-push)托管在GitHub上。
## 安装与注册CodePush
...
![安装 CodePush CLI成功]([https://raw.githubusercontent.com/crazycodeboy/RNStudyNotes/master/React%20Native](https://link.jianshu.com?t=https://raw.githubusercontent.com/crazycodeboy/RNStudyNotes/master/React%20Native)应用部署、热更新-CodePush最新集成总结/images/安装 CodePush CLI成功.png)
目前我的版本是 1.12.1-beta
**PS.**
...
![获取codepush access key]([https://raw.githubusercontent.com/crazycodeboy/RNStudyNotes/master/React%20Native](https://link.jianshu.com?t=https://raw.githubusercontent.com/crazycodeboy/RNStudyNotes/master/React%20Native)应用部署、热更新-CodePush最新集成总结/images/获取codepush access key.png)
...
![推送更新到CodePush](https://raw.githubusercontent.com/crazycodeboy/RNStudyNotes/master/React%20Native%E5%BA%94%E7%94%A8%E9%83%A8%E7%BD%B2%E3%80%81%E7%83%AD%E6%9B%B4%E6%96%B0-CodePush%E6%9C%80%E6%96%B0%E9%9B%86%E6%88%90%E6%80%BB%E7%BB%93/images/%E6%8E%A8%E9%80%81%E6%9B%B4%E6%96%B0%E5%88%B0CodePush.png)
推送更新到CodePush
**注意：**
...
**iOS**
在iOS中我们需要上文中讲到的[生成bundle](#%E7%94%9F%E6%88%90bundle)，将bundle包与相应的图片资源拖到iOS项目中如图：
...
- 自上一次`disallowRestart`被调用，没有新的更新。
- 有更新，但`installMode`为`InstallMode.ON_NEXT_RESTART`的情况下。
- 有更新，但`installMode`为`InstallMode.ON_NEXT_RESUME`，并且程序一直处于前台，并没有从后台切换到前台的情况下。
- 自从上次`disallowRestart`被调用，没有再调用`restartApp`。
...
立即重启app。
当以下情况时，这个方式是很有用的：
- app 当 调用 `sync` 或 `LocalPackage.install` 方法时，指定的 `install mode`是 `ON_NEXT_RESTART` 或 `ON_NEXT_RESUME时` 。 这两种情况都是当app重启或`resume`时，更新内容才能被看到。
...
**参考：**
[http://microsoft.github.io/code-push/docs/getting-started.html](https://link.jianshu.com?t=http://microsoft.github.io/code-push/docs/getting-started.html)
[https://github.com/Microsoft/react-native-code-push](https://link.jianshu.com?t=https://github.com/Microsoft/react-native-code-push)
作者：CrazyCodeBoy
链接：https://www.jianshu.com/p/28589c0be542
來源：简书
