# iOS静态库SDK制作（包含第三方静态库） - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2017年05月08日 17:06:37[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：1845
## 本文来自简书，原文地址:[http://www.jianshu.com/p/155a3cfb765e](http://www.jianshu.com/p/155a3cfb765e)
## 前言
> 
...
- 使用动态库的时候不需要再次link依赖库，即导即用，这个就厉害了。唯一需要注意的是在导入自己制作的动态库时，需要在Embedded Binaries中导入，不然会报错：image not found。此时这个动态库会跟静态库一样被拷贝到目标程序中进行编译，苹果又把这种Framework叫做[Embedded
 Framework](https://developer.apple.com/library/content/documentation/General/Conceptual/ExtensibilityPG/ExtensionScenarios.html)
...
1> 新建工程
![](http://upload-images.jianshu.io/upload_images/1787336-5f8d66da9f38561f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
新建Framework工程
...
![](http://upload-images.jianshu.io/upload_images/1787336-3a6bd29606454666.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
导入第三方静态库
导入第三方静态库之后再link依赖的系统库，像这样
![](http://upload-images.jianshu.io/upload_images/1787336-41c6af9388a548ee.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
link依赖库
注意上面的运行目标，因为我用的是Xcode8，最低支持到iOS8。
要打包的文件和第三方静态库全部导入完成
![](http://upload-images.jianshu.io/upload_images/1787336-34bf79c20d4bf5d7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
所有文件导入情况
3> 项目性质修改
把项目的membership需改为public，否则头文件暴露将会不正常
![](http://upload-images.jianshu.io/upload_images/1787336-0ed9cd50f78d3f55.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
修改项目的membership
4> 暴露头文件
将头文件暴露出去，供外界使用，所有的编译文件都在Project中，需要右击添加到public里面
![](http://upload-images.jianshu.io/upload_images/1787336-c960ce0c11aa7132.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
暴露头文件
5> 选择Mach-O的编译方式
这是最重要的一步，这一步决定我们制作出来的是静态库还是动态库，默认选择的是Dynamic Library，要手动选择Static Library
![](http://upload-images.jianshu.io/upload_images/1787336-ae4df66b2a26397a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Mach-O 形式
6> 编译
如果你的依赖库里面有lib开头的dylib动态库，此时应该会报错
![](http://upload-images.jianshu.io/upload_images/1787336-c8c0b59cc97bb65a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
动态库链接报错
...
![](http://upload-images.jianshu.io/upload_images/1787336-ded1e962bc8e3d29.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
修改的动态库
...
![](http://upload-images.jianshu.io/upload_images/1787336-c8fab609ba26af65.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
制作完成使用
