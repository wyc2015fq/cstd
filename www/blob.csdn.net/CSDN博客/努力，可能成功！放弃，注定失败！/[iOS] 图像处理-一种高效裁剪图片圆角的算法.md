# [iOS] 图像处理 - 一种高效裁剪图片圆角的算法 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年12月19日 22:05:51[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：1379
# 场景
...
![](http://upload-images.jianshu.io/upload_images/2764502-dd591dcaee665459.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
实验前关闭所有比较耗CPU的软件。实验中不操作电脑，避免影响实验结果准确性。最后得到了以下实验数据，并绘制成表格。
![](http://upload-images.jianshu.io/upload_images/2764502-492254b187bb619a.jpeg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
表格.jpeg
**实验过程中的具体数据。**
- **圆角为 10 的情况**
|裁剪方法|用时 ms|
...
|CGContext裁剪|15270|
|贝塞尔裁剪|14317|
![](http://upload-images.jianshu.io/upload_images/2764502-8309f401d0998258.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
圆角为 10
- **圆角为 50 的情况**
|裁剪方法|用时 ms|
|----|----|
...
|CGContext裁剪|14676|
|贝塞尔裁剪|14612|
![](http://upload-images.jianshu.io/upload_images/2764502-90da5881b333d6e6.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
圆角为 50
- **圆角为 100 的情况**
|裁剪方法|用时 ms|
|----|----|
...
|CGContext裁剪|14646|
|贝塞尔裁剪|14597|
![](http://upload-images.jianshu.io/upload_images/2764502-b73e38ee9e93ab7a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
圆角为 100
- **圆角为 250 的情况**
|裁剪方法|用时 ms|
|----|----|
...
|CGContext裁剪|14692|
|贝塞尔裁剪|14313|
![](http://upload-images.jianshu.io/upload_images/2764502-187ddecf716e83d4.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
圆角为 250
### 结论与分析
从上面数据可以看出：
...
文／ck2016（简书作者）
原文链接：http://www.jianshu.com/p/bbb50b2cb7e6
