# iOS简单的密码输入组件XLPasswordView,UI类似支付宝 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年07月12日 23:06:17[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：2092
## 0. Githud链接
`-    [https://github.com/Shannoon/XLPasswordView](https://github.com/Shannoon/XLPasswordView)`
# 1. XLPasswordView描述
...
```
```
# 4. 使用方法很简单,自己下载demo去看就可以,一些颜色自定的自定义看源码修改即可,有什么bug问题,欢迎一起来讨论
文／shannoon（简书作者）
原文链接：http://www.jianshu.com/p/969aecc46553
