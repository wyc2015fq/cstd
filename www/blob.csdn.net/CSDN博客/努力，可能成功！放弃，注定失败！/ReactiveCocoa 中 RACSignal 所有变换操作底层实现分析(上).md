# ReactiveCocoa 中 RACSignal 所有变换操作底层实现分析(上) - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年11月30日 17:28:27[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：833
![](http://upload-images.jianshu.io/upload_images/1194012-2c2d50bd3cdbbd9c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
### 前言
在[上篇文章](http://www.jianshu.com/p/d7d951a99db8)中，详细分析了RACSignal是创建和订阅的详细过程。看到底层源码实现后，就能发现，ReactiveCocoa这个FRP的库，实现响应式（RP）是用Block闭包来实现的，而并不是用KVC / KVO实现的。
...
![](http://upload-images.jianshu.io/upload_images/1194012-a6b40ff2e98de8bf.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
- 2.时间操作
### 一.变换操作
![](http://upload-images.jianshu.io/upload_images/1194012-318ed27712874613.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
![](http://upload-images.jianshu.io/upload_images/1194012-3de04d3461e94214.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
来看看底层是如何实现的。
```
...
![](http://upload-images.jianshu.io/upload_images/1194012-57319101428b7e57.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
![](http://upload-images.jianshu.io/upload_images/1194012-a5ec03de46b8b2af.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
```
![](http://upload-images.jianshu.io/upload_images/1194012-9a051a1f79f17a0d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
```
...
```
![](http://upload-images.jianshu.io/upload_images/1194012-a8d8c3540d8a9a40.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
![](http://upload-images.jianshu.io/upload_images/1194012-704a81dcc0247d6c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
![](http://upload-images.jianshu.io/upload_images/1194012-02693db1639c107a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
![](http://upload-images.jianshu.io/upload_images/1194012-840af26c6732f324.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
collect函数会调用aggregateWithStartFactory: reduce:方法。把所有原信号的值收集起来，保存在NSMutableArray中。
### 二. 时间操作
![](http://upload-images.jianshu.io/upload_images/1194012-f45e4c9ee0e5e1de.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/1194012-a0db69600f432f98.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
### 最后
本来想穷尽分析每一个RACSignal的操作的实现，但是发现所有操作加起来实在太多，用一篇文章全部写完篇幅太长了，简书一篇放不下了，还是拆成几篇，RACSignal还剩过滤操作，多信号组合操作，冷热信号转换操作，高阶信号操作，下篇接着继续分析。最后请大家多多指教。
文／一缕殇流化隐半边冰霜（简书作者）
原文链接：http://www.jianshu.com/p/9c4459ae71c5
