# iOS---精仿手工课~(Objective-C) - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年07月21日 08:23:49[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：1127
# 前言
...
# 效果预览
![](http://upload-images.jianshu.io/upload_images/694552-74abfbac0daa4232.gif?imageMogr2/auto-orient/strip)
新版本.gif
![](http://upload-images.jianshu.io/upload_images/694552-7daaf4dddc6028fc.gif?imageMogr2/auto-orient/strip)
首页-精选.gif
![](http://upload-images.jianshu.io/upload_images/694552-e3e842a3ab14ebee.gif?imageMogr2/auto-orient/strip)
首页-精选-直播.gif
![](http://upload-images.jianshu.io/upload_images/694552-82d7fac4ab14cbfa.gif?imageMogr2/auto-orient/strip)
教程01.gif
![](http://upload-images.jianshu.io/upload_images/694552-7d1a780fc03ebb62.gif?imageMogr2/auto-orient/strip)
市集.gif
![](http://upload-images.jianshu.io/upload_images/694552-47c44761c8da4fb3.gif?imageMogr2/auto-orient/strip)
手工圈.gif
![](http://upload-images.jianshu.io/upload_images/694552-6f6defa7ad37997f.gif?imageMogr2/auto-orient/strip)
首页-达人.gif
![](http://upload-images.jianshu.io/upload_images/694552-19dea3d44b098d60.gif?imageMogr2/auto-orient/strip)
首页-关注.gif
![](http://upload-images.jianshu.io/upload_images/694552-5dadc47439f587f7.gif?imageMogr2/auto-orient/strip)
首页-活动01.gif
![](http://upload-images.jianshu.io/upload_images/694552-73be02dbfb881b34.gif?imageMogr2/auto-orient/strip)
我的.gif
![](http://upload-images.jianshu.io/upload_images/694552-d2b998cd36439b3e.gif?imageMogr2/auto-orient/strip)
教程02.gif
![](http://upload-images.jianshu.io/upload_images/694552-b794f6b3fe160577.gif?imageMogr2/auto-orient/strip)
首页-活动02.gif
![](http://upload-images.jianshu.io/upload_images/694552-2257b35287aa5784.gif?imageMogr2/auto-orient/strip)
首页-精选-02.gif
# 代码结构
![](http://upload-images.jianshu.io/upload_images/694552-dffc7a951b805d40.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Snip20160717_1.png
代码结构我比较喜欢按照业务来区分,大概就是这样子了
# 新版本特性
思路和实现都比较简单,需要注意的一点是**将判断是否有新版本的逻辑提取出来**,直接上代码
#### AppDelegate
```
...
```
# 首页
![](http://upload-images.jianshu.io/upload_images/694552-14da73f65d2dff0c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Snip20160718_2.png
...
```
**转场动画**
关于转场动画,网上有好多大神写的博客,这里我就直接贴一些地址,有兴趣的可以看看,[喵神](https://onevcat.com/2013/10/vc-transition-in-ios7/),
[wr大神](http://www.jianshu.com/p/c609ebc6a433);
**登录界面**
![](http://upload-images.jianshu.io/upload_images/694552-c58e4452b43a3ab2.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Snip20160718_8.png
登录界面是[Jake lin](https://github.com/JakeLin)的一个swift课程,我用OC 重新实现了一遍
```
#pragma mark - 生命周期
- (void)viewDidLoad {
    [super viewDidLoad];
...
```
**直播**
![](http://upload-images.jianshu.io/upload_images/694552-f86dc9dc61b3cedc.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Snip20160718_9.png
聊天界面搭建,用到了 [SDAutoLayout](https://github.com/gsdios),感兴趣的可以学习一下
```
...
```
**达人**
![](http://upload-images.jianshu.io/upload_images/694552-283f82eada904752.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Snip20160718_14.png
...
```
# 教程
![](http://upload-images.jianshu.io/upload_images/694552-e9f760b69a29ba66.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Snip20160718_15.png
![](http://upload-images.jianshu.io/upload_images/694552-5d265e4d38a08f7e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Snip20160718_16.png
```
- (void)viewDidLoad {
    [super viewDidLoad];
...
```
**手工圈**
![](http://upload-images.jianshu.io/upload_images/694552-731c0dea7163ce03.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Snip20160718_17.png
...
```
# 我的
![](http://upload-images.jianshu.io/upload_images/694552-45c67c74a9080c17.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Snip20160718_18.png
...
```
# 最后说两句
由于代码量较大,所以还是上源码吧,[源码地址](https://github.com/GPPG/GPHandMade)
文／我是小菜鸟（简书作者）
