# iOS隐私权限获取和检测 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2017年07月05日 10:41:42[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：2902
### 本文来自简书，原文地址:[http://www.jianshu.com/p/e20fd80619ce](http://www.jianshu.com/p/e20fd80619ce)
### [GitHub:ECAuthorizationTools](https://github.com/EchoZuo/ECAuthorizationTools)
###### 该工具类主要是为了方便大家获取设备权限和检查对应的权限，目前支持iOS7 - iOS10所有设置中的隐私权限获取和检测。具体每一个隐私的权限获取和检测都在工具类ECAuthorizationTools.h中有详细的逻辑思路。DemoViewController.m中也有详细的使用工具类方式。如果有什么不清楚的可以给我留言解决或者在git上issues我。
#### [点击前往GitHub下载项目](https://github.com/EchoZuo/ECAuthorizationTools)
### Abstract 概要
...
```
###### 参照下图:
![](http://upload-images.jianshu.io/upload_images/1424124-36c702a9e7129b3a.PNG?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
image
...
###### 再附上一张Demo截图：
![](http://upload-images.jianshu.io/upload_images/1424124-5d92ba22856d99ad.PNG?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
image
### More 更多
...
- 简书：@EchoZuo 或者 [http://www.jianshu.com/u/3390ce71084e](http://www.jianshu.com/u/3390ce71084e)
- Github:@EchoZuo 或者 [https://github.com/EchoZuo/ECAuthorizationTools](https://github.com/EchoZuo/ECAuthorizationTools)
#### [点击前往GitHub下载项目](https://github.com/EchoZuo/ECAuthorizationTools)
