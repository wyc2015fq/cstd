# iOS CoreSpotlightSearch探索之道 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年06月20日 10:17:42[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：1128
![](http://upload-images.jianshu.io/upload_images/99517-9a3b2a1cc4a53302.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
AppleStore搜索结果示例
### 前言
看到上图的搜索结果，找完了文档都没有发现这个效果怎样实现，我也是醉了，然后不小心看到下图，我相信有方法能实现，只是现在还没有发现！
![](http://upload-images.jianshu.io/upload_images/99517-c0f46c5d2308fb70.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
淘票票搜索显示.png
研究了几天，还是让我找到了结果，苹果还是不行啊，还是我不行？反正一路过来，不容易！！自己想实现的效果，含泪也要实现出来—.—
![](http://upload-images.jianshu.io/upload_images/99517-8aaacffe38ead37a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
最后实现的可用全部类型.png
下面就是探索之道，喜欢看代码的就直接先上代码看吧
[CoreSpotlightSearchDemo](https://github.com/iHTCboy/CoreSpotlightSearchDemo)
### 1、普通类型
一般应用搜索出来的结果都是一图片，一标题，一内容
![](http://upload-images.jianshu.io/upload_images/99517-6618a31f933c3512.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
简书的搜索结果
但是如果想实现没有图片呢？如下图：
![](http://upload-images.jianshu.io/upload_images/99517-9d1242b99045caf2.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/99517-ba6003190161f2c5.PNG?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
带有时间的
```
// 显示时间的必要条件
...
```
```
![](http://upload-images.jianshu.io/upload_images/99517-f20fb4943676011f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
实现的电话类型png
![](http://upload-images.jianshu.io/upload_images/99517-6f5f9aa97a5dd3db.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
通讯录.png
![](http://upload-images.jianshu.io/upload_images/99517-bf0bdb549134fa58.PNG?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/99517-8ccdd6d64132edc9.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
位置导航类型.png
```cpp
```cpp
// 显示的必要条件，经纬度
...
![](http://upload-images.jianshu.io/upload_images/99517-8ff8d409ba87cac9.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
带星星评价
```
//要选中对应的媒体类型
...
![](http://upload-images.jianshu.io/upload_images/99517-18253ee128b3f451.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
音乐类型
![](http://upload-images.jianshu.io/upload_images/99517-3ebc424e2ecb1f06.PNG?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
苹果音乐.PNG
```
attributedSet.contentType = (NSString*) kUTTypeAudio;
...
![](http://upload-images.jianshu.io/upload_images/99517-7286b9a8bb99388e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
文档类型.png
### 8.邮件类型【未实现】
...
![](http://upload-images.jianshu.io/upload_images/99517-6ab7ba38af3b3b5e.PNG?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
苹果邮件.PNG
![](http://upload-images.jianshu.io/upload_images/99517-909c83ec7c4f7e91.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
QQ邮箱搜索显示效果.png
### 9.搜索关键字？
最特别的是，我在搜索很多关键字时，发现京东每一次都出现，并且关键字也命中啦！如下图：
![](http://upload-images.jianshu.io/upload_images/99517-12f0ae64a9c16b14.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
京东搜索.png
...
![](http://upload-images.jianshu.io/upload_images/99517-a042dcd755a69491.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
京东搜索结果多行显示.png
### 11.言外之意
...
因为用户有权选择不显示应用的搜索结果：
![](http://upload-images.jianshu.io/upload_images/99517-45bd345ccb64d4f4.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
关闭应用搜索结果.png
但我在想，我安装了200+应用，有时候都不想显示，苹果没有一个全部关闭的按钮，我想这不是苹果不知道，而是不“为”！就是希望用户保留搜索，一个大数据的时代！！
当然，我们在使用时，是不是也要关心一直搜索隐私问题，苹果说了(他说了算)：
![](http://upload-images.jianshu.io/upload_images/99517-c7860b385e98702a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Spotlight隐私说明.png
### 参考
...
文／iHTCboy（简书作者）
原文链接：http://www.jianshu.com/p/07dee1e1ed4c
