# iOS二维码生成(带logo) - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年08月23日 22:42:42[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：3808
> 
实在不好意思,昨天忘记写的<<二维码生成>>忘记写最常见的黑白二维码嵌入一张图片,一般都是公司的logo.今天补上
```
//
//  ViewController.m
//  内置图片二维码
...
@end
```
![](http://upload-images.jianshu.io/upload_images/1715803-f708e0801ee79824.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
带logo的二维码.png
> 
同时,我今天也把3种二维码生成写到了gitHub上了,想看的朋友down下:[3种iOS二维码生成样式](https://github.com/HHQBOOK/qrCode)
文／长若执念（简书作者）
原文链接：http://www.jianshu.com/p/52dfcdf4f296
