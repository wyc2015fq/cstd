# iOS动画实战之Lottie动画 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2018年07月18日 16:11:36[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：535
### 介绍
如果你还不知道Lottie是什么, 那你真的out了.
如果把iOS动画分为两类: 交互式动画, 播放式动画, 那么其中的播放动画完全可以使用Lottie来完成, 例如:
![](https://upload-images.jianshu.io/upload_images/4628744-a7803eb775c0ea72.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/333)
作为收藏按钮, 是不是很活泼?
![](https://upload-images.jianshu.io/upload_images/4628744-261ad1bb1feeb90a.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/333)
返回与菜单之间的切换, 生动有趣!
![](https://upload-images.jianshu.io/upload_images/4628744-5cb23c0c7a72e14a.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/333)
还有各种形变动画.
这里先放上Lottie的地址: [https://github.com/airbnb/lottie-ios](https://link.jianshu.com?t=https://github.com/airbnb/lottie-ios)
...
### 实战
先看第一个例子:
![](https://upload-images.jianshu.io/upload_images/4628744-a0d36ecba3890131.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/400)
...
```
![](https://upload-images.jianshu.io/upload_images/4628744-b5d1f0251c5e5410.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/400)
甚至可以用在引导页中, 代码都很简单, 就不重复贴了. 值得注意的是, 像这样多次使用到Lottie时一定要注意素材的名字不能一样, 否则动画就是错乱的, 简单讲一讲怎么改.
![](https://upload-images.jianshu.io/upload_images/4628744-7b2cbe91b7c70245.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/198)
这是一个动画资源的文件结构, 如果修改了img_0.png及其文件夹, 则需要在Json文件中修改对应的内容
![](https://upload-images.jianshu.io/upload_images/4628744-976ea74eceeb0f0d.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/700)
这就是Json文件中的内容, 最上面一部分包含了素材路径, 素材名称, 注意修改好就ok.
第二个例子:
![](https://upload-images.jianshu.io/upload_images/4628744-be6d48c56eca1e24.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/400)
...
几点值得注意的是:
- 
我这创建一个UIImageView作为背景, 是拆分了动画, 将不动的部分作为背景, 避免内存中加载的图片过多, 后面会细说这个问题.
- 
...
以上健呗的Demo地址: [https://github.com/syik/JR](https://link.jianshu.com?t=https://github.com/syik/JR)
直播伴侣地址: [https://github.com/syik/BulletAnalyzer](https://link.jianshu.com?t=https://github.com/syik/BulletAnalyzer)
这是一个已经上架的App, 大家可以直接在App Store中找到使用. 上一篇文章为此App中CoreAnimation与CoreGraphics可交互式图表实战.
若大家觉得写得有用, 不吝啬打赏一个Star~, 谢谢~
作者：Syik
链接：https://www.jianshu.com/p/d27d83c5116e
來源：简书
