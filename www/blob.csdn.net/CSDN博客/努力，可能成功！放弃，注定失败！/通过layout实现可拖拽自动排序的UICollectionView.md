# 通过layout实现可拖拽自动排序的UICollectionView - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年05月09日 14:17:09[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：407
##### Translate from [http://blog.karmadust.com/drag-and-rearrange-uicollectionviews-through-layouts/](http://blog.karmadust.com/drag-and-rearrange-uicollectionviews-through-layouts/)
（[Github](https://github.com/mmick66/KDRearrangeableCollectionViewFlowLayout)上的代码 - 使用XCode6.3编译）
...
![](http://46.101.33.206/wp-content/uploads/2015/03/d2.png)
image
...
var bundle : Bundle?
```
offset是cell原始位置到用户手指位置的距离，这记录了我们拖拽的距离，而不是截图的位置到手指的位置的距离
...
```
###### 拖拽Cell
现在，又出现了新的问题。`UILongPressGestureRecognizer`有3个状态是我们该注意的，分别是`Began`,
`Changed` 和 `Ended`，首先，我们隐藏拖拽的Cell，并将截图的View添加到Canvas上
```
