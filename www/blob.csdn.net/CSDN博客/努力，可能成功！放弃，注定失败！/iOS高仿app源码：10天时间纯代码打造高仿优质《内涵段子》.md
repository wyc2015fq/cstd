# iOS高仿app源码：10天时间纯代码打造高仿优质《内涵段子》 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年10月10日 16:46:11[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：1495
### Github 地址 [https://github.com/Charlesyaoxin/NeiHanDuanZI](https://github.com/Charlesyaoxin/NeiHanDuanZI)
#### 介绍：
花了不太到两周的闲余时间模仿了一下今日头条旗下的iOS端app内涵段子，如果喜欢的话请前往[我的Github](https://github.com/Charlesyaoxin)点个星。(8.30-9.11)
...
![](http://upload-images.jianshu.io/upload_images/939127-bec577630d600bdd.gif?imageMogr2/auto-orient/strip)
1.gif
#### 日志:
...
![](http://upload-images.jianshu.io/upload_images/939127-98fd99423876390a.gif?imageMogr2/auto-orient/strip)
3.gif
...
![](http://upload-images.jianshu.io/upload_images/939127-67512f783552d3bb.gif?imageMogr2/auto-orient/strip)
4.gif
![](http://upload-images.jianshu.io/upload_images/939127-ed0e33ea58625113.gif?imageMogr2/auto-orient/strip)
5.gif
...
![](http://upload-images.jianshu.io/upload_images/939127-42361f35820aad63.gif?imageMogr2/auto-orient/strip)
8.gif
#### 发布：选择热吧，发布图片文字
##### 发布
> 
发布界面相对简单，利用masonry[masonry](https://github.com/SnapKit/Masonry)布局，处理键盘弹出下落通知事件，当键盘申弹出和下落的时候更新约束，可以看下这篇软文[masonry约束动画](http://blog.csdn.net/woaifen3344/article/details/50114415)
利于UICollectionview布局图片选择完成后的界面，添加带有占位文字的高度可定制化的textView。
![](http://upload-images.jianshu.io/upload_images/939127-a9c571614261c037.gif?imageMogr2/auto-orient/strip)
7.gif
...
![](http://upload-images.jianshu.io/upload_images/939127-72780653c0da73cd.gif?imageMogr2/auto-orient/strip)
3.gif
#### 用户：用户信息写死在本地，模仿登录逻辑
##### 用户
> 
...
![](http://upload-images.jianshu.io/upload_images/939127-e5633ad9e53919c0.jpeg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
个人.jpeg
#### 代码展示
```
...
##### 本文Github地址
##### [点击前往本文Github地址](https://github.com/Charlesyaoxin/NeiHanDuanZI)
文／一只孤独的iOS（简书作者）
原文链接：http://www.jianshu.com/p/c19052dd96e5
