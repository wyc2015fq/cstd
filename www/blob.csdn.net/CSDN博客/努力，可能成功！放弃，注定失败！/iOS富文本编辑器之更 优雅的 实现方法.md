# iOS富文本编辑器之更"优雅的"实现方法 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年10月08日 14:54:58[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：2673
![](http://upload-images.jianshu.io/upload_images/1694866-f62eb6715324b456.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
> 
前言:最近帮公司的一名程序员搞一个项目的收尾工作,差一个富文本编辑器功能未实现,时间紧迫,调研了下网上的解决方法均较为繁琐. 不得已找了个别门来实现该问题,且看下文
- 需要实现的效果
![](http://upload-images.jianshu.io/upload_images/1694866-a5e800a1bf59e39b.gif?imageMogr2/auto-orient/strip)
需要实现的效果
- 
解决思路
> 
...
```
- 编辑完成后拿出html代码
`    NSString *html = [self.webView stringByEvaluatingJavaScriptFromString:@"document.getElementById('content').innerHTML"];`- 编辑服务器中的富文本
```
...
```
至此可实现一个富文本编辑器的新增与编辑.
- [Demo](https://github.com/xiaosheng0601/RichTextDemo)
文／五阿哥永琪（简书作者）
原文链接：http://www.jianshu.com/p/b2a0528659bd
