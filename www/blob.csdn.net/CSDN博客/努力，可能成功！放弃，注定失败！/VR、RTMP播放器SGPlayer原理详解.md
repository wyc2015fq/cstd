# VR、RTMP播放器SGPlayer原理详解 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2017年04月24日 16:58:23[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：633
## 本文来自简书，原文地址:[http://www.jianshu.com/p/0b3f886b6be0](http://www.jianshu.com/p/0b3f886b6be0)
## 简介
SGPlayer 是一款基于 AVPlayer、FFmpeg 的媒体资源播放器框架。支持全景视频，RTMP、RTSP 等直播流；同时支持 iOS、macOS、tvOS 三个平台。本文将采用图解+说明的方式把关键模块的实现原理介绍给大家。
- 项目地址：[GitHub - SGPlayer](https://github.com/libobjc/SGPlayer)
## 发起原因
关于视频播放，苹果提供的 AVPlayer 在性能上有着十分出色的表现，在无特需求且资源可控的时，首选一定是它。但随着 VR 和直播的兴起，仅使用 AVPlayer 很多时候已经无法满足需求。出于性能考虑，又不能完全抛弃 AVPlayer，毕竟在点播时有着明显的优势。而在现有的开源项目中，普遍定位比较单一，并不能兼顾 AVPlayer、直播、VR。这样一来，需同时使用3款播放器才能满足需求，即点播使用 AVPlayer，直播使用一个独立的播放器，VR 使用一个独立的播放器。这样处理3套不同的接口和回调事件，着实很让人崩溃！SGPlayer
 的出现大大简化了这一过程。
## 组成结构 和 播放流程
![](http://upload-images.jianshu.io/upload_images/317389-05195b81889d17e6.jpeg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
SGPlayer 播放流程图
...
### 贴图规则
![](http://upload-images.jianshu.io/upload_images/317389-d75c29060ef82fae.jpeg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
全景图像 贴图规则
...
### 呈现方式
![](http://upload-images.jianshu.io/upload_images/317389-d0ca1f5c83e541e8.jpeg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
全景图像 观看视角
...
## SGFFPlayer 运作流程
![](http://upload-images.jianshu.io/upload_images/317389-74d413d32f52b73e.jpeg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
SGFFPlayer 运作流程
