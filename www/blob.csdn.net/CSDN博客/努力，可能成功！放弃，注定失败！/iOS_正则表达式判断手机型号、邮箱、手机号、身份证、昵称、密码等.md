# iOS_正则表达式判断手机型号、邮箱、手机号、身份证、昵称、密码等 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年03月18日 09:58:20[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：451标签：[iOS																[iOS开发																[正则表达式																[iOS_正则表达式判断手机型号邮箱手机号](https://so.csdn.net/so/search/s.do?q=iOS_正则表达式判断手机型号邮箱手机号&t=blog)](https://so.csdn.net/so/search/s.do?q=正则表达式&t=blog)](https://so.csdn.net/so/search/s.do?q=iOS开发&t=blog)](https://so.csdn.net/so/search/s.do?q=iOS&t=blog)
