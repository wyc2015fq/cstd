# 七个Swift中的陷阱以及避免方法 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年02月26日 11:38:04[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：320标签：[swift																[iOS开发																[swift使用](https://so.csdn.net/so/search/s.do?q=swift使用&t=blog)](https://so.csdn.net/so/search/s.do?q=iOS开发&t=blog)](https://so.csdn.net/so/search/s.do?q=swift&t=blog)
个人分类：[iOS开发](https://blog.csdn.net/qq_30513483/article/category/6072895)
文章总结翻译自：[Seven
 Swift Snares & How to Avoid Them](https://developer.ibm.com/swift/2016/01/27/seven-swift-snares-how-to-avoid-them/?utm_campaign=This+Week+in+Swift&utm_medium=web&utm_source=This_Week_in_Swift_72)
Swift正在完成一个惊人的壮举，它正在改变我们在苹果设备上编程的方式，引入了很多现代范例，例如：函数式编程和相比于OC这种纯面向对象语言更丰富的类型检查。
Swift语言希望通过采用安全的编程模式去帮助开发者避免bug。然而这也会不可避免的产生一些人造的陷阱，他们会在编译器不报错的情况下引入一些Bug。这些陷阱有的已经在[Swift
 book](https://swift.org/documentation/#the-swift-programming-language)中提到，有一些还没有。这里有七个我在去年遇到的陷阱，它们涉及Swift协议扩展、可选链和函数式编程。
**协议扩展：强大但是需要谨慎使用**
...
![u=3958544063,3658370708&fm=21&gp=0.jpg](http://cc.cocimg.com/api/uploads/20160218/1455778688608700.jpg)在协议扩展中重写协议中的属性时要仔细核对
ok，我们把这个拼写错误改正过来：
```
...
```
![u=3958544063,3658370708&fm=21&gp=0.jpg](http://cc.cocimg.com/api/uploads/20160218/1455778618883606.jpg)在协议扩展中定义的每一个属性，需要在协议中进行声明。
...
![u=3958544063,3658370708&fm=21&gp=0.jpg](http://cc.cocimg.com/api/uploads/20160218/1455778567477705.jpg)不要对导入的协议进行扩展，新增可能需要动态调度的属性
...
![u=3958544063,3658370708&fm=21&gp=0.jpg](http://cc.cocimg.com/api/uploads/20160218/1455778419674576.jpg)如果一个新的属性需要动态调度，避免使用约束性协议扩展。
**使用可选链赋值和副作用**
...
![u=3958544063,3658370708&fm=21&gp=0.jpg](http://cc.cocimg.com/api/uploads/20160218/1455778382636838.jpg)避免把一个有副作用的表达式的结果通过可选链赋值给等号左边的变量
**函数编程陷阱**
...
![u=3958544063,3658370708&fm=21&gp=0.jpg](http://cc.cocimg.com/api/uploads/20160218/1455778225700407.jpg)避免在闭包中使用in-out参数
...
![u=3958544063,3658370708&fm=21&gp=0.jpg](http://cc.cocimg.com/api/uploads/20160218/1455778172724772.jpg)避免在柯里化函数中使用inout参数，因为如果你后来将柯里化改为显式的创建闭包，这段代码就会产生错误
**总结：七个避免**
- 
