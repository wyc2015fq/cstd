# 最好用的 iOS 快速布局UI库 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2018年09月26日 10:01:05[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：158
# NerdyUI
github: [https://github.com/nerdycat/NerdyUI](https://link.jianshu.com?t=https://github.com/nerdycat/NerdyUI)
# Cupcake (Swift 版本)
github: [https://github.com/nerdycat/Cupcake](https://link.jianshu.com?t=https://github.com/nerdycat/Cupcake)
相关文章：
[NerdyUI 使用小技巧](https://www.jianshu.com/p/c9ac29fb634e)
## 序言
...
```
![view](https://github.com/nerdycat/NerdyUI/raw/master/res/view.png)
view
```
...
```
![moose](https://github.com/nerdycat/NerdyUI/raw/master/res/moose.png)
moose
```
...
```
![button](https://github.com/nerdycat/NerdyUI/raw/master/res/button.gif)
button
```
...
```
![input](https://github.com/nerdycat/NerdyUI/raw/master/res/input.gif)
input
...
```
![label](https://github.com/nerdycat/NerdyUI/raw/master/res/label.gif)
label
## 快速的创建约束
...
```
![constraints](https://github.com/nerdycat/NerdyUI/raw/master/res/constraints.png)
constraints
## 快速布局
...
```
![appcell](https://github.com/nerdycat/NerdyUI/raw/master/res/appcell.png)
appcell
...
![appcell2](https://github.com/nerdycat/NerdyUI/raw/master/res/appcell2.png)
appcell2
...
`pod "NerdyUI"`
作者：猫执旅人
链接：https://www.jianshu.com/p/ac47c4826a19
來源：简书
