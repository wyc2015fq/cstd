# 前端开发面试题之 JavaScript - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2016年09月09日 08:50:24[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：3828
...
#### 知识点
`数据类型`、`运算`、`对象`、`function`、`继承`、`闭包`、`作用域`、`原型链`、`事件`、`RegExp`、`JSON`、`Ajax`、`DOM`、`BOM`、`内存泄漏`、`跨域`、`异步加载`、`模板引擎`、`前端MVC`、`前端MVVM`、`路由`、`模块化`、`Canvas`、`jQuery`、
```
ECMAScript
 2015（ES6）
```
、`Node.js`、`AngularJS`、`React`、`CommonJS`、`AMD`、`CMD` ......
#### 题目&答案
- 介绍一下 JS 的基本数据类型。
...
- 前端 MVC、MVVM
1、MVC
![](http://upload-images.jianshu.io/upload_images/1714316-f5f3378c71fa8a2c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
MVC
```cpp
```cpp
模型（Model）：数据保存
...
```
2、MVVM
![](http://upload-images.jianshu.io/upload_images/1714316-235c293d0a018e28.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
MVVM
```cpp
```cpp
模型（Model）
...
```
系列：
[前端开发面试题之 HTML](http://www.jianshu.com/p/65fa501e4683)
[前端开发面试题之综合篇](http://www.jianshu.com/p/fe62c7e33ba8#)
[前端开发面试题之 CSS](http://www.jianshu.com/p/10a7959033f8)
> 
资料搜集整理自 网络
同时发布在 [GitHub-前端开发面试题之 JavaScript](https://github.com/YuanXiaosong/Front-End-Interview/blob/master/%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91%E9%9D%A2%E8%AF%95%E9%A2%98%E4%B9%8BJavaScript.mdown)、[GitHub-《WEB-DE》前端开发面试题之 JavaScript](https://wookong.gitbooks.io/web-de/content/04-Front-End%20Interview%20about%20JavaScript.html)
文／晓松（简书作者）
