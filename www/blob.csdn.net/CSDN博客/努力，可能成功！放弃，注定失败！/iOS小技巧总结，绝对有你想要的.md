# iOS小技巧总结，绝对有你想要的 - 努力，可能成功！放弃，注定失败！ - CSDN博客
置顶2017年05月08日 17:09:54[上天眷顾我](https://me.csdn.net/qq_30513483)阅读数：409标签：[iOS 资源大全																[ios开发																[iOS小技巧](https://so.csdn.net/so/search/s.do?q=iOS小技巧&t=blog)](https://so.csdn.net/so/search/s.do?q=ios开发&t=blog)](https://so.csdn.net/so/search/s.do?q=iOS 资源大全&t=blog)
个人分类：[iOS开发](https://blog.csdn.net/qq_30513483/article/category/6072895)
本文来自简书，原文地址:[http://www.jianshu.com/p/4523eafb4cd4](http://www.jianshu.com/p/4523eafb4cd4)
...
```
##### 字符串按多个符号分割
![](http://upload-images.jianshu.io/upload_images/1608265-59de354dc6972272.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
image.png
...
```
```
![](http://upload-images.jianshu.io/upload_images/1608265-0336b1d206210cf1.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Image.png
##### 屏蔽触发事件，2秒后取消屏蔽
```
...
```
##### fillRule原理
![](http://upload-images.jianshu.io/upload_images/1608265-102c8b228637e659.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
Image.png
##### iOS中数字的格式化
```
...
![](http://upload-images.jianshu.io/upload_images/1608265-2b25556ad97436ad.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
image.png
...
```
![](http://upload-images.jianshu.io/upload_images/1608265-649770861a945c45.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
image.png
##### NSString进行URL编码和解码
```
