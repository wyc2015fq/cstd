...
# 语义分割汇总 - 郭云飞的专栏 - CSDN博客


2018年05月23日 19:26:11[guoyunfei20](https://me.csdn.net/guoyunfei20)阅读数：906


```python
下边是国外小哥汇总的各种语义分割的paper以及code，非常赞。分享一下：https://github.com/mrgloom/awesome-semantic-segmentation.git
```
https://github.com/mrgloom/awesome-seman[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
```python
