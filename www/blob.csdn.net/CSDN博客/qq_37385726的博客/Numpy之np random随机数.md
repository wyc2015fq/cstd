# Numpy之np.random随机数 - qq_37385726的博客 - CSDN博客





2018年09月01日 10:51:11[啧啧啧biubiu](https://me.csdn.net/qq_37385726)阅读数：163
...
[1 numpy.random.rand()](#1-numpy-random-rand-)

[2 numpy.random.randn()](#2-numpy-random-randn-)

[3 numpy.random.randint()](#3-numpy-random-randint-)

[3.1 numpy.random.randint()](#3-1-numpy-random-randint-)

[3.2 numpy.random.random_integers](#3-2-numpy-random-random_integers)

[4 生成[0,1)之间的浮点数](#4-0-1-)

[5 numpy.random.choice()](#5-numpy-random-choice-)

[6 numpy.random.seed()](#6-numpy-random-seed-)

转载自[这里](https://www.cnblogs.com/lemonbit/p/6864179.html)
