# Pytorch之第一次构建神经网络（四） - qq_37385726的博客 - CSDN博客





2018年08月16日 17:26:10[啧啧啧biubiu](https://me.csdn.net/qq_37385726)阅读数：148
...
input = Variable(torch.rand(1,1,32,32),requires_grad = True)  #根据上述网络定义in_channels=1,所以输入为1，shape(32,32)
out = net(input)   #将输入作为参数传入网络返回值即为输出
print('out:\n',out)   
