# JVM性能调优 - 零度的博客专栏 - CSDN博客
2016年07月18日 16:06:49[零度anngle](https://me.csdn.net/zmx729618)阅读数：389
...
    我还观察到一个问题，当较长的时间不访问系统，比如2天，DB上的[MySQL](http://lib.csdn.net/base/14)会断掉所以的连接，导致连接池中缓存的连接不能用。为了解决这些问题，我们充分研究了BasicDataSource，发现了一些优化的点：
