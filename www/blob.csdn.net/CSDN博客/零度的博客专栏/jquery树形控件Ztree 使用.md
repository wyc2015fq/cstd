# jquery树形控件Ztree 使用 - 零度的博客专栏 - CSDN博客
2016年04月06日 09:58:46[零度anngle](https://me.csdn.net/zmx729618)阅读数：2729
官网：
[http://www.ztree.me/v3/main.php](http://www.ztree.me/v3/main.php)
使用 json 数据格式
...
   async: {
    enable: true,
[url:"<%=path](' rel=) %>/organTree/getChildNodes.action",
