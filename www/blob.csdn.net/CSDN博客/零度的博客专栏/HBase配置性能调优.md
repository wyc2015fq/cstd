# HBase配置性能调优 - 零度的博客专栏 - CSDN博客
2016年11月10日 13:55:58[零度anngle](https://me.csdn.net/zmx729618)阅读数：273标签：[hbase																[性能](https://so.csdn.net/so/search/s.do?q=性能&t=blog)](https://so.csdn.net/so/search/s.do?q=hbase&t=blog)
...
这里是一个案例?[Hadoop and HBase
 Optimization for Read Intensive Search Applications](http://software.intel.com/en-us/articles/hadoop-and-hbase-optimization-for-read-intensive-search-applications/)，作者在SSD的机器上设置IO线程数为100，仅供参考。
...
**批量导入**
在批量导入数据到Hbase前，你可以通过预先创建regions，来平衡数据的负载。详见?[Table Creation:
 Pre-Creating Regions](http://hbase.apache.org/book.html#precreate.regions)
