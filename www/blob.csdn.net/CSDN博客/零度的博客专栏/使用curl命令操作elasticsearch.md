# 使用curl命令操作elasticsearch - 零度的博客专栏 - CSDN博客
2018年05月18日 15:13:32[零度anngle](https://me.csdn.net/zmx729618)阅读数：753

原文出处：使用curl命令操作elasticsearch
第一：_cat系列
 ...
 你也可以后面加一个v，让输出内容表格显示表头，举例name       component        version type url
