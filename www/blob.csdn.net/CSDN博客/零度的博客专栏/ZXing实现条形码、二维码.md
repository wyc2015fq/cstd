# ZXing实现条形码、二维码 - 零度的博客专栏 - CSDN博客
2016年10月18日 10:26:59[零度anngle](https://me.csdn.net/zmx729618)阅读数：9076
### 一、 基本介绍 
        1-1. ZXing是一个开源Java类库用于解析多种格式的条形码和二维码。官网：[http://code.google.com/p/zxing/](http://code.google.com/p/zxing/)
...
- Aztec ('alpha' quality)
     同时官网提供了 [Android](http://lib.csdn.net/base/15)、cpp、C#、iPhone、j2me、j2se、jruby、objc、rim、symbian等多种应用的类库，具体详情可以参考下载的源码包中。
     本文主要是在PC上实现条形码（EAN-13）和二维码（QRCode） 的编码和解码的示例，以供大家参考，用到了源码中core和javase下面的相关源代码，附件提供自己编译之后的lib包：
