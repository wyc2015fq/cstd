# 基于Java NIO的Socket通信 - 零度的博客专栏 - CSDN博客
2017年01月17日 17:06:13[零度anngle](https://me.csdn.net/zmx729618)阅读数：314标签：[java																[nio](https://so.csdn.net/so/search/s.do?q=nio&t=blog)](https://so.csdn.net/so/search/s.do?q=java&t=blog)
...
服务端实现，代码如下所示：
**[java]**[view plain](http://blog.csdn.net/shirdrn/article/details/6263692#)[copy](http://blog.csdn.net/shirdrn/article/details/6263692#)[print](http://blog.csdn.net/shirdrn/article/details/6263692#)[?](http://blog.csdn.net/shirdrn/article/details/6263692#)
...
-  * @author shirdrn
-  */
- publicclass NioTcpServer extends Thread {  
- 
- privatestaticfinal Logger log = Logger.getLogger(NioTcpServer.class.getName());  
...
-  * @author shirdrn
-  */
- publicclass NioTcpClient {  
- 
- privatestaticfinal Logger log = Logger.getLogger(NioTcpClient.class.getName());  
- private InetSocketAddress inetSocketAddress;  
- 
...
-      * @param requestData
-      */
- publicvoid send(String requestData) {  
- try {  
