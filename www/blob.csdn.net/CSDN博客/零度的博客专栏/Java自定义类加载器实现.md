# Java自定义类加载器实现 - 零度的博客专栏 - CSDN博客
2017年11月22日 17:50:54[零度anngle](https://me.csdn.net/zmx729618)阅读数：822
...
其实，Class的getResourceAsStream(String name)方法，只是将传入的name进行解析一下而已，最终调用的还是ClassLoader的getResourceAsStream(String
 name)，看一下Class的getResourceAsStrea(String name)的源代码：
```
