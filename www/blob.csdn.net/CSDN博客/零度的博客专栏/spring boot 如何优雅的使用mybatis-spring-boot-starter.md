# spring boot 如何优雅的使用mybatis-spring-boot-starter - 零度的博客专栏 - CSDN博客
2018年06月22日 15:01:48[零度anngle](https://me.csdn.net/zmx729618)阅读数：12475
...
public class UserMapperTest {
	...
	public void testInsert() throws Exception {
		...
		Assert.assertEquals(, UserMapper.getAll().size());
	}
	@Test
	...
	public void testUpdate() throws Exception {
		UserEntity user = UserMapper.getOne(l);
		System.out.println(user.toString());
		user.setNickName("neo");
		UserMapper.update(user);
		Assert.assertTrue(("neo".equals(UserMapper.getOne(l).getNickName())));
	}
}
```
