# 23种设计模式(8)-代理模式 - 零度的博客专栏 - CSDN博客
2017年07月12日 16:16:37[零度anngle](https://me.csdn.net/zmx729618)阅读数：234标签：[设计模式																[代理模式](https://so.csdn.net/so/search/s.do?q=代理模式&t=blog)](https://so.csdn.net/so/search/s.do?q=设计模式&t=blog)
...
**一、静态代理**
    类图结构如下 
![这里写图片描述](https://img-blog.csdn.net/20160130143252210)
**在代理模式中的角色：**
...
类图 
![这里写图片描述](https://img-blog.csdn.net/20160130143511794)
代码
```java
package com.yc.spring.staticproxy;
