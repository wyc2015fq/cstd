# Java加密/解密算法快速入门下篇[包括MD5、BASE64、DES、RSA等] - 零度的博客专栏 - CSDN博客
2017年05月23日 15:50:46[零度anngle](https://me.csdn.net/zmx729618)阅读数：565
       上一篇博客中已经简要介绍了MD5、BASE64、DES、RSA等算法在Java中的具体应用。本篇对这些代码封装成一个工具类EncryptUtil.java，然后再补充一下Commons Codec对BASE64的扩展支持！
<一>. EncryptUtil.java工具类：
