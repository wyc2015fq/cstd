# Java锁的种类及辨析(二):可重入锁 - 零度的博客专栏 - CSDN博客
2017年11月14日 10:38:08[零度anngle](https://me.csdn.net/zmx729618)阅读数：172标签：[并发锁](https://so.csdn.net/so/search/s.do?q=并发锁&t=blog)
个人分类：[Java并发锁](https://blog.csdn.net/zmx729618/article/category/7287093)
