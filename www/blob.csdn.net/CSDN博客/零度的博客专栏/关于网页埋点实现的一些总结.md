# 关于网页埋点实现的一些总结 - 零度的博客专栏 - CSDN博客
2017年02月28日 15:47:29[零度anngle](https://me.csdn.net/zmx729618)阅读数：15295标签：[js埋点](https://so.csdn.net/so/search/s.do?q=js埋点&t=blog)
...
**工具:**
网站的数据采集有很多现成的工具,如[google Analytics](http://link.zhihu.com/?target=https%3A//www.google.com/analytics/),
[百度统计](http://link.zhihu.com/?target=http%3A//tongji.baidu.com/), [友盟+](http://link.zhihu.com/?target=https%3A//web.umeng.com/main.php%3Fc%3Duser%26a%3Dindex)等,往往通过在页面上接入js SDK代码,如下图所示
![](https://pic2.zhimg.com/v2-72fb25323db244f0325ab432a6e919b9_b.png)
而在实际采集过程中,数据是如何传递过去的呢,我们随便打开一个埋有百度统计的网站, 打开chrome的开发者工具,勾选Preserve log
![](https://pic3.zhimg.com/v2-1201242c055ceaf976d9b82313ce906e_b.png)
