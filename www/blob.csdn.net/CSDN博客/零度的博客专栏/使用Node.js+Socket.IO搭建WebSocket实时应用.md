# 使用Node.js+Socket.IO搭建WebSocket实时应用 - 零度的博客专栏 - CSDN博客
2016年10月17日 16:43:11[零度anngle](https://me.csdn.net/zmx729618)阅读数：3020
...
```
命令行运行`node index.js`，如果一切顺利，你应该会看到返回的`listening on *:3000`字样，这说明服务已经成功搭建了。此时浏览器中打开`http://localhost:3000`应该可以看到正常的欢迎页面。
