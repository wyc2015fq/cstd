# 23种设计模式(1)-单例模式 - 零度的博客专栏 - CSDN博客
2017年06月22日 11:22:09[零度anngle](https://me.csdn.net/zmx729618)阅读数：236标签：[设计模式																[单例模式](https://so.csdn.net/so/search/s.do?q=单例模式&t=blog)](https://so.csdn.net/so/search/s.do?q=设计模式&t=blog)
