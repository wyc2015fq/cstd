# 使用Apache.commons.io文件工具类FileUtils,IOUtils使用 - 零度的博客专栏 - CSDN博客
2016年07月12日 14:47:17[零度anngle](https://me.csdn.net/zmx729618)阅读数：12632
Commons IO是apache的一个开源的工具包,封装了IO操作的相关类,使用Commons IO可以很方便的读写文件,
FileUtils 中提供了许多设计文件操作的 已封装好的方法。
IOUtils 则是提供了读写文件的方法。
读取文件：
**[html]**[view plain](http://blog.csdn.net/z69183787/article/details/8097573#)[copy](http://blog.csdn.net/z69183787/article/details/8097573#)[print](http://blog.csdn.net/z69183787/article/details/8097573#)[?](http://blog.csdn.net/z69183787/article/details/8097573#)
- // by FileUtils    
...
IOUtils.writeLines(lines, null, new FileOutputStream(file));
```
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/8097573#)[copy](http://blog.csdn.net/z69183787/article/details/8097573#)[print](http://blog.csdn.net/z69183787/article/details/8097573#)[?](http://blog.csdn.net/z69183787/article/details/8097573#)
- publicclass IoTest {    
- 
- /** 
-      * @param args 
