# 轻量级分布式RPC框架实现 - 零度的博客专栏 - CSDN博客
2016年10月08日 17:29:23[零度anngle](https://me.csdn.net/zmx729618)阅读数：2656
...
相关 Maven 依赖请见附录。
# 第一步：编写服务接口
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/52680941#)[copy](http://blog.csdn.net/z69183787/article/details/52680941#)[print](http://blog.csdn.net/z69183787/article/details/52680941#)[?](http://blog.csdn.net/z69183787/article/details/52680941#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1903035/fork)
- <!-- lang: java -->  
...
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/52680941#)[copy](http://blog.csdn.net/z69183787/article/details/52680941#)[print](http://blog.csdn.net/z69183787/article/details/52680941#)[?](http://blog.csdn.net/z69183787/article/details/52680941#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1903035/fork)
- <span style="font-size:12px;"><!-- lang: java -->  
- # ZooKeeper 服务器  
- registry.address=127.0.0.1:2181
- 
- # RPC 服务器  
- server.address=127.0.0.1:8000</span>  
![](http://static.blog.csdn.net/images/save_snippets.png)
```java
<span style="font-size:12px;"><!-- lang: java -->
# ZooKeeper 服务器
...
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/52680941#)[copy](http://blog.csdn.net/z69183787/article/details/52680941#)[print](http://blog.csdn.net/z69183787/article/details/52680941#)[?](http://blog.csdn.net/z69183787/article/details/52680941#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1903035/fork)
- <!-- lang: java -->  
- publicclass RpcServer implements ApplicationContextAware, InitializingBean {  
- 
...
```
使用`RpcDecoder`提供 
 RPC 解码，只需扩展 Netty 的`ByteToMessageDecoder`抽象类的`decode`方法即可，代码如下：
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/52680941#)[copy](http://blog.csdn.net/z69183787/article/details/52680941#)[print](http://blog.csdn.net/z69183787/article/details/52680941#)[?](http://blog.csdn.net/z69183787/article/details/52680941#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1903035/fork)
- <span style="font-size:12px;"><!-- lang: java -->  
- publicclass RpcDecoder extends ByteToMessageDecoder {  
- 
...
- 
- @Override
- publicvoid decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {  
...
```
使用`RpcEncoder`提供 
 RPC 编码，只需扩展 Netty 的`MessageToByteEncoder`抽象类的`encode`方法即可，代码如下：
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/52680941#)[copy](http://blog.csdn.net/z69183787/article/details/52680941#)[print](http://blog.csdn.net/z69183787/article/details/52680941#)[?](http://blog.csdn.net/z69183787/article/details/52680941#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1903035/fork)
- <span style="font-size:12px;"><!-- lang: java -->  
...
- 
- @Override
- publicvoid encode(ChannelHandlerContext ctx, Object in, ByteBuf out) throws Exception {  
...
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/52680941#)[copy](http://blog.csdn.net/z69183787/article/details/52680941#)[print](http://blog.csdn.net/z69183787/article/details/52680941#)[?](http://blog.csdn.net/z69183787/article/details/52680941#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1903035/fork)
- !-- lang: java -->  
- publicclass RpcHandler extends SimpleChannelInboundHandler<RpcRequest> {  
- 
- privatestaticfinal Logger LOGGER = LoggerFactory.getLogger(RpcHandler.class);  
- 
- privatefinal Map<String, Object> handlerMap;  
- 
...
- 
- @Override
- publicvoid channelRead0(final ChannelHandlerContext ctx, RpcRequest request) throws Exception {  
...
- <span style="font-size:12px;"><!-- lang: java -->  
- # ZooKeeper 服务器  
- registry.address=127.0.0.1:2181</span>  
![](http://static.blog.csdn.net/images/save_snippets.png)
```java
<span style="font-size:12px;"><!-- lang: java -->
# ZooKeeper 服务器
...
```
使用`RpcClient`类实现 
 RPC 客户端，只需扩展 Netty 提供的`SimpleChannelInboundHandler`抽象类即可，代码如下：
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/52680941#)[copy](http://blog.csdn.net/z69183787/article/details/52680941#)[print](http://blog.csdn.net/z69183787/article/details/52680941#)[?](http://blog.csdn.net/z69183787/article/details/52680941#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1903035/fork)
- <span style="font-size:12px;"><!-- lang: java -->  
- publicclass RpcClient extends SimpleChannelInboundHandler<RpcResponse> {  
- 
...
- 
- @Override
- publicvoid channelRead0(ChannelHandlerContext ctx, RpcResponse response) throws Exception {  
...
# 附录：Maven 依赖
**[html]**[view plain](http://blog.csdn.net/z69183787/article/details/52680941#)[copy](http://blog.csdn.net/z69183787/article/details/52680941#)[print](http://blog.csdn.net/z69183787/article/details/52680941#)[?](http://blog.csdn.net/z69183787/article/details/52680941#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1903035/fork)
- <!-- lang: xml -->
- <!-- JUnit -->
- <dependency>
