# 通过反编译字节码来理解 Java Enum - 零度的博客专栏 - CSDN博客
2017年03月27日 10:18:07[零度anngle](https://me.csdn.net/zmx729618)阅读数：1030
枚举的声明很简单, 像 
```
enum
 Gender { Male, Female }
...
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/54140457#)[copy](http://blog.csdn.net/z69183787/article/details/54140457#)[print](http://blog.csdn.net/z69183787/article/details/54140457#)[?](http://blog.csdn.net/z69183787/article/details/54140457#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/2104360/fork)
- publicenum Gender {  
-     Male,  
-     Female  
- }  
...
- 9: areturn  
- 
- publicstatic Gender valueOf(java.lang.String);  
-     Code:  
...
-   }  
- 
- publicstatic Gender valueOf(String name) {  
...
- }  
- 
- publicenum Gender implements Behavior {  
-   Male {  
- @Override
- publicvoid print() {  
...
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/54140457#)[copy](http://blog.csdn.net/z69183787/article/details/54140457#)[print](http://blog.csdn.net/z69183787/article/details/54140457#)[?](http://blog.csdn.net/z69183787/article/details/54140457#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/2104360/fork)
- finalclass Gender$1extends Gender {  
