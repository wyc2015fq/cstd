# Java NIO使用及原理分析(一) - 零度的博客专栏 - CSDN博客
2016年07月08日 16:15:34[零度anngle](https://me.csdn.net/zmx729618)阅读数：398
...
**[java]**[view plain](http://blog.csdn.net/wuxianglong/article/details/6604817#)[copy](http://blog.csdn.net/wuxianglong/article/details/6604817#)[print](http://blog.csdn.net/wuxianglong/article/details/6604817#)[?](http://blog.csdn.net/wuxianglong/article/details/6604817#)
- import java.nio.IntBuffer;  
- 
- publicclass TestIntBuffer {  
...
[]()
```java
<span style="font-family:Arial;font-size:12px;">import java.nio.IntBuffer;
...
```
运行后可以看到：
![](http://hi.csdn.net/attachment/201107/17/0_1310888350Ypu6.gif)
...
- 
- publicclass Program {  
- staticprivatefinalbyte message[] = { 83, 111, 109, 101, 32,  
