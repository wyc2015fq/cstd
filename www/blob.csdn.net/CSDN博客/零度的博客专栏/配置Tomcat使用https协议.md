# 配置Tomcat使用https协议 - 零度的博客专栏 - CSDN博客
2017年10月17日 09:38:18[零度anngle](https://me.csdn.net/zmx729618)阅读数：1227
...
以上命令将生产一对非对称密钥和自我签名的证书：g:\tomcat.keystore
...
一切搞定。
可能遇到的问题：修改了server.xml的配置后，启动tomcat有可能报错
```
1
