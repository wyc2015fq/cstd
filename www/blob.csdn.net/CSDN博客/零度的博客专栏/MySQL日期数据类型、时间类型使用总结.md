# MySQL日期数据类型、时间类型使用总结 - 零度的博客专栏 - CSDN博客
2016年09月29日 11:16:29[零度anngle](https://me.csdn.net/zmx729618)阅读数：267标签：[mysql																[日期格式数据处理](https://so.csdn.net/so/search/s.do?q=日期格式数据处理&t=blog)](https://so.csdn.net/so/search/s.do?q=mysql&t=blog)
