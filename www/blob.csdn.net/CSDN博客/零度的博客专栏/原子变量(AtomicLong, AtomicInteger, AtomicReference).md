# 原子变量(AtomicLong, AtomicInteger, AtomicReference) - 零度的博客专栏 - CSDN博客
2016年10月10日 11:01:58[零度anngle](https://me.csdn.net/zmx729618)阅读数：337
...
Java代码： 
```
<span style="font-family:Arial;font-size:12px;">package zmx.atomic.test;
