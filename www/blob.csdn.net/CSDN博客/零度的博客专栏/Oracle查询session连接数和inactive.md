# Oracle查询session连接数和inactive - 零度的博客专栏 - CSDN博客
2016年04月28日 10:28:17[零度anngle](https://me.csdn.net/zmx729618)阅读数：2159
...
2.查询那些应用的连接数此时是多少 
select  b.MACHINE, b.PROGRAM , count(*) from v$process a, v$session b where a.ADDR = b.PADDR and  b.USERNAME is not null   group by  b.MACHINE  , b.PROGRAM order
 by count(*) desc; 
3.查询是否有死锁 
