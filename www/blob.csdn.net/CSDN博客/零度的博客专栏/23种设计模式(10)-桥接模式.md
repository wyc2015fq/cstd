# 23种设计模式(10)-桥接模式 - 零度的博客专栏 - CSDN博客
2017年07月13日 11:44:48[零度anngle](https://me.csdn.net/zmx729618)阅读数：167标签：[设计模式																[桥接模式](https://so.csdn.net/so/search/s.do?q=桥接模式&t=blog)](https://so.csdn.net/so/search/s.do?q=设计模式&t=blog)
...
**二、结构**
图-桥接模式结构图 
![这里写图片描述](https://img-blog.csdn.net/20160130173210034)
**三、具体案例**
本案例是实现汽车安装引擎的功能 
