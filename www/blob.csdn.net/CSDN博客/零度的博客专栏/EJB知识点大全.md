# EJB知识点大全 - 零度的博客专栏 - CSDN博客
2016年07月05日 09:31:34[零度anngle](https://me.csdn.net/zmx729618)阅读数：587标签：[企业级																[应用																[ejb](https://so.csdn.net/so/search/s.do?q=ejb&t=blog)](https://so.csdn.net/so/search/s.do?q=应用&t=blog)](https://so.csdn.net/so/search/s.do?q=企业级&t=blog)
个人分类：[EJB](https://blog.csdn.net/zmx729618/article/category/6295981)
Chapter01 企业级开发背景知识
...
EJB发布为Web服务，从而实现SOA。
十、[Java EE](http://lib.csdn.net/base/17)相关知识
  (1) Java EE是一个标准；
...
EJB3.0使用了[Java SE](http://lib.csdn.net/base/12)
 5.0 中的注释新特性，只要在方法上写EJB规范的注释，就可以不用来写标准的部署表述，ejb-jar.xml这个要放到jar文件的mate-inf文件夹里。
