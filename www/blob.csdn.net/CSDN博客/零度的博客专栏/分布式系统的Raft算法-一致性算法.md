# 分布式系统的Raft算法-一致性算法 - 零度的博客专栏 - CSDN博客
2018年10月25日 10:52:03[零度anngle](https://me.csdn.net/zmx729618)阅读数：199
原文出处：[https://www.jdon.com/artichect/raft.html](https://www.jdon.com/artichect/raft.html)
...
![](https://www.jdon.com/simgs/idea/raft1.png)
2. 其他服务器同意了，发出OK。
![](https://www.jdon.com/simgs/idea/raft2.png)
...
![](https://www.jdon.com/simgs/idea/raft3.png)
4. 以后通过心跳进行日志复制的通知
![](https://www.jdon.com/simgs/idea/raft4.png)
5. 如果一旦这个Leader当机崩溃了，那么Follower中有一个成为候选者，发出邀票选举。
![](https://www.jdon.com/simgs/idea/raft5.png)
6. Follower同意后，其成为Leader，继续承担日志复制等指导工作：
![](https://www.jdon.com/simgs/idea/raft6.png)
值得注意的是，整个选举过程是有一个时间限制的，如下图：
![](https://www.jdon.com/simgs/idea/raft7.png)
...
![](https://www.jdon.com/simgs/idea/raft8.png)
2. Leader要求Followe遵从他的指令，都将这个新的日志内容追加到他们各自日志中：
![](https://www.jdon.com/simgs/idea/raft9.png)
3.大多数follower服务器将日志写入磁盘文件后，确认追加成功，发出Commited Ok:
![](https://www.jdon.com/simgs/idea/raft10.png)
...
总结：目前几乎所有语言都已经有支持Raft算法的库包，具体可参考：[raftconsensus.github.io](http://raftconsensus.github.io/)
