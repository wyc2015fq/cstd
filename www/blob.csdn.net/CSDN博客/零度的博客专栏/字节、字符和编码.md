# 字节、字符和编码 - 零度的博客专栏 - CSDN博客
2016年06月12日 10:52:33[零度anngle](https://me.csdn.net/zmx729618)阅读数：352
...
在 Tomcat 服务器中，request.getParameter() 得到乱码时，常常是因为前面提到的“误解一”造成的。默认情况下，当提交 "%D6%D0" 给 Tomcat 服务器时，request.getParameter() 将返回 [0x00D6, 0x00D0] 两个 UNICODE 字符，而不是返回一个 "中" 字符。因此，我们需要使用 bytes = string.getBytes("iso-8859-1") 得到原始的字节串，再用
