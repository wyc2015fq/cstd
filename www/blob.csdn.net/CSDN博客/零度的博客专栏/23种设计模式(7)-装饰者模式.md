# 23种设计模式(7)-装饰者模式 - 零度的博客专栏 - CSDN博客
2017年07月12日 11:41:00[零度anngle](https://me.csdn.net/zmx729618)阅读数：229
**装饰模式**
        一、概述 
        二、装饰模式的结构 
        三、具体案列 
...
**二、装饰模式的结构**
　　装饰模式的类图如下：
![这里写图片描述](https://img-blog.csdn.net/20160129181831723)
　　在装饰模式中的角色有： 
 ...
 *
 */
public class Diaosi implements Programmer {
    @Override
    public void programme() {
...
public class Client {
    public static void main(String[] args) {
        //创建构件对象：屌丝 ->他是一个具体的程序员 
        //但是现在他只有编程能力  那怎么行
        //必须赋予他更大的能力  不然怎么赚大钱!
        //所以 上帝给他装饰了一番  瞬间提神了他的B格
        Programmer programmer=new Diaosi();
        ...
        Derector achitect1=new SoftwareArchitect(   new  Hacker(new Diaosi() ) );
        achitect1.programme();
    }
}
```
