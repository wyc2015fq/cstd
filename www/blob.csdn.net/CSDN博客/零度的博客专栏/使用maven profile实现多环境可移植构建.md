# 使用maven profile实现多环境可移植构建 - 零度的博客专栏 - CSDN博客
2017年02月28日 16:21:50[零度anngle](https://me.csdn.net/zmx729618)阅读数：322标签：[maven																[移植](https://so.csdn.net/so/search/s.do?q=移植&t=blog)](https://so.csdn.net/so/search/s.do?q=maven&t=blog)
