# Servlet 3.0新特性概览与开发详解 - 零度的博客专栏 - CSDN博客
2017年01月12日 11:44:33[零度anngle](https://me.csdn.net/zmx729618)阅读数：348
...
5. 文件上传API简化；
tomcat 7.0.X 以后支持Servlet 3.0
# 一、Annotation支持 
## 1.Servlet 
原本Servlet开发完后，必须在web.xml中配置如下代码：
**[html]**[view plain](http://blog.csdn.net/xiazdong/article/details/7208316#)[copy](http://blog.csdn.net/xiazdong/article/details/7208316#)[print](http://blog.csdn.net/xiazdong/article/details/7208316#)[?](http://blog.csdn.net/xiazdong/article/details/7208316#)
- <servlet>
...
代码示例： 
实现一个最简单的Servlet。 
**[java]**[view plain](http://blog.csdn.net/xiazdong/article/details/7208316#)[copy](http://blog.csdn.net/xiazdong/article/details/7208316#)[print](http://blog.csdn.net/xiazdong/article/details/7208316#)[?](http://blog.csdn.net/xiazdong/article/details/7208316#)
- package org.servlet;  
- import java.io.*;  
...
```
现在只需要在java源文件的Filter类前面加上 @WebFilter(filterName="",urlPattern={"/"});
# 3.Listener 
原本在web.xml中配置如下： 
**[html]**[view plain](http://blog.csdn.net/xiazdong/article/details/7208316#)[copy](http://blog.csdn.net/xiazdong/article/details/7208316#)[print](http://blog.csdn.net/xiazdong/article/details/7208316#)[?](http://blog.csdn.net/xiazdong/article/details/7208316#)
- <listener>
...
- import java.sql.*;  
- import javax.naming.*;  
- publicclass FirstListener implements ServletRequestListener{  
...
- <Ahref="http://java.sun.com/xml/ns/javaee/web-app_3_0.xsd"">http://java.sun.com/xml/ns/javaee/web-app_3_0.xsd"
- version="3.0">
...
- import java.sql.*;  
- import javax.naming.*;  
- publicclass SecondListener implements ServletRequestListener{  
- publicvoid requestInitialized(ServletRequestEvent event){  
...
随便访问一个web应用，然后发现 tomcat控制台输出： 看出先加载FirstListener，再加载SecondListener；
# 三、Servlet 异步处理
...
- publicclass AsyncServlet extends HttpServlet{  
- publicvoid service(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException{    
-               request.setCharacterEncoding("GBK");  
...
- import javax.naming.*;  
- import java.io.*;  
- publicclass MyListener implements AsyncListener{  
- publicvoid onStartAsync(AsyncEvent event)throws IOException{}  
- publicvoid onComplete(AsyncEvent event){  
-               System.out.println("-----------------------Complete");  
-       }  
- publicvoid onTimeout(AsyncEvent event){  
-        }  
- publicvoid onError(AsyncEvent event){}  
- }  
![](http://static.blog.csdn.net/images/save_snippets.png)
```java
package org.listener;
...
-  */
- import javax.servlet.http.*;  
- publicclass UploadUtil{  
- publicstatic String getFileType(Part p){  
...
- return type;  
-        }  
- publicstatic String getFileName(Part p){  
-               String name = p.getHeader("content-disposition");  
-               String fileNameTmp = name.substring(name.indexOf("filename=")+10);  
