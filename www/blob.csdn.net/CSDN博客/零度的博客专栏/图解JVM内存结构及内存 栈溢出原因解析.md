# 图解JVM内存结构及内存/栈溢出原因解析 - 零度的博客专栏 - CSDN博客
2017年09月04日 11:17:24[零度anngle](https://me.csdn.net/zmx729618)阅读数：534
# 一、背景知识
## 1、JVM体系结构
...
示例代码：
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/75530650#)[copy](http://blog.csdn.net/z69183787/article/details/75530650#)[print](http://blog.csdn.net/z69183787/article/details/75530650#)[?](http://blog.csdn.net/z69183787/article/details/75530650#)
- package com.jvm;  
- 
...
-  */
- publicclass OOMTest_1 {  
- publicstaticvoid main(String args[]){  
-         List<byte[]> byteList = new ArrayList<byte[]>();  
-         byteList.add(newbyte[1000 * 1024 * 1024]);  
-     }  
- }  
```java
package com.jvm;
...
- publicclass SOFTest {  
- 
- publicvoid stackOverFlowMethod(){  
-         stackOverFlowMethod();  
-     }  
- 
- /**
