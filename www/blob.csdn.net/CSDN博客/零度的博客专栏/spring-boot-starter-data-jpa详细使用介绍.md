# spring-boot-starter-data-jpa详细使用介绍 - 零度的博客专栏 - CSDN博客
2018年06月22日 11:59:21[零度anngle](https://me.csdn.net/zmx729618)阅读数：3337
原文出处：http://www.ityouknow.com/springboot/2016/08/20/spring-boo-jpa.html
### 首先了解JPA是什么？
...
public void testBaseQuery() throws Exception {
	...
	userRepository.findOne(l);
	userRepository.save(user);
	userRepository.delete(user);
	userRepository.count();
	userRepository.exists(l);
	// ...
}
```
就不解释了根据方法名就看出意思来
...
使用
```
Page<HotelSummary> hotels = this.hotelRepository.findByCity(new PageRequest(, , Direction.ASC, "name"));
