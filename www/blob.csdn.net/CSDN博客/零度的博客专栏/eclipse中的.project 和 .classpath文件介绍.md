# eclipse中的.project 和 .classpath文件介绍 - 零度的博客专栏 - CSDN博客
2016年06月03日 15:19:45[零度anngle](https://me.csdn.net/zmx729618)阅读数：343
...
        这些文件你用文本编辑器就能察看,在一个项目中,点刷新的目的是为了更新.project文件中的文件清单，让你把不通过eclipse提交到项目的文件显示出来。
#### .classpath 文件
