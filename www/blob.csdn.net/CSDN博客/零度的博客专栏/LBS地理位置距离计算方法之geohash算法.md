# LBS地理位置距离计算方法之geohash算法 - 零度的博客专栏 - CSDN博客
2016年11月09日 10:26:49[零度anngle](https://me.csdn.net/zmx729618)阅读数：4916
...
某些情况下无法在两列上同时应用索引 （例如[MySQL](http://lib.csdn.net/base/14) 4之前的版本，Google App Engine的数据层等），利用geohash，只需在一列上应用索引即可。
...
- 
例如: 假设我的数据库里存储着1亿条包含经纬度的用户数据，用iPhone/[Android](http://lib.csdn.net/base/15)手机定位得到 新浪总部(理想国际大厦)的经纬度:
 39.98123848, 116.30683690 然后去数据库查找附近的妞 
```
