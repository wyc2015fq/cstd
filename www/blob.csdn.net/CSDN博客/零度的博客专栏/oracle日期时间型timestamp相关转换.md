# oracle日期时间型timestamp相关转换 - 零度的博客专栏 - CSDN博客
2016年04月27日 16:04:50[零度anngle](https://me.csdn.net/zmx729618)阅读数：18416
**1、获取系统时间的语句(ssxff6获取小数点后面六位)**select sysdate,systimestamp,to_char(systimestamp, 'yyyymmdd hh24:mi:ssxff6'),
