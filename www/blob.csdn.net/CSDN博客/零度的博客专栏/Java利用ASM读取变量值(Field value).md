# Java利用ASM读取变量值(Field value) - 零度的博客专栏 - CSDN博客
2016年05月05日 11:17:11[零度anngle](https://me.csdn.net/zmx729618)阅读数：2425
...
```
<span style="font-family:Arial;font-size:12px;">package zmx.reflect.test.asm;
...
然后编写读取类如下：
```
<span style="font-family:Arial;font-size:12px;">public static void main(String[] args){
