# java泛型详解 - 零度的博客专栏 - CSDN博客
2017年08月24日 10:47:57[零度anngle](https://me.csdn.net/zmx729618)阅读数：393标签：[java																[泛型](https://so.csdn.net/so/search/s.do?q=泛型&t=blog)](https://so.csdn.net/so/search/s.do?q=java&t=blog)
个人分类：[Java泛型](https://blog.csdn.net/zmx729618/article/category/6355064)
> 
        对java的泛型特性的了解仅限于表面的浅浅一层，直到在学习设计模式时发现有不了解的用法，才想起详细的记录一下。本文参考[java 泛型详解](http://www.cnblogs.com/sunwei2012/archive/2010/10/08/1845938.html)、[Java中的泛型方法](http://www.cnblogs.com/iyangyuan/archive/2013/04/09/3011274.html)、 [java泛型详解](http://blog.csdn.net/caihuangshi/article/details/51278793)
# 1. 概述
