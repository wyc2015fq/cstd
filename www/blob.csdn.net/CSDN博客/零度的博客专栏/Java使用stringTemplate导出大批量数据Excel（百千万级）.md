# Java使用stringTemplate导出大批量数据Excel（百千万级） - 零度的博客专栏 - CSDN博客
2016年05月05日 14:28:18[零度anngle](https://me.csdn.net/zmx729618)阅读数：2934
...
整理后的公用类：
```
package com.dianping.emidas.activity.excel.util;
import com.dianping.emidas.activity.excel.template.Row;
import com.dianping.emidas.activity.excel.template.Sample;
import com.dianping.emidas.activity.excel.template.Worksheet;
