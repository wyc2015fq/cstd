# Java绝对/相对路径获取与getResourceAsStream()方法 - 零度的博客专栏 - CSDN博客
2016年04月13日 16:38:57[零度anngle](https://me.csdn.net/zmx729618)阅读数：42057标签：[java路径](https://so.csdn.net/so/search/s.do?q=java路径&t=blog)
