# JVM:垃圾回收机制和调优手段 - 零度的博客专栏 - CSDN博客
2016年04月20日 09:49:23[零度anngle](https://me.csdn.net/zmx729618)阅读数：287
...
**由此我们JVM垃圾回收要扫描的范围是：**
![](https://img-blog.csdn.net/20160415001109091)
注：图片来自网络
**新生代：**
...
## 2.2 性能调优的手段
1.使用JDK提供的内存查看工具，如JConsole和Java
 VisualVM
2.控制堆内存各个部分所占的比例
3.采用合适的垃圾收集器
