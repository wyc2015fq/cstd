# java中的Unsafe - 零度的博客专栏 - CSDN博客
2016年10月10日 16:30:00[零度anngle](https://me.csdn.net/zmx729618)阅读数：318
个人分类：[原子变量](https://blog.csdn.net/zmx729618/article/category/6453114)
        在阅读AtomicInteger的源码时，看到了这个类：sum.msic.Unsafe，之前从没见过。所以花了点时间google了一下。Unsafe的源码：[http://www.docjar.com/html/api/sun/misc/Unsafe.java.html](http://www.docjar.com/html/api/sun/misc/Unsafe.java.html)[](http://www.docjar.com/html/api/sun/misc/Unsafe.java.html)[](http://www.docjar.com/html/api/sun/misc/Unsafe.java.html)
[Unsafe](http://www.docjar.com/html/api/sun/misc/Unsafe.java.html)源码中的描述如下：
...
        Unsafe类中还包含有很多其它的方法，如果想使用其中的方法，可以参考这篇文章来获取Unsafe的实例：[http://javafans.info/java/corejava/15.html](http://javafans.info/java/corejava/15.html)。原理是通过反射机制拿到Unsafe中的一个静态属性。
