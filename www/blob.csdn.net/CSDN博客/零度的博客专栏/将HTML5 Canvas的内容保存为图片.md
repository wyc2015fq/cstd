# 将HTML5 Canvas的内容保存为图片 - 零度的博客专栏 - CSDN博客
2017年09月19日 13:57:57[零度anngle](https://me.csdn.net/zmx729618)阅读数：5127
...
        借助Canvas自己的API：toDataURL()实现默认返回base64字节码。整个实现HTML + [JavaScript](http://lib.csdn.net/base/javascript)的代码很简单，代码如下：
**[html]**[view
