# React/React-Native的ES5 ES6写法对照表 - 零度的博客专栏 - CSDN博客
2017年12月26日 17:10:03[零度anngle](https://me.csdn.net/zmx729618)阅读数：307标签：[react-native																[ES6](https://so.csdn.net/so/search/s.do?q=ES6&t=blog)](https://so.csdn.net/so/search/s.do?q=react-native&t=blog)
个人分类：[React-native](https://blog.csdn.net/zmx729618/article/category/7364987)
原文出处：http://bbs.reactnative.cn/topic/15/react-react-native
...
```
然而现在官方已经不再打算在ES6里继续推行Mixin，他们说：[Mixins Are Dead. Long Live
 Composition](https://medium.com/@dan_abramov/mixins-are-dead-long-live-higher-order-components-94a0d2f9e750)。
