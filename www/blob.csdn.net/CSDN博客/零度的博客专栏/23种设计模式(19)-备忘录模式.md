# 23种设计模式(19)-备忘录模式 - 零度的博客专栏 - CSDN博客
2017年07月31日 09:53:25[零度anngle](https://me.csdn.net/zmx729618)阅读数：210
备忘录模式 
一、 概念 
二、 结构 
三、 分类 
...
**二、结构**
　备忘录模式的结构图如下所示 
![这里写图片描述](https://img-blog.csdn.net/20160206110151084)
...
下面给出一个示意性的“白箱实现”。
![这里写图片描述](https://img-blog.csdn.net/20160206110246182)
源代码
...
　　使用内部类实现备忘录模式的类图如下所示。 
![这里写图片描述](https://img-blog.csdn.net/20160210112055633)
...
![这里写图片描述](https://img-blog.csdn.net/20160210112314644)
源代码 
发起人角色源代码
```java
package Memento2;
...
　　“自述历史”模式的类图如下所示：
![这里写图片描述](https://img-blog.csdn.net/20160210112213103)
备忘录角色有如下责任： 
