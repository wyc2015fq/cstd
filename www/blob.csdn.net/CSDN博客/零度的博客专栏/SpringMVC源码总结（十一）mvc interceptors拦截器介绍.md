# SpringMVC源码总结（十一）mvc:interceptors拦截器介绍 - 零度的博客专栏 - CSDN博客
2017年02月27日 10:59:46[零度anngle](https://me.csdn.net/zmx729618)阅读数：622标签：[spring mvc](https://so.csdn.net/so/search/s.do?q=spring mvc&t=blog)
