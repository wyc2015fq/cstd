# Java日期转换使用Joda-Time工具 - 零度的博客专栏 - CSDN博客
2018年03月02日 10:10:24[零度anngle](https://me.csdn.net/zmx729618)阅读数：1422
...
```
但是
DateFormat 的所有实现，包括 SimpleDateFormat 都不是线程安全的，因此你不应该在多线程序中使用，除非是在对外线程安全的环境中使用，如 将 SimpleDateFormat 限制在 ThreadLocal 中。如果你不这么做，在解析或者格式化日期的时候，可能会获取到一个不正确的结果。因此，从日期、时间处理的所有实践来说，我强力推荐使用joda-time 库。
### Joda-Time工具
主要的特点包括：
