# Pushlet实现消息从服务器端推送到客户端 - 零度的博客专栏 - CSDN博客
2016年07月18日 10:52:38[零度anngle](https://me.csdn.net/zmx729618)阅读数：1444
...
 String data="hello,world郭强"+System.*currentTimeMillis*();
**try**{
