# IntelliJ IDEA 12.0搭建Maven Web SSH2架构项目示例(二) - 零度的博客专栏 - CSDN博客
2016年08月08日 14:54:03[零度anngle](https://me.csdn.net/zmx729618)阅读数：1212标签：[intellij idea](https://so.csdn.net/so/search/s.do?q=intellij idea&t=blog)
...
- <version>1.0.0-SNAPSHOT</version><!--证明这是一个快照版本-->
- 
