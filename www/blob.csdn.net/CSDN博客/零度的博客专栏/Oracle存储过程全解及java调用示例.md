# Oracle存储过程全解及java调用示例 - 零度的博客专栏 - CSDN博客
2016年04月28日 15:36:43[零度anngle](https://me.csdn.net/zmx729618)阅读数：548
...
`      ``if total < 100``then`
`        ``update``d_dcsj``set``flag =``null``where`
```
flag
 = var_flag;
```
