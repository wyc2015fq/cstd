# Java弱引用(WeakReference)的理解与使用 - 零度的博客专栏 - CSDN博客
2017年01月05日 15:20:04[零度anngle](https://me.csdn.net/zmx729618)阅读数：33351标签：[java																[弱引用](https://so.csdn.net/so/search/s.do?q=弱引用&t=blog)](https://so.csdn.net/so/search/s.do?q=java&t=blog)
