# Redis的Java客户端Jedis的八种调用方式(事务、管道、分布式)介绍 - 零度的博客专栏 - CSDN博客
2016年09月27日 15:12:38[零度anngle](https://me.csdn.net/zmx729618)阅读数：266标签：[redis																[java](https://so.csdn.net/so/search/s.do?q=java&t=blog)](https://so.csdn.net/so/search/s.do?q=redis&t=blog)
