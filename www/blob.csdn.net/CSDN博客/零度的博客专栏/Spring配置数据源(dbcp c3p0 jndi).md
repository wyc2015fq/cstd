# Spring配置数据源(dbcp/c3p0/jndi) - 零度的博客专栏 - CSDN博客
2016年04月22日 13:40:34[零度anngle](https://me.csdn.net/zmx729618)阅读数：732
...
下面是使用DBCP配置[MySQL](http://lib.csdn.net/base/14)数据源的配置片断：
xml 代码
**[html]**[view
