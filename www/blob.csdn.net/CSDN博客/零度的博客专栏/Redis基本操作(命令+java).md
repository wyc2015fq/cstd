# Redis基本操作(命令+java) - 零度的博客专栏 - CSDN博客
2016年09月22日 16:39:30[零度anngle](https://me.csdn.net/zmx729618)阅读数：371标签：[redis																[java](https://so.csdn.net/so/search/s.do?q=java&t=blog)](https://so.csdn.net/so/search/s.do?q=redis&t=blog)
个人分类：[Redis](https://blog.csdn.net/zmx729618/article/category/6430276)
### 一、server端安装
　　1、 Redis下载：从官网[http://redis.io/](http://redis.io/)下载最新的redis,我下载的是[http://redis.googlecode.com/files/redis-2.6.14.tar.gz](http://redis.googlecode.com/files/redis-2.6.14.tar.gz)
              jedis下载：从[https://github.com/xetorthio/jedis/downloads下载jedis2.1.0](https://github.com/xetorthio/jedis/downloads%E4%B8%8B%E8%BD%BDjedis2.1.0) ，路径为：[https://github.com/downloads/xetorthio/jedis/jedis-2.1.0.jar](https://github.com/downloads/xetorthio/jedis/jedis-2.1.0.jar)
             下载windows平台文件：解压后，选择当前64位win7系统对应的版本
　　2、安装
...
配置文件各字段含义：[http://cardyn.iteye.com/blog/794194](http://cardyn.iteye.com/blog/794194)
...
　 参考：[http://blog.csdn.net/ithomer/article/details/9213185](http://blog.csdn.net/ithomer/article/details/9213185)
