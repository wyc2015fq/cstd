# Java观察者模式与事件驱动模式实例比较 - 零度的博客专栏 - CSDN博客
2017年05月24日 16:15:21[零度anngle](https://me.csdn.net/zmx729618)阅读数：3062
一、观察者模式所涉及的角色有：
...
二、[Java](http://lib.csdn.net/base/javase)事件驱动机制包括三个部分：事件、事件监听器、事件源。
