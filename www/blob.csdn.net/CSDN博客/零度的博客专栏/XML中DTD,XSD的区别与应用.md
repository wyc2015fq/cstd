# XML中DTD,XSD的区别与应用 - 零度的博客专栏 - CSDN博客
2016年05月09日 10:33:33[零度anngle](https://me.csdn.net/zmx729618)阅读数：391标签：[xsd																[xml																[可扩展																[语言](https://so.csdn.net/so/search/s.do?q=语言&t=blog)](https://so.csdn.net/so/search/s.do?q=可扩展&t=blog)](https://so.csdn.net/so/search/s.do?q=xml&t=blog)](https://so.csdn.net/so/search/s.do?q=xsd&t=blog)
