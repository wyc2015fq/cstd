# HttpServletRequest.getHeader() 详细说明 - 零度的博客专栏 - CSDN博客
2016年05月13日 17:26:33[零度anngle](https://me.csdn.net/zmx729618)阅读数：14592
1、JAVA 部分request.getHeader()详细说明
```
...
```
2、JSP部分 request.getHeader() 详细说明
```
