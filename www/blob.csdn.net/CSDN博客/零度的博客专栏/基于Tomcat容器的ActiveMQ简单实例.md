# 基于Tomcat容器的ActiveMQ简单实例 - 零度的博客专栏 - CSDN博客
2016年07月19日 10:07:37[零度anngle](https://me.csdn.net/zmx729618)阅读数：815
      在tomcat中配置ConnectionFactory和ActiveMQQueue,通过JNDI方式实现ActiveMQ。因为JNDI配置在tomcat容器中所以必须通过jsp访问tomcat容器。  
...
        在Tomcat的conf目录下的context.xml配置中添加如下(JNDI)：
Java代码  ![收藏代码](http://topmanopensource.iteye.com/images/icon_star.png)
