# BlockingQueue的基本原理 - 零度的博客专栏 - CSDN博客
2017年04月12日 10:44:10[零度anngle](https://me.csdn.net/zmx729618)阅读数：437标签：[java																[BlockingQueue](https://so.csdn.net/so/search/s.do?q=BlockingQueue&t=blog)](https://so.csdn.net/so/search/s.do?q=java&t=blog)
...
 在[Java](http://lib.csdn.net/base/javase)中，BlockingQueue是一个接口，它的实现类有ArrayBlockingQueue、DelayQueue、 LinkedBlockingDeque、LinkedBlockingQueue、PriorityBlockingQueue、SynchronousQueue等，它们的区别主要体现在存储结构上或对元素操作上的不同，但是对于take与put操作的原理，却是
