# JVM类加载器详解 - 零度的博客专栏 - CSDN博客
2017年11月23日 11:13:05[零度anngle](https://me.csdn.net/zmx729618)阅读数：167标签：[jvm																[classloader](https://so.csdn.net/so/search/s.do?q=classloader&t=blog)](https://so.csdn.net/so/search/s.do?q=jvm&t=blog)
...
下面来看一下简单的例子：
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/78297960#)[copy](http://blog.csdn.net/z69183787/article/details/78297960#)[print](http://blog.csdn.net/z69183787/article/details/78297960#)[?](http://blog.csdn.net/z69183787/article/details/78297960#)
...
- privatestaticfinallong serialVersionUID = 8627644427315706176L;  
- //打印数据
- @Override
...
-      * @throws Exception
-      */
- privatestaticvoid encodeAndDecode(InputStream is,OutputStream os) throws Exception{  
- int bytes = -1;  
