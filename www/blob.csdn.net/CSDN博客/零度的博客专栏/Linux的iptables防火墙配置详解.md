# Linux的iptables防火墙配置详解 - 零度的博客专栏 - CSDN博客
2017年09月13日 13:58:48[零度anngle](https://me.csdn.net/zmx729618)阅读数：539
高级讲述：[http://www.zsythink.net/archives/1199](http://www.zsythink.net/archives/1199)
iptables主要用来配置防火墙，具体的解释请参看上述高级讲述。其是一个需要特别谨慎设置的东西，万一服务器不在你身边，而你贸然设置导致无法SSH，那就等着傻眼吧。
1.首先介绍一下指令和相关配置文件
