# Android程序的反破解技术 - 零度的博客专栏 - CSDN博客
2016年05月23日 16:57:56[零度anngle](https://me.csdn.net/zmx729618)阅读数：461
个人分类：[Android](https://blog.csdn.net/zmx729618/article/category/6238076)
逆向[Android](http://lib.csdn.net/base/15)软件的步骤：首先是对其进行反编译，然后阅读反汇编代码，如果有必要还会对其进行动态调试，找到突破口后注入或直接修改反汇编代码，最后重新编译软件进行测试。整个过程可分为反编译、静态分析、动态调试、重编译等4个环节。反破解技术也是从这四个方面进行的。
...
**[java]**[view
 plain](http://blog.csdn.net/viviwen123/article/details/9117589#)[copy](http://blog.csdn.net/viviwen123/article/details/9117589#)
![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/104220/fork)
...
-     }  
- 
- publicstatic String getProp(Context context, String property) {  
- try {  
...
**[java]**[view
 plain](http://blog.csdn.net/viviwen123/article/details/9117589#)[copy](http://blog.csdn.net/viviwen123/article/details/9117589#)
![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/104220/fork)
- publicint getSignature(String packageName) {        
