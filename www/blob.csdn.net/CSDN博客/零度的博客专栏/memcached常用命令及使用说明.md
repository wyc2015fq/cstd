# memcached常用命令及使用说明 - 零度的博客专栏 - CSDN博客
2017年01月19日 16:33:19[零度anngle](https://me.csdn.net/zmx729618)阅读数：254
**1、启动Memcache 常用参数**
```
[]()
...
***3.8 stats**stats* 命令的功能正如其名：转储所连接的 memcached 实例的当前统计数据。在下例中，执行 stats 命令显示了关于当前 memcached 实例的信息：
```
[]()
STAT pid 22459                             进程ID
