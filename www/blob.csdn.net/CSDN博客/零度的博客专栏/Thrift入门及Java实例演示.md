# Thrift入门及Java实例演示 - 零度的博客专栏 - CSDN博客
2016年11月01日 15:17:21[零度anngle](https://me.csdn.net/zmx729618)阅读数：227标签：[thrift																[实例](https://so.csdn.net/so/search/s.do?q=实例&t=blog)](https://so.csdn.net/so/search/s.do?q=thrift&t=blog)
个人分类：[thrift](https://blog.csdn.net/zmx729618/article/category/6497823)
目录：- 概述
- 下载配置
- 基本概念- 数据类型
- 服务端编码基本步骤
...
异步客户端
[一]、概述
Thrift是一个软件框架，用来进行可扩展且跨语言的服务的开发。它结合了功能强大的软件堆栈和代码生成引擎，以构建在 C++, Java, [Python](http://lib.csdn.net/base/11), PHP, Ruby, Erlang, Perl, Haskell, C#, Cocoa, JavaScript, Node.js, Smalltalk, and OCaml 等等编程语言间无缝结合的、高效的服务。
...
**[html]**[view plain](http://blog.csdn.net/z69183787/article/details/51333001#)[copy](http://blog.csdn.net/z69183787/article/details/51333001#)[print](http://blog.csdn.net/z69183787/article/details/51333001#)[?](http://blog.csdn.net/z69183787/article/details/51333001#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1695093/fork)
- <dependency>
...
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/51333001#)[copy](http://blog.csdn.net/z69183787/article/details/51333001#)[print](http://blog.csdn.net/z69183787/article/details/51333001#)[?](http://blog.csdn.net/z69183787/article/details/51333001#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/1695093/fork)
...
-  *
-  */
- publicclass HelloWorldImpl implements HelloWorldService.Iface {  
- 
...
-  *
-  */
- publicclass HelloServerDemo {  
- publicstaticfinalint SERVER_PORT = 8090;  
- 
...
-  *
-  */
- publicclass HelloClientDemo {  
- 
- publicstaticfinal String SERVER_IP = "localhost";  
- publicstaticfinalint SERVER_PORT = 8090;  
- publicstaticfinalint TIMEOUT = 30000;  
- 
- /**
-      *
-      * @param userName
...
-  *
-  */
- publicclass HelloAsynClientDemo {  
- 
- publicstaticfinal String SERVER_IP = "localhost";  
- publicstaticfinalint SERVER_PORT = 8090;  
- publicstaticfinalint TIMEOUT = 30000;  
