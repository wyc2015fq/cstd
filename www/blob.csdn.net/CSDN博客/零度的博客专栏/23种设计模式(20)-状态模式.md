# 23种设计模式(20)-状态模式 - 零度的博客专栏 - CSDN博客
2017年07月31日 10:28:46[零度anngle](https://me.csdn.net/zmx729618)阅读数：241标签：[设计模式																[状态模式](https://so.csdn.net/so/search/s.do?q=状态模式&t=blog)](https://so.csdn.net/so/search/s.do?q=设计模式&t=blog)
...
![这里写图片描述](https://img-blog.csdn.net/20160210160649264)
状态模式所涉及到的角色有： 
...
public class Context {
    ...
    public void request(String sampleParameter) {
        //转调state来处理        state.handle(sampleParameter);
    }
}
```
抽象状态类
...
public class Client {
    public static void main(String[] args){
        ...
        //将状态设置到环境中        context.setState(state);
        //请求
...
![这里写图片描述](https://img-blog.csdn.net/20160210160856824)
源代码：
抽象状态类
```java
package state;
...
**四、认识状态模式**
●**状态和行为**
　　所谓对象的状态，通常指的就是**对象实例的属性的值**；而**行为指的就是对象的功能**，再具体点说，行为大多可以对应到方法上。
...
![这里写图片描述](https://img-blog.csdn.net/20160210160546854)
而平等性强调的是可替换性，大家是同一行为的不同描述或实现，因此在同一个行为发生的时候，可以根据条件挑选任意一个实现来进行相应的处理。
![这里写图片描述](https://img-blog.csdn.net/20160210160610935)
