# Java之重写equals()和hashCode() - 零度的博客专栏 - CSDN博客
2016年06月30日 09:40:59[零度anngle](https://me.csdn.net/zmx729618)阅读数：359标签：[java																[equals																[hashcode](https://so.csdn.net/so/search/s.do?q=hashcode&t=blog)](https://so.csdn.net/so/search/s.do?q=equals&t=blog)](https://so.csdn.net/so/search/s.do?q=java&t=blog)
