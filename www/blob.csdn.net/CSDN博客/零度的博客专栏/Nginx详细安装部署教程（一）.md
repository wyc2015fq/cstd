# Nginx详细安装部署教程（一） - 零度的博客专栏 - CSDN博客
2017年10月20日 15:59:23[零度anngle](https://me.csdn.net/zmx729618)阅读数：521
**一、Nginx简介**
Nginx是一个web服务器也可以用来做负载均衡及反向代理使用，目前使用最多的就是负载均衡，具体简介我就不介绍了百度一下有很多，下面直接进入安装步骤
**二、Nginx安装**
**1、下载Nginx及相关组件**
Linux系统是Centos 6.5 64位，我直接切换到root用户下安装
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418152744852-939208787.png)
进入用户目录下载程序
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418153003446-820207739.png)
下载相关组件
```
...
**3、启动Nginx**
先找一下nginx安装到什么位置上了
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418154742915-713647057.png)
进入nginx目录并启动
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418154804759-1842869219.png)
...
```
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418162004024-2058687645.png)
进入Linux系统的图形界面，打开浏览器输入localhost会看到下图，说明nginx启动成功
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418162145790-461736932.png)
nginx的基本操作
```
启动
...
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418164812196-1164065507.png)
简单介绍一下vim的语法
```
...
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418173628696-1685332558.png)
分别使用不同的端口80、81、82保存退出并且重启nginx
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418174444118-588824024.png)
**5、开启外网访问**
...
```
下面是防火墙的其他操作命令
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418175910868-1921833075.png)
...
```
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418180736931-1955851185.png)
...
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418174908977-27238342.png)
正确指向后在telnet一下80端口看一下是否可以与端口通信（如果telnet提示没有此命令是没有安装客户端，在启用或禁用windows功能处安装后再操作即可）
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418175445712-2089843604.png)
得到以下界面及代表通信成功
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418175512790-352719306.png)
打开这台Windows系统内的浏览器，输入nginx.test.com会得到以下结果，就说明外网访问成功
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418181546415-521855633.png)
如果防火墙你依然启用，只是设置了启用端口，那我们访问81那个端口会发现无法访问，因为我并没有加入白名单
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170418181649259-174579881.png)
到此Nginx服务器雏形部署完成。
**6、Nginx负载均衡配置**
...
```
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170419164359634-2043724986.png)
...
```
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170419165116649-972950787.png)
配置一下Windows的host将我们要访问的域名aaa.test.com指向Linux
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170419170949509-1331178335.png)
因为硬件有限，我是将Windows中的IIS作为Nginx的后端服务器，所以配置一下IIS的站点域名
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170419171121993-488143433.png)
打开cmd再ping一下aaa.test.com确实指向Linux系统了，再打开浏览器输入aaa.test.com会显示bbb这个站点就代表负载成功了。
![](http://images2015.cnblogs.com/blog/172889/201704/172889-20170419171408649-130031505.png)
