# Spring分布式事务实现 - 零度的博客专栏 - CSDN博客
2016年04月07日 14:31:20[零度anngle](https://me.csdn.net/zmx729618)阅读数：453
个人分类：[JTA](https://blog.csdn.net/zmx729618/article/category/6169359)
...
GenericDao接口：
**[java]**[view
 plain](http://blog.csdn.net/ithomer/article/details/10859235#)[copy](http://blog.csdn.net/ithomer/article/details/10859235#)[print](http://blog.csdn.net/ithomer/article/details/10859235#)[?](http://blog.csdn.net/ithomer/article/details/10859235#)
- publicinterface GenericDao {  
- publicint save(String ds, String sql, Object[] obj) throws Exception;    
- publicint findRowCount(String ds, String sql);   
- }  
GenericDaoImpl 实现：
**[java]**[view
 plain](http://blog.csdn.net/ithomer/article/details/10859235#)[copy](http://blog.csdn.net/ithomer/article/details/10859235#)[print](http://blog.csdn.net/ithomer/article/details/10859235#)[?](http://blog.csdn.net/ithomer/article/details/10859235#)
- publicclass GenericDaoImpl implements GenericDao{  
- 
- private  JdbcTemplate jdbcTemplateA;  
- private  JdbcTemplate jdbcTemplateB;  
- 
- publicvoid setJdbcTemplateA(JdbcTemplate jdbcTemplate) {  
- this.jdbcTemplateA = jdbcTemplate;  
-     }  
- 
- publicvoid setJdbcTemplateB(JdbcTemplate jdbcTemplate) {  
...
-         }catch(Exception e){  
-             e.printStackTrace();  
- thrownew Exception("执行" + ds + "数据库时失败！");  
-         }  
-     }  
- 
- publicint findRowCount(String ds, String sql) {  
...
- 
- publicvoid setGenericDao(GenericDao genericDao) {  
...
**[java]**[view
 plain](http://blog.csdn.net/ithomer/article/details/10859235#)[copy](http://blog.csdn.net/ithomer/article/details/10859235#)[print](http://blog.csdn.net/ithomer/article/details/10859235#)[?](http://blog.csdn.net/ithomer/article/details/10859235#)
- publicclass TestUserService{  
- 
- privatestatic UserService userService;  
- 
- @BeforeClass
