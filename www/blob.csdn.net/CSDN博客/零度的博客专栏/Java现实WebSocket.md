# Java现实WebSocket - 零度的博客专栏 - CSDN博客
2016年08月11日 09:31:53[零度anngle](https://me.csdn.net/zmx729618)阅读数：981
**前言**
...
        所有新的技术都会第一时间在Java社区，出现对应的开源项目！WebSocket也被实现在多种Java的开源库中。WebSocket实现列表：[https://java.net/projects/websocket-spec/pages/WebSocketAPIs/text](https://java.net/projects/websocket-spec/pages/WebSocketAPIs/text)。今天就让我们用Java来解密一下WebSocket的服务器端和客户端
 实现。
**目录**
- 服务器端实现(Tomcat)
...
通过Java实现websocket的客户端，这里将介绍的是”Java-WebSocket”。另外，我发现Java7已经原生支持了websocket, “[JSR 365, Java API for WebSocket](http://www.oracle.com/technetwork/articles/java/jsr356-1937161.html)”
