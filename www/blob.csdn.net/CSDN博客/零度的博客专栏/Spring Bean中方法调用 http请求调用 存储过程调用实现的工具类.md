# Spring Bean中方法调用/http请求调用/存储过程调用实现的工具类 - 零度的博客专栏 - CSDN博客
2016年05月11日 16:25:32[零度anngle](https://me.csdn.net/zmx729618)阅读数：621
个人分类：[JavaUtil工具类](https://blog.csdn.net/zmx729618/article/category/6177525)
版权声明：本文为博主原创文章，未经博主允许不得转载。
**[java]**[view plain](http://blog.csdn.net/z69183787/article/details/38380905#)[copy](http://blog.csdn.net/z69183787/article/details/38380905#)[print](http://blog.csdn.net/z69183787/article/details/38380905#)[?](http://blog.csdn.net/z69183787/article/details/38380905#)
- /**
...
-     * @throws 
-     */
- publicstatic String nativeExec(TScheduleConfig t) {  
...
-     * @throws 
-     */
- publicstatic String webExec(TScheduleConfig t) {  
-         String method = t.getMethod();  
-         String param = t.getParam();  
-         String result = "";  
- try {  
...
- publicstatic String procedureExec(TScheduleConfig t) {  
...
-     */
- @SuppressWarnings("unchecked")  
- publicstatic List<Map<String, Object>> procedureExec2(TScheduleConfig t) {  
-         String datasource = "";  
- final String method = t.getMethod();  
- final String param = t.getParam();  
-         JdbcTemplate jdbcTemplate = DbUtil.getJdbcTemplate(datasource);  
