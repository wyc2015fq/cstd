# JAVA中获取文件的MD5值的几种方法 - 零度的博客专栏 - CSDN博客
2018年03月02日 15:54:51[零度anngle](https://me.csdn.net/zmx729618)阅读数：505
原文出处：[http://blog.csdn.net/sike_java/article/details/78538762](http://blog.csdn.net/sike_java/article/details/78538762)
...
　　方法四应该是最便捷的吧，哈哈，好东西要留在最后，如果你只需要使用标准的MD5，其实一行代码就够了，使用Apache的commons-codec包就提供了获取16进制MD5值的方法。其底层实现上，也是分多次将一个文件读入，类似方法三。所以性能上也不错。
