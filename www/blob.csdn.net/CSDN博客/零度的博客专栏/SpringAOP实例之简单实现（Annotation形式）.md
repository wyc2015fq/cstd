# SpringAOP实例之简单实现（Annotation形式） - 零度的博客专栏 - CSDN博客
2016年04月21日 10:26:12[零度anngle](https://me.csdn.net/zmx729618)阅读数：14186
...
```
`<span style="font-size:12px;">     该切面就是一个POJO，可以在该切面中进行切入点及通知定义，接着往下看吧。</span>`
### 3  声明切入点
