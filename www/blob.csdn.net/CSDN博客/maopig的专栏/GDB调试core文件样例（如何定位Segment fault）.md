# GDB调试core文件样例（如何定位Segment fault） - maopig的专栏 - CSDN博客
2017年06月21日 21:28:06[maopig](https://me.csdn.net/maopig)阅读数：1039
# [](http://blog.csdn.net/ithomer/article/details/5945152)
core dump又叫核心转储, 当程序运行过程中发生异常, 程序异常退出时, 由[操作系统](http://lib.csdn.net/base/operatingsystem)把程序当前的内存状况存储在一个core文件中,
 叫core dump. ([Linux](http://lib.csdn.net/base/linux)中如果内存越界会收到SIGSEGV信号，然后就会core dump)
...
# gdb test core.5581
GNU gdb Red Hat [linux](http://lib.csdn.net/base/linux) (6.3.0.0-1.132.EL4rh)
...
#0  0x000000000040048b in main () at test.c:6
2. 栈溢出。
有关栈溢出的程序，请参见：一个[测试](http://lib.csdn.net/base/softwaretest)栈大小的小程序
[http://blog.163.com/huang_bp/blog/static/12311983720099150746901/edit/](http://blog.163.com/huang_bp/blog/static/12311983720099150746901/edit/)
...
[http://www.upsdn.net/html/2006-11/775.html](http://www.upsdn.net/html/2006-11/775.html)
