# C语言中使用静态函数的好处 - maopig的专栏 - CSDN博客
2011年08月25日 19:56:50[maopig](https://me.csdn.net/maopig)阅读数：5926
...
2).全局
  全局变量本身就是静态存储方式， 静态全局变量当然也是静态存储方式。但是他们的作用域，非静态全局 变量的作用域是整个源程序（多个源文件可以共同使用）；
