# 对X264/FFMPEG架构探讨---感觉不错 - maopig的专栏 - CSDN博客
2011年07月16日 10:18:41[maopig](https://me.csdn.net/maopig)阅读数：3445
3. FFMPEG架构分析
...
3. 写输出文件的各部分
重点关注一下step2和3，看看怎么利用前面分析的编解码器基类来实现多态。大概查看一下这段代码的关系，发现在FFMPEG里，可以用类图来表示大概的编解码**器组合。![](http://hi.csdn.net/attachment/201107/16/0_1310782640Yo22.gif)**
