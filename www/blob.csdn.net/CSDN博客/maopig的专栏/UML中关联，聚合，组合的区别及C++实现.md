# UML中关联，聚合，组合的区别及C++实现 - maopig的专栏 - CSDN博客
2012年05月13日 22:51:37[maopig](https://me.csdn.net/maopig)阅读数：1315标签：[uml																[c++																[class																[function																[文档																[mfc](https://so.csdn.net/so/search/s.do?q=mfc&t=blog)](https://so.csdn.net/so/search/s.do?q=文档&t=blog)](https://so.csdn.net/so/search/s.do?q=function&t=blog)](https://so.csdn.net/so/search/s.do?q=class&t=blog)](https://so.csdn.net/so/search/s.do?q=c++&t=blog)](https://so.csdn.net/so/search/s.do?q=uml&t=blog)
...
![](http://image.360doc.com/DownloadImg/16903/553244_1.jpg)
　　　　　图3.2 类的继承 
类的继承在C++中呈现为：
class B { }
　class A : public B{ }
...
![](http://image.360doc.com/DownloadImg/16903/553244_2.jpg)
...
![](http://image.360doc.com/DownloadImg/16903/553244_3.jpg)![](http://image.360doc.com/DownloadImg/16903/553244_4.jpg)
　　　　　　　　　　图3.4 聚合和组合 
