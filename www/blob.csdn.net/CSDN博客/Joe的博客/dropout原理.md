# dropout原理 - Joe的博客 - CSDN博客





2016年09月17日 20:26:57[Joe-Han](https://me.csdn.net/u010089444)阅读数：5917
...
原文地址:[http://blog.csdn.net/stdcoutzyx/article/details/49022443](http://blog.csdn.net/stdcoutzyx/article/details/49022443)
...
![这里写图片描述](https://img-blog.csdn.net/20160917202243696)
...
![这里写图片描述](https://img-blog.csdn.net/20160917202613792)
对应的公式变化如下如下：
- 没有dropout的神经网络 
![这里写图片描述](https://img-blog.csdn.net/20160917202649650)- 有dropout的神经网络 
![这里写图片描述](https://img-blog.csdn.net/20160917202715761)- 
测试层面

预测的时候，每一个单元的参数要预乘以p。 
![这里写图片描述](https://img-blog.csdn.net/20160917202747355)
## **论文中的其他技术点**
- 
防止过拟合的方法：
- 提前终止（当验证集上的效果变差的时候）
...
- 使用mente-carlo方法来做预测。即对每个样本根据dropout率先    - sample出来k个net，然后做预测，k越大，效果越好。
...
![这里写图片描述](https://img-blog.csdn.net/20160917204411471)
...
- 
dropout 
![这里写图片描述](https://img-blog.csdn.net/20160917204516252)- 
dropConnect

![这里写图片描述](https://img-blog.csdn.net/20160917203428576)
