# 从ffmpeg源代码分析如何解决ffmpeg编码的延迟问题 . - 建建的博客 - CSDN博客
2017年03月11日 22:30:12[纪建](https://me.csdn.net/u013898698)阅读数：808
...
    首先我使用的ffmpeg源代码版本是1.0.3，同时给出我的[测试](http://lib.csdn.net/base/softwaretest)代码，项目中的代码就不给出来了，我给个简单的玩具代码：
**[cpp]**[view
 plain](http://blog.csdn.net/ymsdu2004/article/details/8565822#)[copy](http://blog.csdn.net/ymsdu2004/article/details/8565822#)
...
-  */
- staticvoid video_encode_example(constchar *filename, int codec_id)  
- {  
-     AVCodec *codec;  
...
- }</SPAN>  
**[cpp]**[view
 plain](http://blog.csdn.net/mengyafei43/article/details/41744129#)[copy](http://blog.csdn.net/mengyafei43/article/details/41744129#)
![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/543018/fork)
- <span style="font-family:Courier New;">/**
-  * @file
-  * libavcodec API use example.
-  *
...
![](https://img-my.csdn.net/uploads/201302/02/1359806074_8903.png)
...
- elseif (avctx->me_method == ME_HEX)  
-         x4->params.analyse.i_me_method = X264_ME_HEX;  
- elseif (avctx->me_method == ME_UMH)  
-         x4->params.analyse.i_me_method = X264_ME_UMH;  
- elseif (avctx->me_method == ME_FULL)  
-         x4->params.analyse.i_me_method = X264_ME_ESA;  
- elseif (avctx->me_method == ME_TESA)  
...
**[cpp]**[view
 plain](http://blog.csdn.net/ymsdu2004/article/details/8565822#)[copy](http://blog.csdn.net/ymsdu2004/article/details/8565822#)
- <SPAN style="FONT-FAMILY: Courier New">int x264_param_default_preset( x264_param_t *param, constchar *preset, constchar *tune )  
- {  
...
**[cpp]**[view
 plain](http://blog.csdn.net/ymsdu2004/article/details/8565822#)[copy](http://blog.csdn.net/ymsdu2004/article/details/8565822#)
- <SPAN style="FONT-FAMILY: Courier New">staticint x264_param_apply_preset( x264_param_t *param, constchar *preset )  
- {  
- char *end;  
...
-         param->rc.i_lookahead = 0;  
-     }  
- elseif( !strcasecmp( preset, "veryfast" ) )  
-     {  
...
-     }  
- elseif( !strcasecmp( preset, "faster" ) )  
-     {  
-         param->analyse.b_mixed_references = 0;  
...
-     }  
- elseif( !strcasecmp( preset, "medium" ) )  
-     {  
- /* Default is medium */
-     }  
- elseif( !strcasecmp( preset, "slow" ) )  
-     {  
...
-     }  
- elseif( !strcasecmp( preset, "slower" ) )  
-     {  
-         param->analyse.i_me_method = X264_ME_UMH;  
...
-     }  
- elseif( !strcasecmp( preset, "veryslow" ) )  
-     {  
-         param->analyse.i_me_method = X264_ME_UMH;  
...
-         param->rc.i_lookahead = 60;  
-     }  
- elseif( !strcasecmp( preset, "placebo" ) )  
-     {  
...
**[cpp]**[view
 plain](http://blog.csdn.net/ymsdu2004/article/details/8565822#)[copy](http://blog.csdn.net/ymsdu2004/article/details/8565822#)
- <SPAN style="FONT-FAMILY: Courier New">staticint x264_param_apply_tune( x264_param_t *param, constchar *tune )  
- {  
...
-         }  
- elseif( !strncasecmp( s, "animation", 9 ) )  
-         {  
- if( psy_tuning_used++ ) goto psy_failure;  
...
-         }  
- elseif( !strncasecmp( s, "stillimage", 5 ) )  
-         {  
- if( psy_tuning_used++ ) goto psy_failure;  
...
-         }  
- elseif( !strncasecmp( s, "psnr", 4 ) )  
-         {  
- if( psy_tuning_used++ ) goto psy_failure;  
-             param->rc.i_aq_mode = X264_AQ_NONE;  
-             param->analyse.b_psy = 0;  
-         }  
- elseif( !strncasecmp( s, "ssim", 4 ) )  
-         {  
- if( psy_tuning_used++ ) goto psy_failure;  
-             param->rc.i_aq_mode = X264_AQ_AUTOVARIANCE;  
-             param->analyse.b_psy = 0;  
-         }  
- elseif( !strncasecmp( s, "fastdecode", 10 ) )  
-         {  
-             param->b_deblocking_filter = 0;  
-             param->b_cabac = 0;  
-             param->analyse.b_weighted_bipred = 0;  
-             param->analyse.i_weighted_pred = X264_WEIGHTP_NONE;  
-         }  
-         <SPAN style="COLOR: #ff6666">elseif( !strncasecmp( s, "zerolatency", 11 ) )  
-         {  
-             param->rc.i_lookahead = 0;  
...
**[cpp]**[view
 plain](http://blog.csdn.net/ymsdu2004/article/details/8565822#)[copy](http://blog.csdn.net/ymsdu2004/article/details/8565822#)
- <SPAN style="FONT-FAMILY: Courier New">typedefstruct X264Context {  
-     AVClass        *class;  
-     x264_param_t    params;  
-     x264_t         *enc;  
-     x264_picture_t  pic;  
...
![](https://img-my.csdn.net/uploads/201302/02/1359816848_6482.png)
...
![](https://img-my.csdn.net/uploads/201302/02/1359818088_3309.png)
困扰我两天的问题终于圆满解决了！万岁！
# 总结
...
[http://bbs.csdn.net/topics/370233998](http://bbs.csdn.net/topics/370233998)
[http://x264-settings.wikispaces.com/x264_Encoding_Suggestions](http://x264-settings.wikispaces.com/x264_Encoding_Suggestions)
[](http://blog.csdn.net/mengyafei43/article/details/41744129#)[](http://blog.csdn.net/mengyafei43/article/details/41744129#)[](http://blog.csdn.net/mengyafei43/article/details/41744129#)[](http://blog.csdn.net/mengyafei43/article/details/41744129#)[](http://blog.csdn.net/mengyafei43/article/details/41744129#)[](http://blog.csdn.net/mengyafei43/article/details/41744129#)
- 
顶
0- 
踩
