# libevent源码深度剖析一 - 建建的博客 - CSDN博客
2017年03月07日 15:10:44[纪建](https://me.csdn.net/u013898698)阅读数：103
...
附带一句：Libevent是用[C语言](http://lib.csdn.net/base/c)编写的（MS大牛们都偏爱c语言哪），而且几乎是无处不函数指针，学习其源代码也需要相当的c语言基础。
### 2 Libevent简介
上来当然要先夸奖啦，Libevent 有几个显著的亮点：
事件驱动（event-driven），高性能;
轻量级，专注于网络，不如ACE那么臃肿庞大；
源代码相当精炼、易读；
跨平台，支持Windows、[Linux](http://lib.csdn.net/base/linux)、*BSD和Mac Os；
...
### 3 学习的好处
学习libevent有助于提升程序设计功力，除了网络程序设计方面外，Libevent的代码里有很多有用的设计技巧和基础[数据结构](http://lib.csdn.net/base/datastructure)，比如信息隐藏、函数指针、c语言的多态支持、链表和堆等等，都有助于提升自身的程序功力。
