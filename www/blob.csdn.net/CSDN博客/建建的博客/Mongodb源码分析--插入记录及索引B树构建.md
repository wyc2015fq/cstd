# Mongodb源码分析--插入记录及索引B树构建 - 建建的博客 - CSDN博客
2017年03月07日 14:14:06[纪建](https://me.csdn.net/u013898698)阅读数：243
...
    }
    上面的buildNextLevel方法自下而上根据之前抽取的键值逐层构造一个b树。这里有一个问题需要注意一下，因为mongodb使用bucket来作为b树中的一个层次结点或叶子结点容器（如下图），bucket最大尺寸为8192字节,c。有关b树索引的文章可以参见[这篇文章](http://wenku.baidu.com/view/f4f683dd5022aaea998f0f42.html)：，
    mongodb目前关于B树索引的文档 ：http://blog.nosqlfan.com/html/758.html
![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/mongodb_index_btree.gif)
