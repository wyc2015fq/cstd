# Web性能压力测试工具之ApacheBench（ab）详解 - 建建的博客 - CSDN博客
2017年03月25日 17:08:46[纪建](https://me.csdn.net/u013898698)阅读数：122
个人分类：[Linux](https://blog.csdn.net/u013898698/article/category/6754383)
PS：网站性能压力[测试](http://lib.csdn.net/base/softwaretest)是性能调优过程中必不可少的一环。只有让服务器处在高压情况下才能真正体现出各种设置所暴露的问题。[Apache](http://www.ha97.com/category/web-server/apache)中有个自带的，名为ab的程序，可以对[Apache](http://www.ha97.com/tag/apache)或其它类型的服务器进行网站访问压力测试。
ApacheBench命令原理：
ab命令会创建很多的并发访问线程，模拟多个访问者同时对某一URL地址进行访问。它的测试目标是基于URL的，因此，既可以用来测试Apache的负载压力，也可以测试[nginx](http://www.ha97.com/category/web-server/nginx)、lighthttp、[tomcat](http://www.ha97.com/category/web-server/tomcat)、IIS等其它Web服务器的压力。
...
-P attribute Add Basic [Proxy](http://www.ha97.com/tag/proxy) Authentication, the attributes
are a colon separated username and password.
...
# ab -c 5000 -n 600 http://127.0.0.1/index.[PHP](http://lib.csdn.net/base/php)
ApacheBench用法详解：
在[Linux](http://www.ha97.com/category/linux)系统，一般安装好Apache后可以直接执行；
...
稍等一会得到类似如下显示结果：
![](http://www.ha97.com/wp-content/uploads/2012/05/ab.jpg)
结果分析：
> 
This is ApacheBench, Version 2.3
Copyright 1996 Adam Twiss, Zeus Technology Ltd, http://www.zeustech[.NET](http://lib.csdn.net/base/dotnet)/
...
[Server](http://www.ha97.com/tag/server) Software: Apache/2.2.15
...
#网络上消耗的时间的分解，各项数据的具体[算法](http://lib.csdn.net/base/datastructure)还不是很清楚
