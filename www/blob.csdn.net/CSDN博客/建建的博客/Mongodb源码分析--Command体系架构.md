# Mongodb源码分析--Command体系架构 - 建建的博客 - CSDN博客
2017年03月07日 14:20:26[纪建](https://me.csdn.net/u013898698)阅读数：147
...
![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/mongod_command_showlist.png)
...
    下面是相关类图：
![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/classdraw_dbcommand.png)
-----------------------------分割线--------------------------------
![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/classdraw_dbcommands_admin.png)
-----------------------------分割线--------------------------------
![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/classdraw_dbcommands_generic.png)
-----------------------------分割线--------------------------------
![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/classdraw_replset_commands.png)
-----------------------------分割线--------------------------------
![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/classdraw_security_commands.png)
...
    之前看过我的[这篇文章](http://www.cnblogs.com/daizhj/archive/2011/03/18/1988288.html)的朋友可能还有印象，在mongod启动之后，会循环侦听指向端口上的用户(client)请求，这些请求在mongod中被改装成了message在各个功能类中传递。当用户发送一个count指令操作时，其会在query.cpp中执行下面方法（以count查询指令的执行流程为例来进行分析）：
```
//query.cpp
...
    .....
    }
    上面代码对传递来的查询消息QueryMessage（有关消息机制参见我的[这篇文章](http://www.cnblogs.com/daizhj/archive/2011/04/02/2003335.html)）进行分析之后，如果发现其为command时，执行runCommands方法：
 
```
//query.cpp   
...
    最后用一张时间序来大体回顾一下这一流程：
    ![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/mongod_command_sequence.png)
    
    好了，今天的内容到这里就告一段落了。
    
    参考链接：
