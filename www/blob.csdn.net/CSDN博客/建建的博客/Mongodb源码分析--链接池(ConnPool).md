# Mongodb源码分析--链接池(ConnPool) - 建建的博客 - CSDN博客
2017年03月07日 14:25:41[纪建](https://me.csdn.net/u013898698)阅读数：228
  在之前的[一篇文章](http://www.cnblogs.com/daizhj/archive/2011/05/23/mongos_balancer_source_code.html)中，介绍了mongos的balaner的执行流程，其中在源码中的Balancer::run()方法里简单说明了为了连接到configserver，balancer通过构造ScopedDbConnection实现来链接并执行相应操作，因为当时篇幅所限，只是该链接使用池化的方式一带而过，今天就专门介绍一下mongodb中使用池化方式来管理链接对象以提升链接效率的原理。
    好了，开始今天的正文吧！
...
![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/mongodb_connpool_classdraw.png)
...
![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/observers.jpg)
...
```
    看到这里，我们有必要了解一下_hooks是如何添加相关hook对象的。还记得我在[这篇文章](http://www.cnblogs.com/daizhj/archive/2011/05/16/2022041.html)中介绍在mongos的main（）中有如下代码吗？     
```
//server.cpp
...
![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/mongodb_connpool_sequence.png)
    原文链接:[http://www.cnblogs.com/daizhj/archive/2011/06/07/mongos_connpool_source_code.html](http://www.cnblogs.com/daizhj/archive/2011/06/07/mongos_connpool_source_code.html)
    作者: daizhj, 代震军   
