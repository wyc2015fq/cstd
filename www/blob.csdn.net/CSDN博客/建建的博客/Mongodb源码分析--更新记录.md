# Mongodb源码分析--更新记录 - 建建的博客 - CSDN博客
2017年03月07日 14:17:28[纪建](https://me.csdn.net/u013898698)阅读数：398
...
    ![](http://daizhj.cnblogs.com/images/cnblogs_com/daizhj/mongodb_updaterecord.png)
...
    http://blog.mongodb.org/post/520888030/on-distributed-consistency-part-5-many-writer
 
    原文链接:[http://www.cnblogs.com/daizhj/archive/2011/04/08/mongodb_update_recode_source_code.html](http://www.cnblogs.com/daizhj/archive/2011/04/08/mongodb_update_recode_source_code.html)
```
```
```
```
