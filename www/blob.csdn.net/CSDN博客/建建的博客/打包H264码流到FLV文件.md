# 打包H264码流到FLV文件 - 建建的博客 - CSDN博客
2018年07月01日 21:35:18[纪建](https://me.csdn.net/u013898698)阅读数：86
...
           4 是写入NaluLength       
[2015/12/31]对于多slice帧，多个slice依次写入，结构都是 slice length(4字节) 类似上面16-19字节；+ slice data
...
         但也不排除有些变态的编码器前后的SPS会不同，毕竟标准容许这样做。
