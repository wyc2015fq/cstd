# FFmpeg使用手册 - MP4的格式解析 - 建建的博客 - CSDN博客
2017年08月17日 13:39:31[纪建](https://me.csdn.net/u013898698)阅读数：592
## FFmpeg使用手册 - MP4的格式解析
视频文件转MP4
...
![](http://www.bkjia.com/uploads/allimg/160826/1213164353-0.png)
...
![](http://www.bkjia.com/uploads/allimg/160826/12131B314-1.png)
...
![](http://www.bkjia.com/uploads/allimg/160826/12131631c-2.png)
解析完这个音频的trak之后，接下来可以看到还有一个moov容器中的子容器，就是udta容器，这个udta容器解析方式与前面解析trak的方式基本相同，可以从下图看到，udta的大小为0x0000007c(124)个字节，
![](http://www.bkjia.com/uploads/allimg/160826/1213161V8-3.png)
...
1. 解析mvhd子容器：
![](http://www.bkjia.com/uploads/allimg/160826/12131B262-4.png)
...
如下图：
![](http://www.bkjia.com/uploads/allimg/160826/1213161256-5.png)
...
![](http://www.bkjia.com/uploads/allimg/160826/1213162C7-6.png)
这个tkhd对应的值如下表：
|字段|长度(字节)|值|
|----|----|----|
|尺寸|4|0x0000005c(92)|
...
![](http://www.bkjia.com/uploads/allimg/160826/12131BT0-7.png)
...
|类型|4|mdia|
下面参考一下mp4文件的数据：
![](http://www.bkjia.com/uploads/allimg/160826/12131B514-8.png)
...
![](http://www.bkjia.com/uploads/allimg/160826/1213161118-9.png)
从图中可以逐一解析出来：
|字段|长度(字节)|值|
|----|----|----|
|尺寸|4|0x00000020(32)|
...
![](http://www.bkjia.com/uploads/allimg/160826/1213162126-10.png)
...
![](http://www.bkjia.com/uploads/allimg/160826/12131B395-11.png)
将数据解析出来，对应值如下表：
|字段|长度(字节)|值|
|----|----|----|
|尺寸|4|0x00000014|
...
![](http://www.bkjia.com/uploads/allimg/160826/1213162402-12.png)
将数据解析出来后，对应的值如下表：
|字段|长度(字节)|值|
|----|----|----|
|尺寸|4|0x00000010|
...
|类型|4|edts|
Trak中的edts数据如下图：
![](http://www.bkjia.com/uploads/allimg/160826/12131CI2-13.png)
