# 详解H.264之帧内预测 - 建建的博客 - CSDN博客
2017年02月07日 09:24:01[纪建](https://me.csdn.net/u013898698)阅读数：1909
...
![](https://img-my.csdn.net/uploads/201301/17/1358387549_9302.png)![](https://img-my.csdn.net/uploads/201301/17/1358387568_3816.png)![](https://img-my.csdn.net/uploads/201301/17/1358387577_2893.png)![](https://img-my.csdn.net/uploads/201301/17/1358387597_8836.png)![](https://img-my.csdn.net/uploads/201301/17/1358387608_2139.png)![](https://img-my.csdn.net/uploads/201301/17/1358387627_4742.png)
表2 16×16预测模式
|模式|描     述|
|----|----|
|模式0（垂直）|由上边像素推出相应像素值|
...
![](https://img-my.csdn.net/uploads/201301/17/1358387678_1460.png)
8×8色度块预测模式
每个帧内编码宏块的8×8色度成分由已编码左上方色度像素预测而得，两种色度成分常用同一种预测模式。
4种预测模式类似于帧内16×16预测的4种预测模式，只是模式编号不同。其中DC（模式0）、水平（模式1）、垂直（模式2）、平面（模式3）。
![](https://img-my.csdn.net/uploads/201301/17/1358387659_6545.png)
对于当前块C, 编解码器按照如下方法计算
...
![](https://img-my.csdn.net/uploads/201301/17/1358387738_3478.png)
