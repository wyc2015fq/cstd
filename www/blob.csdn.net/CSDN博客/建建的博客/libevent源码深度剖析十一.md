# libevent源码深度剖析十一 - 建建的博客 - CSDN博客
2017年03月07日 15:32:11[纪建](https://me.csdn.net/u013898698)阅读数：90
...
**[cpp]**[view
 plain](http://blog.csdn.net/sparkliang/article/details/5105470#)[copy](http://blog.csdn.net/sparkliang/article/details/5105470#)
- staticvoid detect_monotonic(void)  
- {  
...
**[cpp]**[view
 plain](http://blog.csdn.net/sparkliang/article/details/5105470#)[copy](http://blog.csdn.net/sparkliang/article/details/5105470#)
- staticint gettime(struct event_base *base, struct timeval *tp)  
- {  
...
     函数evutil_gettimeofday()用来获取当前系统时间，在[Linux](http://lib.csdn.net/base/linux)下其实就是系统调用gettimeofday()；Windows没有提供函数gettimeofday，而是通过调用_ftime()来完成的。
...
**[cpp]**[view
 plain](http://blog.csdn.net/sparkliang/article/details/5105470#)[copy](http://blog.csdn.net/sparkliang/article/details/5105470#)
- staticvoid timeout_correct(struct event_base *base, struct timeval *tv)  
- {  
- struct event **pev;  
-     unsigned int size;  
- struct timeval off;  
