# libevent源码深度剖析八 - 建建的博客 - CSDN博客
2017年03月07日 15:28:39[纪建](https://me.csdn.net/u013898698)阅读数：84
...
![socket pair](https://p-blog.csdn.net/images/p_blog_csdn_net/sparkliang/EntryImages/20091215/sock%20pair.JPG)
    创建一个socket pair并不是复杂的操作，可以参见下面的流程图，清晰起见，其中忽略了一些错误处理和检查。
![create flow](https://p-blog.csdn.net/images/p_blog_csdn_net/sparkliang/EntryImages/20091215/sock%20pair%20flow.JPG)
...
**[cpp]**[view
 plain](http://blog.csdn.net/sparkliang/article/details/5011400#)[copy](http://blog.csdn.net/sparkliang/article/details/5011400#)
...
- return (0);  
- } elseif (base->sig.evsignal_caught) {  
-     evsignal_process(base);// 处理signal事件
- }  
完整的处理框架如下所示：
![integrate frame](https://p-blog.csdn.net/images/p_blog_csdn_net/sparkliang/EntryImages/20091215/frame.JPG)
注1：libevent中，初始化阶段并不注册读socket的读事件，而是在注册信号阶段才会[测试](http://lib.csdn.net/base/softwaretest)并注册；
...
- int ev_signal_added;  
- volatilesig_atomic_t evsignal_caught;  
...
**[cpp]**[view
 plain](http://blog.csdn.net/sparkliang/article/details/5011400#)[copy](http://blog.csdn.net/sparkliang/article/details/5011400#)
- staticvoid evsignal_handler(int sig)  
- {  
