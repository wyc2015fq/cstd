# FFMPEG 硬件解码 - 建建的博客 - CSDN博客
2017年07月10日 14:25:56[纪建](https://me.csdn.net/u013898698)阅读数：291
要: 对FFmpeg多媒体解决方案中的视频编解码流程进行研究。结合对S3C6410处理器视频硬件编解码方法的分析，阐述了嵌入式Linux下基于FFmpeg的H.264视频硬件编解码在S3C6410处理器上的实现方法，为嵌入式多媒体开发提供参考。
关键词: 计算机应用技术；嵌入式系统；FFmpeg；S3C6410；视频硬件编解码；H.264
Video Hardware Codec Based on FFmpeg under Embedded Linux
Liu Jianmin,Yang Bin(School of Information Science & Technology,Southwest Jiaotong University,Chengdu 610031,China)
Abstract： Researches on the video codec process of FFmpeg multimedia solution is conducted. With analysis of video hardware codec method of S3C6410 processor,H.264 video hardware codec implementation of S3C6410 processor based on FFmpeg under Embedded Linux
 is described. A reference for embedded multimedia development is provided.
Key words: computer application; embedded system; FFmpeg; S3C6410; video hardware codec; H.264
引言
...
![](http://www.you01.com/data/attachment/portal/201201/10/1039363cu2i1x82i4w5t5u.gif)
图1　S3C6410视频编解码软件架构
　　具体操作方法如下：
　　① 通过open函数打开编解码器设备文件；
...
![](http://www.you01.com/data/attachment/portal/201201/10/103936hr1yr7rgors31ta3.gif)
...
参考文献
[1] [http://www.ffmpeg.org/](http://www.ffmpeg.org/).
