# mongodb源码分析--查询 - 建建的博客 - CSDN博客
2017年03月07日 14:12:05[纪建](https://me.csdn.net/u013898698)阅读数：232
# [mongodb源码分析--查询](http://www.cnblogs.com/daizhj/archive/2011/03/18/1988288.html)
...
    };
      接着它会判断是否为cmd为开头，形如
 db.$cmd.findOne({getlasterror: 1})，并对一些特殊指令进行单独处理，包括inprog，killop，unlock。
```
