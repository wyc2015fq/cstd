# libevent源码深度剖析十二 - 建建的博客 - CSDN博客
2017年03月07日 15:33:48[纪建](https://me.csdn.net/u013898698)阅读数：81
...
…
     第一种的好处是消息可以立即得到处理，但是很方法很粗暴，你必须立即处理这个消息，所以你必须处理好切换问题，省得把文档上的内容不小心写到PPT里。在[操作系统](http://lib.csdn.net/base/operatingsystem)的进程通信中，消息队列（消息信箱）都是操作系统维护的，你不必关心。
...
![memcached](https://p-blog.csdn.net/images/p_blog_csdn_net/sparkliang/EntryImages/20100104/Picture1.jpg)
注：该图的具体出处忘记了，感谢原作者。
### 4 小节
