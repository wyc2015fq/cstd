# OpenCV图像处理篇之腐蚀与膨胀 - xiahouzuoxin - CSDN博客
...
![](http://www.forkosh.com/mathtex.cgi?%20%5CLarge%20g(x,y)=dilate%5Bf(x,y),B%5D=%5Cmin%7B%5C%7Bf(x-dx,y-dy)%7C(dx,dy)%5Cin%7BD_B%7D%5C%7D%7D)
