# OpenCV图像处理篇之边缘检测算子 - xiahouzuoxin - CSDN博客





2014年11月16日 15:41:57[xiahouzuoxin](https://me.csdn.net/xiahouzuoxin)阅读数：41741
...
![](http://www.forkosh.com/mathtex.cgi?%20%5Cnabla%20f(x,y)=%5Cbegin%7Bpmatrix%7DG_x%20%5C%5C%20G_y%5Cend%7Bpmatrix%7D=%5Cbegin%7Bpmatrix%7D%20%5Cfrac%7B%5Cpartial%20f%7D%7Bx%7D%20%5C%5C%20%5Cfrac%7B%5Cpartial%20f%7D%7By%7D%20%5Cend%7Bpmatrix%7D)
...
![Sobel与Prewitt算子模板](http://xiahouzuoxin.github.io/notes/images/OpenCV%E5%9B%BE%E5%83%8F%E5%A4%84%E7%90%86%E7%AF%87%E4%B9%8B%E8%BE%B9%E7%BC%98%E6%A3%80%E6%B5%8B%E7%AE%97%E5%AD%90/%E7%AE%97%E5%AD%90%E6%A8%A1%E6%9D%BF.png)
Sobel与Prewitt算子模板
...
![](http://www.forkosh.com/mathtex.cgi?%20%5Cnabla%5E2f(x,y)=%5Cfrac%7B%5Cpartial%5E2f(x,y)%7D%7B%5Cpartial%20x%5E2%7D+%5Cfrac%7B%5Cpartial%5E2f(x,y)%7D%7B%5Cpartial%20y%5E2%7D)

由上式可知，xy进行互换的结果是一样的，所以拉普拉斯算子没有x方向和y方向的区分，拉普拉斯算子对应图像中的差分运算是：

![](http://www.forkosh.com/mathtex.cgi?%20%5Cnabla%5E2f(x,y)=f(x+1,y)+f(x-1,y)+f(x,y+1)+f(x,y-1)-4f(x,y))

也可以通过卷积模板实现，

![LOG算子](http://xiahouzuoxin.github.io/notes/images/OpenCV%E5%9B%BE%E5%83%8F%E5%A4%84%E7%90%86%E7%AF%87%E4%B9%8B%E8%BE%B9%E7%BC%98%E6%A3%80%E6%B5%8B%E7%AE%97%E5%AD%90/LOG%E7%AE%97%E5%AD%90.png)
LOG算子


相对于一阶导数，高斯拉普拉斯算子（Laplacian of Gaussian, LOG算子）由于求二阶导数，很容易将点噪声判别为边界，因此常在使用LOG算子前先用高斯平滑滤波器去除正态分布的噪声，二维高斯分布为：

![](http://www.forkosh.com/mathtex.cgi?%20h(x,y)=%5Cfrac%7B1%7D%7B2%5Cpi%5Csigma%5E2%7De%5E%7B-%5Cfrac%7Bx%5E2+y%5E2%7D%7B2%5Csigma%5E2%7D%7D)
...
- 使用高斯滤波器平滑图像，卷积核尺度通过高斯滤波器的标准差确定
- 
计算滤波后图像的梯度幅值和方向 可以使用Sobel算子计算Gx与Gy方向的梯度，则梯度幅值和梯度的方向依次为 ![](http://www.forkosh.com/mathtex.cgi?%20G=%5Csrqt%7BG_x%5E2+G_y%5E2%7D,%20%5CTheta=atan2(Gy,Gx))
...
- 
使用双阈值[T1,T2]法检测边缘的起点和终点，这样能形成连接的边缘。T2>T1，T2用来找到没条线段，T1用来在这条线段两端延伸寻找边缘的断裂处，并连接这些边缘。
...
![Sobel边缘检测结果：右上为x梯度结果，左下为y梯度结果，右下为G(x,y)梯度结果](http://xiahouzuoxin.github.io/notes/images/OpenCV%E5%9B%BE%E5%83%8F%E5%A4%84%E7%90%86%E7%AF%87%E4%B9%8B%E8%BE%B9%E7%BC%98%E6%A3%80%E6%B5%8B%E7%AE%97%E5%AD%90/Sobel%E8%BE%B9%E7%BC%98%E6%A3%80%E6%B5%8B%E7%BB%93%E6%9E%9C.png)
Sobel边缘检测结果：右上为x梯度结果，左下为y梯度结果，右下为G(x,y)梯度结果


![Laplace边缘检测结果](http://xiahouzuoxin.github.io/notes/images/OpenCV%E5%9B%BE%E5%83%8F%E5%A4%84%E7%90%86%E7%AF%87%E4%B9%8B%E8%BE%B9%E7%BC%98%E6%A3%80%E6%B5%8B%E7%AE%97%E5%AD%90/Laplace%E8%BE%B9%E7%BC%98%E6%A3%80%E6%B5%8B%E7%BB%93%E6%9E%9C.png)
Laplace边缘检测结果


![Canny边缘检测结果](http://xiahouzuoxin.github.io/notes/images/OpenCV%E5%9B%BE%E5%83%8F%E5%A4%84%E7%90%86%E7%AF%87%E4%B9%8B%E8%BE%B9%E7%BC%98%E6%A3%80%E6%B5%8B%E7%AE%97%E5%AD%90/Canny%E8%BE%B9%E7%BC%98%E6%A3%80%E6%B5%8B%E7%BB%93%E6%9E%9C.png)
Canny边缘检测结果
