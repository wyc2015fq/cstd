# C++最快的读取文件的方案(scanf,cin(及取消sync),fread)的详细对比 - 在思索中前行！ - CSDN博客





2014年08月30日 14:45:26[_Tham](https://me.csdn.net/txl16211)阅读数：3372
...
- VC对cin取消同步与否**不敏感**，前后效率相同。反过来MINGW则**非常敏感**，前后效率相差8倍。
