# linux下用户及用户组的管理 - 在思索中前行！ - CSDN博客





2014年09月23日 22:42:39[_Tham](https://me.csdn.net/txl16211)阅读数：557标签：[linux用户组](https://so.csdn.net/so/search/s.do?q=linux用户组&t=blog)
...
本篇文章来源于 PHP资讯 原文链接：[http://www.phpq.net/linux/linux-add-delete-user-group.html](http://www.phpq.net/linux/linux-add-delete-user-group.html)
...
**二、用户(user）和用户组（group）概念；1、用户（user）的概念；**
