# 转载和积累系列 - 浏览器渲染原理 - 自娱自乐的代码人，专注Java、c、php - CSDN博客





2013年07月10日 19:18:49[initphp](https://me.csdn.net/initphp)阅读数：854
...
作者：[陈皓](http://coolshell.cn/articles/author/haoel) （[酷壳 – CoolShell.cn](http://coolshell.cn/)）

来源：[http://coolshell.cn/articles/9666.html](http://coolshell.cn/articles/9666.html)
...
> 
In this manner, the user agent can begin to lay out the table once the entire first row has been received. Cells in subsequent rows do not affect column widths. Any cell that has content that overflows uses the ‘overflow’ property to determine whether to
 clip the overflow content.
...
#### 参考
- David Baron的演讲：Fast CSS: How Browsers Lay Out Web Pages：[slideshow](http://dbaron.org/talks/2012-03-11-sxsw/slide-1.xhtml),[all slides](http://dbaron.org/talks/2012-03-11-sxsw/master.xhtml),
[audio (MP3)](http://audio.sxsw.com/2012/podcasts/11-ACC-Fast_CSS_How_Browser_Layout.mp3), [Session page](http://schedule.sxsw.com/2012/events/event_IAP12909),[Lanyrd page](http://lanyrd.com/2012/sxsw-interactive/spmbt/)
