# Java学习笔记46：Java 线程池 - 自娱自乐的代码人，专注Java、c、php - CSDN博客





2013年06月09日 12:29:55[initphp](https://me.csdn.net/initphp)阅读数：1570
...
![](https://img-blog.csdn.net/20130609122824859)
...
public class Test {
    ...
    public static void main(String[] args) {
        Test test = new Test();
        ThreadPoolExecutorSon pool = test.new ThreadPoolExecutorSon(10, 20, 60000, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>());
        for (int i = 0; i < 20; i++) {
            pool.execute(test.new ttt()); //执行线程
        }
        pool.shutdown(); //关闭
    ...
    /**
     * 重写线程池 可以使用beforeExecute和afterExecute
     * @author zhuli.zhul
     * @date 2013 2013-6-9 下午12:24:28
     */
    public class ThreadPoolExecutorSon extends ThreadPoolExecutor {

        public ThreadPoolExecutorSon(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit, BlockingQueue<Runnable> workQueue) {
