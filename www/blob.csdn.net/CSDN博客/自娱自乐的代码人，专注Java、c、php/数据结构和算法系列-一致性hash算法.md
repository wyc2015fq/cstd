# 数据结构和算法系列 - 一致性hash算法 - 自娱自乐的代码人，专注Java、c、php - CSDN博客





2012年06月25日 19:29:54[initphp](https://me.csdn.net/initphp)阅读数：885标签：[算法																[cache																[object																[服务器																[存储](https://so.csdn.net/so/search/s.do?q=存储&t=blog)
...
Hash(“202.168.14.241#2”);  // cache A2](https://so.csdn.net/so/search/s.do?q=服务器&t=blog)](https://so.csdn.net/so/search/s.do?q=object&t=blog)](https://so.csdn.net/so/search/s.do?q=cache&t=blog)](https://so.csdn.net/so/search/s.do?q=算法&t=blog)
