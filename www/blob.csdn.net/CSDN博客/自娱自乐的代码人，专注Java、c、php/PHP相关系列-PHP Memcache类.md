# PHP相关系列 - PHP Memcache类 - 自娱自乐的代码人，专注Java、c、php - CSDN博客





2012年06月18日 12:48:09[initphp](https://me.csdn.net/initphp)阅读数：2420标签：[php																[function																[string																[缓存服务器																[服务器](https://so.csdn.net/so/search/s.do?q=服务器&t=blog)
...
```](https://so.csdn.net/so/search/s.do?q=缓存服务器&t=blog)](https://so.csdn.net/so/search/s.do?q=string&t=blog)](https://so.csdn.net/so/search/s.do?q=function&t=blog)](https://so.csdn.net/so/search/s.do?q=php&t=blog)
