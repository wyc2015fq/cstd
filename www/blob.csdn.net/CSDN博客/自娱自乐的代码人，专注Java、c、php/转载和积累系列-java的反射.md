# 转载和积累系列 - java的反射 - 自娱自乐的代码人，专注Java、c、php - CSDN博客





2013年06月04日 10:00:16[initphp](https://me.csdn.net/initphp)阅读数：796
...
interface China{
    ...
    public void sayHello(String name,intage);
}
...
class hello{
     ...
     * 修改数组大小
     * */
    public static Object arrayInc(Object obj,intlen){
...
//定义项目接口
interface Subject {
    public String say(String name, intage);
}
...
//操作属性文件类
class init{
    public static Properties getPro()throwsFileNotFoundException, IOException{
