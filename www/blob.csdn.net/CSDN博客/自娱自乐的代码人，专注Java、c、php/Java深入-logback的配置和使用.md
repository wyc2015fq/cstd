# Java深入 - logback的配置和使用 - 自娱自乐的代码人，专注Java、c、php - CSDN博客





2014年11月07日 13:42:26[initphp](https://me.csdn.net/initphp)阅读数：58445
...
详细参考：[http://logback.qos.ch/manual/configuration.html](http://logback.qos.ch/manual/configuration.html)
