# 【数字图像处理】Canny边缘检测详解及编程实现 - 江南烟雨 - CSDN博客
2011年11月01日 20:36:10[江南烟雨](https://me.csdn.net/xiajun07061225)阅读数：50805标签：[图像处理																[编程																[算法																[n2																[优化																[c](https://so.csdn.net/so/search/s.do?q=c&t=blog)](https://so.csdn.net/so/search/s.do?q=优化&t=blog)](https://so.csdn.net/so/search/s.do?q=n2&t=blog)](https://so.csdn.net/so/search/s.do?q=算法&t=blog)](https://so.csdn.net/so/search/s.do?q=编程&t=blog)](https://so.csdn.net/so/search/s.do?q=图像处理&t=blog)
