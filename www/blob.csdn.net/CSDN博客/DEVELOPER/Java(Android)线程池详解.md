# Java(Android)线程池详解 - DEVELOPER - CSDN博客





2014年10月08日 11:41:51[学术袁](https://me.csdn.net/u012827205)阅读数：4092
...
介绍**new Thread的弊端及**Java**四种线程池的使用**，对Android同样适用。本文是基础篇，后面会分享下线程池一些高级功能。[原创链接](http://www.trinea.cn/android/java-android-thread-pool/)
