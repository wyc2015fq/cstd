# JavaScript宝座：七大框架论剑 - 我相信...... - CSDN博客





2012年08月09日 16:08:44[半吊子全栈工匠](https://me.csdn.net/wireless_com)阅读数：3917
...
原文链接：[Rich JavaScript Applications – the Seven Frameworks](http://blog.stevensanderson.com/2012/08/01/rich-javascript-applications-the-seven-frameworks-throne-of-js-2012/)　作者：Steven
 Sanderson

翻译：[@李松峰](http://weibo.com/lisf)



一周前，[Throne of JS大会](http://throneofjs.com/)在多伦多召开，这应该是我参加过的最有料也最不一样的一次大会。大会官网如是说：
...
这次大会邀请了七大JavaScript框架/库的创建人，他们济济一堂，面对面交流各自的技术理念。所谓七大框架/库分别是：AngularJS、Backbone、Batman、CanJS、Ember、Meteor、Knockout、Spine。[1](http://blog.stevensanderson.com/2012/08/01/rich-javascript-applications-the-seven-frameworks-throne-of-js-2012/)

**声明：**我在会上讲Knockout，因此我的观点显然不是中立的。在这篇文章中，我重点讨论这些创建人的思路和技术理念，尽量不提我赞成或反对什么。

[1](http://blog.stevensanderson.com/2012/08/01/rich-javascript-applications-the-seven-frameworks-throne-of-js-2012/)*没错，是8个框架，不是7个。但到底怎么回事儿，会议主办方也没有明确给我们解释过……*

![enter image description here](http://www.ituring.com.cn/download/01REswCNiMla)
...
用Backbone创建人Jeremy Ashkenas的话说：“现如今，你说‘单页应用’，都跟说‘不用马拉的车’差不多了”（意思是，早已经没那么新鲜了）[2](http://weibo.com/lisf)。

[2](http://weibo.com/lisf)*“不用马拉的车”（horseless carriage）是汽车刚刚发明的时候，人们对它的称呼。——译者注*
...
在小组讨论中，大多数框架的创建者说，他们对IE浏览器的支持只限于7+（事实上，Ember和AngularJS的起点是IE8，Batman需要ES5“垫片”才能在IE9之前的IE版本中使用）。这也是大势所趋：[jQuery
 2已经不打算支持IE9以下的旧版本IE了](http://blog.jquery.com/2012/06/28/jquery-core-version-1-9-and-beyond/)。
...
[@时蝇喜箭](http://weibo.com/timeflieslikeanarrow) 我们用了很多“法术”，但都是好的“法术”，意味着可以分解成合理的基本组件。
[@连城404](http://weibo.com/lianchengzju) 我们的代码技巧性比较高，但绝非旁门左道，都是些由常规的基本语义元素构成的东西。
[@玉伯也叫射雕](http://weibo.com/lifesinger) 我们实现了很多巧妙的整合，真的非常巧妙，这些整合都可以分解成普通操作。
...
- **Where:**[GitHub](https://github.com/documentcloud/backbone/) 及 [自有站点](http://backbonejs.org/)。
- **When:** 至今已诞生近两年了。

### Meteor
- **Who:**[Meteor 开发团队](http://www.meteor.com/about/people)（他们[刚募集到1120万美元投资](http://www.prnewswire.com/news-releases/andreessen-horowitz-matrix-partners-invest-112-million-in-meteor-163687206.html)，因此可以全职开发）。
- **What:**

+ 前瞻性极强的一个框架，想不出有谁那么激进过（也许[Derby](http://derbyjs.com/)算一个）。
...
+ 可以[看看这个视频](http://www.meteor.com/screencast)，对它的认识就会更全面。

+ 跟会上与我有过交流的所有人一样，我也衷心希望这个框架获得成功——Web开发就需要这种激进的改革才能真正进步。
- **Why:** 你实在觉得做常规Web开发太无聊了，想找点刺激。
- **Where:**[GitHub](https://github.com/meteor/meteor) 和 [自有站点](http://www.meteor.com/)。
- **When:** 诞生时间不长；除了其核心团队在用，不知道还有没有其他站点实际在用Meteor。不过，这个团队真是在严肃地做着一件前无古人的事。

### Ember
- **Who:** Yehuda Katz （之前开发过jQuery和Rails）、Ember团队和Yehuda的公司[Tilde](http://www.facebook.com/tildeinc)。
- **What:**
...
- **Where:**[GitHub](https://github.com/emberjs/ember.js/) 和 [自有站点](http://emberjs.com/)。
...
- **Where:**[GitHub](https://github.com/angular/) 和 [自有站点](http://angularjs.org/)。
...
+ 在降低使用门槛方面下了很大工夫，提供详尽的文档和[交互式示例](http://learn.knockoutjs.com/)。
- **Why:**

+ 只做好一件事（UI），向后兼容到IE6。

+ 对服务器架构或文件组织方式没有影响。可以用在页面的某一小部分中——不需要控制整个页面。
- **Where:**[GitHub](https://github.com/SteveSanderson/knockout) 和 [自有站点](http://knockoutjs.com/)。
- **When:** 到现在已经正式发布近两年了。
...
+ 是Backbone的一个衍生版（看名字就知道[3](http://weibo.com/u/1906984307)）。
- **Why:** 你喜欢Backbone，但又想要点[不一样的东西](http://stackoverflow.com/questions/6530444/backbone-js-vs-spine-js)。
- **Where:**[GitHub](https://github.com/maccman/spine) 和 [自有站点](http://spinejs.com/)
- **When:** v1.0.0已经发布。

[3](http://weibo.com/u/1906984307)*Backbone和Spine都是“脊椎”的意思。——译者注*

### Batman
- **Who:**[Shopify](http://www.shopify.com/) （一家电子商务平台公司）的团队。
- **What:**
...
- **Where:**[GitHub](https://github.com/Shopify/batman) 和 [自有站点](http://batmanjs.org/)。
- **When:** 当前版本 0.9，几个月内将发布1.0版。

### CanJS
- **Who:**[Bitovi](http://bitovi.com/)（一家JavaScript咨询/培训公司）的团队。
- **What:**
...
+ 知名度不高（我也是上周才听说它的），但它的前身却是原来的[JavaScriptMVC项目](http://javascriptmvc.com/)。
- **Why**: 旨在集上述各技术门派之所长，提供与它们类似的功能，同时又保持体积小巧。
- **Where:**[GitHub](https://github.com/jupiterjs/canjs) 和 [自有站点](http://canjs.us/)。
- **When:** 1.0 版已经发布了。
