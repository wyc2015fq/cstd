...
2019年01月21日 08:58:00[半吊子全栈工匠](https://me.csdn.net/wireless_com)阅读数：322
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/DE2dk1GjczoYe8P7wm1jykkW9ticOb0maqbtHKsdLCh7juz01iaNKCCmqocxxqgMwKeZ5Oxlf8nia5jqnmEsiaBPtQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/DE2dk1GjczoYe8P7wm1jykkW9ticOb0mauuo93F721pybVDo7N96GMSaMofDCopkN1XbfZxFibUqFkQ62IZVbcJw/640?wx_fmt=png)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/DE2dk1GjczoYe8P7wm1jykkW9ticOb0maibAEasibF3UORXNV737K7IBlT9EtUNbE448QH4V9gZhhMrX9ggIoiaqDQ/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/DE2dk1GjczoYe8P7wm1jykkW9ticOb0mauRc6a3kED3HD4uw36QEjz9f0apMspC5jalKtAm6CdRTG3t2FnF5Z0Q/640?wx_fmt=jpeg)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/DE2dk1GjczoYe8P7wm1jykkW9ticOb0ma4rNcXdG8KdvtYHmtJtNtJyCP5pyr46kY4jSy8vW8njfVOFbicjT0KPw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/DE2dk1GjczoYe8P7wm1jykkW9ticOb0maPj6jMoYbhLjIFHmeY5QOaZcibZnDSL6s3oicxDYqy2XjicBqr5YFz8vZA/640?wx_fmt=png)
...
- 
节点根据routing计算，把数据发送到primary节点上
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/DE2dk1GjczoYe8P7wm1jykkW9ticOb0maNbyGibnJYic3GZ3oO184kDkzxM00JHCib56CiaHUuFUwZPFXJsBiau74yQg/640?wx_fmt=png)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/DE2dk1GjczoYe8P7wm1jykkW9ticOb0ma0HLIevyus82qD2Kvb5kefaZcuFrU0xJD8SmluFuQibqZLia05dKzQicZg/640?wx_fmt=jpeg)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/DE2dk1GjczoYe8P7wm1jykkW9ticOb0maTu9yOnkFk5hmicMlLYNgYGahEhicddoF0WScmPflaRpHzSefEVmsthTA/640?wx_fmt=png)

### APM度量

度量是性能优化的前提，ES与APM结合，可以更好的完成性能可视化的工作。

![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/DE2dk1GjczoYe8P7wm1jykkW9ticOb0ma1ZY4SWIxxtc2O7ialtS8Vl4BFRDoRMgxL2WrR5uiaNzt48pKzNkfgwzQ/640?wx_fmt=png)

### 多租户视图

ES中的用户体系包括内置用户（root/superuser）和普通用户。

Root是内置的系统管理用户，进行cluster setting，recovery设置，节点加入退出等。Superuser是管理数据的超级用户，能够创建用户，访问所有用户的数据等。普通用户由Superuser来建立，用来操作相应的业务数据，其权限类型包括`READ_ONLY`和`READ_WRITE`。

![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/DE2dk1GjczoYe8P7wm1jykkW9ticOb0maia0qyVq9piaxqIkqgesZ81nPibpfN5oMCAoH6QMXx8J7u5JXTPbl77wQg/640?wx_fmt=png)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/DE2dk1GjczoYe8P7wm1jykkW9ticOb0malrIrGgFvib7qVtlUsMNadvbVtS6y3to8PXDWQoWxNW3WkpkNp5iaVzxQ/640?wx_fmt=jpeg)
...
Master节点需要至少`minimum_master_nodes`节点投票才能赢得选举,将其设置为合适的数据可部分防止脑裂的场景。

![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/DE2dk1GjczoYe8P7wm1jykkW9ticOb0mae9iciaDF00Q45JICtLu9D2pdv0ZWGsjJU8M5e8iaz2BVoaTabuuwNLceA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/DE2dk1GjczoYe8P7wm1jykkW9ticOb0ma70qX0nhAicTQqFVm2jcas7sv72uy7FCXHlSyrgc7Rr39cOX1ibnVGhPw/640?wx_fmt=png)

这是一个云计算的时代，各大公有云厂商（例如，国外的AWS/Azure，国内的百度云/阿里云/青云等等）也都提供了ES云服务。当然，使用ES可以构建自己的私有云服务，实现企业部署。

![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/DE2dk1GjczoYe8P7wm1jykkW9ticOb0marC4L9WEorurVemYDn0Jpo6qMelSj724qiaXgg8UF69H1PG1wLQDicdTw/640?wx_fmt=png)
