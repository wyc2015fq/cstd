# 《BREW进阶与精通——3G移动增值业务的运营、定制与开发》连载之25---空中下载OTA - 我相信...... - CSDN博客





2009年10月25日 15:04:00[半吊子全栈工匠](https://me.csdn.net/wireless_com)阅读数：1337标签：[brew																[手机																[服务器																[负载均衡																[活动																[语言](https://so.csdn.net/so/search/s.do?q=语言&t=blog)
...
在移动通信核心网中的智能网的支持下，BREW与运营商的综合营帐系统以及移动增值业务结算平台相集成，既支持用户的预付费模式，又支持用户的后付费模式。](https://so.csdn.net/so/search/s.do?q=活动&t=blog)](https://so.csdn.net/so/search/s.do?q=负载均衡&t=blog)](https://so.csdn.net/so/search/s.do?q=服务器&t=blog)](https://so.csdn.net/so/search/s.do?q=手机&t=blog)](https://so.csdn.net/so/search/s.do?q=brew&t=blog)
