# 招聘一个靠谱的 iOS（含面试题） - 月若无涯的专栏 - CSDN博客
2015年07月16日 11:03:41[月若无涯](https://me.csdn.net/u010124617)阅读数：1342
转自阳神的博客：http://blog.sunnyxx.com
...
## 一个靠谱的简历
简历非常能反映一个人的性格和水平，相比于你在学校获得多少奖项，工作经历、项目经历、熟悉的技术等更加关键，如果还有博客和一些 Github 上的项目，好感度++，但记得在去面试前收拾下，我们真的会挨个文件 review 你的开源代码的。我们还喜欢关注一些细节，比如简历里关键字的拼写，看似无关紧要但很能反映出对自己的要求，经常见一个简历中 iOS 这三个字母的拼写就出现
 IOS、iOS、ios 三种的，非常不能忍，再列举几个常见问题： 
 ...
 *_foo
```
，调用`setValue:forKey:`时，可以以`foo`还是`_foo`作为key？
