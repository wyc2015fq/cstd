# OpenCV学习笔记（二十六）——小试SVM算法ml - 迭代的是人，递归的是神 - CSDN博客





2011年11月15日 15:07:54[yang_xian521](https://me.csdn.net/yang_xian521)阅读数：51280
...
这次就先介绍一下机器学习中的一个常用算法SVM算法，即支持向量机Support Vector Machine（SVM），是一种有监督学习方法，更多介绍请见维基百科[http://zh.wikipedia.org/wiki/SVM](http://zh.wikipedia.org/wiki/SVM)。
