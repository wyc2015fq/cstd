# OpenCV学习笔记（六十二）——《OpenCV Computer Version with Python》阅读摘要 - 迭代的是人，递归的是神 - CSDN博客





2014年08月30日 08:29:19[yang_xian521](https://me.csdn.net/yang_xian521)阅读数：10532
...
第一个问题在windows下很简单，OpenCV安装好之后，找到目录<build_folder>\lib\Release\cv2.pyd(from a Visual Studio build) 这个文件，然后copy到C:\Python2.7\Lib\site-packages。搞定了，就这么简单。毕竟脚本语言，简直无情，\sources\samples下有很多python的例子，跑几个试试就知道是否安装好了。import
 cv2这句就可以导入cv2模块了
