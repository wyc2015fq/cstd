# OpenCV学习笔记（四）——新版本的数据结构core - 迭代的是人，递归的是神 - CSDN博客





2011年10月26日 09:09:46[yang_xian521](https://me.csdn.net/yang_xian521)阅读数：20268标签：[数据结构																[matlab																[算法																[扩展																[c](https://so.csdn.net/so/search/s.do?q=c&t=blog)
个人分类：[OpenCV](https://blog.csdn.net/yang_xian521/article/category/910716)

所属专栏：[OpenCV学习笔记](https://blog.csdn.net/column/details/opencv-manual.html)](https://so.csdn.net/so/search/s.do?q=扩展&t=blog)
...
总之，新版本支持更多的数学运算，还支持一些画图操作](https://so.csdn.net/so/search/s.do?q=算法&t=blog)](https://so.csdn.net/so/search/s.do?q=matlab&t=blog)](https://so.csdn.net/so/search/s.do?q=数据结构&t=blog)
