# OpenCV学习笔记（十二）——随机数产生器RNG - 迭代的是人，递归的是神 - CSDN博客





2011年11月03日 11:36:16[yang_xian521](https://me.csdn.net/yang_xian521)阅读数：45772标签：[compiler																[算法																[float																[c](https://so.csdn.net/so/search/s.do?q=c&t=blog)
个人分类：[OpenCV](https://blog.csdn.net/yang_xian521/article/category/910716)

所属专栏：[OpenCV学习笔记](https://blog.csdn.net/column/details/opencv-manual.html)](https://so.csdn.net/so/search/s.do?q=float&t=blog)
...
再简单介绍一下c版本的随机数产生器的相关函数，有cvRNG、cvRandArr、cvRandInt、cvRandReal](https://so.csdn.net/so/search/s.do?q=算法&t=blog)](https://so.csdn.net/so/search/s.do?q=compiler&t=blog)
