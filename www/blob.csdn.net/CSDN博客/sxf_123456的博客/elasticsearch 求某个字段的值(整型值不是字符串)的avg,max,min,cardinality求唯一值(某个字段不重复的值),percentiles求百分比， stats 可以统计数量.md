# elasticsearch 求某个字段的值(整型值不是字符串)的avg,max,min,cardinality求唯一值(某个字段不重复的值),percentiles求百分比， stats 可以统计数量 - sxf_123456的博客 - CSDN博客
2018年03月30日 20:59:56[sxf_0123](https://me.csdn.net/sxf_123456)阅读数：209
