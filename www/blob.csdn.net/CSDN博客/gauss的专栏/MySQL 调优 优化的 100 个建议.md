# MySQL 调优/优化的 100 个建议 - gauss的专栏 - CSDN博客
2015年10月05日 00:51:56[gauss](https://me.csdn.net/mathlmx)阅读数：169
...
61、有时候，少量的配置会更好。
62、质疑使用通用的MySQL配置文件。
![](http://mmbiz.qpic.cn/mmbiz/DmibiaFiaAI4B0EL8J6sVn8eCHm5BFxs2Qm3adibzeSzaIUzbITj5p3CsHxOmRzogDAvRffYibzZQRGcmVib9CicpogjA/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1)
### **查询优化：**
63、使用慢查询日志，找出执行慢的查询。
