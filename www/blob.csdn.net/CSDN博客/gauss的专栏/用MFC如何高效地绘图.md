# 用MFC如何高效地绘图 - gauss的专栏 - CSDN博客
2012年01月09日 23:56:16[gauss](https://me.csdn.net/mathlmx)阅读数：286标签：[mfc																[图形																[null																[网络](https://so.csdn.net/so/search/s.do?q=网络&t=blog)](https://so.csdn.net/so/search/s.do?q=null&t=blog)](https://so.csdn.net/so/search/s.do?q=图形&t=blog)](https://so.csdn.net/so/search/s.do?q=mfc&t=blog)
...
与屏幕显示图形差别很小（如果没有运动，当然就没有差别），这样看起来就不会闪。 http://www.mscto.com
**3、如何实现双缓冲**
...
来自:http://user.qzone.qq.com/233536605/blog/1267770828
