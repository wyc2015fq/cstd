# 50个c/c++源代码网站 - gauss的专栏 - CSDN博客
2011年12月04日 09:28:27[gauss](https://me.csdn.net/mathlmx)阅读数：340标签：[编程																[c																[语言																[calendar																[数据结构																[工具](https://so.csdn.net/so/search/s.do?q=工具&t=blog)](https://so.csdn.net/so/search/s.do?q=数据结构&t=blog)](https://so.csdn.net/so/search/s.do?q=calendar&t=blog)](https://so.csdn.net/so/search/s.do?q=语言&t=blog)](https://so.csdn.net/so/search/s.do?q=c&t=blog)](https://so.csdn.net/so/search/s.do?q=编程&t=blog)
...
10、[http://www.google.com/codesearch?q=programming++lang:c&cs_r=lang:c](http://www.google.com/codesearch?q=programming++lang:c&cs_r=lang:c) --谷歌代码的C源代码。
...
15、[http://people.sc.fsu.edu/~burkardt/cpp_src/cpp_src.html](http://people.sc.fsu.edu/~burkardt/cpp_src/cpp_src.html) --这是一个全面的关于C++的345个源代码清单。
...
21、[http://cplus.about.com/od/cgames/C_Games_with_Source_Code.htm](http://cplus.about.com/od/cgames/C_Games_with_Source_Code.htm) --游戏有关的C++源代码。
22、[http://cliodhna.cop.uop.edu/~hetrick/c-sources.html](http://cliodhna.cop.uop.edu/~hetrick/c-sources.html) --免费的C/C++数值计算源代码。
...
28、[ftp://66.77.27.238/sourcecode/cuj/](http://ctc.qzs.qq.com/qzone/qzfl/editor/assets/blank.htm#) --C/C++用户杂志
29、[ftp://66.77.27.238/sourcecode/wd/](http://ctc.qzs.qq.com/qzone/qzfl/editor/assets/blank.htm#) --Windows开发者网络
...
44、[http://users.cs.fiu.edu/](http://users.cs.fiu.edu/) C++。
45、[http://www.josuttis.com/libbook/examples.html](http://www.josuttis.com/libbook/examples.html) --C++标准库-教程和参考资料。
...
本文来自CSDN博客，转载请标明出处：[http://blog.csdn.net/cnsword/archive/2009/05/13/4176636.aspx](http://blog.csdn.net/cnsword/archive/2009/05/13/4176636.aspx)
