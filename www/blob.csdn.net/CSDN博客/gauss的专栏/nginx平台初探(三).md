# nginx平台初探(三) - gauss的专栏 - CSDN博客
2015年11月01日 11:17:26[gauss](https://me.csdn.net/mathlmx)阅读数：366
# 过滤模块 (90%)
## 过滤模块简介 (90%)
### 执行时间和内容 (90%)
...
![http://tengine.taobao.org/book/_images/chapter-4-1.png](http://tengine.taobao.org/book/_images/chapter-4-1.png)
...
ngx_addon_name=ngx_http_example_filter_moduleHTTP_AUX_FILTER_MODULES="$HTTP_AUX_FILTER_MODULES ngx_http_example_filter_module"NGX_ADDON_SRCS="$NGX_ADDON_SRCS $ngx_addon_dir/ngx_http_example_filter_module.c"
...
![http://tengine.taobao.org/book/_images/chapter-4-2.png](http://tengine.taobao.org/book/_images/chapter-4-2.png)
### 响应头过滤函数 (90%)
