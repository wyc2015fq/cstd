...
# Linux内存管理（最透彻的一篇） - 嵌入式Linux - CSDN博客

2018年10月16日 11:14:52[写代码的篮球球痴](https://me.csdn.net/weiqifa0)阅读数：605
...
“事实胜于雄辩”，我们用一个小例子（原形取自《User-Level Memory Management》）来展示上面所讲的各种内存区的差别与位置。![](http://www.kerneltravel.net/journal/v/mem.files/image001.gif)
...
Heap Location:
   ...
   New end of heap:0x804986c![复制代码](https://common.cnblogs.com/images/copycode.gif)
...
![](http://www.kerneltravel.net/journal/v/mem.files/image005.gif)![文本框: 伙伴关系维护](http://www.kerneltravel.net/journal/v/mem.files/image007.gif)![](http://www.kerneltravel.net/journal/v/mem.files/image006.gif)
### 内核内存使用
Slab
...
![](http://www.kerneltravel.net/journal/v/mem.files/image005.gif)![文本框: 伙伴关系维护](http://www.kerneltravel.net/journal/v/mem.files/image008.gif)![文本框: vmalloc](http://www.kerneltravel.net/journal/v/mem.files/image009.gif)![文本框: Kmalloc](http://www.kerneltravel.net/journal/v/mem.files/image014.gif)![](http://www.kerneltravel.net/journal/v/mem.files/image015.gif)
...
如下图所示：
![](http://www.kerneltravel.net/journal/v/mem.files/image016.gif)
