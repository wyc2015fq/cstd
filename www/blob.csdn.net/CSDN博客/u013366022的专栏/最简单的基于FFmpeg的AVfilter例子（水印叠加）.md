# 最简单的基于FFmpeg的AVfilter例子（水印叠加） - u013366022的专栏 - CSDN博客
2014年07月10日 11:01:50[slitaz](https://me.csdn.net/u013366022)阅读数：756
...
下面直接贴上代码：
**[cpp]**[view
 plain](http://blog.csdn.net/leixiaohua1020/article/details/29368911#)[copy](http://blog.csdn.net/leixiaohua1020/article/details/29368911#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/383201/fork)
- /* 
...
- };  
- 
- constchar *filter_descr = "movie=my_logo.png[wm];[in][wm]overlay=5:5[out]";  
- 
...
- staticint video_stream_index = -1;  
- static int64_t last_pts = AV_NOPTS_VALUE;  
- 
- 
- 
- 
- staticint open_input_file(constchar *filename)  
- {  
- int ret;  
-     AVCodec *dec;  
- 
...
- }  
- 
- staticint init_filters(constchar *filters_descr)  
- {  
- char args[512];  
- int ret;  
