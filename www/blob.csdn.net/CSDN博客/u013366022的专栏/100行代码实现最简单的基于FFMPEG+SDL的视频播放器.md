# 100行代码实现最简单的基于FFMPEG+SDL的视频播放器 - u013366022的专栏 - CSDN博客
2014年07月10日 10:57:03[slitaz](https://me.csdn.net/u013366022)阅读数：752
...
## 代码
**[cpp]**[view
 plain](http://blog.csdn.net/leixiaohua1020/article/details/8652605#)[copy](http://blog.csdn.net/leixiaohua1020/article/details/8652605#)![在CODE上查看代码片](https://code.csdn.net/assets/CODE_ico.png)[](https://code.csdn.net/snippets/335239/fork)
...
- //-----------------------------
- int ret, got_picture;  
- staticstruct SwsContext *img_convert_ctx;  
...
注：类库版本2014.5.6，已经支持HEVC以及VP9的解码，附带了这两种视频编码的码流文件。此外修改了个别变更的API函数，并且提高了一些程序的效率。
## FFMPEG相关学习资料
SDL GUIDE 中文译本
