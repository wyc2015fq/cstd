# springcloud(二)：注册中心Eureka - 纯洁的微笑 - CSDN博客
2017年05月15日 08:34:18[微笑很纯洁](https://me.csdn.net/ityouknow)阅读数：7881
...
- `eureka.client.serviceUrl.defaultZone` ：设置与Eureka Server交互的地址，查询服务和注册服务都需要依赖这个地址。默认是[http://localhost:8761/eureka](http://localhost:8761/eureka) ；多个地址可使用 , 分隔。
启动工程后，访问：[http://localhost:8000/](http://localhost:8000/)，可以看到下面的页面，其中还没有发现任何服务
