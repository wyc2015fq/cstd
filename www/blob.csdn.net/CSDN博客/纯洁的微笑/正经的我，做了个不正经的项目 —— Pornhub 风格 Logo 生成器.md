# 正经的我，做了个不正经的项目 —— Pornhub 风格 Logo 生成器 - 纯洁的微笑 - CSDN博客
2019年04月09日 09:09:00[微笑很纯洁](https://me.csdn.net/ityouknow)阅读数：265
**这两天一个朋友做了一款非常有意思的开源软件，我试用了一下感觉挺好玩，分享给大家。**
在线试用了一下这款开源软件，给自己生成了一个 Logo ，大家看看效果：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/PgqYrEEtEnpccuNX9A3wDNvLbeCNWB0Dib45g3mRvRfuRxv4f8ZlLv39mNiaMNUPp4DFavB15tG4OVTuW7zAMCyw/640?wx_fmt=png)
当然也可以定制格式、颜色、字体大小，后期作者计划实现 YouTube 风格。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/PgqYrEEtEnpccuNX9A3wDNvLbeCNWB0DPBRUcatJFHolSajoxVEy6lkNdwzm5bVyY1pEsXmG4to2Hg2ialMEkRw/640?wx_fmt=png)
一股满满的极客风，是不是很有趣，下面为作者的开发经历，值得学习。
**TL;DR**
Logoly.Pro是一个在线的 PornHub 风格 Logo 生成工具，可以帮助你快速生成类似 PornHub 风格的 Logo
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/900wqgayjFPK7ia1060amaHEhvEn1wdZPeZXMRcJmRsTNq2ANw91IaoHtghPcYNqsf4000P8CTPN1JauWk4AQIg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/900wqgayjFPK7ia1060amaHEhvEn1wdZPvs1SWB8wsG9oELWOyMJm62KcrBALlrIt7Y0H00WsNnEiba70lA6hQlQ/640?wx_fmt=png)
## **设计产品**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/900wqgayjFPK7ia1060amaHEhvEn1wdZPUb2Cib93zejlBvdrlRtkzBQykxjQsI3rFiavic8H2MCtfCiahkNEZfN8gw/640?wx_fmt=png)
设计完成后，就要开始准备开始编码了。
## **找库**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/900wqgayjFPK7ia1060amaHEhvEn1wdZPTvqa85jbbj5zBpv6KGxOb3gxI0j3micwETsW4nYT3uLia7iauP78NSibOA/640?wx_fmt=png)
并配置一下域名，将自己的域名设置为主域名
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/900wqgayjFPK7ia1060amaHEhvEn1wdZPiaJdqEMGUKGNEqUFR2A0ddW5NN0boWjg9G6DdIneZKNmYErPbkhbOgA/640?wx_fmt=png)
稍等一会，就会自动为你的域名签注 Let’s Encrypt 的证书。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/900wqgayjFPK7ia1060amaHEhvEn1wdZPJuiajCInicCyufmdLZicgfic9P8ppo4icEYic9aM4Z7K7soSGfZsIXhvsKVA/640?wx_fmt=png)
## **最后**
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/900wqgayjFPK7ia1060amaHEhvEn1wdZPVA6Gtdt9gWGzpmXCD9CBsMgx1BE9GWywEZIu8CG7IoGkMbtLeCGCUQ/640?wx_fmt=png)
