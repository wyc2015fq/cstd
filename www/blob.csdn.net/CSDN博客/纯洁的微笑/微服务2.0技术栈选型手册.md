# 微服务2.0技术栈选型手册 - 纯洁的微笑 - CSDN博客
2018年11月09日 09:09:00[微笑很纯洁](https://me.csdn.net/ityouknow)阅读数：101
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmGnhN6hOuucZerjsiaAOibFPvEpicPXMexqoSyELVn7uKSrj525ia32TuBIjPQDl3SkOtx4VibeLupODzw/640?wx_fmt=png)
下图是在参考过华为技术专家王磊的《微服务的设计与生态系统》的基础上，结合作者自身的实践调整而来，我想同时分享给一线架构师或者工程师参考，其中粉红色标注的模块是和微服务关系最密切的模块，大家在做技术选型时，可以同时对照这个体系。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmGnhN6hOuucZerjsiaAOibFPvibW6tCyibC6icDoubr6x80nz8KwpPibV55BqCQwibTQpF1hoIs2GPNVrN2A/640?wx_fmt=png)
### 四、服务框架选型
...
**服务注册中心**，如果采用Spring Cloud体系，则选择**Eureka**是最佳搭配，Eureka在Netflix经过大规模生产验证，支持跨数据中心，客户端配合Ribbon可以实现灵活的客户端软负载，Eureka目前在github上有超过4.7k星；**Consul**也是不错选择，天然支持跨数据中心，还支持KV模型存储和灵活健康检查能力，目前在github上有超过11k星。
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmGnhN6hOuucZerjsiaAOibFPvxllXmicttdXNndMicj4CuE6tmHxqQjzdt9ljn3icUVRTW0kVHzAtOsuZw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmGnhN6hOuucZerjsiaAOibFPvVsJSIiaxTAbQVwXvFF8AlPBdpc5YRV1neVj1JxpN37Su6wVoP8FNDnw/640?wx_fmt=png)
- 
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmGnhN6hOuucZerjsiaAOibFPvBqicIBGC5t6eVS4e64P0oDgUWPrRsrywxZoE744gBdMb4F0icIJDRbcg/640?wx_fmt=png)
简化发布流程如下：
- 
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmGnhN6hOuucZerjsiaAOibFPvQ9yZ1weTEiaPEaYpuGsMiaNhWRPsiaqicxeNCsxFxKp3NlL0ddicRnLQGTQ/640?wx_fmt=png)
### 十一、写在最后
