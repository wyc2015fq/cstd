# 人生苦短，我用 Python - 纯洁的微笑 - CSDN博客
2019年02月25日 09:09:00[微笑很纯洁](https://me.csdn.net/ityouknow)阅读数：283
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/SAy0yVjKWywvq4Aff6E1TSyTplN8mCoynU18nQGB6KbWy43sMMMZSVP56mmMkgMDXyOnaVwXDQUaESiaN5BgrXQ/640?wx_fmt=jpeg)
## **结缘**
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/SAy0yVjKWywvq4Aff6E1TSyTplN8mCoyZmb3Vzicb7UUh7xibVbktaAkfj6aAtlupwf1qicE2RicERG4PZcySWEULA/640?wx_fmt=jpeg)
Guido von Rossum
...
![640?wx_fmt=gif](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/SAy0yVjKWywvq4Aff6E1TSyTplN8mCoyPyuZfTLa1bqTLv6S8x4IGyvAeuAXDEewFib53y6JJzxSMFX9xaytqNw/640?wx_fmt=gif)
IBM tape drive：读写磁带
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/SAy0yVjKWywvq4Aff6E1TSyTplN8mCoyibKia9IQb7CPiboGY0weuVk6Vd4g04E6PTFHMQ0Z89kbfWGDibPgrB4mZA/640?wx_fmt=png)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/SAy0yVjKWywvq4Aff6E1TSyTplN8mCoyCOZWC82fGUre1ibqrQPE5WYLlIH1synxZAMAXUheuryiaAhb4F3OvtEQ/640?wx_fmt=jpeg)
人生苦短，我用 Python
## 时势造英雄
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/SAy0yVjKWywvq4Aff6E1TSyTplN8mCoyy3v5dXDGmKcyJnxYtIc9Dy3UBHYDdMia45kcTrDEicKiaQsddOHqHlzkA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/SAy0yVjKWywvq4Aff6E1TSyTplN8mCoycG6WxW58rehCIdXyoKETUq2CfvUOFicpJIogHxaTicrmL3buouLlrxoQ/640?wx_fmt=png)
而且如果看 2002-2018 年 Python 的使用情况， Python 明显就是一个赤裸裸的逆袭爆发史呀。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/SAy0yVjKWywvq4Aff6E1TSyTplN8mCoyMeAgBg5PCmMkLNbK9ZTC9ibwEBAia1r2nZwicyZyoKI2BCGiaDze81kukA/640?wx_fmt=png)
我们把 TIOBE 排行榜中 其它编程语言隐藏掉就会发现 Python 语言的热点一直在震荡上行，特别是从 2017 年开始，呈现出爆发的现象。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/SAy0yVjKWywvq4Aff6E1TSyTplN8mCoyhHo0dBgvAAlCq5xSjwA3bEh2VnJ5bv8NPibyYCTwEgPY6xrKxGRryeg/640?wx_fmt=png)
**那么此时不学 Python ，更待何时？**
> 
文章来自公众号 python技术，大家如果想从零开始学习 Python，建议扫描文末二维码关注此公号。
本文主要参考：
https://zh.wikipedia.org/wiki/Python 
http://www.cnblogs.com/vamei/archive/2013/02/06/2892628.html
-END-
**Python 技术**
**从零学习 Python ，讲述关于 Python 的一切。**
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/SAy0yVjKWywvq4Aff6E1TSyTplN8mCoy8vNAtgC1ltRPHoPTgKwHv3DcwGEmCL0fTJRtqwkOH1I67JKff5PWjw/640?wx_fmt=jpeg)
