# “三次握手，四次挥手”你真的懂吗？ - 纯洁的微笑 - CSDN博客
2019年01月30日 08:36:00[微笑很纯洁](https://me.csdn.net/ityouknow)阅读数：917
...
为了便于整体把握文章，手动加上文章目录：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ASQrEXvmx62KVnLgwaciaGFFGGSfc7XjzyKYfzZCo3YyB9iaFX41KDyuVlLVhHPCFLs9aQVbOcHib6ibRtbMTEQ8Ig/640?wx_fmt=png)
## 什么是“3次握手，4次挥手”
...
## TCP头部
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7XjzDPHjW5zvf73u8L8amFh2JxBr7vS4gnDBzpJ3icgZSfEQspibFuKjQ6WQ/640?wx_fmt=jpeg)
...
## 状态转换
三次握手和四次挥手的状态转换如下图。
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7XjzNhibtxkibkXib0dZWUSf8DLagxF8qTd5jBZDaE4N4Kpt4B9iahZZbzDdSw/640?wx_fmt=jpeg)
为什么要“三次握手，四次挥手”
## 三次握手
换个易于理解的视角来看为什么要3次握手。
...
用表格总结一下：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7XjzUkRqpM7GFzYjuRkLCibH3TvUaOmruhDHRLX60RYPYHla6UgXgGfGiaJg/640?wx_fmt=jpeg)
## 四次挥手
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7Xjz97jV7x81fx1VYSIcx0MyVRo6z8hcpyufExsQGHN5w4flFQPgm8Wrcg/640?wx_fmt=jpeg)
三次握手
- 
...
## 四次挥手
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7Xjzn56ia4Cjib8icibsF3tEWdxtVJdMjYwdbTO2eDAOnNqzVpFmibgTrbzw8Vw/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7XjzF36m1kib74bJnzic58ppHxkGn3UoI2KrjvecQIdTtoRHspIvJn6EqWhQ/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7XjziawS8YqbM7ayQstjzZKvib61q95caqAMucaXbe8RmzrekNnqQSHxvFAA/640?wx_fmt=jpeg)
## 全连接队列满
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7Xjzgq5Ocnsy1ogG9OaDXRlKomqHQDKBBtoIE5dh1CbKsII6V2iaDZkic9iag/640?wx_fmt=jpeg)
## 命令
netstat -s命令
> [root@server ~]# netstat -s | egrep "listen|LISTEN" 
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ASQrEXvmx62KVnLgwaciaGFFGGSfc7XjzmBsqguI8UBs2gVNcHUtMxmsBIxOgoF8Czeiae1icIMpHpAux4QNcSbCA/640?wx_fmt=png)上面看到的 667399 times ，表示全连接队列溢出的次数，隔几秒钟执行下，如果这个数字一直在增加的话肯定全连接队列偶尔满了。
> [root@server ~]# netstat -s | grep TCPBacklogDrop 
查看 Accept queue 是否有溢出
ss命令
> [root@server ~]# ss -lnt
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ASQrEXvmx62KVnLgwaciaGFFGGSfc7XjzGIyI0Q3b7Y68gX4ys1AVlpCD94zEn8xtwRu8Azic5qlOuYmibDUicicVLQ/640?wx_fmt=png)
...
IP的数据格式为：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7Xjz7jiaiaSqSjyUqIAuurBZmShCHOw9eNHAxVibAMC0anUjpb2uWsYK3pRwQ/640?wx_fmt=jpeg)
它由固定长度20B+可变长度构成。
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7Xjzolw78D6McIynvWNFf5n645shZibqog9ZYAyabrzeZ55XxWU5QMpAT7Q/640?wx_fmt=jpeg)
剩余的数据部分即为TCP协议相关的。TCP也是20B固定长度+可变长度部分。
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7XjzDic6Ch3vU4QRBvgQ0YT54O9BXKgiatrKqCxhYvjAf1yhN6DV0ks3WDHA/640?wx_fmt=jpeg)
可变长度部分，协议如下：
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/ASQrEXvmx62KVnLgwaciaGFFGGSfc7XjzbXzC9JSKeCgGQbkZv2IDm81pkgHptA7jVo3avTkN2cdZgf1ZiaNia2Ew/640?wx_fmt=jpeg)
