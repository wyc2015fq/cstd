# Eureka 虽然闭源了，但注册中心还有更多选择：Consul 使用详解 - 纯洁的微笑 - CSDN博客
2018年07月20日 07:36:00[微笑很纯洁](https://me.csdn.net/ityouknow)阅读数：6956
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/PgqYrEEtEnq2h8QiaicAacfSDadkaFbxX395HyxnUcNnV2frJL2GMKwrAib4y2OeQUdK501ddPjOKsNdJ2721MLrQ/640?wx_fmt=png)在上个月我们知道 Eureka 2.0 闭源了，但其实对国内的用户影响甚小，一方面国内大都使用的是 Eureka 1.X 系列，另一方面
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/PgqYrEEtEnpIMibSBSxibibqGj2qvW8JtxoPBaV1RibUaUnZP7meREiaVX7iaKPfbicEkGhE3NdoVzyiciaDVG4SxBTfbxg/640?wx_fmt=png)
**Consul 工作原理：**
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/PgqYrEEtEnpIMibSBSxibibqGj2qvW8JtxoEjUB8ibTNqtaqzgnicK2KqQTDEWyKVNRVbvROglNic5hYOra60sJx60BQ/640?wx_fmt=png)- 
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/PgqYrEEtEnpIMibSBSxibibqGj2qvW8JtxoA409VCkmL4LKMeM7GXEkic215djrdbGktSAgGCQUBbicnuSkKuTwGEgw/640?wx_fmt=png)
我这里以 Windows 为例，下载下来是一个 consul_1.2.1_windows_amd64.zip 的压缩包，解压是是一个 consul.exe 的执行文件。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/PgqYrEEtEnpIMibSBSxibibqGj2qvW8Jtxop92hJLMrf1Un3fADF5hdmUvEWVhbRKz2RbicIibpu50ic9icbklnRNia7NA/640?wx_fmt=png)
...
```
启动结果如下：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/PgqYrEEtEnpIMibSBSxibibqGj2qvW8Jtxof745ib07ctiaGUIoiaOKGsMgkib2fWb1wFY8fszvAicXBhkm4OMTKOPouCw/640?wx_fmt=png)
启动成功之后访问：`http://localhost:8500`，可以看到 Consul 的管理界面
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/PgqYrEEtEnpIMibSBSxibibqGj2qvW8Jtxo5EoHdcv0e7PCFj025S6oMXEKN2sRiadagaCWDrsKHGpoGbxrsw2WCDw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/PgqYrEEtEnpIMibSBSxibibqGj2qvW8JtxovdInrjjKv5aA02zwMCrW6mydic6ZAVlytBIUo2FVd20PzTibpsXq1WBQ/640?wx_fmt=png)
我们发现页面多了 service-producer 服务，点击进去后页面显示有两个服务提供者：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/PgqYrEEtEnpIMibSBSxibibqGj2qvW8JtxoXvsOouUBgsuA08K9cnBInA4FMrcTUcW87oeCemldCiacTU3DicuDGjsg/640?wx_fmt=png)
这样服务提供者就准备好了。
## Consul 消费端
...
推荐阅读：
[阿里Dubbo疯狂更新，关Spring Cloud什么事？](http://mp.weixin.qq.com/s?__biz=MzI4NDY5Mjc1Mg==&mid=2247484256&idx=1&sn=a3eccb593195b6753749f10084bbaf8e&chksm=ebf6db1fdc81520967db536d290f703e9e458e4aa1a9319e0aff60f737c9033538bd4ce86855&scene=21#wechat_redirect)
[Spring Cloud在国内中小型公司能用起来吗？](http://mp.weixin.qq.com/s?__biz=MzI4NDY5Mjc1Mg==&mid=2247483976&idx=1&sn=8772578e5c096e0da99b32f3f005e05a&chksm=ebf6da37dc815321efa954e2e135c36ac2df91bd3b892a6b1a5f8f6726b01e8751c42479e420&scene=21#wechat_redirect)
[中小型互联网公司微服务实践-经验和教训](http://mp.weixin.qq.com/s?__biz=MzI4NDY5Mjc1Mg==&mid=2247484078&idx=1&sn=7e0eeb1865ec2d7af3dc42f14d0ea324&chksm=ebf6dad1dc8153c7d74f4e221a4bcd8a76be3d269d27f4537d891b6a0f79a7344c08134fc137&scene=21#wechat_redirect)
[从架构演进的角度聊聊Spring Cloud都做了些什么？](http://mp.weixin.qq.com/s?__biz=MzI4NDY5Mjc1Mg==&mid=2247484118&idx=1&sn=cd0b5768984a4ee95ff6b77a7186ab54&chksm=ebf6daa9dc8153bf9f9a1dfaf80ccabef7cae701e3b77010af5ed67821938407c7bd53927db3&scene=21#wechat_redirect)
END
