# 我为啥不看好ServiceMesh - 纯洁的微笑 - CSDN博客
2018年12月17日 09:09:00[微笑很纯洁](https://me.csdn.net/ityouknow)阅读数：313
### 前言
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmFrV0IicL1DHiaHsYJIWVcyxs2ZSHOlibfaMRPh2zLOl7hXlJo66mPyZPIyusIG5C9HfN6LfyWceGQiaQ/640?wx_fmt=png)
在微服务模式下，企业内部服务少则几个到几十个，多则上百个，每个服务一般都以集群方式部署，这时自然产生两个问题(如下图所示)：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmFrV0IicL1DHiaHsYJIWVcyxseBOjhefEUH7rWxJlTibmySVKJbia8VtqOAPiau7n0b6LT0eMNa5C1bsGg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmFrV0IicL1DHiaHsYJIWVcyxsMnRXERrUebOkTzn3j3ejCzibzQVsICdZ74DoyppMVKNV5HicGLzCwicqQ/640?wx_fmt=png)
在服务消费方和服务提供方之间增加一层代理，由代理负责服务发现和负载均衡功能，消费方通过代理间接访问目标服务。根据代理在架构上所处的位置不同，当前业界主要有三种不同的服务发现模式：
#### 模式一：传统集中式代理
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmFrV0IicL1DHiaHsYJIWVcyxsr1rGx5ib98N9G20looBePD7YuBQPsMnEPDIm7icbd4KRA2BjWC2jiccIQ/640?wx_fmt=png)
...
#### 模式二：客户端嵌入式代理
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmFrV0IicL1DHiaHsYJIWVcyxsWErkALUAUURLK3D02rTsBVMsmVHzBED9PBWPBGpLqCSkVMaPcs411A/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmFrV0IicL1DHiaHsYJIWVcyxsDUStK9s1vnG83YuqFODEOzLMUGudh7clmuUhsXH8CDJQhRORRMdcRA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmFrV0IicL1DHiaHsYJIWVcyxsBGDlQbiaZskia3SaBV5Eial3IRRuibbBgTPxibsO1EtBVAlf8cuicgRexb0g/640?wx_fmt=png)
### 服务网格ServiceMesh
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmFrV0IicL1DHiaHsYJIWVcyxs7Dv8712Pzm2WYIxKbTvpnIKfqIDeicr4iaSQr54LicfdWzvpXUTTHhzUw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmFrV0IicL1DHiaHsYJIWVcyxslC3YM4UyEjI7ePe4iaiax5gquUuwEzrMbuLMsgxcIPyatpds2RaFqM4w/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmFrV0IicL1DHiaHsYJIWVcyxsl2kEORofPDZDOhTSwg6CcdZBlyv9LmWibZkJUrKCAVWJsbTxtOjFzBQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/ELH62gpbFmFrV0IicL1DHiaHsYJIWVcyxsIqLepW5HVYcDtl2jOsj9ebXwUCPY495icMNtlSJMIxRbZu5scaMuMGg/640?wx_fmt=png)
