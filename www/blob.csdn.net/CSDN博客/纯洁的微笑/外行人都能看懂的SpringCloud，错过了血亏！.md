# 外行人都能看懂的SpringCloud，错过了血亏！ - 纯洁的微笑 - CSDN博客
2018年09月03日 08:08:00[微笑很纯洁](https://me.csdn.net/ityouknow)阅读数：505
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/PgqYrEEtEnpLzflUWC5gXiamrEqbtE48gYBHj50ROCQtxY05ibIKXssbBAK4hSx5fgzOPJX0ZOqp3AeCP2blQpbA/640?wx_fmt=jpeg)
作者：Java3y
来源：本文转载自「Java3y」
# 一、前言
> 
...
项目结构图：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib0aUepenD2v17yE28XxYq0elkTajN8sHUjKv7JxDZORYxvNgYRcrbjQD4BwRIaklk01TO2YWTQFvA/640?wx_fmt=png)
# 二、集群/分布式/微服务/SOA是什么？
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0sywl0k9oteicfTrJEJyHibMJ2hF9mIykyTrnCNgQfJaO7OOfV8aj876A/640?wx_fmt=png)
由于我们的系统是分布式的，节点之间的通信是通过网络来进行的。**只要是分布式系统**，那很有可能会出现一种情况：因为一些**故障**，使得有些**节点之间不连通**了，整个网络就分成了**几块区域**。
- 
数据就散布在了这些不连通的区域中，这就叫**分区**
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0ePdtv4K0F39YTStF2icicOIVNXgNB11H3cI63HNX2ZG0CFiaLZoS6lKDA/640?wx_fmt=png)
现在出现了网络分区后，此时有一个请求过来了，想要注册一个账户。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0awjlYGDKVia3RZa61QznX0WmKibL7xyXibfrXMTXAoaTus0vkoX4r1TvA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk08mia6ySoaTdCIs6aoq4pV26ID8iaQSwxauMxHnsrXSMCntaicqWwG4kaw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0ryex4kobYf2nia6TglIXBulXav0E3aWrcJfpicO5uapDXQPNWSZ3HedA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0NzmM4yZ7MNgq88wZQEHaD4w1aicQW6QUmCueicQISZVQ4BbibLzJWSarg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0Xt8p1JoZPOeo7Y4dupk1tuScS825TyBiaCbELPiaH4DnGxLGVWJEN2MQ/640?wx_fmt=png)
## 5.1Eureka细节
Eureka专门用于给其他服务注册的称为Eureka Server(服务注册中心)，其余注册到Eureka Server的服务称为Eureka Client。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0l2micT3S80zqo7O5ezxHEIISO8TqxKmgnCvR0f4RmunKH67HYV7eCXw/640?wx_fmt=png)
...
最后，我们就有了这张图：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0icnXYvabdAQ4ZxATlpxA5QHT1t6X99mUPUuV2ZOCwiccmS8tcPqcCNNg/640?wx_fmt=png)
举个例子：
- 
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0fTgZ6MicsJibhz0bBrJIaE8pAyiakzKFhTuI54QSr9u9W4icF9xDIeCibow/640?wx_fmt=png)
...
所以，我们的图可以画成这样：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0Z2q2YOsTrTwSWhtfiaBwAc0Picx09FQD3EdSuicGA72JibhzA1JxOUUaTQ/640?wx_fmt=png)
## 6.1Ribbon细节
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0U36sg52ktURnpRWwzYesOWVdCf4lpb6nqYI9GgIiauMfTKh5UFyAqLQ/640?wx_fmt=png)
但是，如果我们在**调用多个远程服务时，某个服务出现延迟**，会怎么样？？
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0MOuD1Xwe84qz0zxnFK0IzQq1YaLNxpLEaaO3mLSLxfGDkq2YvF5qjg/640?wx_fmt=jpeg)
在**高并发**的情况下，由于单个服务的延迟，可能导致**所有的请求都处于延迟状态**，甚至在几秒钟就使服务处于负载饱和的状态，资源耗尽，直到不可用，最终导致这个分布式系统都不可用，这就是“雪崩”。
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0UcdNDRAic4CD57KRRibicEfOAqyFonY6ibrSftIlovLNcW8wvzdBib8sXtA/640?wx_fmt=jpeg)
...
启动时的页面：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0OZ5PChyxecD6wdwG773rew85S6jyV597G1S4pia7ZVO6UbpDt5pIbuQ/640?wx_fmt=png)
**监控单服务**的页面：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0dkwhSgREFb2Y8qKjIq2nBJsYibHbWczuJ9uC9cnWtgpniaYlicho8icricg/640?wx_fmt=png)
我们现在的服务是这样的：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0O14YJIyfDftdatpia5ZWjzULMdfT74tJIQZS1N2U3dIaXe7PeqPUhtg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0E04HEKaWg2bGJZZicmGbkNw6wh7yByokicaHtTQyJnH29jFFibe4lBCrQ/640?wx_fmt=png)
举个例子：
- 
...
```
调用：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0wS2ZdEFAobePJkXcXRP4bYL3DoT9PZib7icHcyaad3szIvmgMPDib5XSw/640?wx_fmt=png)
# 九、引出Zuul
基于上面的学习，我们现在的架构很可能会设计成这样：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0VDlibFvyibImkyNDKS5lKPyGYDd7XicJ2FDBjQqSztISVafyfIglNqiasQ/640?wx_fmt=png)
这样的架构会有两个比较麻烦的问题：
- 
**路由规则与服务实例的维护间题**：外层的负载均衡(nginx)需要**维护**所有的服务实例清单(图上的OpenService)
- 
**签名校验、 登录校验冗余问题**：为了保证对外服务的安全性， 我们在服务端实现的微服务接口，往往都会有一定的**权限校验机制**，但我们的服务是独立的，我们**不得不在这些应用中都实现这样一套校验逻辑**，这就会造成校验逻辑的冗余。
还是画个图来理解一下吧：
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0OCjTgJkyc5IvJKEYQde8eRjOsHgvGwUqH5maB7jT3HxJausAAfw8eA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0WmbWIhLLVCarU541BpIHXiaTtxPKLKFWwbgwELjcgN6hgnYFGmVqdwA/640?wx_fmt=png)
或者可以这样理解：
- 
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0TGZuOfmyicKCOb962ay2EPicfZYO4oDibUa4Ozeglm2BibIde8K7NL0rDg/640?wx_fmt=png)
> 
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2BGWl1qPxib3LiaOIcUWPt6eU6UmOJhnk0FuPfID8JbUJosribKtObbhwFPZ3layI0Dd12s2wFmyIaiaoEfia8nMLqw/640?wx_fmt=png)
