# 我来告诉你，一个草根程序员如何进入BAT - 纯洁的微笑 - CSDN博客
2018年07月05日 07:36:00[微笑很纯洁](https://me.csdn.net/ityouknow)阅读数：8675
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/PgqYrEEtEnokkhibyVzCdlQC2Srp4StmQicJhGVEWOBYe4x7mibOiaScs6Mpic7hnN3UvWO5fLL1P8QZ3Tks7hd6eKg/640?wx_fmt=jpeg)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/owvKmkcJ1Xlgwh8Q6s7dYyNic7Z82UIYJcoykI4MDLfEEP3ybP1Ozj5CT6ObmPwGAggxXnEoH3CIiah4DhiaRcXyA/640?wx_fmt=png)
**学习**
...
关于设计模式LZ这里就不多做介绍了，关于反射，其实就是reflect包里的内容，这个包里的类其实并不难，主要是得多用，多看。比如Java领域里最常用的spring框架，里面其实大量充斥着设计模式和反射的真实使用场景，没事多研究一下，绝对让你受益匪浅。
...
**6）小结**
好了，到此为止，基本要求就差不多介绍完了。没错，其实基本要求这部分，差不多就是要求你有扎实的Java基础。这也是所有一线互联网公司，基本都会写在招聘要求地前几条的要求。
...
接下来，LZ就带大家一起来看一下，都有哪些可以加分的部分，需要强调的是，这些加分要求中，在某些特殊情况下，可能会成为基本要求。
**1）数据结构与算法**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/owvKmkcJ1Xlgwh8Q6s7dYyNic7Z82UIYJf1hcymr3BRx3anRaNhLibibfFgXbKVxTI7gsREvic1wM19vDsVVibw5wicQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/owvKmkcJ1Xlgwh8Q6s7dYyNic7Z82UIYJ2iarb2CSUOVPxgCQ1JLwT6mQDhvM5OFKeptpeuA5I8PlW63zaBZtyEg/640?wx_fmt=png)
...
> 
原文出处：http://www.cnblogs.com/zuoxiaolong/p/life54.html
END
