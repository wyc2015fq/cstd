# 机器学习萌新必学的Top10算法 - 算法与数学之美 - CSDN博客
2018年04月10日 00:00:00[算法与数学之美](https://me.csdn.net/FnqTyr45)阅读数：66
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxAlHEYKL3uacmerV9IUIZficzqGbphfYHNUX31gqJaEJLKDibia9yBgRfianBfoh2GOhPo5o56Ibwiadw/640?wx_fmt=png)
比方说，y = B0 + B1*x
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxAlHEYKL3uacmerV9IUIZf5FVj703vyLhmJNmJ9MdKicXrjumScZGIGV6P5vlVdVlOmVJP4bg4VuA/640?wx_fmt=png)
###### **△** 逻辑回归
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxAlHEYKL3uacmerV9IUIZfQw9Vib1ia8o84WXh4kZq1KVaY5wotN8u4QANNmXOq3dRhO7vj8OMyhKw/640?wx_fmt=png)
###### **△** 线性判别分析
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxAlHEYKL3uacmerV9IUIZfZ5Ae99z6yQJFjmWZHiaPcBPNVsicGaQZxOm1n68Wibtnn9kMfM6gVNFyA/640?wx_fmt=png)
###### **△** 决策树
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/YicUhk5aAGtBu1KvjWeMvfdAobXEDFqGnOGng7fDJCAIToR6jficAexhYo13IBAwBGKeAGvoxCWOqib9Wpx8xRqibw/640?wx_fmt=png)
###### **△** 贝叶斯定理
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxAlHEYKL3uacmerV9IUIZftQMMLQCsficrIZFlIIOJuBXAndvRrlaJnz7HMRyZruNIQRt65LsNPsg/640?wx_fmt=png)
###### **△** 最近邻法
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxAlHEYKL3uacmerV9IUIZfBnE12n14UdQ3hygdUXYR4XiaFXWWwUkwCzVTHYVJ92wqJN519aQg9Rw/640?wx_fmt=png)
...
SVM的学习目标就是要找出这个超平面。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxAlHEYKL3uacmerV9IUIZfJFR8Vibpuia1wvtVH2L8Ihh9ro8oW05eCU6eInbjHugoiclWxf1IQjGsw/640?wx_fmt=png)
###### **△** 支持矢量机
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxAlHEYKL3uacmerV9IUIZfvNb5cu9WrsC2GPOaSU9LYAnsZABYXXvs7XoS1wHGibYCm1xHyOAP1Xg/640?wx_fmt=png)
随机森林在这个基础上稍微有点变化。
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxAlHEYKL3uacmerV9IUIZfbAx0rl0st61PVkGofO4yTQiaB1Jb7Ot4pE0sicOWV3xU8ZPJztZbqvKg/640?wx_fmt=png)
AdaBoost适用于短的决策树。
