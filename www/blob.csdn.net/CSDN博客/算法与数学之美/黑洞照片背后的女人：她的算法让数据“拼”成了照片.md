# 黑洞照片背后的女人：她的算法让数据“拼”成了照片 - 算法与数学之美 - CSDN博客
2019年04月17日 21:00:00[算法与数学之美](https://me.csdn.net/FnqTyr45)阅读数：30
...
北京时间4月10日21时许，数百名科研人员参与合作的“事件视界望远镜(EHT)”项目发布人类史上首张黑洞照片。在这张黑洞照片的背后，不得不提到她——加州理工学院助理教授凯蒂·博曼(Katie Bouman)。美国有线电视新闻网(CNN)称，没有她在算法上的努力，就不会有这张黑洞照片。
据美国有线电视新闻网4月11日报道，三年前，26岁的博曼还是麻省理工学院计算机科学和人工智能实验室的一名研究生，她领导创立了一种成像算法。最终，科学人员使用了包括博曼在内的几种成像算法，把望远镜中的数据“拼”到一起，这才有了这张珍贵的照片。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxuw9etgBoq26jRNsXfXSHq3tvqaJYBPKRY2qib1MAAbSRBa6j1RDJibShmY4GS6ydgyOUjhFxTBe2Q/640?wx_fmt=png)
**(CNN报道截图)**
据CNN报道，黑洞距离地球非常遥远，因此，拍摄黑洞照片并非易事。此外，根据定义，黑洞应该是不可见的，尽管它们在与周围物质相互作用时会释放阴影。“事件视界望远镜(EHT)”项目收集了大量关于室女座超巨椭圆星系“M87”中心的超大质量黑洞的数据，这些数据的处理并非易事。
报道中，博曼提到，““我们开发了多种合成数据的方法，并使用不同的算法进行盲测，以寻找恢复图像的方法。我们不打算只研究一种算法，我们希望研发出许多不同的算法，它们都建立在各自的假设之上。如果它们都能恢复出同样的照片，那么你的信心将会建立起来。”
在接受CNN记者采访时，麻省理工学院海斯塔克天文台的研究员称，博曼是其中一个成像团队的核心人物，她给了我们很多灵感。他还表示，像博曼一样的初级研究人员，为这一项目做出了重大贡献。尽管有很多高级研究员参与项目研究，但成像部分主要由以研究生和博士后为主的初级研究员完成。
对此，博曼表示，我们中没有人能够独自完成它。项目之所以能够成功是因为来自不同背景的人汇集到了一起。
**————**
编辑 ∑Pluto
来源：搜狐新闻·环球网
**更多精彩：**
