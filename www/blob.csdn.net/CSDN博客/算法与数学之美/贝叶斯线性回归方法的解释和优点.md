# 贝叶斯线性回归方法的解释和优点 - 算法与数学之美 - CSDN博客
2018年05月11日 08:18:10[算法与数学之美](https://me.csdn.net/FnqTyr45)阅读数：1936
...
![640?wx_fmt=png&wxfrom=5&wx_lazy=1](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsdicAbuAQ5pgia3RKS9tFciacvRpG4layJ7ibkgnqia1eHkUibW0HJsf1kkWlQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsdbGdw8YBz7GibF4ByN9ibPdnPztRw8ZKxsJAf2Ffno7o3l9psiaSoQJ2gA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsdAMtaibfj1Qk0Ueo0lLRTHickLiappGVdkYGdH1dK599CHY9H1OF9xpvhw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsd2DKo1ekpibRXtKfD39BJfbS5VbRqjomBwwfQCiayEtz5icjcO0j1Dl8wA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsdWgSrSMNUBvFjTrjw8VYhoVt0t5X9R4qsxLKDsGAAsQKfzPcibwJwXbg/640?wx_fmt=png)
举一个最小二乘法的例子，我们可以对真实世界中的数据进行线性回归，数据中包含对 15,000 次运动的持续时间和燃烧的卡路里的观测值。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsd92ZPibxtbxels28uDVkkibxT5aghTTPtVQ0JsJkq0xiaROjyQYGAicLPGQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsd1r9W6ricjaRQbicXCMYKL4cxWYlMShVT4mqr6UW49ib7owoBvYVWZp4yw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsd3C0pO9ItPBich0wOQMdkzeqUXbRtsx9UXVR2gYCMk7gY8tLzV0vDoqQ/640?wx_fmt=png)
其中，P(β|y, X) 是给定输入和输出时的模型参数的后验概率分布。它等于输出的似然 P(y|β, X) 乘以给定输入的参数 β 的先验概率 P(β|X) 并且除以归一化常数。这是贝叶斯定理的一个简单表达形式，是支撑贝叶斯推断的基础。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsdoXPo0Syfs2wJgdicPTtqlbmTPoTu2PWfzlVl1Tyagy3k048eqYqibojQ/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsdicurkYpT9SDS9Ofd9o5sOYUIibfl93ESD5U5I7IJylg666wsDP0pmmGA/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsdA9n6Hmwmsx96N5D6mPDfobKia4j7ibXkticwIbn7AaLbzcbPVeQwRL6ibw/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/KmXPKA19gW9zgrU2v6kd3F1yZV5TxOsdSLeJ5HVn4MvKicyIXB0IAQIAVTnbCPxThOhCFySicIfUvHHC3EULlkhw/640?wx_fmt=png)
