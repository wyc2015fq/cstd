# 人人都能读懂的编译器原理 - 算法与数学之美 - CSDN博客
2018年11月18日 21:36:41[算法与数学之美](https://me.csdn.net/FnqTyr45)阅读数：96
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkwHndN2uoqRPb9Yb1VnB5wwP2ic8iaE6RDlROHdfk5g5Wpllvs6UktCuLCpib8V7OImutvXldKtfOkLw/640?wx_fmt=jpeg)
### 解释器是什么？
解释器 非常像编译器，它也是读入编程语言的代码，然后处理这些代码。尽管如此，**解释器会跳过了代码生成，然后即时编译并执行 AST。**解释器最大的优点就在于在你debug期间运行程序所消耗的时间。编译器编译一个程序可能在一秒到几分钟不等，然而解释器可以立即开始执行程序，而不必编译。解释器最大的缺点在于它必须安装在用户电脑上，程序才可以执行。
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkwHndN2uoqRPb9Yb1VnB5wweicKziau6ayH1M5xXFGLphmGicW5LJdP93DVoDVicX5kjxBYYP169OsH1w/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkwHndN2uoqRPb9Yb1VnB5wwsP7FWCI7xhzibRicW9cd0HJI4ia5LLic7ILgTQlbuzO7AQd9v6NNuhiadnQ/640?wx_fmt=jpeg)
**解析 12+3 产生的样例 AST**
...
![640?wx_fmt=gif](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkwHndN2uoqRPb9Yb1VnB5wwEarAlIGAGWJr1cDehxJYSxY7zTlWUXNmKGk272ZGxAH9VECf3rV0icA/640?wx_fmt=gif)
> 
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkwHndN2uoqRPb9Yb1VnB5wwtZJRUMgAkjlHaXk1QHFQWvYCWftBGl0pkRKIJdf1ZDhTxMnO4VynLA/640?wx_fmt=jpeg)
