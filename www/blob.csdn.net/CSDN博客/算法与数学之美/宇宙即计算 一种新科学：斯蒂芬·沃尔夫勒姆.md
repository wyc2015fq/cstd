# 宇宙即计算~一种新科学：斯蒂芬·沃尔夫勒姆 - 算法与数学之美 - CSDN博客
2018年11月25日 22:08:51[算法与数学之美](https://me.csdn.net/FnqTyr45)阅读数：169
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibO9K9WC8qr0rhHmB9X0NA8Fzr5JCefLcI8JsIlCumXJsWibtMf4kf7kZQ/640?wx_fmt=png)
**斯蒂芬·沃尔夫勒姆**这个名字，在中文世界里可能远谈不上家喻户晓；但他的英文名**Stephen Wolfram**恐怕反而却要熟悉得多。
他是**Mathematica**软件的发明者和首席设计师，被广泛地认为是当今**科学和计算技术中最重要的革新者**之一。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOjjh7kne2OTg002vLYEZ2R8gPMtgPKVXEwWOsciawYnQTXkxCHHUGtcA/640?wx_fmt=png)
**　　大名鼎鼎的数学软件Mathematica每次启动的时候都会提醒你这是Wolfram出品**
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOJib4Z5EuVG2ga8XjjFgrsynFrzR7gt3PGN27cqxbdkIgzsGveAuAhhg/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibO4icG6XbibtrRj2VRK2ND5pOYMgdf6cpPw29QccHVicQfLRh68g326E0aQ/640?wx_fmt=png)
...
**![640?wx_fmt=gif](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_gif/qX2AoDIKJ2VAznGDcic8aufvM0RDafq5iamOIHNYHlXl5WoK9G6I6jRkZeicLia3tDxEicwj9K6sAbuo6mBGgSL88PA/640?wx_fmt=gif)**
...
今天，苹果的 Siri 和三星的 S Voice 智能助手在回答问题时，都或多或少地得到 Wolfram Alpha 的支持。此外，微软的必应搜索引擎也在一些方面采用了该技术。 Wolfram Alpha 也被认为是可能实现**强人工智能**的未来产品。
...
![640?wx_fmt=gif](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_gif/qX2AoDIKJ2VAznGDcic8aufvM0RDafq5iaEMwkCtYLGtM2SJDpwZeicUDiaTd2LHclMEmPuMZZ8vItv2BO6T6mUsmA/640?wx_fmt=gif)
"脉冲星"：它的周期为3，看起来像一颗周期爆发的星星。
![640?wx_fmt=gif](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_gif/qX2AoDIKJ2VAznGDcic8aufvM0RDafq5iaN3nPzoj1A2FXjE3UAHe3BX48Rs4bZRFnk7WAa10Qqg6ibrCx92IpFug/640?wx_fmt=gif)
“滑翔者”：每4个回合“它”会向右下角走一格。虽然细胞早就是不同的细胞了，但它能保持原本的形态。
![640?wx_fmt=gif](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_gif/qX2AoDIKJ2VAznGDcic8aufvM0RDafq5iaybkibnkK2jE7SPaV471MqxjgMDNvHvZ5b38glo9C4owG36re03L8DKw/640?wx_fmt=gif)
![640?wx_fmt=gif](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_gif/qX2AoDIKJ2VAznGDcic8aufvM0RDafq5iaybkibnkK2jE7SPaV471MqxjgMDNvHvZ5b38glo9C4owG36re03L8DKw/640?wx_fmt=gif)
“轻量级飞船”：它的周期是4，每2个回合会向右边走一格。
![640?wx_fmt=gif](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_gif/qX2AoDIKJ2VAznGDcic8aufvM0RDafq5iallLa7g4ia4evKyAjfibwWcQ93Wfv9dqibVwOTEFIbcl8iarCmw4icLo7m2Q/640?wx_fmt=gif)
“滑翔者枪”：它会不停地释放出一个又一个滑翔者。
![640?wx_fmt=gif](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_gif/qX2AoDIKJ2VAznGDcic8aufvM0RDafq5ia2Y87NbiaFttrABJRib2EG4qDZxROG9icNpiccFSxRWrJPF2XAnMhFXyJ7Q/640?wx_fmt=gif)
...
可是**沃尔夫勒姆却觉得自己发现了某种本质的东西。1983年，他做出了自己最得意的发现：“Rule 30”。**这是一套规则组，处理的是更加简单的一维细胞自动机，每一次迭代的产物变成新的一行打印在下面。可是，从一个活细胞出发，它却生成了一套极其复杂的无尽花纹；后来Mathematica里使用的随机数生成器，就是基于Rule 30的。（顺便说，用Rule XX指代一维细胞自动机的规则组，这一用法是沃尔夫勒姆首创，沿用至今。）
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibObBaJKsvapYgWIBGGP7NDoKOt2J6R4JicYZjzjIEdrYtexbroxpgH2Fg/640?wx_fmt=png)
Rule 30的全部规则，以及从一个黑点开始的迭代结果。每一次新的迭代就是新的一行，而每一个细胞的死活由且仅由它自己和它左右两侧的细胞在上一行的状态决定。之所以是30，因为按顺序排列的二进制数00011110对应的十进制就是30。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOs8FPOrgN2zJbYqWjsDdUVKAsTYELqu9wBGjfXaicxVfw5qWicibRDXSrA/640?wx_fmt=png)
**250次迭代后的Rule 30。左边缘看起来还有一定规律，但大部分区域看起来近乎是随机的。**
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOyPLxgLxF3KYoLKnjqO5NTFuuZSGP8xpjTuD3lRR4uMo4icU3Hiava0ew/640?wx_fmt=png)
**织锦芋螺（Conus textile）的花纹神似Rule 30的结果**
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOwR4UYA5tC8KbGFwuniasRJ6DbJU8CpEO8tdE2Fr88mxm3ohjNV5Sdkw/640?wx_fmt=png)
...
其结果，就是**Mathematica和WolframAlpha，还有一本名为《一种新科学》的奇书。**
在这本引发巨大争议的书里，沃尔夫勒姆完整地阐述了他的世界观：**自然界的本质是计算，但计算的本质必须用实验探索**。过去的研究者要么使用纯数学去研究计算，要么把计算看成工程的工具。但**沃尔夫勒姆认为，我们需要从经验出发、为了计算本身而探究计算，这是一种新的路线**，书名也因此而来。
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2xTowg6u9NlyxiaOTskX3dicY71LrGjlkpmnHViah642AyNzr7pU1u9TmrgMibhLiahoTSClhb3g97gTMicg42FMQZCQ/640?wx_fmt=png)
**我们能为宇宙建立一个完整的模型吗？我的工作假说是‘能’。**
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2xTowg6u9NlyxiaOTskX3dicY71LrGjlkp8UIvzqtUmguCdl8OXjf4BE40XRoTfjklmF5fDWLVTriaMTiaV2yhJZew/640?wx_fmt=png)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOUACwklPNxwaib0sz4fsiaU1iccyMFK8z3Gia7s3Tu3yM1HrTjyiaah25V2Q/640?wx_fmt=png)
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2xTowg6u9NlyxiaOTskX3dicY71LrGjlkpmnHViah642AyNzr7pU1u9TmrgMibhLiahoTSClhb3g97gTMicg42FMQZCQ/640?wx_fmt=png)
**模仿人类，既是错误的路线，又是唯一可行的路线?**
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/2xTowg6u9NlyxiaOTskX3dicY71LrGjlkp8UIvzqtUmguCdl8OXjf4BE40XRoTfjklmF5fDWLVTriaMTiaV2yhJZew/640?wx_fmt=png)
**科学人：**我们之前采访过**侯世达**。对于他的人工智能（AI）路线——遵循类比、模仿人类思维——你怎么看待？
...
**沃尔夫勒姆：**这是个好问题。水有向下流的“目的”，你可以为物理世界赋予各种各样的“目的”，但**所谓的目的其实有两种，一种是遵循物理机制自然会产生的结果，另一种则是努力要去实现的目标。**
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibO9uGmMrIq8ibn784mSiahObwZa4MraOARFCHKibpRjcxHRcnShG9ibqibZ2g/640?wx_fmt=png)
