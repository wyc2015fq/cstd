# 初中物理史：以科学家名字命名的单位（强烈推荐） - 算法与数学之美 - CSDN博客
2019年01月30日 21:30:00[算法与数学之美](https://me.csdn.net/FnqTyr45)阅读数：69
**1、力（F）的单位——牛顿（英国）**
简称：牛   符号：N
人物成就：牛顿第一定律（惯性定律）、万有引力定律、光的色散。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOcqb3Zzr2kEicJW7U3PUdRZAMg9PmeC7djVZZ0wnkjNQcWm5sZQxUjibw/640?wx_fmt=png)
**2、功或能量（W）的单位——焦耳（英国）**
简称：焦   符号：J
人物成就：焦耳定律。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOY63Z3pTvWD1wvVFrGeloImxCpFhCJ3DLURWGicc9pd4UeABb0pR6bGw/640?wx_fmt=png)
**3、电容（C）单位（高中内容）——法拉（以法拉第命名，英国）**
简称：法   符号F
人物成就：发现电磁感应现象。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOF7XibH50hIrLh7tFWVGVUGVrQnJQQbDUXLGUH5Eu9xDG0uUJbS6dicyg/640?wx_fmt=png)
**4、压强（p）单位——帕斯卡（法国）**
简称：帕   符号Pa
人物成就：帕斯卡裂桶实验。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibO1MRKotoFFESDQIhoZoaGUblibC0yUw7CraX9Qpfa6qkkqSlogudKU1A/640?wx_fmt=png)
**5、电流（I）单位——安培（法国）**
简称：安   符号：A
人物成就：安培定则。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOUfrTs1wicpmBXiaRLtUt5vpPSiaKKT6RAlIRiaaGojLQjFQIXNlwgyBGAA/640?wx_fmt=png)
**6、电压（U）单位——伏特（意大利）**
简称：伏   符号：V
人物成就：发明了伏打电堆。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOuZ3GVVSJWoic4hnwS65KCstfCsAsF6zzvnFe7vod0AxaT5O9HZflH6w/640?wx_fmt=png)
**7、电阻（R）单位——欧姆（德国）**
简称：欧   符号：Ω
人物成就：欧姆定律。
**8、功率（P）单位——瓦特（英国）**
简称：瓦   符号：W
人物成就：改良了蒸汽机。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibOkVyIPfMakqkBSnjRLWmxwZAY8ZfXj9IWXO9CouzXK95pIWm7IoD9wQ/640?wx_fmt=png)
**9、电荷量（Q）的单位——库仑（法国）**
简称：库  符号：C
人物成就：扭秤实验、库仑定律。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibO6kKzYXm9MKPTnI635Cu6sybfxL2ls4fKiaq303QoPw1VYziabMLeTVpg/640?wx_fmt=png)
**10、频率的单位——赫兹（德国）**
简称：赫   符号：Hz
人物成就：证实电磁波的存在，测出电磁波速度。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/951TjTgiabkxxia5afgYkkLj1ALkYfr1ibO8KXLOd0sMCibYJx3etBascUIYs25bbhRnSNCwzwUdvyxFjuxPwylmibQ/640?wx_fmt=png)
∑编辑 | Gemini
*来源 | 今日头条*
