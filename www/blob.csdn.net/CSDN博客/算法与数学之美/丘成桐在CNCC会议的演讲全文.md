# 丘成桐在CNCC会议的演讲全文 - 算法与数学之美 - CSDN博客
2017年11月01日 00:00:00[算法与数学之美](https://me.csdn.net/FnqTyr45)阅读数：490
**丘成桐演讲全文**
*来源：雷锋网*
...
![0?wx_fmt=jpeg](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkyCzWRJkicvwKZNz0MicpOia7YOIDDNf72rfvlHqiaPDycHYUuJCIB2QzAK2j1W3Xeia4p8jX0OXlUUoGA/0?wx_fmt=jpeg)
...
![0?wx_fmt=jpeg](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkyCzWRJkicvwKZNz0MicpOia7YR6ET4WRNGT0eyNz8sFo4l0pYtzDllWK85Y63kFq9XiaS7icuH0kxIdhw/0?wx_fmt=jpeg)
...
![0?wx_fmt=jpeg](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkyCzWRJkicvwKZNz0MicpOia7YLqDwibiatic3myWmMtgO5nfWTR1Lahiao44qkyx6ERcDXCuKfiaprypJf6A/0?wx_fmt=jpeg)
...
![0?wx_fmt=jpeg](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkyCzWRJkicvwKZNz0MicpOia7YY0vUDMEgiamCmdFL52tHhiceavLsvMemHVxdgcrMnIpLtScNdcKO2V0g/0?wx_fmt=jpeg)
因此，我们可以用来追踪表情，表情捕捉。一个人他在笑、在哭、在种种不同的表现的时候，我们能够得到他的重要的面部特征，主要的方法就是我们将它映射到平面上，然后用共形映射或拟共形映射来研究它。这些都是很重要的数学工具，在计算上也有很重要的应用。
![0?wx_fmt=jpeg](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkyCzWRJkicvwKZNz0MicpOia7Yg79JFcTylsIecCZFbLXaPfufOH2ubwslxtiaCym1ZPia1aLDXibsiaudeQ/0?wx_fmt=jpeg)
...
![0?wx_fmt=jpeg](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkyCzWRJkicvwKZNz0MicpOia7YdzwCz25v0Ch2qOVpUXTuwojuluYOXRadSia7lvq5iahMWoAicJc3ZkxoQ/0?wx_fmt=jpeg)
这是在一只兔子上找到的好的网格。但是**这个网格会产生一些奇异点（拓扑学的缘故）**。针对这些奇异点，我们就做了一些研究，得出了很好的结论。
![0?wx_fmt=jpeg](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkyCzWRJkicvwKZNz0MicpOia7Yb8TbPUVtSRA4dtWAhWibKicIfp2og2RT4KmyYMjRl6jFnUG6hWWicDJqg/0?wx_fmt=jpeg)
再比如，我们看这个曲面，在这个曲面上我们画出一些叶状的结构，可是它也有一定的奇异点。我们将这些奇异点分类，得出了一些在计算机科学上有意义的结论。
![0?wx_fmt=jpeg](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkyCzWRJkicvwKZNz0MicpOia7YykmZH1lyHn0pXmR3PFqw1ojDYr34xOrFr3UMAy6EwrI1IgIAg7SIUA/0?wx_fmt=jpeg)
...
![0?wx_fmt=jpeg](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkyCzWRJkicvwKZNz0MicpOia7YGT5DQClkuBTvqjuvckric8fALcOsElHjB7jEibj9Hm7lwyx8bO1ZuxWw/0?wx_fmt=jpeg)
举个例子来讲，有个概率分布u，u是基本的白噪音，影射到右手边的图片，一个概率分布v。我们从映射里看到GAN的问题其实就是：在两个概率分布u和v之间，找到一个最优的传输映射，从一个空间到另外一个空间，**使它的概率分布是保持的。**
![0?wx_fmt=jpeg](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkyCzWRJkicvwKZNz0MicpOia7Y7YibwxZa3mcv6Gfw2SgsXBTxMY0uia7zwXFqVeBZoCBymCk9TpMF4icIA/0?wx_fmt=jpeg)
...
![0?wx_fmt=jpeg](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkyCzWRJkicvwKZNz0MicpOia7YLew1Vy2ATbmMFFakh6VO8lzQNX8Dqz01aabq8sle84CuanicichlCqKA/0?wx_fmt=jpeg)
...
**![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/951TjTgiabkwrxfE9icNpY3mVX2xk6Zr1lQDiaYSCLpedgfWutg5JsfXhov8DoeLjFNCXUeJkEMib1oGEmkT0QyeNw/640?wx_fmt=jpeg)**
