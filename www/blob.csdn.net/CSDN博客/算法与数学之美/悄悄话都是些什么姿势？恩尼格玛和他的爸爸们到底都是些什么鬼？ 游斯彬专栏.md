# 悄悄话都是些什么姿势？恩尼格玛和他的爸爸们到底都是些什么鬼？| 游斯彬专栏 - 算法与数学之美 - CSDN博客
2018年04月09日 00:00:00[算法与数学之美](https://me.csdn.net/FnqTyr45)阅读数：108
 （定场诗）
伤情最是晚凉天，憔悴斯人不堪怜；邀酒摧肠三杯醉，寻香惊梦五更寒。（此处应有赞美声）
>>>> 
![640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFF6UicjRhYKP0flUrrfmoE3rNiaIIReXYaicLVDcSZ95f7icQGqVPNYdahAA/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1)
...
![640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1](https://ss.csdn.net/p?http://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFhKggycaJ2IibF3uCQKokZDok0razSvJicWGJ5pHDKbay35BLjcsLU1Sg/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1)
“恩尼格马”是个什么东西呢！人类历史上首台密码机，而且是“数千年来加密技术的大成者”！融合了各种古代密码加密系统的精髓，所以在说他之前，还得聊聊他的爸爸们。
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFPPs30o3C0pu1ruAh4aedLIPVUjjCfmUxRfIpSbua6rDXhTGWlU5MWQ/640?wx_fmt=jpeg)
加密系统的本质，就是“单向函数“，信息x被加密变成密文y，本质就是信息x经过函数f的变换变成了密文y，就是f（x）=y，函数f也称为密钥。但对于有效的密码的要求是特别的是，必须要求反函数不可求，不然就破译了。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFF49F59otGTicfF2TnpugF4eMCHiar0hu9JeYlqbV4MtolYfiaBIAl0HPzQ/640?wx_fmt=png)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFLibK1f2siaCCAcrLkumL7ibho1TKEiagJGuuH20pl0dNibanhbDEzDk8uZw/640?wx_fmt=jpeg)
*鱼竿不仅能钓鱼，还能发送密文*
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFyLEp8Cicribz4OlxibtaWGpzlVN7blRDExliah5f7mVjQMkaq3miblDiamhg/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFF30YPjjKfZ2mVFSW6rhwhoWCeK3PlPgiblRqhUFe24z4u4ibO35qQoZUQ/640?wx_fmt=jpeg)
*凯撒密码，错位变化字母，但是好破译*
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFxdjpMP0ONhndjVnNsLWrKmQ9BlmJxGqLLM3YEwJkJjjbciaTTALic1xA/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFwUov8KORnTHrxVEyg08kEHth1OHAmdvfWP4iaXYYezZSPTOxiaQduPdg/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFOe7EUH8xDI4x42EsqHASmHT7pkIx4Ldyic5JlibcNoch2iakBsKxYaCibw/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFgMuxYcbOzBgzB6uhysn6Ae9p6adG5mHVdzYycxpJDTsG7f8JZAL6lg/640?wx_fmt=jpeg)
 这两种密码，基本就是二战之前的密码的精华了，各自解决了原始密码的问题，却各自都留下了一个破绽！单表加密的好处是，暴力破解极难，但如果你统计频率。。就废了。多表是，我可以规避频率。。可是要想加强强度，用着就费劲！
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFCpP4otfnRcJq8IX21arfTbke3DnnibEyp76Q7WP8NicugjkJtm3n6zeQ/640?wx_fmt=jpeg)
 而，恩尼格马，是把他俩的优势呈指数型放大，而且全然规避掉了他的弱点！才使得，波兰数学家在获取了“恩尼格玛”之后，陷入了，更深层次的绝望！如果你没见过这台机器，你都根本想不到他到底是怎么加密出来的！
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFibuHHjQsSvC4aS8OHgZ7icqkeEianpg0923o7nU5N5gia4zvaR7sbNE09g/640?wx_fmt=jpeg)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFKlHo1Y6cyCq2nArhyibXpZ6oicib70jHD6meFs0WghicicSROSiaH7o0LoUg/640?wx_fmt=jpeg)
...
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFOtiaDS0MAObPFqicJdO2Kg15bcN5NBj5ahWfiblvVkssM99HZVfPbSkGA/640?wx_fmt=png)
...
![640?wx_fmt=jpeg](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_jpg/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFC8picnIIbPybpWdjTXYJsVbrxxkTpKhsXUB9cVo5vw1pJ7bsn7tIrvA/640?wx_fmt=jpeg)
3小时过去了，等收到一句“打”。。。6格小时过去了。。这边都被消灭了。。。。德国人都撤了。。。这也就是为什么恩尼格玛可以在二战初期让德军可以取得如此辉煌的战绩，以一挑了欧洲各国一群。
![640?wx_fmt=png](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz_png/S4dWtBYyVtyPtbG2wSjVsdcnz6KeeZFFSMRTq6ibgBO9zSgYhBLJiag1tNlEyHNWciaOQEGX2bmZXSwqricicvLGDRg/640?wx_fmt=png)
