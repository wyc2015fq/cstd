# 28 款 GitHub 最流行的开源机器学习项目（附地址） - 知乎
# 



现在机器学习逐渐成为行业热门，经过二十几年的发展，机器学习目前也有了十分广泛的应用，如：数据挖掘、计算机视觉、自然语言处理、生物特征识别、搜索引擎、医学诊断、DNA序列测序、语音和手写识别、战略游戏和机器人等方面。
![](https://pic2.zhimg.com/v2-45430edefba692fb83457c59f00f2c95_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='427'></svg>)
**1. TensorFlow**
...
　　GitHub项目地址： [http://github.com/tensorflow/](https://link.zhihu.com/?target=http%3A//github.com/tensorflow/)…
...
　　GitHub项目地址: [http://github.com/scikit-lear](https://link.zhihu.com/?target=http%3A//github.com/scikit-lear)…
...
**目前Caffe应用实践**主要有数据整理、设计网络结构、训练结果、基于现有训练模型，使用Caffe直接识别。

　　开发语言：C++

　　许可协议： BSD 2-Clause license

　　GitHub项目地址: [http://github.com/BVLC/caffe](https://link.zhihu.com/?target=http%3A//github.com/BVLC/caffe)
...
　　GitHub项目地址: [http://github.com/PredictionI](https://link.zhihu.com/?target=http%3A//github.com/PredictionI)…
...
　　当 brain 用于节点中，可使用npm安装：npm install brain

　　当 brain 用于浏览器，下载最新的 brain.js 文件。训练计算代价比较昂贵，所以应该离线训练网络(或者在 Worker 上)，并使用 toFunction() 或者 toJSON()选项，以便将预训练网络插入到网站中。

　　开发语言：JavaScript

　　GitHub项目地址: [http://github.com/harthur/bra](https://link.zhihu.com/?target=http%3A//github.com/harthur/bra)…
...
　　GitHub项目地址: [http://github.com/fchollet/ke](https://link.zhihu.com/?target=http%3A//github.com/fchollet/ke)…
...
　　GitHub项目地址: [http://github.com/Microsoft/C](https://link.zhihu.com/?target=http%3A//github.com/Microsoft/C)…
...
　　GitHub项目地址: [http://github.com/karpathy/co](https://link.zhihu.com/?target=http%3A//github.com/karpathy/co)…




**9. Pattern**
![](https://pic4.zhimg.com/v2-77395413b868277f834c0b069849f2eb_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='184'></svg>)
...
　　GitHub项目地址: [http://github.com/clips/patte](https://link.zhihu.com/?target=http%3A//github.com/clips/patte)…




**10. NuPIC**
![](https://pic3.zhimg.com/v2-a4dcb02294849eb731b53c9e30047d56_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='640'></svg>)
...
　　GitHub项目地址： [http://github.com/numenta/nup](https://link.zhihu.com/?target=http%3A//github.com/numenta/nup)…
...
　　GitHub项目地址： [http://github.com/Theano/Thea](https://link.zhihu.com/?target=http%3A//github.com/Theano/Thea)…




**12. MXNet**
![](https://pic2.zhimg.com/v2-d338d1f25e7f710cdc148bf6fc4d6621_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='160'></svg>)
...
　　GitHub项目地址： [http://github.com/dmlc/mxnet](https://link.zhihu.com/?target=http%3A//github.com/dmlc/mxnet)
...
　　GitHub项目地址： [http://github.com/JohnLangfor](https://link.zhihu.com/?target=http%3A//github.com/JohnLangfor)…
...
　　GitHub项目地址： [http://github.com/ryanb/ruby-](https://link.zhihu.com/?target=http%3A//github.com/ryanb/ruby-)…
...
　　XGBoost通过提供并行树Boosting(也被称为GBDT、GBM)，以一种快速且准确的方式解决了许多数据科学问题。相同的代码可以运行在大型分布式环境如Hadoop、SGE、MP上。它类似于梯度上升框架，但是更加高效。它兼具线性模型求解器和树学习算法。
...
　　GitHub项目地址： [http://github.com/dmlc/xgboos](https://link.zhihu.com/?target=http%3A//github.com/dmlc/xgboos)…
...
　　GitHub项目地址: [http://github.com/sjwhitworth](https://link.zhihu.com/?target=http%3A//github.com/sjwhitworth)…
...
　　GitHub项目地址: [http://github.com/johnmyleswh](https://link.zhihu.com/?target=http%3A//github.com/johnmyleswh)…
...
　　GitHub项目地址: [http://github.com/h2oai/h2o-2](https://link.zhihu.com/?target=http%3A//github.com/h2oai/h2o-2)
...
　　GitHub项目地址: [http://github.com/NervanaSyst](https://link.zhihu.com/?target=http%3A//github.com/NervanaSyst)…
...
![](https://pic2.zhimg.com/v2-318e8445b6d9b84baeedf8da8b553395_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='380'></svg>)
...
　　GitHub项目地址: [http://github.com/cloudera/or](https://link.zhihu.com/?target=http%3A//github.com/cloudera/or)…
...
　　Shogun是一个机器学习工具箱，由Soeren Sonnenburg 和GunnarRaetsch(创建，其重点是大尺度上的内核学习方法，特别是支持向量机SVM(Support Vector Machines)的学习工具箱。它提供了一个通用的连接到几个不同的SVM实现方式中的SVM对象接口，目前发展最先进的LIBSVM和SVMlight 也位于其中，每个SVM都可以与各种内核相结合。工具箱不仅为常用的内核程序(如线性、多项式、高斯和S型核函数)提供了高效的实现途径，还自带了一些近期的字符串内核函数，例如局部性的改进、Fischer、TOP、Spectrum、加权度内核与移位，后来有效的LINADD优化内核函数也已经实现。
...
　　GitHub项目地址: [http://github.com/shogun-tool](https://link.zhihu.com/?target=http%3A//github.com/shogun-tool)…
...
　　GitHub项目地址: [http://github.com/mikeizbicki](https://link.zhihu.com/?target=http%3A//github.com/mikeizbicki)…
...
![](https://pic4.zhimg.com/v2-b560add24967e979d2f75a7b72ecdaa7_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='571'></svg>)
...
　　GitHub项目地址: [http://github.com/nikolaypavl](https://link.zhihu.com/?target=http%3A//github.com/nikolaypavl)…
...
　　GitHub项目地址: [http://github.com/apache/maho](https://link.zhihu.com/?target=http%3A//github.com/apache/maho)…
...
　　GitHub项目地址: [http://github.com/SeldonIO/se](https://link.zhihu.com/?target=http%3A//github.com/SeldonIO/se)…
...
　　GitHub项目地址: [http://github.com/datumbox/da](https://link.zhihu.com/?target=http%3A//github.com/datumbox/da)…
...
　　GitHub项目地址: [http://github.com/jubatus/jub](https://link.zhihu.com/?target=http%3A//github.com/jubatus/jub)…
...
　　GitHub项目地址: [http://github.com/danielsdele](https://link.zhihu.com/?target=http%3A//github.com/danielsdele)…
