# 11个 AI 和机器学习模型的开源框架，做项目一定用的上！ - 知乎
# 
...
TensorFlow是Google开发的一款开源软件库，专为深度学习或人工神经网络而设计。TensorFlow允许你可以使用流程图创建神经网络和计算模型。它是可用于深度学习的最好维护和最为流行的开源库之一。TensorFlow框架可以使用C++也可以使用Python。其他类似的基于Python的深度学习框架包括Theano，Torch，Lasagne，Blocks，MXNet，PyTorch和Caffe。

你可以使用TensorBoard进行简单的可视化并查看计算流水线。其灵活的架构允许你轻松部署在不同类型的设备上。不利的一面是，TensorFlow没有符号循环，不支持分布式学习。此外，它还不支持Windows。
...
**8. [http://Accord.NET](https://link.zhihu.com/?target=http%3A//Accord.NET)**

[http://Accord.NET](https://link.zhihu.com/?target=http%3A//Accord.NET)是用C#编写的ML框架，专为构建生产级计算机视觉、计算机试听、信号处理和统计应用程序而设计。它是一个文档记录良好的ML框架，可以轻松实现音频和图像处理。[http://Accord.NET](https://link.zhihu.com/?target=http%3A//Accord.NET)可用于数值优化、人工神经网络和可视化。它支持Windows。
...
> 译文链接：[http://www.codeceo.com/article/11-frameworks-for-ai-and-ml.html](https://link.zhihu.com/?target=http%3A//www.codeceo.com/article/11-frameworks-for-ai-and-ml.html)英文原文：11 Open-Source Frameworks for AI and Machine Learning Models翻译作者：码农网 – 小峰
...
【机器学习集训营第六期】​火热报名中，今天**最后1天优惠价**，明天10.1即将涨价500元，报名即**送两门**课程，报名即送《[机器学习工程师 第八期](https://link.zhihu.com/?target=http%3A//www.julyedu.com/course/getDetail/65)》、《[深度学习 第三期](https://link.zhihu.com/?target=http%3A//www.julyedu.com/course/getDetail/69)》，助力您更好的学习机器学习集训营课程，且组团立减500元，想组团/咨询 可添加客服：julyedukefu05
