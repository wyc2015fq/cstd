# 从数学到实现，全面回顾高斯过程中的函数最优化 - 知乎
# 



> 文章选自efavdb，作者： Jonathan Landy，机器之心编译。
...
![](https://pic3.zhimg.com/v2-022b82f40c0baa590e3a7722a5b6be0e_b.gif)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='176'></svg>)
...
![](https://pic3.zhimg.com/v2-df539d50b2bd7bda0eb91bef002c9e06_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='672' height='157'></svg>)
...
我们的 GitHub 提供了简单的高斯过程示例：[https://github.com/EFavDB/gaussian_processes](https://link.zhihu.com/?target=https%3A//github.com/EFavDB/gaussian_processes)
...
![](https://pic1.zhimg.com/v2-8c85cfc6ffa1445bb6dee7255294ee44_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='790' height='165'></svg>)
...
![](https://pic1.zhimg.com/v2-edd170d4161f24f6bc7c0236b934b894_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='725' height='196'></svg>)
...
![](https://pic3.zhimg.com/v2-3a716e52e41d225f14c1576233ba11aa_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='684' height='157'></svg>)
...
![](https://pic1.zhimg.com/v2-de49be2d84218002ee6b1eaedc29f334_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='997' height='470'></svg>)
y 是测量值的向量，长度为 n,
![](https://pic1.zhimg.com/v2-0a11a10443d6fc7627fa0a71bc306414_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='608' height='90'></svg>)
...
![](https://pic3.zhimg.com/v2-f330dddf6ffce367d5657bee6b6d564e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='170' height='41'></svg>)
...
![](https://pic2.zhimg.com/v2-d3c8976498a7661425831b2df0bbd161_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='861' height='322'></svg>)
...
为了从后验概率中采样实际函数，我们将再次简单地评估式 (5) 中的均值和协方差矩阵，这次是对我们所求采样函数的多个测试点进行。一旦我们有了这些测试点后验概率的均值和协方差矩阵，我们可以使用多元正态采样的外部库从 (5) 中抽取样本——为此，我们使用了 python 中 numpy。下面代码的最后一步执行这些步骤。
...
![](https://pic1.zhimg.com/v2-d952f0ae33262c4b41b68efac797180c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='868' height='344'></svg>)
## **选择协方差超参数**
...
![](https://pic1.zhimg.com/v2-fa908a7004023e87c7914f6f74ce71d8_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='714' height='127'></svg>)
我们可以像附录中评估后验分布那样直接进行积分。但更快的方法是注意到 f 积分后，y 值服从如下的正态分布
![](https://pic3.zhimg.com/v2-6dca0f4f71b45c9adee1e5ae0c825e72_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='674' height='104'></svg>)
其中σ^2 * I_00 在式（6）中定义，由此得出，
![](https://pic1.zhimg.com/v2-fbdec827344e54dff26c9b871c93435c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='817' height='102'></svg>)
...
GLCB 在每点的评分方式为
![](https://pic2.zhimg.com/v2-63742e832ffcf914416aac892ec6340d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='602' height='82'></svg>)
...
![](https://pic4.zhimg.com/v2-e9bcf010cdd9bb8ac9ae58eaf65430e7_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='693' height='105'></svg>)
...
![](https://pic4.zhimg.com/v2-24dc5839d995a91c57873257bf030183_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='718' height='114'></svg>)
...
![](https://pic1.zhimg.com/v2-5e477821b1f5079f9091b16e7ed16d14_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='799' height='241'></svg>)
...
![](https://pic2.zhimg.com/v2-a3956e1637a2d392f84eeb58bd459039_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='767' height='273'></svg>)
这里，(1/σ^2) * I 在式（6）中被定义，但在样本集外的所有行中都为零。为了得到式（5），我们必须统一为正文中逆矩阵的分块结构。

首先，我们可以得出
![](https://pic2.zhimg.com/v2-d28a5ad758602715ff66025d8c2f3235_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='813' height='243'></svg>)
这里我们使用了分块表示法。为了计算上述的逆矩阵，我们将利用分块矩阵求逆公式，
![](https://pic1.zhimg.com/v2-e5a796b5f09fe2403d36c38b4e3c7588_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='811' height='245'></svg>)
矩阵（A2）中块 C = 0、D = 1，这大大简化了上述过程。代入后得到
![](https://pic4.zhimg.com/v2-917aa6323364f4038132f5a0bd5a184f_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='797' height='162'></svg>)
利用这个结果和（A1），我们可以得到测试集的平均值
![](https://pic1.zhimg.com/v2-950bf96ed0f4050cfcf5737d67aaa858_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='714' height='282'></svg>)
其中第二行的分子分母同时乘了 (1/σ^2) * I_00 的逆。类似地，测试集的协方差由（A3）的右下块给出。得到，
![](https://pic1.zhimg.com/v2-4e1a5997d611e4a89131e9a1f543713c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='678' height='113'></svg>)
由（A4）和（A5）得出式（5）。
...
![](https://pic2.zhimg.com/v2-d3019599518d3840365f0833fd3d92c1_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='737' height='138'></svg>)
现在，我们利用结果
![](https://pic4.zhimg.com/v2-8f6af7cfc11d6c2b62522093a33c4eeb_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='639' height='141'></svg>)
...
![](https://pic1.zhimg.com/v2-6a2986f33d6a37501b2c0adab3fbbe64_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='902' height='577'></svg>)
## **预定义的核函数**
...
关于 sklearn 实现的更多细节可以在这里找到：[http://scikit-learn.org/stable/modules/generated/sklearn.gaussian_process.GaussianProcessRegressor.html](https://link.zhihu.com/?target=http%3A//scikit-learn.org/stable/modules/generated/sklearn.gaussian_process.GaussianProcessRegressor.html)
...
![](https://pic3.zhimg.com/v2-6707d86e73918abd5635d65416810766_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='596' height='119'></svg>)
这个公式是 logistic 回归的一个正常非线性泛化。此外，f 的先验概率再次得到等式（3）。使用此式和（A8），我们可以得到 f 的后验概率
![](https://pic2.zhimg.com/v2-54f2b716f9d7e1b5fec1b3323e137b71_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='695' height='152'></svg>)
...
原文链接：[http://efavdb.com/gaussian-processes/](https://link.zhihu.com/?target=http%3A//efavdb.com/gaussian-processes/)
