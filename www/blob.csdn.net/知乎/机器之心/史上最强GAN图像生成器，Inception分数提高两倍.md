# 史上最强GAN图像生成器，Inception分数提高两倍 - 知乎
# 
...
> ICLR 2019 大会即将在明年 5 月 6 日于美国举行，9 月 27 日论文提交截止时间已过。本次大会共接收到了 1591 篇论文的投稿，数量相较今年的 1000 篇提升了近 60%。在双盲评审时，人们可以在 Openreview 平台上看到所有论文内容。
...
![](https://pic1.zhimg.com/v2-191a1989bdf6568c98c761a9fec9c64c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='725' height='588'></svg>)



**论文：LARGE SCALE GAN TRAINING FOR HIGH FIDELITY NATURAL IMAGE SYNTHESIS **

地址：[https://openreview.net/pdf?id=B1xsqj09Fm](https://link.zhihu.com/?target=https%3A//openreview.net/pdf%3Fid%3DB1xsqj09Fm)
...
![](https://pic2.zhimg.com/v2-518a7505a74953d3b598e64f7fabbced_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='277'></svg>)
...
![](https://pic2.zhimg.com/v2-60da73184ae1f231672224cfbdc6c095_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='985' height='285'></svg>)表 1：BigGAN 的控制变量研究结果。
...
![](https://pic4.zhimg.com/v2-7a558bb2be64f649c24696c2018c48eb_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='249'></svg>)
图 2：（a）增加截断的效应。从左到右，阈值=2, 1.5, 1, 0.5, 0.04。（b）应用截断和性能差的条件生成模型的饱和度伪影。
...
![](https://pic4.zhimg.com/v2-a54f244ac14ebe8feb18c68857e54fd7_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='315'></svg>)
图 4：截断阈值 0.5 下的模型采样（a-c），以及部分训练模型类泄露（class leakage）示例。
![](https://pic2.zhimg.com/v2-851ffe741c621aaee031f68a8da9d8f1_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='181'></svg>)
表 2：在不同分辨率下的模型评估结果。研究者报告了未使用截断（第 3 列），最佳 FID 分数（第 4 列），验证数据的最佳 IS（第 5 列），以及最高的 IS（第 6 列）。标准差通过至少三次随机初始化计算得到。
![](https://pic2.zhimg.com/v2-10188195c4e86343cfb0e8943cf4bccd_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='552'></svg>)
图 6：由 BigGAN 在 512x512 分辨率下生成的其它样本。
![](https://pic2.zhimg.com/v2-7a49dfa99c0e114fec91bec5ccc48eb1_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='636' height='486'></svg>)
图 8：z、c 配对下的图像插值。
