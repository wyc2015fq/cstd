# 这是一份优美的信息图，吴恩达点赞的deeplearning.ai课程总结 - 知乎
# 
...
信息图下载地址：[https://pan.baidu.com/s/1DtYg3TyplXQOVZ-YmplJaw](https://link.zhihu.com/?target=https%3A//pan.baidu.com/s/1DtYg3TyplXQOVZ-YmplJaw)
...
**1 深度学习基本概念**
![](https://pic1.zhimg.com/v2-b2a4a3cd6b9d699df7e16bfe672c0b8c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='808'></svg>)
...
**2 logistic 回归**
![](https://pic4.zhimg.com/v2-626dfdbbc031d8d3b3fa4279da9edfdb_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='855' height='641'></svg>)
...
**3 浅层网络的特点**
![](https://pic3.zhimg.com/v2-ef5f63eda25f9ac3586d412e8da63fe2_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='853' height='640'></svg>)
...
**4 深度神经网络的特点**
![](https://pic4.zhimg.com/v2-5cb998a7bd7adc88fa2a88da26666bdb_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='854' height='640'></svg>)
...
![](https://pic1.zhimg.com/v2-0ab8b020c341949ef452216c11359434_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='791'></svg>)
...
![](https://pic2.zhimg.com/v2-1ccaff80561373f3a3016bdd2f191449_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='799'></svg>)
...
![](https://pic3.zhimg.com/v2-dab323c72cc33a23a03eeb2462a00cfe_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='801'></svg>)
...
![](https://pic4.zhimg.com/v2-5b5e7bbfa79d4ac61e21179523c4a73f_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='812'></svg>)
...
![](https://pic3.zhimg.com/v2-4f73cf3e765a0dbd13329febac98d092_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='794'></svg>)
...
**9 结构化机器学习过程**
![](https://pic4.zhimg.com/v2-cf1c3ad79c123623080a66376f778bf3_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1037' height='770'></svg>)
...
**10 误差分析**
![](https://pic1.zhimg.com/v2-cdfd5621e08f605af5604795d6188a5c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1032' height='758'></svg>)
...
**11 训练集、开发集与测试集**
![](https://pic3.zhimg.com/v2-acee64d29a659886a4ddbd988e3fe15a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1034' height='764'></svg>)
...
**12 其它学习方法**
![](https://pic1.zhimg.com/v2-61aadc3b9b54b7d7967afea0d428b740_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1038' height='770'></svg>)
...
**13 卷积神经网络基础**
![](https://pic2.zhimg.com/v2-1545334a85adcb1412649b01b3bb0251_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='852' height='638'></svg>)
...
卷积运算的主要参数：
![](https://pic4.zhimg.com/v2-ba5ad828b8a6e324e17a47465bdded23_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='852' height='640'></svg>)
...
深度卷积神经网络的架构：
![](https://pic3.zhimg.com/v2-24b8e3526490cf2d89f1eb1cd5ac556e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='854' height='641'></svg>)
...
**14 经典卷积神经网络**
![](https://pic1.zhimg.com/v2-61a09fabddd5ccb6fb39152a1ac31e38_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='852' height='639'></svg>)- LeNet·5：手写识别分类网络，这是第一个卷积神经网络，由 Yann LeCun 提出。 
...
**15 特殊卷积神经网络**
![](https://pic4.zhimg.com/v2-81f9bd49c33ac0b887e863433a192023_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='854' height='642'></svg>)- ResNet：引入残差连接，缓解梯度消失和梯度爆炸问题，可以训练非常深的网络。
...
**16 实践建议**
![](https://pic2.zhimg.com/v2-c07e048218a92e7f84a293c27af3011d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='850' height='640'></svg>)- 使用开源实现：从零开始实现时非常困难的，利用别人的实现可以快速探索更复杂有趣的任务。
...
**17 目标检测算法**
![](https://pic3.zhimg.com/v2-02f432f3d42f3ac6790688f56755d01e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='853' height='639'></svg>)
...
**18 人脸识别**
![](https://pic4.zhimg.com/v2-2bf7f75b7d11760a95c48dac064d53f3_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='852' height='641'></svg>)
...
**19 风格迁移**
![](https://pic1.zhimg.com/v2-3380c7af323ac648d4db3fe05b934060_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1033' height='761'></svg>)
...
![](https://pic2.zhimg.com/v2-6364b93bbf50c19ffd8dbec1af4e4c49_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1038' height='770'></svg>)
...
**21 NLP 中的词表征**
![](https://pic1.zhimg.com/v2-2a17b9028d0baa8c404a4d1dbe3bf4e0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1034' height='771'></svg>)
...
![](https://pic1.zhimg.com/v2-8d6887c1355e7d9550bbcbc80da71228_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1031' height='759'></svg>)
...
**22 序列到序列**
![](https://pic3.zhimg.com/v2-80c45ab94ba2d8f014bb400d43cb1b72_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1030' height='757'></svg>)
序列到序列的方法使用最多的就是编码器解码器框架，其它还有束搜索等模块的介绍。

编码器解码器架构加上注意力机制可以解决非常多的自然语言处理问题，以下介绍了 BLEU 分值和注意力机制。它们在机器翻译的架构和评估中都是不能缺少的部分。
![](https://pic2.zhimg.com/v2-8f053aef1a137d34b819079af14c2ba9_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1027' height='768'></svg>)
