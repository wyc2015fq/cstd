# 从零开始PyTorch项目：YOLO v3目标检测实现（上） - 知乎
# 



选自Medium，作者：Ayoosh Kathuria，机器之心编译。
...
![](https://pic3.zhimg.com/v2-d8c4a74276bdc9d9132b5a81304e0aba_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='600' height='819'></svg>)
...
![](https://pic1.zhimg.com/v2-b1a1364d2801cd35c407fe56502b28cc_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='738' height='524'></svg>)
**中心坐标**
...
![](https://pic1.zhimg.com/v2-a94a55d339e4b0323feccf73b28c8948_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='655' height='419'></svg>)检测器输出在最终预测之前的变换过程，图源：http://christopher5106.github.io/
...
![](https://pic3.zhimg.com/v2-795028c053fcfeb4e08bf8f4a1ce2f96_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='446' height='700'></svg>)
...
![](https://pic1.zhimg.com/v2-998e609ab3d52cec5028c2fe3aa0ed64_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='435' height='500'></svg>)
**实现**
...
1. YOLO V1: You Only Look Once: Unified, Real-Time Object Detection ([https://arxiv.org/pdf/1506.02640.pdf](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1506.02640.pdf))

2. YOLO V2: YOLO9000: Better, Faster, Stronger ([https://arxiv.org/pdf/1612.08242.pdf](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1612.08242.pdf))

3. YOLO V3: An Incremental Improvement ([https://pjreddie.com/media/files/papers/YOLOv3.pdf](https://link.zhihu.com/?target=https%3A//pjreddie.com/media/files/papers/YOLOv3.pdf))

4. Convolutional Neural Networks ([http://cs231n.github.io/convolutional-networks/](https://link.zhihu.com/?target=http%3A//cs231n.github.io/convolutional-networks/))

5. Bounding Box Regression (Appendix C) ([https://arxiv.org/pdf/1311.2524.pdf](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1311.2524.pdf))

6. IoU ([https://www.youtube.com/watch?v=DNEm4fJ-rto](https://link.zhihu.com/?target=https%3A//www.youtube.com/watch%3Fv%3DDNEm4fJ-rto))

7. Non maximum suppresion ([https://www.youtube.com/watch?v=A46HZGR5fMw](https://link.zhihu.com/?target=https%3A//www.youtube.com/watch%3Fv%3DA46HZGR5fMw))

8. PyTorch Official Tutorial ([http://pytorch.org/tutorials/beginner/deep_learning_60min_blitz.html](https://link.zhihu.com/?target=http%3A//pytorch.org/tutorials/beginner/deep_learning_60min_blitz.html))
...
配置文件下载：[https://github.com/pjreddie/darknet/blob/master/cfg/yolov3.cfg](https://link.zhihu.com/?target=https%3A//github.com/pjreddie/darknet/blob/master/cfg/yolov3.cfg)
...
![](https://pic4.zhimg.com/v2-1220e6f7af3fb6df00fc64224ae2fd13_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='300' height='513'></svg>)
...
也可以直接下载图像：[https://github.com/ayooshkathuria/pytorch-yolo-v3/raw/master/dog-cycle-car.png](https://link.zhihu.com/?target=https%3A//github.com/ayooshkathuria/pytorch-yolo-v3/raw/master/dog-cycle-car.png)
...
也可以通过该地址下载：[https://pjreddie.com/media/files/yolov3.weights](https://link.zhihu.com/?target=https%3A//pjreddie.com/media/files/yolov3.weights)
...
![](https://pic3.zhimg.com/v2-4e7e1629a9942a7c84cbdc44828eb9ce_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='764' height='700'></svg>)
...
原文链接：[https://medium.com/paperspace/tutorial-on-implementing-yolo-v3-from-scratch-in-pytorch-part-1-a0054d38ec78](https://link.zhihu.com/?target=https%3A//medium.com/paperspace/tutorial-on-implementing-yolo-v3-from-scratch-in-pytorch-part-1-a0054d38ec78)
