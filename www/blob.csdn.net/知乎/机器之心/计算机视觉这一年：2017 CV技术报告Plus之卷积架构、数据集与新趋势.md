# 计算机视觉这一年：2017 CV技术报告Plus之卷积架构、数据集与新趋势 - 知乎
# 
...
![](https://pic4.zhimg.com/v2-e465638bd434b1f3590f7cfffbd0715f_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='598' height='434'></svg>)
图 16：DenseNet 架构示例。5 层，growth rate k = 4。每一层的输入为前面所有特征图。来源：Huang et al. (2016) [135]




该模型在 CIFAR-10、CIFAR-100、SVHN 和 ImageNet 上进行评估，并在多个数据集上实现了顶尖性能。同时，DenseNet 使用了较少内存和计算能力。现在已经有多个实现（Keras、Tensorflow 等）：[https://github.com/liuzhuang13/DenseNet](https://link.zhihu.com/?target=https%3A//github.com/liuzhuang13/DenseNet)。[136]
...
- Hanmonic CNNs [146] 使用『圆谐波』（circular harmonics）滤波器替换常规的 CNN 滤波器。
...
**残差网络**
![](https://pic2.zhimg.com/v2-c1045c1a4255b5ef3a5fe1127e0d986d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='570' height='498'></svg>)
...
ResNet 通常被概念化为浅层网络的集成，通过运行（与它们的卷积层平行的）跳过链接，从而在某种程度上抵消深度神经网络的分层性质。这些跳过连接允许更简单的反向传播过程，缓解了深度神经网络中的梯度消失和梯度爆炸问题。如果想了解更多信息，请查阅 Quora：[https://www.quora.com/What-is-an-intuitive-explanation-of-Deep-Residual-Networks](https://link.zhihu.com/?target=https%3A//www.quora.com/What-is-an-intuitive-explanation-of-Deep-Residual-Networks)。[152]
...
![](https://pic4.zhimg.com/v2-6ef7c61ab7759fe740ffc1e3025f7bb3_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='507'></svg>)
...
![](https://pic1.zhimg.com/v2-618b9e8aae22b537a4a4efc986330284_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='237'></svg>)
...
也就是说，图像理解的进步，如分割、物体分类和检测已经将视频理解带入了研究前沿。然而，在这个数据集发布之前，真实世界的视频数据集的种类和规模实际上很缺乏。此外，这个数据集刚刚更新 [181]，并且今年谷歌联合 Kaggle 正组办一场视频理解竞赛，它是 CVPR 2017[182] 的一部分。有关 YouTube-8M 的一般信息请参见：[https://research.google.com/youtube8m/](https://link.zhihu.com/?target=https%3A//research.google.com/youtube8m/)[183]。
...
![](https://pic2.zhimg.com/v2-36b174bec5c94fd1baf5d492cedb1ac9_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='455'></svg>)
