# 从框架优缺点说起，这是一份TensorFlow入门极简教程 - 知乎
# 



选自easy-tensorflow，机器之心编译。
...
教程地址：[http://www.easy-tensorflow.com](https://link.zhihu.com/?target=http%3A//www.easy-tensorflow.com)
...
- [机器之心 GitHub 项目：从零开始用 TensorFlow 搭建卷积神经网络](https://link.zhihu.com/?target=http%3A//mp.weixin.qq.com/s%3F__biz%3DMzA3MzI4MjgzMw%3D%3D%26mid%3D2650730287%26idx%3D1%26sn%3D5697b072a5671ac201e15b43339efab9%26chksm%3D871b2b51b06ca247ac1fdc939e39cfc44cbc2ee25e1b105cf9a582395ddbcdd43cfe18fecd40%26scene%3D21%23wechat_redirect)
- [教程 | 从零开始：TensorFlow 机器学习模型快速部署指南](https://link.zhihu.com/?target=http%3A//mp.weixin.qq.com/s%3F__biz%3DMzA3MzI4MjgzMw%3D%3D%26mid%3D2650736925%26idx%3D2%26sn%3D3ec7f2370ce60ff1bc18f5122e0aa5f2%26chksm%3D871acd63b06d4475c22d227bb03b696dbaea94b5c0ec5486c03db2a056b051ec2e436d3f5976%26scene%3D21%23wechat_redirect)
- [分布式 TensorFlow 入坑指南：从实例到代码带你玩转多机器深度学习](https://link.zhihu.com/?target=http%3A//mp.weixin.qq.com/s%3F__biz%3DMzA3MzI4MjgzMw%3D%3D%26mid%3D2650734471%26idx%3D1%26sn%3Dbe4cd4b85ed84f997baf4c88543dc3f4%26chksm%3D871b3bf9b06cb2ef94ea9531ec74fef14b8db5d1996b0cf0c9bd31ca3594ef1f54feaea17109%26scene%3D21%23wechat_redirect)
...
- [TensorFlow 从基础到实战：一步步教你创建交通标志分类神经网络](https://link.zhihu.com/?target=http%3A//mp.weixin.qq.com/s%3F__biz%3DMzA3MzI4MjgzMw%3D%3D%26mid%3D2650729406%26idx%3D2%26sn%3Da5e37e1d653bbc74063994f739ce3920%26chksm%3D871b2fc0b06ca6d6590ea266086c5a7061d094a12e3dfde3fd3bfdbb7b09f980785139e30b9b%26scene%3D21%23wechat_redirect)
...
**2. Theano**：由蒙特利尔大学研究团队构建。Theano 的顶层构建了数值开源深度库，包括 Keras、Lasagne 和 Blocks。[Yoshua Bengio 在 2017 年 9 月 28 日宣布，Theano 的开发将终止](https://link.zhihu.com/?target=http%3A//mp.weixin.qq.com/s%3F__biz%3DMzA3MzI4MjgzMw%3D%3D%26mid%3D2650731455%26idx%3D1%26sn%3Df1957d20f92c474c397ab2dcc08cc9cf%26chksm%3D871b37c1b06cbed704fbc358de5f8379cd331e1e6f289d44f25dae188c83aa2208190f8a33d2%26scene%3D21%23wechat_redirect)。因此实际上 Theano 已死！
...
![](https://pic3.zhimg.com/v2-03f42bf99be1a6a64e04eeb6e3c64f96_b.gif)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='252' height='448'></svg>)
**计算图与会话**

学习 TensorFlow 的第一步是了解它的主要特色——「计算图」方法。基本上所有的TensorFlow 代码都包含两个重要部分：
...
首先，什么是节点和运算？最好的解释方式是，举个例子。假设我们为函数「f(x,y)=x^2y+y+2」编写代码。TensorFlow 中的计算图如下所示：
![](https://pic1.zhimg.com/v2-53410410c91b10e92d175e9e92e883e4_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='534' height='345'></svg>)图 2：TensorFlow 构建的计算图。
...
生成的计算图和变量为：
![](https://pic4.zhimg.com/v2-c5640d237e0d9012b97ccc1ef867c9e7_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='765' height='242'></svg>)图 3：左：生成的图在 Tensorboard 中可视化；右：生成的变量（在 debug 模式下运行时从 PyCharm 调试器获取的屏幕截图）
...
![](https://pic2.zhimg.com/v2-b2d18ecf672453867637975b35990a41_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='931' height='167'></svg>)
2. 变量
...
它生成的计算图与变量如下所示：
![](https://pic3.zhimg.com/v2-95b601d73a643d29e1a939db67afcb36_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='699' height='207'></svg>)
...
![](https://pic2.zhimg.com/v2-bec42a70cd5bab73843dfd56163e7dd5_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='746' height='605'></svg>)
...
![](https://pic1.zhimg.com/v2-7339e06ec8f6e395312e36fac1cf08c8_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='928' height='618'></svg>)
...
![](https://pic3.zhimg.com/v2-63253908201fb7bd3da383bfc004690a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='669'></svg>)
**参数存储与加载**
