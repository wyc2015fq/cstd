# Kaggle Grandmaster是怎样炼成的 - 知乎
# 



选自Medium，作者：Vladimir Iglovikov，机器之心编辑部。
...
![](https://pic3.zhimg.com/v2-20b03bbfbc8731c96ddb2ca916360e9a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='651' height='733'></svg>)
...
我要向 @Lasteg 表示感谢，是他提议我参加这期的 AMA（Ask Me Anything session）并在 Reddit、kaggle、[http://science.d3.ru](https://link.zhihu.com/?target=http%3A//science.d3.ru)（in Russian）上收集问题。他收集有很多问题，我会尽我所能去回答，但没办法在本篇博客中解决所有问题。如果你的疑问未能在本文获得解答，可以在评论中留言。
...
![](https://pic3.zhimg.com/v2-0efbfdf29b943ef574c9a948a3b7d44a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='608'></svg>)
...
- 我正在尝试编写单元测试。所有人都在讨论单元测试在数据科学中的重要性，但很少有人花时间去写。Alex Parinov 写了一个很好的文档（[https://albumentations.readthedocs.io/en/latest/writing_tests.html](https://link.zhihu.com/?target=https%3A//albumentations.readthedocs.io/en/latest/writing_tests.html)），教你怎么从简单的测试做到复杂的测试。你可以尝试一下，然后再你的学术或 Kaggle ML 流程中添加更多测试。
...
![](https://pic2.zhimg.com/v2-87c36f758e750d9c58e821edd3025d89_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='772' height='580'></svg>)
...
**其他**
![](https://pic4.zhimg.com/v2-e270ec2fb13bf6767a929e7dd5506c8b_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='461' height='518'></svg>)
...
![](https://pic4.zhimg.com/v2-f92119b51397f618cf2fde60ce18eaeb_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='600' height='788'></svg>)
...
原文链接：[https://medium.com/@iglovikov/ask-me-anything-session-with-a-kaggle-grandmaster-vladimir-i-iglovikov-942ad6a06acd](https://link.zhihu.com/?target=https%3A//medium.com/%40iglovikov/ask-me-anything-session-with-a-kaggle-grandmaster-vladimir-i-iglovikov-942ad6a06acd)
