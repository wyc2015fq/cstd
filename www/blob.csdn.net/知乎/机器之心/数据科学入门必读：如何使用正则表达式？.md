...
语料库地址：[https://www.kaggle.com/rtatman/fraudulent-email-corpus](https://link.zhihu.com/?target=https%3A//www.kaggle.com/rtatman/fraudulent-email-corpus)
...
我们可以通过 Anaconda 或 pip 获取 pandas，详情参阅安装指南：[https://pandas.pydata.org/pandas-docs/stable/install.html](https://link.zhihu.com/?target=https%3A//pandas.pydata.org/pandas-docs/stable/install.html)
...
![](https://pic1.zhimg.com/v2-83a733b2b9cabdaf36a1886bf29f0d90_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1001' height='846'></svg>)「From r」起头的电子邮件
...
正则表达式自从生物学迈向工程领域之后，多年来发展迅速。现在，正则表达式已经在各种不同的编程语言中得到了应用，其中某些变体已经超越了其基本模式。在本教程中，我们使用 Python 进行了练习，如果你有进一步探索的兴趣，可以参阅这个帖子：[https://stackoverflow.com/questions/4644847/list-of-all-regex-implementations](https://link.zhihu.com/?target=https%3A//stackoverflow.com/questions/4644847/list-of-all-regex-implementations)。维基百科也有一个比较不同正则表达式引擎的表格：[https://en.m.wikipedia.org/wiki/Comparison_of_regular_expression_engines#Part_1](https://link.zhihu.com/?target=https%3A//en.m.wikipedia.org/wiki/Comparison_of_regular_expression_engines%23Part_1)

一篇教程肯定不能说尽正则表达式的全部。完整参考可参阅 Python 的 re 模块的文档：[https://docs.python.org/3/library/re.html](https://link.zhihu.com/?target=https%3A//docs.python.org/3/library/re.html)。谷歌也有一个快速参考：[https://developers.google.com/edu/python/regular-expressions](https://link.zhihu.com/?target=https%3A//developers.google.com/edu/python/regular-expressions)

如果你需要数据集来做实验，Kaggle 和 StatsModels 很不错。

这里有个正则表达式快速参考表：[https://github.com/dmikalova/sublime-cheat-sheets/blob/master/cheat-sheets/Regular%20Expressions.cheatsheet](https://link.zhihu.com/?target=https%3A//github.com/dmikalova/sublime-cheat-sheets/blob/master/cheat-sheets/Regular%2520Expressions.cheatsheet)。这是为 Sublime 设计的，但对其它工具而言也很方便。
![](https://pic1.zhimg.com/v2-18cc987d5f379a82f1208b6d90722318_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='73' height='24'></svg>)
原文链接：[https://www.dataquest.io/blog/regular-expressions-data-scientists/](https://link.zhihu.com/?target=https%3A//www.dataquest.io/blog/regular-expressions-data-scientists/)
