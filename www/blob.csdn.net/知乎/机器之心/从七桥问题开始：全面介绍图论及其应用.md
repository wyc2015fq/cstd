# 从七桥问题开始：全面介绍图论及其应用 - 知乎
# 



文章选自Medium，作者：Vardan Grigoryan，机器之心编译，[原文链接点此跳转。](https://link.zhihu.com/?target=https%3A//medium.freecodecamp.org/i-dont-understand-graph-theory-1c96572a1401)
...
![](https://pic3.zhimg.com/v2-95cad0ee9de877ee2fec61e74e535d2a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='803' height='449'></svg>)
## **七桥问题**
...
![](https://pic3.zhimg.com/v2-15721eaf9fb870fc8a9f381a6e17a2de_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='737' height='625'></svg>)
你可以尝试一下，在穿过每座桥仅一次的情况下穿过这个城市。每座桥，意味着所有桥都被穿过；只穿过一次，意味着每座桥不能被穿越两次及以上。如果你对这一问题有所了解，就知道这不可能。
![](https://pic4.zhimg.com/v2-0955f04b8a972a667de2113c958f850f_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='504' height='657'></svg>)Leonhard Euler 
有时候，放弃这一问题是合理的。这就是 Leonhard Euler 的解决方法，他没有试图解决这一问题，而是证明其不可解决。让我们试着去理解 Euler 的内在想法，做到像 Euler 一样思考。首先我们从下图开始。
![](https://pic3.zhimg.com/v2-7dea0978a8e2141e8eb9d814a9516aa6_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='837' height='713'></svg>)
图中有四块彼此分隔的区域，两个岛屿和两块陆地，以及七座桥。探讨每一区域的桥数是否有一定模式很有趣。
![](https://pic3.zhimg.com/v2-edc83615dd632ddf0b64b24c38ccfc86_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='606' height='490'></svg>)每块区域的桥数
如图所示，每块区域的桥数皆为奇数。如果你只能穿过桥一次，区域有两座桥，那么你就可以进入并离开该区域。
![](https://pic3.zhimg.com/v2-849fd6d3ed30c82c41e6acfc625bb11e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='917' height='290'></svg>)有两座桥的区域的示例
...
![](https://pic4.zhimg.com/v2-9d711ab022d09872bfaeea1dbe991dd7_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='598' height='489'></svg>)注意添加的新桥
现在我们有两个偶数和两个奇数。让我们在添加新桥的图上画一条新路线。
![](https://pic4.zhimg.com/v2-5f2157427fe75d2ab7cf524f0ec81ae7_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='606' height='493'></svg>)
...
![](https://pic4.zhimg.com/v2-6aa4e46c9ff30649efe5a071be88f1fb_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='644' height='300'></svg>)抽象化七桥问题
...
![](https://pic3.zhimg.com/v2-9e8286715bb2f337a17bcfb16d429432_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='605' height='508'></svg>)
所以，可视化图是解决该问题的好选择，因此我们需要去找出哥尼斯堡七桥问题是怎样被这张图解决的。注意从圈里面向外出来的线。因此我们命名圈为节点（或节点），连接他们的线为边。你也许看到了字母表达法，V 是节点（vertex），E 是边（edge）。 
![](https://pic2.zhimg.com/v2-b9c6c76c99e45bd10c5da9cd77be14fd_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='594' height='495'></svg>)
下一个重要的事是所谓节点自由度（Degree），即连接到节点的边数量。在我们上面的例子里，连接陆地和桥的边的数量可以被表达成节点的自由度。
![](https://pic3.zhimg.com/v2-e607057207f54539c7ec62ae841f858a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='637' height='484'></svg>)
...
![](https://pic2.zhimg.com/v2-485ff0ee3d356ab1a50c5df157d53309_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='363'></svg>)左图：有两个节点有奇数自由度的图像。右图：所有节点都有奇数自由度
...
![](https://pic3.zhimg.com/v2-f06a038c215b29e72fa42f30b7439636_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='729' height='598'></svg>)
...
![](https://pic2.zhimg.com/v2-e472b7ed5a4b3a8dcb4f80b42590f5a9_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='701' height='621'></svg>)
现在，我们了解了什么是有限无向图，让我们再一次思考 Euler 图：
![](https://pic3.zhimg.com/v2-7aeeb587936c28c35fab96b275093aae_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='767' height='609'></svg>)
...
![](https://pic1.zhimg.com/v2-d4efe4c16b17ad5e09b649f1167302d4_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='487' height='561'></svg>)
...
![](https://pic3.zhimg.com/v2-32d7b190bc3ceec45283e78bdfee6556_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='610'></svg>)
...
![](https://pic3.zhimg.com/v2-a865e6bc06cb0044f76f9c5a5bed09fe_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='595' height='545'></svg>)
...
Airbnb 房源搜索一瞥：
![](https://pic4.zhimg.com/v2-3deb09674710deec99ad4434481f240f_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1017' height='794'></svg>)
怎样用滤波器基于词条尽可能快的搜索房源，这是一项很难的任务。如果我们考虑到 Airbnb 储存了几百万条表格的情况下，这个任务更难了。
![](https://pic3.zhimg.com/v2-b7a0e377c34dc60f602529a77f1f4736_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='619' height='428'></svg>)
...
让我们重新想一下，一般储存用同样的基础 URL 服务，像 http(s)://[http://s3.amazonaws.com/](https://link.zhihu.com/?target=http%3A//s3.amazonaws.com/)<bucket>/<object>，这样就是说，这里有一个基本的模式来建 URL 并且我们只需要储存真实照片的 ID，让我们说用了一些独特的 ID 生成器，可以为图片对象返回 20 字节长度的独特的字符 ID，看起来像 [https://s3.amazonaws.com/some-know-bucket/](https://link.zhihu.com/?target=https%3A//s3.amazonaws.com/some-know-bucket/)。这提供了我们好多空间效率，所以为了 5 张照片储存字符 ID，我们只需要 100 字节内存。
...
![](https://pic3.zhimg.com/v2-00b7294d73e22e3a9dfc11a4a585824a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='702' height='338'></svg>)
...
![](https://pic1.zhimg.com/v2-d6c740f695698e37a325b901e460d850_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='677' height='353'></svg>)位集合（Bitset）允许储存 20 个不同数据而只用 20 个字节
举例，检查一个房源有没有「洗衣机」：
...
![](https://pic1.zhimg.com/v2-4a9fbf0342fa1c76a103fac9d84b0858_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='726' height='568'></svg>)
...
![](https://pic1.zhimg.com/v2-ad01064ea37e26e1dcd69fdb667a1c70_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='542' height='425'></svg>)
...
![](https://pic1.zhimg.com/v2-fc59835cad43846ee3e4228534620ce0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='714' height='554'></svg>)
...
![](https://pic4.zhimg.com/v2-dff1896567a333e328a567daedf15eb3_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='661' height='711'></svg>)
...
![](https://pic1.zhimg.com/v2-0b643398c0b2897464ab7c284c225a90_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='575' height='530'></svg>)
...
N-ary 树更像是模拟一个图。
![](https://pic4.zhimg.com/v2-9e478267c773df9f1f261010216a297f_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='716' height='566'></svg>)
首先，将 N-ary 树节点表示为：
...
![](https://pic4.zhimg.com/v2-7f7d906a782d712943f3c1cd603476ab_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='709' height='557'></svg>)
...
![](https://pic4.zhimg.com/v2-1c873c81ae5f401e8ac65a86bfb17917_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='965' height='394'></svg>)二者都是图
...
![](https://pic2.zhimg.com/v2-9df0160a063d1d6cbe890913420413f9_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='647' height='537'></svg>)有向图
推特案例中有 8 个节点，所以我们需要使用|V|x|V|的二维矩阵表征这个图（其中 |V|分别代表行数和列数）。如果从 v 到 u 有一条有向边，那么我们称矩阵的元素 [v][u] 为真，否则为假。
![](https://pic4.zhimg.com/v2-89b92ed55a542d20971c507593f43557_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='634' height='493'></svg>)
...
![](https://pic4.zhimg.com/v2-d93c8790eec54055a186ffd57793e713_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='974' height='396'></svg>)
...
![](https://pic3.zhimg.com/v2-c709244c4c5bc83e8d4ff332c7433e9a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='879' height='347'></svg>)邻接矩阵与邻接列表
...
![](https://pic4.zhimg.com/v2-94e7d50fdee42cbade1ea3f9336843ef_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1023' height='808'></svg>)
...
![](https://pic2.zhimg.com/v2-52af1896237fbeaebcbb877213133c3d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='616' height='487'></svg>)
...
![](https://pic3.zhimg.com/v2-561338c512c31705040a3fc4322258fa_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1007' height='782'></svg>)
...
![](https://pic2.zhimg.com/v2-a8d5b1bbef8a199aa020c498f10c9af9_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='675' height='521'></svg>)Airbnb 过滤器节选
我们还可以通过添加高层的节点，例如「生活设施」节点来连接所有生活设施类的节点（WiFi、电视等），使该集合更容易理解。
![](https://pic1.zhimg.com/v2-5f260a2ea75ab3137b809212d134247c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='707' height='520'></svg>)拥有高级类型的 Airbnb 过滤器
现在，我们可以将 Airbnb 房源（home）表示成节点，然后将这些节点和对应的属性节点连接起来。
![](https://pic1.zhimg.com/v2-53769a67738ae052c458ce14df4fa1ec_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='714' height='545'></svg>)
这个插图的微妙变化使它更像一种特殊类型的图形，称为偶图（bipartite graph）。



![](https://pic4.zhimg.com/v2-bcf82ecc43225fae3c1fbfbdcaa31877_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='656' height='531'></svg>)节点的数量比看起来的更多
...
![](https://pic2.zhimg.com/v2-d6518fbb12e306d555919efb7ca35635_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='969' height='781'></svg>)
...
![](https://pic3.zhimg.com/v2-e13528f776ced6172bd1e3156d2372e6_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1002' height='770'></svg>)前序遍历的细节追踪 ![](https://pic3.zhimg.com/v2-a335dd087637b1374f85aee41e2fc14a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='696' height='418'></svg>)
...
![](https://pic4.zhimg.com/v2-676d8cf369dad17fbb2ac0e11ee03f9b_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='704' height='532'></svg>)我知道这并不是最好的图例（而且有一个书写错误）
...
![](https://pic2.zhimg.com/v2-7440996664cefffe39dec82184c22881_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='707' height='524'></svg>)倒排索引
...
![](https://pic4.zhimg.com/v2-180d0ac2734646f8fa41436ad673ea2f_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='988' height='786'></svg>)
...
![](https://pic1.zhimg.com/v2-1fbaa46d4f5abda0023f7534de9ce564_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='713' height='542'></svg>)
**DFS vs. BFS**

如果你对这个问题不熟悉，想想你在遍历树的时候可用于存储节点的数据结构。如果对比分层遍历树和上文介绍的其他方式（前序/顺序/后序遍历），就会发现两种主要的图遍历方法：深度优先搜索（DFS）和广度优先搜索（BFS）。
![](https://pic2.zhimg.com/v2-9d08e3536f6de6dcc0542a6c492c3cfd_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='913' height='757'></svg>)
深度优先搜索寻找最远的节点，广度优先搜索先寻找最近的节点。
- 深度优先搜索——更多动作，更少思考。
- 广度优先搜索——在进一步行动之前先仔细观察四周。
![](https://pic1.zhimg.com/v2-5c69036a29133cab924d02f1e40c24c8_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='989' height='765'></svg>)
...
![](https://pic3.zhimg.com/v2-716af77a3d745c015ea4deaab2202d0e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='702' height='549'></svg>)
除了处理请求、基于用户坐标确定定位、寻找最近坐标的司机以外，我们还需要寻找最适合这趟行程的司机。为了避免地理空间请求处理（对比司机当前坐标和用户坐标，来获取附近车辆），我们假设已经分割了用户和多辆附近车辆的地图，如下图所示：
![](https://pic2.zhimg.com/v2-7db7d27cee3b054392dd78802427a889_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='706' height='552'></svg>)
...
![](https://pic4.zhimg.com/v2-853335600e34d420a98ee56b7d250b53_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='999' height='186'></svg>)车辆到达用户的可能路径
我们将该地图分割表示为一个图：
![](https://pic4.zhimg.com/v2-5654173adfd2be4344e436412f936b8b_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='611' height='540'></svg>)
...
![](https://pic4.zhimg.com/v2-2baf47456ee9aed0e3fe9f43fe78e5bf_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='697' height='416'></svg>)



我们的 unvisited set 包含了所有的节点，同时也要注意图左边里显示的表格。所有的节点都包括了到 B 和到之前节点的最短距离。例如，从 B 到 F 的最短距离是 20，之前节点是 B。
![](https://pic1.zhimg.com/v2-e2a6d0085286e633a8bfe65cf9a2d694_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='695' height='418'></svg>)
我们把 B 标注为访问过的然后移动到它的近邻 F。
![](https://pic2.zhimg.com/v2-4fe807de601386a6b8fb6c71c99aa3fd_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='698' height='420'></svg>)
现在，我们把 F 标注已访问过的，然后在最小实验距离下选下一个没被访问过的节点，就是 G。
![](https://pic2.zhimg.com/v2-a5ad770f371b809a4e3a8a98666057d5_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='707' height='436'></svg>)
