# 使用Python和Mask R-CNN自动寻找停车位，这是什么神操作？ - 知乎
# 
...
![](https://pic3.zhimg.com/v2-bd619b55e547741440596c95e8b24d86_b.gif)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='347'></svg>)
...
![](https://pic3.zhimg.com/v2-6d5f8d2a7e16451294ebbfef0847b556_b.gif)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='302'></svg>)
...
下面是我分解的空车位检测流程：
![](https://pic3.zhimg.com/v2-2cb3431be1e05abbd45ebd47b8a04cf2_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='158'></svg>)
机器学习流程的输入是来自一个伸出窗外的普通网络摄像头的视频流：
![](https://pic4.zhimg.com/v2-141317762483479190dd4e8fbcaf037f_b.gif)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='360'></svg>)从摄像头中截取的示例视频
...
摄像头的视野是这样的：
![](https://pic2.zhimg.com/v2-a3d5197314ebe4b8e1008c0ee7574245_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='608'></svg>)
我们需要扫描这幅图，然后返回一个有效停车区域列表，就像这样：
![](https://pic4.zhimg.com/v2-5ecb690f9f556fa321cdd8fda40eeabf_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='798' height='448'></svg>)这个城市街道上的有效停车位
...
![](https://pic4.zhimg.com/v2-227f8f1d1126cad4065f250a0bf3ea83_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='359' height='202'></svg>)检测每幅图像中的停车计时器
...
![](https://pic4.zhimg.com/v2-aafeafe04040a0efffd973973a0b0a43_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='798' height='448'></svg>)请注意这些黄色的小标志——它们就是画在道路上的每个车位的边界
...
![](https://pic4.zhimg.com/v2-b1f3b8ceeb95a9ad1f06ee4fc2192f93_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='798' height='449'></svg>)这里，每辆车的边界框实际上就是一个停车位！如果我们能够检测静态的车辆，就没必要检测停车位
...
![](https://pic1.zhimg.com/v2-28db196dacf4fe2e16104ffd8a8dce7c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='687'></svg>)
...
![](https://pic1.zhimg.com/v2-1a59163cf8238225a01ce1f4980876d0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1000' height='554'></svg>)COCO 数据集中已标注轮廓的图像
...
地址：[https://github.com/matterport/Mask_RCNN](https://link.zhihu.com/?target=https%3A//github.com/matterport/Mask_RCNN)

旁注：你不必为训练定制化的 Mask R-CNN 而担心！标注数据是很耗时间的，但是并不困难。如果你想使用自己的数据完整地训练 Mask R-CNN 模型，可以参考这本书：

[https://www.machinelearningisfun.com/get-the-book](https://link.zhihu.com/?target=https%3A//www.machinelearningisfun.com/get-the-book)

如果在我自己的相机图像上运行预训练模型，以下是检测结果：
![](https://pic2.zhimg.com/v2-750e78590ae6385e25f573c039bcc8b1_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='608'></svg>)经过 COCO 默认目标识别的图像——车辆、人、交通信号灯和树
...
下面是 python 代码，用于根据 Matterport』s Mask R-CNN 实现和 OpneCV 预训练的模型来检测汽车边界框：[The MLIF Book — Machine Learning is Fun!​www.machinelearningisfun.com![图标](https://pic1.zhimg.com/v2-cbfc4c5e3dba79f9fd1766959f095288_120x160.jpg)](https://link.zhihu.com/?target=https%3A//www.machinelearningisfun.com/get-the-book)下面是 python 代码，用于根据 Matterport』s Mask R-CNN 实现和 OpneCV 预训练的模型来检测汽车边界框：
...
![](https://pic1.zhimg.com/v2-c44aeaa0bca2e96c47232ca576f04964_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='552'></svg>)每辆检测到的汽车都有一个绿色的边界框
...
问题在于我们图像中的边界框是部分重叠的。
![](https://pic4.zhimg.com/v2-3f404696d98a3b176517d2b1efedc0ab_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='405'></svg>)即使是在不同车位中的车辆，每辆车的边界框都会有一小部分的重叠
...
![](https://pic3.zhimg.com/v2-6af7d144cbd998699a5b1f2287cf3dca_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='467'></svg>)
...
参考原文：[https://medium.com/@ageitgey/snagging-parking-spaces-with-mask-r-cnn-and-python-955f2231c400](https://link.zhihu.com/?target=https%3A//medium.com/%40ageitgey/snagging-parking-spaces-with-mask-r-cnn-and-python-955f2231c400)
