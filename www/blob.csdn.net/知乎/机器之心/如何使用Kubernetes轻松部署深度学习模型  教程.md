# 如何使用Kubernetes轻松部署深度学习模型 | 教程 - 知乎
# 



选自 Medium，作者：Gus Cavanaugh，机器之心编译。

> 本文介绍了如何使用 Python、Keras、Flask 和 Docker 在 Kubernetes 上部署深度学习模型。
![](https://pic2.zhimg.com/v2-afd842234f8d311cae69dfa499f0ec5d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='562'></svg>)
**这简直太容易了，连你的老板都能做到！**
...
![](https://pic2.zhimg.com/v2-fddb26e97a1a4419413845ce70a2d05d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='825' height='683'></svg>)
要想启动一台 Google Cloud 虚拟机，你可以打开屏幕左侧的工具栏。选择 Compute Engine。接着，选择「Create Instance」。如下图所示，我已经拥有了一个正在工作的虚拟机实例。
![](https://pic2.zhimg.com/v2-82dc0b4e7179e11fc05300eac144faed_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1070' height='418'></svg>)
下一步，你需要选择你想要使用的计算规模。默认的（最便宜的）机器设置也可以很好地工作，但是考虑到我们最多只需要使用这个虚拟机大约 1 小时，我选择了内存为 15GB 的 4vCPU 配置。
![](https://pic4.zhimg.com/v2-2054e0d16356605c762c8ee4aa6f2627_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='636' height='809'></svg>)
...
![](https://pic1.zhimg.com/v2-741b6f844468263e05ca823bb66b59d0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='702' height='941'></svg>)
...
![](https://pic2.zhimg.com/v2-603753cb2c3ce2f1f1fae9c0d6e79dc1_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='665' height='470'></svg>)
我并不确定是否需要此步骤。

现在单击「Creat」按钮。很好，困难的部分基本上已经完成了。
![](https://pic3.zhimg.com/v2-138a4e55ebb4b8139001c89b0f415a1e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1043' height='373'></svg>)
...
![](https://pic3.zhimg.com/v2-922bae2139dee022225fa9d2e8afaa9e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='876' height='260'></svg>)
**1. 卸载已有的 Docker 版本**
...
我们将复制一段 Adrian Rosebrock 写的脚本。Adrian 写了一篇很棒的教程，关于如何利用 Keras 构建深度学习模型并使用 Flask 部署它。教程参见：[https://blog.keras.io/building-a-simple-keras-deep-learning-rest-api.html](https://link.zhihu.com/?target=https%3A//blog.keras.io/building-a-simple-keras-deep-learning-rest-api.html)
...
下一个问题涉及 TensorFlow。当我运行 Adrian 的原始脚本时，我无法成功调用模型。于是，我阅读了下面这个 Github issue（[https://github.com/tensorflow/tensorflow/issues/14356](https://link.zhihu.com/?target=https%3A//github.com/tensorflow/tensorflow/issues/14356)），并对代码进行了修改。
...
![](https://pic1.zhimg.com/v2-858395525dd001f71d1b3323634b7c38_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='375' height='500'></svg>)
在终端中运行：
...
![](https://pic3.zhimg.com/v2-65a19c1de3bef2fe2a5b057d402f8ad2_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='370' height='402'></svg>)
接着创建一个新的 Kubernetes 集群：
![](https://pic4.zhimg.com/v2-c15327854543b35dd40e7bb3ed5cad53_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='520' height='252'></svg>)
...
![](https://pic2.zhimg.com/v2-35db1015bdf810521112fbc58b7d1731_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='552' height='359'></svg>)
...
![](https://pic4.zhimg.com/v2-cdb9a8577201ed034cf9cdf2a019b363_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='922' height='564'></svg>)
...
原文链接：[https://medium.com/analytics-vidhya/deploy-your-first-deep-learning-model-on-kubernetes-with-python-keras-flask-and-docker-575dc07d9e76](https://link.zhihu.com/?target=https%3A//medium.com/analytics-vidhya/deploy-your-first-deep-learning-model-on-kubernetes-with-python-keras-flask-and-docker-575dc07d9e76)
