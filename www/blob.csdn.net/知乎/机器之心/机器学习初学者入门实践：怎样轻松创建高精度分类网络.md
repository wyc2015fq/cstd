...
![](https://pic3.zhimg.com/v2-b6dcd98ce939799c7a7ba96c3fccabde_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='600' height='402'></svg>)![](https://pic4.zhimg.com/v2-1e4ed24c9698f97041b3cf36c4b49113_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='600' height='375'></svg>)
...
指南地址：[humphd (David Humphrey)](https://link.zhihu.com/?target=https%3A//github.com/humphd)
...
- 
J Alammar 的博客《A Visual and Interactive Guide to the Basics of Neural Networks》非常赞，使用直观的案例介绍了神经网络的概念：[A Visual and Interactive Guide to the Basics of Neural Networks](https://link.zhihu.com/?target=https%3A//jalammar.github.io/visual-interactive-guide-basics-neural-networks/)

- 
Brandon Rohrer 的这个视频是非常好的卷积神经网络介绍：[https://www.youtube.com/watch?v=FmpDIaiMIeA](https://link.zhihu.com/?target=https%3A//www.youtube.com/watch%3Fv%3DFmpDIaiMIeA)

- 
如果你想了解更多理论上的知识，我推荐 Michael Nielsen 的在线书籍《Neural Networks and Deep Learning》：[Neural networks and deep learning](https://link.zhihu.com/?target=http%3A//neuralnetworksanddeeplearning.com/index.html)
...
Caffe 地址：[Caffe | Deep Learning Framework](https://link.zhihu.com/?target=http%3A//caffe.berkeleyvision.org/)
...
- 
支持 C++ 和 Python（即将支持 node.js：[silklabs/node-caffe](https://link.zhihu.com/?target=https%3A//github.com/silklabs/node-caffe)）([https://github.com/silklabs/node-caffe%EF%BC%89](https://link.zhihu.com/?target=https%3A//github.com/silklabs/node-caffe%25EF%25BC%2589))
...
Caffe 的安装有点麻烦。这里有不同平台的安装说明，包括一些预构建的 Docker 或 AWS 配置：[Caffe | Installation](https://link.zhihu.com/?target=http%3A//caffe.berkeleyvision.org/installation.html)


注：当我在进行练习的时候，我使用了来自 GitHub 的尚未发布的 Caffe 版本：[Merge pull request #5057 from Queuecumber/cuda-pascal-cmake · BVLC/caffe@5a201dd](https://link.zhihu.com/?target=https%3A//github.com/BVLC/caffe/commit/5a201dd960840c319cefd9fa9e2a40d2c76ddd73)


在 Mac 要配置成功则难得多，这个版本有一些版本问题会在不同的步骤终止你的进度。我用了好几天时间来试错，我看了十几个指南，每一个都有一些不同的问题。最后发现这个最为接近：[https://gist.github.com/doctorpangloss/f8463bddce2a91b949639522ea1dcbe4](https://link.zhihu.com/?target=https%3A//gist.github.com/doctorpangloss/f8463bddce2a91b949639522ea1dcbe4)。另外我还推荐：[How To: Set up Caffe Environment and pycaffe on OS X 10.12 Sierra](https://link.zhihu.com/?target=https%3A//eddiesmo.wordpress.com/2016/12/20/how-to-set-up-caffe-environment-and-pycaffe-on-os-x-10-12-sierra/)，这篇文章比较新而且链接了许多类似的讨论。


到目前为止，安装 Caffe 就是我们做的最难的事情，这相当不错，因为你可能原来还以为人工智能方面会更难呢！


如果安装遇到问题请不要放弃，痛苦是值得的。如果我会再来一次，我可能会使用一个 Ubuntu 虚拟机，而不是直接在 Mac 上安装。如果你有问题要问，可以到 Caffe 用户讨论组：[https://groups.google.com/forum/#!forum/caffe-users](https://link.zhihu.com/?target=https%3A//groups.google.com/forum/%23%21forum/caffe-users)
...
另外说明一点，因为我有一块集成英特尔显卡，而不是英伟达的 GPU，所以我决定使用 OpenCL Caffe 分支：[BVLC/caffe](https://link.zhihu.com/?target=https%3A//github.com/BVLC/caffe/tree/opencl)，它在我的笔记本电脑上效果良好！
...
DIGITS 地址：[NVIDIA/DIGITS](https://link.zhihu.com/?target=https%3A//github.com/NVIDIA/DIGITS)
...
在 [NVIDIA/DIGITS](https://link.zhihu.com/?target=https%3A//github.com/NVIDIA/DIGITS/tree/master/docs) 有一些非常好的文档，包括一些安装、配置和启动的页面。我强烈建议你在继续之前通读一下。我并不是一个使用 DIGITS 的专家，如果有问题可以在公开的 DIGITS 用户组查询或询问：[https://groups.google.com/forum/#!forum/digits-users](https://link.zhihu.com/?target=https%3A//groups.google.com/forum/%23%21forum/digits-users)


安装 DIGITS 的方式有很多种，从 Docker 到 Linux 上的 pre-baked package，或者你也可以从源代码构建。我用的 Mac，所以我就是从源代码构建的。


注：在我的实践中，我使用了 GitHub 上未发布的 DIGITS 版本：[Add steps to specify the Python layer file (#1347) · NVIDIA/DIGITS@81be513](https://link.zhihu.com/?target=https%3A//github.com/NVIDIA/DIGITS/commit/81be5131821ade454eb47352477015d7c09753d9)
...
一旦服务器启动，你可以在你的浏览器中通过 [http://localhost:5000](https://link.zhihu.com/?target=http%3A//localhost%3A5000) 来完成一切后续工作。
...
当然可以。详见 [NVIDIA/DIGITS](https://link.zhihu.com/?target=https%3A//github.com/NVIDIA/DIGITS/blob/digits-4.0/docs/ImageFolderFormat.md)。


我们要用这些图片来创建一个新的数据集，准确的说是一个分类数据集（Classification Dataset）。

![](https://pic1.zhimg.com/v2-8498ca8d986454754972c8d89b34022c_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='771' height='437'></svg>)我们会使用 DIGITS 的默认设置，并把我们的训练图片文件路径设置到 data/dolphins-and-seahorses 文件夹。如此一来，DIGITS 将会使用这些标签（dolphin 和 seahorse）来创建一个图像缩放过的数据集——图片的大小将会是 256×256，其中 75% 的为训练图片，25% 的为测试图片。


给你的数据集起一个名字，如 dolphins-and-seahorses，然后鼠标点击创建（Create）。
![](https://pic1.zhimg.com/v2-14e3f916c6c461c04ad64dc2838e7b10_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='985' height='1096'></svg>)
...
![](https://pic2.zhimg.com/v2-8b9919f077d251bf36febddc8b284a71_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='981' height='1061'></svg>)
**训练尝试 1：从头开始**
...
![](https://pic4.zhimg.com/v2-f94e502b7d86b512f8935bfae38d171b_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='995' height='438'></svg>)我们将开始用上一步所建立的 dolphins-and-seahorses 数据集来训练模型，仍然使用 DIGITS 的默认设置。对于第一个神经网络模型，我们可以从提供的神经网络架构中选取一个既有的标准模型，即 AlexNet。AlexNet 的网络结构在 2012 年的计算机视觉竞赛 ImageNet 中获胜过（ImageNet 为计算机视觉顶级比赛）。在 ImageNet 竞赛里需要完成 120 万张图片中 1000 多类图片的分类。
![](https://pic1.zhimg.com/v2-08589dbebaad5207650bf13c3a833b00_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='962' height='1425'></svg>)
Caffe 使用结构化文本文件（structured text files）来定义网络架构，其所使用的文本文件是基于谷歌的 Protocol Buffer。你可以阅读 Caffe 采用的方案：[BVLC/caffe](https://link.zhihu.com/?target=https%3A//github.com/BVLC/caffe/blob/master/src/caffe/proto/caffe.proto)。其中大部分内容在这一部分的神经网络训练的时候都不会用到，但是了解这些构架对于使用者还是很有用的，因为在后面的步骤里我们将会对它们进行调整。AlexNet 的 prototxt 文件是这样的，一个实例： [BVLC/caffe](https://link.zhihu.com/?target=https%3A//github.com/BVLC/caffe/blob/master/models/bvlc_alexnet/train_val.prototxt)。
...
![](https://pic4.zhimg.com/v2-fdc2aaa024d35f56b4e4d174b7aa54f3_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='576' height='500'></svg>)我们可以上传一张图片或者用一个 URL 地址的图片来测试训练完的网络。我们来测试一些出现在我们训练和测试数据集中的图片：

![](https://pic2.zhimg.com/v2-42e063269b29cfc8f82cb5b35d036101_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='628' height='345'></svg>)![](https://pic1.zhimg.com/v2-a7229a91972b3bb8319c38f9c26eeacc_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='639' height='348'></svg>)网络的分类结果非常完美，当我们测试一些不属于我们训练和测试数据集的其他图片时：
![](https://pic2.zhimg.com/v2-bd2381e1f380db8c89a32b8c15483c49_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='636' height='343'></svg>)
...
AlexNet 的快照（Snapshots）如下，可供下载：[BVLC/caffe](https://link.zhihu.com/?target=https%3A//github.com/BVLC/caffe/tree/master/models/bvlc_alexnet)。我们需要一个二进制文件 .caffemodel，含有训练好的权重，可供下载 [http://dl.caffe.berkeleyvision.org/bvlc_alexnet.caffemodel](https://link.zhihu.com/?target=http%3A//dl.caffe.berkeleyvision.org/bvlc_alexnet.caffemodel)。在你下载这些与训练模型的时候，让我们来趁机多学点东西。2014 年的 ImageNet 大赛中，谷歌利用其开源的 GoogLeNet ([https://research.google.com/pubs/pub43022.html](https://link.zhihu.com/?target=https%3A//research.google.com/pubs/pub43022.html))（一个 22 层的神经网络）赢得了比赛。GoogLeNet 的快照如下，可供下载： [BVLC/caffe](https://link.zhihu.com/?target=https%3A//github.com/BVLC/caffe/tree/master/models/bvlc_googlenet)。在具备了所有的预训练权重之后，我们还需要.caffemodel 文件，可供下载：[http://dl.caffe.berkeleyvision.org/bvlc_googlenet.caffemodel](https://link.zhihu.com/?target=http%3A//dl.caffe.berkeleyvision.org/bvlc_googlenet.caffemodel).


有了 .caffemodel 文件之后，我们既可以将它们上传到 DIGITS 当中。在 DIGITS 的主页当中找到预训练模型（Pretrained Models）的标签，选择上传预训练模型（Upload Pretrained Model）：
![](https://pic4.zhimg.com/v2-d6eedd097790f80ce57b472c22b57477_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='985' height='408'></svg>)
...
模型的定义，GoogLeNet 我们可以使用 [BVLC/caffe](https://link.zhihu.com/?target=https%3A//github.com/BVLC/caffe/blob/master/models/bvlc_googlenet/train_val.prototxt)，AlexNet 可以使用 [BVLC/caffe](https://link.zhihu.com/?target=https%3A//github.com/BVLC/caffe/blob/master/models/bvlc_alexnet/train_val.prototxt)。我们不打算使用这些网络的分类标签，所以我们可以直接添加一个 labels.txt 文件：
![](https://pic3.zhimg.com/v2-54c05661aa31e2414cb752027340516a_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='492' height='496'></svg>)
...
回答：Caffe Model Zoo 有许多其他预训练神经网络可供使用，详情请查看 [BVLC/caffe](https://link.zhihu.com/?target=https%3A//github.com/BVLC/caffe/wiki/Model-Zoo)
...
![](https://pic2.zhimg.com/v2-1c5d5dd0da2a819b418ad3f6921da20d_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='951' height='1709'></svg>)
...
![](https://pic2.zhimg.com/v2-2ba9eba1687b03d0efeea1e61116d781_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='579' height='499'></svg>)测试海马图像时以前的网络会出错，现在我们看到完全相反的结果，即使是小孩画的海马，系统也 100% 确定是海马，海豚的情况也一样。

![](https://pic4.zhimg.com/v2-8ebc054bf04a1027545a7cb1c8793d73_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='637' height='335'></svg>)![](https://pic4.zhimg.com/v2-eb3cabcc629c2e7cf85ad3edeed51597_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='628' height='343'></svg>)![](https://pic4.zhimg.com/v2-5f006c9aab8c844383f8042cce01e5b3_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='630' height='342'></svg>)即使你认为可能很困难的图像，如多个海豚挤在一起，并且它们的身体大部分在水下，系统还是能识别。
![](https://pic3.zhimg.com/v2-5bb10cca15ff728833a722ee94f2e59e_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='626' height='337'></svg>)
**训练尝试 3：微调 GoogLeNet**


像前面我们微调 AlexNet 模型那样，同样我们也能用 GoogLeNet。修改这个网络会有点棘手，因为你已经定义了三层全连接层而不是只有一层。
![](https://pic1.zhimg.com/v2-b310784aa26e2a1a1e8802dcbb7305d4_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='954' height='1706'></svg>)
...
![](https://pic4.zhimg.com/v2-f43d5f4867ec8ebfc0a56cc7c88a8967_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='579' height='499'></svg>)正如我们看到的 AlexNet 微调版本，我们修改过的 GoogLeNet 表现得十分惊人，是我们目前最好的。
![](https://pic3.zhimg.com/v2-6feefda28e8340f088dcb11509f015e2_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='634' height='333'></svg>)![](https://pic1.zhimg.com/v2-5e68d183ef41c6d5dab23dfcd51b4a4c_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='634' height='341'></svg>)![](https://pic4.zhimg.com/v2-2291effce9a050a7406fc6e69993b6ef_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='627' height='336'></svg>)
**使用我们的模型**


我们的网络在训练和检测之后，就可以下载并且使用了。我们利用 DIGITS 训练的每一个模型都有了一下载模型（Download Model）键，这也是我们在训练过程中选择不同 snapshots 的一种方法（例如 Epoch #30）：
![](https://pic3.zhimg.com/v2-52e63fe20b118c76671320a672103f32_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='602' height='151'></svg>)
...
你可以在这个 Caffe 案例中查看完整的 C++ 源码：[BVLC/caffe](https://link.zhihu.com/?target=https%3A//github.com/BVLC/caffe/tree/master/examples)


使用 Python 界面和 DIGITS 进行分类的案例：[NVIDIA/DIGITS](https://link.zhihu.com/?target=https%3A//github.com/NVIDIA/DIGITS/tree/master/examples/classification)


最后，Caffe 的案例中还有一个非常好的 Python 演示：[BVLC/caffe](https://link.zhihu.com/?target=https%3A//github.com/BVLC/caffe/blob/master/examples/00-classification.ipynb)
...
![](https://pic3.zhimg.com/v2-b6dcd98ce939799c7a7ba96c3fccabde_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='600' height='402'></svg>)![](https://pic1.zhimg.com/v2-cbbde4b854c8c48e22648b732c072fe0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='600' height='441'></svg>)![](https://pic1.zhimg.com/v2-9eaf05cc51fcb8438a8ed7996438c670_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='600' height='400'></svg>)**未被训练过的海马图像**
![](https://pic4.zhimg.com/v2-1e4ed24c9698f97041b3cf36c4b49113_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='600' height='375'></svg>)![](https://pic3.zhimg.com/v2-b429d5863816f7d15f7d8f30a4c8c826_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='667' height='442'></svg>)
![](https://pic3.zhimg.com/v2-d19994cb0e0ad863b4964d8f2b4cab0a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='480' height='640'></svg>)
接下来，让我们一起来看看在这一挑战当中存在的三次尝试的结果：


模型尝试 1： 从零开始构建 AlexNet（第 3 位）

![](https://pic3.zhimg.com/v2-75ab03c6b9b5988418400de22a7ad2aa_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='571' height='394'></svg>)模型尝试 2：微调 AlexNet（第 2 位）
![](https://pic2.zhimg.com/v2-6733c1a3db76fb92ad362b92f7412c01_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='572' height='396'></svg>)
模型尝试 3：微调 GoogLeNet（第 1 位）
![](https://pic4.zhimg.com/v2-1831a1771f981c478058494f77248957_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='571' height='396'></svg>)
**结论**
...
选自[GitHub](https://link.zhihu.com/?target=https%3A//github.com/humphd/have-fun-with-machine-learning/blob/master/README.md)**机器之心编译**
