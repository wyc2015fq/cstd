# 世界上最好的语言PHP：我也可以用OpenCV搞计算机视觉 - 知乎
# 



选自Medium，作者：Vladimir Goncharov，机器之心编译。
...
![](https://pic1.zhimg.com/v2-d2a8edfc402b658d9afafcecf75c8894_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='270'></svg>)
...
DNN 模块：[https://github.com/opencv/opencv/wiki/ChangeLog#version341](https://link.zhihu.com/?target=https%3A//github.com/opencv/opencv/wiki/ChangeLog%23version341)
...
![](https://pic2.zhimg.com/v2-4f8d3d797f4beeb27aa08529b232362d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='200' height='200'></svg>)php-opencv 项目的 logo
...
php-opencv：[https://github.com/hihozhou/php-opencv](https://link.zhihu.com/?target=https%3A//github.com/hihozhou/php-opencv)
...
完整测示例代码：[https://github.com/php-opencv/php-opencv-examples/blob/master/detect_face_by_cascade_classifier.php](https://link.zhihu.com/?target=https%3A//github.com/php-opencv/php-opencv-examples/blob/master/detect_face_by_cascade_classifier.php)




**结果：**
![](https://pic2.zhimg.com/v2-c5c9f6a0a38d5ada76bfc0ee02026d6d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='270'></svg>)
...
完整的示例代码：[https://github.com/php-opencv/php-opencv-examples/blob/master/recognize_face_by_lbph.php](https://link.zhihu.com/?target=https%3A//github.com/php-opencv/php-opencv-examples/blob/master/recognize_face_by_lbph.php)




**数据集：**
![](https://pic2.zhimg.com/v2-072fcb1ecee527a25a237ee4242a30d1_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='270'></svg>)![](https://pic3.zhimg.com/v2-5167a3cf20e2835035e8d4d15f59caf6_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1000' height='250'></svg>)



**结果：**
![](https://pic4.zhimg.com/v2-0fa4b81da83f15a4824b83465036eefb_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='500' height='250'></svg>)
...
完整的示例代码：[https://github.com/php-opencv/php-opencv-examples/blob/master/detect_facemarks_by_lbf.php](https://link.zhihu.com/?target=https%3A//github.com/php-opencv/php-opencv-examples/blob/master/detect_facemarks_by_lbf.php)
...
Deep Learning，now in OpenCV：[https://github.com/opencv/opencv/wiki/ChangeLog#version341](https://link.zhihu.com/?target=https%3A//github.com/opencv/opencv/wiki/ChangeLog%23version341)
...
完整的示例代码：[https://github.com/php-opencv/php-opencv-examples/blob/master/detect_face_by_dnn_ssd.php](https://link.zhihu.com/?target=https%3A//github.com/php-opencv/php-opencv-examples/blob/master/detect_face_by_dnn_ssd.php)




**结果：**
![](https://pic4.zhimg.com/v2-09b704ddc36ac81823c9f3598e9a6c27_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='270'></svg>)
...
- waifu2x 库：[https://github.com/nagadomi/waifu2x](https://link.zhihu.com/?target=https%3A//github.com/nagadomi/waifu2x)
- 示例的完整代码：[https://github.com/php-opencv/php-opencv-examples/blob/master/upscale_image_x2_by_dnn_waifu2x.php](https://link.zhihu.com/?target=https%3A//github.com/php-opencv/php-opencv-examples/blob/master/upscale_image_x2_by_dnn_waifu2x.php)
![](https://pic4.zhimg.com/v2-939a49bbbffffd13d229cbbe7842b783_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='262' height='765'></svg>)不使用神经网络放大图片
**图像分类**

在 ImageNet 上训练的 MobileNet 神经网络可以分类图像。总的来说，它可以区分 1000 个类别，这对我来说还不够。

示例的完整代码：[https://github.com/php-opencv/php-opencv-examples/blob/master/classify_image_by_dnn_mobilenet.php](https://link.zhihu.com/?target=https%3A//github.com/php-opencv/php-opencv-examples/blob/master/classify_image_by_dnn_mobilenet.php)
![](https://pic4.zhimg.com/v2-eb42148548399731874d5ee0eea09e03_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='240' height='160'></svg>)结果： 87% - 埃及猫，4% - 斑猫，2% - 虎猫
**Tensorflow 目标检测 API**

在 COCO 数据集上使用 Tensorflow 训练的 MobileNet SSD（Single Shot MultiBox Detector）网络不仅可以对图像进行分类，还可以返回目标区域，尽管只能检测 182 个类别。

示例的完整代码：[https://github.com/php-opencv/php-opencv-examples/blob/master/detect_objects_by_dnn_mobilenet.php](https://link.zhihu.com/?target=https%3A//github.com/php-opencv/php-opencv-examples/blob/master/detect_objects_by_dnn_mobilenet.php)
![](https://pic2.zhimg.com/v2-d535e3f44e2346a2cfb3551bee83a9dd_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='500' height='375'></svg>)原图![](https://pic2.zhimg.com/v2-728196c49155686dff4fd582dacfe0e9_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='500' height='375'></svg>)结果
**语法高亮和代码补全**
...
phpdoc.php：[https://github.com/php-opencv/php-opencv-examples/blob/master/phpdoc.php](https://link.zhihu.com/?target=https%3A//github.com/php-opencv/php-opencv-examples/blob/master/phpdoc.php)
...
在 GitHub 上传包：[https://github.com/php-opencv/php-opencv-packages](https://link.zhihu.com/?target=https%3A//github.com/php-opencv/php-opencv-packages)
...
安装这个选项大约需要 1 分钟，所有安装选项在 Ubuntu 上进行：[https://github.com/php-opencv/php-opencv-examples/wiki/Installation-on-ubuntu](https://link.zhihu.com/?target=https%3A//github.com/php-opencv/php-opencv-examples/wiki/Installation-on-ubuntu)
...
原文链接：[https://medium.com/@morozovsk/computer-vision-and-machine-learning-in-php-using-the-opencv-library-3131fe9df94b](https://link.zhihu.com/?target=https%3A//medium.com/%40morozovsk/computer-vision-and-machine-learning-in-php-using-the-opencv-library-3131fe9df94b)
