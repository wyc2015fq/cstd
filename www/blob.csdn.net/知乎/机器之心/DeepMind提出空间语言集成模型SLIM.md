...
![](https://pic2.zhimg.com/v2-24efeabbd66ff01a371af82ee5a26455_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='374'></svg>)
...
![](https://pic4.zhimg.com/v2-2f20ca76ae2c0ac20705806250a4cd13_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='285'></svg>)
...
**2 基于视觉的场景描述数据集**
![](https://pic4.zhimg.com/v2-ef708125a27e18844d9ab7d2ce483f6b_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='568' height='242'></svg>)表 1：数据集统计结果
**B.1 数据集示例**

B.1.1 合成语言，两个对象
![](https://pic2.zhimg.com/v2-ed0a306a5fd470bfdec8a02f0317f80d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='484' height='711'></svg>)
B.1.2 合成语言，三个对象
![](https://pic2.zhimg.com/v2-e9b4be6bb3767ef9c3c276892bcd63fd_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='425' height='650'></svg>)
B.1.3 自然语言，两个对象
![](https://pic4.zhimg.com/v2-941b7d9d003a2b85c5fcbb7a7857d583_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='480' height='716'></svg>)
B.1.4 自然语言，三个对象
![](https://pic3.zhimg.com/v2-e769c47cb8f81538e2c46c770b56222a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='431' height='651'></svg>)
**3 模型描述**
...
![](https://pic2.zhimg.com/v2-96d7e4e5986b75ac5007a73e9ae4ff31_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='963' height='444'></svg>)
图 2：模型图示。表征网络解析多个摄像机坐标拍摄的多视点场景的多个描述和文本描述。所有视点的表征被聚合成一个场景表征向量 r，然后生成网络使用该向量 r 来重建从新的相机坐标看到的场景的图像。
![](https://pic1.zhimg.com/v2-be8a28dcc88764bbc5efb6c84d7aab2c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='486'></svg>)
...
**4 场景编码实验**
![](https://pic2.zhimg.com/v2-51e4246d30525d362539f0297fc2b73d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='308'></svg>)
...
**5 表征分析**
![](https://pic3.zhimg.com/v2-d894b36a8bd3cda4d35f95c1b1c50996_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='401'></svg>)
...
![](https://pic3.zhimg.com/v2-7c1c8b080bbdc7fdf6c8d787b44fad62_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='904' height='214'></svg>)表 2： Gershman and Tenenbaum (2015) 变换![](https://pic2.zhimg.com/v2-6bd2dac63f476a5085c6ff2615181251_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='566'></svg>)
