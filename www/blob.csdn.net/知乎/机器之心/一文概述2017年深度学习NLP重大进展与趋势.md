...
可以说，词嵌入是用于自然语言处理（NLP）的最广为人知的深度学习（DL）技术。它遵循由 Harris（1954）提出的分布式假设，根据该假设，具有相似含义的词通常出现在相似语境中。如想详细了解词嵌入，推荐阅读 Gabriel Mordecki 的文章：《Word embeddings: how to transform text into numbers》（[https://monkeylearn.com/blog/word-embeddings-transform-text-numbers/](https://link.zhihu.com/?target=https%3A//monkeylearn.com/blog/word-embeddings-transform-text-numbers/)）。
![](https://pic1.zhimg.com/v2-2a84fc31c1ebfed0dd35c7714be8cc0c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='175'></svg>)
*词的分布式向量示例（图像来源：[https://arxiv.org/abs/1708.02709](https://link.zhihu.com/?target=https%3A//arxiv.org/abs/1708.02709)）。*
...
![](https://pic3.zhimg.com/v2-1812dfb634732f4945e5757844bef4fe_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='472'></svg>)
*评论极性 vs 神经元值（图像来源：[https://blog.openai.com/unsupervised-sentiment-neuron/](https://link.zhihu.com/?target=https%3A//blog.openai.com/unsupervised-sentiment-neuron/)）。*
...
![](https://pic4.zhimg.com/v2-f9f1009f41e7ac829401664dafbfc3b3_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='176'></svg>)
*情感神经元的行为（图像来源：[https://blog.openai.com/unsupervised-sentiment-neuron/](https://link.zhihu.com/?target=https%3A//blog.openai.com/unsupervised-sentiment-neuron/)）。*
...
![](https://pic4.zhimg.com/v2-f4254849a04b212db265b937ed1a5893_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='256'></svg>)
*生成文本示例（图像来源：[https://blog.openai.com/unsupervised-sentiment-neuron/](https://link.zhihu.com/?target=https%3A//blog.openai.com/unsupervised-sentiment-neuron/)）。*
...
![](https://pic3.zhimg.com/v2-d3638d7de8f766b4dd103c255b0fb5b6_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='210'></svg>)
*特朗普和希拉里在 Twitter 上的情感分析（图像来源：[https://monkeylearn.com/blog/donald-trump-vs-hillary-clinton-sentiment-analysis-twitter-mentions/](https://link.zhihu.com/?target=https%3A//monkeylearn.com/blog/donald-trump-vs-hillary-clinton-sentiment-analysis-twitter-mentions/)）。*
...
![](https://pic1.zhimg.com/v2-067b298baecd3e22d9b24b2a5b75820c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='200'></svg>)
*自动摘要生成模型图示（图片来源：[https://einstein.ai/research/your-tldr-by-an-ai-a-deep-reinforced-model-for-abstractive-summarization](https://link.zhihu.com/?target=https%3A//einstein.ai/research/your-tldr-by-an-ai-a-deep-reinforced-model-for-abstractive-summarization)）。*
...
![](https://pic1.zhimg.com/v2-9865aa11b54846a19e532b3d75b8eca8_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='153'></svg>)
*构建两个词嵌入空间之间的映射（图像来源：[https://arxiv.org/pdf/1710.04087.pdf](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1710.04087.pdf)）。红色的 X 分布是英语单词的词嵌入，蓝色的 Y 分布是意大利单词的词嵌入。*




首先，他们使用对抗学习学习旋转矩阵 W，W 执行第一次原始对齐（raw alignment）。他们基本上按照 Goodfellow et al.（2014）的 proposition 训练生成对抗网络（GAN）。如想对 GAN 的工作原理有直观了解，推荐阅读 [https://tryolabs.com/blog/2016/12/06/major-advancements-deep-learning-2016/](https://link.zhihu.com/?target=https%3A//tryolabs.com/blog/2016/12/06/major-advancements-deep-learning-2016/)。
...
![](https://pic3.zhimg.com/v2-521ec0bb53919d69c5ea8bd2f5e9e82e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='373'></svg>)
*英语-意大利语词翻译平均准确率（图像来源：[https://arxiv.org/pdf/1710.04087.pdf](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1710.04087.pdf)）。*
...
![](https://pic3.zhimg.com/v2-7d50c9bd46e7c81cc28782fdcf58363e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='429'></svg>)
*深度学习论文在 NLP 会议论文中的比例（图像来源：[https://arxiv.org/abs/1708.02709](https://link.zhihu.com/?target=https%3A//arxiv.org/abs/1708.02709)）。*
...
**扩展阅读**
- NLP 研究中的深度学习方法：Recent Trends in Deep Learning Based Natural Language Processing，Young et al.（2017）：[https://arxiv.org/pdf/1708.02709.pdf](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1708.02709.pdf)
- From Characters to Understanding Natural Language (C2NLU): Robust End-to-End Deep Learning for NLP，Blunsom et al.（2017）：[http://drops.dagstuhl.de/opus/volltexte/2017/7248/pdf/dagrep_v007_i001_p129_s17042.pdf](https://link.zhihu.com/?target=http%3A//drops.dagstuhl.de/opus/volltexte/2017/7248/pdf/dagrep_v007_i001_p129_s17042.pdf)
- 模型对比：Comparative Study of CNN and RNN for Natural Language Processing，Yin et al.（2017）：[https://arxiv.org/pdf/1702.01923.pdf](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1702.01923.pdf)
- GAN 工作原理：The major advancements in Deep Learning in 2016，Pablo Soto：[https://tryolabs.com/blog/2016/12/06/major-advancements-deep-learning-2016/](https://link.zhihu.com/?target=https%3A//tryolabs.com/blog/2016/12/06/major-advancements-deep-learning-2016/)
- 词嵌入详解：Word embeddings: how to transform text into numbers，Gabriel Mordecki：[https://monkeylearn.com/blog/word-embeddings-transform-text-numbers/](https://link.zhihu.com/?target=https%3A//monkeylearn.com/blog/word-embeddings-transform-text-numbers/)
- Word embeddings in 2017: Trends and future directions，Sebastian Ruder：[http://ruder.io/word-embeddings-2017/](https://link.zhihu.com/?target=http%3A//ruder.io/word-embeddings-2017/)
...
*原文链接：[https://tryolabs.com/blog/2017/12/12/deep-learning-for-nlp-advancements-and-trends-in-2017/](https://link.zhihu.com/?target=https%3A//tryolabs.com/blog/2017/12/12/deep-learning-for-nlp-advancements-and-trends-in-2017/)*
