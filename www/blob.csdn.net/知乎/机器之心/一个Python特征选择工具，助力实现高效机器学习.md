...
项目地址：[https://github.com/WillKoehrsen/feature-selector](https://link.zhihu.com/?target=https%3A//github.com/WillKoehrsen/feature-selector)
...
为了进行演示，我们将使用来自 Kaggle「家庭信用违约风险」机器学习竞赛的一个数据样本。了解该竞赛可参阅：[https://towardsdatascience.com/machine-learning-kaggle-competition-part-one-getting-started-32fb9ff47426](https://link.zhihu.com/?target=https%3A//towardsdatascience.com/machine-learning-kaggle-competition-part-one-getting-started-32fb9ff47426)，完整数据集可在这里下载：[https://www.kaggle.com/c/home-credit-default-risk/data](https://link.zhihu.com/?target=https%3A//www.kaggle.com/c/home-credit-default-risk/data)。这里我们将使用部分数据样本来进行演示。
![](https://pic2.zhimg.com/v2-f449af4bffb21277248d6312b48056c5_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1000' height='158'></svg>)数据示例。TARGET 是分类标签
...
![](https://pic2.zhimg.com/v2-7d3001e38deb6319fb3e93634eaeb6ad_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='311' height='198'></svg>)
...
`fs.plot_missing()`
![](https://pic4.zhimg.com/v2-ddc14ab410114a1a2350afc9ac537723_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='606' height='462'></svg>)
**共线性特征**
...
`fs.plot_collinear()`
![](https://pic4.zhimg.com/v2-e57ee897c6119894c78200d579706e8f_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='800' height='742'></svg>)
...
![](https://pic2.zhimg.com/v2-504e4747303ec6a5762379ee1d4e31a5_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='401' height='176'></svg>)
如果我们想全面了解数据集，我们还可以通过将 plot_all = True 传入该调用，绘制出数据中所有相关性的图表:
![](https://pic4.zhimg.com/v2-a6457de1eac0bb774d045350050b334b_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='758' height='676'></svg>)
**零重要度特征**
...
LightGBM 库：[http://lightgbm.readthedocs.io/](https://link.zhihu.com/?target=http%3A//lightgbm.readthedocs.io/)
...
![](https://pic4.zhimg.com/v2-47192cec234fee6c3ea1bb8d6635d8ff_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='310'></svg>)
...
![](https://pic2.zhimg.com/v2-fda548276db315f5afc0e58999077a09_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='628' height='306'></svg>)
...
`fs.plot_unique()`
![](https://pic4.zhimg.com/v2-78f18f05b95bb762d317d701b101aca7_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='614' height='462'></svg>)
...
原文链接：[https://towardsdatascience.com/a-feature-selection-tool-for-machine-learning-in-python-b64dd23710f0](https://link.zhihu.com/?target=https%3A//towardsdatascience.com/a-feature-selection-tool-for-machine-learning-in-python-b64dd23710f0)
