# Facebook开源NLP建模框架PyText，从论文到产品部署只需数天 - 知乎
# 



选自code.fb，作者：AHMED ALY HEGAZY、CHRISTOPHER DEWAN，机器之心编译，参与：淑婷、张倩。
...
![](https://pic2.zhimg.com/v2-64e4e45e25ab360af29bd12edbc41de5_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='340'></svg>)
...
**从研究到生产变得更容易**
![](https://pic2.zhimg.com/v2-a3177b98bf8af490bd58d95310dcfd59_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='561'></svg>)
...
![](https://pic1.zhimg.com/v2-f5c284c806ac74f976c2a4d8d5435d20_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='560'></svg>)
一旦工程师对模型的性能感到满意，那他/她就可以利用 PyText 中的 exporter 模块，通过 ONNX 把模型导出至 Caffe2。然后 Caffe2 可以在 C++ 处理产品流量的推断服务中评估和部署。
![](https://pic3.zhimg.com/v2-7d83f108fae0615320af460c4e2b9456_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='608'></svg>)这个代码示例展示了如何使用 ONNX 将模型导出至 Caffe2，预先添加一个运算符（如 string2id），然后执行任何必要的后处理
**PyText 和 NLP 工具的未来**
...
更多关于 PyText 的细节请参考：[https://research.fb.com/publications/pytext-a-seamless-path-from-nlp-research-to-production/](https://link.zhihu.com/?target=https%3A//research.fb.com/publications/pytext-a-seamless-path-from-nlp-research-to-production/)
*![](https://pic1.zhimg.com/v2-18cc987d5f379a82f1208b6d90722318_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='73' height='24'></svg>)*
原文链接：[https://code.fb.com/ai-research/pytext-open-source-nlp-framework/](https://link.zhihu.com/?target=https%3A//code.fb.com/ai-research/pytext-open-source-nlp-framework/)
