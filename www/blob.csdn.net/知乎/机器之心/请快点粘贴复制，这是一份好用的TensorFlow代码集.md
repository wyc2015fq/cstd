# 请快点粘贴复制，这是一份好用的TensorFlow代码集 - 知乎
# 



> [TensorFlow](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzA3MzI4MjgzMw%3D%3D%26mid%3D2650757267%26idx%3D4%26sn%3D31cfed7163a6c049001b0a7a69a30eb2%26chksm%3D871a9cedb06d15fbda2858747a4de2fee0cc8767beb019bc035ed71bd7a32fe1a43700a6bdf3%26token%3D360042082%26lang%3Dzh_CN) 虽然是目前最为流行的神经网络框架，却以「难于上手」著称（Jeff Dean：怪我咯）。有些时候，我们需要简明扼要的代码来指点迷津。最近，来自 NCsoft AI 研究部门的 Junho Kim 就放出了一份这样的 TensorFlow 代码集。它类似于一个迷你版的 Keras，只不过因为其简单性，源码要好读得多。

项目链接：[https://github.com/taki0112/Tensorflow-Cookbook](https://link.zhihu.com/?target=https%3A//github.com/taki0112/Tensorflow-Cookbook)

在这个项目中，作者重点突出这是一份易于使用的 TensorFlow 代码集，它包括常见的正则化、[卷积运算](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzA3MzI4MjgzMw%3D%3D%26mid%3D2650757267%26idx%3D4%26sn%3D31cfed7163a6c049001b0a7a69a30eb2%26chksm%3D871a9cedb06d15fbda2858747a4de2fee0cc8767beb019bc035ed71bd7a32fe1a43700a6bdf3%26token%3D360042082%26lang%3Dzh_CN)和架构模块等代码。实际上，在我们搭建自己的模型或系统时，复制并粘贴这些代码就行了。它们以规范的形式定义不同的功能模块，因此只要修改少量参数与代码，它们就能完美地融入到我们项目中。

目前该项目包含一般深度学习架构所需要的代码，例如初始化和正则化、各种卷积运算、基本网络架构与模块、[损失函数](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s%3F__biz%3DMzA3MzI4MjgzMw%3D%3D%26mid%3D2650757267%26idx%3D4%26sn%3D31cfed7163a6c049001b0a7a69a30eb2%26chksm%3D871a9cedb06d15fbda2858747a4de2fee0cc8767beb019bc035ed71bd7a32fe1a43700a6bdf3%26token%3D360042082%26lang%3Dzh_CN)和其它数据预处理过程。此外，作者还特别增加了对 GAN 的支持，这主要体现在损失函数上，其中生成器损失和判别器损失可以使用推土机距离、最小二乘距离和 KL 散度等。
...
项目页面：[https://www.notion.so/Simple-Tensorflow-Cookbook-6f4563d0cd7343cb9d1e60cd1698b54d](https://link.zhihu.com/?target=https%3A//www.notion.so/Simple-Tensorflow-Cookbook-6f4563d0cd7343cb9d1e60cd1698b54d)

目前整个项目包含 20 种代码块，它们可用于快速搭建深度学习模型：
![](https://pic1.zhimg.com/v2-404da9f1cd987ff9a8c6849262f7b66c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='573' height='671'></svg>)![](https://pic2.zhimg.com/v2-a87242bf22aa67db0c435023fadc5691_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='547' height='609'></svg>)
**代码示例**
...
`x = conv(x, channels=64, kernel=3, stride=2, pad=1, pad_type='reflect', use_bias=True, sn=True, scope='conv')`
![](https://pic3.zhimg.com/v2-4699556161e5d0111cdd0cde992b3692_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='495' height='576'></svg>)
...
![](https://pic3.zhimg.com/v2-9d0857f815fd790cf44835eae713ef62_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='512'></svg>)![](https://pic2.zhimg.com/v2-bb86381cd9cc70a00d5f75ebb3fe00ad_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='404'></svg>)
...
![](https://pic1.zhimg.com/v2-b181181bb37607590ccc2dd42fbf1c0c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='800' height='384'></svg>)
