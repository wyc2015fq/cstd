# 终于，Geoffrey Hinton那篇备受关注的Capsule论文公开了 - 知乎
# 
...
![](https://pic3.zhimg.com/v2-7bc80e90ed967c7e8470906699ea42fa_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1188' height='464'></svg>)
论文链接：[https://arxiv.org/abs/1710.09829](https://link.zhihu.com/?target=https%3A//arxiv.org/abs/1710.09829)
...
![](https://pic4.zhimg.com/v2-da28251aa8d16d51b0a3b0ef68006c4f_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='834' height='109'></svg>)
其中 v_j 为 Capsule j 的输出向量，s_j 为总输入向量。

对于 Capsule 除了第一层的所有层级，Capsule s_j 的总输入为下面 Capsule 层级中所有「预测向量」
![](https://pic2.zhimg.com/v2-d5369b0d19a2a36e9f822d212630038d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='57' height='38'></svg>)
的加权和，而预测向量 u_hat 可通过计算一个 Capsule 的 u_i 输出与下面层级的权重矩阵 W_ij 的乘积而得出：
![](https://pic3.zhimg.com/v2-ce460ea4b06161b9bb0c918880a095f6_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='923' height='94'></svg>)
...
![](https://pic2.zhimg.com/v2-9a4cc19845ae2ea31fbd61e4e8df62fd_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='805' height='107'></svg>)
对数先验（log priors）可以同时和其它权重有区别地进行学习。它们依赖于两个 Capsule 的位置与类型，但不依赖于当前的输入图像。初始化耦合系数可以通过测量前面层级中每一个 Capsule j 的当前输入 v_j 和 Capsule i 的预测
![](https://pic1.zhimg.com/v2-c303dce2556e02718dbb5a71391327a4_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='61' height='43'></svg>)
间一致性（agreement），然后借助该测量的一致性迭代地精炼更新耦合系数。

这个一致性（agreement）可以简单地设置为标量乘积
![](https://pic3.zhimg.com/v2-42023e3208f693feeb4aeaa328003002_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='182' height='42'></svg>)
。该一致性可以被视为对数似然度，并可加入初始 logit 中，b_ij 在计算所有耦合系数更新值之前已经将 Capsule i 链接到更高级的 Capsule 中。

在卷积 Capsule 层中，每一个 Capsule 单元都是一个卷积单元，因此每一个 Capsule 将输出一个向量组而不是单个输出向量。
![](https://pic4.zhimg.com/v2-dc4048aa92337cae53ac72666c278cc7_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1346' height='399'></svg>)
**4. CapsNet 架构**
...
![](https://pic1.zhimg.com/v2-4a635b2d2547136377f594b15c914eac_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1065' height='326'></svg>)
...
**5. MNIST 上的 Capsule**
![](https://pic2.zhimg.com/v2-cd9bc86907fb8870e114edd270a69151_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1269' height='349'></svg>)
...
![](https://pic1.zhimg.com/v2-58f755f7a2177888567d93e9ac57384c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='993' height='270'></svg>)
...
![](https://pic1.zhimg.com/v2-179cb0079ca89111bdb718fcde5b4458_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1133' height='459'></svg>)
...
![](https://pic3.zhimg.com/v2-1dffa7822b78dbdf707f3402576799a6_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='600' height='361'></svg>)
...
[浅析 Geoffrey Hinton 最近提出的 Capsule 计划](https://zhuanlan.zhihu.com/p/29435406)

[观点 | Geoffrey Hinton：放弃反向传播，我们的人工智能需要重头再来](https://link.zhihu.com/?target=http%3A//mp.weixin.qq.com/s/OQvBL_M_iF-NXZenFn7OLQ)

[被 Geoffrey Hinton 抛弃，反向传播为何饱受质疑？（附 BP 推导）](https://link.zhihu.com/?target=http%3A//mp.weixin.qq.com/s/BZPqDx1x4GXbpZ77_MaE1A)
