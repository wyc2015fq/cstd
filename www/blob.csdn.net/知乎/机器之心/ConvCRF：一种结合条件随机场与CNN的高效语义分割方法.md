# ConvCRF：一种结合条件随机场与CNN的高效语义分割方法 - 知乎
# 



选自arxiv，作者：Marvin T. T. Teichmann、Roberto Cipolla，机器之心编译。
...
![](https://pic3.zhimg.com/v2-694e8a7b5944ed66a96d4e2d223d8802_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1022' height='129'></svg>)
其中 θ_i 是可学习的参数。对于一组高斯核 g_1 ... g_s，我们定义经合并的核矩阵 K 为：
![](https://pic1.zhimg.com/v2-e54cc39dc60f4237481a79b5c527ba44_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='221' height='38'></svg>)
所有 s 个核的组合信息传递的结果 Q 如下所示：
![](https://pic4.zhimg.com/v2-7b14364af297d8f900590ace310fe957_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='954' height='104'></svg>)
...
**实验结果**
![](https://pic3.zhimg.com/v2-93a342db88de75a3da33d0fdd48ec6c6_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='851'></svg>)
...
![](https://pic2.zhimg.com/v2-fb6b201a42bfef192b49e43a20d5902d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1023' height='170'></svg>)
表 2：使用解耦训练的条件随机场在验证集上的性能比较。+ C 表示模型使用卷积作为兼容性转换，+ T 表示模型学习了高斯特征。除了来自 DeepLab 的条件随机场，其他模型我们都使用一元运算（unaries）。
![](https://pic1.zhimg.com/v2-56bad6d455d39c91ba11ce2b3ccd8a44_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='841'></svg>)
...
![](https://pic4.zhimg.com/v2-06993025e71a29b2313ddbf61d3bfc17_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='870' height='352'></svg>)- 论文地址：[https://arxiv.org/abs/1805.04777](https://link.zhihu.com/?target=https%3A//arxiv.org/abs/1805.04777)
- 实现地址：[https://github.com/MarvinTeichmann/ConvCRF](https://link.zhihu.com/?target=https%3A//github.com/MarvinTeichmann/ConvCRF)
