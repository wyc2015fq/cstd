...
![](https://pic2.zhimg.com/v2-d07b3a91866ad468f6a9b4adbfed626d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='819' height='387'></svg>)
**系统流程**

特征提取：将普通的 wav 语音信号通过分帧加窗等操作转换为神经网络需要的二维频谱图像信号，即语谱图。
![](https://pic4.zhimg.com/v2-75fbe1ec1aec5413832dff6019ec083b_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='768' height='168'></svg>)
声学模型：基于 Keras 和 TensorFlow 框架，使用这种参考了 VGG 的深层的卷积神经网络作为网络模型，并训练。
![](https://pic3.zhimg.com/v2-a94f14d9d344a1eb15f4e03d9dc93df6_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='622' height='274'></svg>)
CTC 解码：在语音识别系统的声学模型输出中，往往包含了大量连续重复的符号，因此，我们需要将连续相同的符号合并为同一个符号，然后再去除静音分隔标记符，得到最终实际的语音拼音符号序列。
![](https://pic3.zhimg.com/v2-20f535aaf16be95d291bedb796fbc66a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='768' height='374'></svg>)
