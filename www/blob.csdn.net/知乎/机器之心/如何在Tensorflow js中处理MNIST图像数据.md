# 如何在Tensorflow.js中处理MNIST图像数据 - 知乎
# 
...
对任何一个机器学习问题而言，数据处理都是很重要的一步。本文将采用 Tensorflow.js（0.11.1）的 MNIST 样例（[https://github.com/tensorflow/tfjs-examples/blob/master/mnist/data.js](https://link.zhihu.com/?target=https%3A//github.com/tensorflow/tfjs-examples/blob/master/mnist/data.js)），逐行运行数据处理的代码。
...
![](https://pic1.zhimg.com/v2-d7346e744f8d27a20ac3f74eb5113d9c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='1023'></svg>)
**MNISTData**
