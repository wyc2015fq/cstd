# 自然语言处理是如何工作的？一步步教你构建 NLP 流水线 - 知乎
# 



**选自 medium，作者：Adam Geitgey，机器之心编译，参与：翁俊坚、刘晓坤。**
...
![](https://pic4.zhimg.com/v2-a7503c60474c3d3ae2d3c110cdb51707_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='698' height='301'></svg>)
世界上很多信息是非结构化的——例如英语或其他人类语言中的原始文本。那我们要如何让计算机了解非结构化文本并从中提取数据呢？
![](https://pic2.zhimg.com/v2-2ab8bbce647ac63b090b330d9c913de5_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='709' height='318'></svg>)
...
![](https://pic1.zhimg.com/v2-52ec61cd3490943595e7b9e13f15fbbc_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1042' height='307'></svg>)
...
![](https://pic1.zhimg.com/v2-cb466509a8d84eb1b09addbf63d841ac_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='132'></svg>)
...
![](https://pic1.zhimg.com/v2-6c753f5003e0ab09eec758ce413814a0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='191'></svg>)
我们唯一的改变是把「is」变成「be」。
...
下面是我们将停止词变成灰色后的句子：
![](https://pic1.zhimg.com/v2-73b1623bc9cced6f71d5afec848bec20_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='172'></svg>)
...
![](https://pic2.zhimg.com/v2-3a8f1e10f181b10b5cd733206953b0f9_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='674'></svg>)
但我们可以更进一步。除了识别每个单词的父词外，我们还可以预测两个词之间存在的关系类型：
![](https://pic3.zhimg.com/v2-c874cd98915b60b9f74d5889394b5a5a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='662'></svg>)
...
例如：
![](https://pic4.zhimg.com/v2-9b09cfa6b987b1f98d4dfd7b1a358dd7_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='181'></svg>)
我们可以将名词短语组合以产生下方的形式：
![](https://pic4.zhimg.com/v2-310c5c1eeab3ca8937766d4ef34792b3_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='994' height='208'></svg>)
...
在我们的句子中，我们有下列名词：
![](https://pic1.zhimg.com/v2-b154bf430aa6f7ca0dc4d0d5b4e04424_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='86'></svg>)
...
![](https://pic3.zhimg.com/v2-7210833cd31a14a02fe438f015f7bfce_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='151'></svg>)
...
![](https://pic2.zhimg.com/v2-c64784dcb3b845b1565bac61ef02bb11_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='933' height='248'></svg>)
利用共指信息与解析树和命名实体信息相结合，我们可以从文档中提取大量信息。

共指解析是 NLP 流水线实现中最困难的步骤之一。这比句子分析更困难。深度学习的最新进展研究出了更精确的新方法，但还不完善。如果您想了解更多关于它是如何工作的，请查看：[https://explosion.ai/demos/displacy-ent](https://link.zhihu.com/?target=https%3A//explosion.ai/demos/displacy-ent)。
...
下面是我们完整的 NLP 流水线的概述：
![](https://pic4.zhimg.com/v2-2b6677c47ca9f36e5bf48db8c299e193_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='220'></svg>)
共指解析是一个不一定要完成的可选步骤。
...
您可以在这里查找这些代码：[https://spacy.io/usage/linguistic-features#entity-types](https://link.zhihu.com/?target=https%3A//spacy.io/usage/linguistic-features%23entity-types)。

注意它在「Londinium」上犯了一个错误，认为它是一个人的名字而不是一个地方。这可能是因为在训练数据集中没有类似的东西，所以它做了最好的猜测。命名实体检测通常需要一小段模型微调（[https://spacy.io/usage/training#section-ner](https://link.zhihu.com/?target=https%3A//spacy.io/usage/training%23section-ner)），如果您正在解析具有独特或专用术语的文本。

让我们来检测实体并使用它来建立一个数据洗涤器。假设你正试图遵守新的 GDPR 隐私规则（[https://medium.com/@ageitgey/understand-the-gdpr-in-10-minutes-407f4b54111f](https://link.zhihu.com/?target=https%3A//medium.com/%40ageitgey/understand-the-gdpr-in-10-minutes-407f4b54111f)），并且你发现你有数以千计的文件，其中包含有个人可识别的信息，比如人的名字。你接到了移除文档中所有名字的任务。
...
![](https://pic2.zhimg.com/v2-65252894ecb8268fc279d3f9b98edb45_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1062' height='581'></svg>)谷歌对「London」的自我完善的建议
...
但在此之前，先安装 spaCy（[https://spacy.io/](https://link.zhihu.com/?target=https%3A//spacy.io/)）并开始去使用它！可能你不是一个 Python 用户，也可能你最终使用是一个不同的 NLP 库，但这些想法都应该是大致相同。
![](https://pic1.zhimg.com/v2-18cc987d5f379a82f1208b6d90722318_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='73' height='24'></svg>)
原文链接：[https://medium.com/@ageitgey/natural-language-processing-is-fun-9a0bff37854e](https://link.zhihu.com/?target=https%3A//medium.com/%40ageitgey/natural-language-processing-is-fun-9a0bff37854e)
