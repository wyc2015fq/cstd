# 如何使用DeepFake实现视频换脸 - 知乎
# 



文章作者：冯沁原，作者知乎主页：[https://www.zhihu.com/people/fabsqrt/answers](https://www.zhihu.com/people/fabsqrt/answers)。

> 不久之前，AV 视频换脸明星的 DeepFake 火了。这篇文章将一步步教你如何实现换脸。
[DeepFake换脸_腾讯视频​v.qq.com![图标](https://pic3.zhimg.com/v2-a772a2982020f0c43d39432a93d041da_180x120.jpg)](https://link.zhihu.com/?target=https%3A//v.qq.com/x/page/q0642apt86a.html)
如果你是第一次听说 DeepFake，一定要点击上面的视频，亲自感受一下尼古拉斯的脸是如何占据全世界的每一个影片。

项目地址：[https://github.com/Fabsqrt/BitTigerLab/tree/master/DeepFake](https://link.zhihu.com/?target=https%3A//github.com/Fabsqrt/BitTigerLab/tree/master/DeepFake)
...
![](https://pic3.zhimg.com/v2-80d87c729ea38276f3d315a2d575c176_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='360'></svg>)
...
![](https://pic1.zhimg.com/v2-4fa83c5892033f601a726720c3ab40c8_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='882' height='838'></svg>)(来源: Facial landmarks with dlib, OpenCV, and Python) 
...
![](https://pic1.zhimg.com/v2-5fcf667a4bc17fc3b248c57bdf1052e0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1010' height='996'></svg>)(来源: Real-Time Face Pose Estimation ) 
...
![](https://pic2.zhimg.com/v2-aecd67a570d596b20ac8921af17977e9_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='389'></svg>) (来源: Machine Learning is Fun! Part 4: Modern Face Recognition with Deep Learning )![](https://pic1.zhimg.com/v2-17ca2ea2d7058c7d02f1a0e2bdd01ab0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='423'></svg>) (来源: Machine Learning is Fun! Part 4: Modern Face Recognition with Deep Learning )
...
![](https://pic1.zhimg.com/v2-5cb5914416a46f878809364f17941ed4_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='777'></svg>) (来源: Histogram of Oriented Gradients and Object Detection)
...
![](https://pic1.zhimg.com/v2-8ee9a5c82660b36122feb7331921d8b0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='746' height='886'></svg>) (来源: One Millisecond Face Alignment with an Ensemble of Regression Trees) 
在这个基础上，就能够标记出这 68 个点。
![](https://pic1.zhimg.com/v2-32cd872901c26e1b3b6909812e716ba4_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='816' height='646'></svg>) (来源: Facial landmarks with dlib, OpenCV, and Python ) 
...
![](https://pic1.zhimg.com/v2-ff75d202fc7ac1fc8be358f3a8236358_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='333'></svg>)(来源: Building Autoencoders in Keras ) 
...
整个网络的结构如下：
![](https://pic2.zhimg.com/v2-f68436ad3008bb0cebec6ea39ec19661_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='719' height='311'></svg>) 来源: 刷爆朋友圈的视频人物换脸是怎样炼成的?
...
![](https://pic3.zhimg.com/v2-f5b4b69114df700ab27b2586ac404762_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='812' height='676'></svg>) (来源: shaoanlu/faceswap-GAN) 
如上图所示，我们首先扣取 A 的人脸，然后进行变形，之后经历编码和解码生成了重建的脸和 Mask。以下是我们的学习目标。
![](https://pic3.zhimg.com/v2-e3851cbe559325419121347695cdacc2_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='678' height='757'></svg>) (来源: shaoanlu/faceswap-GAN) 
**从图片到视频**
...
![](https://pic2.zhimg.com/v2-64df9517e7e0030cffe88b7b6991de01_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='800' height='814'></svg>)(来源: How to Create DeepFakes with Google Cloud GPU Services)![](https://pic1.zhimg.com/v2-d84353f7b662267eb8424b5f7826d79c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='469' height='519'></svg>) (来源: How to Create DeepFakes with Google Cloud GPU Services)![](https://pic1.zhimg.com/v2-4a024efe0fed406a3ca2b430012ab81c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='471' height='458'></svg>) (来源: How to Create DeepFakes with Google Cloud GPU Services)![](https://pic1.zhimg.com/v2-57faf4fe3e6fe403f6586f32e6e632c0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='456' height='520'></svg>) (来源: How to Create DeepFakes with Google Cloud GPU Services) 
最后是我在 Google Cloud 上进行 Training 的一个截图。
![](https://pic3.zhimg.com/v2-fef63b3979972851576829f39eb984e6_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='798' height='514'></svg>)
**项目架构**

最后让我们从高层理解一下整个 DeepFake 项目的架构。
![](https://pic3.zhimg.com/v2-c345b4fccb129ca1e615f1cd82a14f76_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='819' height='763'></svg>)
**社会影响**
