# 敲黑板！你和GitHub高手就差这三条规则······ - 知乎
# 



**选自Medium，作者：Ariel Camus，机器之心编译，参与：高璇、路。**
...
![](https://pic4.zhimg.com/v2-094eda9d78b9cb5735df55979bf47157_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='889' height='513'></svg>)
...
![](https://pic1.zhimg.com/v2-df1b13b41ba60ce5f6cbb7a30d091208_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='400'></svg>)
...
- 如果你对 Git 和 Github 还不熟悉，请先从 HubSpot 上完成这个很棒的教程：[https://product.hubspot.com/blog/git-github](https://link.zhihu.com/?target=https%3A//product.hubspot.com/blog/git-github)；
- 如果你还不了解 GitHub 流，你应该先学习它，因为我们后边会用到：[https://guides.github.com/tion/flow/](https://link.zhihu.com/?target=https%3A//guides.github.com/tion/flow/)。
...
注：如果使用终端比较麻烦，你无法在所有项目中使用 Git，可以考虑使用 Github 桌面应用程序（[https://desktop.github.com/](https://link.zhihu.com/?target=https%3A//desktop.github.com/)）。
...
![](https://pic4.zhimg.com/v2-667febc98b8c9e3d9026001061559e93_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='377'></svg>)



如果你不知道何为分支，请返回到 Github 流（[https://guides.github.com/guidetion/flow/](https://link.zhihu.com/?target=https%3A//guides.github.com/guidetion/flow/)），阅读我之前推荐的内容。
...
![](https://pic1.zhimg.com/v2-c75a9601549d0ee8be999670397894c0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='372'></svg>)
...
原文链接：[https://medium.freecodecamp.org/follow-these-simple-rules-and-youll-become-a-git-and-github-master-e1045057468f](https://link.zhihu.com/?target=https%3A//medium.freecodecamp.org/follow-these-simple-rules-and-youll-become-a-git-and-github-master-e1045057468f)
