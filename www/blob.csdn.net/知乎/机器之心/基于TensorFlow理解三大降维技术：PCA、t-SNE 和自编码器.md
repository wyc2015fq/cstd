# 基于TensorFlow理解三大降维技术：PCA、t-SNE 和自编码器 - 知乎
# 
...
代码地址：[https://github.com/eliorc/Medium/blob/master/PCA-tSNE-AE.ipynb](https://link.zhihu.com/?target=https%3A//github.com/eliorc/Medium/blob/master/PCA-tSNE-AE.ipynb)
...
![](https://pic3.zhimg.com/v2-c6b93943b1620154d43f0a375f9e990a_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='793' height='690'></svg>)
图 1：PCA 工作流程
...
![](https://pic4.zhimg.com/v2-0c9b6139debce731fed6bf060aa260cf_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1075' height='613'></svg>)
图 2：鸢尾花数据集 PCA 二维绘图
...
相对于 PCA，t-SNE 是一种相对较新的方法，起源于 2008 年的论文《Visualizing Data using t-SNE》：[http://www.jmlr.org/papers/volume9/vandermaaten08a/vandermaaten08a.pdf](https://link.zhihu.com/?target=http%3A//www.jmlr.org/papers/volume9/vandermaaten08a/vandermaaten08a.pdf)
...
![](https://pic2.zhimg.com/v2-32b7b2d0a3f8d2e8639f65fb49408055_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='781' height='806'></svg>)
图 3：t-SNE 工作流程
...
困惑度会实际影响可视化的结果，而且你需要小心应对，因为它可能会在可视化低维数据时出现误导现象——我强烈推荐阅读这篇文章了解如何使用 t-SNE 困惑度：[http://distill.pub/2016/misread-tsne](https://link.zhihu.com/?target=http%3A//distill.pub/2016/misread-tsne)，其中介绍了不同困惑度的影响。
...
![](https://pic2.zhimg.com/v2-aed4fea994a81bf7aae9f53a6179e315_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1101' height='603'></svg>)
...
![](https://pic3.zhimg.com/v2-7d284b97d9ed262a2d22f8422d1031b2_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='995' height='757'></svg>)
...
![](https://pic1.zhimg.com/v2-d80bb595afc06542555c17c30f92ecdc_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='589' height='565'></svg>)
图 6：用于鸢尾花数据集的基本自编码器
...
![](https://pic1.zhimg.com/v2-c7e3a96309e03bf195af745cb0332fd4_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1005' height='564'></svg>)
...
[https://medium.com/towards-data-science/reducing-dimensionality-from-dimensionality-reduction-techniques-f658aec24dfe](https://link.zhihu.com/?target=https%3A//medium.com/towards-data-science/reducing-dimensionality-from-dimensionality-reduction-techniques-f658aec24dfe)
