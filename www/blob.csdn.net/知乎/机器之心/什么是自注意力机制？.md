...
目前有许多句子表征的方法。本文作者之前的博文中已经讨论了 5 中不同的基于单词表征的句子表征方法。想要了解更多这方面的内容，你可以访问以下链接：[https://kionkim.github.io/](https://link.zhihu.com/?target=https%3A//kionkim.github.io/)（尽管其中大多数资料是韩文）
...
![](https://pic3.zhimg.com/v2-202080471a49fb1887789ccdb813a3f2_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='523' height='92'></svg>)
...
![](https://pic2.zhimg.com/v2-9b325090cfb392916753732442efe5e9_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='746'></svg>)
...
![](https://pic1.zhimg.com/v2-d04968f936659be7d033b1a8c73f29b4_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='608'></svg>)
...
![](https://pic1.zhimg.com/v2-885ebbf801656e27d6653f3544f049bc_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='50'></svg>)
当所有的 I_{t,⋅} 为 1 时，通用形式说明任何「skip bigram」对于模型的贡献是均匀的。

对于 RNN 来说，我们忽略单词 x_t 之后的所有信息，因此上述方程可以化简为：
![](https://pic2.zhimg.com/v2-be32c1bfa552f1f80808135d950e007d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='560' height='84'></svg>)
对于双向 RNN 来说，我们可以考虑从 x_T 到 x_t 的后向关系。

另一方面，CNN 只围绕我们感兴趣的单词浏览信息，如果我们只关心单词 x_t 前后的 k 个单词，通用的公式可以被重新排列为：
![](https://pic3.zhimg.com/v2-d6f225dfd37f7d2e9fc7af0a425be02a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1034' height='65'></svg>)
...
![](https://pic4.zhimg.com/v2-f6c38488104c64ecbf8dbaafee962d97_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='624' height='129'></svg>)
...
![](https://pic1.zhimg.com/v2-2cf0c09d21d5ddfa0f2cc9bfce7756e0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='693'></svg>)
...
![](https://pic4.zhimg.com/v2-2b75e3ea9ba2ff670a153303485dd2fb_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='749'></svg>)
...
论文地址：[https://arxiv.org/pdf/1703.03130.pdf](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1703.03130.pdf)
![](https://pic2.zhimg.com/v2-0b24fb48d05109403a01dfceea9d80d9_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='822'></svg>)
...
参见：[https://kionkim.github.io/_posts/2018-07-12-sentiment_analysis_self_attention.md](https://link.zhihu.com/?target=https%3A//kionkim.github.io/_posts/2018-07-12-sentiment_analysis_self_attention.md)
![](https://pic1.zhimg.com/v2-8e842d0abd78a23bfa7fe4ca55430c74_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='807'></svg>)
...
完整的实现代码可以从以下链接获得：[http://210.121.159.217:9090/kionkim/stat-analysis/blob/master/nlp_models/notebooks/text_classification_RN_SA_umich.ipynb](https://link.zhihu.com/?target=http%3A//210.121.159.217%3A9090/kionkim/stat-analysis/blob/master/nlp_models/notebooks/text_classification_RN_SA_umich.ipynb)。
...
下面是 9 个随机选择的注意力矩阵：
![](https://pic1.zhimg.com/v2-1e6cd8460d48ad4be880ad8f40705aa0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='783'></svg>)
当对文本进行分类时，我们可以知道算法将把注意力放在那些单词上。正如预期的那样，在分类过程中，「love」、「awesome」、「stupid」、「suck」这样表达情感的单词受到了重点关注。
![](https://pic1.zhimg.com/v2-18cc987d5f379a82f1208b6d90722318_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='73' height='24'></svg>)
参考链接：[https://medium.com/@kion.kim/self-attention-a-clever-compromise-4d61c28b8235](https://link.zhihu.com/?target=https%3A//medium.com/%40kion.kim/self-attention-a-clever-compromise-4d61c28b8235)
