# 让AI学会刨根问底和放飞自我，斯坦福最新问答数据集CoQA - 知乎
# 



**选自arXiv，作者：Siva Reddy、Danqi Chen、Christopher D. Manning ，机器之心编译。**
...
![](https://pic2.zhimg.com/v2-792a9b0144ac2b6d8003715e1b7b6e35_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='527' height='718'></svg>)图 1：CoQA 数据集中的一个对话。每个回合都包含一个问题（Qi），一个答案（Ai）和支持答案的理由（Ri）
...
![](https://pic4.zhimg.com/v2-3ab0f270d9409eb70fd3bfed19a4d9f3_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='373'></svg>)表 1：CoQA 与现有大型阅读理解数据集的比较（约 10 万多个问题）
...
![](https://pic3.zhimg.com/v2-a302f7c22a28bbbf93476282facf3912_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1078' height='320'></svg>)



论文地址：[https://arxiv.org/abs/1808.07042](https://link.zhihu.com/?target=https%3A//arxiv.org/abs/1808.07042)

摘要：人类通过参与一系列问题和答案相互关联的对话来收集信息。因此协助我们收集信息的机器，也必须能够回答对话问题。我们介绍了一个用于构建对话问答系统的新数据集 CoQA。该数据集包含来自 7 个不同领域的文本段落里 8000 个对话中的 127,000 轮问答。问题是会话形式，而答案是自由形式的文本，并在段落中突出显示相应的依据。我们深入分析了 CoQA，发现会话问题具有现有阅读理解数据集所没有的挑战性现象，例如共指关系和实用推理。我们在 CoQA 上评估强大的对话和阅读理解模型。表现最佳的系统获得了 65.1％的 F1 分数，与人类相比低了 23.7%，这表明它有很大的改善空间。作为一种挑战，我们在_this http URL ([http://stanfordnlp.github.io/coqa/](https://link.zhihu.com/?target=http%3A//stanfordnlp.github.io/coqa/))_社区上推出了 CoQA。
...
![](https://pic3.zhimg.com/v2-ff55f8c0704cf3b3c3d8cd3678ce37ae_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='535' height='752'></svg>)图 2：用不同的颜色表示共指关系链的对话。焦点实体在 Q4，Q5，Q6 中发生变化![](https://pic2.zhimg.com/v2-26fc2297472697883b39a640679cad5d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='610' height='388'></svg>)表 2：CoQA 中域的分布
**数据集分析**
![](https://pic1.zhimg.com/v2-bbad85297cf6cda980fc37365abe3c6c_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='614'></svg>)图 3：SQUAD 和 CoQA 里问题中前三个词的分布情况![](https://pic1.zhimg.com/v2-c1d4a8b8645cc108b301733fc8dc6378_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='479' height='187'></svg>)表 3：SQUAD 和 CoQA 中段落、问题和答案的平均单词数


![](https://pic3.zhimg.com/v2-732d8c74142dfcbea1081c799440a962_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='482' height='473'></svg>)表 4：SQuAD 和 CoQA 中答案类型的分布![](https://pic3.zhimg.com/v2-6fdf4889238203fe00dc453c78dd4c0e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='877' height='770'></svg>)表 5：CoQA 问题中的语言现象![](https://pic2.zhimg.com/v2-6ddedfd5f23e116f8a4f4411d82b20b9_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1080' height='417'></svg>)表 6：模型和人类在开发数据和测试数据上的表现（F1 得分）
