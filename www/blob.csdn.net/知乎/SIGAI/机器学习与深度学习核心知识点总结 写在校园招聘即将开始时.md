# 机器学习与深度学习核心知识点总结 写在校园招聘即将开始时 - 知乎
# 
...
![](https://pic3.zhimg.com/v2-818b36bade362a2ee2d6c0a008f954d6_b.jpg)
...
![](https://pic1.zhimg.com/v2-a6547da0facbf64d8ea0702d7056ecd8_b.jpg)
...
![](https://pic2.zhimg.com/v2-7c23a6e1a68ee3bb3c8eb2d903125d29_b.jpg)
...
![](https://pic2.zhimg.com/v2-cc16536e54aea8e1dd3a940e342fce41_b.jpg)
构造拉格朗日乘子函数：
![](https://pic2.zhimg.com/v2-27f076db6d3e7966ced52d660e97edd1_b.jpg)
在最优点处对x和乘子变量的导数都必须为0：
![](https://pic2.zhimg.com/v2-6365d582945228ae42ae794577d4937d_b.jpg)
...
![](https://pic3.zhimg.com/v2-0f625eadf1fc13a0cfa44eaaba8ee07e_b.jpg)
与拉格朗日乘数法类似，构造广义拉格朗日函数：
![](https://pic1.zhimg.com/v2-b3b69dfc86da31148df652dd5f247be8_b.jpg)
![\lambda_{i}](https://www.zhihu.com/equation?tex=%5Clambda_%7Bi%7D) 必须满足 ![\lambda_{i}\geq 0](https://www.zhihu.com/equation?tex=%5Clambda_%7Bi%7D%5Cgeq+0) 的约束。原问题为：
![](https://pic3.zhimg.com/v2-ab014e8ab02312ea2a9a34578081bcb2_b.jpg)
即先固定住x，调整拉格朗日乘子变量，让函数L取极大值；然后控制变量x，让目标函数取极小值。原问题与我们要优化的原始问题是等价的。

对偶问题为：
![](https://pic4.zhimg.com/v2-01971c2105c756bdda804c7087e54c27_b.jpg)
和原问题相反，这里是先控制变量x，让函数L取极小值；然后控制拉格朗日乘子变量，让函数取极大值。

一般情况下，原问题的最优解大于等于对偶问题的最优解，这称为弱对偶。在某些情况下，原问题的最优解和对偶问题的最优解相等，这称为强对偶。

强对偶成立的一种条件是Slater条件：一个凸优化问题如果存在一个候选x使得所有不等式约束都是严格满足的，即对于所有的i都有 ![g_{i}(x)< 0](https://www.zhihu.com/equation?tex=g_%7Bi%7D%28x%29%3C+0) ，不等式不取等号，则强对偶成立，原问题与对偶问题等价。注意，Slater条件是强对偶成立的充分条件而非必要条件。
...
![](https://pic2.zhimg.com/v2-3aa7a361388ba15bf7dd782629a41a49_b.jpg)
和拉格朗日对偶的做法类似，KKT条件构如下乘子函数：
![](https://pic3.zhimg.com/v2-d95d960102466cae16b6f3756a2f2c76_b.jpg)
...
![](https://pic2.zhimg.com/v2-1efbaf651b8ffc681eeed6c2cdd739e5_b.jpg)
等式约束 ![h_{j}（x^{*}）= 0](https://www.zhihu.com/equation?tex=h_%7Bj%7D%EF%BC%88x%5E%7B%2A%7D%EF%BC%89%3D+0) 和不等式约束 ![g_{k}(x^{*})\leq0](https://www.zhihu.com/equation?tex=g_%7Bk%7D%28x%5E%7B%2A%7D%29%5Cleq0) 是本身应该满足的约束， ![▽_{x}L(x^{*})=0](https://www.zhihu.com/equation?tex=%E2%96%BD_%7Bx%7DL%28x%5E%7B%2A%7D%29%3D0) 和之前的拉格朗日乘数法一样。唯一多了关于 ![g_{i}（x）](https://www.zhihu.com/equation?tex=g_%7Bi%7D%EF%BC%88x%EF%BC%89) 的条件：
![](https://pic2.zhimg.com/v2-96af602d6f96ccddf2c0836b337bc9c1_b.jpg)
KKT条件只是取得极值的必要条件而不是充分条件。

**8.特征值与特征向量**

对于一个n阶矩阵A，如果存在一个数 ![\lambda](https://www.zhihu.com/equation?tex=%5Clambda) 和一个非0向量X，满足：
![](https://pic3.zhimg.com/v2-be429762ebc7a9614fc7b6bea2b57cb2_b.jpg)
则称![\lambda](https://www.zhihu.com/equation?tex=%5Clambda)为矩阵A的特征值，X为该特征值对应的特征向量。根据上面的定义有下面线性方程组成立：
![](https://pic3.zhimg.com/v2-16160bbb3f494a366fd8b4202cd93026_b.jpg)
根据线性方程组的理论，要让齐次方程有非0解，系数矩阵的行列式必须为0，即：
![](https://pic1.zhimg.com/v2-60755f88efa8e9840e367f881eb1c1f0_b.jpg)
上式左边的多项式称为矩阵的特征多项式。矩阵的迹定义为主对角线元素之和：
![](https://pic3.zhimg.com/v2-6efa3804d0d6baf199f840207dfdaf12_b.jpg)
根据韦达定理，矩阵所有特征值的和为矩阵的迹：
![](https://pic2.zhimg.com/v2-9fbbd5271b74fb1821434222fb0b264d_b.jpg)
同样可以证明，矩阵所有特征值的积为矩阵的行列式：
![](https://pic4.zhimg.com/v2-cce96697800e5b511a6a5d7113ebaf1b_b.jpg)
...
![](https://pic4.zhimg.com/v2-c8672a9cfe46ccd2f9499f200b5dd80b_b.jpg)
其中U为*m x m*的正交矩阵，其列称为矩阵A的左奇异向量； ![\Sigma](https://www.zhihu.com/equation?tex=%5CSigma) 为*m x n*的对角矩阵，除了主对角线![\sigma_{ii}](https://www.zhihu.com/equation?tex=%5Csigma_%7Bii%7D) 以外，其他元素都是0；V为*n x n*的正交矩阵，其行称为矩阵A的右奇异向量。U的列为AAT的特征向量，V的列为AT A的特征向量。

**10.最大似然估计**

有些应用中已知样本服从的概率分布，但是要估计分布函数的参数 ![\theta](https://www.zhihu.com/equation?tex=%5Ctheta) ，确定这些参数常用的一种方法是最大似然估计。

最大似然估计构造一个似然函数，通过让似然函数最大化，求解出![\theta](https://www.zhihu.com/equation?tex=%5Ctheta)。最大似然估计的直观解释是，寻求一组参数，使得给定的样本集出现的概率最大。

假设样本服从的概率密度函数为 ![p（x，\theta）](https://www.zhihu.com/equation?tex=p%EF%BC%88x%EF%BC%8C%5Ctheta%EF%BC%89) ，其中X为随机变量，![\theta](https://www.zhihu.com/equation?tex=%5Ctheta)为要估计的参数。给定一组样本 ![x_{i}](https://www.zhihu.com/equation?tex=x_%7Bi%7D) ,*i* =1,...,*l*，它们都服从这种分布，并且相互独立。最大似然估计构造如下似然函数：
![](https://pic1.zhimg.com/v2-51264204c402ccb883ac595a3a58aae8_b.jpg)
其中![x_{i}](https://www.zhihu.com/equation?tex=x_%7Bi%7D)![x_{i}](https://www.zhihu.com/equation?tex=x_%7Bi%7D)是已知量，这是一个关于![\theta](https://www.zhihu.com/equation?tex=%5Ctheta)的函数，我们要让该函数的值最大化，这样做的依据是这组样本发生了，因此应该最大化它们发生的概率，即似然函数。这就是求解如下最优化问题：
![](https://pic1.zhimg.com/v2-4ff9e6b6b24d94c3169d757198a87538_b.jpg)
乘积求导不易处理，因此我们对该函数取对数，得到对数似然函数：
![](https://pic3.zhimg.com/v2-cf9b9fba9544cb4814b532d62e3c7156_b.jpg)
最后要求解的问题为：
![](https://pic3.zhimg.com/v2-d253c63e185af44c7940769a37255152_b.jpg)
...
![](https://pic3.zhimg.com/v2-6bbc4566619751f4f9bedc68683bd5ae_b.jpg)
...
![](https://pic1.zhimg.com/v2-cfd19534ae14c907c7409b97e583b1e8_b.jpg)
如果模型过于简单，一般会有大的偏差和小的方差；反之如果模型复杂则会有大的方差但偏差很小。 

**7.正则化**

为了防止过拟合，可以为损失函数加上一个惩罚项，对复杂的模型进行惩罚，强制让模型的参数值尽可能小以使得模型更简单，加入惩罚项之后损失函数为：
![](https://pic2.zhimg.com/v2-11d039a06457cdb144700277334ee3d9_b.jpg)
...
![](https://pic4.zhimg.com/v2-31771d4e8103bf0963a8484a4d5a724b_b.jpg)
分母p(x)对所有类都是相同的，分类的规则是将样本归到后验概率最大的那个类，不需要计算准确的概率值，只需要知道属于哪个类的概率最大即可，这样可以忽略掉分母。分类器的判别函数为：
![](https://pic1.zhimg.com/v2-5d726c673fc05665e9dda08500432284_b.jpg)
...
![](https://pic4.zhimg.com/v2-2841d9e182fe4745146819bd4051256f_b.jpg)
...
![](https://pic3.zhimg.com/v2-02190d7e793b8cee066378560f53a286_b.jpg)
寻找最佳分裂时需要计算用每个阈值对样本集进行分裂后的纯度值，寻找该值最大时对应的分裂，它就是最佳分裂。如果是数值型特征，对于每个特征将l个训练样本按照该特征的值从小到大排序，假设排序后的值为：
![](https://pic2.zhimg.com/v2-658807637a6a4a84ff11e97d20ad6a69_b.jpg)
接下来从*x*1开始，依次用每个![x_{i}](https://www.zhihu.com/equation?tex=x_%7Bi%7D)作为阈值，将样本分成左右两部分，计算上面的纯度值，该值最大的那个分裂阈值就是此特征的最佳分裂阈值。在计算出每个特征的最佳分裂阈值和上面的纯度值后，比较所有这些分裂的纯度值大小，该值最大的分裂为所有特征的最佳分裂。
...
![](https://pic1.zhimg.com/v2-47519fdf75204479879b3ee84281652c_b.jpg)
其中x是输入向量，F(x)是强分类器，ft(x)是弱分类器，at是弱分类器的权重，T为弱分类器的数量，弱分类器的输出值为+1或-1，分别对应正样本和负样本。分类时的判定规则为：
![](https://pic2.zhimg.com/v2-e112cf5ddfb35a3fad4fd94cb09ad5ed_b.jpg)
...
![](https://pic4.zhimg.com/v2-c2c7cd87682ddc3285196af697c65437_b.jpg)
根据计算公式，错误率低的弱分类器权重大，它是准确率的增函数。AdaBoost算法在训练样本集上的错误率会随着弱分类器数量的增加而指数级降低。它能有效的降低模型的偏差。

AdaBoost算法从广义加法模型导出，训练时求解的是指数损失函数的极小值：
![](https://pic3.zhimg.com/v2-3ec1e0f08e41afeb896104071856457e_b.jpg)
...
![](https://pic3.zhimg.com/v2-c99c0e84c53fd993e3c56f801c4350fa_b.jpg)
其中e为投影后空间的基向量，是标准正交基；a为重构系数，也是投影到低维空间后的坐标。如果定义如下的散布矩阵：
![](https://pic1.zhimg.com/v2-fbfd65635191ec7e00d9f1a82c0cd494_b.jpg)
其中m和 ![\mu](https://www.zhihu.com/equation?tex=%5Cmu) 为所有样本的均值向量。则上面的重构误差最小化等价于求解如下问题：
![](https://pic4.zhimg.com/v2-4602478165f49f31708397b1dd1850af_b.jpg)
通过拉格朗日乘数法可以证明，使得该函数取最小值的![e_{j}](https://www.zhihu.com/equation?tex=e_%7Bj%7D)为散度矩阵最大的*d*'个特征值对应的单位长度特征向量。矩阵W的列 ![e_{j}](https://www.zhihu.com/equation?tex=e_%7Bj%7D) 是我们要求解的基向量，由它们构成投影矩阵。计算时，先计算散布矩阵（或者协方差矩阵），再对该进行进行特征值分解，找到最大的一部分特征值和对应的特征向量，构成投影矩阵。可以证明，协方差矩阵或散布矩阵是实对称半正定矩阵，因此所有特征值非负。进行降维时，先将输入向量减掉均值向量，然后左乘投影矩阵，即可得到投影后的向量。
...
类内散布矩阵定义为：
![](https://pic3.zhimg.com/v2-8599dc4761eb8e552247b957a77ecee6_b.jpg)
它衡量的内类样本的发散程度。其中 ![m_{i}](https://www.zhihu.com/equation?tex=m_%7Bi%7D) 为每个类的均值向量，m为所有样本的均值向量。类间散布矩阵定义为：
![](https://pic3.zhimg.com/v2-f59a2237054af9a9f9e6123eb8e124f2_b.jpg)
它衡量的了各类样本之间的差异。训练时的优化目标是类间差异与类内差异的比值：
![](https://pic1.zhimg.com/v2-b0c85853ed7a3cb0693f08e69f895480_b.jpg)
上面的问题带有冗余，如果w是最优解，将其乘以一个不为0的系数之后还是最优解。为了消掉冗余，加上如下约束：
![](https://pic4.zhimg.com/v2-ccc672b99efb2c9b07f3ef89578ab15b_b.jpg)
然后使用拉格朗日乘数法，最后归结于求解矩阵的特征值与特征向量：
![](https://pic2.zhimg.com/v2-1070d105b4c1a83b5c48045987c8f445_b.jpg)
...
![](https://pic1.zhimg.com/v2-1dc92c258669517b41430a1fea71c580_b.jpg)
...
![](https://pic2.zhimg.com/v2-a7b28cde250e55e89ce4696eb19de401_b.jpg)
其中，*nl*是神经网络的层数。最后一个层的误差项可以直接求出，其他层的误差项根据上面的递推公式进行计算。根据误差项，可以计算出损失函数对每一层权重矩阵的梯度值：
![](https://pic2.zhimg.com/v2-5dd75a9ec3d58758cf0110d6cbb202ed_b.jpg)
以及对偏置向量的梯度值：
![](https://pic2.zhimg.com/v2-b72c6bf0a39070bf8102aa9a910a624d_b.jpg)
...
![](https://pic2.zhimg.com/v2-53dc4efdf30a652b05773a4627dbc2d5_b.jpg)
这从点到超平面的距离方程导出，通过增加一个约束条件消掉了优化变量的冗余。可以证明，这个问题是凸优化问题，并且满足Slater条件。这个问题带有太多的不等式约束，不易求解，因此通过拉格朗日对偶转换为对偶问题求解：
![](https://pic3.zhimg.com/v2-8aea31375ce2e1916a3f8a9d1b1a82ae_b.jpg)
...
加入核函数K之后的对偶问题变为：
![](https://pic3.zhimg.com/v2-7f8668138e6329cd56a1a6c8959e1552_b.jpg)
预测函数为：
![](https://pic4.zhimg.com/v2-157d7bb8e6cb1caac4c801852455e367_b.jpg)
...
![](https://pic1.zhimg.com/v2-d3bbff9b08e0796dbe99b752c0cf45c4_b.jpg)
正样本标签值为1，负样本为0。使用logistic函数的原因是它单调增，并且值域在(0, 1)之间，刚好符合概率的要求。训练时采用最大似然估计，求解对数似然函数的极值：
![](https://pic1.zhimg.com/v2-dbc73eabf9cb076921ba9c877e2f1318_b.jpg)
可以证明这是一个凸优化问题，求解时可以用梯度下降法，也可以用牛顿法。如果正负样本的标签为+1和-1，则可以采用另外一种写法：
![](https://pic3.zhimg.com/v2-ce5fcf5ea4684d2c33369efa8fe1eaa2_b.jpg)
训练时的目标同样是最大化对数似然函数：
![](https://pic2.zhimg.com/v2-1bb8b17b2aac5b3a305477a6a562a72d_b.jpg)
同样的，这也是一个凸优化问题。预测时并不需要计算logistic函数，而是直接计算：
![](https://pic2.zhimg.com/v2-f89d7b9da67a0ce57af7d3966707a549_b.jpg)
...
![](https://pic1.zhimg.com/v2-2ef3de1f88d72e4c815016025cf9b890_b.jpg)
...
![](https://pic1.zhimg.com/v2-0a408600d42e70f2a2ad49c64722a1f8_b.jpg)
根据误差项计算卷积核梯度值的公式为：
![](https://pic1.zhimg.com/v2-4196eb0b46ca408526d1356d5644e038_b.jpg)
如果采用均值池化，池化层的误差项反向传播计算公式为：
![](https://pic3.zhimg.com/v2-51a58e8be056d34e57db5e287a6a91e6_b.jpg)
如果使用max池化，则为：
![](https://pic3.zhimg.com/v2-c5dcb0f7168d8efa22b8e406107734be_b.jpg)
...
![](https://pic3.zhimg.com/v2-853bfcd175b1439a7c5cbbde853e4ea6_b.jpg)
它同时利用了本时刻的输入值和上一个时刻的记忆值。输出层的变换为：
![](https://pic3.zhimg.com/v2-f5b8b5c2819ab1ee522f2e87c37a2722_b.jpg)
这和普通神经网络没什么区别。由于引入了循环层，因此反向传播算法有所不同，称为BPTT，即时间轴上的反向传播算法。算法从最后一个时刻算起，沿着时间轴往前推。误差项的递推公式为：
![](https://pic2.zhimg.com/v2-16275353f59935622f205f0818a8feed_b.jpg)
递推的终点为最后一个时刻。
![](https://pic1.zhimg.com/v2-c6cdad5b61ffe9930cbb5f0e5e8ce04c_b.jpg)
根据误差项计算对权重和偏置的梯度值的公式为：
![](https://pic2.zhimg.com/v2-3ed3be465aad253023780aa12ad7a045_b.jpg)
...
![](https://pic2.zhimg.com/v2-f0a9b075d7857943397cf82c46f2038d_b.jpg)
其中x为随机向量，*k*为高斯分布的个数，*wi*为权重， ![\mu](https://www.zhihu.com/equation?tex=%5Cmu) 为高斯分布的均值向量，![\Sigma](https://www.zhihu.com/equation?tex=%5CSigma)为协方差矩阵。所有权重之和为1，即：
![](https://pic3.zhimg.com/v2-9e212f685bc26d8e99ea361d5d919d2e_b.jpg)
任意一个样本可以看作是先从*k*个高斯分布中选择出一个，选择第*i*个高斯分布的概率为*wi*，再由第*i*个高斯分布 ![N(x,\mu_{i},\Sigma_{i})](https://www.zhihu.com/equation?tex=N%28x%2C%5Cmu_%7Bi%7D%2C%5CSigma_%7Bi%7D%29) 产生出这个样本数据x。高斯混合模型可以逼近任何一个连续的概率分布，因此它可以看做是连续性概率分布的万能逼近器。之所有要保证权重的和为1，是因为概率密度函数必须满足在 ![(-\infty,+\infty)](https://www.zhihu.com/equation?tex=%28-%5Cinfty%2C%2B%5Cinfty%29) 内的积分值为1。
...
算法在实现时首先随机初始化参数![\theta](https://www.zhihu.com/equation?tex=%5Ctheta)的值，接下来循环迭代，每次迭代时分为两步：

E步，基于当前的参数估计值 ![\theta_{i}](https://www.zhihu.com/equation?tex=%5Ctheta_%7Bi%7D) ，计算在给定x时对z的条件概率的数学期望：
![](https://pic1.zhimg.com/v2-6aea8cae93fef707e2f810d8ea9e65a0_b.jpg)
M步，求解如下极值问题，更新![\theta](https://www.zhihu.com/equation?tex=%5Ctheta)的值：
![](https://pic1.zhimg.com/v2-dda61cec19f22f37243c27ce9619d9e0_b.jpg)
实现*Qi *时可以按照下面的公式计算：
![](https://pic2.zhimg.com/v2-7e1b4352f56115bc9b9e48ab613edd55_b.jpg)
