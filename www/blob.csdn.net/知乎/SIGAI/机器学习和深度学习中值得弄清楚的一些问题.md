...
假设有l个训练样本，特征向量为x*i*，标签值为y*i*，这里使用均方误差（MSE），线性回归训练时优化的目标为：
![](https://pic4.zhimg.com/v2-4801589a0b38a820ba2f07a8b933647f_b.jpg)
损失函数对权重向量w的一阶偏导数为：
![](https://pic4.zhimg.com/v2-5646f156b7d234155eb8d397cb3423bb_b.jpg)
损失函数对权重向量w的二阶偏导数为：
![](https://pic4.zhimg.com/v2-e5f4a9cce2c8b1a83766cb64870beed3_b.jpg)
因此目标函数的Hessian矩阵为：
![](https://pic4.zhimg.com/v2-596a70dc170cedd758997fba0c7b4baf_b.jpg)
写成矩阵形式为：
![](https://pic2.zhimg.com/v2-6e45e59a4a2d4e6cfc3bc8f8b9a84fb1_b.jpg)
其中X是所有样本的特征向量按照列构成的矩阵。对于任意不为0的向量x，有：
![](https://pic4.zhimg.com/v2-fc4afaabfb02713475e0dd19cf2fd66b_b.jpg)
...
![](https://pic2.zhimg.com/v2-e4e4d7df24f38831c2d7833cc4fee475_b.jpg)
...
![](https://pic1.zhimg.com/v2-0b98deb3e1596d113249a50348345d28_b.jpg)
因此拉普拉斯矩阵半正定。这里矩阵D的对角线元素是矩阵W的每一行元素的和。

> 问题7：线性判别分析：优化目标有冗余，这个冗余怎么理解呢？

线性判别分析优化的目标函数为：
![](https://pic3.zhimg.com/v2-b7cc075480c96ba3b0f8a80d1f405b36_b.jpg)
如果向量w是最优解，则将其乘以不为0的系数k之后，向量kw仍然是最优解，证明如下：
![](https://pic1.zhimg.com/v2-a9b885830035b08836aa8c80ebb9be10_b.jpg)
从几何上看，w可kw这两个向量表示的是一个方向，如果w是最佳投影方向，则kw还是这个方向：
![](https://pic4.zhimg.com/v2-0f173ac3fe9d0151f4b49a31ccb2b56b_b.jpg)

> 问题8：决策树，如果是回归树，在寻找最佳分裂时的标准

对于回归树，寻找最佳分裂的标准是分裂之后的回归误差最小化。这等价于让分裂之前的回归误差减去分裂之后的回归误差最大化：
![](https://pic4.zhimg.com/v2-f8de5fd0d8f4c28edf2cbceac724b80b_b.jpg)
展开之后为：
![](https://pic2.zhimg.com/v2-16fde3ba24f57c595bc0ae5583ec6bd1_b.jpg)

由于前面的都是常数，因此这等价于将下面的值最大化：
![](https://pic2.zhimg.com/v2-25566b26ebd1655d96281fc92dfa1af9_b.jpg)
...
![](https://pic2.zhimg.com/v2-718189ff532e766f5c86e9211777bbe9_b.jpg)
...
![](https://pic2.zhimg.com/v2-8c882996618e8ac291369ce2ca2358f1_b.jpg)
...
![](https://pic3.zhimg.com/v2-13dc7edac8ffbd49fa91d84774a94aa6_b.jpg)
> 问题16：神经网络的正则化项和动量项的比较。

正则化项的作用：缓解过拟合，迫使参数尽可能小。以L2正则化为例：
![](https://pic2.zhimg.com/v2-e5ddfcaaa30cea890a4a5f5c3ab3d2ed_b.jpg)
动量项的作用：加速收敛，减少震荡。计算公式为：
![](https://pic2.zhimg.com/v2-f5b4d5815714e854a5330a03d211b1d5_b.jpg)
