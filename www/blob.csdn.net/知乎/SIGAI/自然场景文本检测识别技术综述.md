...
![](https://pic1.zhimg.com/v2-67ad5b20d2df7aaa7ad35d5df11c048c_b.jpg)（本图摘自新浪微博《光学字符识别技术：让电脑像人一样阅读》）
...
![](https://pic4.zhimg.com/v2-c1a49777d19401bbff8a040a50c46a8b_b.jpg)
...
![](https://pic3.zhimg.com/v2-57462ddfd42542c344fdaa06372065f6_b.jpg)
...
![](https://pic1.zhimg.com/v2-ecdde0317e149eedf2825fdd5e9907d8_b.jpg)（选自arXiv:1411.4038，’ Fully Convolutional Networks for Semantic Segmentation’）
**STN网络**
...
![](https://pic4.zhimg.com/v2-594664de3bd24e28ca90e29bb182b7c3_b.jpg)（选自arXiv: 1506.02025，’Spatial Transformer Networks’）
## **检测网络框架**
...
![](https://pic2.zhimg.com/v2-67418dc734fd1e5de9f838a4c881d141_b.jpg)（摘自arXiv:1506.01497，’Faster R-CNN: Towards Real-Time Object Detection with Region Proposal Networks’）
...
![](https://pic1.zhimg.com/v2-563a951816191f2afe7c634cb5aaa670_b.jpg)
...
![](https://pic4.zhimg.com/v2-0c6ac432d477c84e5807b6cf1dd96503_b.jpg)（选自arXiv: 1609.03605，’Detecting Text in Natural Image with Connectionist Text Proposal Network’）
**RRPN模型**
...
![](https://pic3.zhimg.com/v2-51f2e283201247fbe64dc69876d79e8a_b.jpg)（选自arXiv: 1703.01086，’Arbitrary-Oriented Scene Text Detection via Rotation Proposals’）
RRPN中方案中提出了旋转感兴趣区域（RRoI，Rotation Region-of-Interest）池化层，将任意方向的区域建议先划分成子区域，然后对这些子区域分别做max pooling、并将结果投影到具有固定空间尺寸小特征图上。
![](https://pic2.zhimg.com/v2-aee97c736b4afe625e949a65a760df6d_b.jpg)（选自arXiv: 1703.01086，’Arbitrary-Oriented Scene Text Detection via Rotation Proposals’）
**FTSN模型**
...
![](https://pic1.zhimg.com/v2-5bba44faaa02979631a796138f087a0c_b.jpg)（选自arXiv: 1709.03272，’Fused Text Segmentation Networks for Multi-oriented Scene Text Detection’）
基于文本实例间像素级重合度的Mask-NMS， 替代了传统基于水平边框间重合度的NMS算法。下图左边子图是传统NMS算法执行结果，中间白色边框被错误地抑制掉了。下图右边子图是Mask-NMS算法执行结果， 三个边框都被成功保留下来。
![](https://pic3.zhimg.com/v2-b1995f992d238f374d386ecb16f7eeda_b.jpg)（选自arXiv: 1709.03272，’Fused Text Segmentation Networks for Multi-oriented Scene Text Detection’）
**DMPNet模型**
...
![](https://pic2.zhimg.com/v2-2261d8ccb6c5e4fc69a187ae794ca0b1_b.jpg)（选自arXiv:1703.01425，’Deep Matching Prior Network: Toward Tighter Multi-oriented Text Detection’）
**EAST模型**
...
![](https://pic1.zhimg.com/v2-a531369b1e175bbf3729a80a0cd6cba0_b.jpg)（选自arXiv: 1704.03155，’EAST: An Efficient and Accurate Scene Text Detector’）
** SegLink模型**
...
![](https://pic2.zhimg.com/v2-0886d326b6a5fac80421cdbcbe551231_b.jpg)（选自arXiv: 1703.06520，’Detecting Oriented Text in Natural Images by Linking Segments’）
如下图所示，该模型能够同时从6种尺度的特征图中检测小文字块。同一层特征图、或者相邻层特征图上的小文字块都有可能被连接入同一个单词中。换句话说，位置邻近、并且尺寸接近的文字块都有可能被预测到同一单词中。
![](https://pic4.zhimg.com/v2-219f92f7bfeebff67c0931335fc62cc7_b.jpg)（选自arXiv: 1703.06520，’Detecting Oriented Text in Natural Images by Linking Segments’）
**PixelLink模型**
...
![](https://pic4.zhimg.com/v2-7950f7f9a95bffeb4925e4ece1bb6eab_b.jpg)（选自arXiv: 1801.01315，’Detecting Scene Text via Instance Segmentation’）
...
![](https://pic2.zhimg.com/v2-7f1f15ce33ff263dba22578fcc5de569_b.jpg)（选自arXiv: 1611.06779，’TextBoxes: A Fast Text Detector with a Single Deep Neural Network’）
Textboxes++是Textboxes的升级版本，目的是增加对倾斜文本的支持。为此，将标注数据改为了旋转矩形框和不规则四边形的格式；对候选框的长宽比例、特征图层卷积核的形状都作了相应调整。
![](https://pic4.zhimg.com/v2-0cc405dc502462564b8f1f165a8f8d23_b.jpg)（选自arXiv: 1801.02765，’TextBoxes++: A Single-Shot Oriented Scene Text Detector’）
**WordSup模型**
...
![](https://pic2.zhimg.com/v2-93f9c5c41230d92bd794104301b9afbd_b.jpg)
如下图所示，WordSup弱监督训练框架中，两个训练步骤被交替执行：给定当前字符检测模型，并结合单词级标注数据，计算出字符中心点掩码图； 给定字符中心点掩码图，有监督地训练字符级检测模型.
![](https://pic1.zhimg.com/v2-f439076f6039d63b568307e5983fe83c_b.jpg)
如下图，训练好字符检测器后，可以在数据流水线中加入合适的文本结构分析模块，以输出符合应用场景格式要求的文本内容。该文作者例举了多种文本结构分析模块的实现方法。
![](https://pic2.zhimg.com/v2-22229bde39d9607d153001a30e4a9bed_b.jpg)（选自arXiv: 1708.06720，’WordSup： Exploiting Word Annotations for Character based Text Detection’）
## **文本识别模型**
...
![](https://pic4.zhimg.com/v2-f50b53d27a00320d34128efd107cdf7f_b.jpg)（选自arXiv: 1507.05717，’An End-to-End Trainable Neural Network for Image-based Sequence Recognition and Its Application to Scene Text Recognition’）
**RARE模型**
...
![](https://pic4.zhimg.com/v2-768f710205bb550be4993450d92f7d3f_b.jpg)
...
![](https://pic1.zhimg.com/v2-0c97bf076825088997915e5229ec10dc_b.jpg)（选自arXiv: 1603.03915，’Robust Scene Text Recognition with Automatic Rectification’）
## **端到端模型**
...
![](https://pic3.zhimg.com/v2-3d87e21b3120b6fd6703c96f87e19b42_b.jpg)![](https://pic3.zhimg.com/v2-c4d17a682e49823afc66de18ca65c522_b.jpg)（选自arXiv: 1801.01671，’FOTS: Fast Oriented Text Spotting with a Unified Network’）
**STN-OCR模型**
...
![](https://pic4.zhimg.com/v2-a73f48f3949bb059943121cd673560fb_b.jpg)（选自arXiv: 1707.08831，’STN-OCR: A single Neural Network for Text Detection and Text Recognition’）
## **训练数据集**
...
![](https://pic4.zhimg.com/v2-a18b74a7e3aaa4234034c38a2361c277_b.jpg)
...
![](https://pic2.zhimg.com/v2-2c4360a90447443d7c8ca176a1b44bad_b.jpg)
ICPR MWI 2018 挑战赛
...
![](https://pic3.zhimg.com/v2-464b669a5da925256438b14a3905676a_b.jpg)
**Total-Text**
...
![](https://pic1.zhimg.com/v2-b4ed96371a66a3a3f8458aa7279bb590_b.jpg)
...
![](https://pic3.zhimg.com/v2-18bfdf8247781f1d358597d1828adf46_b.jpg)
**COCO-TEXT**
...
![](https://pic3.zhimg.com/v2-205bf2b63c1d615a0de227619112b006_b.jpg)
...
![](https://pic2.zhimg.com/v2-54bdad382350613e459100470c91d9a5_b.jpg)
**Synthetic Word Dataset**

合成文本识别数据集，包含9百万张图像，涵盖了9万个英语单词。文件大小为10GB

`下载地址：http://www.robots.ox.ac.uk/~vgg/data/text/`
![](https://pic4.zhimg.com/v2-a8772cc49a8957829bb1715e3aeea26f_b.jpg)
**Caffe-ocr中文合成数据**
...
![](https://pic1.zhimg.com/v2-af40d3b766037073b6ccf389dc9948e8_b.jpg)

参考文献

1. “光学字符识别技术：让电脑像人一样阅读”, 新浪微博, 霍强

[http://tech.sina.com.cn/d/i/2015-04-03/doc-icczmvun8339303.shtml](https://link.zhihu.com/?target=http%3A//tech.sina.com.cn/d/i/2015-04-03/doc-icczmvun8339303.shtml)

2. “Fully Convolutional Networks for Semantic Segmentation”, arXiv:1411.4038，Jonathan Long, Evan Shelhamer, Trevor Darrell

[https://arxiv.org/pdf/1411.4038](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1411.4038)

3. “Spatial Transformer Networks”，arXiv:1506.02025，Max Jaderberg, Karen Simonyan, Andrew Zisserman, Koray Kavukcuoglu

[https://arxiv.org/pdf/1506.02025](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1506.02025)
...
[https://arxiv.org/pdf/1506.01497](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1506.01497)
...
[https://arxiv.org/pdf/1512.02325](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1512.02325)
...
[https://arxiv.org/pdf/1609.03605](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1609.03605)
...
[https://arxiv.org/pdf/1703.01086](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1703.01086)
...
[https://arxiv.org/pdf/1709.03272](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1709.03272)

9.“Deep Matching Prior Network: Toward Tighter Multi-oriented Text Detection”，arXiv:1703.01425，Yuliang Liu, Lianwen Jin

[https://arxiv.org/pdf/1703.01425](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1703.01425)
...
[https://arxiv.org/pdf/1704.03155](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1704.03155)

11.“Detecting Oriented Text in Natural Images by Linking Segments”，arXiv:1703.06520，Baoguang Shi, Xiang Bai, Serge Belongie

[https://arxiv.org/pdf/1703.06520](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1703.06520)

12. “Detecting Scene Text via Instance Segmentation”，arXiv:1801.01315，Dan Deng, Haifeng Liu, Xuelong Li, Deng Cai

[https://arxiv.org/pdf/1801.01315](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1801.01315)
...
[https://arxiv.org/pdf/1611.06779](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1611.06779)

14.“TextBoxes++: A Single-Shot Oriented Scene Text Detector”，arXiv:1801.02765，Minghui Liao, Baoguang Shi, Xiang Bai

[https://arxiv.org/pdf/1801.02765](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1801.02765)
...
[https://arxiv.org/pdf/1708.06720](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1708.06720)
...
[https://arxiv.org/pdf/1507.05717](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1507.05717)
...
[https://arxiv.org/pdf/1603.03915](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1603.03915)
...
[https://arxiv.org/pdf/1801.01671](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1801.01671)
...
[https://arxiv.org/pdf/1707.08831](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1707.08831)

20.“Chinese Text in the Wild”，arXiv:1803.00085，Tai-Ling Yuan, Zhe Zhu, Kun Xu, Cheng-Jun Li, Shi-Min Hu

[https://arxiv.org/pdf/1803.00085.pdf](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1803.00085.pdf)
...
[http://arxiv.org/pdf/1708.09585](https://link.zhihu.com/?target=http%3A//arxiv.org/pdf/1708.09585)
...
[https://arxiv.org/pdf/1710.10400](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1710.10400)
...
[https://arxiv.org/pdf/1702.03970](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1702.03970)
...
[http://arxiv.org/pdf/1601.07140](https://link.zhihu.com/?target=http%3A//arxiv.org/pdf/1601.07140)

25. “Synthetic Data for Text Localisation in Natural Images”，arXiv:1604.06646， Ankush Gupta， Andrea Vedaldi， Andrew Zisserman

[https://arxiv.org/pdf/1604.06646](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/1604.06646)
