...
获取全文PDF请查看：[弯曲文字检测之SPCNet](https://link.zhihu.com/?target=http%3A//www.tensorinfinity.com/paper_81.html)
![](https://pic3.zhimg.com/v2-30a546225ad2f7eb7e52ec8f4b07ebbe_b.png)
...
网络流程图如下：
![](https://pic2.zhimg.com/v2-fe50b9bdad295258099257bead2f09c5_b.png)
...
![](https://pic1.zhimg.com/v2-1a540de0e034386f284a296f49c62180_b.png)
RS模块
...
![](https://pic1.zhimg.com/v2-9726ba8862c449e6c1a16430c112c7b8_b.png)
...
![](https://pic4.zhimg.com/v2-93787a2833b6a5494c7a71adc1dacfef_b.png)
具体计算公式如下：

![s_{i}=\frac{e^{(s_{i1}^{cs}+s_{i1}^{is})}}{e^{(s_{i1}^{cs}+s_{i1}^{is})}+e^{(s_{i0}^{cs}+s_{i0}^{is})}}](https://www.zhihu.com/equation?tex=s_%7Bi%7D%3D%5Cfrac%7Be%5E%7B%28s_%7Bi1%7D%5E%7Bcs%7D%2Bs_%7Bi1%7D%5E%7Bis%7D%29%7D%7D%7Be%5E%7B%28s_%7Bi1%7D%5E%7Bcs%7D%2Bs_%7Bi1%7D%5E%7Bis%7D%29%7D%2Be%5E%7B%28s_%7Bi0%7D%5E%7Bcs%7D%2Bs_%7Bi0%7D%5E%7Bis%7D%29%7D%7D)
...
![\(s_{i1}^{cs}=\frac{\sum _{j}p_{i}^{j}}{N}\)](https://www.zhihu.com/equation?tex=%5C%28s_%7Bi1%7D%5E%7Bcs%7D%3D%5Cfrac%7B%5Csum+_%7Bj%7Dp_%7Bi%7D%5E%7Bj%7D%7D%7BN%7D%5C%29)

实验部分

1 标签如何生成？
![](https://pic2.zhimg.com/v2-f474c9dea5f010077c72bedb436c4379_b.png)

![](https://pic1.zhimg.com/v2-510b04305dc962277950312350f6aeb4_b.png)
...
![](https://pic2.zhimg.com/v2-7968a2885253b6409b187d29f36cbb81_b.png)
下图是在多个基准数据集上和主流方法做对比，可以看到SCPNet都领先于目前主流的方法。
![](https://pic3.zhimg.com/v2-43e466ce2db364e19e2bc131c2633086_b.png)![](https://pic3.zhimg.com/v2-e6507df1e7936275af745535cd1acc76_b.png)![](https://pic1.zhimg.com/v2-54583ce86e1e7db3be1f0df5a139348c_b.png)
下图做了一个可视化结果分析，在ICDAR2015上，作者分别对比了EAST，RRPN和TextBoxes++，发现作者的方法相比它们的确能有效减少FP的检测。所有数据都可以在ICDAR官网看到。
![](https://pic2.zhimg.com/v2-e0e741b375fea16b1655f4ba4f54e845_b.png)
最后放上作者在四个数据集上的检测可视化效果图，可以看出SPCNet的确可以灵活的检测任意形状的文字检测。
![](https://pic1.zhimg.com/v2-5db00e6b1731b4743689a6813e393378_b.png)
