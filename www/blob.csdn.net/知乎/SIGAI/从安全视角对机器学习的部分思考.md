...
获取全文PDF请查看：[从安全视角对机器学习的部分思考](https://link.zhihu.com/?target=http%3A//www.tensorinfinity.com/paper_59.html)
...
PDF请点击：[从安全视角对机器学习的部分思考](https://link.zhihu.com/?target=http%3A//www.sigai.cn/paper_59.html)
...
![](https://pic2.zhimg.com/v2-41ec1320b7f8bd63d75b859c0691a491_b.jpg)
图1：模型在各阶段可能产生的攻击
...
![](https://pic4.zhimg.com/v2-1d1c672248d4d0dc750f5732e9083027_b.jpg)
图2：模型在不同场景的各个阶段
...
![](https://pic4.zhimg.com/v2-749fe2819656a9d1bfbc5956fe47ad9f_b.jpg)
图3：训练和推理阶段的攻击强度对比
...
![](https://pic2.zhimg.com/v2-4cb7fb8699e38fda8ff3333e917198bd_b.jpg)
图4：标签操纵的分类准确率
...
![](https://pic4.zhimg.com/v2-b5726c7ef3dde93b6fb9624870afaa3f_b.jpg)
图5：对输入进行操纵导致的结果
...
![](https://pic4.zhimg.com/v2-8a090c10b2043624ecbdc2a9be41fc93_b.png)
...
![](https://pic2.zhimg.com/v2-0fdf43d27d552711ce0a7ae02c969e01_b.jpg)
图6：FGSM的图像扰动方式

当然可以看到，如式（1）中所示，我们可以很明显的看到，其实如何快速求解这个扰动“r”是个问题，因此之后就有工作专门针对这个问题进行了探索，给出了如下方法，FGSM[52]：

![](https://pic1.zhimg.com/v2-1f170de7aacb41145e0fe6269177e760_b.png)

如式（2）所示，通过梯度可以快速求导，以最小的扰动达到攻击目的。
![](https://pic4.zhimg.com/v2-8b5c248c172b3291f4b39ffbab6bb247_b.jpg)
图7：根据函数梯度进行攻击（手绘）
...
![](https://pic3.zhimg.com/v2-a44526900ac4a57ae9cdbd52a6ff7f96_b.jpg)
图8：影子模型的建立过程
...
[16] I. Goodfellow, Y. Bengio, and A. Courville, “Deep learning,” 2016, Book in preparation for MIT Press ([http://www.deeplearningbook.org](https://link.zhihu.com/?target=http%3A//www.deeplearningbook.org)).
