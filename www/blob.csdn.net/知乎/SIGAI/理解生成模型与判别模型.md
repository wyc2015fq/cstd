...
![](https://pic1.zhimg.com/v2-4bb9088bc3117c27ae04ac9c517425ec_b.png)
...
![](https://pic4.zhimg.com/v2-a6bb452000a167dd9f772d54f5984527_b.png)
...
![](https://pic3.zhimg.com/v2-da8a8e23f9bfa7b9d2a670ad3b9bb8fe_b.png)
将上面两个公式合并起来，有：
![](https://pic3.zhimg.com/v2-408aa1db704c2c52f0e97d5b122a88ee_b.png)
...
![](https://pic4.zhimg.com/v2-3e08b1cb1d4a17c050523b638e9672d7_b.png)
...
![](https://pic1.zhimg.com/v2-63fcbf28e3c4ba6cb77c580259ad1a3c_b.jpg)
根据这个联合概率，我们可以很容易得到条件概率p(x|y)和p(y|x)。例如为了得到p(y|x)，可以先求边缘概率p(x)，对于离散型随机变量，对y的概率求和，对于连续型随机变量，则为求积分，然后有：
![](https://pic4.zhimg.com/v2-a8364a5cbd0819fdf1c8a4ffcd9bdf4f_b.png)
...
![](https://pic1.zhimg.com/v2-82ee6585f3fb83a2bd2e6eb2c0823fa0_b.png)
注意，这里只是直接猜测出了这个概率，而没有假设每个类的样本服从何种概率分布，即没有对p(x|y)或者p(x, y)建模。如果对logistic回归感兴趣，可以阅读SIGAI之前的公众号文章“[理解logistic回归](https://link.zhihu.com/?target=http%3A//mp.weixin.qq.com/s%3F__biz%3DMzU4MjQ3MDkwNA%3D%3D%26mid%3D2247486643%26idx%3D1%26sn%3Dbd1523c0c26d16a0fe59e0e5f89a09f4%26chksm%3Dfdb69124cac118324c852a5c2055e101d37b555b740a182e66ff3b005c9573027c503787fd92%26scene%3D21%23wechat_redirect)”。

softmax回归是logistic回归的多分类版本，它直接估计出一个样本向量x属于k个类中每一个类的概率：
![](https://pic4.zhimg.com/v2-b9868b1dc126ffc346d4b9bab05684cf_b.jpg)
...
![](https://pic3.zhimg.com/v2-e24249fcd14bd1152a24549db05a181a_b.png)
