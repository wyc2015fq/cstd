...
译注：折腾 Vim 当然要能看懂和改写相关脚本，而中文资料匮乏，缺一个提纲挈领的教程。本文翻译自 Andrew Scala 的 《[Five Minute Vimscript](https://link.zhihu.com/?target=http%3A//andrewscala.com/vimscript/)》，立足于让你用最短的时间掌握 VimScript 的基础和要点，你可以把它看成一份语言速查表。
...
教程：
- [Vim 中文帮助文档（usr_41） - 编写 Vim 脚本和 API 列表](https://link.zhihu.com/?target=http%3A//vimcdoc.sourceforge.net/doc/usr_41.html)
- [Vim 脚本指北](https://link.zhihu.com/?target=https%3A//github.com/lymslive/vimllearn)
- [Vim 脚本开发规范](https://link.zhihu.com/?target=https%3A//github.com/vim-china/vim-script-style-guide)
