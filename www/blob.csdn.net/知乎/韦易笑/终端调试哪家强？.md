...
![](https://pic2.zhimg.com/v2-ee61d20f0a4ad8e97432d71b3dc6c91d_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='962' height='555'></svg>)
...
即可打开我们的文本界面：
![](https://pic1.zhimg.com/v2-0fe9daf6c27760f6f6e6edb45a5a8b00_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='997' height='681'></svg>)
上方是源代码窗口，下面是 gdb 终端，窗口管理快捷键模仿 emacs，使用 c-x o 进行窗口切换，如果你还想查看指令窗口，可以输入：layout split
![](https://pic1.zhimg.com/v2-6e1a251c1d8db3cd57c45201de6f0db8_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='997' height='681'></svg>)
...
如果上述文本 TUI的信息不够丰富的话，也许你会对 .gdbinit 感兴趣，~/.gdbinit 是一个 gdb配置脚本，可以设定一些由 python 编写的插件，比如 [peda](https://link.zhihu.com/?target=https%3A//github.com/longld/peda)：
![](https://pic3.zhimg.com/v2-bc05bcfdca611d92bcae5aed610c2a5e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='921' height='741'></svg>)
...
可以啊，试试 [cgdb](https://link.zhihu.com/?target=https%3A//cgdb.github.io/)。
...
![](https://pic4.zhimg.com/v2-f91e01a473f38b5a79b91273f1eaf75b_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='997' height='681'></svg>)
...
更多快捷键见【[这里](https://link.zhihu.com/?target=https%3A//cgdb.github.io/docs/cgdb.html%23CGDB-Mode)】，这下单步和断点比原来轻松多啦，你基本可以呆在源代码窗口里不出来，大部分时候不用再到 gdb 命令行里一条条 next/step 的输入了。
...
![](https://pic3.zhimg.com/v2-6be74d3fb8838d273ffc04f9920f3ffa_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='997' height='681'></svg>)
...
![](https://pic2.zhimg.com/v2-7181bfdfc2865dcfa40d2fcbde82e011_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='997' height='681'></svg>)
按下 m-x （alt+x），提示输入命令（如果终端软件 alt 键不灵，那可以设置一下终端软件，或者一秒内先按 ESC，再按 x键，在 xterm 终端下是等价的），键入 “gdb”敲回车：
![](https://pic2.zhimg.com/v2-1d2fc4e7bcda94d75b2b9ff6f2ee4561_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='997' height='681'></svg>)
下面会问你怎么运行gdb，输入gdb的 shell 启动命令行回车后开始 gdb 模式：
![](https://pic4.zhimg.com/v2-9f2ad8f5eeff3d123fd7ec67cfdc9353_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='997' height='681'></svg>)
看到这里也许你会问，这和直接命令行 gdb 有区别么？别急，继续 m-x 输入命令：

`gdb-many-windows`

马上满足你：
![](https://pic3.zhimg.com/v2-8c5bc51221de9e5c02948c71cd329e4e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1114' height='741'></svg>)
...
![](https://pic1.zhimg.com/v2-67970073ddab887524e4bcad1cb55744_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='512' height='289'></svg>)
...
那么其中一个窗口就会被切换成反汇编窗口：
![](https://pic3.zhimg.com/v2-eb625551d25e3e7ac6bf767cb49ed9aa_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1114' height='741'></svg>)
左上角的 gdb 终端被切换成反汇编窗口了，看完后记得 c-x b 切换回 gdb 控制台，如果你要避免某个窗口被切换走可以搜索 emacs 的 dedicated window。再者，我们可以自己用窗口管理快捷键按照我们的喜好拆分布局：
![](https://pic3.zhimg.com/v2-a18f324f2d9fcfe7768495917d8fe38e_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1114' height='741'></svg>)
...
![](https://pic3.zhimg.com/v2-298298e36f4bab6eb137c0f95be1f66a_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1114' height='741'></svg>)
...
![](https://pic3.zhimg.com/v2-521f9e10dcf5f1f8b021acaf888280e6_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1581' height='857'></svg>)
彻底满足你各种复杂的调试需求，这里不展开了，有兴趣见【[这篇文章](https://link.zhihu.com/?target=http%3A//blog.csdn.net/shyanyang/article/details/37349135)】。
...
我平时调试没环境会先使用 gdb-tui 先看看，有环境或者问题复杂了我会打开 emacs 来调试。后来 [@zpan](https://www.zhihu.com/people/bf00d3045de1641c91366d0b277802a1) 给我介绍了 cgdb 以后，gdb-tui 就退役了，无环境先用 cgdb 看个大概，碰到复杂问题打开 emacs，经过一番调教，十分顺手。
...
其实到 emacs 已经差不多了，但如果你实在记不住这有限的几个快捷键或者 gdb 命令，那么还可以尝试一下 [gdbgui](https://link.zhihu.com/?target=https%3A//gdbgui.com/)：
![](https://pic1.zhimg.com/v2-d6f3dec88891f774a8b19042dcbefd68_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1378' height='991'></svg>)
...
![](https://pic3.zhimg.com/v2-70247802b982e6911b990d51e1838252_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='504' height='240'></svg>)
比如上面的调用栈和线程查看，以及下面的自定义结构体查询：
![](https://pic3.zhimg.com/v2-1aa19eac5e7598cceb0497a7032e1496_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='409' height='266'></svg>)
还能可视化查询数据结构：
![](https://pic1.zhimg.com/v2-9f261e0e18698e201dcda4de3e52f9d0_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='650' height='465'></svg>)
