...
![](https://pic2.zhimg.com/v2-a9ac40f5053674281e05a68988d59e69_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='440' height='382'></svg>)
针对测试样本 Xu，想要知道它属于哪个分类，就先 for 循环所有**训练样本**找出离 Xu 最近的 K 个邻居（k=5），然后判断这 K个邻居中，大多数属于哪个类别，就将该类别作为测试样本的预测结果，如上图有4个邻居是红色，1是绿色，那么判断 Xu 的类别为“红色”。
...
![](https://pic2.zhimg.com/v2-2ccef21da523ee0d97ddda6255bf76f5_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='729' height='281'></svg>)
绿色是拟合出来的曲线，用的是 sklearn 里面的 KNeighborsRegressor，可以看得出对非线性回归问题处理的很好，但是还可以再优化一下，k 个邻居中，根据他们离测试点坐标 x 的距离 d 的倒数 1/d 进行加权处理：


```python
w = [  / d[i] for i in range(k) ]
y = sum([ (w[i] * y[i]) for i in range(k) ]) / sum(w)
```


如果 x 刚好和某样本重合，di = 0 的话，1/d 就正无穷了，那么接取该样本的 y 值，不考虑其他点（sklearn的做法），这样得到的 Y 值就相对比较靠谱了：
![](https://pic3.zhimg.com/v2-e1b3009e7addacddce9ae04f09db8a52_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='745' height='293'></svg>)
...
![](https://pic2.zhimg.com/v2-74a66aee0e313c6b4990b71905f99c51_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='817' height='394'></svg>)
...
![](https://pic4.zhimg.com/v2-9f3d980847adc8c117acef2d60f06fff_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='353' height='103'></svg>)
或者曼哈顿距离：
![](https://pic4.zhimg.com/v2-3c9a7405ed6adbef6fe56b4788f01aab_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='349' height='88'></svg>)
...
![](https://pic1.zhimg.com/v2-781e47685456672ff886eaeabfa18574_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='431' height='111'></svg>)
多项式核（POLY）：
![](https://pic4.zhimg.com/v2-814bee09e6e90c9ed42722148864c4c3_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='242' height='61'></svg>)
以及线性核（相当于传统欧式坐标系下点乘）：
![](https://pic3.zhimg.com/v2-4e447c3359c547ea02dbc6727e800b02_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='346' height='76'></svg>)
那么高维空间里两个点的距离，核化以后距离的平方可以表达为：
![](https://pic2.zhimg.com/v2-8646a3ebdcc9e043df1fc3c035592101_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='655' height='138'></svg>)
...
![](https://pic1.zhimg.com/v2-f9841526856ab1cfcb87dcf0627c87cc_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='733' height='93'></svg>)
...
![](https://pic2.zhimg.com/v2-89b293842bd03f02e1503e6863fc14a9_b.png)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='737' height='119'></svg>)
...
![](https://pic4.zhimg.com/v2-cf603c9fa3ecb7ee9829a45b6a71df9b_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='250' height='238'></svg>)
...
![](https://pic3.zhimg.com/v2-7c43c5be776d079a64db0e6e703592b6_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='960' height='564'></svg>)
...
![](https://pic2.zhimg.com/v2-6d5e9aadc151413b5ac7870c4331bda5_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='841' height='629'></svg>)
...
![](https://pic4.zhimg.com/v2-b638d4a21dd4ecbe7c80b98e34be4d13_b.jpg)![](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='983' height='213'></svg>)
...
[如何学习SVM（支持向量机）以及改进实现SVM算法程序？](https://www.zhihu.com/question/31211585/answer/640501555)
