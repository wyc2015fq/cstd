...
开源C++库，称为[POCO](http://pocoproject.org/)（POrtable COmponents – 可移植元件），非常方便好用。
...
4. Crystal Space [http://www.crystalspace3d.org/main/Main_Page](http://www.crystalspace3d.org/main/Main_Page)
...
tips：目前，我正在研究delta开源引擎，并利用其开发一个小型游戏。
