# linux下代替system的基于管道的popen和pclose函数 - DoubleLi - 博客园
...
**[linux下使用system需要谨慎](http://blog.csdn.net/shanzhizi/article/details/9053953)**，那么代替它的方法是什么呢？
...
更多内容请参考：**[shanzhizi专栏](http://blog.csdn.net/shanzhizi)**。
