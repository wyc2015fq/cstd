...
Enter passphrase (empty forno passphrase):*[Type a passphrase]*# Enter same passphrase again: *[Type passphrase again]*
完了之后，大概是这样。
...
$ [Git](http://lib.csdn.net/base/git) remote -v

origin https://github.com/someaccount/someproject.[git](http://lib.csdn.net/base/git) (fetch)
