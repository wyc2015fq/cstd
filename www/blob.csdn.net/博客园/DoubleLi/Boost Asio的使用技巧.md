# Boost.Asio的使用技巧 - DoubleLi - 博客园





- [基本概念](http://blog.jqian.net/post/boost-asio.html#toc_0)- [Asio proactor](http://blog.jqian.net/post/boost-asio.html#toc_1)

- [I/O服务](http://blog.jqian.net/post/boost-asio.html#toc_2)- [work类](http://blog.jqian.net/post/boost-asio.html#toc_3)
- [run() vs poll()](http://blog.jqian.net/post/boost-asio.html#toc_4)
- [stop()](http://blog.jqian.net/post/boost-asio.html#toc_5)
- [post() vs dispatch()](http://blog.jqian.net/post/boost-asio.html#toc_6)
- [buffer类](http://blog.jqian.net/post/boost-asio.html#toc_7)
- [缓冲区管理](http://blog.jqian.net/post/boost-asio.html#toc_8)

- [I/O对象](http://blog.jqian.net/post/boost-asio.html#toc_9)- [socket](http://blog.jqian.net/post/boost-asio.html#toc_10)
- [信号处理](http://blog.jqian.net/post/boost-asio.html#toc_11)
- [定时器](http://blog.jqian.net/post/boost-asio.html#toc_12)
- [strand](http://blog.jqian.net/post/boost-asio.html#toc_13)

- [参考](http://blog.jqian.net/post/boost-asio.html#toc_14)
...
![](http://blog.jqian.net/images/asio_proactor.png)
...
缓冲区的生命期是使用asio最需要重视的两件事之一，缓冲区之所以需要重视的原因在于Asio异步调用[Reference](http://www.boost.org/doc/libs/1_42_0/doc/html/boost_asio/reference/basic_datagram_socket/async_receive_from/overload1.html)里的这段描述：
...
所以，这里强调使用asio时第二件需要重视的事情，就是handler的返回值（一般可能声明为`boost::asio::placeholders::error`）。因为asio里所有的任务都由`io_service`异步执行，只有执行成功或者失败之后才会回调handler，所以返回值是你了解当前异步操作状况的唯一办法，记住不要忽略任何handler的返回值处理。
