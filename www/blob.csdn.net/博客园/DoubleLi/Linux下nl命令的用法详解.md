...
Linux中nl命令和cat命令很像，不过nl命令会打上行号，属于比较不常用的命令，下面随小编一起来了解下这个鲜为人知的nl命令吧。

![ Linux下nl命令的用法详解](http://www.xitongzhijia.net/uploads/allimg/141208/53-14120Q61635313.jpg)
...
　　上面就是Linux下nl命令的相关介绍了，该命令可以计算出文件的行数，因为使用的频率不多而很少见到，你可以试用看看。
