# linux下的so、o、lo、a、la文件的区别 - DoubleLi - 博客园
...
$ unicore32-[Linux](http://lib.csdn.net/base/linux)-gcc –o myprog /usr/lib/liba.so \

-Wl,--rpath-link -Wl,/home/UNITY_float/install/usr/lib

这样，编译器会首先到“/home/UNITY_float/install/usr/lib”下面去搜索libb.so

       libtool如何把选项“-Wl,--rpath-link –Wl,DIR”传递给gcc？libtool中有一个变量“hardcode_libdir_flag_spec”，该变量本来是传递“-rpath”选项的，但我们可以修改它，添加我们需要的路径，传递给unicore32-[linux](http://lib.csdn.net/base/linux)-gcc。
