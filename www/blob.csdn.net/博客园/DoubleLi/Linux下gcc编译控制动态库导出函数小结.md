# Linux下gcc编译控制动态库导出函数小结 - DoubleLi - 博客园
...
中的符号表都得到控制；其中--retain-symbols-file控制静态符号表，--version-script则对应dynamic符号表；另外可以参考 http://blog.csdn.net/shuiyingzi5/article/details/8108190转自 http://blog.csdn.net/zdragon2002/article/details/6061962
