...
#### 本文代码托管于github  [cmake_demo](https://github.com/carl-wang-cn/demo/tree/master/cmake)
...
#### [](file:///#cmake中如何生成动态库和静态库)cmake中如何生成动态库和静态库

参考ADD_LIBRARY和SET_TARGET_PROPERTIES用法
t3示例

#### [](file:///#cmake中如何使用动态库和静态库（查找库的路径）)cmake中如何使用动态库和静态库（查找库的路径）
...
#### [](file:///#cmake中如何指定生成文件的输出路径)cmake中如何指定生成文件的输出路径
...
#### [](file:///#cmake中如何增加编译选项)cmake中如何增加编译选项

使用变量CMAKE_C_FLAGS添加C编译选项
使用变量CMAKE_CXX_FLAGS添加C++编译选项
使用ADD_DEFINITION添加

#### [](file:///#cmake中如何增加头文件路径)cmake中如何增加头文件路径

参考INCLUDE_DIRECTORIES命令用法

#### [](file:///#cmake中如何在屏幕上打印信息)cmake中如何在屏幕上打印信息

参考MESSAGE用法

#### [](file:///#cmake中如何给变量赋值)cmake中如何给变量赋值
