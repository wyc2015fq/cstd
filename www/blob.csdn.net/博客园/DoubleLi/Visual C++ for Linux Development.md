# Visual C++ for Linux Development - DoubleLi - 博客园
...
原文  [https://blogs.msdn.microsoft.com/vcblog/2016/03/30/visual-c-for-linux-development/](http://www.tuicool.com/articles/hit/UveuA3U)
...
![](http://img0.tuicool.com/JzyuA3r.gif)
...
![](http://img0.tuicool.com/aYvqmyu.png!web)
...
![](http://img2.tuicool.com/mEfyA3a.png!web)
...
![](http://img0.tuicool.com/EJvUbqN.png!web)
...
![](http://img2.tuicool.com/7nm2IrU.gif)
...
![](http://img0.tuicool.com/eQZBvmv.png!web)
...
[Visit our IoT Development page](http://aka.ms/vsiot) to stay current on all of our offerings in this space.
...
Now create an empty Linux project and go grab the source for Spinning Cube from[Julien Guertault’s OpenGL tutorial](http://lousodrome.net/opengl/) . Extract it and add main.c to your project. To enable Intellisense you will need to add the OpenGL headers to the VC++ Directories, you can get them from the [OpenGL Registry](https://www.opengl.org/registry/) .  Now go to your project properties and add export DISPLAY=:0.0 to the Pre-Launch command.

![](http://img1.tuicool.com/NfyAJnJ.png!web)
...
![](http://img1.tuicool.com/vYzymum.gif)

Now hit F5.

![](http://img0.tuicool.com/2MB3yiZ.gif)
...
[Install the Visual C++ for Linux Development extension](http://aka.ms/vslinuxext) , try it out and let us know what works for you, what doesn’t or if you encounter any issues. If your focus is IoT remember to [check out our IoT Development page](http://aka.ms/vsiot) to stay current on happenings there. You can reach us here through the blog, on the extension page on the gallery, via the VS Feedback channel, or find our team [@visualc](https://twitter.com/visualc) or me,  [@robotdad](https://twitter.com/robotdad) , on Twitter.
