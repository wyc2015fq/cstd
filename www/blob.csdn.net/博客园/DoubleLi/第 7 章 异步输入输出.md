...
![](http://zh.highscore.de/cpp/boost/img/88x31_cc_logo.gif) 该书采用 [Creative Commons License](http://creativecommons.org/licenses/by-nc-nd/3.0/de/deed.zh) 授权
...
boost::asio::io_service::id basic_timer_service<TimerImplementation>::id; - [下载源代码](http://zh.highscore.de/cpp/boost/src/7.5.1/basic_timer_service.hpp)
...
- 
修改 [第 7.4 节 “网络编程”](http://zh.highscore.de/cpp/boost/asio.html#asio_networkprogramming) 中的服务器程序，不在一次请求后即终止，而是可以处理任意多次请求。

- 
扩展 [第 7.4 节 “网络编程”](http://zh.highscore.de/cpp/boost/asio.html#asio_networkprogramming) 中的客户端程序，即时在所接收到的HTML代码中分析某个URL。 如果找到，则同时下载相应的资源。 对于本练习，只使用第一个URL。 理想情况下，网站及其资源应被保存在两个文件中而不是同时写出至标准输出流。
...
from:http://zh.highscore.de/cpp/boost/asio.html
