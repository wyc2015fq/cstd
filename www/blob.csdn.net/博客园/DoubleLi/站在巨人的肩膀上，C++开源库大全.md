...
程序员要站在巨人的肩膀上，C++拥有丰富的开源库，这里包括：标准库、Web应用框架、人工[智能](http://lib.csdn.net/base/aiplanning)、[数据库](http://lib.csdn.net/base/mysql)、图片处理、[机器学习](http://lib.csdn.net/base/machinelearning)、日志、代码分析等。
...
- [Nettle](http://www.lysator.liu.se/~nisse/nettle/%20target=) 底层的加密库
...
调试库， 内存和资源泄露检测，单元[测试](http://lib.csdn.net/base/softwaretest)
...
### 网络
- [ACE](http://www.cs.wustl.edu/~schmidt/ACE.html%20target=)：C++面向对象网络变成工具包
- [Boost.Asio](http://think-async.com/%20target=)：用于网络和底层I/O编程的跨平台的C++库
...
- [List of tools for static code analysis](http://en.wikipedia.org/wiki/List_of_tools_for_static_code_analysis#C.2FC.2B.2B target=) ：来自维基百科的静态代码分析工具列表
