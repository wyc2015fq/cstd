# 8种Nosql数据库系统对比 - =朝晖= - 博客园
# [8种Nosql数据库系统对比](https://www.cnblogs.com/dhcn/p/7120649.html)
导读：Kristóf Kovács 是一位软件[架构](http://lib.csdn.net/base/architecture)师和咨询顾问，他最近发布了一片对比各种类型NoSQL[数据库](http://lib.csdn.net/base/mysql)的文章。
