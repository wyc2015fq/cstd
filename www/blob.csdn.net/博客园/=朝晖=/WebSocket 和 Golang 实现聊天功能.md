# WebSocket 和 Golang 实现聊天功能 - =朝晖= - 博客园
# [WebSocket 和 Golang 实现聊天功能](https://www.cnblogs.com/dhcn/p/7124725.html)
...
## Server 服务器
服务器程序实现了 [http](http://golang.org/pkg/net/http/) 包，包含了 [Go](http://lib.csdn.net/base/go) 分发和 Gorilla 项目的 websocket 包.
...
来自：[http://www.waylau.com/go-websocket-chat/](http://www.waylau.com/go-websocket-chat/)
