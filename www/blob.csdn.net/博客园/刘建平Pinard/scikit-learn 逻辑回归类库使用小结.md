...
# scikit-learn 逻辑回归类库使用小结 - 刘建平Pinard - 博客园
...
之前在[逻辑回归原理小结](http://www.cnblogs.com/pinard/p/6029432.html)这篇文章中，对逻辑回归的原理做了小结。这里接着对scikit-learn中逻辑回归类库的我的使用经验做一个总结。重点讲述调参中要注意的事项。
# 1. 概述
