...
![](https://images2015.cnblogs.com/blog/1042406/201612/1042406-20161227180625461-1385841797.jpg)
...
$$
上述第（1）式用了上面第四节的拉普拉斯矩阵的性质3. 第二式用到了指示向量的定义。可以看出，对于某一个子图i，它的RatioCut对应于$h_i^TLh_i$,那么我们的k个子图呢？对应的RatioCut函数表达式为：
$$
