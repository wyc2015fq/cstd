# golang实现文字云算法 - walkabc - 博客园
# [golang实现文字云算法](https://www.cnblogs.com/hitfire/p/8990142.html)
# golang实现文字云算法
#### 项目链接
[https://github.com/bangbaoshi/wordcloud](https://github.com/bangbaoshi/wordcloud)
#### 效果图
![](https://github.com/bangbaoshi/wordcloud/raw/master/imgs/template.png)
![](https://github.com/bangbaoshi/wordcloud/raw/master/imgs/template2.png)
#### 测试步骤如下
```
...
#### 目录介绍
- boot目录包含测试用例
- fonts目录包含若干种字体(非商业使用)
- imgs目录包含模板图片，文字云生成的效果图就是按照模板图片的样子来生成
#### 使用说明
