# 基于 HTML5 Canvas 的电信机柜 U 位动态管理 - xhload3d - 博客园
# 前言
U 是一种表示服务器外部尺寸的单位，是 unit 的缩略语，详细的尺寸由作为业界团体的[美国电子工业协会](https://www.baidu.com/s?wd=%E7%BE%8E%E5%9B%BD%E7%94%B5%E5%AD%90%E5%B7%A5%E4%B8%9A%E5%8D%8F%E4%BC%9A&tn=44039180_cpr&fenlei=mv6quAkxTZn0IZRqIHckPjm4nH00T1Y4ujTYujKBPADkP1fYPWR30ZwV5Hcvrjm3rH6sPfKWUMw85HfYnjn4nH6sgvPsT6KdThsqpZwYTjCEQLGCpyw9Uz4Bmy-bIi4WUvYETgN-TLwGUv3EnWmvPWbdrjm3)（EIA）所决定。之所以要规定服务器的尺寸，是为了使服务器保持适当的尺寸以便放在铁质或铝质的机架上。机架上有固定服务器的螺孔，以便它能与服务器的螺孔对上号，再用螺丝加以固定好，以方便安装每一部服务器所需要的空间。规定的尺寸是服务器的宽（48.26cm＝19 英寸）与高（4.445cm 的倍数）。由于宽为19英寸，所以有时也将满足这一规定的机架称为“19 英寸机架”。厚度以 4.445cm 为基本单位。1U 就是 4.445cm，2U 则是 1U 的 2 倍为 8.89cm。所谓“1U 的 PC 服务器”，就是外形满足 EIA 规格、厚度为 4.445cm 的产品。设计为能放置到 19 英寸机柜的产品一般被称为机架服务器。
...
[https://hightopo.com/demo/rack-builder/index.html](https://hightopo.com/demo/rack-builder/index.html)
# 代码生成
## 场景搭建
...
```
上面出现的点击 toolbar 工具条按钮触发的事件中有一个“弹出对话框”的操作，通过 this.addRackDialog.show() 来实现，addRackDialog 对象定义在 initDialog 函数中，作用为创建一个 dialog 对话框([http://www.hightopo.com/guide/guide/plugin/dialog/ht-dialog-guide.html](http://www.hightopo.com/guide/guide/plugin/dialog/ht-dialog-guide.html))，我们设置此对话框中的内容为一个 form 表单进行显示，同时还设计了两个按钮，“OK”按钮作为执行创建/更改机柜的属性，“Cancel”按钮不执行其他操作，只是将对话框隐藏：
...
```
主要的代码就解释到这里，其他部分的内容有兴趣的同学可以自己去抠代码了解 [https://hightopo.com/demo/rack-builder/index.html](https://hightopo.com/demo/rack-builder/index.html)。还有不懂的可以上官网了解 [https://hightopo.com/](https://hightopo.com/)
