# 快速开发 HTML5 WebGL 的 3D 斜面拖拽生成模型 - xhload3d - 博客园
## 前言
...
## 效果图
![](https://images2018.cnblogs.com/blog/591709/201803/591709-20180309163023836-797217562.gif)
[http://www.hightopo.com/demo/Simple3DEditor/index.html](http://www.hightopo.com/demo/Simple3DEditor/index.html)
## 代码生成
#### 创建场景
```
dm = new ht.DataModel();//[数据模型](http://hightopo.com/guide/guide/core/datamodel/ht-datamodel-guide.html)（http://hightopo.com/guide/guide/core/datamodel/ht-datamodel-guide.html）
g3d = new ht.graph3d.Graph3dView(dm);//[3D 场景组件](http://hightopo.com/guide/guide/core/3d/ht-3d-guide.html)（http://hightopo.com/guide/guide/core/3d/ht-3d-guide.html）
palette = new ht.widget.Palette();//[面板组件](http://hightopo.com/guide/guide/plugin/palette/ht-palette-guide.html)（http://hightopo.com/guide/guide/plugin/palette/ht-palette-guide.html）
splitView = new ht.widget.SplitView(palette, g3d, 'h', 0.2);//[分割组件](http://hightopo.com/guide/guide/core/splitview/ht-splitview-guide.html)，第三个参数为分割的方式 h 为左右分，v 为上下分；第四个参数为分割比例，大于 1 的值为绝对宽度，小于 1 则为比例
...
```
#### 左侧内容构建
![](https://images2018.cnblogs.com/blog/591709/201803/591709-20180308102400607-1275980351.png)
...
```
function loadObjFunc(objUrl, mtlUrl, jsonUrl, p3) {//[加载obj模型](http://hightopo.com/guide/guide/plugin/obj/ht-obj-guide.html)
    var node = new ht.Node();
