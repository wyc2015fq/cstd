# 基于 HTML5 的 3D 工业互联网展示方案 - xhload3d - 博客园
# 前言
...
[http://www.hightopo.com/demo/warehouse/index.html](http://www.hightopo.com/demo/warehouse/index.html)
# 代码生成
...
![](https://images2018.cnblogs.com/blog/591709/201807/591709-20180701225345274-1370123635.png)
...
![](https://images2018.cnblogs.com/blog/591709/201807/591709-20180701225724236-1797746463.png)
```
...
![](https://images2018.cnblogs.com/blog/591709/201807/591709-20180701225811548-464082539.png)
```
...
![](https://images2018.cnblogs.com/blog/591709/201807/591709-20180701225922924-450119355.png)
```
...
feedbackButton.addViewListener(e => {
    if (e.kind === 'click') {// HT 自定义的事件属性，具体查看 http://hightopo.com/guide/guide/core/beginners/ht-beginners-guide.html
...
import graph3dView from './3d/index';
```
![](https://images2018.cnblogs.com/blog/591709/201807/591709-20180701230151978-346117761.png)
...
for (let type in cargoTypes) {// 遍历 cargoTypes 数组， G.js 中定义的
  ...
  loadObj(type, cargo.name, (map, array, s3) => {// loadObj(shape3d, fileName, cbFunc) cbFunc 中的参数可以参考 obj 手册
...
![](https://images2018.cnblogs.com/blog/591709/201807/591709-20180701230310868-1320796980.png)
```
import chartPane from './common/chartPane.js';
```
 chartPane 和 shelfPane 类似，都是 Pane 类的对象，属性也类似，不同的是内容。因为今天展示的只是一个 Demo，我们并没有做过多的关于图表插件的处理，所以这里就用图片来代替动态图表，不过就算想做也是很容易的事，[HT 官网](http://hightopo.com)上有更多有趣的例子！
...
```
整个例子解析完毕，有兴趣的小伙伴可以去 HT 官网（[http://www.hightopo.com/](http://www.hightopo.com/)）上自习查阅资料，好好品味，一定会发现更大的世界。
![](https://images2018.cnblogs.com/blog/591709/201807/591709-20180701230516870-1326377473.png)
[http://www.hightopo.com/demo/large-screen/index.html](http://www.hightopo.com/demo/large-screen/index.html)
# 总结
