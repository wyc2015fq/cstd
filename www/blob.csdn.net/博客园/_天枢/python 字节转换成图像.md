# python 字节转换成图像 - _天枢 - 博客园
## [python 字节转换成图像](https://www.cnblogs.com/yhleng/p/9555871.html)
2018-08-29 17:42 by _天枢, ... 阅读, ... 评论, [收藏](#),  [编辑](https://i.cnblogs.com/EditPosts.aspx?postid=9555871)
python 字节转换成图像
使用base64
