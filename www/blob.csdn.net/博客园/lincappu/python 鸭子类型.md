...
# [python 鸭子类型](https://www.cnblogs.com/lincappu/p/8297973.html)





首先[Python](http://lib.csdn.net/base/11)不支持多态，也不用支持多态，python是一种多态语言，崇尚鸭子类型。
