...
```
最终会调用下面类型的宏定义：
**asmlinkage long sys##name(__SC_DECL##x(__VA_ARGS__))**也就是我们前面提到的sys_read（）系统函数。
...
[http://blogold.chinaunix.net/u3/104447/showart_2527011.html](http://blogold.chinaunix.net/u3/104447/showart_2527011.html)
