...
![](file:///C:/DOCUME~1/ADMINI~1/LOCALS~1/Temp/_I6TQ[5PJ3LAAFM$%7B4F69TM.jpg)
其中Vendor/Product...是选择处理器厂家和型号的，Kernel/Library...是配置应用程序的，按空格键或回车键可以进入选项进行配置，用上下键移动到Kernel/Library...菜单上，按空格或回车进入下面的内核配置界面：
![](file:///C:/DOCUME~1/ADMINI~1/LOCALS~1/Temp/5_5D07$7)KO1YDHNG8Z_UF5.jpg)
...
![](file:///C:/DOCUME~1/ADMINI~1/LOCALS~1/Temp/AM2OXRLR2)O252%7B1A$Y~$BP.jpg)
该界面有很多选项，这里不细讲，我们要配置驱动模块，就用上下键移动到Device Drivers上，然后按回车或空格键进入，设备驱动配置界面如下图：
![](file:///C:/DOCUME~1/ADMINI~1/LOCALS~1/Temp/_2I4QG6)B(_6CL[E%7B27RTJX.jpg)
这里就是linux-2.X/drivers/Kconfig里的内容了，下面那个绿色的V(+)表示这一页没显示完，可以用下键继续往下浏览，找到我们自己的菜单名，然后按回车或空格进入，我的模块配置界面如下：
![](file:///C:/DOCUME~1/ADMINI~1/LOCALS~1/Temp/@VIJAL8$G3SKU5O[~RC_E[2.jpg)
