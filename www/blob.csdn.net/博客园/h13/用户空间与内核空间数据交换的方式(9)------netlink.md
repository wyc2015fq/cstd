# 用户空间与内核空间数据交换的方式(9)------netlink - h13 - 博客园
...
```
以上九篇均转自：[http://blogold.chinaunix.net/u3/94916/showart_1915146.html](http://blogold.chinaunix.net/u3/94916/showart_1915146.html)
