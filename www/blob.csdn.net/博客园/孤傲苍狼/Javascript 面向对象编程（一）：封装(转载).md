# Javascript 面向对象编程（一）：封装(转载) - 孤傲苍狼 - 博客园
...
## [Javascript 面向对象编程（一）：封装(转载)](https://www.cnblogs.com/xdp-gacl/p/3706439.html)
...
5 }
6 
7 Cat.prototype.type = "猫科动物";
8 Cat.prototype.eat = function(){alert("吃老鼠")};
```
