# Java基础加强总结(一)——注解(Annotation) - 孤傲苍狼 - 博客园
...
**![](https://images0.cnblogs.com/i/289233/201403/251114219367096.jpg)**
...
```
1 @Documented
2 **@Retention(value=RUNTIME)**3 public @interface Deprecated
```
...
2 **@Retention(value=SOURCE)**3 public @interface Override
```
...
```
1 **@Target(value={TYPE,FIELD,METHOD,PARAMETER,CONSTRUCTOR,LOCAL_VARIABLE})**2 @Retention(value=SOURCE)
